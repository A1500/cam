/**
 * @class L5.grid.GridDragZone
 * @extends L5.dd.DragZone
 * <p>A customized implementation of a {@link L5.dd.DragZone DragZone} which provides default implementations of two of the
 * template methods of DragZone to enable dragging of the selected rows of a GridPanel.</p>
 * <p>A cooperating {@link L5.dd.DropZone DropZone} must be created who's template method implementations of
 * {@link L5.dd.DropZone#onNodeEnter onNodeEnter}, {@link L5.dd.DropZone#onNodeOver onNodeOver},
 * {@link L5.dd.DropZone#onNodeOut onNodeOut} and {@link L5.dd.DropZone#onNodeDrop onNodeDrop}</p> are able
 * to process the {@link #getDragData data} which is provided.
 */
L5.grid.GridDragZone = function(grid, config){
    this.view = grid.getView();
    L5.grid.GridDragZone.superclass.constructor.call(this, this.view.mainBody.dom, config);
    if(this.view.lockedBody){
        this.setHandleElId(L5.id(this.view.mainBody.dom));
        this.setOuterHandleElId(L5.id(this.view.lockedBody.dom));
    }
    this.scroll = false;
    this.grid = grid;
    this.ddel = document.createElement('div');
    this.ddel.className = 'l-grid-dd-wrap';
};

L5.extend(L5.grid.GridDragZone, L5.dd.DragZone, {
    ddGroup : "GridDD",
     ...
     * <p>This data is available for processing in the {@link L5.dd.DropZone#onNodeEnter onNodeEnter}, {@link L5.dd.DropZone#onNodeOver onNodeOver},
     * {@link L5.dd.DropZone#onNodeOut onNodeOut} and {@link L5.dd.DropZone#onNodeDrop onNodeDrop} methods of a cooperating {@link L5.dd.DropZone DropZone}.</p>
     * <p>The data object contains the following properties:<ul>
     * <li><b>grid</b> : L5.Grid.GridPanel<div class="sub-desc">The GridPanel from which the data is being dragged.</div></li>
     ...
     * <p>The <tt>innerHTML</tt> data is found by calling the owning GridPanel's {@link L5.grid.GridPanel#getDragDropText getDragDropText}.</p>
     */
