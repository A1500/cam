/**
 * @class L5.WindowGroup
 * An object that represents a group of {@link L5.Window} instances and provides z-order management
 * and window activation behavior.
 * @constructor
 */
L5.WindowGroup = function(){
    var list = {};
    var accessList = [];
    var front = null;
    ...
    return {
         ...
         * @param {String/Object} id The id of the window or a {@link L5.Window} instance
         * @return {L5.Window}
         */
        get : function(id){
         ...
         * @param {String/Object} win The id of the window or a {@link L5.Window} instance
         ...
         * @return {L5.Window} The active window
         */
        getActive : function(){
            return front;
        },
         ...
         * The function should accept a single {@link L5.Window} reference as its only argument and should
...
/**
 * @class L5.WindowMgr
 * @extends L5.WindowGroup
 * The default global window group that is available automatically.  To have more than one group of windows
 * with separate z-order stacks, create additional instances of {@link L5.WindowGroup} as needed.
 * @singleton
 */
L5.WindowMgr = new L5.WindowGroup();