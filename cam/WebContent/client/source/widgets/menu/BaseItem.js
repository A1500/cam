 ...
 */
L5.menu.BaseItem = function(config){
    L5.menu.BaseItem.superclass.constructor.call(this, config);

    this.addEvents(
        /**
         * @event click
         * Fires when this item is clicked
         * @param {L5.menu.BaseItem} this
...
L5.extend(L5.menu.BaseItem, L5.Component, {
    /**
    ...
    canActivate : false,
    /**
     * @cfg {String} activeClass The CSS class to use when the item becomes activated (defaults to "l-menu-item-active")
     */
    activeClass : "l-menu-item-active",
    /**
    ...
    render : function(container, parentMenu){
        ...
        L5.menu.BaseItem.superclass.render.call(this, container);
