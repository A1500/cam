 ...
 * Provides a date input field with a {@link L5.DatePicker} dropdown and automatic date validation.
* @constructor
* Create a new DateField
* @param {Object} config
 */
L5.form.DateField = L5.extend(L5.form.TriggerField,  {
    /**
     * @cfg {String} format
     ...
     * class 'l-form-trigger' and triggerClass will be <b>appended</b> if specified (defaults to 'l-form-date-trigger'
     * which displays a calendar icon).
     */
    triggerClass : 'l-form-date-trigger',
    /**
    ...
    initComponent : function(){
        L5.form.DateField.superclass.initComponent.call(this);
        
        this.addEvents(
            /**
             * @event select
             * Fires when a date is selected via the date picker.
             * @param {L5.form.DateField} this
    ...
    validateValue : function(value){
        ...
        if(!L5.form.DateField.superclass.validateValue.call(this, value)){
            return false;
        }
...
dateField.setValue('2006-05-04');
    ...
    setValue : function(date){
        L5.form.DateField.superclass.setValue.call(this, this.formatDate(this.parseDate(date)));
    },
    ...
    onDestroy : function(){
        ...
        L5.form.DateField.superclass.onDestroy.call(this);
    },

    // private
    formatDate : function(date){
        return L5.isDate(date) ? date.dateFormat(this.format) : date;
    },
    ...
    onTriggerClick : function(){
        ...
        if(this.menu == null){
            this.menu = new L5.menu.DateMenu();
        }
        ...
        this.menu.on(L5.apply({}, this.menuListeners, {
            scope:this
        }));
...
L5.reg('datefield', L5.form.DateField);