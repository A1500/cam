/**
 * @class L5.form.TextField
 * @extends L5.form.Field
 * Basic text field.  Can be used as a direct replacement for traditional text inputs, or as the base
 * class for more sophisticated input controls (like {@link L5.form.TextArea} and {@link L5.form.ComboBox}).
 * @constructor
 * Creates a new TextField
 * @param {Object} config Configuration options
 */
L5.form.TextField = L5.extend(L5.form.Field,  {
    /**
    ...
    growMax : 800,
    /**
     * @cfg {String} vtype A validation type name as defined in {@link L5.form.VTypes} (defaults to null)
     */
    vtype : null,
    /**
     ...
     * 'l-form-empty-field').  This class is automatically added and removed as needed depending on the current field value.
     */
    emptyClass : 'l-form-empty-field',
    ...
    initComponent : function(){
        L5.form.TextField.superclass.initComponent.call(this);
        this.addEvents(
            /**
             * @event autosize
             ...
             * @param {L5.form.Field} this This text field
             ...
             * @param {L5.form.TextField} this This text field
    ...
    // private
    initEvents : function(){
        L5.form.TextField.superclass.initEvents.call(this);
        if(this.validationEvent == 'keyup'){
            this.validationTask = new L5.util.DelayedTask(this.validate, this);
        ...
        if(this.maskRe || (this.vtype && this.disableKeyFilter !== true && (this.maskRe = L5.form.VTypes[this.vtype+'Mask']))){
    ...
    //private
    onDisable: function(){
        L5.form.TextField.superclass.onDisable.call(this);
        if(L5.isIE){
    ...
    //private
    onEnable: function(){
        L5.form.TextField.superclass.onEnable.call(this);
        if(L5.isIE){
     ...
     */
    reset : function(){
        L5.form.TextField.superclass.reset.call(this);
        this.applyEmptyText();
    },
    ...
    filterKeys : function(e){
        ...
        var k = e.getKey();
        if(L5.isGecko && (e.isNavKeyPress() || k == e.BACKSPACE || (k == e.DELETE && e.button == -1))){
            return;
        }
        var c = e.getCharCode(), cc = String.fromCharCode(c);
        if(!L5.isGecko && e.isSpecialKey() && !cc){
            return;
        }
    ...
    setValue : function(v){
        ...
        L5.form.TextField.superclass.setValue.apply(this, arguments);
        this.applyEmptyText();
        this.autoSize();
    },
    ...
    autoSize : function(){
        ...
        if(!this.metrics){
            this.metrics = L5.util.TextMetrics.createInstance(this.el);
        }
        var el = this.el;
        var v = el.dom.value;
...
L5.reg('textfield', L5.form.TextField);
