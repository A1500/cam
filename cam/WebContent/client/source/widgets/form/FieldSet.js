/**
 * @class L5.form.FieldSet
 * @extends L5.Panel
 * Standard container used for grouping form fields.
 * @constructor
 * @param {Object} config Configuration options
 */
L5.form.FieldSet = L5.extend(L5.Panel, {
    /**
     ...
     */
    /**
     * @cfg {String} baseCls The base CSS class applied to the fieldset (defaults to 'l-fieldset').
     */
    baseCls:'l-fieldset',
    /**
     * @cfg {String} layout The {@link L5.Container#layout} to use inside the fieldset (defaults to 'form').
     */
    layout: 'form',
    /**
    ...
    onRender : function(ct, position){
        if(!this.el){
            ...
            if (this.title || this.header || this.checkboxToggle) {
                this.el.appendChild(document.createElement('legend')).className = 'l-fieldset-header';
            }
        }

        L5.form.FieldSet.superclass.onRender.call(this, ct, position);
    ...
    onCollapse : function(doAnim, animArg){
        ...
        L5.form.FieldSet.superclass.onCollapse.call(this, doAnim, animArg);
    ...
    onExpand : function(doAnim, animArg){
        ...
        L5.form.FieldSet.superclass.onExpand.call(this, doAnim, animArg);
    },
    ...
    beforeDestroy : function(){
        ...
        L5.form.FieldSet.superclass.beforeDestroy.call(this);
    }
...
L5.reg('fieldset', L5.form.FieldSet);
