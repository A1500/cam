/**
 * @class L5.form.TimeField
 * @extends L5.form.ComboBox
 * Provides a time input field with a time dropdown and automatic time validation.  Example usage:
 * <pre><code>
new L5.form.TimeField({
    minValue: '9:00 AM',
    maxValue: '6:00 PM',
    increment: 30
});
 ...
 * @param {Object} config
 */
L5.form.TimeField = L5.extend(L5.form.ComboBox, {
    /**
    ...
    initComponent : function(){
        L5.form.TimeField.superclass.initComponent.call(this);
    ...
    // inherited docs
    getValue : function(){
        var v = L5.form.TimeField.superclass.getValue.call(this);
        return this.formatDate(this.parseDate(v)) || '';
    },

    // inherited docs
    setValue : function(value){
        L5.form.TimeField.superclass.setValue.call(this, this.formatDate(this.parseDate(value)));
    },

    // private overrides
    validateValue : L5.form.DateField.prototype.validateValue,
    parseDate : L5.form.DateField.prototype.parseDate,
    formatDate : L5.form.DateField.prototype.formatDate,
...
L5.reg('timefield', L5.form.TimeField);