 ...
 */
L5.ToolTip = L5.extend(L5.Tip, {
    /**
     * @cfg {Mixed} target The target HTMLElement, L5.Element or id to associate with this tooltip.
     */
    /**
    ...
    initComponent: function(){
        L5.ToolTip.superclass.initComponent.call(this);
    ...
    initTarget : function(){
        if(this.target){
            this.target = L5.get(this.target);
    ...
    hide: function(){
        ...
        this.lastActive = new Date();
        L5.ToolTip.superclass.hide.call(this);
    },
    ...
    showAt : function(xy){
        this.lastActive = new Date();
        this.clearTimers();
        L5.ToolTip.superclass.showAt.call(this, xy);
    ...
    // private
    onShow : function(){
        L5.ToolTip.superclass.onShow.call(this);
        L5.getDoc().on('mousedown', this.onDocMouseDown, this);
    },

    // private
    onHide : function(){
        L5.ToolTip.superclass.onHide.call(this);
        L5.getDoc().un('mousedown', this.onDocMouseDown, this);
    },
    ...
    // private
    onDestroy : function(){
        L5.ToolTip.superclass.onDestroy.call(this);
        if(this.target){
