 ...
 * you should consider either {@link L5.Tip} or {@link L5.ToolTip}.</p>
 ...
 * <p>The singleton's instance of {@link L5.QuickTip} is available via
 * {@link #getQuickTip}, and supports all the methods, and all the all the
 * configuration properties of L5.QuickTip. These settings will apply to all
...
L5.apply(L5.QuickTips.getQuickTip(), {
    maxWidth: 200,
    minWidth: 100,
    showDelay: 50,
    trackMouse: true
 ...
 * the <b>L5:</b> namespace.  The HTML element itself is automatically set as the quick tip target. Here is the summary
...
&lt;input type="button" value="OK" L5:qtitle="OK Button" L5:qwidth="100"
     L5:qtip="This is a quick tip from markup!">&lt;/input>
</code></pre>
 * @singleton
 */
L5.QuickTips = function(){
    var tip, locks = [];
    return {
        /**
        ...
        init : function(autoRender){
		    if(!tip){
		        if(!L5.isReady){
		            L5.onReady(function(){
		                L5.QuickTips.init(autoRender);
		            });
		            return;
		        }
		        tip = new L5.QuickTip({elements:'header,body'});
		        if(autoRender !== false){
		            tip.render(L5.getBody());
		        }
		    }
        },
         ...
         * {@link L5.QuickTip#register} for details.
