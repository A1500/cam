 ...
 */
    ...
    getLoader : function(){
        var owner;
        return this.loader || ((owner = this.getOwnerTree()) && owner.loader ? owner.loader : new L5.tree.TreeLoader());
    },
...
L5.tree.TreePanel.nodeTypes.node = L5.tree.TreeNode;