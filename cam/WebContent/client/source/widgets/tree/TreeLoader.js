/**
 * @class L5.tree.TreeLoader
 * @extends L5.util.Observable
 * A TreeLoader provides for lazy loading of an {@link L5.tree.TreeNode}'s child
 ...
 */
L5.tree.TreeLoader = function(config){
    this.baseParams = {};
    ...
    this.addEvents(
         ...
         * @param {Object} node The {@link L5.tree.TreeNode} object being loaded.
    ...
    L5.tree.TreeLoader.superclass.constructor.call(this);
};

L5.extend(L5.tree.TreeLoader, L5.util.Observable, {
    /**
    ...
    */
    /**
     * @cfg {String} requestMethod The HTTP request method for loading data (defaults to the value of {@link L5.Ajax#method}).
     */
    /**
    ...
    * specify custom {@link L5.tree.TreeNodeUI} implementations. If the optional
    ...
    */
    ...
    /**
     * Load an {@link L5.tree.TreeNode} from the URL specified in the constructor.
...
new L5.tree.TreePanel({
    ...
    new L5.tree.TreeLoader({
        url: 'dataUrl',
        createNode: function(attr) {
//          Allow consolidation consignments to have
//          consignments dropped into them.
            if (attr.isConsolidation) {
                attr.iconCls = 'l-consol',
                attr.allowDrop = true;
            }
            return L5.tree.TreeLoader.prototype.call(this, attr);
        }
    }),
    ...
}); 
    ...
    */
    createNode : function(attr){
        ...
        if(this.baseAttrs){
            L5.applyIf(attr, this.baseAttrs);
        }
        ...
        if(attr.nodeType){
            return new L5.tree.TreePanel.nodeTypes[attr.nodeType](attr);
        }else{
            return attr.leaf ?
                        new L5.tree.TreeNode(attr) :
                        new L5.tree.AsyncTreeNode(attr);
        }
    },
