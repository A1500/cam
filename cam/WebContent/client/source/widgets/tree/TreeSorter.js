/**
 * @class L5.tree.TreeSorter
 * Provides sorting of nodes in a {@link L5.tree.TreePanel}.  The TreeSorter automatically monitors events on the 
 * associated TreePanel that might affect the tree's sort order (beforechildrenrendered, append, insert and textchange).
 * Example usage:<br />
 * <pre><code>
new L5.tree.TreeSorter(myTree, {
    folderSort: true,
    dir: "desc",
 ...
 * @param {Object} config
 */
L5.tree.TreeSorter = function(tree, config){
    /**
     ...
     * will be called with a single parameter (the {@link L5.tree.TreeNode} being evaluated) and is expected to return
