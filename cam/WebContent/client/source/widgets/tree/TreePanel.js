/**
 * @class L5.tree.TreePanel
 * <p>The TreePanel provides tree-structured UI representation of tree-structured data.</p>
 * <p>{@link L5.tree.TreeNode TreeNode}s added to the TreePanel may each contain metadata
 * used by your application in their {@link L5.tree.TreeNode#attributes attributes} property.</p>
 ...
 * @cfg {L5.tree.TreeNode} root The root node for the tree.
 ...
 * @cfg {Object} dragConfig Custom config to pass to the {@link L5.tree.TreeDragZone} instance
 * @cfg {Object} dropConfig Custom config to pass to the {@link L5.tree.TreeDropZone} instance
 ...
 * @cfg {Boolean} hlDrop false to disable node highlight on drop (defaults to the value of L5.enableFx)
 * @cfg {String} hlColor The color of the node highlight (defaults to C3DAF9)
 * @cfg {Boolean} animate true to enable animated expand/collapse (defaults to the value of L5.enableFx)
 * @cfg {Boolean} singleExpand true if only 1 node per branch may be expanded
 * @cfg {Boolean} selModel A tree selection model to use with this TreePanel (defaults to a {@link L5.tree.DefaultSelectionModel})
 * @cfg {Boolean} trackMouseOver False to disable mouse over highlighting 
 * @cfg {L5.tree.TreeLoader} loader A {@link L5.tree.TreeLoader} for use with this TreePanel
 ...
 * @param {Object} config
 */
L5.tree.TreePanel = L5.extend(L5.Panel, {
    rootVisible : true,
    animate: L5.enableFx,
    lines : true,
    enableDD : false,
    ...
    initComponent : function(){
        L5.tree.TreePanel.superclass.initComponent.call(this);
        ...
        var l = this.loader;
        if(!l){
            l = new L5.tree.TreeLoader({
                dataUrl: this.dataUrl
            });
        }else if(typeof l == 'object' && !l.load){
            l = new L5.tree.TreeLoader(l);
        }
        this.loader = l;
        ...
        */
        ...
        this.addEvents(
            ...
            * event, first create a Menu object (see {@link L5.menu.Menu} for details), then add
            * a handler for this event:<code><pre>
new L5.tree.TreePanel({
    title: 'My TreePanel',
...
//          it via its {@link L5.menu.BaseItem#parentMenu parentMenu} property.
    ...
    /**
     * Returns the default {@link L5.tree.TreeLoader} for this TreePanel.
     * @return {L5.tree.TreeLoader} The TreeLoader for this TreePanel.
     */
    getLoader : function(){
        return this.loader;
    },
    ...
    /**
     * Expands a specified path in this TreePanel. A path can be retrieved from a node with {@link L5.model.Node#getPath}
     * @param {String} path
    ...
    onRender : function(ct, position){
        L5.tree.TreePanel.superclass.onRender.call(this, ct, position);
    ...
    // private
    initEvents : function(){
        L5.tree.TreePanel.superclass.initEvents.call(this);
    ...
    afterRender : function(){
        L5.tree.TreePanel.superclass.afterRender.call(this);
        this.root.render();
        if(!this.rootVisible){
    ...
    onDestroy : function(){
        ...
        this.root.destroy();
        this.nodeHash = null;
        L5.tree.TreePanel.superclass.onDestroy.call(this);
    }
...
L5.tree.TreePanel.nodeTypes = {};

L5.reg('treepanel', L5.tree.TreePanel);