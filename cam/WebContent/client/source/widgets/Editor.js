 ...
 * @constructor
 * Create a new Editor
 * @param {L5.form.Field} field The Field object (or descendant)
 * @param {Object} config The config object
 */
L5.Editor = function(field, config){
    this.field = field;
    L5.Editor.superclass.constructor.call(this, config);
};

L5.extend(L5.Editor, L5.Component, {
    /**
     ...
     * The position to align to (see {@link L5.Element#alignTo} for more details, defaults to "c-c?").
     */
    alignment: "c-c?",
    /**
    ...
    initComponent : function(){
        L5.Editor.superclass.initComponent.call(this);
        this.addEvents(
            /**
             ...
             * @param {Editor} this
             * @param {L5.Element} boundEl The underlying element bound to this editor
    ...
    onRender : function(ct, position){
        ...
        this.el.setStyle("overflow", L5.isGecko ? "auto" : "");//解决editgrid的编辑域宽度不够
    ...
    doAutoSize : function(){
        if(this.autoSize){
            ...
            switch(this.autoSize){
                case "width":
                    this.setSize(sz.width,  undefined);
                break;
                case "height":
                    this.setSize(undefined,  sz.height);
                break;
                default:
    ...
    onShow : function(){
        ...
        this.field.show();
        if(L5.isIE && !this.fixIEFocus){ // IE has problems with focusing the first time
    ...
    beforeDestroy : function(){
        L5.destroy(this.field);
        this.field = null;
    }
});
L5.reg('editor', L5.Editor);