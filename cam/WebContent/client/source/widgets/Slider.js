 ...
 */
L5.Slider = L5.extend(L5.BoxComponent, {
	/**
    ...
    initComponent : function(){
        ...
        L5.Slider.superclass.initComponent.call(this);
        ...
        this.addEvents(
			 ...
			 * @param {L5.Slider} slider The slider
			 ...
			 * @param {L5.Slider} slider The slider
			 * @param {L5.EventObject} e The event fired from L5.dd.DragTracker
			 */
			'dragstart', 
			/**
			 * @event drag
        ...
        if(this.vertical){
            L5.apply(this, L5.Slider.Vertical);
        }
    },
    ...
    onRender : function(){
        this.autoEl = {
            cls: 'l-slider ' + (this.vertical ? 'l-slider-vert' : 'l-slider-horz'),
            cn:{cls:'l-slider-end',cn:{cls:'l-slider-inner',cn:[{cls:'l-slider-thumb'},{tag:'a', cls:'l-slider-focus', href:"#", tabIndex: '-1', hidefocus:'on'}]}}
        };
        L5.Slider.superclass.onRender.apply(this, arguments);
	...
	// private override
    initEvents : function(){
        this.thumb.addClassOnOver('l-slider-thumb-over');
        this.mon(this.el, 'mousedown', this.onMouseDown, this);
        this.mon(this.el, 'keydown', this.onKeyDown, this);

        this.focusEl.swallowEvent("click", true);

        this.tracker = new L5.dd.DragTracker({
    ...
    afterRender : function(){
        L5.Slider.superclass.afterRender.apply(this, arguments);
        if(this.value !== undefined){
    ...
    onDragStart: function(e){
        this.thumb.addClass('l-slider-thumb-drag');
        this.dragging = true;
    ...
    onDragEnd: function(e){
        this.thumb.removeClass('l-slider-thumb-drag');
        this.dragging = false;
    ...
    //private
    onDisable: function(){
        L5.Slider.superclass.onDisable.call(this);
        ...
        if(L5.isIE){
            ...
            if (!this.thumbHolder){
                this.thumbHolder = this.endEl.createChild({cls: 'l-slider-thumb ' + this.disabledClass});    
            }
    ...
    //private
    onEnable: function(){
        L5.Slider.superclass.onEnable.call(this);
