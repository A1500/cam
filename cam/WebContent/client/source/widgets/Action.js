 ...
 * updates across any components that support the Action interface (primarily {@link L5.Toolbar}, {@link L5.Button}
 * and {@link L5.menu.Menu} components).</p>
...
var action = new L5.Action({
    text: 'Do something',
    handler: function(){
        L5.Msg.alert('Click', 'You did something.');
    },
