/**
 * @class L5.CycleButton
 * @extends L5.SplitButton
 * A specialized SplitButton that contains a menu of {@link L5.menu.CheckItem} elements.  The button automatically
 * cycles through each menu item on click, raising the button's {@link #change} event (or calling the button's
 * {@link #changeHandler} function, if supplied) for the active menu item. Clicking on the arrow section of the
 * button displays the dropdown menu just like a normal SplitButton.  Example usage:
 * <pre><code>
var btn = new L5.CycleButton({
    showText: true,
    prependText: 'View as ',
    items: [{
        text:'text only',
    ...
    changeHandler:function(btn, item){
        L5.Msg.alert('Change View', item.text);
    }
});
</code></pre>
 * @constructor
 ...
 */
L5.CycleButton = L5.extend(L5.SplitButton, {
    /**
     * @cfg {Array} items An array of {@link L5.menu.CheckItem} <b>config</b> objects to be used when creating the
     ...
     * following argument list: (SplitButton this, L5.menu.CheckItem item)
     */
	/**
     ...
     * @param {L5.menu.CheckItem} item The item to activate
     ...
     * @return {L5.menu.CheckItem} The active item
     */
    ...
    initComponent : function(){
        this.addEvents(
             ...
             * not be fired.
             * @param {L5.CycleButton} this
             * @param {L5.menu.CheckItem} item The menu item that was selected
             */
            "change"
        );
        ...
        this.menu = {cls:'l-cycle-menu', items:[]};
        var checked;
        ...
        L5.CycleButton.superclass.initComponent.call(this);
