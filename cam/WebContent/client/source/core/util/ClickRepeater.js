...
L5.util.ClickRepeater = function(el, config)
{
     ...
     * @param {L5.util.ClickRepeater} this
     */
        "mousedown",
    /**
     * @event click
    ...
    L5.util.ClickRepeater.superclass.constructor.call(this);
};

L5.extend(L5.util.ClickRepeater, L5.util.Observable, {
    interval : 20,
    delay: 250,
    preventDefault : true,
    stopDefault : false,
    ...
    handleMouseDown : function(){
        ...
        L5.getDoc().on("mouseup", this.handleMouseUp, this);
...
//      Do not honor delay or interval if acceleration wanted.
    ...
    handleMouseUp : function(){
        ...
        L5.getDoc().un("mouseup", this.handleMouseUp, this);
        this.el.removeClass(this.pressClass);
