 ...
 */
L5.util.MixedCollection = function(allowFunctions, keyFn){
    this.items = [];
    this.map = {};
    this.keys = [];
    this.length = 0;
    ...
    L5.util.MixedCollection.superclass.constructor.call(this);
};

L5.extend(L5.util.MixedCollection, L5.util.Observable, {
...
<pre><code>
// normal way
var mc = new L5.util.MixedCollection();
...
var mc = new L5.util.MixedCollection(false, function(el){
   return el.dom.id;
});
mc.add(someEl);
mc.add(otherEl);
 ...
 */
    addAll : function(objs){
        if(arguments.length > 1 || L5.isArray(objs)){
 ...
 */
    ...
    filterBy : function(fn, scope){
        var r = new L5.util.MixedCollection();
 ...
 * @return {Object} The item associated with the passed key.
 */
L5.util.MixedCollection.prototype.get = L5.util.MixedCollection.prototype.item;