 ...
 * Usage:<br>
 * <pre><code>
 * // Get it from a L5.Element object
 * var el = L5.get("foo");
 ...
 * var mgr = new L5.Updater("myElementId");
 ...
 */
L5.Updater = L5.extend(L5.util.Observable, {
    constructor: function(el, forceNew){
        ...
        var d = L5.Updater.defaults;
        /**
         * Blank page URL to use with SSL file uploads (defaults to {@link L5.Updater.defaults#sslBlankUrl}).
         * @type String
         */
        this.sslBlankUrl = d.sslBlankUrl;
        /**
         * Whether to append unique parameter on get request to disable caching (defaults to {@link L5.Updater.defaults#disableCaching}).
         * @type Boolean
         */
        this.disableCaching = d.disableCaching;
        /**
         * Text for loading indicator (defaults to {@link L5.Updater.defaults#indicatorText}).
         * @type String
         */
        this.indicatorText = d.indicatorText;
        /**
         * Whether to show indicatorText when loading (defaults to {@link L5.Updater.defaults#showLoadIndicator}).
         * @type String
         */
        this.showLoadIndicator = d.showLoadIndicator;
        /**
         * Timeout for requests or form posts in seconds (defaults to {@link L5.Updater.defaults#timeout}).
         * @type Number
         */
        this.timeout = d.timeout;
        /**
         * True to process scripts in the output (defaults to {@link L5.Updater.defaults#loadScripts}).
         * @type Boolean
         */
        ...
        if(!this.renderer){
         /**
          * The renderer for this Updater (defaults to {@link L5.Updater.BasicRenderer}).
          */
        this.renderer = this.getDefaultRenderer();
        }
        L5.Updater.superclass.constructor.call(this);
    },
    /**
     * This is an overrideable method which returns a reference to a default
     * renderer class if none is specified when creating the L5.Updater.
     * Defaults to {@link L5.Updater.BasicRenderer}
     */
    getDefaultRenderer: function() {
        return new L5.Updater.BasicRenderer();
    },
    /**
     ...
     * <i>returns</i> the URL (defaults to the value of {@link L5.Ajax#url} if not specified).</p></li>
     ...
     * and executed (defaults to {@link L5.Updater.defaults#loadScripts}). If this option is specified,
     ...
     * <li><b>el</b> : L5.Element<p class="sub-desc">The Element being updated.</p></li>
     ...
     * timing out (defaults to {@link L5.Updater.defaults#timeout}).</p></li>
     * <li>text : <b>String</b><p class="sub-desc">The text to use as the innerHTML of the
     * {@link L5.Updater.defaults#indicatorText} div (defaults to 'Loading...').  To replace the entire div, not
     * just the text, override {@link L5.Updater.defaults#indicatorText} directly.</p></li>
     ...
     * to defeat caching (defaults to {@link L5.Updater.defaults#disableCaching}).</p></li></ul>
     * <p>
     * For example:
<pre><code>
um.update({
    ...
    update : function(url, params, callback, discardUrl){
        if(this.fireEvent("beforeupdate", this.el, url, params) !== false){
            ...
            this.transaction = L5.Ajax.request(o);
        }
    },
    ...
    formUpdate : function(form, url, reset, callback){
        if(this.fireEvent("beforeupdate", this.el, form, url) !== false){
            ...
            form = L5.getDom(form)
            this.transaction = L5.Ajax.request({
                form: form,
                url:url,
                success: this.processSuccess,
                failure: this.processFailure,
    ...
    /**
     * Sets the content renderer for this Updater. See {@link L5.Updater.BasicRenderer#render} for more details.
    ...
    /**
     * Returns the content renderer for this Updater. See {@link L5.Updater.BasicRenderer#render} for more details.
     * @return {Object}
     */
    ...
    abort : function(){
        if(this.transaction){
            L5.Ajax.abort(this.transaction);
        }
    },
    ...
    isUpdating : function(){
        if(this.transaction){
            return L5.Ajax.isLoading(this.transaction);
        }
        return false;
    }
});
 ...
 */
   L5.Updater.defaults = {
       /**
        ...
        loadScripts : false,
        /**
        * Blank page URL to use with SSL file uploads (defaults to {@link L5#SSL_SECURE_URL} if set, or "javascript:false").
        * @type String
        */
        sslBlankUrl : (L5.SSL_SECURE_URL || "javascript:false"),
        /**
 ...
 * Usage:
 * <pre><code>L5.Updater.updateElement("my-div", "stuff.php");</code></pre>
 * @param {Mixed} el The element to update
 ...
 * @member L5.Updater
 */
L5.Updater.updateElement = function(el, url, params, options){
    var um = L5.get(el).getUpdater();
    L5.apply(um, options);
    um.update(url, params, options ? options.callback : null);
};
/**
 * @class L5.Updater.BasicRenderer
 * Default Content renderer. Updates the elements innerHTML with the responseText.
 */
L5.Updater.BasicRenderer = function(){};

L5.Updater.BasicRenderer.prototype = {
    /**
     ...
     * @param {L5.Element} el The element being rendered
