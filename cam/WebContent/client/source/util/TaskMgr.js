 ...
 * (defaults to 10)
 */
L5.util.TaskRunner = function(interval){
...
/**
 * @class L5.TaskMgr
 * A static {@link L5.util.TaskRunner} instance that can be used to start and stop arbitrary tasks.  See
 * {@link L5.util.TaskRunner} for supported methods and task config properties.
 * <pre><code>
// Start a simple clock task that updates a div once per second
var task = {
    run: function(){
 ...
 * @singleton
 */
L5.TaskMgr = new L5.util.TaskRunner();