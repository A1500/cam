...
<model:datasets>
	...
	<next:TabPanel id="tabPanels" autoHeight="true" width="98%" activeTab="0">
		<next:Tabs>
			<next:Panel title="困难家庭信息" name="阳光基本信息" autoHeight="true" autoWidth="true">
			<next:TopBar>
				<next:ToolBarItem symbol="->"/>
				<next:ToolBarItem iconCls="undo" text="返回" handler="undoNum3" />
			</next:TopBar>
				<next:AnchorLayout>
						...
						<next:Html>
							...
							<table border="0" style="width:100%;word-wrap:break-word;overflow:hidden;">
								<tr>
									...
									<td class="FieldInput" style="width: 20%"><label id="familyCardNo" name="familyCardNo" field="familyCardNo" maxlength="18" size="18" /></td>
								...
								<tr>
									...
									<select id="county" name="区" field="county" onchange="setXzqhStreet()" style="width:75%" >
										<option dataset="DmXzqhDataSetState"></option></select></span></td>
									<td class="FieldLabel" width="10%">地址_镇：</td>
									<td class="FieldInput" width="10%"><span onmousemove="this.setCapture();" onmouseout="this.releaseCapture();">
									<select id="town" name="地址_镇" field="town" onchange="setXzqhVillage()" style="width: 75%">
								...
								<tr>
									...
									<td class="FieldInput" width="15%"><span onmousemove="this.setCapture();" onmouseout="this.releaseCapture();">
									<select id="village" name="地址_村(居)" style="width: 75%" field="village">
								...
								<tr>
									...
									<td class="FieldInput" style="width: 20%"><label name="familyMobile"  field="familyMobile" /></td>
								...
								<tr>
									...
									<td class="FieldInput" ><label name="yearAverageIncome"  field="yearAverageIncome" readonly="true"/>&nbsp;<font color=green>自动生成</font></td>
								...
								<tr>
									...
									<td class="FieldInput" style="width: 20%">
										  <label name="houseQuality" field="houseQuality" dataset="DmZfzklxDataSet"></td>
									<td  class="FieldLabel" style="width: 10%">房屋状况:</td>
									<td class="FieldInput" >
									 <label name="houseStatus" field="houseStatus" dataset="DmFwjgDataSet"></td>
									<td id="fwzk" class="FieldLabel" style="width: 10%">住房结构:</td>
									<td class="FieldInput" >
									 <label name="buildingStructure" field="buildingStructure" dataset="DmzfjgDataSet"></td>
								</tr>
								<tr>
									...
									<td class="FieldInput"><label name="buildAverageArea" field="buildAverageArea"  readonly="true"/>&nbsp;<font color=green>自动生成</font></td>
									<td class="FieldLabel"></td>
									<td class="FieldInput"></td>
								</tr>
								<tr>
									<td class="FieldLabel">备注：</td>
									<td colspan="3" class="FieldInput"><textarea name="note" field="note" disabled="disabled"  style="width:90%" rows="3" /></textarea></td>
			...
			<next:Html>
				<form id="accountForm" method="post"  onsubmit="return false" class="L5form">
				   ...
				   <table id="isFive" width="100%"  style="display:none">
					...
					<next:GridPanel height="200" id="YgjzJtxxZrzhEditGridPanel"  autoWidth="true" collapsible="true" animCollapse="true"
					 autoScroll="true" name="YgjzJtxxZrzhEditGridPanel" stripeRows="true" dataset="YgjzJtxxZrzhDataSet" title="阳光救助_家庭信息_自然灾害">
						<next:Columns>
							<next:RowNumberColumn width="30" />
							<next:Column id="familyId" header="家庭ID" field="familyId" width="80" hidden="true">
								<next:TextField allowBlank="false" />
							</next:Column>
							<next:Column id="calamityDate" header="受灾时间" field="calamityDate" width="90" align="center">
								<next:DateField allowBlank="false" format="Y-m-d"/>
							</next:Column>
							<next:Column id="calamityType" header="灾害种类" field="calamityType" width="90" align="center">
								<next:ComboBox dataset="DmZhzlDataSet" displayField="text" valueField="value" typeAhead="true" />
							</next:Column>
							<next:Column id="lossMon" header="灾害损失_金额" field="lossMon" width="110" align="center">
			...
			<next:Panel title="家庭成员基本信息" name="anchor-div" height="570" width='98%'>
				<next:AnchorLayout>
					<next:GridPanel id="YgjzJtxxCyxxEditGridPanel" name="YgjzJtxxCyxxEditGridPanel"  stripeRows="true" height="570" width='98%' dataset="YgjzJtxxCyxxDataSet" title="阳光救助_家庭信息_成员信息">
						<next:TopBar>
							<next:ToolBarItem symbol="->" ></next:ToolBarItem>
						...
						<next:Columns>
							...
							<next:Column header="与户主关系" field="relationshipType" width="13%" dataset="DmHzgxDataSet"  align="center"/>
							<next:Column id="name" header="姓名" field="name" width="10%" align="center">
								<next:TextField />
							</next:Column>
							<next:Column id="idCard" header="身份证号" field="idCard" width="23%" align="center">
								<next:TextField />
							</next:Column>
							<next:Column id="sex" header="性别" field="sex" width="10%" align="center" dataset="DmXbDataSet">
								<next:TextField />
							</next:Column>
							<next:Column id="regPeople" header="录入人" field="regPeople" width="15%" align="center">
								<next:TextField />
							</next:Column>
							<next:Column id="regTime" header="录入时间" field="regTime" width="20%" align="center">
								<next:TextField />
							</next:Column>
						</next:Columns>
					</next:GridPanel>
...
<next:Window id="hello-win" title="家庭成员信息明细" width="780" height="450" closeAction="hide" modal="true" resizable="true" autoScroll="true">
	<next:AnchorLayout>
			...
			<next:Html>
				...
				<table border="0" width="750">
					...
					<tr>
						...
						<td class="FieldInput" style="width: 20%"><label onchange="checkCN('name','sfzh','户主姓名');" name="name" field="name" value="11" /><font color="red">*</font></td>
						<td class="FieldLabel" nowrap="nowrap"  style="width: 10%">身份证号:</td>
						<td class="FieldInput" style="width: 20%"><label onchange="checkIDCard('idCard','户主身份证');getBirthdayByIdCard();" id="jtcysfzh" style="width:110" name="idCard" field="idCard" /><font color="red">*</font></td>
						<td class="FieldLabel" nowrap="nowrap" style="width: 10%">户主关系:</td>
						<td class="FieldInput" style="width: 20%"><label name="relationshipType" field="relationshipType" dataset="DmHzgxDataSet"></label></td>
					</tr>
					<tr>
						<td class="FieldLabel" nowrap="nowrap"  style="width: 10%">性别:</td>
						<td class="FieldInput" style="width: 20%"> <label name="sex" field="sex" dataset="DmXbDataSet"></label></td>
						<td class="FieldLabel" nowrap="nowrap" nowrap="nowrap"  style="width: 10%">出生日期:</td>
						<td class="FieldInput" style="width: 20%"><label id="jtcycsrq"  name="birthday" field="birthday" /><font color="red">*</font></td>
						<td class="FieldLabel" nowrap="nowrap"  style="width: 10%">户籍性质:</td>
						<td class="FieldInput" style="width: 20%"> <label name="domicileType" field="domicileType" dataset="DmHjxzDataSet"></label></td>
					</tr>
					<tr>
						<td class="FieldLabel" nowrap="nowrap"  style="width: 10%">政治面貌:</td>
						<td class="FieldInput" style="width: 20%"><label name="politicalCode" field="politicalCode" dataset="DmZzmmDataSet"/><font color="red">*</font></td>
						<td class="FieldLabel" nowrap="nowrap"  style="width: 10%">民族:</td>
						<td class="FieldInput" style="width: 20%"><label name="nation" field="nation" dataset="DmMzDataSet"></label></td>
						<td class="FieldLabel" nowrap="nowrap"  style="width: 10%">婚姻状况:</td>
						<td class="FieldInput" style="width: 20%"><label name="marriageCode" field="marriageCode" dataset="DmHyzkDataSet"></label></td>
					</tr>
					<tr>
						<td class="FieldLabel" nowrap="nowrap"  style="width: 10%">手机:</td>
						<td class="FieldInput" style="width: 20%"><label name="telMobile" field="telMobile" /></td>
						<td class="FieldLabel" nowrap="nowrap"  style="width: 10%">其他联系方式：</td>
						<td class="FieldInput" style="width: 20%"><label name="telOther" field="telOther" /></td>
						<td class="FieldLabel" nowrap="nowrap"  style="width: 10%">医疗状况:</td>
						<td class="FieldInput" style="width: 20%"> <label name="safeguardType" field="safeguardType" dataset="DmYlzkDataSet"></label></td>
					</tr>
					<tr>
						<td class="FieldLabel" nowrap="nowrap"  style="width: 10%">职业状况:</td>
						<td class="FieldInput" style="width: 20%"><label name="employmentCode" field="employmentCode" dataset="DmZyDataSet"></label></td>
						<td class="FieldLabel" nowrap="nowrap"  style="width: 10%">工作单位_名称:</td>
						<td class="FieldInput" style="width: 20%"><label name="employmentCode" field="employmentCode" /></td>
						<td class="FieldLabel" nowrap="nowrap"  style="width: 10%">工作单位_电话:</td>
						<td class="FieldInput" style="width: 20%"><label name="workUnitTel" field="workUnitTel" /></td>
					</tr>
					<tr>
						<td class="FieldLabel" nowrap="nowrap"  style="width: 10%">工作单位_地址:</td>
						<td class="FieldInput" style="width: 20%"><label name="workUnitAdd" field="workUnitAdd" /></td>
						<td class="FieldLabel" nowrap="nowrap"  style="width: 10%">抚恤对象类型:</td>
						<td class="FieldInput" style="width: 20%"><label name="bptType" field="bptType" dataset="DmFxdxlxDataSet"></label></td>
						<td class="FieldLabel" nowrap="nowrap"  style="width: 10%">抚恤定补金:</td>
						<td class="FieldInput" style="width: 20%"><label name="bptNum"  onchange=" CheckTxt('bptNum','抚恤定补金');" field="bptNum" /></td>
					</tr>
					<tr>
						<td class="FieldLabel" nowrap="nowrap"  style="width: 10%">年收入:</td>
						<td class="FieldInput" style="width: 20%"><label name="incomeYear" field="incomeYear" onchange=" CheckTxt('incomeYear','年收入');" /><font color="red">*</font></td>
						<td class="FieldLabel" nowrap="nowrap"  style="width: 10%">残疾证号:</td>
						<td class="FieldInput" style="width: 20%"><label name="handicapNum" field="handicapNum"></label></td>
				    ...
				    <input type="hidden" id="photocImg" src="">
		...
		<next:GridPanel id="YgjzCyxxCjxxEditGridPanel" name="YgjzCyxxCjxxEditGridPanel" stripeRows="true" collapsible="true" animCollapse="true" autoScroll="true" height="200" width="750" dataset="YgjzCyxxCjxxDataSet" title="阳光救助-残疾信息">
			<next:Columns>
				<next:RowNumberColumn width="30" />
		...
		<next:GridPanel id="YgjzCyxxJyxxEditGridPanel" name="YgjzCyxxJyxxEditGridPanel" width="750" stripeRows="true" collapsible="true" animCollapse="true" autoScroll="true" height="200" dataset="YgjzCyxxJyxxDataSet" title="阳光救助_成员信息_教育信息">
			<next:Columns>
				<next:RowNumberColumn width="30" />
		...
		<next:GridPanel id="YgjzCyxxHbxxEditGridPanel" name="YgjzCyxxHbxxEditGridPanel" width="750"stripeRows="true" height="200" collapsible="true" animCollapse="true" autoScroll="true" dataset="YgjzCyxxHbxxDataSet" title="阳光救助_成员信息_患病信息">
			<next:Columns>
				<next:RowNumberColumn width="30" />
				<next:Column id="peopleId" header="成员ID" field="peopleId" width="80" hidden="true">
					<next:TextField allowBlank="false" />
		...
		<next:GridPanel id="YgjzCyxxSgxxEditGridPanel" name="YgjzCyxxSgxxEditGridPanel" width="750" stripeRows="true" height="200" collapsible="true" animCollapse="true" autoScroll="true" dataset="YgjzCyxxSgxxDataSet" title="阳光救助_成员信息_事故信息">
			<next:Columns>
				<next:RowNumberColumn width="30" />
				<next:Column id="peopleId" header="成员ID" field="peopleId" width="80" hidden="true">
					<next:TextField allowBlank="false" />
