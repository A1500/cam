...
<model:datasets>
   ...
   <model:dataset id="DmHzgxDataSet" cmd="com.inspur.cams.comm.dicm.DicQueryCmd" global="true" autoLoad="true">
	...
	<!-- 教育状况年级 -->
	<model:dataset id="DmJyzknjDataSet"
		cmd="com.inspur.cams.comm.dicm.DicQueryCmd" global="true"
		autoLoad="true">
		<model:record fromBean="com.inspur.cams.comm.dicm.DicBean"></model:record>
		<model:params>
...
<next:Panel width="98%">
	<next:TopBar>
		...
		<next:ToolBarItem iconCls="undo" text="返回" handler="undoNum2" />
	</next:TopBar>
	<next:TabPanel id="tabPanels" autoHeight="true" autoWidth="true"
		activeTab="0">
		<next:Tabs>
					...
					<next:Panel title="基本信息" autoHeight="true" collapsible="true">
						<next:Html>
							<form id="YgjzJtxxForm" method="post" dataset="YgjzJtxxDataSet"
								onsubmit="return false" style="padding-right: 5px"
								class="L5form">
			...
			<next:Html>
				<form id="accountForm" method="post"  onsubmit="return false" class="L5form">
				   ...
				   <table id="isFive" width="100%"  style="display:none">
					...
					<next:Panel title="审核信息" height="270" collapsible="true">
						<next:Html>
							<form id="shenhe" method="post" dataset="YgjzJtxxDataSet"
								class="L5form">
							<table style="width: 100%" frame="void" border="0">
								<tr>
									<td class="FieldLabel" width="15%">审核意见：</td>
									<td class="FieldInput" width="85%"><textarea name="checkNote"
										rows="10" wrap=PHYSICAL style="width:90%"
										onpropertychange="if(value.length>100) value=value.substr(0,100)"
										onKeyDown="gbcount(this.form.checkNote,this.form.total,this.form.used,this.form.remain);"
										onKeyUp="gbcount(this.form.checkNote,this.form.total,this.form.used,this.form.remain);"
										field="checkNote"></textarea> <br />
									<span onmousemove="this.setCapture();"
										onmouseout="this.releaseCapture();"> 最多字数： <input
										style="width: 30" readonly="true" maxLength="4" name="total"
										size="3" value="100"> 已填字数： <input style="width: 30"
										readonly="true" maxLength="4" name="used" size="3" value="0">
									剩余字数： <input style="width: 30" readonly="true" maxLength="4"
										name="remain" size="3" value="100"> </span></td>
								</tr>
								<tr>
									<td class="FieldLabel" width="15%">审核状态：</td>
									<td class="FieldInput"><select field="checkFlag">
										<option dataset="DmShztDataSet"></option>
									</select></td>
								</tr>
								<tr>
									<td colspan="2" style="text-align: center">
									<button onclick="examSave()">提 交</button>
									<button onclick="shReturnClick()" style="margin-left: 15px;">返
									回</button>
									</td>
								</tr>
							</table>
					...
					<next:EditGridPanel id="YgjzJzzsEditGridPanel"
						name="YgjzJzzsEditGridPanel" hidden="true" width="100%"
			...
			<next:Panel title="家庭成员基本信息" name="anchor-div" height="540"
				autoWidth="true">
				<next:AnchorLayout>
					<next:GridPanel id="YgjzJtxxCyxxEditGridPanel"
						name="YgjzJtxxCyxxEditGridPanel" width="98%" stripeRows="true"
						height="540" dataset="YgjzJtxxCyxxDataSet" title="阳光救助_家庭信息_成员信息">
						<next:TopBar>
							<next:ToolBarItem symbol="->"></next:ToolBarItem>
						...
						<next:Columns>
							...
							<next:Column id="sex" header="性别" field="sex" width="60"
								align="center" dataset="DmXbDataSet">
								<next:TextField />
							</next:Column>
							<next:Column id="regPeople" header="录入人" field="regPeople" width="80"
								align="center">
								<next:TextField />
							</next:Column>
							<next:Column id="regTime" header="录入时间" field="regTime" width="110"
								align="center">
								<next:TextField />
							</next:Column>
...
<next:Window id="hello-win" title="家庭成员信息明细" width="780" height="480"
			...
			<next:Html>
				...
				<table border="0" width="750">
					...
					<tr>
						...
						<td class="FieldInput" nowrap rowspan="4"><img
					...
					<tr>
						...
						<td class="FieldInput" width="20%"><label id="jtcycsrq"
					...
					<tr>
						...
						<td class="FieldInput" width="10%"><label name="workUnitTel"
