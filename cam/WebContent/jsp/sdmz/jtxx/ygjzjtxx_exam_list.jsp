	...
	<next:Html>
		...
		<table border="1" style="width: 100%; table-layout: fixed;">
			<tr>
				...
				<td class="FieldInput" width="16%"><input type="text"
					id="hzxmquery" name="hzxmquery" maxlength="25" class="TextEditor"
					title="户主姓名" style="width: 80%"/></td>
				<td class="FieldLabel" width="10%">户主身份证:</td>
				<td class="FieldInput" width="19%"><input type="text"
				...
				<td class="FieldInput" width="17%"><input type="text"
				   id="lrdwmcquery" name="lrdwmc" id="lrdwmc" style="width: 65%" /> <input
					type="text" style="display: none;" readonly="readonly"
					name="lrdwId" id="lrdwIdquery" field="lrdwId" /> <img
					src="<%=SkinUtils.getImage(request,"l5/help.gif")%>"
					style="cursor: hand" onclick="func_ForDomicileSelect()" /></td>
			</tr>
			<tr>
				<td class="FieldLabel" nowrap>救助类型:</td>
				<td class="FieldInput"><input type="text" id="jzlxDisplay"
