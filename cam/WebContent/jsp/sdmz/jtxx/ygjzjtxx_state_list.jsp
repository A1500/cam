	...
	<next:Html>
		...
		<table border="1" style="width:100%;table-layout:fixed;">
			<tr>
			    ...
			    <td class="FieldLabel" width="10%" nowrap="nowrap">所属单位:</td>
				<td class="FieldInput" width="20%" nowrap="nowrap"><input type="text" style="width:60%"  id="lrdwmcquery" readonly name="lrdwmc" id="lrdwmc" />
