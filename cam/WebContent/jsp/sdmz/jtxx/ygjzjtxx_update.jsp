			...
			<next:Html>
				...
				<table border="0" width="750">
					<tr>
						...
						<td class="FieldInput" style="width: 20%"><input type="text"
							onchange="if(checkIDCard('idCard','户主身份证')){checkCyxxIfReapeat()};"
					...
					<tr>
						...
						<td class="FieldInput" style="width: 20%"><input type="text"
							...
							field="birthday" onclick="LoushangDate(this);getBirthdayByIdCard();" style="width: 90%"/><font color="red">*</font></td>
