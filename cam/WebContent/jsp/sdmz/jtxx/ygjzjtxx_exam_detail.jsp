...
<model:datasets>
	...
	<!-- 审核状态 -->
	<model:dataset id="DmShztDataSet" cmd="com.inspur.cams.comm.dicm.DicQueryCmd" global="true" autoLoad="true">
		<model:record fromBean="com.inspur.cams.comm.dicm.DicBean"></model:record>
		<model:params>
...
<next:Panel width="98%" height="100%" autoHeight="true">
	<next:TopBar>
		<next:ToolBarItem symbol="->" />
		<next:ToolBarItem iconCls="undo" text="返回" handler="undoNum4" />
	</next:TopBar>
	<next:TabPanel id="tabPanels" height="580" width="100%" activeTab="4">
		<next:Tabs>
			<next:Panel title="困难家庭信息" name="阳光基本信息" height="100%">
				<next:AnchorLayout>
					<next:Panel title="基本信息" autoHeight="true" collapsible="true">
						<next:Html>
							...
							<table border="0" style="width: 100%;height:100%; word-wrap: break-word; overflow: hidden;" >
								<tr>
									<td class="FieldLabel" style="width: 12%">户主姓名：</td>
									<td class="FieldInput" style="width: 20%"><label name="familyName" maxlength="25" field="familyName" onchange="checkCN('familyName','familyCardNo','户主姓名');" /><font color="red">*</font></td>
									<td class="FieldLabel" style="width: 15%">身份证号：</td>
									<td class="FieldInput" style="width: 20%"><label id="familyCardNo" name="familyCardNo" maxlength="18" onchange="checkIDCard('familyCardNo','户主身份证');" style="width: 100" field="familyCardNo" /><font color="red">*</font></td>
								...
								<tr>
									...
									<td class="FieldInput" style="width: 20%"><label id="familyPhone"
										name="familyPhone" maxlength="20" onchange="checkDhhm();"
										field="familyPhone" /></td>
									<td class="FieldLabel" style="width: 10%">手机：</td>
									<td class="FieldInput" style="width: 20%"><label id="familyMobile"
										name="familyMobile" maxlength="20" onchange="checkSjhm();"
										 field="familyMobile" /></td>
									<td class="FieldLabel" style="width: 10%">其他联系方式：</td>
									<td class="FieldInput" style="width: 20%"><label name="familyOtherPhone"
										maxlength="25" field="familyOtherPhone" /></td>
								</tr>
								<tr>
									<td class="FieldLabel" style="width: 10%">家庭年总收入:（单位：元）</td>
									<td class="FieldInput" style="width: 20%"><label
										name="yearIncome" maxlength="9" field="yearIncome"
										onchange=" CheckTxt('yearIncome','家庭年总收入');" /><font color="red">*</font></td>
									<td class="FieldLabel" style="width: 10%">家庭年人均收入：（单位：元）</td>
									<td class="FieldInput"><label name="yearAverageIncome"
										maxlength="9"  field="yearAverageIncome"
										readonly="true" /></td>
									<td class="FieldLabel" style="width: 15%">人口数量：</td>
									<td class="FieldInput" style="width: 20%"><label name="peopleNum" maxlength="2" field="peopleNum" readonly="true" /></td>
								</tr>
								<tr>
									<td class="FieldLabel">住房类型：</td>
									<td class="FieldInput"><label id="houseQuality"
										name="住房类型" field="houseQuality" style="width:75%"  dataset="DmZfzklxDataSet"></td>
									<td class="FieldLabel" id="fwzk">房屋状况：</td>
									<td class="FieldInput"><label name="houseStatus" id="houseStatus"
										field="houseStatus" style="width:75%" dataset="DmFwjgDataSet"></td>
									<td class="FieldLabel">住房结构:</td>
									<td class="FieldInput"><label name="buildingStructure" id="buildingStructure"
										field="buildingStructure" style="width:75%" dataset="DmzfjgDataSet"></td>
								</tr>
								<tr>
									<td class="FieldLabel" style="width: 10%">建筑面积 :（单位：平方米）</td>
									<td class="FieldInput" style="width: 20%"><label
										name="buildArea" maxlength="6" field="buildArea"
										onchange=" CheckTxt('buildArea','建筑面积');" /></td>
									<td class="FieldLabel" style="width: 10%">人均建筑面积: （单位：平方米）</td>
									<td class="FieldInput"><label name="buildAverageArea" maxlength="6"
										 field="buildAverageArea" /></td>
								...
								<tr>
									...
									<td class="FieldInput" colspan="3"><textarea name="note"
										field="note" style="width:90%" rows="3" disabled="disabled"></textarea></td>
								...
								<tr>
									...
									<td class="FieldInput" colspan="5"><textarea name="checkNote"
										cols="80" rows="3" field="checkNote" disabled="disabled"></textarea></td>
								</tr>
								<tr>
									<td class="FieldLabel">审核状态：</td>
									<td class="FieldInput" colspan="5"><select field="checkFlag"
										disabled="disabled">
										<option dataset="DmShztDataSet"></option>
									</select></td>
								</tr>
			...
			<next:Panel title="家庭成员基本信息" name="anchor-div" autoHeight="true">
				<next:AnchorLayout>
					<next:GridPanel id="YgjzJtxxCyxxEditGridPanel"
						...
						height="100%" dataset="YgjzJtxxCyxxDataSet" title="阳光救助_家庭信息_成员信息">
						<next:TopBar>
						...
						<next:Columns>
							...
							<next:Column id="peopleId" hidden="true" header="成员ID" field="peopleId">
							...
							<next:Column header="与户主关系" field="relationshipType" width="14%"
								dataset="DmHzgxDataSet" align="center" />
							<next:Column id="name" header="姓名" field="name" width="10%"
								align="center">
								<next:TextField />
							</next:Column>
							<next:Column id="idCard" header="身份证号" field="idCard" width="22%"
								align="center">
								<next:TextField />
							</next:Column>
							...
							<next:Column id="regPeople" header="录入人" field="regPeople" width="16%"
								align="center">
								<next:TextField />
							</next:Column>
							<next:Column id="regTime" header="录入时间" field="regTime" width="20%"
								align="center">
								<next:TextField />
							</next:Column>
						...
						<next:BottomBar>
							<next:PagingToolBar dataset="YgjzJtxxCyxxDataSet" />
						</next:BottomBar>
					</next:GridPanel>
				</next:AnchorLayout>
			</next:Panel>

			<next:Panel title="救助指数" name="anchor-div" height="100%">
				<next:AnchorLayout>
					<next:GridPanel id="YgjzJzzsGridPanel" name="YgjzJzzsGridPanel"
						width="98%" stripeRows="true" height="100%"
						dataset="YgjzJzzsDataSet" title="救助指数">
						<next:Columns>
							<next:RowNumberColumn width="30" />
							<next:Column id="compositeIndex" header="综合救助指数" field="compositeIndex"
								width="80">
								<next:NumberField allowBlank="false" />
							</next:Column>
							<next:Column id="medicalIndex" header="医疗救助指数" field="medicalIndex"
								width="80">
								<next:NumberField allowBlank="false" />
							</next:Column>
							<next:Column id="housingIndex" header="住房救助指数" field="housingIndex"
								width="80">
								<next:NumberField allowBlank="false" />
							</next:Column>
							<next:Column id="accidentIndex" header="事故救助指数" field="accidentIndex"
								width="80">
								<next:NumberField allowBlank="false" />
							</next:Column>
							...
							<next:Column id="unemployedIndex" header="失业救助指数" field="unemployedIndex"
								width="80">
								<next:NumberField allowBlank="false" />
							</next:Column>
			...
			<next:Panel  width="100%" autoHeight="true" title="救助类型">
			<next:Html>
				<form id="accountForm" method="post"  onsubmit="return false" class="L5form">
				   ...
				   <table width="100%"   id="isDetail" style="display:none">
					...
					<tr>
						...
						<td class="FieldInput" width="16%"><label id="cardNo" name="cardNo"  /></td>
						<td class="FieldLabel" width="16%"><label>发证机关名称：</label></td>
						<td class="FieldInput" width="16%"><label id="signOrgName" name="signOrgName"  /></td>
						<td class="FieldLabel" width="18%"><label>发证日期：</label></td>
						<td class="FieldInput" width="18%"><label id="signDate" name="signDate"  /></td>
					</tr>
					<tr>
						<td class="FieldLabel" ><label>有效日期起：</label></td>
						<td class="FieldInput" ><label id="cardValidateBegin" name="cardValidateBegin"  /></td>
						<td class="FieldLabel" ><label>有效日期止：</label></td>
						<td class="FieldInput" ><label id="cardValidateEnd" name="cardValidateEnd"  /></td>
						<td class="FieldLabel" ><label>保障起始年月：</label></td>
						<td class="FieldInput" ><label id="assistanceBegin" name="assistanceBegin"  /></td>
					</tr>
					<tr>
						...
						<td class="FieldInput" ><label id="accountName" name="accountName"  /></td>
						<td class="FieldLabel" ><label>银行账号：</label></td>
						<td class="FieldInput" ><label id="accountCode" name="accountCode" /></td>
					</tr>
				   ...
				   <tr><td class="FieldInput" colspan="6">城市低保</td></tr>
					<tr >
						...
						<td class="FieldInput" width="16%"><label id="assistanceMon" name="assistanceMon"  /></td>
						<td class="FieldLabel" width="16%"><label>其中分类施保金额（元）：</label></td>
						<td class="FieldInput" colspan='3'><label id="assistanceClassMon" name="assistanceClassMon"  /></td>
					</tr>
				   ...
				   <table id="isCountry" width="100%"  style="display:none">
					...
					<tr>
						<td class="FieldLabel" width="16%"><label>户月救助金额（元）：</label></td>
						<td class="FieldInput" width="16%"><label id="nassistanceMon" name="nassistanceMon" /></td>
						<td class="FieldLabel" width="16%"><label>其中分类施保金额（元）：</label></td>
						<td class="FieldInput" colspan='3'><label id="nassistanceClassMon" name="nassistanceClassMon" /></td>
					</tr>
				   ...
				   <table id="isFive" width="100%"  style="display:none">
					...
					<tr>
						...
						<td class="FieldLabel" width="16%"><label>户月救助金额（元）：</label></td>
						<td class="FieldInput" colspan='3'><label id="cassistanceMon" name="cassistanceMon"  ></label></td>
					</tr>
			...
			<next:Panel title="受灾类型" name="anchor-div3" height="100%">
				<next:AnchorLayout>
					<next:GridPanel height="100%" id="YgjzJtxxZrzhEditGridPanel"
...
<next:Window id="hello-win" title="家庭成员信息录入" width="780" height="450"
	closeAction="hide" modal="true" resizable="true" autoScroll="true">
	<next:AnchorLayout>
		<next:Panel title="基本信息" collapsible="true" animCollapse="true"
			autoScroll="true" width="750" height="300">
			<next:Html>
				<form id="YgjzJtxxCyxxForm" name="YgjzJtxxCyxxForm" method="post"
					width="98%" dataset="YgjzJtxxCyxxDataSet2" onsubmit="return false"
					class="L5form">
				<table border="0" width="750" >
					<tr>
						...
						<td class="FieldInput" width="20%"><label
							...
							id="idCard" name="idCard" field="idCard" /><font
							color="red">*</font></td>
						<td class="FieldLabel" width="10%" rowspan="4">照片:</td>
						<td nowrap colspan="1" rowspan="4"><img
							name="RELATIONER_PHOTOC_IMG" width=90 id="photocImg" src=""
					...
					<tr>
						...
						<td class="FieldInput" width="20%"><label id="birthday"
							name="birthday" field="birthday" /><font color="red">*</font></td>
					...
					<tr>
						...
						<td class="FieldInput" width="20%"><label name="politicalCode"
							field="politicalCode" dataset="DmZzmmDataSet"></label></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="FieldInput" width="20%"><label name="workUnitName" field="workUnitName" /></td>
					...
					<tr>
						...
						<td class="FieldInput" width="20%"><label name="bptType" field="bptType" dataset="DmFxdxlxDataSet"></label></td>
						<td class="FieldLabel" nowrap="nowrap" width="10%">抚恤定补金:</td>
						<td class="FieldInput" width="20%"><label name="bptNum" onchange=" CheckTxt('bptNum','抚恤定补金');" field="bptNum" /></td>
		...
		<next:GridPanel id="YgjzCyxxCjxxEditGridPanel" name="YgjzCyxxCjxxEditGridPanel" stripeRows="true" collapsible="true"
			animCollapse="true" autoScroll="true" height="200" width="750" 
			dataset="YgjzCyxxCjxxDataSet" title="阳光救助_成员信息_残疾信息">
			<next:Columns>
				<next:RowNumberColumn width="30" />
				<next:Column id="peopleId" header="成员ID" field="peopleId" width="80"
					hidden="true">
					<next:TextField allowBlank="false" />
				</next:Column>
