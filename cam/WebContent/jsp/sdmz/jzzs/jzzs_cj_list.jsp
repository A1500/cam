	...
	<next:Html>
		...
		<table border="1" width="100%">
			...
			<tr>	
			    ...
			    <td class="FieldLabel"  width="10%" nowrap>残疾种类:</td>
			    <td class="FieldInput"  width="15%"> <select id="cjlx" > <option dataset="DmCjlxDataSet"></option></select>
		        </td>	
			    <td class="FieldLabel"  width="10%" nowrap>残疾等级:</td>
				<td class="FieldInput"  width="15%"><select id="cjdj" ><option dataset="DmCjdjDataSet"></option></select></td>	
				<td class="FieldInput" align="center"> 
		        ...
		        <input  type="hidden" id="buildingStructure"  name="buildingStructure"/>
 	            <input type="hidden"  name="jzfx" id="jzfx" value="CJ"/>
		  </table>
		</form>
		</div>
		</fieldset>
...
<next:GridPanel id="editGridPanel" name="ygjzjtxxGrid" width="100%" notSelectFirstRow="true" stripeRows="true" height="330" dataset="ds" title="困难户家庭残疾救助指数">
	<next:TopBar>
		<next:ToolBarItem text="导出Excel" iconCls="export" handler="JzzsCjExcel" ></next:ToolBarItem>
	</next:TopBar>
	<next:Columns>
	    ...
	    <next:Column id="CJXX"  header="残疾类型" align="left" width="120" field="CJXX" renderer="cjxxRef"/>
		<next:Column id="JZZS_CJ" header="救助指数" field="JZZS_CJ" width="100" align="right"/>
