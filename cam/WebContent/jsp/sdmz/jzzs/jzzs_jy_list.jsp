	...
	<next:Html>
		...
		<table border="1" width="100%">
			...
			<tr>	
			   ...
			   <td class="FieldLabel" nowrap width="10%">教育阶段:</td>
			   <td class="FieldInput" width="15%"> <select id="jyzk">
								<option dataset="DmJyzkDataSet"></option>
							</select>
	            </td>
			...
			<input type="hidden"  name="jzfx" id="jzfx" value="JY"/>
		  </table>
		</form>
		</div>
		</fieldset>
...
<next:GridPanel id="editGridPanel" name="ygjzjtxxGrid" width="100%" notSelectFirstRow="true" stripeRows="true" height="330" dataset="ds" title="困难户家庭教育救助指数">
	<next:TopBar>
		<next:ToolBarItem text="导出Excel" iconCls="export" handler="JzzsJyExcel" ></next:ToolBarItem>
	</next:TopBar>
	<next:Columns>
	    ...
	    <next:Column id="JZLX"  header="受助类型" align="left" width="220" field="JZLX" renderer="szlxRef"/>
	    <next:Column id="JYXX"  header="教育阶段" align="left" width="120" field="JYXX" renderer="jyjdRef"/>
		<next:Column id="JZZS_JY" header="救助指数" field="JZZS_JY" width="100" align="right"/>
