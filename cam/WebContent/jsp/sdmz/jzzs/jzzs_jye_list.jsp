...
<model:datasets>
	...
	<model:dataset id="ds" cmd="com.inspur.sdmz.jzzs.cmd.JzzsQueryCommand" autoLoad="false">
			...
			<!-- 失业率  -->
	<model:dataset id="DmSylvDataSet" cmd="com.inspur.cams.comm.dicm.DicQueryCmd" global="true" autoLoad="true">
		<model:record fromBean="com.inspur.cams.comm.dicm.DicBean"></model:record>
		<model:params>
			<model:param name="dic" value='DIC_UNEMPLOYMENT_RATE'></model:param>
		</model:params>
	</model:dataset>
</model:datasets>
		...
		<table border="1" width="100%">
			...
			<tr>
			    ...
			    <td class="FieldInput" ><input type="text" id="jzlxDisplay" style="width:70%" readOnly="true" ondblclick="displayDbClick('jzlxDisplay','jzlxquery')" />
			   	...
			   	<td class="FieldLabel" nowrap width="10%">失业率:</td>
			   	<td class="FieldInput" width="15%">
							<select id="sylv">
								<option dataset="DmSylvDataSet"></option>
							</select>
	            </td>
			    ...
			    <input type="hidden"  name="jzfx" id="jzfx" value="SY"/>
		  </table>
		</form>
		</div>
		</fieldset>
...
<next:GridPanel id="editGridPanel" name="ygjzjtxxGrid" width="100%" notSelectFirstRow="true" stripeRows="true" height="330" dataset="ds" title="困难户家庭就业救助指数">
	<next:TopBar>
		<next:ToolBarItem text="导出Excel" iconCls="export" handler="JzzsJyeExcel" ></next:ToolBarItem>
	</next:TopBar>
	<next:Columns>
	    ...
	    <next:Column id="JYZH"  header="失业率" align="left" width="120" field="JYZH"/>
		<next:Column id="JZZS_SY" header="救助指数" field="JZZS_SY" width="100" align="right"/>
