	...
	<next:Html>
		...
		<tr>	
		   ...
		   <tr>
	        ...
	        <input type="hidden"  name="jzfx" id="jzfx" value="DQ"/>
		  </table>
		</form>
		</div>
		</fieldset>
...
<next:GridPanel id="editGridPanel" name="ygjzjtxxGrid" width="100%" notSelectFirstRow="true" stripeRows="true" height="330" dataset="ds" title="困难户家庭单亲救助指数">
	<next:TopBar>
		<next:ToolBarItem text="导出Excel" iconCls="export" handler="JzzsDqExcel" ></next:ToolBarItem>
	</next:TopBar>
	<next:Columns>
		...
		<next:Column id="JZZS_DQ" header="救助指数" field="JZZS_DQ" width="100" align="right"/>
