...
<model:datasets>
	...
	<model:dataset id="ds" cmd="com.inspur.sdmz.jzzs.cmd.JzzsQueryCommand" autoLoad="false">
	</model:dataset>
</model:datasets>
	...
	<next:Html>
		...
		<table border="1" width="100%">
			<tr>
				...
				<option  dataset="DmXzqhDataSetQu"></option> </select>
				</td>	
				<td class="FieldLabel" nowrap="nowrap" width="10%">街镇:</td>
				<td class="FieldInput" width="15%"> <select id="dzZhenquery" onchange="getDzCun()">
								<option dataset="DmXzqhDataSetStreet"></option> </select>
			    </td>	
			    <td class="FieldLabel" nowrap="nowrap" width="10%">村居:</td>
				<td class="FieldInput" width="15%"><select id="dzCunquery">
								<option dataset="DmXzqhDataSetVillage"></option></select>
			    </td>
			...
			<tr>	
			    ...
			    <td class="FieldInput" ><input type="text" id="jzlxDisplay" style="width:65%" readOnly="true" ondblclick="displayDbClick('jzlxDisplay','jzlxquery')" />
				 ...
				 <td class="FieldLabel"  width="10%" nowrap>事故种类:</td>
				 <td class="FieldInput"  width="15%"> <select id="sgzlquery">
								<option dataset="DmSgzlDataSet"></option></select>
	             </td>
				 <td class="FieldLabel" nowrap  width="10%">事故损失:</td>
				 <td class="FieldInput"  width="15%"> <select id="sgssquery">
								<option dataset="DmSgssDataSet"></option> </select>
	             </td>
				<td class="FieldInput" align="center"> 
		    ...
		    <input type="hidden"  name="jzfx" id="jzfx" value="SG"/>
		  </table>
		</form>
		</div>
		</fieldset>
...
<next:GridPanel id="editGridPanel" name="ygjzjtxxGrid" width="100%" notSelectFirstRow="true" stripeRows="true" height="330" dataset="ds" title="困难户家庭事故救助指数">
	<next:TopBar>
		<next:ToolBarItem text="导出Excel" iconCls="export" handler="JzzsSgExcel" ></next:ToolBarItem>
	</next:TopBar>
	<next:Columns>
	    ...
	    <next:Column id="SGXX"  header="事故种类" align="left" width="120" field="SGXX" renderer="sgzlRef"/>
		<next:Column id="JZZS_SG" header="救助指数" field="JZZS_SG" width="100" align="right"/>
