	...
	<next:Html>
		...
		<table border="1" width="100%">
			<tr>
			   ...
			   <td class="FieldInput" width="15%"> <select id="dzCunquery"> <option dataset="DmXzqhDataSetVillage"></option></select>
			   </td>
			...
			<tr>	
			   ...
			   <td class="FieldLabel" width="10%" nowrap>灾害种类:</td>
			   <td class="FieldInput" width="15%"> <select id="zhzl"  > <option dataset="DmZhzlDataSet"></option> </select>
			   </td>	
			   <td class="FieldLabel" width="10%"nowrap>灾害损失:</td>
			   <td class="FieldInput" width="15%"> <select id="zhssje" > <option dataset="DmZhssjeDataSet"></option> </select>
			   </td>
			    <td class="FieldInput" align="center"> 
			...
			<input type="hidden"  name="jzfx" id="jzfx" value="ZH"/>
		  </table>
		</form>
		</div>
		</fieldset>
...
<next:GridPanel id="editGridPanel" name="ygjzjtxxGrid" width="100%" notSelectFirstRow="true" stripeRows="true" height="330" dataset="ds" title="困难户家庭自然灾害救助指数">
	<next:TopBar>
		<next:ToolBarItem text="导出Excel" iconCls="export" handler="JzzsZrzhExcel" ></next:ToolBarItem>
		</next:TopBar>
	<next:Columns>
	    ...
	    <next:Column id="ZRZH"  header="灾害种类" align="left" width="80" field="ZRZH" renderer="zrzhRef"/>
		<next:Column id="JZZS_ZRZH" header="救助指数" field="JZZS_ZRZH" width="100" align="right"/>
