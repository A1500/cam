...
<model:datasets>
	...
	<model:dataset id="ds" cmd="com.inspur.sdmz.jzzs.cmd.JzzsQueryCommand" global="true" autoLoad="false">
	</model:dataset>
</model:datasets>
		...
		<table border="1" width="100%">
			<tr>
						...
						<td class="FieldInput" width="15%">
						 ...
						 <td class="FieldLabel" nowrap width="10%">医疗支出:</td>
			             <td class="FieldInput" width="15%"> <select id="ylzc"> <option dataset="DmYlzcDataSet"></option></select></td>	
			 ...
			 <tr>	
			    ...
			    <td class="FieldInput"><input type="text" id="jzlxDisplay" style="width:65%" readOnly="true" ondblclick="displayDbClick('jzlxDisplay','jzlxquery')" />
			 	...
			 	<td class="FieldLabel" width="10%" nowrap>患病种类:</td>
			    <td class="FieldInput" width="15%"> <select id="hbzl"> <option dataset="DmHbzlDataSet"></option> </select> </td>	
				...
				<input  type="hidden"  id="ylnl" name="ylnl"/>
				...
				<input type="hidden"  name="jzfx" id="jzfx" value="YL"/>
		  </table>
		</form>
		</div>
		</fieldset>
...
<next:GridPanel id="editGridPanel" name="ygjzjtxxGrid" width="100%" stripeRows="true" notSelectFirstRow="true" height="330" dataset="ds" title="困难户家庭医疗救助指数">
	<next:TopBar>
		<next:ToolBarItem text="导出Excel" iconCls="export" handler="JzzsYlExcel" ></next:ToolBarItem>
	</next:TopBar>
	<next:Columns>
		...
		<next:Column id="RK_SL" header="人口数量" field="RK_SL" width="40" align="center"/>
	    ...
	    <next:Column width="120" header="患病类型" align="center" field="HBXX" id="HBXX" renderer="hblxRef"/>
		<next:Column id="JZZS_YL" header="救助指数" field="JZZS_YL" width="100" align="right"/>
		<next:Column id="JZQK"  header="一年内受助情况(元/次)" field="JZQK" width="130" align="center"/>
		</next:Columns>
	<next:BottomBar>
