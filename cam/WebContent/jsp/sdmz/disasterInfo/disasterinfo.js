...
function query(){		
	...
	ds.setParameter("DISASTER_INFO.DISASTER_ADD@=",getParam("disasterAdd"));		
	ds.setParameter("DISASTER_INFO.REG_PEOPLE@=",getParam("regPeople"));		
	ds.setParameter("DISASTER_INFO.REG_TIME@=",getParam("regTime"));		
	ds.load();
}
