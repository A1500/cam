...
<body>
<model:datasets>
	<model:dataset id="ds" cmd="com.inspur.sdmz.comm.analysis.spendOfActivityAnalysis.cmd.SpendOfActivityCommand" global="true" autoLoad="true" pageSize="100">
	</model:dataset>
	<model:dataset id="jzfaDs" cmd="com.inspur.sdmz.dicm.cmd.DmQueryCommand" global="true" autoLoad="true">
		<model:record fromBean="com.inspur.sdmz.dicm.data.DmBean"></model:record>
		<model:params>
			<model:param name="tableName" value='SAM_PLAN'></model:param>
			<model:param name="valueField" value='PLAN_ID'></model:param>
			<model:param name="textField" value='PLAN_NAME'></model:param>
		</model:params>
	</model:dataset>
</model:datasets>
		...
		<div>
			<form style="width: 95%; height: 100%;" class="L5form">
				<table  border="1" width="100%" height="100">
					...
					<tr>
						<td class="FieldLabel" nowrap>救助活动包括:</td>
						<td colspan="3" class="FieldInput">
							<input type="text" id="jzfaIdDisplay" readOnly="true" style="width:65%" ondblclick="displayDbClick('jzfaIdDisplay','jzfaIdQuery')" />
							<img src="<%=SkinUtils.getImage(request, "help.gif")%>" style="cursor:hand" onclick="mutiHelp('jzfaDs','jzfaIdDisplay','jzfaIdQuery')"/>
							<input type="hidden" id="jzfaIdQuery"><button onclick="query()">查 询</button>
