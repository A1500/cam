...
<body>
<model:datasets>
	<model:dataset id="ds" cmd="com.inspur.sdmz.comm.analysis.knhOfAreaAnalysis.cmd.KnhOfAreaAnalysisPieCommand" global="true" autoLoad="true" pageSize="100">
	</model:dataset>
...
<next:Panel  name="form" width="100%" border="0" bodyStyle="padding-bottom:10px;padding-top:12px;" height="150" >
	<next:Html>
