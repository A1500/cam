...
<html>
	<head>
		...
		<script type="text/javascript" src="knhBySexAnalysis_list.js"></script>
...
<body>
<model:datasets>
	<model:dataset id="ds" cmd="com.inspur.sdmz.comm.analysis.knhBySexAnalysis.cmd.KnhBySexAnalysisPieCommand" global="true" autoLoad="true" pageSize="100">
	</model:dataset>
			...
			<form style="width: 95%; height: 100%;" class="L5form">
				<table  border="1" width="100%" height="100">
					...
					<tr>
						...
						<td <%if(sign==1) {%>colspan="5"<%}else{%>colspan="3"<%}%> class="FieldInput">
