...
<body>
<model:datasets>
	<model:dataset id="ds" cmd="com.inspur.sdmz.comm.analysis.knhType.cmd.KnhTypePieCommand" global="true" autoLoad="true" pageSize="100">
	</model:dataset>
