function init() {
	//alert('organArea:'+organArea);370102003000
    //alert('organType:'+organType);
	if(sign==1){
...
function flushPie() {
	document.getElementById("svgDiv").innerHTML = "<embed id=\"svg\" src=\"knhTypePie.svg\" width=\"100%\" height=\"100%\" type=\"image/svg+xml\" pluginspage=\"SVGView.exe\"/>";
}
function query() {
