...
<body>
<model:datasets>
	<model:dataset id="ds" cmd="com.inspur.sdmz.comm.analysis.knhGrowthAnalysis.cmd.KnhGrowthAnalysisLineCommand" global="true" autoLoad="true" pageSize="100">
	</model:dataset>
...
<next:Panel  name="form" width="100%" border="0" bodyStyle="padding-bottom:10px;padding-top:12px;" height="200">
	...
	<fieldset style="overflow: visible;" class="GroupBox"><legend class="GroupBoxTitle">查询条件 <img class="GroupBoxExpandButton" src="<%=SkinUtils.getImage(request,"groupbox_collapse.gif")%>" onclick="collapse(this)" /> </legend>
		<div>
			<form style="width: 80%; height: 100%;" class="L5form">
				<table  border="1" width="100%" height="100">
					...
					<tr>
						...
						&nbsp;&nbsp;至:&nbsp;&nbsp;<input type="text" id="endDateQuery" format="Y-m-d" onclick="LoushangDate(this)"/></td>
					...
					<tr>
						<td class="FieldLabel" nowrap>统计间隔:</td>
						<td <%if(sign==1) {%>colspan="4"<%}else{%>colspan="3"<%}%> class="FieldInput">
							<input type="radio" name="date" value="YEAR" />按年统计&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="date" value="MONTH" />按月统计
						</td>
