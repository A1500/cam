...
function query() {
	...
	if(monthQuery=="s") {
	    ...
	    ds.setParameter("endDate", yearQuery+"-06-30");
	} else {
	    ds.setParameter("startDate", yearQuery+"-07-01");
...
function setReportTitle() {
	...
	reportTitleSpan.innerHTML = getChnNumber(year)+"年"+(month=="s"?"上":"下")+"半年各单位业务办理年统计报表";
}
