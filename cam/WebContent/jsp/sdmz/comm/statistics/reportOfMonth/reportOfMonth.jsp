...
<head>
<next:ScriptManager/>
<script type="text/javascript" src="reportOfMonth.js"></script>
<style>
<!--
body {
			...
			<form style="width: 95%; height: 100%;" class="L5form">
				<table  border="1" width="100%" >
					<tr>
						...
						<td class="FieldLabel" nowrap>救助月份</td>
						<td class="FieldInput">
...
<table dataset="ds">
	<tr height=25 align="center" nowrap>
		<td class="tdTitle" colspan="5"><strong><span id="reportTitle">各单位救助成果月统计报表</span></strong></td>
	</tr>
	<tr height=49>
		<td class="tdTitle" height=49 width=193 style='height:36.95pt;width:145pt'>
			<span>业务统计
			</span><br><span>救助单位</span>
		</td>
