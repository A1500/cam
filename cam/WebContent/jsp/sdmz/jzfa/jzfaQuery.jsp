...
<model:datasets>
	...
	<model:dataset id="sjtjDataset" cmd="com.inspur.sdmz.jzfa.cmd.PlanQueryCmd" method="sjtj" global="true" autoLoad="false" pageSize="10">
		<model:record fromBean="com.inspur.sdmz.jzfa.data.Plan"></model:record>
	</model:dataset>
...
<next:Panel autoScroll="true">
	<next:AnchorLayout>
		...
		<next:GridPanel id="jzfaGrid" name="grid" notSelectFirstRow="true" clickToSelectedForChkSM="true"
		...
		<%} %>
			...
			<next:Columns>
				...
				<next:Column header="救助方案名称" field="planName" width="150" align="center" sortable="true"/>
				...
				<next:Column header="开始日期" id="planBegin" field="planBegin" width="100" align="center" sortable="true"/>
				<next:Column header="结束日期" id="planEnd" field="planEnd" width="100" align="center" sortable="true"/>
				...
				<next:Column header="登记单位" field="planOrgName" width="80" sortable="true"/>
				...
				<form id="jzfaForm" name="jzfaForm" method="post" dataset="jzfaDatasetNew" onsubmit="return false" class="L5form">
					<table border="0" width="98%">
						...
						<tr>
							...
							<td class="FieldInput" style="width:20%"><input type="text" id="jzzjJeInsert" name="jzzjJe" field="fund" readonly="readonly"/></td>
						</tr>
						<tr>
						...
						<tr>
							<td class="FieldLabel">救助户数:</td>
							<td class="FieldInput"><input type="text" id="jzhsInsert" name="jzhs" field="familyNum"  readonly="readonly"/></td>
							<td class="FieldLabel">救助人数:</td>
							<td class="FieldInput"><input type="text" id="jzrsInsert" name="jzrs" field="peopleNum"  readonly="readonly" /></td>
						</tr>
				...
				<form id="jzfaUpdateForm" name="jzfaUpdateForm" method="post" dataset="jzfaUpdateDataset" onsubmit="return false" class="L5form">
					<table border="0" width="98%">
						...
						<tr>
							...
							<td class="FieldInput" style="width:20%"><select name="jzlxdm" field="planType"><option dataset="DmJzlxDataSet" value="1"></option></select><font color="red">*</font></td>
							<td class="FieldLabel" style="width:10%">救助资金金额:</td>
							<td class="FieldInput" style="width:20%"><input type="text" id="jzzjJeEdit" name="jzzjJe" field="fund" readonly="true"/></td>
						</tr>
						<tr>
							<td class="FieldLabel">开始日期:</td>
						...
						<tr>
							<td class="FieldLabel">救助户数:</td>
							<td class="FieldInput"><input type="text" id="jzhsEdit" name="jzhs" field="familyNum" readonly="true"/></td>
							<td class="FieldLabel">救助人数:</td>
							<td class="FieldInput"><input type="text" id="jzrsEdit" name="jzrs" field="peopleNum" readonly="true"/></td>
						</tr>
						 <input type="hidden" name="regOrganType" id="regOrganType" value="A1" />
					</table>
				</form>
