...
<head>
	...
	<script type="text/javascript" src="complaintHandleList.js"></script>
</head>

<body>
<model:datasets>
<model:dataset id="applywayDataset" enumName="APPLY_WAY.TYPE"  autoLoad="true" global="true"></model:dataset>
<model:dataset id="complaintDataset" cmd="com.inspur.sdmz.apply.cmd.SamApplyQueryCmd" method="samapplyQuery" pageSize="10">
...
<next:GridPanel id="complaintGridPanel" name="complaintGrid" dataset="complaintDataset" notSelectFirstRow="true" stripeRows="true" width="100%" height="450" title="->  您的位置 : 业务管理 >> 投诉业务">>
	<next:TopBar>
		...
		<next:ToolBarItem text="投诉业务受理" iconCls="add" handler="insert" ></next:ToolBarItem>
		<next:ToolBarItem text="变更" iconCls="detail" handler="update" ></next:ToolBarItem>
		<next:ToolBarItem text="提交审核" iconCls="edit" handler="tjsh" ></next:ToolBarItem>
		<next:ToolBarItem text="删除" iconCls="remove" handler="remove"></next:ToolBarItem>
	</next:TopBar>
	<next:Columns>
