...
<head>
	...
	<script type="text/javascript" src="consultHandleList.js"></script>
</head>
<body>
<model:datasets>
	<model:dataset id="consultDataset" cmd="com.inspur.sdmz.apply.cmd.SamApplyQueryCmd" method="samapplyQuery" pageSize="10">
...
<next:GridPanel id="consultGridPanel" name="consultGrid" dataset="consultDataset" notSelectFirstRow="true"  stripeRows="true" width="100%" height="450" title="->  您的位置 : 业务管理 >> 咨询业务">
	...
	<next:TopBar>
		...
		<next:ToolBarItem text="咨询业务受理" iconCls="add" handler="insert" ></next:ToolBarItem>
