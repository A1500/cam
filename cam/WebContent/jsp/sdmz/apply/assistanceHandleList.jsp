...
<head>
	...
	<script type="text/javascript" src="assistanceHandleList.js"></script>
</head>
<body>
<model:datasets>
	<model:dataset id="applyDataset" cmd="com.inspur.sdmz.apply.cmd.SamApplyQueryCmd" method="samapplyQuery"  pageSize="10">
...
<next:GridPanel id="applyGridPanel" name="applyGrid" dataset="applyDataset" notSelectFirstRow="true"  stripeRows="true" width="100%" height="450" title="->  您的位置 : 业务管理 >> 救助业务">
	...
	<next:TopBar>
		...
		<next:ToolBarItem text="救助业务受理" iconCls="add" handler="insert" ></next:ToolBarItem>
		<next:ToolBarItem text="变更" iconCls="edit" handler="update" ></next:ToolBarItem>
		<next:ToolBarItem text="提交审核" iconCls="detail" handler="tjsh" ></next:ToolBarItem>
