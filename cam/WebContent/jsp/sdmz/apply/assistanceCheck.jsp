...
<html>
	<head>
		...
		<script type="text/javascript" src="assistanceCheck.js"></script>
	</head>
<body>
<model:datasets>
...
<next:Panel width="800">
		<next:Panel title="救助服务办理单">
			...
			<table width="100%">
				<tr>
				<td colspan="4" align="center"><font size="20" >救助业务审核</font></td>
				</tr>
				<tr>
					<td class="FieldLabel"><label>申请人:</label></td>
					<td class="FieldInput"><input type="text" name="applyPeople" field="applyPeople" disabled="disabled"/><font color="red">*</font></td>
					<td class="FieldLabel"><label>身份证号:</label></td>
					<td class="FieldInput"><input type="text" name="applyIdcard" field="applyIdcard" style="width: 140px" disabled="disabled"/><font color="red">*</font></td>
				</tr>
				<tr>
					<td class="FieldLabel"><label>家庭人口:</label></td>
					<td class="FieldInput"><input type="text" name="applyPeopleNum" field="applyPeopleNum" disabled="disabled" style="width: 30px"/><font color="red">*</font></td>
					<td class="FieldLabel"><label>家庭成员:</label></td>
					<td class="FieldInput"><input type="text" name="familyMember" field="familyMember" disabled="disabled"/></td>
				</tr>
				<tr>					
					<td class="FieldLabel"><label>联系电话:</label></td>
					<td class="FieldInput"><input type="text" name="applyTel" field="applyTel" disabled="disabled"/></td>
					<td class="FieldLabel"><label>申请方式:</label></td>
					<td class="FieldInput"><select name="applyWay" field="applyWay" disabled="disabled"><option dataset="applywayDataset"></option></select><font color="red">*</font></td>
				</tr>
				<tr>
					<td class="FieldLabel"><label>性别:</label></td>
					<td colspan="3" class="FieldInput"><input type="radio" name="applySex" field="applySex" dataset="xbdmDataset" disabled="disabled"/></td>
				</tr>	
				<tr>
					<td class="FieldLabel"><label>家庭住址:</label></td>
					<td colspan="3" class="FieldInput"><input type="text"  name="applyAdd" field="applyAdd" style="width: 500px" disabled="disabled"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3" class="FieldInput"><textarea  name="applyReasons" field="applyReasons" cols="100" rows="5" disabled="disabled"/></textarea></td>
				</tr>
				<tr>
