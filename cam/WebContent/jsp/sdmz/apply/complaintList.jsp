...
<title>明细查询列表</title>
<next:ScriptManager />
<script type="text/javascript" src="complaintList.js"></script>
<script language="javascript">
		 	 //查询条件打开合并函数
...
<next:Panel name="form" width="100%" border="0" bodyStyle="padding-bottom:10px;padding-top:12px;" autoHeight="true" title="->  您的位置 : 业务管理 >> 投诉业务明细">
	<next:Html>
		...
		<table border="1" width="100%" style="width:100%;table-layout:fixed;">
			<tr>
				<td class="FieldLabel" nowrap="nowrap" width=10%>投诉人:</td>
				<td class="FieldInput"  width=20%><input type="text" id="qapplyPeople"
					class="TextEditor"  title="投诉人" /></td>
				<td class="FieldLabel" nowrap="nowrap" width=10%>投诉起始日期:</td>
				<td class="FieldInput" width=20%><input type="text" id="qapplyDate" format="Y-m-d"  onclick="LoushangDate(this)"/> 
				</td>
				<td class="FieldLabel" nowrap="nowrap" width=10%>投诉结束日期:</td>
				<td class="FieldInput" width=20%><input type="text" id="qapplypeopleqend" format="Y-m-d"  onclick="LoushangDate(this)"/> 
				</td>
			...
			<tr>
				<td class="FieldLabel" width=10% nowrap="nowrap">投诉方式:</td>
...
<next:GridPanel id="editGridPanel" name="mignxiGrid" width="98%"
	stripeRows="true" height="330" dataset="ds" notSelectFirstRow="true" title="明细查询">
<next:TopBar>
	...
	<next:Columns>
		...
		<next:Column id="applyPeople" header="投诉人" field="applyPeople"  sortable="true">
			<next:TextField />
		</next:Column>

		<next:Column id="complaintedOrg" header="被投诉单位" field="complaintedOrg" >
			<next:TextField />
		</next:Column>

		<next:Column id="applyDate" header="投诉日期" field="applyDate"  sortable="true">
			<next:TextField />
		</next:Column>

		<next:Column id="applyWay" header="投诉方式" field="applyWay"  dataset="ConsultDataSet" sortable="true">
			<next:TextField />
		</next:Column>
		...
		<next:Column id="handleSign" header="办理标志" field="handleSign"  dataset="BanliDataSet" sortable="true">
			<next:TextField />
		</next:Column>
	...
	<next:Html>
		<form dataset="ds" id="test1">
			...
			<tbody>
				<tr>
					<td align="right">
						<label class="FieldLabel">投诉人</label>
					</td>
					<td>
				...
				<tr>
					<td align="right">
						<label class="FieldLabel">被投诉单位</label>
					</td>
					<td class="InnerTableContentCell">
						<input type="text" style="width: 200px;" field="complaintedOrg" class="TextEditor"  disabled="disabled" />
					</td>
				</tr>
				<tr>
					<td align="right">
						<label class="FieldLabel" title="">投诉日期</label>
					</td>
					<td>
				...
				<tr>
					<td align="right">
						<label class="FieldLabel">投诉方式</label>
					</td>
					<td class="InnerTableContentCell">
				...
				<tr>
					<td align="right">
						<label class="FieldLabel">办理标志</label>
					</td>
					<td class="InnerTableContentCell">
