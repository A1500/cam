...
<html>
	<head>
		...
		<script type="text/javascript" src="all_trash_list.js"></script>
		...
		function init(){	
			...
			msgDs.setParameter("boxType","trash");
...
<next:GridPanel border="false" id="editGridPanel" name="mailGrid" anchor="100% 45%" dataset="msgDs" autoScroll="true" enableColumnResize="true" notSelectFirstRow="true">
	<next:TopBar>		
		...
		<next:ToolBarItem  iconCls="remove" text="删除" handler="delMsg"/>	
	...
	<next:Columns>
		...
		<next:Column id="sender" header="发件人"  field="sender"  width="20%" sortable="true">
			<next:TextField allowBlank="false" />
		</next:Column>
		
		 <next:Column id="stat" header="状态"  field="stat"  width="5%" sortable="true">
	...
	<fieldset style="width: 100%;">
		...
		<table width="100%">
			...
			<tr>			
				...
				<td class="FieldInput">
					<input type="text" id="endTime" format="Ymd" name="endTime" onclick="LoushangDate(this)" ondblclick=""/>					
				</td>
			</tr>
			<tr>				
				<td class="FieldLabel">
			...
			<tr>
				<td align="center" colspan="4">
					<button onclick="queryMail('trash')" style="width: 80">查 询</button> 
				</td>
			</tr>
		</table>
		</fieldset>
...
<input type="hidden"id="boxType" value="trash"/>
