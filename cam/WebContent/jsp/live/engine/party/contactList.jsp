	...
	<next:Tree name="strutree" id="strutree" collapsible="false" width="250" height="100%" autoScroll="true" rootExpanded="true" allowCheck="true">
		<next:TreeDataSet dataset="struTreeDataset" root="rootdata">
			<next:TreeLoader cmd="org.loushang.live.contact.contactlist.cmd.ContactQueryCmd" method="queryUserGroup" trigger="start_group_tree">
				<next:treeRecord name="groupRecord" idField="groupId" fromBean="org.loushang.live.contact.contactlist.data.Group"></next:treeRecord>
			...
			<next:TreeLoader cmd="org.loushang.live.contact.contactlist.cmd.ContactQueryCmd" method="queryContactListTree" trigger="start_contact_tree" >
				<next:treeRecord name="contactRecord" idField="memberId" fromBean="org.loushang.live.contact.contactlist.data.Contact"></next:treeRecord>
				<next:TreeBaseparam name="GROUP_ID" value="getStruParent" />
				<next:TreeBaseparam name="FILTER_FLAG" value="true" />
				<!--
				<next:TreeBaseparam name="online" value="changeOnlineDisplayState" />
			--></next:TreeLoader>
		</next:TreeDataSet>
		<next:TreeNodemodel recordType="groupRecord">
			<next:TreeNodeAttribute  name="text" mapping="groupName"></next:TreeNodeAttribute>
		...
		<next:TreeNodemodel recordType="contactRecord">
			<next:TreeNodeAttribute  name="text" handler="nickName"></next:TreeNodeAttribute>
			<next:TreeNodeAttribute name="icon" handler="getIcon"></next:TreeNodeAttribute>
			<next:TreeNodeAttribute name="showType" handler="checkbox"></next:TreeNodeAttribute>
			<next:TreeNodeAttribute name="changeParent" value="false"></next:TreeNodeAttribute>
			<next:Listeners>
