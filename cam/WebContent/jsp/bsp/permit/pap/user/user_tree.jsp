...
<script type="text/javascript" src="user_tree.js"></script>
</head>
<body>
<next:ViewPort>
<next:BorderLayout>
			...
			<next:Html>
					...
					<next:TreeNodemodel recordType="struRecord">
						...
						<next:RightmouseMenu menuId="menuId1" trigger="istRoot">
							<next:MenuItem text='<%=res.get("USER.ADD_USER")%>' handler="addUser"></next:MenuItem>
						</next:RightmouseMenu>
					...
					<next:TreeNodemodel recordType="userRecord">
						...
						<next:RightmouseMenu menuId="roleMenu">
							<next:MenuItem text='<%=res.get("USER.DEL_USER")%>' handler="delUser"></next:MenuItem>
						</next:RightmouseMenu>
						<next:Listeners>
