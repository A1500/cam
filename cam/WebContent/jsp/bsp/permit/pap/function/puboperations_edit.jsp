...
<model:datasets>
	<model:dataset id="operationDataset" cmd="org.loushang.bsp.permit.pap.function.cmd.OperationQueryCommand" global="true">
		<model:record fromBean="org.loushang.bsp.permit.pap.function.data.Operation">
			<model:field name="functionName" type="string" />
		</model:record>
	</model:dataset>
	<model:dataset id="urlDataset" cmd="org.loushang.bsp.permit.pap.function.cmd.UrlQueryCommand" global="true" pageSize="-1" sortField="seq">
...
<next:ViewPort>
<next:Panel  title='<%=res.get("PUB_OPERATIONS.TITLE")%>' width="100%" height="55%" autoScroll="true">
	<next:TopBar>
	...
	<next:Html>
		...
		<table border="0"  width="100%" >
	   		<tr>
				...
				<td class="FieldInput"><input type="text" id="operationCodeFld" name=<%=res.get("PUB_OPERATIONS.OPERATION_CODE")%> field="operationCode" onblur="testCode()"  /><font id="operationHint" color="red">*</font> </td>
			</tr>
	   		<tr>
			...
			<tr>
				<td  class="FieldLabel" ><%=res.get("PUB_OPERATIONS.SEQ")%></td>
				<td class="FieldInput"><input type="text" id="seq" name=<%=res.get("PUB_OPERATIONS.SEQ")%> field="seq"  />  
