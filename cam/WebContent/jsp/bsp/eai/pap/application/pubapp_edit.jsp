...
<model:datasets>
	<model:dataset id="appDataset" method="queryWithMenu" cmd="org.loushang.bsp.eai.pap.application.cmd.AppQueryCommand" global="true">
		<model:record fromBean="org.loushang.bsp.eai.pap.application.data.App" ></model:record>
	</model:dataset>
</model:datasets>
<next:ViewPort>
<next:Panel  title='<%=res.get("PUB_APP.TITLE")%>' width="100%">
	...
	<next:Html>
		...
		<table border="0"  width="100%" >
			...
			<td class="FieldInput"><input type="text" id="appCodeFld" name="应用编码" field="appCode" />
			<font id="appHint" color="red">*</font></td>
	   		...
	   		<tr>
				...
				<td class="FieldInput"><input type="text" name=<%=res.get("PUB_APP.SERVER")%> field="serverHost"  maxlength="30"/>
				 <font id="functionHint" color="red">*</font>
				 </td>
			</tr>
	   		<tr>
			...
			<tr>
			<td  class="FieldLabel" >序号</td>
			<td class="FieldInput"><input type="text" name="序号" field="seq"  />
			<font id="functionHint" color="red">*</font>
			</td>
