...
<html>
<%
  String parentLable=request.getParameter("parentLable");
  if(parentLable!=null&&parentLable.equals("module")){
	  parentLable="上级模块";
  }else if(parentLable!=null&&parentLable.equals("component")){
	  parentLable="所属业务组件";
  }
%>
	<head>
	...
	<next:Html>
		...
		<table   width="100%" >
	   		...
	   		<tr>
				...
				<td class="FieldInput"><input type="text" id="moduleCodeFld" name=<%=res.get("PUB_MODULES.MODULE_CODE")%> field="moduleCode" onchange="testCode()" /><font id="moduleHint" color="red">*</font> </td>
			</tr>
	   		<tr>
	   		...
	   		<tr>
				<td  class="FieldLabel" ><%=parentLable%></td>
