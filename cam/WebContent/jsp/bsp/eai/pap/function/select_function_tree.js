...
function confirmValue(){
	...
	var command;
	if(showType=="module"){
		command=new L5.Command("org.loushang.bsp.eai.pap.function.cmd.ModuleCommand");
	}
	if(showType=="function"){
		command=new L5.Command("org.loushang.bsp.eai.pap.function.cmd.FunctionCommand");
	}
	if(showType=="operation"){
		command=new L5.Command("org.loushang.bsp.eai.pap.function.cmd.OperationCommand");
	}
