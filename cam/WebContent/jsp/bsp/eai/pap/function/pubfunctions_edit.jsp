...
<body>
<model:datasets>
	<model:dataset id="functionDataset" method="queryWithMenu" cmd="org.loushang.bsp.eai.pap.function.cmd.FunctionQueryCommand" global="true">
	...
	<next:Html>
		...
		<table border="0"  width="100%" >
	   		...
	   		<tr>
				...
				<td class="FieldInput"><input type="text" id="functionCodeFld" name=<%=res.get("PUB_FUNCTIONS.FUNCTION_CODE")%> field="functionCode"  onchange="testCode()"/><font id="functionHint" color="red">*</font> </td>
			</tr>
	   		<tr>
