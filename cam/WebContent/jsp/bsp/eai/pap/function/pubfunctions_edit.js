...
function init() {
	...
	if (method=="INSERT"){
		ds.newRecord({"moduleCode":moduleCode,"moduleName":moduleName});
			//如果上级没有同步菜单这里不需要选
		if(withMenu == 'n'){
...
function testCode(){
	...
	var cmd = new L5.Command('org.loushang.bsp.eai.pap.function.cmd.FunctionCommand');
...
function save(){
	...
	var command=new L5.Command("org.loushang.bsp.eai.pap.function.cmd.FunctionCommand");
