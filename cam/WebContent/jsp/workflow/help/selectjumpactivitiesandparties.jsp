...
<model:datasets>
	<model:dataset id="actDataSet"
		cmd="org.loushang.workflow.client.common.help.cmd.TaskHelpCmd" global="true" autoLoad="true" method="selectJumpActivitiesAndParties">
		<model:record >
			...
			<next:Html>
				<table width="100%">
					<tr height="25">
						...
						<td class="FieldInput">
							<select id="selectJumpActivity" style="width:150" onChange="selectedActChanged()">
