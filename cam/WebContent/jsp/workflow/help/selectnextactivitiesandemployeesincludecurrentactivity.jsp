...
//判断当前环节是否是结束环节
window['activityIsEnd']= new L5.model.Dataset({proxy:new L5.CommandProxy('org.loushang.workflow.client.common.help.cmd.TaskHelpCmd','getActivityDefInfoWithIsEndByAssignmentId'),reader: new L5.model.JsonReader({fields:[{name:'isEnd',type:'string'}]}),ds:'activityIsEnd',pageSize:-1,id:'activityIsEnd',remoteSort:true});

var activityIsEnd = L5.DatasetMgr.lookup("activityIsEnd");
...
<model:datasets>
	<model:dataset id="actDataSet"
		cmd="org.loushang.workflow.client.common.help.cmd.TaskHelpCmd" global="true" autoLoad="true" method="selectNextActivitiesIncludeCurrentActivity">
		<model:record >
			...
			<next:Html>
				<table width="100%">
					<tr height="25">
						...
						<td class="FieldInput">
							<select id="selectNextActivity" style="width:150" onChange="actsChange()">
