...
<HTML>
<HEAD>
<TITLE>流程恢复事件配置</TITLE>
<next:ScriptManager></next:ScriptManager>
</HEAD>
<BODY>
<model:datasets>
	<model:dataset pageSize="10" id="propertyConfigDataset"
		cmd="org.loushang.workflow.config.property.cmd.PropertyConfigQueryCmd"
			...
			<next:Panel>
				<next:Panel width="100%" border="0"
					...
					<next:Html>
						...
						<table border="1" width="100%">
							<tr>
								<td class="FieldLabel">监听类名称：</td>
								<td class="FieldInput"><input type="text"
									id="propertyValue" class="TextEditor" style="width: 200px"
									title="监听类名称" /></td>
				...
				<next:EditGridPanel id="userGridPanel" width="100%" height="100%"
					...
					<next:Columns>
						...
						<next:Column header="监听类名称" field="propertyValue" width="200">
							<next:TextField allowBlank="false" />
						</next:Column>
