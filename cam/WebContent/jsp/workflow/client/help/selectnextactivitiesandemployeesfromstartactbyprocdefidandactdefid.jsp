...
<model:datasets>
	<model:dataset id="actDataSet"
		cmd="org.loushang.workflow.client.common.help.cmd.TaskHelpCmd" global="true" autoLoad="true" method="selectNextActivitiesAndEmployeesFromStartActByProcDefIdAndActDefId">
		<model:record >
	...
	<div style="width:100%;border:1px;background-color:#d4e1f1;">
		<div class="FieldLabel" style="width:60%;text-align:left;float:left">选择下一环节:
			<select name="actDefInfo" id="actDefInfo" style="width:100" onchange="selectedActChanged();">
	...
	<next:Panel  height="100%">
		<next:Html>
    		<next:GridPanel id="userGridPanel" height="400" width="100%" name="partiesGridPanel"  dataset="partiesDataset" frame="true" title="参与者选择" notSelectFirstRow="true">
				<next:Columns>
...
function selectedActChanged(){
	...
	partiesDataset.baseParams["preActDefUniqueId"]=startActDefUniqueId;
	partiesDataset.load();
}
