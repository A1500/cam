...
<HTML>
<%
  List actDefList=(List)request.getAttribute("nextActivities");
...
<model:datasets>
	<model:dataset id="actDataSet"
		cmd="org.loushang.workflow.client.common.help.cmd.TaskHelpCmd" global="true" autoLoad="true" method="selectNextActivitiesAndEmployeesByPkAndActDefId">
		<model:record >
