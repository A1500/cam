...
%>
<HEAD>
<TITLE>选择历史环节以及参与者</TITLE>
<next:ScriptManager></next:ScriptManager>
</HEAD>
<BODY style="margin:0px;padding: 0px;">
<model:datasets>
	<model:dataset id="actDataSet"
		cmd="org.loushang.workflow.client.common.help.cmd.TaskHelpCmd" global="true" autoLoad="true" method="selectHistoryActivitiesAndParties">
		<model:record >
	...
	<model:dataset pageSize="10" id="partiesDataset" cmd="org.loushang.workflow.client.common.help.cmd.TaskHelpCmd" method="selectHistoryActivityParties">
		<model:record >
	...
	<div style="width:100%;border:1px;background-color:#d4e1f1;">
		<div class="FieldLabel" style="width:60%;text-align:left;float:left">选择历史环节:
