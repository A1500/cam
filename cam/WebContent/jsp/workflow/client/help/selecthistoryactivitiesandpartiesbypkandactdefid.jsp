...
<model:datasets>
	<model:dataset id="actDataSet"
		cmd="org.loushang.workflow.client.common.help.cmd.TaskHelpCmd" global="true" autoLoad="true" method="selectHistoryActivitiesAndPartiesByPkAndActDefId">
		<model:record >
...
function selectOrganId(){
	...
	var url =L5.webPath+"/jsp/workflow/client/help/selecthistoryparties.jsp?activityId="+record.get("activityId");      
