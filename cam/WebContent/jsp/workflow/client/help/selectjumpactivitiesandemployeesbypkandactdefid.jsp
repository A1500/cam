...
<model:datasets>
	<model:dataset id="actDataSet"
		cmd="org.loushang.workflow.client.common.help.cmd.TaskHelpCmd" global="true" autoLoad="true" method="selectJumpActivitiesAndEmployeesByPkAndActDefId">
		<model:record >
...
function selectOrganId()
{
  ...
  var url =L5.webPath+"/jsp/workflow/client/help/selectactivityemployees.jsp?actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;      
  var win = showModalDialog(url,window,"scroll:yes;status:no;dialogWidth:500px;dialogHeight:550px");
  if (win == null) {
  	return;
  }else if(win[0]=="cancel"){
  	document.getElementById("organIds").value="";
   	document.getElementById("organNames").value=""; 
  	return;
  }
  else{
