...
<BODY>
<model:datasets>
	<model:dataset pageSize="10" id="partiesDataset" cmd="org.loushang.workflow.client.common.help.cmd.TaskHelpCmd" autoLoad="true" method="selectHistoryActivityEmployees">
		<model:record >
...
<next:Panel >
	...
	<next:Panel height="400">
			<next:Html>
    		<next:GridPanel id="userGridPanel" height="398" name="partiesGridPanel"  dataset="partiesDataset"     title="选择历史环节参与者" notSelectFirstRow="true">
				<next:Columns>
