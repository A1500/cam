...
<html>
	<head>
		...
		function executeInsertPre()
		{
			getIframeWindow("procEditor").executePre("insert");
		}
		...
		function executeInsert()
		{
			...
			var highLevelProcDefUniqueId="<%=request.getParameter("id")%>";
			if(highLevelProcDefUniqueId!=null&&highLevelProcDefUniqueId!=""&&highLevelProcDefUniqueId!="null")
			{
		...
		{
			var url = 'jsp/workflow/modeling/bpmn/querybpmnprocessdef.jsp?isHighLevel=0';
			var text = 'BPMN流程定义查询';
			L5.forward(url, text);
		}
	...
	<body>
		...
		<input type="hidden" name="definitionId" id="definitionId" value="<%=request.getParameter("id")%>"/>
		<input type="hidden" id="isHighLevel" field="isHighLevel" value="0"/>
