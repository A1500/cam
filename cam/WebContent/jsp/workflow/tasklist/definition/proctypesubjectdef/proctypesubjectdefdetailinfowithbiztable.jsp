...
<model:datasets>
	<model:dataset pageSize="15" id="procTypeSubjectDefDataset"
		...
		method="queryProcTypeSubjectDefDetailInfoWithBizTable">
		<model:record
	...
	<next:TabPanel name="tabpanel-div" height="590" activeTab="<%=dispalyTab %>">
		...
		<next:Tabs>
			<next:Center floatable="true" cmargins="0 0 0 0" margins="0 0 0 0">
				<next:Panel id="bizTabelPanel" title="业务标题定义">
					<next:AnchorLayout>
						<next:Panel width="100%" border="0"
							bodyStyle="padding-bottom:10px;padding-top:0px;">
							<next:Html>
								<fieldset style="overflow: visible;" class="GroupBox">
								<legend class="GroupBoxTitle">关联业务表 <img
									class="GroupBoxExpandButton"
									src="<%=SkinUtils.getImage(
													request,
								...
								<table border="1" width="100%">
									<tr>
										<td class="FieldLabel" width="15%">业务表名：</td>
										<td class="FieldInput"><input type="text" id="bizTable"
											field="bizTable" class="TextEditor" title="业务表名" size="40" /></td>
										<td class="FieldLabel" width="15%">业务表主键名：</td>
										<td class="FieldInput"><input type="text" id="bizTablePk"
											field="bizTablePk" class="TextEditor" title="业务表主键名"
											size="40" /></td>
										<td class="FieldButton" width="15%">
										<button onclick="saveBizTable()">保存</button>
										</td>
									</tr>
								</table>
								</form>
						...
						<next:EditGridPanel id="procTypeSubjectGridPanel"
							name="procTypeSubjectGridPanel" anchor="100%" height="100%"
							dataset="procTypeSubjectDefDataset"    
							title="业务标题详细信息">
							<next:Columns>
								...
								<next:Column header="业务字段值" field="subjectKey" width="200">
									<next:TextField allowBlank="false" />
								</next:Column>
								<next:Column header="业务字段显示名称" field="subjectAlias" width="200">
									<next:TextField allowBlank="false" />
								</next:Column>
								...
								<next:Column id="isQueryCondition" header="是否作为查询条件" field="isQueryCondition"
									width="150">
									<next:ComboBox triggerAction="all"
										dataset="isQueryConditionDataset" typeAble="false"/>
								</next:Column>
								<next:Column header="标题类别" field="subjcetCategory" hidden="true">
							...
							<next:BottomBar>
								<next:PagingToolBar displayMsg="从第{0}条到{1}条，一共{2}条"
									displayInfo="true" dataset="procTypeSubjectDefDataset" />
							</next:BottomBar>
						</next:EditGridPanel>
					</next:AnchorLayout>
				</next:Panel>
						...
						<next:Tabs>
										<next:EditGridPanel id="procTypeDaiBanProcSubjectGridPanel"
											...
											<next:TopBar>
												...
												<next:ToolBarItem iconCls="save" text="保存" handler="forDaiBanProSubjectSave" />
								...
								<next:EditGridPanel id="procTypeYiBanProcSubjectGridPanel"
									...
									<next:TopBar>
										...
										<next:ToolBarItem iconCls="save" text="保存" handler="forYiBanProSubjectSave" />
										<next:ToolBarItem iconCls="add" text="查询条件定义" handler="forYiBanQuery"></next:ToolBarItem>
										<next:ToolBarItem iconCls="detail" text="预览" handler="forYiBanPreview"></next:ToolBarItem>
										<next:ToolBarItem iconCls="undo" text="返回" handler="backToProcTypeSubjectDefList" />
									</next:TopBar>
									<next:BottomBar>
										<next:PagingToolBar displayMsg="从第{0}条到{1}条，一共{2}条"
								...
								<next:EditGridPanel id="procTypeEndProcSubjectGridPanel"
									...
									<next:TopBar>
										...
										<next:ToolBarItem iconCls="save" text="保存" handler="forEndProSubjectSave" />
										<next:ToolBarItem iconCls="add" text="查询条件定义" handler="forEndQuery"></next:ToolBarItem>
										<next:ToolBarItem iconCls="detail" text="预览" handler="forEndPreview"></next:ToolBarItem>
										<next:ToolBarItem iconCls="undo" text="返回" handler="backToProcTypeSubjectDefList" />
									</next:TopBar>
								</next:EditGridPanel>
						</next:Tabs>
...
function forSave()
{
	...
	command.execute("saveProcTypeSubjectDefDetailInfoWithBizTable");
	if (!command.error) {
	...
	L5.MessageBox.confirm('确定', msg,function(state){
		if(state=="yes"){   
			...
			if (deleteSelected.length < 1) {
				...
				command.execute("deleteWithBizTable");
				if (!command.error) {
...
function forBizQuery(){
	forQuery("bizQuery","bizTable");
}

//定义流程标题---待办---查询条件
function forDaiBanQuery(){
	forQuery("daiBanQuery","bizTable");
}

//定义流程标题---已办---查询条件
function forYiBanQuery(){
	forQuery("yiBanQuery","bizTable");
}

//定义流程标题---办结---查询条件
function forEndQuery(){
	forQuery("endQuery","bizTable");
}
...
function forDaiBanPreview() {
	forPreview("daiBanPreview","bizTable");
}

//办结预览
function forYiBanPreview() {
	forPreview("yiBanPreview","bizTable");
}

//办结预览
function forEndPreview() {
	forPreview("endPreview","bizTable");
}
