...
<model:datasets>
	<model:dataset pageSize="10" id="yiBanDataset" cmd="org.loushang.workflow.tasklist.taskinfo.cmd.YiBanTaskQueryCmd" autoLoad="false" method="queryProcYiBanTaskTableDetailInfoByProc" global="true">
		<model:record>
...
function showState()
{
   ...
   var backUrl="jsp/workflow/tasklist/display/procsubject/queryyibandetailinfobyproc.jsp";
