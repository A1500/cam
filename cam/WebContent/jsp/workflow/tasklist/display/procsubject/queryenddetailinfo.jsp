...
<model:datasets>
	<model:dataset pageSize="10" id="endDataset" cmd="org.loushang.workflow.tasklist.taskinfo.cmd.EndTaskQueryCmd" autoLoad="false" method="queryProcEndTaskTableDetailInfo" global="true">
		<model:record>
...
function showState()
{
   ...
   var backUrl="jsp/workflow/tasklist/display/procsubject/queryenddetailinfo.jsp";
