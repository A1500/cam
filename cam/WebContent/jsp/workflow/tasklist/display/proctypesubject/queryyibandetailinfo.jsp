...
<model:datasets>
	<model:dataset pageSize="10" id="yiBanDataset"
		...
		autoLoad="false" method="queryProcTypeYiBanTaskTableDetailInfo"
		global="true">
		<model:record>
							...
							<table border="1" width="100%">
								<tr>
									...
									<td class="FieldInput"><select type="text"
										name="<%=procTypeSubjectKey%>" field="subjectQueryDefUniqueId"
										title="查询条件">
...
function showState()
{
   ...
   var backUrl="jsp/workflow/tasklist/display/proctypesubject/queryyibandetailinfo.jsp";
