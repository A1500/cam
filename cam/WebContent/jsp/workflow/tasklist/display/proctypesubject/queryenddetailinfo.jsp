...
<model:datasets>
	<model:dataset pageSize="10" id="endDataset"
		...
		autoLoad="false" method="queryProcTypeEndTaskTableDetailInfo"
		global="true">
		<model:record>
...
function showState()
{
   ...
   var backUrl="jsp/workflow/tasklist/display/proctypesubject/queryenddetailinfo.jsp";
