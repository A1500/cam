...
<model:datasets>
	<model:dataset pageSize="10" id="endTaskDataset" cmd="org.loushang.workflow.tasklist.taskinfo.cmd.EndTaskQueryCmd" autoLoad="true" method="querySysEndTaskTableDetailInfoByProc">
		<model:record>
...
<next:ViewPort>
	<next:BorderLayout>
		...
		<next:Center floatable="true" cmargins="0 0 0 0" margins="0 0 0 0" >
			...
			<next:GridPanel id="endTaskGridPanel" name="endTaskGridPanel" width="100%" height="100%" dataset="endTaskDataset"     title="办结任务详细信息列表" notSelectFirstRow="true">
				<next:Columns>
...
function showState()
{
   ...
   showprocessstate(endTaskGridPanel,"end","jsp/workflow/tasklist/display/syssubject/queryenddetailinfobyproc.jsp");
}
//查询条件面板打开合并函数
