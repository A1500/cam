...
<model:datasets>
	<model:dataset pageSize="10" id="yiBanDataset" cmd="org.loushang.workflow.tasklist.taskinfo.cmd.YiBanTaskQueryCmd" autoLoad="true" global="true" method="querySysYiBanTaskTableDetailInfo">
		<model:record>
...
function showState()
{
   ...
   showprocessstate(yiBanTaskGridPanel,"yiban","jsp/workflow/tasklist/display/syssubject/queryyibandetailinfo.jsp");
}
//查询条件面板打开合并函数
