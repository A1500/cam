...
<body>
<model:datasets>
  <model:dataset id="portalPageDataset" cmd="org.loushang.portal.page.cmd.PortalPageQueryCmd" method="queryPortalPage" global="true">
  ...
  <next:Html>
	<form action="" name="form1" method="post" onsubmit="return false" class="L5Form" >
	  <table width="100%" cellpadding="0" cellspacing="0" border="0">
		...
		<tr>
		  <td class="FieldLabel" rowspan="4" width="10%" nowrap="nowrap"><label >页面布局:</label></td> 
		  <td rowspan="3" width="10%" nowrap="nowrap">
			<input id="columnLayout" value="0" type="radio" name="layoutradio" checked="checked">
			<label>简单布局</label>
		  </td>
		...
		<tr>
		  ...
		  <td nowrap="nowrap" width="75%">
			...
			<input id="fourcolumns" value="4" type="radio" name="columnradio" checked="checked" onClick="changeLayout(4)"/><label>4列</label>
		  </td>
		</tr>
		<tr>
		...
		<tr>
		  <td width="10%" nowrap="nowrap">
			<input id="absoluteLayout" value="1" type="radio" name="layoutradio"/>
			<label >任意布局</label>
		  </td>
		  <td align="center" width="5%" nowrap="nowrap"><label>简介</label></td>
		  <td nowrap="nowrap" width="75%">
...
function doSave(){
	...
	var layoutType="0";
	//简单布局
	var columnLayout=L5.getDom("columnLayout");
	if(columnLayout.checked)
	{
	...
	command.execute("insertPortalPage");
	if (!command.error) {
