...
<html>
	<head>
		<title>特邀颁证师明细</title>
		<next:ScriptManager/>
		<script type="text/javascript" src="mrmpybzy_detail.js"></script>
	</head>
<body>
<model:datasets>
	<model:dataset id="ds" cmd="com.inspur.cams.marry.base.cmd.MrmPybzyQueryCommand" global="true">
		<model:record fromBean="com.inspur.cams.marry.base.data.MrmPybzy"></model:record>
		<model:params>
			<model:param name="PYBZY_ID" value='<%=request.getParameter("pybzyId")%>'></model:param>
		</model:params>
	</model:dataset>
	<!-- 性别 -->
	...
	<next:Html>
		...
		<table border="1"  width="99%" >
	   		...
	   		<tr>
				...
				<td class="FieldInput"><label name="xl" id="xl" field="xl" dataset="EducationDataset"/></td>
			</tr>
	   		<tr>
			...
			<td  class="FieldLabel" >聘用原因</td>
				<td class="FieldInput" colspan="3">
				<label name="pyyy" field="pyyy" /> 
				</td>
			</tr>
			<tr>
				<td  class="FieldLabel" >备注</td>
				<td class="FieldInput" colspan="3"><label name="bz" field="bz" /> </td>
			</tr>			
		</table>
		</form>
   </next:Html>
