...
<next:ScriptManager />
<script type="text/javascript" src="mrmexamapply_list.js"></script>
...
<model:datasets>
	...
	<model:dataset id="Personds"
		...
		method="examApplyDataSet" global="true" pageSize="12">
		<model:record>
...
<next:EditGridPanel clicksToAssistWin="2" id="editGridPanel"
	name="editGridPanel" width="100%" stripeRows="true" height="400"
