...
<script type="text/javascript" src="mrmPerson_query.js"></script>
...
<body>
<model:datasets>
	<model:dataset id="ds" cmd="com.inspur.cams.marry.person.cmd.MarrypersonCommand" method="queryMarryPersons" global="true"></model:dataset>
	<!-- 考试结果 -->
					...
					<form style="width: 100%; height: 100%;" class="L5form">
						<table  border="1" width="100%" >
							...
							<tr>
								...
								<td class="FieldInput">
								<select  id="politics" name="politics" title="政治面貌" >
									<option dataset="PoliticalDataset" />
								</select>	</td>
								<td class="FieldLabel" nowrap>编制性质:</td>
								<td class="FieldInput">
								<select  id="kind" name="kind" title="编制性质" >
									<option dataset="FormationDataset" />
								</select>	</td>
							...
							<tr >
								...
								<td class="FieldInput"><select name="workstate" id="queryWorkState" field="workstate" >
									<option dataset="workstateDataset" />
									</select></td>	
								<td class="FieldLabel" nowrap>年龄:</td>
								<td class="FieldInput"><input type="text"  id="queryAge"   /></td>	
								<td align="center" colspan="2" class="FieldLabel" style="text-align: center"><button onclick="query()">查 询</button>
...
<next:GridPanel id="editGridPanel" name="editGridPanel-grid" width="100%" height="100%" title="婚姻登记员查询" dataset="ds">
	<next:TopBar>
	<next:ToolBarItem id="qrToolbar" text=""></next:ToolBarItem>
		<next:ToolBarItem symbol="->" ></next:ToolBarItem>
		<next:ToolBarItem text="打印" iconCls="detail" handler="print"/>
		<next:ToolBarItem text="导出名册" iconCls="edit" handler="forExcel"/>
	</next:TopBar>
	<next:Columns>
		...
		<next:Column header="职务" id="technical" field="TECHNICAL" width="60" dataset="zwDataset"/>
