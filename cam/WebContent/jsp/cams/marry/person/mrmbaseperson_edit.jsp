		...
		<table border="1"  width="100%" >
			...
			<tr>
	   		...
	   		<tr>
				...
				<td class="FieldInput"><input type="text" name="workDate" readonly="readonly" field="workDate" format="Y-m-d"  /><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)" /> </td>
			...
			<tr>	
				...
				<td class="FieldInput">
				<select name="computerType" id="computerType" field="computerType" >
					<option dataset="computerTypeDataset" />
				</select>
				</td>
				
				<td  class="FieldLabel" >资格证编号：</td>
				<td class="FieldInput"><input type="text" id="certificateId"  name="certificateId" field="certificateId"  /> </td>
				
				<td  class="FieldLabel" >初次发证时间：</td>
				<td class="FieldInput" ><input type="text" name="djyccfzsj" id="djyccfzsj" readonly="readonly" field="djyccfzsj" format="Y-m-d" /><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)" /> </td>
			</tr>
			<tr>
				<td  class="FieldLabel" >最近一次考试合格时间：</td>
				<td class="FieldInput" ><input type="text" name="partyTime" id="partyTime" readonly="readonly" field="partyTime" format="Y-m-d" /><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)" /> </td>
				
				<td  class="FieldLabel" >授权登记范围：</td>
				<td class="FieldInput">
				<select name="djfwtype" id="djfwtype" field="djfwtype" >
			...
			<tr>
				...
				<td class="FieldInput"><input type="text" name="marryStartDate" readonly="readonly" field="marryStartDate" format="Y-m-d"  /><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)" /> </td>
			
				<td  class="FieldLabel" >从事婚姻工作结束时间：</td>
				<td class="FieldInput"><input type="text" name="marryEndDate" readonly="readonly" field="marryEndDate" format="Y-m-d"  /><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)" /> </td>
...
<next:Panel title="电子档案" height="100%" id="mrmbpelectronic">
    <next:Html>
		<iframe  src="mrmBasePersonElec.jsp?idField=<%=request.getParameter("dataBean")%>&deptId=<%=request.getParameter("deptId")%>"
