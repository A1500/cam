...
<script type="text/javascript" src="mrmPerson_statistics.js"></script>
<style>
body {
...
<model:datasets>
	<model:dataset id="ds"
		cmd="com.inspur.cams.marry.query.papers.cmd.MarriageRegistrarQueryCmd" global="true" method="query"
		autoLoad="false">
		<model:record>
		...
		<next:Html>
			...
			<table border="1" width="100%">
				<tr>
					...
					<td class="FieldInput" colspan="2" style="width: 200px"><input type="text" id="deptName" onclick="func_ForDomicileSelect()" name="deptName" />
	...
	<next:Panel width="100%" border="0"
		...
		<next:Html>
			...
			<div align="center"><span id="reportTitle"
				style="font-size: large;">婚姻登记员统计分析</span></div>
			</div>
