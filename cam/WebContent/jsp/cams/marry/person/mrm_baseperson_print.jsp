...
<script type="text/javascript" src="mrm_baseperson_print.js"></script>
...
<model:datasets>
	...
	<!-- 电子档案 -->
	<model:dataset id="mrmElectronicDataSet" cmd="com.inspur.cams.marry.base.cmd.MrmElectronicQueryCmd" global="true" pageSize="20">
