...
<html>
	<head>
		<title>登记员资格考试信息表列表</title>
		<next:ScriptManager/>
		<script type="text/javascript">
			var organCode='<%=BspUtil.getOrganCode()%>';
			var organType = '<%=BspUtil.getOrganType()%>';
		</script>
		<script type="text/javascript" src="mrmqualificationexam_list.js"></script>
...
<model:datasets>
	...
	<!-- 考试时间 -->
	<model:dataset id="ksTimeDataset" autoLoad="true"
					...
					<form style="width: 100%; height: 100%;" class="L5form">
						<table  border="1" width="100%" >
							...
							<tr>
								...
								<td class="FieldInput"><input type="text"  id="certificateId" class="TextEditor" title="资格证编号"  /></td>	
...
<next:EditGridPanel id="editGridPanel" name="mrmqualificationexamGrid" width="100%" height="98%" stripeRows="true" dataset="ds" title="登记员资格考试信息表">
		<%
   ...
   <next:Column id="ckfkbz" header="初考复考标志" field="CKFKBZ" width="90" align="center">
		...
		<next:Column id="certificateId" header="资格证编号" field="CERTIFICATE_ID" width="100" align="center">
			<next:TextField  />
		</next:Column>
...
<next:EditGridPanel hidden="true" id="gridPanel" name="mrmqualificationexamGrid" width="100%" height="98%" stripeRows="true" dataset="ds" title="登记员资格考试信息表">
	<next:Columns>
	    <next:RowNumberColumn width="30"/>
	    <next:CheckBoxColumn></next:CheckBoxColumn>
		...
		<next:Column id="certificateId" header="资格证编号" field="CERTIFICATE_ID" width="100" align="center"  editable="false">
			<next:TextField  />
		</next:Column>
...
<input type="hidden" id="method" value="queryMarryExam"/>
