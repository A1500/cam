...
<html>
	<head>
		...
		<script type="text/javascript" src="mrmbasepersonbzy_detail.js"></script>
...
<next:Panel  title="人员基本信息表" width="100%" height="98%" autoWidth="true">
	...
	<next:Html>
		...
		<table border="1"  width="100%" >
			...
			<td class="FieldLabel" rowspan="3" width="16%">照片:</td>
			...
			<tr>	
				...
				<td class="FieldInput" ><label name="partyTime" field="partyTime" format="Y-m-d" /> </td>
				...
				<td class="FieldInput">
				<label name="bzyzgzh" field="bzyzgzh"  /> 
				</td>
			...
			<tr>
				...
				<td class="FieldInput"><label name="bzybegintime" field="bzybegintime" format="Y-m-d"  /><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)" /> </td>
			
				<td  class="FieldLabel" >从事颁证员工作结束时间：</td>
				<td class="FieldInput"><label name="bzyendtime" field="bzyendtime" format="Y-m-d"  /><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)" /> </td>
			...
			<tr>
				...
				<label name="remark" field="remark" rows="2" style="width:90%" />
				 </td>
			</tr>		
		</table>
		</form>
