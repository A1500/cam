...
<title>档案目录维护</title>
<next:ScriptManager/>
<script type="text/javascript" src="mrmdocument.js"></script>
</head>
<body>
<%--定义dataset--%>
<model:datasets>
...
<next:Panel title="档案目录" collapsible="true" width="30%" autoScroll="true">
...
<form class="L5form">
	<table style="width:100%">
		<tr>
			<td class="FieldLabel" style="width:25%">档案目录:</td>
