...
var cueTitle=decodeURIComponent('<%=request.getParameter("cueTitle")%>');
var cueDate=decodeURIComponent('<%=request.getParameter("cueDate")%>');
</script>
<script type="text/javascript">
var webObj;
var activeDocument;
...
function init(){  
	//取得文件名 和标签    
	var nowFileName = "mrmCheckResult.doc";
	...
	ds.on("load",function(){
		...
		showMap.put("cueTitle",cueTitle);
		showMap.put("result",record.get("result"));
		showMap.put("cueDate",cueDate);
...
<body >
<model:datasets>
	<model:dataset id="ds" cmd="com.inspur.cams.marry.base.cmd.MrmOrganStandardApplyQueryCommand" global="true" method="queryApply">
