...
<script type="text/javascript" src="RegistrationDeptQuery.js"></script>
<style>
body {
					...
					<table width="100%" dataset="ds" align="center" >
						...
						<tr repeat="true">
							<td align="center"><a href="#"><label 
								field="ORGAN_NAME" onclick="queryNextLevel(this)" style="width: 200px;"/></label><label style="display: none;"
