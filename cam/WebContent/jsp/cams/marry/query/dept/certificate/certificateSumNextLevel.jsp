...
<script type="text/javascript" src="certificateSumNextLevel.js"></script>
<style>
body {
...
<body>
<model:datasets> 
	<model:dataset id="ds" cmd="com.inspur.cams.marry.query.dept.cmd.CertificateQueryCmd" global="true" method="query" autoLoad="false">
		<model:record>
			...
			<model:field name="XLZX_NUM"/>
			<model:field name="FL_NUM"/>
		</model:record>
	</model:dataset>
</model:datasets>
<next:ViewPort>
	<next:Panel width="100%" border="0"  bodyStyle="background-color:#EAF4FD;padding-bottom:10px;padding-top:12px;" height="100%" autoScroll="true"><div> 
			...
			<table style="border-style: hidden; width: 90%" cellpadding="0" cellspacing="0" border="0">
				...
				<tr >
					<td colspan="4" style="border-width: 0px">
						...
						<tr>
							...
							<td class="tdTitle" width="3%"  align="center" colspan="2">专业</td>
						...
						<tr>	
							...
							<td class="tdTitle"  width="2%" align="center" >心理咨询</td>
							<td class="tdTitle"  width="2%" align="center" >法律</td>
				...
				<tr  repeat="true">
							...
							<td align="right" style="padding-right: 2px;"><label style="width: 30px;height: 20px;" field="XLZX_NUM"/></label></td>
							<td align="right" style="padding-right: 2px;"><label style="width: 30px;height: 20px;" field="FL_NUM"/></label></td>
