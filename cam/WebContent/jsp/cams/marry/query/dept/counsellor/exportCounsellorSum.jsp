...
<%
	...
	String name="辅导员统计表_"+date;
	String username=GetBspInfo.getBspInfo(request).getUserName();
%>
</head>
<Excel:tablelist filename="<%=name %>">
	<Excel:table sheetname="辅导员统计表">
		<Excel:tr>
			<Excel:td colspan="17" align="center" ><Excel:font size="15">辅导员统计表</Excel:font></Excel:td>
		</Excel:tr>
		<Excel:tr>
			<Excel:td colspan="17" align="left">统计单位：<%= BspUtil.getOrganName()%></Excel:td>
		</Excel:tr>
