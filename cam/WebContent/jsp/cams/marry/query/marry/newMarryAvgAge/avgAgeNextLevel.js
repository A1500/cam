...
function back() {
	if(pageflag=='1'){
		...
		var url = "jsp/cams/marry/query/marry/newMarryAvgAge/queryavgAge.jsp";
...
function queryNextLevel(value){
	...
	data.put("xzqu", xzqh);
	data.put("pageflag","2");
	var url = "jsp/cams/marry/query/marry/newMarryAvgAge/avgAgeNextLevel.jsp";
	L5.forward(url, null, data);
}
...
function forExcel(){
	...
	L5.dataset2excel(ds, "/jsp/cams/marry/query/marry/newMarryAvgAge/exportAvgAgeExcel.jsp?statisticsTime="+statisticsTime);
}