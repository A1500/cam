...
<model:datasets>
	<model:dataset id="ds"
		cmd="com.inspur.cams.marry.query.marry.cmd.MarryAgeGapQueryCmd" global="true" method="query"
		autoLoad="false">
		<model:record>
...
<next:ViewPort>
	...
	<next:Panel width="100%" border="0"
		...
		<next:TabPanel>
			<next:Tabs>
				<next:Panel  id="dataPanel" title="结婚登记男女年龄差统计表" bodyStyle="background-color:#EAF4FD;padding-bottom:10px;padding-top:12px;" height="100%" autoScroll="true">
					<next:Html>
			...
			<table style="border-style: hidden; width: 90%" cellpadding="0" cellspacing="0"
				...
				<next:Panel id= "highcharts" title="结婚登记男女年龄差统计表（图表）" height="100%" autoScroll="true" bodyStyle="background-color:#EAF4FD;padding-bottom:10px;padding-top:12px;">
					<next:Html>
