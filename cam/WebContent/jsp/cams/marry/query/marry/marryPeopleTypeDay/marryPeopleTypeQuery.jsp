...
<script type="text/javascript" src="marryPeopleTypeQuery.js"></script>
<style>
body {
...
<body>
<model:datasets> 
	<model:dataset id="ds" cmd="com.inspur.cams.marry.query.marry.cmd.MarryPeopleTypeDayQueryCmd" global="true" method="query" autoLoad="false">
		<model:record>
	...
	<next:Panel width="100%" border="0" bodyStyle="background-color:#EAF4FD;padding-bottom:10px;padding-top:12px;" height="100%" autoScroll="true">
		<next:Html>
			...
			<div align="center"><span id="reportTitle"
				style="font-size: large;">结婚登记统计总表(日报表)</span></div>
			</div>
