...
function queryNextLevel(value){
	...
	data.put("xzqu", xzqu);
	data.put("pageflag","1");
	var url = "jsp/cams/marry/query/marry/marryPeopleDay/marryPeopleDayNext.jsp";
...
function forExcel(){
	...
	L5.dataset2excel(ds, "/jsp/cams/marry/query/marry/marryPeopleDay/exportMarryPeopleDayExcel.jsp?statisticsTime="+statisticsTime);
}