...
function back() {
	if(pageflag=='1'){
		...
		var url = "jsp/cams/marry/query/marry/marryPeopleDay/marryPeopleDay.jsp";
		L5.forward(url, null, data);
	}else{
		history.go(-1);
	}
...
function forExcel(){
	...
	L5.dataset2excel(dsNext, "/jsp/cams/marry/query/marry/marryPeopleDay/exportMarryPeopleDayExcel.jsp?statisticsTime="+statisticsTime);
}