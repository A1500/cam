...
<%
	...
	String name="复婚平均年龄统计表_"+date;
	String username=GetBspInfo.getBspInfo(request).getUserName();
%>
</head>
<Excel:tablelist filename="<%=name %>">
	<Excel:table sheetname="复婚平均年龄统计表">
		<Excel:tr>
			<Excel:td colspan="5" align="center" ><Excel:font size="15">复婚平均年龄统计表</Excel:font></Excel:td>
		</Excel:tr>
		<Excel:tr>
		...
		<Excel:tr height="30" bgcolor="grey" border="1">
			...
			<Excel:td  align="center" width="200" rowspan="2" bordercolor="black">复婚登记人数</Excel:td>			
			<Excel:td  align="center" width="200" colspan="3" bordercolor="black">复婚平均年龄</Excel:td>
		</Excel:tr>
