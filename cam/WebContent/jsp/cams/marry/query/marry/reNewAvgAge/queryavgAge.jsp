...
<model:datasets>
	<model:dataset id="ds"
		cmd="com.inspur.cams.marry.query.marry.cmd.ReNewAvgAgeQueryCmd"
	...
	<next:Panel width="100%" border="0"
		...
		<next:Html>
			...
			<div align="center"><span id="reportTitle"
				style="font-size: large;">复婚平均年龄统计表</span></div>
			</div>
					...
					<table width="100%" dataset="ds" align="center">
						<tbody id="resultsBody">
							<tr>
								...
								区划名称</td>
								<td class="tdTitle" width="4%" align="center" rowspan="2">复婚登记人数</td>
								<td class="tdTitle" width="4%" align="center" colspan="3">复婚平均年龄
								</td>
							</tr>
							<tr>
