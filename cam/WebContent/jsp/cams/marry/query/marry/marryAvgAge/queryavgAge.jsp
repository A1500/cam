...
<model:datasets>
	<model:dataset id="ds"
		cmd="com.inspur.cams.marry.query.marry.cmd.MarryAvgAgeQueryCmd" global="true" method="query"
		autoLoad="false">
		<model:record>
	...
	<next:Panel width="100%" border="0"
		...
		<next:Html>
			...
			<div align="center"><span id="reportTitle"
				style="font-size: large;">结婚登记当事人平均年龄统计表</span></div>
			</div>
			...
			<table style="border-style: hidden; width: 90%" cellpadding="0" cellspacing="0"
				border="0">
				 <tr>
					...
					<td colspan="2" style="border-width: 0px">
					<div align="right"><span class= "btTitle">统计时间：<label id="statisticsTime" style="font-size: small;"></span></div>
				</tr>
				<tr >
					...
					<table width="100%" dataset="ds" align="center" >
						...
						<tr>
							...
							<td class="tdTitle" width="4%" align="center" rowspan="2">结婚登记对数</td>
							<td class="tdTitle" width="4%" align="center" colspan="3" >结婚登记当事人平均年龄</td>
						</tr>
						<tr>
