...
<script type="text/javascript" src="queryavgAge.js"></script>
<style>
body {
...
<model:datasets>
	<model:dataset id="ds"
		cmd="com.inspur.cams.marry.query.marry.cmd.ReMarryAvgAgeQueryCmd"
	...
	<next:Panel width="100%" border="0"
		...
		<next:Html>
			...
			<div align="center"><span id="reportTitle"
				style="font-size: large;">再婚平均年龄统计表</span></div>
			</div>
				...
				<tr>
					...
					<table width="100%" dataset="ds" align="center">
						<tbody id="resultsBody">
							<tr>
								<td class="tdTitle" width="8%" align="center" rowspan="2">地区行政<br>
								区划名称</td>
								<td class="tdTitle" width="4%" align="center" rowspan="2">再婚登记人数</td>
								<td class="tdTitle" width="4%" align="center" colspan="3">再婚平均年龄
								</td>
							</tr>
							<tr>
							...
							<tr repeat="true">
								<td align="center"><a href="#"><label
									style="width: 50px;" field="ITEM_NAME"
									onclick="queryNextLevel(this)" /></label><label style="display: none;"
									field="ITEM_CODE" /></label></a></td>
								<td align="right" style="padding-right: 2px"><label style="width: 50px; height: 20px;"
									field="TOTAL_NUM" /></label></td>
								<td align="right" style="padding-right: 2px"><label style="width: 50px; height: 20px;"
									field="TOTAL_AVG" /></label></td>
								<td align="right" style="padding-right: 2px"><label style="width: 50px; height: 20px;"
									field="MAN_AVG" /></label></td>
								<td align="right" style="padding-right: 2px"><label style="width: 50px; height: 20px;"
									field="WOMAN_AVG" /></label></td>
							</tr>
						</tbody>
					</table>
					</td>
