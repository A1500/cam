...
<model:datasets>
	<model:dataset id="ds"
		cmd="com.inspur.cams.marry.query.marry.cmd.MarryAgeGroupQueryCmd" global="true" method="query"
		autoLoad="false">
		<model:record>
...
<next:ViewPort>
	...
	<next:Panel width="100%" border="0"
		...
		<next:TabPanel>
			<next:Tabs>
				<next:Panel id="dataPanel" title="结婚登记分年龄段统计表" bodyStyle="background-color:#EAF4FD;padding-bottom:10px;padding-top:12px;" height="100%" autoScroll="true">
					<next:Html>
						<div align="center" id="reDiv" style="display: none;">
						<div align="center" style="width: 90%;">
						<div align="center"><span id="reportTitle"
							style="font-size: large;">结婚登记分年龄段统计表</span></div>
						</div>
				...
				<next:Panel id= "highcharts" title="结婚登记分年龄段统计表（图表）" width="100%" height="100%" autoScroll="true" bodyStyle="background-color:#EAF4FD;padding-bottom:10px;padding-top:12px;">
					<next:Html>
