...
<script type="text/javascript" src="marryPeopleMonth.js"></script>
<style>
body {
...
<body>
<model:datasets> 
	<model:dataset id="ds" cmd="com.inspur.cams.marry.statisticMonth.cmd.MarryPeopleMonthQueryCommand" global="true" pageSize="100">
				...
				<tr >
					...
					<table width="99.9%" dataset="ds" align="center" >
						...
						<tr>
							...
							<td class="tdTitle" width="2%" align="center" colspan="12">结婚登记对数</td>
						</tr>
						<tr>
