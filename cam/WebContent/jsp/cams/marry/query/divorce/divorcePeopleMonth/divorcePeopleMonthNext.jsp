...
<script type="text/javascript" src="divorcePeopleMonthNext.js"></script>
<style>
body {
...
<body>
<model:datasets>
	<model:dataset id="dsNext" cmd="com.inspur.cams.divorce.statisticMonth.cmd.DivorcePeopleMonthQueryCommand" global="true"  autoLoad="false">
				...
				<tr>
					...
					<table width="100%" dataset="dsNext" align="center">
					   ...
					   <tr>
							...
							<td class="tdTitle" width="80%" align="center" colspan="12"  >按月份分类(离婚对数)</td>
						</tr>
						<tr>
