...
function back() {
	if(pageflag=='1'){
		var data = new L5.Map();
		data.put("cxsjq",cxsjq);
		var url = "jsp/cams/marry/query/divorce/divorcePeopleMonth/divorcePeopleMonth.jsp";
		L5.forward(url, null, data);
	}else{
		history.go(-1);
	}
...
function forExcel(){
	...
	L5.dataset2excel(dsNext, "/jsp/cams/marry/query/divorce/divorcePeopleMonth/exportDivorcePeopleMonthExcel.jsp?statisticsTime="+statisticsTime);
}