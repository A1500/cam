...
function queryNextLevel(value){
	...
	data.put("xzqu", xzqu);
	data.put("pageflag","1");
	var url = "jsp/cams/marry/query/divorce/job/job_query.jsp";
...
function CheckTxt(ObjNum)
 ...
 function forExcel(){
	...
	L5.dataset2excel(ds, "/jsp/cams/marry/query/divorce/job/exportjobExcel.jsp?statisticsTime="+statisticsTime);
}