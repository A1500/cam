...
<script type="text/javascript" src="divorcePeopleDayNext.js"></script>
<style>
body {
...
<body>
<model:datasets>
	<model:dataset id="dsNext" cmd="com.inspur.cams.divorce.statisticDay.cmd.DivorcePeopleDayQueryCommand" global="true"  autoLoad="false">
		<model:record fromBean="com.inspur.cams.divorce.statisticDay.dao.DivorcePeopleDay"></model:record>
	</model:dataset>
</model:datasets>
<next:ViewPort>
				...
				<tr>
					...
					<table width="100%" dataset="dsNext" align="center">
					   ...
					   <tr>
							...
							<td class="tdTitle" width="80%" align="center" colspan="31"  >按日期分类(离婚对数)</td>
						</tr>
						<tr>
