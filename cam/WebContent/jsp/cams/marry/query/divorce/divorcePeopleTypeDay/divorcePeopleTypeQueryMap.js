...
function initQueryTime(){
	if(cxsjq!='null'&&cxsjz!='null'){
		...
		document.getElementById("cxsjq").value=date.getFullYear()+"-01"+"-01";//查询开始时间
...
function queryNextLevel(value){
	...
	data.put("xzqu", xzqu);
	data.put("pageflag","1");
	var url = "jsp/cams/marry/query/divorce/divorcePeopleTypeDay/divorcePeopleTypeNextLevel.jsp";
