...
<body>
<model:datasets> 
	<model:dataset id="ds" cmd="com.inspur.cams.marry.query.divorce.cmd.DivorcePeopleTypeDayQueryCmd" global="true" method="query" autoLoad="false">
		<model:record>
		...
		<next:Html>
			...
			<table border="1" width="100%">
				<tr>
					...
					<input type="text"  id = "cxsjq" 
						format="Y-m-d" onclick="LoushangDate(this)" name="出生日期"/>------
					<input type="text"  id = "cxsjz" 
	...
	<next:Panel width="100%" border="0" bodyStyle="background-color:#EAF4FD;padding-bottom:10px;padding-top:12px;" height="100%" autoScroll="true">
		<next:Html>
			...
			<div align="center"><span id="reportTitle"
				style="font-size: large;">离婚登记统计总表(日报表)</span></div>
			</div>
