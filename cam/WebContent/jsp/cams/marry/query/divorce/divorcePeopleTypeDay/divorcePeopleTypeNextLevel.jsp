...
<script type="text/javascript" src="divorcePeopleTypeNextLevel.js"></script>
<style>
body {
...
<body>
<model:datasets>
	<model:dataset id="dsNext" cmd="com.inspur.cams.marry.query.divorce.cmd.DivorcePeopleTypeDayQueryCmd"
