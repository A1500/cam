...
<%
	...
	String name="离婚登记统计总表_"+date;
	String username=GetBspInfo.getBspInfo(request).getUserName();
%>
</head>
<Excel:tablelist filename="<%=name %>">
	<Excel:table sheetname="离婚登记统计总表">
		<Excel:tr>
			<Excel:td colspan="13" align="center" ><Excel:font size="15">离婚登记统计总表</Excel:font></Excel:td>
		</Excel:tr>
		<Excel:tr>
		...
		<Excel:tr height="30" bgcolor="grey" border="1">
			...
			<Excel:td  align="center" width="100" rowspan="3" bordercolor="black">离婚登记对数</Excel:td>			
		...
		<Excel:tr border="1">
			...
			<Excel:td align="right"><%=rec.get("MAINLAND_NUM")%></Excel:td>			
			<Excel:td align="right"><%=rec.get("FOREIGNER_NUM")%></Excel:td>
			<Excel:td align="right"><%=rec.get("FOREIGNER_WOMAN_NUM")%></Excel:td>
			<Excel:td align="right"><%=rec.get("HK_NUM")%></Excel:td>
			<Excel:td align="right"><%=rec.get("HK_WOMAN_NUM")%></Excel:td>
			<Excel:td align="right"><%=rec.get("MO_NUM")%></Excel:td>
			<Excel:td align="right"><%=rec.get("MO_WOMAN_NUM")%></Excel:td>
			<Excel:td align="right"><%=rec.get("TW_NUM")%></Excel:td>
			<Excel:td align="right"><%=rec.get("TW_WOMAN_NUM")%></Excel:td>
			<Excel:td align="right"><%=rec.get("HQ_NUM")%></Excel:td>
			<Excel:td align="right"><%=rec.get("HQ_WOMAN_NUM")%></Excel:td>
		</Excel:tr>
		<%
			}
		%>
