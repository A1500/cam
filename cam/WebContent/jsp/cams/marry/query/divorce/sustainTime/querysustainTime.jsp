...
<script type="text/javascript" src="querysustainTime.js"></script>
<style>
body {
...
<next:ViewPort>
	...
	<next:Panel width="100%" border="0"
		...
		<next:TabPanel>
			<next:Tabs>
				<next:Panel id="dataPanel" title="婚姻维系时间统计表" bodyStyle="background-color:#EAF4FD;padding-bottom:10px;padding-top:12px;" height="100%" autoScroll="true">
					<next:Html>
							...
							<tr >
								...
								<table width="100%" dataset="ds" align="center" id = "sourceTable" >
									...
									<tr>
										...
										<td class="tdTitle" width="2%" align="center" colspan="2" >1年和1年以内</td>
