...
<model:datasets>
	<model:dataset id="ds"
		cmd="com.inspur.cams.marry.query.divorce.cmd.DivorceAvgAgeQueryCmd" global="true" method="query"
		autoLoad="false">
		<model:record>
	...
	<next:Panel width="100%" border="0"
		...
		<next:Html>
			...
			<div align="center"><span id="reportTitle"
				style="font-size: large;">离婚登记当事人平均年龄统计表</span></div>
			</div>
				...
				<tr >
					...
					<table width="100%" dataset="ds" align="center" >
						...
						<tr>
							...
							<td class="tdTitle" width="4%" align="center" rowspan="2">离婚登记对数</td>
							<td class="tdTitle" width="4%" align="center" colspan="3" >离婚登记当事人平均年龄</td>
						</tr>
						<tr>
