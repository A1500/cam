...
function query() {
	var cxsjq_y = document.getElementById("cxsjq_y").value;//查询开始年份
    var cxsjz_y = document.getElementById("cxsjz_y").value;//查询结束年份
    var cxsjq_m = document.getElementById("cxsjq_m").value;//查询开始月
    var cxsjz_m = document.getElementById("cxsjz_m").value;//查询结束月
    if(cxsjq_y=="") {
...
function queryNextLevel(value){
	...
	data.put("xzqu", xzqu);
	data.put("pageflag","1");
	var url = "jsp/cams/marry/query/divorce/degree/degree_query.jsp";
...
function forExcel(){
	...
	L5.dataset2excel(ds, "/jsp/cams/marry/query/divorce/degree/exportdegreeExcel.jsp?statisticsTime="+statisticsTime);
}