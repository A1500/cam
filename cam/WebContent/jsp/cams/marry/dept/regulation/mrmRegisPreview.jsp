...
var id='<%=request.getParameter("deptCode")%>';
/**
本方法 以实例的方式，约定说明模板、标签和数据的格式
**/
function init(){  
	var nowFileName = rootPath+"download?table=MRM_REGIS_ORGAN_INFO&column=REGULATION&pk=DEPT_CODE&filename=FILE_NAME&DEPT_CODE='"+id+"'";
