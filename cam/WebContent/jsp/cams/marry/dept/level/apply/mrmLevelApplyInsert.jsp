...
<script type="text/javascript" src="mrmLevelApplyInsert.js"></script>
<style type="text/css">
<!--
@media print {
...
<next:Panel>
	...
	<next:TabPanel id="tabp">
		<next:Tabs>
			<next:Panel title="等级评定申报表" autoHeight="true" id="ptab">
				<next:TopBar>
					<next:ToolBarItem symbol="->" ></next:ToolBarItem> 
					...
					<form id="editForm"  dataset="ds" onsubmit="return false" style="padding:20px;" class="L5form">
						<table border="1"  width="700" align="center" class="noprint">
							...
							<tr>
								...
								数据量共[  <span id="blNum" field="blNum" style="font-size: 14px;"></span>   ]条
							...
							<tr>
								<td colspan="3" align="right"><%=organName %>
								</td>
							</tr>
							<tr>
			...
			<next:GridPanel id="uploadGrid" title="上传证明材料" height="70%" stripeRows="true" dataset="mrmElectronicDataSet" notSelectFirstRow="true">
				<next:TopBar>
					<next:ToolBarItem symbol="->"></next:ToolBarItem>
