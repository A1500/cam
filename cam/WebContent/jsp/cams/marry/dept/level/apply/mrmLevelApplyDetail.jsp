...
<script type="text/javascript" src="mrmLevelApplyDetail.js"></script>
<style type="text/css">
<!--
label {
	font-size: 17px;
...
<next:Panel>
	...
	<next:TabPanel>
		<next:Tabs>
			<next:Panel title="等级评定申报表" autoHeight="true">
			<next:TopBar>
					<next:ToolBarItem symbol="->" ></next:ToolBarItem> 
						...
						<table border="1"  width="700" align="center" class="noprint">
							<tr>
								<td colspan="4" align="center">
									...
									申 报 等 级：
									<label field="applyLevel" id="applyLevel" dataset="evaluLevelDataSet" style="font-size: 17px;width: 280px"></label><br><br>
									申 报 时 间：
							...
							<tr>
								...
								数据量共[  <span field="dataNum" style="font-size: 14px;"></span>   ]条
								</td>
							</tr>
							<tr>
			...
			<next:GridPanel id="uploadGrid" dataset="mrmElectronicDataSet" title="上传证明材料" height="70%">
				<next:Columns>
