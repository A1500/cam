...
<script type="text/javascript" src="mrm_level_apply.js"></script>
<style type="text/css">
<!--
@media print {
			...
			<table border="1"  width="700" align="center" class="noprint">
				<tr>
					<td colspan="4" align="center">
						...
						申 报 单 位： <label field="deptName" style="font-size: 20px;text-decoration: underline">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><br><br>
						...
						申 报 时 间：
						<input type="text" id="creatDate"  title="成立日期" format="Y-m-d"  style="width: 280px;font-size: 17px;"/>
				...
				<tr>
					<td colspan="3" align="right">(单位盖章)
					</td>
				</tr>
				<tr>
					<td colspan="3" align="right"> 年    月    日
					</td>
				</tr>
				...
				<tr>
					<td rowspan="4" align="center">省级人民政府<br>民政部门<br>意见</td><td colspan="3">
					</td>
				</tr>
				<tr>
					<td colspan="3"></td>
