...
String applyType=MrmApplyType.MRM_RECTIFICATION;
...
<script type="text/javascript" src="mrmLevelRectification.js"></script>
<style type="text/css">
<!--
label {
	font-size: 17px;
...
<model:datasets>
	<model:dataset id="applyDs" cmd="com.inspur.cams.marry.base.cmd.MrmOrganStandardApplyQueryCommand" global="true">
		<model:record fromBean="com.inspur.cams.marry.base.data.MrmOrganStandardApply">
			...
			<model:field name="correctContent" type="string" rule="require|length{500}" />
			<model:field name="correctResult" type="string" rule="require|length{500}" />
		</model:record>
	</model:dataset>	
...
<next:Panel>
  <next:TopBar>
	...
	%>
     	<next:ToolBarItem iconCls="select"  text="同意整改" handler="submitEnd"/>
     	<next:ToolBarItem iconCls="select"  text="不同意整改" handler="cancelEnd"/>
    <%
		} 
	%>
  ...
  <next:TabPanel>
     <next:Tabs>
        <next:Panel autoHeight="true" title="婚姻登记机关整改情况报告">
	       <next:Html>
						...
						<table border="1"  width="700" align="center" class="noprint">
							<tr>
								<td colspan="4" align="center">
									<br><br>
									<font size="5" style="">婚姻登记机关整改情况报告</font><br><br><br><br><br>
								
									<div align="left">
									<p align="left" style='text-indent: 100.0pt' >
									整 改 单 位： <label field="organName" style="font-size: 20px;text-decoration: underline">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><br><br>
									</p>
									<p align="left" style='text-indent: 100.0pt' >
									现 有 等 级：
									...
									<p align="left" style='text-indent: 100.0pt' >
									报 告 单 位： <label field="cancelOrganName" style="font-size: 20px;text-decoration: underline">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><br><br>
								</p>
									<p align="left" style='text-indent: 100.0pt' >
									报 告 时 间：
										...
										%>
										<input type="text" id="creatDate" field='applyTime'  name="报 告 时 间" format="Y-m-d"  
										style="font-size: 17px;" readonly="readonly" onclick="LoushangDate(this)"/> 
										<%
										}else{
										%>	
											<label field="applyTime"/>
										<%
										} 
										%>
									<br><br>
						    ...
						    <tr>
								<td align="center" width="25%">整改单位名称</td>
								<td width="40%"> <label field="organName" style="font-size: 17px"></label></td>
								<td width="20%" align="center">整改单位等级</td>
								<td width="15%"> <label   field="applyLevel"  style="font-size: 17px"  dataset="evaluLevelDataSet"></label>
								</td>
							</tr>
							 <tr>
								<td align="center" width="25%">通知整改单位</td>
								<td width="40%"> 
										<%
										if("INSERT".equals(method) || "UPDATE".equals(method)){
										%>
										<select field='correctOrganLevel' style="font-size: 17px;">
											<option value="" >请选择……</option>
											<option value="12" >市民政局</option>
											<option value="11" >省民政厅</option>
										</select> 
										<%
										}else{
										%>	
											<label field="correctOrgan" style="font-size: 17px;"/>
										<%
										} 
										%>
								</td>
								<td width="20%" align="center">通知整改时间</td>
								<td width="15%"> 
									 	<%
										if("INSERT".equals(method) || "UPDATE".equals(method)){
										%>
										<input type="text"  field='correctDate'  name="通知整改时间" format="Y-m-d"  
									 		readonly="readonly"style="font-size: 17px;" onclick="LoushangDate(this)"/> 
										<%
										}else{
										%>	
											<label field="correctDate" style="font-size: 17px;"/>
										<%
										} 
										%>
								</td>
							 ...
							 <tr>
								<td align="center"  >整改时间</td>
								<td colspan="3"> 
										<%
										if("INSERT".equals(method) || "UPDATE".equals(method)){
										%>
										<input type="text"  field='startLine'  name="整改开始时间" format="Y-m-d"  
									 		readonly="readonly"style="font-size: 17px;" onclick="LoushangDate(this)"/> 
									 		至 
									 	<input type="text" field='deadLine'  name="整改结束时间" format="Y-m-d"  
									 		readonly="readonly"style="font-size: 17px;" onclick="LoushangDate(this)"/>
										<%
										}else{
										%>	
										<table style="border-left:0px;border-top:0px;border-right:0px;border-bottom:0px">
											<tr>
												<td style="border-left:0px;border-top:0px;border-right:0px;border-bottom:0px">
												<label field="startLine" style="font-size: 17px;"/>
												</td>
												<td style="border-left:0px;border-top:0px;border-right:0px;border-bottom:0px">
													至<label field="deadLine" style="font-size: 17px;width:120px"/>
												</td>
											</tr>
										</table>
										<%
							...
							<tr>
							    <td rowspan="5" align=center>整改内容</td>
							</tr>
							<tr>
								<td colspan="3" >
									<%
									if("INSERT".equals(method) || "UPDATE".equals(method)){
									%>
										<textarea id="reason" field="correctContent" name="整改内容" style="font-size:17px;width:100%;overflow:hidden;border:0" rows="6" 
										></textarea>
									<%
									}else{
									%>	
										<textarea field="correctContent" readonly="readonly" name="整改内容" style="font-size:17px;width:100%;overflow:hidden;border:0" rows="6" 
										></textarea>
									<%
									} 
									%>
							...
							<tr>&nbsp;</tr><tr>&nbsp;</tr><tr>&nbsp;</tr><tr>&nbsp;</tr>
								...
								<tr>
							    <td rowspan="5" align=center>整改结果</td>
							</tr>
							<tr>
								<td colspan="3" >
									...
									if("INSERT".equals(method) || "UPDATE".equals(method)){
									%>
										<textarea   field="correctResult" name="整改结果" style="font-size:17px;width:100%;overflow:hidden;border:0" rows="6" 
									></textarea>
									<%
									}else{
									%>	
									<textarea   field="correctResult" readonly="readonly" name="整改结果" style="font-size:17px;width:100%;overflow:hidden;border:0" rows="6" 
									></textarea>
									<%
									} 
									%>
							...
							<tr>&nbsp;</tr><tr>&nbsp;</tr><tr>&nbsp;</tr><tr>&nbsp;</tr>
							<tr>
								<td rowspan="4"  align="center">地市级人民政府<br>民政部门意见</td>
								<td colspan="3">
								<%
									if("12".equals(organType) && "true".equals(handle) ){
									%>
									<select id="cityOpinionId" name="地市级人民政府民政部门意见" field="cityOpinionId" style="font-size:17px;width:200px">
