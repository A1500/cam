...
<script type="text/javascript" src="mrmLevelCancelDetail.js"></script>
</head>
<body>
<model:datasets>
	...
	<next:Panel title="婚姻登记机关列表" width="100%" height="100%">
			<next:GridPanel id="gridanel" title="婚姻登记机关列表"
				...
				<next:TopBar>
				    ...
				    <next:ToolBarItem iconCls="add" text="填写撤销报告" handler="newCancel" />
				</next:TopBar>
				<next:Columns>
...
<next:Panel id="panel1" width="100%" height="100%"  title="待办业务列表">
	<next:Panel border="0">	
		<next:Html><center>		
				...
				<div>
					<form style="width: 98%; height: 100%;" class="L5form">
						<table  border="0" width="100%">
							<tr>
							 	<td class="FieldLabel" style="width:10%">撤销等级资格单位</td>
				                <td class="FieldInput" style="width:20%"><input id="curOrganName1" style="width:80%"/></td>
				                <td class="FieldLabel" style="width:10%">申报时间</td>
	...
	<next:GridPanel id="gridPanel" title="等级评定撤销申报列表" dataset="applyDataSet" stripeRows="true" notSelectFirstRow="true" height="100%">
		<next:TopBar>		
			<next:ToolBarItem symbol="->"></next:ToolBarItem>
		...
		<next:Columns>
			<next:RowNumberColumn/>
			<next:RadioBoxColumn/>
		    <next:Column header="撤销等级资格单位" field="organName" width="200"  ></next:Column>
		    <next:Column header="撤销等级" field="applyLevel" width="120" dataset="evaluLevelDataSet"></next:Column>
...
<next:Panel id="panel2" width="100%" height="100%"  title="已办业务列表">
	<next:Panel border="0">	
		<next:Html><center>		
			<fieldset  style="width:98%;overflow: visible;" class="GroupBox">
				<legend class="GroupBoxTitle">
	...
	<next:GridPanel id="gridEndPanel" title="等级评定撤销申报列表" dataset="applyEndDataSet" stripeRows="true" notSelectFirstRow="true" height="100%">
		<next:TopBar>		
			<next:ToolBarItem symbol="->"></next:ToolBarItem>
