...
<script type="text/javascript" src="mrmLevelReCheckList.js"></script>
...
<next:Panel width="100%" height="100%">
	...
	<next:GridPanel id="gridPanel" title="等级评定申报列表" dataset="applyDataSet" stripeRows="true" notSelectFirstRow="true" height="100%">
		<next:TopBar>		
		...
		<next:Columns>
			...
			<next:Column header="申报时间" field="applyTime" width="120" renderer="renderTime" ></next:Column>
