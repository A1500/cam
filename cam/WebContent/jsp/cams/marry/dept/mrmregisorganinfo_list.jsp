...
<html>
	<head>
		...
		<next:ScriptManager/>
		<script type="text/javascript" src="mrmregisorganinfo_list.js"></script>
	...
	<next:Html>
		...
		<table border="1" width="100%">
			...
			<tr>
				...
				<td class="FieldInput">
					<select id="types" title="机构性质" style="width: 250px;"><option dataset="jgxzDs" ></option></select>
				</td>
...
<next:GridPanel id="editGridPanel" name="mrmregisorganinfoGrid" width="100%" stripeRows="true" height="400" dataset="ds" title="登记机关信息表">
	<next:TopBar>
		...
		<next:ToolBarItem text="查看" iconCls="detail" handler="queryDetails"/>
		<next:ToolBarItem symbol=""></next:ToolBarItem>
		<next:ToolBarItem symbol="-"></next:ToolBarItem>
		<next:ToolBarItem symbol=""></next:ToolBarItem>
	</next:TopBar>
	<next:Columns>
		...
		<next:Column id="types" header="机构性质" field="types" width="130" renderer="jgxzRenderer" sortable="true">
			<next:TextField />
		</next:Column>
