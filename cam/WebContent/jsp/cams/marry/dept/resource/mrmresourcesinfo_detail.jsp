...
<html>
	<head>
		<title>资源信息表明细</title>
		<next:ScriptManager/>
		<script type="text/javascript" src="mrmresourcesinfo_detail.js"></script>
	...
	<next:Html>
		...
		<table border="1"  width="100%" >
	   		...
	   		<tr>
				...
				<td class="FieldInput"><label field="resourceId" /> </td>
	   		...
	   		<tr>
				...
				<td class="FieldInput"><label field="resourceName" /> </td>
			
				<td  class="FieldLabel" >数量</td>
				<td class="FieldInput"><label field="resourceNum" /> </td>
			</tr>			
		</table>
		</form>
   </next:Html>
