...
<script type="text/javascript" src="bpttestedDetail.js"></script>
</head>
<body>
<model:datasets>
	...
	<model:dataset id="RelationshipTypeDataset"
		enumName="RELATIONSHIP.TYPE" autoLoad="true" global="true"></model:dataset>
	<!-- 性别 -->
	...
	<!-- 婚姻状况 -->
	<model:dataset id="MarriageDataset" enumName="MARRIAGE.STATE"
		autoLoad="true" global="true"></model:dataset>
	<!-- 政治面貌 -->
	<model:dataset id="PoliticalDataset" enumName="POLITICAL.LANDSCAPE"
		autoLoad="true" global="true"></model:dataset>
	<!-- 户籍类别 -->
	<model:dataset id="DomicileDataset" enumName="DOMICILE.TYPE"
		autoLoad="true" global="true"></model:dataset>
	<!-- 医疗保障方式 -->
	<model:dataset id="SafeguardDataset" enumName="COMM.MEDICAL_STATUS"
		autoLoad="true" global="true"></model:dataset>
	<!-- 职业 -->
	...
	<next:Html>
		...
		<table border="0" width="100%" align="left">
			...
			<tr>
				...
				<td class="FieldInput"><label name="testedType"
					field="testedType" dataset="dsTest" /></td>
				<td class="FieldLabel">职业健康检查：</td>
				<td class="FieldInput"><label name="isHealthFlag"
					field="isHealthFlag" dataset="dsHestth" /></td>
				<td class="FieldLabel">健康状况：</td>
				<td class="FieldInput"><label name="healthStateCode"
					field="healthStateCode" dataset="dsHealth" /></td>
			</tr>
			<tr>
				...
				<td class="FieldInput"><label name="workAbilityCode"
					field="workAbilityCode" dataset="WorkAbilityCodeEnum" /></td>
			</tr>
			<tr>
				<td class="FieldLabel">生活状况：</td>
				<td class="FieldInput"><label name="lifeStateCode"
			...
			<tr>
				...
				<td class="FieldInput"><label name="disabilityLevelCode"
					field="disabilityLevelCode" dataset="DisabilityLevelDataset" /></td>

				<td class="FieldLabel">先天性残疾子女数：</td>
				<td class="FieldInput" colspan="3"><label name="disabilityNum"
					field="disabilityNum" /></td>

			</tr>
			<tr>
				<td class="FieldLabel">身份认定依据：</td>
				<td class="FieldInput" colspan="5"><label name="identityBasis"
					field="identityBasis" /></td>
			</tr>
			<tr>
