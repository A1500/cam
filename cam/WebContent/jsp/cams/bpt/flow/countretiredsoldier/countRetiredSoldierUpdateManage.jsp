...
<next:Panel autoHeight="true"   bodyStyle="width:100%" width="100%">
	<next:TabPanel id="tabPanel">
		...
		<next:Panel title="类别信息" width="100%" height="100%" id="countretiredsoldierTabPanel">
				<next:Html>
				  <iframe id="countretiredsoldierTabPanelFrame" src="../../dataCollection/bptcountretiredsoldier/bptcountretiredsoldierEdit.jsp?peopleId='<%=request.getParameter("peopleId")%>'"
		...
		<next:Panel title="电子档案" width="100%" height="100%"
				id="uploadTabPanel">
				<next:Html>
				  <iframe id="upload" src="../../comm/uploadfile.jsp?peopleId=<%=request.getParameter("peopleId")%>&serviceType=81&applyId=<%=request.getParameter("applyId")%>"
						frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="100%">
	   				</iframe>
				</next:Html>
		</next:Panel>
		<next:Panel title="公示书" width="100%" height="100%"
				id="publicityDoc">
				<next:Html>
				  <iframe id="countrySoldierApproveFrame" src="openSoldierUpdate.jsp?peopleId=<%=request.getParameter("peopleId")%>&applyId=<%=request.getParameter("applyId")%>"
						frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="100%">
	   				</iframe>
				</next:Html>
		</next:Panel>
		...
		<next:Panel title="县级审批" width="100%" height="100%"
				...
				<next:Html>
				  <iframe id="countrySoldierTownApproveFrame" src="townApprovedEdit.jsp?peopleId=<%=request.getParameter("peopleId")%>&applyId=<%=request.getParameter("applyId")%>&serviceType=81"
						frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="100%">
	   				</iframe>
				</next:Html>
		</next:Panel>
