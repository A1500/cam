...
<body>
<model:datasets>
	<model:dataset id="RetiredSoldierDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptCountRetiredSoldierQueryCommand" global="true" method="queryIngoingBptRetiredSoldier">
...
<next:Panel autoHeight="true" width="99%">
	<next:Html>
...
<script type="text/javascript">
	function init() {	
	 ...
	 RetiredSoldierDataSet.setParameter("applyId",applyId);
