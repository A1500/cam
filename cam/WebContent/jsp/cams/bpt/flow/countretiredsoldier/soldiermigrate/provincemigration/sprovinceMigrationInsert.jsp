...
<html>
<head>
<title>添加年满60周岁农村籍退役士兵定补关系省内迁移</title>
<next:ScriptManager />
<script type="text/javascript" src="sprovinceMigrationInsert.js"></script>
...
<model:datasets>
	<!-- 人员信息 -->
	<model:dataset id="ProvinceMigrationDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptApplyCountrySoldierQueryCommand" method="queryByIdCard" global="true">
