...
<html>
	<head>
		...
		<script type="text/javascript" src="countretiredsoldierInsert.js"></script>
				...
				<next:Html>
					...
					<table border="0" width="98%">
						...
						<tr>
							...
							<td class="FieldInput" >
							   <select name="domicileType" id="domicileType" field="domicileType" title="户籍类别" onchange="func_Type()">
