...
<next:ScriptManager />
		<script>
			...
			var processId = '<%=request.getParameter("processId")== null ?"":request.getParameter("processId")%>';
			var peopleId= '<%=request.getParameter("peopleId") == null?"":request.getParameter("peopleId")%>';
		</script>
</head>
<body>
<model:datasets>
