function init() {
	var DependantIntoProviDataSet = L5.DatasetMgr.lookup("DependantIntoProviDataSet");
	DependantIntoProviDataSet.setParameter("organCode", organCode);
	DependantIntoProviDataSet.load();
	L5.QuickTips.init();
}
