...
<model:datasets>
	<!-- 三属抚恤关系跨省迁出【未提交】 -->
	<model:dataset id="DependantEmigratDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptApplyEmigrationQueryCommand" method="queryUncommitDependent" global="true">
	</model:dataset>
	<!-- 民族 -->
