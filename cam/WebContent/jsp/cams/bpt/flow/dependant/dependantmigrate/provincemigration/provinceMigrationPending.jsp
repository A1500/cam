...
<model:datasets>
	<!-- 三属人员省内迁移【未提交】 -->
	<model:dataset id="DependantEmigratDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptProvinceMigrateQueryCommand" method="queryUnCommiDependProEmigrate" global="true">
	</model:dataset>
	<!-- 民族 -->
...
<next:GridPanel id="editGridPanel" name="bptpetitionGrid"   stripeRows="true" width="100%" height="100%" dataset="DependantEmigratDataSet">
	<next:TopBar>
	...
	<next:BottomBar>
		<next:PagingToolBar dataset="DependantEmigratDataSet"/>
	</next:BottomBar>
</next:GridPanel>
