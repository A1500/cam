				...
				<next:Html>
					...
					<table border="1" width="98%">
						<tr>
							...
							<td class="FieldInput" style="width:15%"><label name="dependantTypeCode"
								field="dependantTypeCode" title="优抚对象类别" dataset="DependantTypeDataset">
							</td>

							<td class="FieldLabel" nowrap style="width:15%">与牺牲病故军人关系：</td>
							<td class="FieldInput" style="width:15%" colspan="3"><label name="relationship"
								field="relationship" title="与牺牲病故军人关系" dataset="RelationTypeEnum"/>
							</td>

							
						
						<!--  	<td class="FieldLabel" nowrap>优抚对象状态：</td>
							<td class="FieldInput"><label name="dependantStateCode"
								field="dependantStateCode" title="优抚对象状态" dataset="ObjectStateDataset"/>
							 </td>
							 -->
						</tr>
						<tr>
							<td class="FieldLabel" nowrap>原定期抚恤证编号：</td>
							<td class="FieldInput"><label   name="oldPaperNo" field="oldPaperNo" title="原定期抚恤证编号" /></td>
                          <!--   <td class="FieldLabel">批准日期：</td>
							<td class="FieldInput"><label   name="approvalDate" field="approvalDate" format="Y-m-d"  title="批准日期" /></td>
						  -->
						    <td class="FieldLabel" nowrap>是否正在上学：</td>
							<td class="FieldInput" colspan="3"><label name="studentFlag"
								field="studentFlag" title="是否正在上学" dataset="StudnetFlagEnum"/>
							</td>
						</tr>
						<tr>
							...
							<td class="FieldLabel" style="width:15%">是否孤儿：</td>
							<td class="FieldInput" style="width:15%"><label name="orphanFlag" field="orphanFlag" title="是否孤儿" dataset="OrphanFlagEnum"></label></td>
						...
						<tr>
							...
							<td class="FieldInput" colspan="5"><label   name="ingoingReason" field="ingoingReason"  title="迁入原因"/></td>
						</tr>
