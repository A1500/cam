...
<model:datasets>
	...
	<model:dataset id="DependantDataset" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleDependantQueryCommand" method="queryDependantInfo" global="true">
		<model:record fromBean="com.inspur.cams.bpt.base.data.BptPeopleDependant">
			...
			<model:field name="dependantStateCode" type="string" /> 
			...
			<model:field name="buryAddress" type="string" />
				...
				<next:Html>
					...
					<table border="1" width="98%">
						<tr>
							...
							<td class="FieldInput"><input type="text" name="idCard" field="idCard" title="身份证件号码" maxlength="18" style="width: 135" onchange="func_QueryIdCardAllMessage()" />
				...
				<next:Html>
					...
					<table border="1" width="98%">
						...
						<tr>
							...
							<td class="FieldLabel">出生日期：</td>
							<td class="FieldInput"><input type="text" name="lezswBirthday" field="lezswBirthday"style= "width:100px;" maxlength="10" format="Y-m-d" onpropertychange="changeDateStyle(this)"    title="出生日期"/><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)" ></td>

							<td class="FieldLabel">入伍（工作）时间：</td>
							<td class="FieldInput"><input type="text" name="conscriptDate" field="conscriptDate"style= "width:100px;" maxlength="10" onpropertychange="changeDateStyle(this)" format="Y-m-d"   title="入伍(工作)时间" /><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)" ></td>
						</tr>
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" name="deathDate" field="deathDate" format="Y-m-d" maxlength="10" onpropertychange="changeDateStyle(this)"  title="牺牲病故时间" style= "width:100px;"/><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)" ></td>
						</tr>
						...
						<tr>
							...
							<td class="FieldInput" ><input type="text" title="烈士（牺牲、病故军人）批准时间" name="lezswApproveDate" field="lezswApproveDate" format="Y-m-d"   onpropertychange="changeDateStyle(this)" style="width: 100px;" maxlength="10"/><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ></td>
							<td class="FieldLabel">安葬地点：</td>
							<td class="FieldInput"><input type="text" name="buryAddress" field="buryAddress" title="安葬地点"/></td>
