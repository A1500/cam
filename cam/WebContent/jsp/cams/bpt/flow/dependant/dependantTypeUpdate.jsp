				...
				<next:Html>
					...
					<table border="1" width="98%">
						...
						<tr>
							...
							<td class="FieldInput" ><input  type="text" title="烈士（牺牲、病故军人）批准时间" name="lezswApproveDate" field="lezswApproveDate" format="Y-m-d" style="width: 100px;" maxlength="10" onpropertychange="changeDateStyle(this)" /><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ></td>
						...
						<tr>
							...
							<td class="FieldInput" ><input type="text" name="accountCode" field="accountCode" title="银行帐号" style="width:90%" ></input> </td>
						</tr>
