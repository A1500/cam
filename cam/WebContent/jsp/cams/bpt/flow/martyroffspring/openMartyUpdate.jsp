...
<script type="text/javascript" src="openMartyUpdate.js"></script>
<script type="text/javascript" src="../../comm/bptComm.js"></script>
</head>
<body>
<model:datasets>
	<!-- 公示书信息 -->
	<model:dataset id="BptOpenLetterDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptOpenLetterQueryCommand" method="queryMartyOpenLetter" global="true">
		<model:record fromBean="com.inspur.cams.bpt.base.data.BptOpenLetter">
				...
				<model:field name="statusType" type="string" />
				<model:field name="lezswName" type="string" />
				<model:field name="sacrificeDate" type="string" />
				<model:field name="lezswApproveDate" type="string" />
		</model:record>
	</model:dataset>
	<!-- 性别 -->
					...
					<table border="1" width="98%">
						...
						<tr>
					       <td class="FieldLabel" >身份类别：</td>
							<td class="FieldInput" ><label 
								name="statusType" field="statusType" dataset="StatusTypeEnum" title="身份类别"/></td>
							<td class="FieldLabel" >牺牲者姓名：</td>
							<td class="FieldInput" width="15%" colspan="3"><label 
								name="lezswName" field="lezswName"   title="牺牲者姓名"/></label></td>
							
					    </tr>
					    <tr>
					       <td class="FieldLabel" >牺牲时间：</td>
							<td class="FieldInput"><label 
								name="sacrificeDate" field="sacrificeDate" title="牺牲时间"/></td>
							<td class="FieldLabel" >批准烈士（平反时间）：</td>
							<td class="FieldInput" width="15%" colspan="3"><label 
								name="lezswApproveDate" field="lezswApproveDate"   title="批准烈士（平反时间）"/></label></td>
					    </tr>
						<tr>
						...
						<input type="hidden" id="docpath" value="jsp/cams/bpt/flow/martyroffspring/print/martyOpen.doc"/>
						...
						<input type="hidden" id="method" name="queryData" queryData="queryData" value="queryMartyData"/>
