...
<model:datasets>
	<model:dataset id="BaseinfoPeopleDataSet"
		cmd="com.inspur.cams.bpt.manage.cmd.BptApplyMartyrOffspringQueryCommand"
		global="true" method="queryMartyrOffspirng">
	...
	<next:Html>
		...
		<table border="1" width="100%">
			...
			<tr>
				...
				<td class="FieldInput"><select name="statusType"
					field="statusType" title="身份类别" id="statusType">
					<option dataset="StatusTypeEnum"></option>
				</select></td>

				<td class="FieldLabel" nowrap>牺牲时间：</td>
				<td class="FieldInput">
				<input type="text" id="sacrificeDate" field="sacrificeDate" title="牺牲时间" format="Y-m-d" style="width: 100px;" maxlength="10" /><img  src="../../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);">
				</td>
				<td class="FieldLabel" nowrap>批准烈士（平反）时间：</td>
				<td class="FieldInput">
				<input type="text" id="lezswApproveDate" style="width: 100px;" format="Y-m-d" title="批准烈士（平反）时间"></input><img src="../../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);">
				</td>
...
<next:GridPanel id="editGridPanel" name="baseinfopeopleGrid"
	...
	dataset="BaseinfoPeopleDataSet" title="部分烈士（错杀被平反人员）子女信息" notSelectFirstRow="true">
		<next:TopBar>
					<next:ToolBarItem symbol="->" ></next:ToolBarItem>
	...
	<next:Columns>
		...
		<next:Column  header="身份类别" field="STATUS_TYPE" width="180" align="center" dataset="StatusTypeEnum">
			<next:TextField/>
		</next:Column>
		<next:Column  header="牺牲时间" field="SACRIFICE_DATE" width="120" align="center">
			<next:TextField/>
		</next:Column>
		<next:Column  header="批准烈士（平反）时间" field="LEZSW_APPROVE_DATE" width="160" align="right">
			<next:TextField/>
		</next:Column>
	</next:Columns>
	<next:BottomBar>
