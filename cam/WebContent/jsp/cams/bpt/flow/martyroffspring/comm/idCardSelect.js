...
function query(){
	...
	BaseinfoPeopleDataSet.setParameter("statusType",getParam("statusType"));		
	BaseinfoPeopleDataSet.setParameter("sacrificeDate",getParam("sacrificeDate"));		
	BaseinfoPeopleDataSet.setParameter("lezswApproveDate",getParam("lezswApproveDate"));		
...
function detail() {
	...
	var url = '../martyrOffspringDetailManage.jsp?familyId=' + familyId + '&peopleId='+ peopleId + '&applyId=' + applyId;
