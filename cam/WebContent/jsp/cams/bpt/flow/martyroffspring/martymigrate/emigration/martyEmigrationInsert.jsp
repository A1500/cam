...
<html>
<head>
<title>添加部分烈士（错杀被平反人员）子女关系跨省迁出</title>
<next:ScriptManager />
<script type="text/javascript" src="martyEmigrationInsert.js"></script>
...
<model:datasets>
	<!-- 人员信息 -->
	<model:dataset id="BaseinfoPeopleDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptApplyMartyrOffspringQueryCommand" method="queryByIdCard" global="true">
