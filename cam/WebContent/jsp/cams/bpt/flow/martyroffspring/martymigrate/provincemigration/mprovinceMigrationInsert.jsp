...
<next:ScriptManager />
<script type="text/javascript" src="mprovinceMigrationInsert.js"></script>
...
<model:datasets>
	<!-- 平反人员省内迁移 -->
	<model:dataset id="ProvinceMigrationDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptApplyMartyrOffspringQueryCommand" method="queryByIdCard" global="true">
