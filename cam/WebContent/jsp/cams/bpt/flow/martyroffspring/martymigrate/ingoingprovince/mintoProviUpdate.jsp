...
<script type="text/javascript" src="mintoProviUpdate.js"></script>
				...
				<next:Html>
					...
					<table border="1" width="99%">
						<tr>
							...
							<td class="FieldInput"><input type="text" id="sacrificeDate" name="sacrificeDate" field="sacrificeDate"style= "width:100px;"  format="Y-m-d" onpropertychange="changeDateStyle(this)" title="牺牲时间"/><img  src="../../../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)"><font color="red">*</font></td>
						</tr>
						<tr>
							<td class="FieldLabel">批准烈士（平反）时间：</td>
							<td class="FieldInput"><input type="text" id="lezswApproveDate" name="lezswApproveDate" field="lezswApproveDate"style= "width:100px;"  format="Y-m-d" onpropertychange="changeDateStyle(this)" title="批准烈士（平反）时间"/><img  src="../../../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)"><font color="red">*</font></td>
