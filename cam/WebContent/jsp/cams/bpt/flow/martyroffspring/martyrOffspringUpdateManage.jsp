...
<next:Panel autoHeight="true" bodyStyle="width:100%" width="100%">
	<next:TabPanel id="tabPanel">
		...
		<next:Panel title="类别信息" width="100%" height="100%" id="martyrOffspringTabPanel">
				<next:Html>
				  <iframe id="martyrOffspringTabPanelFrame" src="martyrOffspringUpdate.jsp?peopleId=<%=request.getParameter("peopleId")%>"
		...
		<next:Panel title="公示书" width="100%" height="100%"
				id="publicityDoc">
				<next:Html>
				  <iframe id="countrySoldierOpenFrame" src="openMartyUpdate.jsp?peopleId=<%=request.getParameter("peopleId")%>&applyId=<%=request.getParameter("applyId")%>"
						frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="100%">
	   				</iframe>
				</next:Html>
		</next:Panel>
		...
		<next:Panel title="县级审批" id="martyrOffspringTownApprove" width="100%" height="100%">
				<next:Html>
				    <iframe id="martyrOffspringTownApproveFrame" src="martyrOffspringTownEdit.jsp?peopleId=<%=request.getParameter("peopleId")%>&applyId=<%=request.getParameter("applyId")%>&serviceType=B1"
						frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="100%">
	   				</iframe>
				</next:Html>
		</next:Panel>
