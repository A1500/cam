function init() {
		...
		DemobilizedIllnessDataset.setParameter("PEOPLE_ID",peopleId);
...
function saveClick(){
	...
	var allowanceMonth = DemobilizedIllnessRecord.get("allowanceMonth");
	...
	command.execute("updateDemobilizedIllnessRecord");
	if (!command.error) {
