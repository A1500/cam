...
<model:datasets>
	<!-- 人员信息 -->
	<model:dataset id="BaseinfoPeopleDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleDemobilizedIllnessQueryCommand"  method="queryApplyIntoDemobilizedIllnessPeople" global="true" pageSize="8">
...
<next:GridPanel id="editGridPanel" name="baseinfopeopleGrid" width="100%" stripeRows="true" height="98%" dataset="BaseinfoPeopleDataSet" >
	<next:TopBar>
