					 ...
					 -->
                       ...
                       <tr>
						...
						<tr>
							...
							<td class="FieldInput" colspan="3"><label type="text" name="allowanceMonth" field="allowanceMonth" title="抚恤金已发至月份"/></td>
						</tr>
						<tr>
							<td class="FieldLabel">迁入原因</td>
							<td class="FieldInput" colspan="5"><label type="text" rows="2" name="ingoingReason" field="ingoingReason" style="width:90%" title="迁入原因"/></td>
						</tr>
                        <tr>
