...
<html>
	<head>
		...
		<next:ScriptManager/>
		<script type="text/javascript" src="illMigrationList.js"></script>
...
<model:datasets>
   ...
   <!-- 是否抗美援朝 -->
	...
	<!-- 未提交回乡复员人员省内迁出列表 -->
	<model:dataset id="BaseinfoPeopleDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptApplyDemobilizedQueryCommand"  method="queryIllEmigrationPeopleList" global="true">
	</model:dataset>
</model:datasets>
