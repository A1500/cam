...
function insert() {
	var url=L5.webPath+'/jsp/cams/bpt/flow/demobilizedillness/illprovincemigrate/illprovinceMigrationInsert.jsp';
...
function detail() {
	...
	var url = 'illprovinceMigrationDetailManage.jsp?idCard=' + idCard + '&peopleId='
			+ peopleId + '&applyId=' + applyId + '&familyId=' + familyId;
	var win = window.showModalDialog(url, window,
			"scroll:yes;status:no;dialogWidth:" + width + "px;dialogHeight:"
					+ height + "px;resizable:1");
...
function createAndSend() {
	...
	DisabilityEmigrateRecord.set("SERVICE_TYPE","47");
