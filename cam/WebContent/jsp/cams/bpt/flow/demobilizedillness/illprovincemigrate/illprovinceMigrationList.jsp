...
<html>
	<head>
		<title>带病回乡军人信息列表</title>
		<next:ScriptManager/>
		<script type="text/javascript" src="illprovinceMigrationList.js"></script>
...
<model:datasets>
   ...
   <!-- 是否抗美援朝 -->
	...
	<!-- 未提交回乡复员人员省内迁出列表 -->
	<model:dataset id="BaseinfoPeopleDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptApplyDemobilizedQueryCommand"  method="queryillprovinceEmigrationPeopleList" global="true">
	</model:dataset>
</model:datasets>
<next:GridPanel id="editGridPanel" name="baseinfopeopleGrid" width="100%" stripeRows="true" height="100%" dataset="BaseinfoPeopleDataSet" >
	...
	<next:Columns>
		...
		<next:Column id="ASDP_NO" header="退伍证号" field="ASDP_NO" width="90" >
			<next:TextField  />
		</next:Column>
