...
<script type="text/javascript" src="illprovinceMigrationInsert.js"></script>
...
<model:datasets>
	...
	<!-- 带病回乡退伍军人 -->
	<model:dataset id="ProvinceMigrationDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleDemobilizedIllnessQueryCommand" method="queryDemobilizedIllnessBPTPeople" global="true">
...
<next:Panel height="100%" width="100%">
	...
	<next:Html>
					...
					<tr>
							...
							<td class="FieldInput" style="width:15%"><input readonly="readonly" type="text" id ="idCard" name="idCard" field="idCard" style="width:135" maxlength="18"/>
