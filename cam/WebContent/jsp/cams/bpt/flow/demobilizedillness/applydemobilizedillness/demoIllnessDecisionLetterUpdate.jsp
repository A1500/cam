...
<script type="text/javascript" src="demoIllnessDecisionLetterUpdate.js"></script>
...
<model:datasets>
	...
	<!-- 不符合情形 -->
	<model:dataset id="noFitDataset" enumName="DEMOBILIZEDILLNESS.NOFIT.CODE" autoLoad="true" global="true"></model:dataset>
	<!-- 依据条款 -->
	<model:dataset id="foundationDataset" enumName="DEMOBILIZEDILLNESS.FOUNDATION.CODE" autoLoad="true" global="true"></model:dataset>
</model:datasets>
	...
	<next:Html>
		...
		<table border="1" width="99%">
	   		<tr>
				...
				<td class="FieldInput" width="30%">带病回乡退伍军人身份认定 </td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="FieldInput"><input type="text" format="Y-m-d" style="width: 100px;" maxlength="10" name="decisionDate" field="decisionDate" title="出具时间" onpropertychange="changeDateStyle(this)" 
		...
		<!-- 打印相关 -->
		<input type="hidden" id="docpath" value="jsp/cams/bpt/flow/demobilizedillness/table/demobilizedIllnessDecisionLetter.doc"/>
