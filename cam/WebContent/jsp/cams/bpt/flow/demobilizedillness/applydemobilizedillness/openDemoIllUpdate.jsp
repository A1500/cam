...
<script type="text/javascript" src="openDemoIllUpdate.js"></script>
					...
					<table border="1" width="98%">
					    ...
					    <tr>
					       <td class="FieldLabel" >姓名：</td>
							...
							<td class="FieldInput"><label format="Y-m-d" maxlength="10" 
						...
						<tr>
						    <td class="FieldLabel" >致病时间：</td>
							<td class="FieldInput" ><input 
								format="Y-m-d" maxlength="10"  type="text"
								name="illDate" field="illDate" style="width: 100px;" title="致病时间" onpropertychange="changeDateStyle(this)"/><img  src="../../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ></td>
						
							<td class="FieldLabel" >致病地点：</td>
							<td class="FieldInput" colspan="3"><input 
								format="Y-m-d" maxlength="10"  type="text"
								name="illAddress" field="illAddress" style="width: 100px;" title="致病地点" /></td>
						</tr>
						<tr>
							<td class="FieldLabel" >致病部位体检结果：</td>
							<td class="FieldInput"  colspan="5"><textarea
								rows="2" name="illBodyCheck"
								field="illBodyCheck" style="width:94%" title="致病部位体检结果"></textarea></td>
						</tr>
						<tr>
							<td class="FieldLabel" >将要享受的待遇：</td>
							<td class="FieldInput"  colspan="5"><textarea
								rows="2" name="treatment"
								field="treatment" style="width:94%" title="将要享受的待遇"></textarea><font color="red">*</font></td>
						</tr>
						<tr>
