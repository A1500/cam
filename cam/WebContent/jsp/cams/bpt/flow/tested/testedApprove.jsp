...
<next:Tabs>
	<next:TabPanel>
	<next:Panel width="100%" id="peopleTabPanel" title="人员基本信息" height="100%">
				<next:Html>
...
<next:Panel width="100%" id="typeTabPanel" title="类别信息" height="100%">
				<next:Html>
					<iframe id="instance" src="../../../jsp/cams/bpt/flow/comm/testedDetail.jsp?processId=<%=(String)request.getParameter("processId")%>&assignmentId=<%= (String)request.getParameter("assignmentId")%>"
						frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="yes" allowtransparency="yes" width="100%" height="100%">
	   				</iframe>
				</next:Html>
</next:Panel>
...
function updateInfo() {//修改申请信息
	...
	var url = L5.webPath+"/jsp/cams/bpt/flow/tested/bpttested_edit.jsp?peopleId=" + peopleId + "&familyId=" + familyId;
