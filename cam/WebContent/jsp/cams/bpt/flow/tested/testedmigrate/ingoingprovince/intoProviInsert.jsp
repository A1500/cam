...
<script type="text/javascript" src='<%=SkinUtils.getJS(request,"Check.js")%>'></script>
...
<model:datasets>
	...
	<model:dataset id="dsTested"
		cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleTestedQueryCommand" method="queryPeopleTestedInfo"
		global="true">
...
<next:Panel autoHeight="true" bodyStyle="width:100%;">
	...
	<next:TabPanel >
		<next:Tabs>
				...
				<next:Html>
					...
					<table border="1" width="98%">
						...
						<tr>
							...
							<td class="FieldInput"><input   type="text" id="idCard" name="idCard" field="idCard" title="身份证件号码" maxlength="18" style="width: 135" onchange="func_QueryIdCardAllMessage()" />
							<input type="button" name="ReadCard" value="读身份证" onclick="ReadIDCard()" style="width:60px;" /><font color="red">*</font>
							    <input type="hidden" name="stype" id="stype" value="14"/>
							</td>
			...
			<next:Panel id="typeInfo" title="类别信息" height="100%" autoHeight="true" autoScroll="true" width="100%">
				<next:Html>
					<form id="editForm" dataset="dsTested"
					...
					<table border="1" width="98%">
						...
						<tr>
							...
							<td class="FieldInput" colspan="3"><input type="text" readonly="readonly"  format="Y-12"  name="allowanceMonth" field="allowanceMonth" title="抚恤金已发至月份"style="width: 100px;" maxlength="10"/><img  src="../../../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ><font color="red">*</font></td>
						</tr>
