...
<body>
<model:datasets>
	<model:dataset id="TestedIngoProvinceDataSet"
		cmd="com.inspur.cams.bpt.manage.cmd.BptApplyIntoprovinceQueryCommand"
		global="true" method="queryUncommitTestedIntoprovin">
	</model:dataset>
	<!-- 性别 -->
...
<next:GridPanel id="editGridPanel" name="baseinfopeopleGrid"
	...
	dataset="TestedIngoProvinceDataSet"  notSelectFirstRow="true">
	<next:TopBar>
	...
	<next:BottomBar>
		<next:PagingToolBar dataset="TestedIngoProvinceDataSet" />
	</next:BottomBar>
</next:GridPanel>
</body>
</html>
