...
<model:datasets>
	<!-- 参试人员抚省内迁移 -->
	<model:dataset id="ProvinceMigrationDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptProvinceMigrateQueryCommand" method="queryTestedProEmigrate" global="true">
...
<next:Panel width="100%" height="100%" autoScroll="false">
	...
	<next:Html>
		...
		<table border="1" width="99%">
			...
			<input type="hidden" id="serviceType" name="printQuery" queryData="queryData" value="63"/>
		</table>
		</form>
   </next:Html>
</next:Panel>	
