...
<model:datasets>
	<!-- 参试人员省内迁移 -->
	<model:dataset id="ProvinceMigrationDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleTestedQueryCommand" method="queryByIdCard" global="true">
		...
		<table border="1" width="99%">
			...
			<tr>
				<td class="FieldLabel">迁入地实际居住(行政区划):</td> 
							...
							<input type="hidden" id="apanageCode" name="apanageCode" field="inApanageCode" title="行政区划"/>       
				         &nbsp;&nbsp;&nbsp;地址: 
