	...
	<next:Html>
		...
		<table border="0" width="98%" >
			...
			<tr>
				...
				<td class="FieldInput" colspan="3"><label  name="decruitmentDate" field="decruitmentDate" format="Y-m-d" style="width: 100px;"  title="退伍时间"  /></td>
			</tr>
			<tr>
			<td class="FieldLabel" nowrap >原部队番号：</td>
				<td class="FieldInput" ><label name="forcesNo" field="forcesNo" title="原部队番号" /></td>
			...
			<input type="hidden" id="docpath" value="jsp/cams/bpt/flow/tested/table/bptphysicalexamination/physicalexamination_print.doc"/>
			<input type="hidden" id="applyId" name="printQuery" queryData="queryData" value="<%=request.getParameter("applyId")%>"/>
			<input type="hidden" id="type" name="printQuery" queryData="queryData" value="65"/>
