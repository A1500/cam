...
<html>
<head>
<title>参加核试验军队退役人员登记审核表</title>
<next:ScriptManager />
		<script>
			var peopleId="<%=request.getParameter("peopleId")%>";
		</script>
<script type="text/javascript" src="test_apptable.js"></script>
</head>
<body>
<input type="hidden" id="docpath" value="jsp/cams/bpt/flow/tested/table/test_apptable.doc"/>
...
<input type="hidden" id="scaconfPath" value="testApp/testAppPrintDao"/>
</body>  
</html> 
