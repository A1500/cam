...
<model:datasets>
	...
	<!-- 伤残审批信息 -->
	<model:dataset id="ProvinceMigrationDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleDisabilityQueryCommand" method="queryDisabilityByIdCard" global="true">
	...
	<next:Html>
		...
		<table border="1" width="99%">
			<tr>
				...
				<td class="FieldInput" style="width:15%"><input type="text" readonly="readonly" name="idCard" field="idCard" style="width:135" maxlength="18" onchange="queryDisbilityByIdCardPro(this)"/>
