...
<model:datasets>
	<!-- 伤残人员抚恤关系跨省迁出【未提交】 -->
	<model:dataset id="ProvinceMigratDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptProvinceMigrateQueryCommand" method="queryUnCommiDisaProvinceEmigrate" global="true">
	</model:dataset>
	<!-- 民族 -->
...
<next:GridPanel id="editGridPanel" name="bptpetitionGrid"   stripeRows="true" width="100%" height="100%" dataset="ProvinceMigratDataSet">
	<next:TopBar>
