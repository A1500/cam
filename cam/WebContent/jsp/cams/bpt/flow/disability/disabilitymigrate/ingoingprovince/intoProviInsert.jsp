...
<html>
<head>
<title>新增外省残疾人员抚恤关系迁入我省信息</title>
<next:ScriptManager />
		<script>
...
<model:datasets>
	...
	<!-- 伤残信息 -->
	<model:dataset id="BptPeopleDisabilityDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleDisabilityQueryCommand" global="true"  method="queryPeopleDisabilityInfo" >
...
<next:Panel autoHeight="true">
	...
	<next:TabPanel>
		<next:Tabs>
		<next:Panel title="基本信息" autoHeight="true" width="100%"  autoScroll="true" id="peopleTabPanel">
				<next:Html>
					<fieldset>
					...
					<table border="0" width="98%">
						...
						<tr>
							...
							<td class="FieldInput" ><input type="text"
								name="idCard" id="idCard" field="idCard" title="身份证件号码" style="width:135" maxlength="18" onchange="func_QueryIdCardAllMessage()"/>
						...
						<tr>
						  ...
						  <!--<td class="FieldLabel" >姓名拼音码：</td> -->
							<td class="FieldInput" style="display:none"><input type="text" id="phoneticCode" name="phoneticCode" field="phoneticCode" title="姓名拼音码" />
							</td>
			...
			<next:Panel title="类别信息" height="100%" autoScroll="true" width="100%">
				<next:Html>
					<fieldset>
					...
					<table border="1" width="98%">
					    <tr>
					       <td class="FieldLabel" >伤残类别：</td>
							<td class="FieldInput" ><select
								id="disabilityTypeCode" name="disabilityTypeCode" field="disabilityTypeCode" title="伤残类别">
						...
						<tr>
							...
							<td class="FieldInput" colspan="3"><input type="text" name="oldPaperNo" field="oldPaperNo" id="oldPaperNo" title="原残疾证件编号" maxlength="20"/><font color="red">*</font></td>
						
							<!--  <td  class="FieldLabel" >批准日期：</td>
							<td class="FieldInput"><input type="text" id="approveDate" title="批准日期" name="approveDate" field="approveDate" format="Y-m-d" maxlength="10" style="width: 100px;" /><img  src="../../../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ><font color="red">*</font></td>
						-->
						</tr>
						...
						<tr>
							...
							<td class="FieldInput" ><input
								...
								name="relationshipType" field="conscriptDate" title="入伍(参加工作时间)" onpropertychange="changeDateStyle(this)" /><img  src="../../../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ><font color="red">*</font></td>
								
							<td class="FieldLabel"  nowrap="nowrap">退伍时间：</td>
							<td class="FieldInput"><input
								format="Y-m-d" maxlength="10" style="width: 100px; type="text"
								name="veteransDate" field="veteransDate" title="退伍时间" onpropertychange="changeDateStyle(this)" /><img  src="../../../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ><font color="red">*</font></td>
							<td class="FieldLabel"  nowrap="nowrap">离退休时间：</td>
							<td class="FieldInput" ><input
								format="Y-m-d" maxlength="10" style="width: 100px; type="text"
								name="retiredDate" field="retiredDate" onpropertychange="changeDateStyle(this)"  /><img  src="../../../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ></td>
						</tr>
						...
						<tr>
							...
							<td class="FieldInput"><input
								format="Y-m-d" maxlength="10" style="width: 100px; type="text"
								name="disabilityDate" field="disabilityDate" title="致残时间" onpropertychange="changeDateStyle(this)" /><img  src="../../../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ><font
								color="red">*</font></td>
							<td class="FieldLabel" nowrap="nowrap">致残时所在单位：</td>
							<td class="FieldInput" colspan="3"><input type="text"
								name="uinitOfDisability" field="uinitOfDisability" style="width:86%"/></td>
						...
						<tr>	
							...
							<td class="FieldLabel" nowrap="nowrap">生活能力：</td>
						...
						<tr>
							...
							<td class="FieldInput" colspan="3"><input type="text" format="Y-12" maxlength="10" style="width: 100px; name="allowanceMonth" field="allowanceMonth"id="allowanceMonth" title="抚恤金已发至月份"/><img  src="../../../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ><font color="red">*</font></td>
						</tr>
						...
						<tr>
							...
							<td class="FieldInput" colspan="5"><textarea rows="3" name="note" field="note" style="width:90%"></textarea></td>
						</tr>
