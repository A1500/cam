...
<html>
<head>
	<title>修改外省残疾人员抚恤关系迁入我省信息</title>
	<next:ScriptManager />
				...
				<next:Html>
					...
					<table border="1" width="98%">
						...
						<!--  	<td  class="FieldLabel" >批准日期：</td>
							<td class="FieldInput"><input type="text" id="approveDate" title="批准日期" name="approveDate" field="approveDate" format="Y-m-d" maxlength="10" /><font color="red">*</font></td>
					-->
						</tr>
						...
						<tr>
							...
							<td class="FieldInput" ><input
								...
								name="relationshipType" field="conscriptDate"style="width: 100px;" title="入伍(参加工作时间)" onpropertychange="changeDateStyle(this)" /><img  src="../../../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ><font color="red">*</font></td>
								
							<td class="FieldLabel"  nowrap="nowrap">退伍时间：</td>
							<td class="FieldInput"><input
								format="Y-m-d" maxlength="10" type="text"
								name="veteransDate"style="width: 100px;" field="veteransDate" title="退伍时间" onpropertychange="changeDateStyle(this)" /><img  src="../../../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ><font color="red">*</font></td>
						...
						<tr>
							...
							<td class="FieldInput" colspan="3"><input type="text" format="Y-m" maxlength="10" name="allowanceMonth"style="width: 100px;" field="allowanceMonth" title="抚恤金已发至月份"/><img  src="../../../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ><font color="red">*</font></td>
						</tr>
