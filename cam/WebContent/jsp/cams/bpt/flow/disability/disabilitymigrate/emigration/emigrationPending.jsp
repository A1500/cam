...
<model:datasets>
	<!-- 伤残人员抚恤关系跨省迁出【未提交】 -->
	<model:dataset id="DisabilityEmigratDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptApplyEmigrationQueryCommand" method="queryUnCommiDisaEmigrate" global="true">
	</model:dataset>
	<!-- 民族 -->
...
<next:GridPanel id="editGridPanel" name="bptpetitionGrid"   stripeRows="true" width="100%" height="100%" dataset="DisabilityEmigratDataSet">
	<next:TopBar>
	...
	<next:BottomBar>
		<next:PagingToolBar dataset="DisabilityEmigratDataSet"/>
	</next:BottomBar>
</next:GridPanel>
