...
<model:datasets>
	...
	<!-- 伤残信息 -->
	<model:dataset id="BptPeopleDisabilityDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleDisabilityQueryCommand" method="queryDisabilityBptPeople" global="true"></model:dataset>
    <!-- 民族 -->
					...
					<form style="width: 98%; height: 100%;" class="L5form">
						<table  border="1" width="100%" >
							...
							<tr>	
								...
								<td class="FieldInput" align="center" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	<button onclick="query()">查 询</button></td>
							</tr>
							<tr>
...
<next:GridPanel id="editGridPanel" name="baseinfopeopleGrid" width="98%" stripeRows="true" height="98%" dataset="BptPeopleDisabilityDataSet" title="伤残人员信息" notSelectFirstRow="true">
				<next:TopBar>
					<next:ToolBarItem symbol="->" ></next:ToolBarItem>
