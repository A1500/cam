...
<next:Panel title="电子档案" width="100%" height="100%"
				id="uploadTabPanel">
				<next:Html>
				    <iframe id="upload" src="../../../jsp/cams/bpt/comm/uploadfileDetail.jsp?peopleId=<%=peopleId%>&serviceType=11&applyId=<%=applyId%>"
...
<next:Panel width="100%" id="acceptTabPanel" title="受理通知书" height="100%">
				<next:Html>
					<iframe id="instance" src="../../../jsp/cams/bpt/flow/disability/assessdisability/acceptNoticeDetail.jsp?peopleId=<%=peopleId%>&applyId=<%=applyId%>"
						frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="yes" allowtransparency="yes" width="100%" height="100%">
	   				</iframe>
				</next:Html>
</next:Panel>
<next:Panel title="评定公示书" width="100%" height="100%"
				id="open_dis_appTabPanel" >
				<next:Html>
				  <iframe  id="openNotice" src="../../../jsp/cams/bpt/flow/disability/assessdisability/openDisabilitydetail.jsp?peopleId=<%=peopleId%>&applyId=<%=applyId%>&assignmentId=<%= (String)request.getParameter("assignmentId")%>"
					 	frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="100%" >
	   				</iframe>
				</next:Html>
		</next:Panel>
...
function sipApplyFlag() {
		...
		} else if(proCheckFlag == 1) {
			document.getElementById("ProvinceAcceptEnd").style.display="";
		}
