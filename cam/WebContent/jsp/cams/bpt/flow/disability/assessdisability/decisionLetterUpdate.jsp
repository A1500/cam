...
<script type="text/javascript" src="decisionLetterUpdate.js"></script>
	...
	<next:Html>
		...
		<table border="1"  width="99%">
	   		<tr>
				...
				<label id="serviceType" name="serviceType" field="serviceType" dataset="serviceTypeDataset"></label>
