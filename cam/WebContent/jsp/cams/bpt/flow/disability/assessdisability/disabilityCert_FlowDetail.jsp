			...
			<div id="CityVerify" style="display:none">
				<table width="99%">
			   		<tr>
			   			...
			   			<td  class="FieldLabel" style="width:10%">负责人</td>
						<td class="FieldInput" style="width:30%"><label validateName="市级审核" name="cityAduitIncharge" field="cityAduitIncharge" /> </td>
						<td  class="FieldLabel" style="width:20%">时间</td>
						<td class="FieldInput" style="width:30%"><label validateName="时间" name="cityAduitApproveDate" field="cityAduitApproveDate"/></td>
					</tr>
			   		<tr>
						<td  class="FieldLabel" >意见</td>
				...
				<table width="99%">
					<tr>
						...
						<td  class="FieldInput" nowrap="nowrap" colspan="3">
								<label id="cancelTreateFlag" name="cancelTreateFlag" field="cancelTreateFlag" title="取消待遇标志" dataset="CancelTreateFlagEnum"></label>
						</td>
					</tr>
					<tr>
					...
					<td colspan="3" class="FieldInput">
						<table  style="width:100%">
							<tr >
								...
								<td  class="FieldInput" nowrap="nowrap">
									 <label id="oldIdCard" name="oldIdCard" field="oldIdCard" validateName="原身份证号"/>
								</td>
					...
					<td colspan="3" class="FieldInput">
						<table style="width:100%">
							<tr >
								<td  class="FieldLabel" nowrap="nowrap">身份证号</td>
								<td  class="FieldInput" nowrap="nowrap">
									 <label id="newIdCard" name="newIdCard" field="newIdCard" validateName="新身份证号"/>
								</td>
								<td  class="FieldLabel" nowrap="nowrap">姓名</td>	
								<td  class="FieldInput" nowrap="nowrap">
						...
						<td  class="FieldLabel" style="width:20%">时间</td>
						<td class="FieldInput" style="width:30%"><label validateName="时间" name="provinceCheckDate" field="provinceCheckDate"/></td>
					</tr>
			   		<tr>
						<td  class="FieldLabel" >意见</td>
						<td class="FieldInput" colspan="3"><label name="provinceCheckAdvice" field="provinceCheckAdvice"></label></td>
					</tr>
			...
			<div id="ProvinceVerify" style="display:none">
				<table width="99%">
			   		<tr>
						...
						<td class="FieldInput" style="width:30%"><label validateName="负责人" name="provinceAduitIncharge" field="provinceAduitIncharge" /> </td>
						
						<td  class="FieldLabel" style="width:20%">时间</td>
						<td class="FieldInput" style="width:30%"><label validateName="时间" name="provinceAduitApproveDate" field="provinceAduitApproveDate" /></td>
					</tr>
			   		<tr>
						<td  class="FieldLabel" >意见</td>
						<td class="FieldInput" colspan="3"><label name="provinceAduitAdvice" field="provinceAduitAdvice"></label> </td>
					</tr>
				</table>
			</div>
				<br>
			<div id="ProvinceApprove" style="display:none">
				<table width="99%">
			   		<tr>
			   			...
			   			<td class="FieldLabel">负责人</td>
						<td class="FieldInput" style="width:30%"><label validateName="负责人" name="provinceIncharge" field="provinceIncharge"/></td>
						<td class="FieldLabel" style="width:20%">时间</td>
						<td class="FieldInput" style="width:30%"><label validateName="时间" name="provinceApproveDate" field="provinceApproveDate"/></td>
					</tr>
			   		<tr>
						<td class="FieldLabel" >意见</td>
