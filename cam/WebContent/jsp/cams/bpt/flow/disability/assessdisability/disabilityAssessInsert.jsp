...
<script type="text/javascript" src="disabilityAssessInsert.js"></script>
...
<model:datasets>
	...
	<model:dataset id="BptPeopleDisabilityDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleDisabilityQueryCommand" method="queryPeopleDisabilityInfo" global="true">
		<model:record fromBean="com.inspur.cams.bpt.base.data.BptPeopleDisability">
				...
				<model:field name="isKoreaWar" type="string"/>
				
				<model:field name="disabilityStateCode" type="string" defaultValue="1"/>
					...
					<table border="1" width="98%">
						...
						<tr>
							...
							<td class="FieldInput" ><input
								...
								name="relationshipType" style="width: 100px;" field="conscriptDate" onpropertychange="changeDateStyle(this)" title="入伍(参加工作)时间" onpropertychange="changeDateStyle(this)" /><img  src="../../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ></td>
							<td class="FieldLabel"  nowrap="nowrap">退伍时间：</td>
							<td class="FieldInput"><input
								format="Y-m-d" style="width: 100px;"maxlength="10" type="text"
								name="veteransDate" field="veteransDate" onpropertychange="changeDateStyle(this)" title="退伍时间" onpropertychange="changeDateStyle(this)" /><img  src="../../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ></td>
							<td class="FieldLabel"  nowrap="nowrap">离退休时间：</td>
							<td class="FieldInput" ><input
								format="Y-m-d" style="width: 100px;"maxlength="10" type="text"
								name="retiredDate" field="retiredDate"  onpropertychange="changeDateStyle(this)" title="离退休时间" onpropertychange="changeDateStyle(this)" /><img  src="../../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="FieldInput"><input
								format="Y-m-d"style="width: 100px;" maxlength="10" type="text"
								name="disabilityDate" field="disabilityDate" onpropertychange="changeDateStyle(this)"  title="致残时间" onpropertychange="changeDateStyle(this)" /><img  src="../../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ><font
								color="red">*</font></td>
