		...
		<table border="0" width="98%" >
			...
			<tr>
	   		...
	   		<tr>
				...
				<td class="FieldInput"><label type="text" name="postCode" field="postCode" title="邮政编码"/></td>
				<td  class="FieldLabel" nowrap="nowrap">身份证件发放机关:</td>
				<td class="FieldInput" ><input type="text" name="issuingAuthority" field="issuingAuthority" title="身份证件发放机关" style="width: 40%" /><font color="red">*</font> </td>
			</tr>
			<tr>
				<td class="FieldLabel" nowrap>入伍时间：</td>
				<td class="FieldInput"><label type="text" name="conscriptDate" field="conscriptDate" format="Y-m-d" style="width: 100px;" maxlength="10" title="入伍时间"   ></label>
				<td class="FieldLabel" nowrap>退伍时间：</td>
				<td class="FieldInput" colspan="3"><label type="text" name="veteransDate" field="veteransDate" format="Y-m-d" style="width: 100px;"  title="退伍时间" maxlength="10" ></label>
			</tr>
			<tr>
			<td class="FieldLabel" nowrap >原部队番号：</td>
				<td class="FieldInput" ><input type="text" name="disabledArmyNo" field="disabledArmyNo" title="原部队番号" /></td>
				...
				<td class="FieldLabel" nowrap="nowrap">省厅批准残情等级：</td>
					<td class="FieldInput" >
			...
			<tr>
	   		...
	   		<tr>
				<td  class="FieldLabel" >村（居）委会意见：</td>
				<td class="FieldInput" colspan="3"><textarea type="text" name="villageView" field="villageView"  style="width: 88%" ></textarea> </td>
			
				<td  class="FieldLabel" >时间</td>
				<td class="FieldInput"><input type="text" name="villageTime" field="villageTime"  format="Y-m-d" maxlength="10" onpropertychange="changeDateStyle(this)" /><img  src="../../../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ></td>
			</tr>
	   		<tr>
				<td  class="FieldLabel" >乡镇（街道）民政办意见：</td>
				<td class="FieldInput" colspan="3"><textarea type="text" name="twonView" field="twonView" style="width: 88%"  ></textarea> </td>
			
				<td  class="FieldLabel" >时间</td>
				<td class="FieldInput"><input type="text" name="twonTime" field="twonTime" format="Y-m-d" maxlength="10" onpropertychange="changeDateStyle(this)" /><img  src="../../../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ></td>
			</tr>
	   		<tr>
				<td  class="FieldLabel" >县（市区）民政局意见：</td>
