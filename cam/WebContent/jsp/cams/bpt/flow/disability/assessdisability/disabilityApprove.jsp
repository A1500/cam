...
<html> 
	<head>
		...
		<script type="text/javascript" src="<%=SkinUtils.getJS(request, "bpm/bpm.js")%>"></script>
				...
				<script type="text/javascript" src="../../../jsp/cams/bpt/flow/disability/assessdisability/disabilityApprove.js"></script>
		</head>
<body>
<model:datasets>
	...
	<next:Html>
		...
		<table border="0"  width="99%" >
			...
			<div id="TownVerify">
				<table width="99%">
			   		...
			   		<tr>
						...
						<td class="FieldInput" colspan="3"><textarea  disabled="disabled" name="townAduitBulletinResult" field="townAduitBulletinResult" style="width:80%" rows="2"></textarea> </td>
			   		</tr>
			...
			<div id="ProvinceAccept" style="display:none">
				<table width="99%">
					<tr>
						<td  class="FieldLabel" rowspan="6" nowrap="nowrap">省级初审</td>			   			
					...
					<tr>
						...
						<td class="FieldInput" colspan="3">
							<textarea type="text" name="briefDisability" field="briefDisability" style="width:80%" rows="2"></textarea> 
						</td>
					</tr>
			   		<tr>
						<td  class="FieldLabel" >意见</td>
						<td class="FieldInput" colspan="3">
							...
							<tr>
								...
								<td class="FieldInput">
									...
									validateType="provinceCheckDisNature:provinceCheckDisLevel:province_report"
								...
								<td class="FieldInput">
									<div id="ProvinceAcceptPass" style="display:none">伤残性质：
										...
										&nbsp;&nbsp;&nbsp;
										申报等级：
										<select name="provinceCheckDisLevel" validateType="disabilityLevelCode" field="provinceCheckDisLevel">
											<option dataset="DisabilityLevelDataset"></option>
										</select>
									</div>
								</td>
			...
			<div id="ProvinceVerify" style="display:none">
				<table width="99%">
			   		<tr>
						...
						<td  class="FieldLabel" style="width:20%">时间</td>
						<td class="FieldInput" style="width:30%"><input type="text" maxlength="10" validateName="时间" format="Y-m-d" style="width: 100px; name="provinceAduitApproveDate" field="provinceAduitApproveDate" onpropertychange="changeDateStyle(this)" /><img  src="../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  > </td>
					</tr>
			   		<tr>
						<td  class="FieldLabel" >意见</td>
						<td class="FieldInput" colspan="3">
						<table width="100%">
							<tr>
								...
								<td class="FieldInput">
									<select style="width:90px;" name="proAduitFlag"  
									validateType="provinceAduitDisabilityNatu:provinceAduitDisabilityLeve:province_report"
									validateName="审批意见" id="ProvinceVerifyFlag" field="proAduitFlag" onchange="changeAppDiv('ProvinceVerify')">
										<option dataset="ApplyContent"></option>
									</select>
								</td>
								<td class="FieldInput">
									<div id="ProvinceVerifyPass" style="display:none">伤残性质：
										<select name="provinceAduitDisabilityNatu" validateType="disabilityCaseCode"  field="provinceAduitDisabilityNatu">
											<option dataset="DisabilityCaseDataset"></option>
										</select>
										&nbsp;&nbsp;&nbsp;
										申报等级：
										<select name="provinceAduitDisabilityLeve" validateType="disabilityLevelCode"  field="provinceAduitDisabilityLeve">
											<option dataset="DisabilityLevelDataset"></option>
										</select>	
									</div>
								</td>
							...
							<tr>
								<td colspan="3">
									<textarea type="text" name="provinceAduitAdvice" field="provinceAduitAdvice" style="width:80%" rows="2"></textarea> 
								</td>
							</tr>
						</table>
			...
			<div id="ProvinceApprove" style="display:none">
				<table width="99%">
			   		<tr>
						...
						<td  class="FieldLabel" style="width:20%">时间</td>
						<td class="FieldInput" style="width:30%"><input type="text" maxlength="10" validateName="时间" format="Y-m-d" style="width: 100px; name="provinceApproveDate" field="provinceApproveDate"  onpropertychange="changeDateStyle(this)" /><img  src="../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  > </td>
			   		...
			   		<tr>
						...
						<table width="100%">
							<tr>
								...
								<td class="FieldInput">
									<select style="width:90px;" name="proFlag"  
									validateType="provinceVerifyDisabilityNat:provinceLevel:null"
									validateName="审批意见" id="ProvinceApproveFlag" field="proFlag" onchange="changeAppDiv('ProvinceApprove')">
										<option dataset="ApplyContent"></option>
									</select>
								</td>
								<td class="FieldInput">
									<div id="ProvinceApprovePass" style="display:none">伤残性质：
										<select name="provinceVerifyDisabilityNat"  field="provinceVerifyDisabilityNat">
											<option dataset="DisabilityCaseDataset"></option>
										</select>
										&nbsp;&nbsp;&nbsp;
										审批等级：
										<select name="provinceLevel"  field="provinceLevel">
											<option dataset="DisabilityLevelDataset"></option>
										</select>
									</div>
								</td>
							...
							<tr>
								<td colspan="3">
									<textarea type="text" name="provinceAdvice" field="provinceAdvice" style="width:80%" rows="2"></textarea> 
								</td>
							</tr>
						</table>
						</td>
...
<next:Panel title="不予评定决定书" width="100%" height="100%"
				...
				<next:Html>
				  <iframe id="decisionTabPanel" src="../../../jsp/cams/bpt/flow/disability/assessdisability/decisionLetterUpdate.jsp?peopleId=<%=peopleId%>&applyId=<%=applyId%>&serviceType=<%=serviceType%>"
						frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="100%">
	   				</iframe>
				</next:Html>
		</next:Panel>
...
function init() {
	...
	var introductTabPanel = L5.getCmp("open_dis_appTabPanel");
	introductTabPanel.on("activate",setSrc);
...
function setSrc() {
	if(first){
		if(serviceType=="12"){
		document.getElementById("openNotice").src="../../../jsp/cams/bpt/flow/disability/assessdisability/openDisabilitydetail.jsp?peopleId=<%=peopleId%>&applyId=<%=applyId%>&serviceType=<%=serviceType%>&adjust=adjust";
		}
	}
	first = "false";
}
