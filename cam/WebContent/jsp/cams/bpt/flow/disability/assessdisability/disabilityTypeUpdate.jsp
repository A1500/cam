					...
					<table border="1" width="98%">
						...
						<tr>
							...
							<td class="FieldInput" ><input
								...
								name="relationshipType" field="conscriptDate" title="入伍(参加工作时间)" onpropertychange="changeDateStyle(this)" /><img  src="../../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" >
								</td>
							<td class="FieldLabel"  nowrap="nowrap">退伍时间：</td>
							<td class="FieldInput"><input
								format="Y-m-d" style="width: 100px;"maxlength="10" type="text"
								name="veteransDate" field="veteransDate" title="退伍时间" onpropertychange="changeDateStyle(this)" /><img  src="../../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" >
								</td>
							<td class="FieldLabel"  nowrap="nowrap">离退休时间：</td>
							<td class="FieldInput" ><input
								format="Y-m-d"  style="width: 100px;"maxlength="10" type="text"
								name="retiredDate" field="retiredDate" title="离退休时间" onpropertychange="changeDateStyle(this)" /><img  src="../../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" >
								</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="FieldInput"><input
								format="Y-m-d"  style="width: 100px;"maxlength="10" type="text"
								name="disabilityDate" field="disabilityDate" title="致残时间" onpropertychange="changeDateStyle(this)" /><img  src="../../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" >
								<font
								color="red">*</font></td>
