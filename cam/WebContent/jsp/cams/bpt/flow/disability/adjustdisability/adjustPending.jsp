...
<html>
	<head>
		<title>调整伤残等级待办列表</title>
		<next:ScriptManager/>
		<script type="text/javascript" src="adjustPending.js"></script>
	</head>
<body>
<model:datasets>
	<!-- 未提交调整伤残等级人员 -->
...
<next:GridPanel id="editGridPanel" name="bptpetitionGrid" clickToSelectedForChkSM="true" stripeRows="true" width="100%" height="100%" dataset="DisabilityPeopleDataSet">
	<next:TopBar>
		...
		<next:ToolBarItem symbol="-" ></next:ToolBarItem>
		<next:ToolBarItem iconCls="add"  text="增加" id="add_button" handler="insert"/>
		<next:ToolBarItem symbol="-" ></next:ToolBarItem>
		<next:ToolBarItem iconCls="edit"  text="修改" id="update_button"  handler="update"/>
		<next:ToolBarItem symbol="-" ></next:ToolBarItem>
		<next:ToolBarItem text="查看" iconCls="detail" id="detail_button"  handler="detail"/>
		<next:ToolBarItem symbol="-" ></next:ToolBarItem>
		<next:ToolBarItem text="删除" iconCls="delete" id="del_button"  handler="del"/>
		<next:ToolBarItem symbol="-" ></next:ToolBarItem>
		...
		<next:ToolBarItem symbol="-" ></next:ToolBarItem>
		<next:ToolBarItem iconCls="view"  text="不予认定并结束" id="nobutton"  handler="end"/>
		<next:ToolBarItem symbol="-" ></next:ToolBarItem>
	</next:TopBar>
	<next:Columns>
		...
		<next:Column id="disabilityStateCode" header="优抚对象状态" field="DISABILITY_STATE_CODE" width="80" dataset="ObjectStateDataset">
						<next:TextField allowBlank="false"/>
		</next:Column>
		...
		<!--<next:Column id="regTime" header="录入时间" field="APPROVE_DATE" width="90">
			<next:TextField allowBlank="false"/>
		</next:Column> -->
