...
<script type="text/javascript" src="adjustDisabilityInsert.js"></script>
<script type="text/javascript" src="../../../comm/bptComm.js"></script>
</head>        
<body>
<model:datasets>   
	<!-- 人员信息 -->
	<model:dataset id="BaseinfoPeopleDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleDisabilityQueryCommand" method="queryDisabilityByIdCard" global="true">
	...
	<!-- 伤残校验信息 -->
	<model:dataset id="DisabilityCheckDataset" cmd="com.inspur.cams.bpt.manage.cmd.BptApplyDisabilityQueryCommand" global="true" method="queryApplyInfoForCheck">
		<model:record fromBean="com.inspur.cams.bpt.base.data.BptApplyDisability">
		</model:record>
	</model:dataset>
	<!-- 性别 -->
	...
	<next:Html>
		...
		<table border="1" width="99%">
			...
			<tr>
				...
				<td class="FieldInput"><label  field="disabilityNo"></label> </td>		
	   		...
	   		<tr>
				...
				<td class="FieldInput" colspan="3"><label type="text" name="disabilityDate" field="disabilityDate" format="Y-m-d" style="width: 100px;" maxlength="10" /></td>
			</tr>
			<tr>
				<td class="FieldLabel">致残地点：</td>
				<td class="FieldInput" colspan="5"><label name="disabilityAdd" field="disabilityAdd" style="width:90%"></td>
			</tr>
			
			<tr>	
				<td class="FieldLabel">致残情况：</td>
				<td class="FieldInput" colspan="5"><label name="disabilityBody" field="disabilityBody" style="width:90%"/></td>
			</tr>

			<tr>
				<td class="FieldLabel">致残原因：</td>
				<td class="FieldInput" colspan="5"><label name="disabilityReason" field="disabilityReason" style="width:90%"></td>	
			</tr>
			<!--  <tr>	
				<td class="FieldLabel">调整伤残等级原因：</td>
				<td class="FieldInput" colspan="5"><textarea name="adjustReason" field="adjustReason" rows="3" style="width:90%"/></textarea><font color="red">*</font></td>
			</tr>
			-->
