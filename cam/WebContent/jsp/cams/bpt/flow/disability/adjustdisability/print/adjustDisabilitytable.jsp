				...
				<next:Html>
					...
					<table border="1" width="99%">
						...
						<tr>	
							...
							<td class="FieldInput" colspan="5"><label name="adjustReason" field="adjustReason" rows="3" style="width:90%"/></label></td>
						</tr>
						<tr>
							<td class="FieldLabel">致残时间：</td>
							<td class="FieldInput" colspan="5"><label name="disabilityDate" field="disabilityDate"/></td>
						</tr>
						<tr>
							<td class="FieldLabel">致残地点：</td>
							<td class="FieldInput" colspan="5"><label name="disabilityAdd" field="disabilityAdd"></label></td>
						</tr>
						<tr>	
							<td class="FieldLabel">致残情况：</td>
							<td class="FieldInput" colspan="5"><label name="disabilityBody" field="disabilityBody"/></label></td>
						</tr>
						<tr>
