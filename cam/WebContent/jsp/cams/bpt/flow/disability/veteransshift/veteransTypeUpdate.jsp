...
<script type="text/javascript" src="veteransTypeUpdate.js"></script>
...
<model:datasets>
	...
	<model:dataset id="BptPeopleDisabilityDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptApplyDisabilityQueryCommand" method="queryVeteransDisability" global="true">
		<model:record fromBean="com.inspur.cams.bpt.base.data.BptPeopleDisability">
				...
				<model:field name="commitFlag" type="string" rule="require"/>
				<model:field name="serviceType" type="string" rule="require"/>
				...
				<next:Html>
					...
					<table border="1" width="98%">
						...
						<tr>
							...
							<td class="FieldInput" colspan="3"><input type="text" id="ingoingAddress" name="ingoingAddress" field="ingoingAddress" style="width:86%"/><font
								color="red">*</font> </td>
						</tr>
						<!-- <tr>
							...
							<td class="FieldInput" colspan="5"><textarea id="exchangeReason" name="exchangeReason" field="exchangeReason"
							 rows="3" style="width:92%"></textarea><font color="red">*</font></td>
						</tr>
						-->
						<tr>
							<td class="FieldLabel">备注(类别信息)：</td>
							<td class="FieldInput" colspan="5"><textarea
								rows="3" name="note" field="note" title="备注(类别信息)" style="width:90%"></textarea>
								</td>
