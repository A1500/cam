...
<script type="text/javascript" src="veteransShiftInsert.js"></script>
...
<model:datasets>
	<!-- 人员信息 -->
	<model:dataset id="BaseinfoPeopleDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptBaseinfoPeopleQueryCommand" method="queryBaseInfoPeople" global="true">
...
<next:Panel height="100%" width="100%" autoScroll="false">
	<next:TopBar>
	...
	<next:TabPanel>
		<next:Tabs>
				...
				<next:Html>
					...
					<table border="0" width="98%">
						<tr>
							...
							<td class="FieldLabel" width="2%" rowspan="3">照片:</td>
							<td nowrap   rowspan="3">
								<div  style="width:0px;">
			...
			<next:Panel title="类别信息" autoHeight="true" autoScroll="true" width="100%" id="typeInfo">
				<next:Html>
					<fieldset>
					...
					<table border="1" width="98%">
					    <tr>
					       <td class="FieldLabel" >伤残类别：</td>
							<td class="FieldInput" >
							<input type="hidden" id="disabilityTypeCode" name="disabilityTypeCode" value="11"
						...
						<tr>
							...
							<td class="FieldInput" ><input
								format="Y-m-d" style="width: 100px;" maxlength="10" type="text"
								name="retiredDate" field="retiredDate" title="离退休时间" onpropertychange="changeDateStyle(this)" /><img  src="../../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="FieldInput" ><select
								id="disabilityLevelCode" name="verteransLevelCode" field="verteransLevelCode" title="部队审批残疾等级" >
								<option dataset="DisabilityLevelDataset"></option>
							</select><font color="red">*</font></td>
							<td class="FieldLabel" >部队审批残疾性质：</td>
							<td class="FieldInput" >
								<select name="verteransCaseCode" field="verteransCaseCode" title="部队审批残疾性质">
									<option dataset="DisabilityCaseDataset"></option>
								</select><font color="red">*</font></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="FieldInput" ><input type="text" id="oldDisabilityNo"
						...
						<tr>
							...
							<td class="FieldInput">
							<input
								format="Y" style="width: 100px;" maxlength="10" type="text"
								name="allowanceMonth" field="allowanceMonth" onblur="setMoth(this)" title="抚恤金发至"/><img  src="../../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ><font
								color="red">*</font>
							</td>
							<td  class="FieldLabel" >从何地迁入：</td>
							<td class="FieldInput" colspan="3"><input type="text" name="ingoingAddress" title="从何地迁入" field="ingoingAddress" style="width:86%"/><font
								color="red">*</font> </td>
						</tr>
						<tr>
					<!--  <td class="FieldLabel">换证、补证原因：</td>
							<td class="FieldInput" colspan="5"><textarea id="exchangeReason" name="exchangeReason" field="exchangeReason"
							 rows="3" title="换证、补证原因" style="width:92%"></textarea><font color="red">*</font></td>
						</tr>
						-->		
						<tr>
							<td class="FieldLabel">备注(类别信息)：</td>
							<td class="FieldInput" colspan="5"><textarea
								rows="3" name="note" field="note" title="备注(类别信息)" style="width:92%"></textarea></td>
						</tr>
					</table>
					</form>
					</fieldset>
