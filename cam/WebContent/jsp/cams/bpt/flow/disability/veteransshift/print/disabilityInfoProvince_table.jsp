...
<input type="hidden" id="docpath" value="jsp/cams/bpt/flow/disability/veteransshift/print/disabilityIntoProvince_table.doc"/>
...
<input type="hidden" id="method" value="queryVeterIntoProvince"/>
<input type="hidden" id="serviceType" name="printQuery" queryData="queryData" value="14"/>
</body>  
