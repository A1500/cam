...
<html>
	<head>
		<title>伤残人员换证、补证呈报表</title>
		<next:ScriptManager/>
		<script type="text/javascript" src="exchangePending.js"></script>
	</head>
<body>
<model:datasets>
	<!-- 未提交换证、补证人员 -->
...
<next:GridPanel id="editGridPanel" name="bptpetitionGrid" clickToSelectedForChkSM="true" stripeRows="true" width="100%" height="100%" dataset="DisabilityPeopleDataSet">
	<next:TopBar>
		...
		<next:ToolBarItem symbol="-" ></next:ToolBarItem>
		<next:ToolBarItem iconCls="view" id="endButton"  text="结束" handler="end"/>
		<next:ToolBarItem symbol="-" ></next:ToolBarItem>
	</next:TopBar>
	...
	<next:Columns>
		...
		<next:Column id="regTime" header="录入时间" field="APPROVE_DATE" width="120" hidden="true">
			<next:TextField allowBlank="false"/>
		</next:Column> 
