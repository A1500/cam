...
<script type="text/javascript" src="changeCertiDisaUpdate.js"></script>
</head>
<body>
<model:datasets>
	<!-- 人员信息 -->
...
<next:Panel autoHeight="true"   bodyStyle="width:100%" width="100%" >
	<next:TabPanel>
		...
		<next:Panel title="电子档案" width="100%" height="100%"
				id="uploadTabPanel">
				<next:Html>
				    <iframe id="upload" src="../../../comm/uploadfileDetail.jsp?peopleId=<%=request.getParameter("peopleId")%>&serviceType=18&applyId=<%=request.getParameter("applyId")%>"
						frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="100%">
	   				</iframe>
				</next:Html>
		</next:Panel>

			<next:Panel width="100%" height="100%" autoScroll="false" title="残疾人员证件变更">
				<next:TopBar>
				...
				<next:Html>
					...
					<table border="1" width="99%">
						...
						<tr>
							...
							<td class="FieldInput" colspan="5"><textarea id="changeReasonContent" name="changeReasonContent" field="changeReasonContent" rows="3" style="width:95%"></textarea><font color="red">*</font></td>
						</tr>
