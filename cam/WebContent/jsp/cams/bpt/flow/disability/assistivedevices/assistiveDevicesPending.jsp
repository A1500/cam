...
<html>
	<head>
		<title>伤残人员配置伤残辅助器械待办</title>
		<next:ScriptManager/>
		<script type="text/javascript" src="assistiveDevicesPending.js"></script>
	</head>
<body>
<model:datasets>
	<!--  未提交配置伤残辅助器械 DataSet -->
	<model:dataset id="AssistiveDevicesDataset" cmd="com.inspur.cams.bpt.manage.cmd.BptApplyAssistiveDevicesQueryCommand" method="queryUnCommitPeople" global="true">
...
<next:GridPanel id="editGridPanel" name="bptpetitionGrid" clickToSelectedForChkSM="true" stripeRows="true" width="100%" notSelectFirstRow="true" height="100%" dataset="AssistiveDevicesDataset">
	<next:TopBar>
	...
	<next:BottomBar>
		<next:PagingToolBar dataset="AssistiveDevicesDataset"/>
	</next:BottomBar>
</next:GridPanel>
