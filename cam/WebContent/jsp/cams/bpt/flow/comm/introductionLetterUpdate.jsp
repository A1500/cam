...
<model:datasets>
	<!-- 残疾情况医学鉴定介绍信 -->
	<model:dataset id="DisabilityIdentiDataset" cmd="com.inspur.cams.bpt.manage.cmd.DisabilityIdentificationQueryCommand" global="true" method="introductionSave">
	...
	<next:Html>
		...
		<table border="1"  width="99%">
			...
			<tr>
				...
				<td class="FieldInput"><input type="text" format="Y-m-d" maxlength="10"style="width: 100px;" name="introductionDate" field="introductionDate" onpropertychange="changeDateStyle(this)"  title="介绍时间" onpropertychange="changeDateStyle(this)" /><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ><font color="red">*</font> </td>
				<td class="FieldLabel"  >鉴定时间：</td>
				<td class="FieldInput" colspan="5"><input type="text" format="Y-m-d" maxlength="10"style="width: 100px;" name="identificationDate" field="identificationDate"  onpropertychange="changeDateStyle(this)" title="鉴定时间" onpropertychange="changeDateStyle(this)" /><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ></td>
			</tr>
	   		<tr>
