			...
			<next:Panel height="100%" autoScroll="true" width="100%">
				<next:Html>
					...
					<table border="1" width="98%">
						...
						<tr>
							<td class="FieldLabel"  nowrap="nowrap">入伍(残疾工作)时间：</td>
							...
							<!-- 
							<td class="FieldLabel"  nowrap="nowrap">参加工作时间：</td>
							<td class="FieldInput" ><label name="toWorkDate" field="toWorkDate"/></td>  -->
						</tr>
						...
						<tr>
							...
							<td class="FieldInput" colspan="5"><label name="jobStatusDescribe" field="jobStatusDescribe"></label></td>
						</tr>
