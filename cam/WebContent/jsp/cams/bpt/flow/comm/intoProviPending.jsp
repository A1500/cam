...
<model:datasets>
	<!-- 外省人员迁入我省【未提交】 -->
	<model:dataset id="IntoProviDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptApplyIntoprovinceQueryCommand" method="queryIntoprovin" global="true">
	</model:dataset>
	<!-- 民族 -->
...
<next:GridPanel id="editGridPanel" name="bptpetitionGrid" clickToSelectedForChkSM="true" stripeRows="true" width="100%" height="100%" dataset="IntoProviDataSet">
	<next:TopBar>
	...
	<next:BottomBar>
		<next:PagingToolBar dataset="IntoProviDataSet"/>
	</next:BottomBar>
</next:GridPanel>
</body>
</html>
