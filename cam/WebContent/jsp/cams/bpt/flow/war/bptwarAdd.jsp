...
<script type="text/javascript" src="bptwarAdd.js"></script>
				...
				<next:Html>
					...
					<table border="0" width="98%">
						...
						<tr>
							...
							<td class="FieldInput"><input id="idCard" type="text" name="idCard"
								field="idCard" title="身份证件号码" maxlength="18"
								 onchange="func_QueryIdCardAllMessage()" style="width: 135" />
							...
							<td class="FieldInput"><input type="text" id="namebase"
								name="namebase" field="name" title="姓名" /><font color="red">*</font>
							</td>
						...
						<tr id="workAddress">
							...
							<td class="FieldInput" colspan="5"><input type="text"
								name="workUnitAdd" field="workUnitAdd" title="工人单位地址" style="width: 90%"></td>
						</tr>
				...
				<next:Html>
					...
					<table border="0" width="98%" align="left">
						...
						<tr>	
							...
							<td class="FieldInput" ><input type="text" id="healthStateName" name="healthStateName" field="healthStateName" title="健康状况" 
							   onfocus="func_HealthSelect()"/><input type="hidden" id="healthStateCode" field="healthStateCode" title="健康状况" /><font color="red">*</font></td>
							<td class="FieldLabel" nowrap>生活状况：</td>
							<td class="FieldInput" colspan="3"><select style="width: 120px;"
