...
<model:datasets>
	<!-- 参战人员抚恤关系跨省迁出【未提交】 -->
	<model:dataset id="ProvinceMigratDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptProvinceMigrateQueryCommand" method="queryUnComWarProvinceEmigrate" global="true">
	</model:dataset>
	<!-- 民族 -->
