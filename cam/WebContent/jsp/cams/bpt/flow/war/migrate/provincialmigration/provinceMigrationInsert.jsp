...
<model:datasets>
	...
	<model:dataset id="ProvinceMigrationDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptProvinceMigrateQueryCommand" global="true">
	...
	<next:Html>
		...
		<table border="1" width="99%">
			<tr>
				...
				<td class="FieldInput" style="width:15%"><input readonly="readonly" type="text" id="idCard" maxlength="18" name="idCard" field="idCard" style="width:135"/>
