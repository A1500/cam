...
<model:datasets>
	<!-- 参战人员省内迁移 -->
	<model:dataset id="ProvinceMigrationDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptProvinceMigrateQueryCommand" method="queryWarUpdateRecord" global="true">
	...
	<next:Html>
		...
		<table border="1" width="99%">
			...
			<tr>
				...
				<td class="FieldInput"><label   id="ingoingName"   name="ingoingName" field="ingoingName" />
				</td>
				<td class="FieldLabel" nowrap="nowrap">残疾抚恤金已发至:</td>   
				<td class="FieldInput"><label  id="allowanceMonth" name="allowanceMonth" field="allowanceMonth"/></td>
				<td class="FieldLabel" nowrap="nowrap">迁出地民政部门联系电话:</td>
				<td class="FieldInput" ><label   name="outTownCheckPhone" field="outTownCheckPhone"/></td>
			</tr>   
			<tr>
				<td class="FieldLabel" >迁入地户口薄(行政区划):</td>
				<td class="FieldInput" colspan="5"><span style="width:300px;"><label  id="domicileName"  name="domicileName" field="domicileName"></label></span>
					<span>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;地址:</span>    
					<label name="inDomicileAddress" field="inDomicileAddress" title="户口薄住址" ></label>
				</td>
			</tr>
			<tr>
				<td class="FieldLabel">迁入地实际居住(行政区划):
				</td> 
				<td class="FieldInput" colspan="5"><span style="width:300px;"><label   id="apanageName"   name="apanageName" field="apanageName" /></label></span>
					 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;地址: 
				    <label  name="inApanageAddress" field="inApanageAddress" title="实际居住地址"  /> 
				</td>
			</tr>
			<!-- 打印相关 -->
			...
			<input type="hidden" id="serviceType" name="printQuery" queryData="queryData" value="53"/>
		</table>
		</form>
   </next:Html>
</next:Panel>	
