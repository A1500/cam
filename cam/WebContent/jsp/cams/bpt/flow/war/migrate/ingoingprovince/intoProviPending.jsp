...
<model:datasets>
	<!-- 参战人员抚恤关系跨省迁出【未提交】 -->
	<model:dataset id="IntoProvinceDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptApplyIntoprovinceQueryCommand" method="queryUnCommitWarIntoprovi" global="true">
	</model:dataset>
	<!-- 民族 -->
