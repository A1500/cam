...
<html>
	<head>
		...
		<next:ScriptManager/>
		<script type="text/javascript" src="demoProvinceMigrationList.js"></script>
...
<model:datasets>
   ...
   <!-- 是否抗美援朝 -->
	...
	<!-- 未提交回乡复员人员省内迁出列表 -->
	<model:dataset id="BaseinfoPeopleDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptProvinceMigrateQueryCommand"  method="queryUnCommiDemoProvinceEmigrate" global="true">
	</model:dataset>
</model:datasets>
<next:GridPanel id="editGridPanel" name="baseinfopeopleGrid" width="100%" stripeRows="true" height="100%" dataset="BaseinfoPeopleDataSet" >
	...
	<next:Columns>
	    ...
	    <next:Column id="serviceType" header="serviceType" field="SERVICE_TYPE"  width="60" hidden="true">
        ...
        <next:Column id="peopleId" header="peopleId" field="PEOPLE_ID" width="60" hidden="true">
			<next:TextField allowBlank="false" />
		        ...
		        <next:Column id="peopleId" header="applyId" field="APPLY_ID" width="60" hidden="true">
			<next:TextField allowBlank="false" />
		</next:Column>
		...
		<next:Column id="belongDate" header="属于时期" field="BELONGDATE" width="60" dataset="warDs">
			<next:TextField  />
			
		</next:Column>
		<next:Column id="dsIskoeanwar" header="是否参加抗美援朝" field="IS_KOREANWAR" width="103" dataset="dsIskoeanwar">
			<next:TextField  />
		</next:Column>
		<next:Column id="CONSCRIPT_DATE" header="入伍时间" field="CONSCRIPT_DATE" width="90">
			<next:TextField  />
		</next:Column>
		<next:Column id="DECRUITMENT_DATE" header="退伍时间" field="DECRUITMENT_DATE" width="90">
			<next:TextField  />
		</next:Column>
		<next:Column id="DEMOBILIZED_NO" header="复员证号" field="DEMOBILIZED_NO" width="90" >
			<next:TextField  />
		</next:Column>
