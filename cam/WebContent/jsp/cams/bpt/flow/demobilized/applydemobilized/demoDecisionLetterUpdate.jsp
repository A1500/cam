...
<script type="text/javascript" src="demoDecisionLetterUpdate.js"></script>
...
<model:datasets>
	...
	<!-- 不符合情形 -->
	<model:dataset id="noFitDataset" enumName="DEMOBILIZED.NOFIT.CODE" autoLoad="true" global="true"></model:dataset>
	<!-- 依据条款 -->
	<model:dataset id="foundationDataset" enumName="DEMOBILIZED.FOUNDATION.CODE" autoLoad="true" global="true"></model:dataset>
</model:datasets>
	...
	<next:Html>
		...
		<table border="1"  width="99%">
	   		<tr>
				...
				<td class="FieldInput" width="30%">在乡复员军人身份认定 </td>
			</tr>
			<tr>
