...
<script type="text/javascript" src="openDemoUpdate.js"></script>
			...
			<next:Panel height="100%" autoScroll="true" width="100%" id="typeInfo">
				...
				<next:Html>
					...
					<table border="1" width="98%">
						...
						<tr>
							<td class="FieldLabel" >将要享受待遇：</td>
							<td class="FieldInput"  colspan="5"><textarea
								rows="2" name="treatment"
								field="treatment" style="width:94%" title="在部队情况"></textarea><font color="red">*</font></td>
						</tr>
						<tr>
						...
						<input type="hidden" id="docpath" value="jsp/cams/bpt/flow/demobilized/applydemobilized/print/demobilizedOpenLetter.doc"/>
