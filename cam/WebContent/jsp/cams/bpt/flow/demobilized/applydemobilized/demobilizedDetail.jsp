...
<next:Panel autoHeight="true"  bodyStyle="width:100%" width="100%" >
	...
	<%--<next:Panel title="介绍信3" width="100%" height="100%"
				id="introduceTabPanel">
				<next:Html>
		...
		<next:Panel title="公示书" width="100%" height="100%"
				id="openletter">
				<next:Html>
				  <iframe id="openletter1" src="openDemoDetail.jsp?peopleId=<%=request.getParameter("peopleId")%>&familyId=<%=request.getParameter("familyId")%>&applyId=<%=request.getParameter("applyId")%>&serviceType=41"
						frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="100%">
	   				</iframe>
				</next:Html>
		</next:Panel>
		<next:Panel title="县级审核" width="100%" height="100%"
				id="demobilizedEdit">
				<next:Html>
				  <iframe id="demobilizedEdit" src="demobilizedflow_editDetail.jsp?peopleId=<%=request.getParameter("peopleId")%>&familyId=<%=request.getParameter("familyId")%>&applyId=<%=request.getParameter("applyId")%>&serviceType=41"
						frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="100%">
	   				</iframe>
				</next:Html>
		</next:Panel>
		...
		<next:Panel title="不予认定在乡复员审批决定书" width="100%" height="100%"
				id="decisionLetterTabPanel">
				<next:Html>
				  <iframe id="decisionTabPanel" src="demoDecisionLetterDetail.jsp?peopleId=<%=request.getParameter("peopleId")%>&applyId=<%=request.getParameter("applyId")%>"
						frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="100%">
	   				</iframe>
				</next:Html>
		</next:Panel>
