...
<html>
	<head>
		...
		<next:ScriptManager/>
		<script type="text/javascript" src="changeDemobilizedList.js"></script>
...
<model:datasets>
   ...
   <!-- 是否抗美援朝 -->
	...
	<!-- 未提交回乡复员人员换证、补证列表 -->
	<model:dataset id="BaseinfoPeopleDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptApplyDemobilizedQueryCommand" autoLoad="true" method="queryDemobilizedPeopleList" global="true">
	</model:dataset>
</model:datasets>
