...
<next:Tabs>
	...
	Map<String, Object> Idmap = new HashMap<String, Object>();
		BptBaseinfoPeopleQueryCommand command= new BptBaseinfoPeopleQueryCommand();
				...
				applyId =(String) Idmap.get("applyId");
		
	%>
<next:Panel width="100%" id="demobilizedTabPanel" title="换证、补证信息表" height="100%">
				
				<next:Html>
					<iframe id="instance" src="../../../jsp/cams/bpt/flow/demobilized/changecertidem/exchaCertiDemoDetail.jsp?peopleId=<%=peopleId%>&familyId=<%=familyId%>&applyId=<%=applyId%>"
						frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="yes" allowtransparency="yes" width="100%" height="100%">
	   				</iframe>
				</next:Html>			
</next:Panel>	

<next:Panel  title="在乡复员换证、补证申请审批" height="100%" width="100%" id="approveTabPanel" autoScroll="true" >
	<next:TopBar>
			...
			<div id="city">
				<table border="1"  width="100%" >
					...
					<tr>
						...
						<td class="FieldInput"><input type="text" name="approvalDate" field="approvalDate" id="approvalDate" format="Y-m-d" style="width: 100px;" maxlength="10" /><img  src="../../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" > </td>
					</tr>
				</table>
			</div>
