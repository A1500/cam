...
<next:ScriptManager />
<script type="text/javascript" src="exchaCertiDemoInsert.js"></script>
	...
	<next:Html>
		...
		<table border="1" width="99%">
			<tr>
				...
				<td class="FieldInput" style="width:15%"><input type="text" name="idCard" field="idCard" style="width:135" onchange="queryByIdCard()"/>
