...
<model:datasets>
	<!-- 在乡复员军人信息 -->
	<model:dataset id="PeopleDemobilizedDataset" cmd="com.inspur.cams.bpt.manage.cmd.BptApplyIntoprovinceQueryCommand" global="true" method="queryDemobilizedBptPeople">
		...
		<table border="1"  border="0" width="98%">
		   <tr>
	   		...
	   		<tr>
				...
				<td class="FieldInput" colspan="3"><label name="belongDate" field="belongDate" dataset="warDs" title="属于时期"></label></td>
			...
			<!--   <tr>
			   ...
			   <td  class="FieldLabel" nowrap>批准日期：</td>
				<td class="FieldInput" colspan="3"><label name="approvalDate" field="approvalDate" title="批准日期"></label></td>
			</tr>
			-->
	   		<tr>
	   			<td class="FieldLabel" nowrap="nowrap">原残疾证件编号：</td>
				<td class="FieldInput" ><label  name="oldPaperNo" field="oldPaperNo" id="oldPaperNo" title="原残疾证件编号" maxlength="8"/></td>
