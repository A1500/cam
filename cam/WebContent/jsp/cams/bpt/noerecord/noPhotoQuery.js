...
function openDetail(peopleId,username,idCard,objectType){
	...
	var url = L5.webPath+"/jsp/cams/bpt/noerecord/noPhotoBasicInfoUpdate.jsp?peopleId="+peopleId+"&familyId="+familyId+"&username="+username+"&idCard="+idCard+"&objectState=2&objectType="+objectType;
...
/*function update(){ 
   ...
   objectState = basicInfoGrid.getSelectionModel().getSelections()[0].get('OBJECT_STATE');
	...
	var url='./peopleBasicInfo/basicInfoUpdate.jsp?peopleId='+peopleId+'&familyId='+familyId+'&username='+username+'&idCard='+idCard+'&objectState='+objectState+'&objectType='+objectType;
