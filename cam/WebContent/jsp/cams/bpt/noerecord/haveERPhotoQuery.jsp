...
<html>
	<head>
		<title>档案完全人员查询</title>
		<next:ScriptManager/>
		<script type="text/javascript" src='<%=SkinUtils.getJS(request,"camsCheck.js")%>'></script>
		<script type="text/javascript" src="haveERPhotoQuery.js"></script>
...
<body>
<model:datasets>
	<model:dataset id="NoERecordDataset" cmd="com.inspur.cams.bpt.manage.cmd.BptNoERecordQueryCommand" method="queryHaveERecordPhoto" global="true" pageSize="10">
	</model:dataset>
	<model:dataset id="NoERecordDataset1" cmd="com.inspur.cams.bpt.manage.cmd.BptNoERecordQueryCommand" method="queryHaveERecordPhoto" global="true" pageSize="10">
	</model:dataset>
	<!-- 优抚对象状态 -->
...
<next:GridPanel id="editGridPanel" name="noERecordGrid" width="100%" stripeRows="true" height="100%" dataset="NoERecordDataset" title="档案完全人员查询">
	<next:TopBar>
