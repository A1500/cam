...
<html>
<head>
<title>三属抚恤及人员情况统计</title>
<script type="text/javascript">
</script>

<next:ScriptManager />
<script type="text/javascript" src="dependentQueryStatistics.js"></script>
...
<model:datasets>
	...
	<model:dataset id="BptPeopleDemobilizedDataSet"
		cmd="com.inspur.cams.bpt.query.cmd.BptPeopleQueryStatisticsCmd" method="queryDependent"
...
<next:GridPanel id="GridPanel" name="baseinfopeopleGrid" width="100%"
	...
	title="三属人员抚恤信息" notSelectFirstRow="true">
	<next:TopBar>
	...
	<next:Columns>
		...
		<next:Column id="disabilityStateCode" header="三属类别" field="DEPENDANTTYPE"
			width="90" dataset="DependantTypeDataset">
			<next:TextField allowBlank="false" />
		</next:Column>
