...
<html>
<head>
<title>带病回乡军人抚恤统计表</title>
<script type="text/javascript">
</script>

<next:ScriptManager />
<script type="text/javascript" src="demobilizedIllnessQueryStatistics.js"></script>
<script type="text/javascript"
...
<model:datasets>
	...
	<model:dataset id="BptPeopleDemobilizedDataSet"
		cmd="com.inspur.cams.bpt.query.cmd.BptPeopleQueryStatisticsCmd" method="queryDemobilizedIllness"
	...
	<next:Html>
		...
		<table border="1" width="100%">
			<tr>
				...
				<td class="FieldInput"><input type="text" id="domicileName" style="width: 60"
				...
				<td class="FieldInput"><input type="text" id="name" style="width: 90"
				...
				<td class="FieldInput">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<button onclick="set()">重 置</button></td>
			</tr>
			<tr>
				<td class="FieldLabel">户籍类别：</td>
				<td class="FieldInput"><select id="domicileType" style="width: 60">
					<option dataset="DomicileDataset"></option>
				</select></td>
				<td class="FieldLabel" nowrap="nowrap">证书编号：</td>
				<td class="FieldInput"><input type="text" id="demobilizedno" style="width: 90"
				...
				<td class="FieldInput" colspan="3" ><input type="text" id="cxsj_q"
						format="Y-m-d" style="width: 100px;" maxlength="10" onpropertychange="changeDateStyle(this)" 
						/><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" >--  --<input
						type="text" id="cxsj_z" format="Y-m-d"
						style="width: 100px;" maxlength="10"  onpropertychange="changeDateStyle(this)" 
...
<next:GridPanel id="GridPanel" name="baseinfopeopleGrid" width="100%"
	...
	title="带病回乡军人信息" notSelectFirstRow="true">
	<next:TopBar>
	...
	<next:Columns>
		...
		<next:Column  header="工作单位" field="WORKUNIT"
			width="90">
			<next:TextField allowBlank="false" />
		</next:Column>
		...
		<next:Column  header="入伍时间" field="INLISTTIME"
			width="90"  >
			<next:TextField allowBlank="false" />
		</next:Column>
		
		<next:Column  header="退伍时间" field="RETIREDTIME"
			width="90"  >
			<next:TextField allowBlank="false" />
		</next:Column>
		
		<next:Column  header="参保类型" field="SAFEGUARD"
			width="90"  dataset="SafeguardDataset">
			<next:TextField allowBlank="false" />
		</next:Column>
		<next:Column  header="医疗保险证号" field="MEDICAL"
			width="90">
			<next:TextField allowBlank="false" />
		</next:Column>
		<next:Column  header="是否参战" field="WAR"
			width="90"  dataset="YesNo">
			<next:TextField allowBlank="false" />
		</next:Column>

		<next:Column  header="是否参试" field="INNUCLEAR"
			width="90"  dataset="YesNo">
			<next:TextField allowBlank="false" />
		</next:Column>

		<next:Column id="disabilityWarCode" header="抚恤金额(元)" field="MOUN" align="right"			width="90">
			<next:TextField  />
		</next:Column>
