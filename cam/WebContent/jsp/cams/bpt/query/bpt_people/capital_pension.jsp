...
<html>
<head>
<title>定期抚恤金人员情况统计</title>
<next:ScriptManager />
<script type="text/javascript" src="capital_pension.js"></script>
...
<model:datasets>
	...
	<model:dataset id="BptCompulsoryDataSet"
		...
		method="queryCapitalPension" global="true" pageSize="100">
	</model:dataset>
...
<next:GridPanel id="GridPanel" name="baseinfopeopleGrid" width="100%"
	...
	title="定期抚恤金人员信息" notSelectFirstRow="true">
	<next:TopBar>
