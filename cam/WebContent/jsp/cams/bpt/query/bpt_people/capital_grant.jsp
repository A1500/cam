...
<html>
<head>
<title>生活补助金人员情况统计</title>
<next:ScriptManager />
<script type="text/javascript" src="capital_grant.js"></script>
...
<model:datasets>
	...
	<model:dataset id="BptCompulsoryDataSet"
		...
		method="queryGrant" global="true" pageSize="100">
	</model:dataset>
...
<next:GridPanel id="GridPanel" name="baseinfopeopleGrid" width="100%"
	...
	title="生活补助金人员信息" notSelectFirstRow="true">
	<next:TopBar>
