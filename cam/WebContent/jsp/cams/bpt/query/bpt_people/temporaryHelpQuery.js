...
function query() {
	...
	var ds = L5.DatasetMgr.lookup("BptTemporaryDataSet");
...
function excel_export() {
	if(BptTemporaryDataSet.getCount() == 0) {
		L5.Msg.alert("提示","没有要导出的数据");
		return false;
	}
	L5.dataset2excel(BptTemporaryDataSet,"/jsp/cams/bpt/query/excel_export/capitalGrantExcel.jsp?type=2");
}
