...
<html>
<head>
<title>部分烈士子女人员情况统计</title>
<script type="text/javascript">
</script>

<next:ScriptManager />
<script type="text/javascript" src="martyrOffspringQueryStatistics.js"></script>
...
<model:datasets>
	...
	<model:dataset id="BptPeopleDemobilizedDataSet"
		cmd="com.inspur.cams.bpt.query.cmd.BptPeopleQueryStatisticsCmd" method="queryMartyrOffspring"
...
<next:GridPanel id="GridPanel" name="baseinfopeopleGrid" width="100%"
	...
	title="部分烈士子女人员信息" notSelectFirstRow="true">
	<next:TopBar>
