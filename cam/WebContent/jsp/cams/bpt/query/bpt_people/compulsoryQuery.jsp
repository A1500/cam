...
<html>
<head>
<title>优待金抚恤统计表</title>
<next:ScriptManager />
<script type="text/javascript" src="compulsoryQuery.js"></script>
...
<model:datasets>
	...
	<!-- 伤残信息 -->
	<model:dataset id="BptCompulsoryDataSet"
		cmd="com.inspur.cams.bpt.query.cmd.BptPeopleQueryStatisticsCmd"
		method="queryCompulsory" global="true" pageSize="100">
	</model:dataset>
...
<next:GridPanel id="GridPanel" name="baseinfopeopleGrid" width="100%"
	stripeRows="true" height="100%" dataset="BptCompulsoryDataSet"
	title="优待金发放人员信息" notSelectFirstRow="true">
	<next:TopBar>
	...
	<next:Columns>
		...
		<next:Column id="objectType" header="优抚对象类别"
			field="OBJECT_TYPE_CODE" width="90" dataset="ObjectDataSet">
			<next:TextField allowBlank="false" />
		</next:Column>
	...
	<next:BottomBar>
		<next:PagingToolBar dataset="BptCompulsoryDataSet" />
	</next:BottomBar>
