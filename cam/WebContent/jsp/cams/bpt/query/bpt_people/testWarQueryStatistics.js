...
function init() {
	if (autoQuery == "true") {
		...
		var selects = document.getElementById("serviceType").options;
		for (var i = 0; i < selects.length; i++) {
			if (selects[i].value == serviceType) {
...
function toExcel(){
	...
	L5.dataset2excel(ds,"/jsp/cams/bpt/query/excel_export/testWarQueryStatistics_excel.jsp");
