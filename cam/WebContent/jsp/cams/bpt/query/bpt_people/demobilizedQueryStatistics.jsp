...
<html>
<head>
<title>在乡复员军人抚恤统计表</title>
<script type="text/javascript">
</script>

<next:ScriptManager />
<script type="text/javascript" src="demobilizedQueryStatistics.js"></script>
<script type="text/javascript"
...
<model:datasets>
	...
	<model:dataset id="BptPeopleDemobilizedDataSet"
		cmd="com.inspur.cams.bpt.query.cmd.BptPeopleQueryStatisticsCmd" method="queryDemobilized"
...
<next:GridPanel id="GridPanel" name="baseinfopeopleGrid" width="100%"
	...
	title="在乡复员军人信息" notSelectFirstRow="true">
	<next:TopBar>
	...
	<next:Columns>
		...
		<next:Column id="disabilityNo" header="属于时期" field="BELONGDATE"
			width="60" dataset="warDs">
			<next:TextField allowBlank="false" />
		</next:Column>
		
				<next:Column id="disabilityStateCode" header="入伍时间" field="INLISTTIME"
			width="90"  >
			<next:TextField allowBlank="false" />
		</next:Column>
		
		<next:Column id="disabilityStateCode" header="退伍时间" field="RETIREDTIME"
			width="90"  >
			<next:TextField allowBlank="false" />
		</next:Column>
