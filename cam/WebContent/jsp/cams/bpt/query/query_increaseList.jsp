...
<html>
	<head>
		...
		<script type="text/javascript" src="query_increaseList.js"></script>
...
<model:datasets>
	<!-- 全部人员信息 -->
	<model:dataset id="dsBptObject" cmd="com.inspur.cams.bpt.manage.cmd.BptBaseinfoPeopleQueryCommand" method="queryIncreaseBpt" global="true" pageSize="100">
...
<next:Panel name="offspringform" id="offspringform" hidden="true" width="100%" border="0" autoScroll="true"
	...
	<next:Html>
		...
		<table border="1" width="100%">
			...
			<tr>
					<td class="FieldLabel">批准日期：</td>
					<td  style="background-color: #f5fafa;text-align: left;font: normal 12px tahoma, arial, helvetica, sans-serif;"><select id ="offspringtimeType" onchange="showTime('test')">
					<option value="2">截止日期</option>
					<option value="1">起止日期</option>
					</select>  
