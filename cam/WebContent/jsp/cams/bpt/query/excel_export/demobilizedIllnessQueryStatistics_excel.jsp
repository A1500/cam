...
%>
<Excel:tablelist filename="带病回乡军人信息" >
	<Excel:table>
		<Excel:tr>
			<Excel:td colspan="9" align="center"><Excel:font size="12">带病回乡军人信息</Excel:font></Excel:td>
		</Excel:tr>
		<Excel:tr >
		...
		<Excel:tr bgcolor="grey"  border="1">
			...
			<Excel:td align="center" width="120" rowspan="2"><Excel:font size="13">入伍时间</Excel:font></Excel:td>
			<Excel:td align="center" width="120" rowspan="2"><Excel:font size="13">退伍时间</Excel:font></Excel:td>
			...
			<Excel:td align="center" width="120" rowspan="2"><Excel:font size="13">是否参试</Excel:font></Excel:td>
		...
		<Excel:tr border="1">
            ...
            <Excel:td  align="center" width="120"><%=record.get("INLISTTIME")==null?"":record.get("INLISTTIME")%></Excel:td>
            <Excel:td  align="center" width="120"><%=record.get("RETIREDTIME")==null?"":record.get("RETIREDTIME")%></Excel:td>
              ...
              <Excel:td align="center" width="120"><%=EnumUtil.findTextFromEnum(String.valueOf(record.get("WAR")),"COMM.YESORNO")%></Excel:td>
              <Excel:td align="center" width="120"><%=EnumUtil.findTextFromEnum(String.valueOf(record.get("INNUCLEAR")),"COMM.YESORNO")%></Excel:td>
