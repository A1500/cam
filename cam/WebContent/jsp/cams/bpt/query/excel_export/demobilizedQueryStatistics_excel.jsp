...
%>
<Excel:tablelist filename="在乡复员军人信息" >
	<Excel:table>
		<Excel:tr>
			<Excel:td colspan="9" align="center"><Excel:font size="12">在乡复员军人信息</Excel:font></Excel:td>
		</Excel:tr>
		<Excel:tr >
		...
		<Excel:tr border="1">
            ...
            <Excel:td align="center" width="120"><%=EnumUtil.findTextFromEnum(String.valueOf(record.get("BELONGDATE")),"DEMOBILIZED.BELONGDATE")%></Excel:td>
