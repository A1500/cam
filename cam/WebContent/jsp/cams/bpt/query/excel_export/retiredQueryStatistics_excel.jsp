...
%>
<Excel:tablelist filename="农村籍退役士兵人员信息" >
	<Excel:table>
		<Excel:tr>
			<Excel:td colspan="9" align="center"><Excel:font size="12">农村籍退役士兵人员信息</Excel:font></Excel:td>
		</Excel:tr>
		<Excel:tr >
		...
		<Excel:tr border="1">
			...
			<Excel:td align="center" width="120"></Excel:td> 
		</Excel:tr>
		<%
			}
		%>
