...
<Excel:tablelist filename="伤残人员信息" >
	<Excel:table>
		<Excel:tr>
			<Excel:td colspan="9" align="center"><Excel:font size="12">三属人员信息</Excel:font></Excel:td>
		</Excel:tr>
		<Excel:tr >
		...
		<Excel:tr bgcolor="grey"  border="1">
			...
			<Excel:td align="center" width="200" rowspan="2"><Excel:font size="13">三属类别</Excel:font></Excel:td>
		...
		<Excel:tr border="1">
            ...
            <Excel:td  align="center" width="120"><%=record.get("DEMOBILIZEDNO")==null?"":record.get("DEMOBILIZEDNO")%></Excel:td>
              ...
              <Excel:td align="center" width="120"><%=EnumUtil.findTextFromEnum(String.valueOf(record.get("DEPENDANTTYPE")),"DEPENDANT.CODE")%></Excel:td>
