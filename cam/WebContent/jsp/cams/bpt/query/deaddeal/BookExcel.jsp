...
<%
	...
	String name="待办理去世优抚对象信息_"+date;
	out.clear();//清空缓存的内容
	out = pageContext.pushBody(); 
%>
</head>
<Excel:tablelist filename="<%=name%>">
	<Excel:table sheetname="待办理去世优抚对象信息">
		<Excel:tr>
			<Excel:td colspan="10" align="center" ><Excel:font size="15"  bold="true">"代办理去世优抚对象信息"</Excel:font></Excel:td>
		</Excel:tr>
		<Excel:tr>
