...
<script type="text/javascript" src="page_YouDaiJin.js"></script>
...
<model:datasets>
	<model:dataset id="ds"
		cmd="com.inspur.cams.bpt.query.cmd.YouDaiJinStandardCmd"
	...
	<next:Panel name="form" width="100%" border="0"
		...
		<next:Html>
			...
			<table border="1" width="100%">
				<tr>
					<td class="FieldLabel" nowrap>查询时间段:</td>
					<td class="FieldInput" colspan="3" ><input type="text" id="cxsj_q"
						format="Y-m-d" style="width: 100px;" maxlength="10"/><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" >--  --<input
		...
		<next:Html>
			<div align="center" id="reDiv" style="display: none;" >
				<div align="center" style="width: 80%;">
					...
					<br />
					<div align="right"><span style="font-size: small;">单位：员&frasl;人</span></div>
				</div>
				...
				<tr repeat="true">
					<td width="20%" align="left"><a href="#"><label id="test" field="ORGAN_NAME"  onclick="test(this)" size="6" readonly="true"  /></label>
						<label id="code" field="ORGAN_CODE"  style="display:none" size="6" readonly="true" /></label></a></td>
					<td width="4%" align="right"><input type="text" field="SOLDIER_TOWN"
						size="6" readonly="true" /></td>
					<td width="4%" align="right"><input type="text" field="SOLDIER_COUNTRY"
						size="6" readonly="true" /></td>
					<td width="4%" align="right"><input type="text" field="SANSHU_TOWN"
						size="6" readonly="true" /></td>
					<td width="4%" align="right"><input type="text" field="SANSHU_COUNTRY"
						size="6" readonly="true" /></td>
					<td width="4%" align="right"><input type="text" field="DEMOBILIIZED_SOLDIER"
						size="6" readonly="true" /></td>
					<td width="4%" align="right"><input type="text" field="DISABLED_SOLDIER"
						size="6" readonly="true" /></td>
				</tr>
			</table>
			</div>
