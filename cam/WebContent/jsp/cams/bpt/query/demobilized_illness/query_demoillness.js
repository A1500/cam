...
function test(value) {
	...
	data.put("xzqu", xzqu);
	var url = "jsp/cams/bpt/query/demobilized_illness/query_demoillness.jsp";
	...
	var url = L5.webPath+"/jsp/cams/bpt/query/demobilized_illness/query_demoillness.jsp"+parm;
	window.open(url);
}
function back() {
	history.go(-1);
...
function printBill(){
	...
	var url = L5.webPath+'/jsp/cams/bpt/query/print/demobilizedIll.fr3'; 
	var reportName="带病回乡退伍军人统计表";
