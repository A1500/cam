...
function query() {
	...
	if (objectType == '6') {// 参试
		...
		if(getParam("offspringspringDomicileCode") == "" || getParam("offspringDomicileCode") == null) {
			dsBptObject
				.setParameter("organCode",organCode);
		} else {
			dsBptObject
		...
		var testType = getParam("offspringType");
		if(testType != null && testType != "") {
...
function excel_export() {
	...
	L5.dataset2excel(dsBptObject,"/jsp/cams/bpt/query/excel_export/increaseOrDecreaseExcel.jsp?type=increase");
}