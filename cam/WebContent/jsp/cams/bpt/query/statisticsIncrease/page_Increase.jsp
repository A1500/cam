...
<script type="text/javascript" src="page_Increase.js"></script>
...
<script type="text/javascript">
	...
	endTimeId = "cxsj_z";
	startTimeId = "cxsj_q";
	urlPage = "../query_increaseList.jsp";
</script>
<style>
body {
...
<model:datasets>
	<model:dataset id="ds"
		cmd="com.inspur.cams.bpt.query.cmd.YouFuTongJi_IncreaseCmd"
	...
	<next:Panel name="form" width="100%" border="0"
		...
		<next:Html>
			...
			<table border="1" width="100%">
				<tr>
					<td class="FieldLabel" nowrap>批准起止日期:</td>
	...
	<next:Panel width="100%" border="0"
		...
		<next:Html>
			...
			<div align="center"><span id="reportTitle"
				style="font-size: large;">新增优抚对象人数统计表</span></div>
			...
			<div align="right"><span style="font-size: small;">编制单位：<%=BspUtil.getOrganName()%></span></div>
					...
					<table width="1350" dataset="ds" align="center" style="margin-left:40px;margin-right:40px;">
						...
						<tr>
							...
							<td class="tdTitle" width="60" align="center">部分</br>烈士子女
							</td>
