...
<script type="text/javascript" src="query_uranium.js"></script>
...
<model:datasets>
	<model:dataset id="ds"
		cmd="com.inspur.cams.bpt.query.cmd.UraniumTongJiCmd" global="true"
		autoLoad="false">
		<model:record>
	...
	<next:Panel width="100%" border="0"
		...
		<next:Html>
			...
			<div align="center"><span id="reportTitle"
				style="font-size: large;">山东省铀矿开发军队统计表</span></div>
			...
			<div align="right"><span style="font-size: small;">编制单位：<%=BspUtil.getOrganName()%></span></div>
					...
					<table width="700" dataset="ds" align="center" style="margin-left:40px;margin-right:40px;">
						<tr>
							...
							<td class="tdTitle" width="200" align="center">农村</td>
							<td class="tdTitle" width="200" align="center">城镇</td>
							<td class="tdTitle" width="110" align="center" >合计</td>
						</tr>
						<tr repeat="true">
							...
							<td align="right" nowrap="nowrap" class="td"><a href="#" style="cursor:hand"><label onclick="redirectQuery(this.parentNode.parentNode,'3','1')" field="T1" ></label></a></td>
							<td align="right" nowrap="nowrap" class="td"><a href="#" style="cursor:hand"><label onclick="redirectQuery(this.parentNode.parentNode,'3','2')" field="T2" ></label></a></td>
							<td align="right" nowrap="nowrap" class="td"><a href="#" style="cursor:hand"><label onclick="redirectQuery(this.parentNode.parentNode,'3','')" field="T3" ></label></a></td>
