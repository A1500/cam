...
function setReportTitle() {
	...
	if (year1 ==year2) {
		reportTitleSpan.innerHTML = getChnNumber(year1) + "年山东省铀矿开发军队统计表";
	}else{
		reportTitleSpan.innerHTML =getChnNumber(year1)+"--"+getChnNumber(year2)+ "山东省铀矿开发军队统计表";
	}
}
...
var type = document.getElementById("timeType").value;
	...
	var url = L5.webPath+"/jsp/cams/bpt/query/uranium/query_uranium.jsp"+parm;
	window.open(url);
}
 //打印预览调用方法
function printBill(){
	var printDataset=L5.DatasetMgr.lookup("ds");
	var url = L5.webPath+'/jsp/cams/bpt/query/print/queryuranium.fr3'; 
	var reportName="山东省铀矿开发军队统计表";
