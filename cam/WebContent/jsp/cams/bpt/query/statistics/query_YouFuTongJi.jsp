...
<script type="text/javascript" src="query_YouFuTongJi.js"></script>
...
<model:datasets>
	<model:dataset id="ds"
		cmd="com.inspur.cams.bpt.query.cmd.YouFuTongJiCmd" global="true"
		autoLoad="false">
		<model:record>
	...
	<next:Panel width="100%" border="0"
		...
		<next:Html>
			...
			<div align="center"><span id="reportTitle"
				style="font-size: large;">各类优抚对象人数统计表</span></div>
			...
			<div align="right"><span style="font-size: small;">编制单位：<%=BspUtil.getOrganName()%></span></div>
					...
					<table width="1350" dataset="ds" align="center" style="margin-left:40px;margin-right:40px;">
						...
						<tr repeat="true">
							...
							<td align="right" nowrap="nowrap" class="td"><a href="#" style="cursor:hand"><label  
								readonly="true" field="OFFSPRINGL" onclick="redirectQuery(this.parentNode.parentNode,'B')"></label></a></td>
							<td align="right" nowrap="nowrap" class="td"><a href="#" style="cursor:hand"><label  
								readonly="true" field="OFFSPRINGP" onclick="redirectQuery(this.parentNode.parentNode,'B')"></label></a></td>
