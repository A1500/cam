...
<script type="text/javascript" src="query_compulsory.js"></script>
...
<model:datasets>
	<model:dataset id="ds"
		cmd="com.inspur.cams.bpt.query.cmd.CompulsoryQueryCmd"
			...
			<div align="center" id="reDiv" style="display: none;" >
				...
				<div align="center" style="width: 80%;">
					<div align="center"><span id="reportTitle"
						style="font-size: large;">优待金发放情况</span></div>
				...
				<tr>
					...
					<td class="tdTitle" align="center" width="15%" colspan="3">伤残军人</td>
					<td class="tdTitle" align="center" width="15%" colspan="3">三属人员</td>
					<td class="tdTitle" align="center" width="15%" colspan="3">复员军人</td>
					<td class="tdTitle" align="center" width="15%" colspan="3">带病回乡退役人员</td>
				</tr>
				<tr>
