...
<html>
	<head>
		...
		<script type="text/javascript" src="query_martyroffList.js"></script>
		...
		<script language="javascript">
			 ...
			 function collapse(element){
       	   ...
       	   var statusType = '<%=request.getParameter("statusType")%>';
					...
					<form style="width: 95%; height: 100%;" class="L5form">
						<table  border="1" width="100%" >
						   ...
						   <tr >
								...
								<td class="FieldInput">
								    <select name="statusType" field="statusType" title="身份类别" style="width:160">
