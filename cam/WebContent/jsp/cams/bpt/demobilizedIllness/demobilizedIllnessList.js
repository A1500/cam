...
function insert() {
	...
	var url='jsp/cams/bpt/demobilizedIllness/demobilizedIllnessInsert.jsp';
...
function update(){
	...
	var url='jsp/cams/bpt/demobilizedIllness/demobilizedIllnessEdit.jsp';
...
function detail(){
	...
	data.put("dataBean",selected[0].get('peopleId'));
	var url='jsp/cams/bpt/demobilizedIllness/demobilizedIllnessDetail.jsp';
	var text = '修改基础信息_人员信息';
	L5.forward(url,text,data);
}
