...
<html>
	<head>
		...
		<next:ScriptManager/>
		<script type="text/javascript" src="bpthospital_year_list.js"></script>
		<script>
...
<body>
<model:datasets>
	<model:dataset id="ds" cmd="com.inspur.cams.bpt.bptinstitution.cmd.BptHospitalQueryCommand" method="getDetail"  global="true">
...
<next:GridPanel id="editGridPanel" name="bpthospitalGrid" clickToSelectedForChkSM="true" width="100%" stripeRows="true" height="100%" dataset="ds" title="优抚医院信息">
	<next:TopBar>
		...
		<next:ToolBarItem text="删除" iconCls="delete" handler="hospitalDelete" />
	</next:TopBar>
	<next:Columns>
	    <next:RowNumberColumn width="30"/>
	    <next:CheckBoxColumn></next:CheckBoxColumn>
	     
		<next:Column id="hospitalId" header="hospitalId" field="hospitalId" width="90" hidden="true">
			<next:TextField allowBlank="false" />
		</next:Column>
		<next:Column id="ID" header="ID" field="id" width="90" hidden="true">
			<next:TextField allowBlank="false" />
		</next:Column>
		<next:Column id="domicileCode" header="年度" field="years" width="120"  >
			<next:TextField allowBlank="false"/>
		</next:Column>
