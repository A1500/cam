...
<script type="text/javascript" src="bpthospital_insert.js"></script>
...
<next:Panel  bodyStyle="width:100%;height:100%">
	<next:TopBar>
		...
		<next:ToolBarItem iconCls="save" text="保存" handler="saveInsertClick" />
	</next:TopBar>
	<next:TabPanel>
		<next:Tabs>
					...
					<table border="0" width="100%">
						...
						<tr>
							...
							<td class="FieldInput" style="width: 35%"  colspan="3"><input type="text"
								...
								field="years" title="年度"/><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" >
						...
						<tr>
							...
							<input type="hidden"
								name="domicileCode" field="domicileCode" title="所属行政区划编号"/><font color="red">*</font>
							</td>
						</tr>
						
						<tr>
							<td class="FieldLabel" style="width: 15%" nowrap>行政级别:</td>
							<td class="FieldInput" style="width: 35%"><select name="administrativelevel" field="administrativelevel" title="行政级别">
							<option dataset="administrativelevel"/>
							</select>

							<td class="FieldLabel" style="width: 15%" nowrap>单位性质:</td>
							<td class="FieldInput" style="width: 35%" ><select name="unitsnature" field="unitsnature" title="单位性质">
						...
						<tr>
							...
							<td class="FieldInput" style="width: 35%" title="主管部门"><input type="text"
								name="personSection" field="personSection" /></td>

							<td class="FieldLabel" style="width: 15%" nowrap>建立日期:</td>
							<td class="FieldInput" style="width: 35%" title="建立日期"><input type="text"
						...
						<tr>
							...
							<td class="FieldInput" style="width: 35%" title="注册资本"><input type="text"
								name="registerProperty" field="registerProperty" /><font
								color="red">*</font></td>

							<td class="FieldLabel" style="width: 15%" nowrap>固定资产原值(万元):</td>
							<td class="FieldInput" style="width: 35%" title="固定资产原值"><input type="text"
								name="immobilisations" field="immobilisations" /><font
								color="red">*</font></td>
						</tr>

						<tr>
							<td class="FieldLabel" style="width: 15%" nowrap>占地面积(平方米):</td>
							<td class="FieldInput" style="width: 35%" title="占地面积"><input type="text"
								name="floorArea" field="floorArea" /><font color="red">*</font>
							</td>

							<td class="FieldLabel" style="width: 15%" nowrap>业务用房面积(平方米):</td>
							<td class="FieldInput" style="width: 35%" title="业务用房面积"><input type="text"
								name="businessArea" field="businessArea" /></td>
						</tr>

						<tr>
							<td class="FieldLabel" style="width: 15%" nowrap>联系电话:</td>
							<td class="FieldInput" style="width: 35%" title="联系电话"><input type="text"
								name="telContact" field="telContact" /></td>

							<td class="FieldLabel" style="width: 15%" nowrap>邮政编码:</td>
							<td class="FieldInput" style="width: 35%" title="邮政编码"><input type="text"
								name="postcode" field="postcode" /></td>
						</tr>

						<tr>
							<td class="FieldLabel" style="width: 15%" nowrap>通信地址:</td>
							<td class="FieldInput" style="width: 35%" colspan="3" title="通信地址">
						...
						<tr>
							...
							<td class="FieldInput" style="width: 35%" colspan="3" title="单位介绍">
						...
						<tr>
							...
							<td class="FieldInput" style="width: 35%" title="新建扩建改建"><input type="text"
								name="newExpansion" field="newExpansion" /></td>

							<td class="FieldLabel" style="width: 15%" nowrap>新增大型设备（台）:</td>
							<td class="FieldInput" style="width: 35%" title="新增大型设备"><input type="text"
						...
						<tr>
							...
							<td class="FieldInput" style="width: 35%" title="优抚医院种类">
							...
							<td class="FieldInput" style="width: 35%" title="优抚医院业务类型">
						...
						<tr>
							...
							<td class="FieldInput" style="width: 35%" title="优抚医院等级">
						...
						<tr>
							...
							<td class="FieldInput" style="width: 35%"  title="全年收住院人次"><input type="text"
								name="allyearInhospital" field="allyearInhospital" /></td>
						
							<td class="FieldLabel" style="width: 15%" nowrap>全年门诊人次:</td>
							<td class="FieldInput" style="width: 35%" title="全年门诊人次"><input type="text"
						...
						<tr>
							...
							<td class="FieldInput" style="width: 35%" title=" type="text"
					...
					<form id="BptHospitalLegalForm" method="post"
						...
						<table border="0" width="98%" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td class="FieldInput" style="width: 35%" title="姓名"><input type="text"
								name="name" field="name" /><font color="red">*</font></td>

								<td class="FieldLabel" style="width: 15%" nowrap>身份证号码:</td>
								<td class="FieldInput" style="width: 35%" title="身份证号码"><input type="text" onchange="backMsgByIdCard('BptHospitalLegalDataSet',this)"
							...
							<tr>
								...
								<td class="FieldInput" style="width: 35%" title="民族">
								...
								<td class="FieldInput" style="width: 35%" title="性别">
							...
							<tr>
								...
								<td class="FieldInput" style="width: 35%" title="出生日期"><input type="text"
								id="birthday"name="birthday" field="birthday" format="Y-m-d" style="width: 100px;" maxlength="10"  onpropertychange="changeDateStyle(this)" /><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ><font color="red">*</font></td>
