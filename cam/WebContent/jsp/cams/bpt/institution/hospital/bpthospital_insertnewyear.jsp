...
<script type="text/javascript" src="bpthospital_insertnewyear.js"></script>
					...
					<table border="0" width="100%">
						...
						<tr>
							...
							<td class="FieldInput" style="width: 35%"  colspan="3"><input type="text"
								...
								field="years" title="年度" /><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ></td>
						...
						<tr>
							<td class="FieldLabel" style="width: 15%" nowrap>中央划拨维修改造经费:</td>
							<td class="FieldInput" style="width: 35%"><input type="text"
								name="centralFunds" field="centralFunds" /></td>

							<td class="FieldLabel" style="width: 15%" nowrap>地方下拨的维修改造经费:</td>
							<td class="FieldInput" style="width: 35%"><input type="text"
								name="placeFunds" field="placeFunds" /></td>
						</tr>

						<tr>
							<td class="FieldLabel" style="width: 15%" nowrap>优抚对象医疗经费:</td>
							<td class="FieldInput" style="width: 35%"><input type="text"
								name="bptMedicalFunds" field="bptMedicalFunds" /></td>

							<td class="FieldLabel" style="width: 15%" nowrap>优抚对象的生活经费:</td>
							<td class="FieldInput" style="width: 35%"><input type="text"
								name="bptLiveFunds" field="bptLiveFunds" /></td>
						</tr>

						<tr>
							<td class="FieldLabel" style="width: 15%" nowrap>办公经费:</td>
							<td class="FieldInput" style="width: 35%"><input type="text"
								name="officialFunds" field="officialFunds" /></td>

							<td class="FieldLabel" style="width: 15%" nowrap>人员工资:</td>
							<td class="FieldInput" style="width: 35%"><input type="text"
								name="personnelFunds" field="personnelFunds" /></td>
						</tr>

						<tr>
							<td class="FieldLabel" style="width: 15%" nowrap>其他经费:</td>
							<td class="FieldInput" style="width: 35%"><input type="text"
								name="otherFunds" field="otherFunds" /></td>

							<td class="FieldLabel" style="width: 15%">创收收入：</td>
							<td class="FieldInput" style="width: 35%"><input type="text"
						...
						<tr>
							...
							<td class="FieldInput"  colspan="4">
								<table style="width: 99%" nowrap>
									<tr>
									 	<td class="FieldLabel" style="width: 15%" nowrap>全市复退军人精神病患者:</td>
										<td class="FieldInput" style="width: 35%"><input type="text"
									...
									<tr>
									 	<td class="FieldLabel" style="width: 15%" nowrap>社会精神病患者治疗:</td>
										<td class="FieldInput" style="width: 35%"><input type="text"
											name="treatMentalNum" field="treatMentalNum" /></td>
										<td class="FieldLabel" style="width: 15%" nowrap>巡回医疗:</td>
										<td class="FieldInput" style="width: 35%"><input type="text"
											name="mobileMedical" field="mobileMedical" /></td>
									</tr>
									<tr>
									<td class="FieldLabel" style="width: 15%" nowrap>住院治疗:</td>
										<td class="FieldInput" style="width: 35%"><input type="text"
											name="hospitalization" field="hospitalization" /></td>
											<td class="FieldLabel" style="width: 15%" nowrap>电话咨询:</td>
										<td class="FieldInput" style="width: 35%"><input type="text"
