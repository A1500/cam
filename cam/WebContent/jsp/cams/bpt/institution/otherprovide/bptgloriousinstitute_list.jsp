...
<body>
<model:datasets>
	<model:dataset id="ds" cmd="com.inspur.cams.bpt.bptinstitution.cmd.BptGloriousInstituteQueryCommand" autoLoad="false" global="true">
				...
				<div>
					<form style="width: 100%; height: 100%;" class="L5form">
						<table  border="1" width="100%" >
							<tr >
								<td class="FieldLabel" nowrap>行政区划:</td>
								<td class="FieldInput">
								...
								<td class="FieldLabel" nowrap>单位全称:</td>
								<td class="FieldInput"><input type="text"  id="unitFullname" class="TextEditor" title="单位全称"  /></td>	
								<td class="FieldLabel"><button onclick="query()">查 询</button> </td>
							</tr>
							<tr>
								<td class="FieldLabel" nowrap>主管部门:</td>
								<td class="FieldInput"><input type="text"  id="personSection" class="TextEditor" title="主管部门"  /></td>	
								<td class="FieldLabel" nowrap>光荣院性质:</td>
								<td class="FieldInput">
