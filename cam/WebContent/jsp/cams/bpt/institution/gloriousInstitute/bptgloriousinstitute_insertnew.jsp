...
<script type="text/javascript" src="bptgloriousinstitute_insertnew.js"></script>
							...
							<table border="0" width="100%">
								...
								<tr>
									...
									<td class="FieldInput" style="width: 35%"  colspan="3"><input type="text"
										...
										field="years" /><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ></td>
								</tr>
								<tr>
									...
									<input type="text" id="domicileCode" name="domicileName" field="domicileName" title="属地行政区划" style="width:90%" onclick="func_ForDomicileSelect1()" readonly="readonly"/>
									<input type="hidden"
								...
								<tr>
									...
									<td class="FieldInput" style="width: 35%"><input
										type="text" id="creationDate" name="creationDate" field="creationDate" format="Y-m-d" style="width: 100px;" maxlength="10" /><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ></td>
								</tr>
								<tr>
