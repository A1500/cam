...
<script type="text/javascript" src="bptgloriousinstitute_insert.js"></script>
							...
							<table border="0" width="100%">
								...
								<tr>
									...
									<td class="FieldInput" style="width: 35%"  colspan="3"><input type="text"
										...
										field="years"  /><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" >
					...
					<form id="BptGloriousLegalForm" method="post"
						...
						<table border="0" width="98%" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td class="FieldInput" style="width: 35%">
								<select name="majorJob" field="majorJob" title="文化程度">
