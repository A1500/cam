...
function init() {
		...
		if (method==null||method==""){
			...
			bptGloriousLegalDataSet.newRecord({gloriousId : document.forms[0].gloriousId.value});
			return;
			}
		...
		function getValue() {
			...
			var bptGloriousLegalDataSet=L5.DatasetMgr.lookup("BptGloriousLegalDataSet");
				bptGloriousLegalDataSet.baseParams["GLORIOUS_DETAIL_ID@="] = idField+BptGloriousInstituteDataSet.get("years");
...
//		var BptGloriousLegalRecord = BptGloriousLegalDataSet.getAllChangedRecords();
...
//	var BptGloriousInstituteDataSet = L5.DatasetMgr.lookup("BptGloriousInstituteDataSet");
//	var BptGloriousInstituteRecord=BptGloriousInstituteDataSet.getCurrent();
//	var years=BptGloriousInstituteRecord.get("years");
//	if(years!=null&&years!="") {
//		var gloriousId = BptGloriousInstituteRecord.get("gloriousId");
//		BptGloriousInstituteDataSet.add("GLORIOUS_ID",gloriousId);
//		alert(years);
//		BptGloriousInstituteDataSet.load();	
//		
//	}
