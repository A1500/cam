				...
				<next:Html>
					...
					<table border="0" width="98%">
					  <tr>
							...
							<td class="FieldInput" ><input type="text" name="idCard" field="idCard" title="身份证件号码" style="width:155" onchange="func_CheckIdCard();func_ShowBirthday();"/><font color="red">*</font></td>
						...
						<tr>
						   ...
						   <td class="FieldInput" >
						       <input type="text" id="domicileName" name="domicileName" field="domicileName" title="属地行政区划" style="width:155" onclick="func_ForDomicileSelect()" readonly="readonly"/><font color="red">*</font>
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" id="apanageName" name="apanageName" field="apanageName" title="行政区划"  style="width:155"readonly="readonly" onclick="func_ForApanageSelect()"/><font color="red">*</font>
