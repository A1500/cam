...
function init() {
	...
	L5.QuickTips.init();
	var command1 = new L5.Command("com.inspur.cams.bpt.manage.cmd.BptBaseinfoPeopleCommand");
	command1.setParameter("PEOPLE_ID",fPeopleId);
	command1.execute("queryPeopleInfo");
	if(command1.getReturn("address")!=null&&command1.getReturn("address")!=""){
	document.getElementById("address").value = command1.getReturn("address");
	}
	if(command1.getReturn("domicileAddress")!=null&&command1.getReturn("domicileAddress")!=""){
	document.getElementById("domicileAddress").value = command1.getReturn("domicileAddress");
	}
