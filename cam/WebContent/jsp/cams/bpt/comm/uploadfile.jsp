...
<next:EditGridPanel id="editGridPanel" name="uploadfile" width="100%" notSelectFirstRow="true" autoExpandColumn="catalogName" stripeRows="true" height="100%" dataset="ds" title="附件信息">
	<next:TopBar>
	        ...
	        <next:ToolBarItem iconCls="detail"  text="查看所有电子档案" handler="checkElectronic"/>
		...
		<table border="1"  width="100%" >
			<tr>
				...
				<td class="FieldInput" colspan="3">
					<textarea id="fileMess" name="fileMess" cols="70%" rows="3"></textarea>
				</td>
			</tr>
			<tr>
				<td class="FieldLabel" nowrap="nowrap" >档案存放位置</td>
				<td class="FieldInput" >
					<textarea id="fileSave" name="fileSave"  cols="70%"></textarea>
				</td>
			</tr>
			<tr>
				<td class="FieldLabel" nowrap="nowrap">附件上传：</td>
