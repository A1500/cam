				...
				<next:Html>
					...
					<table border="0" width="98%">
                        ...
                        <tr>
							...
							<td class="FieldInput">
								<label name="isStudy"  field="isStudy" dataset="StudyFlagEnum" title="是否上学"></label>
							</td>
						</tr>
                        <tr>
                        ...
                        <tr>
							...
							<td class="FieldLabel" >是否有劳动能力：</td>
							<td class="FieldInput" >
								<label name="isWork" field="isWork" title="劳动能力" dataset="WorkAbilityCodeEnum"></label>
							</td>
						</tr>
						<tr>
