					...
					<form id="BaseinfoPeopleForm" method="post" dataset="BaseinfoPeopleDataSet" onsubmit="return false" style="padding: 5px;" class="L5form">
					  <table border="0" width="98%">
					     <tr>
							...
							<td class="FieldLabel" width="20%" rowspan="3">照片:</td>
							<td nowrap  rowspan="3">
						 ...
						 <!-- <td class="FieldLabel" >姓名拼音码：</td>
							<td class="FieldInput" ><label   id="phoneticCode" name="phoneticCode" field="phoneticCode" title="姓名拼音码" /><font color="red">*</font>
							</td>-->
