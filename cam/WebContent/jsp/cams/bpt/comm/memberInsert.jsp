...
<script type="text/javascript">
   ...
   var fPeopleId  = '<%=request.getParameter("fPeopleId")%>';
</script>
				...
				<next:Html>
					...
					<table border="0" width="98%">
					    <tr>
							...
							<td class="FieldInput" ><input type="text" name="idCard" field="idCard" title="身份证件号码" style="width:135" onblur="func_QueryIdCard()"/><font color="red">*</font></td>
						...
						<tr>
						   ...
						   <td class="FieldInput" colspan="3"><input type="text" id="domicileAddress" name="domicileAddress" field="domicileAddress" title="户口薄住址" style="width:85%"></td>      
						</tr>
						<tr>
							<td class="FieldLabel">实际居住(行政区划)：</td> 
							<td class="FieldInput"><input type="text" id="apanageName" name="apanageName" field="apanageName" title="行政区划" readonly="readonly" style="width:90%" onclick="func_ForApanageSelect()"/><font color="red">*</font>
