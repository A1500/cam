...
<model:datasets>
	...
	<model:dataset id="PetitionDataset" cmd="com.inspur.cams.bpt.manage.cmd.BptPetitionQueryCommand" global="true" pageSize="5">
		<model:record fromBean="com.inspur.cams.bpt.base.data.BptPetition"></model:record>
	</model:dataset>
	<!-- 优抚对象类型 -->
	...
	<next:Html>
		...
		<table border="1"  width="90%" >
	   		<tr>
				...
				<td  class="FieldLabel" nowrap="nowrap" style="width:20%">身份证件号码：</td>
...
<next:GridPanel id="editGridPanel" name="bptpetitionGrid"  stripeRows="true" height="200" autoWidth="true" dataset="PetitionDataset" title="信访管理">
	<next:Columns>
		...
		<next:Column id="objectType" header="优抚对象类别" field="objectType" width="130" renderer="objectTypeRender">
			<next:TextField allowBlank="false" />
		</next:Column>
