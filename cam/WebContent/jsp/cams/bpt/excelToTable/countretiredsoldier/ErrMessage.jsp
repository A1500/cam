...
<model:datasets>
	...
	<!-- 60岁老兵 -->
	<model:dataset id="CountretiredsoldierErrDataset"
...
<next:GridPanel id="baseGridPanel" name="basicInfoGridPanel" width="100%" height="100%" autoScroll="false" stripeRows="true" dataset="CountretiredsoldierErrDataset" notSelectFirstRow="true" autoExpandColumn="ERROR_MESSAGE">
	<next:TopBar>
	...
	<next:BottomBar>
		<next:PagingToolBar dataset="CountretiredsoldierErrDataset"/>
	</next:BottomBar>
</next:GridPanel>
