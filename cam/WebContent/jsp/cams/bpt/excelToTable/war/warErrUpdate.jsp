...
<script type="text/javascript" src="warErrUpdate.js"></script>
	...
	<model:dataset id="BaseinfoPeopleDataSet" cmd="com.inspur.cams.bpt.excelToTable.ExcelToTableQueryCommand" global="true" method="queryErrUpdate">
		<model:record  >
		 <model:field name="domicileName" type="string"/>
			...
			<model:field name="warNo" mapping="WAR_NO" type="string" rule="require"/>
			...
			<model:field name="warTypeCode" mapping="WAR_TYPE_CODE" type="string" rule="require"/>
				...
				<next:Html>
					...
					<table border="1" width="98%">
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" name="retiredDate"style="width: 100px;" onpropertychange="changeDateStyle(this)" 
