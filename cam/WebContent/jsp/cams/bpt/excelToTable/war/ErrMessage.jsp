...
<model:datasets>
	<!-- 参战人员错误DS -->
	<model:dataset id="WarErrDataset"
...
<next:GridPanel id="baseGridPanel" name="basicInfoGridPanel" width="100%" height="100%" autoScroll="false" stripeRows="true" dataset="WarErrDataset" notSelectFirstRow="true" autoExpandColumn="ERROR_MESSAGE">
	<next:TopBar>
	...
	<next:BottomBar>
		<next:PagingToolBar dataset="WarErrDataset"/>
	</next:BottomBar>
</next:GridPanel>
