...
<model:datasets>
	...
	<!-- 带病回乡退伍军人错误导出 -->
	<model:dataset id="demoIllErrDataset"
...
<next:GridPanel id="baseGridPanel" name="basicInfoGridPanel" width="100%" height="100%" autoScroll="false" stripeRows="true" dataset="demoIllErrDataset" notSelectFirstRow="true" autoExpandColumn="ERROR_MESSAGE">
	<next:TopBar>
	...
	<next:BottomBar>
		<next:PagingToolBar dataset="demoIllErrDataset"/>
	</next:BottomBar>
</next:GridPanel>
