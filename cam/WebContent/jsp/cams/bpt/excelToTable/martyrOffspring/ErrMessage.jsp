...
<model:datasets>
	<!-- 老烈子女 -->
	<model:dataset id="MartyrOffspringErrDataset"
...
<next:GridPanel id="baseGridPanel" name="basicInfoGridPanel" width="100%" height="100%" autoScroll="false" stripeRows="true" dataset="MartyrOffspringErrDataset" notSelectFirstRow="true" autoExpandColumn="ERROR_MESSAGE">
	<next:TopBar>
	...
	<next:BottomBar>
		<next:PagingToolBar dataset="MartyrOffspringErrDataset"/>
	</next:BottomBar>
</next:GridPanel>
