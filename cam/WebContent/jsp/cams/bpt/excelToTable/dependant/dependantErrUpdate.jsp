...
<script type="text/javascript" src="dependantErrUpdate.js"></script>
<script type="text/javascript" src="queryLezsw.js"></script>
</head>
<body>
<model:datasets>
	<!-- 错误信息 -->
	<model:dataset id="BaseinfoPeopleDataSet" cmd="com.inspur.cams.bpt.excelToTable.ExcelToTableQueryCommand" global="true" method="queryErrUpdate">
		<model:record  >
		 <model:field name="domicileName" type="string"/>
			...
			<model:field name="dependantTypeCode" mapping="DEPENDANT_TYPE_CODE" type="string" rule="require"/>
			<model:field name="relationship" mapping="RELATIONSHIP" type="string" rule="require"/>
			<model:field name="dependantStateCode" mapping="DEPENDANT_STATE_CODE" type="string" rule="require"/>
			<model:field name="dependantNo" mapping="DEPENDANT_NO" type="string" rule="require"/>
			<model:field name="approvalDate" mapping="APPROVAL_DATE" type="string" rule="require"/>
			<model:field name="studentFlag" mapping="STUDENT_FLAG" type="string" rule="require"/>
			<model:field name="handicapFlag" mapping="HANDICAP_FLAG" type="string" rule="require"/>
			<model:field name="oldLonelyFlag" mapping="OLD_LONELY_FLAG" type="string" rule="require"/>
			<model:field name="orphanFlag" mapping="ORPHAN_FLAG" type="string" rule="require"/>
			...
			<model:field name="holderFlag" mapping="HOLDER_FLAG" type="string" rule="require"/>
			<model:field name="lezswCertificateId" mapping="LEZSW_CERTIFICATE_ID" type="string"/>
			<model:field name="lezswName" mapping="LEZSW_NAME" type="string" rule="require"/>
			<model:field name="lezswSex" mapping="LEZSW_SEX" type="string" rule="require"/>
			<model:field name="lezswBirthday" mapping="LEZSW_BIRTHDAY" type="string"/>
			<model:field name="conscriptDate" mapping="CONSCRIPT_DATE" type="string"/>
			<model:field name="workUnit" mapping="WORK_UNIT" type="string"/>
			<model:field name="position" mapping="POSITION" type="string"/>
			<model:field name="deathDate" mapping="DEATH_DATE" type="string"/>
			<model:field name="deathAddress" mapping="DEATH_ADDRESS" type="string"/>
			<model:field name="lezswApproveDate" mapping="LEZSW_APPROVE_DATE" type="string"/>
			<model:field name="deathReason" mapping="DEATH_REASON" type="string"/>
				...
				<next:Html>
					...
					<table border="0" width="98%">
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" name="idCard" field="idCard" title="身份证件号码" maxlength="18" style="width: 135" onchange="func_CheckIdCard()" /><font color="red">*</font>
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" id="apanageName" name="apanageName" field="apanageName" style="width:90%" title="行政区划" readonly="readonly" onclick="func_ForApanageSelect()"/><font color="red">*</font>
				...
				<next:Html>
					...
					<table border="1" width="98%">
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" name="dependantNo" field="dependantNo" title="定期抚恤证编号" /><font color="red">*</font></td>
                            <td class="FieldLabel">批准日期：</td>
							<td class="FieldInput"><input type="text" name="approvalDate" id="approvalDate" field="approvalDate" format="Y-m-d" maxlength="10"style="width: 100px;" onpropertychange="changeDateStyle(this)"  title="批准日期" /><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)" ><font color="red">*</font></td>
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" id="lezswCertificateId" name="lezswCertificateId" field="lezswCertificateId" title="牺牲病故证书字号" onchange="queryLezsw()" /></td>

							<td class="FieldLabel" nowrap="nowrap">烈士（牺牲、病故军人）姓名：</td>
							<td class="FieldInput"><input type="text" id="lezswName" name="lezswName" field="lezswName" title="烈士（牺牲、病故军人）姓名" /><font color="red">*</font></td>
						</tr>
						...
						<tr>
							...
							<td class="FieldLabel">出生日期：</td>
							<td class="FieldInput"><input type="text" name="lezswBirthday" id="lezswBirthday" field="lezswBirthday"maxlength="10"style="width: 100px;" format="Y-m-d"  onpropertychange="changeDateStyle(this)" title="烈士出生日期" /><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)" ></td>

							<td class="FieldLabel">入伍（工作）时间：</td>
							<td class="FieldInput"><input type="text" name="conscriptDate" id="conscriptDate" field="conscriptDate"maxlength="10"style="width: 100px;" format="Y-m-d"  onpropertychange="changeDateStyle(this)"  title="入伍(工作)时间"/><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)" ></td>
						</tr>
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" name="deathDate"id="deathDate" field="deathDate"maxlength="10"style="width: 100px;" format="Y-m-d"  onpropertychange="changeDateStyle(this)"   title="牺牲病故时间"/><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)" ></td>
						</tr>
						...
						<tr>
							...
							<td class="FieldInput" colspan="3"><input type="text" title="烈士（牺牲、病故军人）批准时间" id="lezswApproveDate" name="lezswApproveDate" field="lezswApproveDate"style="width: 100px;" format="Y-m-d"  onpropertychange="changeDateStyle(this)" maxlength="10" /><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)" ></td>
						</tr>
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" name="accountCode" field="accountCode" title="银行账号" style="width: 200"></input><font color="red">*</font></td>
						</tr>
