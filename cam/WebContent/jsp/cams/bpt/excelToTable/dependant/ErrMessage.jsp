...
<model:datasets>
	<!-- 三属错误信息 -->
	<model:dataset id="DependantErrDataset"
...
<next:GridPanel id="baseGridPanel" name="basicInfoGridPanel" width="100%" height="100%" autoScroll="false" stripeRows="true" dataset="DependantErrDataset" notSelectFirstRow="true" autoExpandColumn="ERROR_MESSAGE">
	<next:TopBar>
	...
	<next:BottomBar>
		<next:PagingToolBar dataset="DependantErrDataset"/>
	</next:BottomBar>
</next:GridPanel>
