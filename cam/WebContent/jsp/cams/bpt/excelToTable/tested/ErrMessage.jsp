...
<model:datasets>
	...
	<!-- 参试人员 -->
	<model:dataset id="testErrDataset"
...
<next:GridPanel id="baseGridPanel" name="basicInfoGridPanel" width="100%" height="100%" autoScroll="false" stripeRows="true" dataset="testErrDataset" notSelectFirstRow="true" autoExpandColumn="ERROR_MESSAGE">
	<next:TopBar>
	...
	<next:BottomBar>
		<next:PagingToolBar dataset="testErrDataset"/>
	</next:BottomBar>
</next:GridPanel>
