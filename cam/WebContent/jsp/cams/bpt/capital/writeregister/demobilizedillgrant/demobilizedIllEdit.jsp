...
<html>
	<head>
		<title>带病回乡退伍军人生活补助金修改</title>
		<next:ScriptManager/>
		<script type="text/javascript" src="<%=SkinUtils.getJS(request, "cams.js")%>"></script>
		<script type="text/javascript" src="<%=SkinUtils.getJS(request, "camsCheck.js")%>"></script>
		<script type="text/javascript" src="demobilizedIllEdit.js"></script>
...
<next:Window id="addNewDemobilizedIllGrantObject" title="新增发放对象" resizable="false" width="780" height="330"  closeAction="hide" modal="true">
  <next:Panel>
	<next:Html>
