...
<html>
	<head>
		<title>60岁农村籍退役军人生活补助金增加页面</title>
		<next:ScriptManager/>
		...
		<script type="text/javascript" src="soldierAdd.js"></script>
	</head>
<body>
<model:datasets>
	<model:dataset id="ds" cmd="com.inspur.cams.bpt.manage.cmd.BptCapitalDetailQueryCommand" pageSize="500" global="true">
					...
					<form style="width: 95%; height: 100%;" class="L5form">
						<table  border="1" width="100%">
							<tr>
								...
								<td class="FieldInput" align="center"><button onclick="query()">生成明细</button></td>		
							</tr>
						</table>
					</form>
				</div>
...
<next:EditGridPanel id="editGridPanel" name="bptcapitaldetailGrid" width="100%" stripeRows="true" height="100%" dataset="ds">
	...
	<next:Columns>
		...
		<next:Column id="credentialsNo" header="抚恤证编号" field="credentialsNo" width="120"></next:Column>
		<next:Column id="objectType" header="优抚对象类别" field="objectType" width="130" dataset="objectds"></next:Column>
		...
		<next:Column id="grantStaMon" header="省标准" field="grantStaMon"
			renderer="formatNum(this)" width="80" align="right" hidden="true">
		...
		<next:Column id="otherSubsidyOne" header="地方补贴"
