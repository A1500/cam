...
<html>
	<head>
		...
		<script type="text/javascript" src="soldierList.js"></script>
...
<model:datasets>
	<!-- 人员信息 -->
	<model:dataset id="BaseinfoPeopleDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptCountRetiredSoldierQueryCommand" method="queryCountretiredSoldier" global="true">
