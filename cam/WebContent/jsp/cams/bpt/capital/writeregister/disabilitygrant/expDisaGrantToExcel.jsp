...
<Excel:tablelist filename="<%=name%>">
	<Excel:table sheetname="伤残抚恤金发放">
		<Excel:tr height="50" >
			...
			<Excel:td  align="center" width="100">残疾证号</Excel:td>
			<Excel:td  align="center" width="100">优抚对象类别</Excel:td>
			<Excel:td  align="center" width="100">伤残等级代码</Excel:td>
			<Excel:td  align="center" width="100">伤残性质</Excel:td>
			<Excel:td  align="center" width="100">伤残属别</Excel:td>
			<Excel:td  align="center" width="100">伤残时期</Excel:td>
			...
			<Excel:td  align="center" width="100">护理费</Excel:td>
			...
			<Excel:td  align="center" width="100">煤补补贴</Excel:td>
			<Excel:td  align="center" width="100">抗日增发</Excel:td>
		...
		<Excel:tr>
			...
			<Excel:td><%=rec.get("DISABILITY_LEVEL_CODE")%></Excel:td>
			<Excel:td><%=rec.get("DISABILITY_CASE_CODE")%></Excel:td>
			<Excel:td><%=rec.get("DISABILITY_GENUS_CODE")%></Excel:td>
			<Excel:td><%=rec.get("DISABILITY_WAR_CODE")%></Excel:td>
			...
			<Excel:td><%=rec.get("NURSING_MON")%></Excel:td>
			<Excel:td><%=rec.get("SUB_TOTAL")%></Excel:td>
			<Excel:td><%=rec.get("INCREASE_MECHANISM")%></Excel:td>
			<Excel:td><%=rec.get("GRAIN_OIL_MON")%></Excel:td>
			<Excel:td><%=rec.get("COAL_SUBSIDY_MON")%></Excel:td>
			<Excel:td><%=rec.get("ANTI_JAPANESE_MON")%></Excel:td>
