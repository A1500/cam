...
<script type="text/javascript" src="bptcapitaldetailAdd.js"></script>
</head>
<body>
<model:datasets>
	<model:dataset id="ds"
		cmd="com.inspur.cams.bpt.manage.cmd.BptCapitalDetailQueryCommand"
		global="true" pageSize="500">
		<model:record
			fromBean="com.inspur.cams.bpt.capital.data.BptCapitalDetail"></model:record>
	</model:dataset>
	<!-- 发放类别 -->
	<model:dataset id="GrantTypeDataset" enumName="GRANTTYPE.FLAG"
		autoLoad="true" global="true"></model:dataset>
	<!-- 优抚对象类别-->
	<model:dataset id="objectDs" enumName="DISABILITY.TYPE.CODE"
		autoLoad="true" global="true"></model:dataset>
	<!-- 伤残等级-->
	<model:dataset id="LevelDs" enumName="LEVEL.CODE" autoLoad="true"
		global="true"></model:dataset>
	<!-- 伤残性质-->
	<model:dataset id="caseDs" enumName="CASE.CODE" autoLoad="true"
		global="true"></model:dataset>
	<!-- 伤残属别-->
	<model:dataset id="genusDs" enumName="GENUS.CODE" autoLoad="true"
		global="true"></model:dataset>
	<!-- 伤残时期-->
	<model:dataset id="warDs" enumName="WAR.CODE"
		autoLoad="true" global="true"></model:dataset>
	<!-- 孤老标志-->
	...
	<next:Html>
		...
		<table border="1" width="100%">
			<tr>
				...
				<td class="FieldInput"><input type="text" id="buildDate"
					class="TextEditor" style="width: 80" format="Y-m-d" maxlength="10"  onpropertychange="changeDateStyle(this)" /><img
				...
				<td class="FieldInput"><input type="text" id="startDate"
					class="TextEditor" style="width: 80" format="Y-m" maxlength="7"  onpropertychange="changeDateStyle_Mon(this)" /><img
					src="../../../../../../skins/images/default/rl.gif" align="middle"
					onclick="getTimes(this);"><font color="red">*</font></td>
				<td class="FieldLabel">应发时间止：</td>
				<td class="FieldInput"><input type="text" id="endDate"
					class="TextEditor" format="Y-m" style="width: 80" maxlength="7"  onpropertychange="changeDateStyle_Mon(this)" /><img
					src="../../../../../../skins/images/default/rl.gif" align="middle"
					onclick="getTimes(this);"><font color="red">*</font></td>
				<td class="FieldInput" style="margin-left: 30%">
				<button onclick="query()">生成明细</button>
				</td>
			</tr>
		</table>
		</form>
...
<next:EditGridPanel id="editGridPanel" name="bptcapitaldetailGrid"
	...
	<next:Columns>
		...
		<next:Column id="peopleId" header="peopleId" field="peopleId"
			width="90" hidden="true"></next:Column>
		<next:Column id="regDetailId" header="名册明细ID" field="regDetailId"
			width="90" hidden="true"></next:Column>
		...
		<next:Column id="credentialsNo" header="残疾证号" field="credentialsNo"
			width="90"></next:Column>
		<next:Column id="objectType" header="优抚对象类别" field="objectType"
			width="130" dataset="objectDs"></next:Column>
		<next:Column id="changeState" header="发放类别" field="changeState"
			width="130" dataset="GrantTypeDataset"></next:Column>
		<next:Column id="disabilityLevelCode" header="伤残等级代码"
			field="disabilityLevelCode" width="80" dataset="LevelDs"></next:Column>
		<next:Column id="disabilityWarCode" header="伤残时期" field="disabilityWarCode"
			width="60" dataset="warDs"></next:Column>
		...
		<next:Column id="disabilityCaseCode" header="伤残性质"
			field="disabilityCaseCode" width="60" dataset="caseDs"></next:Column>
		<next:Column id="disabilityGenusCode" header="伤残属别"
			field="disabilityGenusCode" width="60" dataset="genusDs"></next:Column>
