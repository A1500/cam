...
<html>
	<head>
		<title>伤残抚恤金发放名册修改</title>
		<next:ScriptManager/>
		<script type="text/javascript" src="<%=SkinUtils.getJS(request, "cams.js")%>"></script>
		<script type="text/javascript" src="<%=SkinUtils.getJS(request, "camsCheck.js")%>"></script>
		<script type="text/javascript" src="bptcapitaldetailEdit.js"></script>
...
<next:Window id="addNewDisabiGrantObject" title="新增发放对象" resizable="false" width="850" height="400" closeAction="hide" modal="true">
  <next:Panel>
	<next:Html>
		<form dataset="ds" id="form1" onsubmit="return false" class="L5form">
			<table border="0" width="99%">
				...
				<tr>
					...
					<td class="FieldLabel">伤残等级代码：</td>
					<td class="FieldInput"><label id="disabilityLevelCode" field="disabilityLevelCode" dataset="LevelDs"></label></td>
					<td class="FieldLabel">伤残时期：</td>
					<td class="FieldInput"><label id="disabilityWarCode" field="disabilityWarCode" dataset="warDs"></label></td>
				</tr>
				<tr>
					...
					<td class="FieldInput"><label id="disabilityCaseCode" field="disabilityCaseCode" dataset="caseDs"></label></td>
					<td class="FieldLabel">伤残属别：</td>
					<td class="FieldInput"><label id="disabilityGenusCode" field="disabilityGenusCode" dataset="genusDs"></label></td>
				</tr>
				<tr>
					<td class="FieldLabel">发放标准(元/月)：</td>
				...
				<tr>
					<td class="FieldLabel">护理费(元)：</td>
				    <td class="FieldInput"><input type="text" id="nursingMon" field="nursingMon" onblur="checkIfFload(this);computeSumMon();" style="text-align:right"/></td>
				...
				<tr>
					...
					<td class="FieldLabel">煤补补贴(元)：</td>
					<td class="FieldInput"><input type="text" id="coalSubsidyMon" field="coalSubsidyMon" onblur="checkIfFload(this);computeSumMon()" style="text-align:right"></input></td>
				    <td class="FieldLabel">抗日增发(元)：</td>
				    <td class="FieldInput"><input type="text" id="antiJapaneseMon" field="antiJapaneseMon" onblur="checkIfFload(this);computeSumMon()" style="text-align: right"/></td>
				</tr>
				<tr>
