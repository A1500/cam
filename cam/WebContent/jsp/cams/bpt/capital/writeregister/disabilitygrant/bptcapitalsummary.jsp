...
<html>
	<head>
		...
		<script type="text/javascript" src="bptcapitalsummary.js"></script>	
	</head>
<body>
<model:datasets>
	<model:dataset id="DisabilityExportDataset" cmd="com.inspur.cams.bpt.manage.cmd.BptCapitalDetailQueryCommand" global="true" method="queryExportData">
		<model:record fromBean="com.inspur.cams.bpt.capital.data.BptCapitalDetail"></model:record>
	</model:dataset>
	<model:dataset id="ds" cmd="com.inspur.cams.bpt.manage.cmd.BptCapitalSummaryQueryCommand" global="true">
	...
	<!-- 名册类别代码 -->
	<model:dataset id="dsRegType" enumName="CAPITAL.REGTYPE" autoLoad="true"></model:dataset>	
</model:datasets>
					...
					<form style="width: 95%; height: 100%;" class="L5form">
						<table  border="1" width="100%" >
							<tr >
								...
								<td class="FieldInput"><input type="text"  id="domicileName" class="TextEditor" title="所属机构" onclick="help()"/>
													   <input type="hidden"  id="domicileCode" class="TextEditor" title="所属机构"/></td>
								<td class="FieldLabel">发放起止日期:</td>
								<td class="FieldInput"><input type="text"  id="startDate" style="width:80" title="所属年月"  format="Y-m-d" maxlength="10" onpropertychange="changeDateStyle(this)" /><img  src="../../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" >-- --<input type="text"  id="endDate" class="TextEditor" title="所属年月"  style="width:80" format="Y-m-d" maxlength="10" onpropertychange="changeDateStyle(this)" /><img  src="../../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ></td>	
...
<next:GridPanel id="editGridPanel" name="bptcapitalsummaryGrid" width="100%" clickToSelectedForChkSM="true" stripeRows="true" height="100%" dataset="ds" notSelectFirstRow="true">
	<next:TopBar>
	...
	<next:Columns>
		...
		<next:Column id="registerName" header="名册名称" field="registerName" width="170"></next:Column>
		<next:Column id="registerType" header="名册类别" field="registerType" width="120" dataset="dsRegType" hidden="true"></next:Column>
		<next:Column id="organName" header="发放单位" field="organName" width="90" ></next:Column>
		<next:Column id="respectiveYears" header="发放年度" field="respectiveYears" width="70" align="left" hidden="true"></next:Column>
		...
		<next:Column id="grantMonSum" header="发放资金金额" field="grantMonSum" width="90" renderer="formatNum(this)" align="right"></next:Column>
		<next:Column id="grantFlag" header="发放状态" field="grantFlag" width="60" dataset="dsGrantFlag"></next:Column>
		<next:Column id="grantSureDate" header="发放确认日期" field="grantSureDate" width="80"></next:Column>
		<next:Column id="note" header="备注" field="note" width="90" hidden="true"></next:Column>
	</next:Columns>
	<next:BottomBar>
				...
				<form id="grantConfirmForm" name="grantConfirmForm" method="post" dataset="ds" onsubmit="return false" class="L5form">
					<table border="0" width="98%">
						<tr>
							...
							<td class="FieldInput"><input type="text" id="grantMonSum" name="grantMonSum" field="grantMonSum" style="text-align: right"/><font color="red">*</font></td>
						</tr>
					</table>
				</form>
			</next:Html>
