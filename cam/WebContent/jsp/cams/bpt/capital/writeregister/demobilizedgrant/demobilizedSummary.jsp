...
<html>
	<head>
		...
		<script type="text/javascript" src="demobilizedSummary.js"></script>
	</head>
<body>
<model:datasets>
	<!-- 数据导出Dataset -->
	<model:dataset id="DemobilizedExportDataset" cmd="com.inspur.cams.bpt.manage.cmd.BptCapitalDetailQueryCommand" global="true" method="queryExportData">
					...
					<form style="width: 95%; height: 100%;" class="L5form">
						<table  border="1" width="100%" >
							<tr>
								...
								<td class="FieldInput"><input type="text"  id="startYear" style="width:80" title="所属年月"  format="Y-m-d" maxlength="10" onpropertychange="changeDateStyle(this)" /><img  src="../../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" >-- --<input type="text"  id="endYear" class="TextEditor" title="所属年月"  style="width:80" format="Y-m-d" maxlength="10"/><img  src="../../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ></td>	
