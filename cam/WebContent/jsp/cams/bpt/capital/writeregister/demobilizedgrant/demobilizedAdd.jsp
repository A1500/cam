...
<html>
	<head>
		...
		<script type="text/javascript" src="demobilizedAdd.js"></script>
	</head>
<body>
<model:datasets>
...
<next:EditGridPanel id="editGridPanel" name="bptcapitaldetailGrid" width="100%" stripeRows="true" height="100%" dataset="ds">
	...
	<next:Columns>
		...
		<next:Column id="credentialsNo" header="定期抚恤证编号" field="credentialsNo" width="120"></next:Column>
		<next:Column id="changeState" header="发放类别" field="changeState" width="130" dataset="GrantTypeDataset"></next:Column>
		<next:Column id="belongDate" header="属于时期" field="belongDate" width="100" dataset="warDs"></next:Column>
