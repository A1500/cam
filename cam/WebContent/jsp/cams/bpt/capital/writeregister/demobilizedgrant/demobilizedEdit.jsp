...
<next:EditGridPanel id="editGridPanel" name="bptcapitaldetailGrid" width="100%" stripeRows="true" height="100%" dataset="dsLife" enableHdMenu="true" enableColumnHide="true" enableColumnMove="true">
	<next:TopBar>
...
<next:Window id="addNewDemobilizedGrantObject" title="新增发放对象" resizable="false" width="780" height="335"  closeAction="hide" modal="true">
  <next:Panel>
	<next:Html>
		<form dataset="dsLife" id="form1" onsubmit="return false" class="L5form">
			<table border="0" width="99%">
				...
				<tr>
					...
					<td class="FieldLabel">属于时期：</td>
				    <td class="FieldInput"><label id="belongDate" field="belongDate" dataset="warDs"></label></td>
				...
				<tr>
					...
					<td class="FieldInput"><label id="grantMonSum" field="grantMonSum" style="text-align:right"/></td>
				</tr>
				<tr>
