...
<head>
<title>在乡复员军人定期定量补助导出</title>
<%
	SimpleDateFormat sdf=new SimpleDateFormat("yyyy年MM月dd日HH时mm分");
	String date=sdf.format(new Date());
	System.out.println(date);
	String name="在乡复员军人定期定量补助_"+date;
%>
</head>
<%
...
<Excel:tablelist filename="<%=name%>">
	<Excel:table sheetname="在乡复员军人定期定量补助发放">
		<Excel:tr height="50" >
			...
			<Excel:td  align="center" width="100">属于时期</Excel:td>
		...
		<Excel:tr>
			...
			<Excel:td><%=rec.get("BELONG_DATE")%></Excel:td>
