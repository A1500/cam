...
<html>
	<head>
		...
		<script type="text/javascript" src="livingAllowanceGrantAdd.js"></script>
	</head>
<body>
<model:datasets>
...
<next:EditGridPanel id="editGridPanel" name="bptcapitaldetailGrid" width="100%" stripeRows="true" height="100%" dataset="ds">
	...
	<next:Columns>
	    ...
	    <next:Column id="peopleId" header="peopleId" field="peopleId" width="90" hidden="true"></next:Column>  
		<next:Column id="regDetailId" header="名册明细ID" field="regDetailId" width="90" hidden="true"></next:Column>
		...
		<next:Column id="accountCode" header="银行帐号" field="accountCode" width="170"></next:Column>
		<next:Column id="credentialsNo" header="证书编号" field="credentialsNo" width="120"></next:Column>
		<next:Column id="objectType" header="优抚对象类别" field="objectType" width="130" dataset="ObjectTypeDataset"></next:Column>
		<next:Column id="changeState" header="发放类别" field="changeState" width="130" dataset="GrantTypeDataset"></next:Column>
		<next:Column id="domicileType" header="户籍类别" field="domicileType" width="80" dataset="DomicileDataset"></next:Column>
		<next:Column id="oldLonelyFlag" header="是否孤老" field="oldLonelyFlag" width="60" dataset="dsLoneFlag"></next:Column>
		<next:Column id="grantStaMon" header="省标准" field="grantStaMon" renderer="formatNum(this)" width="80" align="right" hidden="true"></next:Column>
		<next:Column id="grantMonths" header="发放月数" field="grantMonths" width="80" align="right"></next:Column>
		<next:Column id="grantMon" header="发放金额" field="grantMon" renderer="formatNum(this)" width="80" align="right"></next:Column>
