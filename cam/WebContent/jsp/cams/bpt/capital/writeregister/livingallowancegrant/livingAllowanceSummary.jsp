...
<html>
	<head>
		...
		<script type="text/javascript" src="livingAllowanceSummary.js"></script>	
	</head>
<body>
<model:datasets>
	<!-- 数据导出Dataset -->
	<model:dataset id="LivingAllowanceExportDataset" cmd="com.inspur.cams.bpt.manage.cmd.BptCapitalDetailQueryCommand" global="true" method="queryExportData">
...
<next:GridPanel id="editGridPanel" name="bptcapitalsummaryGrid" width="100%" clickToSelectedForChkSM="true" stripeRows="true" height="100%" dataset="ds" notSelectFirstRow="true">
	...
	<next:Columns>
		...
		<next:Column id="registerName" header="名册名称" field="registerName" width="200" >
		</next:Column>
		<next:Column id="registerType" header="名册类别" field="registerType" width="120" dataset="dsRegType" hidden="true">
		</next:Column>
		<next:Column id="organName" header="发放单位" field="organName" width="90" >
		</next:Column>
		<next:Column id="respectiveYears" header="发放年度" field="respectiveYears" width="70" align="left" hidden="true">
		</next:Column>
		...
		<next:Column id="grantDate" header="发放日期" field="grantDate" width="80" >
		</next:Column>
		<next:Column id="grantMonSum" header="发放资金总额" field="grantMonSum" width="90" renderer="formatNum(this)" align="right">
			<next:NumberField></next:NumberField>
		</next:Column>
		<next:Column id="grantFlag" header="发放状态" field="grantFlag" width="60" dataset="dsGrantFlag">
		</next:Column>
