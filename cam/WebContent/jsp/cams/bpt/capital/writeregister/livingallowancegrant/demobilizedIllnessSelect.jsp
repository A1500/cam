...
<html>
	<head>
		...
		<next:ScriptManager/>
		<script type="text/javascript" src="demobilizedIllnessSelect.js"></script>
...
<model:datasets>
	<!-- 人员信息 -->
	<model:dataset id="BaseinfoPeopleDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleDemobilizedIllnessQueryCommand" method="queryDemobilizedIllnessPeople" global="true" pageSize="8">
					...
					<form style="width: 95%; height: 100%;" class="L5form">
						<table  border="1" width="100%" >
							<tr >
								...
								<td class="FieldInput"><input type="text"  id="domicileName" class="TextEditor" title="属地行政区划" onclick="forHelp()" readonly="readonly"/>
								...
								<td class="FieldInput">
									<select id="objectState" name="objectState" field="objectState" title="优抚对象状态" disabled="disabled"> 
...
<next:GridPanel id="editGridPanel" name="baseinfopeopleGrid" width="100%" stripeRows="true" height="98%" dataset="BaseinfoPeopleDataSet" title="带病回乡退伍军人信息">
	<next:TopBar>
		<next:ToolBarItem symbol="->" ></next:ToolBarItem>
