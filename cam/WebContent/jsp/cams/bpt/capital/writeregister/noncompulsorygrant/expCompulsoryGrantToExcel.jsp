...
<Excel:tablelist filename="<%=name%>">
	<Excel:table sheetname="优待金发放">
		<Excel:tr height="50" >
			...
			<Excel:td  align="center" width="100">标准</Excel:td>
		...
		<Excel:tr>
			...
			<Excel:td><%=rec.get("OBJECT_TYPE_CODE")%></Excel:td>
			...
			<Excel:td><%=rec.get("GRANT_MON_STA")%></Excel:td>
