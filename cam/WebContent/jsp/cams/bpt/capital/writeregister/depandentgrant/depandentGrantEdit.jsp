...
<html>
	<head>
		<title>三属定期抚恤金发放名册修改</title>
		<next:ScriptManager/>
		<script type="text/javascript" src="<%=SkinUtils.getJS(request, "cams.js")%>"></script>
		<script type="text/javascript" src="<%=SkinUtils.getJS(request, "camsCheck.js")%>"></script>
		<script type="text/javascript" src="depandentGrantEdit.js"></script>
...
<next:Window id="addNewDepandGrantObject" title="新增发放对象" resizable="false" width="850" height="340"  closeAction="hide" modal="true">
  <next:Panel>
	<next:Html>
		<form dataset="ds" id="form1" onsubmit="return false" class="L5form">
			<table border="0" width="99%">
				...
				<tr>
					...
					<td class="FieldInput"><label id="objectType" field="objectType" dataset="DependantTypeDataset"></label></td>
				</tr>
				<tr>
