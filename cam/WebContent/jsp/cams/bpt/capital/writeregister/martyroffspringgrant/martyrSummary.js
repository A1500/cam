...
function query(){
	...
	ds.setParameter("registerType","B1");		
	ds.load();
...
function detail(){
	...
	var url = "martyrDetail.jsp?registerId="+registerId;
...
function insert() {
	var width = screen.width-200;
    var height = screen.height-200;
	var url = "martyrAdd.jsp?method=INSERT";
	var win = window.showModalDialog(url, window, "scroll:no;status:no;dialogWidth:" + width + "px;dialogHeight:" + height + "px;resizable:1");
	init();
}
...
function update(){
    ...
    var height = screen.height-200;
    var registerId = selected[0].get('registerId');
	var url = "martyrEdit.jsp?method=UPDATE&registerId="+registerId;
	var win = window.showModalDialog(url, window, "scroll:no;status:no;dialogWidth:" + width + "px;dialogHeight:" + height + "px;resizable:1");
	init();
}
