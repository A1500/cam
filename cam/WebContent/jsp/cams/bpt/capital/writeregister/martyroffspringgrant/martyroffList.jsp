...
<html>
	<head>
		...
		<script type="text/javascript" src="martyroffList.js"></script>
...
<model:datasets>
	<!-- 人员信息 -->
	<model:dataset id="BaseinfoPeopleDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleMartyrOffspringQueryCommand" method="queryMartyrOffspring" global="true">
...
<next:GridPanel id="editGridPanel" name="bptmartyGrid" width="100%" stripeRows="true" height="99%"  autoScroll="true" dataset="BaseinfoPeopleDataSet" title="农村籍退役士兵信息">
	<next:TopBar>
		<next:ToolBarItem symbol="->" ></next:ToolBarItem>
