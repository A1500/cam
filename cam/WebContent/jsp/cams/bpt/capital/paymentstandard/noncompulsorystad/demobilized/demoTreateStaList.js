...
function insert() {
    var url='jsp/cams/bpt/capital/paymentstandard/noncompulsorystad/demobilized/demoTreateStaEdit.jsp';
	var text = '增加在乡复员军人优待金发放标准';
	var data = new L5.Map();
...
function detail(){
	...
	var url='jsp/cams/bpt/capital/paymentstandard/noncompulsorystad/demobilized/demoTreateStaDetail.jsp';
	var text = '查看在乡复员军人优待金标准';
	L5.forward(url,text,data);
}
function update(){
    var editGrid=L5.getCmp('editGridPanel');
