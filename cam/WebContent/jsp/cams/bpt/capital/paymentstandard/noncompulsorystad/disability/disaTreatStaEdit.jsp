...
<html>
	<head>
		...
		<script type="text/javascript" src="disaTreatStaEdit.js"></script>
...
<next:EditGridPanel id="editGridPanel" name="bptcapitalstaGrid" width="100%" stripeRows="true" height="100%" dataset="ds" title="伤残抚恤金标准">
	...
	<next:Columns>
		...
		<next:Column id="disabilityLevel" header="残疾等级" field="disabilityLevel" width="140" renderer="disa_level_render">			
			<next:TriggerField onTriggerClick="openDisaLevelWin" readOnly="true"/>
		</next:Column>
...
<next:Window id="disabilityLevelSelectWin" title='选择残疾等级' resizable="false" width="300" height="330" lazyRender="false" closable="false">
	<next:FitLayout>
		<next:Panel  id="extend" border="false">
		<next:Html>
			<form onsubmit="return false" dataset="ds" class="L5form">
				<input type="hidden" systype="itemselector"  id="disabilityLevelSelectId"  field="disabilityLevel">
				<div id="favordiv"></div>
			</form>
	    </next:Html>
		</next:Panel>
