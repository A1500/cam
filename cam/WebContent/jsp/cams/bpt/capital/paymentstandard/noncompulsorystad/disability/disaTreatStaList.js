...
function insert() {
    var url='jsp/cams/bpt/capital/paymentstandard/noncompulsorystad/disability/disaTreatStaEdit.jsp';
	var text = '增加伤残优待金发放标准';
	var data = new L5.Map();
...
function detail(){
	...
	var url='jsp/cams/bpt/capital/paymentstandard/noncompulsorystad/disability/disaTreatStaDetail.jsp';
	var text = '查看伤残优待金标准';
	L5.forward(url,text,data);
}
function update(){
