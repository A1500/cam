...
function insert() {
    var url='jsp/cams/bpt/capital/paymentstandard/noncompulsorystad/demobilizedIll/demoIllTreateStaEdit.jsp';
	var text = '增加带病回乡退伍军人优待金标准';
	var data = new L5.Map();
...
function detail(){
	...
	var url='jsp/cams/bpt/capital/paymentstandard/noncompulsorystad/demobilizedIll/demoIllTreateStaDetail.jsp';
	var text = '查看带病回乡退伍军人优待金标准';
	L5.forward(url,text,data);
}
function update(){
    var editGrid=L5.getCmp('editGridPanel');
