...
function insert() {
    var url='jsp/cams/bpt/capital/paymentstandard/noncompulsorystad/dependant/depenTreatStaEdit.jsp';
	var text = '增加三属优待金发放标准';
	var data = new L5.Map();
...
function detail(){
	...
	var url='jsp/cams/bpt/capital/paymentstandard/noncompulsorystad/dependant/depenTreatStaDetail.jsp';
	var text = '查看三属优待金标准';
	L5.forward(url,text,data);
}
