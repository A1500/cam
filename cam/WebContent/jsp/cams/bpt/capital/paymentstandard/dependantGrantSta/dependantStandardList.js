...
function insert() {
    var url='jsp/cams/bpt/capital/paymentstandard/dependantGrantSta/dependantStaEdit.jsp';
	var text = '增加三属抚恤金发放标准';
	var data = new L5.Map();
...
function detail(){
	...
	var url='jsp/cams/bpt/capital/paymentstandard/dependantGrantSta/dependantStaDetail.jsp';
	var text = '查看三属抚恤金标准';
	L5.forward(url,text,data);
}
