...
<head>
	...
	<script language="javascript">
		...
		<script type="text/javascript" src="martyrStaList.js">
	</script>
</head>

<body>
<model:datasets>
	<model:dataset id="marStaDs" cmd="com.inspur.cams.bpt.manage.cmd.BptCapitalMarStaQueryCommand" sortField="START_DATE" sortDirection="DESC" global="true">
		<model:record fromBean="com.inspur.cams.bpt.capital.data.BptCapitalRetMarSta"></model:record>
	</model:dataset>
</model:datasets>

<next:GridPanel id="editGridPanel" name="bptcapitalmarstaGrid" width="100%" stripeRows="true" height="100%" clickToSelectedForChkSM="true" dataset="marStaDs" title="老烈平反子女补助标准列表">
	<next:TopBar>
	...
	<next:BottomBar>
		<next:PagingToolBar dataset="marStaDs"/>
	</next:BottomBar>
</next:GridPanel>
</body>
</html>
