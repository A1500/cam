...
<title>烈士子女补助标准树</title>
<script type="text/javascript" src="martyrStaTree.js"></script>
<model:datasets>
	<model:dataset id="dicMarStaDataset" global="true">
	...
	<next:BorderLayout>
		<next:Left split="true" cmargins="5 0 0 0" margins="5 0 0 0">
			<next:Panel title="行政区划" collapsible="true" autoScroll="true"
				...
				<next:Html>
					<next:Tree name="dicMarTree" id="dicMarTree" collapsible="true"
