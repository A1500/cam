...
<title>农村退役士兵补助标准树</title>
<script type="text/javascript" src="retiredStaTree.js"></script>
<model:datasets>
	<model:dataset id="dicRetStaDataset" global="true">
	...
	<next:BorderLayout>
		<next:Left split="true" cmargins="5 0 0 0" margins="5 0 0 0">
			<next:Panel title="行政区划" collapsible="true" autoScroll="true"
				...
				<next:Html>
					<next:Tree name="dicRetTree" id="dicRetTree" collapsible="true"
