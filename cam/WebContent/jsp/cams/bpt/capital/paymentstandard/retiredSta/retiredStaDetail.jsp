...
<html>
	<head>
		...
		<script type="text/javascript" src="retiredStaDetail.js"></script>
...
<body>
<model:datasets>
	<model:dataset id="ds" cmd="com.inspur.cams.bpt.manage.cmd.BptCapitalRetStaQueryCommand" method="execute" global="true" pageSize="500">
		<model:record fromBean="com.inspur.cams.bpt.capital.data.BptCapitalRetMarSta">
		</model:record>
	</model:dataset>
</model:datasets>

<next:Panel title="农村退役士兵补助标准列表"  name="bptcapitalretstaGrid" width="100%" height="95%"  id="editGridPanel" >
	<next:TopBar>
	...
	<next:Html>
		<form id="RetiredStaForm" class="L5form" method="post" dataset="ds" onsubmit="return false"	style="padding: 5px;" >
