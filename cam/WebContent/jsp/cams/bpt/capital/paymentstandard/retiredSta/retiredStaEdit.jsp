...
<html>
	<head>
		<title>农村退役士兵补助标准</title>
		<next:ScriptManager/>
		<script type="text/javascript" src="<%=SkinUtils.getJS(request, "camsCheck.js")%>"></script>
		<script type="text/javascript" src="../../../comm/bptComm.js"></script>
		<script type="text/javascript" src="retiredStaEdit.js"></script>
...
<model:datasets>
	<model:dataset id="queryDs" cmd="com.inspur.cams.bpt.manage.cmd.BptCapitalRetStaQueryCommand" global="true">
		<model:record fromBean="com.inspur.cams.bpt.capital.data.BptCapitalRetMarSta"></model:record>
	</model:dataset>
</model:datasets>

<next:Panel title="农村退役士兵补助标准列表"  width="100%" height="100%" border="true" autoScroll="true"	 id="retiredSta">
	<next:TopBar>
	...
	<next:Html>
		<form id="RetiredStaForm" method="post" dataset="queryDs" onsubmit="return false"	style="padding: 5px;" class="L5form">
			<table border="1" width="98%">
				...
				<tr>
					...
					<td class="FieldInput" style="width: 35%"><input type="text" id="proStaMon"
						name="proStaMon" field="proStaMon" maxlength="16" title="省标准（元）"/>
						<font color="red">*</font>
					</td>
				</tr>
				<tr>
