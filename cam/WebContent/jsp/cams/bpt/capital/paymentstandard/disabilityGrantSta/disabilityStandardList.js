...
function insert() {
    var url='jsp/cams/bpt/capital/paymentstandard/disabilityGrantSta/disabilityStaEdit.jsp';
	var text = '增加伤残抚恤金发放标准';
	var data = new L5.Map();
...
function detail(){
	...
	var url='jsp/cams/bpt/capital/paymentstandard/disabilityGrantSta/disabilityStaDetail.jsp';
	var text = '查看伤残抚恤金标准';
	L5.forward(url,text,data);
}
function update(){
