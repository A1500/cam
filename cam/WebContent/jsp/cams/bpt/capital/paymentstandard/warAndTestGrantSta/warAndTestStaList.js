...
function insert() {
    var url='jsp/cams/bpt/capital/paymentstandard/warAndTestGrantSta/warAndTestStaEdit.jsp';
	var text = '增加参战参核退役人员生活补助发放标准';
	var data = new L5.Map();
...
function detail(){
	...
	var url='jsp/cams/bpt/capital/paymentstandard/warAndTestGrantSta/warAndTestStaDetail.jsp';
	var text = '查看参战参核退役人员生活补助标准';
	L5.forward(url,text,data);
}
