...
function insert() {
    var url='jsp/cams/bpt/capital/paymentstandard/demobilizedGrantSta/demobilizedStaEdit.jsp';
	var text = '增加在乡复员军人定期定量补助发放标准';
	var data = new L5.Map();
...
function detail(){
	...
	var url='jsp/cams/bpt/capital/paymentstandard/demobilizedGrantSta/demobilizedStaDetail.jsp';
	var text = '查看在乡复员军人定期定量补助标准';
	L5.forward(url,text,data);
}
function update(){
    var editGrid=L5.getCmp('editGridPanel');
