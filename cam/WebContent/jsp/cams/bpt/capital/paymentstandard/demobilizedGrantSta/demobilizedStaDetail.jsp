...
<html>
	<head>
		<title>在乡复员军人定期定量补助标准查看</title>
		<next:ScriptManager/>
		<script type="text/javascript" src="<%=SkinUtils.getJS(request, "camsCheck.js")%>"></script>
		<script type="text/javascript" src="../../../comm/bptComm.js"></script>
		<script type="text/javascript" src="demobilizedStaDetail.js"></script>
						...
						<form style="width:100%; height: 100%;" class="L5form">
							<table border="0" width="100%">
								<tr>
									...
									<td class="FieldInput"><input type="text" id="startDate" class="TextEditor" title="生效日期"  format="Y-m-d" style="width: 100px;" onpropertychange="changeDateStyle(this)"  maxlength="10";"/><img id="dateSelect" src="../../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ></td>
...
<next:GridPanel id="editGridPanel" name="bptcapitalstaGrid" width="100%" stripeRows="true" height="100%" dataset="ds" title="伤残抚恤金标准">
	...
	<next:Columns>
	    ...
	    <next:Column id="belongDate" header="属于时期" field="belongDate" width="95" >			
			<next:ComboBox dataset="warDs"/>
		</next:Column>
	...
	<next:ExtendConfig>
	   		plugins:new L5.ux.grid.ColumnHeaderGroup({
        		rows: [
        			  [{header:'',start:1,colspan:3},{header:'地方补贴',start:4,colspan:9},{header:'年合计',start:13,colspan:1}]]
    		})
	</next:ExtendConfig>
</next:GridPanel>
</body>
