...
<html>
	<head>
		<title>带病回乡退伍军人生活补助标准</title>
		<next:ScriptManager/>
		<script type="text/javascript" src="<%=SkinUtils.getJS(request, "camsCheck.js")%>"></script>
		<script type="text/javascript" src="../../../comm/bptComm.js"></script>
		<script type="text/javascript" src="demobilizedIllStaEdit.js"></script>
...
<next:EditGridPanel id="editGridPanel" name="bptcapitalstaGrid" width="100%" stripeRows="true" height="100%" dataset="ds" title="伤残抚恤金标准">
	...
	<next:ExtendConfig>
	   		plugins:new L5.ux.grid.ColumnHeaderGroup({
        		rows: [
        			  [{header:'',start:2,colspan:2},{header:'地方补贴',start:4,colspan:9},{header:'年合计',start:13,colspan:1}]]
    		})
	</next:ExtendConfig>
