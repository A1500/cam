...
<title>优抚档案目录查看</title>
<next:ScriptManager/>
<script type="text/javascript" src="bptcataloguearchivesDetail.js"></script>
		 	      ...
		 	      <form class="L5form" >
					 <table style="width:100%">
						...
						<tr>
							...
							<td class="FieldInput">
				                <select  style="width: 160px;" id="serviceType" field="serviceType" disabled="disabled">
