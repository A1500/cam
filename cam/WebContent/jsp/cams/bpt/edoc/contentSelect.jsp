...
<html>
	<head>
		<title>档案目录选择</title>
		<next:ScriptManager/>
		<script type="text/javascript" src="contentSelect.js"></script>
		<script>
...
<model:datasets>
	...
	<!-- 档案目录Dataset -->
	<model:dataset id="CatalogueArchivesDataset" cmd="com.inspur.cams.bpt.bptelectronicfile.cmd.BptUploadfileQueryCommand" method="queryContentByServiceType" sortField="catalogOrder" global="true" pageSize="50">
