				...
				<next:Html>
					...
					<table border="1" width="98%">
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" name="approvalDate" field="approvalDate"maxlength="10" format="Y-m-d"style="width: 100px;"  onpropertychange="changeDateStyle(this)" 
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" name="lezswBirthday" field="lezswBirthday" style="width: 100px;"format="Y-m-d"maxlength="10" onpropertychange="changeDateStyle(this)" 
							 title="烈士出生日期"/><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)" ></td>
                            <td class="FieldLabel">入伍（工作）时间：</td>
							<td class="FieldInput"><input type="text" name="conscriptDate" field="conscriptDate" style="width: 100px;"format="Y-m-d" maxlength="10"  onpropertychange="changeDateStyle(this)" 
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" name="deathDate" field="deathDate" format="Y-m-d"maxlength="10"style="width: 100px;" onpropertychange="changeDateStyle(this)" 
						...
						<tr>
							...
							<td class="FieldInput" colspan="3"><input  type="text" title="烈士（牺牲、病故军人）批准时间" name="lezswApproveDate" field="lezswApproveDate"style="width: 100px;" maxlength="10"  onpropertychange="changeDateStyle(this)" 
							format="Y-m-d"/><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)" ></td>
						</tr>
						<tr>
