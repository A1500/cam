...
<model:datasets>
	...
	<!-- 遗属信息 -->
	<model:dataset id="DependantDataset" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleDependantQueryCommand.java" global="true">
...
<next:Panel height="100%" bodyStyle="width:100%" width="100%" autoScroll="false">
	...
	<next:TabPanel >
		<next:Tabs>
				...
				<next:Html>
					...
					<table border="0" width="98%">
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" name="idCard" field="idCard" title="身份证件号码" maxlength="18" style="width: 135" onchange="func_QueryIdCard()" />
			...
			<next:Panel id="typeInfo" title="类别信息" autoHeight="true" autoScroll="true"
				width="100%">
				<next:Html>
					...
					<table border="1" width="98%">
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" name="approvalDate" id="approvalDate" field="approvalDate" format="Y-m-d" maxlength="10"style="width: 100px;"  onpropertychange="changeDateStyle(this)" 
							title="批准日期" /><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)" ><font color="red">*</font></td>
						...
						<tr>
							...
							<td class="FieldLabel">出生日期：</td>
							<td class="FieldInput"><input type="text" name="lezswBirthday" id="lezswBirthday" field="lezswBirthday"maxlength="10"style="width: 100px;" format="Y-m-d" onpropertychange="changeDateStyle(this)" 
							 title="烈士出生日期" /><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)" ></td>

							<td class="FieldLabel">入伍（工作）时间：</td>
							<td class="FieldInput"><input type="text" name="conscriptDate" id="conscriptDate" field="conscriptDate"maxlength="10"style="width: 100px;" format="Y-m-d"  onpropertychange="changeDateStyle(this)" 
							 title="入伍(工作)时间"/><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)" ></td>
						</tr>
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" name="deathDate"id="deathDate" field="deathDate"maxlength="10"style="width: 100px;" format="Y-m-d"  onpropertychange="changeDateStyle(this)" 
							  title="牺牲病故时间"/><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)" ></td>
						</tr>
						...
						<tr>
							...
							<td class="FieldInput" colspan="3"><input type="text" title="烈士（牺牲、病故军人）批准时间" id="lezswApproveDate" name="lezswApproveDate" field="lezswApproveDate"style="width: 100px;" format="Y-m-d" onpropertychange="changeDateStyle(this)" 
