...
<script type="text/javascript" src="cmartyrOffspringInsert.js"></script>
...
<model:datasets>
	...
	<!-- 部分烈士（错杀被平反人员）子女信息 -->  
	<model:dataset id="MartyrOffspringDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleMartyrOffspringQueryCommand" global="true">
		<model:record fromBean="com.inspur.cams.bpt.base.data.BptPeopleMartyrOffspring">
			...
			<model:field name="martyrOffspringNo" type="string" rule="require"/> 
			<model:field name="martyrOffspringStateCode" type="string" rule="require"/> 
		</model:record>
	</model:dataset>
	<!-- 行政区划自动补全 -->
				...
				<next:Html>
					...
					<table border="1" width="99%">
						<tr>
							...
							<td class="FieldInput"><input type="text" name="idCard" field="idCard" title="身份证件号码" maxlength="18" style="width: 135" onblur="func_QueryIdCard()" />
						...
						<tr>
							...
							<td class="FieldInput" ><input type="text"
								name="birthday" field="birthday" readonly="readonly" format="Y-m-d"maxlength="10" title="出生日期"/><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)" ><font color="red">*</font></td>
				...
				<next:Html>
					...
					<table border="1" width="99%">
						...
						<tr>
							...
							<td class="FieldInput"><select name="martyrOffspringStateCode"
								field="martyrOffspringStateCode" title="优抚对象状态">
								<option dataset="ObjectStateDataset"></option>
							</select><font color="red">*</font></td>
			
							<td class="FieldLabel">证书编号：</td>
							<td class="FieldInput"><input type="text" name="martyrOffspringNo"
								field="martyrOffspringNo" title="证书编号" /><font color="red">*</font></td>
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" id="lezswApproveDate" maxlength="10" name="lezswApproveDate" field="lezswApproveDate"style= "width:100px;"  format="Y-m-d" onpropertychange="changeDateStyle(this)" title="批准烈士（平反）时间"/><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)"><font color="red">*</font></td>
