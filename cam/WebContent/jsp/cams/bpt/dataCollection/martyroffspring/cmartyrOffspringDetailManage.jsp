...
<next:Panel autoHeight="true" bodyStyle="width:100%" width="100%">
	<next:TabPanel id="tabPanel">
		...
		<next:Panel title="类别信息" width="100%" height="100%" id="martyrOffspringTabPanel">
				<next:Html>
				  <iframe id="martyrOffspringTabPanelFrame" src="cmartyrOffspringDetail.jsp?peopleId=<%=request.getParameter("peopleId")%>"
		...
		<next:Panel title="电子档案" width="100%" height="100%"
				id="uploadTabPanel">
				<next:Html>
				  <iframe id="upload" src="../comm/uploadfileDetail.jsp?peopleId='<%=request.getParameter("peopleId")%>'&serviceType='B1'"
						frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="100%">
	   				</iframe>
				</next:Html>
		</next:Panel>
