...
<html>
	<head>
		...
		<script type="text/javascript" src="disabilityList.js"></script>
...
<model:datasets>
	...
	<!-- 伤残信息 -->
	<model:dataset id="BptPeopleDisabilityDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleDisabilityQueryCommand" method="queryDisabilityBptPeople" pageSize="20" global="true"></model:dataset>
    <!-- 民族 -->
					...
					<form style="width: 98%; height: 100%;" class="L5form">
						<table  border="1" width="100%" >
							...
							<tr>
								...
								<td class="FieldInput"><input type="text"  id="disabilityNo" class="TextEditor" title="证书编号"/></td>
...
<next:GridPanel id="editGridPanel" name="baseinfopeopleGrid" width="100%" stripeRows="true" height="98%" autoScroll="true" dataset="BptPeopleDisabilityDataSet" title="伤残人员信息" notSelectFirstRow="true">
				...
				<next:Columns>
					...
					<next:Column id="nation" header="民族" field="NATION" width="50" dataset="NationDataset" >
						<next:TextField allowBlank="false" />
					</next:Column>
					...
					<next:Column id="disabilityCaseCode" header="伤残性质" field="DISABILITY_CASE_CODE" width="60" dataset="DisabilityCaseDataset">
						<next:TextField  />
					</next:Column>
					...
					<next:Column id="disabilityWarCode" header="伤残时期" field="DISABILITY_WAR_CODE" width="60" dataset="BptWarDataset">
						<next:TextField  />
					</next:Column>
