				...
				<next:Html>
					...
					<table border="1" width="98%">
						<tr>
							...
							<td class="FieldInput" ><label name="disabilityTypeCode" field="disabilityTypeCode" dataset="DisabilityTypeCodeEnum" title="伤残类别"></label></td>
							
							<td class="FieldLabel" >伤残等级：</td>
							<td class="FieldInput" ><label name="disabilityLevelCode" field="disabilityLevelCode" dataset="DisabilityLevelDataset" title="伤残等级"></label></td>
							
							<td class="FieldLabel" >伤残性质：</td>
							<td class="FieldInput" ><label name="disabilityCaseCode" field="disabilityCaseCode" dataset="DisabilityCaseDataset" title="伤残性质"></label></td>
						</tr>
						...
						<tr>
							...
							<td class="FieldInput" colspan="3"><label name="disabilityGenusCode" field="disabilityGenusCode" dataset="DisabilityGenusDataset" title="伤残属别"></label></td>
