		...
		<table border="0" width="100%" align="left">
			...
			<tr>
				...
				<td class="FieldInput"><input type="text" name="warNo"
					field="warNo" title="生活补助证编号"></input></td>

				<td class="FieldLabel" nowrap>批准日期：</td>
				<td class="FieldInput"><input type="text" name="approvalDate"style="width: 100px;" 
					field="approvalDate" format="Y-m-d" maxlength="10"  onpropertychange="changeDateStyle(this)" title="批准日期"/><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ><font
					color="red">*</font></td>
			</tr>
			<tr>
				...
				<td class="FieldInput"><input type="text" name="conscriptcDate"
					...
					maxlength="10" /><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ><font color="red">*</font></td>
