...
<%
	//String familyId = MaxValueUtil.nextStringValue("FAMILY_ID");
	///String peopleId = MaxValueUtil.nextStringValue("PEOPLE_ID");
%>
<html>
	<head>
...
<next:Panel autoHeight="true"   bodyStyle="width:100%" width="100%" autoScroll="false">
	<next:TabPanel>
		...
		<next:Panel title="电子档案" width="100%" height="100%"
				id="uploadTabPanel">
				<next:Html>
				  <iframe id="upload" src="../disability/uploadfile.jsp?peopleId='<%=request.getParameter("peopleId")%>'&serviceType='61'"
						frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="100%">
	   				</iframe>
				</next:Html>
		</next:Panel>
