...
<script type="text/javascript" src="memberInsert.js"></script>
				...
				<next:Html>
					...
					<table border="0" width="98%">
					    <tr>
							...
							<td class="FieldInput" ><input type="text" name="idCard" field="idCard" title="身份证件号码" maxlength="18" style="width:135" onblur="func_QueryIdCard()"/><font color="red">*</font></td>
						...
						<tr>
						   ...
						   <td class="FieldInput" nowrap="nowrap">
						       <input type="text" id="domicileName" name="domicileName" style="width:90%" field="domicileName" title="属地行政区划" onclick="func_ForDomicileSelect()" readonly="readonly"/><font color="red">*</font>
						...
						<tr>
							...
							<td class="FieldInput" nowrap="nowrap"><input type="text" id="apanageName" name="apanageName" style="width:90%" field="apanageName" title="行政区划" readonly="readonly" onclick="func_ForApanageSelect()"/><font color="red">*</font>
                        ...
                        <tr>
							...
							<td class="FieldInput" >
							  <select name="marriageCode" field="marriageCode">
								<option dataset="MarriageDataset" title="婚姻状况"></option>
							  </select>
						    </td>
						...
						<!--人员ID -->
						<input type="hidden" name="peopleId" field="peopleId" id="peopleId">
						<!--家庭ID -->
						<input type="hidden" name="familyId" field="familyId" id="familyId">
                     </table>
					</form>
				  </fieldset>
				</next:Html>
