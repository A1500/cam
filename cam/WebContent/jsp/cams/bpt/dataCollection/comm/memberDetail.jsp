...
<script type="text/javascript" src="memberDetail.js"></script>
</head>
<body>
<model:datasets>
				...
				<next:Html>
					...
					<table border="0" width="98%">
                        ...
                        <tr>
							...
							<td class="FieldInput" ><label name="nation" field="nation" title="民族" dataset="NationDataset" title="民族"></label></td>
						</tr>
						<tr>
                        ...
                        <tr>
							...
							<td class="FieldInput" ><label name="politicalCode" field="politicalCode" dataset="PoliticalDataset" title="政治面貌"></label></td>
							<td class="FieldLabel" >是否上学：</td>
							<td class="FieldInput"><label name="isStudy" id="isStudy" field="isStudy" title="是否上学" dataset="StudyFlagEnum"></label></td>
						</tr>
                        <tr>
							...
							<td class="FieldInput" ><label name="incomeYear" field="incomeYear" title="年收入"></label></td>
							<td class="FieldLabel" >是否残疾：</td>
							<td class="FieldInput" >
								<label name="disabilityFlag" field="disabilityFlag" title="是否残疾" dataset="HandicapFlagEnum"></label>
							</td>
						</tr>
                        <tr>
							...
							<td class="FieldInput" ><label name="isWork" field="isWork" title="劳动能力" dataset="WorkAbilityCodeEnum"></label></td>				
						</tr>
                        <tr>
							<td class="FieldLabel" >工作单位地址：</td>
							<td class="FieldInput"  colspan="3"><label name="workUnitAdd" field="workUnitAdd" title="工作单位地址" style="width: 90%"></label></td>
