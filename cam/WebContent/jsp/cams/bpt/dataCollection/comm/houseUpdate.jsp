					...
					<table border="1" width="98%">
						...
						<tr>
							...
							<td class="FieldInput" colspan="3">
										...
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<select name="houseStatus2" field="houseStatus2">
							...
							<td class="FieldInput">
										<select name="houseStructureType" field="houseStructureType" onchange="selStructureType()">
											<option dataset="HouseStructureTypeDataset"></option>
										</select>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<select name="buildingStructure" field="buildingStructure">
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" name="houseNumber" maxlength="3" field="houseNumber" /></td>	
							
							<td class="FieldLabel" nowrap="nowrap">住房建筑时间：</td>
							<td class="FieldInput"><input type="text" name="buildingDate"style="width: 100px;"
								field="buildingDate" format="Y-m-d"  onpropertychange="changeDateStyle(this)" 
								/><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)" ></td>
										
							<td class="FieldLabel" nowrap="nowrap">家庭人口数：</td>
							<td class="FieldInput"><input type="text" name="peopleNum" maxlength="2" field="peopleNum" onblur="assignAverageArea()" title="家庭人口数"/><font style="color:red;">*</font></td>	
						</tr>
						
						<tr>
							<td class="FieldLabel">总建筑面积：</td>
							<td class="FieldInput">
									<input type="text" name="buildArea" field="buildArea" maxlength="4" onblur="assignAverageArea()"/>
							</td>	
						
							<td class="FieldLabel" nowrap="nowrap">人均建筑面积：</td>
							<td class="FieldInput" nowrap="nowrap" colspan="3"><input type="text" name="buildAverageArea" field="buildAverageArea" readonly="readonly" title="人均建筑面积"/><font color="green">自动计算</font></td>
