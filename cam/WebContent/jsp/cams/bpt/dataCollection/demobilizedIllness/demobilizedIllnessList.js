...
function detail(){
	...
	var peopleId = selected[0].get('PEOPLE_ID');
	var familyId = selected[0].get('FAMILY_ID');
	var url='demobilizedIllnessDetail.jsp?peopleId='+peopleId+'&familyId='+familyId;
	var width = screen.width-200;
    var height = screen.height-150;
...
function  ett(){
   var url=L5.webPath+"/jsp/cams/bpt/excelToTable/demobilizedIllness/ErrMessage.jsp";
