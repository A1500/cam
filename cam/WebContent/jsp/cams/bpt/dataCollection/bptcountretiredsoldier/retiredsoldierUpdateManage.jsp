...
<script type="text/javascript" src="retiredsoldierUpdateManage.js"></script>
</head>
<body>
	...
	<next:TabPanel>
		<next:Tabs>
		  ...
		  <next:Panel title="类别信息" width="100%" height="100%" id="demobilizedTypeTabPanel">
				<next:Html>
				  <iframe id="demobilizedType" src="cbptcountretiredsoldierEdit.jsp?peopleId='<%=request.getParameter("peopleId")%>'"
						frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="100%">
	   				</iframe>
				</next:Html>
		 </next:Panel>
        ...
        <next:Panel title="电子档案" width="100%" height="100%" id="uploadTabPanel">
				<next:Html>
				  <iframe id="upload" src="../disability/uploadfile.jsp?peopleId='<%=request.getParameter("peopleId")%>'&serviceType='81'"
						frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="100%">
	   				</iframe>
				</next:Html>
		</next:Panel>
