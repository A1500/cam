...
<script type="text/javascript" src="../../../comm/phoneticCode/phoneticCode.js"></script>
		...
		<script type="text/javascript" src="bptcountretiredsoldierAdd.js"></script>
...
<model:datasets>
	...
	<!-- 类别信息 -->
	<model:dataset id="RetiredSoldierDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptCountRetiredSoldierQueryCommand" global="true">
				...
				<next:Html>
					...
					<table border="0" width="98%">
					    <tr>
							...
							<td class="FieldInput" ><input type="text" id="idCard" name="idCard" field="idCard" title="身份证件号码" style="width:135" maxlength="18" onchange="func_QueryIdCard()"/><font color="red">*</font>
							...
							<td nowrap colspan="1" rowspan="4"><img name="RELATIONER_PHOTOC_IMG" width=75 height=100 src="../comm/default.jpg" 
						...
						<tr>
							...
							<td class="FieldInput" ><input type="text"
								name="birthday" readonly="readonly" field="birthday" title="出生日期"/><font color="red">*</font></td>
