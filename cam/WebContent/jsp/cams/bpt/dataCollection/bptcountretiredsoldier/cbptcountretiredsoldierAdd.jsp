...
<script type="text/javascript" src="../../comm/idCardReader.js"></script>
		...
		<script type="text/javascript" src="cbptcountretiredsoldierAdd.js"></script>
				...
				<next:Html>
					...
					<table border="0" width="98%">
						...
						<tr>
							...
							<td class="FieldInput" >
							   <select name="domicileType" field="domicileType" title="户籍类别" id= "domicileType" onchange="func_Type()">
