	...
	<next:Html>
		...
		<table border="0" width="98%">
		    <tr>
				...
				<td class="FieldInput"><input type="text" id="conscriptDate" name="conscriptDate" field="conscriptDate"style="width: 100px;" format="Y-m-d"maxlength="10" onblur="check_conscriptDate();func_BelongDate()" onpropertychange="changeDateStyle(this)"  title="入伍时间"/><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ><font color="red">*</font></td>
				<td  class="FieldLabel" nowrap>复员时间：</td>
				<td class="FieldInput"><input type="text" name="decruitmentDate" field="decruitmentDate"style="width: 100px;" format="Y-m-d" maxlength="10" title="复员时间" onpropertychange="changeDateStyle(this)" /><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ><font color="red">*</font></td>
			...
			<tr>
			    <td class="FieldLabel" >优抚对象状态：</td>
							<td class="FieldInput" ><select name="demobilizedStateCode" field="demobilizedStateCode" title="优抚对象状态">
				...
				<td class="FieldInput"><input type="text" name="approvalDate" field="approvalDate" format="Y-m-d"maxlength="10"style="width: 100px;"  onpropertychange="changeDateStyle(this)" title="批准日期"/><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ><font color="red">*</font></td>
			</tr>
	   		<tr>
				<td  class="FieldLabel" nowrap>复员证号：</td>
				<td class="FieldInput"><input type="text" name="asdpNo" field="asdpNo" title="复员证号"/></td>
			...
			<tr>
				...
				<td class="FieldInput"><select name="supportPattern" field="supportPattern" title="供养方式"><option dataset="SupportPatternEnum"></option></select><font color="red">*</font></td>
			</tr>
	   		<tr>
			...
			<tr>
				...
				<td class="FieldInput" colspan="5"><textarea rows="3" cols="155" name="note" title="备注(类别信息)" field="note" ></textarea></td>
			</tr>
