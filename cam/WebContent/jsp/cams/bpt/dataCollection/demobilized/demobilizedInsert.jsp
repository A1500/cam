...
<model:datasets>
	...
	<!-- 在乡复员军人信息 -->
	<model:dataset id="PeopleDemobilizedDataset" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleDemobilizedQueryCommand" global="true">
...
<next:TabPanel>
<next:Tabs>
<next:Panel title="人员基本信息" autoHeight="true" width="100%" id="peopleTabPanel">
				<next:Html>
					...
					<table border="0" width="98%">
					    <tr>
							...
							<td class="FieldInput" ><input type="text" id="idCard" name="idCard" field="idCard" title="身份证件号码" style="width:135" maxlength="18" onchange="func_QueryIdCard()"/>
	...
	<next:Html>
		...
		<table border="0" width="98%">
		    <tr>
				...
				<td class="FieldInput"><input type="text" id="conscriptDate" name="conscriptDate" field="conscriptDate" format="Y-m-d" title="入伍时间"maxlength="10" style="width: 100px;" onblur="check_conscriptDate();func_BelongDate()" onpropertychange="changeDateStyle(this)" /><img  src="../../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ><font color="red">*</font></td>
