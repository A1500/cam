	...
	<next:Html>
		...
		<table border="0" width="100%" align="left">
			<tr>
				...
				<td class="FieldInput"><input type="text" name="approvalDate"style="width: 100px;" onpropertychange="changeDateStyle(this)" 
					field="approvalDate" format="Y-m-d" maxlength="10" title="批准日期"/><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ><font
					color="red">*</font></td>
			</tr>
			...
			<tr>
				...
				<td class="FieldInput"><input type="text" name="retiredDate" id="retiredDate"
