...
<script type="text/javascript" src="bptwar_list.js"></script>
	...
	<next:Html>
		...
		<table border="1" width="100%">
			...
			<tr>
				...
				<td class="FieldInput"><select id="objectState"
					name="objectState" field="objectState" title="优抚对象状态">
				...
				<td colspan="2" align="center"><button id="queryButton" onclick="query()">查 询</button>&nbsp;<button onclick="reset()">重 置</button>
				</td>
			</tr>
		</table>
		</form>
