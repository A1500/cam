				...
				<next:Html>
					...
					<table border="0" width="98%" align="left">
						<tr>
							...
							<td class="FieldInput"><input type="text" name="warNo"
								field="warNo" title="生活补助证编号"></input><font color="red">*</font></td>
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" name="retiredDate"style="width: 100px;" id="retiredDate"
								title="离退休时间" field="retiredDate" format="Y-m-d" onpropertychange="changeDateStyle(this)" 
						...
						<tr>	
							...
							<td class="FieldInput" ><input type="text" id="healthStateName" name="healthStateName" field="healthStateName" title="健康状况" 
							   onfocus="func_HealthSelect()"/><input type="hidden" id="healthStateCode" field="healthStateCode"/><font color="red">*</font></td>
