...
//	var url='jsp/cams/bpt/dataCollection/war/bptwarAdd.jsp';
//	var text = '增加基础信息_人员信息';
//	L5.forward(url,text,data);
	var url="bptwarAdd.jsp?method=INSERT";
    ...
    var height = screen.height-150;
 	...
 	if(returnValue!=""&returnValue!=undefined){
 		...
 		var peopleId = list[0];
 		var familyId = list[1];
 		var url2="bptwar_edit.jsp?familyId="+familyId+"&peopleId="+peopleId;
...
function upload() {
	var data = new L5.Map();
	data.put("method","INSERT");
	var url='jsp/cams/bpt/dataCollection/war/bptwarUpload.jsp';
	var text = '下载基础信息_人员信息';
	L5.forward(url,text,data);
...
//	L5.forward(url,text,data);
	...
	var url="bptwar_edit.jsp?familyId="+familyId+"&peopleId="+peopleId;
	var width = screen.width-200;
    var height = screen.height-150;
...
function detailWar(){
	...
	var width = screen.width-200;
    var height = screen.height-150;
	var url='bptwarDetailMain.jsp?familyId='+familyId+'&peopleId='+peopleId;
	var win = window.showModalDialog (url,window,"scroll:no;status:no;dialogWidth:"+width+"px;dialogHeight:"+height+"px;resizable:1");
	if (win==null) {
		return;
	}
...
function  ett(){
   var url=L5.webPath+"/jsp/cams/bpt/excelToTable/war/ErrMessage.jsp";
