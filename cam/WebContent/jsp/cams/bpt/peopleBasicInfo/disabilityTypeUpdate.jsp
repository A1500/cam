	...
	<next:Html>
		...
		<table border="1" width="98%">
			...
			<tr>
				...
				<td class="FieldInput"><label name="disabilityNo"
					field="disabilityNo" title="证书编号"/></td>
				<td class="FieldLabel">批准日期：</td>
				<td class="FieldInput"><label title="批准日期" name="approveDate" field="approveDate"/></td>
			</tr>
			...
			<tr>
				...
				<td class="FieldInput"><input format="Y-m-d"
					...
					field="conscriptDate"maxlength="10"style="width: 100px;" title="入伍(参加工作)时间" onpropertychange="changeDateStyle(this)"/><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)" ></td>

				<td class="FieldLabel" nowrap="nowrap">退伍时间：</td>
				<td class="FieldInput"><input format="Y-m-d"
					 type="text" name="veteransDate"maxlength="10"style="width: 100px;"onpropertychange="changeDateStyle(this)"
					field="veteransDate" title="退伍时间" /><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this)" ></td>
				<td class="FieldLabel" nowrap="nowrap">离退休时间：</td>
				<td class="FieldInput"><input format="Y-m-d"
					 type="text" name="retiredDate"maxlength="10"style="width: 100px;"onpropertychange="changeDateStyle(this)"
			...
			<tr>
				...
				<td class="FieldInput" ><label name="disabilityWarCode" field="disabilityWarCode" dataset="BptWarDataset"></td>
