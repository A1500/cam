...
<html>
	<head>
		...
		<script type="text/javascript" src="bptcountretiredsoldierEdit.js"></script>
	...
	<next:Html>
		...
		<table border="1"  width="99%" >
			...
			<tr>
				...
				<td class="FieldInput"><input type="text" name="conscriptDate" field="conscriptDate" format="Y-m-d"style="width: 100px;" maxlength="10" title="入伍时间"onpropertychange="changeDateStyle(this)"/><img  src="../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ><font color="red">*</font></td>
	   		    <td class="FieldLabel" >退役时间：</td>
				<td class="FieldInput"><input type="text" name="decruitmentDate" field="decruitmentDate" format="Y-m-d"style="width: 100px;" maxlength="10" title="退役时间"onpropertychange="changeDateStyle(this)"/><img  src="../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ><font color="red">*</font></td>
			...
			<tr>
	   		...
	   		<tr>
				...
				<td class="FieldInput"><input type="text" name="soldierStartDate" field="soldierStartDate" format="Y-m-d"style="width: 100px;" maxlength="10" title="服义务兵开始时间"onpropertychange="changeDateStyle(this)" onblur="func_StartDate()"/><img  src="../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ><font color="red">*</font></td>
				<td  class="FieldLabel" >服义务兵(结束时间)：</td>
				<td class="FieldInput"><input type="text" name="soldierEndDate" field="soldierEndDate" format="Y-m-d" style="width: 100px;"maxlength="10" title="服义务兵结束时间"onpropertychange="changeDateStyle(this)" onblur="func_EndDate()"/><img  src="../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ><font color="red">*</font></td>
