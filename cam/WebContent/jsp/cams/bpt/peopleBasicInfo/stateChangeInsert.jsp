...
<next:Panel title="状态变更"  width="100%" height="45%">
	<next:TopBar>
		<next:ToolBarItem symbol="->" ></next:ToolBarItem>
		<next:ToolBarItem iconCls="add"  text="修改" handler="insert" />
		<next:ToolBarItem symbol="->" ></next:ToolBarItem>
	...
	<next:Html>
		...
		<table border="1"  width="90%" >
	   		...
	   		<tr>
				...
				<td class="FieldInput" >
						<select id="changeStateSuf" name="changeStateSuf" field="changeStateSuf"  onclick="ondisplay()" onchange="onChangeState()" disabled="disabled"> 
								<option  dataset="ObjectStateDataset" ></option>
						</select>
					<font color="red">*</font> </td>
			</tr>
			<tr >
				<td  class="FieldLabel"  id="deathAlllowancetd"  style="width:20%">死亡日期：</td>
				<td class="FieldInput"  id="deathAlllowance" style="width:30%"><input type="text" id="deathDate" name="deathDate" field="deathDate" format="Y-m-d" disabled="disabled"
				...
				<td  class="FieldLabel" id="allowanceMonthtitle"  style="width:20%">抚恤金发放至：</td>
				<td class="FieldInput"  id="allowanceMonthtd" colspan="3" style="width:30%"><input type="text" id="allowanceMonth" name="allowanceMonth" field="allowanceMonth" format="Y-m" disabled="disabled"
								style="width: 100px;" maxlength="10" /><img id="allowanceMonthimg" src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ><font color="red">*</font></td>
			</tr>
	   		<tr>
				<td  class="FieldLabel" >备注：</td>
				<td class="FieldInput" colspan="3">
					<textarea id = "note" name="note" field="note" cols="122%" rows="3" disabled="disabled"></textarea>
			    </td>
			</tr>
			<!-- 状态变更ID -->
...
<next:GridPanel id="GridPanel" name="bptstatechangeGrid" height="60%" width="100%" stripeRows="true" title="状态变更历史查看" dataset="StateChangeDataset">
	<next:Columns>
