	...
	<next:Html>
		...
		<table border="0" width="98%">
			<tr>
				...
				<td class="FieldInput">
				    <label name="demobilizedStateCode" field="demobilizedStateCode" title="优抚对象状态" dataset="ObjectStateDataset"/>
				</td>
				<td class="FieldLabel" nowrap>生活补助证编号:</td>
				<td class="FieldInput"><label name="demobilizedNo" field="demobilizedNo" title="生活补助证编号" /></td>
				<td class="FieldLabel" nowrap>批准日期:</td>
				<td class="FieldInput"><label id="approvalDate" name="approvalDate" field="approvalDate"/></td>
			</tr>
			<tr>
				<td class="FieldLabel" nowrap>入伍时间：</td>
				<td class="FieldInput"><input type="text"name="conscriptDate" id="conscriptDate" field="conscriptDate" format="Y-m-d"maxlength="10"style="width: 100px;"   title="入伍时间" onpropertychange="changeDateStyle(this)"/><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ><font color="red">*</font></td>
				<td class="FieldLabel" nowrap>退伍时间：</td>
				<td class="FieldInput"><input type="text"  name="decruitmentDate"id="decruitmentDate" field="decruitmentDate" format="Y-m-d" maxlength="10"style="width: 100px;"  title="退伍时间" onpropertychange="changeDateStyle(this)"/><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ><font color="red">*</font></td>
			...
			<tr>
				...
				<td class="FieldInput">
				    <select name="isInnuclear" field="isInnuclear" title="是否参试">
