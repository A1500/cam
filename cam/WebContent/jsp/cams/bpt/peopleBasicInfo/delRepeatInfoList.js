...
function detail(objectType,peopleId,familyId,username,idCard){
	...
	var url='../peopleBasicInfo/basicInfoUpdate.jsp?peopleId='+peopleId+'&familyId='+familyId+'&username='+username+'&idCard='+idCard+'&objectType='+objectType;
