...
<html>
	<head>
		...
		<script type="text/javascript" src="delRepeatInfoList.js"></script>
...
<model:datasets>
	<!-- 全部人员信息 -->
	<model:dataset id="dsBptObject" cmd="com.inspur.cams.bpt.manage.cmd.BptBaseinfoPeopleQueryCommand" method="queryRepeatIdcard" global="true" pageSize="20">
	...
	<fieldset style="overflow: visible;" class="GroupBox"><legend
				...
				<div>
					...
					<button onclick="reset()">重 置</button> 
						...
						<tr>
							<td colspan="8" align="center"><font color='red'>注:请删除重复身份证号中的<b>一条</b>记录!删除后无法恢复,请谨慎操作!</font></td>
						</tr>
						</table>
					</form>
				</div>
...
<next:GridPanel id="baseGridPanel" name="basicInfoGridPanel" width="100%" height="100%" autoScroll="false" stripeRows="true" dataset="dsBptObject" title="优抚对象基本信息" notSelectFirstRow="true">
	...
	<next:Columns>
		...
		<next:Column id="demobilized_flag" header="在乡带病人员" field="DEMOBILIZED_FLAG"  renderer="typeRender"  width="115" >
			<next:TextField allowBlank="false" />
		</next:Column>
		
		<next:Column id="war_flag" header="参战参试人员" field="WAR_FLAG" renderer="typeRender"  width="130">
			<next:TextField allowBlank="false" />
		</next:Column>
