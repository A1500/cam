...
function domicileSelect(){
		var revalue=window.showModalDialog(L5.webPath+"/jsp/cams/comm/diccity/dicCity.jsp?organCode="+organCode+"&organName="+organName,"","dialogHeight:500px;dialogWidth:450px;resizable:no;scroll:yes;");
