					...
					<table border="1" width="98%">
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" name="buildingDate"
								field="buildingDate" format="Y-m-d" style="width: 100px;"  maxlength="10" onpropertychange="changeDateStyle(this)"/><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ></td>
										
							<td class="FieldLabel" nowrap="nowrap">家庭人口数：</td>
							<td class="FieldInput"><input type="text" name="peopleNum" field="peopleNum" maxlength="2" onblur="assignAverageArea()" title="家庭人口数"/><font style="color:red;">*</font></td>	
						</tr>
