...
<model:datasets>
	<!-- 全部人员信息 -->
	<model:dataset id="dsBptObject" cmd="com.inspur.cams.bpt.manage.cmd.BptBaseinfoPeopleQueryCommand" method="queryBPTObjectInfo" global="true" pageSize="10">
		<model:record fromBean="com.inspur.cams.comm.baseinfo.data.BaseinfoPeople"></model:record>
	</model:dataset>
	<!-- 全部人员信息用于导出Excel -->
	<model:dataset id="dsBptObject1" cmd="com.inspur.cams.bpt.manage.cmd.BptBaseinfoPeopleQueryCommand" method="queryBPTObjectInfo" global="true">
		<model:record fromBean="com.inspur.cams.comm.baseinfo.data.BaseinfoPeople"></model:record>
	</model:dataset>
	<!-- 伤残人员信息 -->
	<model:dataset id="BptPeopleDisabilityDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleDisabilityQueryCommand" method="queryDisabilityBptPeople" global="true" pageSize="10">
		<model:record fromBean="com.inspur.cams.comm.baseinfo.data.BaseinfoPeople"></model:record> 
	</model:dataset>
	<!-- 伤残人员信息用于导出Excel -->
	<model:dataset id="BptPeopleDisabilityDataSet1" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleDisabilityQueryCommand" method="queryDisabilityBptPeople" global="true" >
		<model:record fromBean="com.inspur.cams.comm.baseinfo.data.BaseinfoPeople"></model:record> 
	</model:dataset>
	<!--三属人员信息 -->
		<model:dataset id="DependantDataset" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleDependantQueryCommand" method="queryDepePeo" global="true" pageSize="10">
		<model:record fromBean="com.inspur.cams.comm.baseinfo.data.BaseinfoPeople"></model:record>
	</model:dataset>
	<!--三属人员信息用于导出Excel -->
		<model:dataset id="DependantDataset1" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleDependantQueryCommand" method="queryDepePeo" global="true" >
		<model:record fromBean="com.inspur.cams.comm.baseinfo.data.BaseinfoPeople"></model:record>
	</model:dataset>
	<!-- 在乡人员信息 -->
	<model:dataset id="demobilizedDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleDemobilizedQueryCommand" method="queryDemobilizedPeople" global="true" pageSize="10">
		<model:record fromBean="com.inspur.cams.comm.baseinfo.data.BaseinfoPeople"></model:record>
	</model:dataset>
	<!-- 在乡人员信息用于导出Excel -->
	<model:dataset id="demobilizedDataSet1" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleDemobilizedQueryCommand" method="queryDemobilizedPeople" global="true" >
		<model:record fromBean="com.inspur.cams.comm.baseinfo.data.BaseinfoPeople"></model:record>
	</model:dataset>
	<!-- 带病回乡人员信息 -->
	<model:dataset id="dsDemobilizeInelld" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleDemobilizedIllnessQueryCommand" method="queryDemobilizedIllnessPeople" global="true" pageSize="10">
		<model:record fromBean="com.inspur.cams.comm.baseinfo.data.BaseinfoPeople"></model:record>
	</model:dataset>
	<!-- 带病回乡人员信息用于导出Excel -->
	<model:dataset id="dsDemobilizeInelld1" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleDemobilizedIllnessQueryCommand" method="queryDemobilizedIllnessPeople" global="true" >
		<model:record fromBean="com.inspur.cams.comm.baseinfo.data.BaseinfoPeople"></model:record>
	</model:dataset>
	<!--参战人员信息 -->
	<model:dataset id="dataSetWar" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleWarQueryCommand" method="queryPeople" global="true" pageSize="10">
		<model:record fromBean="com.inspur.cams.comm.baseinfo.data.BaseinfoPeople"></model:record>
	</model:dataset>
	<!--参战人员信息用于导出Excel -->
	<model:dataset id="dataSetWar1" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleWarQueryCommand" method="queryPeople" global="true">
		<model:record fromBean="com.inspur.cams.comm.baseinfo.data.BaseinfoPeople"></model:record>
	</model:dataset>
	<!-- 参试人员信息 -->
	<model:dataset id="dataSetTested" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleTestedQueryCommand" method="queryPeople" global="true" pageSize="10">
		<model:record fromBean="com.inspur.cams.comm.baseinfo.data.BaseinfoPeople"></model:record>
	</model:dataset>
	<!-- 参试人员信息用于导出Excel -->
	<model:dataset id="dataSetTested1" cmd="com.inspur.cams.bpt.manage.cmd.BptPeopleTestedQueryCommand" method="queryPeople" global="true">
		<model:record fromBean="com.inspur.cams.comm.baseinfo.data.BaseinfoPeople"></model:record>
	</model:dataset>
	<!-- 60周岁以上农村籍退役军人 -->
	<model:dataset id="countretiredSoldierDataSet" cmd="com.inspur.cams.bpt.manage.cmd.BptCountRetiredSoldierQueryCommand" method="queryCountretiredSoldier" global="true" pageSize="10">
		<model:record fromBean="com.inspur.cams.comm.baseinfo.data.BaseinfoPeople"></model:record>
	</model:dataset>
	<!-- 60周岁以上农村籍退役军人用于导出Excel -->
	<model:dataset id="countretiredSoldierDataSet1" cmd="com.inspur.cams.bpt.manage.cmd.BptCountRetiredSoldierQueryCommand" method="queryCountretiredSoldier" global="true">
		<model:record fromBean="com.inspur.cams.comm.baseinfo.data.BaseinfoPeople"></model:record>
	</model:dataset>
	<!-- 性别 -->
					...
					<input type="hidden" id="test" value="2"/>
						<table  border="1" width="100%" >
							<tr >
								...
								<td class="FieldInput" align="center" style="text-align: center" ><button id="queryButton" onclick="query()">查 询</button></td>
							</tr>
							<tr>
								...
								<td class="FieldLabel" nowrap="nowrap">是否为省内迁移人员：</td>
								<td class="FieldInput">
									<select id="isprovinceMigrate" name="isprovinceMigrate" > 
											<option dataset="isprovinceMigrateds"></option>
									</select>
								</td>	
							...
							<tr>
								...
								<td class="FieldInput"   id ="times" style="display: none;" ><input type="text" id="cxsj_qs"
								...
								<td class="FieldInput"   id = "time" ><input type="text" id="cxsj_z"
	...
	<next:Html>
		...
		<table border="1" width="100%">
			<tr>
				...
				<td class="FieldLabel">姓名：</td>
				<td class="FieldInput"><input type="text" id="disbilityname"
					class="TextEditor" title="姓名" /></td>

				<td class="FieldLabel" nowrap="nowrap">身份证件号码：</td>
				<td class="FieldInput"><input type="text" id="disbilityidCard"
		...
		<!-- 		<td class="FieldLabel" nowrap="nowrap">伤残类别：</td>
			...
			<tr>
				...
				<td class="FieldLabel" nowrap="nowrap">是否为省内迁移人员：</td>
				<td class="FieldInput">
					<select id="cisprovinceMigrate" name="cisprovinceMigrate" > 
							<option dataset="isprovinceMigrateds"></option>
					</select>
				</td>
			</tr>
			<tr>
				<td class="FieldLabel" align="center" >年龄：</td>
					<td class="FieldInput" align="center">
						<input type="text"  id="disabilityageBegin" style="width:60px"  />~<input type="text"  id="disabilityageEnd" style="width:60px"  />
					</td>
				<td class="FieldLabel" nowrap="nowrap">批准日期：</td>
					...
					<td class="FieldInput"  colspan="2" id ="disabilitytimes" style="display: none;" ><input type="text" id="disabilitycxsj_qs"
						format="Y-m-d" style="width: 80px;" maxlength="10" onpropertychange="changeDateStyle(this)" /><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" >--  --<input
						type="text" id="disabilitycxsj_zs" format="Y-m-d"
						style="width: 80px;" maxlength="10"   onpropertychange="changeDateStyle(this)" /><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" > 
					</td>
					<td class="FieldInput" colspan="2"  id = "disabilitytime" ><input type="text" id="disabilitycxsj_z"
						format="Y-m-d" style="width: 80px;" maxlength="10" onpropertychange="changeDateStyle(this)" /><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" > 
					</td>
					<td class="FieldInput" colspan="2"  style="text-align: center">
					<button id="disabilityQueryButton" onclick="query()">查 询</button>&nbsp;&nbsp;&nbsp;&nbsp;
					<button onclick="reset()">重 置</button>
					</td>
			</tr>
		</table>
	...
	<fieldset style="overflow: visible;" class="GroupBox">
	    <legend class="GroupBoxTitle">查询条件 <img class="GroupBoxExpandButton" src="<%=SkinUtils.getImage(request,"groupbox_collapse.gif")%>" onclick="collapse(this)" /></legend>
				<div>
					<form style="width: 98%; height: 100%;" class="L5form">
						...
						<tr>		
							...
							<!-- 	<td class="FieldLabel" nowrap="nowrap">优抚对象类别：</td>
								...
								<td class="FieldLabel" nowrap="nowrap">是否为省内迁移人员：</td>
								<td class="FieldInput">
									<select id="sisprovinceMigrate" name="sisprovinceMigrate" > 
											<option dataset="isprovinceMigrateds"></option>
									</select>
								</td>
						</tr>	
						...
						<td class="FieldLabel" align="center" >年龄：</td>
					<td class="FieldInput" align="center">
						<input type="text"  id="dependantageBegin" style="width:60px"  />~<input type="text"  id="dependantageEnd" style="width:60px"  />
					</td>
						<td class="FieldLabel">批准日期：</td>
					...
					<td class="FieldInput"  colspan="2" id ="dependanttimes" style="display: none;" ><input type="text" id="dependantcxsj_qs"
						format="Y-m-d" style="width: 80px;" maxlength="10" onpropertychange="changeDateStyle(this)" /><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" >--  --<input
						type="text" id="dependantcxsj_zs" format="Y-m-d"
						style="width: 80px;" maxlength="10"  onpropertychange="changeDateStyle(this)"  /><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" > 
					</td>
					<td class="FieldInput" colspan="2"  id = "dependanttime" ><input type="text" id="dependantcxsj_z"
						format="Y-m-d" style="width: 80px;" maxlength="10" onpropertychange="changeDateStyle(this)" /><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" > 
					</td>
					<td colspan="2" align="center"><button id="dependantQueryButton" onclick="query()">查 询</button>
					...
					<form style="width: 95%; height: 100%;" class="L5form">
						<table  border="1" width="100%" >
							<tr >
								...
								<td rowspan="2" align="center"><button id="demobilizedQueryButton" onclick="query()">查 询</button>
								</td>
							</tr>
							<tr>
								<td class="FieldLabel" nowrap="nowrap">优抚对象状态：</td>
						...
						<!-- 	<td class="FieldLabel" nowrap="nowrap">备注：</td>
						 ...
						 <td class="FieldLabel" align="center" >年龄：</td>
					<td class="FieldInput" align="center">
						<input type="text"  id="demobilizeageBegin" style="width:60px"  />~<input type="text"  id="demobilizeageEnd" style="width:60px"  />
					</td>
					<td rowspan="2" align="center"><button onclick="reset()">重 置</button></td>
				</tr>
				<tr>	
					<td class="FieldLabel" nowrap="nowrap">是否为省内迁移人员：</td>
					<td class="FieldInput">
						<select id="zisprovinceMigrate" name="zisprovinceMigrate" > 
								<option dataset="isprovinceMigrateds"></option>
						</select>
					</td>
						 <td class="FieldLabel" nowrap="nowrap">批准日期：</td>
					...
					<td class="FieldInput" nowrap="nowrap" colspan="2" id ="demobilizetimes" style="display: none;" ><input type="text" id="demobilizecxsj_qs"
						format="Y-m-d" style="width: 80px;" maxlength="10" onpropertychange="changeDateStyle(this)" /><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" >--  --<input
						type="text" id="demobilizecxsj_zs" format="Y-m-d"
						style="width: 80px;" maxlength="10"  onpropertychange="changeDateStyle(this)"  /><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" > 
					</td>
					<td class="FieldInput" nowrap="nowrap" colspan="2"  id = "demobilizetime" ><input type="text" id="demobilizecxsj_z"
						format="Y-m-d" style="width: 80px;" maxlength="10" onpropertychange="changeDateStyle(this)" /><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" > 
					</td>
...
<next:Panel  name="demobilizedIllnessform" id="demobilizedIllnessform" hidden="true" width="100%" autoScroll="true"  border="0" bodyStyle="padding-bottom:10px;padding-top:12px;" autoHeight="true" >
	...
	<fieldset style="overflow: visible;" class="GroupBox"><legend
				...
				<div>
					<form style="width: 95%; height: 100%;" class="L5form">
						<table  border="1" width="100%" >
							<tr >
								...
								<td rowspan="2" align="center"><button id="demobilizedIllnessQueryButton" onclick="query()">查 询</button>
								</td>
							</tr>
							<tr>	
								<td class="FieldLabel" nowrap="nowrap">优抚对象状态：</td>
						...
						<!--     <td class="FieldLabel" nowrap="nowrap">备注：</td>
						 ...
						 <td class="FieldLabel" align="center" >年龄：</td>
					<td class="FieldInput" align="center">
						<input type="text"  id="demobilizedIllnessageBegin" style="width:60px"  />~<input type="text"  id="demobilizedIllnessageEnd" style="width:60px"  />
					</td>
					<td rowspan="2" align="center"><button onclick="reset()">重 置</button></td>
					</tr>
					<tr>
					<td class="FieldLabel" nowrap="nowrap">是否为省内迁移人员：</td>
					<td class="FieldInput">
						<select id="bisprovinceMigrate" name="bisprovinceMigrate" > 
								<option dataset="isprovinceMigrateds"></option>
						</select>
					</td>
					...
					<td class="FieldInput" nowrap="nowrap"  colspan="2" id ="demobilizedIllnesstimes" style="display: none;" ><input type="text" id="demobilizedIllnesscxsj_qs"
						format="Y-m-d" style="width: 80px;" maxlength="10" onpropertychange="changeDateStyle(this)" /><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" >--  --<input
						type="text" id="demobilizedIllnesscxsj_zs" format="Y-m-d"
						style="width: 80px;" maxlength="10"  onpropertychange="changeDateStyle(this)"  /><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" > 
					</td>
					<td class="FieldInput" nowrap="nowrap" colspan="2"  id = "demobilizedIllnesstime" ><input type="text" id="demobilizedIllnesscxsj_z"
						format="Y-m-d" style="width: 80px;" maxlength="10" onpropertychange="changeDateStyle(this)" /><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" > 
					</td>
				</tr>	
						</table>
		...
		<table border="1" width="100%">
			...
			<tr>
				...
				<td class="FieldInput"><select id="warDomicileType"
				 ...
				 <td class="FieldLabel" align="center" >年龄：</td>
					<td class="FieldInput" align="center">
						<input type="text"  id="warageBegin" style="width:60px"  />~<input type="text"  id="warageEnd" style="width:60px"  />
					</td>
					<td class="FieldLabel" nowrap="nowrap">是否为省内迁移人员：</td>
					<td class="FieldInput">
						<select id="czisprovinceMigrate" name="czisprovinceMigrate" > 
								<option dataset="isprovinceMigrateds"></option>
						</select>
					</td>
				</tr>
				<tr>
					<td class="FieldLabel" nowrap="nowrap">批准日期：</td>
					<td  nowrap="nowrap"  style="background-color: #f5fafa;text-align: left;font: normal 12px tahoma, arial, helvetica, sans-serif;"><select id ="wartimeType" onchange="showTime('war')">
					<option value="0">--请选择--</option>
					<option value="2">截止日期</option>
					<option value="1">起止日期</option>
					</select>  
					...
					<td  align="center" colspan="2"><button onclick="query()" id="warQueryButton" style="text-align:center;">查 询</button>&nbsp&nbsp&nbsp&nbsp<button onclick="reset()">重 置</button></td>
				</tr>	
		</table>
		</form>
		</div>
	...
	<next:Html>
		...
		<table border="1" width="100%">
			...
			<tr>
				...
				<td class="FieldLabel" align="center" >年龄：</td>
					<td class="FieldInput" align="center">
						<input type="text"  id="testageBegin" style="width:60px"  />~<input type="text"  id="testageEnd" style="width:60px"  />
					</td>
				<td class="FieldLabel" nowrap="nowrap">是否为省内迁移人员：</td>
				<td class="FieldInput">
					<select id="csisprovinceMigrate" name="csisprovinceMigrate" > 
							<option dataset="isprovinceMigrateds"></option>
					</select>
				</td>
			</tr>
			<tr>
				<td class="FieldLabel" nowrap="nowrap">批准日期：</td>
					<td   nowrap="nowrap" style="background-color: #f5fafa;text-align: left;font: normal 12px tahoma, arial, helvetica, sans-serif;"><select id ="testtimeType" onchange="showTime('test')">
					<option value="0">--请选择--</option>
					<option value="2">截止日期</option>
					<option value="1">起止日期</option>
					</select>  
				...
				<td colspan="2" class="FieldInput">
					...
					<td  align="center" colspan="2"><button onclick="query()" id="tesedQueryButton" style="text-align:center;">查 询</button>&nbsp&nbsp&nbsp&nbsp<button onclick="reset()">重 置</button></td>	
				</tr>	
		</table>
		</form>
		</div>
					...
					<form style="width: 95%; height: 100%;" class="L5form">
						<table  border="1" width="100%" >
						   <tr>
				                ...
				                <td align="center" >
								    <button id="countretiredQueryButton" onclick="query()">查 询</button>
								</td>
			               </tr>
						   <tr >
							...
							<!-- 	<td class="FieldLabel" nowrap>备注：</td>
								...
								<td class="FieldLabel" nowrap="nowrap">是否为省内迁移人员：</td>
								<td class="FieldInput">
									<select id="jisprovinceMigrate" name="jisprovinceMigrate" > 
											<option dataset="isprovinceMigrateds"></option>
									</select>
								</td>
								 <td align="center" >
