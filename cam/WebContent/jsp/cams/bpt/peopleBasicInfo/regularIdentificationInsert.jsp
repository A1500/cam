...
<next:Panel border="false" bodyBorder="false" width="100%" height="100%">
<next:Panel title="定期认证" width="100%" height="50%">
	<next:TopBar>
...
<next:GridPanel id="editGridPanel" name="bptregularidentificationGrid"
	stripeRows="true" height="50%" width="100%" dataset="RegularIdentificationDataset" title="定期认证">
	<next:Columns>
