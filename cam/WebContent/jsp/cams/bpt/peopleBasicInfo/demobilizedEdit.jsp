	...
	<next:Html>
		...
		<table border="0" width="98%">
		    <tr>
				...
				<td class="FieldInput"><input type="text" name="conscriptDate" field="conscriptDate"style="width: 100px;" format="Y-m-d"maxlength="10"  onblur="func_BelongDate()" title="入伍时间"onpropertychange="changeDateStyle(this)"/><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ><font color="red">*</font></td>
			...
			<tr>
				...
				<td class="FieldInput" ><label name="demobilizedStateCode" field="demobilizedStateCode" title="优抚对象状态" dataset="ObjectStateDataset"></td>
			    <td class="FieldLabel" >定期定量补助证编号:</td>
			    <td class="FieldInput"><label name="demobilizedNo" field="demobilizedNo" title="定期定量补助证编号"/></td>
