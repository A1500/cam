...
%>
<Excel:tablelist filename="参试人员基本信息" >
	<Excel:table>
		<Excel:tr>
			<Excel:td colspan="9" align="center"><Excel:font size="12">参试人员基本信息</Excel:font></Excel:td>
		</Excel:tr>
		<Excel:tr >
		...
		<Excel:tr bgcolor="grey"  border="1">
			...
			<Excel:td align="center" width="200" rowspan="2"><Excel:font size="13">参试类别</Excel:font></Excel:td>
			<Excel:td align="center" width="120" rowspan="2"><Excel:font size="13">残疾等级</Excel:font></Excel:td>
		</Excel:tr>
		<Excel:tr ></Excel:tr>
		<%
		...
		<Excel:tr border="1">
            ...
            <Excel:td  align="center" width="200"><%=record.get("TESTED_TYPE")==null?"":record.get("TESTED_TYPE")%></Excel:td>
