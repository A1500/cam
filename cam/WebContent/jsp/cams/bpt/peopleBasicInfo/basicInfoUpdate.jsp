...
<script type="text/javascript" src="basicInfoUpdate.js"></script>
</head>
<body>
<model:datasets>
	<!-- 人员信息 -->
		...
		<next:Tabs>
			<next:Panel title="人员基本信息" width="100%" height="100%"
				...
				<% String objectType = request.getParameter("objectType");
				  ...
				  <iframe id="peopleInfo" src="peopleUpdate.jsp?peopleId=<%=request.getParameter("peopleId")%>"
			...
			<next:Panel title="类别信息" width="100%" height="100%" id="disabilityPanel">
				<next:Html>
					<iframe id="disability" src="disabilityTypeUpdate.jsp?peopleId=<%=request.getParameter("peopleId")%>"
						frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="100%">
	   				</iframe>
				</next:Html>
			</next:Panel>
			...
			<next:Panel title="住房信息" width="100%" height="100%"
				id="houseTabPanel">
				<next:Html>
				  <iframe id="house" src="houseUpdate.jsp?familyId=<%=request.getParameter("familyId")%>"
						frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="100%">
	   				</iframe>
				</next:Html>
			</next:Panel>
			...
			<next:Panel title="状态变更" autoHeight="true" autoWidth="true" autoScroll="false"
				...
				<next:Html>
					<iframe id="instance" src="stateChangeInsert.jsp?peopleId=<%=request.getParameter("peopleId")%>&username=<%=request.getParameter("username")%>
			 ...
			 <next:Panel title="电子档案" autoHeight="true" autoWidth="true"
				id="electronicTabPanel">
				 <next:Html>
					<iframe id="electronic" src="electronicListUpdate.jsp?peopleId=<%=request.getParameter("peopleId")%>&username=<%=request.getParameter("username")%>&objectType=<%=request.getParameter("objectType") %>&objectState=<%=request.getParameter("objectState")%>"
						frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="480">
	   				</iframe>
				</next:Html>
			</next:Panel>
			<next:Panel title="电子档案" autoHeight="true" autoWidth="true"
				id="electronicDetailTabPanel">
				 <next:Html>
					<iframe id="electronicDetail" src="electronicListDetail.jsp?peopleId=<%=request.getParameter("peopleId")%>&username=<%=request.getParameter("username")%>&serviceType=<%=request.getParameter("objectType")%>";
						frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="480">
	   				</iframe>
				</next:Html>
			</next:Panel>
			<next:Panel title="信访管理" autoHeight="true" autoWidth="true" autoScroll="false"
				id="petitionTabPanel">
				<next:Html>
					<iframe id="instance" src="petitionInsert.jsp?peopleId=<%=request.getParameter("peopleId")%>&username=<%=request.getParameter("username")%>
			...
			<next:Panel title="定期认证" autoHeight="true" autoWidth="true" autoScroll="false"
				...
				<next:Html>
					<iframe id="instance" src="regularIdentificationInsert.jsp?peopleId=<%=request.getParameter("peopleId")%>&username=<%=request.getParameter("username")%>
					&idCard=<%=request.getParameter("idCard")%>&objectType=<%=request.getParameter("objectType")%>"
						frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="480">
	   				</iframe>
				</next:Html>
			...
			<next:Panel title="年度照片" width="100%" height="100%" autoScroll="false"
				id="yearphotopanel">
				<next:Html>
					<iframe id="yearPhoto" src="../comm/yearPhotoInsert.jsp?peopleId=<%=request.getParameter("peopleId")%>"
						frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="100%">
	   				</iframe>
				</next:Html>
			</next:Panel>
