var basepeople=[['ID_CARD','身份证件号码','','B1'],
	['NAME','姓名','','B2'],
	['BIRTHDAY','出生日期','','B3'],
	['NATION','民族','','B4'],
	['SEX','性别','COMM.SEX','B5'],
...
var testpeople=[['CONSCRIPTC_DATE','入伍（参加工作）时间','','T1'],
	...
	['INSANITY_FLAG','是否精神病','COMM.YESORNO','p1'],
	['OLD_LONELY_FLAG','是否孤老','COMM.YESORNO','p2'],
	['WORK_ABILITY_CODE','劳动能力','WORK.ABILITY.CODE','p4'],
	['VIABILITY_CODE','生活能力','VIABILITY.CODE','p5'],
	['BANK','开户银行','BANK.CODE','p7'],
	['ACCOUNT_NAME','开户名称','','p8'],
	['ACCOUNT_CODE','银行账号','','p9']
];
var warpeople=[['CONSCRIPTC_DATE','入伍（参加工作）时间','','W1'],
...
var depantpoeple=[['STUDENT_FLAG','是否正在上学','COMM.YESORNO','D1'],
	...
	['OLD_LONELY_FLAG','是否孤老','COMM.YESORNO','p2'],
	['ORPHAN_FLAG','是否孤儿','COMM.YESORNO','p3'],
	['WORK_ABILITY_CODE','劳动能力','WORK.ABILITY.CODE','p4'],
	['VIABILITY_CODE','生活能力','VIABILITY.CODE','p5'],
	['SUPPORT_PATTERN','优抚供养方式','SUPPORT.PATTERN','p6'],
	['BANK','开户银行','BANK.CODE','p7'],
...
var disablitypeople=[['CONSCRIPT_DATE','入伍时间','','Dis1'],
...
var demopeople=[['CONSCRIPT_DATE','入伍时间','','demo1'],
...
var demoillpeople=[['CONSCRIPT_DATE','入伍时间','','deill1'],
...
var soldierpeople=[['CONSCRIPT_DATE','入伍时间','','s1'],
...
var martyrpeople=[['STATUS_TYPE','身份类别','STATUS.TYPE','m1'],
	['LEZSW_NAME','牺牲者姓名','','m2'],
