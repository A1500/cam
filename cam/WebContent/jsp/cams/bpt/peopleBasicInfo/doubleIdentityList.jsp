...
<html>
	<head>
		...
		<script type="text/javascript" src="doubleIdentityList.js"></script>
...
<model:datasets>
	<!-- 全部人员信息 -->
	<model:dataset id="dsBptObject" cmd="com.inspur.cams.bpt.manage.cmd.BptBaseinfoPeopleQueryCommand" method="queryDoubleIdentity" global="true" pageSize="20">
	...
	<!-- 用于导出excel -->
	<model:dataset id="dsBptObject1" cmd="com.inspur.cams.bpt.manage.cmd.BptBaseinfoPeopleQueryCommand" method="queryDoubleIdentity" global="true" >
		<model:record fromBean="com.inspur.cams.comm.baseinfo.data.BaseinfoPeople">
			<model:field name="APPLY_ID" type="string"/>
			<model:field name="ACTDEF_NAME" type="string"/>
			<model:field name="ACT" type="string"/>
