	...
	<excel:tablelist filename="<%=fileName %>">
		<excel:table sheetname="士兵信息">
			<excel:tr bgcolor="grey">
				...
				<excel:td border="3" width="96" align="center">部队单位</excel:td>
				<excel:td border="3" width="112" align="center">军区大单位</excel:td>
				<excel:td border="3" width="96" align="center">未接收原因</excel:td>
				<excel:td border="3" width="96" align="center">专业特长</excel:td>
				<excel:td border="3" width="96" align="center">入伍时间</excel:td>
				<excel:td border="3" width="120" align="center">入伍户口所在地</excel:td>
				<excel:td border="3" width="64" align="center">安置理由</excel:td>
				<excel:td border="3" width="96" align="center">移交材料</excel:td>
			...
			<excel:tr>
				...
				<excel:td><%=record.get("NAME")%></excel:td>
	 			...
	 			<excel:td><%=record.get("NORECEIVERESON")%></excel:td>
