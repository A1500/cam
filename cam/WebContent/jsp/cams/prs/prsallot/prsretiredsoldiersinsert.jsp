				...
				<next:Html>
					...
					<table border="0" width="98%">
						...
						<td class="FieldLabel">身份证号：</td>
							...
							<td class="FieldInput"><input type="text" field="name" onblur="nameNew()"
								name="姓名" id="name" /><font color="red">*</font></td>
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" id="filesReceiveTime"
								...
								name="接收档案时间" /><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ></td>
						...
						<!-- <select
						 ...
						 -->
						<input type="text" field ="specialty" id="specialtyInput" name="专业特长"></td>
						...
						<tr>
							...
							<td class="FieldInput" colspan="1"><input type="text"
								field="address" name="家庭住址"  /></td>
							<td class="FieldLabel">报到时间：</td>
							<td class="FieldInput"><input type="text" field="arriveTime"  id="arriveTime"
								format="Y-m-d" maxlength="10"onpropertychange="changeDateStyle(this)" name="报到时间" title="报到时间"/><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ><font
								color="red">*</font></td>
						</tr>
						<tr>
						...
						<td class="FieldInput"><select  id = "flag" field="flag" name="是否退档" >
						...
						<tr>
							...
							<td class="FieldInput" colspan="5"><textarea field="content"
								rows="2" style="width: 85%" name="备注(基本信息)"></textarea></td>
						</tr>
