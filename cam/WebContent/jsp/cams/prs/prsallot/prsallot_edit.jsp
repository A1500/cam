...
<script type="text/javascript" src="prsallot_edit.js"></script>
</head>
<body>
<model:datasets>
<!-- 退役士兵基本信息 -->
			...
			<next:Html>
				...
				<table border="0" width="98%">
					<tr>
						...
						<td class="FieldInput"><select id="sergeantLevel" name="士官级别"
							field="sergeantLevel">
					...
					<tr>
						...
						<td class="FieldInput"><input type="text" field="name" id="name"
					...
					<tr>
						...
						<td class="FieldInput"><input type="text" field="enlistPlace"
							id="enlistPlace" name="入伍地" /><font color="red">*</font></td>
						<td class="FieldLabel">入伍时间：</td>
						<td class="FieldInput"><input type="text" field="enlistTime" onblur="serveTime()"
							id="enlistTime"  format="Y-m-d" maxlength="10"
					...
					<tr>
						...
						<td class="FieldInput"><input type="text" id="retiredTime" onblur="serveTime()"
							field="retiredTime" format="Y-m-d" maxlength="10"
					...
					<tr>
						...
						<td class="FieldInput"><input type="text" field="tel"
							style="width: 135" size="11" id="tel" name="联系方式" /><font
							color="red">*</font></td>
					...
					<tr>
						...
						<td class="FieldInput" colspan="1"><input type="text"
							field="address" name="家庭住址"  /><font
							color="red">*</font></td>
						<td class="FieldLabel">报到时间：</td>
						<td class="FieldInput"><input type="text" field="arriveTime"  id="arriveTime"format="Y-m-d"
							maxlength="10" onpropertychange="changeDateStyle(this)"
							name="报到时间" title="报到时间"/><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="FieldInput"><input type="text"
							field="spouseLocation" style="width: 135" id="spouseLocation"
							name="配偶户口所在地" /></td>
						<td class="FieldLabel">安置理由：</td>
						<td class="FieldInput"><select id="placemenRenson"
							field="placemenRenson" name="安置理由">
						...
						<td class="FieldInput"><select field="flag" id="flag"
							name="是否退档">
