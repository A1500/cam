...
<title>政策法规浏览</title>
<next:ScriptManager />
<script type="text/javascript" src="receivePoliciesRegList.js"></script>
...
<body>
<model:datasets>
	<model:dataset id="policRegDS"
		cmd="com.inspur.cams.prs.prspoliciesregulations.cmd.PrsPoliciesRegulationsQueryCmd">
		<model:record
			fromBean="com.inspur.cams.prs.prspoliciesregulations.dao.PrsPoliciesRegulations"></model:record>
	</model:dataset>
	<model:dataset id="effectFlagDS" enumName="PRS.EFFECT_FLAG"
		autoLoad="true" global="true"></model:dataset>
	<model:dataset id="typeDS" enumName="PRS.POLICREG_TYPE" autoLoad="true"
...
<next:GridPanel id="gridPanel" clickToSelectedForChkSM="true"
	notSelectFirstRow="true" title="政策法规浏览" name="informGrid" width="100%"
	height="99.9%" dataset="policRegDS" frame="true">
	<next:TopBar>
