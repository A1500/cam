...
<next:Panel autoHeight="true" bodyStyle="width:100%">
	<next:TabPanel>
		<next:Tabs>
			<next:Panel title="伤病残退役士兵基本信息">
				<next:Html>
					<iframe id="instanceDisability"
						src="../readonly/illdetail.jsp?dataBean=<%=request.getParameter("idField")%>"
			...
			<next:Panel title="伤病残退役士兵部队信息">
				<next:Html>
					<iframe id="instanceDisability"
						src="../readonly/illarmy.jsp?dataBean=<%=request.getParameter("idField")%>"
						frameborder="no" border="0" marginwidth="0" marginheight="0"
						scrolling="no" allowtransparency="yes" width="100%" height="450">
					</iframe>
				</next:Html>
			</next:Panel>
			<next:Panel title="伤病残退役士兵培训信息">
				<next:Html>
					<iframe id="instanceDisability"
