...
<script type="text/javascript" src="illdetail.js"></script>
</head>
<body>
<model:datasets>
	<!-- 退役士兵基本信息 -->
				...
				<table border="0" width="98%">
					...
					<tr>
						...
						<td class="FieldInput" style="width: 15%"><label id="retiredTime" 
							name="retiredTime" field="retiredTime" format="Y-m-d" /></td>
					</tr>
					<tr>
						...
						<td class="FieldInput" style="width: 15%"><label id="filesReceiveTime"
							name="filesReceiveTime" field="filesReceiveTime" format="Y-m-d" /></td>
					...
					<tr>
						...
						<td class="FieldInput"><label type="text" name="计划年度"
							 field="planYear" /></td>
						<td class="FieldLabel">是否接收：</td>
						<td class="FieldInput"><label field="ifReceive"
							 dataset="DisabilityFlagDataset"/></td>
						<td class="FieldLabel">
							<div id="receiveTimeL" style="display: block;">接收时间：</div>
							<div id="noReceiveReasonL" style="display: block;">不接收原因：</div>
						</td>
						<td class="FieldInput">
							<div id="receiveTime" style="display: block;"><label field="receiveTime"
								name="接收时间" ></label></div>
							<div id="noReceiveReason" style="display: block;"><label field="noReceiveReason" name="不接收原因"></label></div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="FieldInput" style="width: 15%"><label field="specialty" name="specialty" /></td>
					...
					<tr>
						...
						<td class="FieldInput" style="width: 15%" colspan="1"><label id="address"
							name="address" field="address" style="width: 135" /><font
							color="red">*</font></td>
