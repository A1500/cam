				...
				<table width="100%">
					...
					<tr>
					 ...
					 <tr>
						...
						<input type="radio" id="dealFlag"  name="处理结果" field="dealFlag" value="01"  onclick="send_problem11();" disabled="disabled" />待办<br>
						<input type="radio" id="dealFlag"  name="处理结果" field="dealFlag" value="03" onclick="send_problem1();" disabled="disabled"/>办理<br>
					    <input type="radio" id="dealFlag" name="处理结果" field="dealFlag" value="02" onclick="send_problem();" disabled="disabled" />转办单位
					  <select  name="area1" id="area1" onchange="setDomicile()" disabled="disabled"><option  dataset="domicileCityDataset"></option></select>
					     <select  name="area" id="area" disabled="disabled" ><option  dataset="domicileDataset"></option></select>
					    </td>
				 	 </tr>
					<tr>
						<td class="FieldLabel">处理情况：</td>
						<td class="FieldInput" colspan="3">
							<textArea type="text" id="deal" name="处理情况：" field="deal" cols="15" rows="3" style="width:90%;"disabled="disabled"></textArea>
						</td>
				   </tr>
				  <tr>
						<td class="FieldLabel">受理人：</td>
						<td class="FieldInput" >
							<input type="text" id="dealPerson" name="处理人：" field="dealPerson" disabled="disabled"/>
						</td>
						<td class="FieldLabel">受理时间：</td>
						<td class="FieldInput" colspan="5">
							<input type="text" id="dealTime" name="处理时间：" field="dealTime"  format="Y-m-d" onclick="LoushangDate(this);" disabled="disabled"/>
						</td>
				</tr>
				<tr>
           			...
           			<tr><td class="FieldLabel">请重新添加附件</td>
					<td colspan="3">
