...
<next:Panel autoHeight="true" bodyStyle="width:100%">
	...
	<next:TabPanel>
		<next:Tabs>
			<next:Panel title="转业士官基本信息" autoHeight="true" width="100%"
				...
				<next:Html>
					...
					<table border="0" width="98%">
						...
						<td class="FieldLabel">身份证号：</td>
							<td class="FieldInput"><input type="text" field="idcardNo" id ="idcardNo" size="18"  style="width:135"
								name="身份证号"  onchange="func_QueryIdCard()"/></td>
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" field="birthday"
								format="Y-m-d" onclick="LoushangDate(this)" name="出生日期" /><font color="red">*</font></td>
						</tr>
						<tr>
							<td class="FieldLabel">入伍时间：</td>
							<td class="FieldInput"><input type="text" field="enlistTime" style="width:135"
								format="Y-m-d" onclick="LoushangDate(this)" name="入伍时间" /><font
								color="red">*</font></td>
							<td class="FieldLabel">入伍地：</td>
							<td class="FieldInput"><input type="text" field ="enlistPlace" id="enlistPlace"  name="入伍地" /><font color="red">*</font>
							</td>
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" id="retiredTime"
								...
								name="退役时间：" /><font color="red">*</font></td>
						</tr>
						<tr>
							...
							<td class="FieldInput"><input type="text" id="servicedTime"
								field="servicedTime" name="服役年限" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="FieldInput" colspan="3"><input type="text"
								field="address" name="家庭住址" style="width: 85%" /><font
								color="red">*</font></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="FieldInput"><select  id = "placemenRenson" field="placemenRenson" name="安置理由" >
								<option dataset="PlaceReasonDataset"></option></select>
								</td>
					 	<%--	<td class="FieldLabel" colspan="2"></td>
							<td class="FieldInput"><input type="hidden" field="transFile"
								id="transFile" name="移交材料" /></td>
							</tr>
							<tr>--%>
							<td class="FieldLabel">是否退档：</td>
						<td class="FieldInput"><select  id = "flag" field="flag" name="是否退档" style="width:135">
						...
						<tr>
							...
							<td class="FieldInput" colspan="5"><textarea field="content"
								rows="2" style="width: 91%" name="备注(基本信息)"></textarea></td>
						</tr>
						<input type="hidden" name="soldiersId" id="soldiersId"
							field="soldiersId" />
						<input type="hidden" name="allotFlag" id="allotFlag"
							field="allotFlag" />
					</table>
					</form>
					</fieldset>
			...
			<next:Panel id="armyInfo" title="转业士官部队信息表" autoHeight="true"
				width="98%">
				<next:Panel>
					<next:Html>
						<fieldset>
						...
						<table border="1" width="98%">
							...
							<tr>
								...
								<td class="FieldInput"><select id="disabilityProperties"
									...
									title="伤残性质">
									<option dataset="DisabilityCaseDataset"></option></td>
								<td class="FieldLabel">是否精神病</td>
								<td class="FieldInput"><select id="mentalGrade"
									onchange="changeLevel()" field="mentalGrade" name="是否精神病">
									<option dataset="yesON" value="0"></option></td>
							</tr>
							<tr>
								<td class="FieldLabel">残疾等级</td>
								<td class="FieldInput" colspan="3"><select id="injuringGrade"
				...
				<next:EditGridPanel id="awardGridPanel" name="立功授奖情况" height="300"
					...
					<next:Columns>
						...
						<next:Column id="awardsName" header="立功授奖名称" field="awardsName" width="200">
							<next:ComboBox dataset="AwardsNameDataset"id="awardsNameComboBox" />
						</next:Column>
						<next:Column id="awardsNumber" header="立功授奖次数" field="awardsNumber" width="95">
							<next:TextField />
						</next:Column>
