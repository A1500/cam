...
<title>退役士兵信息</title>
<next:ScriptManager />
<script type="text/javascript" src="illretiredsoldiersinsert.js">
</script>
...
<model:datasets>
	...
	<model:dataset id="DisabilityLevelDataset" enumName="ILLLEVEL.CODE"
		...
		<!-- 精神病等级 -->
	<model:dataset id="MentalLevelDataset" enumName="MENTALLEVEL.CODE"
		autoLoad="true" global="true">
	</model:dataset>
	<!-- 伤病残退役士兵接收方式 -->
...
<next:Panel autoHeight="true" bodyStyle="width:100%">
	<next:TopBar>
		...
		<next:ToolBarItem iconCls="save" text="保存信息"
			handler="approvalandsave" />
		<next:ToolBarItem symbol="-"></next:ToolBarItem>
		<next:ToolBarItem iconCls="undo" text="返回" handler="back" />
	</next:TopBar>
	<next:TabPanel>
		<next:Tabs>
			<next:Panel title="伤病残退役士兵基本信息" autoHeight="true" width="100%"
				...
				<next:Html>
					...
					<table border="0" width="98%">
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" field ="enlistPlace" id  ="enlistPlace"  style="width:135" name="入伍地" /><font color="red">*</font></td>
						...
						<td class="FieldInput"><input type="text"id=planYear name="计划年度" style="width:135"
							...
							<td class="FieldInput"><select field="ifReceive" style="width:135" onchange="ifReceiveChanges()"
								id="ifReceive" name="是否接收" ><option dataset ="yesON"></option>
								</select></td>
							<td class="FieldLabel">
							<div id="receiveTimeL" style="display: block;">接收时间：</div><div id="noReceiveReasonL" style="display: none;">不接收原因：</div>
							</td>
							<td class="FieldInput"><div id="receiveTimeDiv" style="display: block;"><input type="text" 
								format="Y-m-d" maxlength="10"onpropertychange="changeDateStyle(this)" id="receiveTime"
							 field="receiveTime" name="接收时间" /><img  src="../../../../skins/images/default/rl.gif" align="middle" onclick="getTimes(this);" ></div>
			...
			<next:Panel id="armyInfo" title="伤病残退役士兵部队信息表" autoHeight="true"
				width="98%">
				<next:Panel>
					<next:Html>
						<fieldset>
