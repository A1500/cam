...
<script type="text/javascript" src="prsretiredsoldiers_approval.js"></script>
		...
		<table border="1" width="100%">
			<tr>
				...
				<td class="FieldInput"><input type="text" id="domicileName"
					class="TextEditor" title="属地行政区划" onclick="func_ForDomicileSelect()" />
...
<next:GridPanel id="editGridPanel" name="prsretiredsoldiersGrid"
	...
	<next:TopBar>
		...
		<next:ToolBarItem text="退档" iconCls="yes" id="sendup"
			handler="sendup" />
		<next:ToolBarItem symbol="-"></next:ToolBarItem>
		<next:ToolBarItem text="审核" iconCls="view" handler="approval" />
		<next:ToolBarItem symbol="-"></next:ToolBarItem>
	...
	<next:Columns>
		...
		<next:Column id="filesSource" header="档案来源" field="filesSource"
			width="90" dataset="FileResourcesDataset">
			<next:TextField />
		</next:Column>
		...
		<next:Column id="address" header="家庭住址" field="address" width="150">
			<next:TextField />
		</next:Column>
	</next:Columns>
	<next:BottomBar>
