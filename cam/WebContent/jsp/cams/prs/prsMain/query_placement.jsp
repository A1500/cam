...
<script type="text/javascript" src="query_placement.js"></script>
<style>
body {
				...
				<tr>
					...
					<table width="100%" dataset="ds" align="center">
						...
						<tr repeat="true">
							...
							<td align="right"><a href="#"><label  onclick="querydetail(this,'1')"  field="UNPLACED" ></label><label
								style="display: none"  field="ORGAN_CODE" ></label></a></td>	 
								
							<td align="right"><a href="#"><label  onclick="querydetail(this,'7')"  field="TOTAL_PLACED" ></label><label
								style="display: none"  field="ORGAN_CODE" ></label></a></td>
							<td align="right"><a href="#"><label  onclick="querydetail(this,'2')"  field="SELF_EMPLOYMENT" ></label><label
								style="display: none"  field="ORGAN_CODE" ></label></a></td>
								
							<td align="right"><a href="#"><label  onclick="querydetail(this,'3')"  field="FUXUEFUGONG" ></label><label
								style="display: none"  field="ORGAN_CODE" ></label></a></td>
							
							<td align="right"><a href="#"><label  onclick="querydetail(this,'4')"  field="PLACEMENT_GOV" ></label><label
								style="display: none"  field="ORGAN_CODE" ></label></a></td>
							
							<td align="right"><a href="#"><label  onclick="querydetail(this,'5')"  field="EMPLOYED" ></label><label
								style="display: none"  field="ORGAN_CODE" ></label></a></td>
							
							<td align="right"><a href="#"><label  onclick="querydetail(this,'6')"  field="SELF_EMPLOYED" ></label><label
								style="display: none"  field="ORGAN_CODE" ></label></a></td>
