...
<%
	...
	if("01".equalsIgnoreCase(type)){
		 docpath = "jsp/cams/bpt/peopleBasicInfo/table/settle_letter_apptable.doc"; //模板地址
	}else if("02".equalsIgnoreCase(type)){
		 docpath = "jsp/cams/bpt/peopleBasicInfo/table/anzhi.doc"; //模板地址
	}else if("03".equalsIgnoreCase(type)){
		 docpath = "jsp/cams/bpt/peopleBasicInfo/table/train.doc"; //模板地址
	}else{
	    docpath = "jsp/cams/prs/print/illInfo.doc"; //模板地址
	}
