...
<next:Panel name="form" width="100%" border="0"
	...
	<next:Html>
		...
		<table border="1" width="100%">
			<tr>
				<td class="FieldLabel" nowrap="nowrap" >计划年度：</td>
				<td class="FieldInput" ><input type="text" id="cYear"
					class="TextEditor" title="计划年度" /></td>
			...
			<tr>
				...
				<td class="FieldInput"><input type="text" field ="enlistPlace" id  ="enlistPlace"  name="入伍地" />
				</td>
...
<next:GridPanel id="editGridPanel" name="prsretiredsoldiersGrid" clickToSelectedForChkSM="true"
	...
	notSelectFirstRow="true" title="复员干部信息">
	<next:TopBar>
	...
	<next:Columns>
		...
		<next:Column id="enlistTime" header="入伍时间" field="ENTIME"
			...
			<next:TextField />
				...
				<next:Column id="enlistPlace" header="退役时间" field="RETIREDTIME"
			width="90">
			<next:TextField />
		</next:Column>
		...
		<next:Column id="filesSource" header="档案来源" field="SOURCE"
			dataset="FileResourcesDataset" width="90">
			<next:TextField />
		</next:Column>
