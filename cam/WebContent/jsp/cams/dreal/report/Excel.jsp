...
<%!
	...
	String name="代办理去世低保五保对象信息_"+date;
	
%>

</head>
<Excel:tablelist filename="<%=name %>">
	<Excel:table sheetname="代办理去世低保五保对象信息">
		<Excel:tr>
			<Excel:td colspan="8" align="center" ><Excel:font size="15">代办理去世低保五保对象信息列表</Excel:font></Excel:td>
		</Excel:tr>
		<Excel:tr>
		...
		%>
		<Excel:tr border="1">
			<Excel:td align="center"><%=rec.get("DOMICILE_FULL_NAME")%></Excel:td>
