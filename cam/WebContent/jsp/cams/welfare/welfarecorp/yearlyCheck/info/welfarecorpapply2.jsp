...
<div id="float">
	 <input field="" type="button" value="下一页" style="height: 25px; width: 80px; position: absolute; margin-left: 20px;" onclick="nextPageY('3')" /> 
	 <input field="" type="button" value="上一页" style="height: 25px; width: 80px; position: absolute; margin-left: 120px;" onclick="lastPageY('1')" />
		...
		<TBODY>
			...
			<tr>
				...
				<td colspan="4">
					...
					<span><font color="blue">自动生成</font></span>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td align="center" height="30px">注册资金(万元)</td>
