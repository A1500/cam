...
<script language="javascript">
	var procTypeId="wealQualification";
	//var act="现场勘查";
	var actId="<%=request.getParameter("actId")%>";
	var procDefUniqueId="8a898bf33f79d6a1013f7a542ea6000a";	
		...
		<next:Panel title="待办任务" width="100%" height="100%">
			...
			<next:GridPanel id="daiBanTaskGridPanel" title="待办流程列表" name="daiBanTaskGridPanel" width="100%" height="100%" dataset="daiBanDataset"  notSelectFirstRow="true">
				...
				<next:Columns>
		        	...
		        	<next:Column id="legalPeople" header="法人代表" field="LEGAL_PEOPLE" width="140" ></next:Column>
		        	<next:Column id="economicNatureName" header="经济性质" field="ECONOMIC_NATURE_CODE" width="130" dataset="ecoDataSet"></next:Column>
		        	<next:Column id="licenseCode" header="营业执照编号" field="LICENSE_CODE" width="130" ></next:Column>
...
function init(){
	...
	daiBanDataset.setParameter("tableName","WEAL_UNIT_INFO");
	...
	yiBanTaskDataset.setParameter("tableName","WEAL_UNIT_INFO");
	...
	endTaskDataset.setParameter("tableName","WEAL_UNIT_INFO");
