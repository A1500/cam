...
<script type="text/javascript">
 	...
 	function init(){
 		...
 		var approveDate=ds.getAt(0).get("approveDate");
							...
							<TBODY>
								...
								<TR>
									<TD height=50 colspan="4" align=right>
										<div align="center" style="width:300">福企证字第<label style="width:100" id='serialNum'></label>号</div>
									</TD>
								</TR>
								<TR>
									<TD height=40 width="100"  align=left style="font-size: 20px;">企业名称:</TD>
									<TD align=left  style="font-size: 20px"><label  style="width:100" field='companyName' id='companyName'/></TD>
									<TD height=40 align=left style="font-size: 20px">地址:</TD>
									<TD align=left style="font-size: 20px"><label  style="width:100" field='companyAddress' id='companyAddress'/></TD>
								</TR>
								<TR>
									<TD align=left width="130"  style="font-size: 20px">法定代表人:</TD>
								...
								<TR>
									<TD height=40 align=left style="font-size: 20px">企业类型:</TD>
