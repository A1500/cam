...
<Excel:tablelist filename="职工信息列表">
	...
	<%--标题栏 --%>
		<Excel:tr>
			<Excel:td colspan="34" align="center">职工信息列表</Excel:td>
		</Excel:tr>
	<%--列标题 --%>
		<Excel:tr bgcolor="grey">
			...
			<Excel:td  align="center" width="200">假肢制作师证书持有情况</Excel:td>
			<Excel:td  align="center" width="100">证书编号</Excel:td>
			<Excel:td  align="center" width="100">发证时间</Excel:td>
			<Excel:td  align="center" width="150">最近一次年检时间</Excel:td>
			<Excel:td  align="center" width="200">矫形器制作师证书持有情况</Excel:td>
			<Excel:td  align="center" width="100">证书编号</Excel:td>
			<Excel:td  align="center" width="100">发证时间</Excel:td>
			<Excel:td  align="center" width="150">最近一次年检时间</Excel:td>
			<Excel:td  align="center" width="200">特有工种职业资格证书持有情况</Excel:td>
			<Excel:td  align="center" width="100">证书编号</Excel:td>
			<Excel:td  align="center" width="100">发证时间</Excel:td>
			<Excel:td  align="center" width="150">最近一次年检时间</Excel:td>
	...
	<%--数据区 --%>
		...
		<Excel:tr>
			...
			<Excel:td  align="center"><%=EnumUtil.findTextFromEnum((String)record.get("certSituation"),"COMM.HAVEORNO") %></Excel:td>
			<Excel:td  align="center"><%=record.get("certCode")%></Excel:td>
			<Excel:td  align="center"><%=record.get("certDate")%></Excel:td>
			<Excel:td  align="center"><%=record.get("certTime")%></Excel:td>
			<Excel:td  align="center"><%=EnumUtil.findTextFromEnum((String)record.get("certOrthosisSituation"),"COMM.HAVEORNO") %></Excel:td>
			<Excel:td  align="center"><%=record.get("certOrthosisCode")%></Excel:td>
			<Excel:td  align="center"><%=record.get("certOrthosisDate")%></Excel:td>
			<Excel:td  align="center"><%=record.get("certOrthosisTime")%></Excel:td>
			<Excel:td  align="center"><%=EnumUtil.findTextFromEnum((String)record.get("certSpecialSituation"),"COMM.HAVEORNO") %></Excel:td>
			<Excel:td  align="center"><%=record.get("certSpecialCode")%></Excel:td>
			<Excel:td  align="center"><%=record.get("certSpecialDate")%></Excel:td>
			<Excel:td  align="center"><%=record.get("certSpecialTime")%></Excel:td>
		</Excel:tr>
		<%
			}
		%>
