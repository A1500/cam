...
<html>
	<head>
		<title>注销列表</title>
		<next:ScriptManager/>
		<script type="text/javascript" src="unitCancelList.js"></script>
					...
					<form style="width: 95%; height: 100%;" class="L5form">
						<table  border="1" width="100%" >
							...
							<tr>	
								...
								<td class="FieldInput"><button onclick="query()">查 询</button>&nbsp;&nbsp;&nbsp;<button type="reset">重 置</button> 
								</td>
							</tr>
						</table>
					</form>
...
<next:GridPanel id="editGridPanel" name="wealfitlogoffGrid" width="100%"  stripeRows="true" height="100%" dataset="ds" title="注销企业列表"  clickToSelectedForChkSM="true">
	<next:TopBar>
