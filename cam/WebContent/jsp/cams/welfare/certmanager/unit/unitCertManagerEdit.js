function init() {
	if (method==null||method==""){
		...
		ds.newRecord({"taskCode":taskCode,"companyType":'1',"morgArea":organArea,"morgName":organName});
...
function save(){
 ...
 function back()
 {	 	var url='jsp/cams/welfare/certmanager/unit/unitCertManagerList.jsp';
		var text = 'WEAL_CERT';
		L5.forward(url,text);	 
 }
//获得当前日期 
...
function query(){
	...
	dsWin.setParameter("WEAL_UNIT_STATUS.COMPANY_NAME@=",getParam("companyNameQuery"));		
