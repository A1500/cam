function init() {
	ds.setParameter("WEAL_CERT.COMPANY_TYPE@=","1");//企业类型：1	
	ds.load();
};
...
function query(){
	...
	ds.setParameter("WEAL_CERT.COMPANY_TYPE@=","1");		
...
function addCert() {
	...
	var url='jsp/cams/welfare/certmanager/fit/fitCertManagerEdit.jsp';
	var text = '证书管理编辑';
