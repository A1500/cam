...
<script type="text/javascript">
	...
	function showDeviceWin(){
		var width = 1200;
		var height = 600;
		var url="wealDevice.jsp?taskCode="+taskCode;
		var reValue=window.showModalDialog(url, window, "scroll:0;status:no;dialogWidth:" + width + "px;dialogHeight:" + height + "px;resizable:1");
		deviceCondion();
	}
...
<model:datasets>
	...
	<!-- 设施信息表 -->
	<model:dataset id="wealFitDeviceDataSet" cmd="com.inspur.cams.welfare.base.cmd.WealFitDeviceQueryCommand" global="true" pageSize="100">
			...
			<TABLE class=unnamed1 cellSpacing=0 cellPadding=0 width=900 border=0 id="toadd" >
				<tbody>
					<tr>
					 ...
					 <!-- 网站地址 -->
					  <tr>
					    ...
					    <td colspan="8" class=unnamed2><div align="left">
					      <input type="text" vname="网站地址" value="" id="webAddress" field="webAddress" size=50/>
					    </div></td>
					  </tr>
					  <tr>
					    <td class=unnamed6 height="30" colspan="3"><div align="center">经济性质</div></td>
					    <td colspan="3" class=unnamed2>
					     <select id="economicNatureCode" field="economicNatureCode" vname="经济性质" style="width:86%">
					     	<option dataset="ecoDataSet" ></option>
					     </select><font color="red">*</font>
					    </td>
					    <td class=unnamed3 height="30" colspan="2"><div align="center">组织机构代码</div></td>
					    <td colspan="3" class=unnamed6>
					      <input type="text" name="组织机构代码" id="organCode" field="organCode" />
					    </td>
					    
					    <tr>
					    <td class=unnamed6 colspan="3" height="30" ><div align="center">营业执照编号</div></td>
					    <td colspan="3" class=unnamed2>
					      <input type="text" name="营业执照编号" id="licenseCode" field="licenseCode" size=50/>
					   </td>
					  ...
					  <tr>
					    ...
					    <td colspan="8" class=unnamed2><input type="text" vname="注册资金" id="regFund" field="regFund" size=50/><font color="red">*</font></td>
					  </tr>
					   <tr>
					  	<td colspan="3" class=unnamed6 height="30" ><div align="center">经营范围</div></td>
					    <td colspan="8" class=unnamed2><input type="text" vname="经营范围" id="businessScope" field="businessScope" style="width:70%" /><font color="red">*</font></td>
					  </tr>
						
					 <tr>
						  	<td colspan="3" class=unnamed6 height="30" ><div align="center">总经营面积（㎡）</div></td>
						  	<td colspan="3" class=unnamed2>
						  		<input type="text" vname="总经营面积" onblur="checkArea(this.value)" id="operateArea" field="operateArea" size=50/><font color="red">*</font>
						   ...
						   <tr>
						    ...
						    <td colspan="8" class=unnamed2><div align="left">
						      <input type="text" vname="其它" id="otherArea" size=50 field="otherArea" size=50/><font color="red">*</font>
						    </div></td>
						  </tr>
							 ...
							 <tr >
							  ...
							  <tr>
							    ...
							    <td colspan="3" class=unnamed3 align="center" height="30"><label type="text" name="非生产人员" id="noProNum" /></td>
							    <td colspan="2" class=unnamed6 align="center"><label type="text" name="生产人员" id="proNum" /></td>
							    <td colspan="2" class=unnamed2 align="center"><label type="text" name="残疾职工" id="disNum" /></td>
							  </tr>
							  <tr>
					<!--假肢矫形器职业资格证书执有情况  -->
							  <tr>
							  ...
							  <tr>
							    <td colspan="11" class=unnamed6 height="30"><div align="left">假肢制作师职业资格证书持有情况</div></td>
							  </tr>
							  <tr>
							 ...
							 <tr>
							  ...
							  <tr>
							    <td colspan="11" class=unnamed6 height="30"><div align="left">矫形器制作师职业资格证书持有情况</div></td>
							  </tr>
							  <tr>
							    <td colspan="2" class=unnamed6 height="30"><div align="center">姓名</div></td>
							    <td colspan="3" class=unnamed2 align="center"><div align="center">身份证号码</div></td>
							...
							<tr>
							 <td colspan="11" class=unnamed6 height="30"><div align="left">假肢矫形器生产装配特有工种职业资格证书执有情况（至少有两人）</div></td>
							  ...
							  <tr>
							    <td colspan="11" class=unnamed6 height="30"><div align="left">装配假肢矫形器基本设施  <input type="button" onclick="showDeviceWin()" value="设施信息"/></div></td>
							  </tr>			
							 <tr>
						...
						<tr>
					   <td rowspan="9" class=unnamed6 colspan="2"><div align="center">主<br />要<br />产<br />品<br /></div></td>
					...
					<tr>
						  	...
						  	<td colspan="5" class="unnamed2"><div align="center"><label name="产值" id="productValueT"/></div></td>
					</tr>
					<tr>
