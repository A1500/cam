...
%>
<script type="text/javascript" src="fitQualificationList.js"></script>
...
<model:datasets>
	<!-- 待办业务表 -->
	<model:dataset id="daiBanDataset" cmd="com.inspur.cams.welfare.prosthesis.apply.cmd.FitApplyQueryCmd" method="queryQualificationList">
		<model:record fromBean="com.inspur.cams.welfare.base.data.WealFitApply"></model:record>
	</model:dataset>
	<!-- 已办业务表 -->
	<model:dataset id="yiBanDataset" cmd="com.inspur.cams.welfare.prosthesis.apply.cmd.FitApplyQueryCmd" method="queryQualificationList">
		<model:record fromBean="com.inspur.cams.welfare.base.data.WealFitApply"></model:record>
	</model:dataset>
	<!-- 业务信息表 -->
			...
			<next:Panel title="待办任务" width="100%" height="100%" >
				...
				<next:GridPanel id="daiBanTaskGridPanel" name="daiBanTaskGridPanel" width="100%" height="100%" dataset="daiBanDataset" title="待办列表" notSelectFirstRow="true">
					...
					<next:Columns>
						...
						<next:Column id="APPLY_STAUTS" header="业务状态" field="APPLY_STAUTS" hidden="true"  dataset="wealApplyStauts"></next:Column>
