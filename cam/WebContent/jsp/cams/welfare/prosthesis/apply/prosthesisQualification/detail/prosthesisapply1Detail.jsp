...
<script language="javascript">
	...
	function backPageD(){
		var data = new L5.Map();
		var url='jsp/cams/welfare/prosthesis/apply/prosthesisQualification/applytask/fitQualificationList.jsp';
	...
	function nextPageD(){
		var data = new L5.Map();
		var url='jsp/cams/welfare/prosthesis/apply/prosthesisQualification/detail/prosthesisapply2Detail.jsp';
		data.put("taskCode",taskCode);
		var text = '网上申报';
		L5.forward(url,text,data);
	}
