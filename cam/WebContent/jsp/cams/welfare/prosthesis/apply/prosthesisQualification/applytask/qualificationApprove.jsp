...
<iframe id="applyframe" marginwidth=0 marginheight=0 width=100% height=93% src="../detail/prosthesisapply1Detail.jsp?method=DETAIL&act=act&taskCode=<%=request.getParameter("primaryKey") %>" frameborder=0></iframe>
			...
			<form id="editForm"    onsubmit="return false" dataset="welfFitApplyDataSet" style="padding: 5px;" class="L5form">
				...
				<table width="98%">
			   		<tr >
						...
						<select style="width:130px;" name="explorationBaseOpinion"  onchange="fillOption(this)"
				...
				<table width="98%">
			   		<tr>
						...
						<td class="FieldInput" style="width:60%">
						<select style="width:130px;" name="chargeBaseOpinion" onchange="fillOption(this)"
				...
				<table width="98%">
			   		<tr>
						...
						<td class="FieldInput" style="width:60%" >
						<select style="width:130px;" name="cityFlag" onchange="fillOption(this)"
...
function init() {
	...
	if(actDefName=='补齐补正'){
		document.getElementById("applyframe").src="../prosthesisapply1.jsp?method=DETAIL&taskCode="+taskCode;
	}
...
function goBack(item) {
	//history.go(-1);
	var url='jsp/cams/welfare/prosthesis/apply/prosthesisQualification/applytask/fitQualificationApprovalList.jsp?actId='+getActId(actDefName);
	L5.forward(url);
}
//校验非空的域是否为空
