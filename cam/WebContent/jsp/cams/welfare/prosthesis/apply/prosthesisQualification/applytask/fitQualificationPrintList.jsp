...
<script type="text/javascript" src="fitQualificationPrintList.js"></script>
...
<model:datasets>
	<!-- 待办业务表 -->
	<model:dataset id="daiBanDataset" cmd="com.inspur.cams.welfare.prosthesis.apply.cmd.FitApplyQueryCmd" method="queryQualificationPrintList">
			...
			<next:Panel  width="100%" height="100%"  >
				...
				<next:GridPanel id="daiBanTaskGridPanel" name="daiBanTaskGridPanel" width="100%" height="100%" dataset="daiBanDataset" title="待办列表" notSelectFirstRow="true">
					...
					<next:Columns>
						...
						<next:Column id="COMPANY_NAME" header="企业名称" field="COMPANY_NAME" ></next:Column>
