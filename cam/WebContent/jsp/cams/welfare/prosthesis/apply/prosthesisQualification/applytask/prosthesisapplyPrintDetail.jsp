 	...
 	function init(){
		...
		wealFitInfoDataSet.on("load",function(ds){
			if(ds.getCount==0){
				...
				document.getElementById("totalNum").innerHTML=totalNum==""?"0":totalNum;
				document.getElementById("disNum").innerHTML=disNum==""?"0":disNum;
				document.getElementById("noProNum").innerHTML=noProNum==""?"0":noProNum;
				document.getElementById("proNum").innerHTML=proNum==""?"0":proNum;
				//职工证书情况
...
<TABLE height=677 cellSpacing=0 cellPadding=0 width=600 align=center 
	...
	<TBODY>
		...
		<TR>
			...
			<TABLE height=677 cellSpacing=0 cellPadding=0 width=600 align=center dataset="wealFitInfoDataSet"
				>
				<TBODY>
					<TR>
...
<TABLE height=629 cellSpacing=0 cellPadding=0 width=600 align=center id="tab"
	border=0>
	<TBODY>
		<TR>
		...
		<TR vAlign=top>
			...
			<TABLE class=unnamed1 cellSpacing=0 cellPadding=0 width=600 border=0 id="toadd" dataset="wealFitInfoDataSet">
				<tbody>
					<tr>
					  ...
					  <tr>
					    ...
					    <td colspan="3" class=unnamed2><div align="left">
					      &nbsp;<label  name="注册地址" id="address" field="address" size=50/>
					    	</div>
					    </td>
					 ...
					 <!-- 网站地址 -->
					  ...
					  <tr>
					   ...
					   <tr>
					    ...
					    <td colspan="8" class=unnamed2>&nbsp;<label  name="经营范围" id="businessScope" field="businessScope" /></td>
					  </tr>
					...
					<tr>
					    ...
					    <td colspan="5" class=unnamed2 height="30"><div align="center">年生产能力</div>
					    	<tr>
					...
					<tr>
					  	...
					  	<td colspan="2" class="unnamed2"><div align="center">&nbsp;<label  name="数量" /></div></td>
					  	<td colspan="3" class="unnamed2"><div align="center">&nbsp;<label  name="产值" /></div></td>
					</tr>
					<tr>
		...
		<tr >
			<td colspan="11" >
				<TABLE class=unnamed1 cellSpacing=0 cellPadding=0 width="600" border=0 id="toadd" dataset="welfFitApplyDataSet">
				<tbody>
				<tr>
				  	<td width="200" class="unnamed6" height="240">现场勘查情况</td>
				  	<td width="200" class="unnamed2">
				  		<table width="100%" height="100%">
				  			<tr>
							<td><p class="testarea02">意见标准：</p></br></td>
				  			</tr>
				  			<tr>
							<td><label style="width:90px;" name="cityFlag" id="explorationBaseOpinion" field="explorationBaseOpinion" dataset="wealBaseOpinionDs"/></td>
				  			</tr>
				  			<tr>
							<td><p class="testarea02">情况详情（当不符合条件时，需要填写详情）：</p></br></td>
				  			</tr>
				  			<tr>
								<td valign="top"><label name="explorationAddOpinion" field="explorationAddOpinion"  cols="50" rows="8" style="width:550px;height:150px"/></td>
				  			</tr>
				  			<tr>
							<td align="right"><label type="text" validateName="时间"format="Y-m-d" style="width: 100px; name="explorationTime" field="explorationTime" maxlength="10"  /></td>
				  			</tr> 
			  			</table>
					</td> 
				</tr>
				<tr>
				  	<td width="200" class="unnamed6" height="240">主管审核意见</td>
				  	<td width="400" class="unnamed2">
				  		<table width="100%" height="100%">
				  			<tr>
							<td><p class="testarea02">意见标准：</p></br></td>
				  			</tr>
				  			<tr>
							<td><label style="width:90px;" name="cityFlag" 
							 id="chargeBaseOpinion" field="chargeBaseOpinion" dataset="wealBaseOpinionDs"/></td>
				  			</tr>
				  			<tr>
							<td><p class="testarea02">情况详情（当不符合条件时，需要填写详情）：</p></br></td>
				  			</tr>
				  			<tr>
								<td valign="top"><label name="chargeAddOpinion" field="chargeAddOpinion"  cols="50" rows="8" style="width:550px;height:150px"/></br></td>
				  			</tr>
				  			<tr>
							<td align="right"><label type="text" validateName="时间"format="Y-m-d" style="width: 100px; name="chargeTime" field="chargeTime" maxlength="10"  /></td>
				  			</tr> 
			  			</table>
				  	</td>
				</tr>
				<tr>
				  	<td width="200" class="unnamed6" height="240">处长审核意见</td>
				  	<td width="400" class="unnamed2">
				  		<table width="100%" height="100%">
				  			<tr>
							<td><p class="testarea02">意见标准：</p></br></td>
				  			...
				  			<tr>
							<td><label style="width:90px;" name="cityFlag"  id="chiefBaseOpinion" field="chiefBaseOpinion" dataset="wealBaseOpinionDs"/></td>
				  			</tr>
				  			<tr>
							<td><p class="testarea02">情况详情（当不符合条件时，需要填写详情）：</p></br></td>
				  			</tr>
				  			<tr>
								<td valign="top"><label name="chiefAddOpinion" field="chiefAddOpinion"  cols="50" rows="8" style="width:550px;height:150px"/></td>
				  			</tr>
				  			<tr>
							<td align="right"><label type="text" validateName="时间"format="Y-m-d" style="width: 100px; name="chiefTime" field="chiefTime" maxlength="10"  /></td>
				  			</tr> 
			  			</table>
				  	</td>
				</tr>
				<tr>
				  	<td width="200" class="unnamed6" height="240">主管厅长意见</td>
				  	<td width="400" class="unnamed2">
				  		<table width="100%" height="100%">
				  			<tr>
							<td><p class="testarea02">意见标准：</p></br></td>
				  			...
				  			<tr>
							<td><label style="width:90px;" name="cityFlag" id="directorBaseOpinion" field="directorBaseOpinion" dataset="wealBaseOpinionDs"/></td>
				  			</tr>
				  			<tr>
							<td><p class="testarea02">情况详情（当不符合条件时，需要填写详情）：</p></br></td>
				  			</tr>
				  			<tr>
								<td valign="top"><label name="directorAddOpinion" field="directorAddOpinion"  cols="50" rows="8" style="width:550px;height:150px"/></td>
				  			</tr>
				  			<tr>
							<td align="right"><label type="text" validateName="时间"format="Y-m-d" style="width: 100px; name="directorTime" field="directorTime" maxlength="10"  /></td>
				  			</tr> 
			  			</table>
				  	</td>
				</tr>
