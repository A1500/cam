	...
	<next:TabPanel  id="panel">
		<next:Tabs>
			<next:Panel title="资格认定申报表" width="100%" height="100%" id="applytablepanel">
				<next:Html>
					<iframe id="applytable"
						src="prosthesisapplyPrintDetail.jsp?taskCode=<%=request.getParameter("taskCode")%>"
			...
			<next:Panel title="证书打印" width="100%" height="100%" id="certificatepanel">
				<next:Html>
					<iframe id="certificate" 
						src="prosthesisapplyCertPrint.jsp?taskCode=<%=request.getParameter("taskCode")%>"
						frameborder="no" border="0" marginwidth="0" marginheight="0"
						scrolling="yes" allowtransparency="yes" width="100%" height="100%">
					</iframe>
				</next:Html>
			...
			<next:Panel title="回执单" width="100%" height="100%" id="backtablepanel">
				<next:Html>
					<iframe id="backtable"
						src="prosthesisapplyBackPrint.jsp?taskCode=<%=request.getParameter("taskCode")%>&companyName=<%=request.getParameter("companyName")%>"
						frameborder="no" border="0" marginwidth="0" marginheight="0"
						scrolling="yes" allowtransparency="yes" width="100%" height="100%">
					</iframe>
				</next:Html>
