...
<iframe id="frame" marginwidth=0 marginheight=0 width=100% height=93% src="../detail/prosthesisapply1Detail.jsp?method=DETAIL&taskCode=<%=request.getParameter("primaryKey") %>" frameborder=0></iframe>
