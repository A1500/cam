...
<script type="text/javascript">
				...
				wealWorkerDataSet1.on('load',function(ds){
					if(ds.getCount()>0){
						for(var i=0;i<ds.getCount();i++){
							...
							document.getElementById("nameSpe"+i).innerHTML=ds.getAt(i).get('name');
							document.getElementById("idCardSpe"+i).innerHTML=ds.getAt(i).get('idCard');
							document.getElementById("certSpecialCode"+i).innerHTML=ds.getAt(i).get('certSpecialCode');
							document.getElementById("certSpecialDate"+i).innerHTML=ds.getAt(i).get('certSpecialDate'); */
						}
					}
				});
	...
	function nextPage(){
		var data = new L5.Map();
		var url='jsp/cams/welfare/prosthesis/certChange/info/fitCertChangeDetail3.jsp';
		data.put("taskCode",taskCode);
		var text = '网上申报';
		L5.forward(url,text,data);
	}
					...
					<tr>
					 ...
					 <!-- 网站地址 -->
					  ...
					  <tr>
					    ...
					    <td colspan="2" class=unnamed6>&nbsp;<label type="text" vname="注册资金" id="regFund" field="regFund" /><font color="red">*</font></td>
					    <td class=unnamed3 height="30" colspan="3"><div align="center">初次认定时间</div></td>
					    ...
					    <td colspan="2" class=unnamed6>&nbsp;<label  name="税务登记编号" id="registrationCode" field="registrationCode" /></td>
					     <td class=unnamed3 height="30" colspan="3"><div align="center">组织机构代码</div></td>
					    <td colspan="1" class=unnamed6>
					      &nbsp;<label type="text" name="组织机构代码" id="organCode" field="organCode" size=50/><font color="red">*</font>
					    </td>
					  </tr>
					  
					   <tr >
						   <td class=unnamed6 colspan="3" height="100"><div align="center">
								年度经营状况(万元)</div>
						   </td>
						   <td class=unnamed6 colspan="8" height="100">
						   		<table  cellSpacing=0 cellPadding=0 style="border-collapse:collapse" width="100%" border=-1>
						   		<tbody>
						   			<tr>
						   				<td class=unnamed5 height="30">经济收入</td>
						   				<td class=unnamed5>&nbsp;<label field="incomeYear" style="width:80" type="text"></input></td>
						   				<td class=unnamed5 height="30">利润</td>
						   				<td class=unnamed5>&nbsp;<label type="text" field="profitYear" style="width:80" ></input></td>
						   			</tr>
						   			<tr><td class=unnamed5 height="30">审计情况</td>
						   			<td class=unnamed5 height="30" colspan="3">&nbsp;<label type="text" field="operateSituation" style='width:50%'></input></td>
						   			</tr>
						   			<tr><td class=unnamed5 height="30">增值税总额</td>
						   				<td class=unnamed5 height="30">&nbsp;<label  type="text" field="addedTaxYear"></input></td>
						   				<td class=unnamed5 height="30">所得税总额</td>
						   				<td class=unnamed5 height="30">&nbsp;<label  type="text" field="incomeTaxYear"></input></td>
						   			</tr>
						   			<tr>
							   			<td class=unnamed5 height="30">应减免税金总额</td>
						   				<td class=unnamed5 height="30">&nbsp;<label  type="text" field="shouldredueTaxYear"></input></td>
						   				<td class=unnamed5 height="30">实际减免税金总额</td>
						   				<td class=unnamed5 height="30">&nbsp;<label  type="text" field="realredueTaxYear"></input></td>
									</tr>
									</tbody>
						   		</table>
						   </td>
