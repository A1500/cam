...
<script type="text/javascript">
	...
	function nextPageD(){
		...
		var data = new L5.Map();
		var url='jsp/cams/welfare/prosthesis/certChange/info/fitCertChangeEdit3.jsp';
		data.put("taskCode",taskCode);
		var text = '网上申报';
		L5.forward(url,text,data);
	}
					 ...
					 <!-- 网站地址 -->
					  ...
					  <tr>
					   ...
					   <td colspan="1" class=unnamed3 height="30" ><div align="center">注册资金(万元)</div></td>
					    ...
					    <td colspan="1" class=unnamed2>
					      <input type="text" name="营业执照编号" id="licenseCode" field="licenseCode" /><font color="red">*</font>
					   </td>
					    
					    <td colspan="1" class=unnamed3 height="30" ><div align="center">税务登记编号</div></td>
					    <td colspan="2" class=unnamed6><input type="text" name="税务登记编号" id="registrationCode" field="registrationCode" /><font color="red">*</font></td>
					     <td class=unnamed3 height="30" colspan="3"><div align="center">组织机构代码</div></td>
					    <td colspan="1" class=unnamed6>
					      <input type="text" name="组织机构代码" id="organCode" field="organCode" size=50/><font color="red">*</font>
					    </td>
					  </tr>		
					 <tr>
						  	<td colspan="3" class=unnamed6 height="30" ><div align="center">总经营面积（m2）</div></td>
						  	<td colspan="2" class=unnamed2>
						  		<input type="text" vname="总经营面积" id="operateArea" onblur="checkArea(this.value)" field="operateArea"/><font color="red">*</font>
