...
<script language="javascript">
	...
	function backFill(){
		if(method="INSERT"){
			...
			wealFitInfoDataSetS.setParameter("SERIAL_NUM@=",document.getElementById("serialNum").value);
			...
			var wealFitInfoDataSet = L5.DatasetMgr.lookup("wealFitInfoDataSet");
			wealFitInfoDataSet.setParameter("SERIAL_NUM@=",document.getElementById("serialNum").value);
				wealFitInfoDataSet.load();
		}
	}
	...
	function back(){
		var data = new L5.Map();
		var url='jsp/cams/welfare/prosthesis/certChange/certChangeList.jsp';
	...
	function nextPageY(){
		...
		var data = new L5.Map();
		var url='jsp/cams/welfare/prosthesis/certChange/info/fitCertChangeEdit2.jsp';
		data.put("taskCode",taskCode);
		var text = '网上申报';
		L5.forward(url,text,data);
	}
					...
					<TR>
						...
						<TABLE cellSpacing=0 cellPadding=0 width='100%' border=0>
							<TBODY>
								...
								<TR>
									<TD width='668' height=34 align=middle class=title1><STRONG>换 证 审 批 表
									</STRONG></TD>
								</TR>
							</TBODY>
						</TABLE>
