	...
	<head>
		...
		<script language="javascript">
			...
			function init() {
				...
				ds.setParameter("WEAL_FIT_STATUS.NEXT_CHECK@=",year);
				ds.load();
			};
			...
			function query(){
				...
				ds.setParameter("WEAL_FIT_STATUS.NEXT_CHECK@=",getParam("nextYear"));		
				ds.load();
			}
			function insert(){
				...
				var url='jsp/cams/welfare/prosthesis/yearlyCheck/info/prosthesisapply1Add.jsp';
				var text = '认定信息采集';
