...
<script type="text/javascript">
	...
	function backPageD(){
		var data = new L5.Map();
		var url='jsp/cams/welfare/prosthesis/yearlyCheck/info/prosthesisapply1Detail.jsp';
	...
	function nextPage(){
		var data = new L5.Map();
		var url='jsp/cams/welfare/prosthesis/yearlyCheck/info/prosthesisapply3Detail.jsp';
		data.put("taskCode",taskCode);
		var text = '网上申报';
		L5.forward(url,text,data);
	}
