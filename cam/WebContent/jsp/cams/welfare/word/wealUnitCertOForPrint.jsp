...
function init(){  
	...
	welfCertDataSet.on("load",function(ds){
		...
		showMap.put("startDate",ds.get("startDate").split("-")[0]);
		showMap.put("endDate",ds.get("endDate").split("-")[0]);
		showMap.put("mAndDay",ds.get("endDate").split("-")[1]+"月"+ds.get("endDate").split("-")[2]+"日");
