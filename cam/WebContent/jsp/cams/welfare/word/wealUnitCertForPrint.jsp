...
function init(){  
	...
	//取得文件名 和标签    
	 if(certType == '0'){
		nowFileName = "unitCertO.doc";
	}else{
		nowFileName = "unitCertC.doc";
	} 
	...
	welfCertDataSet.on("load",function(ds){
		...
		showMap.put("organType",ds.get("organType"));
		showMap.put("businessScope",ds.get("businessScope"));
		//showMap.put("siteArea",ds.get("siteArea"));
		showMap.put("companyAddress",ds.get("companyAddress"));
		//showMap.put("approveDate",ds.get("approveDate"));
		showMap.put("startDate",ds.get("startDate"));
		showMap.put("endDate",ds.get("endDate"));
		showMap.put("signOrgan",ds.get("signOrgan"));
		showMap.put("signDate",ds.get("signDate"));
		/*var signDate = ds.get("signDate");
		showMap.put("FYear",signDate.split("-")[0]);
		showMap.put("FMonth",signDate.split("-")[1]);
		showMap.put("FDay",signDate.split("-")[2]);
		*/
		/* if(certType == '0'){
