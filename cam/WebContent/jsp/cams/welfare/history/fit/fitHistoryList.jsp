...
<html>
	<head>
		...
		<next:ScriptManager/>
		<script type="text/javascript" src="fitHistoryList.js"></script>
...
<next:GridPanel id="editGridPanel" name="wealfitstatusGrid" width="100%" stripeRows="true" height="100%" dataset="ds" title="企业列表">
	<next:TopBar>
