...
function query(){		
	ds.setParameter("WEAL_DIC_ECONOMICNATURE.code@=",getParam("code"));		
	ds.setParameter("WEAL_DIC_ECONOMICNATURE.name@LIKE",getParam("name"));		
	ds.setParameter("WEAL_DIC_ECONOMICNATURE.type@=",getParam("type"));		
	ds.load();
}
