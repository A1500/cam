...
<script type="text/javascript" src="soo_config_tree.js"></script>
</head>
<body>
<next:ViewPort>
<next:BorderLayout>
	<next:Left split="true" cmargins="5 0 0 0" margins="5 0 0 0" >
		<next:Panel title='单点登陆用户树' collapsible="true"  autoScroll="true" width="20%" anchor="100% 100%">
			<next:Html>
					...
					<next:TreeNodemodel recordType="struRecord">
						...
						<next:RightmouseMenu menuId="menuId1" trigger="istRoot">
							<next:MenuItem text='单点登陆设置' handler="addUser"></next:MenuItem>
						</next:RightmouseMenu>
					</next:TreeNodemodel>
					<next:TreeNodemodel recordType="userRecord">
						...
						<next:RightmouseMenu menuId="roleMenu">
							<next:MenuItem text='单点登陆设置' handler="configSoo"></next:MenuItem>
						</next:RightmouseMenu>
						<next:Listeners>
