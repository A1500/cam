...
function detail(){
    ...
    var height = 768;
	if(changeType=="01"){
		url = "dicCityInsertCheckDetail.jsp?method=detail&changeId="+records[0].get("changeId");
	}else if(changeType=="03"){
		url = "dicCityDeleteCheckDetail.jsp?method=detail&changeId="+records[0].get("changeId");
	}else{
		url = "dicCityChangeCheckDetail.jsp?method=detail&changeId="+records[0].get("changeId");
	}
