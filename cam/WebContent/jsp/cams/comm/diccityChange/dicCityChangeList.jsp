...
<script type="text/javascript" src="dicCityChangeList.js"></script>
...
<next:EditGridPanel height="60%" id="grid"  dataset="dicCityChangeDataSet" autoScroll="true"  width="100%" titleCollapse="true" collapsible="true"  stripeRows="true">
	<next:TopBar>
		...
		<next:ToolBarItem iconCls="return" text="返回" handler="back" id="back"></next:ToolBarItem>
	</next:TopBar>
	<next:Columns>
...
<next:Window id ="typeWin" title="调整类别" expandOnShow="false"
       ...
       <next:Panel>
			...
			<next:Html>
				<form id="editForm"  dataset="dicCityChangeDataSet" onsubmit="return false"  class="L5form">
				<table border="1"  width="100%" >
			   		<tr>	
						<td  class="FieldLabel" style="width:30%">类别</td>
						<td class="FieldInput" style="width:70%"><select style="width:200" id="changeType" field="changeType"   >
							<option dataset="adjustTypeDataset"></option>
						</select></td>
					</tr>
				</table>
				</form>
