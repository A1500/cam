...
<body> 
<model:datasets> 
	<model:dataset id="ds" cmd="com.inspur.cams.low.query.cmd.LowAreaSortQueryCmd" pageSize="20" method="queryFamily" global="true" autoLoad="false">
	</model:dataset>
</model:datasets>
...
<next:Panel name="form" width="99%" border="0" autoScroll="true"
	...
	<next:Html>
		...
		<div>
		<form style="width: 99%; height: 90%;" class="L5form">
...
<next:GridPanel id="editGridPanel" name="ygjzjtxxGrid" width="99%" stripeRows="true" height="470" dataset="ds"    title="最低生活保障家庭成员信息列表" autoScroll="true" collapsible="true" autoWidth="true">
 
	<next:Columns>
		<next:RowNumberColumn width="25" />
		<next:Column id="HZXM"        header="户主姓名"    field="HZXM"  width="6%" align="center"/>
		<next:Column id="HZID"        header="户主身份证"  field="HZID"   width="11%" align="center" />
		<next:Column id="LOW_NO"      header="低保证号"    field="LOW_NO"     width="10%" align="center"/>
