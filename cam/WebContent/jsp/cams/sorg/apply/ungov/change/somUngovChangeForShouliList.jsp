...
<html>
	...
	<script type="text/javascript">
		var procTypeId ="somUngovChange";
		var act="受理";	
		var procDefUniqueId="402881e631e4e3630131e516c226000d";
...
function forNewChange(){
	var url="jsp/cams/sorg/apply/ungov/change/somUngovChange.jsp";
	L5.forward(url,"民办非企业单位变更登记页面");
