...
<head>
	<next:ScriptManager/>
	<script type="text/javascript" src="somUngovChange.js"></script>
	...
	<script type="text/javascript">
		<%
			...
			String somApplyType=ApplyType.SOM_UNGOV_CHANGE;
	...
	<next:TabPanel id="tab" activeTab="1" width="100%" height="100%" >
		<next:Tabs>
			<next:Panel title="民办非企业单位变更登记申请表" width="100%" height="100%"  autoScroll="true">
					...
					<next:Html>
						...
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput" style="width: 10%;"><input type="text" id="appDate" format="Y-m-d" onclick="WdatePicker();"title="申请时间"/><font color="red">*</font></td>
							</tr>
						</table>
						</form>
						</fieldset>
				...
				<next:EditGridPanel id="changeEdit" dataset="somChangeList" height="80%" autoScroll="true" >
					<next:TopBar>
