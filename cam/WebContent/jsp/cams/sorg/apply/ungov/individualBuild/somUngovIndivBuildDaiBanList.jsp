...
var act="<%=act%>";
var procTypeId ="somUngovIndivBuild";
//查询条件面板打开合并函数
...
function handle()
{
	...
	var url;
	if(act=='auditReport'){
		url='jsp/cams/sorg/apply/ungov/individualBuild/somUngovIndivBuildReportDetail.jsp';
	}else if(act=='accept'){
		url='jsp/cams/sorg/apply/ungov/individualBuild/somUngovIndivBuildInsert.jsp';
	}else if(act=='inform'){
		url='jsp/cams/sorg/apply/ungov/individualBuild/somUngovIndivBuildInform.jsp';
	}else if(act == 'supply' ){
		url='jsp/cams/sorg/apply/ungov/individualBuild/somUngovIndivBuildInsert.jsp';
		url+='?method=UPDATE&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId+'&act='+act;
	}else{
		url='jsp/cams/sorg/apply/ungov/individualBuild/somUngovIndivBuildFlow.jsp';
	}
