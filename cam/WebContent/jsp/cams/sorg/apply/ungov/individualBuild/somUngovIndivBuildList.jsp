...
<html>
<head>
<title>民办非企业单位(合伙)列表</title>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript" src='<%=SkinUtils.getJS(request,"cams.js") %>'></script>
<script type="text/javascript" src='<%=SkinUtils.getJS(request,"camsCheck.js")%>'></script>
<script type="text/javascript">
var procTypeId = 'somUngovIndivBuild';//流程类型ID	
var act="受理";
var procDefUniqueId="8a898b9d363952230136395b83ea0050";
...
function forNewBuild(){
	var url="jsp/cams/sorg/apply/ungov/individualBuild/somUngovIndivBuildInsert.jsp?method=INSERT";
...
function handle(){
	...
	var url='jsp/cams/sorg/apply/ungov/individualBuild/somUngovIndivBuildInsert.jsp';
	url+='?method=UPDATE&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	L5.forward(url);
}
//查看流程状态图
function showState(){
...
function handleyiban(){
	...
	var actDefUniqueId=rec.get("ACT_DEF_UNIQUE_ID");
	var assignmentId=rec.get("ID");
	var url='jsp/cams/sorg/apply/ungov/individualBuild/somUngovIndivBuildFlow.jsp';
	url+='?method=yiban&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	L5.forward(url);
}
//查看流程状态图
...
function handleEnd(){
	...
	var assignmentId=rec.get("ID");
	var url="jsp/cams/sorg/apply/ungov/individualBuild/somUngovIndivBuildFlow.jsp";
	url+="?processId="+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId+"&act=accept&method=end";
	L5.forward(url);
}
//查看流程状态图
