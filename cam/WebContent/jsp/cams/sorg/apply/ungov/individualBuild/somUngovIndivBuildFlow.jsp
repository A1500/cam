...
<%@ page import="com.inspur.cams.sorg.apply.ungov.cmd.UngovIndivBuildCmd"%>
...
<%
	...
	if(processId == null||"".equals(processId)){
		processId = new UngovIndivBuildCmd().getProcessId(assignmentId);
	}
	String taskCode = "";
	if(new UngovIndivBuildCmd().getTaskCode(processId) != null){
		taskCode = (new UngovIndivBuildCmd().getTaskCode(processId)).getTaskCode();
	}
...
%>
	...
	var url= L5.webPath;
	var legalRecord="";
	var fileCodeF="M026";//法定代表人fileCode
</script>
</head>
<body>
<%--定义dataset--%>
								...
								<form method="post" onsubmit="return false" dataset="somRuleDataSet" class="L5form">
										...
										<table width="100%">
											...
											<tr>
												...
												<td class="FieldInput" colspan="5"><textarea name="需说明的主要问题" id=mainQuestion field="mainQuestion" cols="65" rows="4" style="width:97%"style="width:97%;background-color:#F5FAFA;border:0;overflow:auto;" readonly></textarea></td>
											</tr>
										</table>
								</form>
									</fieldset>
