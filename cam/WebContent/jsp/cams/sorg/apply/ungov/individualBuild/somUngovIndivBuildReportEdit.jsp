...
<script type="text/javascript" src="somUngovIndivBuildReportEdit.js"></script>
				...
				<next:Html>
					...
					<table width="100%">
						...
						<tr>
							...
							<td class="FieldInput" colspan="5"><label id="sorgKind" field="sorgKind" name='民办非企业单位类型'  dataset="sorgKindSelect"></label></td>
						</tr>
						<tr>
					...
					<table width="100%">
						<tr>
							...
							<td class="FieldInput" style="width:13%"><input type="text" id="appPhone" name='"申请人电话"' field="appPhone" style="width:90%"/></td>
