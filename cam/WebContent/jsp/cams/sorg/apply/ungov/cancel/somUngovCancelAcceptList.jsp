...
<script type="text/javascript">
	var procTypeId = "somUngovCancel";
	var act="受理";
	var procDefUniqueId="402881ec31e65c160131e681fd700048";	
...
function handleyiban(){
	...
	var url="jsp/cams/sorg/apply/ungov/cancel/somUngovCancelDeal.jsp?processId="+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	url+="&method=yiban";
	L5.forward(url);
}
//查看流程状态图
...
function handleEnd(){
	...
	var rec=selected[0];
	var assignmentId=rec.get("ID");
	var url="jsp/cams/sorg/apply/ungov/cancel/somUngovCancelDeal.jsp?assignmentId="+assignmentId;
	url+="&method=end";
	L5.forward(url);
}
//查看流程状态图
...
//受理按钮
function forAccept(){
	var url="jsp/cams/sorg/apply/ungov/cancel/somUngovCancelAccept.jsp?method=INSERT";
	L5.forward(url,"民办非企业单位注销登记录入");	
}
//修改按钮
function forUpdate(){
	...
	var actDefUniqueId=rec.get("ACT_DEF_UNIQUE_ID");
	var assignmentId=rec.get("ID");
	var url="jsp/cams/sorg/apply/ungov/cancel/somUngovCancelAccept.jsp?processId="+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	url+="&method=UPDATE";
	L5.forward(url);
}
</script>
