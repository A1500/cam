...
function forDeal(){
	...
	var url;
	if(act=="watch"){
		url="jsp/cams/sorg/apply/ungov/cancel/somUngovCancelEdit.jsp";
		url+="?act="+act+"&processId="+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	}else if(act == 'supply'){
		url="jsp/cams/sorg/apply/ungov/cancel/somUngovCancelAccept.jsp";
		url+="?act="+act+"&method=UPDATE&processId="+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	}else{
		url="jsp/cams/sorg/apply/ungov/cancel/somUngovCancelDeal.jsp";
		url+="?act="+act+"&processId="+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	}
