...
<script type="text/javascript" src="somUngovCancelAccept.js"></script>
						...
						<fieldset>
							...
							<table width="100%">
								<tr>
									...
									<td class="FieldInput" style="width:17%"><input type="text" name='审查日期' field="borgCheckDate" format="Y-m-d" onclick="WdatePicker()" style="width:90%"/></td>
								...
								<tr>
									...
									<td class="FieldInput" colspan="5"><textarea rows="3" name='意见' field="borgOpinion" style="width:98%;"></textarea>
									</td>
								</tr>
							</table>
							</form>
