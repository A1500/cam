...
function handle()
{
	...
	var url;
	if(act=='auditReport'){
		url='jsp/cams/sorg/apply/ungov/build/somUngovBuildReportDetail.jsp';
		url+='?act='+act+'&method=daiban&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	}else if(act=='accept'){
		url='jsp/cams/sorg/apply/ungov/build/somUngovBuildInsert.jsp';
		url+='?act='+act+'&method=daiban&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	}else if(act=='inform'){
		url='jsp/cams/sorg/apply/ungov/build/somUngovBuildInform.jsp';
		url+='?act='+act+'&method=daiban&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	}else if(act=='supply'){
		url='jsp/cams/sorg/apply/ungov/build/somUngovBuildInsert.jsp';
		url+='?method=UPDATE&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId+'&act='+act;
	}else{
		url='jsp/cams/sorg/apply/ungov/build/somUngovBuildFlow.jsp';
		url+='?act='+act+'&method=daiban&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	}
	L5.forward(url);
}
