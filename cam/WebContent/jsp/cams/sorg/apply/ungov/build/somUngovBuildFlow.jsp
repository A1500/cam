...
<%@ page import="com.inspur.cams.sorg.apply.ungov.cmd.UngovBuildCmd"%>
...
<script type="text/javascript" src="somUngovBuildUpdate.js"></script>
...
<%
	...
	if(processId == null||"".equals(processId)){
		processId = new UngovBuildCmd().getProcessId(assignmentId);
	}
	String taskCode = "";
	if(new UngovBuildCmd().getTaskCode(processId) != null){
		taskCode = (new UngovBuildCmd().getTaskCode(processId)).getTaskCode();
	}
...
%>
	...
	var url= L5.webPath;
	var legalRecord="";
	var fileCodeF="M004";//法定代表人fileCode
</script>
</head>
<body>
<%--定义dataset--%>
										...
										<form method="post" dataset="somOrganDataSet" onsubmit="return false" class="L5form">
											<table width="100%">
												<tr>
													...
													<td class="FieldInput" colspan="3"><label  field="cnName" style="width:96%"/><span style="color:red"></span></td>
									...
									<next:Panel title="举办人（自然人）">
										<next:EditGridPanel id="heldPeopleGrid" dataset="somHeldPeopleDataSet" width="100%" stripeRows="true" height="100%">
											<next:Columns>
												...
												<next:Column header="人事关系所在单位" field="personUnit" width="20%" editable="false"><next:TextField/></next:Column>
			...
			<form title="" id="addForm" method="post" dataset="somDutyInsertDataSet" onsubmit="return false" class="L5form">
				<table width="100%">
					<tr>
						...
						<td class="FieldInput"style="width:25%">
						<label  field="birthday"  ></label></td>

					</tr>
					<tr>
						<td class="FieldLabel" style="width:25%">性别：</td>
						<td class="FieldInput"style="width:25%"><label  field="sex"  dataset="sexSelect"></label>
						</td>
						<td class="FieldLabel">电话：</td>
						<td class="FieldInput">
						<label  field="phone"></label></td>
					</tr>
					<tr>
						<td class="FieldLabel">政治面貌：</td>
						<td class="FieldInput"><label  field="politics" dataset="politicsSelect"></label>
						</td>
						<td class="FieldLabel">职务及职称：</td>
						<td class="FieldInput" ><label  field="sorgDuties"></label>
						</td>
					</tr>
					<tr>
						<td class="FieldLabel">人事关系所在单位：</td>
						<td class="FieldInput" colspan="3"><label  field="personUnit"></label></td>
					</tr>
				</table>
			</form>
		</next:Html>
...
<next:TopBar>
	...
	<next:Html>
		<form method="post" onsubmit="return false" class="L5form">
			<table width="100%">
				<tr>
					<td class="FieldLabel" style="width:21%">登记证号：</td>
					<td class="FieldInput" colspan="5"><input type="text" id="sorgCode" name='登记证号' field="sorgCode" onblur="sorgCodeUK();" style="width:100%"/></td>
				</tr>
				<tr>
					<td class="FieldLabel" style="width:21%">组织机构代码：</td>
					<td class="FieldInput" style="width:21%"><input type="text" id="organCode" name='组织机构代码' field="organCode" maxlength="10" style="width:100%"/></td>
					<td class="FieldLabel" style="width:23%">登记日期：</td>
					<td class="FieldInput" style="width:21%"><input type="text" id="regDate" name='登记日期' field="regDate" format="Y-m-d" onclick="WdatePicker()" style="width:100%"/></td>
				</tr>
				<tr>
					<td class="FieldLabel" style="width:21%"><label>选择证书类型：</label></td>
					<td class="FieldInput" style="width:21%"><select id="certType" ><option dataset="certTypeSelect" ></option></select></td>
					<td class="FieldLabel" style="width:21%"><label>发证日期：</label></td>
					<td class="FieldInput" style="width:21%"><input type="text" id="PrintDate"  style="width:100%" format="Y-m-d" onclick="WdatePicker();" ></td>
				</tr>
				<tr>
					<td class="FieldLabel" style="width:21%"><label>有效期限起：</label></td>
					<td class="FieldInput" style="width:21%"><input type="text" id="beginDate"  style="width:100%" format="Y-m-d" onclick="WdatePicker();" ></td>
					<td class="FieldLabel" style="width:21%"><label>有效期限止：</label></td>
					<td class="FieldInput" style="width:21%"><input type="text" id="endDate"  style="width:100%" format="Y-m-d" onclick="WdatePicker();" ></td>
				</tr>
				<tr>
