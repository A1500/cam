...
<script type="text/javascript" src="somUngovBuildInsert.js"></script>
...
<model:datasets>
	...
	<!-- 届次信息 -->
	<model:dataset id="somSessionDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomSessionQueryCmd" global="true" pageSize="100">
