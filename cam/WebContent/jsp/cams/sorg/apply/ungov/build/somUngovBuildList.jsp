...
var procTypeId = 'somUngovBuild';//流程类型ID	
var act="受理";
var procDefUniqueId="8a898b9d36385b4201363904440b0031";
...
function forNewBuild(){
	var url="jsp/cams/sorg/apply/ungov/build/somUngovBuildInsert.jsp?method=INSERT";
...
function handle(){
	...
	var url='jsp/cams/sorg/apply/ungov/build/somUngovBuildInsert.jsp';
...
function handleyiban(){
	...
	var actDefUniqueId=rec.get("ACT_DEF_UNIQUE_ID");
	var assignmentId=rec.get("ID");
	var url='jsp/cams/sorg/apply/ungov/build/somUngovBuildFlow.jsp';
