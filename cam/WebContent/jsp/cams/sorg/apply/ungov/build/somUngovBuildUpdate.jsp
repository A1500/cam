...
<model:datasets>
	...
	<%--举办人情况--%>
	<model:dataset id="somHeldPeopleDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomHeldPeopleQueryCmd"  pageSize="100">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomHeldPeople"></model:record>
	</model:dataset>
	<%--举办单位情况--%>
	<model:dataset id="somHeldOrganDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomHeldOrganQueryCmd" pageSize="100">
						...
						<next:Panel  title="基本信息"  width="100%" height="100%" autoScroll="true">
							...
							<table width="100%">
								<tr>
									...
									<td class="FieldInput" style="width:12%"> <input type="text"style="width:90%"  field="name" name="姓名"></td>
									...
									<next:Panel title="举办人（自然人）">
										<next:EditGridPanel id="heldPeopleGrid" dataset="somHeldPeopleDataSet" width="100%" stripeRows="true" height="100%">
											...
											<next:Columns>
												...
												<next:Column header="人事关系所在单位" field="personUnit" width="15%" editable="true"><next:TextField/></next:Column>
