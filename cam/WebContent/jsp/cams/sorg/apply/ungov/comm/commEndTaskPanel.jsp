...
function handleEnd(){
	...
	var url="jsp/cams/sorg/apply/ungov/nameApproval/somUngovNameApprovalDetail.jsp?method=end&processId="+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	L5.forward(url);
}
//查看流程状态图
