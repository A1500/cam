...
<script language="javascript">
	var procTypeId="somUngovNameApproval";
	var act="受理";
	var procDefUniqueId="8a898b9d36380c7a0136381938d10038";		
...
function handleyiban(){
	...
	var url='jsp/cams/sorg/apply/ungov/nameApproval/somUngovNameApprovalDetail.jsp?processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId+"&method=yiban";
	L5.forward(url);
}
//查看已办流程图
...
function handleEnd(){
	...
	var actDefUniqueId=rec.get("ACT_DEF_UNIQUE_ID");
	var assignmentId=rec.get("ID");
	var url="jsp/cams/sorg/apply/ungov/nameApproval/somUngovNameApprovalDetail.jsp?method=yiban&processId="+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	L5.forward(url);
}
//查看流程状态图
...
// 受理页面
function forAccept(){
	var url='jsp/cams/sorg/apply/ungov/nameApproval/somUngovNameApprovalEdit.jsp?method=INSERT';
	L5.forward(url);
}
function enter(){
...
function forUpdate(){
	...
	var actDefUniqueId=rec.get("ACT_DEF_UNIQUE_ID");
	var assignmentId=rec.get("ID");
	var url='jsp/cams/sorg/apply/ungov/nameApproval/somUngovNameApprovalEdit.jsp?method=UPDATE&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	L5.forward(url);
}
</script>
</html>