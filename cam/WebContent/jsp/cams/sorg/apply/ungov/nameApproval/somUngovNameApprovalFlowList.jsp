...
function forDeal(){
	...
	var url;
	if(act == 'supply'){
		var url='jsp/cams/sorg/apply/ungov/nameApproval/somUngovNameApprovalEdit.jsp?method=UPDATE';
		url+='&act='+act+'&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId+"&method=UPDATE";
	}else{
		url='jsp/cams/sorg/apply/ungov/nameApproval/somUngovNameApprovalDetail.jsp';
		url+='?act='+act+'&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId+"&method=daiban";
	}
	L5.forward(url);
}
</script>
