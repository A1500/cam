...
<script type="text/javascript" src="somUngovPartBuildInsert.js"></script>
...
%>
	...
	var sorgId="";
	var updateRecord="";
	var fileCodeF = "M015";//民非负责人
	var legalDutyId = '<%=IdHelp.getUUID32()%>';//民非负责人
...
<model:datasets>
	...
	<model:dataset id="somOrganDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomOrganQueryCmd" global="true" method="queryOrgan">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomOrgan">
			...
			<model:field name="housingArea" type="string" rule="integer" />
			...
			<next:Panel title="负责人登记表">
				<next:TabPanel  width="100%" height="100%">
					<next:Tabs>
						...
						<next:EditGridPanel id="somResumeGrid" dataset="somResumeDataSet" width="765" stripeRows="true" height="250" title="本人简历">
							<next:TopBar>
								<next:ToolBarItem symbol="->"></next:ToolBarItem>
...
<next:Window id="peopleWin" title="全体合伙人情况" resizable="false" width="800" height="200" closeAction="hide" autoScroll="true">
	<next:Panel id="panel_win">
		<next:Html>
			<form title="全体合伙人信息" id="addForm" method="post" dataset="somDutyInsertDataSet" onsubmit="return false" class="L5form">
				<table width="100%">
					<tr>
