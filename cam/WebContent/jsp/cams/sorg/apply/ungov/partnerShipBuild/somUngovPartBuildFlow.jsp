...
<%@ page import="com.inspur.cams.sorg.apply.ungov.cmd.UngovPartBuildCmd"%>
...
<script type="text/javascript" src="somUngovPartBuildUpdate.js"></script>
...
<%
	...
	if(processId == null||"".equals(processId)){
		processId = new UngovPartBuildCmd().getProcessId(assignmentId);
	}
	String taskCode = "";
	if(new UngovPartBuildCmd().getTaskCode(processId) != null){
		taskCode = (new UngovPartBuildCmd().getTaskCode(processId)).getTaskCode();
	}
...
<!-- 负责人录入窗口 -->
<next:Window id="peopleWin" title="全体合伙人情况" resizable="false" width="800" height="200" closeAction="hide" autoScroll="true">
