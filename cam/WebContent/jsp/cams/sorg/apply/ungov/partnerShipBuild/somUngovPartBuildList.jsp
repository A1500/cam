...
var procTypeId = 'somUngovPartBuild';//流程类型ID	
var act="受理";
var procDefUniqueId="8a898b9d363934c4013639411dc90033";
...
function forNewBuild(){
	var url="jsp/cams/sorg/apply/ungov/partnerShipBuild/somUngovPartBuildInsert.jsp?method=INSERT";
...
function handle(){
	...
	var url='jsp/cams/sorg/apply/ungov/partnerShipBuild/somUngovPartBuildInsert.jsp';
...
function handleyiban(){
	...
	var actDefUniqueId=rec.get("ACT_DEF_UNIQUE_ID");
	var assignmentId=rec.get("ID");
	var url='jsp/cams/sorg/apply/ungov/partnerShipBuild/somUngovPartBuildFlow.jsp';
