...
var act="<%=act%>";
var procTypeId ="somUngovPartBuild";
//查询条件面板打开合并函数
...
function handle()
{
	...
	var url;
	if(act=='auditReport'){
		url='jsp/cams/sorg/apply/ungov/partnerShipBuild/somUngovPartBuildReportDetail.jsp';
		url+='?act='+act+'&method=daiban&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	}else if(act=='accept'){
		url='jsp/cams/sorg/apply/ungov/partnerShipBuild/somUngovPartBuildInsert.jsp';
		url+='?act='+act+'&method=daiban&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	}else if(act=='inform'){
		url='jsp/cams/sorg/apply/ungov/partnerShipBuild/somUngovPartBuildInform.jsp';
		url+='?act='+act+'&method=daiban&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	}else if(act == 'supply' ){
		url='jsp/cams/sorg/apply/ungov/partnerShipBuild/somUngovPartBuildInsert.jsp';
		url+='?method=UPDATE&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId+'&act='+act;
	}else{
		url='jsp/cams/sorg/apply/ungov/partnerShipBuild/somUngovPartBuildFlow.jsp';
		url+='?act='+act+'&method=daiban&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	}
	L5.forward(url);
}
