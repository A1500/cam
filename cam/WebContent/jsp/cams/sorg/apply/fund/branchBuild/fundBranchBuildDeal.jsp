...
<next:Window id="forPrint" closeAction="hide" title="打印证书" width="600"  autoScroll="true" modal="true">
<next:TopBar>
		...
		<form method="post" onsubmit="return false" class="L5form">
			<table width="100%">
				<tr>
					...
					<td class="FieldInput"style="width:15% colspan="3"><input id="branchSorgCode" name="分支（代表）机构登记证号"  style="width:100%" onblur='sorgCodeUK()'/></td>
