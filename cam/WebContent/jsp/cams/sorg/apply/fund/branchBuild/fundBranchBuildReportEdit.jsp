...
<%
	...
	if(method.equals("INSERT")){
		...
		sorgId = SomIdHelp.getFundSorgId();
	}else{
		taskCode = "";
		sorgId = "";
	}
...
<script type="text/javascript" src="fundBranchBuildReportEdit.js"></script>
					...
					<form method="post" dataset="somOrganDataSet" onsubmit="return false"class="L5form">
						<table width="100%">
							<tr>
								...
								<td class="FieldInput" colspan="5"><input type="text"  id="mainSorgCode" name='"主体登记证号"' onkeyup="value=value.replace(/[^\-\\w\.\/]/ig,'').toUpperCase()" field="mainSorgCode" onblur="validateSorgCode()" style="width:98%"/><label style="color:red">*</label></td>
							</tr>
							<tr>
