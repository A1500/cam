...
function handleyiban(){
	...
	var url;
	if(act=='auditReport'){
		url='jsp/cams/sorg/apply/fund/branchBuild/fundBranchBuildReportDetail.jsp';
	}else{
		url='jsp/cams/sorg/apply/fund/branchBuild/fundBranchBuildDeal.jsp';
	}
...
function forDeal(){
	...
	if(act=='auditReport'){
		url='jsp/cams/sorg/apply/fund/branchBuild/fundBranchBuildReportDetail.jsp';
		url+='?method=daiban&act='+act+'&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	}else if(act=='accept'){
		url='jsp/cams/sorg/apply/fund/branchBuild/fundBranchBuildEdit.jsp';
		url+='?method=daiban&act='+act+'&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	}else if(act == 'supply'){
		url='jsp/cams/sorg/apply/fund/branchBuild/fundBranchBuildReportEdit.jsp?method=UPDATE&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId+'&act='+act;
	}else{
		url='jsp/cams/sorg/apply/fund/branchBuild/fundBranchBuildDeal.jsp';
		url+='?method=daiban&act='+act+'&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	}
