...
<script language="javascript">
	var procTypeId="somFundBranchBuild";
	var act="受理";
	var procDefUniqueId="8a898b9d363e970301363ea7cdbf002d";	
...
function handleyiban(){
	...
	var url='jsp/cams/sorg/apply/fund/branchBuild/fundBranchBuildDeal.jsp?method=yiban'+'&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId+"&act=nameCheck"+"&method=yiban";
	L5.forward(url);
}
//查看已办流程图
...
function handleEnd(){
	...
	var actDefUniqueId=rec.get("ACT_DEF_UNIQUE_ID");
	var assignmentId=rec.get("ID");
	var url="jsp/cams/sorg/apply/fund/branchBuild/fundBranchBuildDeal.jsp?processId="+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId+'&method=end';
	L5.forward(url);
}
//查看流程状态图
...
// 受理页面
function forAccept(){
	var url='jsp/cams/sorg/apply/fund/branchBuild/fundBranchBuildReportEdit.jsp?method=INSERT';
	L5.forward(url);
}
// 修改页面
function forUpdate(){
	...
	var actDefUniqueId=rec.get("ACT_DEF_UNIQUE_ID");
	var assignmentId=rec.get("ID");
	var url='jsp/cams/sorg/apply/fund/branchBuild/fundBranchBuildReportEdit.jsp?method=UPDATE&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	L5.forward(url);
}
</script>
</html>