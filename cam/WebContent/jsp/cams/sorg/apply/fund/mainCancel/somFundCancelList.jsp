...
function forDeal(){
	...
	var url;
	if(act=="watch"){
		url="jsp/cams/sorg/apply/fund/mainCancel/somFundCancelEdit.jsp";
		url+="?act="+act+"&processId="+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	}else if(act == 'supply'){
		url="jsp/cams/sorg/apply/fund/mainCancel/somFundCancelAccept.jsp?processId="+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
		url+="&method=UPDATE&act="+act;
	}else{
		url="jsp/cams/sorg/apply/fund/mainCancel/somFundCancelDeal.jsp";
		url+="?act="+act+"&processId="+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	}
