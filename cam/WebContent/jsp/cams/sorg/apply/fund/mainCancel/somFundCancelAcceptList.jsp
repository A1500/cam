...
<script type="text/javascript">
	var procTypeId = "somFundCancel";
	var act="受理";
	var procDefUniqueId="402881ec320a604801320a6804f60037";	
...
function handleyiban(){
	...
	var url="jsp/cams/sorg/apply/fund/mainCancel/somFundCancelDeal.jsp?processId="+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	url+="&method=yiban"
	L5.forward(url);
}
//查看流程状态图
...
function handleEnd(){
	...
	var actDefUniqueId=rec.get("ACT_DEF_UNIQUE_ID");
	var assignmentId=rec.get("ID");
	var url="jsp/cams/sorg/apply/fund/mainCancel/somFundCancelDeal.jsp?actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	url+="&method=end";
	L5.forward(url);
}
//查看流程状态图
...
//受理按钮
function forAccept(){
	var url="jsp/cams/sorg/apply/fund/mainCancel/somFundCancelAccept.jsp?method=INSERT";
	L5.forward(url,"基金会注销登记录入");	
}
//修改按钮
function forUpdate(){
	...
	var actDefUniqueId=rec.get("ACT_DEF_UNIQUE_ID");
	var assignmentId=rec.get("ID");
	var url="jsp/cams/sorg/apply/fund/mainCancel/somFundCancelAccept.jsp?processId="+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	url+="&method=UPDATE";
	L5.forward(url);
}
</script>
