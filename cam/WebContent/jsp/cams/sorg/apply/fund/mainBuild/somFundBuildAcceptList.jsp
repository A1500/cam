...
<html>
<head>
<title>申请名称核准任务查询</title>
<next:ScriptManager></next:ScriptManager>
<script language="javascript">
	var procTypeId="somFundBuild";
	var act="受理";
	var procDefUniqueId="8a898b9d363e008b01363e008bbf0000";	
...
function handleyiban(){
	...
	var url='jsp/cams/sorg/apply/fund/mainBuild/somFundBuildDeal.jsp?method=yiban&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	L5.forward(url);
}
//查看已办流程图
...
function handleEnd(){
	...
	var actDefUniqueId=rec.get("ACT_DEF_UNIQUE_ID");
	var assignmentId=rec.get("ID");
	var url="jsp/cams/sorg/apply/fund/mainBuild/somFundBuildRegisterDetil.jsp?method=end&processId="+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	L5.forward(url);
}
//查看流程状态图
...
// 受理页面
function forAccept(){
	var url='jsp/cams/sorg/apply/fund/mainBuild/somFundBuildInsert.jsp?method=INSERT';
	L5.forward(url);
}
// 修改页面
function forUpdate(){
	...
	var actDefUniqueId=rec.get("ACT_DEF_UNIQUE_ID");
	var assignmentId=rec.get("ID");
	var url='jsp/cams/sorg/apply/fund/mainBuild/somFundBuildInsert.jsp?method=UPDATE&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	L5.forward(url);
}
</script>
</head>
