...
function handleyiban(){
	...
	var url;
	if(act=='auditReport'){
		url='jsp/cams/sorg/apply/fund/mainBuild/somFundBuildReportDetail.jsp';
	}else if(act=='print' || act=='issue'){
		url='jsp/cams/sorg/apply/fund/mainBuild/somFundBuildRegisterDetil.jsp';
	}else if(act=='inform'){
		url='jsp/cams/sorg/apply/fund/mainBuild/somFundBuildInform.jsp';
	}else{
		url='jsp/cams/sorg/apply/fund/mainBuild/somFundBuildDeal.jsp';
	}
...
function forDeal(){
	...
	if(act=='auditReport'){
		...
		url='jsp/cams/sorg/apply/fund/mainBuild/somFundBuildInsert.jsp';
	}else if(act=='print'){
		url='jsp/cams/sorg/apply/fund/mainBuild/somFundBuildRegister.jsp';
	}else if(act=='issue'){
		url='jsp/cams/sorg/apply/fund/mainBuild/somFundBuildRegisterDetil.jsp';
	}else if(act=='inform'){
		url='jsp/cams/sorg/apply/fund/mainBuild/somFundBuildInform.jsp';
