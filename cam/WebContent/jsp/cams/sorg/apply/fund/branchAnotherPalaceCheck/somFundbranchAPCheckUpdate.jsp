...
<%--定义dataset--%>
<model:datasets>
	<model:dataset id="somMainOrganDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomOrganQueryCmd" method="queryMain" global="true">
					...
					<next:Html>
						...
						<table width="100%">
							<tr>
								...
								<td class="FieldInput" colspan="5"><label id="mainSorgCode" field="mainSorgCode" style="width:98%"/></td>
							</tr>
								<tr>
