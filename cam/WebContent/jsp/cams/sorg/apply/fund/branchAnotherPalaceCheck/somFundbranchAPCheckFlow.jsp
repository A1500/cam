...
<%@ page import="com.inspur.cams.sorg.apply.fund.cmd.FundBranchAPCheckCmd"%>
<%@ taglib uri="/tags/next-web" prefix="next" %>
<%@ taglib uri="/tags/next-model" prefix="model" %>
<html>
<head>
<title>基金会异地设立分支/代表机构的审查</title>
...
<%
	...
	if(processId == null){
		processId = new FundBranchAPCheckCmd().getProcessId(assignmentId);
	}
%>
			...
			<next:Panel title="设立申请书" width="100%" >
				<next:Panel width="100%" height="100%" autoScroll="true">
						...
						<legend>设立申请书</legend>
							...
							<tr>
								<td class="FieldLabel"><label>拟设立的分支/代表机构业务主管单位：</label></td>
								<td class="FieldInput" colspan="3">
									<label field="borgName" dataset="businessOrganSelect" style="width:98%"/>
								</td>
								<td class="FieldLabel" style="width:17%">拟设立的分支/代表机构负责人：</td>
								<td class="FieldInput" style="width:17%"><label field="branchCharger" style="width:98%"/></td>
							</tr>
							<tr>
