...
<html>
<head>
<title>基金会异地设立分支/代表机构的审查列表</title>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript" src='<%=SkinUtils.getJS(request,"cams.js") %>'></script>
<script type="text/javascript" src='<%=SkinUtils.getJS(request,"camsCheck.js")%>'></script>
<script type="text/javascript">
	var procTypeId = 'somFundBranchAnotherPlaceCheck';//流程类型ID
	var act="受理";
	var procDefUniqueId="4028b8813390943301339126e163008f";	
...
function forNewBuild(){
	var url="jsp/cams/sorg/apply/fund/branchAnotherPalaceCheck/somFundbranchAPCheckInsert.jsp";
	L5.forward(url,"基金会异地设立分支/代表机构的审查录入页面");
