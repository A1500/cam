...
<script language="javascript">
	var procTypeId="somFundElectionDelay";
	var act="受理";
...
function handleyiban(){
	...
	var url='jsp/cams/sorg/apply/fund/electionDelay/somFundElectionDelayDetail.jsp?processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId+"&method=yiban&taskCode="+rec.get("TASK_CODE");
	L5.forward(url);
}
//查看已办流程图
...
function handleEnd(){
	...
	var actDefUniqueId=rec.get("ACT_DEF_UNIQUE_ID");
	var assignmentId=rec.get("ID");
	var url="jsp/cams/sorg/apply/fund/electionDelay/somFundElectionDelayDetail.jsp?method=end&taskCode="+rec.get('TASK_CODE')+"&processId="+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	L5.forward(url);
}
//查看流程状态图
...
// 受理页面
function forAccept(){
	var url='jsp/cams/sorg/apply/fund/electionDelay/somFundElectionDelayEdit.jsp?method=INSERT';
	L5.forward(url);
}
// 修改页面
function forUpdate(){
	...
	var actDefUniqueId=rec.get("ACT_DEF_UNIQUE_ID");
	var assignmentId=rec.get("ID");
	var url='jsp/cams/sorg/apply/fund/electionDelay/somFundElectionDelayEdit.jsp?method=UPDATE&taskCode='+rec.get("TASK_CODE")+'&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	L5.forward(url);
}
</script>
</html>