...
<script type="text/javascript" src="somFundElectionDelayEdit.js"></script>
						...
						<form id="ElectionForm" method="post" dataset="somElectionDataSet" onsubmit="return false" class="L5form">
							...
							<table width="100%">
								...
								<tr>
									...
									<input type="text" id="delayDate" name='延期换届时间' field="delayDate" onfocus="WdatePicker()" style="width:90%"/><font color="red">*</font></td>
								</tr>
								<tr>
