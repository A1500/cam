...
<html>
	...
	<script type="text/javascript">
		...
		var act="受理";			
		var procDefUniqueId="402881e731dfcd840131dfd26e14000c";
...
function forNewChange(){
	var url="jsp/cams/sorg/apply/fund/branchChange/somFundBranchChange.jsp";
	L5.forward(url,"基金会/代表机构变更登记页面");
