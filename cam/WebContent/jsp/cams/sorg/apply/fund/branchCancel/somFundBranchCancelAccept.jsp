...
<script type="text/javascript" src="somFundBranchCancelAccept.js"></script>
							...
							<form id="cbForm" method="post" dataset="somOrganDataSet" onsubmit="return false" class="L5form">
								<table width="100%">
									<tr>
										...
										<td class="FieldInput" width="30%"><input id="sorgCode" field="sorgCode" onkeyup="value=value.replace(/[^\-\\w\.\/]/ig,'').toUpperCase()" name='"分支/代表机构登记证号"' onblur="loadSorg()" style="width:50%"/><span style="color:red">*</span></td>
									...
									<tr>
										...
										<td class="FieldInput"><label id='name'field="name" name='"基金会名称"'/></td>
