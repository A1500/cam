...
function forDeal(){
	...
	var url;
	if(act=="watch"){
		url="jsp/cams/sorg/apply/fund/branchCancel/somFundBranchCancelEdit.jsp";
		url+="?act="+act+"&processId="+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	}else if(act=="supply"){
		url="jsp/cams/sorg/apply/fund/branchCancel/somFundBranchCancelAccept.jsp?processId="+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
		url+="&method=UPDATE&act="+act;
	}else{
		url="jsp/cams/sorg/apply/fund/branchCancel/somFundBranchCancelDeal.jsp";
		url+="?act="+act+"&processId="+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	}
	L5.forward(url);
}
