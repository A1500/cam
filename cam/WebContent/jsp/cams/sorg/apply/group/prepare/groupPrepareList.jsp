...
<script language="javascript">
	...
	var act="受理";
	var procDefUniqueId="8a898b9d3629c479013629c4796f0000";	
...
function handleyiban(){
	...
	var url='jsp/cams/sorg/apply/group/prepare/groupPrepareDeal.jsp?processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId+"&method=yiban";
	L5.forward(url);
}
//查看已办流程图
...
// 受理页面
function forAccept(){
	var url='jsp/cams/sorg/apply/group/prepare/groupPrepareEdit.jsp?method=INSERT';
	L5.forward(url);
}
// 修改页面
function forUpdate(){
	...
	url+='?act=accept&method=UPDATE'+'&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	L5.forward(url);
}
</script>
</html>