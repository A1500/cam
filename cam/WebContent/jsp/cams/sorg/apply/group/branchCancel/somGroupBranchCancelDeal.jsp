		...
		<next:TabPanel id="tab" width="100%" height="100%">
			<next:Tabs>
				<next:Panel id="panelSomOrgan" title="社会团体分支（代表）机构注销登记表" width="100%" height="100%" autoScroll="true">
					<next:Html>
					<fieldset>
					<legend>社会团体分支（代表）机构注销登记信息</legend>
						...
						<table width="100%">
							<tr>
								...
								<td class="FieldInput" width="30%"><label id="branchCharger" field="branchCharger" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="FieldInput"><label field="name" name='"社团名称"'/></td>
							...
							<tr>
								...
								<td class="FieldInput" >
									<select id="cancelReason" name='"注销原因"' field="cancelReason" disabled="disabled">
										<option dataset="cancelReasonSelect"></option>
									</select>
								</td>
								<td class="FieldLabel"><label>社会团体类别：</label></td>
								<td class="FieldInput"><label id="sorgKind" field="sorgKind" dataset="sorgKindSelect" /></td>
							</tr>
							<tr id="cancelReasonDescTr" style="display:none">
								<td class="FieldLabel"><label>注销原因说明：</label></td>
								<td class="FieldInput" colspan="3"><textarea rows="3" id="cancelReasonDesc" name='"注销原因说明"' field="cancelReasonDesc" readonly style="width:93%"style="width:93%;background-color:#F5FAFA;border:0;overflow:auto;"></textarea></td>
							</tr>
							<tr>
								<td class="FieldLabel"><label>社团履行内部程序：</label></td>
								<td class="FieldInput" colspan="3"><textarea rows="3" id="liqResult" name='"社团履行内部程序"' field="liqResult" readonly style="width:93%"style="width:93%;background-color:#F5FAFA;border:0;overflow:auto;"></textarea></td>
							</tr>
						</table>
						</form>
						</fieldset>
