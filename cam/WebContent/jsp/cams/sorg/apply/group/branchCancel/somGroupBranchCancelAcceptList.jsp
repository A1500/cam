...
<html>
<head>
<title>社会团体分支/代表机构列表</title>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript">
	var procTypeId = "somGroupBranchCancel";
	var act="受理";
	var procDefUniqueId="402881ec320a604801320a662f990033";	
...
function handleyiban(){
	...
	var url="jsp/cams/sorg/apply/group/branchCancel/somGroupBranchCancelDeal.jsp?processId="+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	url+="&method=yiban";
	L5.forward(url);
}
//查看流程状态图
...
function handleEnd(){
	...
	var rec=selected[0];
	var assignmentId=rec.get("ID");
	var url="jsp/cams/sorg/apply/group/branchCancel/somGroupBranchCancelDeal.jsp?assignmentId="+assignmentId;
	url+="&method=end";
	L5.forward(url);
}
//查看流程状态图
...
//受理按钮
function forAccept(){
	var url="jsp/cams/sorg/apply/group/branchCancel/somGroupBranchCancelAccept.jsp?method=INSERT";
	L5.forward(url,"社会团体分支（代表）机构注销登记录入");	
}
//修改按钮
function forUpdate(){
	...
	var actDefUniqueId=rec.get("ACT_DEF_UNIQUE_ID");
	var assignmentId=rec.get("ID");
	var url="jsp/cams/sorg/apply/group/branchCancel/somGroupBranchCancelAccept.jsp?processId="+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	url+="&method=UPDATE";
	L5.forward(url);
}
</script>
