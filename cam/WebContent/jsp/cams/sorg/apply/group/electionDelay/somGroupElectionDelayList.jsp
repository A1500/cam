...
function handleyiban(){
	...
	var url='jsp/cams/sorg/apply/group/electionDelay/somGroupElectionDelayDetail.jsp?taskCode='+rec.get("TASK_CODE")+"&method=yiban&act="+act+'&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	L5.forward(url);
}
//查看已办流程图
...
function forDeal(){
	...
	var url;
	if(act == 'supply'){
		var url='jsp/cams/sorg/apply/group/electionDelay/somGroupElectionDelayEdit.jsp?method=UPDATE&act='+act+'&taskCode='+rec.get("TASK_CODE")+'&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	}else{
		var url='jsp/cams/sorg/apply/group/electionDelay/somGroupElectionDelayDetail.jsp?taskCode='+rec.get("TASK_CODE")+"&method=daiban&act="+act+'&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	}
	L5.forward(url);
}
</script>
