...
<head>
	<next:ScriptManager/>
	<script type="text/javascript" src="somGroupChange.js"></script>
...
<next:Window id="legalPeopleWin" closeAction="hide" title="负责人列表" width="800" height="350" autoScroll="true" modal="true">
	...
	<next:Columns>
		...
		<next:Column header="是否在任" field="ifServe"width="80" editable="false" hidden="true"><next:TextField/><next:ComboBox dataset="ifServeSelect"/></next:Column>
		<next:Column header="是否法定代表人" field="ifLegal" width="120" editable="false"><next:TextField/><next:ComboBox dataset="comm_yesorno"/></next:Column>
...
<table width="100%">
			<tr>
				...
				<td class="FieldInput"style="width:25%"><select  id="houseSourceBefore" readonly="readonly"><option  dataset="resideSourceSelect"></option></select></td>
