...
<script type="text/javascript" src="groupManageReportPeople.js"></script>
...
<script type="text/javascript">
	...
	var sessionId='<%=request.getParameter("meetingId")%>';
	var sessionName='<%=request.getParameter("sessionName")%>';
	sessionName=decodeURIComponent(sessionName);
	var sorgCode='<%=request.getParameter("sorgCode")%>';
	var electionTaskCode='<%=request.getParameter("electionTaskCode")%>';
	var applyType='017';
...
<next:Panel width="100%" autoScroll="true">
	<next:TopBar>
		...
		<next:ToolBarItem iconCls="return" text="关闭" handler="closeW"></next:ToolBarItem>
	</next:TopBar>
						...
						<form id="form2" dataset="somSessionDataSet" onsubmit="return false" class="L5form">
							...
							<table width="100%">
								...
								<tr>
									...
									<td class="FieldInput" colspan="3"><input type="text" id="sessionName" field="sessionName" name='"届次名称"' style="width:90%" readonly/><span style="color:red">*</span></td>
