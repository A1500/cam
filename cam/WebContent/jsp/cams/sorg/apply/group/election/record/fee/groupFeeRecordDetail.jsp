					...
					<legend>社会团体会费标准备案</legend>
						...
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput" colspan="5"><textarea name="会费标准" id="fee" field="fee" cols="75" rows="12" readonly="readonly" style="width:95%"></textarea>
							</tr>
							<tr>
								<td class="FieldLabel">备案承办人：</td>
								<td class="FieldInput"><label field="regPeople"/><font color="red">*</font></td>
								<td class="FieldLabel">备案日期：</td>
								<td class="FieldInput" colspan="3"><label field="regDate"/></td>
							</tr>
						</table>
					</fieldset>
				</form>
