...
<script type="text/javascript" src="groupFeeRecordEdit.js"></script>
...
<body>
<model:datasets>
	<model:dataset id="somFeeDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomFeeQueryCmd" method="queryFee">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomFee"/>
	</model:dataset>
	<model:dataset id="somMeetingDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomMeetingQueryCmd" global="true">
		...
		<form id="feeForm" method="post" dataset="somFeeDataSet" onsubmit="return false" class="L5form">
			...
			<table width="100%">
				...
				<tr>
					...
					<td class="FieldInput"><input type="text" name="meetingName" id="meetingName" field="meetingName" maxlength="100" style="width:90%" onclick="showMeeting()" readonly/></td>
