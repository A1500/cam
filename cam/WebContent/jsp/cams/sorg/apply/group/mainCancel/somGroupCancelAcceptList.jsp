...
<script type="text/javascript">
	var procTypeId = "somGroupCancel";
	var act="受理";
	var procDefUniqueId="402881ec31e5e98e0131e5eb94dc0014";	
	//设置任务状态
...
function handleyiban(){
	...
	var url="jsp/cams/sorg/apply/group/mainCancel/somGroupCancelDeal.jsp?processId="+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId+"&method=yiban";
	url+="&method=yiban";
	L5.forward(url);
}
//查看流程状态图
...
function handleEnd(){
	...
	var rec=selected[0];
	var assignmentId=rec.get("ID");
	var url="jsp/cams/sorg/apply/group/mainCancel/somGroupCancelDeal.jsp?assignmentId="+assignmentId+"&method=end";
	url+="&method=end";
	L5.forward(url);
}
//查看流程状态图
...
//受理按钮
function forAccept(){
	var url="jsp/cams/sorg/apply/group/mainCancel/somGroupCancelAccept.jsp?method=INSERT";
	L5.forward(url,"社会团体注销登记录入");	
}
//修改按钮
function forUpdate(){
	...
	var actDefUniqueId=rec.get("ACT_DEF_UNIQUE_ID");
	var assignmentId=rec.get("ID");
	var url="jsp/cams/sorg/apply/group/mainCancel/somGroupCancelAccept.jsp?processId="+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	url+="&method=UPDATE";
	L5.forward(url);
}
</script>
