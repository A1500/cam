...
var nameValue="<%=name%>";
var procTypeId ="somGroupBranchAnotherPlaceCheck";
//查询条件面板打开合并函数
...
function showState()
{
   ...
   var url='jsp/workflow/monitor/flowview.jsp?backUrl=jsp/cams/sorg/apply/group/branchAnotherPalaceCheck/somGroupbranchAPCheckDaiBanList.jsp?name='+nameValue+'&assignmentId='+assignmentId;
   var text = '流程状态';
   L5.forward(url,text);
}
