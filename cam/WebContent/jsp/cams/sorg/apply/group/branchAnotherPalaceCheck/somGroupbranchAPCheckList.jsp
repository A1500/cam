...
<html>
<head>
<title>社会团体异地设立分支/代表机构的审查列表</title>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript" src='<%=SkinUtils.getJS(request,"cams.js") %>'></script>
<script type="text/javascript" src='<%=SkinUtils.getJS(request,"camsCheck.js")%>'></script>
<script type="text/javascript">

	var procTypeId = 'somGroupBranchAnotherPlaceCheck';//流程类型ID
	var act="受理";
...
function forNewBuild(){
	var url="jsp/cams/sorg/apply/group/branchAnotherPalaceCheck/somGroupbranchAPCheckInsert.jsp";
	L5.forward(url,"社会团体异地设立分支/代表机构的审查录入页面");
...
function showState(){
   ...
   var url='jsp/workflow/monitor/flowview.jsp?backUrl=jsp/cams/sorg/apply/group/branchAnotherPalaceCheck/somGroupbranchAPCheckList.jsp&assignmentId='+assignmentId;
   var text = '流程状态';
   L5.forward(url,text);
}
