...
<script type="text/javascript">
			var procTypeId = 'somGroupBuild';//流程类型ID
			var act="受理";
			//设置任务状态
...
function forNewBuild(){
	var url="jsp/cams/sorg/apply/group/mainBuild/somGroupBuildInsert.jsp";
	L5.forward(url,"社会团体主体成立登记录入页面");
...
function showState(){
   ...
   var url='jsp/workflow/monitor/flowview.jsp?backUrl=jsp/cams/sorg/apply/group/mainBuild/somGroupBuildList.jsp&assignmentId='+assignmentId;
   var text = '流程状态';
   L5.forward(url,text);
}
