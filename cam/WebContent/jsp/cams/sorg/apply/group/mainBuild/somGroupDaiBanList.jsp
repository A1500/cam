...
function showState()
{
   ...
   var url='jsp/workflow/monitor/flowview.jsp?backUrl=jsp/cams/sorg/apply/group/mainBuild/somGroupDaiBanList.jsp?name='+nameValue+'&assignmentId='+assignmentId;
   var text = '流程状态';
   L5.forward(url,text);
}
