...
<script type="text/javascript" src="somGroupBuildInsert.js"></script>
...
<model:datasets>
	...
	<!-- 负责人信息 -->
	<model:dataset id="aspDutyDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomDutyQueryCmd" global="true"  method="queryAspchief" >
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomDuty"></model:record>
	</model:dataset>
					...
					<next:Html>
						...
						<table width="100%">
							<tr>
								...
								<td class="FieldInput" colspan="3"><input type="text" id="cnName" name='社会团体中文名称' field="cnName" onblur="fillOrganInfo();" style="width:97%"/><span style="color:red">*</span></td>
					...
					<form onsubmit="return false" dataset="somSessionDataSet" class="L5form">
						<table width="100%">
							<tr>
								...
								<td class="FieldInput" colspan="3"><input type="text" id="sessionName" title="届次名称" field="sessionName" style="width:97%" onclick="showMeeting()" readonly/><span style="color:red">*</span></td>
