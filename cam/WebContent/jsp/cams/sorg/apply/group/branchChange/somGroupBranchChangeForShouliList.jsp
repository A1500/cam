...
<html>
	...
	<script type="text/javascript">
		...
		var act="受理";
		var procDefUniqueId="8ac896bb318d9b2901318e80be43002e";
...
function forNewChange(){
	var url="jsp/cams/sorg/apply/group/branchChange/somGroupBranchChange.jsp";
	L5.forward(url,"社会团体分支/代表机构变更登记页面");
