...
function sendForPrint(){
	...
	command.setParameter("applyType", somApplyType);
	command.setParameter("opinion", newRecord);
	command.setParameter("organType", 'branch');//主体还是分支
	command.setParameter("business", business);
	command.setParameter("actArea", actArea);
	command.setParameter("fetchPeople", fetchPeople);
	command.setParameter("fetchDate", fetchDate);
	command.setParameter("fetchPhone", fetchPhone);
...
function forChangeShow(somChangeDataset){
	...
	if(changeItem=='0'){
		...
		var changeAfter=record.get('changeAfter');
		var changeAfters=changeAfter.split(';');
		document.getElementById('moneyPeopleAfter').innerHTML=changeAfters[0];
		document.getElementById('moneyborgAfter').innerHTML=changeAfters[1];
		document.getElementById('moneySourceAfter').innerHTML=changeAfters[2];
		document.getElementById('moneyAfter').innerHTML=changeAfters[3];
...
function forCertType(){
	...
	somOrganDataSet.load();
	sorgOrganRecord= somOrganDataSet.getCurrent();
	var sorgCode=sorgOrganRecord.get('sorgCode');
	if(business=='' ){
	...
	if(num!='' && endDate!='' && beginDate!='' && PrintDate!=''&& actArea!=''){
		if(endDate<beginDate){
			L5.Msg.alert('提示',"有效期限止不得早于有效期限起！");
			return;
		}
		var url=L5.webPath+"/jsp/cams/sorg/comm/print/groupBranchBuildForPrint.jsp?id="+sorgId+"&PrintDate="+PrintDate+"&beginDate="+beginDate+"&endDate="+endDate+"&taskCode="+taskCode+"&certType="+num+"&sorgCode="+sorgCode+"&business="+encodeURIComponent(business)+"&actArea="+encodeURIComponent(actArea);
		PostNewWin(url);
	}else{
...
<model:datasets>
	...
	<%--历史意见表--%>
	<model:dataset id="somFlowDataset" cmd="com.inspur.cams.sorg.base.cmd.SomFlowQueryCmd" sortField="COMMIT_TIME" pageSize="20">
			...
			<next:Panel title="社会团体变更登记申请表" width="100%" height="100%" autoScroll="true">
				...
				<next:EditGridPanel id="changeEdit" dataset="somChangeList" height="60%" autoScroll="true">
					<next:TopBar>
						...
						<next:ToolBarItem symbol="->"></next:ToolBarItem>
						<next:ToolBarItem text="查看变更" iconCls="detail" handler="detailForChange"></next:ToolBarItem>
					</next:TopBar>
					<next:Columns>
			...
			<next:Panel title="流程历史意见" id="historyPanel" >
				<next:EditGridPanel id="lishi" dataset="somFlowDataset" height="100%"  width="100%" autoScroll="true" stripeRows="true">
					<next:Columns>
						<next:RowNumberColumn/>
						<next:RadioBoxColumn></next:RadioBoxColumn>
						<next:Column header="处理环节" field="activity"
							 width="13%" editable="false">
							<next:TextField />
						</next:Column>
						...
						<next:Column header="处理意见" field="opinionId"
							 width="10%"editable="false"  dataset="hisOpinionSelect">
							<next:TextField/>
						</next:Column>
						<next:Column header="处理补充意见" field="opinion"
					...
					<form method="post" onsubmit="return false" class="L5form" dataset="somFlowAddDataset">
						<table width="100%">
							<tr>
								...
								<select field="curOpinionId" id="curOpinionId" name='处理意见' style="width:150px">
						...
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput" colspan="5"><textarea rows="2"
									name='"所在单位人事部门审查意见"' readonly="readonly" field="workOpinion"
									style="width: 97.7%;background-color:#F5FAFA;border:0;overflow:auto;"></textarea></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="FieldInput" colspan="5"><textarea rows="2"
									name='"按照本社会团体章程会议产生通过情况"' field="sorgOpinion" style="width: 97.7%"></textarea></td>
							</tr>
							<tr>
								<td class="FieldLabel"><label>签署日期：</label></td>
								<td class="FieldInput" colspan="5"><input type="text"
									field="sorgCheckDate" format="Y-m-d" onclick="WdatePicker()"
									style="width: 22%" /></td>
							</tr>
							<tr>
								<td class="FieldLabel">备注：</td>
								<td class="FieldInput" colspan="5"><textarea rows="2"
									name='"备注"' readonly="readonly" field="note" style="width: 97.7%"></textarea></td>
							</tr>
						</table>
					</form>
				</next:Html>
...
<!-- 社会团体名称变更 -->
<next:Window id="AddChange0" modal="true" closeAction="hide" title="名称变更" width="600"  autoScroll="true">
	<next:TopBar>
		<next:ToolBarItem text='' id="displayItem" />
...
<table width="100%">
			...
			<tr>
				...
				<td class="FieldInput"style="width:25%"><select  id="sorgGroupKindBefore" style="color:blue" disabled="disabled"><option dataset="sorgKindSelect"></option></select></td>
				<td class="FieldLabel" style="width:25%"><label>所属行（事）业变更前：</label></td>
				<td class="FieldInput"style="width:25%"><select  id="sorgBusScopeBefore" style="color:blue" disabled="disabled"><option  dataset="busScopeSelect"></option></select></td>
			</tr>
			<tr>
				<td class="FieldLabel"style="width:15%"><label style="color:blue">名称变更为：</label></td>
				<td class="FieldInput"style="width:15%"colspan="3"><label  id="nameAfter" style="color:blue"/></td>
			</tr>
			...
			<tr>
				...
				<td class="FieldInput"style="width:15%"><select  id="sorgGroupKindAfter"  style="color:blue"><option dataset="sorgKindSelect"  style="color:blue"></option></select></td>
				<td class="FieldLabel" style="width:15%"><label style="color:blue">所属行（事）业变更为：</label></td>
				<td class="FieldInput"style="width:15%"><select  id="sorgBusScopeAfter"   style="color:blue"><option  dataset="busScopeSelect" style="color:blue"></option></select></td>
			</tr>
			</span>
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更程序：</label></td>
				<td class="FieldInput" colspan="5"><textArea cols="75" rows="4" style="width: 100%;color:blue" field='changeDesc' readonly="readonly"></textArea></td>
			</tr>
			<tr>
...
<!-- 负责人变更 -->
<next:Window id="AddChange2" modal="true" closeAction="hide" title="负责人变更" width="600"  autoScroll="true">
	<next:TopBar>
		<next:ToolBarItem text='' id="displayItem" />
		<next:ToolBarItem symbol="负责人变更"></next:ToolBarItem>
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
		<next:ToolBarItem text="查看负责人信息" iconCls="detail" handler="detailLegalPeople"></next:ToolBarItem>
		<next:ToolBarItem text="关闭" iconCls="return" handler="closeChangeWin"></next:ToolBarItem>
	</next:TopBar>
	<next:Html>
	<form method="post" onsubmit="return false" class="L5form"dataset="somChangeDataset">
...
<table width="100%">
			<tr>
				...
				<td class="FieldInput"style="width:25%"><label  id="leaPeopleNameBefore" /></td>
...
<!-- 住所变更 -->
<next:Window id="AddChange1" modal="true" closeAction="hide" title="住所变更" width="500"  autoScroll="true">
	<next:TopBar>
		<next:ToolBarItem text='' id="displayItem" />
...
<table width="100%">
			<tr>
				...
				<td class="FieldInput" style="width:25%"><label  id="houseAreaBefore"  /></td>
				</tr>
			<tr>
			...
			<tr>
				...
				<td class="FieldInput"style="width:15%"><select id="houseSourceAfter" style="color:blue"><option  dataset="resideSourceSelect"></option></select></td>
				<td class="FieldLabel"><label style="color:blue">用房面积变更为：</label></td>
				<td class="FieldInput"><label id="houseAreaAfter"  style="color:blue"/></td>
			</tr>
			</span>
			<tr>
				<td class="FieldLabel"><label style="color:blue">住所名称变更为：</label></td>
				<td class="FieldInput" colspan="3"><label id="houseNameAfter"  style="color:blue"/></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">产权单位变更为：</label></td>
				<td class="FieldInput" colspan="3"><label id="houseBorgAfter"  style="color:blue"/></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">租借期限变更为：</label></td>
				<td class="FieldInput"><label id="houseDateAfter"  style="color:blue"/></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更程序：</label></td>
				<td class="FieldInput" colspan="5"><textArea cols="75" rows="4" readonly="readonly" style="width: 100%;color:blue" field="changeDesc" ></textArea></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更理由：</label></td>
...
<!-- 业务范围变更 -->
<next:Window id="AddChange3" modal="true" closeAction="hide" title="业务范围变更" width="600"  autoScroll="true">
	<next:TopBar>
		<next:ToolBarItem text='' id="displayItem" />
...
<!-- 变更注册资金 -->
<next:Window id="AddChange4" modal="true" closeAction="hide" title="注册资金变更" width="500"  autoScroll="true">
	<next:TopBar>
		<next:ToolBarItem text='' id="displayItem" />
...
<table width="100%">
			...
			<tr>
				...
				<td class="FieldInput"style="width:15%"><label id="moneyPeopleAfter" style="color:blue"/></td>
				<td class="FieldLabel"><label style="color:blue">资金数额变更为：</label></td>
				<td class="FieldInput"><label id="moneyAfter" style="color:blue"/></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">验资单位变更为：</label></td>
				<td class="FieldInput" colspan="3"><label id="moneyborgAfter" style="color:blue"/></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">资金来源变更为：</label></td>
				<td class="FieldInput" colspan="3"><label id="moneySourceAfter" style="color:blue"/></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更程序：</label></td>
				<td class="FieldInput" colspan="5"><textArea cols="75" rows="4" readonly="readonly" style="width: 100%;color:blue" field="changeDesc"></textArea></td>
...
<!-- 业务主管单位变更 -->
<next:Window id="AddChange5" modal="true" closeAction="hide" title="业务主管单位变更" width="600"  autoScroll="true">
	<next:TopBar>
		<next:ToolBarItem text='' id="displayItem" />
	...
	<table width="100%">
			<tr>
				...
				<td class="FieldInput"style="width:25%"><select id="borgNameBefore" disabled="disabled"><option dataset="businessOrganSelect"></option></select></td>
				<td class="FieldLabel"style="width:25%"><label style="color:blue">变更为业务主管单位：</label></td>
				<td class="FieldInput"style="width:25%"><select field="changeAfter" style="color:blue" disabled="disabled"><option dataset="businessOrganSelect"></option></select></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更程序：</label></td>
...
<table width="100%">
			...
			<tr>
					...
					<td class="FieldInput"style="width:15%" colspan="3"><input id="actArea" name="活动地域" style="width:100%" maxlength="25"/></td>
			</tr>
			<tr>
