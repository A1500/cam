...
<script type="text/javascript">
	var nameValue="<%=name%>";
	var procTypeId ="somGroupBranchChange";
	//设置任务状态
...
<model:datasets>
	...
	<model:dataset id="taskCode" cmd="com.inspur.cams.comm.dicm.DicQueryCmd" global="true" autoLoad="true">
		<model:record fromBean="com.inspur.cams.comm.dicm.DicBean"></model:record>
		<model:params>
			<model:param name="dic" value='SOM_APPLY'></model:param>
			<model:param name="value" value='PROCESS_ID'></model:param>
			<model:param name="text" value='TASK_CODE'></model:param>
		</model:params>
	</model:dataset>
	<!-- 变更业务 -->
