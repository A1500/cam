...
<script language="javascript">
	var procTypeId="somGroupBranchBuild";
	var act="受理";
	var procDefUniqueId="8a898b9d3633517001363351709a0000";	
...
function showState(){
	...
	var url='jsp/workflow/monitor/flowview.jsp?backUrl=jsp/cams/sorg/apply/group/branchBuild/groupBranchBuildAcceptList.jsp&assignmentId='+assignmentId;
	L5.forward(url);
}
//已办任务查询
function queryyiban(){
...
function handleyiban(){
	...
	var url='jsp/cams/sorg/apply/group/branchBuild/groupBranchBuildDeal.jsp?method=yiban'+'&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	L5.forward(url);
}
//查看已办流程图
...
function handleEnd(){
	...
	var actDefUniqueId=rec.get("ACT_DEF_UNIQUE_ID");
	var assignmentId=rec.get("ID");
	var url="jsp/cams/sorg/apply/group/branchBuild/groupBranchBuildDeal.jsp?method=end"+"&processId="+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	L5.forward(url);
}
//查看流程状态图
...
// 受理页面
function forAccept(){
	var url='jsp/cams/sorg/apply/group/branchBuild/groupBranchBuildReportEdit.jsp?method=INSERT';
	L5.forward(url);
}
// 修改页面
function forUpdate(){
	...
	var actDefUniqueId=rec.get("ACT_DEF_UNIQUE_ID");
	var assignmentId=rec.get("ID");
	var url='jsp/cams/sorg/apply/group/branchBuild/groupBranchBuildReportEdit.jsp?method=UPDATE&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	L5.forward(url);
}
</script>
</html>