...
<model:datasets>
	...
	<%--人员简历 --%>
	<model:dataset id="somResumeDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomPeopleResumeQueryCommand"  pageSize="-1">
					...
					<form method="post" dataset="somOrganDataSet" onsubmit="return false"class="L5form">
						<table width="100%">
							<tr>
								...
								<td class="FieldInput" colspan="5"><label type="text"  id="mainSorgCode" name='"社团主体登记证号"' field="mainSorgCode" onblur="validateSorgCode()" style="width:98%"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="FieldInput" colspan="5"><label type="text" id="cnName" name='"机构名称"' field="cnName" onblur="cnNameUK()" style="width:98%"/></td>
							</tr>
							<tr>
