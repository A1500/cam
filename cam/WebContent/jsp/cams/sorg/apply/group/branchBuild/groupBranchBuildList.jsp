...
function showState(){
	...
	var url='jsp/workflow/monitor/flowview.jsp?backUrl=jsp/cams/sorg/apply/group/branchBuild/groupBranchBuildList.jsp?act='+act+'&assignmentId='+assignmentId;
	L5.forward(url);
}
//已办任务查询
function queryyiban(){
...
function handleyiban(){
	...
	var url;
	if(act=='auditReport'){
		url='jsp/cams/sorg/apply/group/branchBuild/groupBranchBuildReportDetail.jsp';
	}else{
		url='jsp/cams/sorg/apply/group/branchBuild/groupBranchBuildDeal.jsp';
	}
...
function forDeal(){
	...
	}else if(act=='accept' || act == 'supply'){
		url='jsp/cams/sorg/apply/group/branchBuild/groupBranchBuildReportEdit.jsp';
