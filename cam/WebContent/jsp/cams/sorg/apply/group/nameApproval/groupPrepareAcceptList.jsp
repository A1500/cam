...
<script language="javascript">
	var procTypeId="somGroupNameApproval";
	var act="受理";
	var procDefUniqueId="8a898bba3628b96b013628bce1790171";		
...
<model:datasets>
	<model:dataset pageSize="10" id="daiBanDataset" cmd="com.inspur.cams.comm.workflow.taskinfo.cmd.TaskInfoQueryCmd" method="queryDaiBan"  global="true">
		<model:record>
			...
			<model:field name="LIMIT_TIME" type="string" />
			<model:field name="TO_LIMIT_TIME" type="string" />
		</model:record>
	</model:dataset>
...
<next:Window id="winSorg" closeAction="hide" title="社会团体类别" width="200"  autoScroll="true" modal="true">
	<next:TopBar>
	...
	<next:Html>
		<table width="100%">
			<tr>
				<td align="center"><label >请选择社会团体类别：</label></td>
			</tr>
			<tr>
				<td align="center"><select id="sorgType">
					<option value="1">社会团体主体</option>
...
function handleyiban(){
	...
	var url='jsp/cams/sorg/apply/group/nameApproval/groupPrepareReportDetail.jsp?processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId+"&method=yiban";
	L5.forward(url);
}
//查看已办流程图
...
function handleEnd(){
	...
	var actDefUniqueId=rec.get("ACT_DEF_UNIQUE_ID");
	var assignmentId=rec.get("ID");
	var url="jsp/cams/sorg/apply/group/nameApproval/groupPrepareReportDetail.jsp?method=end&processId="+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	L5.forward(url);
}
//查看流程状态图
...
function enter(){
	...
	var url='jsp/cams/sorg/apply/group/nameApproval/groupPrepareReportEdit.jsp?method=INSERT&sorgType='+sorgType;
	L5.forward(url);
}
...
function forUpdate(){
	...
	var actDefUniqueId=rec.get("ACT_DEF_UNIQUE_ID");
	var assignmentId=rec.get("ID");
	var url='jsp/cams/sorg/apply/group/nameApproval/groupPrepareReportEdit.jsp?method=UPDATE&processId='+processId+"&actDefUniqueId="+actDefUniqueId+"&assignmentId="+assignmentId;
	L5.forward(url);
}
</script>
</html>