							...
							<table width="100%">
								...
								<tr>
									...
									<td class="FieldInput" width="30%">
										<input field="invStartDate" style="width:80%" format="Y-m-d" onclick="WdatePicker()" name='"调查开始时间"'/><span style="color:red">*</span>
									</td>
									<td class="FieldLabel" width="20%"><label>调查结束时间：</label></td>
									<td class="FieldInput" width="30%">
										<input field="invEndDate" style="width:80%" format="Y-m-d" onclick="WdatePicker()" name='"调查结束时间"'/><span style="color:red">*</span>
									</td>
								</tr>
								<tr>
