...
<next:Panel width="100%" height="100%">
	<next:TopBar>
		...
		<next:ToolBarItem text="打印《取缔决定书》" iconCls="print" handler="printForbidInform"></next:ToolBarItem>
		<next:ToolBarItem text="打印《<取缔决定书>送达回证》" iconCls="print" handler="printForbidInformBack"></next:ToolBarItem>
