						...
						<form method="post" dataset="somPenaltyDataSet" onsubmit="return false" class="L5form">
							<table width="100%">
								...
								<tr>
									...
									<td class="FieldInput"><input field="regName" name='"案件名称"' style="width:80%" /><span style="color:red">*</span></td>
									<td class="FieldLabel"><label>立案时间：</label></td>
									<td class="FieldInput"><input field="regDate" name='"立案时间"' style="width:80%" format="Y-m-d" onclick="WdatePicker()" /><span style="color:red">*</span></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="FieldInput"><input field="partyCharger" name='"当事人法定代表人（负责人）或发起人"' style="width:80%"/><span style="color:red">*</span></td>
					...
					<form method="post" onsubmit="return false" class="L5form" dataset="somPenaltyApplyDataSet">
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput"><input field="regDealPeople" name='"承办人"' style="width:40%"/><span style="color:red">（承办人为多个，请使用“,”分割）*</span></td>
							</tr>
							<tr>
