...
<html>
<head>
<title>社会组织任务列表</title>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript" src='<%=SkinUtils.getJS(request,"cams.js") %>'></script>
<script type="text/javascript" src='<%=SkinUtils.getJS(request,"camsCheck.js")%>'></script>
<script type="text/javascript">
	var procTypeId = 'somPenaltyForbid';//流程类型ID	
	var act="p_accept";
	var actDefName="<%=Activity.PENALTYACT_ACCEPT_CN%>";
	var procDefUniqueId="8a898b0934bff47b0134c04d0ec90030";
...
//受理按钮
function forAccept(){
	var url="jsp/cams/sorg/penalty/forbid/penaltyForbidAccept.jsp?method=INSERT";
	L5.forward(url,"取缔非法社会组织受理登记");	
}
//通过按钮处理待办任务
function forUpdate(){
	...
	var url="jsp/cams/sorg/penalty/forbid/penaltyForbidAccept.jsp";
...
function handleyiban(){
	...
	var actDefUniqueId=rec.get("ACT_DEF_UNIQUE_ID");
	var assignmentId=rec.get("ID");
	var url="jsp/cams/sorg/penalty/forbid/penaltyForbidAcceptDetail.jsp";
...
function handleEnd(){
	...
	var rec=selected[0];
	var assignmentId=rec.get("ID");
	var url="jsp/cams/sorg/penalty/forbid/penaltyForbidFinalDetail.jsp";
