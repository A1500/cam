...
<html>
<head>
<title>取缔非法社会组织受理登记</title>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript" src="penaltyForbidAccept.js"></script>
...
<script type="text/javascript">
	...
	var caseCode = '<%=StrUtil.n2b(SomIdHelp.getSomCaseCode())%>';
</script>
</head>
<body>
<model:datasets>
						...
						<form method="post" dataset="somPenaltyDataSet" onsubmit="return false" class="L5form">
							<table width="100%">
								<tr>
									...
									<td class="FieldInput" width="30%"><input field="caseCode" name='"编号"' style="width:80%" readOnly/><span style="color:red">*</span></td>
								...
								<tr>
									...
									<td class="FieldInput" width="30%"><input id="sorgCode" field="sorgCode" name='"社会组织登记证号"' onchange="loadSorg()" style="width:80%"/><br/><span style="color:red">（登记证号不存在请填“无”）*</span></td>
								</tr>
								<tr>
									<td class="FieldLabel"><label>社会组织名称：</label></td>
									<td class="FieldInput" colspan="3"><input id="sorgName" field="sorgName" name='"社会组织名称"' onchange="" style="width:93%"/><span style="color:red">*</span></td>
								</tr>
								<tr>
