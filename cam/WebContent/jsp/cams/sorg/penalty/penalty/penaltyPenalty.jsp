...
<model:datasets>
	<model:dataset id="somPenaltyDataSet" cmd="com.inspur.cams.sorg.penalty.base.cmd.SomPenaltyQueryCmd" global="true">
		<model:record fromBean="com.inspur.cams.sorg.penalty.base.data.SomPenalty">			
			<model:field name="informDate" type="string" rule="require|length{10}" />
			<model:field name="informNo" type="string" rule="require|length{32}" />
			<model:field name="penaltyInformType" type="string" rule="require" />
			<model:field name="informContent" type="string" rule="require|length{500}" />
			<model:field name="avermentReason" type="string" rule="require|length{500}" />
		</model:record>
	</model:dataset>	
	<model:dataset id="somPenaltyApplyDataSet" cmd="com.inspur.cams.sorg.penalty.base.cmd.SomPenaltyApplyQueryCmd" global="true">
		<model:record fromBean="com.inspur.cams.sorg.penalty.base.data.SomPenaltyApply">
			<model:field name="penaltyDealPeople" type="string" rule="require" />			
		</model:record>
	</model:dataset>
	<%--电子档案--%>
						...
						<form method="post" dataset="somPenaltyDataSet" onsubmit="return false" class="L5form">
							<table width="100%">
								...
								<tr>
									...
									<td class="FieldInput"><input field="informDate" name='"事先/听证告知书发出日期"' style="width:93%"/><span style="color:red">*</span></td>
									<td class="FieldLabel"><label>事先/听证告知书编号：</label></td>
									<td class="FieldInput"><input field="informNo" name='"事先/听证告知书编号"' style="width:93%"/><span style="color:red">*</span></td>									
								</tr>
								<tr>
									<td class="FieldLabel"><label>事先/听证告知处罚的类型：</label></td>
									<td class="FieldInput"><select field="penaltyInformType" name='"事先/听证告知处罚的类型"' style="width:93%"><option dataset='penaltyInformTypeSelect'></select><span style="color:red">*</span></td>									
									<td class="FieldLabel"></td>
									<td class="FieldInput"></td>		
								</tr>
								<tr>
									<td class="FieldLabel"><label>事先/听证告知处罚的内容：</label></td>
									<td class="FieldInput" colspan="3"><textarea rows="5" field="informContent" name='"事先/听证告知处罚的内容"' style="width:93%"></textarea><span style="color:red">*</span></td>									
								</tr>
								<tr>
					...
					<form method="post" onsubmit="return false" class="L5form" dataset="somPenaltyApplyDataSet">
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput"><input field="penaltyDealPeople" name='"承办人"' style="width:40%"/><span style="color:red">（承办人为多个，请使用“,”分割）*</span></td>
							</tr>
							<tr>
