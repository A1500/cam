						...
						<form method="post" dataset="somPenaltyDataSet" onsubmit="return false" class="L5form">
							<table width="100%">
								...
								<tr>
									...
									<td class="FieldInput"><label field="informDate" name='"事先/听证告知书发出日期"' style="width:93%"/></td>
									<td class="FieldLabel"><label>事先/听证告知书编号：</label></td>
									<td class="FieldInput"><label field="informNo" name='"事先/听证告知书编号"' style="width:93%"/></td>									
								</tr>	
								<tr>
