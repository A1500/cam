...
<html>
<head>
<title>社会组织行政处罚待办任务</title>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript">
	var procTypeId ="somPenalty";
...
function forDeal(){
	...
	var url="";
	if(act=='p_reg'){	
		url="jsp/cams/sorg/penalty/penalty/penaltyReg.jsp";
	}else if(act=='p_regCheck' || act=='p_regAudit'){
		url="jsp/cams/sorg/penalty/penalty/penaltyRegDetail.jsp";
	}else if(act=='p_inv'){
		url="jsp/cams/sorg/penalty/penalty/penaltyInv.jsp";
	}else if(act=='p_invEnd'){
		url="jsp/cams/sorg/penalty/penalty/penaltyInvEnd.jsp";
	}else if(act=='p_invEndCheck' || act=='p_invEndAudit'){
		url="jsp/cams/sorg/penalty/penalty/penaltyInvEndDetail.jsp";
	}else if(act=='p_inform'){
		url="jsp/cams/sorg/penalty/penalty/penaltyInform.jsp";
	}else if(act=='p_penalty'){
		url="jsp/cams/sorg/penalty/penalty/penaltyPenalty.jsp";
	}else if(act=='p_penaltyCheck' || act=='p_penaltyAudit'){
		url="jsp/cams/sorg/penalty/penalty/penaltyPenaltyDetail.jsp";
	}else if(act=='p_penaltyInform'){
		url="jsp/cams/sorg/penalty/penalty/penaltyPenaltyInform.jsp";
	}else if(act=='p_final'){
		url="jsp/cams/sorg/penalty/penalty/penaltyFinal.jsp";
	}else if(act=='p_finalCheck' || act=='p_finalAudit'){
		url="jsp/cams/sorg/penalty/penalty/penaltyFinalDetail.jsp";
	}
...
function handleyiban(){
	...
	if(act=='p_reg' || act=='p_regCheck' || act=='p_regAudit'){	
		...
		url="jsp/cams/sorg/penalty/penalty/penaltyInvDetail.jsp";
	}else if(act=='p_invEnd' || act=='p_invEndCheck' || act=='p_invEndAudit'){
		url="jsp/cams/sorg/penalty/penalty/penaltyInvEndDetail.jsp";
	}else if(act=='p_inform'){
		url="jsp/cams/sorg/penalty/penalty/penaltyInformDetail.jsp";
	}else if(act=='p_penalty' || act=='p_penaltyCheck' || act=='p_penaltyAudit'){
		url="jsp/cams/sorg/penalty/penalty/penaltyPenaltyDetail.jsp";
	}else if(act=='p_penaltyInform'){
		url="jsp/cams/sorg/penalty/penalty/penaltyPenaltyInformDetail.jsp";
...
function getActDefName(){
	...
	}else if(act=='p_invEndCheck'){
		return "<%=Activity.PENALTYACT_INV_END_CHECK_CN%>";
	}else if(act=='p_invEndAudit'){
		return "<%=Activity.PENALTYACT_INV_END_AUDIT_CN%>";
	}else if(act=='p_inform'){
		return "<%=Activity.PENALTYACT_INFORM_CN%>";
	}else if(act=='p_penalty'){
		return "<%=Activity.PENALTYACT_PENALTY_CN%>";
	}else if(act=='p_penaltyCheck'){
		return "<%=Activity.PENALTYACT_PENALTY_CHECK_CN%>";
	}else if(act=='p_penaltyAudit'){
		return "<%=Activity.PENALTYACT_PENALTY_AUDIT_CN%>";
	}else if(act=='p_penaltyInform'){
		return "<%=Activity.PENALTYACT_PENALTY_INFORM_CN%>";
	}else if(act=='p_final'){
