...
<model:datasets>
	<model:dataset id="somPenaltyDataSet" cmd="com.inspur.cams.sorg.penalty.base.cmd.SomPenaltyQueryCmd" global="true">
		<model:record fromBean="com.inspur.cams.sorg.penalty.base.data.SomPenalty">
			<model:field name="invStartDate" type="string" rule="require" />
			<model:field name="invEndDate" type="string" rule="require" />
			<model:field name="invProcess" type="string" rule="require" />
			<model:field name="invInfact" type="string" rule="require" />
			<model:field name="invProve" type="string" rule="require" />
			<model:field name="invCaseNature" type="string" rule="require" />
			<model:field name="invProof" type="string" rule="require" />
			<model:field name="invPunSuggestions" type="string" rule="require" />
			<model:field name="invPerson" type="string" rule="require" />
		</model:record>
	</model:dataset>
	<model:dataset id="somPenaltyApplyDataSet" cmd="com.inspur.cams.sorg.penalty.base.cmd.SomPenaltyApplyQueryCmd" global="true">
		<model:record fromBean="com.inspur.cams.sorg.penalty.base.data.SomPenaltyApply">
			...
			<model:field name="invAcceptDealPeople" type="string" rule="require|length{300}" />
		</model:record>
	</model:dataset>
	<%--电子档案--%>
					...
					<fieldset>
						<form method="post" dataset="somPenaltyDataSet" onsubmit="return false" class="L5form">
							<table width="100%">
								...
								<tr>
									<td class="FieldLabel"><label>调查人：</label></td>
									<td class="FieldInput" colspan="3"><input field="invPerson" name='"调查人"' style="width:40%"/><span style="color:red">（调查人为多个，请使用“,”分割）*</span></td>
								</tr>
								<tr>
									<td class="FieldLabel" width="20%"><label>调查开始时间：</label></td>
									<td class="FieldInput" width="30%">
										<input field="invStartDate" format="Y-m-d" onclick="WdatePicker()" name='"调查开始时间"' /><span style="color:red">*</span>
									</td>
									<td class="FieldLabel" width="20%"><label>调查结束时间：</label></td>
									<td class="FieldInput" width="30%">
										<input field="invEndDate" format="Y-m-d" onclick="WdatePicker()" name='"调查结束时间"' /><span style="color:red">*</span>
									</td>
								</tr>
								<tr>
									<td class="FieldLabel"><label>案由及调查经过：</label></td>
									<td class="FieldInput" colspan="3"><textarea rows="5" field="invProcess" name='"案由及调查经过"' style="width:93%"></textarea><span style="color:red">*</span></td>
								</tr>
								<tr>
									<td class="FieldLabel"><label>违法事实：</label></td>
									<td class="FieldInput" colspan="3"><textarea rows="5" field="invInfact" name='"违法事实"' style="width:93%"></textarea><span style="color:red">*</span></td>
								</tr>
								<tr>
									<td class="FieldLabel"><label>证据证明：</label></td>
									<td class="FieldInput" colspan="3"><textarea rows="5" field="invProve" name='"证据证明"' style="width:93%"></textarea><span style="color:red">*</span></td>
								</tr>
								<tr>
									<td class="FieldLabel"><label>案件性质：</label></td>
									<td class="FieldInput" colspan="3"><textarea rows="5" field="invCaseNature" name='"案件性质"' style="width:93%"></textarea><span style="color:red">*</span></td>
								</tr>
								<tr>
									<td class="FieldLabel"><label>处罚依据：</label></td>
									<td class="FieldInput" colspan="3"><textarea rows="5" field="invProof" name='"处罚依据"' style="width:93%"></textarea><span style="color:red">*</span></td>
								</tr>
								<tr>
									<td class="FieldLabel"><label>处罚建议：</label></td>
									<td class="FieldInput" colspan="3"><textarea rows="5" field="invPunSuggestions" name='"处罚建议"' style="width:93%"></textarea><span style="color:red">*</span></td>
								</tr>
							</table>
						</form>
					</fieldset>
					...
					<form method="post" onsubmit="return false" class="L5form" dataset="somPenaltyApplyDataSet">
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput"><input field="invAcceptDealPeople" name='"承办人"' style="width:40%"/><span style="color:red">（承办人为多个，请使用“,”分割）*</span></td>
							</tr>
							<tr>
