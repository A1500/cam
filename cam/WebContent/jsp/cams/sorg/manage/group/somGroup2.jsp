...
<html>
<head>
<title>社团主体信息明细</title>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript" src="somGroup2.js"></script>
...
<model:datasets>
	...
	<%--清算组织人员信息--%>
	<model:dataset id="somLiqpeopleDataSet" cmd="com.inspur.cams.sorg.manage.cmd.SomGroupLiqpeopleQueryCmd">
...
<next:Panel width="100%" height="100%">
	<next:TopBar>
		<next:ToolBarItem symbol="社团主体信息明细"></next:ToolBarItem>
	...
	<next:TabPanel id="tab" width="100%" height="100%"  activeTab="2">
		<next:Tabs>
			...
			<next:Panel title="主要负责人">
				<next:EditGridPanel id="propleGrid" name="grid" width="100%" stripeRows="true" height="100%" dataset="somPresidePeopleDataSet">
					<next:TopBar>
						<next:ToolBarItem symbol="主要负责人列表"></next:ToolBarItem>
						<next:ToolBarItem symbol="->"></next:ToolBarItem>
					...
					<next:Columns>
						...
						<next:Column header="姓名"    field="name" width="15%" editable="false"><next:TextField /></next:Column>
						...
						<next:Column header="社团职务" field="sorgDuties" width="15%" dataset="sorgDutiesSelect" editable="false"><next:TextField /></next:Column>
						<next:Column header="政治面貌" field="politics" width="17%" editable="false" dataset="politicsSelect"><next:TextField /></next:Column>
						<next:Column header="电话"    field="phone" width="18%" editable="false"><next:TextField /></next:Column>
					</next:Columns>
					<next:BottomBar>
			...
			<next:Panel title="社会团体法定代表人登记表"  width="100%" autoScroll="true">
				<next:Html>
					...
					<table width="100%">
						<tr>
							...
							<td class="FieldInput" style="width:20%"><label   id="idCard" field="idCard" style="width:90%"/></td>
							...
							<td class="FieldInput" style="width:20%"><label   field="aliasName" style="width:90%"/></td>
						...
						<tr>	
							...
							<td class="FieldInput" colspan="5"><label   field="adds" style="width:98%"/></td>
						</tr>
						<tr>
							<td class="FieldLabel"><label>户口所在地：</label></td>
							<td class="FieldInput" colspan="5"><label   field="populace" style="width:98%"/></td>
						</tr>
						<tr>
							...
							<td class="FieldInput"><label field="ifLegal" dataset="comm_yesorno" style="width:90%"/></td>
						...
						<tr>
							...
							<td class="FieldInput" colspan="5"><label field="workName" style="width:98%"/></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="FieldInput" colspan="5"><textarea rows="10" field="resume" readonly="readonly" style="width:98%"></textarea></td>
						</tr>
						<tr>
							<td class="FieldLabel"><label>所在单位人事部门审查意见：</label></td>
							<td class="FieldInput" colspan="5"><textarea rows="2" field="workOpinion" readonly="readonly" style="width:98%"></textarea></td>
						</tr>
						<tr>
							<td class="FieldLabel"><label>签署日期：</label></td>
							<td class="FieldInput" colspan="5"><label  field="workCheckDate" format="Y-m-d" style="width:30%"/></td>
						</tr>
						<tr>
							<td class="FieldLabel"><label>按照本社团章程会议产生通过情况：</label></td>
							<td class="FieldInput" colspan="5"><textarea rows="2" field="sorgOpinion" readonly="readonly" style="width:98%"></textarea></td>
						</tr>
						<tr>	
							<td class="FieldLabel"><label>签署日期：</label></td>
							<td class="FieldInput" colspan="5"><label field="sorgCheckDate" format="Y-m-d" style="width:30%"/></td>
						</tr>
						<tr>
							<td class="FieldLabel"><label>备注：</label></td>
							<td class="FieldInput" colspan="5"><textarea rows="2" field="memberNote" readonly="readonly" style="width:98%"></textarea></td>
						</tr>
					</table>
					</form>
				</next:Html>
			</next:Panel>
			<next:Panel id="cbPanel" title="社会团体法人注销登记表" width="100%">
				<next:Html>
					...
					<table width="100%">
						...
						<tr>
							<td class="FieldLabel" style="width:17%"><label>社团代码：</label></td>
							<td class="FieldInput" style="width:17%"><label field="organCode" style="width:90%"/></td>
							<td class="FieldLabel" style="width:17%"><label>社团类别：</label></td>
						...
						<tr>
							...
							<td class="FieldInput"><label field="cancelDate" format="Y-m-d" style="width:90%"/></td>
						...
						<tr>
							...
							<td class="FieldInput" colspan="5"><textarea rows="5" field="cancelReason" readonly="readonly" style="width:98%"></textarea></td>
						</tr>
						<tr>
							<td class="FieldLabel"><label>清算结论：</label></td>
							<td class="FieldInput" colspan="5"><textarea rows="2" field="liqResult" readonly="readonly" style="width:98%"></textarea></td>
						</tr>
					</table>
					</form>
				</next:Html>
			</next:Panel>
			<next:Panel title="清算人员" width="100%" >
				<next:EditGridPanel id="grid" stripeRows="true" width="100%" height="100%" dataset="somLiqpeopleDataSet">
					<next:TopBar>
					...
					<next:Columns>
						<next:RowNumberColumn />
						<next:RadioBoxColumn></next:RadioBoxColumn>
						<next:Column header="姓名" field="name" width="17%" sortable="true" editable="false"><next:TextField /></next:Column>
						<next:Column header="工作单位" field="workName" width="30%" sortable="true"  editable="false"></next:Column>
						<next:Column header="职务（职称）" field="workDuties" width="20%" sortable="true" editable="false"><next:TextField /></next:Column>
						<next:Column header="在清算组织中职务" field="liqDuties" width="20%"sortable="true" editable="false"><next:TextField /></next:Column>
						<next:Column header="清算组织负责人" field="ifChief" width="13%" sortable="true" editable="false" dataset="comm_yesorno"><next:TextField /></next:Column>
					</next:Columns>
					<next:BottomBar>
			...
			<next:Panel width="100%" title="成立电子档案查看">
				<next:Html>
				  <iframe id="uploadInfo1" src="../upload/somDownloadComm.jsp?sorgId=<%=request.getParameter("sorgId") %>&applyType=002"
			...
			<next:Panel width="100%" title="注销电子档案查看">
				<next:Html>
				  <iframe id="uploadInfo2" src="../upload/somDownloadComm.jsp?sorgId=<%=request.getParameter("sorgId") %>&applyType=004"
						frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="100%">
	   				</iframe>
				</next:Html>
			</next:Panel>
			...
			<form id="form_win" method="post" dataset="winPresidePeopleDataSet" onsubmit="return false" class="L5form">
				<table width="100%">
					<tr>
						...
						<td class="FieldInput" style="width:20%"><label field="cardType" dataset="cardTypeSelect" style="width:90%"/></td>
					...
					<tr>
						<td class="FieldLabel"><label>家庭住址：</label></td>
						<td class="FieldInput" colspan="3"><label field="adds" style="width:96.7%"/></td>
					...
					<tr>
						...
						<td class="FieldInput" colspan="3"><label field="otherDuties" style="width:97%"/></td>
					...
					<tr>
						<td class="FieldLabel"><label>本人简历：</label></td>
						<td class="FieldInput" colspan="5"><textarea  rows="10" field="resume" readonly="readonly" style="width:97.7%"></textarea></td>
					</tr>
					<tr>
						<td class="FieldLabel"><label>所在单位人事部门审查意见：</label></td>
					...
					<tr>
						<td class="FieldLabel"><label>备注：</label></td>
						<td class="FieldInput" colspan="5"><textarea rows="2" name='"备注"' field="memberNote" readonly="readonly" style="width:97.7%"></textarea></td>
					</tr>
				</table>
			</form>
		</next:Html>
...
<next:Window id="win2" title="查看清算人员"  resizable="false" width="500" height="162" closeAction="hide" autoScroll="true">
	<next:Panel id="panel_win">
		<next:Html>
			<form id="form_win" method="post" dataset="winLiqpeopleDataSet" onsubmit="return false" class="L5form">
				<table width="100%">
					<tr>
						...
						<td class="FieldInput" style="width:25%"><label field="ifChief" dataset="comm_yesorno"/></td>
					</tr>
					<tr>
						<td class="FieldLabel"><label>在清算组织中职务：</label></td>
						<td class="FieldInput"><label  field="liqDuties" /></td>
	...
	<next:Buttons>
		<next:ToolButton text="关闭窗口" handler="close"></next:ToolButton>
	</next:Buttons>
</next:Window>
</body>
</html>