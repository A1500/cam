...
<script type="text/javascript" src="groupRule.js"></script>
...
<body>
<model:datasets>
	<model:dataset id="somRuleDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomRuleQueryCmd" method="queryRule" sortField="createTime" sortDirection="DESC">
...
<next:EditGridPanel id="grid" dataset="somRuleDataSet" width="100%" stripeRows="true" height="99.9%">
	<next:TopBar>
		...
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
		<next:ToolBarItem iconCls="add" text="进行新的章程核准录入" handler="insert"></next:ToolBarItem>
		<next:ToolBarItem iconCls="edit" text="修改列表中选中的章程核准信息" handler="update"></next:ToolBarItem>
		<next:ToolBarItem iconCls="remove" text="删除选中的章程核准信息" handler="del"></next:ToolBarItem>
	...
	<next:Columns>
		...
		<next:Column header="会议时间" field="meetingDate" width="10%"></next:Column>
		<next:Column header="创建时间" field="createTime" width="15%"></next:Column>
