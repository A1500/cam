...
<script type="text/javascript" src="somGroupList.js"></script>
		...
		<form class="L5form">
				<table  border="1" width="100%">
					<tr>
						...
						<td class="FieldInput" style="width:45%"><input type="text" id="sorgCode" style="width:100%"/></td>
						<td class="FieldLabel" style="width:15%"><label>社团状态：</label></td>
...
<next:EditGridPanel id="grid" dataset="somOrganDataSet" width="100%" stripeRows="true" height="99.9%">
	<next:TopBar>
		<next:ToolBarItem symbol="社团主体列表"></next:ToolBarItem>
		...
		<next:ToolBarItem iconCls="detail" text="查询分支/代表机构" handler="branch"></next:ToolBarItem>
	...
	<next:Columns>
		...
		<next:Column field="cnName" header="社团名称" width="40%" sortable="true"></next:Column>
		<next:Column field="sorgStatus" header="社团状态" width="15%" sortable="true" dataset="sorgStatusSelect"></next:Column>
		<next:Column field="morgName" header="登记管理机关" width="23%" sortable="true"></next:Column>
	</next:Columns>
	<next:BottomBar>
