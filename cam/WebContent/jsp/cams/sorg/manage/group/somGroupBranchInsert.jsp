...
<%@ page import="org.loushang.next.skin.SkinUtils,com.inspur.cams.comm.util.IdHelp,com.inspur.cams.comm.util.StrUtil"%>
<html>
<head>
<title>社团分支/代表信息录入</title>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript" src="somGroupBranchInsert.js"></script>
<script type="text/javascript" src='<%=SkinUtils.getJS(request,"cams.js")%>'></script>
<script type="text/javascript" src='<%=SkinUtils.getJS(request,"camsCheck.js")%>'></script>
<script type="text/javascript" src='<%=SkinUtils.getJS(request,"My97DatePicker/WdatePicker.js") %>'></script>
<script type="text/javascript">
	<%String sorgId = IdHelp.getUUID30();%>
...
<model:datasets>
	...
	<model:dataset id="somOrganDataSet" cmd="com.inspur.cams.sorg.manage.cmd.SomGroupOrganQueryCmd">
...
<next:Panel width="100%" height="100%">
	<next:TopBar>
		<next:ToolBarItem symbol="分支/代表机构信息录入"></next:ToolBarItem>
	...
	<next:TabPanel id="tab" width="100%" height="100%" >
		<next:Tabs>
					...
					<form method="post" dataset="somOrganDataSet" onsubmit="return false"class="L5form">
						<table width="100%">
							<tr>
								...
								<td class="FieldInput" colspan="5"><input type="text"  id="mainSorgCode" name='"社团主体登记证号"' field="mainSorgCode" onchange="validateSorgCode()" style="width:98%"/><label style="color:red">*</label></td>
							</tr>
							<tr>
								<td class="FieldLabel"><label>社团主体名称：</label></td>
								<td class="FieldInput" colspan="5"><label id="name" style="width:98%"></label></td>
							</tr>
							<tr>
								<td class="FieldLabel"><label>机构登记证号：</label></td>
								<td class="FieldInput" colspan="5"><input type="text"  id="sorgCode" name='"机构登记证号"' field="sorgCode" onchange="sorgCodeUK()" style="width:98%"/><label style="color:red">*</label></td>
							</tr>
							<tr>
								<td class="FieldLabel"><label>机构名称：</label></td>
								<td class="FieldInput" colspan="5"><input type="text" id="cnName" name='"机构名称"' field="cnName" onchange="cnNameUK()" style="width:98%"/><label style="color:red">*</label></td>
							</tr>
							<tr>
			...
			<next:Panel title="电子档案上传" width="100%" >
				<next:Html>
				  <iframe id="uploadInfo" src="../upload/somUploadComm.jsp?sorgId=<%=sorgId %>&applyType=005"
