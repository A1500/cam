...
<html>
<head>
<title>社会团体举办实体备案</title>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript" src="groupEntityEdit.js"></script>
...
<next:Panel width="100%" height="100%" autoScroll="true">
	...
	<next:Tabs>
	<next:Panel title="社会团体举办实体备案" width="100%" >
		<next:Panel width="100%" height="100%" autoScroll="true">
	<next:Html>
		<form id="entityForm" method="post" dataset="somEntityDataSet" onsubmit="return false" class="L5form">
		<fieldset>
		<legend>社会团体举办实体备案</legend>
		<input type="hidden" field="id" name="举办实体ID"/>
		...
		<table width="100%">
			...
			<tr>
				<td class="FieldLabel">注册（或批准）时间：</td>
				<td class="FieldInput"><label field="registDate"/></td>
				<td class="FieldLabel">注册（或批准）证种类：</td>
				<td class="FieldInput"><label field="registCardType" /></td>
			</tr>
			<tr>
				<td class="FieldLabel">注册（或批准）证号码：</td>
				<td class="FieldInput"><label field="registCardCode"/></td>
				<td class="FieldLabel">注册（或批准）机关：</td>
				<td class="FieldInput"><label field="registOrgan"/></td>	
			</tr>
			<tr>
				<td class="FieldLabel">备案的主要文件：</td>
				<td class="FieldInput" colspan="3"><textArea name="recordFile" id="recordFile" field="recordFile" cols="75" rows="5" readonly="readonly" style="width:95%" ></textArea>
			</tr>
			<tr>
				<td class="FieldLabel">备注：</td>
				<td class="FieldInput" colspan="3"><textArea name="note" id="note" field="note" cols="75" rows="3" readonly="readonly" style="width:95%"></textArea></td>
			</tr>
			<tr>
