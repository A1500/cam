...
<script type="text/javascript" src="groupBranchManagePeople.js"></script>
...
<model:datasets>
	...
	<%--人员简历 --%>
	<model:dataset id="somResumeDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomPeopleResumeQueryCommand" method="commExecute"sortField="startDate" sortDirection="ASC" global="true">
				...
				<form id="peopleFrom" method="post" dataset="somDutyDataSet" onsubmit="return false" class="L5form">
					...
					<table width="100%">
						<tr>
							...
							<td class="FieldInput" style="width:21%"><input type="text" id="idCard" field="idCard" name='"身份证号码"' onblur="checkIdCardThisPage()" maxlength="18" style="width:90%"/><span style="color:red">*</span></td>
