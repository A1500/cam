...
<script type="text/javascript" src="somGroupCertInsert.js"></script>
...
<body>
<model:datasets>
		<model:dataset id="somGroupCertDataset" cmd="com.inspur.cams.sorg.manage.cmd.SomCertQueryCmd">
	...
	<model:dataset id="checkCertDataset" cmd="com.inspur.cams.sorg.manage.cmd.SomCertQueryCmd" global="true" >
...
<next:Panel width="100%">
	<next:TopBar>
		<next:ToolBarItem symbol="证书录入功能页面"></next:ToolBarItem>
	...
	<next:Html>
		<form method="post" onsubmit="return false" dataset="somGroupCertDataset" class="L5form">
		<table width="100%">
			<tr>
				<td class="FieldLabel" style="width: 10%;"><label>登记证号：</label></td>
				<td class="FieldInput" style="width: 10%;"><input type="text" name="登记证号"
					field="sorgCode" onblur="loadCertSorg('insert');" id="sorgCode" onkeyup="value=value.replace(/[^\-\\w\.\/]/ig,'').toUpperCase()" /><font
					color="red">*</font></td>
				...
				<td class="FieldInput" style="width: 10%;"><select style="display: none" name="证件类型"
					id="certType" field="certType"><option dataset="certType"></option></select></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<textarea rows="5"  id="businessForPrint" cols="150" style="height: 50px; overflow-y: visible"></textarea>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="FieldInput"><label  id="regDate"  field="regDate" /></td>
			</tr>
			<tr>
				<td class="FieldLabel" style="width:10%;"><label>有效期起：</label></td>
				<td class="FieldInput" style="width:10%;"><input name="有效期起" id="signBeginDate" type="text" format="Y-m-d"  field="signBeginDate" onclick="WdatePicker();" value=""></input><font color="red">*</font></td>
				<td class="FieldLabel" style="width:10%;"><label>有效期止：</label></td>
				<td class="FieldInput" style="width:10%;"><input name="有效期止" type="text" format="Y-m-d"  id="signEndDate" field="signEndDate" onclick="WdatePicker();"/><font color="red">*</font></td>
			...
			<tr>
				...
				<td class="FieldInput"><input name="发证日期" type="text" format="Y-m-d"  id="signDate" field="signDate" onclick="WdatePicker();"/><font color="red">*</font></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="FieldInput"><select field="certStatus" name="证件状态" id="certStatus" onchange="forChangeStatus();"><option dataset="certStatus"></option></select><font color="red">*</font></td>
				<td class="FieldLabel"><label>制证人：</label></td>
				<td class="FieldInput"><label field="printPeople" id="printPeople" /><font
					color="red">*</font></td>
			...
			<tr>
				...
				<td class="FieldInput"><input type="text" field="fetchDate" format="Y-m-d"  onclick="WdatePicker();"/></td>
				<td class="FieldLabel"><label>发证人</label></td>
				<td class="FieldInput"><label field="issuePeople" id="issuePeople"/></td>
			</tr>
			<tr id="receiveTr" style="display:none;">
				<td class="FieldLabel"><label>收缴标志：</label></td>
				<td class="FieldInput"><select field="ifReceive" id="ifReceive"><option dataset="ifReceive"></option></select></td>
				...
				<td class="FieldInput"><input type="text" field="receiveDate" format="Y-m-d"  onclick="WdatePicker();"/></td>
			</tr>
		</table>
