...
<html>
<head>
<title>社团主体信息修改</title>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript" src="somGroupUpdate.js"></script>
...
<next:Panel width="100%" height="100%">
	<next:TopBar>
		<next:ToolBarItem symbol="社团主体信息修改"></next:ToolBarItem>
	...
	<next:TabPanel id="tab" width="100%" height="100%"  activeTab="1" >
		<next:Tabs>
				...
				<next:Html>
					...
					<table width="100%">
						...
						<tr>
							...
							<td class="FieldInput">
								<select field="sorgKind" name='"社会团体类型"' style="width:90%">
				...
				<next:Html>
					...
					<table width="100%">
						<tr>
							...
							<td class="FieldInput" style="width:20%"><input type="text" id="name" name='"姓名"' field="name" style="width:90%"/><span style="color:red">*</span></td>
			...
			<next:Panel title="电子档案上传" width="100%" >
				<next:Html>
				  <iframe id="uploadInfo" src="../upload/somUploadComm.jsp?sorgId=<%=request.getParameter("sorgId") %>&applyType=002"
