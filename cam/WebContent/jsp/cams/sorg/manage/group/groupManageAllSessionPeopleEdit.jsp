...
<script type="text/javascript" src="groupManageAllSessionPeopleEdit.js"></script>
...
<model:datasets>
	...
	<model:dataset id="somCurrentSessionDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomSessionQueryCmd" method="getCurrentSession">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomSession"></model:record>
	</model:dataset>
