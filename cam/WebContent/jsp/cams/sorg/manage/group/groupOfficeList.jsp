...
<script type="text/javascript" src="groupOfficeList.js"></script>
			...
			<next:Panel title="办理过的办事机构备案" width="100%" height="100%">
				<next:EditGridPanel id="grid2" dataset="somOfficeDataSet" width="100%" stripeRows="true" height="99.9%">
					...
					<next:Columns>
						...
						<next:Column field="place" header="社会团体登记证号" width="30%" sortable="false"></next:Column>
