...
<script type="text/javascript" src="somGroupBranch.js"></script>
	...
	<next:TabPanel width="100%" height="100%"  activeTab="0" >
		<next:Tabs>
			...
			<next:Panel width="100%" title="成立电子档案查看">
				<next:Html>
				  <iframe id="uploadInfo" src="../upload/somDownloadComm.jsp?sorgId=<%=request.getParameter("sorgId") %>&applyType=005"
