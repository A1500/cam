...
<script type="text/javascript" src="groupFeeList.js"></script>
...
<model:datasets>
	...
	<model:dataset id="somFeeDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomFeeQueryCmd" method="queryFee" sortField="CREATE_TIME" sortDirection="DESC">
...
<next:TabPanel id="tab" activeTab="0" width="100%"  height="100%">
	<next:Tabs>
		<next:Panel title="办理新的备案" width="100%" height="100%">
			...
			<next:Panel title="办理过的会费标准备案" width="100%" height="100%">
				<next:EditGridPanel id="grid2" dataset="somFeeDataSet" width="100%" stripeRows="true" height="99.9%">
					<next:TopBar>
						<next:ToolBarItem symbol="->"></next:ToolBarItem>
					...
					<next:Columns>
						...
						<next:Column field="fee" header="社会团体名称" width="30%" sortable="false"></next:Column>
						<next:Column field="regDate" header="社会团体登记证号" width="30%" sortable="false"></next:Column>
