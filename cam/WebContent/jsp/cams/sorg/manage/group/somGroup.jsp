...
<script type="text/javascript" src="somGroup.js"></script>
	...
	<next:TabPanel id="tab" width="100%" height="100%"  activeTab="2">
		<next:Tabs>
				...
				<next:Html>
					...
					<table width="100%">
						...
						<tr>
							...
							<td class="FieldInput"><label   field="folk" dataset="folkSelect" style="width:90%"/></td>
			...
			<next:Panel width="100%" title="成立电子档案查看">
				<next:Html>
				  <iframe id="uploadInfo" src="../upload/somDownloadComm.jsp?sorgId=<%=request.getParameter("sorgId") %>&applyType=002"
