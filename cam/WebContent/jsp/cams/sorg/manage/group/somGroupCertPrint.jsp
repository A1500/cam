...
<script type="text/javascript" src="somGroupCertPrint.js"></script>
...
<next:Panel width="100%">
	...
	<next:Html>
		<form method="post" onsubmit="return false"
			dataset="somGroupCertDataset" class="L5form">
		...
		<table width="100%">
			<tr>
				...
				<td class="FieldInput" style="width: 10%;"><input type="text" name="登记证号"
					field="sorgCode" onchange="loadCertSorg('print');" id="sorgCode" /><font
					color="red">*</font></td>
				...
				<td class="FieldInput" style="width: 10%;"><select name="证件类型"
					id="certType" field="certType" onchange="forCheckR();">
			...
			<tr>
				...
				<td class="FieldInput" style="width: 10%;"><input
					id="signBeginDate" type="text" name="有效期起" format="Y-m-d" field="signBeginDate"
