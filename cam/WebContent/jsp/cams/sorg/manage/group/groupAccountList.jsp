...
<script type="text/javascript">
	...
	var applyType='<%=ApplyType.SOM_GROUP_ACCOUNT%>';
	<%
...
<script type="text/javascript" src="groupAccountList.js"></script>
...
<model:datasets>
	...
	<model:dataset id="somAccountDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomAccountQueryCmd" sortField="CREATE_TIME" sortDirection="DESC">
...
<next:TabPanel id="tab" activeTab="0" width="100%"  height="100%">
	<next:Tabs>
		...
		<next:Panel title="办理过的备案信息" width="100%" height="100%">
			<next:EditGridPanel id="grid2" dataset="somAccountDataSet" width="100%" stripeRows="true" height="99.9%">
				<next:TopBar>
					<next:ToolBarItem symbol="->"></next:ToolBarItem>
				...
				<next:Columns>
					...
					<next:Column field="sorgType" header="社会团体登记证号" width="30%" sortable="false"></next:Column>
