...
<next:Panel width="100%" height="100%">
	...
	<next:TabPanel id="tab" name="tabpanel-div" width="100%"  height="100%" activeTab="0">
		<next:Tabs>
			<next:Panel id="cbPanel" width="100%" title="社会团体法人注销登记表">
				<next:Html>
					...
					<table width="100%">
						...
						<tr>
							...
							<td class="FieldInput" style="width:17%"><label field="sorgKind" style="width:90%" dataset="sorgKindSelect"></td>
						...
						<tr>
							...
							<td class="FieldInput"><label field="legalPeople" style="width:90%"/></td>
							<td class="FieldLabel"><label>社团电话：</label></td>
							<td class="FieldInput" colspan="3"><label field="sorgPhone" style="width:90%"/></td>
						</tr>
						<tr>
							<td class="FieldLabel"><label>注销日期：</label></td>
							<td class="FieldInput" colspan="5"><input type="text" name='"注销日期"' field="cancelDate" format="Y-m-d" onclick="WdatePicker()" style="width:17.5%"/><span style="color:red">*</span></td>
						</tr>
						<tr>
			...
			<next:Panel title="清算组织人员" width="100%">
				<next:EditGridPanel id="grid_1" stripeRows="true" width="100%" height="100%" dataset="somLiqpeopleDataSet">
					...
					<next:Columns>
						...
						<next:Column header="清算组织负责人" field="ifChief" width="13%" editable="false" dataset="comm_yesorno"><next:TextField /></next:Column>
			...
			<next:Panel title="电子档案上传" width="100%" >
				<next:Html>
				  <iframe id="uploadInfo" src="../upload/somUploadComm.jsp?sorgId=<%=request.getParameter("sorgId") %>&applyType=004"
