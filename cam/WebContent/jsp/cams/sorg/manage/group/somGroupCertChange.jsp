...
<script type="text/javascript" src="somGroupCertChange.js"></script>
...
<next:Panel width="100%" height="100%" autoScroll="true">
	<next:TopBar>
		<next:ToolBarItem symbol="修改证书信息页面"></next:ToolBarItem>
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
		<next:ToolBarItem iconCls="save" text="完成换发" handler="saveChange"></next:ToolBarItem>
		<next:ToolBarItem iconCls="undo" text="返回" handler="returnList"></next:ToolBarItem>
	</next:TopBar>
	<next:Html>
		<form method="post" onsubmit="return false" class="L5form" dataset="somGroupCertDataset">
			<table width="100%">
			<tr>
				...
				<td class="FieldInput" style="width: 10%;"><select style="display: none" field="certType"  disabled="disabled"><option dataset="certType" ></option></select></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="FieldInput"><label  id="signOrgan" field="signOrgan"  readonly="readonly" value=""/></td>
			...
			<tr>
				...
				<td class="FieldInput"><input type="text" field="printPeople" /></td>
			...
			<tr>
				...
				<td class="FieldInput"><input type="text" field="issuePeople" /></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label>收缴标志:</label></td>
				<td class="FieldInput"><select field="ifReceive"><option dataset="ifReceive"></option></select></td>
