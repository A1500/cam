...
<script type="text/javascript" src="groupManagePeopleList.js"></script>
			...
			<next:Panel title="办理新的备案" width="100%" height="100%">
				...
				<next:GridPanel id="grid" dataset="somOrganDataSet" width="100%" stripeRows="true" height="99.9%">
					<next:TopBar>
						...
						<next:ToolBarItem iconCls="view" text="查看历史届次负责人信息" handler="his"></next:ToolBarItem>
						<next:ToolBarItem symbol="->"></next:ToolBarItem>
						<next:ToolBarItem iconCls="add" text="负责人备案" handler="manage"></next:ToolBarItem>
					</next:TopBar>
					<next:Columns>
