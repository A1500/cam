...
<script type="text/javascript" src="groupManagePeople.js"></script>
						...
						<form id="form2" dataset="somSessionDataSet" onsubmit="return false" class="L5form">
							...
							<table width="100%">
								...
								<tr>
									...
									<td class="FieldInput" colspan="3"><input type="text" id="sessionName" field="sessionName" name='"届次名称"' style="width:90%" onclick="showMeeting()"/><span style="color:red">*</span></td>
								...
								<tr>
									...
									<input type="text" id="startDate" field="startDate" onClick="WdatePicker()" style="width:90%" onchange="setEndDate()"/>
									</td>
									<td class="FieldLabel" style="width:17%">章程规定换届日期：</td>
									<td class="FieldInput" style="width:15%">
									<input type="text" id="endDate" field="endDate" onClick="WdatePicker()" style="width:90%"/>
									</td>
