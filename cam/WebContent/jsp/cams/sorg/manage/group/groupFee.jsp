...
<script type="text/javascript" src="groupFee.js"></script>
...
<body>
<model:datasets>
	<model:dataset id="somFeeDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomFeeQueryCmd" method="queryFee"  sortField="createTime" sortDirection="DESC">
...
<next:EditGridPanel id="grid" dataset="somFeeDataSet" width="100%" stripeRows="true" height="99.9%">
	<next:TopBar>
		<next:ToolBarItem symbol="会费信息"></next:ToolBarItem>
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
		<next:ToolBarItem iconCls="add" text="进行新的备案备案" handler="insert"></next:ToolBarItem>
		<next:ToolBarItem iconCls="edit" text="修改选中的备案信息" handler="update"></next:ToolBarItem>
	...
	<next:Columns>
		...
		<next:Column header="创建时间" field="createTime" width="10%"></next:Column>
		<next:Column header="会费标准ID" field="feeId" hidden="true"></next:Column>
		<next:Column header="业务编号" field="taskCode" hidden="true"></next:Column>	
	</next:Columns>
	<next:BottomBar>
		<next:PagingToolBar dataset="somFeeDataSet"/>
	</next:BottomBar>
</next:EditGridPanel>
</body>
</html>