...
<script type="text/javascript" src="groupManageAllSessionPeople.js"></script>
...
<body>
<model:datasets>
	<model:dataset id="somSessionDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomSessionQueryCmd"  sortField="createTime" sortDirection="DESC">
...
<next:EditGridPanel id="sessionGrid" dataset="somSessionDataSet" width="100%" stripeRows="true" height="100%">
	<next:TopBar>
		...
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
		<next:ToolBarItem iconCls="add" text="录入新一届负责人信息" handler="insert"></next:ToolBarItem>		
		<next:ToolBarItem iconCls="detail" text="修改选中届次负责人信息" handler="hisManage"></next:ToolBarItem>		
		<next:ToolBarItem iconCls="remove" text="删除选中届次负责人信息" handler="del"></next:ToolBarItem>
	</next:TopBar>
	<next:Columns>
