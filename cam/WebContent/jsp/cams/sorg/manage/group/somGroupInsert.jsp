...
<html>
<head>
<title>社团主体信息录入</title>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript" src="somGroupInsert.js"></script>
<script type="text/javascript" src='<%=SkinUtils.getJS(request,"cams.js")%>'></script>
<script type="text/javascript" src='<%=SkinUtils.getJS(request,"camsCheck.js")%>'></script>
<script type="text/javascript" src='<%=SkinUtils.getJS(request,"L5-webext-searhelp_5.0.0.js")%>'></script>
...
<model:datasets>
	...
	<model:dataset id="somOrganDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomOrganQueryCmd" >
		...
		<%--社团基本信息验证 --%>
			...
			<model:field name="actArea" type="string" rule="require|length{50}" />
			...
			<model:field name="councilNum" type="string" rule="require|integer" />
			<model:field name="standCouncilNum" type="string" rule="require|integer" />
	...
	<%--法定代表人--%>
	<model:dataset id="somDeputyPeopleDataSet" cmd="com.inspur.cams.sorg.manage.cmd.SomGroupPeopleQueryCmd" method="queryPeopleByParam">
	...
	<%--所有符合身份证号的人员列表--%>
	<model:dataset id="winPeopleDataSet" cmd="com.inspur.cams.sorg.manage.cmd.SomGroupPeopleQueryCmd" method="queryPeopleByIdCard" pageSize="4">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomPeople"></model:record>
	</model:dataset>
	<%--所有符合身份证号的人员所在社会组织信息--%>
	<model:dataset id="winMemberDataSet" cmd="com.inspur.cams.sorg.manage.cmd.SomGroupPeopleQueryCmd" method="queryMemberByPeopleId" pageSize="6">
...
<next:Panel width="100%" height="100%">
	<next:TopBar>
		<next:ToolBarItem symbol="社团主体信息录入"></next:ToolBarItem>
	...
	<next:TabPanel id="tab" width="100%" height="100%"  activeTab="1" >
		<next:Tabs>
			<next:Panel title="社会团体法人登记表" width="100%" autoScroll="true">
				<next:Html>
					...
					<table width="100%">
						...
						<tr>
							...
							<td class="FieldInput" colspan="5"><input type="text" id="cnName" name='"社团名称/中文"' field="cnName" onchange="cnNameUK()" style="width:98%"/><span style="color:red">*</span></td>
						</tr>
						<tr>
							<td class="FieldLabel"><label>社团名称/英文：</label></td>
							<td class="FieldInput" colspan="3"><input type="text" name='"社团名称/英文"' field="enName" style="width:97%"/></td>
							<td class="FieldLabel"><label>社团名称/缩写：</label></td>
							<td class="FieldInput"><input type="text" field="abName" name='"社团名称/缩写"' style="width:90%"/></td>
						</tr>
						<tr>
							...
							<td class="FieldInput">
								<select id="sorgKind" field="sorgKind" name='"社会团体类型"' style="width:90%">
						...
						<tr>
							...
							<td class="FieldLabel" style="width:17%"><label>社团邮编：</label></td>
							<td class="FieldInput" style="width:17%"><input type="text" id="sorgPost" name='"社团邮编"' field="sorgPost" style="width:90%"/><span style="color:red">*</span></td>
							<td class="FieldLabel" style="width:15%"><label>社团传真：</label></td>
						...
						<tr>
							...
							<td class="FieldInput" colspan="5"><input type="text" id="sorgPhone" name='"社团电话"' field="sorgPhone" style="width:59%"/><span style="color:red">*说明：多个电话，中间用英文分号隔开</span></td>
						</tr>
						<tr>
							<td class="FieldLabel"><label>活动地域：</label></td>
							<td class="FieldInput" colspan="5"><input type="text" name='"活动地域"' field="actArea" style="width:98%" /><span style="color:red">*</span></td>
						</tr>
						<tr>
							<td class="FieldLabel"><label>社团宗旨：</label></td>
							<td class="FieldInput" colspan="5"><textarea rows="10" name='"社团宗旨"' field="purpose" style="width:98%"></textarea><span style="color:red">*</span></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" id="unitsNum" name='"单位会员数"' field="unitsNum" maxlength="6" style="width:90%"/><span style="color:red">*</span></td>
							<td class="FieldLabel"><label>个人会员数：</label></td>
							<td class="FieldInput"><input type="text" id="peopleNum" name='"个人会员数"' field="peopleNum" maxlength="6" style="width:90%"/><span style="color:red">*</span></td>
							<td class="FieldLabel"><label>理事数：</label></td>
							<td class="FieldInput"><input type="text" name='"理事数"' field="councilNum" maxlength="6" style="width:90%"><span style="color:red">*</span></td>
						</tr>
						<tr>
							<td class="FieldLabel"><label>常务理事数：</label></td>
							<td class="FieldInput"><input type="text" name='"常务理事数"' field="standCouncilNum" maxlength="6" style="width:90%"/><span style="color:red">*</span></td>
							<td class="FieldLabel"><label>活动资金数额：</label></td>
							<td class="FieldInput" colspan="3"><input type="text" id="regMon" name='"活动资金数额"' field="regMon" maxlength="10" style="width:30%"/>万元<span style="color:red">*</span></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="FieldInput" colspan="5"><input type="text" name='"经费来源"' field="moneySource" style="width:98%"/><span style="color:red">*</span></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="FieldInput" colspan="5"><input type="text" name='"社团通信地址"' field="sorgAdds" style="width:98%"/></td>
						</tr>
						<tr>
							...
							<td class="FieldInput"><input type="text" name='"社团电子邮箱"' field="sorgEmail" style="width:90%"/></td>
						</tr>
					</table>
					</form>
				</next:Html>
			...
			<next:Panel id="panel_legal" title="社会团体法定代表人登记表"  width="100%" autoScroll="true">
				<next:Html>
					...
					<table width="100%">
						<tr>
							...
							<td class="FieldInput" style="width:20%"><input type="text"   id="idCard" name='"身份证号"' field="idCard" onchange="validateIdcard()" style="width:90%"/><span style="color:red">*</span></td>
							...
							<td class="FieldInput" style="width:20%"><input type="text" name='"曾用名"' field="aliasName" style="width:90%"/></td>
						...
						<tr>
							...
							<td class="FieldLabel"><label>是否在其他社团担任法定代表人：</label></td>
							<td class="FieldInput">
								<select field="ifLegal" name='"是否在其他社团担任法定代表人"' style="width:90%">
									<option dataset="comm_yesorno"></option>
								</select><span style="color:red">*</span>
							</td>
						...
						<tr>
							...
							<td class="FieldInput" colspan="3"><input type="text" name='"单位职务"'  field="workDuties" style="width:96.5%"/></td>
						...
						<tr>
							<td class="FieldLabel"><label>按照本社团章程会议产生通过情况：</label></td>
							<td class="FieldInput" colspan="5"><textarea   rows="2" name='"按照本社团章程会议产生通过情况"' field="sorgOpinion" style="width:97.7%"></textarea><span style="color:red">*</span></td>
						</tr>
						<tr>
			...
			<next:Panel title="电子档案上传" width="100%" >
				<next:Html>
				  <iframe id="uploadInfo" src="../upload/somUploadComm.jsp?sorgId=<%=sorgId %>&applyType=002"
