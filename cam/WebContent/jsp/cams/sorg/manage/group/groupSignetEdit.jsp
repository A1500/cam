...
<html>
<head>
<title>社会团体印章备案</title>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript" src="groupSignetEdit.js"></script>
...
<next:Panel width="100%" autoScroll="true">
	...
	<next:TabPanel width="100%" height="100%" id="tab">
		<next:Tabs>
			<next:Panel title="社会团体印章备案" width="100%" >
					...
					<next:Html>
						...
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput" ><input type="text" name="领章人" field="fetchPeople" style="width:90%"/></td>
