...
<head>
<next:ScriptManager/>
<script type="text/javascript" src="somPartyMemberUpdate.js"></script>
<script type="text/javascript" src="querySorgOrganMess.js"></script>
...
<next:Panel width="100%" height="100%" >
	...
	<next:Html>
		...
		<table width="100%">
			...
			<input type="hidden" id="memberId" field="memberId"/>
			<tr>
				...
				<td class="FieldInput" >
					<select id="sorgType"disabled style="width:90%"><option dataset="sorgTypeDS"></option></select>
						...
						<tr>
							...
							<td class="FieldInput"><select name='性别' id="sex" field="sex" style="width: 90%"><option dataset="SEX"></option></select><span style='color:red'>*</span></td>
