...
<script type="text/javascript">
	...
	var ifFullSystemIn='<%=request.getParameter("ifFullSystemIn")%>';
	var ifIn='<%=request.getParameter("ifIn")%>';
</script>
</head>
<body>
<model:datasets>
	...
	<model:dataset id="somPartyQueryDataSet"  cmd="com.inspur.cams.sorg.manage.cmd.SomPartyQueryCmd" >
...
<next:Panel width="100%" height="100%" >
	<next:TopBar>
			...
			<next:ToolBarItem  iconCls="save" text="保存" handler="savePartyMember" ></next:ToolBarItem>
			...
			<next:Html>
				...
				<table width="100%">
					...
					<tr>
						...
						<td class="FieldInput" width="21%"><input type="text" id="sorgCode" onchange="querySorgOrganMess();" style="width: 90%"/><font color="red">*</font></td>
						<td class="FieldLabel" width="14%"><label>社会组织类型:</label></td>
						<td class="FieldInput" width="19%"><select id="sorgType"  style="width:90%" onchange="querySorgOrganMess();" ><option dataset="sorgTypeDS" ></option></select></td>
						<td class="FieldLabel" width="14%"><label>社会组织名称:</label></td>
						<td class="FieldInput" width="18%"><label id="sorgName"></label></td>
					</tr>
					<tr>
						<td class="FieldLabel" width='14%'><label>身份证号：</label></td>
						<td class="FieldInput" width='21%'><input type="text" name="身份证号" id="idCard" field="idCard" onchange="doCheckIdCard()" style="width:90%"/><span style='color:red'>*</span></td>
						<td class="FieldLabel" width='14%'><label>姓名：</label></td>
						<td class="FieldInput" width='18%'><input type="text" name="姓名" id="name_partyMember" field="name" style="width:90%" /><font color="red">*</font></td>
					...
					<tr>
						...
						<td class="FieldInput"><select name='性别' id="sex" field="sex" style="width: 90%"><option dataset="SEX"></option></select><font color="red">*</font></td>
						<td class="FieldLabel"><label>出生日期:</label></td>
						<td class="FieldInput"><input name='出生日期' field="birthday" type="text" id="birthday" format="Y-m-d" onclick="WdatePicker();" style="width: 90%"/><font color="red">*</font></td>
					...
					<tr>
						...
						<td class="FieldInput" width="18%"><select name='专职/兼职' id="ifFulltime" field="ifFulltime" style="width: 90%"><option dataset="ifFullTimeDS"></option></select><span style='color:red'>*</span></td>
				...
				<div id="fullSystemInDiv" style="display:none;">
					...
					<table width="100%">
						<tr>
							...
							<td class="FieldInput"  width="21%"><select id="inType" field='inType'  style="width: 90%" disabled="disabled"><option dataset='inTypeSelect'></option></select></td>
							<td class="FieldLabel"  width="14%"><label>转入时间:</label></td>
							<td class="FieldInput"  width="18%"><input type="text" name="转入时间" id="inTime" format="Y-m-d"  field="inTime" onclick="WdatePicker();" style="width: 90%"/><font color="red">*</font></td>
							<td class="FieldLabel"  width="14%"><label>从何单位转入:</label></td>
							<td class="FieldInput"  width="19%"><input type="text" name="从何单位转入" id="inFromOrgan" field="inFromOrgan" style="width: 90%"/><font color="red">*</font></td>
						</tr>
					</table>
					</fieldset>
				</div>
				...
				<fieldset>
					...
					<table width="100%">
						<tr>
							...
							<td class="FieldInput" width="19%"><select name="跨支部党员标识" id="ifOtherBranch" field="ifOtherBranch" style="width: 90%"><option dataset='comm_yesorno'/></select></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="FieldInput" width="21%"><input name='申请入党日期' type="text" id="applicationDate" field="applicationDate" format="Y-m-d" onclick="WdatePicker();" style="width: 90%"/></td>
