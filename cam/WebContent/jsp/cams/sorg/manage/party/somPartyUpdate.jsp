...
<title>党建情况登记表</title>
<next:ScriptManager />
<script type="text/javascript" src="somPartyUpdate.js"></script>
	...
	<next:Html>
		...
		<table width="100%">
			...
			<tr>
				...
				<td class="FieldInput"><select   id="inType" field='inType'  style="width: 95%" onchange="showInInfo()" disabled="disabled"><option dataset='inTypeSelect'></option></select></td>
		...
		<div id="buildDiv" style="display:block;">
				...
				<table width="100%">
					...
					<tr>
						...
						<td class="FieldInput"><select name="党组织类别" id="buildType" field="buildType" onchange="showCombined(this.options[this.options.selectedIndex]);" style="width: 95%"><option dataset="build_type"></option></select><font color="red">*</font></td>
					...
					<tr>
						...
						<td class="FieldInput"><select id="belongRel" field="belongRel" onchange="showBelongRel(this.options[this.options.selectedIndex]);" style="width: 95%"><option dataset="belong_rel"></option></select><font color="red">*</font></td>
...
<!-- 未建党组织 -->
			<div id="unfoundedDiv" style="display:none;">
				...
				<table width="100%">
					...
					<tr>
						...
						<td class="FieldInput"><input type="text" name="负责人党员数" id="" field="" style="width: 95%"/></td>
						<td class="FieldLabel"><label>党员总数:</label></td>
			...
			<next:EditGridPanel id="partyChangeGrid" dataset="somPartyChangeDataSet" stripeRows="true" title="变更情况" height="100%" >
				<next:TopBar>
					<next:ToolBarItem symbol="->"></next:ToolBarItem>
					<next:ToolBarItem symbol="->"></next:ToolBarItem>
					<next:ToolBarItem text="增加变更" iconCls="add" handler="addChange"></next:ToolBarItem>
					<next:ToolBarItem text="删除变更" iconCls="remove" handler="delChange"></next:ToolBarItem>
					<next:ToolBarItem iconCls="upload" text="增加上传附件" handler="uploadFile_change"></next:ToolBarItem>
				</next:TopBar>
				<next:Columns>
					<next:RowNumberColumn/>
					<next:RadioBoxColumn></next:RadioBoxColumn>
					<next:Column header="内码" field="changeId" width="15%" editable="true" hidden="true"><next:TextField/></next:Column>
					<next:Column header="变更日期" field="changeDate" width="10%" editable="true" ><next:TextField /></next:Column>
					<next:Column header="变更内容" field="changeItem" width="15%" editable="true" ><next:ComboBox  dataset="somPartyChangeItemSelect"/></next:Column>
					<next:Column header="变更前" field="changeBefore" width="25%"editable="true"><next:TextField/></next:Column>
					<next:Column header="变更后" field="changeAfter" width="25%" editable="true"><next:TextField/></next:Column>
					<next:Column header="审批文件号" field="auditFileNo" width="15%" editable="true"><next:TextField/></next:Column>
					<next:Column header="审批文件" field="auditFile" width="25%" editable="true"><next:TextField/></next:Column>
