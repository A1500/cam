...
<script type="text/javascript" src="ungovOfficeList.js"></script>
	...
	<next:Tabs>
		<next:Panel title="办理新的备案" width="100%" height="100%">
			...
			<next:Panel title="办理过的办事机构备案" width="100%" height="100%">
				<next:EditGridPanel id="grid2" dataset="somOfficeDataSet" width="100%" stripeRows="true" height="99.9%">
					<next:TopBar>
						<next:ToolBarItem symbol="->"></next:ToolBarItem>
					...
					<next:Columns>
						...
						<next:Column field="place" header="民办非企业单位登记证号" width="30%" sortable="false"></next:Column>
