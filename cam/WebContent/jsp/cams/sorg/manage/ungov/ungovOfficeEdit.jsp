						...
						<form id="officeForm" method="post" dataset="somOfficeDataSet" onsubmit="return false" class="L5form">
							...
							<table width="100%">
								...
								<tr>
									...
									<td class="FieldInput"><input type="text" name="内设机构名称" id="name" field="name" maxlength="100" style="width:90%"/></td>
									<td class="FieldLabel">场所：</td>
									<td class="FieldInput" colspan="3"><input type="text" name="场所" id="place" field="place" maxlength="100" style="width:96.5%"/></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="FieldInput" colspan="5"><textarea type="text" name="职能" id="dutiesDesc" field="dutiesDesc" cols="75" rows="5" style="width:98%"></textarea></td>
								</tr>
								<tr>
