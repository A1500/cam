...
<html>
<head>
<title>民办非企业单位明细</title>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript" src="somUngov2.js"></script>
...
<next:Panel width="100%" height="100%">
	...
	<next:TabPanel id="tab" name="tabpanel-div" width="100%"  height="100%" activeTab="2">
		<next:Tabs>
			...
			<next:Panel width="100%" title="成立电子档案查看">
				<next:Html>
				  <iframe id="uploadInfo1" src="../upload/somDownloadComm.jsp?sorgId=<%=request.getParameter("sorgId") %>&applyType=101"
			...
			<next:Panel width="100%" title="注销电子档案查看">
				<next:Html>
				  <iframe id="uploadInfo2" src="../upload/somDownloadComm.jsp?sorgId=<%=request.getParameter("sorgId") %>&applyType=103"
						frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="100%">
	   				</iframe>
				</next:Html>
			</next:Panel>
...
<next:Window id="propleWin" title="查看主要负责人"  resizable="false" width="740" height="376" closeAction="hide" autoScroll="true">
...
<next:Window id="win" title="查看清算人员"  resizable="false" width="500" height="162" closeAction="hide" autoScroll="true">
	<next:Panel id="panel_win">
		<next:Html>
