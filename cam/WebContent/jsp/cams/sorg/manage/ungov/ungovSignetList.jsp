...
<script type="text/javascript" src="ungovSignetList.js"></script>
...
<model:datasets>
	...
	<model:dataset id="somSignetDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomSignetQueryCmd" global="true">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomSignet"></model:record>
	</model:dataset>
	<model:dataset id="sorgKindDS" cmd="com.inspur.cams.comm.dicm.DicQueryCmd" global="true" autoLoad="true">
		...
		<next:Panel title="办理新的备案" width="100%" height="100%">
			...
			<next:EditGridPanel id="grid" dataset="somOrganDataSet" width="100%" stripeRows="true" height="99.9%">
				...
				<next:Columns>
					...
					<next:Column field="sorgKind" header="组织类型" width="15%" sortable="false" editable="false"><next:ComboBox dataset="sorgKindDS"/></next:Column>
			...
			<next:Panel title="办理过的印章备案信息" width="100%" height="100%">
				<next:EditGridPanel id="grid2" dataset="somSignetDataSet" width="100%" stripeRows="true" height="99.9%">
					<next:TopBar>
						<next:ToolBarItem symbol="->"></next:ToolBarItem>
					...
					<next:Columns>
						<next:RowNumberColumn></next:RowNumberColumn>
						<next:RadioBoxColumn></next:RadioBoxColumn>
						<next:Column field="signetDate" header="民办非企业单位名称" width="30%" sortable="false"></next:Column>
						<next:Column field="fetchPeople" header="民办非企业单位登记证号" width="30%" sortable="false"></next:Column>
