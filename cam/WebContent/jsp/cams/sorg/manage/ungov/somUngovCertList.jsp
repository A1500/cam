...
<script type="text/javascript" src="somUngovCertList.js"></script>
...
<body>
<model:datasets>
	<model:dataset id="somUngovCertDataset"cmd="com.inspur.cams.sorg.manage.cmd.SomCertQueryCmd" pageSize="10" autoLoad="false">
...
<next:Panel width="100%" border="0">
	<next:Html>
		...
		<table width="100%">
			<tr>
				<td class="FieldLabel"><label>民办非企业单位名称：</label></td>
...
<next:EditGridPanel id="hlistPanel" dataset="somUngovCertDataset" enableHdMenu="true" height="99.9%" width="100%">
	<next:TopBar>
		<next:ToolBarItem text='' id="displayItem" />
		<next:ToolBarItem symbol="民办非企业单位证书信息"></next:ToolBarItem>
	...
	<next:Columns>
		...
		<next:Column header="民办非企业单位名称" field="sorgName" sortable="true"editable="false" renderer="jtxxDetailHref" width="25%"><next:TextField/></next:Column>
	...
	<next:BottomBar>
		<next:PagingToolBar dataset="somUngovCertDataset" />
	</next:BottomBar>
</next:EditGridPanel>
...
<next:Window id="Cert" closeAction="hide" title="证书详细信息" width="700" height="400" autoScroll="true">
	<next:TopBar>
		<next:ToolBarItem text='' id="displayItem" />
		<next:ToolBarItem symbol="民办非企业单位证书明细"></next:ToolBarItem>
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
