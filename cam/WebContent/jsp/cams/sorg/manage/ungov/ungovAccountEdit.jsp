...
<model:datasets>
	<model:dataset id="somAccountDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomAccountQueryCmd">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomAccount">
			<model:field name="accountCode" type="string" rule="require|length{30}"/>
			<model:field name="bankAdds" type="string" rule="length{100}"/>
...
<next:TopBar>
	...
	<next:TabPanel id="tabSomOrgan" width="100%" height="100%">
		<next:Tabs>
			<next:Panel title="民办非企业单位帐户备案" width="100%" height="100%" autoScroll="true">
				<next:Html>
						...
						<fieldset>
							...
							<table width="100%">
								...
								<tr>
									...
									<td class="FieldInput" colspan="3"><textarea name="开户理由" id="reason" field="reason" cols="75" rows="15" style="width:95%"></textarea></td>
								</tr>
								<tr>
								...
								<tr>
									<td class="FieldInput" colspan="4"><font color="red">说明：开户理由的内容，必须在500字符之内！</font></td>
								</tr>
							</table>
						</fieldset>
					</form>
