...
<script type="text/javascript" src="somUngovCertInsert.js"></script>
...
<body>
<model:datasets>
	<model:dataset id="somUngovCertDataset"
	...
	<model:dataset id="somOrganDataset"
		...
		<model:params>
			<model:param name="sorg_type" value='M'></model:param>
...
<next:Panel title="民办非企业组织证书录入功能页面" width="100%">
	<next:Html>
		<form method="post" onsubmit="return false"
			dataset="somUngovCertDataset" class="L5form">
	<table width="100%">
			<tr>
			...
			<tr>
				...
				<td class="FieldLabel"><label>开办资金(万元)：</label></td>
			...
			<tr>
				...
				<td class="FieldInput"><select field="certStatus" id="certStatus"  onchange="forChangeStatus();" name="证件状态"><option dataset="certStatus"></option></select><font color="red">*</font></td>
				<td class="FieldLabel"><label>制证人：</label></td>
				<td class="FieldInput"><label id="printPeople" field="printPeople" /><font
					color="red">*</font></td>
