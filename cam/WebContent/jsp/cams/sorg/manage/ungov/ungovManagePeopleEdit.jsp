...
<body>
<model:datasets>
	<model:dataset id="somSessionDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomSessionQueryCmd" method="getCurrentSession">
...
<next:Panel width="100%" autoScroll="true">
	...
	<next:TabPanel id="tabSomOrgan" width="100%" height="100%">
		<next:Tabs>
			<next:Panel title="民办非企业单位负责人备案表" width="100%" height="100%" autoScroll="true">
				<next:Panel>
					<next:Html>
						...
						<form id="form2" dataset="somSessionDataSet" onsubmit="return false" class="L5form">
							...
							<table width="100%">
								...
								<tr>
									...
									<td class="FieldInput" colspan="3"><input type="text" id="sessionName" field="sessionName" name='"届次名称"' style="width:90%"/></td>
									<td class="FieldLabel">本届任期（年）：</td>
									<td class="FieldInput"><input type="text" id="tenure" field="tenure" name='"本届任期（年）"' onchange="setEndDate()" style="width:90%"/></td>
								</tr>
								<tr>
									<td class="FieldLabel" style="width:17%">本届开始日期：</td>
									<td class="FieldInput" style="width:17%"><input type="text" id="startDate" field="startDate" name='"本届开始日期"' onblur="setEndDate()" format="Y-m-d" onclick="WdatePicker()" style="width:90%"/></td>
									<td class="FieldLabel" style="width:17%">章程规定换届日期：</td>
									<td class="FieldInput" style="width:15%"><input type="text" id="endDate" field="endDate" name='"章程规定换届日期"' format="Y-m" onclick="WdatePicker()" style="width:90%"/></td>
...
<jsp:include page="../../comm/people/ungovPeopleEdit.jsp" flush="true"/>
</body>
</html>