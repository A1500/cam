...
<script type="text/javascript" src="ungovAccountList.js"></script>
		...
		<next:Panel title="办理过的备案信息" width="100%" height="100%">
			<next:EditGridPanel id="grid2" dataset="somAccountDataSet" width="100%" stripeRows="true" height="99.9%">
				...
				<next:Columns>
					<next:RowNumberColumn></next:RowNumberColumn>
					<next:RadioBoxColumn></next:RadioBoxColumn>
					<next:Column field="name" header="民办非企业单位名称" width="30%" sortable="false"></next:Column>
					<next:Column field="sorgType" header="民办非企业单位登记证号" width="30%" sortable="false"></next:Column>
