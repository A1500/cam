...
<script type="text/javascript" src="somUngovCertPrint.js"></script>
...
<next:Panel width="100%">
	...
	<next:Html>
		<form method="post" onsubmit="return false" dataset="somUngovCertDataset" class="L5form">
		<fieldset><legend>证书相关内容</legend>
	<table width="100%">
			<tr>
				<td class="FieldLabel" style="width: 10%;"><label>登记证号：</label></td>
				<td class="FieldInput" style="width: 10%;"><input type="text" name="登记证号" field="sorgCode" onblur="loadCertSorg('print');" id="sorgCode" /><font color="red">*</font></td>
