...
<script type="text/javascript" src="ungovOfficeEdit.js"></script>
...
<next:Panel width="100%" autoScroll="true">
	...
	<next:TabPanel width="100%" height="100%" id="tab">
		<next:Tabs>
			<next:Panel title="民办非企业单位内设机构备案" width="100%" >
					...
					<next:Html>
						<form id="officeForm" method="post" dataset="somOfficeDataSet" onsubmit="return false" class="L5form">
							...
							<table width="100%">
								...
								<tr>
									<td class="FieldLabel">职能：</td>
									<td class="FieldInput" colspan="5"><textarea type="text" name="职能" id="dutiesDesc" field="dutiesDesc" cols="75" rows="5" style="width:98%;background-color:#F5FAFA;border:0;overflow:auto;" readonly></textarea></td>
								</tr>
								<tr>
									<td class="FieldLabel">设立理由：</td>
									<td class="FieldInput" colspan="5"><textarea type="text" name="设立理由" id="reason" field="reason" cols="75" rows="4" style="width:98%;background-color:#F5FAFA;border:0;overflow:auto;"readonly></textarea></td>
								</tr>
								<tr>
