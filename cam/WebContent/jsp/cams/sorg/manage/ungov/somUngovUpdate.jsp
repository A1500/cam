...
<html>
<head>
<title>民办非企业单位信息修改</title>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript" src="somUngovUpdate.js"></script>
...
<model:datasets>
	...
	<model:dataset id="somOrganDataSet" cmd="com.inspur.cams.sorg.manage.cmd.SomUngovOrganQueryCmd" method="queryMain">
		...
		<%--单位基本信息验证 --%>
			...
			<model:field name="business" type="string" rule="require|length{100}" />
...
<next:Panel width="100%" height="100%">
	<next:TopBar>
		<next:ToolBarItem symbol="民办非企业单位信息修改"></next:ToolBarItem>
	...
	<next:TabPanel id="tab" width="100%" height="100%"  activeTab="1" >
		<next:Tabs>
			...
			<next:Panel title="电子档案上传" width="100%" >
				<next:Html>
				  <iframe id="uploadInfo" src="../upload/somUploadComm.jsp?sorgId=<%=request.getParameter("sorgId") %>&applyType=101"
