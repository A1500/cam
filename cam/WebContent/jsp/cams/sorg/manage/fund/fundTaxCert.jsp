...
<script type="text/javascript" src="fundTaxCert.js"></script>
...
<body>
<model:datasets>
	<model:dataset id="somTaxCertDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomTaxRegistrationCertQueryCmd" global="true" sortField="regDate" sortDirection="desc">
...
<next:EditGridPanel id="grid" dataset="somTaxCertDataSet" width="100%" stripeRows="true" height="99.9%">
	<next:TopBar>
		<next:ToolBarItem symbol="税务登记证备案信息"></next:ToolBarItem>
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
	...
	<next:Columns>
		...
		<next:Column header="税务登记证号" field="certNo" width="10%"></next:Column>
	...
	<next:BottomBar>
		<next:PagingToolBar dataset="somTaxCertDataSet"/>
	</next:BottomBar>
</next:EditGridPanel>
</body>
</html>