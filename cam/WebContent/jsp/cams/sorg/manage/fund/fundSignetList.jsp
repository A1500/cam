...
<script type="text/javascript" src="fundSignetList.js"></script>
			...
			<next:Panel title="办理过的印章备案信息" width="100%" height="100%">
				<next:EditGridPanel id="grid2" dataset="somSignetDataSet" width="100%" stripeRows="true" height="99.9%">
					...
					<next:Columns>
						<next:RowNumberColumn></next:RowNumberColumn>
						<next:RadioBoxColumn></next:RadioBoxColumn>
						<next:Column field="signetDate" header="基金会名称" width="30%" sortable="false"></next:Column>
						<next:Column field="fetchPeople" header="基金会登记证号" width="30%" sortable="false"></next:Column>
