...
<script type="text/javascript" src="somFundInsert.js"></script>
...
<model:datasets>
	<%--基本信息--%>
	<model:dataset id="somOrganDataSet" cmd="com.inspur.cams.sorg.manage.cmd.SomFundOrganQueryCmd" >
...
<next:Panel width="100%" height="100%">
	<next:TopBar>
		<next:ToolBarItem symbol="基金会信息录入"></next:ToolBarItem>
	...
	<next:TabPanel id="tab" width="100%" height="100%"  activeTab="1" >
		<next:Tabs>
				...
				<next:Html>
					...
					<table width="100%">
						...
						<tr>
							...
							<td class="FieldInput" colspan="3"><input type="text" id="organCode" name='"组织机构代码"' field="organCode" style="width:97%" onchange="organCodeUK()"/></td>
							<td class="FieldLabel"><label>基金会类型：</label></td>
							<td class="FieldInput">
								<select field="sorgKind" id="sorgKind" name='"基金会类型"' style="width:90%" onchange="changSorgKind()">
			...
			<next:Panel id="panel_legal" title="基金会法定代表人登记"  width="100%" autoScroll="true">
				<next:Html>
			...
			<next:Panel title="电子档案上传" width="100%" >
				<next:Html>
				  <iframe id="uploadInfo" src="../upload/somUploadComm.jsp?sorgId=<%=sorgId %>&applyType=201"
...
<next:Window id="win_peopleValidate" title="人员身份验证"  resizable="false" width="395" height="403" closeAction="hide">
		<next:EditGridPanel id="grid_2" width="381" stripeRows="true" height="170" dataset="winPeopleDataSet">
			<next:TopBar>
		...
		<next:EditGridPanel id="grid_3" width="381" stripeRows="true" height="202" dataset="winMemberDataSet">
			<next:TopBar>
