...
<html>
<head>
<title>基金会负责人备案查看</title>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript" src="fundBranchManagePeopleDetail.js"></script>
...
<next:Panel title="基金会分支（代表）机构负责人列表" width="100%" height="100%">
		...
		<next:Html>
			...
			<table width="100%">
				<tr>
					...
					<td class="FieldInput" style="width: 25%"><label id="McnName" style="width: 90%" /></td>
					<td class="FieldLabel" style="width: 25%">登记证号：</td>
					<td class="FieldInput" style="width: 25%"><label id="MsorgCode" style="width: 90%" /></td>
				</tr>
				<tr>
	...
	<next:EditGridPanel id="peopleGrid" dataset="aspForJianShi" width="100%" stripeRows="true" height="280" hasSum="true" autoScroll="true" title="基金会分支（代表）机构负责人">
		<next:TopBar>
			<next:ToolBarItem symbol="->"></next:ToolBarItem>
