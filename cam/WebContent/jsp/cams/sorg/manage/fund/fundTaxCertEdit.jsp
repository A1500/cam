...
<html>
<head>
<title>基金会税务登记证备案</title>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript" src="fundTaxCertEdit.js"></script>
...
<body>
<model:datasets>
	<model:dataset id="somTaxCertDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomTaxRegistrationCertQueryCmd" global="true">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomTaxRegistrationCert">
		</model:record>
	</model:dataset>
	<%--电子档案--%>
...
<next:Panel width="100%" autoScroll="true">
	...
	<next:TabPanel width="100%" height="100%" id="tab">
		<next:Tabs>
			<next:Panel title="基金会税务登记证备案" width="100%" >
				<next:Panel width="100%" height="100%" autoScroll="true">	
					<next:Html>
						<form id="taxCertForm" method="post" dataset="somTaxCertDataSet" onsubmit="return false" class="L5form">
						<fieldset>
						<legend>基金会税务登记证备案</legend>
						<input type="hidden" id="sorgId" field="sorgId" value="基金会ID">
						<table width="100%">
							<tr>
								<td class="FieldLabel" style="width:20%">基金会名称：</td>
								<td class="FieldInput"  style="width:30%"><label id="cnName"/></td>
								<td class="FieldLabel" style="width:20%">登记证号：</td>
								<td class="FieldInput"  style="width:30%"><label id="sorgCode"/></td>
							</tr>
							<tr>
								<td class="FieldLabel">税务登记证号：</td>
								<td class="FieldInput" ><input type="text" name="税务登记证号" field="certNo" style="width:90%"/><font color="red">*</font></td>
