...
<script type="text/javascript" src="fundRuleList.js"></script>
...
<next:TabPanel id="tab" activeTab="0" width="100%"  height="100%">
	<next:Tabs>
		<next:Panel title="办理新的章程核准" width="100%" height="100%">
			...
			<next:Panel title="办理过的章程核准信息" width="100%" height="100%">
				<next:EditGridPanel id="grid2" dataset="somRuleDataSet" width="100%" stripeRows="true" height="99.9%">
					...
					<next:Columns>
						...
						<next:Column field="ifDraft" header="基金会名称" width="30%" sortable="false"></next:Column>
						<next:Column field="mainQuestion" header="基金会登记证号" width="30%" sortable="false"></next:Column>
