...
<script type="text/javascript" src="somFundBranch.js"></script>
...
<next:Panel width="100%" height="100%">
	<next:TopBar>
		<next:ToolBarItem symbol="分支/代表机构信息明细"></next:ToolBarItem>
	...
	<next:TabPanel width="100%" height="100%"  activeTab="0" >
		<next:Tabs>
					...
					<form method="post" dataset="somOrganDataSet" onsubmit="return false"class="L5form">
						<table width="100%">
							...
							<tr>	
								...
								<td class="FieldInput" colspan="5"><textarea field="business" rows="10" style="width:98%" readonly="readonly"></textarea></td>
							</tr>
							<tr>
			...
			<next:Panel width="100%" title="成立电子档案查看">
				<next:Html>
				  <iframe id="uploadInfo" src="../upload/somDownloadComm.jsp?sorgId=<%=request.getParameter("sorgId") %>&applyType=204"
