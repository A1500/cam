...
<script type="text/javascript" src="somFundCertList.js"></script>
...
<body>
<model:datasets>
	<model:dataset id="somFundCertDataset" cmd="com.inspur.cams.sorg.manage.cmd.SomCertQueryCmd" pageSize="10" autoLoad="false">
	...
	<model:dataset id="Certdataset" global="true" cmd="com.inspur.cams.sorg.manage.cmd.SomCertQueryCmd">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomCert"></model:record>
		<model:params>
			<model:param name="sorg_Type" value='J'></model:param>
		</model:params>
	...
	<model:dataset id="businessOrganSelect" cmd="com.inspur.cams.comm.dicm.DicQueryCmd" global="true" autoLoad="true" sortField="ORDER_NUMBER">
		...
		<model:params>
			...
			<model:param name="text" value='BORG_NAME'>
			</model:param><model:param name="filterSql" value='<%="MORG_CODE ="+BspUtil.getOrganCode().substring(0,6)%>'></model:param>
		</model:params>
	</model:dataset>
</model:datasets>
...
<next:EditGridPanel id="hlistPanel" dataset="somFundCertDataset" enableHdMenu="true" height="99.9%" width="100%">
	<next:TopBar>
		<next:ToolBarItem text='' id="displayItem" />
		<next:ToolBarItem symbol="基金会证书信息"></next:ToolBarItem>
	...
	<next:Columns>
		...
		<next:Column header="基金会名称" field="sorgName" sortable="true"editable="false" renderer="jtxxDetailHref" width="25%"><next:TextField/></next:Column>
	...
	<next:BottomBar>
		<next:PagingToolBar dataset="somFundCertDataset" />
	</next:BottomBar>
</next:EditGridPanel>


<%-- 证书详细信息 --%>
<next:Window id="Cert" closeAction="hide" title="证书详细信息" width="700" height="400" autoScroll="true">
	<next:TopBar>
		<next:ToolBarItem text='' id="displayItem" />
		<next:ToolBarItem symbol="基金会证书明细"></next:ToolBarItem>
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
	...
	<next:Html>
		<form method="post" onsubmit="return false" class="L5form" dataset="Certdataset">
		<table width="100%">
			<tr>
				<td class="FieldLabel" style="width: 10%;"><label>登记证号：</label></td>
				<td class="FieldInput" style="width: 10%;"><label field="sorgCode" readonly="readonly"/></td>
				<td class="FieldLabel" style="width: 10%;"><label>组织机构代码：</label></td>
				<td class="FieldInput" style="width: 10%;"><label field="organCode" readonly="readonly"/></td>
			...
			<tr>
				...
				<td class="FieldInput"><label field="regMon" readonly="readonly"/>万元</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="FieldInput"><label field="issueReason" readonly="readonly" dataset="issueReason"/></td>
				<td class="FieldLabel"><label>发证机关：</label></td>
			...
			<tr>
				...
				<td class="FieldInput" colspan="5"><label style="height: 50px;" field="checkResult" readonly="readonly"/></td>
			</tr>
			<tr>
			...
			<tr style="display: none;">
				<td class="FieldLabel"><label>证件状态：</label></td>
				<td class="FieldInput"><input type="text" id="wincertStatus" field="certStatus" readonly="readonly" /></td>
			</tr>
		</table>
...
<%-- 发证页面 --%>
<next:Window id="certF" closeAction="hide" title="证书详细信息" width="700" height="400" autoScroll="true">
	<next:TopBar>
		<next:ToolBarItem text='' id="displayItem" />
		<next:ToolBarItem symbol="基金会证书明细"></next:ToolBarItem>
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
...
<next:Window id="printDemo" closeAction="hide" title="选择证书类别" width="250">
	<next:TopBar>
		<next:ToolBarItem text='' id="displayItem" />
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
