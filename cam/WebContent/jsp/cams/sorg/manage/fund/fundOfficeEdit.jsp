...
<script type="text/javascript" src="fundOfficeEdit.js"></script>
...
<next:Panel  width="100%" autoScroll="true">
	...
	<next:TabPanel width="100%" height="100%" id="tab">
		<next:Tabs>
			<next:Panel title="基金会办事机构备案" width="100%" >
					...
					<next:Html>
						<form id="officeForm" method="post" dataset="somOfficeDataSet" onsubmit="return false" class="L5form">
							...
							<table width="100%">
								...
								<tr>
									<td class="FieldLabel">基金会履行内部程序：</td>
									<td class="FieldInput" colspan="5"><textarea type="text" name="基金会履行内部程序" id="process" field="process" cols="75" rows="2" style="width:97%"></textarea></td>
								</tr>
								<tr>
