...
<html>
<head>
<title>基金会分支/代表列表</title>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript" src="somFundBranchList.js"></script>
		...
		<form class="L5form">
				<table  border="1" width="100%">
					...
					<tr>
						...
						<td class="FieldLabel"><label>机构类别：</label></td>
						<td class="FieldInput">
...
<next:EditGridPanel id="grid" dataset="somOrganDataSet" width="100%" stripeRows="true" height="99.9%">
	<next:TopBar>
		...
		<next:ToolBarItem iconCls="detail" text="查看基金会主体" handler="sorgMain"></next:ToolBarItem>
	...
	<next:Columns>
		...
		<next:Column field="cnName" header="机构名称" width="35%" sortable="true"></next:Column>
		<next:Column field="sorgKind" header="机构类别" dataset="sorgKindSelect" width="12%" sortable="true"></next:Column>
