...
<script type="text/javascript" src="somFundBranchInsert.js"></script>
...
<next:Panel width="100%" height="100%">
	<next:TopBar>
		<next:ToolBarItem symbol="基金会分支/代表机构信息录入"></next:ToolBarItem>
	...
	<next:TabPanel id="tab" name="tabpanel-div" width="100%"  height="100%" activeTab="0">
		<next:Tabs>
			<next:Panel width="100%" height="100%" autoScroll="true" title="基金会分支/代表机构信息录入">
				<next:Html>
					...
					<table width="100%">
						...
						<tr>
							...
							<td class="FieldInput"><label id="legalPeople" style="width:90%"></label></td>
						</tr>
						<tr>
			...
			<next:Panel title="电子档案上传" width="100%" >
				<next:Html>
				  <iframe id="uploadInfo" src="../upload/somUploadComm.jsp?sorgId=<%=sorgId %>&applyType=204"
