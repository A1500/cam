...
<script type="text/javascript" src="fundAccountList.js"></script>
		...
		<next:Panel title="办理过的备案信息" width="100%" height="100%">
			<next:EditGridPanel id="grid2" dataset="somAccountDataSet" width="100%" stripeRows="true" height="99.9%">
				...
				<next:Columns>
					...
					<next:Column field="sorgType" header="基金会登记证号" width="30%" sortable="false"></next:Column>
