...
function save(){
	...
	var command=new L5.Command("com.inspur.cams.sorg.base.cmd.SomElectionCmd");
...
function returnBack(){
	...
	var url="jsp/cams/sorg/manage/fund/fundElection.jsp";
	L5.forward(url,'',data);
}
...
function confirmPrint(){
	...
	//电话号码
	if(isTel(linkmanPhone) != true){
		L5.Msg.alert("提示","校验未通过："+"联系电话格式不正确");
		return;
	}	
