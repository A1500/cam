...
<script type="text/javascript" src="fundOrganCodeEdit.js"></script>
...
<next:Panel width="100%" autoScroll="true">
	...
	<next:TabPanel width="100%" height="100%" id="tab">
		<next:Tabs>
			<next:Panel title="基金会组织机构代码备案" width="100%" >
				<next:Panel width="100%" height="100%" autoScroll="true">	
					<next:Html>
						<form id="signetForm" method="post" dataset="somOrganCodeDataSet" onsubmit="return false" class="L5form">
						<fieldset>
						<legend>基金会组织机构代码备案</legend>
						...
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput" ><input type="text" name="组织机构代码" field="organCode" style="width:90%"/><font color="red">*</font></td>
