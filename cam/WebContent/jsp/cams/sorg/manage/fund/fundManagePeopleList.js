function init(){
	...
	somSessionQueryDataSet.setParameter("TASK_CODE@LIKE",'J%');
...
function insert(){
	...
	if(records[0].get("ifBranch") == '1'){
		...
		url="jsp/cams/sorg/manage/fund/fundManagePeopleEdit.jsp";
	}
	L5.forward(url,'',data);
}
// 负责人管理
function update(){
	...
	var url='';
	if(records[0].get("ifBranch") == '1'){
		url="jsp/cams/sorg/manage/fund/fundBranchManagePeopleEdit.jsp";
	}else{
		url="jsp/cams/sorg/manage/fund/fundManagePeopleEdit.jsp";
	}
	L5.forward(url,'',data);
...
function manage(){
	...
	var url='';
	if(records[0].get("ifBranch") == '1'){
		url="jsp/cams/sorg/manage/fund/fundBranchManagePeopleDetail.jsp";
	}else{
...
function detail(){
	...
	if(records[0].get("ifBranch") == '1'){
		...
		url="jsp/cams/sorg/manage/fund/fundManagePeopleDetail.jsp";
	}
	L5.forward(url,'',data);
}
// 查看历史备案
...
function hisDetail(){
	...
	var url="jsp/cams/sorg/manage/fund/fundManagePeopleHisDetail.jsp";
	L5.forward(url,'',data);
}