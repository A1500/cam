...
<script type="text/javascript" src="somFund.js"></script>
...
<next:Panel width="100%" height="100%">
	<next:TopBar>
		<next:ToolBarItem symbol="基金会信息明细"></next:ToolBarItem>
	...
	<next:TabPanel id="tab" width="100%" height="100%"  activeTab="2">
		<next:Tabs>
			...
			<next:Panel width="100%" title="成立电子档案查看">
				<next:Html>
				  <iframe id="uploadInfo" src="../upload/somDownloadComm.jsp?sorgId=<%=request.getParameter("sorgId") %>&applyType=201"
