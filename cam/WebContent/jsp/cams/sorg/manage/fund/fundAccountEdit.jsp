...
<script type="text/javascript" src="fundAccountEdit.js"></script>
...
<body>
<model:datasets>
	<model:dataset id="somAccountDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomAccountQueryCmd" global="true">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomAccount">
			...
			<model:field name="accountDate" type="string" rule="require"/>
		</model:record>
	</model:dataset>
	<%--电子档案--%>
...
<next:Panel width="100%" autoScroll="true">
	...
	<next:TabPanel width="100%" height="100%" id="tab">
		<next:Tabs>
			<next:Panel title="基金会银行账户备案" width="100%" >
				<next:Panel width="100%" height="100%" autoScroll="true">
					<next:Html>
						<form id="signetForm" method="post" dataset="somAccountDataSet" onsubmit="return false" class="L5form">
						<fieldset>
						<legend>基金会银行账户备案</legend>
						...
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput"><input type="text" name="账户名称" id="name" field="name" maxlength="50" style="width:90%"/></td>
								<td class="FieldLabel">开户银行：</td>
								<td class="FieldInput"><input type="text" name="开户银行" id="bank" field="bank" maxlength="50" style="width:100%"/></td>
							</tr>
							<tr>
							...
							<tr>
								<td class="FieldLabel">开户银行账号：</td>
								<td class="FieldInput"><input type="text" name="开户银行账号" id="accountCode" field="accountCode" maxlength="30" style="width:90%"/></td>
								<td class="FieldLabel">开户日期：</td>
								<td class="FieldInput"><input type="text" name="开户日期" id="accountDate" field="accountDate" format="Y-m-d" onclick="WdatePicker();" style="width:100%"/></td>
							</tr>
							<tr>
								<td class="FieldLabel">设立银行账户理由：</td>
								<td class="FieldInput" colspan="3"><textarea name="设立银行账户理由" id="reason" field="reason" cols="75" rows="15" style="width:95%"></textarea></td>
							</tr>
							<tr>
