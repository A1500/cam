...
<script type="text/javascript" src="somFundList.js"></script>
		...
		<form class="L5form">
				<table  border="1" width="100%">
					<tr>
						...
						<td class="FieldLabel" style="width:15%"><label>基金会状态：</label></td>
					...
					<tr>
						...
						<td class="FieldLabel"><label>基金会类别：</label></td>
						<td class="FieldInput">
...
<next:EditGridPanel id="grid" dataset="somOrganDataSet" width="100%" stripeRows="true" height="99.9%">
	<next:TopBar>
		<next:ToolBarItem symbol="基金会列表"></next:ToolBarItem>
		...
		<next:ToolBarItem iconCls="detail" text="查看分支/代表机构" handler="branch"></next:ToolBarItem>
	...
	<next:Columns>
		...
		<next:Column field="cnName" header="基金会名称" width="35%" sortable="true"></next:Column>
		<next:Column field="sorgKind" header="基金会类别" dataset="sorgKindSelect" width="12%" sortable="true"></next:Column>
		<next:Column field="sorgStatus" header="基金会状态" width="13%" sortable="true" dataset="sorgStatusSelect"></next:Column>
