...
function insert(){
	...
	var url="jsp/cams/sorg/manage/fund/fundElectionEdit.jsp";
	L5.forward(url,'',data);
}
function update(){
...
function detail(){
	...
	data.put("searchCnName",encodeURIComponent(encodeURIComponent(searchCnName)));
	data.put("searchSorgCode",searchSorgCode);
	var url="jsp/cams/sorg/manage/fund/fundElectionDetail.jsp";
	L5.forward(url,'',data);
}
function returnBack(){
	var data=new L5.Map();
	data.put("searchCnName",encodeURIComponent(encodeURIComponent(searchCnName)));
	data.put("searchSorgCode",searchSorgCode);	
	var url="jsp/cams/sorg/manage/fund/fundElectionList.jsp";
	L5.forward(url,'',data);
}