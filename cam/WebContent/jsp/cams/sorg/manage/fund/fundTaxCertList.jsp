...
<script type="text/javascript" src="fundTaxCertList.js"></script>
...
<next:TabPanel id="tab" activeTab="0" width="100%"  height="100%">
	<next:Tabs>
		<next:Panel title="办理新的备案" width="100%" height="100%">
			...
			<next:Panel title="办理过的办事机构备案" width="100%" height="100%">
				<next:EditGridPanel id="grid2" dataset="somTaxCertDataSet" width="100%" stripeRows="true" height="99.9%">
					<next:TopBar>
						<next:ToolBarItem symbol="->"></next:ToolBarItem>
					...
					<next:Columns>
						<next:RowNumberColumn></next:RowNumberColumn>
						<next:RadioBoxColumn></next:RadioBoxColumn>
						<next:Column field="certNo" header="基金会名称" width="30%" sortable="false"></next:Column>
