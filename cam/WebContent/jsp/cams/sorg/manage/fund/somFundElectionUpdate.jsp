...
<script type="text/javascript" src="somFundElectionUpdate.js"></script>
			...
			<next:Html>
				...
				<table width="100%">
					...
					<tr id="electionPeriodTr" style="display:block;">
						...
						<td class="FieldInput" ><input type="text" name="换届年限:" id="electionPeriod"  style="width:90%" onchange="changeElectionPeriod()"></label><span>年</span></td>
					...
					<tr>
						...
						<td class="FieldInput"><label name="是否最新标准" id="ifCurrent" field="ifCurrent" style="width: 90%"  dataset="ifCurrentDS"></label></td>
						<td class="FieldLabel"></td>
						<td class="FieldInput"></td>
						<td class="FieldLabel"></td>
						<td class="FieldInput"></td>
					...
					<tr>
						...
						<td class="FieldInput" colspan="3"><label name="morgName" id="morgName" field="morgName" readonly="true" style="width:100%"/></td>
						<td class="FieldLabel"><label>登记管理机关行政区划：</label></td>
						<td class="FieldInput"><label name="morgArea" id="morgArea" field="morgArea" readonly="true" style="width:100%"/></td>
					</tr>
					<tr>
