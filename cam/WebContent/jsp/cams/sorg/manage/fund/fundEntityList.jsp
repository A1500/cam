...
<script type="text/javascript" src="fundEntityList.js"></script>
			...
			<next:Panel title="办理过的举办实体备案" width="100%" height="100%">
				<next:EditGridPanel id="grid2" dataset="somEntityDataSet" width="100%" stripeRows="true" height="99.9%">
					...
					<next:Columns>
						<next:RowNumberColumn></next:RowNumberColumn>
						<next:RadioBoxColumn></next:RadioBoxColumn>
						<next:Column field="name" header="基金会名称" width="30%" sortable="false"></next:Column>
						<next:Column field="adds" header="基金会登记证号" width="30%" sortable="false"></next:Column>
