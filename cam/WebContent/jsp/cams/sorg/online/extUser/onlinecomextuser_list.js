...
function query(){
	...
	ds.setParameter("COM_EXT_USER.USER_ID@like",getParam("userId"));		
	ds.setParameter("COM_EXT_USER.USER_NAME@like",getParam("userName"));		
...
function insert() {
	...
	var url='jsp/cams/sorg/online/extUser/onlinecomextuser_edit.jsp';
