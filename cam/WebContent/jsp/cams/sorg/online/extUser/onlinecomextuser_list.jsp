...
<html>
	<head>
		<title>社会组织外网用户维护列表</title>
		<next:ScriptManager/>
		<script type="text/javascript" src="onlinecomextuser_list.js"></script>
...
<next:GridPanel id="editGridPanel" name="comextuserGrid" width="100%" stripeRows="true" height="100%" dataset="ds" title="社会组织外网用户维护列表" notSelectFirstRow="true">
	...
	<next:Columns>
		...
		<next:Column id="organType" header="社会组织类型" field="organType" width="90" >
			<next:TextField allowBlank="false" />
		</next:Column>
