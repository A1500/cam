...
<script type="text/javascript" src="groupBranchBuildPre.js"></script>
...
<model:datasets>
	...
	<%--用来根据mainsorgcode校验主体是否存在--%>
	<model:dataset id="somMainOrganDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomOrganQueryCmd" method="queryMain">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomOrgan"></model:record>
	</model:dataset>
	<%--查询名字是否通过核准或异地分支审核通过--%>
	<model:dataset id="somQueryOrganDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomOrganQueryCmd" global="true">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomOrgan"></model:record>
	</model:dataset>
	<%--根据名称和状态查询出原系统中已经存在的，用来取sorgId和sorgStatus，赋给新的somorgandataset--%>
	<model:dataset id="somOrganExistDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomOrganQueryCmd"  global="true">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomOrgan"></model:record>
	</model:dataset>
...
<next:Panel width="100%" height="100%">
	<next:TopBar>
		...
		<next:ToolBarItem iconCls="save" text="保存" handler="saveAllInfo"/>
		<next:ToolBarItem iconCls="select" text="提交" handler="submitAllInfo"/>
					...
					<form method="post" dataset="somOrganDataSet" onsubmit="return false"class="L5form">
						<table width="100%">
							<tr>
								...
								<input type="text" name='"社团主体登记证号"' id="mainSorgCode" field="mainSorgCode" onblur="validateSorgCode()" style="width:98%"/><label style="color:red">*</label>
								</td>
							</tr>
							<tr>
								<td class="FieldLabel"><label>社会团体名称：</label></td>
								<td class="FieldInput" colspan="5">
								<input type="text"  id="mainSorgName" name='"社会团体主体名称"' field="mainSorgName" style="width:98%"/><label style="color:red">*</label>
								</td>
							</tr>
							<tr>
								<td class="FieldLabel"><label>分支/代表机构名称：</label></td>
								<td class="FieldInput" colspan="5">
								<input type="text"  id="cnName" name='"办公场所"' field="cnName" onchange="checkBranchName()" style="width:98%"/><label style="color:red">*</label>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<input type="text" id="borgNameDispaly" style="width:45%" name="borgNameDispaly"  title="业务主管单位"  onkeyup="findDiv(this,'borgName','popup','','businessOrganAuto','BORG_NAME@like','borgCode','borgName','35')" onblur="clearDiv()" onchange="clearBorg(this)"/><img src="<%=SkinUtils.getImage(request,"l5/help.gif")%>" style="cursor:hand" onclick="showBorgWin()"/>
								...
								<td class="FieldInput"><input type="text" name='"成立日期"' field="buildDate" onclick="WdatePicker()" readonly="readonly" style="width:90%"/><span style="color:red">*</span></td>
							</tr>
						</table>
					...
					<form title="负责人信息" id="addForm" method="post" dataset="somDutyInsertDataSet" onsubmit="return false" class="L5form">
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput">
									<select id="ifPartyLeader" field="ifPartyLeader" name='"是否党政机关领导干部"' onchange="valid_ifPartyLeader_add()" style="width:90%">
