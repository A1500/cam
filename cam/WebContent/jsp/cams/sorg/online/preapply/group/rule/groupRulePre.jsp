...
<script type="text/javascript" src="groupRulePre.js"></script>
					...
					<form id="form2" method="post" dataset="somApplyDataSet" onsubmit="return false" class="L5form">
						...
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput" style="width:49%"><select name="业务主管单位" field="borgName" style="width:90%" disabled="disabled"><option dataset="businessOrganSelect"></option></select></td>
