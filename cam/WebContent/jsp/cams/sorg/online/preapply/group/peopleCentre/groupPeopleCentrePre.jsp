...
<script type="text/javascript" src="groupPeopleCentrePre.js"></script>
...
<model:datasets>
	...
	<model:dataset id="somSessionQueryDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomSessionQueryCmd" global="true" method="getCurrentSession">
	...
	<%--人员简历 --%>
	<model:dataset id="somResumeQueryDataSet" cmd="com.inspur.cams.sorg.online.base.cmd.SomPeopleResumeOnlineQueryCommand" sortField="startDate" sortDirection="DESC" global="true">
			...
			<next:Panel title="社会团体负责人备案表" width="100%" height="100%" autoScroll="true">	
				<next:Panel>		
					<next:Html>
						...
						<form id="form2" dataset="somSessionQueryDataSet" onsubmit="return false" class="L5form">
