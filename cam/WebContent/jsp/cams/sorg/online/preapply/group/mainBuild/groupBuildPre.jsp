...
<script type="text/javascript" src="groupBuildPre.js"></script>
...
<model:datasets>
	...
	<model:dataset id="somOrganDataSetQuery" cmd="com.inspur.cams.sorg.online.base.cmd.SomOrganOnlineQueryCommand"  global="true">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomOrgan">
			<%--社会团体基本信息验证 --%>
			<model:field name="sorgCode" type="string" rule="length{20}" />
			<model:field name="cnName" type="string" rule="require|length{100}" />
	...
	<model:dataset id="somSessionDataSet" cmd="com.inspur.cams.sorg.online.base.cmd.SomSessionOnlineQueryCommand" global="true">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomSession">
			<model:field name="sessionName" type="string" rule="require" />
		</model:record>
	</model:dataset>
	<!-- 负责人信息 -->
	<model:dataset id="somDutyDataSet" cmd="com.inspur.cams.sorg.online.base.cmd.SomDutyOnlineQueryCommand" global="true"  method="queryPeople" pageSize="100">
	...
	<!-- 章程核准信息 -->
	<model:dataset id="somRule" cmd="com.inspur.cams.sorg.online.base.cmd.SomRuleOnlineQueryCommand" global="true" method="queryRule">
	...
	<%--会费标准信息--%>
	<model:dataset id="somFee" cmd="com.inspur.cams.sorg.online.base.cmd.SomFeeOnlineQueryCommand" global="true" method="queryFee">
	...
	<model:dataset id="somPartyMemberDataSet" cmd="com.inspur.cams.sorg.online.base.cmd.SomPartyMemberOnlineQueryCommand" global="true" pageSize="100">
	...
	<%--法定代表人人员简历 --%>
	<model:dataset id="somResumeLegalDataSet" cmd="com.inspur.cams.sorg.online.base.cmd.SomPeopleResumeOnlineQueryCommand">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomPeopleResume"></model:record>
	</model:dataset>	
	<%--人员简历 --%>
...
<next:Panel width="100%" height="100%">
	<next:TopBar>
		...
		<next:ToolBarItem iconCls="save" text="保存" handler="saveAllInfo"></next:ToolBarItem>
		<next:ToolBarItem iconCls="select" text="提交" handler="saveAndSendInfo"></next:ToolBarItem>
		...
		<next:Tabs>
			<next:Panel title="登记申请书" width="100%" >
				<next:Panel width="100%" height="100%" autoScroll="true">
					<next:Html>
						<form method="post" dataset="somOrganDataSetQuery" onsubmit="return false" class="L5form">
						<table width="100%">
							<tr>
								<td class="FieldLabel">社会团体中文名称：</td>
								<td class="FieldInput" colspan="3"><input type="text" id="cnName" name='社会团体中文名称' field="cnName" onblur="fillOrganInfo(this.value);" style="width:90%"/><span style="color:red">*</span></td>
								<td class="FieldLabel">登记证号：</td>
								<td class="FieldInput"><input type="text" id="sorgCode" name='登记证号' field="sorgCode" onblur="sorgCodeUK();" style="width:90%"/></td>
							</tr>
							<tr>
								...
								<td class="FieldInput" style="width:17%"><input type="text" name='登记日期' field="regDate" onclick="WdatePicker()" readonly="readonly" style="width:90%"/></td>
							</tr>
							<tr>
								...
								<td class="FieldInput"><input type="text" name='成立日期' field="buildDate" onclick="WdatePicker()" readonly="readonly" style="width:90%"/></td>
							</tr>
							<tr>	
						...
						<form onsubmit="return false" dataset="somSessionDataSet" class="L5form">
							<table width="100%">
								<tr>
									...
									<td class="FieldInput" colspan="3"><input type="text" id="sessionName" field="sessionName" style="width:97%" onclick="showMeeting()" readonly/><span style="color:red">*</span></td>
								...
								<tr>
									...
									<td class="FieldInput" style="width:17%"><input type="text" id="startDate" field="startDate"onclick="WdatePicker()" readonly="readonly" style="width:90%"/></td>
					...
					<form method="post" onsubmit="return false" dataset="somFee" class="L5form">					
						...
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput"><input type="text" name="meetingDate" id="meetingDate" field="meetingDate" style="width:90%" readonly="readonly" onclick="WdatePicker()" /></td>
					...
					<form title="负责人信息" id="addForm" method="post" dataset="somDutyInsertDataSet" onsubmit="return false" class="L5form">
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldLabel">出生年月：</td>
								<td class="FieldInput"><input type="text" id="birthday" field="birthday" name='"出生年月"' onclick="WdatePicker()" readonly="readonly" style="width:90%"/></td>
								<td class="FieldLabel">年龄：</td>
							...
							<tr>
								...
								<td class="FieldInput">
     							...
     							<span style="color:red">*</span></td>
								<td class="FieldLabel">任职开始日期：</td>
								<td class="FieldInput"><input type="text" field="startDate" name='"任职开始日期"' onclick="WdatePicker()" readonly="readonly" style="width:90%"/><span style="color:red">*</span></td>
