...
<head>
	...
	<script type="text/javascript" src="groupBranchChangePre.js"></script>
...
<model:datasets>
	...
	<!-- 变更window的dataset -->
	<model:dataset id="somChangeList" cmd="com.inspur.cams.sorg.online.base.cmd.SomChangeOnlineQueryCommand" method="queryAndBuildGroupBranch">
		...
		<next:Tabs>
			<next:Panel title="社会团体分支（代表）机构变更登记申请表" width="100%" height="100%" autoScroll="true">
				<next:Panel>
					...
					<table width="100%">
						<tr>
							<td class="FieldLabel" style="width: 10%;"><label>社会团体分支/代表(机构)登记证号：</label></td>
