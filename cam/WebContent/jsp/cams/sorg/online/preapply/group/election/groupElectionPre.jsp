...
<script type="text/javascript" src="groupElectionPre.js"></script>
...
<model:datasets>
	...
	<model:dataset id="somElectionDataSet" cmd="com.inspur.cams.sorg.online.base.cmd.SomElectionOnlineQueryCommand" method="queryElection">
	...
	<model:dataset id="somAspchiefDataSet" cmd="com.inspur.cams.sorg.online.base.cmd.SomAspchiefOnlineQueryCommand" global="true">
						...
						<form id="ElectionForm" method="post" dataset="somElectionDataSet" onsubmit="return false" class="L5form">
							...
							<table width="100%">
								<tr>
									...
									<input type="text" id="cnName"  field="sorgName" style="width:90%" onchange="findSorgCode()">
									</td>
									<td class="FieldLabel" style="width:16%">登记证号或批准筹备文号：</td>
									<td class="FieldInput" style="width:30%">
									<input type="text" id="sorgCode" field="sorgCode" style="width:90%">
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="FieldInput" colspan="3"><input type="text" name="会议名称" id="meetingName"  field="meetingName" maxlength="50" style="width:97%"onchange="meetingQuery();"></td>
								</tr>
								<tr>
						...
						<form id="form2" method="post" dataset="somApplyDataSet" onsubmit="return false" class="L5form">
							...
							<table width="100%">
								...
								<tr>
									...
									<td class="FieldInput" style="width:15%"><input type="text" field="borgCheckDate" readonly="readonly" onclick="WdatePicker()" style="width:90%"></td>
