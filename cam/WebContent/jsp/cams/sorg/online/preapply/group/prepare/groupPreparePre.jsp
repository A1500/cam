...
<script type="text/javascript" src="groupPreparePre.js"></script>
...
<model:datasets>
	...
	<model:dataset id="somHeldPeopleDataSet" cmd="com.inspur.cams.sorg.online.base.cmd.SomHeldPeopleOnlineQueryCommand" global="true" pageSize="100">
	...
	<model:dataset id="somHeldOrganDataSet" cmd="com.inspur.cams.sorg.online.base.cmd.SomHeldOrganOnlineQueryCommand" global="true" pageSize="100">
	...
	<model:dataset id="somAspchiefDataSet" cmd="com.inspur.cams.sorg.online.base.cmd.SomAspchiefOnlineQueryCommand" global="true"  pageSize="100">
	...
	<%--电子档案上传窗口--%>
	<model:dataset id="winElectronicDataSet" cmd="com.inspur.cams.sorg.online.base.cmd.SomElectronicOnlineQueryCommand" global="true">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomElectronic"></model:record>
	</model:dataset>
				...
				<next:Html>
					...
					<table width="100%">
						<tr>
							...
							<td class="FieldInput" colspan="5"><input type="text"id='cnName' field="cnName" name='"申请筹备社团名称"' style="width:90%"  onblur="checkOrganInfoAndDealSorgId(this.value);"/></td>
						</tr>
						<tr>
