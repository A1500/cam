...
<script type="text/javascript" src="fundRulePre.js"></script>
...
<model:datasets>
	...
	<model:dataset id="somRuleDataSet" cmd="com.inspur.cams.sorg.online.base.cmd.SomRuleOnlineQueryCommand" method="queryRule" global="true">
					...
					<form id="ruleForm" method="post" dataset="somRuleDataSet" onsubmit="return false" class="L5form">
						...
						<table width="100%">
							<tr>
								...
								<td class="FieldInput"><input type="text" id="sorgCode" name="登记证号" maxlength="20" onchange="sorgCodechange();" style="width:90%"> <span style="color:red">*</span></td>
							</tr>
							<tr>
								<td class="FieldLabel">会议名称：</td>
								<td class="FieldInput"><input type="text" id="meetingName" field="meetingName" maxlength="100" style="width:90%" onclick="showMeeting()" readonly><span style="color:red">*</span></td>
					...
					<form id="form2" method="post" dataset="somApplyDataSet" onsubmit="return false" class="L5form">
						...
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput" colspan="3" style="width:49%">
									<select name="业务主管单位" field="borgName" style="width:90%" disabled="disabled"><option dataset="businessOrganSelect"></option></select></td>
						...
						<legend>审查意见</legend>
							...
							<tr>
								...
								<td class="FieldInput" style="width:49%"><input type="text"  field="acceptTime" readonly="readonly" onclick="WdatePicker()" style="width:90%"></td>
							</tr>
							<tr>
								...
								<td class="FieldInput" style="width:49%"><input type="text" field="examinTime" readonly="readonly" onclick="WdatePicker()" style="width:90%"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="FieldInput" style="width:49%"><input type="text" field="auditTime" readonly="readonly" onclick="WdatePicker()" style="width:90%"></td>
							</tr>
						</table>
						</fieldset>
					</form>
