...
function init(){
	...
	somApplyDataSet.setParameter("APPLY_TYPE","234");
...
function detail(){
	...
	var url='';
	url='jsp/cams/sorg/online/preapply/fund/electionDelay/fundElectionDelayPre.jsp';
	text='';
...
<next:Panel width="100%" height="100%">
	<next:TopBar>
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
			...
			<next:Panel title="社会组织变更登记预受理列表" width="100%" height="100%">
