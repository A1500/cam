...
function init(){
	...
	somApplyDataSet.setParameter("APPLY_TYPE","204");
...
function queryItem(){
	...
	if(cnName=="" && taskCode==""){
		L5.Msg.alert("提示","请至少输入基金会分支/代表机构名称或受理编号!");
		return false;
	}
	var somApplyDataSet=L5.DatasetMgr.lookup("somApplyDataSet");
	...
	<next:TopBar>
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
			...
			<next:Panel width="100%" border="0">
				<next:Html>
					<form class="L5form">
					<fieldset style="overflow:visible;" class="FundBox">
					<legend class="FundBoxTitle">查询条件</legend>
						<table border="1" width="100%">
							<tr>
								<td class="FieldLabel" style="width:15%">基金会分支/代表机构名称：</td>
			...
			<next:Panel title="基金会分支/代表机构设立登记预受理列表" width="100%" height="100%">
				<next:EditGridPanel  id="preGrid" dataset="somApplyDataSet" height="100%" notSelectFirstRow="true">
					...
					<next:Columns>
						...
						<next:Column header="基金会分支/代表机构名称"  field="sorgName" sortable="true" editable="false" width="20%" ><next:TextField></next:TextField></next:Column>
