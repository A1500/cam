...
<script type="text/javascript" src="fundBranchCancelPre.js"></script>
...
<script type="text/javascript">
	<%
		String applyType=ApplyType.SOM_FUND_BRANCH_CANCEL;
	%>
							...
							<form id="cbForm" method="post" dataset="somOrganDataSet" onsubmit="return false" class="L5form">
								<table width="100%">
									<tr>
										...
										<td class="FieldInput" width="30%"><input id="sorgCode" field="sorgCode" name='"分支/代表机构登记证号"' onblur="checkSorgCode()" style="width:80%" maxlength="20"/><span style="color:red">*</span></td>
									...
									<tr>
										...
										<td class="FieldInput"><label id='mainSorgName'field="mainSorgName" name='"基金会名称"'/></td>
