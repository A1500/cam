...
<script type="text/javascript" src="fundBranchBuildPre.js"></script>
					...
					<form method="post" dataset="somOrganDataSet" onsubmit="return false"class="L5form">
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput" colspan="5"><input id="mainSorgName"  field="mainSorgName" style="width:98%"/><label style="color:red">*</label></td>
							</tr>
							<tr>
								<td class="FieldLabel"><label>分支/代表机构名称：</label></td>
								<td class="FieldInput" colspan="5"><input type="text" id="cnName" name='"机构名称"' field="cnName" onblur="fillOrganInfo()"  style="width:98%"/><label style="color:red">*</label></td>
							</tr>
							<tr>
			...
			<next:Panel title="基金会负责人备案表">
				...
				<next:EditGridPanel id="peopleGrid" dataset="somDutyDataSet" width="100%" stripeRows="true" height="99.9%">
					...
					<next:Columns>
						...
						<next:Column header="担任职务" field="sorgDuties" width="15%" editable="false"><next:ComboBox dataset="dutySelectDic"/></next:Column>
