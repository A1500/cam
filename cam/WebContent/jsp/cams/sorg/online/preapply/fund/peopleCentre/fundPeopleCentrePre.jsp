...
<script type="text/javascript" src="fundPeopleCentrePre.js"></script>
...
<model:datasets>
	...
	<model:dataset id="somSessionDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomSessionQueryCmd" global="true" method="getCurrentSession">
