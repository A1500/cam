...
<script type="text/javascript" src="fundCancelPre.js"></script>
...
<model:datasets>
	...
	<model:dataset id="somLiqpeopleDataSet" cmd="com.inspur.cams.sorg.online.base.cmd.SomLiqpeopleOnlineQueryCommand" global="true" sortField="IF_CHIEF" pageSize="100" sortDirection="DESC">
