...
function init(){
	...
	somApplyDataSet.setParameter("APPLY_TYPE","101");
...
function queryItem(){
	...
	if(cnName=="" && taskCode==""){
		L5.Msg.alert("提示","请至少输入民办非企业单位名称或受理编号!");
		return false;
	}
	var somApplyDataSet=L5.DatasetMgr.lookup("somApplyDataSet");
...
<body>
<model:datasets>
	<model:dataset id="somApplyDataSet" cmd="com.inspur.cams.sorg.online.base.cmd.SomApplyOnlineQueryCommand" method="queryHasAcceptStatus" global="true" sortField="createTime" sortDirection="DESC">
...
<next:Panel width="100%" height="100%">
	<next:TopBar>
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
			...
			<next:Panel title="民办非企业单位（法人）成立登记预受理列表" width="100%" height="100%">
