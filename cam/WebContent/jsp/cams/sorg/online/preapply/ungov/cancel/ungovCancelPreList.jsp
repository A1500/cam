...
function init(){
	...
	somApplyDataSet.setParameter("APPLY_TYPE","103");
...
<next:Panel width="100%" height="100%">
	<next:TopBar>
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
			...
			<next:Panel title="民办非企业单位注销登记预受理列表" width="100%" height="100%">
				<next:EditGridPanel  id="preGrid" dataset="somApplyDataSet" height="100%" notSelectFirstRow="true">
					...
					<next:Columns>
						...
						<next:Column header="民办非企业单位名称"  field="sorgName" sortable="true" editable="false" width="20%" ><next:TextField></next:TextField></next:Column>
