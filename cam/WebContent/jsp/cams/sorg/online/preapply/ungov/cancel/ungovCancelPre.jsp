...
<script type="text/javascript" src="ungovCancelPre.js"></script>
					...
					<next:Html>
						...
						<table width="100%">
							<tr>
								...
								<td class="FieldInput" width="30%"><input id="sorgCode" field="sorgCode" name='"登记证号"' onblur="checkSorgCode()" style="width:80%" maxlength="20"/></td>
							...
							<tr>	
								...
								<td class="FieldInput">
									<select id="sorgKind" field="sorgKind" name='"民办非企业单位类型"' style="width:80%" disabled>
										<option dataset="sorgKindSelect" ></option>
									</select>
								</td>																					
								<td class="FieldLabel"><label>所属行（事）业：</label></td>
								<td class="FieldInput">
									<select id="busScope" field="busScope" name='"所属行（事）业"' style="width:80%" disabled>
							...
							<tr>
								...
								<td class="FieldInput">
									<select id="borgName" field="borgName" name='"业务主管单位"' style="width:80%" disabled>
