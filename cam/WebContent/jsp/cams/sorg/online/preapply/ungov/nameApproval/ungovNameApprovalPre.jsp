...
<script type="text/javascript" src="ungovNameApprovalPre.js"></script>
...
<model:datasets>
	...
	<model:dataset id="aspChiefDataset" cmd="com.inspur.cams.sorg.online.base.cmd.SomAspchiefOnlineQueryCommand" global="true">
