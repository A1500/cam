...
<head>
	<next:ScriptManager/>
	<script type="text/javascript" src="ungovChangePre.js"></script>
	...
	<script type="text/javascript">
		...
		if(taskCode == ''){
			taskCode = '<%=StrUtil.n2b(SomIdHelp.getUngovTaskCode())%>';//生成业务编号
		}
...
<model:datasets>
	...
	<model:dataset id="somOrganDataSetExist" cmd="com.inspur.cams.sorg.base.cmd.SomOrganQueryCmd"  global="true">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomOrgan"></model:record>
	</model:dataset>
	<!-- 变更列表的dataset -->
	<model:dataset id="somChangeList" cmd="com.inspur.cams.sorg.online.base.cmd.SomChangeOnlineQueryCommand" method="queryAndBuildUngov">
	...
	<model:dataset id="somDutyQueryDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomDutyQueryCmd" method="queryPeople" global="true">
	...
	<next:TabPanel id="tab" activeTab="1" width="100%" height="100%" >
		<next:Tabs>
			<next:Panel title="民办非企业单位变更登记申请表" width="100%" height="100%"  autoScroll="true">
					...
					<next:Html>
						...
						<table width="100%">
							<tr>
								...
								<td class="FieldInput" style="width: 10%;"><label id="sorgCode" /></td>
							...
							<tr>
								...
								<td class="FieldInput" style="width: 10%;"><label id="appDate"/></td>
							</tr>
						</table>
						</form>
						</fieldset>
				...
				<next:EditGridPanel id="changeEdit" dataset="somChangeList" height="100%" autoScroll="true" >
					<next:TopBar>
...
<next:Window id="detailLegalPeopleWindow" closeAction="hide" title="法定代表人登记表" height="400" width="800" modal="true">
	<next:TabPanel  width="98%" height="84%" id="detailLegalPeopleTab">
		<next:Tabs>
			...
			<next:EditGridPanel dataset="somResumeLegalDataSet" stripeRows="true" title="本人简历" width="100%" height="100%" autoScroll="true">
				<next:TopBar>
					<next:ToolBarItem symbol="->"></next:ToolBarItem>
				</next:TopBar>
				<next:Columns>
