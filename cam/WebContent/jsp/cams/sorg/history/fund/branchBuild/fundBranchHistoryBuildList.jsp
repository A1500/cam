...
<html>
<head>
<title>社会团体分支（代表）机构成立登记列表</title>
...
%>	
<script type="text/javascript" src="fundBranchHistoryBuildList.js"></script>
...
<script type="text/javascript">
	...
	var applyType='<%=ApplyType.SOM_FUND_BRANCH_BUILD%>';
</script>
</head>
<body>
...
<next:Panel width="100%" border="0">
	...
	<legend class="GroupBoxTitle">查询条件</legend>
			<table border="1" width="100%">
				<tr>
					<td class="FieldLabel" style="width:15%">基金会分支(代表)机构名称：</td>
...
<next:EditGridPanel id="grid" dataset="somApplyDataSet" width="100%" stripeRows="true" height="99.9%">
	...
	<next:Columns>
		...
		<next:Column field="sorgName" header="基金会分支(代表)机构名称" width="30%" sortable="false"></next:Column>
