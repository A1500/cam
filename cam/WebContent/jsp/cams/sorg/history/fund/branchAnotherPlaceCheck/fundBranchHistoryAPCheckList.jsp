...
<html>
<head>
<title>基金会异地设立分支/代表机构登记列表</title>
...
%>	
<script type="text/javascript" src="fundBranchHistoryAPCheckList.js"></script>
...
<next:EditGridPanel id="grid" dataset="somApplyDataSet" width="100%" stripeRows="true" height="99.9%">
	...
	<next:Columns>
		...
		<next:Column field="sorgName" header="基金会异地设立分支(代表)机构" width="30%" sortable="false"></next:Column>
