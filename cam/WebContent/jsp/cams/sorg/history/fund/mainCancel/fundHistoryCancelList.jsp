...
%>	
<script type="text/javascript" src="fundHistoryCancelList.js"></script>
...
<script type="text/javascript">
	...
	var applyType='<%=ApplyType.SOM_FUND_CANCEL%>';
</script>
</head>
<body>
...
<next:EditGridPanel id="grid" dataset="somApplyDataSet" width="100%" stripeRows="true" height="99.9%">
	...
	<next:Columns>
		...
		<next:Column field="sorgName" header="基金会名称" width="30%" sortable="false"></next:Column>
