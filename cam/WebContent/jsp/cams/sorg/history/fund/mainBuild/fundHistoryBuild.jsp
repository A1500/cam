...
<script type="text/javascript" src="fundHistoryBuild.js"></script>
		...
		<form onsubmit="return false"  class="L5form" dataset="somSessionDataSet">
			<table width="100%">
				...
				<tr>
					...
					<td class="FieldInput" style="width:17%"><input type="text" id="startDate" field="startDate" onchange="calSessionDate()" onClick="WdatePicker()" style="width:90%"/></td>
		...
		<form id="form2" method="post"  onsubmit="return false" class="L5form" dataset="somApplyDataSet">
			...
			<table width="100%">
				...
				<tr>
					...
					<td class="FieldInput"><input type="text"  field="acceptTime" format="Y-m-d" onclick="WdatePicker();" style="width:90%"></td>
				</tr>
			</table>
			</fieldset>
		</form>
					...
					<form title="负责人信息" id="addForm" method="post" dataset="peopleInsertDataset" onsubmit="return false" class="L5form">
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldLabel">家庭住址：</td>
								<td class="FieldInput" colspan=3><input type="text" field="adds" name='"家庭住址"' style="width:90%"/></td>
							</tr>
							<tr>
								<td class="FieldLabel">邮编：</td>
