...
%>	
<script type="text/javascript" src="fundHistoryChangeList.js"></script>
...
<script type="text/javascript">
	...
	var applyType='<%=ApplyType.SOM_FUND_CHANGE%>';
</script>
</head>
<body>
...
<next:EditGridPanel id="grid" dataset="somApplyDataSet" width="100%" stripeRows="true" height="99.9%">
	...
	<next:Columns>
		...
		<next:Column field="SORG_NAME" header="基金会名称" width="20%" sortable="false"></next:Column>
