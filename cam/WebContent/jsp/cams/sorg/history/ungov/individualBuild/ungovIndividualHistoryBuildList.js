...
function insert(){
	...
	url="jsp/cams/sorg/history/ungov/individualBuild/ungovIndividualHistoryBuild.jsp";
	L5.forward(url,'',data);	
}
function update(){
	...
	var url="jsp/cams/sorg/history/ungov/individualBuild/ungovIndividualHistoryBuild.jsp";
	L5.forward(url,'',data);	
}
