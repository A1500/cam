...
<html>
<head>
<title>历史数据采集-民办非企业单位（个体）成立登记</title>
...
<script type="text/javascript" src="ungovIndividualHistoryBuild.js"></script>
...
<next:Panel width="100%" height="100%">
	<next:TopBar>
		<next:ToolBarItem symbol="历史数据采集-民办非企业单位（个体）成立登记"></next:ToolBarItem>
