...
<head>
	<next:ScriptManager/>
	<script type="text/javascript" src="ungovHistoryChange.js"></script>
					...
					<next:Html>
						...
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput" style="width: 10%;"><input type="text" id="acceptTime" onClick="WdatePicker()"title="申请时间"/><font color="red">*</font></td>
							</tr>
						</table>
						</form>
						</fieldset>
	...
	<next:Html>
		<form method="post" onsubmit="return false" class="L5form" dataset="somChangeDataset">
			<table width="100%">
				...
				<tr>
					<td class="FieldLabel"><label style="color:blue">变更程序：</label></td>
					<td class="FieldInput" colspan="5"><textArea id="monPeopleChangeDesc" field="changeDesc" readonly="readonly" cols="75" rows="4" style="width: 100%;color:blue"></textArea></td>
				</tr>
				<tr>
					<td class="FieldLabel"><label style="color:blue">变更理由：</label></td>
					<td class="FieldInput" colspan="5"><textArea  id="monPeopleChangeReason"  field="changeReason"readonly="readonly"  cols="75" rows="4" style="width: 100%;color:blue" ></textArea></td>
				</tr>
			</table>
		</form>
	</next:Html>
