...
<html>
<head>
<title>历史数据采集-民办非企业单位注销登记列表</title>
...
%>	
	...
	var applyType='<%=ApplyType.SOM_UNGOV_CANCEL%>';
</script>
<script type="text/javascript" src="ungovHistoryCancelList.js"></script>
...
<next:EditGridPanel id="grid" dataset="somApplyDataSet" width="100%"
	...
	<next:Columns>
		...
		<next:Column field="sorgName" header="民办非企业单位名称" width="30%"
			sortable="false"></next:Column>
		<next:Column field="acceptOrganName" header="受理单位名称" width="30%"
			sortable="false"></next:Column>
		<next:Column field="acceptPeopleName" header="受理人" width="18%"
			sortable="false"></next:Column>
		<next:Column field="acceptTime" header="受理时间" width="20%"
			sortable="false"></next:Column>
	</next:Columns>
	<next:BottomBar>
