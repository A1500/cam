...
<html>
<head>
<title>民办非企业单位注销登记录入</title>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript" src="ungovHistoryCancel.js"></script>
...
<script type="text/javascript">
	...
	if(taskCode == ''){
		taskCode = '<%=SomIdHelp.getUngovTaskCode()%>';//生成业务编号
	}
...
<model:datasets>
	...
	<model:dataset id="somOrganDataSet1" cmd="com.inspur.cams.sorg.base.cmd.SomOrganQueryCmd" method="queryMain" global="true">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomOrgan">
		</model:record>
	</model:dataset>
					...
					<next:Html>
						...
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput"><label id='cnName' field="cnName" name='"单位名称"'/></td>
							...
							<tr>	
								...
								<td class="FieldInput">
									<select id="sorgKind" field="sorgKind" name='"民办非企业单位类型"' style="width:50%" disabled="disabled">
							...
							<tr>							
								...
								<td class="FieldInput"><label field="sorgPhone" name='"电话"'/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="FieldInput" colspan="3" ><textarea rows="3" id="cancelReason" name='"申请注销理由"' field="cancelReason" style="width:93%"></textarea><span style="color:red">*</span></td>
							</tr>
							<tr>
								<td class="FieldLabel"><label>清算结论：</label></td>
								<td class="FieldInput" colspan="3" ><textarea rows="3" id="liqResult" name='"清算结论"' field="liqResult" style="width:93%"></textarea><span style="color:red">*</span></td>
							</tr>
						</table>
						</form>
						</fieldset>
						<fieldset>
							...
							<table width="100%">
								<tr>
									...
									<td class="FieldInput" style="width:30%"><input type="text" name='审查日期' field="borgCheckDate"onClick="WdatePicker()" style="width:90%"/></td>
									<td class="FieldLabel" style="width:20%"></td>
									<td class="FieldInput" style="width:30%"></td>
								</tr>
								<tr>
									<td class="FieldLabel">业务主管单位意见：</td>
									<td class="FieldInput" colspan="3"><textarea rows="3" name='意见' field="borgOpinion" style="width:98%;"></textarea>
									</td>
								</tr>
							</table>
							</form>
