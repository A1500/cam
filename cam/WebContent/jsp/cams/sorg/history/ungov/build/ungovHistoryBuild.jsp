...
<html>
<head>
<title>历史数据采集-民办非企业单位（法人）成立登记</title>
...
<script type="text/javascript" src="ungovHistoryBuild.js"></script>
...
<next:Panel width="100%" height="100%">
	<next:TopBar>
		<next:ToolBarItem symbol="历史数据采集-民办非企业单位（法人）成立登记"></next:ToolBarItem>
						...
						<fieldset>
							...
							<table width="100%">
								...
								<tr>
									...
									<td class="FieldInput" style="width:17%"><input type="text" id="sorgCode" name='登记证号' field="sorgCode" style="width:90%" onkeyup="value=value.replace(/[^\\w\.\/]/ig,'').toUpperCase()"  onblur="sorgCodeUK()" /><span style="color:red">*</span></td>
						...
						<next:Panel title="举办人（自然人）">
							<next:EditGridPanel id="heldPeopleGrid" dataset="somHeldPeopleDataSet" width="100%" stripeRows="true" height="100%">
								...
								<next:Columns>
									...
									<next:Column header="户口所在地" field="populace" width="20%" editable="true"><next:TextField/></next:Column>
						...
						<next:Panel  title="基本信息"  width="100%" height="100%" autoScroll="true">
							<next:Html>
								...
								<tr>
									...
									<td class="FieldInput" style="width:12%"> <input type="text" id='legalName' style="width:90%"  field="name" name="姓名"></td>
			...
			<form title="" id="addForm" method="post" dataset="somDutyInsertDataSet" onsubmit="return false" class="L5form">
				<table width="100%">
					<tr>
						...
						<td class="FieldInput" style="width:25%"><input type="text" field="name" name='"姓名"' style="width:90%" onchange="fillHeldPeople(this.value);"/><span style="color:red">*</span></td>
