...
<script>
	...
	var applyType = '<%=ApplyType.getSOM_GROUP_BRANCH_BUILD()%>';
	var updateRecord="";
	var rootPath="<%=SkinUtils.getRootUrl(request)%>";
	var currentUserName = '<%= GetBspInfo.getBspInfo().getUserName()%>';	
	var fileCode = "S059";
</script>
<script type="text/javascript" src="groupBranchHistoryBuild.js"></script>
					...
					<form method="post" dataset="somOrganDataSet" onsubmit="return false"class="L5form">
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput" colspan="5"><input type="text" id="branchSorgCode" onkeyup="value=value.replace(/[^\-\\w\.\/]/ig,'').toUpperCase()" onblur="sorgCodeUK();" name='"分支/代表机构登记证号"' field="sorgCode"  style="width:98%" /><label style="color:red">*</label></td>
							</tr>
							<tr>
