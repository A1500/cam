...
%>	
<script type="text/javascript" src="groupBranchHistoryChangeList.js"></script>
...
<script type="text/javascript">
	...
	var applyType='<%=ApplyType.SOM_GROUP_BRANCH_CHANGE%>';
</script>
</head>
<body>
...
<next:Panel width="100%" border="0">
	...
	<legend class="GroupBoxTitle">查询条件</legend>
			<table border="1" width="100%">
				<tr>
					<td class="FieldLabel" style="width:15%">社团(分支)代表机构名称：</td>
...
<next:EditGridPanel id="grid" dataset="somApplyDataSet" width="100%" stripeRows="true" height="99.9%">
	...
	<next:Columns>
		...
		<next:Column field="SORG_NAME" header="社会团体(分支)代表机构名称" width="20%" sortable="false"></next:Column>
