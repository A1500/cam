...
<script type="text/javascript" src="groupHistoryBuild.js"></script>
...
<script type="text/javascript">
	...
	currentSorgId = '<%=StrUtil.n2b(SomIdHelp.getGroupSorgId())%>';
...
<model:datasets>
	...
	<!-- 负责人信息 -->
	<model:dataset id="somDutyDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomDutyQueryCmd" global="true"  method="queryPeople" pageSize="300">
	...
	<%--人员简历 --%>
	<model:dataset id="somResumeDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomPeopleResumeQueryCommand" sortField="startDate">
					...
					<legend>社会团体信息</legend>
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput" style="width:17%"><input type="text" id="startDate" field="startDate" onClick="WdatePicker()" onchange="calSessionDate()" style="width:90%"/></td>
				...
				<form method="post" onsubmit="return false" dataset="somFee" class="L5form">
					...
					<table width="100%">
						...
						<tr>	
							...
							<td class="FieldLabel" style="width:17%width:17%">实到人数：</td>
