<%@ page language="java" contentType="text/html; charset=utf-8"
	pageEncoding="utf-8"%>
<%@ page
	import="com.inspur.cams.comm.util.StrUtil,org.loushang.next.skin.SkinUtils,com.inspur.cams.sorg.util.SomIdHelp"%>
...
<script type="text/javascript" src="groupBranchHistoryAPCheck.js"></script>
...
var method='<%=request.getParameter("method")%>';
	...
	var sorgId='<%=sorgId%>';
	if(sorgId == ''){
		sorgId = '<%=StrUtil.n2b(SomIdHelp.getGroupSorgId())%>';
	}
...
<%--定义dataset--%>
<model:datasets>
	<model:dataset id="somMainOrganDataSet"
					...
					<next:Html>
						...
						<table width="100%">
							<tr>
								...
								<td class="FieldInput"><input type="text" id="mainSorgCode"
									field="mainSorgCode" name='社会团体登记证号'
									onblur="validateSorgCode()" style="width: 90%" onkeyup="value=value.replace(/[^\-\\w\.\/]/ig,'').toUpperCase()" /><span
									style="color: red">*</span></td>
								<td class="FieldLabel">社会团体名称：</td>
								<td class="FieldInput" colspan="3"><input id="name"
									field="mainSorgName"name='"社会团体名称"' style="width: 97%" /><span
									style="color: red">*</span></td>
							</tr>
							<tr>
								...
								<td class="FieldInput" style="width: 17%"><input
									id="legalPeople" field="legalPeople"name='"法定代表人"' style="width: 90%" /><span
									style="color: red">*</span></td>
							</tr>
							<tr>
								<td class="FieldLabel" style="width: 17%">登记日期：</td>
								<td class="FieldInput" style="width: 17%"><input
									type="text" name='登记日期' field="regDate" onClick="WdatePicker()"
								...
								<td class="FieldInput" style="width: 17%"><select
									name='"分支机构类型"' field="sorgKind" style="width: 90%">
							...
							<tr>
								...
								<td class="FieldInput" colspan="5"><input type="text"
									id="cnName" name='"拟设立的分支/代表机构名称"' field="cnName"
									onblur="cnNameUK()" style="width: 98%" /><label
									style="color: red">*</label></td>
							</tr>
							<tr>
								<td class="FieldLabel"><label>拟设立的分支/代表机构办公场所：</label></td>
								<td class="FieldInput" colspan="5"><input type="text"
									name='"拟设立的分支/代表机构办公场所"' field="residence" style="width: 98%" /><label
									style="color: red">*</label></td>
							</tr>
							<tr>
								<td class="FieldLabel" style="width: 17%">拟设立的分支/代表机构负责人：</td>
								<td class="FieldInput" style="width: 17%"><input
									type="text" name='拟设立的分支/代表机构负责人' field="branchCharger"
									style="width: 90%" /><label style="color: red">*</label></td>
								<td class="FieldLabel" style="width: 15%"><label>拟设立的分支/代表机构电话：</label></td>
								<td class="FieldInput" style="width: 17%"><input
									type="text" id="sorgPhone" name='"拟设立的分支/代表机构电话"'
									field="sorgPhone" style="width: 90%" /></td>
								<td class="FieldLabel" style="width: 15%"><label>拟设立的分支/代表机构邮编：</label></td>
								<td class="FieldInput" style="width: 17%"><input
									type="text" id="sorgPost" name='"拟设立的分支/代表机构邮编"'
									field="sorgPost" style="width: 90%" /></td>
							</tr>
