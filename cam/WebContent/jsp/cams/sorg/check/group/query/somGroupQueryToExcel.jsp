...
<Excel:tablelist filename="查询报表">
	...
	<%--标题栏 --%>
		<Excel:tr>
			<Excel:td colspan="4" align="center">查询报表</Excel:td>
		</Excel:tr>
		<%
	...
	<%--时间栏 --%>
		<Excel:tr>
			<Excel:td colspan="4" align="left">日期：<%=sdf.format(new java.util.Date())%></Excel:td>
		</Excel:tr>
	<%--列标题 --%>
		<Excel:tr bgcolor="grey">
			<Excel:td  align="center" width="100">登记证号</Excel:td>
			<Excel:td  align="center" width="300">社会组织名称</Excel:td>
	...
	<%--数据区 --%>
		...
		<Excel:tr>
			...
			<Excel:td  align="center"><%=record.get("batchYear")%></Excel:td>
