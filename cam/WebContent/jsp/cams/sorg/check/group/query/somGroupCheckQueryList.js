...
function detail(){
	...
	var url='jsp/cams/sorg/check/group/detail/groupCheckDetail01.jsp';
	var text = '年检明细';
...
function confirmPrint(){
	...
	var url='';
	if(printPart==1){
		url='jsp/cams/sorg/check/group/print/groupCheckPrint01.jsp';
	}else{
		url='jsp/cams/sorg/check/group/print/groupCheckPrint9.jsp';
	}
	var text = '年检明细';
	L5.forward(url,text,data);
}
...
function ToExcel(){
	...
	L5.dataset2excel(dataset,"/jsp/cams/sorg/check/group/query/somGroupQueryToExcel.jsp");
}
