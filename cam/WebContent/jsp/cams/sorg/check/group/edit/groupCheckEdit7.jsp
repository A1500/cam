...
function nextPage(){
	save();
	var data = new L5.Map();
	var url='jsp/cams/sorg/check/group/edit/groupCheckEdit8.jsp';
...
<p style='line-height: 30.0pt; mso-line-height-rule: exactly'><span
	style='font-size: 16.0pt; font-family: 宋体; color: black'>编制单位：<input
...
<table border=1 cellspacing=0 cellpadding=0 width="800"
	...
	<tr style='height: 18.0pt'>
		...
		<p align=right
			...
			<input field="baReceiveDonations" name='"接受捐赠收到的现金"' style="width: 98%; text-align: right" maxlength="10" />
			</p>
		</td>
	</tr>
	<tr style='height: 18.0pt'>
		...
		<p align=right
			style='text-align: right; line-height: 30.0pt; mso-line-height-rule: exactly; mso-layout-grid-align: none; text-autospace: none'>
			<input field="baGatherDues" name='"收取会费收到的现金"' style="width: 98%; text-align: right" maxlength="10" />
			</p>
		</td>
	</tr>
	<tr style='height: 18.0pt'>
		...
		<p align=right
			style='text-align: right; line-height: 30.0pt; mso-line-height-rule: exactly; mso-layout-grid-align: none; text-autospace: none'>
			<input field="baRenderServices" name='"提供服务收到的现金"' style="width: 98%; text-align: right" maxlength="10" />
			</p>
		</td>
	</tr>
	<tr style='height: 18.0pt'>
		...
		<p align=right
			style='text-align: right; line-height: 30.0pt; mso-line-height-rule: exactly; mso-layout-grid-align: none; text-autospace: none'>
			<input field="baSellProduct" name='"销售商品收到的现金"' style="width: 98%; text-align: right" maxlength="10" />
			</p>
		</td>
	</tr>
	<tr style='height: 18.0pt'>
		...
		<p align=right
			style='text-align: right; line-height: 30.0pt; mso-line-height-rule: exactly; mso-layout-grid-align: none; text-autospace: none'>
			<input field="baGovernmentGrants" name='"政府补助收到的现金"' style="width: 98%; text-align: right" maxlength="10" />
			</p>
		</td>
	</tr>
	<tr style='height: 18.0pt'>
		...
		<p align=right
			style='text-align: right; line-height: 30.0pt; mso-line-height-rule: exactly; mso-layout-grid-align: none; text-autospace: none'>
			<input field="baInfolwOthers" name='"收到的其他与业务活动有关的现金"' style="width: 98%; text-align: right" maxlength="10" />
			</p>
		</td>
	</tr>
	<tr style='height: 18.0pt'>
		...
		<p align=right
			style='text-align: right; line-height: 30.0pt; mso-line-height-rule: exactly; mso-layout-grid-align: none; text-autospace: none'>
			<input field="baInflowSum" name='"现金流入小计"' style="width: 98%; text-align: right" maxlength="10" />
			</p>
		</td>
	</tr>
	<tr style='height: 18.0pt'>
		...
		<p align=right
			style='text-align: right; line-height: 30.0pt; mso-line-height-rule: exactly; mso-layout-grid-align: none; text-autospace: none'>
			<input field="baDonatedPay" name='"提供捐赠或者资助支付的现金"' style="width: 98%; text-align: right" maxlength="10" />
			</p>
		</td>
	</tr>
	<tr style='height: 18.0pt'>
		...
		<p align=right
			style='text-align: right; line-height: 30.0pt; mso-line-height-rule: exactly; mso-layout-grid-align: none; text-autospace: none'>
			<input field="baPayEmployee" name='"支付给员工以及为员工支付的现金"' style="width: 98%; text-align: right" maxlength="10" />
			</p>
		</td>
	</tr>
	<tr style='height: 18.0pt'>
		...
		<p align=right
			style='text-align: right; line-height: 30.0pt; mso-line-height-rule: exactly; mso-layout-grid-align: none; text-autospace: none'>
			<input field="baProductServices" name='"购买商品、接受服务支付的现金"' style="width: 98%; text-align: right" maxlength="10" />
			</p>
		</td>
	</tr>
	<tr style='height: 18.0pt'>
		...
		<p align=right
			style='text-align: right; line-height: 30.0pt; mso-line-height-rule: exactly; mso-layout-grid-align: none; text-autospace: none'>
			<input field="baOutflowOthers" name='"支付的其他与业务活动有关的现金"' style="width: 98%; text-align: right" maxlength="10" />
			</p>
		</td>
	</tr>
	<tr style='height: 18.0pt'>
		...
		<p align=right
			style='text-align: right; line-height: 30.0pt; mso-line-height-rule: exactly; mso-layout-grid-align: none; text-autospace: none'>
			<input field="baOutflowSum" name='"现金流出小计"' style="width: 98%; text-align: right" maxlength="10" />
			</p>
		</td>
	</tr>
	<tr style='height: 18.0pt'>
		...
		<p align=right
			style='text-align: right; line-height: 30.0pt; mso-line-height-rule: exactly; mso-layout-grid-align: none; text-autospace: none'>
			<input field="baNetAmount" name='"业务活动产生的现金流量净额"' style="width: 98%; text-align: right" maxlength="10" />
			</p>
		</td>
	</tr>
	<tr style='height: 18.0pt'>
	...
	<tr style='height: 18.0pt'>
		...
		<p align=right
			style='text-align: right; line-height: 30.0pt; mso-line-height-rule: exactly; mso-layout-grid-align: none; text-autospace: none'>
			<input field="iaRegoupingOutlay" name='"收回投资所收到的现金"' style="width: 98%; text-align: right" maxlength="10" />
			</p>
		</td>
	</tr>
	<tr style='height: 18.0pt'>
		...
		<p align=right
			style='text-align: right; line-height: 30.0pt; mso-line-height-rule: exactly; mso-layout-grid-align: none; text-autospace: none'>
			<input field="iaMadeIncome" name='"取得投资收益所收到的现金"' style="width: 98%; text-align: right" maxlength="10" />
			</p>
		</td>
	</tr>
</table>
