...
function addTr(){
    ...
    newNameTD.style.borderTop="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='line-height: 13.0pt; mso-line-height-rule: exactly'><span lang=EN-US><o:p><input name='备案时间' id='regTime"+xuhao+"' style='width:98%' format='Y-m-d' onclick='WdatePicker()'/></o:p></span></p>";
   //添加列:住所
...
<table id="table" class=MsoNormalTable border=1 cellspacing=0 cellpadding=0
	...
	<thead>
		<tr style='height: 23.65pt'>
			<td width="7%"
				style='width: 7.02%; border-top: 1.5pt; border-left: 1.5pt; border-bottom: 1.0pt; border-right: 1.0pt; border-color: windowtext; border-style: solid; mso-border-top-alt: 1.5pt; mso-border-left-alt: 1.5pt; mso-border-bottom-alt: .5pt; mso-border-right-alt: .5pt; mso-border-color-alt: windowtext; mso-border-style-alt: solid; padding: 0cm 5.4pt 0cm 5.4pt; height: 23.65pt'>
			...
			<td width="28%"
				style='width: 28.6%; border-top: solid windowtext 1.5pt; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-top-alt: solid windowtext 1.5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 23.65pt'>
			<p class=MsoNormal align=center
