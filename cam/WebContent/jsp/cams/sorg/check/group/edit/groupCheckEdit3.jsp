	...
	<table cellspacing=0 cellpadding=0 width="800" id="changeTable">
		...
		<tr style='height: 18.0pt'>
			...
			<p class=MsoNormal
				...
				<input type="text" id="changeDate1" format="Y-m-d" onclick="WdatePicker()" style="width: 98%" /></span></p>
			</td>
		</tr>
		<tr style='height: 18.0pt'>
			<td width="33%"
			...
			<p class=MsoNormal
				style='line-height: 25.0pt; mso-line-height-rule: exactly'><b
				style='mso-bidi-font-weight: normal'><span>
				<input type="text" id="changeDate2" format="Y-m-d" onclick="WdatePicker()" style="width: 98%" /></span></p>
			</td>
		</tr>
		<tr style='height: 18.0pt'>
			<td width="33%"
			...
			<p class=MsoNormal
				style='line-height: 25.0pt; mso-line-height-rule: exactly'><b
				style='mso-bidi-font-weight: normal'><span>
				<input type="text" id="changeDate3" format="Y-m-d" onclick="WdatePicker()" style="width: 98%" /></span></p>
			</td>
		</tr>
		<tr style='height: 18.0pt'>
			<td width="33%"
			...
			<p class=MsoNormal
				style='line-height: 25.0pt; mso-line-height-rule: exactly'><b
				style='mso-bidi-font-weight: normal'><span>
				<input type="text" id="changeDate4" format="Y-m-d" onclick="WdatePicker()" style="width: 98%" /></span></p>
			</td>
		</tr>
		<tr style='height: 18.0pt'>
			<td width="33%"
			...
			<p class=MsoNormal
				style='line-height: 25.0pt; mso-line-height-rule: exactly'><b
				style='mso-bidi-font-weight: normal'><span>
				<input type="text" id="changeDate5" format="Y-m-d" onclick="WdatePicker()" style="width: 98%" /></span></p>
			</td>
		</tr>
		<tr style='height: 18.0pt'>
			<td width="33%"
			...
			<p class=MsoNormal
				style='line-height: 25.0pt; mso-line-height-rule: exactly'><b
				style='mso-bidi-font-weight: normal'><span>
				<input type="text" id="changeDate6" format="Y-m-d" onclick="WdatePicker()" style="width: 98%" /></span></p>
			</td>
		</tr>
		<tr style='height: 18.0pt'>
			<td width="33%"
			...
			<p class=MsoNormal
				style='line-height: 25.0pt; mso-line-height-rule: exactly'><b
				style='mso-bidi-font-weight: normal'><span>
				<input type="text" id="changeDate7" format="Y-m-d" onclick="WdatePicker()" style="width: 98%" /></span></p>
			</td>
		</tr>
		<tr style='height: 18.0pt'>
			<td width="33%"
			...
			<p class=MsoNormal
				style='line-height: 25.0pt; mso-line-height-rule: exactly'><b
				style='mso-bidi-font-weight: normal'><span>
				<input type="text" id="changeDate8" format="Y-m-d" onclick="WdatePicker()" style="width: 98%" /></span></p>
			</td>
		</tr>
		<tr style='mso-yfti-lastrow: yes; height: 18.0pt'>
			...
			<p class=MsoNormal
				style='line-height: 25.0pt; mso-line-height-rule: exactly'><b
				style='mso-bidi-font-weight: normal'><span>
				<input type="text" id="changeDate9" format="Y-m-d" onclick="WdatePicker()" style="width: 98%" /></span></p>
			</td>
		</tr>
	</table>
</form>
	...
	<table cellspacing=0 cellpadding=0 width="800">
		...
		<tr style='height: 23.25pt'>
			...
			<p class=MsoNormal
				...
				lang=EN-US><span style='mso-spacerun: yes'><input type="text" name='最近一次换届大会时间' field="electionMeetingTime" style="width: 80" format="Y-m-d" onclick="WdatePicker()" />）<span lang=EN-US><o:p></o:p></span></span></p>
			</td>
		</tr>
		<tr style='height: 23.25pt'>
			<td width="34%" colspan=2
