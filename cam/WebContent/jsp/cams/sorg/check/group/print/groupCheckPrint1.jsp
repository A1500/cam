 ...
 <tr style='page-break-inside:avoid;height:27.0pt'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:27.0pt'>
	  <p style='line-height:28.0pt;'>
		  <span style='font-size:14.0pt;font-family:宋体'>
		  省部级及以上(<label class='label1'   field="servantProNum" style="width:50"></label>)人；
		  地厅级(<label class='label1'   field="servantCityNum" style="width:50"></label>)人；
		  县处级(<label class='label1'   field="servantTownNum" style="width:50"></label>)人
		  </span>
	  </p>
  </td>
 </tr>
 <tr style='mso-yfti-lastrow:yes;page-break-inside:avoid;height:27.0pt'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:27.0pt'>
	  <p style='margin-right:-.7pt;line-height:28.0pt;'>
		  <span style='font-size:14.0pt;font-family:宋体'>
		  总数(<label class='label1'   field="retiredSumNum" style="width:50"></label>)人，
		  其中地厅级及以上(<label class='label1'   field="retiredCityNum" style="width:50"></label>)人；
		  70岁以上(<label class='label1'   field="retiredOldNum" style="width:50"></label>)人
		  </span>
	  </p>
  </td>
 </tr>
