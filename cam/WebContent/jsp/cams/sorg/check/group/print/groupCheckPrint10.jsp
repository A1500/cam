	...
	somCheckSuborganDataSet.on("load",function(ds){
		if(ds.getCount()==0){
			...
			for(i=1;i<=ds.getCount();i++){
				...
				document.getElementById("accounts_10"+sequence).value=ds.getAt(i-1).get("accounts");
...
function addTr_10(){
    ...
    newNameTD.style.borderTop="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='line-height: 13.0pt; mso-line-height-rule: exactly'><span lang=EN-US><o:p><label class='label10'  name='名称' id='organName_10"+xuhao+"' style='width:98%'  maxlength='100'/></o:p></span></p>";
    //添加列:负责人
    ...
    newNameTD.style.borderTop="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='line-height: 13.0pt; mso-line-height-rule: exactly'><span lang=EN-US><o:p><label class='label10'  name='负责人' id='manager_10"+xuhao+"' style='width:98%'  maxlength='72'/></o:p></span></p>";
    //添加列:登记时间
    ...
    newNameTD.style.borderTop="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='line-height: 13.0pt; mso-line-height-rule: exactly'><span lang=EN-US><o:p><label class='label10'  name='登记时间' id='regTime_10"+xuhao+"' style='width:98%'/></o:p></span></p>";
    //添加列:登记证号
    ...
    newNameTD.style.borderTop="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='line-height: 13.0pt; mso-line-height-rule: exactly'><span lang=EN-US><o:p><label class='label10'  name='登记证号' id='regNumber_10"+xuhao+"' style='width:98%' maxlength='30'/></o:p></span></p>";
 	//添加列:账户
    ...
    newNameTD.style.borderTop="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='line-height: 13.0pt; mso-line-height-rule: exactly'><span lang=EN-US><o:p><label class='label10'  name='住所' id='address_10"+xuhao+"' style='width:98%'  maxlength='100'/></o:p></span></p>";
}
</script>
<style media="print">
...
<model:datasets>
	<model:dataset id="somCheckSuborganDataSet_10" cmd="com.inspur.cams.sorg.check.checksuborgan.cmd.SomCheckSuborganQueryCommand" global="true" pageSize="300">
...
<p class=MsoNormal align=left width=800px
	...
	<label class='label10'  field="delegateBuildNum" style="width:50"></label>
	）个，其中已办理成立登记手续的（	<label class='label10'  field="delegateBuildedNum" style="width:50"></label>
	）个；<span
...
<p class=MsoNormal align=left width=800px
	...
	<label class='label10'  field="delegateCancelNum" style="width:50"></label>
	）个，其中已办理注销登记手续的（
	<label class='label10'  field="delegateCanceledNum" style="width:50"></label>
	）个；<span
	lang=EN-US><o:p></o:p></span></span></p>
