...
function addTr_11(){
    ...
    newNameTD.style.borderTop="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='line-height: 13.0pt; mso-line-height-rule: exactly'><span lang=EN-US><o:p><label class='label11'  name='名称' id='organName_11"+xuhao+"' style='width:98%'  maxlength='100'/></o:p></span></p>";
    //添加列:负责人
    ...
    newNameTD.style.borderTop="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='line-height: 13.0pt; mso-line-height-rule: exactly'><span lang=EN-US><o:p><label class='label11'  name='负责人' id='manager_11"+xuhao+"' style='width:98%'  maxlength='72'/></o:p></span></p>";
    //添加列:备案时间
    ...
    newNameTD.style.borderTop="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='line-height: 13.0pt; mso-line-height-rule: exactly'><span lang=EN-US><o:p><label class='label11'  name='备案时间' id='regTime_11"+xuhao+"' style='width:98%'/></o:p></span></p>";
   //添加列:住所
    ...
    newNameTD.style.borderTop="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='line-height: 13.0pt; mso-line-height-rule: exactly'><span lang=EN-US><o:p><label class='label11'  name='住所' id='address_11"+xuhao+"' style='width:98%'  maxlength='100'/></o:p></span></p>";
...
<model:datasets>
	<model:dataset id="somCheckSuborganDataSet_11" cmd="com.inspur.cams.sorg.check.checksuborgan.cmd.SomCheckSuborganQueryCommand" global="true" pageSize="300">
...
<p class=MsoNormal align=left width=800px
	...
	field="workingBuildNum" style="width: 50"></label> </span></span>）个，其中已办理设立备案手续的（<span
	lang=EN-US><span style='mso-spacerun: yes'> <label class='label11' 
	field="workingBuildedNum" style="width: 50"></label> </span></span>）个；<span
...
<p class=MsoNormal align=left width=800px
	...
	lang=EN-US><span style='mso-spacerun: yes'><label class='label11' 
	field="workingCancelNum" style="width: 50"></label></span></span>）个，其中已办理撤销备案手续的（<span
	lang=EN-US><span style='mso-spacerun: yes'> <label class='label11' 
	field="workingCanceledNum" style="width: 50"></label> </span></span>）个；<span
	lang=EN-US><o:p></o:p></span></span></p>
