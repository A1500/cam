					...
					<form class="L5form">
						<table  border="1" width="100%" >
							<tr >
								...
								<td class="FieldInput"><input type="text"  id="batchYear" class="TextEditor" title="年检年份"  /></td>	
...
<next:GridPanel id="editGridPanel" name="somchecktaskGrid" width="100%" stripeRows="true" height="100%" dataset="ds" title="年检任务配置" notSelectFirstRow="true">
	<next:TopBar>
	...
	<next:Columns>
		...
		<next:Column id="taskName1" header="任务名称" field="taskName" width="250" >
			<next:TextField  />
		</next:Column>
	
		<next:Column id="batchYear1" header="年检年份" field="batchYear" width="90" >
			<next:TextField  />
		</next:Column>
		...
		<next:Column id="ifValid1" header="是否有效" field="ifValid" width="90" >
