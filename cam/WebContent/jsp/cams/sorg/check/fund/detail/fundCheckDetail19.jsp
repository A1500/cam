...
<div id="float"class="noprint"><input type="button" value="上一页"
	style="height: 25px; width: 80px; position: absolute; margin-left: 20px;"
	onclick="nextPageJ1('18')" /> <input type="button" value="下一页"
	style="height: 25px; width: 80px; position: absolute; margin-left: 120px;"
	onclick="nextPageJ1('20')" />  <input type="button" value="返回"
	...
	<TBODY>
		...
		<TR>
			...
			<TD align=middle width=111>&nbsp;<label
				...
				CLASS='input-01' SIZE='12' MAXLENGTH='15' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:right'>
			</TD>
			<TD align=middle width=76>&nbsp;<label
				id='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$bili$1' value=''
				CLASS='input-01' SIZE='5' MAXLENGTH='5' onKeyUp="value=value.replace(/[^\d.]/g,'');setSum();" style='text-align:center'></label>
			%</TD>
