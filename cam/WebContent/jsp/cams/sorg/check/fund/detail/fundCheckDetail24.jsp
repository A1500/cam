...
<div id="float" class="noprint">
	<input type="button" value="下一页" style="height:25px;width:80px;position:absolute;margin-left:120px;" onclick="nextPageJ1('25')"/>
	<input type="button" value="上一页" style="height:25px;width:80px;position:absolute;margin-left:20px;" onclick="nextPageJ1('23')"/>
	...
	<TBODY>
		...
		<TR>
			<TD class=word-st-14 height=40>B、本基金会通过社会组织评估，评估等级为 <label
				...
				CLASS='input-01' style='border-bottom: solid 1px;width:80;font-size: 16.0pt; font-family: 仿宋_GB2312'></label> ，有效期 自 <label
				name='query$form$0$JJHNJ_JSHJDGLTAB$youxiaoqikaishi' field='startDate'
				ID='有效期开始' CLASS='input-01' 
				 style='text-align:center;border-bottom: solid 1px;width:50;font-size: 16.0pt; font-family: 仿宋_GB2312'></label>
		...
		<TR>
			<TD class=word-st-14 height=40>本基金会是否取得过税收优惠资格 
				<label field='ifRevenueFavorable' style='text-align:center;border-bottom: solid 1px;width:50;font-size: 16.0pt; font-family: 仿宋_GB2312' dataset='comm_haveorno'></label>
			</TD>
		</TR>
		<TR>
	...
	ID='时间及批准部门' CLASS='input-01' ROWS='3' COLS='80' limit='256' field=favorableDateOrganDoc></textarea>
		...
		<TR>
			<TD class=word-st-14 height=40>本基金会是否受到过行政处罚 
				<label field='ifPunnish' style='width:100' dataset='comm_haveorno' style='text-align:center;border-bottom: solid 1px;width:50;font-size: 16.0pt; font-family: 仿宋_GB2312'></label>
			</TD>
		</TR>
		<TR>
