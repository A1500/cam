...
<div id="float" class="noprint">
	<input type="button" value="上一页" style="height:25px;width:80px;position:absolute;margin-left:20px;" onclick="nextPageJ1('28')"/>
	<input type="button" value="下一页" style="height:25px;width:80px;position:absolute;margin-left:120px;" onclick="nextPageJ1('30')"/>
				...
				<TBODY>
					...
					<TR align=middle>
						...
						<TD class=font12size2 height=31>
							<textarea CLASS='boder12-0' COLS='12' rows='3' limit='18'readonly ></textarea></TD>
						<TD class=font12size2 vAlign=middle>&nbsp;<label style='width:73px'
							name='query$form$0$JOIN_OUTER_ITEM$wofangjingfei$1' value=''
							ID='子表1.我方经费$1' 
							onkeyup="value=value.replace(/[^\d.-]/g,'') " style='text-align:right' CLASS='boder12-0' SIZE='10' maxlength='10'
							onChange='createNo(this);' ></TD>
						<TD class=font12size2 vAlign=middle>&nbsp;<label style='width:73px'
							name='query$form$0$JOIN_OUTER_ITEM$waifangjingfei$1' value=''
							ID='子表1.外方经费$1'
							onkeyup="value=value.replace(/[^\d.-]/g,'') " style='text-align:right' CLASS='boder12-0' maxlength='10' SIZE='10'
							onChange='createNo(this);' ></TD>
				...
				<TBODY>
					...
					<TR class=font12size2 align=middle>
						...
						<TD class=font12size2 vAlign=middle height=31>
							&nbsp;<label style='width:80px' CLASS='boder12-0' format="Y-m-d" onclick="LoushangDate(this);" readonly style='text-align:center'></TD>
						<TD class=font12size2><textarea
					...
					<TR class=font12size2 align=middle>
						...
						<TD class=font12size2 vAlign=middle height=32>
							&nbsp;<label CLASS='boder12-0' format="Y-m-d" onclick="LoushangDate(this);" readonly style='text-align:center'></TD>
						<TD class=font12size2><textarea
