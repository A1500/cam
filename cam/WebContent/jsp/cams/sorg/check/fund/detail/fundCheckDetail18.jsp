...
<body>
<model:datasets>
	<model:dataset id="somJxMajorDetailDataSet" cmd="com.inspur.cams.sorg.check.somcheckmajordetail.cmd.SomCheckMajorDetailQueryCommand" global="true" method="queryNoPage">
		<model:record fromBean="com.inspur.cams.sorg.check.somcheckmajordetail.dao.SomCheckMajorDetail"></model:record>
	</model:dataset>
</model:datasets>
<div id="float" class="noprint">
	<input type="button" value="下一页" style="height: 25px; width: 80px; position: absolute; margin-left: 120px;" onclick="nextPageJ1('19')" />
	<input type="button" value="上一页" style="height: 25px; width: 80px; position: absolute; margin-left: 20px;" onclick="nextPageJ1('17')" />
...
<TABLE class='word-st-14 border-tl' id=table1 cellSpacing=0
	...
	<TBODY>
		<TR>
			...
			<TD align=center colSpan=9 height=30>支出 <strong>（单位：<span style="color:red">万元</span>	）</strong>
			</TD>
		</TR>
		<TR>
		...
		<TR>
			<TD  height=32>1.<label readonly="readonly"
				...
				ID='子表.项目名称$1' CLASS='input-01' ROWS='3' style='width:80%' COLS='11' 
				></label></TD>
			<TD align=middle  height=32><label
				id='query$form$0$JJHNJ_ZHDGYHDSHZ_SUB$shouru$1'  ID='收入'
				CLASS='input-01' style='text-align:right'></label></TD>
			<TD align=middle ><label
				id='query$form$0$JJHNJ_ZHDGYHDSHZ_SUB$zhijiekuanwu$1'
				ID='直接款物' CLASS='input-01' style='text-align:right'></label></TD>
			<TD align=middle ><label
				id='query$form$0$JJHNJ_ZHDGYHDSHZ_SUB$xiangmurenyuangongzi$1'
				 ID='项目人员工资' CLASS='input-01' style='text-align:right'></label></TD>
			<TD align=middle ><label
				id='query$form$0$JJHNJ_ZHDGYHDSHZ_SUB$bangongfeiyong$1' 
				ID='办公费用' CLASS='input-01'  style='text-align:right'></label></TD>
			<TD align=middle ><label
				id='query$form$0$JJHNJ_ZHDGYHDSHZ_SUB$zichanshiyongfeiyong$1'
				value='' ID='资产使用费用' CLASS='input-01' style='text-align:right'></label></TD>
			<TD align=middle ><label
				id='query$form$0$JJHNJ_ZHDGYHDSHZ_SUB$xuanchuanfeiyong$1' 
				ID='宣传费用' CLASS='input-01'  style='text-align:right'></label></TD>
			<TD align=middle ><label
				id='query$form$0$JJHNJ_ZHDGYHDSHZ_SUB$chalvfei$1' 
				ID='差旅费' CLASS='input-01'  style='text-align:right'></label></TD>
			<TD align=middle ><label
				id='query$form$0$JJHNJ_ZHDGYHDSHZ_SUB$qitafeiyong$1' 
				ID='其他费用' CLASS='input-01'  style='text-align:right'></label></TD>
			<TD align=middle ><label
		...
		<TR>
			<TD  height=32>2.<label readonly="readonly"
				...
				ID='子表.项目名称$22' CLASS='input-01' ROWS='3' style='width:80%' COLS='11' 
				></label></TD>
			<TD align=middle  height=32><label
				id='query$form$0$JJHNJ_ZHDGYHDSHZ_SUB$shouru$2'  ID='收入'
				CLASS='input-01' style='text-align:right'
				></label></TD>
			<TD align=middle ><label
			...
			<TD align=middle ><label
				id='query$form$0$JJHNJ_ZHDGYHDSHZ_SUB$zichanshiyongfeiyong$2'
				 ID='资产使用费用' CLASS='input-01'  style='text-align:right'></label></TD>
			<TD align=middle ><label
		...
		<TR>
			...
			<TD align=middle><label
				...
				value='' ID='项目人员工资' CLASS='input-01' style='text-align:right'></label></TD>
			<TD align=middle><label
		...
		<TR>
			...
			<TD align=middle><label
				...
				CLASS='input-01' style='text-align:right'></TD>
			<TD align=middle><label
		...
		<tr>
			<TD  height=32>11.<label readonly="readonly"
				...
				ID='子表.项目名称$122' CLASS='input-01' ROWS='3' style='width:80%' COLS='11'
				></label></TD>
			<TD align=middle  height=32><label
			...
			<TD align=middle ><label
				...
				value='' ID='宣传费用' CLASS='input-01' style='text-align:right'></label></TD>
			<TD align=middle ><label
		...
		<TR>
			...
			<TD align=middle  height=32><label
				...
				CLASS='input-01' style='text-align:right'style='text-align:right'
				></label></TD>
			<TD align=middle ><label
		...
		<TR>
			...
			<TD align=middle><label
				...
				ID='办公费用' CLASS='input-01' SIZE='11' style='text-align:right'></label></TD>
			<TD align=middle><label
