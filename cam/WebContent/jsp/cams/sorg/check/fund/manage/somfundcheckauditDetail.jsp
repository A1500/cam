...
<html>
	<head>
		...
		<script language="javascript">
			...
			function returnList(){
				var data = new L5.Map();
				var url='jsp/cams/sorg/check/fund/manage/somfundcheckaudit_list.jsp';
				var text = '年检列表';
...
<iframe id="frame" marginwidth=0 marginheight=0 width=100% height=93% src="../detail/fundCheckDetail1.jsp?taskCode=<%= taskCode%>" frameborder=0></iframe>
