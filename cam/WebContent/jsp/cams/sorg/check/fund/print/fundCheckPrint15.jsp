							...
							<TBODY>
								<TR>
									<TD height=20>上年度总收入中有时间受限为上年不得使用的限定性收入为 <label
										field='limitTotal' style='border-bottom: solid 1px;width:60;font-size: 14.0pt; font-family: 仿宋_GB2312;text-align: center'></label>
									（单位：	<span style="color:red">万元</span>）,</TD>
								</TR>
								<TR>
									<TD height=20>
									<P>请说明具体情况:</P>
								...
								<TR>
									...
									<P>于上年解除时间限定的净资产为 <label field='unlimitTotal'
										style='border-bottom: solid 1px;width:60;font-size: 14.0pt; font-family: 仿宋_GB2312;text-align: center'></label>
									（单位：	<span style="color:red">万元</span>），</P>
									</TD>
								</TR>
								<TR>
