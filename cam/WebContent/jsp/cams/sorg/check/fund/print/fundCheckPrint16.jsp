...
function backJ(){
	var data = new L5.Map();
	var url='jsp/cams/sorg/check/fund/query/somFundCheckQueryList.jsp';
	var text = '年检查询';
...
<TABLE class='word-st-14 border-tl' id=table1 cellSpacing=0
	...
	<TBODY>
		<TR>
			...
			<TD align=middle width='134'height=24><STRONG>本年捐赠额（<span style="color:red">万元</span>）</STRONG></TD>
...
<jsp:include page="fundCheckPrint17.jsp" flush="true"/>
<jsp:include page="fundCheckPrint18.jsp" flush="true"/>
<jsp:include page="fundCheckPrint19.jsp" flush="true"/>
<jsp:include page="fundCheckPrint20.jsp" flush="true"/>
<jsp:include page="fundCheckPrint21.jsp" flush="true"/>
<jsp:include page="fundCheckPrint22.jsp" flush="true"/>
<jsp:include page="fundCheckPrint23.jsp" flush="true"/>
<jsp:include page="fundCheckPrint24.jsp" flush="true"/>
<jsp:include page="fundCheckPrint25.jsp" flush="true"/>
<jsp:include page="fundCheckPrint26.jsp" flush="true"/>
<jsp:include page="fundCheckPrint27.jsp" flush="true"/>
<jsp:include page="fundCheckPrint28.jsp" flush="true"/>
<jsp:include page="fundCheckPrint29.jsp" flush="true"/>
<jsp:include page="fundCheckPrint30.jsp" flush="true"/>
</body>
</html>