	...
	<next:Panel id="panelPartyMember" width="770" height="85%" autoScroll="true" title='基本信息'>
		...
		<table width="100%">
						...
						<tr>
							...
							<td class="FieldInput"><label name='性别' id="sex" field="sex" style="width: 90%" dataset="sexSelect"></label></td>				
						...
						<tr>
							...
							<td class="FieldInput" width="18%"><label name='专职/兼职' id="ifFulltime" field="ifFulltime" style="width: 90%" dataset="ifPartyMemberFulltimeSelect"></label></td>				
