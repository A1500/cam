...
function init(){  
	//取得文件名 和标签    
	var nowFileName = "groupBranchAPCheckAgree.doc";
	...
	command.execute("queryOrganName");
	...
	command.execute("queryOrganName");
	var mainSorgName = command.getReturn("cnName");
	showMap.put("cnName",cnName);
	showMap.put("mainSorgName",mainSorgName);
