...
function init(){  
	//取得文件名 和标签    
	var nowFileName = "penaltyForbidInform.doc";
	...
	ds.on("load",function(ds){
		...
		if(sorgType=="S"){
			...
			showMap.put("fileName","《社会团体登记管理条例》第三十五条");	
		}else if(sorgType=="M"){
			showMap.put("sorgType","民办非企业单位");	
			showMap.put("fileName","《民办非企业单位登记管理暂行条例》第二十七条");	
		}else if(sorgType=="J"){
			showMap.put("sorgType","基金会");	
			showMap.put("fileName","《基金会管理条例》第四十条");	
		}
