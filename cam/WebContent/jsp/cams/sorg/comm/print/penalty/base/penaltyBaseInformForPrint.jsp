...
var informDayNum='<%=request.getParameter("informDayNum")%>';
...
function init(){  
	...
	var nowFileName="";
	if(op=="beforeInform"){
		nowFileName = "penaltyBaseBeforeInform.doc";
	}else if(op=="beforeInformPublic"){
		nowFileName = "penaltyBaseBeforeInformPublic.doc";
	}else if(op=="hearingInform"){
		nowFileName = "penaltyBaseHearingInform.doc";
	}else if(op=="hearingInformPublic"){
		nowFileName = "penaltyBaseHearingInformPublic.doc";
	}
	...
	ds.on("load",function(ds){
		...
		showMap.put("invProof",ds.get("invProof"));
		showMap.put("informContent",ds.get("informContent"));
		showMap.put("dayNum",informDayNum);
		...
		var printTime=ds.get("informDate").split("-");
		var printTimeY = printTime[0];
		var printTimeM = printTime[1];
		var printTimeD = printTime[2];
