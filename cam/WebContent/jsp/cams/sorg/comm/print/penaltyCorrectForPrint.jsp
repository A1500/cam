...
function init(){
	//取得文件名 和标签    
	var nowFileName = "penaltyCorrect.doc";
	...
	ds.on("load",function(ds){
		showMap.put("correctNo",ds.get("correctNo"));
		showMap.put("sorgName",sorgName);
		showMap.put("illegalBehavior",ds.get("illegalBehavior"));
		showMap.put("deregulation",ds.get("deregulation"));
		var correctDate = ds.get("correctDate").split("-");
		var correctDateY = correctDate[0];
		var correctDateM = correctDate[1];
		var correctDateD = correctDate[2];
		showMap.put("correctDateY",correctDateY);
		showMap.put("correctDateM",correctDateM);
		showMap.put("correctDateD",correctDateD);
