...
<body onload="Start();" onunload="winclose();" >
					...
					<form style="width: 98%; height: 100%;" class="L5form" name="file" id="form_content">
						<table  border="0" width="100%" align="center">
							...
							<tr align="center">
								...
								<td colspan="3" align="center">
											选择文拍仪设备：<label><input type="radio" name="ModeGroup1" value="0" onclick="changeModel()">多易拍</label>
							...
							<tr align="center">
								...
								<td colspan="3" align="center">
									...
									文件名称：<input type="text" id="fileName" style="width:260;margin-left:12;" />
