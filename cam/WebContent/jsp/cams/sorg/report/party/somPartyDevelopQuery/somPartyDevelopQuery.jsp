...
<body>
<model:datasets> 
	<model:dataset id="ds" cmd="com.inspur.cams.sorg.report.cmd.SomPartyReportCmd" global="true" method="queryDevelop" autoLoad="false">
	</model:dataset>
</model:datasets>
	...
	<next:Panel width="100%" border="0"
		...
		<next:Html>
			...
			<div align="center"><span 
				style="font-size: large;font-weight:bold;">发展党员情况</span></div>
