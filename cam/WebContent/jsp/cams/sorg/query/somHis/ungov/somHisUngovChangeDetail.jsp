...
function forChangeShow(somChangeDataset){
	...
	if(changeItem=='0'){
		...
		document.getElementById('houseNameBefore').innerHTML=changeBefores[4];
		...
		document.getElementById('houseDateBefore').innerHTML=changeBefores[1];
		...
		document.getElementById('houseNameAfter').innerHTML=changeAfters[4];
		...
		document.getElementById('houseDateAfter').innerHTML=changeAfters[1];
	}else if(changeItem=='2'){
...
function detailLegalPeople(){
	...
	win.show();
	document.getElementById("detailAge").innerHTML=getAgeByCode(somLegalPeopleDataSet.getCurrent().get('idCard'));
...
<next:Window id="legalPeopleWindow" closeAction="hide" title="法定代表人登记表" height="400" width="800" modal="true">
	<next:TabPanel  width="98%" height="90%" id="detailLegalPeopleTab">
		<next:Tabs>
					...
					<form  method="post" dataset="somLegalPeopleDataSet" onsubmit="return false" class="L5form">
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput"><label id="detailAge" name='年龄'/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="FieldInput"><label field="education" dataset="educationSelect"/></td>
							...
							<tr>
								...
								<td class="FieldInput"><label id="ifPartyLeader_detail" field="ifPartyLeader" dataset="comm_yesorno"/></td>
...
<table width="100%">
			<tr>
				<td class="FieldLabel" style="width:30%"><label>名称变更前：</label></td>
				<td class="FieldInput"style="width:70%"><label id="nameBefore" /></td>
			</tr>
			<tr>
...
<table width="100%">
			...
			<tr>
				...
				<td class="FieldInput"colspan="3"><label id="houseDateAfter"  style="color:blue"/></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更程序：</label></td>
...
<!-- 变更开办资金 -->
<next:Window id="AddChange4" modal="true" closeAction="hide" title="开办资金变更" width="500"  autoScroll="true">
	<next:TopBar>
		<next:ToolBarItem text='' id="displayItem" />
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
		<next:ToolBarItem text="关闭" iconCls="return" handler="closeChangeWin"></next:ToolBarItem>
...
<!-- 出资人变更 -->
<next:Window id="AddChange7" closeAction="hide" title="出资人变更" width="600"  autoScroll="true" modal="true">
	<next:TopBar>
		<next:ToolBarItem text='' id="displayItem" />
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
		<next:ToolBarItem text="关闭" iconCls="return" handler="closeChangeWin"></next:ToolBarItem>
...
<table width="100%">
			<tr>
				...
				<td class="FieldInput"style="width:75%"><textArea field="changeBefore"  readonly="readonly" cols="75" rows="4" style="width: 100%"></textArea></td>
			</tr>
			<tr>
