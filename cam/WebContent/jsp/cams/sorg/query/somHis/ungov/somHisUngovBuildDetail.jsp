			...
			<next:Panel title="成立登记详细信息" width="100%" >
				<next:TabPanel width="100%" height="100%" id="sorgTab" activeTab="1">
					<next:Tabs>
						...
						<next:Panel title="单位领导成员(合伙人)情况">
						...
						<next:Panel title="法定代表人(负责人)登记表">
...
<!-- 负责人录入窗口 -->
<next:Window id="peopleWin" title="单位领导成员(合伙人)情况" resizable="false" width="800" height="400" closeAction="hide" autoScroll="true">
	<next:Panel id="panel_win">
		<next:Html>
			<form title="单位领导成员(合伙人)情况" id="addForm" method="post" dataset="somDutyInsertDataSet" onsubmit="return false" class="L5form">
				<table width="100%">
					<tr>
						<td class="FieldLabel" style="width:15%">身份证号码：</td>
