...
<%
	...
	String name="民办非企业单位台帐_"+date;
	String username=GetBspInfo.getBspInfo(request).getUserName();
%>
</head>
<Excel:tablelist filename="<%=name %>">
	<Excel:table sheetname="民办非企业单位台帐">
		<Excel:tr>
			<Excel:td colspan="86" align="center" ><Excel:font size="15">民办非企业单位台帐</Excel:font></Excel:td>
		</Excel:tr>
		<Excel:tr>
		...
		<Excel:tr height="30" bgcolor="grey" border="1">
			...
			<Excel:td  align="center" width="82" rowspan="3" bordercolor="black">开办资金</Excel:td>
			<Excel:td  align="center" width="93" rowspan="3" bordercolor="black">性质</Excel:td>
			<Excel:td  align="center" width="93" rowspan="3" bordercolor="black">是否新成立</Excel:td>
		...
		<Excel:tr border="1">
			...
			<Excel:td align="center"><%=rec.get("SORG_KIND")%></Excel:td>
			<Excel:td align="center"><%=rec.get("IF_NEW_BUILD")%></Excel:td>
