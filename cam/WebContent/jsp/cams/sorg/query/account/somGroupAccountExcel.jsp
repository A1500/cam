...
<%
	...
	String name="社会团体台帐_"+date;
	String username=GetBspInfo.getBspInfo(request).getUserName();
%>
</head>
<Excel:tablelist filename="<%=name %>">
	<Excel:table sheetname="社会团体台帐">
		<Excel:tr>
			<Excel:td colspan="89" align="center" ><Excel:font size="15">社会团体台帐</Excel:font></Excel:td>
		</Excel:tr>
		<Excel:tr>
		...
		<Excel:tr height="30" bgcolor="grey" border="1">
			...
			<Excel:td  align="center" width="103" rowspan="3" bordercolor="black">会员总数</Excel:td>			
			<Excel:td  align="center" width="82" colspan="2" bordercolor="black"></Excel:td>
			<Excel:td  align="center" width="153" rowspan="3" bordercolor="black">党政机关领导干部兼任领导人数</Excel:td>						
			...
			<Excel:td  align="center" width="150" rowspan="3" bordercolor="black">志愿者数</Excel:td>			
			<Excel:td  align="center" width="93" rowspan="3" bordercolor="black">是否建立党组织</Excel:td>
			<Excel:td  align="center" width="93" rowspan="3" bordercolor="black">出版物数</Excel:td>
		...
		<Excel:tr height="20" bgcolor="grey" border="1">
			...
			<Excel:td  align="center" width="82" rowspan="2" bordercolor="black">团体会员</Excel:td>	
			<Excel:td  align="center" width="82" rowspan="2" bordercolor="black">个人会员</Excel:td>	
		...
		<Excel:tr border="1">
			...
			<Excel:td align="center"><%=rec.get("TOTAL_NUM")%></Excel:td>
			<Excel:td align="center"><%=rec.get("UNITS_NUM")%></Excel:td>
			<Excel:td align="center"><%=rec.get("PEOPLE_NUM")%></Excel:td>
			<Excel:td align="center"><%=rec.get("SERVANT_TOTAL_NUM")%></Excel:td>
			<Excel:td align="center"><%=rec.get("")%></Excel:td>
			...
			<Excel:td align="center"><%=rec.get("VOLUNTER_NUM")%></Excel:td>
			<Excel:td align="center"><%=rec.get("IF_BUILD_PARTY")%></Excel:td>
			<Excel:td align="center"><%=rec.get("PUBLICATION_TOTAL_NUM")%></Excel:td>
		...
		<Excel:tr>
			...
			<Excel:td colspan="82" align="right">制表时间：<%= date2%></Excel:td>
		</Excel:tr>
	</Excel:table>
</Excel:tablelist>
