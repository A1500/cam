...
<script type="text/javascript" src="somFundAccount.js"></script>
...
<body>
<model:datasets>
	<model:dataset id="ds" cmd="com.inspur.cams.sorg.query.cmd.SomAccountQueryCmd" global="true" method="queryFundAccount" autoLoad="false" pageSize="15">
		<model:record fromBean="com.inspur.cams.sorg.query.data.SomFundAccountQuery"></model:record>
	</model:dataset>
	<!-- 行业分类 -->
...
<next:ViewPort>
	<next:GridPanel id="accountGrid" name="accountGrid" width="100%" height="100%" title="基金会台帐" dataset="ds" enableScollGridView="true">
		<next:TopBar>
		...
		<next:Columns>
			...
			<next:Column header="类型" field="T4" width="130" />
			...
			<next:Column header="其中：女" field="T5" width="130" />
			<next:Column header="中共党员人数" field="PARTY_PRACTITIONER_NUM" width="130" />
			<next:Column header="大学专科人数" field="T6" width="130" />
			<next:Column header="大学本科及以上人数" field="T7" width="130" />

			<next:Column header="助理社会工作师人数" field="T8" width="130" />
			<next:Column header="社会工作师人数" field="T9" width="130" />

			<next:Column header="35岁及以下人数" field="T10" width="130" />
			<next:Column header="36岁至45岁人数" field="T11" width="130" />
			<next:Column header="46岁至55岁人数" field="T12" width="130" />
			<next:Column header="56岁及以上人数" field="T13" width="130" />

			<next:Column header="执行会计制度" field="T14" width="130" />
			...
			<next:Column header="销售费用" field="T15" width="130" />
			<next:Column header="管理费用" field="MANAGE_COST_TY_SUM" width="130" />
			<next:Column header="管理费用税金" field="T16" width="130" />
			<next:Column header="差旅费" field="T17" width="130" />
			<next:Column header="财务费用" field="T18" width="130" />
			<next:Column header="利息支出" field="T19" width="130" />
			<next:Column header="公允价值变动收益" field="T20" width="130" />
			<next:Column header="投资收益" field="INV_INCOME_TY_SUM" width="130" />
			<next:Column header="营业利润" field="T21" width="130" />
			...
			<next:Column header="经营收入" field="T22" width="130" />
			...
			<next:Column header="商品和服务支出" field="T23" width="130" />
			<next:Column header="福利费" field="T24" width="130" />
			<next:Column header="劳务费" field="T25" width="130" />
			<next:Column header="取暖费" field="T26" width="130" />
			<next:Column header="差旅费" field="T27" width="130" />
			<next:Column header="对个人和家庭补助支出" field="T28" width="130" />
			<next:Column header="助学金" field="T29" width="130" />
			<next:Column header="抚恤金" field="T30" width="130" />
			<next:Column header="生活补助" field="T31" width="130" />
			...
			<next:Column header="业务活动成本税费" field="TAXES_TY_SUM" width="130" />

			<next:Column header="管理费用" field="MANAGE_COST_TY_SUM" width="130" />
			<next:Column header="人员费用" field="T32" width="130" />
			<next:Column header="日常费用" field="T33" width="130" />
			<next:Column header="固定资产折旧" field="T34" width="130" />
			<next:Column header="管理费用税费" field="T35" width="130" />

			<next:Column header="净资产变动额" field="ASSETS_CHANGE_TY_SUM" width="130" />
			<next:Column header="业务主管部门" field="BORG_NAME" width="130" />
			<next:Column header="原始基金数额" field="REG_MON" width="130" />
			<next:Column header="是否建立党组织" field="IF_BUILD_PARTY" width="130" />

			<next:Column header="本年度募集资金" field="CURRENT_MONEY" width="130" />
			<next:Column header="公益活动项目数" field="ACTIVITY_NUM" width="130" />
