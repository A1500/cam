...
<script type="text/javascript" src="somGroupAccount.js"></script>
<style>
</style>
...
<body>
<model:datasets>
	<model:dataset id="ds" cmd="com.inspur.cams.sorg.query.cmd.SomAccountQueryCmd" global="true" method="queryGroupAccount" autoLoad="false"  pageSize="15">
		<model:record fromBean="com.inspur.cams.sorg.query.data.SomGroupAccountQuery"></model:record>
	</model:dataset>
	<!-- 行业分类 -->
...
<next:ViewPort>
	<next:GridPanel id="accountGrid" name="accountGrid" width="100%" height="100%" title="社会团体台帐" dataset="ds" enableScollGridView="true">
		<next:TopBar>
		...
		<next:Columns>
			...
			<next:Column header="行业分类" field="BUS_SCOPE" width="130" />
			...
			<next:Column header="女性" field="DUTY_FEMALE_COUNT" width="130" />

			<next:Column header="会员总数" field="TOTAL_NUM" width="130" />
			<next:Column header="团体会员" field="UNITS_NUM" width="130" />
			<next:Column header="个人会员" field="PEOPLE_NUM" width="130" />

			<next:Column header="党政机关领导干部兼任领导人数" field="SERVANT_TO_TALNUM" width="130" />
			...
			<next:Column header="管理费用税金" field="T15" width="130" />
			...
			<next:Column header="管理费用税费" field="T34" width="130" />
			...
			<next:Column header="志愿者数" field="VOLUNTER_NUM" width="130" />
			<next:Column header="是否建立党组织" field="IF_BUILD_PARTY" width="130" />
			<next:Column header="出版物数" field="PUBLICATION_TOTAL_NUM" width="130" />
