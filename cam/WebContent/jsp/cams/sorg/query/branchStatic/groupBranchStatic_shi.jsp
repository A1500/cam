...
<script type="text/javascript" src="groupBranchStatic_shi.js"></script>
<style>
body {
...
<body>
<model:datasets>
		<model:dataset id="ds" cmd="com.inspur.cams.sorg.query.cmd.SomBranchStaticCmd" method="groupBranchStatic" global="true" autoLoad="false">
		<model:record>
			...
			<model:field name="COUNT_FD" type="string" />
			<model:field name="COUNT_F" type="string" />
			<model:field name="COUNT_D" type="string" />			
		</model:record>
	</model:dataset>
</model:datasets>
<next:ViewPort>
	<next:Panel width="100%" border="0"
		...
		<next:Html>
			...
			<div align="center"><span id="reportTitle"
				style="font-size: large;">社会团体分支（代表）机构统计表</span></div>
				...
				<tr>
					...
					<table width="100%" dataset="ds" align="center">
						<tr>
							...
							<td class="tdTitle" width="200" align="center" colspan="2">已建立分支（代表）机构</td>
							<td class="tdTitle" width="200" align="center" colspan="2">未建立分支（代表）机构</td>
							<td class="tdTitle" width="100" align="center" rowspan="2">分支（代表）<br/>机构总数</td>
							<td class="tdTitle" width="100" align="center" rowspan="2">分支机构<br/>总数</td>
							<td class="tdTitle" width="100" align="center" rowspan="2">代表机构<br/>总数</td>
						</tr>
						<tr>
						...
						<tr repeat="true">
							...
							<td align="center" class="td">
								<label field="COUNT_FD" ></label>
							</td>								
							<td align="center" class="td">
								<label field="COUNT_F" ></label>
							</td>							
							<td align="center" class="td">
								<label field="COUNT_D" ></label>
							</td>
						</tr>						
					</table>
					</td>
