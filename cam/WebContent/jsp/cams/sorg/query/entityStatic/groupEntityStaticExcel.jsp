...
<%
	...
	String name="社会团体举办实体情况统计表_"+date;
	String username=GetBspInfo.getBspInfo(request).getUserName();
%>
</head>
<Excel:tablelist filename="<%=name %>">
	<Excel:table sheetname="社会团体举办实体情况统计表">
		<Excel:tr>
			<Excel:td colspan="7" align="center" ><Excel:font size="15">社会团体举办实体情况统计表</Excel:font></Excel:td>
		</Excel:tr>
		<Excel:tr>
		...
		<Excel:tr height="30" bgcolor="grey" border="1">
			...
			<Excel:td  align="center" width="200" colspan="2" bordercolor="black">已建立举办实体</Excel:td>
			<Excel:td  align="center" width="200" colspan="2" bordercolor="black">未建立举办实体</Excel:td>
			<Excel:td  align="center" width="100" rowspan="2" bordercolor="black">举办实体数</Excel:td>			
		</Excel:tr>
		...
		<Excel:tr border="1">
			...
			<Excel:td align="center"><%=rec.get("COUNT_E")%></Excel:td>
		</Excel:tr>
		<%
			}
		%>
