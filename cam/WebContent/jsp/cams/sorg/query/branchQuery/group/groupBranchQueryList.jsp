...
<html>
<head>
<title>社团分支/代表机构列表</title>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript" src="groupBranchQueryList.js"></script>
	...
	<fieldset style="overflow: visible;" class="GroupBox">
		...
		<form class="L5form">
			<table  border="1" width="100%">
				<tr>
					<td class="FieldLabel" style="width:15%"><label>社团主体名称：</label></td>
					<td class="FieldInput" style="width:20%"><input type="text" id="m_cnName" style="width:100%"/></td>				
					<td class="FieldLabel" style="width:15%"><label>社团主体登记证号：</label></td>
...
<next:EditGridPanel id="grid" dataset="somOrganDataSet" width="100%" stripeRows="true" height="99.9%">
	<next:TopBar>
		<next:ToolBarItem symbol="社团分支/代表机构列表"></next:ToolBarItem>
	...
	<next:Columns>
		...
		<next:Column field="SORG_CODE" header="分支/代表机构登记证号" width="20%" sortable="false"></next:Column>
		<next:Column field="CN_NAME" header="分支/代表机构名称" width="25%" sortable="false"></next:Column>
		<next:Column field="SORG_STATUS" header="分支/代表机构状态" width="20%" sortable="false" dataset="sorgStatusSelect"></next:Column>
		<next:Column field="M_CN_NAME" header="社团主体名称" width="25%"></next:Column>
