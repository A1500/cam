			...
			//for(i=1;i<=somJxOrganFundsDataSet12.getCount();i++){
				...
				//for(j=1;j<=somJxOrganFundsDataSet12.getCount();j++){
					...
					///	tab.rows[rowLength-1].cells[1].getElementsByTagName("label")[0].innerHTML=somJxOrganFundsDataSet12.getAt(j-1).get("organName");
						...
						//var checkinType = "";
						//if(somJxOrganFundsDataSet12.getAt(j-1).get("checkinType")=="1"){
						//	checkinType="有限责任公司";
						//}
						//if(somJxOrganFundsDataSet12.getAt(j-1).get("checkinType")=="2"){
						//	checkinType="有限责任公司（国有独资）";
						//}
						//if(somJxOrganFundsDataSet12.getAt(j-1).get("checkinType")=="3"){
							//checkinType="有限责任公司（自然人独资）";
						//}
						//if(somJxOrganFundsDataSet12.getAt(j-1).get("checkinType")=="4"){
							//checkinType="有限责任公司（法人独资）";
						//}if(somJxOrganFundsDataSet12.getAt(j-1).get("checkinType")=="5"){
							//checkinType="股份有限公司";
						//}if(somJxOrganFundsDataSet12.getAt(j-1).get("checkinType")=="6"){
							//checkinType="股份有限公司（上市）";
						//}if(somJxOrganFundsDataSet12.getAt(j-1).get("checkinType")=="7"){
							//checkinType="有限责任公司分公司";
						//}if(somJxOrganFundsDataSet12.getAt(j-1).get("checkinType")=="8"){
							//checkinType="股份有限公司分公司 集体所有制（股份合作）企业";
						//}if(somJxOrganFundsDataSet12.getAt(j-1).get("checkinType")=="9"){
						//	checkinType="集体所有制（股份合作）企业";
						//}if(somJxOrganFundsDataSet12.getAt(j-1).get("checkinType")=="10"){
							//checkinType="集体所有制（股份合作）企业设立的非法人分支机构";
						//}
						//if(somJxOrganFundsDataSet12.getAt(j-1).get("checkinType")=="11"){
							//checkinType="集体所有制（股份合作）企业设立的法人分支机构";
						//}
						//if(somJxOrganFundsDataSet12.getAt(j-1).get("checkinType")=="12"){
							///checkinType="集体所有制（股份合作）企业设立的法人分支机构的营业登记单位";
						//}
						//if(somJxOrganFundsDataSet12.getAt(j-1).get("checkinType")=="13"){
							//checkinType="全民所有制企业";
						//}
						//if(somJxOrganFundsDataSet12.getAt(j-1).get("checkinType")=="14"){
							//checkinType="全民所有制企业的营业单位";
						//}
						//if(somJxOrganFundsDataSet12.getAt(j-1).get("checkinType")=="15"){
							//checkinType="集体所有制企业";
						//}
						//if(somJxOrganFundsDataSet12.getAt(j-1).get("checkinType")=="16"){
							//checkinType="集体所有制企业的营业单位";
						//}
						//if(somJxOrganFundsDataSet12.getAt(j-1).get("checkinType")=="17"){
							//checkinType="合伙企业（普通合伙、特殊普通合伙、有限合伙）";
						//}
						//if(somJxOrganFundsDataSet12.getAt(j-1).get("checkinType")=="18"){
							//checkinType="合伙企业的分支机构";
						//}
						//if(somJxOrganFundsDataSet12.getAt(j-1).get("checkinType")=="19"){
							//checkinType="个人独资企业";
						//}
						//if(somJxOrganFundsDataSet12.getAt(j-1).get("checkinType")=="20"){
							//checkinType="个人独资企业的分支机构";
						//}
						//if(somJxOrganFundsDataSet12.getAt(j-1).get("checkinType")=="21"){
							//checkinType="个体工商户";
						//}
						//if(somJxOrganFundsDataSet12.getAt(j-1).get("checkinType")=="22"){
							//checkinType="无";
						//}
...
mso-hansi-font-family:仿宋_GB2312'>（七）其他活动情况<span lang=EN-US><o:p></o:p></span></span></p>


<p class=MsoNormal
	style="text-align:left"><span
	lang=EN-US style='font-size: 14.0pt; font-family: 仿宋_GB2312'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1、本组织承接政府转移职能和购买服务情况（填写承接内容）：</span><u><span
...
<p class=MsoNormal
	style="text-align:left"><span
	lang=EN-US style='font-size: 14.0pt; font-family: 仿宋_GB2312'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2、中央及省级党委、政府对本组织工作批示内容（填写批示内容）：</span><u><span
	style='font-size: 14.0pt; font-family: 仿宋_GB2312'></span></u><span
	style='font-size: 14.0pt; font-family: 仿宋_GB2312; mso-hansi-font-family: 宋体'>
...
<p class=MsoNormal
	style="text-align:left"><span
	lang=EN-US style='font-size: 14.0pt; font-family: 仿宋_GB2312'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3、中央及省级党委、政府对本组织在有关简报、通报情况:</span><u><span
	style='font-size: 14.0pt; font-family: 仿宋_GB2312'></span></u><span
	style='font-size: 14.0pt; font-family: 仿宋_GB2312; mso-hansi-font-family: 宋体'>
...
<p class=MsoNormal
	style="text-align:left"><span
	lang=EN-US style='font-size: 14.0pt; font-family: 仿宋_GB2312'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4、本组织在全国及省级党委、政府部门召开会议上的典型发言情况:</span><u><span
	style='font-size: 14.0pt; font-family: 仿宋_GB2312'></span></u><span
	style='font-size: 14.0pt; font-family: 仿宋_GB2312; mso-hansi-font-family: 宋体'>
 ...
 <textarea field="statement"  title='本组织在全国及省级党委、政府部门召开会议上的典型发言情况' name='"本组织在全国及省级党委、政府部门召开会议上的典型发言情况"'  style="width:600;margin-left: 100"  rows="7" readonly="readonly" ></textarea>
	...
	lang=EN-US style='font-size: 14.0pt; font-family: 仿宋_GB2312'><o:p></o:p></span></p></form>
</div></div>
<TABLE align='center'>
