		...
		<TR>
			...
			<TABLE height=645 cellSpacing=0 cellPadding=0 width=800 align=center
				...
				<TBODY>
					...
					<TR>
						<TD align=middle height=14><STRONG>（一）接受捐赠情况</STRONG></TD>
					</TR>
					<TR>
						<TD height='10' vAlign=bottom align=right>单位：人民币元</TD>
					</TR>
					<TR>
							...
							<TBODY>
								...
								<TR>
									...
									<TD class=unnamed2 align=middle height=22><input
										name='query$form$0$JJHNJ_REPORT_THR$xianjin3' field='inPeopleMoney'
										ID='现金3' MAXLENGTH='8' CLASS='boder-0' isMoney='true'
										style='text-align: right' SIZE='14'
										onKeyUp="value=value.replace(/[^\d..]/g,'');setSumMoney();"></TD>
									<TD class=unnamed2 height=22><input
										name='query$form$0$JJHNJ_REPORT_THR$shiwuzhehe3' field='inPeoplePracticali'
										ID='实物折合3' MAXLENGTH='8' CLASS='boder-0' isMoney='true'
										style='text-align: right' SIZE='16'
										onKeyUp="value=value.replace(/[^\d.]/g,'');setSumMoney();" ></TD>
									<TD class=font-calend height=22><input
								...
								<TR>
									...
									<TD class=unnamed2 align=middle width='21%' height=22><input
										name='query$form$0$JJHNJ_REPORT_THR$xianjin4' field='inOtherMoney'
										ID='现金4' MAXLENGTH='8' CLASS='boder-0' isMoney='true'
										style='text-align: right' SIZE='14'
										onKeyUp="value=value.replace(/[^\d.]/g,'');setSumMoney();" ></TD>
									<TD class=unnamed2 width='16%' height=22><input
										name='query$form$0$JJHNJ_REPORT_THR$shiwuzhehe4' field='inOtherPracticali'
										ID='实物折合4' MAXLENGTH='8' CLASS='boder-0' isMoney='true'
										style='text-align: right' SIZE='16'
										onKeyUp="value=value.replace(/[^\d.]/g,'');setSumMoney();" ></TD>
								...
								<TR>
									...
									<TD class=unnamed2 align=middle height=22><input
										name='query$form$0$JJHNJ_REPORT_THR$xianjin6' field='offPeopleMoney'
										ID='现金6' MAXLENGTH='8' CLASS='boder-0' isMoney='true'
										style='text-align: right' SIZE='14'
										onKeyUp="value=value.replace(/[^\d.]/g,'');setSumMoney();" ></TD>
									<TD class=unnamed2 height=22><input
										name='query$form$0$JJHNJ_REPORT_THR$shiwuzhehe6' field='offPeoplePracticali'
										ID='实物折合6' MAXLENGTH='8' CLASS='boder-0' isMoney='true'
										style='text-align: right' SIZE='16'
										onKeyUp="value=value.replace(/[^\d.]/g,'');setSumMoney();" ></TD>
									<TD class=font-calend height=22><input
								...
								<TR>
									...
									<TD class=unnamed2 align=middle height=22><input 
										name='query$form$0$JJHNJ_REPORT_THR$xianjin7' field='offOtherMoney'
										ID='现金7' MAXLENGTH='8' CLASS='boder-0' isMoney='true'
										style='text-align: right' SIZE='14'
										onKeyUp="value=value.replace(/[^\d.]/g,'');setSumMoney();" ></TD>
									<TD class=unnamed2 height=22><input
										name='query$form$0$JJHNJ_REPORT_THR$shiwuzhehe7' field='offOtherPracticali'
										ID='实物折合7' MAXLENGTH='8' CLASS='boder-0' isMoney='true'
										style='text-align: right' SIZE='16'
										onKeyUp="value=value.replace(/[^\d.]/g,'');setSumMoney();" ></TD>
									<TD class=font-calend height=22><input
					...
					<TR>
						...
						<TABLE cellSpacing=0 cellPadding=0 width='100%' align=center
							...
							<TBODY>
								...
								<TR>
									<TD align=right height=22>单位：人民币元</TD>
								</TR>
								<TR>
									<TD>
										...
										<TBODY>
											...
											<TR>
												...
												<TD class=unnamed3 align=middle height=22><input
													...
													field='balance' ID='上年度基金余额' MAXLENGTH='8' size='13' CLASS='boder-0'
											...
											<TR>
												...
												<TD class=unnamed3 align=middle height=22><input
													name='query$form$0$JJHNJ_REPORT_THR$zongzhichu' field='expenditure'
													ID='本年度总支出' MAXLENGTH='8' size='13' isMoney='true'
											...
											<TR>
												...
												<TD class=unnamed3 align=middle height=22><input
													name='query$form$0$JJHNJ_REPORT_THR$gongyizhichu' field='expPub'
													ID='公益支出' MAXLENGTH='8' isMoney='true' size='13'
													style='text-align: right' CLASS='boder-0'
													onKeyUp="value=value.replace(/[^\d.]/g,'');setPerMoney();" ></TD>
											</TR>
											<TR>
												...
												<TD class=unnamed3 align=middle height=22><input
													name='query$form$0$JJHNJ_REPORT_THR$gongzizhichu' field='expPer'
													ID='工资支出' MAXLENGTH='8' size='13' isMoney='true'
													style='text-align: right' CLASS='boder-0'
													onKeyUp="value=value.replace(/[^\d.]/g,'');setPerMoney();" ></TD>
											</TR>
											<TR>
												...
												<TD class=unnamed3 align=middle height=22><input
													...
													field='expOff' ID='行政支出' MAXLENGTH='8' isMoney='true' size='13'
													style='text-align: right' CLASS='boder-0'
													onKeyUp="value=value.replace(/[^\d.]/g,'');setPerMoney();" ></TD>
											</TR>
											<TR>
					...
					<TR>
						<TD vAlign=top height=23>说明：公益事业支出为业务活动成本中直接用于开展符合公益目的的活动的费用，上年基金余额为上年末净资产。&nbsp;</TD>
					</TR>
				</TBODY>
			</TABLE>
			</TD>
