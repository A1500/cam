...
<model:datasets>
	<model:dataset id="somCheckDataSet" cmd="com.inspur.cams.sorg.jxcheck.somjxcheck.cmd.SomJxCheckQueryCommand" global="true">
		<model:record fromBean="com.inspur.cams.sorg.jxcheck.somjxcheck.dao.SomJxCheck">
			...
			<model:field name="linkmanName" type="string" rule="length{200}" />
		</model:record>
	</model:dataset>
			...
			<TABLE class=unnamed1 cellSpacing=0 cellPadding=0 width=800 border=0>
				<TBODY>
					...
					<TR>
						...
						<TD height=30 colspan='5' class=unnamed3><select field='sorgKind'><option dataset="sorgKindSelect"></option></select></TD>
					</TR>
					<TR>
						...
						<TD height=30 colspan='2' class=unnamed3><input field="initialFund"
							name='原始基金数额'  
							CLASS='boder-0' SIZE='30' MAXLENGTH='50' >(人民币<span
					...
					<TR>
						...
						<TD class=unnamed3 colSpan=5 height=30><input field="residence"
							name='query$form$0$JJH_NJ_REPORT1$jijinhuizhusuo' value=''
					...
					<TR>
							...
							<TBODY>
								<TR>
									<TD align=left><input field="secretaryName"
										name='query$form$0$JJH_NJ_REPORT1$mishuchangxingming' value=''
						...
						<TD height=30 class=unnamed2><input field="secretaryPhone"
							name='query$form$0$JJH_NJ_REPORT1$mishuzhangdianhua' value=''
							ID='秘书长固定电话' CLASS='boder-0' SIZE='16' MAXLENGTH='20' >
						</TD>
						<TD height=30 class=unnamed2><input field="secretaryMobile"
							name='query$form$0$JJH_NJ_REPORT1$mishuzhangyidongdianhua'
						...
						<TD height=30 class=unnamed2><input field="linkmanPhone"
							name='query$form$0$JJH_NJ_REPORT1$quhaoyi' value='' ID='区号一'
							CLASS='boder-0' SIZE='18' maxlength='30' /> 
						</TD>
						<TD height=30 class=unnamed3><input field="linkmanMobile"
							name='query$form$0$JJH_NJ_REPORT1$yidongdianhua' value=''
					...
					<TR>
						...
						<TD height=30 colspan='2' class=unnamed2><input field="sorgEmail"
							name='query$form$0$JJH_NJ_REPORT1$dianziyouxiangdizhi' value=''
						...
						<TD height=30 colspan='2' class=unnamed3><input field="sorgFax"
							name='query$form$0$JJH_NJ_REPORT1$quhaoer' value='' ID='区号二'
							CLASS='boder-0' SIZE='24' maxlength='30' > </TD>
					</TR>
					<TR>
						<TD class=unnamed2 align=middle height=30>网站名称</TD>
						<TD height=30 colspan='2' class=unnamed2><input field="sorgWebName"
							name='query$form$0$JJH_NJ_REPORT1$hulianwangzhongwenming'
						...
						<TD height=30 colspan='2' class=unnamed3><input field="sorgWeb"
							name='query$form$0$JJH_NJ_REPORT1$hulianwangwangzhi' value=''
					...
					<TR>
							...
							<TBODY>
								<TR>
									<TD><input field="presidentName"
										name='query$form$0$JJH_NJ_REPORT1$lishichangxingming' value=''
										CLASS='boder-0' ></TD>
								</TR>
							</TBODY>
						</TABLE>
						...
						<TD height=30 colspan='2' class=unnamed3><input field="sorgPost"
							name='query$form$0$JJH_NJ_REPORT1$youzhengbianma' value=''
					...
					<TR>
						...
						<TABLE height=40 cellSpacing=0 cellPadding=0 width='100%' border=0>
							<TBODY>
								<TR>
									<TD><input field="syndicNum" name='query$form$0$JJH_NJ_REPORT1$lishirenshu'
										value='' CLASS='boder-0' SIZE='16' maxlength='20' >
									</TD>
								</TR>
							</TBODY>
						</TABLE>
							...
							<TBODY>
								<TR>
									<TD><input field="auditorNum"
										name='query$form$0$JJH_NJ_REPORT1$jianshirenshu' value=''
										CLASS='boder-0' SIZE='8' maxlength='8' ></TD>
								</TR>
							</TBODY>
						</TABLE>
						</TD>
					...
					<TR>
						<TD class=unnamed2 align=middle height=30>负责人数</TD>
						<TD height=30 colspan='2' class=unnamed2>
						<TABLE height=40 cellSpacing=0 cellPadding=0 width='100%' border=0>
							<TBODY>
								<TR>
									<TD class=unnamed4 width='55%'><input field="principalNum"
										name='query$form$0$JJH_NJ_REPORT1$fuzerenshu' value=''
						...
						<TD class=unnamed2 align=middle height=30><input field="principalGovNum"
							name='query$form$0$JJH_NJ_REPORT1$GUOJIARENYUAN' value=''
							CLASS='boder-0' SIZE='10' maxlength='10' ></TD>
						<TD height=30 colspan='2' class=unnamed3>
						<TABLE height=40 cellSpacing=0 cellPadding=0 width='100%' border=0>
							<TBODY>
								<TR>
									...
									<TD align=middle><input field="principalProvinceNum"
										name='query$form$0$JJH_NJ_REPORT1$SHENGBUJI' value=''
							...
							<TBODY>
								<TR>
									<TD><input field="ramusNum"
										name='query$form$0$JJH_NJ_REPORT1$fenzhijigoushu' value=''
										CLASS='boder-0' SIZE='10' maxlength='10' ></TD>
								</TR>
							</TBODY>
						</TABLE>
							...
							<TBODY>
								<TR>
									<TD align=left><input field="delegateNum"
										name='query$form$0$JJH_NJ_REPORT1$daibiaojigoushu' value=''
										CLASS='boder-0' SIZE='8' maxlength='8' ></TD>
								</TR>
							</TBODY>
						</TABLE>
							...
							<TBODY>
								<TR>
									<TD><input field="specialFunds"
										name='专项基金数' value=''
										 size='8' maxlength='8' CLASS='boder-0' ></TD>
								</TR>
							</TBODY>
						</TABLE>
						</TD>
							...
							<TBODY>
								<TR>
									<TD align=left><input field="fulltimeNum"
										name='query$form$0$JJH_NJ_REPORT1$zhuanzhirenshu' value=''
										ID='专职人数' size='8' maxlength='8' CLASS='boder-0' >
									</TD>
								</TR>
							</TBODY>
						</TABLE>
							...
							<TBODY>
								<TR>
									<TD><input field="postulandNum"
										name='query$form$0$JJH_NJ_REPORT1$zhiyuanzherenshu' value=''
										CLASS='boder-0' SIZE='10' maxlength='10' ></TD>
								</TR>
							</TBODY>
						</TABLE>
					...
					<TR>
						...
						<TD colSpan=5 height=30><input field="taxCode"
							name='query$form$0$JJH_NJ_REPORT1$nashuirenshibiehao' value=''
