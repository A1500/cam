			...
			for(i=1;i<=somJxOrganFundsDataSet.getCount();i++){
				...
				for(j=1;j<=somJxOrganFundsDataSet.getCount();j++){
					if(somJxOrganFundsDataSet.getAt(j-1).get("seqNum") == i){
						...
						tab.rows[rowLength-1].cells[2].getElementsByTagName("input")[0].value=somJxOrganFundsDataSet.getAt(j-1).get("peopleName");
						tab.rows[rowLength-1].cells[3].getElementsByTagName("input")[0].value=somJxOrganFundsDataSet.getAt(j-1).get("organDate");
						tab.rows[rowLength-1].cells[4].getElementsByTagName("input")[0].value=somJxOrganFundsDataSet.getAt(j-1).get("sorgCode");
						tab.rows[rowLength-1].cells[5].getElementsByTagName("textarea")[0].value=somJxOrganFundsDataSet.getAt(j-1).get("place");
						tab.rows[rowLength-1].cells[6].getElementsByTagName("select")[0].value=somJxOrganFundsDataSet.getAt(j-1).get("accountType");
						tab.rows[rowLength-1].cells[7].getElementsByTagName("textarea")[0].value=somJxOrganFundsDataSet.getAt(j-1).get("openAccount");
					}
				}
...
function addFTr(){
    ...
    newNameTD.style.borderRight="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML ="<p class=MsoNormal style='mso-line-height-alt: 12.0pt'><span lang=EN-US style='font-size: 14.0pt; font-family: 仿宋_GB2312'><textarea id='organName"+xuhao+"' onkeyup='this.value = this.value.slice(0,100)' ROWS='3' COLS='20'></textarea></span></p>"
    //添加列:负责人
    ...
    newNameTD.style.borderRight="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='mso-line-height-alt: 12.0pt'><span lang=EN-US style='font-size: 14.0pt; font-family: 仿宋_GB2312'><input id='peopleName"+xuhao+"' type='text' style='width: 100%;' maxlength='30'></span></p>";
    //添加列:登记时间
    ...
    newNameTD.style.borderRight="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML ="<p class=MsoNormal style='mso-line-height-alt: 12.0pt'><span lang=EN-US style='font-size: 14.0pt; font-family: 仿宋_GB2312'><input id='organDate"+xuhao+"' type='text' style='width: 100%;' format='Y-m-d' onclick='LoushangDate(this)' readonly></span></p>";
    //添加列:登记证号
    ...
    newNameTD.style.borderRight="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='mso-line-height-alt: 12.0pt'><span lang=EN-US style='font-size: 14.0pt; font-family: 仿宋_GB2312'><input id='sorgCode"+xuhao+"' type='text' style='width: 100%;' maxlength='20'></span></p>";
	//添加列:住所
    ...
    newNameTD.style.borderRight="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='mso-line-height-alt: 12.0pt'><span lang=EN-US style='font-size: 14.0pt; font-family: 仿宋_GB2312'><textarea id='place"+xuhao+"' type='text' style='width: 100%;' onkeyup='this.value = this.value.slice(0,100)' ROWS='3' COLS='20' ></textarea></span></p>";
	//添加列:账户
    ...
    newNameTD.style.borderRight="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='mso-line-height-alt: 12.0pt'><span lang=EN-US style='font-size: 14.0pt; font-family: 仿宋_GB2312'><select id='accountType"+xuhao+"' style='width:100%;'><option  value=''>请选择...</option><option value='1'>基本账户</option><option value='2'>一般账户</option><option value='0'>无</option></select></span></p>";
	//添加列:开户银行
    var newNameTD=newTR.insertCell(7);
    newNameTD.style.padding="0cm 5.4pt 0cm 5.4pt";
    newNameTD.style.borderBottom="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='mso-line-height-alt: 12.0pt'><span lang=EN-US style='font-size: 12.0pt; font-family: 仿宋_GB2312'><textarea  ROWS='3' COLS='20' onkeyup='this.value = this.value.slice(0,100)' ></textarea></span></p>";
