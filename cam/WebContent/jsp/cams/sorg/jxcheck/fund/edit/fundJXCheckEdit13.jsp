...
//初始化
function init(){
	var somJxContributeDataSet = L5.DatasetMgr.lookup("somJxContributeDataSet");
	...
	var somJxContributeDataSet1 = L5.DatasetMgr.lookup("somJxContributeDataSet1");
...
function setPerMoney(){
	...
	if(!value1 || !value2){
		...
		document.getElementById("公益比例").value=(parseFloat(value1)/parseFloat(value2)*100).toFixed(2);
		if(document.getElementById("公益比例").value=="Infinity"){
			document.getElementById("公益比例").value="";
		}
	}
	if((!value3 && !value4) || !value5){
		...
		document.getElementById("福利支出比例").value=((parseFloat(value3)+parseFloat(value4))/parseFloat(value5)*100).toFixed(2);
		if(document.getElementById("福利支出比例").value=="Infinity"){
			document.getElementById("福利支出比例").value="";
		}
	}
	...
	<TBODY>
		...
		<TABLE height=645 cellSpacing=0 cellPadding=0 width=800 align=center
			...
			<TBODY>
				...
				<TR>
					<TD height=14 colspan='2' align=middle><STRONG>（一）接受捐赠情况</STRONG></TD>
				</TR>
				<TR>
					<TD colspan='2' align=right vAlign=bottom>单位：人民币元</TD>
				</TR>
				<TR>
						...
						<TBODY>
							...
							<TR>
								...
								<TD class=unnamed2 align=middle height=22><input
									name='query$form$0$JJHNJ_REPORT2$xianjin3' field='inPeopleMoney' ID='现金3'
									MAXLENGTH='8' CLASS='boder-0' isMoney='true'
									style='text-align: right' SIZE='14'
									onKeyUp="value=value.replace(/[^\d..]/g,'');setSumMoney();" ></TD>
								<TD class=unnamed2 height=22><input
									name='query$form$0$JJHNJ_REPORT2$zhehe3' field='inPeoplePracticali' ID='实物折合3'
									MAXLENGTH='8' CLASS='boder-0' SIZE='16' isMoney='true'
									style='text-align: right' onKeyUp="value=value.replace(/[^\d.]/g,'');setSumMoney();"
									></TD>
								<TD class=font-calend height=22><input
							...
							<TR>
								...
								<TD class=unnamed2 align=middle width='15%' height=22><input
									name='query$form$0$JJHNJ_REPORT2$xianjin4' field='inOtherMoney' ID='现金4'
									MAXLENGTH='8' CLASS='boder-0' isMoney='true'
									style='text-align: right' SIZE='14'
									onKeyUp="value=value.replace(/[^\d.]/g,'');setSumMoney();" ></TD>
								<TD class=unnamed2 width='19%' height=22><input
									name='query$form$0$JJHNJ_REPORT2$zhehe4' field='inOtherPracticali' ID='实物折合4'
									MAXLENGTH='8' CLASS='boder-0' SIZE='16' isMoney='true'
									style='text-align: right' onKeyUp="value=value.replace(/[^\d.]/g,'');setSumMoney();"
									></TD>
							...
							<TR>
								...
								<TD class=unnamed2 align=middle height=22><input
									name='query$form$0$JJHNJ_REPORT2$xianjin6' field='offPeopleMoney' ID='现金6'
									MAXLENGTH='8' CLASS='boder-0' isMoney='true'
									style='text-align: right' SIZE='14'
									onKeyUp="value=value.replace(/[^\d.]/g,'');setSumMoney();" ></TD>
								<TD class=unnamed2 height=22><input
									name='query$form$0$JJHNJ_REPORT2$zhehe6' field='offPeoplePracticali' ID='实物折合6'
									MAXLENGTH='8' CLASS='boder-0' SIZE='16' isMoney='true'
									style='text-align: right' onKeyUp="value=value.replace(/[^\d.]/g,'');setSumMoney();"
									></TD>
								<TD class=font-calend height=22><input
							...
							<TR>
								...
								<TD class=unnamed4 align=middle height=22><input
									name='query$form$0$JJHNJ_REPORT2$xianjin7' field='offOtherMoney' ID='现金7'
									MAXLENGTH='8' CLASS='boder-0' isMoney='true'
									style='text-align: right' SIZE='14'
									onKeyUp="value=value.replace(/[^\d.]/g,'');setSumMoney();" ></TD>
								<TD class=unnamed4 height=22><input
									name='query$form$0$JJHNJ_REPORT2$zhehe7' field='offOtherPracticali' ID='实物折合7'
									MAXLENGTH='8' CLASS='boder-0' SIZE='16' isMoney='true'
									style='text-align: right' onKeyUp="value=value.replace(/[^\d.]/g,'');setSumMoney();"
									></TD>
						...
						<TBODY>
							...
							<TABLE class=unnamed1 cellSpacing=0 cellPadding=0 width='100%'
								...
								<TBODY>
									...
									<TR>
										<TD class=unnamed2 height=22>一、本年度组织开展募捐活动()项，募捐取得的收入（自动求和）</TD>
										<TD class=font-cal height=22><input
									...
									<TR>
										<TD class=unnamed2 height=22>其中：来自境内自然人的捐赠</TD>
										<TD class=unnamed2 height=22><input
											name='query$form$0$JJHNJ_REPORT2$xianjin11' field='inPeopleMoney'
											ID='_现金3' MAXLENGTH='8' CLASS='boder-0' isMoney='true'
											style='text-align: right' SIZE='14'
											onKeyUp="value=value.replace(/[^\d..]/g,'');setSumMoney1();" ></TD>
										<TD class=unnamed2 align=middle height=22><input
											name='query$form$0$JJHNJ_REPORT2$zhehe11' field='inPeoplePracticali' ID='_实物折合3'
											MAXLENGTH='8' CLASS='boder-0' SIZE='16' isMoney='true'
									...
									<TR>
										...
										<TD class=unnamed2 height=22><input
											name='query$form$0$JJHNJ_REPORT2$xianjin12' field='inOtherMoney'
											ID='_现金4' MAXLENGTH='8' CLASS='boder-0' isMoney='true'
											style='text-align: right' SIZE='14'
											onKeyUp="value=value.replace(/[^\d.]/g,'');setSumMoney1();" ></TD>
										<TD class=unnamed2 align=middle height=22><input
											name='query$form$0$JJHNJ_REPORT2$zhehe12' field='inOtherPracticali' ID='_实物折合4'
											MAXLENGTH='8' CLASS='boder-0' SIZE='16' isMoney='true'
											style='text-align: right'
											onKeyUp="value=value.replace(/[^\d.]/g,'');setSumMoney1();" ></TD>
										<TD class=font-calend align=middle height=22><input
									...
									<TR>
										<TD class=unnamed2 height=22>其中：来自境外自然人的捐赠</TD>
										<TD class=unnamed2 height=22><input
											name='query$form$0$JJHNJ_REPORT2$xianjin14' field='offPeopleMoney'
											ID='_现金6' MAXLENGTH='8' CLASS='boder-0' isMoney='true'
											style='text-align: right' SIZE='14'
											onKeyUp="value=value.replace(/[^\d.]/g,'');setSumMoney1();" ></TD>
										<TD class=unnamed2 align=middle height=22><input
											name='query$form$0$JJHNJ_REPORT2$zhehe14' field='offPeoplePracticali' ID='_实物折合6'
											MAXLENGTH='8' CLASS='boder-0' SIZE='16' isMoney='true'
											style='text-align: right'
											onKeyUp="value=value.replace(/[^\d.]/g,'');setSumMoney1();" ></TD>
										<TD class=font-calend align=middle height=22><input
									...
									<TR>
										<TD class=unnamed4 height=22>来自境外法人或者其他组织的捐赠</TD>
										<TD class=unnamed4 height=22><input
											name='query$form$0$JJHNJ_REPORT2$xianjin15' field='offOtherMoney'
											ID='_现金7' MAXLENGTH='8' CLASS='boder-0' isMoney='true'
											style='text-align: right' SIZE='14'
											onKeyUp="value=value.replace(/[^\d.]/g,'');setSumMoney1();" ></TD>
										<TD class=unnamed4 align=middle height=22><input
											name='query$form$0$JJHNJ_REPORT2$zhehe15' field='offOtherPracticali' ID='_实物折合7'
											MAXLENGTH='8' CLASS='boder-0' SIZE='16' isMoney='true'
											style='text-align: right'
											onKeyUp="value=value.replace(/[^\d.]/g,'');setSumMoney1();" ></TD>
				...
				<TR>
					...
					<TABLE cellSpacing=0 cellPadding=0 width='100%' align=center
						...
						<TBODY>
									...
									<TBODY>
										...
										<TR>
											...
											<TD class=unnamed3 align=middle height=22><input
												name='query$form$0$JJHNJ_REPORT2$shouruheji' field='commLastSum'
										...
										<TR>
											...
											<TD class=unnamed3 align=middle height=22><input
												name='query$form$0$JJHNJ_REPORT2$zongshouru' field='commLastTotal'
										...
										<TR>
											...
											<TD class=unnamed3 align=middle height=22><input
												name='query$form$0$JJHNJ_REPORT2$zongzhichu' field='commExpenditure'
										...
										<TR>
											...
											<TD class=unnamed3 align=middle height=22><input
												name='query$form$0$JJHNJ_REPORT2$gongyizhichu' field='commExpPub'
										...
										<TR>
											...
											<TD class=unnamed3 align=middle height=22><input
												name='query$form$0$JJHNJ_REPORT2$fulizhichu' field='commExpPer'
										...
										<TR>
											...
											<TD class=unnamed3 align=middle height=22><input
												name='query$form$0$JJHNJ_REPORT2$xingzhengzhichu' field='commExpOff'
							...
							<tr>
								<td valign=bottom height=50 colspan=2>说明：公募基金会计算公益事业支出占上年度总收入的比例时，公益事业支出为业务活动成本中直接用于开展符合公益目的的活动的费用，调整后的上年度总收入=上年度收入合计-上年收入中时间限定为上年不得使用的限定性收入+于上年解除时间限定的净资产。</td>
							</tr>
						</TBODY>
					</TABLE>
					</TD>
