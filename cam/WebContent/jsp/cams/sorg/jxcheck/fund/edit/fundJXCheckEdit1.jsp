		...
		<script language="javascript">
			...
			function init(){
				if(method=="INSERT"){
					...
					somCheckDataSet.newRecord({"taskCode":taskCode,"reportDate":date,"checkYear":year,"sorgType":'J',"status":"0","fillPeopleName":'<%=username%>',"fillPeopleId":'<%=peopleId%>',"fillPeopleArea":'<%=peopleArea%>',"currentActivity":'0'});
					changeYear();
				}else{
						...
						<TABLE cellSpacing=0 cellPadding=0 width='100%' border=0>
							<TBODY>
								<TR>
									...
									<STRONG><STRONG><input ID='year' field="checkYear" CLASS='unnamed3' SIZE='4' maxlength='4' onblur="changeYear();" readonly="readonly" title="年份">
