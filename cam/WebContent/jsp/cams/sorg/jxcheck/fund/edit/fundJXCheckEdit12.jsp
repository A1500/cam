...
function addFTr(){
    ...
    newNameTD.style.borderRight="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='mso-line-height-alt: 12.0pt'><span lang=EN-US style='font-size: 14.0pt; font-family: 仿宋_GB2312'><input  type='text' style='width: 100%;' maxlength='72'></span></p>";
    //添加列:登记时间
    ...
    newNameTD.style.borderRight="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML ="<p class=MsoNormal style='mso-line-height-alt: 12.0pt'><span lang=EN-US style='font-size: 14.0pt; font-family: 仿宋_GB2312'><select name='工商登记类型'  id='checkinTypeJ"+xuhao+"'><option  value=''>请选择...</option><option  value='1'>有限责任公司</option><option  value='2'>有限责任公司（国有独资）</option><option  value='3'>有限责任公司（自然人独资）</option><option  value='4'>有限责任公司（法人独资）</option><option  value='5'>股份有限公司</option><option  value='6'>股份有限公司（上市）</option><option  value='7'>有限责任公司分公司</option><option  value='8'>股份有限公司分公司 集体所有制（股份合作）企业</option><option  value='9'>集体所有制（股份合作）企业</option><option  value='10'>集体所有制（股份合作）企业设立的非法人分支机构</option><option  value='11'>集体所有制（股份合作）企业设立的法人分支机构</option><option  value='12'>集体所有制（股份合作）企业设立的法人分支机构的营业登记单位</option><option  value='13'>全民所有制企业</option><option  value='14'>全民所有制企业的营业单位</option><option  value='15'>集体所有制企业</option><option  value='16'>集体所有制企业的营业单位</option><option  value='17'>合伙企业（普通合伙、特殊普通合伙、有限合伙）</option><option  value='18'>合伙企业的分支机构</option><option  value='19'>个人独资企业</option><option  value='20'>个人独资企业的分支机构</option><option  value='21'>个体工商户</option></select></span></p>";
	//添加列:账户
    ...
    newNameTD.style.borderBottom="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='mso-line-height-alt: 12.0pt'><span lang=EN-US style='font-size: 12.0pt; font-family: 仿宋_GB2312'><input  type='text' style='width: 100%;' maxlength='10'></span></p>";
