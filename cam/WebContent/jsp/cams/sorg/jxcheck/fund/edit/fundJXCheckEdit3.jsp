...
<model:datasets>
	<model:dataset id="somJxCouncilMeetingDataSet" cmd="com.inspur.cams.sorg.jxcheck.somjxcouncilmeeting.cmd.SomJxCouncilMeetingQueryCommand" global="true">
		<model:record fromBean="com.inspur.cams.sorg.jxcheck.somjxcouncilmeeting.dao.SomJxCouncilMeeting">
			<model:field name="meetingTheme" type="string" rule="length{100}" />
			<model:field name="peopleList" type="string" rule="length{500}" />
			<model:field name="meetingResult" type="string" rule="length{500}" />
			<model:field name="note" type="string" rule="length{500}" />
		</model:record>
	</model:dataset>
				...
				<TBODY>
					<TR>
						<TD height=24 colspan='2' class=word-st-14>1、本基金会于（ <input field='meetingYear'
							name='query$form$0$JJHNJ_JGJSLSJQK_SUB$nian$1' value=''
							ID='子表1.年$1'  SIZE='4' MAXLENGTH='4' >
						）年（ <input field='meetingMonth' name='query$form$0$JJHNJ_JGJSLSJQK_SUB$yue$1' value=''
							ID='子表1.月$1'  SIZE='2' MAXLENGTH='2' >
						）月（ <input field='meetingDay' name='query$form$0$JJHNJ_JGJSLSJQK_SUB$ri$1' value=''
							ID='子表1.日$1'  SIZE='2' MAXLENGTH='2' >
						）日召开（ <input  field='meetingNumber' name='query$form$0$JJHNJ_JGJSLSJQK_SUB$jie$1'
							value='' ID='子表1.届$1'  SIZE='3' MAXLENGTH='3'
							> ）届（ <input  field='meetingTimes'
							name='query$form$0$JJHNJ_JGJSLSJQK_SUB$ci$1' value=''
					...
					<TR>
						<TD height=24 colspan='2' class=word-st-14>会议地点： <input  field='meetingPlace'
							name='query$form$0$JJHNJ_JGJSLSJQK_SUB$huiyididian$1' value=''
					...
					<TR>
						...
						<TD width='87%' class=word-st-14><textarea  field='meetingTheme'
							name='会议议题' ID='子表1.会议主题$1'  ROWS='6' COLS='60' 
							></textarea></TD>
					</TR>
					<TR>
					...
					<TR>
						<TD height=31 colspan='2' align=middle class=word-st-14><textarea  field='meetingResult'
							name='会议决议'ID='子表1.会议决议$1' ROWS='25' COLS='84'
							></textarea></TD>
					</TR>
					<TR>
