	...
	somJxCheckInterProjectDataSet.on("load",function(ds){
		if(ds.getCount()==0){
			...
			for(i=0;i<ds.getCount();i++){
				...
				tab.rows[i+2].cells[4].getElementsByTagName("label")[0].innerHTML=record.get("offProjectFund");
				tab.rows[i+2].cells[5].getElementsByTagName("label")[0].innerHTML=record.get("onProjectFund");
