...
<TABLE height=400 cellSpacing=0 cellPadding=0 width=645 align=center
	...
	<TBODY>
		...
		<TR>
			<TD class=word-st-14 height=40>本基金会通过社会组织评估，评估等级为 <label
		...
		<TR>
			<TD class=word-st-14 height=40>取得的优惠资格的类型：
			<input id=favorableType1 type=checkbox value='1'CLASS='input-01' disabled="disabled">公益性捐赠税前扣除资格
			<input id=favorableType2 type=checkbox value='2'CLASS='input-01' disabled="disabled">自身收入免税资格（可多选）</TD>
		</TR>
		<TR>
			<TD class=word-st-14 height=40>取得资格的时间及批准部门、批准文号：
