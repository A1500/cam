...
function init(){
	...
	somJxCouncilMeetingDataSet.on('load',function(){
		if(somJxCouncilMeetingDataSet.getCount() == 0){
			somJxCouncilMeetingDataSet.newRecord({"taskCode":taskCode});
		}
	});
	//创建页面导航下拉框
	...
	<TBODY>
		<TR>
			...
			<TABLE height=245 cellSpacing=0 cellPadding=0 width='97%'
				...
				<TBODY>
					<TR>
						<TD height=24 colspan='2' class=word-st-14>1、本基金会于（ <label field='meetingYear' style='border-bottom: solid 1px;width:40;font-size: 11.0pt; font-family: 仿宋_GB2312'></label>
						&nbsp;）年（ <label field='meetingMonth' style='border-bottom: solid 1px;width:30;font-size: 11.0pt; font-family: 仿宋_GB2312'></label>
						&nbsp;）月（ <label field='meetingDay' style='border-bottom: solid 1px;width:30;font-size: 11.0pt; font-family: 仿宋_GB2312'></label>
						&nbsp;）日召开（ <label  field='meetingNumber' style='border-bottom: solid 1px;width:30;font-size: 11.0pt; font-family: 仿宋_GB2312'></label>
						&nbsp;）届（ <label  field='meetingTimes' style='border-bottom: solid 1px;width:30;font-size: 11.0pt; font-family: 仿宋_GB2312'></label>
						&nbsp;）次理事会议</TD>
					</TR>
					<!--<TR><TD height=24 colspan='2' class=word-st-14>会议时间： &nbsp; </TD></TR>-->
					<TR>
						<TD height=24 colspan='2' class=word-st-14>会议地点：<label field='meetingPlace' style='border-bottom: solid 1px;width:500;font-size: 10.0pt; font-family: 仿宋_GB2312'></label></TD>
					</TR>
					<TR>
						...
						<TD width='87%' class=word-st-14><textarea  field='meetingTheme'  readonly="readonly"
							...
							ID='子表1.会议主题$1'  ROWS='6' COLS='60' limit='100'
							></textarea></TD>
					</TR>
					<TR>
						<TD width='17%' height=24 valign='top' class=word-st-14>出席人员名单：
						</TD>
						<TD width='83%' class=word-st-14><textarea  field='peopleList' readonly="readonly"
							name='query$form$0$JJHNJ_JGJSLSJQK_SUB$renyuanmingdan$1'
							ID='子表1.人员名单$1'  ROWS='6' COLS='60' limit='500'
							></textarea></TD>
					</TR>
					<TR>
					...
					<TR>
						<TD height=31 colspan='2' align=middle class=word-st-14><textarea  field='meetingResult'  readonly="readonly"
							name='query$form$0$JJHNJ_JGJSLSJQK_SUB$huiyijueyi$1' 
							ID='子表1.会议决议$1' ROWS='25' COLS='84' limit='500' 
							></textarea></TD>
					</TR>
					<TR>
					...
					<TR>
						<TD height=31 colspan='2' align=middle class=word-st-14><textarea  field='note'  readonly="readonly"
							name='query$form$0$JJHNJ_JGJSLSJQK_SUB$beizhu$1'
							ID='子表1.备注$1' ROWS='5' COLS='84' limit='500' 
							></textarea></TD>
					</TR>
					<TR>
