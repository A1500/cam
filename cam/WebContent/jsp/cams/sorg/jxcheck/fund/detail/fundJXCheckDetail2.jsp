...
<div id="float" class="noprint">
	<input  type="button" value="下一页" style="height:25px;width:80px;position:absolute;margin-left:120px;" onclick="nextPageJ1('3')"/>
	<input  type="button" value="上一页" style="height:25px;width:80px;position:absolute;margin-left:20px;" onclick="lastPageJ1('1')"/>
				...
				<TBODY>
					...
					<TR>
						...
						<TABLE height=30 cellSpacing=0 cellPadding=0 width='100%' border=0>
							<TBODY>
								<TR>
									<TD>&nbsp;<label field="specialFunds"></label></TD>
								</TR>
							</TBODY>
						</TABLE>
						</TD>
