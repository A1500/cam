...
function setSumMoney(){
	somJxCheckBalanceSheetDataSet.set("caSumS",(setParseFloat("货币资金")+setParseFloat("短期投资")+setParseFloat("应收款项")+setParseFloat("预付账款")+setParseFloat("存货")+setParseFloat("待摊费用")+setParseFloat("一年内到期的长期债权投资")+setParseFloat("其他流动资产")).toFixed(2));
	somJxCheckBalanceSheetDataSet.set("caSumE",(setParseFloat("_货币资金")+setParseFloat("_短期投资")+setParseFloat("_应收款项")+setParseFloat("_预付账款")+setParseFloat("_存货")+setParseFloat("_待摊费用")+setParseFloat("_一年内到期的长期债权投资")+setParseFloat("_其他流动资产")).toFixed(2));
	somJxCheckBalanceSheetDataSet.set("piSumS",(setParseFloat("长期股权投资")+setParseFloat("长期债权投资")).toFixed(2));
	somJxCheckBalanceSheetDataSet.set("piSumE",(setParseFloat("_长期股权投资")+setParseFloat("_长期债权投资")).toFixed(2));
	somJxCheckBalanceSheetDataSet.set("faSumS",(setParseFloat("固定资产原价")+setParseFloat("减：累计折旧")+setParseFloat("固定资产净值")+setParseFloat("在建工程")+setParseFloat("文物文化资产")+setParseFloat("固定资产清理")).toFixed(2));
	somJxCheckBalanceSheetDataSet.set("faSumE",(setParseFloat("_固定资产原价")+setParseFloat("_减：累计折旧")+setParseFloat("_固定资产净值")+setParseFloat("_在建工程")+setParseFloat("_文物文化资产")+setParseFloat("_固定资产清理")).toFixed(2));
	somJxCheckBalanceSheetDataSet.set("assetsSumS",(somJxCheckBalanceSheetDataSet.get("caSumS")+somJxCheckBalanceSheetDataSet.get("piSumS")+somJxCheckBalanceSheetDataSet.get("faSumS")+setParseFloat("无形资产")+setParseFloat("受托代理资产")).toFixed(2));
	somJxCheckBalanceSheetDataSet.set("assetsSumE",(somJxCheckBalanceSheetDataSet.get("caSumE")+somJxCheckBalanceSheetDataSet.get("piSumE")+somJxCheckBalanceSheetDataSet.get("faSumE")+setParseFloat("_无形资产")+setParseFloat("_受托代理资产")).toFixed(2));

	somJxCheckBalanceSheetDataSet.set("clSumS",(setParseFloat("短期借款")+setParseFloat("应付款项")+setParseFloat("应付工资")+setParseFloat("应交税金")+setParseFloat("预收账款")+setParseFloat("预提费用")+setParseFloat("预计负债")+setParseFloat("一年内到期的长期负债")+setParseFloat("其他流动负债")).toFixed(2));
	somJxCheckBalanceSheetDataSet.set("clSumE",(setParseFloat("_短期借款")+setParseFloat("_应付款项")+setParseFloat("_应付工资")+setParseFloat("_应交税金")+setParseFloat("_预收账款")+setParseFloat("_预提费用")+setParseFloat("_预计负债")+setParseFloat("_一年内到期的长期负债")+setParseFloat("_其他流动负债")).toFixed(2));
	somJxCheckBalanceSheetDataSet.set("llSumS",(setParseFloat("长期借款")+setParseFloat("长期应付款")+setParseFloat("其他长期负债")).toFixed(2));
	somJxCheckBalanceSheetDataSet.set("llSumE",(setParseFloat("_长期借款")+setParseFloat("_长期应付款")+setParseFloat("_其他长期负债")).toFixed(2));
	somJxCheckBalanceSheetDataSet.set("paSumS",(somJxCheckBalanceSheetDataSet.get("clSumS")+somJxCheckBalanceSheetDataSet.get("llSumS")+setParseFloat("受托代理负债")).toFixed(2));
	somJxCheckBalanceSheetDataSet.set("paSumE",(somJxCheckBalanceSheetDataSet.get("clSumE")+somJxCheckBalanceSheetDataSet.get("llSumE")+setParseFloat("_受托代理负债")).toFixed(2));

	somJxCheckBalanceSheetDataSet.set("netAssetsSumS",(setParseFloat("非限定性净资产")+setParseFloat("限定性净资产")).toFixed(2));
	somJxCheckBalanceSheetDataSet.set("netAssetsSumE",(setParseFloat("_非限定性净资产")+setParseFloat("_限定性净资产")).toFixed(2));
	somJxCheckBalanceSheetDataSet.set("debtAssetsSumS",(somJxCheckBalanceSheetDataSet.get("paSumS")+somJxCheckBalanceSheetDataSet.get("netAssetsSumS")).toFixed(2));
	somJxCheckBalanceSheetDataSet.set("debtAssetsSumE",(somJxCheckBalanceSheetDataSet.get("paSumE")+somJxCheckBalanceSheetDataSet.get("netAssetsSumE")).toFixed(2));
}
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
	...
	<tr style='mso-yfti-irow: 20; height: 10.1pt'>
		...
		<p class=MsoNormal align=right
			...
			lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋_GB2312; mso-hansi-font-family: 仿宋_GB2312'><o:p>
			<input field="faNetValueS" id="固定资产净值" name='"固定资产净值"' style="width: 98%; "
				maxlength="8" style='text-align:right' onkeyup="value=value.replace(/[^\d.]/g,'');setSumMoney() " />
		</o:p></span></p>
		</td>
		<td width=100 valign=top
		...
		<p class=MsoNormal align=right
			...
			lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋_GB2312; mso-hansi-font-family: 仿宋_GB2312'><o:p>
			<input field="faNetValueE" id="_固定资产净值" name='"_固定资产净值"' style="width: 98%; "
				maxlength="8" style='text-align:right' onkeyup="value=value.replace(/[^\d.]/g,'');setSumMoney() " />
		</o:p></span></p>
		</td>
		<td width=170 valign=top
