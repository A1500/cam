...
<div id="float" class="noprint">
	<input type="button" value="上一页" style="height:25px;width:80px;position:absolute;margin-left:20px;" onclick="lastPageM1('5')"/>
...
<p class=MsoNormal id="noBuildPartyResonSpan" style="display:none"
	...
	style='font-size: 16.0pt; font-family: 仿宋_GB2312; mso-hansi-font-family: 宋体; mso-bidi-font-weight: bold'>应建未建党组织原因具体说明：</span><span>
