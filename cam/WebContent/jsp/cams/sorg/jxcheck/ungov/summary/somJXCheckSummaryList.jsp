...
%>	
		<script language="javascript">
			...
			function query(){
				...
				ds.setParameter("BUSINESS_TYPE",sorgKindS);
				ds.load();
				year=checkYear;
			}	
			function init(){
			...
			function summary(){
				...
				var url='jsp/cams/sorg/jxcheck/ungov/summary/somJXCheckSummary.jsp';
			  	var text = '民办非企业单位年检汇总';
...
<model:dataset id="sorgKind" enumName="JXSOM.UNGOV.BUSINESS_TYPE" autoLoad="true" global="true"></model:dataset>
...
<next:GridPanel id="editGridPanel" name="somcheckGrid" width="100%" stripeRows="true" height="100%" dataset="ds" title="民办非企业单位年检列表" notSelectFirstRow="true">
	...
	<next:Columns>
		...
		<next:Column id="cnName" header="民办非企业单位类型" field="businessType" dataset="sorgKind" width="250" >
			<next:TextField  />
		</next:Column>
