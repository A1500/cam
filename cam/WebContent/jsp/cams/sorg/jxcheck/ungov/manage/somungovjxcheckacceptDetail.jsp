...
<html>
	<head>
		...
		<script language="javascript">
			...
			function returnList(){
				var data = new L5.Map();
				var url='jsp/cams/sorg/jxcheck/ungov/manage/somungovjxcheckaccept_list.jsp';
				var text = '年检列表';
...
<div id="floatBottom" style="height:7%">
	...
	<input type="button" value="出具年检结论" style="height:25px;width:80px;position:absolute;margin-left:30%;"  onclick="check();"/>
	<!--[if lte IE 7]><div></div><![endif]-->
		...
		<form method="post" onsubmit="return false" class="L5form" dataset="somCheckDataSet">
			<table width="100%">
				<tr>
					...
					<td class="FieldInput" colspan="5">
					<select field="checkResult" name='"年检结果"' style="width:150px" default="0">
