...
<html>
	...
	%>
		<title>年检查询列表</title>
		<next:ScriptManager/>
		<script type="text/javascript" src="somgroupjxcheckaccept_list.js"></script>
...
<next:TabPanel  width="100%" height="100%" id="tab">
	<next:Tabs>
		...
		<next:Panel title="未填报" width="100%" >
			...
			<next:GridPanel id="editGridPanel2" name="somcheckGrid" width="100%" stripeRows="true" height="100%" dataset="noCheckDs" title="社会团体未年检列表" notSelectFirstRow="true">
				<next:TopBar>
					<next:ToolBarItem symbol="->" ></next:ToolBarItem>
