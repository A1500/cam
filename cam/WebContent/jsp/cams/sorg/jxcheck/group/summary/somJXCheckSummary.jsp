...
<script language="javascript">
	...
	function back(){
		...
		url="jsp/cams/sorg/jxcheck/group/summary/somJXCheckSummaryList.jsp";
		L5.forward(url,'',data);
	}
/*
展示基本信息的具体数值
...
function showbaseWin(item,value,title){
	...
	baseInfoDs.setParameter("SORG_TYPE","S");
...
function showWin(value,field,tableName,columnName){
	...
	if(field.indexOf('CURRENT_TOTAL') != -1 || field.indexOf('IN_TOTAL')!=-1 || field.indexOf('OFF_TOTAL')!=-1){
		...
		if(field.indexOf('PARTY_TYPE') != -1){
			detailDs.setParameter("sqlfield",field.slice(field.length-1,field.length));
		}else if(field.indexOf('IF_BUILD_PARTY') != -1){
			detailDs.setParameter("sqlfield",field.slice(field.length-1,field.length));
		}else if(field.indexOf('PARTY_SPACE') != -1){
			detailDs.setParameter("sqlfield",field.slice(field.length-1,field.length));
		}else if(field.indexOf('PARTY_RELATION_TYPE') != -1){
			detailDs.setParameter("sqlfield",field.slice(field.length-1,field.length));
		}else if(field.indexOf('PARTY_PEOPLE_TYPE') != -1){
			detailDs.setParameter("sqlfield",field.slice(field.length-1,field.length));
		}else if(field.indexOf('PARTY_PEOPLE_AGE') != -1){
			detailDs.setParameter("sqlfield",field.slice(field.length-1,field.length));
		}else if(field.indexOf('PARTY_PEOPLE_AGE') != -1){
			detailDs.setParameter("sqlfield",field.slice(field.length-1,field.length));
		}else if(field.indexOf('PARTY_PEOPLE_EDU') != -1){
			detailDs.setParameter("sqlfield",field.slice(field.length-1,field.length));
		}else if(field.indexOf('PARTY_STUDY_WAY_SELF') != -1){
			detailDs.setParameter("sqlfield",field.slice(field.length-1,field.length));
		}else if(field.indexOf('PARTY_STUDY_WAY_TALK') != -1){
			detailDs.setParameter("sqlfield",field.slice(field.length-1,field.length));
		}else if(field.indexOf('PARTY_STUDY_WAY_CHAIR') != -1){
			detailDs.setParameter("sqlfield",field.slice(field.length-1,field.length));
		}else if(field.indexOf('PARTY_STUDY_WAY_VISIT') != -1){
			detailDs.setParameter("sqlfield",field.slice(field.length-1,field.length));
		}else if(field.indexOf('PARTY_STUDY_WAY_ART') != -1){
			detailDs.setParameter("sqlfield",field.slice(field.length-1,field.length));
		}else if(field.indexOf('PARTY_STUDY_WAY_OTHER') != -1){
			detailDs.setParameter("sqlfield",field.slice(field.length-1,field.length));
		}else if(field.indexOf('NO_BUILD_PARTY_RESON') != -1){
			detailDs.setParameter("ifBuildParty","0");
			detailDs.setParameter("sqlfield",field.slice(field.length-1,field.length));
	...
	detailDs.setParameter("SORG_TYPE","S");
...
<body>
<model:datasets>
	<model:dataset id="ds" cmd="com.inspur.cams.sorg.jxcheck.somjxcheck.cmd.SomJxCheckQueryCommand" method="queryGroupCheckReport" global="true">
	</model:dataset>
...
<next:Panel id="panel" cls="noprint" border="0">
	<next:TopBar>
		...
		<next:ToolBarItem symbol="社会团体年检信息汇总"></next:ToolBarItem>
...
<table width="650">
	<tr>
		<td class="FieldInput" width="80%">社会团体年检信息社会团体已经上报的总数为</td>
		<td class="FieldInput" width="20%"><label name="社会团体年检信息社会团体已经上报的总数"
			field="TOTAL" onclick="showbaseWin('1',this.innerHTML,this.name)" style="cursor:hand;color:blue"></label></td>
	</tr>
	<tr>
		<td class="FieldInput" width="80%">社会团体年检信息社会团体已经上报的审批完成数为</td>
		<td class="FieldInput" width="20%"><label name="社会团体年检信息社会团体已经上报的审批完成数"
			field="CHECK_PASS" onclick="showbaseWin('2',this.innerHTML,this.name)" style="cursor:hand;color:blue"></label></td>
	</tr>
	<tr>
		<td class="FieldInput" width="80%">社会团体年检信息社会团体已经上报的未审批完成数为</td>
		<td class="FieldInput" width="20%"><label name='社会团体年检信息社会团体已经上报的未审批完成数'
			field="CHECK_NO_PASS" onclick="showbaseWin('3',this.innerHTML,this.name)" style="cursor:hand;color:blue"></label></td>
	</tr>
	<tr>
		<td class="FieldInput" width="80%">社会团体年检信息中年检合格的社会团体个数为</td>
		<td class="FieldInput" width="20%"><label name='社会团体年检信息中年检合格的社会团体个数'
			field="CHECK_OK" onclick="showbaseWin('4',this.innerHTML,this.name)" style="cursor:hand;color:blue"></label></td>
	</tr>
	<tr>
		<td class="FieldInput" width="80%">社会团体年检信息中年检基本合格的社会团体个数为</td>
		<td class="FieldInput" width="20%"><label name="社会团体年检信息中年检基本合格的社会团体个数"
			field="CHECK_BASAL_OK" onclick="showbaseWin('5',this.innerHTML,this.name)" style="cursor:hand;color:blue"></label></td>
	</tr>
	<tr>
		<td class="FieldInput" width="80%">社会团体年检信息中年检不合格的社会团体个数为</td>
		<td class="FieldInput" width="20%"><label name="社会团体年检信息中年检不合格的社会团体个数"
			field="CHECK_NOT_OK" onclick="showbaseWin('6',this.innerHTML,this.name)" style="cursor:hand;color:blue"></label></td>
	</tr>
	<tr>
		<td class="FieldInput" width="80%">社会团体年检信息中一年未年检的社会团体个数为</td>
		<td class="FieldInput" width="20%"><label name="社会团体年检信息中一年未年检的社会团体个数"
			field="ONE_YEAR" onclick="showbaseWin('7',this.innerHTML,this.name)" style="cursor:hand;color:blue"></label></td>
	</tr>
	<tr>
		<td class="FieldInput" width="80%">社会团体年检信息中两年未年检的社会团体个数为</td>
		<td class="FieldInput" width="20%"><label name="社会团体年检信息中两年未年检的社会团体个数"
...
<table width="650">
	<tr>
		<td class="FieldInput" width="25%">单位会员数</td>
		<td class="FieldInput" width="25%"><label
			field="UNITS_NUM" style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_VIP_ORGAN','单位会员数')"></label></td>
		<td class="FieldInput" width="25%">个人会员数</td>
		<td class="FieldInput" width="25%"><label
			field="PEOPLE_NUM" style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_VIP_ORGAN','个人会员数')"></label></td>
	</tr>
	<tr>
		<td class="FieldInput" width="25%">理事人数</td>
		<td class="FieldInput" width="25%"><label
			field="COUNCIL_NUM" style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_VIP_ORGAN','理事人数')"></label></td>
		<td class="FieldInput" width="25%">常务理事人数</td>
		<td class="FieldInput" width="25%"><label
			field="STAND_COUNCIL_NUM" style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_VIP_ORGAN','常务理事人数')"></label></td>
	</tr>
	<tr>
		<td class="FieldInput" width="25%">监事会或监事人数</td>
		<td class="FieldInput" width="25%"><label
			field="AUDITOR_NUM" style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_VIP_ORGAN','监事会或监事人数')"></label></td>
		<td class="FieldInput" width="25%">秘书处工作人员人数</td>
		<td class="FieldInput" width="25%"><label
			field="SECRETARY_NUM" style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_VIP_ORGAN','秘书处工作人员人数')"></label></td>
	</tr>
	<tr>
		<td class="FieldInput" width="25%">日常办事机构个数</td>
		<td class="FieldInput" width="25%"><label
			field="DAILY_NUM" style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_VIP_ORGAN','日常办事机构个数')"></label></td>
		<td class="FieldInput" width="25%">分支（代表）机构个数</td>
		<td class="FieldInput" width="25%"><label
			field="ORGAN_NUM" style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_VIP_ORGAN','分支（代表）机构个数')"></label></td>
	</tr>
	<tr>
		<td class="FieldInput" width="25%">专项基金机构个数</td>
		<td class="FieldInput" width="25%"><label
			field="SPECIAL_NUM" style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_VIP_ORGAN','专项基金机构个数')"></label></td>
		<td class="FieldInput" width="25%">实体机构个数</td>
		<td class="FieldInput" width="25%"><label
			field="ENTITY_NUM" style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_VIP_ORGAN','实体机构个数')"></label></td>
	</tr>
</table>
<p class=MsoNormal><span lang=EN-US><o:p>&nbsp;</o:p></span></p>
<p class=MsoNormal><span lang=EN-US><o:p>&nbsp;</o:p></span></p>
...
<table width="650">
	...
	<tr>
		...
		<td class="FieldInput" width="25%">留学半年以上归国人员人数</td>
		<td class="FieldInput" width="25%"><label
			 style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_PEOPLE','留学半年以上归国人员人数')"field="FROM_ABROAD_NUM"></label></td>
	</tr>
	<tr>
		<td class="FieldInput" width="25%">从业人员中持有“社会工作者”资格证书人数</td>
		<td class="FieldInput" width="25%"><label
			 style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_PEOPLE','从业人员中持有“社会工作者”资格证书人数')"field="CASEWORKER_NUM"></label></td>
		<td class="FieldInput" width="25%">持有从事岗位相应专业技术资格证书人数</td>
		<td class="FieldInput" width="25%"><label
			 style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_PEOPLE','持有从事岗位相应专业技术资格证书人数')"field="VAWIRRMQ_NUM"></label></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="FieldInput" width="25%">从业人员中具有省部级行政级别人数</td>
		<td class="FieldInput" width="25%"><label
			 style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_PEOPLE','从业人员中具有省部级行政级别人数')"field="PROVINCIAL_NUM"></label></td>
	</tr>
	<tr>
		<td class="FieldInput" width="25%">从业人员中具有厅局级行政级别人数</td>
		<td class="FieldInput" width="25%"><label
			 style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_PEOPLE','从业人员中具有厅局级行政级别人数')"field="BOARD_NUM"></label></td>
		<td class="FieldInput" width="25%">从业人员中具有处级行政级别人数</td>
		<td class="FieldInput" width="25%"><label
			 style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_PEOPLE','从业人员中具有处级行政级别人数')"field="CHUJI_NUM"></label></td>
	</tr>
	<tr>
...
<table width="650">
	<tr>
		<td class="FieldInput" width="25%">会员(代表)大会次数</td>
		<td class="FieldInput" width="25%"><label
			field="GENERAL_TIMES"style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_ACTIVITY','会员(代表)大会次数')"></label></td>
		<td class="FieldInput" width="25%">理事会（常务理事会）或董事会次数</td>
		<td class="FieldInput" width="25%"><label
			field="COUNCIL_TIMES"style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_ACTIVITY','理事会（常务理事会）或董事会次数')"></label></td>
	</tr>
	<tr>
		<td class="FieldInput" width="25%">学术/专业会议次数</td>
		<td class="FieldInput" width="25%"><label
			field="LEARN_MEETING_TIMES"style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_ACTIVITY','学术/专业会议次数')"></label></td>
		<td class="FieldInput" width="25%">培训次数</td>
		<td class="FieldInput" width="25%"><label
			field="TRAIN_TIMES"style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_ACTIVITY','培训次数')"></label></td>
	</tr>
	<tr>
		<td class="FieldInput" width="25%">参加培训人数</td>
		<td class="FieldInput" width="25%"><label
			field="TRAIN_NUM"style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_ACTIVITY','参加培训人数')"></label></td>
	...
	<tr>
		...
		<td class="FieldInput" width="25%">公益活动支出金额（万元）</td>
		<td class="FieldInput" width="25%"><label
			field="COMMONWEAL_OUT"style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_ACTIVITY','公益活动支出金额（万元)')"></label></td>
	</tr>
	<tr>
		<td class="FieldInput" width="25%">开展国际合作项目个数</td>
		<td class="FieldInput" width="25%"><label
			field="INT_ITEM_NUM"style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_ACTIVITY','开展国际合作项目个数')"></label></td>
		<td class="FieldInput" width="25%">开展国际合作项目总计金额（万元）</td>
		<td class="FieldInput" width="25%"><label
			field="INT_ITEM_MONEY"style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_ACTIVITY','开展国际合作项目总计金额（万元）')"></label></td>
	</tr>
	<tr>
		<td class="FieldInput" width="25%">组织或参加国际会议次数</td>
		<td class="FieldInput" width="25%"><label
			field="MEETING_TIMES"style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_ACTIVITY','组织或参加国际会议次数')"></label></td>
		<td class="FieldInput" width="25%">接受境外组织捐赠或赞助次数</td>
		<td class="FieldInput" width="25%"><label
			field="ACCEPT_OFF_NUM"style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_ACTIVITY','接受境外组织捐赠或赞助次数')"></label></td>
	</tr>
	<tr>
		<td class="FieldInput" width="25%">接受境外组织捐赠或赞助总计金额（万元）</td>
		<td class="FieldInput" width="25%"><label
			field="ACCEPT_OFF_MONEY"style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_ACTIVITY','接受境外组织捐赠或赞助总计金额（万元）')"></label></td>
		<td class="FieldInput" width="25%">聘请外籍员工人数</td>
		<td class="FieldInput" width="25%"><label
			field="RETAIN_PEOPLE_NUM"style="cursor:hand;color:blue" onclick="showWin(this.innerHTML,this.field,'SOM_JX_ACTIVITY','聘请外籍员工人数')"></label></td>
	</tr>
...
<table width="650">
	...
	<tr>
		<td class="FieldInput" width="25%">会费收入（元）</td>
		<td class="FieldInput" width="25%"><label
			field="FEE_EARNING"></label></td>
	...
	<tr>
		...
		<td class="FieldInput" width="25%">管理费用中其它费用（元）</td>
		<td class="FieldInput" width="25%"><label
			field="OTHER_CHARGE"></label></td>
	</tr>
	<tr>
