...
%>	
		<script language="javascript">
			...
			function summary(){
				...
				var url='jsp/cams/sorg/jxcheck/group/summary/somJXCheckSummary.jsp';
			  	var text = '社会团体年检汇总';
			...
			function summaryGridAllOnLoad(record){
					summaryDs.each(function(record, index){
					 ...
					 var data = new L5.Map(); 
				    //data.put("taskCode",summaryTaskCode.substring(0, summaryTaskCode.lastIndexOf(',')));
				    data.put("year",year);
...
<next:GridPanel id="editGridPanel" name="somcheckGrid" width="100%" stripeRows="true" height="100%" dataset="ds" title="社会团体年检列表" notSelectFirstRow="true">
	...
	<next:Columns>
		...
		<next:Column id="cnName" header="社会团体类型" field="sorgKind" dataset="sorgKind" width="250" >
			<next:TextField  />
		</next:Column>
