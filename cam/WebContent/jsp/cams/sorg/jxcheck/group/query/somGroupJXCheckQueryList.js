...
function detail(){
	...
	var url='jsp/cams/sorg/jxcheck/group/detail/groupJXCheckDetail1.jsp';
	var text = '年检明细';
...
function print(){
	...
	data.put("method","DETAIL");
	data.put("taskCode",selected[0].get('taskCode'));
	var url='jsp/cams/sorg/jxcheck/group/print/groupJXCheckPrint1.jsp';
	var text = '年检明细';
	L5.forward(url,text,data);
}
...
function ToExcel(){
	...
	L5.dataset2excel(dataset,"/jsp/cams/sorg/jxcheck/group/query/somGroupJxQueryToExcel.jsp");
} 