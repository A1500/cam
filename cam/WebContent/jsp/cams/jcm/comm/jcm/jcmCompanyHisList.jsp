...
<html>
<head>
<title>单位历史信息列表</title>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript" src="jcmCompanyHisList.js"></script>
...
<next:EditGridPanel id="grid" dataset="jcmCompanyHisDataSet" width="100%" stripeRows="true" height="99.9%">
	<next:TopBar>
	...
	<next:Columns>
		...
		<next:Column field="companyHisId" header="历史表主键" width="30%" sortable="false"/>
		<next:Column field="companyChangeId" header="变更主键" width="30%" sortable="false"/>
	...
	<next:BottomBar>
		<next:PagingToolBar dataset="jcmCompanyHisDataSet"/>
	</next:BottomBar>
</next:EditGridPanel>
</body>
</html>