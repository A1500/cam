...
<next:EditGridPanel id="grid" dataset="jcmCompanyMoneyDataSet" width="100%" stripeRows="true" height="99.9%">
	...
	<next:Columns>
		...
		<next:Column field="companyMoneyId" header="工作经费主键" width="30%" sortable="false"/>
		<next:Column field="moneyType" header="工作经费类别" width="30%" sortable="false"/>
		<next:Column field="moneyCost" header="工作经费金额" width="30%" sortable="false"/>
