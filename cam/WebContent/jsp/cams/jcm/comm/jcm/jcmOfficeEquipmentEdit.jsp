...
<fieldset>
	...
	<table width="100%">
		<tr>
			...
			<td class="FieldInput" style="width:36%"><input type="text" name="主键" id="officeId" field="officeId" maxlength="50" style="width:90%"/></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="FieldInput" style="width:36%"><input type="text" name="设备类型" id="deviceType" field="deviceType" maxlength="50" style="width:90%"/></td>
		</tr>
		<tr>
			<td class="FieldLabel" style="width:18%">设备个数：</td>
			<td class="FieldInput" style="width:36%"><input type="text" name="设备个数" id="deviceNum" field="deviceNum" maxlength="50" style="width:90%"/></td>
		</tr>
		<tr>
			<td class="FieldLabel" style="width:18%">购买年份：</td>
			<td class="FieldInput" style="width:36%"><input type="text" name="购买年份" id="buyYear" field="buyYear" maxlength="50" style="width:90%"/></td>
		</tr>
	</table>
</fieldset>
</form>
