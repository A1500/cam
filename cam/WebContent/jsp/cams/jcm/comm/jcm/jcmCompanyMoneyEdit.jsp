...
<fieldset>
	...
	<table width="100%">
		...
		<tr>
			...
			<td class="FieldInput" style="width:36%"><input type="text" name="工作经费主键" id="companyMoneyId" field="companyMoneyId" maxlength="50" style="width:90%"/></td>
		</tr>
		<tr>
			<td class="FieldLabel" style="width:18%">工作经费类别：</td>
			<td class="FieldInput" style="width:36%"><input type="text" name="工作经费类别" id="moneyType" field="moneyType" maxlength="50" style="width:90%"/></td>
		</tr>
		<tr>
			<td class="FieldLabel" style="width:18%">工作经费金额：</td>
			<td class="FieldInput" style="width:36%"><input type="text" name="工作经费金额" id="moneyCost" field="moneyCost" maxlength="50" style="width:90%"/></td>
		</tr>
		<tr>
