...
<script type="text/javascript" src="jcmAllUnitQueryList.js"></script>
...
<body>
<model:datasets>
<model:dataset id="jcmAllUnitQueryDataSet" cmd="com.inspur.cams.jcm.cmd.JcmAllUnitQueryCommand" method="execute">
		<model:record fromBean="com.inspur.cams.jcm.data.JcmAllUnitQuery"/>
	</model:dataset>
	<!-- 单位性质 -->
	<model:dataset id="DWXZDs" enumName="FIS.CEME.INSPECTION.STATUS"
								...
								<table  border="1" width="100%">
									<tr>
							            ...
							            <td class="FieldInput" width="20%"><select type="text" id="companyNature"
											class="TextEditor" title="companyNature" />
											<option dataset="DWXZDs"/>
										</select></td>
										<td class="FieldLabel" width="10%">行政级别：</td>
							            <td class="FieldInput" width="20%">
							            <input type="text"  id="organName" style="width:40%" /></td>
									</tr>
									<tr>
										<td class="FieldLabel" width="10%">所属类别：</td>
							            <td class="FieldInput" width="20%">
							            <input type="text"  id="companyType" style="width:40%" /></td>
										<td class="FieldLabel" width="10%">邮政编码：</td>
							            <td class="FieldInput" width="20%">
							            <input type="text"  id="companyPostCode" style="width:40%" /></td>
...
<next:EditGridPanel id="grid" dataset="jcmAllUnitQueryDataSet" width="100%" stripeRows="true" height="99.9%">
	<!--<next:TopBar>
	...
	<next:Columns>
		...
		<next:Column field="COMPANY_ID" header="主键" width="30%" sortable="false" hidden="true"/>
		<next:Column  field="COMPANY_NAME" header="单位名称" width="15%" sortable="false">
		</next:Column>
		<next:Column field="COMPANY_NATURE" header="单位性质" width="10%" sortable="false" />
		<next:Column field="COMPANY_PEOPLE_NAME" header="法人" width="10%" sortable="false"/>
		...
		<next:Column field="COMPANY_STATUS" header="状态" width="10%" sortable="false"/>
		<next:Column field="GROSS_AREA" header="建筑面积" width="10%" sortable="false"/>
	...
	<!--<next:BottomBar>
		<next:PagingToolBar dataset="jcmAllUnitQueryDataSet"/>
	</next:BottomBar>-->
</next:EditGridPanel>
</body>
</html>