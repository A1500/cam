...
<body>
<model:datasets>
	<model:dataset id="jcmCompanyProfileDataSet" cmd="com.inspur.cams.jcm.cmd.JcmCompanyProfileQueryCmd" method="queryCompany">
...
<next:EditGridPanel id="grid" dataset="jcmCompanyProfileDataSet" width="100%" stripeRows="true" height="99.9%">
	...
	<next:Columns>
		...
		<next:Column renderer="DetailsRendener" field="COMPANY_NAME" header="单位名称" width="15%" sortable="false">
		</next:Column>
