...
<%@page import="com.inspur.cams.marry.query.marry.cmd.MarryPeopleTypeQueryCmd"%>
...
<%
	...
	MarryPeopleTypeQueryCmd hsrqcmd = new MarryPeopleTypeQueryCmd();
	//设置查询参数
	...
	for (int i = 0; i < ds.getCount(); i++) {
		...
		sb.append("<marry_num>" + (rec.get("MARRY_NUM").toString().replaceAll(",","") == null ? 0 : rec.get("MARRY_NUM").toString().replaceAll(",","")) + "</marry_num>");//具体数据值
		sb.append("</city>");
	}
	sb.append("</config>");
