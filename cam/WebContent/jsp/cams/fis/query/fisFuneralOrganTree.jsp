...
<script type="text/javascript" src="fisFuneralOrganTree.js"></script>
</head>
<body>
<model:datasets>
	...
	<next:Panel  border="false" anchor="100% 100%" >
		...
		<next:Tree name="dicCitytree" id="dicCitytree" collapsible="true" rootExpanded="true" autoScroll="true" height="100%" lines="true">
			<next:TreeDataSet dataset="dicCityDataSet" root="rootdata">
				...
				<next:TreeLoader cmd="com.inspur.cams.fis.base.cmd.FisFuneralOrganManageQueryCmd" method="queryOrganByUnitId" trigger="getOrganManage">
					<next:treeRecord name="fisFuneralOrganRecord" idField="ORGAN_CODE" >
			...
			<next:TreeNodemodel recordType="fisFuneralOrganRecord">
