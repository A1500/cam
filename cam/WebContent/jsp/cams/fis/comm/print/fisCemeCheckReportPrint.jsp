...
<script type="text/javascript">
	 var cemeId='<%=request.getParameter("cemeApplyId")%>';
</script>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript" src="json.js"></script>
<script type="text/javascript" src="fisCemeCheckReportPrint.js"></script>
<title>打印</title>
</head>
<body >
<model:datasets>
	...
	<!-- 打印信息DS -->
	<model:dataset id="printInfoDS" cmd="com.inspur.cams.fis.base.cmd.FisCemeCheckScoreQueryCmd" global="true">
		<model:record fromBean="com.inspur.cams.fis.base.data.FisCemeCheckScore"/>
	</model:dataset>
	<model:dataset id="printDS" cmd="com.inspur.cams.fis.base.cmd.FisCemeApplyInfoQueryCmd" global="true">
