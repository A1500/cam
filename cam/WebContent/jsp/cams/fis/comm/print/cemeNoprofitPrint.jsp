...
<script type="text/javascript" src="cemeNoprofitPrint.js"></script>
<title>打印</title>
</head>
<body >
<model:datasets>
	...
	<model:dataset id="printInfoDS" cmd="com.inspur.cams.fis.ep.base.cmd.FisCemeQueryCmd" global="true" method="queryForPrintInfo">
		<model:record fromBean="com.inspur.cams.fis.ep.base.data.FisCeme">
			...
			<model:field name="FUND_SOURCES" />
		</model:record>
	</model:dataset>
	<model:dataset id="printDS" cmd="com.inspur.cams.fis.ep.base.cmd.FisCemeQueryCmd" global="true" method="queryForPrint">
		<model:record fromBean="com.inspur.cams.fis.ep.base.data.FisCemeGovApproval">
			<model:field name="APP"  />
		</model:record>
	</model:dataset>
</model:datasets>
<next:ViewPort>
