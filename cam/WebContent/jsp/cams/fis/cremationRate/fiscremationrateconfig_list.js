...
function query(){
	...
	ds.setParameter("FIS_CREMATION_RATE_CONFIG.NAME@=",getParam("name"));		
...
function insert() {
	...
	var url='jsp/cams/fis/cremationRate/fiscremationrateconfig_edit.jsp';
	var text = '增加FIS_CREMATION_RATE_CONFIG';
...
function update(){
	...
	var url='jsp/cams/fis/cremationRate/fiscremationrateconfig_edit.jsp';
	var text = '修改FIS_CREMATION_RATE_CONFIG';
	L5.forward(url,text,data);
}
