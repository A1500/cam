...
<script type="text/javascript" src="publicCemeChangeCheckList.js"></script>
<script type="text/javascript" src="../../ep.js"></script> 
<script language="javascript">
	var organCode = '<%=BspUtil.getOrganCode()%>' ;
	var organType = '<%=BspUtil.getOrganType()%>';
	var organName = '<%=BspUtil.getOrganName()%>';
	var procTypeId="fisCemePublicChange";
	var act="";
	var actId="<%=request.getParameter("actId")%>";
	var procDefUniqueId="8a898ca2410fbb0f01410fde0fb5000a";	
