...
<script type="text/javascript" src="publicCemeApprove.js"></script> 
...
<next:Panel>
  <next:TopBar>
     ...
     <next:ToolBarItem iconCls="remove" id="buQi" handler="buQi" text="补齐补正"></next:ToolBarItem>
	...
	<next:Html>
		...
		<table border="1" width="100%" height="100%">
			<tr>
				...
				<td class="FieldInput">	<label name="公墓性质" field="prop" dataset="cemePropDataSet"></label></td>
			</tr>
			<tr>
				...
				<td class="FieldInput"><label name="单位性质" field="properties" dataset="propertiesDataSet"></label></td>
...
<next:Panel title="变更事项" width="100%" height="100%" autoScroll="true">
	...
	<next:Panel title="审核审批" border="false" autoScroll="true" >
			...
			<div id="xjdiv">
			    ...
			    <fieldset>
			      <legend>乡镇发起意见</legend>
				 <table width="100%">
					<tr>
					<td class="FieldLabel" rowspan="4" width="100px;">审<br>核<br>内<br>容</td>
					<td class="FieldLabel" width="10%">审核结果</td>
					<td class="FieldInput">
					<label style="width:90px;" name="zeroResult"  id="zeroResult" field="zeroResult" dataset="fisBaseOpinionDs"/>
					</td>
					</tr>
					<tr>
					<td class="FieldLabel" width="10%">审核意见</td>
					<td class="FieldInput"><label name="zeroOpinion" field="zeroOpinion"  /></textarea></td>	
					</tr>
					<tr>
					<td class="FieldLabel" width="10%">审核时间</td>
					<td class="FieldInput" ><label type="text" name="zeroTime" field="zeroTime"   /></td>
					</tr>
			 ...
			 <div id="xjdiv2" >
			 <form id="shform10"   onsubmit="return false" dataset="fisCemeApplyInfoDs" style="padding: 5px;" class="L5form">
			 		<fieldset><legend>审核意见</legend>
					<table width="100%">
					<tr>
						<td class="FieldLabel" rowspan="4" width="100px;">审<br>核<br>内<br>容</td>
						<td class="FieldLabel" width="10%">审核结果</td>
						<td class="FieldInput"><input type="hidden" id="select" name="select" />
									<select style="width:130px;" name="zeroResult" validateName="乡级审核结果" id="zeroResult" field="zeroResult"  onChange="onChangeSelectZ();">
			 ...
			 <form id="shform2"    onsubmit="return false" dataset="fisCemeApplyInfoDs" style="padding: 5px;" class="L5form">
				...
				<table width="98%">
					<tr>
						<td class="FieldLabel" rowspan="3" width="100px;">审批<br>报告<br>文件</td>
					...
					<tr>
						...
						<td class="FieldLabel" width="10%">审核结果</td>
						<td class="FieldInput">	<input type="hidden" id="select" name="select" />
							<select style="width:130px;" name="firstResult" id="firstResult" field="firstResult"  onChange="onChangeSelectF();">
							<option dataset="fisBaseOpinionDs"></option>
							</select>
						</td>
					</tr>
			 ...
			 <form id="shform3"    onsubmit="return false" dataset="fisCemeApplyInfoDs" style="padding: 5px;" class="L5form">
				...
				<table width="98%">
					...
					<td class="FieldLabel" width="10%">审核结果</td>
					<td class="FieldInput">
					<label style="width:90px;" name="firstResult"  id="firstResult" field="firstResult" dataset="fisBaseOpinionDs"/>
					</td>
					</tr>
					<tr>
					<td class="FieldLabel" width="10%">审核意见</td>
