...
<script type="text/javascript" src="publicCemeChangeEdit.js"></script> 
...
<next:ViewPort>
	<next:Panel width="100%" height="100%">
		...
		<next:Panel title="变更事项" width="100%" height="100%" autoScroll="true">
			...
			<next:Panel id="shenhePanel" title="乡级审核" width="100%" height="100%">
<next:Html>
...
<input type="hidden" id="select" name="select" />
				<select style="width:130px;" name="zeroResult" validateName="乡级审核结果" id="zeroResult" field="zeroResult"  onChange="onChangeSelect();">
...
<td class="FieldInput"><textarea name="zeroOpinion" field="zeroOpinion"  validateName="乡级审核意见" cols="55" rows="8"></textarea></td>	
</tr>
<tr>
<td class="FieldLabel" width="10%">审核时间</td>
<td class="FieldInput" ><input type="text" validateName="乡级审核时间"format="Y-m-d" style="width: 100px" name="zeroTime" id="zeroTime" field="zeroTime" maxlength="10" readonly="readonly" /><img  src="../../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ></td>
</tr>
</table>
</fieldset>
</div>  
...
<!-- 主管单位变更 -->
<next:Window id="AddChange0" closeAction="hide" title="主管单位变更" width="600"  autoScroll="true" modal="true">
	<next:TopBar>
		<next:ToolBarItem text='' id="displayItem" />
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
		<next:ToolBarItem text="确定" iconCls="add" handler="forManaLevelMove" ></next:ToolBarItem>
...
<next:Html>
	...
	<table width="100%">
			<tr>
				...
				<td class="FieldInput"style="width:75%"><label id="manaLevelName" /></td>
			</tr>
			<tr>
				<td class="FieldLabel" style="width:25%"><label>变更前：</label></td>
				<td class="FieldInput"style="width:75%"><label id="manaLevelBefore"/></td>
			</tr>
			<tr>
				<td class="FieldLabel"style="width:25%"><label style="color:blue">变更后：</label></td>
				<td class="FieldInput"style="width:75%"><input id="manaLevelId" style="display: none"/><input id='manaLevelAfter' type="text" onclick="updateSelectManaCode()" readonly="readonly" style="width:98%"/></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更理由：</label></td>
				<td class="FieldInput"><textArea cols="75" id="manaLevelReason" rows="4" style="width: 100%" ></textArea></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更时间：</label></td>
				<td class="FieldInput"><input type="text" validateName="变更时间" format="Y-m-d" style="width: 100px" id="manaLevelTime" maxlength="10" readonly="readonly" /><img  src="../../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  > </td>
			</tr>
		</table>
...
<!-- 主办单位变更 -->
<next:Window id="AddChange1" closeAction="hide" title="主办单位变更" width="600"  autoScroll="true" modal="true">
	<next:TopBar>
		<next:ToolBarItem text='' id="displayItem" />
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
		<next:ToolBarItem text="确定" iconCls="add" handler="forOrganizerMove" ></next:ToolBarItem>
		<next:ToolBarItem text="关闭" iconCls="return" handler="closeChangeWin"></next:ToolBarItem>
	</next:TopBar>
<next:Html>
	<form method="post" onsubmit="return false" class="L5form" dataset="detailds">
	...
	<table width="100%">
			<tr>
				<td class="FieldLabel" style="width:25%"><label>变更项目：</label></td>
				<td class="FieldInput"style="width:75%"><label id="organizerName" /></td>
			</tr>
			<tr>
				<td class="FieldLabel" style="width:25%"><label>变更前：</label></td>
				<td class="FieldInput"style="width:75%"><label id="organizerBefore"/></td>
			</tr>
			<tr>
				<td class="FieldLabel"style="width:25%"><label style="color:blue">变更后：</label></td>
				<td class="FieldInput"style="width:75%"><input id='organizerAfter' type="text"  style="width:98%"/></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更理由：</label></td>
				<td class="FieldInput"><textArea cols="75" id="organizerReason" rows="4" style="width: 100%" field=""></textArea></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更时间：</label></td>
				<td class="FieldInput"><input type="text" validateName="变更时间" format="Y-m-d" style="width: 100px" id="organizerTime" maxlength="10" readonly="readonly" /><img  src="../../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  > </td>
			</tr>
		</table>
