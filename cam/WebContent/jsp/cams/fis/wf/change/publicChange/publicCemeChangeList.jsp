...
<script type="text/javascript" src="publicCemeChangeList.js"></script>
...
<model:datasets>
	...
	<!-- 上报状态 -->
	<model:dataset id="fisCemeIsReport" enumName="FIS.CEMECREATE.REPORT.STATUS" global="true" autoLoad="true"></model:dataset>
			...
			<next:TopBar>
				...
				<next:GridPanel id="daiBanTaskGridPanel" name="daiBanTaskGridPanel" width="100%" height="100%" dataset="daiBanDataSet" title="待办任务列表" notSelectFirstRow="true">
					...
					<next:Columns>
						...
						<next:Column field="ZERO_TIME" header="发起时间" width="10%" sortable="false" renderer="renderDate" />
					</next:Columns>
					<next:BottomBar>
