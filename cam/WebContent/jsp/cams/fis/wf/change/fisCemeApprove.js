...
//	var detaildsList = L5.DatasetMgr.lookup("detaildsList");
//	detaildsList.setParameter("CEME_APPLY_ID",document.getElementById("changeId").value);
//	detaildsList.load();
	...
	if(organType=="13"){
		...
		endCode="C20";
		accessoriesDataSet.setParameter("endCode", endCode);
		fisCemeApplyInfoDs.set("secondTime",curDay);
		fisCemeApplyInfoDs.set("secondReportTime",curDay);
	}else if(organType=="11"){
		endCode="C30";
		accessoriesDataSet.setParameter("endCode", endCode);
		fisCemeApplyInfoDs.set("thirdTime",curDay);
		fisCemeApplyInfoDs.set("thirdReportTime",curDay);
	}
...
function onChangeSelectS(){
	document.getElementById("select").value=document.getElementById("secondResult").value;
}
function onChangeSelectT(){
	document.getElementById("select").value=document.getElementById("thirdResult").value;
}