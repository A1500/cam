...
<script type="text/javascript" src="fisCemeChangeRecordEdit.js"></script> 
...
<model:datasets>
	...
	<model:dataset id="itemDs" cmd="com.inspur.cams.comm.dicm.DicQueryCmd" global="true" autoLoad="true">
		...
		<model:params>
			<model:param name="dic" value='FIS_CEME_CHANGE_RECORD'></model:param>
		</model:params>
	</model:dataset>
	<!-- 变更备案明细表 -->
			...
			<next:Panel title="公墓信息" width="100%" height="100%" autoScroll="true">
				...
				<next:Html>
					...
					<table border="1" width="100%" height="100%">
						<tr>
							<input type="text" id="changeId" style="display: none" dataset="fisCemeChangeDs" filed="changeId"/>
							...
							<td class="FieldInput" style="width: 210"><label name="单位编号" id="organId" field="organId" style="font-weight: bold;"></label></td>
...
<next:Window id="AddChange" closeAction="hide" title="添加变更" width="400"  autoScroll="true" modal="true">
	...
	<table width="100%">
			<tr>
				...
				<td class="FieldInput"style="width:15%"><select id="addChangeItem" ><option dataset="itemDs" value=""></option></select></td>
...
<!-- 主管单位变更 -->
<next:Window id="AddChange0" closeAction="hide" title="公墓名称变更" width="600"  autoScroll="true" modal="true">
	<next:TopBar>
		<next:ToolBarItem text='' id="displayItem" />
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
...
<next:Html>
	<form method="post" onsubmit="return false" class="L5form" dataset="detailds">

	<table width="100%">
			<tr>
				<td class="FieldLabel" style="width:25%"><label>变更项目：</label></td>
				<td class="FieldInput"style="width:75%"><label id="nameName" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="FieldInput"><textArea cols="75" id="nameReason" rows="4" style="width: 100%" field=""></textArea></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更时间：</label></td>
				<td class="FieldInput"><input type="text" validateName="变更时间" format="Y-m-d" style="width: 100px" id="nameTime" maxlength="10" readonly="readonly" /><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  > </td>
			</tr>
		</table>
...
<!-- 法人代表变更 -->
<next:Window id="AddChange1" closeAction="hide" title="法人代表变更" width="600"  autoScroll="true" modal="true">
	<next:TopBar>
		<next:ToolBarItem text='' id="displayItem" />
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
		<next:ToolBarItem text="确定" iconCls="add" handler="forLegalPeopleMove" ></next:ToolBarItem>
		<next:ToolBarItem text="关闭" iconCls="return" handler="closeChangeWin"></next:ToolBarItem>
	</next:TopBar>
<next:Html>
	<form method="post" onsubmit="return false" class="L5form" dataset="detailds">
	...
	<table width="100%">
			<tr>
				<td class="FieldLabel" style="width:25%"><label>变更项目：</label></td>
				<td class="FieldInput"style="width:75%"><label id="legalPeopleName" /></td>
			</tr>
			<tr>
				<td class="FieldLabel" style="width:25%"><label>变更前：</label></td>
				<td class="FieldInput"style="width:75%"><label id="legalPeopleBefore"/></td>
			</tr>
			<tr>
				<td class="FieldLabel"style="width:25%"><label style="color:blue">变更后：</label></td>
				<td class="FieldInput"style="width:75%"><input id='legalPeopleAfter' type="text"  style="width:98%"/></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更理由：</label></td>
				<td class="FieldInput"><textArea cols="75" id="legalPeopleReason" rows="4" style="width: 100%" field=""></textArea></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更时间：</label></td>
				<td class="FieldInput"><input type="text" validateName="变更时间" format="Y-m-d" style="width: 100px" id="legalPeopleTime" maxlength="10" readonly="readonly" /><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  > </td>
			</tr>
		</table>
...
<next:Window id="AddChange2" closeAction="hide" title="负责人变更" width="600"  autoScroll="true" modal="true">
	<next:TopBar>
		<next:ToolBarItem text='' id="displayItem" />
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
		<next:ToolBarItem text="确定" iconCls="add" handler="forDirectorMove" ></next:ToolBarItem>
		<next:ToolBarItem text="关闭" iconCls="return" handler="closeChangeWin"></next:ToolBarItem>
	</next:TopBar>
<next:Html>
	<form method="post" onsubmit="return false" class="L5form" dataset="detailds">
	...
	<table width="100%">
			<tr>
				<td class="FieldLabel" style="width:25%"><label>变更项目：</label></td>
				<td class="FieldInput"style="width:75%"><label id="directorName" /></td>
			</tr>
			<tr>
				<td class="FieldLabel" style="width:25%"><label>变更前：</label></td>
				<td class="FieldInput"style="width:75%"><label id="directorBefore"/></td>
			</tr>
			<tr>
				<td class="FieldLabel"style="width:25%"><label style="color:blue">变更后：</label></td>
				<td class="FieldInput"style="width:75%"><input id='directorAfter' type="text"  style="width:98%"/></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更理由：</label></td>
				<td class="FieldInput"><textArea cols="75" id="directorReason" rows="4" style="width: 100%" field=""></textArea></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更时间：</label></td>
				<td class="FieldInput"><input type="text" validateName="变更时间" format="Y-m-d" style="width: 100px" id="directorTime" maxlength="10" readonly="readonly" /><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  > </td>
			</tr>
		</table>
...
<!-- 联办单位变更 -->
<next:Window id="AddChange3" closeAction="hide" title="联办单位变更" width="600"  autoScroll="true" modal="true">
	<next:TopBar>
		<next:ToolBarItem text='' id="displayItem" />
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
		<next:ToolBarItem text="确定" iconCls="add" handler="forCoOrganizerMove" ></next:ToolBarItem>
		<next:ToolBarItem text="关闭" iconCls="return" handler="closeChangeWin"></next:ToolBarItem>
	</next:TopBar>
	<next:Html>
		<form method="post" onsubmit="return false" class="L5form" dataset="detailds">
			<table width="100%">
				<tr>
					<td class="FieldLabel" style="width:25%"><label>变更项目：</label></td>
					<td class="FieldInput"style="width:75%"><label id="coOrganizerName" /></td>
				</tr>
				<tr>
					<td class="FieldLabel" style="width:25%"><label>变更前：</label></td>
					<td class="FieldInput"style="width:75%"><label id="coOrganizerBefore"/></td>
				</tr>
				<tr>
					<td class="FieldLabel"style="width:25%"><label style="color:blue">变更后：</label></td>
					<td class="FieldInput"style="width:75%"><input id='coOrganizerAfter' type="text"  style="width:98%"/></td>
				</tr>
				<tr>
					<td class="FieldLabel"><label style="color:blue">变更理由：</label></td>
					<td class="FieldInput"><textArea cols="75" id="coOrganizerReason" rows="4" style="width: 100%" field=""></textArea></td>
				</tr>
				<tr>
					<td class="FieldLabel"><label style="color:blue">变更时间：</label></td>
					<td class="FieldInput"><input type="text" validateName="变更时间" format="Y-m-d" style="width: 100px" id="coOrganizerTime" maxlength="10" readonly="readonly" /><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  > </td>
				</tr>
			</table>
		</form>
	</next:Html>
...
<next:Window id="AddChangeAll" closeAction="hide" title="添加变更" width="400"  autoScroll="true" modal="true">
	...
	<table width="100%">
			<tr>
				...
				<td class="FieldInput"style="width:15%"><select id="addChangeItemAll" onchange="itemChange()" ><option dataset="itemDs" value=""></option></select></td>
			</tr>
			<tr>
				<td class="FieldLabel" style="width:25%"><label>变更前：</label></td>
			...
			<tr>
				<td class="FieldLabel"style="width:25%"><label style="color:blue">变更后：</label></td>
				<td class="FieldInput"style="width:75%"><input id='itemAfterAll' type="text" style="width:98%" onchange="nameTest()"/></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更理由：</label></td>
