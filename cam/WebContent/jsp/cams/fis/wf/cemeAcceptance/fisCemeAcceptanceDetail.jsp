				...
				<fieldset><legend>省级审批</legend>
					<table width="100%">
						...
						<tr>
							...
							<td class="FieldInput" ><label type="text"  id="businessCemeCertificateId2" field="businessCemeCertificateId" style="width: 30%" maxlength="50" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="FieldInput" colspan="3"><textarea  rows="10"	name="审批意见" id="thirdOpinion" field="thirdOpinion" maxlength="1500"
								style="width: 80%" readonly="readonly"> </textarea></td>
						</tr>
					</table>
				</fieldset>
