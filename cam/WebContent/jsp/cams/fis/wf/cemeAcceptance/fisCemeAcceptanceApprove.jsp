...
<html>
	<head>
		...
		<script type="text/javascript" src="fisCemeAcceptanceApprove.js"></script>
...
<model:datasets>
	...
	<model:dataset id="agreementOpinion" enumName="FIS.CEMEACCEPTANCE.OPINIONS" autoLoad="true" global="true">
	</model:dataset>
	<!-- 省级审批意见 -->
	<model:dataset id="provinceOpinion" enumName="FIS.CEMEACCEPTANCE.OPINIONS" autoLoad="true" global="true">
	</model:dataset>
	<!-- 审批意见历史流水 -->
...
<next:TopBar>
	...
	<next:ToolBarItem id="zhengdun"  iconCls="remove" text="整顿" handler="boHui"/>
				...
				<legend>验收信息</legend>
					<table border="1" width="100%" >
						...
						<tr>
		                    ...
		                    <td class="FieldInput" colspan="3"><label name="实际安葬墓穴数合计" id="sinceHoleNum" field="sinceHoleNum" style="text-align:right" maxlength="50"></label>个</td>
			           </tr>
			           <tr>
			                ...
			                <td class="FieldInput" colspan="3"><label name="实际单穴数" id="singleHole" field="singleHole" style="text-align:right" maxlength="50"></label>个</td>
			           </tr>
			           <tr>
			                ...
			                <td class="FieldInput" colspan="3"><label name="实际双穴数" id="doubleHole" field="doubleHole" style="text-align:right" maxlength="50"></label>个</td>
			          </tr>
			          <tr>
			                ...
			                <td class="FieldInput"><label name="计划多穴数" id="planMoreHole" field="planMoreHole" style="text-align:right" maxlength="50"></label>个</td>
							  ...
							  <td class="FieldInput" colspan="3"><label name="实际多穴数" id="moreHole" field="moreHole" style="text-align:right" maxlength="50"></label>个</td>
							</tr>
							<tr>
							  ...
							  <td class="FieldInput" colspan="3"><label name="实际安放格位数量" id="cageHoleNum" field="cageHoleNum" style="text-align:right" maxlength="50"></label>个</td>
							</tr>
							<tr>
							  ...
							  <td class="FieldInput" colspan="3"><label name="实际生态安葬数量" id="ecologicalHoleNum" field="ecologicalHoleNum" style="text-align:right" maxlength="50"></label>个</td>
							</tr>
							<tr>
							  ...
							  <td class="FieldInput" colspan="3"><label name="实际公益安葬数量" id="welfareHoleNum" field="welfareHoleNum" style="text-align:right" maxlength="50"></label>个</td>
							</tr>
						<TR>
				...
				<legend>验收信息</legend>
					<table border="1" width="100%" >
						...
						<tr>
			                ...
			                <td class="FieldLabel">实际安葬墓穴数合计</td>
		                    <td class="FieldInput" colspan="3"><label name="实际安葬墓穴数合计" id="E_sinceHoleNum" field="sinceHoleNum" style="text-align:right" maxlength="50"></label>个</td>
			           </tr>
			           <tr>
			                <td class="FieldLabel">计划单穴数</td>
			                ...
			                <td class="FieldLabel">实际单穴数</td>
			                <td class="FieldInput" colspan="3"><label name="实际单穴数" id="E_singleHole" field="singleHole" style="text-align:right" maxlength="50"></label>个</td>
			           </tr>
			           <tr>
			                <td class="FieldLabel">计划双穴数</td>
			                ...
			                <td class="FieldLabel">实际双穴数</td>
			                <td class="FieldInput" colspan="3"><label name="实际双穴数" id="E_doubleHole" field="doubleHole" style="text-align:right" maxlength="50"></label>个</td>
			          </tr>
			          <tr>
			                <td class="FieldLabel">计划多穴数</td>
			                <td class="FieldInput"><label name="计划多穴数" id="E_planMoreHole" field="planMoreHole" style="text-align:right" maxlength="50"></label>个</td>
							  <td class="FieldLabel">实际多穴数</td>
							  <td class="FieldInput" colspan="3"><label name="实际多穴数" id="E_moreHole" field="moreHole" style="text-align:right" maxlength="50"></label>个</td>
							</tr>
							<tr>
							  <td class="FieldLabel">计划安放格位数量</td>
							  ...
							  <td class="FieldLabel">实际安放格位数量</td>
							  <td class="FieldInput" colspan="3"><label name="实际安放格位数量" id="E_cageHoleNum" field="cageHoleNum" style="text-align:right" maxlength="50"></label>个</td>
							</tr>
							<tr>
							  <td class="FieldLabel">计划生态安葬数量</td>
							  ...
							  <td class="FieldLabel">实际生态安葬数量</td>
							  <td class="FieldInput" colspan="3"><label name="实际生态安葬数量" id="E_ecologicalHoleNum" field="ecologicalHoleNum" style="text-align:right" maxlength="50"></label>个</td>
							</tr>
							<tr>
							  <td class="FieldLabel">计划公益安葬数量</td>
							  ...
							  <td class="FieldLabel">实际公益安葬数量</td>
							  <td class="FieldInput" colspan="3"><label name="实际公益安葬数量" id="E_welfareHoleNum" field="welfareHoleNum" style="text-align:right" maxlength="50"></label>个</td>
							</tr>
						<TR>
							<td class="FieldLabel" >经营管理方式<br>(维护管理办法)</td>
							<td class="FieldInput"  colspan="5">
		...
		<legend>区县受理意见</legend>
				...
				<fieldset><legend>市级审核</legend>
					<table width="100%">
						<tr>
							...
							<td class="FieldLabel" width="10%" id="secondReportTimeLabel">转报时间</td>
							<td class="FieldInput"><input type="text" name="转报时间" id="secondReportTime" field="secondReportTime" readonly="readonly" format="Y-m-d" /><img  id="img2" src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  > </td>
						</tr>
						<tr>
							<td class="FieldLabel" style="width:10%" id="secondReportNameLabel">转报文件名：</td>
							<td class="FieldInput" ><input type="text" name="转报文件名" field="secondReportName" id="secondReportName" style="width: 30%" maxlength="50" style="width:50%"/></td>
						</tr>
						<tr>
							<td class="FieldLabel" style="width:10%" id="secondReportNumberLabel">转报文号：</td>
							<td class="FieldInput" ><input type="text" name="转报文号" field="secondReportNumber" id="secondReportNumber" style="width: 30%" maxlength="50" style="width:50%"/></td>
						</tr>
						...
						<tr>
							...
							<td class="FieldInput"><select name="市级审核结果" id="secondResult" field="secondResult" style="width: 30%" onchange="showSJ()"><option dataset="agreementOpinion">市级审核结果 </option></select><font color="red">*</font></td>
			...
			<div id="shenPi1" >
				<fieldset><legend>省级审批</legend>
					<table width="100%">
						<tr>
							<td class="FieldLabel" rowspan="5" width="100px;">批<br>	复<br>内<br>容</td>
							<td class="FieldLabel" width="10%" id="thirdReportTimeLabel">批复时间</td>
							<td class="FieldInput"><input type="text" id="thirdReportTime" field="thirdReportTime" readonly="readonly" format="Y-m-d" /><img  src="../../../../../skins/images/default/rl.gif" id="img3" align="middle"  onclick="getTimes(this)"  > </td>
						</tr>
										           
						<tr>
							<td class="FieldLabel" style="width:10%" id="thirdReportNameLabel">批复文件名：</td>
							<td class="FieldInput" ><input type="text" id="thirdReportName" field="thirdReportName" style="width: 30%" maxlength="50"/></td>
						</tr>
						<tr>
							<td class="FieldLabel" style="width:10%" id="thirdReportNumberLabel">批复文号：</td>
							<td class="FieldInput" ><input type="text" id="thirdReportNumber" field="thirdReportNumber" style="width: 30%" maxlength="50" /></td>
						</tr>
						
						<tr>
							<td class="FieldLabel" style="width:10%" id="businessCemeCertificateId1Label" disabled=true>《经营性公墓合格证》编号：</td>
							<td class="FieldInput" ><input type="text" id="businessCemeCertificateId1" field="businessCemeCertificateId" dataset="fisCemeInfoDataSet" style="width: 30%" maxlength="50" /></td>
						</tr>
						<tr>
						    <td class="FieldLabel" style="width:10%" id="rectifyDeadline1Label" disabled=true>整顿截止时间</td>
			                <td class="FieldInput"><input type="text" id="rectifyDeadline1" field="rectifyDeadline" readonly="readonly" format="Y-m-d" format="Y-m-d" /><img  id="img1"  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  > </td>
						</tr>
	
						<tr>
							<td class="FieldLabel" rowspan="4" width="100px;">省<br>	级<br>审<br>批</td>
							<td class="FieldLabel" width="10%">审批时间</td>
							<td class="FieldInput"><input type="text" name="审批时间" id="thirdTime" field="thirdTime" readonly="readonly" format="Y-m-d" /><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  > </td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="FieldInput" >
							      <select id="thirdResult" field="thirdResult" name="省级审批结果" onchange="show()" >
                                        <option  dataset="provinceOpinion"></option>
							      </select>							
							</td>	
						</tr>
						<tr>
				...
				<fieldset><legend>省级审批</legend>
					<table width="100%">
						<tr>
							...
							<td class="FieldInput"><label  id="shengjipifu" field="thirdReportTime" style="width: 30%" readonly="readonly"/></td>							
						</tr>
						<tr>
							<td class="FieldLabel" style="width:10%">批复文件名：</td>
							<td class="FieldInput" ><label id="shengjipifu2" name="批复文件名" field="thirdReportName" style="width: 30%" maxlength="50" /></td>
						</tr>
						<tr>
						...
						<tr>
							<td class="FieldLabel" style="width:10%">《经营性公墓合格证》编号：</td>
							<td class="FieldInput" ><label type="text"  id="businessCemeCertificateId2"field="businessCemeCertificateId" dataset="fisCemeInfoDataSet"  style="width: 30%" maxlength="50" /></td>
						</tr>
						<tr>
						...
						<tr>
							<td class="FieldLabel" style="width:10%">审批结果：</td>
							<td class="FieldInput" ><label field="thirdResult" style="width: 30%" dataset="provinceOpinion"/></td>	
