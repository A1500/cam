...
<model:datasets>
	...
	<model:dataset id="hisDs" cmd="com.inspur.cams.fis.base.cmd.FisCemeCheckHistoryQueryCmd" method="queryOrder" global="true" >
		...
		<!-- 1:同意,2:不同意,3:补齐补正 -->
	<model:dataset id="opinionPlus" enumName="FIS.CEMEACCEPTANCE.OPINIONS_PLUS" autoLoad="true" global="true">
	</model:dataset>
			<!-- 历史信息 -->
...
<next:GridPanel id="cemePanel" name="fisCemeGrid" width="98%" stripeRows="true" height="300" dataset="hisDs" autoScroll="true" title="历史列表">
		<next:TopBar>
		...
		<next:Columns>
		    ...
		    <next:Column id="firstTime" header="受理时间" field="FIRST_TIME" width="120" />		    
			<next:Column id="cemeApplyId" header="验收业务编码" field="CEME_APPLY_ID" width="120" />
			<next:Column id="firstUnit" header="受理单位编码" field="FIRST_UNIT_ID" width="120" />
			...
			<next:Column id="firstOpinion" header="受理意见" field="FIRST_OPINION" width="120" />
...
<next:Window id="cemeWin" title="公墓验收审批意见历史记录" width="800" height="500" autoHeight="true" resizable="false" closeAction="hide" modal="true">
