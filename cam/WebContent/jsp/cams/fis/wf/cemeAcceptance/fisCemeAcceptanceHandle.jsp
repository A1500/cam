...
<script language="javascript">
	var procTypeId="fisCemeAcceptance";
	var organType = '<%=BspUtil.getOrganType()%>';
	var organTest = '<%=BspUtil.getCorpOrgan().getOrganName()%>';
	var act=" ";
	var procDefUniqueId="8a898c8641625cc50141625cc5730000";	
				...
				<next:Html>			
					<fieldset style="overflow: visible;" class="GroupBox">
				        ...
				        <tr>
							...
							<td class="FieldButton" style="width:30%"><button onclick="queryDB()">查询</button>&nbsp;&nbsp;&nbsp;&nbsp;<button type="reset">重置</button></td>
						</tr>
					</table>
				</form>
						</div>
			...
			<next:Panel width="100%" border="0">
				<next:Html>			
					<fieldset style="overflow: visible;" class="GroupBox">
						...
						<tr>
						 	<td class="FieldLabel" style="width:10%">公墓名称：</td>
							<td class="FieldInput" style="width:20%"><input type="text"  id="nameYB" class="TextEditor" title="公墓名称" style="width:90%" /></td>	
						    <td class="FieldLabel" style="width:10%">发起单位:</td>
							<td class="FieldInput" style="width:20%"><input type="text"  id="fillOrganNameYB" class="TextEditor" title="发起单位" style="width:80%" /></td>
							<td class="FieldButton" style="width:30%"><button onclick="queryyiban()">查询</button>&nbsp;&nbsp;&nbsp;&nbsp;<button type="reset">重置</button></td>
						</tr>
					</table>
				</form>
						</div>
			...
			<next:Panel width="100%" border="0">	
				...
				<fieldset style="overflow: visible;" class="GroupBox">
					...
					<div class="GroupBoxDiv" style="width: 100%;height: 100%;">	
						...
						<tr>
						 	<td class="FieldLabel" style="width:10%">公墓名称：</td>
							<td class="FieldInput" style="width:20%"><input type="text"  id="nameEnd" class="TextEditor" title="公墓名称" style="width:90%" /></td>	
						    <td class="FieldLabel" style="width:10%">发起单位:</td>
							<td class="FieldInput" style="width:20%"><input type="text"  id="fillOrganNameEnd" class="TextEditor" title="发起单位" style="width:80%" /></td>
							<td class="FieldButton"style="width:30%"><button onclick="queryEnd()">查询</button>&nbsp;&nbsp;&nbsp;&nbsp;<button type="reset">重置</button></td>
						</tr>
					</table>
				</form>
					</div>
