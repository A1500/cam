...
<script type="text/javascript" src="fisPublicCemeYearlyApproveList.js"></script>
...
<model:datasets>
	<!-- 公益性年检业务表 -->
	<model:dataset id="daiBanDataset" cmd="com.inspur.cams.fis.base.cmd.FisCemeApplyInfoQueryCmd" method="queryPublic">
...
<next:ViewPort>
			<next:Panel title="公益性公墓年检办理" width="100%" height="100%" >
				...
				<next:GridPanel id="daiBanTaskGridPanel" name="daiBanTaskGridPanel" width="100%" height="100%" dataset="daiBanDataset" title="待办列表" notSelectFirstRow="true">
					...
					<next:Columns>
						...
						<next:Column id="CEME_APPLY_ID" header="业务编码" field="CEME_APPLY_ID" width="15%" hidden="true"></next:Column>
						<next:Column id="SCORE_ID" header="打分编码" field="SCORE_ID" width="15%" hidden="true"></next:Column>
						<next:Column id="RECORD_ID" header="公墓记录编码" field="RECORD_ID" width="15%" hidden="true"></next:Column>
						<next:Column id="ORGAN_IDS" header="公墓编码" field="ORGAN_ID" width="15%" hidden="true"></next:Column>
						<next:Column id="NAME" header="公墓名称" field="NAME" width="15%" ></next:Column>
						<next:Column id="APPLY_STATE" header="业务状态" field="APPLY_STATE" dataset="applyState" width="15%" align="center"></next:Column>
						<next:Column id="IS_REPORT" header="上报状态" field="IS_REPORT" width="15%" dataset="isReportState" align="center"></next:Column>
						...
						<next:Column id="CHECK_YEAR" header="年检年度" field="CHECK_YEAR" width="15%" align="center"></next:Column>
