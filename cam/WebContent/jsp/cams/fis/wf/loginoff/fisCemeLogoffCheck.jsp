...
<script type="text/javascript" src="fisCemeLogoffCheck.js"></script> 
...
<next:Panel title="公墓信息" width="100%" height="100%" autoScroll="true">
	<next:Html>
		<form id="editForm" dataset="fisCemeInfoDataSet" onsubmit="return false"
			class="L5form">
...
<next:Panel title="关闭事项" width="100%" autoScroll="true" height="100%">
		<next:Html>
		<form id="beianForm1"    onsubmit="return false" dataset="fisCemeInfoDataSet" style="padding: 5px;" class="L5form">
		  <fieldset>
  ...
  <next:Panel title="外管单位意见" width="100%" autoScroll="true" height="98%">
		...
		<form id="form83" method="post" dataset="cemeLogoffOpinionDs" onsubmit="return false" class="L5form">
		<fieldset>
...
<next:Panel title="审核审批" border="false" autoScroll="true" >
			...
			<form id="shform1"    onsubmit="return false" dataset="fisCemeApplyInfoDs" style="padding: 5px;" class="L5form">
			    <fieldset>
				  ...
				  <table width="98%">
				  		<tr>
				  		    <td class="FieldLabel" style="width:5%" rowspan="3" >上<p>报<p>内<p>容</td>
						<td  class="FieldLabel" style="width:10%">报告文件名</td>
						<td class="FieldInput" ><input type="text" validateName="报告文件名" style="width: 100px" name="firstReportName" id="firstReportName" field="firstReportName" maxlength="10"  /></td>
					</tr>
					<tr>
					    <td  class="FieldLabel" style="width:10%">报告文号</td>
						<td class="FieldInput" ><input type="text" validateName="报告文号" style="width: 100px" name="firstReportNumber" id="firstReportNumber" field="firstReportNumber" maxlength="10"  /></td>
					</tr>
					<tr>
						...
						<td class="FieldInput" ><input type="text" validateName="报告时间"format="Y-m-d" style="width: 100px" name="firstReportTime" id="firstReportTime" field="firstReportTime" maxlength="10"  readonly="readonly"/><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  > </td>
				  		...
				  		<tr>
				  		    <td  class="FieldLabel" style="width:5%" rowspan="3">县<p>级<p>发<p>起</td>
				  			<td  class="FieldLabel" style="width:10%">县级审核结果</td>
						<td class="FieldInput" style="width:60%" colspan="5">
						<select style="width:130px;" name="firstResult" validateName="县级审核结果" id="firstResult" field="firstResult">
							<option dataset="fisBaseOpinionDs"></option>
						</select>
						</td>
					</tr>
					<tr>
						<td  class="FieldLabel" >县级审核意见</td>
						<td class="FieldInput" colspan="5"><textarea name="firstOpinion" field="firstOpinion"  validateName="县级审核意见" cols="50" rows="8"></textarea> </td>
					</tr>
					<tr>
						<td  class="FieldLabel" >县级审核时间</td>
						<td class="FieldInput" colspan="5"><input type="text" validateName="县级审核时间"format="Y-m-d" style="width: 100px" name="firstTime" id="firstTime" field="firstTime" maxlength="10" readonly="readonly" /><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  > </td>
					</tr>
				</table>
			    </fieldset>
			 </form>   
			 ...
			 <form id="shform2"    onsubmit="return false" dataset="fisCemeApplyInfoDs" style="padding: 5px;" class="L5form">
				...
				<table width="98%">
				    <tr>
				        <td  class="FieldLabel" rowspan="3">上<p>报<p>内<p>容</td>
					...
					<tr>
			   		...
			   		<tr>
			   		    <td  class="FieldLabel" style="width:5%" rowspan="5">县<p>级<p>发<p>起</td>
			   			<td  class="FieldLabel" style="width:10%">县级审核结果</td>
						<td class="FieldInput" style="width:60%" colspan="5">
			  ...
			  <div id="sjdiv" >
				...
				<table width="98%">
				   <tr>
				        <td class="FieldLabel" style="width:5%" rowspan="3" >转<p>报<p>内<p>容</td>
						<td  class="FieldLabel" >报告文件名</td>
						<td class="FieldInput" ><input type="text"  style="width: 100px" name="报告文件名" id="secondReportName" field="secondReportName" maxlength="10"  /></td>
					</tr>
					<tr>
					    <td  class="FieldLabel" >报告文号</td>
						<td class="FieldInput" ><input type="text"  style="width: 100px" name="报告文号" id="secondReportNumber" field="secondReportNumber" maxlength="10"  /></td>
					</tr>
					<tr>
					    <td  class="FieldLabel" >报告时间</td>
						<td class="FieldInput" ><input type="text" format="Y-m-d" style="width: 100px" name="报告时间" id="secondReportTime" field="secondReportTime" maxlength="10"  readonly="readonly"/><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  > </td>
					</tr>
			   		<tr>
			   		    <td class="FieldLabel" style="width:5%" rowspan="3" >市<p>级<p>审<p>核</td>
			   			<td  class="FieldLabel" style="width:10%">市级审核结果</td>
						<td class="FieldInput" style="width:60%" colspan="5">
						<select style="width:130px;" name="审核结果"  id="secondResult" field="secondResult" >
							<option dataset="fisBaseOpinionDs"></option>
						</select><font color="red">*</font>
						</td>
					</tr>
					<tr>
						<td  class="FieldLabel" >市级审核意见</td>
						<td class="FieldInput" colspan="5"><textarea name="审核意见" field="secondOpinion"  id="secondOpinion" cols="50" rows="8"></textarea><font color="red">*</font> </td>
					</tr>
					<tr>
						<td  class="FieldLabel" >市级审核时间</td>
						<td class="FieldInput" colspan="5"><input type="text" format="Y-m-d" style="width: 100px" name="审核时间" id="secondTime" field="secondTime" maxlength="10"  readonly="readonly"/><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  > <font color="red">*</font></td>
					</tr>
				</table>
				</fieldset>
				</form>
				...
				<table width="98%">
				    <tr>
				        <td  class="FieldLabel" rowspan="3">转<p>报<p>内<p>容</td>
						<td  class="FieldLabel" >报告文件名</td>
						<td class="FieldInput" ><label field="secondReportName" maxlength="10"  /></td>
					</tr>
					<tr>
					    <td  class="FieldLabel" >报告文号</td>
						<td class="FieldInput" ><label field="secondReportNumber" maxlength="10"  /></td>
					</tr>
					<tr>
					    <td  class="FieldLabel" >报告时间</td>
						<td class="FieldInput" ><label field="secondReportTime" maxlength="10"  /></td>
					</tr>
			   		<tr>
			   		    <td  class="FieldLabel" style="width:5%" rowspan="5">市<p>级<p>审<p>核</td>
			   			<td  class="FieldLabel" style="width:10%">市级审核结果</td>
						<td class="FieldInput" style="width:60%" colspan="5">
						<label style="width:90px;" name="审核结果"  id="secondResult" field="secondResult" dataset="fisBaseOpinionDs"/>
						</td>
					</tr>
					<tr>
						<td  class="FieldLabel" >市级审核意见</td>
						<td class="FieldInput" colspan="5"><textarea name="审核意见" field="secondOpinion"  cols="50" rows="8" readonly="readonly"></textarea> </td>
					</tr>
					<tr>
						<td  class="FieldLabel" >市级审核时间</td>
						<td class="FieldInput" colspan="5"><label type="text" format="Y-m-d" style="width: 100px" name="审核时间" field="secondTime" maxlength="10"  /> </td>
					</tr>
				</table>
				</fieldset>
				</form>
			    ...
			    <div id="sjdiv2" >
			    <form id="shform8"    onsubmit="return false" dataset="fisCemeApplyInfoDs" style="padding: 5px;" class="L5form">
				<fieldset>
			      <legend>市级审核意见</legend>
				<table width="98%">
				    <tr>
					...
					<tr>
			   		...
			   		<tr>
			   		    <td  class="FieldLabel" style="width:5%" rowspan="5">市<p>级<p>发<p>起</td>
			   			<td  class="FieldLabel" style="width:10%">市级审核结果</td>
						<td class="FieldInput" style="width:60%" colspan="5">
						<label style="width:90px;" name="审核结果"  id="secondResult" field="secondResult" dataset="fisBaseOpinionDs"/>
						</td>
			    ...
			    <div id="shjdiv" >
			    <form id="shform5"    onsubmit="return false"  style="padding: 5px;" class="L5form">
				<fieldset>
			      <legend>省级审批意见</legend>
				   <table width="98%" dataset="fisCemeApplyInfoDs">
				     <tr>
				        <td class="FieldLabel" style="width:5%" rowspan="3" >批<p>复<p>内<p>容</td>
						<td  class="FieldLabel" style="width:15%">报告文件名</td>
						<td class="FieldInput" ><input type="text" style="width: 100px" name="报告文件名" id="thirdReportName" field="thirdReportName" maxlength="10"  /></td>
					 </tr>
					 <tr>
					    <td  class="FieldLabel" >报告文号</td>
						<td class="FieldInput" ><input type="text" style="width: 100px" name="报告文号" id="thirdReportNumber" field="thirdReportNumber" maxlength="10"  /></td>
					 </tr>
					 <tr>
					    <td  class="FieldLabel" >报告时间</td>
						<td class="FieldInput" ><input type="text" format="Y-m-d" style="width: 100px" name="报告时间" id="thirdReportTime" field="thirdReportTime" maxlength="10"  readonly="readonly"/><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  > </td>
					 </tr>
			   		 <tr>
			   		    <td  class="FieldLabel" style="width:5%" rowspan="5">省<p>级<p>审<p>批</td>
			   			<td  class="FieldLabel" style="width:15%">省级审批结果</td>
						<td class="FieldInput" style="width:85%" colspan="5">
						<select style="width:130px;" name="审批结果"  id="thirdResult" field="thirdResult" >
							<option dataset="fisBaseOpinionDs"></option>
						</select><font color="red">*</font>
						</td>
					</tr>
					<tr>
						<td  class="FieldLabel" >省级审批意见 </td>
						<td class="FieldInput" colspan="5"><textarea name="审批意见" field="thirdOpinion"  cols="50" rows="8"></textarea><font color="red">*</font> </td>
					</tr>
					<tr>
						<td  class="FieldLabel" >省级审批时间</td>
						<td class="FieldInput" colspan="5"><input type="text"format="Y-m-d" style="width: 100px" name="审批时间" id="thirdTime" field="thirdTime" maxlength="10"  readonly="readonly"/><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ><font color="red">*</font> </td>
					</tr>
				</table>
				</fieldset>
				</form>
				...
				<fieldset>
			      <legend>省级审批意见</legend>
					<table width="98%" dataset="fisCemeApplyInfoDs">
					     <tr>
					        <td  class="FieldLabel" rowspan="3">批<p>复<p>内<p>容</td>
							<td  class="FieldLabel" style="width:15%">报告文件名</td>
							<td class="FieldInput" ><label style="width: 100px" name="报告文件名" id="thirdReportName" field="thirdReportName" maxlength="10"  /></td>
						</tr>
						<tr>
						    <td  class="FieldLabel" >报告文号</td>
							<td class="FieldInput" ><label  style="width: 100px" name="报告文号" id="thirdReportNumber" field="thirdReportNumber" maxlength="10"  /></td>
						</tr>
						<tr>
						    <td  class="FieldLabel" >报告时间</td>
							<td class="FieldInput" ><label format="Y-m-d" style="width: 100px" name="报告时间" id="thirdReportTime" field="thirdReportTime" maxlength="10"  readonly="readonly"/></td>
						</tr>
				   		<tr>
				   		    <td  class="FieldLabel" style="width:5%" rowspan="5">省<p>级<p>审<p>批</td>
				   			<td  class="FieldLabel" style="width:10%">省级审批结果</td>
							<td class="FieldInput" style="width:60%" colspan="5">
							<label style="width:90px;" name="审批结果" id="thirdResult" field="thirdResult" dataset="fisBaseOpinionDs"/>
							</td>
						</tr>
						<tr>
							<td  class="FieldLabel" >省级审批意见</td>
							<td class="FieldInput" colspan="5"><textarea name="审批意见" field="thirdOpinion"  cols="50" rows="8" readonly="readonly"></textarea> </td>
						</tr>
						<tr>
							<td  class="FieldLabel" >省级审批时间</td>
							<td class="FieldInput" colspan="5"><label type="text" format="Y-m-d" style="width: 100px" name="审批时间" field="thirdTime" maxlength="10"  /></td>
						</tr>
					</table>
				</fieldset>
				</form>
