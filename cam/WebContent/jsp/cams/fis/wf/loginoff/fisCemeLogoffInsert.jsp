...
<script type="text/javascript" src="fisCemeLogoffInsert.js"></script> 
...
<model:datasets>
	...
	<model:dataset id="fisCemeApplyInfoDs" cmd="com.inspur.cams.fis.base.cmd.FisCemeApplyInfoQueryCmd">
		<model:record fromBean="com.inspur.cams.fis.base.data.FisCemeApplyInfo">
		  ...
		  %>
		   <model:field name="firstReportName" type="string" rule="require" />
		   <model:field name="firstReportNumber" type="string" rule="require"/>
		   <model:field name="firstResult" type="string" rule="require"/>
		   <model:field name="firstOpinion" type="string" rule="require"/>
		   <%}else{ %>
		   <model:field name="secondReportName" type="string" rule="require"/>
		   <model:field name="secondReportNumber" type="string" rule="require"/>
	...
	<model:dataset id="accessoriesDataSet" cmd="com.inspur.cams.fis.base.cmd.FisCemeApplyInfoQueryCmd" method="queryAccessoryType" global="true">
		<model:record fromBean="com.inspur.cams.fis.base.data.FisCemeAccessories"></model:record>
	</model:dataset>
	<!-- 附件上传下载列表 -->
...
<next:Panel id="detailPanel" title="关闭事项" width="100%" height="99%">
		...
		<form id="beianForm"    onsubmit="return false" dataset="fisCemeDataSet" style="padding: 5px;" class="L5form">
		   <fieldset>
		   <legend>公墓安葬信息</legend>
			  <table width="98%">
			    <tr>
			       <td class="FieldLabel">安葬墓穴数量</td>
			       <td class="FieldInput"><input type="text" name="安葬墓穴数量" id="sinceHoleNum" field="sinceHoleNum" /><font color="red">*</font></td>
			    ...
			    <tr>
			       ...
			       <td class="FieldLabel">公益安葬数量</td>
			       <td class="FieldInput"><input type="text" name="公益安葬数量" id="welfareHoleNum" field="welfareHoleNum" /><font color="red">*</font></td>
			    </tr>
			</table>
		 </fieldset>
	    </form>
		   ...
		   <legend>公墓撤销备案信息</legend>
			  <table width="98%">
				<tr>
					...
					<td class="FieldInput" colspan="7"><textarea name="撤销原因" field="logoffReason" cols="50" rows="8"></textarea><font color="red">*</font></td>
				</tr>
				<tr>
					<td  class="FieldLabel" >撤销时间</td>
					<td class="FieldInput" colspan="7"><input type="text" format="Y-m-d" style="width: 100px" name="撤销时间" id="logoffDate" field="logoffDate" maxlength="10"  readonly="readonly"/><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  > </td>
				</tr>
			</table>
		 </fieldset>
	    </form>
			...
			<legend>国土资源单位意见</legend>
				<table width="100%">
					<tr>
						...
						<td class="FieldInput"><input type="text" format="Y-m-d" style="width: 100px" name="国土资源审核时间" id="guotuTime" field="guotuTime" maxlength="10" readonly="readonly" /><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  > <font color="red">*</font></td>
					</tr>
					<tr>
						<td class="FieldLabel" width="8%">部门审核意见</td>
						<td class="FieldInput" colspan="3"><textarea  rows="10"
							name="国土资源审核意见" id="guotuOpinion" field="guotuOpinion" maxlength="1500" 
		...
		<legend>城乡规划单位意见</legend>
			<table width="100%">
				<tr>
					...
					<td class="FieldLabel" width="8%">部门审核时间</td>
					<td class="FieldInput"><input type="text" format="Y-m-d" style="width: 100px" name="城乡规划审核时间" id="townTime" field="townTime" maxlength="10" readonly="readonly" /><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ><font color="red">*</font> </td>
				</tr>
				<tr>
				    <td class="FieldLabel" width="8%">部门审核意见</td>
		...
		<legend>环境保护单位意见</legend>
			<table width="100%">
				<tr>
					...
					<td class="FieldLabel" width="8%">部门审核时间</td>
					<td class="FieldInput"><input type="text" format="Y-m-d" style="width: 100px" name="环境保护审核时间" id="huanbaoTime" field="huanbaoTime" maxlength="10" readonly="readonly" /><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ><font color="red">*</font> </td>
				</tr>
				<tr>
					<td class="FieldLabel" width="8%">部门审核意见</td>
		...
		<legend>林业部门意见</legend>
			<table width="100%">
				<tr>
					...
					<td class="FieldLabel" width="8%">部门审核时间</td>
					<td class="FieldInput"><input type="text" validateName="林业审核时间"format="Y-m-d" style="width: 100px" name="linyeTime" id="linyeTime" field="linyeTime" maxlength="10" readonly="readonly" /><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ></td>
				</tr>
				<tr>
					<td class="FieldLabel" width="8%">部门审核意见</td>
					<td class="FieldInput" colspan="3"><textarea rows="10" validateName="林业审核意见" id="linyeOpinion" field="linyeOpinion" maxlength="1500"
    ...
    <form id="shenheForm"   dataset="fisCemeApplyInfoDs" onsubmit="return false" style="padding: 5px;" class="L5form">
		  ...
		  <table width="98%">
	   		<tr>
				...
				<td class="FieldInput" ><input type="text" style="width: 100px" name="报告文件名" id="firstReportName" field="firstReportName" maxlength="10"  /><font color="red">*</font></td>
			</tr>
			<tr>
			    <td  class="FieldLabel" style="width:10%">报告文号</td>
				<td class="FieldInput" ><input type="text" style="width: 100px" name="报告文号" id="firstReportNumber" field="firstReportNumber" maxlength="10"  /><font color="red">*</font></td>
			</tr>
			<tr>
			    <td  class="FieldLabel" style="width:10%">报告时间</td>
				<td class="FieldInput" ><input type="text" format="Y-m-d" style="width: 100px" name="报告时间" id="firstReportTime" field="firstReportTime" maxlength="10"  readonly="readonly"/><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  > </td>
			</tr>
	   		<tr>
				...
				<select style="width:130px;" name="县级审核结果" id="firstResult" field="firstResult">
			...
			<tr>
				...
				<td class="FieldInput" colspan="5"><textarea name="县级审核意见" field="firstOpinion" cols="50" rows="8"></textarea><font color="red">*</font> </td>
			</tr>
			<tr>
				<td  class="FieldLabel" >县级审核时间</td>
				<td class="FieldInput" colspan="5"><input type="text" format="Y-m-d" style="width: 100px" name="县级审核时间" id="firstTime" field="firstTime" maxlength="10" readonly="readonly" /><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  > </td>
			</tr>
		</table>
		</fieldset>
	    </form>
		...
		<table width="98%">
		   <tr>
			...
			<tr>
	   		...
	   		<tr>
	   		    <td class="FieldLabel" style="width:5%" rowspan="3" >市<p>级<p>发<p>起</td>
	   			<td  class="FieldLabel" style="width:10%">市级审批结果</td>
				<td class="FieldInput" style="width:60%" colspan="5">
				<select style="width:130px;" name="市级审批结果"  id="secondResult" field="secondResult" >
					<option dataset="fisBaseOpinionDs"></option>
				</select>
				</td>
			</tr>
			<tr>
				<td  class="FieldLabel" >市级审批意见</td>
				<td class="FieldInput" colspan="5"><textarea name="市级审批意见" field="secondOpinion"  id="secondOpinion" cols="50" rows="8"></textarea> </td>
			</tr>
			<tr>
				<td  class="FieldLabel" >市级审批时间</td>
				<td class="FieldInput" colspan="5"><input type="text" format="Y-m-d" style="width: 100px" name="市级审批时间" id="secondTime" field="secondTime" maxlength="10"  readonly="readonly"/><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  > </td>
			</tr>
		</table>
		</fieldset>
		</form>
