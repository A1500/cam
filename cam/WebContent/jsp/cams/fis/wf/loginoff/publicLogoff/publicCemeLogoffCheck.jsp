...
<script type="text/javascript" src="publicCemeLogoffCheck.js"></script> 
...
<model:datasets>
	...
	<model:dataset id="fisOpinionDs" enumName="FIS.OPINION" autoLoad="true" global="true"></model:dataset>
	<!--公墓关闭备案信息  -->
...
<next:Panel>
  <next:TopBar>
     ...
     <next:ToolBarItem id="reject" iconCls="remove" handler="reject" text="补齐补正"></next:ToolBarItem>
     <next:ToolBarItem id="send" iconCls="save" handler="send" text="提交"></next:ToolBarItem>
     <next:ToolBarItem id="submit" iconCls="save" handler="submit" text="审批"></next:ToolBarItem>
     <next:ToolBarItem iconCls="detail" handler="rejectDetail" text="审批历史"></next:ToolBarItem>
...
<next:Panel title="关闭事项" width="100%" autoScroll="true" height="100%">
		<next:Html>
		<form id="beianForm"    onsubmit="return false" dataset="fisCemeInfoDataSet" style="padding: 5px;" class="L5form">
		   <fieldset>
		   <legend>公墓信息</legend>
		   <table width="98%">
		       <tr>
			       ...
			       <td class="FieldInput" colspan="2"><label name="singleHole" id="singleHole" field="singleHole"/></td>
			    </tr>
			    <tr>
			       <td class="FieldLabel" width="15%">双穴</td>
			       <td class="FieldInput" colspan="2"><label name="doubleHole" id="doubleHole" field="doubleHole"/></td>
			    </tr>
			    <tr>
			        <td class="FieldLabel" width="15%">多穴</td>
			       <td class="FieldInput" colspan="2"><label name="moreHole" id="moreHole" field="moreHole"/></td>
			    </tr>
			    <tr>
			       <td class="FieldLabel" width="15%">合计</td>
			       <td class="FieldInput" colspan="2"><label name="sinceHoleNum" id="sinceHoleNum" field="sinceHoleNum"/></td>
			    </tr>
			    <tr>
			       <td class="FieldLabel">安放格位数量</td>
			       <td class="FieldInput"><label name="placeSiteNum" id="placeSiteNum" field="cageHoleNum"/></td>
			       <td class="FieldLabel" width="15%">生态安葬数量</td>
			       <td class="FieldInput"><label name="ecoBurialNum" id="ecoBurialNum" field="ecologicalHoleNum"/></td>
			    </tr>
		   </table>
		   </fieldset>
		</form>
		    ...
		    <tr>
		        ...
		        <td  class="FieldInput" style="width:60%">
		           <select field="zeroResult" name = "审核结果">
		              <option dataset="fisOpinionDs"></option>
		           </select><font color="red">*</font>
		        </td>     
		    </tr>
			<tr>
				<td  class="FieldLabel"  >乡镇、街办审核意见</td>
				<td class="FieldInput" colspan="5"><textarea name="审核意见" field="zeroOpinion" cols="50" rows="8"></textarea><font color="red">*</font> </td>
			</tr>
			<tr>
				<td  class="FieldLabel" >乡镇、街办审核时间</td>
				<td class="FieldInput" colspan="5"><input type="text" format="Y-m-d" style="width: 100px" name="审核时间" id="zeroTime" field="zeroTime" maxlength="10" readonly="readonly" /><img  src="../../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ><font color="red">*</font> </td>
			</tr>
		</table>
		</fieldset>
	    </form>
	 ...
	 <form id="shenheForm"   dataset="fisCemeApplyInfoDs" onsubmit="return false" style="padding: 5px;" class="L5form">
		 ...
		 <table width="98%">
		    <tr>
				...
				<label style="width:90px;" name="审核结果" 
					 id="zeroResult" field="zeroResult" dataset="fisBaseOpinionDs"/>
				</td>
			</tr>
			<tr>
				<td  class="FieldLabel" style="width:10%">乡镇、街办审核意见</td>
				<td class="FieldInput" colspan="5" style="width:60%"><textarea name="审核意见" field="zeroOpinion"  cols="50" rows="8" readonly="readonly"></textarea> </td>
			</tr>
			<tr>
				<td  class="FieldLabel" style="width:10%">乡镇、街办审核时间</td>
				<td class="FieldInput" colspan="5" style="width:60%"><label style="width: 100px" name="审核时间" id="zeroTime" field="zeroTime" /></td>
			</tr>
		</table>
		</fieldset>
	    </form>
		  ...
		  <table width="98%">
			...
			<tr>
	   		...
	   		<tr>
				...
				<td class="FieldInput" style="width:60%" colspan="5">
				<select style="width:130px;" name="审批结果"  id="firstResult" field="firstResult">
			...
			<tr>
				...
				<td class="FieldInput" colspan="5"><textarea name="审批意见" field="firstOpinion"  cols="50" rows="8"></textarea><font color="red">*</font> </td>
			</tr>
			<tr>
				<td  class="FieldLabel" >县级审核时间</td>
				<td class="FieldInput" colspan="5"><input type="text" format="Y-m-d" style="width: 100px" name="审批时间" id="firstTime" field="firstTime" maxlength="10" readonly="readonly" /><img  src="../../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ><font color="red">*</font> </td>
			</tr>
		</table>
	    </fieldset>
	 </form>   
	      ...
	      <legend>县级审批意见</legend>
			...
			<tr>
	   		...
	   		<tr>
	   			...
	   			<td  class="FieldLabel" style="width:10%">县级审批结果</td>
				<td class="FieldInput" style="width:60%" colspan="5">
				<label style="width:90px;" name="审批结果" 
					 id="firstResult" field="firstResult" dataset="fisBaseOpinionDs"/>
				</td>
			</tr>
			<tr>
				<td  class="FieldLabel" >县级审批意见</td>
				<td class="FieldInput" colspan="5"><textarea name="审批意见" field="firstOpinion"  cols="50" rows="8" readonly="readonly"></textarea> </td>
			</tr>
			<tr>
				<td  class="FieldLabel" >县级审批时间</td>
				<td class="FieldInput" colspan="5"><label type="text" format="Y-m-d" style="width: 100px" name="审批时间" field="firstTime" maxlength="10"  /></td>
			</tr>
		</table>
		</fieldset>
	   </form>
