...
<script type="text/javascript" src="publicCemeLogoffList.js"></script>
...
<model:datasets>
	...
	<model:dataset id="fisCemeIsReport" enumName="FIS.CEME.PUBLIC.LOGOFF" global="true" autoLoad="true"></model:dataset>
</model:datasets>
	<next:Panel width="100%" autoHeight="true" titleCollapse="true" collapsible="true" title="公墓撤销">	
	    <next:TopBar>
	       <next:ToolBarItem symbol="->"></next:ToolBarItem>
	       <next:ToolBarItem handler="download" iconCls="export" text="使用说明下载"></next:ToolBarItem>
	    </next:TopBar>	
		<next:Html><center>		 
			...
			<form style="width: 98%; height: 100%;" class="L5form">
				<table  border="1" width="100%">
					<tr>
		                ...
		                <td class="FieldButton" style="width:30%"><button onclick="queryApply()">查询</button>&nbsp;&nbsp;&nbsp;
