...
<script type="text/javascript" src="publicCemeLogoffCheckList.js"></script>
...
<script language="javascript">
	...
	var procDefUniqueId="8a898be941058a390141059fb12f0002";	
...
<model:datasets>
	...
	<model:dataset pageSize="10" id="endDataSet" cmd="com.inspur.cams.fis.base.cmd.FisCemeWorkflowQueryCmd" method="queryEnd" autoLoad="false" global="true">
		<model:record>
		</model:record>
	</model:dataset>
	<!-- 备案信息 -->
	...
	<!-- 上报状态 -->
	<model:dataset id="fisCemeIsReport" enumName="FIS.CEMECREATE.REPORT.STATUS" global="true" autoLoad="true">
	</model:dataset>
	<!-- 公墓信息 -->
  ...
  <next:Panel title="待办任务" width="100%" height="100%">
	...
	<next:GridPanel id="daiBanGridPanel" title="待办任务列表" dataset="daiBanDataSet" width="100%" height="100%" stripeRows="true" notSelectFirstRow="true">
		...
		<next:Columns>
			...
			<next:Column field="ZERO_TIME" header="发起时间" width="10%" sortable="false"/>
		</next:Columns>
		<next:BottomBar>
	...
	<next:GridPanel id="yiBanGridPanel" title="已办任务列表" dataset="yiBanDataSet" width="100%" height="100%" stripeRows="true" notSelectFirstRow="true">
		<next:TopBar>
		     <next:ToolBarItem symbol="->"></next:ToolBarItem>
		     <next:ToolBarItem iconCls="detail" text="明细" handler="handleyiban"></next:ToolBarItem>
	...
	<next:GridPanel id="banjieGridPanel" title="办结任务列表" dataset="endDataSet" width="100%" height="100%" stripeRows="true" notSelectFirstRow="true">
		<next:TopBar>
		     <next:ToolBarItem symbol="->"></next:ToolBarItem>
		...
		<next:BottomBar>
			<next:PagingToolBar dataset="endDataSet" />
		</next:BottomBar>
	</next:GridPanel>
	</next:Panel>
	</next:Tabs>
