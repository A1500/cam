...
<script type="text/javascript" src="fisCemeLogoffDetail.js"></script> 
	...
	<next:Html>
	 ...
	 <form id="shform2"    onsubmit="return false" dataset="fisCemeApplyInfoDs" style="padding: 5px;" class="L5form">
		...
		<table width="98%">
			...
			<tr>
	   		...
	   		<tr>
				...
				<td class="FieldInput" style="width:60%" colspan="5">
				<label style="width:90px;" name="cityFlag"  id="secondResult" field="secondResult" dataset="fisBaseOpinionDs"/>
				</td>
			</tr>
			<tr>
				<td  class="FieldLabel" >市级审批意见</td>
				<td class="FieldInput" colspan="5"><textarea name="secondOpinion" field="secondOpinion"  cols="50" rows="8" readonly="readonly"></textarea> </td>
			</tr>
			<tr>
				<td  class="FieldLabel" >市级审批时间</td>
				<td class="FieldInput" colspan="5"><label type="text" validateName="时间"format="Y-m-d" style="width: 100px" name="chiefTime" field="secondTime" maxlength="10"  /> </td>
			</tr>
		</table>
		</fieldset>
		</form>
		...
		<table width="98%">
	     ...
	     <div id="shjdiv1" >
	    <form id="shform6"    onsubmit="return false"  style="padding: 5px;" class="L5form">
		<fieldset>
		  ...
		  <table width="98%" dataset="fisCemeApplyInfoDs">
		     <tr>
				...
				<td class="FieldInput" ><label validateName="报告文件名" style="width: 100px" name="thirdReportName" id="thirdReportName" field="thirdReportName" maxlength="10"  /></td>
			</tr>
			<tr>
			    <td  class="FieldLabel" >报告文号</td>
				<td class="FieldInput" ><label validateName="报告文号" style="width: 100px" name="thirdReportNumber" id="thirdReportNumber" field="thirdReportNumber" maxlength="10"  /></td>
			</tr>
			<tr>
			    <td  class="FieldLabel" >报告时间</td>
				<td class="FieldInput" ><label validateName="报告时间"format="Y-m-d" style="width: 100px" name="thirdReportTime" id="thirdReportTime" field="thirdReportTime" maxlength="10"  readonly="readonly"/></td>
			</tr>
	   		<tr>
	   		    <td  class="FieldLabel" style="width:5%" rowspan="5">省<p>级<p>审<p>批</td>
	   			<td  class="FieldLabel" style="width:10%">省级审批结果</td>
				<td class="FieldInput" style="width:60%" colspan="5">
				<label style="width:90px;" name="thirdResult" id="thirdResult" field="thirdResult" dataset="fisBaseOpinionDs"/>
				</td>
			</tr>
			<tr>
				<td  class="FieldLabel" >省级审批意见</td>
				<td class="FieldInput" colspan="5"><textarea name="thirdOpinion" field="thirdOpinion"  cols="50" rows="8" readonly="readonly"></textarea> </td>
			</tr>
			<tr>
				<td  class="FieldLabel" >省级审批时间</td>
				<td class="FieldInput" colspan="5"><label type="text" validateName="时间"format="Y-m-d" style="width: 100px" name="thirdTime" field="thirdTime" maxlength="10"  /></td>
			</tr>
		</table>
		</fieldset>
		</form>
