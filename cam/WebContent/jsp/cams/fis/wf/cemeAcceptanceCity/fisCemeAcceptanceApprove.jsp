...
<model:datasets>
	...
	<model:dataset id="fisCemeApplyInfoDataSet" cmd="com.inspur.cams.fis.base.cmd.FisCemeApplyInfoQueryCmd" pageSize="10">
		<model:record fromBean="com.inspur.cams.fis.base.data.FisCemeApplyInfo">
			...
			<model:field name="secondTime" type="string" rule="require" />
			</model:record>
	</model:dataset>
		...
		<legend>市级受理意见</legend>
			<table width="100%">
			 ...
			 <tr>
			    ...
			    <td class="FieldInput"><label type="text" validateName="报告文件名"  name="firstReportName" id="firstReportName" field="firstReportName" style="width: 300px"  /></td>
			</tr>
			<tr>
			    <td class="FieldLabel" style="width:10%">文件文号</td>
			    <td class="FieldInput" ><label type="text" validateName="报告文号"  name="firstReportNumber" id="firstReportNumber" field="firstReportNumber" style="width: 300px"  /></td>
			</tr>
			<tr>
			    <td class="FieldLabel" style="width:10%">文件时间</td>
			    <td class="FieldInput" ><label type="text" validateName="报告时间"format="Y-m-d" style="width: 100px" name="firstReportTime" id="firstReportTime" field="firstReportTime" maxlength="10"  readonly="readonly"/><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ></td>
			</tr>
						<tr>
						...
						<tr>
							...
							<td class="FieldInput"><label type="text" name="受理市级名称" id="firstUnit" field="firstUnit" style="width: 30%" maxlength="50" style="width:50%"/></td>
						</tr>
						<tr>
							<td class="FieldLabel" style="width:10%">市级受理结果：</td>
				...
				<fieldset><legend>省级审批</legend>
					<table width="100%">
						<tr>
							...
							<td class="FieldLabel" width="10%" id="secondReportTimeLabel">批复时间</td>
							<td class="FieldInput"><input type="text" id="secondReportTime" field="secondReportTime" readonly="readonly" format="Y-m-d" /><img  src="../../../../../skins/images/default/rl.gif" id="img2" align="middle"  onclick="getTimes(this)"  > </td>
						</tr>
										           
						<tr>
							<td class="FieldLabel" style="width:10%" id="secondReportNameLabel">批复文件名：</td>
							<td class="FieldInput" ><input type="text" field="secondReportName" id="secondReportName" style="width: 30%" maxlength="50"/></td>
						</tr>
						<tr>
							<td class="FieldLabel" style="width:10%" id="secondReportNumberLabel">批复文号：</td>
							<td class="FieldInput" ><input type="text" id="secondReportNumber"  field="secondReportNumber" style="width: 30%" maxlength="50" /></td>
						</tr>
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" name="审批时间" id="secondTime" field="secondTime" readonly="readonly" format="Y-m-d" /><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  > </td>
						</tr>
						<tr>
							<td class="FieldLabel" style="width:10%" >审批单位名称：</td>
							<td class="FieldInput" ><label type="text" name="审批单位名称" id="secondUnit" field="secondUnit" style="width: 30%" maxlength="50" /></td>
						</tr>
						<tr>
							<td class="FieldLabel" style="width:10%" >审批结果：</td>
							<td class="FieldInput" >
							      <select id="secondResult" field="secondResult" name="省级审批结果" onchange="show()" >
						...
						<tr>
							...
							<td class="FieldInput" ><textarea  onpropertychange="if(value.length>1000) value=value.substr(0,1000)"   rows="10"
								name="审批意见" id="secondOpinion" field="secondOpinion" maxlength="1500"
