...
<script type="text/javascript" src="fisCemeAcceptanceDetail.js"></script>
...
<model:datasets>
	...
	<model:dataset id="propertiesDataSet" enumName="FIS.FUNERALHOME.STATE" autoLoad="true" global="true">
	</model:dataset>
	<!-- 13:县级, 14:乡镇级, 15:村级 -->
	<model:dataset id="dominationDS" enumName="FIS.FUNERALHOME.DOMINATION" autoLoad="true" global="true">
	</model:dataset>
	...
	<model:dataset id="organizerProperties" enumName="FIS.CEME.ORGANIZERPROP" autoLoad="true" global="true">
	</model:dataset>
				...
				<fieldset><legend>省级审批</legend>
					<table width="100%">
						<tr>
							...
							<td class="FieldInput"><label field="secondReportTime" style="width: 30%" readonly="readonly"/></td>
						</tr>
						<tr>
							<td class="FieldLabel" style="width:10%">批复文件名：</td>
							<td class="FieldInput" ><label name="批复文件名" field="secondReportName" maxlength="50" style="width:30%"/></td>
						</tr>
						<tr>
							<td class="FieldLabel" style="width:10%">批复文号：</td>
							<td class="FieldInput" ><label name="批复文号" field="secondReportNumber" maxlength="50" style="width:30%"/></td>
						</tr>
						<!-- <tr>
						...
						<tr>
							...
							<td class="FieldInput"><label name="审批时间" id="secondTime" field="secondTime" style="width: 30%" readonly="readonly" /></td>
						</tr>
						<tr>
							<td class="FieldLabel" style="width:10%">审批单位名称：</td>
							<td class="FieldInput" ><label name="审批单位名称" id="secondUnit" field="secondUnit" style="width: 30%" maxlength="50"/></td>
						</tr>
						<tr>
							<td class="FieldLabel" style="width:10%">审批结果：</td>
							<td class="FieldInput" ><label field="secondResult" style="width: 30%" dataset="agreementOpinion"/></td>	
												
						</tr>
						<tr>
							<td class="FieldLabel" width="10%">审批意见</td>
							<td class="FieldInput" ><textarea  rows="10"	name="审批意见" id="secondOpinion" field="secondOpinion" maxlength="1500"
