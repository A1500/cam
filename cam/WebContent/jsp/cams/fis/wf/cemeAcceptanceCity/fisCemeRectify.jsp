			...
			<tr>
				...
				<td class="FieldInput">
						<input type="hidden" id="select" name="select" />
							<select style="width:130px;" name="firstResult" validateName="市级审核结果" id="firstResult" field="firstResult" >
								<option dataset="agreementOpinion"></option>
							</select>
					</td>
			</tr>
			<tr>
				<td class="FieldLabel" width="10%">市级审核意见</td>
				<td class="FieldInput"><textarea name="firstOpinion" field="firstOpinion"  validateName="市级审核意见" cols="55" rows="8" onpropertychange="if(value.length>1000) value=value.substr(0,1000)" maxlength="1500"></textarea><font color="red">*可输入1000字</font></td>	
			</tr>
			<tr>
				<td class="FieldLabel" width="10%">市级审核时间</td>
				<td class="FieldInput" ><input type="text" validateName="市级审核时间"format="Y-m-d" style="width: 100px" name="firstTime" id="firstTime" field="firstTime" maxlength="10" readonly="readonly" /><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  ></td>
			</tr>
			</table>
			</fieldset>
			</div>  
