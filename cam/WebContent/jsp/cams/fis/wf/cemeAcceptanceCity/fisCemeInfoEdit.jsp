				...
				<legend>验收信息</legend>
					<table border="1" width="100%" >
						...
						<td class="FieldLabel" width="16%">占用土地性质</td>
							<td class="FieldInput" width="16%"><input name="占用土地性质" id="LAND_PROPERTIES" field="landProperties" maxlength="50" ></input></td>
    ...
    <form id="shenheForm"   dataset="fisCemeApplyInfoDs" onsubmit="return false" style="padding: 5px;" class="L5form">
		 <div id="shenHe2" >
			...
			<input type="hidden" id="select" name="select" />
							<select style="width:130px;" name="firstResult" validateName="市级审核结果" id="firstResult" field="firstResult"  onChange="onChangeSelect();">
