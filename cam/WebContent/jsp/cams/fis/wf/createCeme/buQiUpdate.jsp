...
<html>
<head>
<title>殡葬墓地申请_补齐补正</title>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript" src="buQiUpdate.js"></script>
...
<model:datasets>
	...
	<model:dataset id="accessoriesDataSet"
		cmd="com.inspur.cams.fis.base.cmd.FisCemeApplyInfoQueryCmd" method="queryAccessoryType" global="true">
...
<form id="form1" method="post" dataset="fisCemeInfoDataSet" onsubmit="return false" class="L5form">
	...
	<table border="1" width="100%" >
						<tr>
							...
							<td class="FieldInput"  width="16%"><label  name="公墓名称" maxlength="50" field="name" style="width: 200"/></td>
							<td class="FieldLabel" width="16%">单位编号</td>
							<td class="FieldInput" width="16%"><label name="单位编号"  field="organId" style="font-weight: bold;"/></td>
							<td class="FieldLabel" width="16%">单位性质</td>
							<td class="FieldInput" width="16%">	<select field="properties" ><option dataset="corpProperties">单位性质 </option></select></td>							</td>
						</tr>
						<tr>
							...
							<td class="FieldInput" ><select name="主办级别" field="domination" ><option dataset="dominateState" >主办级别</option></select><font color="red">*</font></td>
						...
						<tr>
							...
							<td class="FieldInput" colspan="3"><input type="text" id="directorMobile" field="directorMobile" maxlength="50" onchange=checkMobTel("directorMobile") /><font color="red">*</font></td>
						</tr>
						<tr>
							<td class="FieldLabel">法人代表</td>
							<td class="FieldInput"><input type="text" name="法人代表" maxlength="36" field="legalPeople" /></td>
							<td class="FieldLabel" >联系电话</td>
							<td class="FieldInput"  colspan="3"><input type="text" id="officePhone" name="法人代表联系电话" field="officePhone" maxlength="50" onchange=checkMobTel("officePhone") /></td>
						...
						<td class="FieldLabel">网站网址</td>
							...
							<td class="FieldInput"><input type="text" name="服务电话" maxlength="16" id="servicePhone"	field="servicePhone"  onchange=checkTelCreate("servicePhone") /></td>
						</tr>
						<tr>
						<!-- 	<td class="FieldLabel" >批准建设时间</td>
							...
							<td class="FieldInput"  colspan="5"><input type="text" name="计划使用年限至" id="yearPlanto" field="yearPlanto" maxlength="4" /> <font color="red">*</font></td>
						</tr>
						<tr>
						<td class="FieldLabel" >占用土地性质</td>
							...
							<td class="FieldInput"><input type="text" name="占地面积" id="totalArea" maxlength="13" style="text-align:right" field="totalArea" />亩<font color="red">*</font></td>
							<td class="FieldLabel">墓区建成面积</td>
							<td class="FieldInput"><input type="text" name="墓区建成面积" id="builtArea" maxlength="13" style="text-align:right" field="builtArea" />亩<font color="red">*</font></td>
						</tr>
						<tr>
							<td class="FieldLabel">建筑面积</td>
							<td class="FieldInput"><input type="text" name="建筑面积" id="builtTotalArea" maxlength="13" style="text-align:right" field="builtTotalArea" />㎡<font color="red">*</font></td>
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" name="总投资额" id="totalInvestment" maxlength="13" style="text-align:right" field="totalInvestment" />万元<font color="red">*</font></td>
						
							<td class="FieldLabel">固定资产</td>
							<td class="FieldInput"  colspan="3"><input type="text" name="固定资产" id="fixedAssets" maxlength="10" style="text-align:right" field="fixedAssets"/>万元<font color="red">*</font></td>
						</tr>
						<tr>
						...
						<tr>	
							...
							<td class="FieldInput" ><input type="text" name="计划安葬墓穴数" id="planSinceHoleNum" field="planSinceHoleNum" style="text-align:right" maxlength="10" />个<font color="red">*</font></td>
					...
					<TR>
						...
						<tr>
							...
							<td class="FieldInput" colspan="5"><input type="text" name="主办单位申请时间" id="applyTime" field="applyTime" format="Y-m-d" readonly="readonly" /><img  src="../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"> </td>
						</tr>
						<tr>
...
<legend>国土资源单位意见</legend>
		...
		<table width="100%">
						...
						<tr>
							...
							<td class="FieldInput"><input type="text" name="检查时间" id="guotuTime" field="guotuTime" style="width: 80%" readonly="readonly" format="Y-m-d" onclick="LoushangDate(this)" /></td>
						</tr>
						<tr>
...
<legend>城乡规划单位意见</legend>
		...
		<table width="100%">
						...
						<tr>
							...
							<td class="FieldLabel" width="8%">部门审核时间</td>
							<td class="FieldInput"><input type="text" name="城乡规划审核时间" id="townTime" field="townTime" style="width: 80%" readonly="readonly" format="Y-m-d" onclick="LoushangDate(this)" /></td>
						</tr>
						<tr>
							<td class="FieldLabel" width="8%">部门审核意见</td>
							<td class="FieldInput" colspan="3"><textarea  onpropertychange="if(value.length>1000) value=value.substr(0,1000)"   rows="10"
...
<legend>环境保护单位意见</legend>
		...
		<table width="100%">
						...
						<tr>
							...
							<td class="FieldLabel" width="8%">部门审核时间</td>
							<td class="FieldInput"><input type="text" name="环境保护审核时间" id="huanbaoTime" field="huanbaoTime" readonly="readonly" format="Y-m-d" onclick="LoushangDate(this)" /></td>
						</tr>
						<tr>
							<td class="FieldLabel" width="8%">部门审核意见</td>
							<td class="FieldInput" colspan="3"><textarea  onpropertychange="if(value.length>1000) value=value.substr(0,1000)"   rows="10"
...
<legend>林业部门意见</legend>
		...
		<table width="100%">
						...
						<tr>
							...
							<td class="FieldLabel" width="8%">部门审核时间</td>
							<td class="FieldInput"><input type="text" name="林业审核时间" id="linyeTime" field="linyeTime" readonly="readonly" format="Y-m-d" onclick="LoushangDate(this)" /></td>
						</tr>
						<tr>
							<td class="FieldLabel" width="8%">部门审核意见</td>
							<td class="FieldInput" colspan="3"><textarea  onpropertychange="if(value.length>1000) value=value.substr(0,1000)"   rows="10"
...
<next:Panel title="审核审批" width="100%" autoScroll="true">
<next:Html>

<form id="form8" method="post" dataset="fisCemeApplyInfoDataSet" onsubmit="return false" class="L5form">
<fieldset>
<legend>乡镇(街办)审核意见</legend>

		<table width="100%">
						<tr>
							<td class="FieldLabel" rowspan="4" width="100px;">乡<br>	镇<br>街<br>	办<br>受<br>理</td>
						...
						<tr>
							...
							<td class="FieldInput" ><input type="text" name="当前乡镇(街办)名称" id="zeroUnit" field="zeroUnit" style="width: 30%" maxlength="50" /></td>
						</tr>
						<tr>
							<td class="FieldLabel" style="width:10%">乡镇(街办)受理结果：</td>
							<td class="FieldInput"><select name="乡镇(街办)审核结果" field="zeroResult" style="width: 30%"><option dataset="agreementOpinion">乡镇(街办)审核结果 </option></select><font color="red">*</font></td>	
