...
function queryDB(){
	...
	if(allConditon!=""){
		daiBanDataset.setParameter("mysetwhere","PROP@=:"+"1"+allConditon);
	}
	daiBanDataset.load();
...
function queryyiban(){
	...
	if(allConditon!=""){
		yiBanTaskDataset.setParameter("mysetwhere","PROP@=:"+"1"+allConditon);
	}	
	yiBanTaskDataset.load();	
...
function queryEnd(){
	...
	if(allConditon!=""){
		endTaskDataset.setParameter("mysetwhere","PROP@=:"+"1"+allConditon);
	}	
	endTaskDataset.load();	
