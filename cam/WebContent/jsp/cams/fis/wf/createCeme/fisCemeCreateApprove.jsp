...
<next:TopBar>
	...
	<next:ToolBarItem iconCls="remove" text="驳回" handler="boHui"/>
	...
	<table border="1" width="100%" height="100%">
					...
					<tr>
						...
						<TR>
							...
							<label name="经营管理方式（维护管理办法）" field="manageStyle" dataset="manageStyle2GY"</label></td>
						</TR>
		...
		<legend>乡镇受理意见</legend>
				 ...
				 <div id="shenPi" >
					...
					<tr>
						...
						<tr>
							...
							<td class="FieldInput" ><label type="text" name="当前乡镇(街办)名称" id="firstUnit" field="firstUnit" style="width: 30%" maxlength="50" /></td>
						</tr>
						<tr>
							<td class="FieldLabel" width="10%" >审核结果：</td>
							<td class="FieldInput" ><select name="区县审核结果" field="firstResult" style="width: 30%"><option dataset="agreementOpinion">县级审核结果 </option></select></td>	
						...
						<tr>
							...
							<td class="FieldInput" colspan="3"><textarea  onpropertychange="if(value.length>1000) value=value.substr(0,1000)"   rows="10"
								name="区县审批意见" id="firstOpinion" field="firstOpinion" maxlength="1500"
			...
			<next:Panel title="附件" height="200%">
				<next:EditGridPanel id="uploadGrid" width="99.9%" stripeRows="true" height="100%" dataset="accessoriesDataSet">
					<next:TopBar>
						<next:ToolBarItem symbol="县级提交附件列表"></next:ToolBarItem>
