...
<model:datasets>
	<model:dataset id="fisCemeApplyInfoDataSet" cmd="com.inspur.cams.fis.base.cmd.FisCemeApplyInfoQueryCmd"  method="queryCreate" pageSize="10">
	...
	<model:dataset id="ReportStateNew" enumName="FIS.CEMECREATE.REPORT.STATUS" autoLoad="true" global="true">
		...
		<next:EditGridPanel title="公墓申建受理任务列表" id="grid" dataset="fisCemeApplyInfoDataSet" width="100%" stripeRows="true" height="99.9%">
			<next:TopBar>
				<next:ToolBarItem symbol="->"></next:ToolBarItem>
				<next:ToolBarItem iconCls="add" id="add" text="增加" handler="insert"></next:ToolBarItem>
