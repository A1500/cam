...
<fieldset>
	...
	<table border="1" width="100%" height="100%">
						...
						<tr>	
							...
							<td class="FieldInput" ><label name="计划公益安葬数量"  field="planWelfareHoleNum" style="text-align:right" maxlength="10" />个</td>
					
							<td class="FieldLabel" >计划生态安葬数量：</td>
							<td class="FieldInput" ><label name="计划生态安葬数量"  field="planEcologicalHoleNum" style="text-align:right" maxlength="10" />个</td>
					
							<td class="FieldLabel" >计划格位数量：</td>
							<td class="FieldInput" ><label name="计划安放格位数量"  field="planCageHoleNum" style="text-align:right" maxlength="10" />个</td>
					</tr>
					<tr>	
							<td class="FieldLabel" >计划安葬墓穴总数：</td>
							<td class="FieldInput" colspan="5"><label name="计划安葬墓穴数"  field="planSinceHoleNum" style="text-align:right" maxlength="10" />个</td>
					</tr>	
					<tr>
	...
	<table border="1" width="100%" >
		<!--<tr>
			<td class="FieldLabel" style="width:20%">公墓新建业务编码：</td>
			<td class="FieldInput" style="width:30%"><label  field="cemeApplyId" /></td>
			
			<td class="FieldLabel" style="width:20%">公墓新建业务标识：</td>
			<td class="FieldInput" style="width:30%"><label field="applyFlag"  /></td>
		</tr>  -->
		<tr>
				<td class="FieldLabel">公墓新建业务标识：</td>
			<td class="FieldInput"><input type="text" name="公墓新建业务标识" field="applyFlag" dataset="fisCemeApplyInfoDataSet" readonly="readonly" /></td>
				<td class="FieldLabel">公墓申建业务编码</td>
				<td class="FieldInput" colspan="3"><input type="text" name="公墓申建业务编码" field="cemeApplyId" dataset="fisCemeApplyInfoDataSet" style="width: 300" readonly="readonly"/></td>
		</tr>		

						<tr>
							<td class="FieldLabel" >公墓记录编码：</td>
							<td class="FieldInput"><label name="公墓记录编码" field="recordId" /></td>
							<td class="FieldLabel" >公墓名称</td>
							<td class="FieldInput" ><input type="text" name="公墓名称" maxlength="50" id="name" field="name"  /></td>
							<td class="FieldLabel" >公墓名称校验：</td>
							<td class="FieldInput" ><button onclick="queryName()">名称重复性校验</button></td>
						</tr>
						<tr>
							<td class="FieldLabel" >单位编号</td>
							<td class="FieldInput" ><input type="text" name="单位编号" field="organId" style="font-weight: bold;"/></td>
							<td class="FieldLabel">公墓性质</td>
							<td class="FieldInput" colspan="3" ><label name="公墓性质" field="prop" dataset="cemeProp" readonly="readonly" /></td>
						</tr>
						<tr>
							<td class="FieldLabel" >主管单位代码</td>
							<td class="FieldInput" ><input type="text" name="主管单位代码" id="manaLevelId" field="manaLevelId" readonly="readonly" maxlength="50"  /></td>
						
							<td class="FieldLabel">单位性质</td>
							<td class="FieldInput">
								<select field="properties" style="width:90%" ><option dataset="corpProperties">单位性质 </option></select></td>							</td>
							<td class="FieldLabel">组织机构代码</td>
						...
						<tr>
							...
							<td class="FieldInput" >
								<select field="domination" style="width:90%"><option dataset="dominateState" >主办级别</option></select></td>
							<td class="FieldLabel" >主管单位</td>
							<td class="FieldInput"  colspan="3"><input type="text" name="主管单位" id="manaLevel" readonly="readonly" field="manaLevel" maxlength="50" style="width:200"/></td>
						</tr>
						<tr>
							<td class="FieldLabel">主办单位</td>
							<td class="FieldInput"  ><input type="text" name="主办单位" field="organizer"  style="width:200" maxlength="25"/></td>
							<td class="FieldLabel" >主办单位性质</td>
							<td class="FieldInput" colspan="3"><input type="text"  name="主办单位性质" field="organizerProperties"/></td>
						
						</tr>
						<tr>
							<td class="FieldLabel" >联办单位</td>
							<td class="FieldInput"  ><input type="text" name="联办单位" id="coOrganizer" field=coOrganizer maxlength="50" style="width:200"/></td>
							<td class="FieldLabel" >联办单位性质</td>
							<td class="FieldInput" colspan="3">
								<input type="text" name="联办单位性质" field="coOrganizerProperties" />
							</td>
						</tr>
						<tr>
						<td class="FieldLabel">所属行政区划</td>
							<td class="FieldInput"><input type="text" id="deptName" name="所属行政区划" field="deptName" /></td>
							<td class="FieldLabel">所在地址</td>
							<td class="FieldInput"><input type="text" name="所在地址" maxlength="100" field="address" /></td>
							<td class="FieldLabel">邮政编码</td>
							<td class="FieldInput"><input type="text" name="邮政编码" maxlength="6"
								field="portCode" /></td>
						</tr>
						<tr>
							<td class="FieldLabel">法人代表</td>
							...
							<td class="FieldLabel" >联系电话</td>
							<td class="FieldInput"  colspan="3"><input type="text" name="法人代表联系电话" id="OFFICE_PHONE" field="officePhone" maxlength="50" style="width:200"/></td>
						...
						<tr>
							...
							<td class="FieldLabel">编制人数</td>
							<td class="FieldInput"><input type="text" id="numberOf" name="编制人数" maxlength="9" style="text-align:right" 
								field="numberOf" />人</td>
							<td class="FieldLabel">实有人数</td>
							<td class="FieldInput"><input type="text" id="numberReal" name="实有人数" maxlength="9" style="text-align:right" 
								field="numberReal" />人</td>
								<td class="FieldLabel" >参加民政部门业务培训人数</td>
							<td class="FieldInput" ><input type="text" name="参加民政部门业务培训人数"  style="text-align:right" id="trainNum" field="trainNum" maxlength="50" />人</td>
						...
						<td class="FieldLabel">网站网址</td>
							<td class="FieldInput">
								<input type="text" name="网站网址" maxlength="50" field="web" />
							</td>
							<td class="FieldLabel">电子邮件地址</td>
						...
						<tr>
							<!-- <td class="FieldLabel" >批准建设时间</td>
							<td class="FieldInput" ><input type="text" name="批准建设时间" id="approveTime" field="approveTime" readonly="readonly" format="Y-m-d" onclick="LoushangDate(this)" /></td>
							 -->
							<td class="FieldLabel" >计划使用年限至</td>
							<td class="FieldInput"  colspan="5"><input type="text" name="计划使用年限至" id="yearPlanto" field="yearPlanto" maxlength="4" /></td>
						</tr>
						<tr>
						<td class="FieldLabel" >占用土地性质</td>
							<td class="FieldInput" ><input type="text" name="占用土地性质" id="LAND_PROPERTIES" field="landProperties" maxlength="50" /></td>
							
							<td class="FieldLabel">占地面积</td>
							<td class="FieldInput"><input type="text" name="占地面积" id="totalArea" maxlength="13" onchange=setGreen() style="text-align:right" 
								field="totalArea" />亩</td>
							<td class="FieldLabel">墓区建成面积</td>
							<td class="FieldInput"><input type="text" name="墓区建成面积" id="builtArea" maxlength="13" style="text-align:right" 
								field="builtArea" />亩</td>
						</tr>
						<tr>
							<td class="FieldLabel">建筑面积</td>
							<td class="FieldInput"><input type="text" name="建筑面积" id="builtTotalArea" maxlength="13" style="text-align:right" 
								field="builtTotalArea" />㎡</td>
							<td class="FieldLabel" >营业室面积</td>
							<td class="FieldInput" ><input type="text" name="营业室面积" id="businessArea" field="businessArea"  style="text-align:right"   maxlength="10" />㎡</td>
							<td class="FieldLabel" >档案室面积</td>
							<td class="FieldInput" ><input type="text" name="档案室面积" id="filesroomArea" field="filesroomArea"   style="text-align:right"  maxlength="10" />㎡</td>
						</tr>
						<tr>
							<td class="FieldLabel" >办公室面积</td>
							<td class="FieldInput" ><input type="text" name="办公室面积（㎡）" id="officeromAinput" type="text"style="text-align:right"   field="officeromArea" maxlength="10" />㎡</td>
							<td class="FieldLabel" >绿地面积</td>
							<td class="FieldInput" ><input type="text" name="绿地面积（㎡）" id="greenArea" style="text-align:right" onchange=setGreen()  field="greenArea" maxlength="10" />㎡</td>
							<td class="FieldLabel" >绿化覆盖率</td>
							<td class="FieldInput" ><input type="text" name="绿化覆盖率(%)" id="greenRatio" style="text-align:right"   field="greenRatio" maxlength="10" readonly="readonly" />%</td>
						</tr>
						
						<tr>
							<td class="FieldLabel">总投资额</td>
							<td class="FieldInput"><input type="text" name="总投资额" id="totalInvestment" maxlength="13" style="text-align:right" 
								field="totalInvestment" />万元</td>
						
							<td class="FieldLabel">固定资产</td>
							<td class="FieldInput"  colspan="3"><input type="text" name="固定资产" id="fixedAssets" maxlength="10" style="text-align:right" 
								field="fixedAssets"/>万元</td>
						</tr>
						<tr>
							<td class="FieldLabel" >建设资金合计</td>
							<td class="FieldInput" ><input type="text" name="建设资金合计" id="fundTotal" field="fundTotal"  style="text-align:right" maxlength="10" />万元</td>
							<td class="FieldLabel" >财政拨款</td>
							<td class="FieldInput" ><input type="text" name="财政拨款" id="fundFinance"  field="fundFinance" style="text-align:right" maxlength="10" />万元</td>
							<td class="FieldLabel" >上级部门拨款</td>
							<td class="FieldInput" ><input type="text" name="上级部门拨款" id="fundHigher"   field="fundHigher" style="text-align:right" maxlength="10" />万元</td>
						</tr>
						<tr>
							<td class="FieldLabel" >自筹</td>
							<td class="FieldInput" ><input type="text" name="自筹" id="fundSelf"   field="fundSelf" style="text-align:right" maxlength="10" />万元</td>
							<td class="FieldLabel" >福彩资助</td>
							<td class="FieldInput" ><input type="text" name="福彩资助" id="fundLottery"   field="fundLottery" style="text-align:right" maxlength="10" />万元</td>
							<td class="FieldLabel" >其他</td>
							<td class="FieldInput" ><input type="text" name="其他" id="fundOther"   field="fundOther" style="text-align:right" maxlength="10" />万元</td>
						</tr>
						<tr>	
							<td class="FieldLabel" >计划安葬墓穴数：</td>
							<td class="FieldInput" ><input type="text" name="计划安葬墓穴数" id="planSinceHoleNum" field="planSinceHoleNum" style="text-align:right" maxlength="10" />个</td>
					...
					<tr>
						...
						<td class="FieldLabel" >多穴数：</td>
						<td class="FieldInput" ><input type="text" name="多穴数" id="planMoreHole" field="planMoreHole" style="text-align:right" maxlength="10" />个</td>
					
						<td class="FieldLabel">单穴数：</td>
						<td class="FieldInput" ><input type="text" name="单穴数" id="planSingleHole" field="planSingleHole" style="text-align:right" maxlength="10" />个</td>

						<td class="FieldLabel">双穴数：</td>
						<td class="FieldInput" ><input type="text" name="双穴数" id="planDoubleHole" field="planDoubleHole" style="text-align:right" maxlength="10" />个</td>
					</tr>
					<TR>
							<td class="FieldLabel" >经营管理方式<br>(维护管理办法)</td>
							<td class="FieldInput"  colspan="5"><input type="text" name="经营管理方式（维护管理办法）" field="manageStyle" style="width: 60%;height: 80"/></td>
						</TR>
						...
						<tr>
							<td class="FieldLabel" >申建时间：</td>
							<td class="FieldInput" colspan="5"><input type="text" name="主办单位申请时间" id="applyTime" field="applyTime" format="Y-m-d"	onclick="LoushangDate(this)" readonly="readonly" style="width: 60%"/></td>
						</tr>
						<tr>
							<td class="FieldLabel">主办单位申请原因</td>
