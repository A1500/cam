...
<next:TopBar>
	...
	<next:ToolBarItem id="BQBZ" iconCls="remove" text="补齐补正" handler="boHuiBQ"/>	
...
<fieldset>
	...
	<table border="1" width="100%" height="100%">
						<tr>
							...
							<td class="FieldInput" width="16%"><label  maxlength="50" field=name></label></td>
						...
						<td class="FieldLabel" >公墓性质</td>
							...
							<td class="FieldInput" ><label id="domination" field="domination" maxlength="50" dataset="dominateState"></label></td>
						...
						<tr>
							...
							<td class="FieldInput" colspan="3"><label  id="manaLevelId" field="manaLevelId" maxlength="50" ></label></td>
						...
						<tr>
							...
							<td class="FieldInput"  ><label name="联办单位" id="coOrganizer" field=coOrganizer maxlength="50" s></label></td>
							<td class="FieldLabel" >联办单位性质</td>
							<td class="FieldInput" colspan="3"><label name="联办单位性质" field="coOrganizerProperties" ></label>
							</td>
						</tr>
						<tr>
						<td class="FieldLabel">所属行政区划</td>
							...
							<td class="FieldInput"><label name="所在地址" maxlength="100" field="address" ></label></td>
							<td class="FieldLabel">邮政编码</td>
							<td class="FieldInput"><label name="邮政编码" maxlength="6"	field="portCode" ></label></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="FieldInput"><label id="numberOf" name="编制人数" maxlength="9" style="text-align:right" field="numberOf" ></label>人</td>
							<td class="FieldLabel">实有人数</td>
							<td class="FieldInput"><label id="numberReal" name="实有人数" maxlength="9" style="text-align:right" field="numberReal" ></label>人</td>
						...
						<tr>
							...
							<td class="FieldInput">	<label name="网站网址" maxlength="50" field="web" ></label></td>
							<td class="FieldLabel">电子邮件地址</td>
							<td class="FieldInput" ><label name="电子邮件地址" maxlength="50" field="email" ></label></td>
							<td class="FieldLabel">服务电话</td>
							<td class="FieldInput"><label name="服务电话" maxlength="16" field="servicePhone" ></label></td>
						</tr>
						<tr>
						...
						<td class="FieldLabel" >占用土地性质</td>
							...
							<td class="FieldInput"><label name="占地面积" id="totalArea" maxlength="13" style="text-align:right" field="totalArea" ></label>亩</td>
							<td class="FieldLabel">墓区建成面积</td>
							<td class="FieldInput"><label name="墓区建成面积" id="builtArea" maxlength="13" style="text-align:right" field="builtArea" ></label>亩</td>
						</tr>
						<tr>
							<td class="FieldLabel">建筑面积</td>
							<td class="FieldInput"><label name="建筑面积" id="builtTotalArea" maxlength="13" style="text-align:right" field="builtTotalArea" />㎡</td>
						...
						<tr>
							...
							<td class="FieldInput"><label name="总投资额" id="totalInvestment" maxlength="13" style="text-align:right" field="totalInvestment" ></label>万元</td>
							<td class="FieldLabel">固定资产</td>
							<td class="FieldInput"  colspan="3"><label name="固定资产" id="fixedAssets" maxlength="10" style="text-align:right" field="fixedAssets"></label>万元</td>
						</tr>
						<tr>
						...
						<tr>	
							...
							<td class="FieldInput" ><label name="计划公益安葬数量"  field="planWelfareHoleNum" style="text-align:right" maxlength="10" ></label>个</td>
					
							<td class="FieldLabel" >计划生态安葬数量：</td>
							<td class="FieldInput" ><label name="计划生态安葬数量"  field="planEcologicalHoleNum" style="text-align:right" maxlength="10" ></label>个</td>
					
							<td class="FieldLabel" >计划格位数量：</td>
							<td class="FieldInput" ><label name="计划安放格位数量"  field="planCageHoleNum" style="text-align:right" maxlength="10" ></label>个</td>
						</tr>
						<tr>	
							<td class="FieldLabel" >计划安葬墓穴总数：</td>
							<td class="FieldInput" colspan="5"><label name="计划安葬墓穴数"  field="planSinceHoleNum" style="text-align:right" maxlength="10" ></label>个</td>
						</tr>	
						<tr>
							...
							<tr>
								...
								<td class="FieldInput" colspan="5"><label name="主办单位申请时间" id="applyTime" field="applyTime"  /></td>
							</tr>
							<tr>
								<td class="FieldLabel">主办单位申请原因</td>
								<td class="FieldInput" colspan="5"><label name="主办单位申请原因" field="note" style="height: 80"></label> </td>
							</tr>
					</table>
	...
	<table border="1" width="100%" >
						<tr>
							...
							<td class="FieldInput" ><label  name="公墓名称" maxlength="50" field="name" style="width: 200"/></td>
							<td class="FieldLabel" >单位编号</td>
							<td class="FieldInput" ><label name="单位编号"  field="organId" style="font-weight: bold;"/></td>
							<td class="FieldLabel">单位性质</td>
							<td class="FieldInput">	<select field="properties" ><option dataset="corpProperties">单位性质 </option></select></td>							</td>
						</tr>
						<tr>
							<td class="FieldLabel">公墓性质</td>
						...
						<tr>
							...
							<td class="FieldInput" ><input type="text" name="批准建设时间" id="approveTime" field="approveTime" readonly="readonly" format="Y-m-d" onclick="LoushangDate(this)" /><font color="red">*</font></td>
							 -->
							<td class="FieldLabel" >计划使用年限至</td>
							<td class="FieldInput"  colspan="3"><input type="text" name="计划使用年限至" id="yearPlanto" field="yearPlanto" maxlength="4" /><font color="red">*</font></td>
						</tr>
						<tr>
						<td class="FieldLabel" >占用土地性质</td>
...
<legend>其他部门意见</legend>
		...
		<table width="100%">
						...
						<tr>
							...
							<td class="FieldLabel" width="8%">部门审核时间</td>
							<td class="FieldInput"><label field="qitaTime" readonly="readonly" /></td>
						</tr>
						<tr>
							<td class="FieldLabel" width="8%">部门审核意见</td>
				...
				<fieldset><legend>省级审批</legend>
					<table width="100%">
						...
						<tr>
							...
							<td class="FieldInput" ><select field="thirdResult" style="width: 30%"><option dataset="agreementOpinion">县级审核结果 </option></select></td>	
						</tr>
						<tr>
...
<next:Window id="cemeWin" title="公墓申建审批意见历史记录" width="650" height="400" autoHeight="true" resizable="false" closeAction="hide" modal="true">
	...
	<next:GridPanel id="cemePanel" name="fisCemeGrid" width="98%" stripeRows="true" height="300" dataset="historyBackup" autoScroll="true" title="历史列表">
		...
		<next:Columns>
			...
			<next:Column id="cemeApplyId" header="申建业务编码" field="CEME_APPLY_ID" width="90" />
