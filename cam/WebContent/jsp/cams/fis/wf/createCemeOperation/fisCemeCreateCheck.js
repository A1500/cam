...
function queryDB(){
	...
	if(allConditon!=""){
		daiBanDataset.setParameter("mysetwhere","PROP@=:"+"2"+allConditon);
	}
	daiBanDataset.load();
}
//查看待办流程图
...
function queryyiban(){
	...
	if(allConditon!=""){
		yiBanTaskDataset.setParameter("mysetwhere","PROP@=:"+"2"+allConditon);
	}	
	yiBanTaskDataset.load();	
...
function queryEnd(){
	...
	if(allConditon!=""){
		endTaskDataset.setParameter("mysetwhere","PROP@=:"+"2"+allConditon);
	}	
	endTaskDataset.load();	
