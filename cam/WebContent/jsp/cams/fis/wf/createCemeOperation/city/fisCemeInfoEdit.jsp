...
<form id="form1" method="post" dataset="fisCemeInfoDataSet" onsubmit="return false" class="L5form">
	...
	<table border="1" width="100%" >
						<tr>
							...
							<td class="FieldInput" ><input type="text" name="公墓名称" maxlength="50" id="name" onchange=nameTest() field="name" style="width: 200"/><font color="red">*</font></td>
						...
						<tr>
							...
							<td class="FieldInput" colspan="3"><select field="properties" ><option dataset="corpProperties">单位性质 </option></select></td>							</td>
...
<next:Window id="cemeWin" title="相似公墓名称列表结果" width="650" height="400" autoHeight="true" resizable="false" closeAction="hide" modal="true">
	...
	<next:GridPanel id="cemePanel" name="fisCemeGrid" width="98%" stripeRows="true" height="300" dataset="cemeQueryDataSet" autoScroll="true" title="公墓列表">
		...
		<next:Columns>
		    ...
		    <next:RadioBoxColumn></next:RadioBoxColumn>
			<next:Column id="organId" header="公墓单位编码" field="organId" width="90" >
				<next:TextField allowBlank="false" />
			</next:Column>
			<next:Column id="name" header="公墓名称" field="name" width="90"><next:TextField  />
			</next:Column>
