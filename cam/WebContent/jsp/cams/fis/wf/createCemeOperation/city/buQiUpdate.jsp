...
<legend>市级审核意见</legend>
		...
		<table width="100%">
						<tr>
							<td class="FieldLabel" rowspan="4" width="100px;">市<br>	级<br>办<br>理</td>
							<td class="FieldLabel" width="10%">审核时间</td>
							<td class="FieldInput"><input type="text" name="市级审核时间" id="zeroTime" field="zeroTime" readonly="readonly" format="Y-m-d" /><img  src="../../../../../../skins/images/default/rl.gif" align="middle"  onclick="getTimes(this)"  > <font color="red">*</font></td>
						</tr>
						<tr>
							<td class="FieldLabel" style="width:10%" >办理单位名称：</td>
							<td class="FieldInput" ><input type="text" name="当前单位名称" id="zeroUnit" field="zeroUnit" style="width: 30%" maxlength="50" /></td>
						</tr>
						<tr>
							<td class="FieldLabel" style="width:10%">市级审核结果：</td>
							<td class="FieldInput"><select name="市级审核结果" field="zeroResult" style="width: 30%"><option dataset="agreementOpinion">市级审核结果 </option></select><font color="red">*</font></td>	
				 ...
				 <div id="shenPi" >
					...
					<table width="100%">
						...
						<tr>
							...
							<td class="FieldInput"><label field="firstTime" name="审批时间" style="width: 30%" readonly="readonly" /></td>
						</tr>
						<tr>
							...
							<td class="FieldInput"><label field="firstResult" name="审批结果" style="width: 30%" dataset="agreementOpinion" /></td>	
