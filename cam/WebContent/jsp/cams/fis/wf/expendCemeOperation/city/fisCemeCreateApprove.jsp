...
<form id="form1" method="post" dataset="fisCemeInfoDataSet" onsubmit="return false" class="L5form">
						...
						<tr>
							...
							<td class="FieldInput"  ><label name="公墓名称" maxlength="50" field=name></label></td>
							<td class="FieldLabel" >单位编号</td>
							<td class="FieldInput"><label  field="organId" style="font-weight: bold;"></label></td>
							<td class="FieldLabel">单位性质</td>	
							<td class="FieldInput"><label name="单位性质" field="properties" dataset="corpProperties"></label></td>
					...
					<form id="form2" method="post" dataset="fisCemeExpendInfoDataSet" onsubmit="return false" class="L5form">
						...
						<tr>
							...
							<td class="FieldLabel" width="15%">新增公墓计划使用年限至</td>
						...
						<tr>
							<td class="FieldLabel" width="15%" >占用土地性质 </td>
							<td class="FieldInput" ><label name="占用土地性质" id="LAND_PROPERTIES" field="landProperties" maxlength="50" /> </td>
							
							<td class="FieldLabel" width="15%">占地面积</td>
							<td class="FieldInput"><label name="占地面积" id="totalArea" maxlength="13" style="text-align:right" 
								field="totalArea" ></label>亩 </td>
							<td class="FieldLabel" width="15%">墓区建成面积</td>
...
<next:Window id="cemeWin" title="公墓扩建审批意见历史记录" width="650" height="400" autoHeight="true" resizable="false" closeAction="hide" modal="true">
	...
	<next:GridPanel id="cemePanel" name="fisCemeGrid" width="98%" stripeRows="true" height="300" dataset="historyBackup" autoScroll="true" title="历史列表">
		...
		<next:Columns>
			...
			<next:Column id="cemeApplyId" header="扩建业务编码" field="cemeApplyId" width="90" />
