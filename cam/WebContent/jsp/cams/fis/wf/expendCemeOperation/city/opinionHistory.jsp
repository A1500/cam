...
<next:GridPanel id="cemePanel" name="fisCemeGrid" width="98%" stripeRows="true" height="300" dataset="hisDs" autoScroll="true" title="历史列表">
		...
		<next:Columns>
			...
			<next:Column id="cemeApplyId" header="扩建业务编码" field="CEME_APPLY_ID" width="120" />
...
<next:Window id="cemeWin" title="公墓扩建审批意见历史记录" width="800" height="500" autoHeight="true" resizable="false" closeAction="hide" modal="true">
