...
function queryDB(){
	...
	if(allConditon!=""){
		daiBanDataset.setParameter("mysetwhere","E.PROP@=:"+"2"+allConditon);
	}
	daiBanDataset.load();
...
function queryyiban(){
	...
	if(organizer!=""){
		allConditon+="&A.ORGANIZER@LIKE:%"+organizer+"%";
	}
	if(domination!=""){
		allConditon+="&A.DOMINATION@LIKE:%"+domination+"%";
	}
	if(applyTime!=""){
		allConditon+="&E.APPLY_TIME@LIKE:%"+applyTime+"%";
	}
	if(allConditon!=""){
		yiBanTaskDataset.setParameter("mysetwhere","E.PROP@=:"+"2"+allConditon);
	}
	yiBanTaskDataset.load();	
...
function queryEnd(){
	...
	if(allConditon!=""){
		endTaskDataset.setParameter("mysetwhere","E.PROP@=:"+"2"+allConditon);
	}
	endTaskDataset.load();	
...
function showCemeInfoYB(){
	...
	var url="jsp/cams/fis/wf/expendCemeOperation/city/fisCemeInfoDetail.jsp";
	L5.forward(url,'',data);
