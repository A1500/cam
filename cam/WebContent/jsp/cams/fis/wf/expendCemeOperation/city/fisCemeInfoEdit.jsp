	...
	<next:Html>
					...
					<form id="form2" method="post" dataset="fisCemeExpendInfoDataSet" onsubmit="return false" class="L5form">
						...
						<tr>
							...
							<td class="FieldInput"  ><input type="text" name="新增公墓计划使用年限至" id="yearPlanto" field="yearPlanto" maxlength="4" /><font color="red">*</font></td>
							<td class="FieldLabel">所在地址</td>
						...
						<td class="FieldLabel" width="16%">占用土地性质</td>
							<td class="FieldInput" width="16%"><input type="text" name="占用土地性质" id="landProperties" field="landProperties" maxlength="50" /><font color="red">*</font></td>
							
							<td class="FieldLabel" width="16%">占地面积</td>
							<td class="FieldInput" width="16%"><input type="text" name="占地面积" id="totalArea" maxlength="13" style="text-align:right" field="totalArea" />亩<font color="red">*</font></td>
							<td class="FieldLabel" width="16%">墓区建成面积</td>
							<td class="FieldInput" width="16%"><input type="text" name="墓区建成面积" id="builtArea" maxlength="13" style="text-align:right" field="builtArea" />亩<font color="red">*</font></td>
						</tr>
						<tr>
...
<next:Panel title="外管单位意见" width="100%" autoScroll="true">
<next:Html>
...
<legend>市级受理意见</legend>
		...
		<table width="100%">
						...
						<tr>
							...
							<td class="FieldInput"><select name="市级受理结果" field="zeroResult" style="width: 30%"><option dataset="agreementOpinion">市级审核结果 </option></select><font color="red">*</font></td>	
												
						</tr>
						<tr>
							<td class="FieldLabel" width="10%">受理意见</td>
							<td class="FieldInput" colspan="3"><textarea  onpropertychange="if(value.length>1000) value=value.substr(0,1000)"   rows="10"
								name="受理意见" id="zeroOpinion" field="zeroOpinion" maxlength="1500"
								style="width: 80%"> </textarea><font color="red">*可输入1000字</font></td>
						</tr>
					</table>
