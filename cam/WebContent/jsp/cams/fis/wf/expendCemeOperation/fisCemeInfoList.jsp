...
<model:datasets>
	<model:dataset id="fisCemeApplyInfoDataSet" cmd="com.inspur.cams.fis.base.cmd.FisCemeApplyInfoQueryCmd"  method="queryExpend" pageSize="10">
	...
	<model:dataset id="ReportStateNew" enumName="FIS.CEMECREATE.REPORT.STATUS" autoLoad="true" global="true">
		...
		<next:Panel title="公墓扩建受理任务查询" width="100%" border="0" autoHeight="true" titleCollapse="true" collapsible="true" >
			<next:TopBar>
		...
		<next:EditGridPanel title="公墓扩建受理任务列表" id="grid" dataset="fisCemeApplyInfoDataSet" width="100%" stripeRows="true" height="99.9%">
			<next:TopBar>
				<next:ToolBarItem symbol="->"></next:ToolBarItem>
				<next:ToolBarItem iconCls="add" id="add" text="增加" handler="insert" id="insert"></next:ToolBarItem>
