...
<%
	...
	String title="享受惠民政策分地区统计_"+date;
	//out.clear();//清空缓存的内容
	//out = pageContext.pushBody(); 
%>
<!--导出Excel-->
<Excel:tablelist filename="<%=title%>">
	<Excel:table sheetname="享受惠民政策分地区统计" border="1">
		<Excel:tr>
			<Excel:td colspan="17" align="center" border="0"><Excel:font size="15">享受惠民政策分地区统计</Excel:font></Excel:td>
		</Excel:tr>
		<Excel:tr border="0">
