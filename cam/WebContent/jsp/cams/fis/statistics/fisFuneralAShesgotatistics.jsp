...
<script type="text/javascript" src="fisFuneralAShesgotatistics.js"></script>
...
<model:datasets>
	...
	<model:dataset id="ds"
		...
		method="queryDeathAshesgoInfoSumByUnit" pageAble="flase">
	</model:dataset>
</model:datasets>
	...
	<next:Html>
		...
		<div align="center" style="width: 950px;">
			<div align="center"><span id="reportTitle"
				style="font-size: large;">骨灰去向统计表</span></div>
		</div>
		...
		<table style="border-style: hidden; width: 950px;" class="table2"
			...
			<table width="950px" class="table2" dataset="ds" align="center">
				<tr class="tr2">
					<td class="tdTitle" align="center" rowspan="2">单位</td>
					<td class="tdTitle" align="center" rowspan="2">总数</td>
					<td class="tdTitle" align="center" colspan="9">骨灰去向</td>
				</tr>
				<tr class="tr2">
					<td class="tdTitle" align="center">户口所在地公益<BR />性公墓安葬（放）</td>
					<td class="tdTitle" align="center">非户口所在地公益<BR />性公墓安葬（放）</td>
					<td class="tdTitle" align="center">户口所在地经营<BR />性公墓安葬（放）</td>
					<td class="tdTitle" align="center">非户口所在地经营<BR />性公墓安葬（放）</td>
					<td class="tdTitle" align="center">自有坟地<BR />安葬（放）</td>
					<td class="tdTitle" align="center">殡仪馆<BR />骨灰寄存</td>
					<td class="tdTitle" align="center">骨灰撒散</td>
					<td class="tdTitle" align="center">不要骨灰</td>
				...
				<tr repeat="true" class="tr2" >
					...
					<td class="td2"  align="right"><label field="ASHES01"
						size="20" onclick="forDetail(this.parentNode.parentNode,'ASHES01')"/></td>
					<td class="td2"  align="right"><label field="ASHES02"
						size="20" onclick="forDetail(this.parentNode.parentNode,'ASHES02')"/></td>
						
					<td class="td2"  align="right"><label field="ASHES03"
						size="20" onclick="forDetail(this.parentNode.parentNode,'ASHES03')"/></td>
					<td class="td2"  align="right"><label field="ASHES04"
						size="20" onclick="forDetail(this.parentNode.parentNode,'ASHES04')"/></td>
						
					<td class="td2"  align="right"><label field="ASHES05"
						size="20" onclick="forDetail(this.parentNode.parentNode,'ASHES05')"/></td>
					<td class="td2"  align="right"><label field="ASHES06"
						size="20" onclick="forDetail(this.parentNode.parentNode,'ASHES06')"/></td>
						
					<td class="td2"  align="right"><label field="ASHES07"
						size="20" onclick="forDetail(this.parentNode.parentNode,'ASHES07')"/></td>
					<td class="td2"  align="right"><label field="ASHES08"
						size="20" onclick="forDetail(this.parentNode.parentNode,'ASHES08')"/></td>
						
					<td class="td2"  align="right"><label field="ASHES09"
						size="20" onclick="forDetail(this.parentNode.parentNode,'ASHES09')"/></td>
				</tr>
			</table>
