...
<script type="text/javascript" src="fisFuneralDeathdiseaseAreaStatistics.js"></script>
...
<model:datasets>
	...
	<model:dataset id="fisFuneralDeadInfoDS"
		...
		method="queryDeathDiseaseInfoSumByArea" pageAble="flase">
	</model:dataset>
</model:datasets>
	...
	<next:Html>
		...
		<div align="center" style="width: 850px;">
			<div align="center"><span id="reportTitle"
				style="font-size: large;">病故病种分地区统计表</span></div>
		</div>
