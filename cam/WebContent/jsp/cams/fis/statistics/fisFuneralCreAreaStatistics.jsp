...
<script type="text/javascript" src="fisFuneralCreAreaStatistics.js"></script>
	...
	<next:Html>
		...
		<div align="center" style="width: 800px;">
			<div align="center"><span id="reportTitle"
				style="font-size: large;">火化量分地区年龄段统计表</span></div>
		</div>
		...
		<table style="border-style: hidden; width: 800px;" class="table2"
			...
			<table width="800px" class="table2" dataset="fisFuneralDeadInfoDS" align="center">
				<tr class="tr2">
					<td class="tdTitle" align="center" rowspan="3">地区</td>
					<td class="tdTitle" style="border-bottom-width: 0px" align="center" colspan="3" rowspan="2">总数</td>
					<td class="tdTitle" align="center" rowspan="3">火化率<br />(%)</td>
				...
				<tr repeat="true" class="tr2" >
					<td class="td2" width="300px" align="center"><label field="NAME"
