...
function exportExcel() {
	...
	var url = L5.webPath
			+ "/jsp/cams/fis/statistics/fisFuneralPreferentialStatisticsExcel.jsp?statisticsTime="
			+ statisticsTime;

	L5.dataset2excel(ds, "/jsp/cams/fis/statistics/fisFuneralPreferentialStatisticsExcel.jsp?statisticsTime="
			+ statisticsTime);
