...
<%
	...
	String title="火化量分殡仪馆统计表_"+date;
	//out.clear();//清空缓存的内容
	//out = pageContext.pushBody(); 
%>
<!--导出Excel-->
<Excel:tablelist filename="<%=title%>">
	<Excel:table sheetname="火化量分殡仪馆统计表" border="1">
		<Excel:tr>
			<Excel:td colspan="17" align="center" border="0"><Excel:font size="15">火化量分殡仪馆统计表</Excel:font></Excel:td>
		</Excel:tr>
		<Excel:tr border="0">
