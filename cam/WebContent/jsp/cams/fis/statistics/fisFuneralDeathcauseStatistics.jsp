...
<script type="text/javascript" src="fisFuneralDeathcauseStatistics.js"></script>
...
<model:datasets>
	...
	<model:dataset id="fisFuneralDeadInfoDS"
		...
		method="queryDeathCauseInfoSumByUnit" pageAble="flase">
	</model:dataset>
</model:datasets>
	...
	<next:Html>
		...
		<div align="center" style="width: 800px;">
			<div align="center"><span id="reportTitle"
				style="font-size: large;">死亡原因分殡仪馆统计表</span></div>
		</div>
