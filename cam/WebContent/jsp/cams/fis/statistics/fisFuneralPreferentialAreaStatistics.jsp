...
<script type="text/javascript" src="fisFuneralPreferentialAreaStatistics.js"></script>
...
<model:datasets>
	...
	<model:dataset id="fisFuneralDeadInfoDS"
		...
		method="queryDeathReduInfoSumByArea" pageAble="flase">
	</model:dataset>
</model:datasets>
	...
	<next:Html>
		...
		<div align="center" style="width: 950px;">
			<div align="center"><span id="reportTitle"
				style="font-size: large;">享受惠民政策分地区统计表</span></div>
		</div>
