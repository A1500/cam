...
<script type="text/javascript" src="fisFuneralDeathcauseAreaStatistics.js"></script>
...
<model:datasets>
	...
	<model:dataset id="fisFuneralDeadInfoDS"
		...
		method="queryDeathCauseInfoSumByArea" pageAble="flase">
	</model:dataset>
</model:datasets>
	...
	<next:Html>
		...
		<div align="center" style="width: 800px;">
			<div align="center"><span id="reportTitle"
				style="font-size: large;">死亡原因分地区统计表</span></div>
		</div>
		...
		<table style="border-style: hidden; width: 800px;" class="table2"
			...
			<table width="800px" class="table2" dataset="fisFuneralDeadInfoDS" align="center">
				<tr class="tr2">
					...
					<td class="tdTitle" align="center" colspan="20">死亡原因</td>
				</tr>
				<tr class="tr2">
					<td class="tdTitle" style="border-bottom-width: 0px" align="center" colspan="2">自然死亡</td>
					<td class="tdTitle" style="border-bottom-width: 0px" align="center" colspan="2">病故</td>
					<td class="tdTitle" style="border-bottom-width: 0px" align="center" colspan="2">事故</td>
					<td class="tdTitle" style="border-bottom-width: 0px" align="center" colspan="2">车祸</td>
					<td class="tdTitle" style="border-bottom-width: 0px" align="center" colspan="2">他杀</td>
					<td class="tdTitle" style="border-bottom-width: 0px" align="center" colspan="2">自杀</td>
					<td class="tdTitle" style="border-bottom-width: 0px" align="center" colspan="2">溺水</td>
					<td class="tdTitle" style="border-bottom-width: 0px" align="center" colspan="2">中毒</td>
					<td class="tdTitle" style="border-bottom-width: 0px" align="center" colspan="2">自然灾害</td>
