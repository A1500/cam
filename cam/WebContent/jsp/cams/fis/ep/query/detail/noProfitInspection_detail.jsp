...
<script type="text/javascript" src="noProfitInspection_detail.js"></script>
</head>
<body>
<next:ViewPort>
	<next:AnchorLayout>
		<next:Panel width="100%" height="99%">
			<next:TabPanel width="100%" height="100%" id="tab">
				<next:Tabs>
					...
					<next:Panel title="公墓基本信息 ">
						<next:Html>
							<iframe id="cemeteryinformation"
								src="noProfitCemeteryInfo.jsp?dataBean=<%=request.getParameter("idField")%>"
					...
					<next:Panel title="公墓年检打分情况" id="noProfit">
						<next:Html>
							<iframe id="noProfit_score"
								src="noProfit_score.jsp?dataBean=<%=request.getParameter("idField")%>"
								frameborder="no" border="0" marginwidth="0" marginheight="0"
								scrolling="no" allowtransparency="yes" width="100%" height="99%">
							</iframe>
						</next:Html>
