...
<script type="text/javascript" src="fisCemeYearlyCheckDetail.js"></script>
<script language="javascript">
		var scoreId='<%=request.getParameter("scoreId")%>';
				...
				<next:Html>
					...
					<table border="1" width="100%" height="100%">
						...
						<tr>
							...
							<td class="FieldInput" width="35%"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3"
								...
								field="businesscertificateReason" maxlength="50" readonly="readonly"></textarea></td>
						</tr>
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3"
								...
								field="businesslicenseReason" maxlength="50" readonly="readonly"></textarea></td>
						</tr>
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="税务登记证原因"
								style="width: 400px" field="taxcertificateReason" maxlength="50" id="taxcertificateReason" readonly="readonly"></textarea> </td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="收费原因"
								style="width: 400px" field="feeReason" maxlength="50" id="feeReason" readonly="readonly"></textarea> </td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3"
								...
								field="purchasegravesReason" maxlength="50" id="purchasegravesReason" readonly="readonly"></textarea></td>
						</tr>
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="服务承诺原因"
								style="width: 400px" field="pledgeReason" maxlength="50" id="pledgeReason" readonly="readonly"></textarea></td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="工作人员职责原因"
								style="width: 400px" field="staffresponsibilitiesReason" maxlength="50" id="staffresponsibilitiesReason" readonly="readonly"></textarea></td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3"
								...
								field="officeTimeReason" maxlength="50" id="officeTimeReason" readonly="readonly"></textarea></td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="全省统一证原因"
								style="width: 400px" field="provincialdocumentsReason" maxlength="50" id="provincialdocumentsReason" readonly="readonly"></textarea></td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3"
								...
								field="departmentchargesReason" maxlength="50" id="departmentchargesReason" readonly="readonly"></textarea></td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="无违法出租原因"
								style="width: 400px" field="nooffenseReason" maxlength="50" id="nooffenseReason" readonly="readonly"></textarea> </td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3"
								...
								field="propergraveReason" maxlength="50" id="propergraveReason" readonly="readonly"></textarea> </td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="统一卷盒原因"
								style="width: 400px" field="boxesandbagsReason" maxlength="50" id="boxesandbagsReason" readonly="readonly"></textarea></td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="死亡证明复印件原因"
								style="width: 400px" field="deathcertificateReason" maxlength="50" id="deathcertificateReason" readonly="readonly"></textarea></td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3"
								...
								field="ashescontractReason" maxlength="50" id="ashescontractReason" readonly="readonly"></textarea> </td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="承办人签名原因"
								style="width: 400px" field="contractorssignatureReason" maxlength="50" id="contractorssignatureReason" readonly="readonly"></textarea> </td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="承办人身份证原因"
								style="width: 400px" field="contractoridReason" maxlength="50" id="contractoridReason" readonly="readonly"></textarea> </td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="补充合同协议原因"
								style="width: 400px" field="addcontractReason" maxlength="50" id="addcontractReason" readonly="readonly"></textarea> </td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="其他材料原因"
								style="width: 400px" field="othermaterialsReason" maxlength="50" id="othermaterialsReason" readonly="readonly"></textarea> </td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="墓碑20%以下原因"
								style="width: 400px" field="tombstoneTwentyReason" maxlength="50" id="tombstoneTwentyReason" readonly="readonly"></textarea> </td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3"
								...
								field="tombstoneFiftyReason" maxlength="50" id="tombstoneFiftyReason" readonly="readonly"></textarea> </td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="墓碑50%以上原因"
								style="width: 400px" field="tombstoneoverfiftyReason" maxlength="50" id="tombstoneoverfiftyReason" readonly="readonly"></textarea> </td>
						...
						<tr>
							...
							field="operatingareaNum" id="operatingareaNum" onchange="checkAssMon(this.id)" maxlength="12" style="width: 70px"></label></td>
							<td class="FieldLabel" style="text-align: center">1</td>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="营业室面积原因"
								style="width: 400px" field="operatingareaReason" maxlength="50" id="operatingareaReason" readonly="readonly"></textarea> </td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="档案室面积原因"
								style="width: 400px" field="archivesareaReason" maxlength="50" id="archivesareaReason" readonly="readonly"></textarea> </td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="办公室面积原因"
								style="width: 400px" field="officeareaReason" maxlength="50" id="officeareaReason" readonly="readonly"></textarea> </td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="道路供水原因"
								style="width: 400px" field="roadsafetyReason" maxlength="50" id="roadsafetyReason" readonly="readonly"></textarea> </td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="文明祭奠原因"
								style="width: 400px" field="civilizationMemorialReason" maxlength="50" id="civilizationMemorialReason" readonly="readonly"></textarea> </td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="明火祭奠原因"
								style="width: 400px" field="fireMemorialReason" maxlength="50" id="fireMemorialReason" readonly="readonly"></textarea> </td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="生态原因"
								style="width: 400px" field="ecologyReason" maxlength="50" id="ecologyReason" readonly="readonly"></textarea> </td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="绿化率原因"
								style="width: 400px" field="greenCoverageReason" maxlength="50" id="greenCoverageReason" readonly="readonly"></textarea> </td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="绿地面积比率原因"
								style="width: 400px" field="greenareaRatioReason" maxlength="50" id="greenareaRatioReason" readonly="readonly"></textarea> </td>
						...
						<tr>
							...
							<td class="FieldInput"><textarea  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="信息化原因"
								style="width: 400px" field="informationReason" maxlength="50" id="informationReason" readonly="readonly"></textarea> </td>
						</tr>
					</table>
					</fieldset>
					</form>
					<form id="form1" method="post" dataset="scoreDataSet" onsubmit="return false" class="L5form">
						<fieldset><legend>年检报告</legend>
						    <table border="1" width="100%" height="100%">
						        <tr>
						           <td class='FieldLabel' style="width:10%">本年安葬墓穴数</td>
						           <td class='FieldInput'><label id="yearSinceHoleNum" field="yearSinceHoleNum"></label>个</td>
						           <td class='FieldLabel' style="width:10%">累计安葬墓穴数</td>
						           <td class='FieldInput'><label id="totalSinceHoleNum" field="totalSinceHoleNum"></label>个</td>
						        </tr>
						        <tr>
						           <td class='FieldLabel' style="width:10%">本年存放骨灰</td>
						           <td class='FieldInput'><label id="yearBoneAshNum" field="yearBoneAshNum"></label>个</td>
						           <td class='FieldLabel' style="width:10%">累计存放骨灰</td>
						           <td class='FieldInput'><label id="totalBoneAshNum" field="totalBoneAshNum"></label>个</td>
						        </tr>
						        <tr>
						           <td class='FieldLabel' style="width:10%">本年缴纳维护费</td>
						           <td class='FieldInput' colspan="3"><label id="yearMaintenanceFee" field="yearMaintenanceFee"></label>万元</td>
						        </tr>
						        <tr>
						           <td class='FieldLabel' style="width:10%">本年安葬超标墓穴数</td>
						           <td class='FieldInput'><label id="yearOverproofHoleNum" field="yearOverproofHoleNum"></label>个</td>
						           <td class='FieldLabel' style="width:10%">有无炒买炒卖行为</td>
						           <td class='FieldInput'>
						               <label id="isSpeculation" field="isSpeculation" dataset="yesOrnoDs"/>
						           </td>
						        </tr>
						    </table>
						</fieldset>
				...
				<next:Html>
					...
					<table width="100%">
						<tr>
							...
							<td class="FieldInput" colspan="3" width="69%"><label  style="text-align:right"
								type="text" name="县级总得分" field="firstTotalScore" id="xjScore"/></td>
						</tr>
						<tr>
							<td class="FieldLabel" rowspan="2" width="100px;">检<br>
							查</td>
							<td class="FieldLabel" width="8%">县级检查时间</td>
							<td class="FieldInput"><label type="text" name="检查时间"
								id="firstTime" field="firstTime" readonly="readonly" /></td>
							<td class="FieldLabel">县级年检结果</td>
							<td class="FieldInput"><select  name="年检结果"
								field="firstResult" disabled="disabled">
					...
					<table width="100%">
						<tr>
							<td class="FieldLabel" width="31%" colspan="2">市级总得分:</td>
							<td class="FieldInput" colspan="3" width="69%"><label  style="text-align:right"
								type="text" name="总得分" field="secondTotalScore"/></td>
						</tr>
						<tr>
							...
							<td class="FieldInput"><label type="text" name="年检时间"
								field="secondTime" readonly="readonly" /></td>
							<td class="FieldLabel">市级年检结果</td>
							<td class="FieldInput"><select  name="年检结果"
								field="secondResult" disabled="disabled">
						...
						<tr>
							...
							<td class="FieldInput" colspan="3"><textarea  onpropertychange="if(value.length>250) value=value.substr(0,250)"   rows="20" maxlength="49"
								style="width: 80%" name="年检报告" field="secondAnnuareport" id="annuareport" readonly="readonly"></textarea></td>
						</tr>
...
<!-- 下载附件列表  -->
<next:Window id="uploadList" closeAction="hide" title="附件查看"
