...
<script type="text/javascript" src="cemeNoprofitInspectionDetail.js"></script>
<script>
							...
							<table width="100%">
								<tr>
									...
									<td class="FieldInput"><label name="主管单位" id="manaLevel"
										field="manaLevel" readonly="readonly" /> <label 
								...
								<tr>
									...
									<td class="FieldInput"><label  name="公墓占地面积" renderer="muRender"
										style="text-align: right" field="totalArea" id="totalArea"
										 maxlength="10" /><!--&nbsp;&nbsp;<select name="公墓占地面积计量单位" id="totalAreaUnits"
								...
								<tr>
									...
									<td class="FieldInput" colspan="5"><textarea readonly="readonly" rows="3"
						...
						<next:Html>
							...
							<table width="100%">
								...
								<tr>
									...
									<td class="FieldInput"><label  name="单穴安葬数(本年)" style="text-align:right"
									...
									<td class="FieldInput" ><label  name="双穴安葬数(本年)" style="text-align:right" onblur="getNum()"
										field="yearDoubleHole" id="yearDoubleHole"
										onchange="checkNum(this.id)" maxlength="10" style="width: 80px" /></td>
									<td class="FieldLabel" style="width: 15%">多穴:</td>
									<td class="FieldInput"><label  name="多穴安葬数(本年)" style="text-align:right" onblur="getNum()"
										field="yearMoreHole" id="yearMoreHole"
										onchange="checkNum(this.id)" maxlength="10" style="width: 80px"/></td>
								    <td class="FieldLabel" style="width: 15%">合计:</td>
									<td class="FieldInput"><label  name="本年安葬墓穴数合计" style="text-align:right"
								...
								<tr>
									...
									<td class="FieldLabel" style="width: 15%">单穴:</td>
									<td class="FieldInput"><label  name="单穴迁出数(本年)" style="text-align:right" onblur="getNum()"
										field="outSingleHole" id="outSingleHole"  maxlength="10" onchange="checkNum(this.id)" style="width: 80px"/></td>
									<td class="FieldLabel" style="width: 15%">双穴:</td>
									<td class="FieldInput"><label  name="双穴迁出数(本年)" style="text-align:right" onblur="getNum()"
										field="outDoubleHole" id="outDoubleHole"  maxlength="10" onchange="checkNum(this.id)" style="width: 80px"/></td>
									<td class="FieldLabel" style="width: 15%">多穴:</td>
									<td class="FieldInput"><label  name="多穴迁出数(本年)" style="text-align:right" onblur="getNum()"
										field="outMoreHole" id="outMoreHole"  maxlength="10" onchange="checkNum(this.id)" style="width: 80px"/></td>
								    <td class="FieldLabel" style="width: 15%">合计:</td>
									<td class="FieldInput"><label  name="本年迁出墓穴数合计" style="text-align:right" 
								...
								<tr>
									...
									<td class="FieldLabel" style="width: 15%">单穴:</td>
									<td class="FieldInput"><label  name="单穴安葬数(自使用至今)" style="text-align:right" onblur="getNum()"
										field="singleHole" id="singleHole"
										onchange="checkNum(this.id)" maxlength="10" style="width: 80px"/></td>
									<td class="FieldLabel" style="width: 15%">双穴:</td>
									<td class="FieldInput"><label  name="双穴安葬数(自使用至今)" style="text-align:right" onblur="getNum()"
										field="doubleHole" id="doubleHole"
										onchange="checkNum(this.id)" maxlength="10"  style="width: 80px"/></td>
									<td class="FieldLabel" style="width: 15%">多穴:</td>
									<td class="FieldInput"><label  name="多穴安葬数(自使用至今)" style="text-align:right" onblur="getNum()"
										field="moreHole" id="moreHole" onchange="checkNum(this.id)"
										maxlength="10"  style="width: 80px"/></td>
									<td class="FieldLabel" style="width: 15%">合计:</td>
									<td class="FieldInput"><label  name="自使用至今安葬穴位数合计" style="text-align:right"
						...
						<next:Html>
							...
							<table width="100%">
								...
								<tr>
									...
									<td class="FieldInput"><label  name="服务承诺得分"
								...
								<tr>
									...
									<td class="FieldLabel" style="text-align: center">1</td>
									<td class="FieldInput"><label  style="text-align:right"
								...
								<tr>
									...
									<td class="FieldLabel"><label  name="墓穴面积或墓碑高度超过规定标准20%以下的个数" style="text-align:right"
								...
								<tr>
									...
									<td class="FieldLabel"><label  name="墓穴面积或墓碑高度超过规定标准20%至50%的个数" style="text-align:right"
								...
								<tr>
									...
									<td class="FieldLabel"><label  name="墓穴面积或墓碑高度超过规定标准50%以上的个数" style="text-align:right"
								...
								<tr>
									...
									<td class="FieldLabel"><label  name="生态（卧碑、树葬、花葬、草坪葬、艺术葬等）墓穴占墓穴总数的比例" style="text-align:right"
								...
								<tr>
									...
									<td class="FieldLabel"><label  name="绿化覆盖率" style="text-align:right"
									field="greenCoverageNum" id="greenCoverageNum" onchange="checkAssMon(this.id)" maxlength="7" style="width: 70px"/>
									<td class="FieldLabel" style="text-align: center">5</td>
									<td class="FieldInput"><label  name="绿化覆盖率得分" style="text-align:right"
										field="greenCoverageScore" id="greenCoverageScore" style="width: 50px"
										onchange="checkNum(this.id)" maxlength="5" /> </td>
									<td class="FieldInput"><textarea readonly="readonly" onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="绿化覆盖率原因"
								...
								<tr>
									...
									<td class="FieldLabel"><label  name="绿地面积和占总面积的比例" style="text-align:right"
						...
						<next:Html>
							...
							<table width="100%" align="center">
								<tr>
									...
									<td class="FieldInput" colspan="3" width="76%"><label style="text-align:right"
										 readonly="readonly" name="总得分" field="totalScore" maxlength="6" /></td>
								</tr>
							</table>
							</fieldset>
							...
							<table width="100%">
								<tr>
									...
									<td class="FieldInput"><label  name="年检时间" 
									...
									<td class="FieldInput"><label name="年检结果"
										field="secondResult" dataset="inspectionDataSet"></label>
										</td>
								</tr>
							<%if("1".equals(checkNum)){ %>
								<tr>
									<td class="FieldLabel" width="100px;">年检报告:</td>
									<td class="FieldInput" colspan="3">
									<textarea readonly="readonly"  rows="30" 
										style="width: 80%" name="年检报告" field="firstOpinion" id="annuareport"></textarea>
									</td>
								</tr>
							<%}else if("2".equals(checkNum)){ %>
								<tr>
									<td class="FieldLabel" width="100px;">年检报告:</td>
									<td class="FieldInput" colspan="3">
									<textarea readonly="readonly"  rows="30" 
										style="width: 80%" name="年检报告" field="annuareport" id="annuareport"></textarea>	
