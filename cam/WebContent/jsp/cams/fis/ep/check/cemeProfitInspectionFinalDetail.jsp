...
<script type="text/javascript" src="cemeProfitInspectionFinalDetail.js"></script>
<script>
...
<!--公墓基本信息-->
	<model:dataset id="infoDataSet"
		...
		<model:record
			...
			<model:field name="unitProperties" type="string" rule="require" />
			...
			<model:field name="landProp" type="string" rule="require" />
			<model:field name="landUseForm" type="string" rule="require" />
			<model:field name="landUse" type="string" rule="require" />
			...
			<model:field name="builtAreaUnits" type="string" rule="require" />
...
<!--公墓工作流信息-->
	<model:dataset id="wfDs"
		...
		<model:params>
			<model:param name="CEME_ID" value='cemeId'></model:param>
		</model:params>
	</model:dataset>
<!--公墓审批事项-->
						...
						<next:Html>
							...
							<table width="100%">
								...
								<tr>
									...
									<td class="FieldInput"><label type="text" name="法人代表"
								...
								<tr>
									...
									<td class="FieldInput"><label type="text"
										...
										id="totalArea" renderer="muRender" maxlength="12" /><!--
									...
									<td class="FieldInput"><label type="text"
										...
										id="builtArea" renderer="muRender" maxlength="12" /><!--
								...
								<tr>
									...
									<td class="FieldInput"><label type="text"
										...
										id="builtTotalArea" renderer="aRender"
										maxlength="12" /></td>
								...
								<tr>
									...
									<td class="FieldInput" colspan="5"><textarea readonly="readonly"
				...
				<next:GridPanel title="政府部门批准文号" id="govAppGridPanel"
					...
					<next:BottomBar>
						...
						<next:Html>
							...
							<table width="100%">
								<tr>
									...
									<td class="FieldInput" colspan="3" style="width: 19%"><label type="text" name="本年安葬总人数" style="text-align:right"
									...
									<td class="FieldInput" colspan="3" style="width: 35%"><label type="text" style="text-align:right"
								...
								<tr>
									...
									<td class="FieldInput"><label type="text" name="单穴销售数(本年)" style="text-align:right" onblur="getNum()"
									...
									<td class="FieldInput"><label type="text" name="双穴销售数(本年)" style="text-align:right" onblur="getNum()"
									...
									<td class="FieldInput"><label type="text" name="多穴销售数(本年)" style="text-align:right" onblur="getNum()"
									...
									<td class="FieldInput"><label type="text" name="本年销售墓穴数合计" style="text-align:right" onblur="getNum()"
								...
								<tr>
									...
									<td class="FieldLabel" style="width: 15%">单穴:</td>
									<td class="FieldInput"><label type="text" name="单穴安葬数(本年)" style="text-align:right" onblur="getNum()"
										field="yearSingleHole" id="yearSingleHole"  maxlength="10" onchange="checkNum(this.id)" style="width: 80px"/></td>
									<td class="FieldLabel" style="width: 15%">双穴:</td>
									<td class="FieldInput"><label type="text" name="双穴安葬数(本年)" style="text-align:right" onblur="getNum()"
										field="yearDoubleHole" id="yearDoubleHole"  maxlength="10" onchange="checkNum(this.id)" style="width: 80px"/></td>
									<td class="FieldLabel" style="width: 15%">多穴:</td>
									<td class="FieldInput"><label type="text" name="多穴安葬数(本年)" style="text-align:right" onblur="getNum()"
								...
								<tr>
									...
									<td class="FieldLabel" style="width: 15%">单穴:</td>
									<td class="FieldInput"><label type="text" name="单穴迁出数(本年)" style="text-align:right" onblur="getNum()"
										field="outSingleHole" id="outSingleHole"  maxlength="10" onchange="checkNum(this.id)" style="width: 80px"/></td>
									<td class="FieldLabel" style="width: 15%">双穴:</td>
									<td class="FieldInput"><label type="text" name="双穴迁出数(本年)" style="text-align:right" onblur="getNum()"
										field="outDoubleHole" id="outDoubleHole"  maxlength="10" onchange="checkNum(this.id)" style="width: 80px"/></td>
									<td class="FieldLabel" style="width: 15%">多穴:</td>
									<td class="FieldInput"><label type="text" name="多穴迁出数(本年)" style="text-align:right" onblur="getNum()"
								...
								<tr>
									...
									<td class="FieldLabel" style="width: 15%">单穴:</td>
									<td class="FieldInput"><label type="text" name="单穴安葬数(自开业至今)" style="text-align:right" onblur="getNum()"
										field="singleHole" id="singleHole"
										 maxlength="10" onchange="checkNum(this.id)" style="width: 80px"/></td>
									<td class="FieldLabel" style="width: 15%">双穴:</td>
									<td class="FieldInput"><label type="text" name="双穴安葬数(自开业至今)" style="text-align:right" onblur="getNum()"
										field="doubleHole" id="doubleHole"
										 maxlength="10" onchange="checkNum(this.id)" style="width: 80px"/></td>
									<td class="FieldLabel" style="width: 15%">多穴:</td>
									<td class="FieldInput"><label type="text" name="多穴安葬数(自开业至今)" style="text-align:right" onblur="getNum()"
										field="moreHole" id="moreHole" 
										maxlength="10" onchange="checkNum(this.id)" style="width: 80px"/></td>
									<td class="FieldLabel" style="width: 15%">合计:</td>
									<td class="FieldInput"><label type="text" name="自开业至今安葬穴位数合计" style="text-align:right"
						...
						<next:Html>
							...
							<table width="100%">
								<tr>
									<td class="FieldInput" colspan="5"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="5" maxlength="49"
						...
						<next:Html>
							...
							<table width="100%">
								...
								<tr>
									...
									<td class="FieldInput" width="35%"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3"
								...
								<tr>
									...
									<td class="FieldInput" ><label type="text"
										...
										maxlength="5"  onchange="checkNum(this.id)"/></td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3"
								...
								<tr>
									...
									<td class="FieldInput" ><label type="text" name="税务登记证得分" style="text-align:right"
										field="taxcertificateScore" id="taxcertificateScore"  style="width: 50px"
										 maxlength="5"  onchange="checkNum(this.id)"/></td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="税务登记证原因"
								...
								<tr>
									...
									<td class="FieldInput" ><label type="text" name="收费得分" style="text-align:right"
										...
										maxlength="5"  onchange="checkNum(this.id)"/></td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="收费原因"
								...
								<tr>
									...
									<td class="FieldInput" ><label type="text" name="服务承诺得分" style="text-align:right"
										field="pledgeScore" id="pledgeScore"  style="width: 50px"
										 maxlength="5"  onchange="checkNum(this.id)"/> </td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="服务承诺原因"
								...
								<tr>
									...
									<td class="FieldInput" ><label type="text" name="工作人员职责及照片、编号得分" style="text-align:right"
										...
										id="staffresponsibilitiesScore"  style="width: 50px"
										 maxlength="5"  onchange="checkNum(this.id)"/></td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="工作人员职责原因"
								...
								<tr>
									...
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="全省统一证原因"
								...
								<tr>
									...
									<td class="FieldLabel" style="text-align: center">2</td>
									<td class="FieldInput" ><label type="text" name="无违法出租或买卖墓穴（格位）现象得分"
										field="nooffenseScore" id="nooffenseScore"  style="width: 50px" style="text-align:right"
										 maxlength="5"  onchange="checkNum(this.id)"/></td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="无违法出租原因"
								...
								<tr>
									...
									<td class="FieldInput" ><label type="text" name="使用全省统一的卷盒和卷袋得分" style="text-align:right"
										field="boxesandbagsScore" id="boxesandbagsScore"  style="width: 50px"
										 maxlength="5"  onchange="checkNum(this.id)"/> </td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="统一卷盒原因"
								...
								<tr>
									...
									<td class="FieldInput" ><label type="text" name="有死亡证明或火化证明的复印件得分" style="text-align:right"
										field="deathcertificateScore" id="deathcertificateScore"  style="width: 50px"
										 maxlength="5"  onchange="checkNum(this.id)"/> </td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="死亡证明复印件原因"
								...
								<tr>
									...
									<td class="FieldInput" ><label type="text" name="有丧事承办人签名的骨灰安放（葬）处理表、业务流程单等得分"
										...
										maxlength="5"  onchange="checkNum(this.id)"/></td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="承办人签名原因"
								...
								<tr>
									...
									<td class="FieldInput" ><label type="text" name="有丧事承办人的有效身份证件复印件得分" style="text-align:right"
										field="contractoridScore" id="contractoridScore"  style="width: 50px"
										 maxlength="5"  onchange="checkNum(this.id)"/></td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="承办人身份证原因"
								...
								<tr>
									...
									<td class="FieldInput" ><label type="text" name="有补充签订的合同或者协议得分" style="text-align:right"
										field="addcontractScore" id="addcontractScore"  style="width: 50px"
										 maxlength="5"  onchange="checkNum(this.id)"/></td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="补充合同协议原因"
								...
								<tr>
									...
									<td class="FieldInput" ><label type="text" name="有其他应当归档的材料得分" style="text-align:right"
										field="othermaterialsScore" id="othermaterialsScore"  style="width: 50px"
										 maxlength="5"  onchange="checkNum(this.id)"/> </td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="其他材料原因"
								...
								<tr>
									...
									<td class="FieldInput" ><label type="text" name="墓穴面积或墓碑高度超过规定标准20%以下的个数得分" style="text-align:right"
										field="tombstoneTwentyScore" id="tombstoneTwentyScore"  style="width: 50px"
										 maxlength="5"  onchange="checkNum(this.id)"/></td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="墓碑20%以下原因"
								...
								<tr>
									...
									<td class="FieldInput" ><label type="text" name="墓穴面积或墓碑高度超过规定标准50%以上的个数得分" field="tombstoneoverfiftyScore"
										id="tombstoneoverfiftyScore"  maxlength="5"  style="width: 50px"  onchange="checkNum(this.id)" style="text-align:right"/></td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="墓碑50%以上原因"
								...
								<tr>
									...
									<td class="FieldInput" ><label type="text" name="营业室面积得分" style="text-align:right"
										field="operatingareaScore" id="operatingareaScore"  style="width: 50px"
										 maxlength="5"  onchange="checkNum(this.id)"/></td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="营业室面积原因"
								...
								<tr>
									...
									<td class="FieldInput" ><label type="text" name="档案室面积得分" style="text-align:right"
										field="archivesareaScore" id="archivesareaScore"  style="width: 50px"
										 maxlength="5"  onchange="checkNum(this.id)"/></td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="档案室面积原因"
								...
								<tr>
									...
									<td class="FieldInput" ><label type="text" name="办公室面积得分" style="text-align:right"
										field="officeareaScore" id="officeareaScore"  style="width: 50px"
										 maxlength="5"  onchange="checkNum(this.id)"/></td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="办公室面积原因"
								...
								<tr>
									...
									<td class="FieldLabel" style="text-align: center">3</td>
									<td class="FieldInput" ><label type="text" name="道路、供水、供电畅通，安全防护措施到位得分"
										field="roadsafetyScore" id="roadsafetyScore"  style="width: 50px" style="text-align:right"
										 maxlength="5"  onchange="checkNum(this.id)"/> </td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="道路供水原因"
								...
								<tr>
									...
									<td class="FieldInput" ><label type="text" name="有文明祭奠举措，无封建迷信活动得分" style="text-align:right"
										...
										maxlength="5"  onchange="checkNum(this.id)"/></td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="文明祭奠原因"
								...
								<tr>
									...
									<td class="FieldLabel" style="text-align: center">2</td>
									<td class="FieldInput" ><label type="text" name="允许明火祭奠的，设立固定明火祭奠设施、开设防火隔离带等措施，并经县（市、区）以上林业部门审批得分"
										field="fireMemorialScore" id="fireMemorialScore"  style="width: 50px" style="text-align:right"
										 maxlength="5"  onchange="checkNum(this.id)"/> </td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="明火祭奠原因"
								...
								<tr>
									...
									<td class="FieldInput" ><label type="text" name="生态（卧碑、树葬、花葬、草坪葬、艺术葬等）墓穴占墓穴总数的比例得分" style="text-align:right"
										field="ecologyScore" id="ecologyScore"  style="width: 50px"
										 maxlength="5"  onchange="checkNum(this.id)"/></td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="生态原因"
								...
								<tr>
									...
									<td class="FieldLabel"><label type="text" name="绿化覆盖率"
									...
									<td class="FieldInput" ><label type="text" name="绿化覆盖率得分" style="text-align:right"
										field="greenCoverageScore" id="greenCoverageScore"  style="width: 50px"
										 maxlength="5"  onchange="checkNum(this.id)"/> </td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="绿化率原因"
								...
								<tr>
									...
									<td class="FieldInput" ><label type="text" name="绿地面积和占总面积的比例得分" style="text-align:right"
										field="greenareaRatioScore" id="greenareaRatioScore"  style="width: 50px" style="text-align:right"
										 maxlength="5"  onchange="checkNum(this.id)"/> </td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="绿地面积比率原因"
								...
								<tr>
									...
									<td class="FieldLabel" style="text-align: center">1</td>
									<td class="FieldInput" ><label type="text" name="按照所购墓穴（格位）标准进行安葬或安放，无自行改建墓穴（格位）得分" style="text-align:right"
										field="burialTombScore" id="burialTombScore"  style="width: 50px"
										 maxlength="5"  onchange="checkNum(this.id)"/></td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="标准安葬墓穴原因"
								...
								<tr>
									...
									<td class="FieldInput" ><label type="text" name="墓区建设地点和规模与申报材料相符得分" style="text-align:right"
										field="burialConformScore" id="burialConformScore"  style="width: 50px"
										 maxlength="5"  onchange="checkNum(this.id)"/></td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="墓区相符原因"
								...
								<tr>
									...
									<td class="FieldLabel" style="text-align: center">6</td>
									<td class="FieldInput" ><label type="text" name="新建和扩建墓区的审批验收手续符合《山东省公墓管理办法》规定得分" style="text-align:right"
										field="acceptanceComplianceScore"  style="width: 50px"
										id="acceptanceComplianceScore" 
										maxlength="5"  onchange="checkNum(this.id)"/> </td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="手续符合规定原因"
								...
								<tr>
									...
									<td class="FieldInput" ><label type="text" name="公墓根据销售墓穴的数量和使用年限，有不低于6%的税后收入预留，有交款凭证得分" style="text-align:right"
										field="paymentCertificateScore" id="paymentCertificateScore"  style="width: 50px"
										 maxlength="5"  onchange="checkNum(this.id)" /></td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="有交款凭证原因"
								...
								<tr>
									...
									<td class="FieldLabel" style="text-align: center">1</td>
									<td class="FieldInput" ><label type="text" name="工作人员参加省或设区的市人民政府民政部门组织的业务培训得分" style="text-align:right"
										field="businessTrainingScore" id="businessTrainingScore"  style="width: 50px"
										 maxlength="5"  onchange="checkNum(this.id)"/></td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="业务培训原因"
								...
								<tr>
									...
									<td class="FieldLabel" style="text-align: center">3</td>
									<td class="FieldInput"  ><label type="text" name="公墓管理的各项规章制度健全得分" style="text-align:right"
										field="systemSoundScore" id="systemSoundScore"  style="width: 50px"
										 maxlength="5"  onchange="checkNum(this.id)"/></td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="规章制度健全原因"
								...
								<tr>
									...
									<td class="FieldInput"  ><label type="text" name="有高峰应急预案得分" style="text-align:right"
										field="contingencyPlansScore" id="contingencyPlansScore"  style="width: 50px"
										 maxlength="5"  onchange="checkNum(this.id)"/></td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="应急预案原因"
								...
								<tr>
									...
									<td class="FieldInput" ><label type="text" name="实行信息化管理，使用省厅研制的软件信息系统得分" style="text-align:right"
										field="informationScore" id="informationScore"  style="width: 50px"
										 maxlength="5"  onchange="checkNum(this.id)"/></td>
									<td class="FieldInput"><textarea readonly="readonly"  onpropertychange="if(value.length>49) value=value.substr(0,49)"   rows="3" name="信息化原因"
						...
						<next:Html>
							...
							<table width="100%" align="center">
								<tr>
									...
									<td class="FieldInput" colspan="3" width="77%"><label  style="text-align:right"
							...
							<table width="100%">
								...
								<tr>
									...
									<td class="FieldInput" colspan="3"><textarea readonly="readonly"  rows="30"
										name="检查意见" id="firstOpinion" field="firstOpinion" 
										style="width: 80%"  disabled="disabled"> </textarea></td>
								</tr>
							</table>
							</div>
							</fieldset>
							...
							<table width="100%">
								<tr>
									...
									<td class="FieldInput"><label type="text" name="年检时间"
										field="secondTime" readonly="readonly" format="Y-m-d"
										onclick="LoushangDate(this)" /></td>
									<td class="FieldLabel">年检结果</td>
									<td class="FieldInput"><label  name="年检结果"
										field="secondResult" dataset="inspectionDataSet"></label></td>
								</tr>
								<tr>
									<td class="FieldLabel" width="100px;">年检报告:</td>
									<td class="FieldInput" colspan="3"><textarea readonly="readonly"  onpropertychange="if(value.length>240) value=value.substr(0,240)"   rows="20" 
					...
					<next:Panel title="业务材料">
						<next:EditGridPanel id="uploadGrid" width="99.9%"
							...
							<next:TopBar>
								...
								<next:ToolBarItem symbol="->"></next:ToolBarItem>
								<next:ToolBarItem iconCls="detail" text="查看下载附件" id="downFile"  handler="clickUploadFile"></next:ToolBarItem>
							</next:TopBar>
