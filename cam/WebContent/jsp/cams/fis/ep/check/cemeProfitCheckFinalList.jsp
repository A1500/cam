...
<script type="text/javascript" src="cemeProfitCheckFinalList.js"></script>
<script>
...
<!--查询需要进行年检的经营性公墓-->
	<model:dataset id="ds"
		...
		global="true" method="cemeProfitFinalCheckQuery">
	</model:dataset>
...
<next:GridPanel id="editGridPanel" name="inspectionGrid" width="99.9%"
	...
	<next:TopBar>
		<next:ToolBarItem id="cemeTitle" text="需要进行年检的经营性公墓"/>
	...
	<next:Columns>
		...
		<next:Column header="年检状态" field="CHECK_NUM" renderer="rendenerCheckNum" width="100">
			<next:TextField />
		</next:Column>
		<next:Column header="年检结果" field="CHECK_RESULT" dataset="resultDataSet" width="100">
			<next:TextField />
		</next:Column>
