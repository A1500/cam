...
<script type="text/javascript" src="cemeProfitCheckList.js"></script>
<script>
...
<!--查询需要进行年检的经营性公墓-->
	<model:dataset id="ds"
		...
		global="true" method="cemeProfitCheckQuery">
	</model:dataset>
	...
	<next:Html>
		...
		<table border="1" width="100%">
			...
			<tr>
				...
				<td class="FieldLabel">检查年份:</td>
				<td class="FieldInput"><input type="text" id="year"
					class="TextEditor" title="检查年份" value="2011" /></td>
			</tr>
			<tr>
...
<next:GridPanel id="editGridPanel" name="inspectionGrid" width="99.9%"
	...
	<next:TopBar>
		<next:ToolBarItem id="cemeTitle" text="需要进行检查的经营性公墓"/>
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
		<next:ToolBarItem text="检查办理" iconCls="detail" handler="accepted" />
		<next:ToolBarItem text="上报" iconCls="export" handler="report" />
	</next:TopBar>
	<next:Columns>
		...
		<next:Column id="cemeId" header="公墓编号" field="CEME_ID" width="110"
			hidden="false">
			<next:TextField allowBlank="false" />
		</next:Column>
		...
		<next:Column header="检查年份" field="CHECK_YEAR" width="60" align="center">
			<next:TextField />
		</next:Column>
		<next:Column header="本年度检查次数" field="CHECK_NUM" width="100" hidden="true">
			<next:TextField />
		</next:Column>
		<next:Column header="检查状态" field="CHECK_NUM" renderer="rendenerCheckNum" width="100">
			<next:TextField />
		</next:Column>
		<next:Column header="检查结果" field="CHECK_RESULT" dataset="resultDataSet" width="100" hidden="true">
			<next:TextField />
		</next:Column>
		<next:Column header="上报状态" field="IS_REPORT" dataset="fisYesOrNo" align="center">
			<next:TextField />
		</next:Column>
		<next:Column header="主管单位" field="MANA_LEVEL">
			<next:TextField />
		</next:Column>
