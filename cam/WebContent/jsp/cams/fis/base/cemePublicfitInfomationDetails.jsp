...
<script type="text/javascript">
	<%
		...
		String organID = request.getParameter("unitId");
	%>
	var method='<%=method%>';
	var organID = '<%=organID%>'
	var organId='GZ370000-00';
</script>
<script type="text/javascript" src="cemePublicfitInfomationDetails.js"></script>
<script type="text/javascript"
	...
	<next:Html>
		...
		<table border="1" width="100%" >
			...
			<tr>
				...
				<td class="FieldInput"><label type="text" id="deptName"
					name="所属行政区" maxlength="100" 
					style="width: 200" field="deptName" readonly="readonly" /><font color=red>*</font>
					<input type="hidden" id="deptCode" name="所属行政区划Code" field="deptCode" /></td>
				<td class="FieldLabel">所在位置</td>
				<td class="FieldInput"><label type="text" name="所在位置"
					maxlength="100" style="width: 200" field="address" /><font color=red>*</font></td>
			</tr>
			<tr>
				<td class="FieldLabel">正式使用时间</td>
				<td class="FieldInput"><label type="text" name="正式营业时间"
					field="gestionTime"/></td>	
				<td class="FieldLabel">计划使用年限至</td>
				<td class="FieldInput"><label type="text" name="计划使用年限至"
					id="yearPlanto" field="yearPlanto" maxlength="4" /></td>
			</tr>
			<tr>
				<td class="FieldLabel">占用土地性质</td>
				<td class="FieldInput"><label type="text" name="占用土地性质"
					id="landProperties" field="landProperties" maxlength="50" /></td>
				<td class="FieldLabel">占地面积（亩）</td>
				<td class="FieldInput"><label type="text" name="占地面积"
					id="totalArea" maxlength="13" style="text-align: right"
					field="totalArea" />亩</td>
			</tr>
			<tr>
				<td class="FieldLabel">建筑面积</td>
				<td class="FieldInput"><label type="text" name="建筑面积"
					id="builtTotalArea" maxlength="13" style="text-align: right"
					field="builtTotalArea" />㎡</td>
				<td class="FieldLabel">绿地面积</td>
				<td class="FieldInput"><label type="text" name="绿地面积（㎡）"
					id="greenArea" style="text-align: right"
					field="greenArea" maxlength="10" />㎡<font color=red>*</font></td>
			</tr>
			<tr>
				<td class="FieldLabel">绿化覆盖率</td>
				<td class="FieldInput"><label type="text" name="绿化覆盖率(%)"
				...
				<td class="FieldInput" colspan="5"><label
					name="维护管理办法" field="manageStyle" style="width: 80%; height: 60"/></td>
			</tr>
		</table>
		</form>
	</next:Html>
