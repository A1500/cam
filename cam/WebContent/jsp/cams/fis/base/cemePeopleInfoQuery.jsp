...
<model:datasets>
	...
	<model:dataset id="fisPeoInfoDS"
		...
		global="true" pageSize="15" sortField="workDate" method="queryForPeopleRecords">
					...
					<form class="L5form">
						<table width="100%" >
							<tr>
						        ...
						        <td class="FieldInput" >
						        	<input type="text" name="qIdCard" id="qIdCard"/>
						        </td>
...
<next:GridPanel id="editGridPanel" name="funeralServicePeople" stripeRows="true" 
	...
	<next:Columns>
		...
		<next:Column id="duty" header="工种(专业等级)" field="DUTY" width="280">
			<next:TextField />
		</next:Column>
		...
		<next:Column id="ifCancel" header="是否注销" field="IF_CANCEL"
			dataset="commYesOrNoDS" width="80" align="center">
			<next:TextField />
		</next:Column>
		<next:Column id="createOrganName" header="所属公墓" field="CREATE_ORGAN_NAME"
