	...
	<next:Html>
		...
		<table border="1" width="100%" height="100%">
			...
			<tr>
				...
				<td class="FieldInput" colspan="3"><input type="text" name="单位编号" field="unitId" /><font color="red">*</font></td>
			</tr>
			<tr>
				<td class="FieldLabel" width="135">服务机构名称</td>
				<td class="FieldInput"><input type="text" name="服务机构名称" maxlength="50" field="unitName" /></td>
				
				<td class="FieldLabel" width="135">注册（或登记）单位</td>
				<td class="FieldInput" ><input type="text" name="注册（或登记）单位" field="organizer" /><font color="red">*</font></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="FieldInput"><select name="properties"
					field="properties">
			...
			<tr>
				...
				<td class="FieldInput"><input type="text" name="legalPeople" maxlength="36"
					field="legalPeople" /></td>
					
				<td class="FieldLabel">法人代表联系电话</td>
				<td class="FieldInput"><input type="text" id="legalPeoplePhone" name="legalPeoplePhone"  field="legalPeoplePhone" /></td>
			</tr>
			<tr>
				<td class="FieldLabel">负责人</td>
				<td class="FieldInput"><input type="text" id="director" name="director" field="director" /></td>
					
				<td class="FieldLabel">负责人联系电话</td>
				<td class="FieldInput"><input type="text" id="directorPhone" name="directorPhone" field="directorPhone" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="FieldInput"><input type="text" name="address" maxlength="100"
					field="address" /></td>

				<td class="FieldLabel">邮政编码</td>
				<td class="FieldInput"><input type="text" name="portCode" maxlength="6"
					field="portCode" /></td>
			</tr>
			<tr>
				<td class="FieldLabel">服务电话</td>
				<td class="FieldInput"><input type="text" name="servicePhone" maxlength="16"
					field="servicePhone" /></td>

				<td class="FieldLabel">网站网址</td>
				<td class="FieldInput"><input type="text" name="web" maxlength="50" 
					field="web" /></td>
			</tr>
			<tr>
				<td class="FieldLabel">电子邮件地址</td>
				<td class="FieldInput"><input type="text" name="email" maxlength="50"
					field="email" /></td>

				<td class="FieldLabel">QQ群</td>
				<td class="FieldInput"><input type="text" name="qq" field="qq" maxlength="15"/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="FieldInput" colspan="3"><textarea rows="5" name="受表彰情况" style="width: 60%"
					onpropertychange="if(value.length>100) value=value.substr(0,100)" field="honours" ></textarea></td>
			</tr>
			<tr>
				<td class="FieldLabel">备注</td>
				<td class="FieldInput" colspan="3"><textarea name="备注" field="note" 
