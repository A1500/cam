...
<html>
	<head>
		...
		<script type="text/javascript" src="gd_info_list.js"></script>
	</head>
<body>
<model:datasets>
...
<next:GridPanel id="editGridPanel" name="disreliefinfoGrid" width="100%" clickToSelectedForChkSM="true" stripeRows="true" height="100%" dataset="ds" title="">
	<next:TopBar>
		<next:ToolBarItem text="“过渡性生活补助”列表"/>
		...
		<next:ToolBarItem text="打印救助卡" iconCls="print" id="undo" hidden="true"/>
	</next:TopBar>
	<next:Columns>
	    <next:RowNumberColumn width="30"/>
	    <next:CheckBoxColumn></next:CheckBoxColumn>
	
		<next:Column id="acceptAreaName" header="村名称" field="acceptAreaName" width="180" >
			<next:TextField  />
		</next:Column>
		...
		<next:Column id="requiredForFood" header="需口粮救助(公斤)" field="requiredForFood" width="110" align="right" renderer="formatNum">
			<next:NumberField  />
		</next:Column>
		<next:Column id="requiredForClothes" header="需衣被救助(件)" field="requiredForClothes" width="110" align="right">
			<next:TextField  />
		</next:Column>
