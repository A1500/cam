...
<script type="text/javascript" src="goodsRollDetails.js"></script>
</head>
<body>
<model:datasets>
	<!--发放流水-->
...
<next:GridPanel id="doleGrid" name="doleGrid" width="100%"
	...
	<next:TopBar>
		...
		<next:ToolBarItem text="新增" iconCls="add" handler="addInfo"/>
		<next:ToolBarItem text="修改" iconCls="edit" handler="editInfo"/>
		<next:ToolBarItem text="撤销" iconCls="delete" handler="deleteInfo"/>
