...
<next:ScriptManager />
<script type="text/javascript" src="fundsRollList.js"></script>
...
<next:GridPanel id="editGridPanel" name="disreliefinfoGrid" width="100%"
	...
	<next:TopBar>
		<next:ToolBarItem text="发放名册管理列表"></next:ToolBarItem>
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
		<next:ToolBarItem text="资金发放管理" iconCls="edit" handler="editDole" />
	</next:TopBar>
	<next:Columns>
		...
		<next:Column header="资金发放数/总发放数(次)" field="DOLE_NUMS" width="140"
