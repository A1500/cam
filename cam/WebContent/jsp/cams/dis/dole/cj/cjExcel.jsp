...
<Excel:tablelist filename="<%=name %>">
	<Excel:table sheetname="房屋重建发放名册列表">
		<Excel:tr>
			<Excel:td colspan="9" align="center" ><Excel:font size="15">房屋重建发放名册列表</Excel:font></Excel:td>
		</Excel:tr>
		<Excel:tr>
		...
		<Excel:tr height="30" bgcolor="grey" border="1">
			...
			<Excel:td  align="center" width="100" bordercolor="black">核准修缮间数(间)</Excel:td>
		...
		<Excel:tr>
			...
			<Excel:td colspan="5" align="right">制表时间：<%= date%></Excel:td>
		</Excel:tr>
	</Excel:table>
</Excel:tablelist>
