...
<script type="text/javascript" src="cardDetails.js"></script>
</head>
<body>
<model:datasets>
	<!--发放流水-->
...
<next:GridPanel id="doleGrid" name="doleGrid" width="100%"
	stripeRows="true" height="100%" dataset="disReliefDoleDs"
	notSelectFirstRow="true">
	<next:TopBar>
		<next:ToolBarItem text="发放流水列表"></next:ToolBarItem>
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
		<next:ToolBarItem text="打印救助卡" iconCls="print" handler="editInfo" />
