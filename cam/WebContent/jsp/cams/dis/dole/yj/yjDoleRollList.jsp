...
<script type="text/javascript" src="yjDoleRollList.js"></script>
</head>
<body>
<model:datasets>
	<!-- 档案信息 -->
...
<next:EditGridPanel id="yjGrid" name="yjGrid" width="100%" stripeRows="true" height="100%"
