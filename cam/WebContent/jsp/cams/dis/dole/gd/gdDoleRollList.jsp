...
<script type="text/javascript" src="gdDoleRollList.js"></script>
</head>
<body>
<model:datasets>
	<!-- 档案信息 -->
...
<next:EditGridPanel id="gdGrid" name="gdGrid" width="100%" stripeRows="true" height="100%"
