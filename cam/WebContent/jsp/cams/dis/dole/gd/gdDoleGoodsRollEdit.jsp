...
<script type="text/javascript" src="gdDoleGoodsRollEdit.js"></script>
</head>
<body>
<model:datasets>
	<!-- 批次信息 -->
...
<next:Panel width="100%" height="65%">
	...
	<next:Html>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td class="FieldLabel" style="width: 15%" nowrap>核准救助人口:</td>
				<td class="FieldInput" style="width: 35%" colspan="3"><label field="approvalFamilyNum" /></td>
			</tr>
			<tr>
				<td class="FieldLabel" style="width: 15%" nowrap>核准救助粮食（公斤）:</td>
			...
			<tr>
				<td class="FieldLabel" style="width: 15%" nowrap>核准饮水救助（元）:</td>
