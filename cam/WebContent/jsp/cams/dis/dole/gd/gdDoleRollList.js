...
function onSaveConfirm() {
	...
	var gdGrid = L5.getCmp("gdGrid");
	var infoSelected = gdGrid.getSelectionModel().getSelections();
...
function forExcel(){
	...
	L5.dataset2excel(dataset, "/jsp/cams/dis/dole/gd/gdExcel.jsp?allocationType="+allocationType);
}
// 打印救助卡
function printCard() {
}
