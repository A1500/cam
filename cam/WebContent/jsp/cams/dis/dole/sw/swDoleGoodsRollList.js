...
function confirm() {
	...
	var url = 'swDoleGoodsRollEdit.jsp?batchId=' + batchId + '&batchDetailId='
...
function detail() {
	...
	var url = 'swDoleGoodsRollEdit.jsp?ifDetail=1&batchId=' + batchId + '&batchDetailId='
			+ batchDetailId+'&infoId='+selected[0].get('infoId');
	var width = 900;
	var height = 580;
	var win = window.showModalDialog(url, window,
