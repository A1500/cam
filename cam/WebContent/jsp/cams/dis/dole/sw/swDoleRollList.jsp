...
<html>
<head>
<title>遇难人员家属生活救助-资金发放名册管理</title>
<next:ScriptManager />
...
<script type="text/javascript" src="swDoleRollList.js"></script>
</head>
<body>
<model:datasets>
	<!-- 档案信息 -->
...
<next:EditGridPanel id="swGrid" name="swGrid" width="100%" stripeRows="true" height="100%"
	...
	<next:Columns>
		...
		<next:Column id="APPROVAL_MONEY" header="核准救助金额(元)"
			field="APPROVAL_MONEY" width="120" align="right" summaryType="sum"
			renderer="formatMoneyForDis" editable="false">
			<next:ExtendConfig>
               	summaryRenderer : formatMoneyForDis
           	</next:ExtendConfig>
		</next:Column>
		<next:Column id="AMOUNT" header="<b>实际发放金额(元)</b>" field="AMOUNT"
			width="120" align="right" renderer="formatMoneyForDis"
			summaryType="sum">
			<next:ExtendConfig>
               	summaryRenderer : formatMoneyForDis
           	</next:ExtendConfig>
		...
		<next:EditGridPanel id="winGrid" dataset="disFundsBatchSourceDs"
			...
			<next:Columns>
				...
				<next:Column id="amountPay" header="<b>支出金额(万元)</b>"
					field="amountPay" align="right" width="95"
					renderer="formatMoneyForDis" summaryType="sum">
					<next:ExtendConfig>
	                    	summaryRenderer : formatMoneyForDis
	                	</next:ExtendConfig>
