...
<Excel:tablelist filename="<%=name %>">
	<Excel:table sheetname="查询列表">
		<Excel:tr>
			...
			%>
			<Excel:td colspan="3" align="center" ><Excel:font size="20">救灾情况统计表</Excel:font></Excel:td>
			<%
			...
			%>
			<Excel:td colspan="11" align="center" ><Excel:font size="20">救灾情况统计表</Excel:font></Excel:td>
			<%
			}
			%>
		</Excel:tr>
		...
		<Excel:tr height="30" bgcolor="grey" border="1">
			...
			<% 
				if("DC".equals(reliefType)){
			%>
			<Excel:td  align="center" width="100" bordercolor="black" colspan="2" >冬春救助</Excel:td>
			<%
				}else if("SW".equals(reliefType)){
			%>
			...
			%>
			<Excel:td  align="center" width="100" bordercolor="black" colspan="2">应急救助</Excel:td>
			<%
				}else if("GD".equals(reliefType)){
			%>
			<Excel:td  align="center" width="100" bordercolor="black" colspan="2">过渡救助</Excel:td>
			<%
				}else if("CJ".equals(reliefType)){
			%>
			<Excel:td  align="center" width="100" bordercolor="black" colspan="2">灾区民房恢复重建补助</Excel:td>
			<%
				}else{
			%>
			<Excel:td  align="center" width="100" bordercolor="black" colspan="2" >冬春救助</Excel:td>
