...
<script type="text/javascript" src="goodsSwapSumsList.js"></script>
...
<model:datasets>
	...
	<model:dataset id="disFundsSourceDs"
		cmd="com.inspur.cams.dis.base.cmd.DisFundsSourceQueryCmd" method="querySwapGoodsForSums"
		pageAble="false">
	</model:dataset>
</model:datasets>
	...
	<next:Html>
		...
		<div align="center" style="width: 800px;">
			<div align="center"><span id="reportTitle"
				style="font-size: large;">置换物资情况统计表</span></div>
		</div>
		...
		<table style="border-style: hidden; width: 800px;" class="table2"
			...
			<tr class="tr2">
				<td colspan="1" style="border-width: 0px" class="td2">
			...
			<table width="800px" class="table2" dataset="disFundsSourceDs" align="center">
				<tr class="tr2">
					<td class="tdTitle" align="center"><span id="areaName">地区</span></td>
					<td class="tdTitle" style="border-bottom-width: 0px" align="center">置换资金金额</td>
					<td class="tdTitle" style="border-bottom-width: 0px" align="center">置换次数</td>
				</tr>
				<tr repeat="true" class="tr2" >
					<td class="td2" width="300px" align="center">
						<label field="NAME" style="color: #0000FF"/></td>
						
					<td class="td2" width="110" align="right"><label field="METERIAL"
						size="20" /></td>
					<td class="td2" width="110" align="right"><label field="NUMS"
						size="20" /></td>
				</tr>
			</table>
			<table width="800px" class="table2">
				<tr class="tr2">
					<td class="td2" colspan="1" style="border-width: 0px">
