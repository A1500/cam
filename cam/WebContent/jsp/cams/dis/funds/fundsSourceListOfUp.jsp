...
<script type="text/javascript" src="fundsSourceListOfUp.js"></script>
...
<next:Panel name="allocationPanel" width="100%" height="100%">
			...
			<table width="100%">
				<tr>
					...
					<td class="FieldInput"><input type="text"
						id="cx_upAllocationNum_up" class="TextEditor" title="上级拨款文号" style="width: 200px"/></td>
	...
	<next:GridPanel id="allocationGridPanel" dataset="allocationDs"
		...
		<next:TopBar>
			<next:ToolBarItem text="上级下拨资金管理"></next:ToolBarItem>
			<next:ToolBarItem symbol="->"></next:ToolBarItem>
			<next:ToolBarItem id="addUpbtn" iconCls="add" text="新增"
				handler="addUp" />
			<next:ToolBarItem id="editUpbtn" iconCls="edit" text="修改"
				handler="editUp" />
			<next:ToolBarItem id="deleteUpbtnId" iconCls="delete" text="删除"
				handler="deleteComm" />
			...
			<table border="0" width="100%">
				...
				<tr id="trAlloNum">
					...
					<td class="FieldInput"><input type="text"
						...
						style="width: 80%" /><font color="red">*</font>
					</td>
					<td class="FieldLabel" width="15%">拨款方向:</td>
					<td class="FieldInput"><select name="拨款方向" id="fundDirect" style="width: 150px;">
						<option value="1">拨付全省（除青岛）</option>
						<option value="0">拨付青岛</option>
...
<!--新增资金来源-明细(县)-->
<next:Window id="sourceDetailWinC" width="700" height="370"
	collapsible="false" closable="close" resizable="true" modal="true">
	<next:TopBar>
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
		<next:ToolBarItem iconCls="no" text="取消" handler="hideDetailWin"></next:ToolBarItem>
		...
		<next:Html>
			...
			<table border="0" width="100%">
				<tr>
					...
					<td class="FieldInput"><label field="disYear" /></td>
					<td class="FieldLabel" width="15%">拨款类型:</td>
					<td class="FieldInput" colspan="3"><label field="upAllocationType"
						dataset="disAllocationTypeDs" /></td>
				</tr>
				<tr>
					<td class="FieldLabel" width="15%">拨款日期:</td>
				...
				<tr>
					<td class="FieldLabel" width="15%" rowspan="3">拨款金额:</td>
					<td class="FieldInput" rowspan="3"><label field="amount"
				...
				<tr>
					<td class="FieldLabel" width="15%">其中，市财政:</td>
					<td class="FieldInput"><label field="amountCity"
						style="text-align: right;"></label>&nbsp;万元</td>
				</tr>
				<tr>
					<td class="FieldLabel" width="15%">资金用途:</td>
...
<!--新增资金来源-明细(乡)-->
<next:Window id="sourceDetailWinT" width="700" height="360"
	collapsible="false" closable="close" resizable="true" modal="true">
	<next:TopBar>
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
		<next:ToolBarItem iconCls="no" text="取消" handler="hideDetailWin"></next:ToolBarItem>
	...
	<next:Panel id="singleSourcePanel2">
		<next:Html>
			...
			<table border="0" width="100%">
				...
				<tr>
					<td class="FieldLabel" width="15%">其中，县财政:</td>
					<td class="FieldInput"><label field="amountCounty"
						style="text-align: right;"></label>&nbsp;万元</td>
				</tr>
				<tr>
					<td class="FieldLabel" width="15%">资金用途:</td>
