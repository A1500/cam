...
<script type="text/javascript" src="fundsAllocationList.js"></script>
		...
		<table width="100%">
			<tr>
				...
				<td class="FieldInput"><input type="text" id="qUpAllocationNum"
					class="TextEditor" title="拨款文号" /></td>
				<td class="FieldLabel" nowrap>拨款类型：</td>
				<td class="FieldInput"><select id="qUpAllocationType"
					class="TextEditor" title="拨款类型">
...
<next:GridPanel id="allocationGridPanel" dataset="disFundsBatchDs" autoExpandColumn="note"
	name="allocationGridPanel" width="99.9%" height="100%" notSelectFirstRow="true">
	<next:TopBar>
		<next:ToolBarItem text="资金拨付管理"></next:ToolBarItem>
		...
		<next:ToolBarItem iconCls="search" text="进度追踪" handler="followAllo"/>
	</next:TopBar>
	<next:Columns>
