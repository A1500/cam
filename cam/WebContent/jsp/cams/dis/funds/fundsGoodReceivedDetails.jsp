...
<script type="text/javascript" src="fundsGoodReceivedDetails.js"></script>
...
<next:ViewPort>
		...
		<next:Html>
			...
			<table border="0" width="100%">
				<tr>
					...
					<td class="FieldInput" width="50%"><label field="disYear"/></td>
	...
	<next:GridPanel id="allocationAllGrid" dataset="disDetailBatchSourceDs"
		...
		<next:Columns>
			...
			<next:Column header='物资类型' field="meterialType"
				renderer="meterialTypeRenderer" width="120">
				<next:ComboBox dataset="dmDisMaterialTypeDs" typeAble="false" />
			</next:Column>
			<next:Column header="物资单位" field="meterialUnit" align="center" width="60">
				<next:TextField editable="false" />
			</next:Column>
			<next:Column header="物资数量" field="meterialNum" align="right"
				renderer="formatMoneyForDis" summaryType="sum" width="80">
				<next:ExtendConfig>
			...
			<next:Column header="物资数量结余" field="meterialNumBalance" align="right"
				renderer="formatMoneyForDis" summaryType="sum" width="110">
				<next:ExtendConfig>
		                    summaryRenderer : formatMoneyForDis
		                </next:ExtendConfig>
				<next:TextField />
			</next:Column>
			<next:Column header="物资金额合计结余(万元)" field="meterialAccountBalance" align="right"
				renderer="formatMoneyForDis" summaryType="sum" width="140">
				<next:ExtendConfig>
		                    summaryRenderer : formatMoneyForDis
		                </next:ExtendConfig>
				<next:TextField />
			</next:Column>
			<next:Column header="备注" field="note" align="left" width="200">
				<next:TextField/>
			</next:Column>
		</next:Columns>
	</next:GridPanel>
