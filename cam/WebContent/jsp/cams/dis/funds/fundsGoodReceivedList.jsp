...
<script type="text/javascript" src="fundsGoodReceivedList.js"></script>
...
<model:datasets>
	...
	<model:dataset id="disDetailSourceDs"
		cmd="com.inspur.cams.dis.base.cmd.DisDetailSourceQueryCmd" sortField="ALLOCATION_TIME DESC,FILL_TIME DESC,DETAIL_ID">
	...
	<next:Html>
		...
		<table width="100%">
			<tr>
				...
				<td class="FieldLabel" width="100px">物资用途：</td>
...
<next:GridPanel id="allocationGridPanel" dataset="disDetailSourceDs" autoExpandColumn="note"
	name="allocationGridPanel" width="99.9%" height="100%" notSelectFirstRow="true">
	<next:TopBar>
		<next:ToolBarItem text="捐赠物资接收管理"></next:ToolBarItem>
	...
	<next:Columns>
		...
		<next:Column id="allocationTime" header="接收日期" field="allocationTime"
