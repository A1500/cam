...
<script type="text/javascript" src="fundsAllocationEdit2CityLive.js"></script>
...
<next:Panel name="detailPanel" width="100%" title="资金拨付明细" autoScroll="true">
<!--市款-->
	<next:GridPanel id="cityGrid" dataset="disFundsSourceCityDs"
		height="98%" width="100%" hasSum="true" stripeRows="true"
