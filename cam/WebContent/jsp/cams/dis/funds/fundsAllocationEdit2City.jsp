...
<script type="text/javascript" src="fundsAllocationEdit2City.js"></script>
	...
	<next:Html>
		...
		<table border="0" width="100%">
			...
			<tr>
				...
				<td class="FieldInput">
					<label id="amountLblCd" style="color: red"/>
				</td>
			</tr>
			<tr>
				<td class="FieldLabel" width="15%">拨款总额(市级):</td>
				<td class="FieldInput">
					<label id="amountLblCity" field="amountTotalCity"/>
				</td>
			</tr>
		</table>
		</form>
...
<!--中央款-->
	<next:EditGridPanel id="centralGrid" dataset="disFundsSourceCentralDs"
		...
		<next:Columns>
			...
			<next:Column id="oldUpAllocationNum" header="源拨款资金文号(中央)"
				field="oldUpAllocationNum" align="center" width="135">
				<next:TextField allowBlank="false" editable="false" />
			</next:Column>
