function init(){
//	isCheckedSub(tree.getNodeByRecord(record),tree.getNodeByRecord(record).ups);
//	var treePanel = L5.getCmp('treePanel');
...
//				//tree.getNodeByRecord(record).remove();
//				node.remove();
//			}
//		}
//	});
...
function getChoiceBox(record){
   if(record.get("leve")<=radioMaxlevel||record.get("id").substr(6,3)=="999")
      return '';
   else
      return  radioType;
}
