...
<script type="text/javascript" src="reliefMainCounty.js"></script>
</head>
<body>
<model:datasets>
	<!--审批-->
	<model:dataset id="disShenpiDs"
		cmd="com.inspur.cams.dis.base.cmd.DisReliefBatchQueryCmd"
		method="queryShenpi" global="true">
	</model:dataset>
...
<next:Panel height="100%" autoScroll="true">
	<next:Panel height="220" width="99%">
		<next:ColumnLayout>
			<next:Panel id="panel1" title="审批" columnWidth=".5">
			<next:Html>
				<form method="post" onsubmit="return false" class="L5form" dataset="disShenpiDs">
