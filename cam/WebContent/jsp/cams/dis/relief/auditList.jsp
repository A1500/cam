...
<html>
<head>
<title>救助申请审核复核</title>
<next:ScriptManager />
<script type="text/javascript" src="auditList.js"></script>
...
<next:GridPanel id="editGridPanel" name="disreliefinfoGrid" width="100%"
	...
	<next:TopBar>
		<next:ToolBarItem text="救助申请/审核/复核信息列表"></next:ToolBarItem>
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
		<next:ToolBarItem text="填报" iconCls="edit" handler="editReq" />
		<next:ToolBarItem text="上报需求" iconCls="upload" handler="reportReq" />
		<next:ToolBarItem text="提交档案" iconCls="yes" handler="commitReq" />
		<next:ToolBarItem text="查看流程" iconCls="search" handler="detailFlow" />
