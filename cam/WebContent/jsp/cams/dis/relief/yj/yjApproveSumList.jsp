...
<script type="text/javascript" src="yjApproveSumList.js"></script>
</head>
<body>
<model:datasets>
	<!-- 批次信息 -->
...
<next:Panel width="100%">
	...
	<next:Html>
		<fieldset>
		<form id="yjForm" method="post" dataset="batchDetailds"
...
<next:GridPanel id="sumsGrid" name="sumsGrid" width="100%"
	...
	<next:Columns>
		...
		<next:Column id="APPROVAL_FOOD" header="总核准救助口粮（公斤）"
			field="APPROVAL_FOOD" width="150" align="right" renderer="formatMoneyForDis"
			summaryType="sum">
			<next:ExtendConfig>
		...
		<next:Column id="APPROVAL_FOOD_AVG" header="人均核准救助口粮（公斤）"
			field="APPROVAL_FOOD_AVG" width="150" align="right"
		...
		<next:Column id="APPROVAL_CLOTHES" header="总核准救助衣被（件）"
			field="APPROVAL_CLOTHES" width="150" align="right" summaryType="sum"
		...
		<next:Column id="APPROVAL_CLOTHES_AVG" header="人均核准救助衣被（件）"
			field="APPROVAL_CLOTHES_AVG" width="150" align="right" renderer="formatMoneyForDis"
			summaryType="sum">
			<next:ExtendConfig>
               	summaryRenderer : formatMoneyForDis
           	</next:ExtendConfig>
