...
<script type="text/javascript" src="yjList.js"></script>
</head>
<body>
<model:datasets>
	<!--批次明细-以乡镇为单位(单条)-->
...
<next:GridPanel id="yjGrid" name="yjGrid" width="100%"
	...
	<next:Columns>
		...
		<next:Column id="approvalWater" header="核准饮水救助（元）"
	...
	<next:Html>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td class="FieldInput" style="width: 35%"><label
					field="APPROVAL_CLOTHES" renderer="formatMoneyForDis" /></td>
