...
<%!
	...
	String name="过渡生活救助_"+date;
	
%>

</head>
<Excel:tablelist filename="<%=name %>">
	<Excel:table sheetname="过渡生活救助查询列表">
		<Excel:tr>
			<Excel:td colspan="11" align="center" ><Excel:font size="15">过渡生活救助查询列表</Excel:font></Excel:td>
		</Excel:tr>
		<Excel:tr>
		...
		<Excel:tr height="30" bgcolor="grey" border="1">
			...
			<Excel:td  align="center" width="100" bordercolor="black">村名称</Excel:td>
			<Excel:td  align="center" width="100" bordercolor="black">家庭人口(人)</Excel:td>
			<Excel:td  align="center" width="100" bordercolor="black">户口类型</Excel:td>
			<Excel:td  align="center" width="100" bordercolor="black">家庭类型</Excel:td>
			<Excel:td  align="center" width="100" bordercolor="black">核准救助口粮(公斤)</Excel:td>
			<Excel:td  align="center" width="100" bordercolor="black">核准救助衣被(件)</Excel:td>
			<Excel:td  align="center" width="100" bordercolor="black">核准救助资金(元)</Excel:td>
			<Excel:td  align="center" width="100" bordercolor="black">村填报人姓名</Excel:td>
		...
		<Excel:tr border="1">
			...
			<Excel:td align="right"><%=rec.get("familyNum")%></Excel:td>
			<Excel:td align="right"><%=familyRegister%></Excel:td>
			...
			<Excel:td align="right"><%=rec.get("acceptPeopleName")%></Excel:td>
