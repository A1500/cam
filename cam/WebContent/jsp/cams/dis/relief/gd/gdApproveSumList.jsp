...
<script type="text/javascript" src="gdApproveSumList.js"></script>
</head>
<body>
<model:datasets>
	<!-- 批次信息 -->
...
<next:GridPanel id="sumsGrid" name="sumsGrid" width="100%"
	...
	<next:Columns>
		...
		<next:Column id="FAMILY_NUM" header="救助家庭人口数量(人)" field="FAMILY_NUM"
			width="150" align="right"></next:Column>
		...
		<next:Column id="APPROVAL_FOOD_AVG" header="人均核准救助口粮（公斤）"
			field="APPROVAL_FOOD_AVG" width="160" align="right"
		...
		<next:Column id="APPROVAL_MONEY" header="总核准救助资金（元）"
			field="APPROVAL_MONEY" width="140" align="right" renderer="formatMoneyForDis"
			summaryType="sum" >
			<next:ExtendConfig>
               	summaryRenderer : formatMoneyForDis
           	</next:ExtendConfig>
