...
<script type="text/javascript" src="cjApproveSumList.js"></script>
</head>
<body>
<model:datasets>
	<!-- 批次信息 -->
...
<next:GridPanel id="sumsGrid" name="sumsGrid" width="100%"
	...
	<next:Columns>
		...
		<next:Column id="APPROVAL_REBUILED_HOUSE" header="总核准重建间数（间）"
			field="APPROVAL_REBUILED_HOUSE" width="130" align="right" 
			summaryType="sum">
			<next:ExtendConfig>
		...
		<next:Column id="APPROVAL_REPAIRED_HOUSE_AVG" header="人均核准修缮间数（间）"
			field="APPROVAL_REPAIRED_HOUSE_AVG" width="140" align="right" renderer="formatMoneyForDis"
			summaryType="sum">
			<next:ExtendConfig>
               	summaryRenderer : formatMoneyForDis
           	</next:ExtendConfig>
