...
<next:GridPanel id="editGridPanel" name="disreliefinfoGrid" width="100%"
	...
	<next:TopBar>
		<next:ToolBarItem text="救助审批信息列表"></next:ToolBarItem>
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
		<next:ToolBarItem text="审核" iconCls="edit" handler="sumReq" />
		<next:ToolBarItem text="审批" iconCls="yes" handler="approveReq" />
	</next:TopBar>
	<next:Columns>
