...
<%!
	...
	String name="冬春生活救助_"+date;
	
%>

</head>
<Excel:tablelist filename="<%=name %>">
	<Excel:table sheetname="冬春生活救助">
		<Excel:tr>
			<Excel:td colspan="13" align="center" ><Excel:font size="15">冬春生活救助</Excel:font></Excel:td>
		</Excel:tr>
		<Excel:tr>
		...
		<Excel:tr border="1">
			...
			<Excel:td align="right"><%=rec.get("approvalTimes")%></Excel:td>
