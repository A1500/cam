...
<script type="text/javascript" src="dcDetail.js"></script>
</head>
<body>
<model:datasets>
	<!-- 批次信息 -->
...
<next:Panel width="100%" height="100%" autoScroll="true">
	...
	<next:Html>
		<fieldset>
		<form id="dcForm" method="post" dataset="infoDs"
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td class="FieldInput" style="width: 35%"><label field="requiredForWater" /></td>
			</tr>
			<tr>
				<td class="FieldLabel" style="width: 15%" nowrap>核准救助时段（月）:</td>
				<td class="FieldInput" style="width: 35%"><label field="approvalTimes" /></td>
			...
			<tr>
				...
				<td class="FieldInput" style="width: 35%" colspan="3"><textarea
					name="note" rows="5" field="note" title="备注" style="width: 71.5%" disabled="disabled"></textarea></td>
			</tr>
		</table>
		</form>
		</fieldset>
