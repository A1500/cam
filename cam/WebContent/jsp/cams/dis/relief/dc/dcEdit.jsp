...
<script type="text/javascript" src="dcEdit.js"></script>
</head>
<body>
<model:datasets>
	<!-- 批次信息 -->
	...
	<model:dataset id="infoDs"
		...
		<model:record fromBean="com.inspur.cams.dis.base.data.DisReliefInfo">
			...
			<model:field name="approvalTimes" type="float" rule="require"></model:field>
	...
	<next:Html>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td class="FieldInput" style="width: 35%"><input type="text"
					id="approvalTimes" name="approvalTimes" field="approvalTimes" 
					title="核准救助时段" onchange="CheckTxt('approvalTimes','核准救助时段');"/>
					<font color="red">*</font></td>
			...
			<tr id="yhTr">
				...
				<td class="FieldInput" style="width: 35%"><input type="text"
					name="bank" field="bank" title="开户银行" /><font color="red">*</font></td>
				<td class="FieldLabel" style="width: 15%" nowrap>开户银行帐号:</td>
				<td class="FieldInput" style="width: 35%"><input type="text"
					name="accountCode" field="accountCode" title="开户银行帐号"
					style="width: 200" /><font color="red">*</font></td>
			</tr>
			<tr id="yhTr2">
			...
			<tr>
				...
				<td class="FieldInput" style="width: 35%" colspan="3"><textarea
					name="note" rows="5" field="note" title="备注" style="width: 71.5%"></textarea></td>
			</tr>
		</table>
		</form>
		</fieldset>
