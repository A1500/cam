...
<title>待办任务列表</title>
<next:ScriptManager />
<script type="text/javascript" src="doleList.js"></script>
...
<model:datasets>
	...
	<model:dataset id="allocationTypeDataset" enumName="DIS.INFO_ALLOCATION_TYPE"
		autoLoad="true" global="true"></model:dataset>
</model:datasets>
...
<next:GridPanel id="editGridPanel" name="disreliefinfoGrid" width="100%"
	...
	<next:Columns>
		...
		<next:Column header="发放单位" field="ALLOCATION_TYPE" width="200" dataset="allocationTypeDataset" >
			<next:TextField allowBlank="false" />
		</next:Column>
