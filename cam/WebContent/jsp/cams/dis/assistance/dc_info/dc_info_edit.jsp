...
<html>
	<head>
		...
		<script type="text/javascript" src="dc_info_edit.js"></script>
	</head>
<body>
<model:datasets>
	...
	<next:Html>
		...
		<table border="1"  width="100%" >
	   		...
	   		<tr>
				...
				<td class="FieldInput"><select type="text"id="reliefType" name="reliefType" field="reliefType"  />
