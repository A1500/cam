...
<html>
	<head>
		...
		<script type="text/javascript" src="disasterDeathSolatiumBatch.js"></script>	
	</head>
<body>
<model:datasets>
...
<next:GridPanel id="disasterDeathSolatiumBatchGrid" name="disasterDeathSolatiumBatchGrid" width="100%" clickToSelectedForChkSM="true" stripeRows="true" height="100%" dataset="ds"
