...
<html>
	<head>
		...
		<script type="text/javascript" src="lifeAssistanceWinterSpringBatch.js"></script>	
	</head>
<body>
<model:datasets>
...
<next:GridPanel id="lifeAssistanceWinterSpringBatchGrid" name="lifeAssistanceWinterSpringBatchGrid" width="100%" clickToSelectedForChkSM="true" stripeRows="true" height="100%" dataset="ds"
	...
	<next:Columns>
		...
		<next:Column id="batchDetailId" header="批次明细ID" field="batchDetailId" hidden="true"><next:TextField ></next:TextField></next:Column>
		<next:Column id="reliefType" header="救助类型" field="reliefType" width="180" dataset="ReliefTypeDataset"><next:TextField ></next:TextField></next:Column>
		<next:Column id="batchId" header="批次号" field="batchId" width="90" hidden="true"><next:TextField ></next:TextField></next:Column>
		<next:Column id="batchName" header="批次名称" field="batchName" width="90"><next:TextField ></next:TextField></next:Column>
		<next:Column id="requiredOrganName" header="所需填报单位名称" field="requiredOrganName" width="200" ><next:TextField ></next:TextField></next:Column>
		<next:Column id="fillState" header="填报状态" field="fillState" width="90" dataset="BatchdetailFillState"><next:TextField ></next:TextField></next:Column>
	</next:Columns>
	<next:BottomBar>
