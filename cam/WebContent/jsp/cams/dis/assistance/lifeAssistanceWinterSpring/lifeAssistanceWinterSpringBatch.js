...
var orgName;
function init(){
	ds.setParameter("reliefType","DC");//冬春生活
 ...
 */
function detail(){
	var editGrid = L5.getCmp("lifeAssistanceWinterSpringBatchGrid");//获得控制权
	var selected = editGrid.getSelectionModel().getSelections();//获得选中行
	if(selected.length!=1){
		L5.Msg.alert('提示','请选中一条记录查看！');
		return false;
	}
	var url='jsp/cams/dis/assistance/lifeAssistanceWinterSpring/lifeAssistanceWinterSpringList.jsp';
	var text='救助批次明细';
	var data=new L5.Map();
