...
<next:GridPanel id="editGridPanel" height="100%" name="disreliefinfoGrid" clickToSelectedForChkSM="true" width="100%" stripeRows="true"clickToSelectedForChkSM="true" dataset="ds" title="应急生活救助批次列表">
	<next:TopBar>
