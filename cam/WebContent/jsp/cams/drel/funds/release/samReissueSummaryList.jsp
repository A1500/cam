...
<html>
	<head>
		<title>专项补贴计划</title>
		<next:ScriptManager/>
		<script type="text/javascript" src="samReissueSummaryList.js"></script>
					...
					<form style="width: 100%; height: 100%;" class="L5form" id="queryForm">
						<table  border="1" width="100%" >
							<tr >
								...
								<td class="FieldLabel" style="display: none;">救助方式:</td>
...
<next:GridPanel id="editGridPanel" name="samreleasesummaryGrid" title="补发名册列表" width="100%" stripeRows="true"  notSelectFirstRow="true" clickToSelectedForChkSM="true" height="100%" dataset="releaseSummaryListDs" >
	<next:TopBar>
	...
	<next:Columns>
		...
		<next:Column id="releaseWay" header="救助对象" field="releaseTarget" width="8%" dataset="releaseTargetDS"  align="center">
			<next:NumberField  />
		</next:Column>
		<next:Column  header="补发标准（元）" field="releaseStandard" width="14%"  renderer="formatMoney" align="right">
			<next:NumberField allowBlank="false" />
		</next:Column>
		<next:Column  header="补发总户数" field="releaseFamilySum" width="10%"  align="right">
			<next:NumberField  />
		</next:Column>
		<next:Column id="releasePeopleNum" header="补发总人数" field="releasePeopleNum" width="100" align="right">
            <next:NumberField  />
        </next:Column>
		<next:Column  header="补发总额（元）" field="releaseFundSum" width="10%"   renderer="formatMoney" align="right">
			<next:NumberField allowBlank="false" />
		</next:Column>
        ...
        <form dataset="releaseSummaryDs"  onsubmit="return false"  class="L5form">
            <table width='100%'>
                <tr>
                    ...
                    <td class="FieldInput" >
                        <input type="text" name="地区"  field="releaseAreaName" readonly="readonly" />
                ...
                <tr>
                    <td class="FieldLabel" style="width:100">补发对象</td>
                    <td class="FieldInput" >
                        <select field="releaseTarget" name="救助目标" >
                            <option  dataset="releaseTargetDS" />
                        </select><span style="color:red">*</span>
                    </td>
                    <td class="FieldLabel" style="width:100;">补发标准（元）</td>
                    <td class="FieldInput" >
                        <input type="text" name="补发标准"  field="releaseStandard" />
                        <span style="color:red">*</span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="FieldInput" style="display: none;">
                        <select field="releaseWay" name="发放方式">
                            <option dataset="releaseWayDs"/>
                        </select>
                    </td>
                </tr>
