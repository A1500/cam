...
<%
	...
	String title=request.getParameter("releaseDate")+assitanceTypeText+"发放明细";
%>
<Excel:tablelist filename="<%=title%>">
	<Excel:table>
	<%--标题栏 --%>
		<Excel:tr>
			<Excel:td colspan="10" align="center"><%=request.getParameter("releaseDate")+assitanceTypeText %>发放明细</Excel:td>
		</Excel:tr>
		<%
	...
	<%--列标题 --%>
		<Excel:tr bgcolor="grey">
			<Excel:td  align="center">属地</Excel:td>
			<Excel:td  align="center">姓名</Excel:td>
			<Excel:td  align="center">身份证号</Excel:td>
			<Excel:td  align="center">保障人数</Excel:td>
			<Excel:td  align="center">保障金（元）</Excel:td>
			<Excel:td  align="center">分类施保金（元）</Excel:td>
	...
	<%--数据区 --%>
		...
		<Excel:tr>
			...
			<Excel:td width="100"><%=record.get("classMon")%></Excel:td>
