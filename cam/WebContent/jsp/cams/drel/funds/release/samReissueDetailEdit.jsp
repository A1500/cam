...
<html>
	<head>
		...
		<next:ScriptManager/>
		<script type="text/javascript" src="samReissueDetailEdit.js"></script>
...
<next:GridPanel id="editGridPanel" name="samreleasedetailGrid" width="100%" stripeRows="true" height="400"  notSelectFirstRow="true" clickToSelectedForChkSM="true"  dataset="releaseDetailListDS">
	...
	<next:Columns>
		...
		<next:Column id="domicileName" header="所属地" field="domicileName" width="120"  align="center">
            <next:TextField  />
        </next:Column>
...
<next:Window id="releaseDetailWin" title="补发明细" closeAction="hide"  width="740" modal="true">
    <next:TopBar>
        <next:ToolBarItem symbol="->"></next:ToolBarItem>
