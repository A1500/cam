...
<next:ScriptManager />
	...
	<script type="text/javascript" src="samReissueDetailAdd.js"></script>
...
<next:GridPanel id="infoQueryGrid" name="baseinfoFamilyResource" stripeRows="true" height="100%" width="100%" notSelectFirstRow="true" clickToSelectedForChkSM="true"  dataset="baseinfoFamilyDS" notSelectFirstRow="true">
	<next:TopBar>
		<next:ToolBarItem id="qrToolbar" text="低保家庭查询信息"></next:ToolBarItem>
		<next:ToolBarItem symbol="->" ></next:ToolBarItem>
		<next:ToolBarItem text="添加选中救助对象" iconCls="yes" handler="openReleaseMonthWin"></next:ToolBarItem>
		<next:ToolBarItem text="添加全部救助对象" iconCls="yes" handler="openReleaseMonthWinAll"></next:ToolBarItem>
...
<next:Window id="releaseMonthWin" title="补发月数" closeAction="hide"  width="300" modal="true">
    <next:TopBar>
        <next:ToolBarItem symbol="->"></next:ToolBarItem>
        <next:ToolBarItem iconCls="yes" text="保存" handler="saveReleaseMonth" ></next:ToolBarItem>
        <next:ToolBarItem iconCls="return" text="关闭" handler="closeReleaseMonthWin"></next:ToolBarItem>
    </next:TopBar>
    <next:Html>
            ...
            <table width='100%'>
                <tr>
                    <td colspan="2" style="text-align:left">
                        <label id="msgTd" style="color:red;"></label>
                    </td>
                </tr>
                <tr>
                    <td class="FieldLabel" id="valueLabel" style="width:80">补发月数:</td>
                    <td class="FieldInput" >
                        <select name="补发月数"  id="reissueMonth" >
