...
function query(){	
	...
	releaseSummaryListDs.setParameter("SAM_RELEASE_SUMMARY.RELEASE_TYPE@=","02");		
	releaseSummaryListDs.setParameter("SAM_RELEASE_SUMMARY.RELEASE_WAY@=",getParam("releaseWay"));		
...
function saveReleaseSummary(){
	...
	releaseSummaryRecord.set("releaseType","02");
	releaseSummaryRecord.set("feedbackStatus","01");
	releaseSummaryRecord.set("isSpecial","0");
...
var width = screen.width-200;
    var height = 492;
	var url = "samReissueDetailEdit.jsp?releaseId="+rec.get('releaseId')+"&assistanceType="+rec.get("assistanceType")+"&releaseDate="+rec.get('releaseDate')+"&hrefFlg="+(new Date()).getTime();;
...
function detail(releaseId,releaseDate,assistanceType) {
	var width = screen.width - 200;
	var height = 492;
	var url = "samReleaseDetail.jsp?releaseType=02&releaseId=" + releaseId+"&releaseDate="+releaseDate+"&assistanceType="+assistanceType;
