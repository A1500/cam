...
<script type="text/javascript" src="samFiveModInsert.js"></script>
			...
			<next:Html>
				...
				<table width="100%">
					...
					<tr>						
						...
						<td class="FieldInput" style="width: 18%"><input type="text" disabled="disabled"
					...
					<tr>
						...
						<td class="FieldInput" style="width: 18%">
							<select id='supportWay' name='供养方式' style="width:80%" disabled="disabled" onblur='getSupportOrg()'>
