...
<next:GridPanel id="editGridPanel" name="sammedicalbalanceGrid"
	...
	<next:Columns>
		...
		<next:Column id="cardNo" header="证件编号（低保或五保）" field="SAM_CARD_NO" width="18%">
			<next:TextField allowBlank="false" />
		</next:Column>
		...
		<next:Column id="leaveTime" header="出院日期" field="LEAVE_DATE" width="90">
			<next:TextField />
		</next:Column>
		...
		<next:Column id="assitancePay" header="医疗救助费用（元）" field="ASSITANCE_PAY" align="right"  width="15%" renderer="formatNum">
			<next:TextField />
		</next:Column>
