...
<next:ScriptManager />
<script type="text/javascript" src="samMBalanceOutpatientReport.js"></script>
...
<next:GridPanel id="rule_Grid" name="rule_Grid" dataset="ds"
	title="优抚门规查询报表" stripeRows="true" notSelectFirstRow="true"
	...
	<next:Columns>
		...
		<next:Column id="hospitalPay" header="医院减免金额(元)" field="SUMHOS" align="right" 
			width="15%" renderer="formatNum">
			<next:TextField />
		</next:Column>
		<next:Column id="specialPay" header="优抚补助金额(元)" field="SUMSPEC" width="15%" align="right" 
			renderer="formatNum">
			<next:TextField />
		</next:Column>
