...
<next:GridPanel id="editGridPanel" name="sammedicalbalanceGrid"
	...
	<next:Columns>
		...
		<next:Column id="totalExpense" header="住院总费用（元）" field="TOTAL_EXPENSE" width="15%"  align="right" renderer="formatNum">
			<next:TextField />
		</next:Column>
		<next:Column id="insuranceExpense" header="保内费用（元）" field="INSURANCE_EXPENSE" width="15%"  align="right" renderer="formatNum">
			<next:TextField />
		</next:Column>
	
		<next:Column id="INSURENCE_PAY" header="保险机构支付费用（元）" field="INSURANCE_PAY" width="18%"  align="right" renderer="formatNum">
			<next:TextField />
		</next:Column>
	
		<next:Column id="assitancePay" header="医疗救助费用（元）" field="SPECIAL_PAY" width="15%" align="right"  renderer="formatNum">
			<next:TextField />
		</next:Column>
	
		<next:Column id="personalPay" header="个人支付费用（元）" field="PERSONAL_PAY" width="15%" align="right"  renderer="formatNum">
			<next:TextField />
		</next:Column>
	</next:Columns>
	<next:BottomBar>
