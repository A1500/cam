...
<script type="text/javascript" src="samMBalanceReportByHos.js"></script>
...
<next:Panel name="form" width="99.9%" border="0"
	...
	<next:Html>
		...
		<table border="1" width="100%">
			<tr>
				<td class="FieldLabel" width="20%">医院名称：</td>
...
<next:GridPanel id="editGridPanel" name="sammedicalbalanceGrid"
	...
	<next:Columns>
		...
		<next:Column id="hosptialId" header="医院" field="hospitalName" width="20%">
			<next:TextField allowBlank="false" />
		</next:Column>
		<next:Column hidden="true" id="hosptialId" header="医院" field="HOSPITAL_ID" width="90">
			<next:TextField allowBlank="false" />
		</next:Column>
