...
<next:Panel name="form" width="99.9%" border="0"
	...
	<next:Html>
		...
		<table border="1" width="100%">
			<tr>
				<td class="FieldLabel" width="20%">救助类别：</td>
...
<next:GridPanel id="editGridPanel" name="sammedicalbalanceGrid"
	...
	<next:Columns>
		...
		<next:Column id="assitanceType" header="救助类别" field="ASSITANCE_TYPE" dataset="assitanceTypeDataset"
			width="10%">
			<next:TextField allowBlank="false" />
		</next:Column><next:Column id="sumTotalExp" header="住院总费用（元）" field="SUMTOTALEXP" align="right" 
			width="18%">
			<next:TextField allowBlank="false" />
		</next:Column>
