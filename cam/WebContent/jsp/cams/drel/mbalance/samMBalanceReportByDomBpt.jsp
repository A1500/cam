...
<next:Panel name="form" width="99.9%" border="0"
	...
	<next:Html>
		...
		<table border="1" width="100%">
			<tr>
				<td class="FieldLabel" width="10%"><label>优抚对象属地:</label></td>
				<td class="FieldInput" width="10%"><input type="text" onclick="forHelp(this.id)"
					id="qapanage" name="优抚对象属地"/></td>
...
<next:GridPanel id="editGridPanel" name="sammedicalbalanceGrid"
	...
	<next:Columns>
		...
		<next:Column id="domicileName" header="优抚对象属地" field="domicileName" width="13%" >
