...
<script type="text/javascript" src="samFiveChangeInsert.js"></script>
...
<model:datasets>
	...
	<model:dataset id="familyDataSet" cmd="com.inspur.cams.drel.sam.cmd.BaseinfoFamilyQueryCmd" global="true"  >
		<model:record fromBean="com.inspur.cams.comm.baseinfo.data.BaseinfoFamily">
			...
			<model:field name="assistanceMoney" type="string" rule="regex{^[0-9]{1,14}$}" />
			<model:field name="assistanceClassMoney" type="string" rule="regex{^[0-9]{1,14}$}" />
	...
	<next:Panel title="家庭基本信息" titleCollapse="true" collapsible="true"  autoHeight="true" autoScroll="true">
			...
			<next:Html>
				...
				<table width="100%">
                    ...
                    <tr>
                        ...
                        <input type="checkbox" name="changeItem" id="changeItem05" value="05" onclick="changeItemClick(this)">变更供养方式 &nbsp;&nbsp;
                        <input type="checkbox" name="changeItem" id="changeItem06" value="06" onclick="changeItemClick(this)">停止供养 &nbsp;&nbsp;
					...
					<tr>
						...
						<td class="FieldInput" style="width: 18%" colspan="5"><textarea name="变更原因" title="变更原因"
		...
		<next:GridPanel id="peoplePanel" titleCollapse="true" collapsible="true"  stripeRows="true" autoHeight="true" dataset="peopleListDataSet" title="家庭成员基本信息" >
			...
			<next:Columns>
				...
				<next:Column  field="PERSONAL_STATS_TAG" header="人员状态" width="145" renderer="getPersonalStatsTag">
				</next:Column>
			</next:Columns>
		</next:GridPanel>
		...
		<next:Html>
			...
			<table width="100%">
				...
				<tr>
					...
					<td class="FieldInput" style="width: 10%">
					<input type="text"
						title="经办人" name="经办人" style="width: 80%" field="checkAgent" maxlength="16" /><font color="red">*</font></td>
					<td class="FieldInput" colspan="4"></td>
				</tr>
			</table>
			</fieldset>
