...
<script type="text/javascript" src="samFiveChangeDetail.js"></script>
	...
	<next:Panel title="家庭基本信息" titleCollapse="true" collapsible="true"  autoHeight="true" autoScroll="true">
		...
		<next:EditGridPanel id="peoplePanel" titleCollapse="true" collapsible="true"  stripeRows="true" autoHeight="true" dataset="peopleListDataSet" title="家庭成员基本信息" >
			<next:Columns>
				...
				<next:Column  field="PERSONAL_STATS_TAG" header="人员状态" width="145">
		...
		<next:Panel title="审核意见信息" id="checkEditPanel" titleCollapse="true" collapsible="true"  autoHeight="true" autoScroll="true">
			...
			<fieldset><legend>入户调查</legend>
				...
				<table width="100%">
					...
					<tr>						
						<td class="FieldLabel" style="width: 10%">经办人</td>
						<td class="FieldInput" style="width: 10%"><input type="text" title="经办人" name="经办人" style="width:80%" field="principal" maxlength="16"/></td>
						<td class="FieldInput" colspan="4"></td>				
					</tr>
				</table>
				</fieldset>
				...
				<table width="100%">
					...
					<tr>						
						...
						<td class="FieldLabel" style="width: 10%">负责人</td>
						<td class="FieldInput" style="width: 10%">
						<input type="text" title="负责人" name="负责人" style="width:80%"  maxlength="16"field="checkPrincipal"/>
					<font color="red">*</font>	</td>
						<td class="FieldLabel" style="width: 10%">审核日期</td>
						<td class="FieldInput" style="width: 10%">
						<input type="text" title="审核日期" name="审核日期" field="checkDate" style="width:80%"  format="Y-m-d" onclick="LoushangDate(this)" readonly="readonly"/><font color="red">*</font>
						</td>
					</tr>
				<tr>
					<td class="FieldLabel" style="width: 10%">经办人</td>
			...
			<fieldset><legend>入户调查</legend>
				<table width="100%">
					...
					<tr>						
						...
						<td class="FieldInput" style="width: 10%" colspan="5"><input type="text"
							name="调查负责人" title="调查负责人" field="surveyPeople" maxlength="16" style="width:80%" /></td>
					</tr>
				...
				<table width="100%">
					...
					<tr>						
						...
						<td class="FieldLabel" style="width: 10%">民政局负责人</td>
						<td class="FieldInput" style="width: 10%">
						<input type="text" title="民政局负责人" name="民政局负责人" style="width:80%" field="auditPrincipal" maxlength="16"/>
						<font color="red">*</font></td>
						<td class="FieldLabel" style="width: 10%">审批日期</td>
						<td class="FieldInput" style="width: 10%">
