	...
	<next:TabPanel width="100%" height="100%">
		<next:Tabs>
			...
			<next:Panel title="变更业务待办" width="100%" height="100%">
				<next:Html>
				   <iframe id="applyChangeDaiBanIframe" src="samFiveChangeDaiBanList.jsp?name=<%=request.getParameter("name")%>&flag=<%=request.getParameter("flag")%>"
			...
			<next:Panel title="变更业务已办" width="100%" height="100%">
				<next:Html>
				   <iframe id="applyChangeYiBanIframe" src="samFiveChangeYiBanList.jsp?name=<%=request.getParameter("name")%>"
							frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="100%">
		   		   </iframe>
				</next:Html>
			</next:Panel>
			<next:Panel title="变更业务结束" width="100%" height="100%">
				<next:Html>
				   <iframe id="applyChangeJieShuIframe" src="samFiveChangeJieShuList.jsp?name=<%=request.getParameter("name")%>"
							frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="100%">
		   		   </iframe>
				</next:Html>
			</next:Panel>
