...
<script type="text/javascript" src="samFiveDetail.js"></script>
				...
				<tr>						
					...
					<tr>						
						...
						<td class="FieldInput" style="width: 10%" colspan="5"><input type="text"
							name="调查负责人" title="调查负责人" field="surveyPeople"  maxlength="100"style="width:80%" /><font color="red">*</font></td>
					</tr>
