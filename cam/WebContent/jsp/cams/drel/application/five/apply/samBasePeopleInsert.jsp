...
<next:Panel id="peopleWin" title="" height='100%' width="1000" autoScroll="true">
	<next:TopBar>
		...
		<next:ToolBarItem id="newIdCard" iconCls="add" text="生成身份代码" handler="newIdCard"/>
	...
	<next:Html>
		...
		<tr>
			...
			<tr>
				...
				<td class="FieldInput"><select name="生活自理能力" title="生活自理能力" id="selfCareAbility" style="width:90%"> <option dataset="selfCareAbilityDataset"></option> </select><font color="red">*</font></td>
			...
			<tr>
                ...
                <td class="FieldInput">
                    <select name="是否供养对象" title="是否供养对象" id="isAssistance" style="width:90%"> 
				...
				<td class="FieldInput"  colspan="2"><select name="残疾等级" title="残疾等级" id="disabilityLevel" style="width:90%"> <option dataset="DmCjdjDataSet"></option> </select></td>
			</tr>
			<tr>
				...
				<td class="FieldInput"><select name="文化程度" title="文化程度" field="eduCode" style="width:90%"> <option dataset="eduDataSet"> </option></select><font color="red">*</font></td>
                <td class="FieldLabel">与户主关系</td>
                <td class="FieldInput"  colspan="2">
                    <select id="relationshipType" style="width:90%" name="与户主关系"  title="与户主关系" field="relationshipType" onblur='hasSelf()'> 
                ...
                <td class="FieldInput" colspan='3'>
                	 <input type="text" style="width:80%" name="户籍地址" title="户籍地址" id="lrdwmc" field="apanageName" onkeyup="findDiv2(this,'lrdwId','popup','','dicCityDs','PY_CAPITAL@like','NAME@like','id','name','30')" onblur="clearDiv()"  style="width:300"/>
