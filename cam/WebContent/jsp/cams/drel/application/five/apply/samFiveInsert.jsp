...
<script type="text/javascript" src="samFiveInsert.js"></script>
...
<model:datasets>
	...
	<model:dataset id="familyDataSet" cmd="com.inspur.cams.drel.sam.cmd.BaseinfoFamilyQueryCmd" global="true"  >
		<model:record fromBean="com.inspur.cams.comm.baseinfo.data.BaseinfoFamily">
			...
			<model:field name="applyReason" type="string" rule="require|length{500}" />
...
<!-- 审核入户调查 -->
   ...
   <next:Panel  height="100%" autoScroll="true" id="tab">
		<next:TopBar>
				...
				<next:ToolBarItem id="saveId" iconCls="select" text="提交" disabled="" handler="submitApply" />
				...
				<table width="100%">
					...
					<tr>						
						...
						<td class="FieldInput" style="width: 18%"><input type="text"
							name="户主姓名" title="户主姓名" field="familyName"  style="width:80%" maxlength="25" /><font color="red">*</font>		</td>				
						<td class="FieldLabel" style="width: 15%">身份证号</td>
						<td class="FieldInput" style="width: 18%"><input type="text" id="familyCardNo"
							name="身份证号" title="身份证号" field="familyCardNo" style="width:80%" maxlength="18" onchange="checkCradNo(this)" /><font color="red">*</font></td>
				...
				<table width="100%">
					...
					<tr>						
						...
						<td class="FieldInput" style="width: 10%" colspan="5"><input type="text"
							name="调查负责人" title="调查负责人" maxlength="100" field="surveyPeople" style="width:80%" /><font color="red">*</font></td>
					</tr>
...
<next:Panel title="审核意见信息" id="checkDetailPanel" titleCollapse="true" collapsible="true"  autoHeight="true" autoScroll="true">
			...
			<fieldset><legend>入户调查</legend>
				...
				<table width="100%">
					<tr>						
						<td class="FieldLabel" style="width: 10%">公示结果</td>
						<td class="FieldInput" style="width: 10%"><select name="公示结果" disabled="disabled" title="公示结果" field="noticeResult"  style="width:80%"  ><option dataset="noticeResultDataSet"></option></select>
						</td>			
						<td class="FieldLabel" style="width: 10%">公示开始日期</td>
