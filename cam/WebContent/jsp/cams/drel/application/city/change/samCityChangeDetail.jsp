...
<script type="text/javascript" src="samCityChangeDetail.js"></script>
	...
	<next:Panel title="家庭基本信息" titleCollapse="true" collapsible="true"  autoHeight="true" autoScroll="true">
			...
			<next:Html>
				...
				<tr>
					...
					<td class="FieldInput" style="width: 18%"><label 
						 field="familyPostcode" style="width: 80%"></label></td>
				...
				<tr>
					...
					<td class="FieldInput" style="width: 18%" id="assistanceClassMoney" >
						<input type="text" name="分类施保金" maxlength="16"
							title="分类施保金" field="assistanceClassMoney"id="assistanceClassMoneyID" onchange="countTotle();"style="width:80%" />
					</td>
			...
			<fieldset><legend>入户调查</legend>
				...
				<table width="100%">
					...
					<tr>						
						...
						<td class="FieldLabel" style="width: 10%">负责人</td>
						<td class="FieldInput" style="width: 10%">
						<input type="text" title="负责人" name="负责人" maxlength="16" style="width:80%" field="checkPrincipal"/><font color="red">*</font>
						</td>
						<td class="FieldLabel" style="width: 10%">审核日期</td>
						<td class="FieldInput" style="width: 10%">
