...
<model:datasets>
	...
	<model:dataset id="applyDataSet" cmd="com.inspur.cams.drel.sam.cmd.SamApplyInfoQueryCmd" method="queryJieShu" global="true"  >
		...
		<model:params>
			<model:param name="processTypeRC" value='samCityChange'></model:param>
			<model:param name="processTypeCH" value='samCityChange'></model:param>
