...
<script type="text/javascript" src="samCityChangeInsert.js"></script>
...
<model:datasets>
   ...
   <model:dataset id="employmentCodeDataset" cmd="com.inspur.cams.comm.dicm.DicQueryCmd" global="true" autoLoad="true">
	...
	<!-- 意见 -->
	<model:dataset id="opinionDataSet" enumName="SAM_CHANGE_OPINION_TYPE" autoLoad="true" global="true"></model:dataset>
	<!-- 意见 -->
	<model:dataset id="opinionDataSet_all" enumName="SAM_CHANGE_OPINION_TYPE" autoLoad="true" global="true"></model:dataset>
	<!-- 人员状态 -->
	<model:dataset id="samPersonalStatsDataSet" enumName="SAM_PERSONAL_STATS_TAG" autoLoad="true" global="true"></model:dataset>
	<!-- 人员注销状态 -->
	<model:dataset id="samPersonalCancelStatsDataSet" enumName="SAM_PERSONAL_STATS_TAG" autoLoad="true" global="true"></model:dataset>
   ...
   <next:Panel  height="100%" autoScroll="true" id="tab">
	...
	<next:Panel title="家庭基本信息" titleCollapse="true" collapsible="true"  autoHeight="true" autoScroll="true">
			...
			<next:Html>
				...
				<table width="100%">
					...
					<tr>						
						...
						<td class="FieldInput" style="width: 18%"><input type="text" id="familyName"  maxlength="25"
							name="户主姓名" title="户主姓名" field="familyName"  style="width:80%" onchange='checkFamilyName(this)'/><font color="red">*</font>		</td>				
						<td class="FieldLabel" style="width: 15%">身份证号</td>
						<td class="FieldInput" style="width: 18%"><input type="text" id="familyCardNo" maxlength="18"
							name="身份证号" title="身份证号" field="familyCardNo" style="width:80%" /><font color="red">*</font></td>
					...
					<tr>
						...
						<td class="FieldInput" style="width: 18%"><select 
							name="救助金计算方式" title="救助金计算方式" field="assistanceMode"id="assistanceModeID"   onchange="countAssistanceMoney(this.value)"style="width:80%" ><option dataset="assistanceModeDataset"></option></select><font color="red">*</font></td>
						<td class="FieldLabel" style="width: 15%">属别</td>
						<td class="FieldInput" style="width: 18%">
							<select name="属别" title="属别" field="belonging" style="width:80%" >
					...
					<tr>	
						...
						<td class="FieldInput" style="width: 18%">
						<label id="assistanceMoneyID1" field="assistanceMoney" onchange="countTotle();" style="display:none"></label>
						<input type="text" maxlength="14"
							name="户月保障金" title="户月保障金" id="assistanceMoneyID" onchange="countTotle();" field="assistanceMoney" style="width:80%;display:block" />
						...
						<td class="FieldInput" style="width: 18%"><input type="text" maxlength="14"
							name="分类施保金" title="分类施保金" field="assistanceClassMoney" onchange="countTotle();" id="assistanceClassMoneyID"  style="width:80%" /></td>	
					...
					<tr>
                        <td class="FieldLabel" style="width: 15%">变更事项</td>
                        <td class="FieldInput" style="width: 18%" colspan="5">
                        <input type="checkbox" name="changeItem" id="changeItem01" value="01" onclick="changeItemClick(this)">增加保障金 &nbsp;&nbsp;
                        <input type="checkbox" name="changeItem" id="changeItem02" value="02" onclick="changeItemClick(this)">减少保障金 &nbsp;&nbsp;
                        <input type="checkbox" name="changeItem" id="changeItem03" value="03" onclick="changeItemClick(this)">停发保障金 &nbsp;&nbsp;
                        <input type="checkbox" name="changeItem" id="changeItem04" value="04" onclick="changeItemClick(this)">变更户主或其他家庭成员
                        <font color="red">*</font>
                        </td>
                    </tr>
					
				    <tr>
						<td class="FieldLabel" style="width: 15%">变更原因</td>
						<td class="FieldInput" style="width: 18%" colspan="5"><textarea name="变更原因" id="applyReason" title="变更原因"
		...
		<next:GridPanel id="peoplePanel" titleCollapse="true" collapsible="true"  stripeRows="true" autoHeight="true" dataset="peopleListDataSet" title="家庭成员基本信息" >
			<next:TopBar>
					<next:ToolBarItem symbol="->" ></next:ToolBarItem>
					<next:ToolBarItem id="peopleChange" iconCls="detail" text="变更户主" handler="changePeopleRelationshipType"  disabled="" />
					<next:ToolBarItem id="peopleAdd" iconCls="add" text="新增" handler="addPeople"  disabled="" />
					<next:ToolBarItem id="changePeopleID" iconCls="detail" text="修改" handler="changePeople" />
					<next:ToolBarItem id="cancelPeopleID" iconCls="detail" text="注销" handler="cancelPeople" />
					<next:ToolBarItem id="removePeopleID" iconCls="remove" text="删除" handler="removePeople" />
			...
			<next:Columns>
				...
				<next:Column  id="name" field="NAME" header="姓名" width="60">
				...
				<next:Column  field="PERSONAL_STATS_TAG" header="人员状态" width="140" renderer="getPersonalStatsTag">
				</next:Column>
			</next:Columns>
		</next:GridPanel>
			...
			<fieldset><legend>入户调查</legend>
				...
				<table width="100%">
					...
					<tr>						
						...
						<td class="FieldInput" style="width: 10%"><input type="text"
							name="评议日期" title="评议日期" field="discussionDate" style="width:80%"  format="Y-m-d" onclick="LoushangDate(this)" readonly="readonly"/></td>
					</tr>
					<tr>						
						<td class="FieldLabel" style="width: 10%">评议人数量</td>
						<td class="FieldInput" style="width: 10%">
						<input type="text"  name="评议总人数" title="评议总人数" field="total"id="total" onchange="countDiscussionNum();"  maxlength="2" style="width:80%" /></td>				
						<td class="FieldLabel" style="width: 10%">同意人数</td>
						<td class="FieldInput" style="width: 10%"><input type="text"
							name="同意人数" title="同意人数" id="agreeNum" field="agreeNum" maxlength="2"  onchange="countDiscussionNum();" style="width:80%" /></td>	
						<td class="FieldLabel" style="width: 10%">不同意人数</td>
						<td class="FieldInput" style="width: 10%"><input type="text"
							name="不同意人数" title="不同意人数" field="disagreeNum" maxlength="2" style="width:80%" /></td>
					</tr>
					</table>
				</fieldset>
				</form>
				...
				<table width="100%">
					<tr>						
						...
						<td class="FieldInput" style="width: 10%"><input type="text"
							name="公示开始日期" title="公示开始日期" field="beginDate" style="width:80%" format="Y-m-d" onclick="LoushangDate(this)" readonly="readonly" /></td>
						<td class="FieldLabel" style="width: 10%">公示结束日期</td>
						<td class="FieldInput" style="width: 10%"><input type="text"
							name="公示结束日期" title="公示结束日期" field="endDate" style="width:80%" format="Y-m-d" onclick="LoushangDate(this)" readonly="readonly" /></td>	
					</tr>
					<tr>						
...
<next:Panel title="审核意见信息" id="checkDetailPanel" titleCollapse="true" collapsible="true"  autoHeight="true" autoScroll="true">
			<next:Html>
				<form  method="post" onsubmit="return false" class="L5form" dataset="checkSurveyDataset">
			<fieldset><legend>入户调查</legend>
				<table width="100%">
					<tr>						
						<td class="FieldLabel" style="width: 10%">调查结果</td>
				...
				<form  method="post" onsubmit="return false" class="L5form" dataset="checkNoticeDataset">
					<fieldset><legend>公示结果</legend>
				<table width="100%">
					<tr>						
						<td class="FieldLabel" style="width: 10%">公示结果</td>
						...
						<td class="FieldLabel" style="width: 10%">公示开始日期</td>
						<td class="FieldInput" style="width: 10%"><label field="beginDate"></label></td>
						<td class="FieldLabel" style="width: 10%">公示结束日期</td>
						<td class="FieldInput" style="width: 10%"><label field="endDate"></label></td>
					</tr>
					<tr>						
						<td class="FieldLabel" style="width: 10%">经办人</td>
						<td class="FieldInput" style="width: 10%"><label field="principal"></label></td>
						<td class="FieldInput" colspan="4"></td>				
					</tr>
				</table>
				</fieldset>
				</form>
					<form  method="post" onsubmit="return false" class="L5form" dataset="applyDataSet">
					<fieldset><legend>审核意见</legend>
				<table width="100%">
					<tr>
						<td class="FieldLabel" style="width: 10%" >审核意见</td>
						<td class="FieldInput" style="width: 10%" colspan="5">
							<textarea name="applyReason" style="width:98%;background-color:#F5FAFA;border:0;overflow:auto;"  readonly
										field="checkRemarks" /></textarea>
						</td>
					</tr>
					<tr>						
						<td class="FieldLabel" style="width: 10%">审核结果</td>
						...
						<td class="FieldLabel" style="width: 10%">负责人</td>
						<td class="FieldInput" style="width: 10%"><label field="checkPrincipal"></label></td>
						<td class="FieldLabel" style="width: 10%">审核日期</td>
						<td class="FieldInput" style="width: 10%"><label field="checkDate"></label></td>
					</tr>
					<tr>
					<td class="FieldLabel" style="width: 10%">经办人</td>
					<td class="FieldInput" style="width: 10%"><label
			...
			<next:Panel title="审批意见信息"id="auditDetailPanel" titleCollapse="true" collapsible="true"  autoHeight="true" autoScroll="true">
			<next:Html>
			...
			<fieldset><legend>入户调查</legend>
				...
				<table width="100%">
					<tr>
						...
						<td class="FieldInput" style="width: 10%" colspan="5">
							<textarea name="审核意见" style="width:98%;background-color:#F5FAFA;border:0;overflow:auto;"  readonly
										field="auditRemarks" /></textarea>
						</td>
					</tr>
					<tr>						
						...
						<td class="FieldInput" style="width: 10%"><label field="auditPrincipal"></label></td>
						<td class="FieldLabel" style="width: 10%">审批日期</td>
						<td class="FieldInput" style="width: 10%"><label field="auditDate"></label></td>
					</tr>
					<tr>						
						...
						<td class="FieldLabel" style="width: 10%">救助截止月份</td>
						<td class="FieldInput" style="width: 10%">
...
<!-- 回填家庭信息 -->
<next:Window id="familyQueryWin" closeAction="hide" title="回填家庭信息" width="650" height="367" modal="true">
	<next:GridPanel id='familyQueryGrid' dataset="familyQueryDataSet" height="340">
		<next:Columns>
		    <next:RadioBoxColumn></next:RadioBoxColumn> 	
			<next:Column field="FAMILY_NAME" header="姓名" width="70"><next:TextField /></next:Column>	
			<next:Column field="FAMILY_CARD_NO" header="身份证号" width="140"><next:TextField /></next:Column>
			<next:Column field="FAMILY_CARD_NO" header="性别" width="50" renderer="getFamilySex"><next:TextField /></next:Column>
			<next:Column field="FAMILY_CARD_NO" header="年龄" width="50" renderer="getFamilyAge"><next:TextField /></next:Column>
			<next:Column field="ADDRESS" header="居住地址" width="240"><next:TextField /></next:Column>
		</next:Columns>	
		<next:BottomBar>
			<next:PagingToolBar dataset="familyQueryDataSet" />
		</next:BottomBar>
		<next:Buttons>
			<next:ToolButton text="回填" handler="confirmFamilyQueryWin"></next:ToolButton>
			<next:ToolButton text="关闭" handler="closeFamilyQueryWin"></next:ToolButton>
		</next:Buttons>
	</next:GridPanel>	
</next:Window>
		
<next:Window id="cancelPeopleWin" title='人员注销' closeAction="hide" width="400" modal="true">
	<next:TopBar>
		<next:ToolBarItem symbol="->" ></next:ToolBarItem>
		<next:ToolBarItem iconCls="add" text="确定" handler="confirmCancelPeopleWin"></next:ToolBarItem>
		<next:ToolBarItem iconCls="return" text="关闭" handler="closeCancelPeopleWin"></next:ToolBarItem>
	</next:TopBar>
	<next:Html>
		<table width="100%" >
			<tr>
				<td class="FieldLabel" style="width:20%">注销原因</td>
				<td class="FieldInput" style="width:80%">
					<select id="personalStatsTag" title='注销原因' name='注销原因' style="width:80%" >
						<option dataset='samPersonalCancelStatsDataSet'></option>
