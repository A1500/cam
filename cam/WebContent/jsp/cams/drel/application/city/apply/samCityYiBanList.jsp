...
function detail(applyId,FAMILY_ID){
	...
	var url='samCityDetail.jsp?method=detail&name='+nameValue+'&applyId='+applyId+"&hrefFlg="+getCurrent();
	...
	<model:dataset id="applyDataSet" cmd="com.inspur.cams.drel.sam.cmd.SamApplyInfoQueryCmd" method="queryYiBan" global="true"  >
		<model:params>
			...
			<next:Panel width="100%" height="100%">
							...
							<form class="L5form">
								<table  border="1" width="100%">
									...
									<tr>
						                ...
						                <td class="FieldInput" style="width:10%"><input type="text"  id="familyName" style='width:80%' maxlength="80"/></td>
				...
				<next:GridPanel id="YiBanGridPanel" title="已办业务列表" dataset="applyDataSet" width="100%" height="100%" stripeRows="true" clickToSelectedForChkSM="true">
					<next:TopBar>		
						<next:ToolBarItem symbol="->"></next:ToolBarItem>	
                        <next:ToolBarItem iconCls="print"  text="打印公示书" handler="printCityYiBan"/>     
					</next:TopBar>
					<next:Columns>
