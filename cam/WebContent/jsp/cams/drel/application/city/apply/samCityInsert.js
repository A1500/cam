...
function prepareForInsert(){
	...
	if(ActivityName == "check"){
		familyDataSet.newRecord({"assistanceMode":"10",belonging:"04","applyDate":nowTime,"address":address,
		...
		familyDataSet.newRecord({"domicileName":organName,"domicileCode":organArea,"assistanceMode":"10",belonging:"04","applyDate":nowTime,"address":address,
		"regId":regId,"regOrg":regOrg,"regOrgName":regOrgName,"regPeople":regPeople,"regTime":regTime,"regOrgType":regOrgType,"apanageName":organName,"apanageCode":organArea});
...
function scanFiles(){
    ...
    var url="../../../../../comm/arch/archUploadfile.jsp?applyId="+applyId+"&sysType=sam&applyType=010"+"&fileName="+encodeURI(encodeURI(familyDataSet.get("familyName")))+"&hrefFlg="+getCurrent();
