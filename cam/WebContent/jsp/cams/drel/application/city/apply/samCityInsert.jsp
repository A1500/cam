			...
			<next:Html>
				...
				<table width="100%">
					...
					<tr>
						...
						<td class="FieldInput" style="width: 18%"><input type="text" maxlength="6" title="邮政编码" field="familyPostcode" style="width:80%" /></td>						
					</tr>
					<tr>
				    ...
				    <tr>
						...
						<td class="FieldInput" style="width: 18%" colspan="5"><textarea name="申请理由" id="applyReason" title="申请理由"
