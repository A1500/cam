...
var time1 = '';
	...
	function ensureDetail(){
		...
		var _url="../../../comm/ensureInfo/peopleInfoDetail.jsp?commissionId="+records[0].get("APPLY_ID");
	...
	function getEnsureFlg(value,cellmeta,record,rowindex,colindex,dataset){
		if(value!=""){
			return '已反馈'
		}else{
			return '未反馈'
				...
				<next:Panel title="待办业务查询" width="100%" autoHeight="true" titleCollapse="true" collapsible="true"  >	
				 ...
				 <next:GridPanel  clickToSelectedForChkSM="true"id="daiBanGridPanel" title="待办业务列表" dataset="applyDataSet" width="100%" height="100%" stripeRows="true" notSelectFirstRow="true">
					<next:TopBar>		
						...
						%>	
						<next:ToolBarItem iconCls="detail"  text="查看核对信息" handler="ensureDetail"/>
					...
					<next:Columns>
						...
						<next:Column header="核对状态" field="ENSURE_ID" width="140" renderer="getEnsureFlg"></next:Column>
						<%
