...
<model:datasets>
	...
	<model:dataset id="baseinfoPeopleDataSet" cmd="com.inspur.cams.drel.sam.cmd.BaseinfoPeopleQueryCmd" global="true"  >
		<model:record fromBean="com.inspur.cams.comm.baseinfo.data.BaseinfoPeople">
			...
			<model:field name="incomeMonth" type="string" rule="require|regex{^[0-9]{1,16}}" />
	...
	<next:Html>
		...
		<tr>
			...
			<tr>
				...
				<td class="FieldInput"><select name='是否“三无”' title='是否“三无”' id="isThreeNo" style="width:90%"> <option dataset="comm_yesorno"> </option></select><font color="red">*</font></td>
				<td class="FieldLabel">月收入（元）</td>
				<td class="FieldInput"><input name="月收入（元）" id='incomeMonthD' type="text" field='incomeMonth' style="width:90%" maxlength="14" /><font color="red">*</font></td>
				<td class="FieldLabel">与户主关系</td>
				<td class="FieldInput" colspan="2"><select id="relationshipType" style="width:90%" name="与户主关系"  title="与户主关系" field="relationshipType" style="width:90%" onblur='hasSelf()'> <option dataset="relationshipTypeDataset"></option> </select><font color="red">*</font></td>
			</tr>
			<tr>
				...
				<td class="FieldInput" colspan='2'>
					<select name="属别" title="属别" id="belonging" style="width:90%" >
