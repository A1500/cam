...
<script type="text/javascript" src="cityFamilyDetail.js"></script>
...
<model:datasets>
  ...
  <next:Panel width="100%" height="100%" autoScroll="true" id="tab">
				...
				<tr>
					...
					<td class="FieldInput" style="width: 18%" rowspan="4">
						<div id="photoDiv"><img id="img" name="FAMILY_IMG" width=140 height=90
							src="<%=SkinUtils.getRootUrl(request) %>skins/images/family.png" align="top"
	...
	<next:GridPanel id="supportPanel"titleCollapse="true" collapsible="true"  stripeRows="true"  autoHeight="true" dataset="supportListDataset" notSelectFirstRow="true" title="监护人信息">
