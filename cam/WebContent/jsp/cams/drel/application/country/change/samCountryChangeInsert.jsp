...
<script type="text/javascript" src="samCountryChangeInsert.js"></script>
...
<model:datasets>
	...
	<model:dataset id="familyQueryDataSet" cmd="com.inspur.cams.drel.sam.cmd.BaseinfoFamilyQueryCmd" method="querySamFamilyList" global="true">
		<model:params>
			<model:param name="assistanceType" value='02'></model:param>
		</model:params>
	</model:dataset>
	<!-- 家庭房产信息 -->
			...
			<next:Html>
				...
				<table width="100%">
					...
					<tr>
						...
						<td class="FieldInput" style="width: 18%" colspan="5"><textarea name="变更原因"
