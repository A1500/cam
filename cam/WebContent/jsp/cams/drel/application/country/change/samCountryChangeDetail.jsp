...
<script type="text/javascript" src="samCountryChangeDetail.js"></script>
...
<model:datasets>
	...
	<!-- 审核入户调查 -->
	<model:dataset id="checkSurveyDataset" cmd="com.inspur.cams.drel.sam.cmd.SamApplySurveyQueryCmd" global="true" >
	...
	<!-- 审核公示结果 -->
	<model:dataset id="checkNoticeDataset" cmd="com.inspur.cams.drel.sam.cmd.SamApplyNoticeQueryCmd" global="true" >
		<model:record fromBean="com.inspur.cams.drel.sam.data.SamApplyNotice">
...
<!-- 银行账户信息 -->
   ...
   <next:Panel  height="100%" autoScroll="true" id="tab">
		<next:TopBar>
				...
				<next:ToolBarItem iconCls="save" id="saveId" disabled="" text="保存" handler="save"/>
				<next:ToolBarItem iconCls="select" id="submitId" disabled="" text="提交" handler="submitApply"/>
				<%
					}
				%>	
	...
	<next:Panel title="家庭基本信息" titleCollapse="true" collapsible="true"  autoHeight="true" autoScroll="true">
			<next:TopBar>
				<next:ToolBarItem symbol="->"></next:ToolBarItem>
				<next:ToolBarItem iconCls="detail" text="家庭详细信息" handler="detailexpand"/>
		</next:TopBar>
			<next:Html>
				...
				<table width="100%">
					...
					<tr>
						...
						<td class="FieldInput" style="width: 18%"><label
							name="家庭年总收入" title="家庭年总收入" field="yearIncome" style="width:80%" ></label></td>
						<td class="FieldLabel" style="width: 15%">家庭年均收入（元）</td>
						<td class="FieldInput" style="width: 18%"><label
							name="家庭年均收入" title="家庭年均收入" field="yearAverageIncome" style="width:80%" ></label></td>
				...
				<tr>
					...
					<td class="FieldInput" style="width: 18%"><label name="联系电话"
						title="联系电话" field="familyPostcode" style="width: 80%"></label></td>
				...
				<tr>
					...
					<td class="FieldInput" style="width: 18%" id="assistanceMoney">
						<input type="text" name="户月保障金" title="户月保障金"  maxlength="16"onchange="countTotle();" id="assistanceMoneyID"
							field="assistanceMoney" style="width:80%" />
					</td>
					<td class="FieldInput" style="width: 18%" id="assistanceMoneyL">
						<label  field="assistanceMoney"onchange="countTotle();" id="assistanceMoneyID1" ></label>					
					</td>
                ...
                <tr>
					...
					<tr>
						...
						<td class="FieldInput" style="width: 18%" colspan="5"><textarea name="applyReason" style="width:98%;background-color:#F5FAFA;border:0;overflow:auto;"  readonly
										field="applyReason" /></textarea></td>
					</tr>
				</table>
				</form>
	...
	<next:Panel title="入户调查|评议|公示结果信息" id="panel2"  titleCollapse="true" collapsible="true"  autoHeight="true" autoScroll="true">
			<next:Html>
			...
			<fieldset><legend>入户调查</legend>
				...
				<table width="100%">
					<tr>
						...
						<textarea name="评议内容" style="width:98%;background-color:#F5FAFA;border:0;overflow:auto;"  readonly
					...
					<tr>						
						...
						<td class="FieldInput" style="width: 10%">
						<label field="discussionResult" dataset="discussionResultDataSet" ></label>
						</td>			
						...
						<td class="FieldInput" style="width: 10%"><label  field="discussionDate" ></label></td>
					</tr>
					<tr>						
				...
				<table width="100%">
					<tr>						
						...
						<td class="FieldInput" style="width: 10%">
						<label field="noticeResult" dataset="noticeResultDataSet"></label>
						</td>				
...
<next:Panel title="审核意见信息" id="checkDetailPanel" titleCollapse="true" collapsible="true"  autoHeight="true" autoScroll="true">
				...
				<table width="100%">
					...
					<tr>						
						...
						<td class="FieldLabel" style="width: 10%">
							<label id="beginDateLD" style="display:none">救助截止月份</label>
							<label id="beginDateSLD" style="display:none">救助开始月份</label>
						</td>
						<td class="FieldInput" style="width: 10%">
		...
		<next:Panel title="审核意见信息" id="checkEditPanel" titleCollapse="true" collapsible="true"  autoHeight="true" autoScroll="true">
			<next:Html>
				<form  method="post" onsubmit="return false" class="L5form" dataset="checkSurveyDataset">
			<fieldset><legend>入户调查</legend>
				<table width="100%">
				...
				<table width="100%">
					<tr>						
						<td class="FieldLabel" style="width: 10%">公示结果</td>
						<td class="FieldInput" style="width: 10%"><select name="公示结果" title="公示结果" field="noticeResult"  style="width:80%"  ><option dataset="noticeResultDataSet"></option></select>
						</td>			
						<td class="FieldLabel" style="width: 10%">公示开始日期</td>
						<td class="FieldInput" style="width: 10%">
						<input type="text" title="公示开始日期" name="公示开始日期" field="beginDate" style="width:80%"  format="Y-m-d" onclick="LoushangDate(this)" readonly="readonly"/>
						</td>
						<td class="FieldLabel" style="width: 10%">公示结束日期</td>
						<td class="FieldInput" style="width: 10%">
					...
					<tr>						
						<td class="FieldLabel" style="width: 10%">经办人</td>
						<td class="FieldInput" style="width: 10%"><input type="text" maxlength="16" title="经办人" name="经办人" style="width:80%" field="principal"/></td>
						<td class="FieldInput" colspan="4"></td>				
					</tr>
				</table>
				</fieldset>
				...
				<table width="100%">
					<tr>
						<td class="FieldLabel" style="width: 10%" >审核意见</td>
						<td class="FieldInput" style="width: 10%" colspan="5">
							<textarea name="审核意见" title="审核意见" 
										field="checkRemarks" style="width: 97%"   /></textarea>
						</td>
					</tr>
					<tr>						
						<td class="FieldLabel" style="width: 10%">审核结果</td>
						<td class="FieldInput" style="width: 10%">
						<select name="审核结果" title="审核结果" field="checkOpinionId"  style="width:80%"  ><option dataset="opinionDataSet"></option></select>
						<font color="red">*</font></td>
						<td class="FieldLabel" style="width: 10%">负责人</td>
						<td class="FieldInput" style="width: 10%">
						<input type="text" title="负责人" name="负责人" maxlength="16" style="width:80%" field="checkPrincipal"/>
						<font color="red">*</font></td>
						<td class="FieldLabel" style="width: 10%">审核日期</td>
						<td class="FieldInput" style="width: 10%">
						<input type="text" title="审核日期" name="审核日期" field="checkDate" style="width:80%"  format="Y-m-d" onclick="LoushangDate(this)" readonly="readonly"/>
						<font color="red">*</font></td>
					</tr>
				<tr>
					<td class="FieldLabel" style="width: 10%">经办人</td>
	...
	<next:Panel title="审批意见信息"id="auditEditPanel" titleCollapse="true" collapsible="true"  autoHeight="true" autoScroll="true">
			<next:Html>
				<form  method="post" onsubmit="return false" class="L5form" dataset="auditSurveyDataset">
			<fieldset><legend>入户调查</legend>
				<table width="100%">
				...
				<table width="100%">
					...
					<tr>						
						...
						<td class="FieldLabel" style="width: 10%">民政局负责人</td>
						<td class="FieldInput" style="width: 10%">
						<input type="text" title="民政局负责人" name="民政局负责人" maxlength="16" style="width:80%" field="auditPrincipal"/>
						<font color="red">*</font></td>
						<td class="FieldLabel" style="width: 10%">审批日期</td>
						<td class="FieldInput" style="width: 10%">
				...
				<table width="100%">
					<tr>						
						...
						<font color="red">*</font></td>			
						<td class="FieldLabel" style="width: 10%">公示开始日期</td>
						<td class="FieldInput" style="width: 10%"><input type="text" title="公示开始日期" name="公示开始日期" field="beginDate" style="width:80%"  format="Y-m-d" onclick="LoushangDate(this)" readonly="readonly"/>
						<font color="red">*</font></td>
						<td class="FieldLabel" style="width: 10%">公示结束日期</td>
						<td class="FieldInput" style="width: 10%">
						<input type="text" title="公示结束日期" name="公示结束日期" field="endDate" style="width:80%"  format="Y-m-d" onclick="LoushangDate(this)" readonly="readonly"/><font color="red">*</font>
						</td>
					</tr>
					<tr>						
						<td class="FieldLabel" style="width: 10%">经办人</td>
