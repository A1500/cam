...
function handle(){
	...
	if(records&&records.length==1){
	    ...
	    var beginDate=records[0].get("BEGIN_DATE");
	  	var url="samCountryInChangeInsert.jsp?treatmentId="+treatmentId+"&assistanceType="+assistanceType+"&applyId="+applyId+"&hrefFlg="+getCurrent()+"&beginDate="+beginDate;
...
<next:Panel width="100%" height="100%">
	<next:Panel title="查询条件" width="100%" autoHeight="true" titleCollapse="true" collapsible="true"  >	
	 ...
	 <next:GridPanel  clickToSelectedForChkSM="true"id="familyPanel" title="农村低保家庭列表" dataset="baseinfoFamilyDS" width="100%" height="100%" stripeRows="true" notSelectFirstRow="true">
		<next:TopBar>		
