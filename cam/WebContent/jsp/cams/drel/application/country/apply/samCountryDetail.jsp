...
<script type="text/javascript" src="samCountryDetail.js"></script>
<script type="text/javascript"
		...
		<next:Html>
			...
			<table width="100%">
				...
				<tr>
					...
					<td class="FieldInput" style="width: 18%"><label  field="familyPostcode" style="width: 80%"></label></td>
				...
				<tr>
					...
					<td class="FieldInput" style="width: 18%" id="assistanceMoney">
						<input type="text" name="户月保障金" onchange="countTotle();"  title="户月保障金"  maxlength="16"
							field="assistanceMoney" style="width:80%" id="assistanceMoneyID" />
					</td>
					...
					<td class="FieldInput" style="width: 18%" id="assistanceClassMoney" >
						<input type="text" name="分类施保金" maxlength="16" onchange="countTotle();" 
							title="分类施保金" field="assistanceClassMoney" id="assistanceClassMoneyID" style="width:80%" />
					</td>
