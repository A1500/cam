	...
	<next:TabPanel width="100%" height="100%">
		<next:Tabs>
			...
			<next:Panel title="新申请待办" width="100%" height="100%">
				<next:Html>
				   <iframe id="newApplyDaiBanIframe" src="samCountryDaiBanList.jsp?name=<%=request.getParameter("name")%>&flag=<%=request.getParameter("flag")%>"
			...
			<next:Panel title="新申请已办" width="100%" height="100%">
				<next:Html>
				   <iframe id="newApplyYiBanIframe" src="samCountryYiBanList.jsp?name=<%=request.getParameter("name")%>"
							frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="100%">
		   		   </iframe>
				</next:Html>
			</next:Panel>
			<next:Panel title="新申请结束" width="100%" height="100%">
				<next:Html>
				   <iframe id="newApplyJieShuIframe" src="samCountryJieShuList.jsp?name=<%=request.getParameter("name")%>"
							frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" width="100%" height="100%">
		   		   </iframe>
				</next:Html>
			</next:Panel>
