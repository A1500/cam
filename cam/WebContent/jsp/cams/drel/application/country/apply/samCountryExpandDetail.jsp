...
function init(){
    ...
    supportedPeopleDataSet.on('load',getHouseListDataset);
}
function getHouseListDataset(ds){
	ds.un("load",getHouseListDataset);
...
function detailSupport(supportId){
	var width = 850;
    var height = 187;
	var url="../../../comm/supportDetail.jsp?familyId="+familyId+"&supportId="+supportId+"&assistanceType=02";
