...
<script type="text/javascript" src="samBatchHandleAudit.js"></script>
...
<next:Panel width="100%" height="100%" title="批量审批" autoHeight="true" titleCollapse="true" autoScroll="true" >
	<next:GridPanel  clickToSelectedForChkSM="true" dataset="applyListDataSet" width="100%" height="200" stripeRows="true" notSelectFirstRow="true">
		<next:Columns>
        	...
        	<next:Column header="变更事项" field="changeItem" width="150" dataset="samChangeItemDs"></next:Column>
		</next:Columns>
		<next:BottomBar>
