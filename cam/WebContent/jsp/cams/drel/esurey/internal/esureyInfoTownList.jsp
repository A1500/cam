...
<html>
	<head>
		<title>城乡居民家庭经济状况乡镇（街道）审核列表</title>
		<next:ScriptManager/>
<script type="text/javascript">
		...
		<script type="text/javascript" src="esureyInfoTownList.js"></script>		
...
<model:datasets>
	...
	<model:dataset id="shDataset" cmd="com.inspur.cams.drel.esurey.cmd.SamEsureyFamilyQueryCmd" autoLoad="true" global="true">
		<model:record fromBean="com.inspur.cams.drel.esurey.data.SamEsureyFamily"></model:record>
	</model:dataset>
	<!-- 家庭性质 -->
...
<next:GridPanel id="esurey_Grid" name="esurey_Grid"   dataset="EsureyFamilyDS"  stripeRows="true" title="城乡居民家庭经济状况申报列表"  width="100%" height="99.9%">
	<next:TopBar>
		<next:ToolBarItem symbol="->" ></next:ToolBarItem>
		<next:ToolBarItem text="修改" iconCls="edit" handler="edit_esurey" ></next:ToolBarItem>
		<next:ToolBarItem text="审核" iconCls="edit" handler="check_esurey"></next:ToolBarItem>
	</next:TopBar>
	<next:Columns>
		...
		<next:Column id="familyCardNo" header="户主身份证件号码" field="familyCardNo" width="20%">
			<next:TextField />
		</next:Column>
		...
		<next:Column id="curActivity" header="当前环节" field="curActivity" width="10%"  dataset="curDS">
			<next:TextField />
		</next:Column>
		<next:Column id="curState" header="当前环节状态" field="curState"  dataset="curStatusDS" width="15%">
			<next:TextField />
		</next:Column>
	</next:Columns>
	<next:BottomBar>
