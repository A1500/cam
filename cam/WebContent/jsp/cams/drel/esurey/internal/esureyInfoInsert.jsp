...
<script type="text/javascript" src="esureyInfoInsert.js"></script>
...
<!--申报家庭基本信息-->
	<model:dataset id="esureyFamilyDS3" cmd="com.inspur.cams.drel.esurey.cmd.SamEsureyFamilyQueryCmd">
		<model:record fromBean="com.inspur.cams.drel.esurey.data.SamEsureyFamily"></model:record>
	</model:dataset>
<!--申报家庭基本信息-->
	<model:dataset id="esureyFamilyDS5" cmd="com.inspur.cams.drel.esurey.cmd.SamEsureyFamilyQueryCmd">
		<model:record fromBean="com.inspur.cams.drel.esurey.data.SamEsureyFamily"></model:record>
	</model:dataset>	
	<!-- 家庭信息 -->
...
<next:Panel name="fit-div" width="100%" height="100%">
	<next:FitLayout>
<!--	申报家庭基本信息	-->
		<next:Panel id="jtjbxxPanel" autoWidth="true" height="100%" title="申报家庭基本信息" >
			<next:TopBar>
				<next:ToolBarItem symbol="->"></next:ToolBarItem>
				<next:ToolBarItem iconCls="save" text="保存至下一步(维护家庭成员)" handler="nextJtcy()"/>
				<next:ToolBarItem iconCls="undo" text="返回主页" handler="return_list1"/>				
				<next:ToolBarItem symbol=""></next:ToolBarItem>
				<next:ToolBarItem symbol="-"></next:ToolBarItem>
				<next:ToolBarItem symbol=""></next:ToolBarItem>
			</next:TopBar>
		...
		<next:Tabs>
			<next:Panel title="困难户家庭信息"   autoHeight="true" >
				<next:AnchorLayout>
					...
					<table border="0"  width="100%" >
				  		<tr >
							...
							<td class="FieldInput">
								<input type="text" id="familyCardNo" name="身份证号:" field="familyCardNo"  onchange="check_isDoing();"  style="width:70%" maxlength="18" class="TextEditor" /><font color="red">*</font><br/>
								<button onclick="forHistoryInfo()">信息检索</button>
							</td>	
							<td class="FieldLabel" colspan="2">户主姓名:</td>
							<td class="FieldInput">
								<input type="text" id="familyName" name="户主姓名:" field="familyName" onchange="back_name(this.value);" style="width:70%" maxlength="25" class="TextEditor" /><font color="red">*</font>
							</td>	
						</tr>
				  		<tr >	
							...
							<td class="FieldInput">
								<select id="domicileType" name="家庭性质:" field="domicileType" style="width:70%" onchange="backType(this.options[this.options.selectedIndex]);">
									<option dataset="familyTypeDS"></option>
				  		...
				  		<tr >			
							...
							<td class="FieldInput">
								<select id="assistanceType" name="救助类型" field="assistanceType"  style="width:70%"><option dataset="assistanceTypeDS"></option></select>
								<font color="red">*</font>
							</td>	
							<td class="FieldLabel" colspan="2">邮政编码:</td>
							<td class="FieldInput">
								<input type="text" id="familyPostcode" name="邮政编码: " field="familyPostcode" style="width:70%" maxlength="6" class="TextEditor" />
							</td>		
						</tr>
				  		<tr >		
							<td class="FieldLabel" colspan="2">户籍行政区划:</td>
							<td class="FieldInput">
								<input type="text" id="regAddress" name="户籍行政区划:" field="domicileName"  style="width:70%" onclick="func_ForDomicileSelect()" readonly="readonly" class="TextEditor" /><font color="red">*</font>
								<input type="hidden" id="regAddressh" name="户籍行政区划:" field="regAddress"/>
							</td>
							<td class="FieldLabel" colspan="2">属地行政区划:</td>
							<td class="FieldInput">
								<label id="familyAddress" name="属地行政区划:" field="apanageName"  style="width:70%"></label>
							</td>	
						</tr>		
				  		<tr >	
						...
						<tr>
							...
							<td class="FieldInput" width="26%">
								<input type="text" id="familyPhone" name="宅电:" field="familyPhone" style="width:70%" maxlength="20" class="TextEditor" />
							</td>
						...
						<tr>
							...
							<td class="FieldInput">
								<input type="text" id="familyMobile" name="手机:" field="familyMobile" style="width:70%" maxlength="20" class="TextEditor" />
							</td>
						...
						<tr>
							...
							<td class="FieldInput">
								<input type="text" name="其他:" id="familyOtherPhone" field="familyOtherPhone" class="TextEditor" maxlength="50" style="width:70%" />
							</td>
							<td class="FieldLabel" style="width: 110px;">房屋面积:<br/>(单位：平方米)</td>
							<td class="FieldInput">
								<input type="text" id="buildArea" name="房屋面积:" field="buildArea" class="TextEditor"  style="width:70%" maxlength="16"/>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="FieldInput">
								<input type="text" name="家庭年人均:" id="yearAverageIncome" field="yearAverageIncome" disabled="disabled" class="TextEditor" />
								<span><font color=green>自动生成</font></span>
							</td>
						...
						<tr >	
							<td class="FieldLabel" colspan="2">年赡（抚、扶）养费:<br/>(单位：元)</td>
							<td class="FieldInput">
								<input type="text" id="yearSupportMon" name="年赡（抚、扶）养费:" field="yearSupportMon" onchange="workOutSupMIncome();" disabled="disabled"  maxlength="16" class="TextEditor" />
								<br/><span><font color=red>农村户籍填写*</font></span>
							</td>
							<td class="FieldLabel" colspan="2">月赡（抚、扶）养费:<br/>(单位：元)</td>
							<td class="FieldInput">
								<input type="text" id="monthSupportMonon" name="月赡（抚、扶）养费:" field="monthSupportMonon" onchange="workOutSupYIncome();" disabled="disabled" maxlength="16" class="TextEditor"/>
								<br/><span><font color=red>城市户籍填写*</font></span>
							</td>		
						</tr>
					</table>
			...
			<next:Panel title="户主基本信息"   autoHeight="true" >
			  <next:AnchorLayout>
				<next:Panel title="基本信息" collapsible="true" height="100%"  width="100%"  autoScroll="true" >
			     <next:Html>
                  	<form id="cyjbxxForm"  onsubmit="return false"   dataset="esureyPeopleDS3" class="L5form" >
						<table border="0"  width="100%">
					  		<tr >
								<td class="FieldLabel" width="20%">姓名:</td>
								<td class="FieldInput" width="30%">
									<input type="text" id="hname" name="姓名:" field="name"  class="TextEditor" maxlength="25" readonly="readonly" style="width:65%"/><font color="red">*</font>
								</td>	
								<td class="FieldLabel" width="20%">与户主关系:</td>
								<td class="FieldInput" width="30%">
									<select name="与户主关系:" id="hrelationshipType" field="relationshipType" disabled="disabled" style="width:65%"><option dataset="RelationDS"></option></select><font color="red">*</font>
								</td>		
							</tr>
					  		<tr >	
								<td class="FieldLabel">身份证号:</td>
								<td class="FieldInput">
									<input type="text" name="身份证号:" id="hidCard" field="idCard" readonly="readonly" maxlength="18" class="TextEditor" style="width:65%"/><font color="red">*</font>
								</td>
								<td class="FieldLabel">性别:</td>
								<td class="FieldInput">
									<select name="性别" field="sex"  id="hsex" style="width:65%">
					  		...
					  		<tr >			
								...
								<td class="FieldInput">
									<select  name="民族:" id="hnation" field="nation" style="width:65%"><option  dataset="DmMzDataSet" ></option></select><font color="red">*</font>
								</td>	
					  		...
					  		<tr >		
								...
								<td class="FieldInput" colspan="3">
									<select name="户口性质" id="hdomicileType" field="domicileType" disabled="disabled" style="width:26%">
										<option dataset="familyTypeDS"></option>
									</select><font color="red">*</font>
								</td>
							</tr>	
					  		<tr >		
								...
								<td class="FieldInput">
									<input type="text" name="hincomeYear" id="hincomeYear" field="incomeYear" disabled="disabled" maxlength="16" style="width:65%" onchange="workOutMIncome();" class="TextEditor" />
									<br/><span><font color=red>农村户籍必须填写*</font></span>
								</td>
								<td class="FieldLabel">月收入:<br/>(单位：元)</td>
								<td class="FieldInput">
									<input type="text" name="hincomeMonth" id="hincomeMonth" field="incomeMonth" disabled="disabled" maxlength="16" style="width:65%" onchange="workOutYIncome();" class="TextEditor" />
					  		...
					  		<tr >		
								...
								<td class="FieldInput" colspan="3">
									<input type="text" id="hworkUnitName" field="workUnitName" maxlength="50" class="TextEditor" style="width:65%"/>
								</td>
							</tr>			
						</table>
					</form>
		...
		<next:Panel title="户主经济信息" id = "peopleEsur_panel"  name="peopleEsur_panel" height="600" >
			  <next:AnchorLayout>
				<next:Panel title="经济信息" collapsible="true" name="tabPanels3" animCollapse="true"   width="100%"   >
			    <next:Panel >
                  <next:Html>
						...
						<table border="0"  width="99%" height="100%">
					  		<tr >
								...
								<td class="FieldInput" width="25%">
									<label id="hcyName"   ></label>
								</td>	
								<td class="FieldLabel" width="20%">身份证号:</td>
								<td class="FieldInput" width="25%">
									<label id="hcyIdCard"  ></label>
								</td>
							</tr>
						</table>
					</form>
              ...
              <next:Panel   width="100%" height="100%"  autoScroll="true">
				<next:EditGridPanel  id="social_grid" name="social_grid" autoWidth="true" height="200" clicksToEdit="1" dataset="SamEsureySocialDS">
					<next:TopBar>
					...
					<next:Columns>
						...
						<next:Column id="hsYearMonth" header="年月标志"  field="yearMonth" >
						...
						<next:Column id="hsSalary" header="工资、养老金金额(/元)"  field="salary" width="150">
							<next:NumberField allowBlank="false"/>
						</next:Column>
						<next:Column id="hsPension" header="养老金缴纳金额(/元)"  field="pension" width="150">
							<next:TextField allowBlank="false"/>
						</next:Column>
						<next:Column id="hsPensionBalance" header="养老金余额(/元)"  field="pensionBalance" width="150">
							<next:TextField allowBlank="false"/>
						</next:Column>
					</next:Columns>
				</next:EditGridPanel>
				
				<next:EditGridPanel  id="estate_grid" name="estate_grid" autoWidth="true" height="200" clicksToEdit="1" dataset="SamEsureyPeopleEstateDS">
					<next:TopBar>
              ...
              <next:EditGridPanel  id="house_grid" name="house_grid" autoWidth="true" height="200" clicksToEdit="1" dataset="SamEsureyHouseDS">
					<next:TopBar>
					...
					<next:Columns>
						...
						<next:Column id="hhouseArea" header="建筑面积(平方米)"  field="houseArea" width="150">
							<next:NumberField allowBlank="false"/>
						</next:Column>
					</next:Columns>
				</next:EditGridPanel>
				
				<next:EditGridPanel  id="business_grid" name="business_grid" autoWidth="true" height="200" clicksToEdit="1"  dataset="SamEsureyBusinessDS">
					<next:TopBar>
				...
				<next:EditGridPanel  id="car_grid" name="car_grid" autoWidth="true" height="200" clicksToEdit="1" dataset="SamEsureyCarDS">
					<next:TopBar>
				...
				<next:EditGridPanel  id="tax_grid" name="tax_grid" autoWidth="true" height="200" clicksToEdit="1" dataset="SamEsureyTaxDS">
					<next:TopBar>
					...
					<next:Columns>
						...
						<next:Column id="hturnoverLatestYear" header="最近一年营业额(/元)"  field="turnoverLatestYear" width="150">
							<next:NumberField allowBlank="false"/>
						</next:Column>
						<next:Column id="htaxesLatestYear" header="最近一年纳税额(/元)"  field="taxesLatestYear" width="150">
							<next:NumberField allowBlank="false"/>
						</next:Column>
					</next:Columns>
				</next:EditGridPanel>
				
				<next:EditGridPanel  id="tax2_grid" name="tax2_grid" autoWidth="true" height="200" clicksToEdit="1" dataset="SamEsureyTaxDS2">
					<next:TopBar>
						<next:ToolBarItem text="本成员地税信息列表:"></next:ToolBarItem>
						<next:ToolBarItem symbol="->" ></next:ToolBarItem>
					...
					<next:Columns>
						...
						<next:Column id="hurnoverLatestYearx" header="最近一年营业额(/元)"  field="turnoverLatestYear" width="150">
							<next:NumberField allowBlank="false"/>
						</next:Column>
						<next:Column id="haxesLatestYearx" header="最近一年纳税额(/元)"  field="taxesLatestYear" width="150">
							<next:NumberField allowBlank="false"/>
						</next:Column>
					</next:Columns>
				</next:EditGridPanel>
				
				<next:EditGridPanel  id="fund_grid" name="fund_grid" autoWidth="true" height="200" clicksToEdit="1" dataset="SamEsureyHousingFundDS">
					<next:TopBar>
					...
					<next:Columns>
						...
						<next:Column id="hcollectNum" header="历史提取金额合计(/元)"  field="collectNum" width="150">
							<next:NumberField allowBlank="false"/>
						</next:Column>
					</next:Columns>
				</next:EditGridPanel>
				
				<next:EditGridPanel  id="bank_grid" name="bank_grid" autoWidth="true" height="200" clicksToEdit="1" dataset="SamEsureyBankDS">
					<next:TopBar>
					...
					<next:Columns>
						...
						<next:Column id="htotalSavings" header="存款金额合计(/元)"  field="totalSavings" width="150">
							<next:NumberField allowBlank="false"/>
						</next:Column>
				...
				<next:EditGridPanel  id="securities_grid" name="securities_grid" autoWidth="true" height="200" clicksToEdit="1" dataset="SamEsureySecuritiesDS">
					<next:TopBar>
					...
					<next:Columns>
						...
						<next:Column id="hstock" header="股票市值总金额(/元)"  field="stock" width="150">
							<next:NumberField allowBlank="false"/>
						</next:Column>
						<next:Column id="hfund" header="基金市值总金额(/元)"  field="fund" width="150">
							<next:NumberField allowBlank="false"/>
						</next:Column>
						<next:Column id="hmoney" header="资金总余额(/元)"  field="money" width="150">
							<next:NumberField allowBlank="false"/>
						</next:Column>
					</next:Columns>
				</next:EditGridPanel>
				
				<next:EditGridPanel  id="insurance_grid" name="insurance_grid" autoWidth="true" height="200" clicksToEdit="1" dataset="SamEsureyInsuranceDS">
					<next:TopBar>
					...
					<next:Columns>
						...
						<next:Column id="hbenefitNum" header="保险受益金额(/元)"  field="benefitNum" width="150">
							<next:NumberField allowBlank="false"/>
						</next:Column>
					</next:Columns>
				</next:EditGridPanel>
...
<!--	申报家庭成员信息	-->
		<next:Panel id="jtcyxxPanel" width="100%" height="100%" title="申报家庭成员信息"
				autoScroll="true">
			<next:TopBar>
				<next:ToolBarItem symbol="->"></next:ToolBarItem>
				<next:ToolBarItem iconCls="save" text="录入完成保存" handler="allSave()"/>
				<next:ToolBarItem iconCls="save" text="添加赡（抚、扶）养信息" handler="add_sfEsurey()"/>
			</next:TopBar>
			
			<next:GridPanel id="jtcyGridPanel" name="jtcyGridPanel" width="100%" stripeRows="true" height="400" 
				dataset="esureyPeopleDS">
				<next:TopBar>
					<next:ToolBarItem text="共同生活家庭成员列表:"></next:ToolBarItem>
					<next:ToolBarItem symbol="->" ></next:ToolBarItem>
					<next:ToolBarItem iconCls="add" text="添加家庭成员" handler="addFamilyMember()"/>
					<next:ToolBarItem iconCls="edit" text="修改家庭成员" handler="editFamilyMember()"/>
					<next:ToolBarItem iconCls="remove" text="删除家庭成员" handler="deleteFamilyMember()"/>
				</next:TopBar>
				<next:Columns>
				    <next:RowNumberColumn width="10"/>
                  	...
                  	<form id="cyjbxxForm" method="post" onsubmit="return false"   dataset="esureyPeopleDS2" class="L5form" >
						<table border="0"  width="100%">
					  		<tr >
								...
								<td class="FieldLabel" width="20%">与户主关系:</td>
								<td class="FieldInput" width="30%">
									<select  name="与户主关系:" id="relationshipType" field="relationshipType" style="width:90%" disabled="disabled" ><option dataset="RelationDS"></option></select>
									<font color="red">*</font>
								</td>		
							</tr>
					  		<tr >	
								<td class="FieldLabel">身份证号:</td>
								<td class="FieldInput">
									<input type="text" name="身份证号:" id="idCard" field="idCard" onchange="check_peopleIdCard();" maxlength="18" disabled="disabled" style="width:90%" class="TextEditor" />
									<font color="red">*</font>
								</td>
								<td class="FieldLabel">性别:</td>
								<td class="FieldInput">
					  		...
					  		<tr>			
								<td class="FieldLabel">民族:</td>
								<td class="FieldInput">
									<select  name="民族:" id="nation" field="nation" style="width:90%"><option  dataset="DmMzDataSet" ></option></select>
									<font color="red">*</font>
								</td>	
								<td class="FieldLabel">文化程度:</td>
								<td class="FieldInput">
					  		...
					  		<tr >		
								<td class="FieldLabel">年收入:<br/>(单位：元)</td>
								<td class="FieldInput">
									<input type="text" name="年收入:" id="incomeYear" field="incomeYear" disabled="disabled" onchange="workOutMIncome2();" maxlength="16" style="width:90%" class="TextEditor" />
									<br/><span><font color=red>农村户籍必须填写*</font></span>
								</td>
								<td class="FieldLabel">月收入:<br/>(单位：元)</td>
								<td class="FieldInput">
									<input type="text" name="月收入:" id="incomeMonth" field="incomeMonth" disabled="disabled" onchange="workOutYIncome2();" maxlength="16" style="width:90%" class="TextEditor" />
									<br/><span><font color=red>城市户籍必须填写*</font></span>
								</td>	
							</tr>	
					  		<tr >		
								<td class="FieldLabel">工作单位:</td>
								<td class="FieldInput" colspan="3">
									<input type="text" id="workUnitName" field="workUnitName" class="TextEditor" style="width:96%" maxlength="50" />
								</td>
							</tr>			
						</table>
					</form>
...
<!--	成员经济状况信息	-->
              <next:Panel title="本成员经济状况信息" width="100%" height="100%">
               ...
               <next:Panel width="100%" height="100%"  autoScroll="true" >
				<next:EditGridPanel  id="wsocial_grid" name="wsocial_grid"  height="150" collapsible="true" title="本成员社保列表" clicksToEdit="1" dataset="SamEsureySocialDS">
					<next:TopBar>
						<next:ToolBarItem symbol="->" ></next:ToolBarItem>
						<next:ToolBarItem iconCls="add" text="添加" handler="addSocial"/>
				...
				<next:EditGridPanel  id="westate_grid" name="westate_grid"  height="150" collapsible="true" title="本成员其他财产收入列表" clicksToEdit="1" dataset="SamEsureyPeopleEstateDS">
					<next:TopBar>
						<next:ToolBarItem symbol="->" ></next:ToolBarItem>
						<next:ToolBarItem iconCls="add" text="添加" handler="add_estate"/>
              ...
              <next:EditGridPanel  id="whouse_grid" name="whouse_grid"  height="150" collapsible="true" title="本成员房屋信息列表" clicksToEdit="1" dataset="SamEsureyHouseDS">
					<next:TopBar>
						<next:ToolBarItem symbol="->" ></next:ToolBarItem>
						<next:ToolBarItem iconCls="add" text="添加" handler="add_house"/>
				...
				<next:EditGridPanel  id="wbusiness_grid" name="wbusiness_grid" height="150" collapsible="true" title="本成员工商经营信息列表" clicksToEdit="1"  dataset="SamEsureyBusinessDS">
					<next:TopBar>
						<next:ToolBarItem symbol="->" ></next:ToolBarItem>
						<next:ToolBarItem iconCls="add" text="添加" handler="add_business"/>
				...
				<next:EditGridPanel  id="wcar_grid" name="wcar_grid" height="150"  collapsible="true" title="本成员车辆信息列表" clicksToEdit="1" dataset="SamEsureyCarDS">
					<next:TopBar>
						<next:ToolBarItem symbol="->" ></next:ToolBarItem>
						<next:ToolBarItem iconCls="add" text="添加" handler="add_car"/>
				...
				<next:EditGridPanel  id="wtax_grid" name="wtax_grid"  height="150"  collapsible="true" title="本成员国税信息列表" clicksToEdit="1" dataset="SamEsureyTaxDS">
					<next:TopBar>
						<next:ToolBarItem symbol="->" ></next:ToolBarItem>
						<next:ToolBarItem iconCls="add" text="添加" handler="add_tax"/>
				...
				<next:EditGridPanel  id="wdtax_grid" name="wdtax_grid"  height="150"  collapsible="true" title="本成员地税信息列表" clicksToEdit="1" dataset="SamEsureyTaxDS2">
					<next:TopBar>
						<next:ToolBarItem symbol="->" ></next:ToolBarItem>
						<next:ToolBarItem iconCls="add" text="添加" handler="add_tax2"/>
						<next:ToolBarItem iconCls="remove" text="删除" handler="delete_tax22"/>
				...
				<next:EditGridPanel  id="wfund_grid" name="wfund_grid"  height="150"  collapsible="true" title="本成员公积金信息列表" clicksToEdit="1" dataset="SamEsureyHousingFundDS">
					<next:TopBar>
						<next:ToolBarItem symbol="->" ></next:ToolBarItem>
						<next:ToolBarItem iconCls="add" text="添加" handler="add_fund"/>
						<next:ToolBarItem iconCls="remove" text="删除" handler="delete_fund"/>
				...
				<next:EditGridPanel  id="wbank_grid" name="wbank_grid"  height="150"  collapsible="true" title="本成员人民银行信息列表" clicksToEdit="1" dataset="SamEsureyBankDS">
					<next:TopBar>
						<next:ToolBarItem symbol="->" ></next:ToolBarItem>
						<next:ToolBarItem iconCls="add" text="添加" handler="add_bank"/>
						<next:ToolBarItem iconCls="remove" text="删除" handler="delete_bank"/>
				...
				<next:EditGridPanel  id="wsecurities_grid" name="wsecurities_grid"  height="150"  collapsible="true" title="本成员证监列表" clicksToEdit="1" dataset="SamEsureySecuritiesDS">
					<next:TopBar>
						<next:ToolBarItem symbol="->" ></next:ToolBarItem>
						<next:ToolBarItem iconCls="add" text="添加" handler="add_securities"/>
						<next:ToolBarItem iconCls="remove" text="删除" handler="delete_securities"/>
				...
				<next:EditGridPanel  id="winsurance_grid" name="winsurance_grid" height="200"  collapsible="true" title="本成员保险信息列表" clicksToEdit="1" dataset="SamEsureyInsuranceDS">
					<next:TopBar>
						<next:ToolBarItem symbol="->" ></next:ToolBarItem>
						<next:ToolBarItem iconCls="add" text="添加" handler="add_insurance"/>
						<next:ToolBarItem iconCls="remove" text="删除" handler="delete_insurance"/>
...
<next:Window id="family_help" title="帮助信息"  width="410" height="370" collapsible="true" closeAction="hide" animCollapse="true" resizable="true">
	...
	<next:GridPanel id="base_family" name="base_family" autoWidth="true" height="160" disableSelection="true" stripeRows="true" title="困难户家庭" notSelectFirstRow="true" collapsible="true"  autoScroll="true" dataset="baseFamilyDS">
				<next:Columns>		
		...
		<next:GridPanel id="esurey_family" name="esurey_family" autoWidth="true" height="160" disableSelection="true" stripeRows="true" title="经济核对家庭" notSelectFirstRow="true" collapsible="true"  autoScroll="true" dataset="esureyFamilyDS3">
				<next:Columns>		
					<next:CheckBoxColumn></next:CheckBoxColumn>		 
