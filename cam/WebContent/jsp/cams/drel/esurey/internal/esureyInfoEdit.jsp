...
<head>
	<next:ScriptManager/>
	<script type="text/javascript" src="esureyInfoEdit.js"></script>
...
<!--申报家庭基本信息-->
	...
	<!--申报赡养家庭基本信息-->
	<model:dataset id="esureyFamilyDS2" cmd="com.inspur.cams.drel.esurey.cmd.SamEsureyFamilyQueryCmd">
		<model:record fromBean="com.inspur.cams.drel.esurey.data.SamEsureyFamily">
		</model:record>
	</model:dataset>
<!--申报家庭成员基本信息-->
...
<!--申报家庭成员基本信息-->
	...
	<!--申报家庭成员基本信息-->
	<model:dataset id="esureyPeopleDS5" cmd="com.inspur.cams.drel.esurey.cmd.SamEsureyPeopleQueryCmd">
		<model:record fromBean="com.inspur.cams.drel.esurey.data.SamEsureyPeople"></model:record>
	</model:dataset>
	<!--申报家庭成员基本信息-->
	<model:dataset id="esureyPeopleDS6" cmd="com.inspur.cams.drel.esurey.cmd.SamEsureyPeopleQueryCmd">
		<model:record fromBean="com.inspur.cams.drel.esurey.data.SamEsureyPeople"></model:record>
	</model:dataset>		
<!--申报家庭成员社保基本信息-->
...
<next:Panel name="fit-div" width="100%" height="100%" autoScroll="true" collapsible="true">
		<next:TopBar>
			<next:ToolBarItem symbol="->"></next:ToolBarItem>
			<next:ToolBarItem iconCls="save" text="保存家庭信息" handler="save_family"/>				
			<next:ToolBarItem iconCls="undo" text="返回" handler="return_list"/>
		</next:TopBar>
<!--	申报家庭基本信息	-->
			<next:Panel title="家庭基本信息"  autoWidth="true" autoHeight="true" collapsible="true" >
					<next:Html>
					...
					<table border="0"  width="100%" >
				  		...
				  		<tr >			
							...
							<td class="FieldInput">
								<input type="text" id="familyPostcode" name="邮政编码: " field="familyPostcode" maxlength="6" style="width:70%" class="TextEditor" />
							</td>		
						</tr>
				  		<tr >		
							<td class="FieldLabel" colspan="2">户籍行政区划:</td>
							<td class="FieldInput">
								<input type="text" id="regAddress"  field="domicileName" onclick="func_ForDomicileSelect()" class="TextEditor" style="width:70%" />
								<font color="red">*</font>
								<input type="hidden" id="regAddressh" field="regAddress"/>
							</td>
						...
						<tr>
							...
							<td class="FieldInput" width="26%">
								<input type="text" id="familyPhone" name="宅电:" field="familyPhone" maxlength="20" class="TextEditor" style="width:70%" />
							</td>
						...
						<tr>
							...
							<td class="FieldInput">
								<select id="buildingStructure" name="房屋性质:" field="buildingStructure" style="width:70%" disabled="disabled">
						...
						<tr>
							...
							<td class="FieldInput">
								<input type="text" id="buildArea" name="房屋面积(平方):" field="buildArea" class="TextEditor" maxlength="16" disabled="disabled" style="width:70%"/>
							</td>
						</tr>
						<tr>
							...
							<td class="FieldInput">
								<input type="text" id="yearIncome" name="家庭年:" field="yearIncome" disabled="disabled" style="width:70%" class="TextEditor" />
								<span><br/><font color=green>自动生成</font></span>
							</td>
							<td class="FieldLabel" rowspan="2">收入情况</td>
							<td class="FieldLabel">家庭月：<br/>(单位：元)</td>
							<td class="FieldInput">
								<input type="text" id="monthIncome" name="家庭月:" field="monthIncome" disabled="disabled" style="width:70%" class="TextEditor" />
								<span><br/><font color=green>自动生成</font></span>
							</td>
						</tr>
						<tr>
							...
							<td class="FieldInput">
								<input type="text" name="家庭年人均:" id="yearAverageIncome" field="yearAverageIncome" style="width:70%" disabled="disabled" class="TextEditor" />
								<span><br/><font color=green>自动生成</font></span>
							</td>
							<td class="FieldLabel" >家庭月人均：<br/>(单位：元)</td>
							<td class="FieldInput">
								<input type="text" id="monthAverageIncome" name="家庭月人均:" field="monthAverageIncome" style="width:70%" disabled="disabled" class="TextEditor" />
								<span><br/><font color=green>自动生成</font></span>
							</td>
						</tr>
						<tr >	
							...
							<td class="FieldInput">
								<input type="text" id="yearSupportMon" name="年赡（抚、扶）养费:" field="yearSupportMon" onchange="workOutSupMIncome();" style="width:70%" disabled="disabled"  maxlength="16"/>
								<br/><span><font color=red>农村户籍填写*</font></span>
							</td>
							<td class="FieldLabel" colspan="2">月赡（抚、扶）养费：<br/>(单位：元)</td>
							<td class="FieldInput">
								<input type="text" id="monthSupportMonon" name="月赡（抚、扶）养费:" field="monthSupportMonon" onchange="workOutSupYIncome();" style="width:70%" disabled="disabled"  maxlength="16"/>
			 ...
			 <next:GridPanel id="jtcyGridPanel" name="jtcyGridPanel" autoWidth="true" stripeRows="true" height="200" title="共同生活家庭成员列表" collapsible="true" autoScroll="true" dataset="esureyPeopleDS">
				<next:TopBar>
					<next:ToolBarItem symbol="->"></next:ToolBarItem>
					<next:ToolBarItem iconCls="add" text="新增" handler="addFamilyMember()"/>
					<next:ToolBarItem iconCls="edit" text="修改" handler="editFamilyMember()"/>
					<next:ToolBarItem iconCls="delete" text="删除" handler="deleteFamilyMember()"/>										
				</next:TopBar>
				<next:Columns>
				    <next:RadioBoxColumn></next:RadioBoxColumn>
				    <next:Column id="peopleId" header="人员Id" field="peopleId" hidden="true" width="10%" >
					</next:Column>
					...
					<next:Column id="relationshipType" header="户主关系" field="relationshipType" width="10%" dataset="RelationDS">
					</next:Column>
					...
					<next:Column   header="年收入(单位：元)" field="incomeYear"  width="10%" >
					</next:Column>
					<next:Column  header="月收入(单位：元)" field="incomeMonth"  width="10%" >
					</next:Column>
				</next:Columns> 
		</next:GridPanel>    

		<next:GridPanel id="supGridPanel" name="supGridPanel" autoWidth="true" stripeRows="true" height="200" title="赡（抚、扶）养家庭列表" collapsible="true" autoScroll="true" dataset="esureyFamilyDS2">
				<next:TopBar>
					<next:ToolBarItem symbol="->"></next:ToolBarItem>
					<next:ToolBarItem iconCls="add" text="新增" handler="add_supFamily"/>
					<next:ToolBarItem iconCls="edit" text="修改" handler="edit_supFamily"/>
					<next:ToolBarItem iconCls="detail" text="详细" handler="detail_supFamily"/>
					<next:ToolBarItem iconCls="delete" text="删除" handler="delete_supFamily" />
				</next:TopBar>
				<next:Columns>
				    <next:RadioBoxColumn></next:RadioBoxColumn>
					<next:Column id="sfamilyId" header="家庭Id" field="familyId" hidden="true" width="10%" >
					</next:Column>
					<next:Column id="sfamilyName" header="户主姓名" field="familyName"   width="10%"  >
					</next:Column>
					<next:Column id="sfamilyCardNo" header="身份证号" field="familyCardNo" width="20%" >
					</next:Column>
					<next:Column id="speopleNum" header="人口数量" field="peopleNum" width="10%"  >
					</next:Column>
					<next:Column id="sdomicileType" header="家庭性质" field="domicileType" width="15%" dataset="familyTypeDS"  >
					</next:Column>			
				</next:Columns> 
		</next:GridPanel>	
</next:Panel>	

<next:Window id="jtcyEdit" title="编辑" titleCollapse="false"  resizable="true" width="800"  height="400" closeAction="hide">
     	<next:TopBar>
			<next:ToolBarItem symbol="->" ></next:ToolBarItem>
						...
						<table border="0"  width="100%">
					  		<tr >
								...
								<td class="FieldInput" width="30%">
									<input type="text" id="name" name="姓名:" field="name" onchange="backfillName(this.value)" style="width:90%" maxlength="25" class="TextEditor" />
									<font color=red>*</font>
								</td>	
					  		...
					  		<tr >	
								...
								<td class="FieldInput">
									<input type="text" name="身份证号:" id="idCard" field="idCard" onchange="check_IdCard();" disabled="disabled" style="width:90%" maxlength="18" class="TextEditor" />
									<font color=red>*</font>
								</td>
					  		...
					  		<tr >		
								...
								<td class="FieldInput">
									<input type="text" name="incomeYear" id="incomeYear" field="incomeYear" disabled="disabled" onchange="workOutMIncome2();" style="width:90%" class="TextEditor" />
									<br/><span><font color=red>农村户籍必须填写*</font></span>
								</td>
								<td class="FieldLabel">月收入：<br/>(单位：元)</td>
								<td class="FieldInput">
									<input type="text" name="incomeMonth" id="incomeMonth" field="incomeMonth" disabled="disabled" onchange="workOutYIncome2();" style="width:90%" class="TextEditor" />
...
<!--	成员经济状况信息	-->
                  	...
                  	<form id="cyjjzkxxForm" method="post" onsubmit="return false" class="L5form" >
						<table border="0"  width="100%" >
					  		<tr >
								<td class="FieldLabel" width="20%">姓名:</td>
								<td class="FieldInput" width="30%">
									<label id="cyName" ></label>
								</td>	
								<td class="FieldLabel" width="20%">身份证号:</td>
								<td class="FieldInput" width="30%">
									<label id="cyIdCard" ></label>
								</td>
							</tr>
						</table>
					</form>
              ...
              <next:Panel   width="100%" height="100%"  autoScroll="true">
				<next:EditGridPanel  id="wsocial_grid" name="wsocial_grid" autoWidth="true" height="150" title="社保列表" clicksToEdit="2" dataset="SamEsureySocialDS">
					<next:TopBar>
						<next:ToolBarItem symbol="->" ></next:ToolBarItem>
					...
					<next:Columns>
						...
						<next:RadioBoxColumn></next:RadioBoxColumn>
						<next:Column id="sId" header="流水ID"  field="id" hidden="true">    
							<next:TextField allowBlank="false"/>
						</next:Column>
						<next:Column id="sType" header="信息类别"  field="type"  hidden="true">
							<next:TextField allowBlank="false"/>
						</next:Column>
						<next:Column id="sFeedbackId" header="填表Id"  field="feedbackId" hidden="true">
							<next:TextField allowBlank="false"/>
						</next:Column>
						<next:Column id="sPeopleId" header="人员Id"  field="peopleId" hidden="true">
							<next:TextField allowBlank="false"/>
						</next:Column>
						...
						<next:Column id="sSalaryType" header="工资类别"  field="salaryType" width="20%">
							<next:ComboBox triggerAction="all" valueField="value" displayField="text" dataset="salaryDS"/>
						</next:Column>
						<next:Column id="sSalary" header="工资或养老金金额(/元)"  field="salary" width="20%">
				...
				<next:EditGridPanel  id="westate_grid" name="westate_grid" autoWidth="true" height="150" title="其他财产收入列表" clicksToEdit="2" dataset="SamEsureyPeopleEstateDS">
					<next:TopBar>
						<next:ToolBarItem symbol="->" ></next:ToolBarItem>
              ...
              <next:EditGridPanel  id="whouse_grid" name="whouse_grid" autoWidth="true" height="150" title="房屋信息列表" clicksToEdit="2" dataset="SamEsureyHouseDS">
					<next:TopBar>
						<next:ToolBarItem symbol="->" ></next:ToolBarItem>
				...
				<next:EditGridPanel  id="wbusiness_grid" name="wbusiness_grid" autoWidth="true" height="150" title="工商经营信息列表" clicksToEdit="2"  dataset="SamEsureyBusinessDS">
					<next:TopBar>
						<next:ToolBarItem symbol="->" ></next:ToolBarItem>
					...
					<next:Columns>
						...
						<next:Column id="regFund" header="注册资金(/元)"  field="regFund" >
							<next:NumberField allowBlank="false" />
						</next:Column>
				...
				<next:EditGridPanel  id="wcar_grid" name="wcar_grid" autoWidth="true" height="150" title="车辆信息列表" clicksToEdit="2" dataset="SamEsureyCarDS">
					<next:TopBar>
						<next:ToolBarItem symbol="->" ></next:ToolBarItem>
				...
				<next:EditGridPanel  id="wtax_grid" name="wtax_grid" autoWidth="true" height="150" title="国税信息列表" clicksToEdit="2" dataset="SamEsureyTaxDS">
					<next:TopBar>
						<next:ToolBarItem symbol="->" ></next:ToolBarItem>
					...
					<next:Columns>
						...
						<next:Column id="taxesOrg" header="纳税企业名称"  field="taxesOrg" width="20%">
							<next:TextField allowBlank="false"/>
						</next:Column>
				...
				<next:EditGridPanel  id="wdtax_grid" name="wdtax_grid" autoWidth="true" height="150" title="地税信息列表" clicksToEdit="2" dataset="SamEsureyTaxDS2">
					<next:TopBar>
						<next:ToolBarItem symbol="->" ></next:ToolBarItem>
					...
					<next:Columns>
						...
						<next:Column id="dtaxesPeople" header="纳税人姓名"  field="taxesPeople" width="15%">
							<next:TextField allowBlank="false"/>
						</next:Column>
						<next:Column id="dtaxesOrg" header="纳税企业名称"  field="taxesOrg" width="20%">
							<next:TextField allowBlank="false"/>
						</next:Column>
				...
				<next:EditGridPanel  id="wfund_grid" name="wfund_grid" autoWidth="true" height="150" title="公积金信息列表" clicksToEdit="2" dataset="SamEsureyHousingFundDS">
					<next:TopBar>
						<next:ToolBarItem symbol="->" ></next:ToolBarItem>
					...
					<next:Columns>
						...
						<next:Column id="fName" header="姓名"  field="name" width="15%">
							<next:TextField allowBlank="false"/>
						</next:Column>
				...
				<next:EditGridPanel  id="wbank_grid" name="wbank_grid" autoWidth="true" height="150" title="人民银行信息列表" clicksToEdit="2" dataset="SamEsureyBankDS">
					<next:TopBar>
						<next:ToolBarItem symbol="->" ></next:ToolBarItem>
				...
				<next:EditGridPanel  id="wsecurities_grid" name="wsecurities_grid" autoWidth="true" height="150" title="证监列表" clicksToEdit="2" dataset="SamEsureySecuritiesDS">
					<next:TopBar>
						<next:ToolBarItem symbol="->" ></next:ToolBarItem>
					...
					<next:Columns>
						...
						<next:Column id="eName" header="开户人姓名"  field="name" width="15%">
							<next:TextField allowBlank="false"/>
						</next:Column>
				...
				<next:EditGridPanel  id="winsurance_grid" name="winsurance_grid" autoWidth="true" height="200" title="保险信息列表" clicksToEdit="2" dataset="SamEsureyInsuranceDS">
					<next:TopBar>
						<next:ToolBarItem symbol="->" ></next:ToolBarItem>
