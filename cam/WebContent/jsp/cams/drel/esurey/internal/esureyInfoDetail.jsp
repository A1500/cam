...
<head>
	...
	<next:ScriptManager/>
	<script type="text/javascript" src="esureyInfoDetail.js"></script>		
...
<!--申报家庭成员基本信息-->
	<model:dataset id="esureyPeopleDS4" cmd="com.inspur.cams.drel.esurey.cmd.SamEsureyPeopleQueryCmd" method="querySupportPeo" pageSize="5">
		<model:record fromBean="com.inspur.cams.drel.esurey.data.SamEsureyPeople"></model:record>
	</model:dataset>
<!--申报信息_抚养关系-->
...
<next:Panel name="fit-div" width="100%" height="100%"  collapsible="true">
			...
			<next:Html>
				<form id="sbjtjbxxForm" method="post" onsubmit="return false"  dataset="esureyFamilyDS"
					class="L5form" >
					<table border="0"  width="100%" >
						...
						<tr>
							...
							<td class="FieldInput">
								<label id="buildArea" name="房屋面积:" field="buildArea"  ></label>
							</td>
						</tr>
						<tr>
		...
		<next:GridPanel id="jtcyGridPanel" name="jtcyGridPanel" autoWidth="true" stripeRows="true" height="200" title="共同生活家庭成员列表" collapsible="true"
				...
				<next:Columns>
					...
					<next:Column id="name" header="成员姓名" field="name" width="15%" renderer="peopleDetailHref">
					</next:Column>
		...
		<next:GridPanel id="jtcysfGridPanel" name="jtcysfGridPanel" autoWidth="true" stripeRows="true" height="200" title="赡（抚、扶）养义务人员列表" collapsible="true"
				dataset="esureyPeopleDS4">
				<next:TopBar>
					<next:ToolBarItem symbol="->"></next:ToolBarItem>
