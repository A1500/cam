//页面初始化方法
function init(){
	L5.getCmp("tabpanel-div").setActiveTab("0");
	//家庭信息
	...
	esureyPeopleDS3.setParameter("familyId",familyId);
...
function save_onclick(){
    ...
    if(_$("checkOpinion")==""){
    	L5.Msg.alert("提示","审核意见必须填写！");
    	return;
    }
    if(esureyFamily.get("checkOpinion")==1){
		esureyFamily.set("curActivity","02");
		esureyFamily.set("curState","4");
    }else{
		esureyFamily.set("curActivity","03");
    ...
    command.setParameter("signType", "check");
