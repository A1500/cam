...
<html>
	<head>
		<title>申报家庭信息查询</title>
		<next:ScriptManager/>
		<script type="text/javascript" src="esureyInfoCheck.js"></script>
					...
					<form style="width: 98%; height: 100%;" class="L5form">
						<table  border="1" width="100%" >
							<tr >
								...
								<td class="FieldInput">
									<input type="text"  id="shzt" class="TextEditor" title="审核状态"   />
								</td>	
							</tr><tr>
...
<next:GridPanel id="sbjtxxGridPanel" name="sbjtxxGridPanel" width="100%" height="400" notSelectFirstRow="true" 
	stripeRows="true" dataset="declareFamilyInfoDataset" title="->  您的位置 : 申报家庭信息审核">	
	
	<next:TopBar>
		<next:ToolBarItem text="申报家庭基本信息列表:"></next:ToolBarItem>
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
		<next:ToolBarItem iconCls="detail" text="详细" handler="query"/>
		<next:ToolBarItem iconCls="edit" text="修改" handler="query"/>
		<next:ToolBarItem iconCls="search" text="审核" handler="query"/>
		<next:ToolBarItem symbol=""></next:ToolBarItem>
		<next:ToolBarItem symbol="-"></next:ToolBarItem>
		<next:ToolBarItem symbol=""></next:ToolBarItem>
	</next:TopBar>
