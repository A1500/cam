...
<script type="text/javascript" src="queryInOut.js"></script>
...
<body>
<model:datasets>
	<model:dataset id="samGeroKeptPersonDataSet" cmd="com.inspur.cams.drel.samu.cmd.SamGeroKeptPersonQueryCmd" method="queryInoutRecord"  pageSize="15">
		...
		<form class="L5form">
			<table border="1" width="100%">
				...
				<tr>
					...
					<td class="FieldLabel" style="width:10%">入院时间</td>
					<td class="FieldInput" style="width:20%"><input type="text" id="startInDate" format="Y-m-d" onclick="LoushangDate(this)" style="width:40%" readonly="readonly"/>
		                        至<input type="text" id="endInDate" format="Y-m-d" onclick="LoushangDate(this)" style="width:40%" readonly="readonly"/></td>
					<td class="FieldLabel" style="width:10%">出院时间</td>
					<td class="FieldInput" style="width:20%"><input type="text" id="startOutDate" format="Y-m-d" onclick="LoushangDate(this)" style="width:40%" readonly="readonly"/>
		                        至<input type="text" id="endOutDate" format="Y-m-d" onclick="LoushangDate(this)" style="width:40%" readonly="readonly"/></td>
...
<next:EditGridPanel id="grid" dataset="samGeroKeptPersonDataSet" width="100%" stripeRows="true" height="99.9%">
	...
	<next:Columns>
		...
		<next:Column field="AGE" header="年龄"  sortable="false"/>
		<next:Column field="FAMILY_ADD" header="家庭住址"  sortable="false"/>
		<next:Column field="CURRENT_IN_ROOM" header="所在房间"  sortable="false"/>
		<next:Column field="CURRENT_IN_BED" header="所用床位"  sortable="false"/>
		<next:Column field="IN_DATE" header="入院时间" ></next:Column>
		<next:Column field="OUT_DATE" header="出院时间" ></next:Column>
