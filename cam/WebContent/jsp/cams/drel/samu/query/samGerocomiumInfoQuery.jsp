		...
		<form class="L5form">
			<table border="1" width="100%">
				...
				<tr>
					...
					<td class="FieldLabel" style="width: 10%">房屋性质：</td>
					<td class="FieldInput" style="width: 20%"><select id="houseProperty"  style="width: 80%">
					<option dataset=housePropertyDataset></option></select></td>
					<td class="FieldLabel" style="width:10%">占地面积</td>
					<td class="FieldInput" style="width:20%"><input type="text" id="startArea"  style="width:40%" />
		                        至<input type="text" id="endArea"  style="width:40%" /></td>
				</tr>
				<tr>
					<td class="FieldLabel" style="width:10%">固定资产</td>
					<td class="FieldInput" style="width:20%"><input type="text" id="startAssets"  style="width:40%" />
		                        至<input type="text" id="endAssets"  style="width:40%" /></td>
		            <td class="FieldLabel" style="width:10%">五保供养标准</td>
					<td class="FieldInput" style="width:20%"><input type="text" id="startStandard"  style="width:40%" />
		                        至<input type="text" id="endStandard"  style="width:40%" /></td>
		             <td class="FieldLabel" style="width:10%">管理工作经费</td>
					<td class="FieldInput" style="width:20%"><input type="text" id="startFunds"  style="width:40%" />
		                        至<input type="text" id="endFunds"  style="width:40%" /></td>
	   
				</tr>
				<tr>
					<td class="FieldLabel" style="width:10%">年副业收入</td>
					<td class="FieldInput" style="width:20%"><input type="text" id="startIncome"  style="width:40%" />
		                        至<input type="text" id="endIncome"  style="width:40%" /></td>
...
<next:EditGridPanel id="grid" dataset="samGerocomiumInfoDataSet" width="100%" stripeRows="true" height="99.9%">
	...
	<next:Columns>
		...
		<next:Column field="year" header="年份" width="4%" sortable="false"/>
		<next:Column field="gerocomiumName" header="名称" width="10%" sortable="false"/>
