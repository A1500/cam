...
<model:datasets>
	...
	<model:dataset id="samInsertDetailDataSet" cmd="com.inspur.cams.drel.samu.cmd.SamGeroApplyQueryCmd" method="queryCheckDetail" pageSize="15">
		<model:record fromBean="com.inspur.cams.drel.samu.data.SamGeroApply"/>
		<model:record>
			<model:field name="PERSON_NAME"/>
			<model:field name="PERSON_ID"/>
...
<next:EditGridPanel id="infoQueryGrid" name="samCheckDetailDataSet"
	...
	<next:Columns>
		...
		<next:Column header="敬老院" field="GEROCOMIUM_ID" width="80" align="center"/>
...
<next:Window id="insertWin" title="增加五保对象查体信息" expandOnShow="false"
	...
	<next:EditGridPanel id="insertDetail" dataset="samGeroKeptPersonDataSet" height="100%" width="98%" clickToSelectedForChkSM="true" stripeRows="true">
		...
		<next:Columns>
   		<next:RowNumberColumn width="30"/>
   		<next:CheckBoxColumn></next:CheckBoxColumn>
		<next:Column header="姓名" field="personName" width="80" align="center" />
		<next:Column header="身份证号" field="idCard" width="135" align="center" />
		<next:Column header="敬老院" field="gerocomiumId" width="80" align="center"/>
		<next:Column header="房间" field="inRoom" width="80" align="center"/>
		<next:Column header="床位" field="inBed" width="80" align="center"/>
	</next:Columns>
	<next:BottomBar>
