...
<script type="text/javascript" src="samGerocomiumInfoInsert.js"></script>
<script type="text/javascript">
	<%
...
<next:Panel autoHeight="true" bodyStyle="width:100%">
	...
	<next:TabPanel>
		<next:Tabs>
			<next:Panel title="敬老院基本信息" width="99%" height="130%">
				<next:Html>
					...
					<table width="99%">
						...
						<tr>
							...
							<td class="FieldInput" style="width: 18%"><input type="text"
								...
								style="display: none" /><font color="red">*</font></td>
						...
						<tr>
							...
							<td class="FieldInput" style="width: 18%"><input type="text"
								name="总房间数" id="totalRoomNum" field="totalRoomNum" maxlength="50"  onblur="checkNum(this)"
								style="width: 80%" /><font color="red">*</font></td>
								
							<td class="FieldLabel" style="width: 15%">总床位数：</td>
							<td class="FieldInput" style="width: 18%"><input type="text"
								name="总床位数" id="totalBedNum" field="totalBedNum" maxlength="50" onblur="checkNum(this)"
								style="width: 80%" /><font color="red">*</font></td>
						...
						<tr>
							...
							(单位：亩)</td>
							<td class="FieldInput" style="width: 18%"><input type="text"
								name="占地面积" id="totalArea" field="totalArea" maxlength="50" onblur="formatFloat(this)"
								style="width: 80%" /><font color="red">*</font></td>
							<td class="FieldLabel" style="width: 15%">建筑面积：<br>
							(单位：平米)</td>
							<td class="FieldInput" style="width: 18%"><input type="text"
								name="建筑面积" id="buildArea" field="buildArea" maxlength="50" onblur="formatFloat(this)"
								style="width: 80%" /><font color="red">*</font></td>

							<td class="FieldLabel" style="width: 15%">室外娱乐场所面积：<br>
							(单位：平米)</td>
							<td class="FieldInput" style="width: 18%"><input type="text"
								name="室外娱乐场所面积" id="outdoorArea" field="outdoorArea" onblur="formatFloat(this)"
								maxlength="50" style="width: 80%" /><font color="red">*</font></td>
						</tr>
						<tr>
							...
							(单位：平米)</td>
							<td class="FieldInput" style="width: 18%"><input type="text"
								name="室内娱乐场所面积" id="indoorArea" field="indoorArea" onblur="formatFloat(this)"
								maxlength="50" style="width: 80%" /><font color="red">*</font></td>
						
							<td class="FieldLabel" style="width: 15%">固定资产：<br>
							(单位：万元)</td>
							<td class="FieldInput" style="width: 18%"><input type="text"
								name="固定资产" id="fixedAssets" field="fixedAssets" maxlength="50" onblur="formatFloat(this)"
								style="width: 80%" /><font color="red">*</font></td>

							<td class="FieldLabel" style="width: 15%">五保对象供养标准：<br>
							(单位：元/年)</td>
							<td class="FieldInput" style="width: 18%"><input type="text"
								name="五保对象供养标准" id="supportStandard" field="supportStandard" onblur="formatFloat(this)"
								maxlength="50" style="width: 80%" /><font color="red">*</font></td>
						</tr>
						<tr>
							...
							(单位：万元/年)</td>
							<td class="FieldInput" style="width: 18%"><input type="text"
								name="管理工作经费" id="managementFunds" field="managementFunds" onblur="formatFloat(this)"
								maxlength="50" style="width: 80%" /><font color="red">*</font></td>
							...
							(单位：亩)</td>
							<td class="FieldInput" style="width: 18%"><input type="text"
								name="年种植蔬菜面积" id="vegetablesArea" field="vegetablesArea" onblur="formatFloat(this)"
								maxlength="50" style="width: 80%" /><font color="red">*</font></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="FieldInput" style="width: 18%" colspan="5"><textarea 
								name="所服务乡镇" title="所服务乡镇" id="serveTowns" field="serveTowns" 
								style="width: 94%" readonly="readonly"/></textarea><img 
								src="<%=SkinUtils.getImage(request, "l5/help.gif")%>" 
								style="cursor: hand" onclick="func_ForServeAreaSelect()" /><font color="red">*</font><input
								type="text" id="serveTownsId" name="serveTownsId" field="serveTownsId"
		...
		<table width="100%">
			...
			<tr>
				...
				<td class="FieldInput" style="width: 18%"><input type="text"
					...
					onclick="LoushangDate(this)" readonly="readonly" style="width: 80%" /><font color="red">*</font></td>

				<td class="FieldLabel" style="width: 15%">民族：</td>
				<td class="FieldInput" style="width: 18%"><select name="民族" id="nation" field="nation" style="width: 80%">
				<option dataset="nation"></option> </select></td>

				<td class="FieldLabel" style="width: 15%">政治面貌：</td>
				<td class="FieldInput" style="width: 18%"><select name="政治面貌" id="politicsStatus" field="politicsStatus" style="width: 80%">
			...
			<tr>
				...
				<td class="FieldInput" style="width: 18%"><select
					id="salary" name="工资" title="工资"
					field="salary" style="width: 80%">
					<option dataset="samSalaryType"></option>
				</select><font color="red">*</font></td>
