			...
			<fieldset>
				...
				<table width="100%">
					...
					<tr>
						...
						<td class="FieldInput" style="width:18%"><label field="serveTowns"/></td>
					...
					<tr>
						...
						<td class="FieldLabel" style="width:15%">年种植蔬菜面积：</td>
						<td class="FieldInput" style="width:18%"><label field="vegetablesArea"/></td>
					
						<td class="FieldLabel" style="width:15%">年蔬菜产量：</td>
