...
<html>
	<head>
		<title>零花钱发放</title>
		<next:ScriptManager/>
		<script type="text/javascript" src="clothApplyDetail.js"></script>
		...
		<script language="javascript">
		    ...
		    var clothDate='<%=request.getParameter("clothDate")%>';	
		    <%
...
<next:EditGridPanel id="editGridPanel" name="samreleasedetailGrid" width="100%" stripeRows="true" height="400"  
	...
	<next:Columns>
        ...
        <next:Column id="clothDate" header="发放日期" field="CLOTH_DATE" width="90"   align="right">
        </next:Column>
