...
<%
	...
	String titel ="敬老院供养五保对象服装发放情况统计表";
%>
<script>
...
<script type="text/javascript" src="clothIssueReport.js"></script>
<style>
body {
...
<body>
<model:datasets> 
	<model:dataset id="geroApplyDs" cmd="com.inspur.cams.drel.samu.cmd.SamGeroApplyQueryCmd" method="applyClothList" global="true" pageSize="15">
			...
			<table style="border-style: hidden; width: 90%" cellpadding="0" cellspacing="0" border="0">
			   <tr>
					<td colspan="2" style="border-width: 0px">
					 ...
					 <td colspan="2" style="border-width: 0px">
					 <div align="right"><span class= "btTitle">单位：人 、套</span></div>
					</td>			
			   </tr>
				...
				<tr >
					<td colspan="4" style="border-width: 0px">
						...
						<tr>
							...
							<td class="tdTitle" width="3%"  align="center"rowspan="2"  >总人数</td>
							<td class="tdTitle" width="3%"  align="center" colspan="5" >服装（套）</td>
						</tr>
						<tr>
							<td class="tdTitle" width="3%" align="center" >总数</td>
							<td class="tdTitle" width="3%"  align="center"  >春装</td>
							<td class="tdTitle" width="3%"  align="center" >夏装</td>
							<td class="tdTitle" width="3%"  align="center" >秋装</td>
							<td class="tdTitle" width="3%"  align="center" >冬装</td>
						</tr>
					<tr>
					...
					<td style="display: none">
							...
							<td align="right" style="padding-right: 2px">
								<label style="width: 30px;height: 20px;"  field="APPLY_CLOTHNUM" renderer="nullToZero"/></label>
							</td>
							<td align="right" style="padding-right: 2px">
								<label style="width: 30px;height: 20px;"  field="SPRING_CLOTH" renderer="nullToZero"/></label>
							</td>
							<td align="right" style="padding-right: 2px">
								<label style="width: 30px;height: 20px;"  field="SUMMER_CLOTH" renderer="nullToZero"/></label>
							</td>
							<td align="right" style="padding-right: 2px">
								<label style="width: 30px;height: 20px;"  field="AUTUMN_CLOTH" renderer="nullToZero"/></label>
							</td>
							<td align="right" style="padding-right: 2px">
								<label style="width: 30px;height: 20px;"  field="WINTER_CLOTH" renderer="nullToZero"/></label>
							</td>
