...
<head>
<next:ScriptManager />
	<script type="text/javascript" src="supportInfoReport.js"></script>
...
<body>
<model:datasets> 
	<model:dataset id="ds" cmd="com.inspur.cams.drel.samu.cmd.SamGeroKeptPersonQueryCmd" global="true" method="reportSupportInfo">
						...
						<table width="99.9%" dataset="ds" align="center" >
							<tbody id="resultsBody">
								<tr>
									...
									<td class="tdTitle" width="3%" align="center" colspan="3">年龄</td>
									<td class="tdTitle" width="3%" align="center" colspan="2">性别</td>
								</tr>
							    <tr>
									<td class="tdTitle" width="3%" align="center" >平均年龄</td>
									<td class="tdTitle" width="3%" align="center" >最大年龄</td>
									<td class="tdTitle" width="3%" align="center" >最小年龄</td>
							...
							<td align="center"><a href="#"><label id="mylabel" style="width: 100px;cursor: hand;" field="NAME" onclick="queryNextLevel(this)" /></label><label style="display: none;" field="ID" /></label></a></td>
									...
									<td align="right" style="padding-right: 2px">
										<label field="AVG_AGE" size="20" readonly="true" renderer='getMoneyFormatNoPoint'/></label>
									</td>
									<td align="right" style="padding-right: 2px">
										<label field="MAX_AGE" size="20" readonly="true" renderer='nullToZero'/></label>
									</td>
									<td align="right" style="padding-right: 2px">
										<label field="MIN_AGE" size="20" readonly="true" renderer='nullToZero'/></label>
									</td>
								    <td align="right" style="padding-right: 2px">
