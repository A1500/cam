...
<script type="text/javascript" src="checkBodyReport.js"></script>
<style>
body {
...
<body>
<model:datasets> 
	<model:dataset id="geroApplyDs" cmd="com.inspur.cams.drel.samu.cmd.SamGeroApplyQueryCmd" method="applyCheckList" global="true" pageSize="15">
			...
			<table style="border-style: hidden; width: 90%" cellpadding="0" cellspacing="0" border="0">
			   <tr>
					<td colspan="2" style="border-width: 0px">
					 ...
					 <td colspan="2" style="border-width: 0px">
					 <div align="right"><span class= "btTitle">单位：人 、次</span></div>
					</td>			
			   </tr>
				<tr style="border-color: #000000;">
					...
					<td colspan="2" style="border-width: 0px">
					<div align="right"><span class= "btTitle">统计年度：<label id="statisticsTime" class= "btTitle"> </span></div>
				</tr>
				<tr >
					<td colspan="4" style="border-width: 0px">
						...
						<tr>
							...
							<td class="tdTitle" width="3%"  align="center" colspan="3" >查体</td>
						</tr>
						<tr>
							<td class="tdTitle" width="3%" align="center" >查体总人数</td>
							<td class="tdTitle" width="3%"  align="center"  >查体总人次</td>
							<td class="tdTitle" width="3%"  align="center" >平均查体次数</td>
					...
					<td style="display: none">
							...
							<td align="right" style="padding-right: 2px">
								<label style="width: 30px;height: 20px;"  field="CHECK_PEOPLENUM" renderer="nullToZero"/></label>
							</td>
							<td align="right" style="padding-right: 2px">
								<label style="width: 30px;height: 20px;"  field="CHECK_BODYNUM" renderer="nullToZero"/></label>
							</td>
							<td align="right" style="padding-right: 2px">
								<label style="width: 30px;height: 20px;"  field="AVERAGE_CHECKNUM" renderer="nullToZero"/></label>
							</td>
						</tr>
						</tbody>
						</table>
