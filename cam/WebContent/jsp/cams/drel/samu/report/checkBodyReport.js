function init(){
		...
		document.getElementById('label2').innerHTML=ds.sum("CHECK_PEOPLENUM");
		document.getElementById('label3').innerHTML=ds.sum("CHECK_BODYNUM");
		document.getElementById('label4').innerHTML=ds.sum("CHECK_PEOPLENUM")/ds.sum("CHECK_BODYNUM");
		});
}
