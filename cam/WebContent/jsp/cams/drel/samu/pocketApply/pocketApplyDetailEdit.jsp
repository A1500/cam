...
<html>
	<head>
		<title>零花钱发放</title>
		<next:ScriptManager/>
		<script type="text/javascript" src="pocketApplyDetailEdit.js"></script>
		...
		<script language="javascript">
		    ...
		    var pocketYm='<%=request.getParameter("POCKET_YM")%>';	
		    <%
...
<model:datasets>
	...
	<!-- 业务信息表 -->
	<model:dataset id="pocketApplyDetailDs" cmd="com.inspur.cams.drel.samu.cmd.SamGeroApplyQueryCmd" method="queryMoneyDetail" global="true">
...
<next:EditGridPanel id="editGridPanel" name="samreleasedetailGrid" width="100%" stripeRows="true" height="400"  
	...
	<next:Columns>
        ...
        <next:Column id="pocketYm" header="发放年月" field="POCKET_YM" width="90"   align="right">
        </next:Column>
		<next:Column id="pocketMoney" header="发放金额(元)" field="POCKET_MONEY" width="90"    align="right">
...
<next:Window id="applyDetailWin" title="增加发钱人员信息" closeAction="hide"  width="740" modal="true">
