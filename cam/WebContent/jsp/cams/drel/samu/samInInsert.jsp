...
<next:EditGridPanel id="infoQueryGrid" name="baseinfoPeopleResource"
	...
	<next:Columns>
		...
		<next:Column header="敬老院" field="SUPPORT_ORG" width="80" align="center"/>
		<next:Column header="是否在院" field="inHospital" width="80" align="center">
		<next:TextField></next:TextField>
		</next:Column>
		<next:Column header="房间" field="IN_ROOM" width="80" align="center">
		<next:TextField></next:TextField>
		</next:Column>
		<next:Column header="座位" field="IN_BED" width="80" align="center">
		<next:TextField></next:TextField>
		</next:Column>
	</next:Columns>
	<next:BottomBar>
