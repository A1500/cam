...
<model:datasets>
	<!-- 查体名册列表 -->	
	<model:dataset id="samListDataSet" cmd="com.inspur.cams.drel.samu.cmd.SamGeroApplyQueryCmd" method="queryList" pageSize="15">
	...
	<!-- 敬老院下拉框选项 -->	
	<model:dataset id="samGeroDataSet1" cmd="com.inspur.cams.drel.samu.cmd.SamGerocomiumInfoQueryCmd" method="queryGero" pageSize="200">
		...
		<form class="L5form">
			<table border="1" width="100%">
				<tr>
					...
					id="gerocomiumNameQuery" name="敬老院" title="敬老院" style="width:85%">
...
<next:EditGridPanel id="grid" dataset="samListDataSet" width="100%" stripeRows="true" height="99.9%">
	...
	<next:Columns>
		...
		<next:Column field="CHECK_DATE" header="查体时间"  sortable="false"/>
		<next:Column field="TOTALNUM" header="总人数"  sortable="false"/>
		<%-- <next:Column field="CHECK_RESULT" header="主要查体结果" dataset="checkResultDataset" sortable="false"/> --%>
	</next:Columns>
	<next:BottomBar>
		<next:PagingToolBar dataset="samListDataSet"/>
	</next:BottomBar>
</next:EditGridPanel>
<next:Window id="addListWin" title="登记名册" closeAction="hide"  width="540" modal="true">
    <next:TopBar>
        <next:ToolBarItem symbol="->"></next:ToolBarItem>
        ...
        <form  id="formList" method="post" 
            ...
            <table width='100%'>
                <tr>
					...
					id="gerocomiumName" field="gerocomiumName" name="敬老院" title="敬老院" style="width:85%">
					<option dataset="samGeroDataSet"></option>
					</select></td>                  
                 ...
                 <tr>
                     <td class="FieldLabel"  style="width:100;">查体结果</td>
                    <td class="FieldInput" style="width:35%;"><select
