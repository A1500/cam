...
<script type="text/javascript" src="samCityHisInsert.js"></script>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>						
						...
						<td class="FieldInput" style="width: 18%"><input type="text" maxlength="25"
							name="户主姓名" title="户主姓名" id="familyName" field="familyName"  style="width:80%" /><font color="red">*</font>		</td>				
						<td class="FieldLabel" style="width: 15%">身份证号</td>
						<td class="FieldInput" style="width: 18%"><input type="text" maxlength="18"
							name="身份证号" title="身份证号" field="familyCardNo" id="familyCardNo" style="width:80%" onchange="checkCradNo(this)" /><font color="red">*</font></td>
					...
					<tr>
						...
						<td class="FieldInput" style="width:18%">
							<input type="text" name="低保证号" title="低保证号" field="cardNo" style="width:80%" maxlength="20"/>
						</td>
						<td class="FieldLabel" style="width: 15%">救助金计算方式</td>
						<td class="FieldInput" style="width: 18%"><select 
							name="救助金计算方式" title="救助金计算方式" id="assistanceModeID" field="assistanceMode" style="width:80%" ><option dataset="assistanceModeDataset"></option></select></td>
					...
					<tr>	
						...
						<td class="FieldInput" style="width: 18%"><input type="text" maxlength="14"
							name="户月保障金" title="户月保障金" field="assistanceMoney" style="width:80%" /></td>
						...
						<td class="FieldInput" style="width: 18%"><input type="text" maxlength="14"
							name="分类施保金" title="分类施保金" field="assistanceClassMoney" style="width:80%" /></td>	
			...
			<fieldset><legend>入户调查</legend>
				<table width="100%">
					<tr>						
						...
						<td class="FieldInput" style="width: 10%"><input type="text" id="d12"
							name="调查日期" title="调查日期" field="surveyDate" style="width:80%"  onClick="WdatePicker()" maxlength="10"/>
							</td>	
				...
				<table width="100%">
					...
					<tr>						
						...
						<td class="FieldInput" style="width: 10%"><input type="text"
							name="同意人数" title="同意人数" field="agreeNum" maxlength="2"id="agreeNum" onchange="countDiscussionNum();"  style="width:80%" /></td>	
			...
			<table width="100%">
				...
				<tr>
					...
					<input type="text" maxlength="16"
						title="经办人" name="经办人" style="width: 80%" field="checkAgent" /></td>
					<td class="FieldInput" colspan="4"></td>
				</tr>
			</table>
			</fieldset>
