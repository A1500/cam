...
<script type="text/javascript" src="samCountryHisInsert.js"></script>
				...
				<table width="100%">
					...
					<tr>						
						...
						<td class="FieldInput" style="width: 18%"><input type="text"
							name="户主姓名" title="户主姓名" id="familyName" field="familyName" maxlength="25"  style="width:80%" /><font color="red">*</font>		</td>				
					...
					<tr>
						...
						<td class="FieldInput" style="width: 18%"><select 
							name="救助金计算方式" id="assistanceModeID" title="救助金计算方式" field="assistanceMode" style="width:80%" ><option dataset="assistanceModeDataset"></option></select></td>
						<td class="FieldLabel" style="width: 15%">低保证号</td>
						<td class="FieldInput" style="width: 18%">
							<input type="text" name="低保证号" title="低保证号" field="cardNo" style="width:80%"  />
						</td>	
					...
					<tr>	
						...
						<td class="FieldInput" style="width: 18%"><input type="text"
							name="户月保障金" title="户月保障金" field="assistanceMoney"  maxlength="14"style="width:80%" /></td>
						<td class="FieldLabel" style="width: 15%">分类施保类别</td>
						<td class="FieldInput" style="width: 18%">
							<select name="分类施保类别" title="分类施保类别" id='asisstanceClass' field="assistanceClass"  onchange="getClassMoney(this.value);" style="width:80%" >
			...
			<fieldset><legend>入户调查</legend>
				...
				<table width="100%">
					...
					<tr>						
						...
						<td class="FieldInput" style="width: 10%">
						<input type="text" maxlength="2"  name="评议总人数" title="评议总人数" id="total" onchange="countDiscussionNum();" field="total"  style="width:80%" /></td>				
						<td class="FieldLabel" style="width: 10%">同意人数</td>
						<td class="FieldInput" style="width: 10%"><input type="text"
							name="同意人数"  maxlength="2"title="同意人数" field="agreeNum" id="agreeNum" onchange="countDiscussionNum();"  style="width:80%" /></td>	
						<td class="FieldLabel" style="width: 10%">不同意人数</td>
						<td class="FieldInput" style="width: 10%"><input type="text"
							name="不同意人数" maxlength="2" title="不同意人数" field="disagreeNum" style="width:80%" /></td>
					</tr>
					</table>
				</fieldset>
				</form>
