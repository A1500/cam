...
<head>
<next:ScriptManager/>
<script type="text/javascript" src="samSureyReport.js"></script>
<style>
.table {
...
<body>
<model:datasets>
	<model:dataset id="ds" cmd="com.inspur.cams.drel.surey.assistance.cmd.SamSureyReportCmd" global="true" autoLoad="false">
		<model:record fromBean="com.inspur.cams.drel.surey.util.Report">
		</model:record>
	</model:dataset>
	<model:dataset id="samSureyWfDataset" cmd="com.inspur.cams.drel.surey.comm.cmd.SamSureyWfQueryCmd" method="statsReport" global="true" autoLoad="false">
				...
				<table dataset="ds" width="80%" class="table">
					...
					<tr>
						<td class="tdTitle" rowspan="2">
							<span span id="checkOrgan">核对单位</span>
						</td>
					...
					<tr repeat="true">
						...
						<td align="center" class="td">
							...
							<input type="text" field="Row1" size="6" readonly="true" class="input" onclick="showWinRow(this,null,null)" />
						</td>
						<td align="center" class="td">	
							<input type="hidden" field="type"/>
							<input type="hidden" field="id"/>						
						...
						<td align="center" class="td">
							<input type="hidden" field="type"/>
							<input type="hidden" field="id"/>
							<input type="text" field="Row4" size="6" readonly="true" class="input" onclick="showWinRow(this,'01',null)"/>
						</td>
						<td align="center" class="td">	
							<input type="hidden" field="type"/>
							<input type="hidden" field="id"/>							
						...
						<td align="center" class="td">
							<input type="hidden" field="type"/>
							<input type="hidden" field="id"/>
							<input type="text" field="Row7" size="6" readonly="true" class="input" onclick="showWinRow(this,'02',null)"/>
						</td>
						<td align="center" class="td">	
							<input type="hidden" field="type"/>
							<input type="hidden" field="id"/>						
						...
						<td align="center" class="td">
							<input type="hidden" field="type"/>
							<input type="hidden" field="id"/>
							<input type="text" field="Row10" size="6" readonly="true" class="input" onclick="showWinRow(this,'03',null)"/>
						</td>
						<td align="center" class="td">	
							<input type="hidden" field="type"/>
							<input type="hidden" field="id"/>						
