...
<next:ScriptManager/>
<script type="text/javascript" src="samSureyCenterCheckList.js"></script>
			...
			<next:Panel title="待办任务列表" width="100%" height="100%">
				...
				<next:GridPanel id="surey_todo_grid" name="surey_todo_grid"   dataset="todoSamSureyWfDS" title="待办任务列表" stripeRows="true" autoScroll="true" collapsible="true"  width="100%" height="100%">
					<next:TopBar>
						...
						<next:ToolBarItem text="移交" iconCls="select"  handler="townTransfer"></next:ToolBarItem>
					</next:TopBar>
					<next:Columns>
						...
						<next:Column id="preActivityOrganName" header="下一环节单位" field="nextActivityOrganName"  width="20%" >
							<next:TextField />
						</next:Column>
...
<next:Window id="mininum_win" title="低保办理窗口" closeAction="hide" height="370" width="520" collapsible="false" resizable="false" border="false"   autoScroll="true">
			...
			<table>
				...
				<tr>
					...
					<td colspan="3" class="FieldInput">
					    ...
					    <input type="radio" id="mini_dealResult2" name="处理结果"  value="TR" disabled="disabled" onclick="mini_transmit(this.value);" />转办
					</td>
			   </tr>
			   <tr>
		...
		<next:GridPanel id="mini_sureyWfHis" name="办理历史意见信息"   dataset="SamSureyWfAssistanceHisDS" title="办理历史意见信息" stripeRows="true" autoScroll="true" collapsible="true"  autoWidth="true" height="120" border="false">
					<next:Columns>
						<next:RadioBoxColumn></next:RadioBoxColumn>
						<next:Column id="ACTIVITY_ORGAN_NAME" header="核对单位" field="ACTIVITY_ORGAN_NAME" width="15%" >
							<next:TextField allowBlank="false" />
						</next:Column>
						<next:Column id="SURVEY_RESULT" header="核对结果" field="SURVEY_RESULT" width="10%" >
							<next:TextField allowBlank="false" />
						</next:Column>
						<next:Column id="SIGN_ORGAN" header="发证机关" field="SIGN_ORGAN" width="10%" >
							<next:TextField allowBlank="false" />
						</next:Column>
						<next:Column id="SIGN_DATE" header="发证时间" field="SIGN_DATE" width="10%" >
							<next:TextField allowBlank="false" />
						</next:Column>
					</next:Columns>
					<next:BottomBar>
							<next:PagingToolBar dataset="SamSureyWfAssistanceHisDS" />
					</next:BottomBar>
				</next:GridPanel>	
				</next:FitLayout>
</next:Window>
			...
			<table>
				...
				<tr>
					...
					<td colspan="3" class="FieldInput">
					    ...
					    <input type="radio" id="lowIncome_dealResult2" name="处理结果"  value="TR" disabled="disabled" onclick="lowIncome_transmit(this.value);" />转办
					</td>
			   </tr>
			   <tr>
					<td class="FieldLabel" >补充意见：</td>
