...
function countTotle(ds){
	...
	document.getElementById('label2').innerHTML=getMoneyFormatNoPoint(ds.sum("CONCENTRATED_FAMILY_SUM"));
	document.getElementById('label3').innerHTML=getMoneyFormatNoPoint(ds.sum("DISPERSION_FAMILY_SUM"));
	document.getElementById('label4').innerHTML=getMoneyFormatNoPoint(ds.sum("ASSISTANCE_PEOPLE_SUM"));
	document.getElementById('label5').innerHTML=getMoneyFormatNoPoint(ds.sum("CONCENTRATED_PEOPLE_SUM"));
	document.getElementById('label6').innerHTML=getMoneyFormatNoPoint(ds.sum("DISPERSION_PEOPLE_SUM"));
	setButtonAble();
}
//按钮启用
...
function exportExcel(){
	...
	L5.dataset2excel(dataset,"/jsp/cams/drel/report/exportFiveBaseCaseExcel.jsp?startTime="+startTime);
