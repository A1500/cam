...
<%
	...
	String name="待办理去世低保五保对象信息_"+date;
	out.clear();//清空缓存的内容
...
<Excel:tablelist filename="<%=name %>">
	<Excel:table sheetname="待办理去世低保五保对象信息">
		<Excel:tr>
			<Excel:td colspan="8" align="center" ><Excel:font size="15">待办理去世低保五保对象信息列表</Excel:font></Excel:td>
		</Excel:tr>
		<Excel:tr>
