...
<script type="text/javascript" src="samAssistancePeoNum.js"></script>
<style>
body {
...
<body>
<model:datasets> 
	<model:dataset id="ds" cmd="com.inspur.cams.drel.funds.release.cmd.SamReleaseSummaryQueryCmd" global="true" method="queryAssistancPeoNum" autoLoad="false">
	</model:dataset>
</model:datasets>
<next:ViewPort>
			...
			<table border="1" width="100%">
				<tr>
					...
					<td class="FieldInput" width="20%"  colspan="2">
	                     <input type="text" id="queryDate" format="Y-m" onclick="LoushangDate(this)"  readonly="readonly" style = "width:46%;padding-right:20px;background:url('<%= SkinUtils.getImage(request, "default/rl.gif ") %> ') no-repeat scroll right center transparent; "/>
				...
				<tr >
					...
					<tr  repeat="true">
							...
							<td align="right" style="padding-right: 2px">
									<label style="width: 30px;height: 20px;" field="FAMILY_COUNT" /></label>
								</td>
							<td align="right" style="padding-right: 2px">
									<label style="width: 30px;height: 20px;"  field="PEOPLE_COUNT" /></label>
								</td>
						</tr>
						</tbody>
						</table>
