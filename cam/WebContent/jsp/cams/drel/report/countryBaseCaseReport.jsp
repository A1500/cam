...
<script type="text/javascript" src="countryBaseCaseReport.js"></script>
<style>
body {
			...
			<table border="1" width="100%">
				<tr>
					...
					<td class="FieldInput" width="40%"  colspan="2">
	                     <input type="text" id="queryDate"  format="Y-m" name="statTime" readonly="readonly" onclick="setmonth(this)" style = "padding-right:20px;background:url('<%= SkinUtils.getImage(request, "default/rl.gif ") %> ') no-repeat scroll right center transparent; "/>
				...
				<tr >
					<td colspan="4" style="border-width: 0px">
						...
						<tr>
							...
							<td class="tdTitle" width="3%"  align="center" colspan="2" style="border-bottom:none">户数（户）</td>
							<td class="tdTitle" width="3%" align="center"   colspan="2"style="border-bottom:none">人数（人）</td>
							<td class="tdTitle" width="3%" align="center"   colspan="3"style="border-bottom:none">保障金（元）</td>
						</tr>
						<tr>
							<td class="tdTitle" width="3%"  align="center" style="border-top:none"></td>
							<td class="tdTitle" width="3%" align="center" >其中分类施保</td>
							<td class="tdTitle" width="3%"  align="center" style="border-top:none"></td>
							<td class="tdTitle" width="3%" align="center" >其中分类施保</td>
