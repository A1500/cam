...
<script type="text/javascript" src="villageWStandingBookReport.js"></script>
...
<next:GridPanel id="grid" dataset="ds" width="100%" stripeRows="true" height="99.9%">
	...
	<next:Columns>
		...
		<next:Column field="ADDRESS" header="住址" width="25%" sortable="false"/>
		<next:Column field="FAMILY_POSTCODE" header="邮编" width="10%" sortable="false"/>
		<next:Column field="FAMILY_PHONE" header="电话" width="10%" sortable="false"/>
		<next:Column field="ASSISTANCE_TYPE" header="享受保障类别" width="10%" sortable="false" dataset="dic_assistanceType"/>
		<next:Column field="ASSISTANCE_PEOPLE_NUM" header="享受人数" width="10%" sortable="false"/>
		<next:Column field="OLD_NO" header="老年人" width="10%" sortable="false"/>
		<next:Column field="CNR" header="成年人" width="10%" sortable="false"/>
		<next:Column field="WCN" header="未成年人" width="10%" sortable="false"/>
		...
		<next:Column field="TOTAL_NUM" header="合计" width="10%" sortable="false"/>
		...
		<next:Column field="MONTH_INCOME" header="享受低保家庭人口月收入" width="10%" sortable="false" renderer="formatNum" />
		<next:Column field="LOW_STANDARDS" header="最低保障救济标准" width="10%" sortable="false" renderer="formatNum"/>
