...
<script type="text/javascript" src="deadDrelReport.js"></script>
...
<model:datasets>
	<model:dataset id="bymonthds" cmd="com.inspur.cams.drel.report.cmd.SamBaseCaseReportQueryCmd" global="true" method="queryDeadByMonth" autoLoad="false">
	<model:record>
