...
<script type="text/javascript" src="cityPeople.js"></script>
<style>
body {
...
<body>
<model:datasets> 
	<model:dataset id="ds" cmd="com.inspur.cams.drel.funds.release.cmd.SamReleaseSummaryQueryCmd" global="true" method="queryPeoAverageStat" autoLoad="false">
	</model:dataset>
</model:datasets>
<next:ViewPort>
			...
			<table border="1" width="100%">
				<tr>
					...
					<td class="FieldInput" width="20%"  colspan="2">
	                     <input type="text" id="queryDate" format="Ymd" name="cxsj_q" readonly="readonly" onclick="setmonth(this)" style = "width:46%;padding-right:20px;background:url('<%= SkinUtils.getImage(request, "default/rl.gif ") %> ') no-repeat scroll right center transparent; "/> 
	                </td>
				...
				<tr >
					<td colspan="4" style="border-width: 0px">
						...
						<tr>
							...
							<td class="tdTitle" width="3%" align="center"  >保障金</td>
							...
							<%} %>
							<%if(!"03".equals(assistanceType)){ %>
							<td class="tdTitle"  width="2%" align="center" >总金额</td>
							<%} %>
							<%if("01".equals(assistanceType)){ %>
							<td class="tdTitle"  width="2%" align="center" >补差</td>
							<%} %>
						</tr>
					<tr>
						<td align="center" style="padding-right: 2px"><label>合计</label></td>
						<td align="right" style="padding-right: 2px"><label  id="label0"style="width: 30px;height: 20px;"   /></label></td>
						...
						<td align="right" style="padding-right: 2px"><label  id="label2"style="width: 30px;height: 20px;"  /></label></td>
							...
							<%} %>
						<%if("01".equals(assistanceType)){ %>
							<td  align="right"style="padding-right: 2px"><label  id="label4"style="width: 30px;height: 20px;"  /></label></td>
							<%} %>
						<%if(!"03".equals(assistanceType)){ %>
							<td align="right" style="padding-right: 2px"><label id="label5" style="width: 30px;height: 20px;"  /></label></td>
						<%} %>
						<%if("01".equals(assistanceType)){ %>
							<td align="right" style="padding-right: 2px" ><label id="label6" style="width: 30px;height: 20px;" /></label></td>
							<%} %>
					</tr>
					<tr  repeat="true"> 
							...
							<td align="right" style="padding-right: 2px">
								<label style="width: 30px;height: 20px;"  field="RELEASE_FAMILY_SUM" renderer='getMoneyFormatNoPoint'/></label>
							</td>
							<td align="right" style="padding-right: 2px">
								<label style="width: 30px;height: 20px;"  field="RELEASE_PEOPLE_SUM" renderer='getMoneyFormatNoPoint'/></label>
							</td>
							<td align="right" style="padding-right: 2px">
							...
							<%if("01".equals(assistanceType)){ %>
							<td align="right" style="padding-right: 2px">
								<label style="width: 30px;height: 20px;"  field="WATER_RELEASE_SUM"  renderer="getMoneyFormat"/></label>
							</td>
							<%} %>
							<%if(!"03".equals(assistanceType)){ %>
							<td align="right" style="padding-right: 2px">
							...
							<%if("01".equals(assistanceType)){ %>
							<td align="right" style="padding-right: 2px">
								<label style="width: 30px;height: 20px;"  field="PEOPLE_AVERAGE" renderer="getMoneyFormat" /></label>
							</td>
							<%} %>
						</tr>
						</tbody>
