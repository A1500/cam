...
<script type="text/javascript" src="samRuralResidentsFamilyDetail.js"></script>
			...
			<table width="100%">
				...
				<tr>
					...
					<td class="FieldInput" style="width: 18%"><label name="家庭年总收入"
						title="家庭月年收入" field="yearIncome" style="width: 80%"></label></td>
					<td class="FieldLabel" style="width: 15%">家庭年均收入（元）</td>
					<td class="FieldInput" style="width: 18%"><label name="家庭年均收入"
						title="家庭年均收入" field="yearAverageIncome" style="width: 80%"></label></td>
