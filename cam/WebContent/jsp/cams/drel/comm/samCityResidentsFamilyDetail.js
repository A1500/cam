...
function peopleDetail(peopleId){
	var width = 1000;
    var height = 600;
	var url="samCityResidentsPeopleDetail.jsp?peopleId="+peopleId+'&applyId='+applyId;
...
function detailSupport(supportId){
	var width = 850;
    var height = 187;
	var url="supportDetail.jsp?familyId="+familyId+"&supportId="+supportId+"&assistanceType=01";
