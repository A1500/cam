...
function loadSamPeopleJobsDataSet(ds){
	...
	samPeopleJobsDataSet.setParameter("APPLY_ID",applyId);
...
function loadSamPeopleInsuranceDataSet(ds){
	...
	samPeopleInsuranceDataSet.setParameter("APPLY_ID",applyId);
...
<model:datasets>
	...
	<!-- 家庭成员就业信息 -->
	<model:dataset id="samPeopleJobsDataSet" cmd="com.inspur.cams.drel.archive.sampeoplejobsarchive.cmd.SamPeopleJobsArchiveQueryCmd" global="true">
		<model:record fromBean="com.inspur.cams.drel.archive.sampeoplejobsarchive.data.SamPeopleJobsArchive"></model:record>
	</model:dataset>
	<!-- 家庭成员教育信息 -->
	...
	<!-- 家庭成员保障性支出信息 -->
	<model:dataset id="samPeopleInsuranceDataSet" cmd="com.inspur.cams.drel.archive.sampeopleinsurancearchive.cmd.SamPeopleInsuranceArchiveQueryCmd" global="true">
		<model:record fromBean="com.inspur.cams.drel.archive.sampeopleinsurancearchive.data.SamPeopleInsuranceArchive"></model:record>
	</model:dataset>
	<!-- 人员患病信息 -->
	...
	<!-- 婚姻状况-->
	<model:dataset id="DmHyzkDataSet"
		cmd="com.inspur.cams.comm.dicm.DicQueryCmd" global="true"
		autoLoad="true">
		<model:record fromBean="com.inspur.cams.comm.dicm.DicBean"></model:record>
		<model:params>
	...
	<!-- 政治面貌-->
	<model:dataset id="DmZzmmDataSet"
		cmd="com.inspur.cams.comm.dicm.DicQueryCmd" global="true"
		autoLoad="true">
		<model:record fromBean="com.inspur.cams.comm.dicm.DicBean"></model:record>
		<model:params>
	...
	<!-- 残疾等级 -->
	<model:dataset id="DmCjdjDataSet"
		cmd="com.inspur.cams.comm.dicm.DicQueryCmd" global="true"
		autoLoad="true">
		<model:record fromBean="com.inspur.cams.comm.dicm.DicBean"></model:record>
		<model:params>
	...
	<!-- 户籍类别 -->
	<model:dataset id="DmHjxzDataSet" enumName="SAM_DOMICILE_TYPE"
		autoLoad="true" global="true"></model:dataset>
	<model:dataset id="comm_yesorno" enumName="COMM.YESORNO"
		autoLoad="true" global="true"></model:dataset>
	<!-- 文化程度-->
	<model:dataset id="eduDataSet"
		cmd="com.inspur.cams.comm.dicm.DicQueryCmd" global="true"
		autoLoad="true">
		<model:record fromBean="com.inspur.cams.comm.dicm.DicBean"></model:record>
		<model:params>
	...
	<!-- 学业状况 -->
	<model:dataset id="eduStatusDataset" enumName="SAM_EDU_STATUS"
		autoLoad="true" global="true"></model:dataset>
	<!-- 与户主关系 -->
	...
	<model:dataset id="assistanceTypeSelect"
		cmd="com.inspur.cams.comm.dicm.DicQueryCmd" global="true"
		autoLoad="true">
		<model:record fromBean="com.inspur.cams.comm.dicm.DicBean"></model:record>
		<model:params>
	...
	<model:dataset id="belongingDataset" enumName="SAM_BELONGING"
		autoLoad="true" global="true"></model:dataset>
	<!-- 人员分类救助类别 -->
	<model:dataset id="traditonTypeDataset" enumName="SAM_TRADITON_TYPE"
		autoLoad="true" global="true"></model:dataset>
	<!-- 单位性质 -->
	<model:dataset id="unitNatureDataset" enumName="SAM_UNIT_NATURE"
		autoLoad="true" global="true"></model:dataset>
	<!-- 隶属关系 -->
	<model:dataset id="affiliationDataset" enumName="SAM_AFFILIATION"
		autoLoad="true" global="true"></model:dataset>
	<!-- 学校类别 -->
	<model:dataset id="schoolTypeDataset" enumName="SAM_SCHOOL_TYPE"
		autoLoad="true" global="true"></model:dataset>
	<!-- 支出类型 -->
	<model:dataset id="insuranceTypeDataset" enumName="SAM_INSURANCE_TYPE"
		autoLoad="true" global="true"></model:dataset>
	<!-- 缴费周期 -->
	<model:dataset id="insuranceCycleDataset"
		enumName="SAM_INSURANCE_CYCLE" autoLoad="true" global="true"></model:dataset>
</model:datasets>
<!-- 人员录入窗口 -->
<next:Panel id="peopleWin" title="" height="100%" width="100%"
	autoScroll="true">
	<next:TopBar>
		...
		<next:Html>
			...
			<table border="0" width="100%">
				<tr>
					...
					<td class="FieldInput" width="15%"><label field="sex"
						dataset="studentsex" /></td>
					<td class="FieldInput" width="10%" rowspan="4">
					<div id="photoDiv1"><img id="img1"
						name="RELATIONER_PHOTOC_IMG1" width="82.5" height="110"
						src="<%=SkinUtils.getRootUrl(request) %>jsp/cams/sorg/comm/signet/default.jpg"
						align="top"
						ondblclick="editPhoto(11,'photoId1','RELATIONER_PHOTOC_IMG1');"
						onerror="javascript:this.src='<%=SkinUtils.getRootUrl(request) %>jsp/cams/sorg/comm/signet/default.jpg'"
						alt="暂无图片" /> <input type="hidden" id="photoId1" name="photoId1" />
					</div>
					</td>
				</tr>
				<tr>
					...
					<td class="FieldInput"><label field="nation"
						dataset="DmMzDataSet" /></td>

				</tr>
				<tr>
					<td class="FieldLabel">婚姻状况</td>
					<td class="FieldInput"><label field="marriageCode"
						dataset="DmHyzkDataSet" /></td>
					<td class="FieldLabel">就业状况</td>
					<td class="FieldInput"><label field="employmentCode"
						dataset="DmZyDataSet" /></td>
					<td class="FieldLabel">政治面貌</td>
					<td class="FieldInput"><label field="politicalCode"
						dataset="DmZzmmDataSet" /></td>
				</tr>
				<tr>
					<td class="FieldLabel">劳动能力</td>
					<td class="FieldInput"><label id="laborCapacity" /></td>
					<td class="FieldLabel">健康状况</td>
					<td class="FieldInput"><label field="healthCode"
						dataset="healthCodeDataset" /></td>
				...
				<tr>
					...
					<td class="FieldInput" colspan="2"><label field="domicileType"
						dataset="DmHjxzDataSet" /></td>
				</tr>
				<tr>
					...
					<td class="FieldInput" colspan="2"><label field="eduCode"
						dataset="eduDataSet" /></td>
				</tr>
				<tr>
					...
					<td class="FieldInput" colspan="2"><label
						field="relationshipType" dataset="relationshipTypeDataset" /></td>
				</tr>
				<tr>
					<td class="FieldLabel">户籍地址</td>
					<td class="FieldInput" colspan='3'><label
						field="apanageName" /></td>
				...
				<tr>
					...
					<td class="FieldInput" colspan="6"><textarea name="备注"
						title="备注" rows="4" style="width: 93.5%" field='note' readonly="readonly"></textarea></td>
				</tr>
				<tr>
			...
			<table width="100%">
				<tr>
					...
					<td class="FieldInput" style="width: 25%"><label
						field="unitNature" dataset='unitNatureDataset' /></td>
				</tr>
				<tr>
					...
					<td class="FieldInput" style="width: 15%"><label
						field="affiliation" dataset='affiliationDataset' /></td>
					<td class="FieldLabel" style="width: 10%">联系电话</td>
					<td class="FieldInput" style="width: 25%"><label
						field='contactPhone' /></td>
				</tr>
				<tr>
					<td class="FieldLabel" style="width: 10%">联系人</td>
					<td class="FieldInput" style="width: 15%"><label
						field='contactPeople' /></td>
		...
		<next:Html>
			...
			<table width="100%">
				<tr>
					...
					<td class="FieldInput" style="width: 15%"><label
						field="schoolType" dataset='schoolTypeDataset' /></td>
				</tr>
				<tr>
					<td class="FieldLabel" style="width: 10%">联系人</td>
					<td class="FieldInput" style="width: 15%"><label
						field='conectPeople' /></td>
					<td class="FieldLabel" style="width: 10%">联系电话</td>
					<td class="FieldInput" style="width: 15%"><label
						field='conectPhone' /></td>
					<td class="FieldLabel" style="width: 10%">入学时间</td>
					<td class="FieldInput" style="width: 25%"><label
						field='entranceDate' /></td>
				</tr>
			</table>
			</form>
		</next:Html>
	</next:Panel>
	<next:GridPanel titleCollapse="true" collapsible="true"
		id='SamPeopleInsuranceEditGridPanel' notSelectFirstRow="true"
		stripeRows="true" autoHeight="true"
		dataset="samPeopleInsuranceDataSet" title="家庭成员保障性支出信息">
		<next:Columns>
			<next:RowNumberColumn />
			<next:RadioBoxColumn></next:RadioBoxColumn>
			<next:Column id="insuranceType" header="支出类型" field="insuranceType"
				width="150">
				<next:ComboBox dataset='insuranceTypeDataset' displayField="text"
					valueField="value" typeAhead="true" />
			</next:Column>
			<next:Column id="insuranceFee" header="缴纳金额（元）" field="insuranceFee"
			...
			<next:Column id="insuranceCycle" header="缴费周期" field="insuranceCycle"
				width="150">
				<next:ComboBox dataset='insuranceCycleDataset' displayField="text"
					valueField="value" typeAhead="true" />
			</next:Column>
