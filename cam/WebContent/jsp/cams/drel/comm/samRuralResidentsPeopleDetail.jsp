...
<!-- 人员录入窗口 -->
<next:Panel id="peopleWin" title="" height="100%" width="100%" autoScroll="true">
	<next:TopBar>
	...
	<next:Html>
		...
		<tr>
			...
			<tr>
				...
				<td class="FieldInput"><label field='incomeYear' /></td>
				<td class="FieldLabel">与户主关系</td>
				<td class="FieldInput"><label field="relationshipType" dataset="relationshipTypeDataset" /></td>
	...
	<next:EditGridPanel  titleCollapse="true" collapsible="true" id='SamPeopleInsuranceEditGridPanel' notSelectFirstRow="true"
