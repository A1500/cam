...
<next:Panel  name="form" width="98%" border="0" bodyStyle="padding-bottom:10px;padding-top:12px;" autoHeight="true" >
	<next:Html>		
				<div>
					<form name="frm" style="width: 95%; height: 100%;" class="L5form" action="../../../../../ReportServer" target="Rpt_CountryMedicalAssistanceCityReject">
...
<iframe id="Rpt_CountryMedicalAssistanceCityReject" name="Rpt_CountryMedicalAssistanceCityReject" width="100%" height="100%">
...
<script type="text/javascript">
	...
	if(cityFlag == "00") {//市级用户
		document.getElementById("Rpt_CountryMedicalAssistanceCityReject").src = "../../../../../ReportServer?reportlet=Rpt_CountryMedicalAssistanceCityReject.cpt&op=write&id="+id;
	}else {//区县级用户
	...
	function reject() {
		L5.MessageBox.confirm('确定', '你确定要回退吗？',function(sta){
			if(sta=="yes"){
				...
				command.setParameter("RPT_CountryMEDICALASSISTANCE.ID@=", id);
				command.execute("forRetreat");
				var msg = command.getReturn("message");
				L5.Msg.alert("提示",msg,function(){L5.forward("jsp/cams/drel/manage/rpt/Rpt_CountryMedicalAssistanceSummary.jsp");});	
			}else 
			return;
		});	
	}
