			...
			//必须使用异步方式，然后转向必须在afterExecute回调函数中。
	   		...
	   		if (msg==null || msg=="") {
				...
				if(msg == "上报成功！") {
					...
					L5.Msg.alert("提示", "已经上报的数据不能再进行上报！");return;
				}
			}
			}
