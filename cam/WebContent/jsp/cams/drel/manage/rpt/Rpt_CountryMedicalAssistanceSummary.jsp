   		...
   		command.afterExecute = function(){
	   		...
	   		if (msg==null || msg=="") {//增加
				...
				data.put("quarter", quarter);
	       		var url = "jsp/cams/drel/manage/rpt/Rpt_CountryMedicalAssistanceSummaryInsert.jsp";
				...
				var url = "jsp/cams/drel/manage/rpt/Rpt_CountryMedicalAssistanceSummaryUpdate.jsp";
		       	var text = "农村医疗救助工作情况填报";
		        L5.forward(url, text, data);
			}
		}
		command.execute("queryCountrymedicalassistanceForSummary");
	}	
	//校验是否数字
function _isNum(s){
	return /^[0-9]+$/.test(s);
