...
<%
	...
	String Flag = reportOrganCode.substring(reportOrganCode.length()-3);//省级标志
...
<script type="text/javascript">
	...
	if(Flag=='000'){
		...
		document.getElementById("Rpt_CountryMedicalAssistanceReport").src = "../../../../../ReportServer?reportlet=Rpt_CountryMedicalAssistanceReportUpdate.cpt&op=write&id=<%=request.getParameter("id")%>";
	}
	//设置默认值
	function setDefault() {
