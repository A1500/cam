   		...
   		command.afterExecute = function(){
	   		...
	   		if (msg==null || msg=="") {
	   			...
	   			if(provinceFlag == "000" && reportOrganCode!='371000') {//省级用户
					document.forms[0].reportlet.value = "/Rpt_CountryMedicalAssistanceProvinceQuery.cpt";
					document.forms[0].reportCorpOrganId.value = '<%=reportCorpOrganId%>';
				}else if(cityFlag == "00") {//市级用户
					document.forms[0].reportlet.value = "/Rpt_CountryMedicalAssistanceCityQuery.cpt";
					document.forms[0].reportOrganCode.value = '<%=reportOrganCode%>';
					document.forms[0].reportCorpOrganId.value = '<%=reportCorpOrganId%>';
					document.forms[0].id.value = command.getReturn("id", false);
				}else {//其他
					document.forms[0].reportlet.value = "/Rpt_CountryMedicalAssistanceDistrictQuery.cpt";
					document.forms[0].reportOrganCode.value = '<%=reportOrganCode%>';
				}
