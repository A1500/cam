...
<script type="text/javascript">
	...
	if(Flag=="000"){
		...
		document.getElementById("Rpt_CityMedicalAssistanceReport").src = "../../../../../ReportServer?reportlet=Rpt_CityMedicalAssistanceReport.cpt&op=write&reportCorpOrganId=<%=reportCorpOrganId %>&reporterOrganId=<%=reporterOrganId %>&reportTime=<%=reportTime %>&year=<%=request.getParameter("year")%>&quarter=<%=request.getParameter("quarter")%>&reported=0";
	}
	//设置默认值
	function setDefault() {
