function init() {
	...
	if(organArea.substring(6,12) != '000000'){//是县级以下
		colModel.setDataIndex(3,"DOMICILE_NAME");
	}else{
		 colModel.setDataIndex(3,"DOMICILE_FULL_NAME");
	}
}
...
if(sAge){
	...
	baseinfoPeopleDS.setParameter("assistanceType",document.getElementById("assistanceTypeId").value);
...
function exportExcel(){
	...
	var filename=assistanceBegin+"低保人员查询";
...
function detailFamily(){
	...
	if(records&&records.length==1){
	    ...
	    if(assistanceType == '01'){
	     	url="cityFamilyDetail.jsp?treatmentId="+treatmentId+"&assistanceType="+assistanceType+"&applyId="+applyId;
