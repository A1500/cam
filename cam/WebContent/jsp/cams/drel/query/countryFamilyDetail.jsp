...
<script type="text/javascript" src="countryFamilyDetail.js"></script>
...
<model:datasets>
  ...
  <next:Panel width="100%" height="100%" autoScroll="true" id="tab">
	<next:TopBar>
			...
			<next:ToolBarItem iconCls="detail" text="查看历史救助信息" handler="hisDetail"/>
			...
			<table width="100%">
				...
				<tr>
					...
					<td class="FieldInput" style="width: 18%" rowspan="4">
						<div id="photoDiv"><img id="img" name="FAMILY_IMG" width=140 height=90
							src="<%=SkinUtils.getRootUrl(request) %>jsp/cams/sorg/comm/signet/default.jpg" align="top"
				...
				<tr>
					...
					<td class="FieldInput" style="width: 18%"><label name="家庭年总收入"
						title="家庭月总收入" field="yearIncome" style="width: 80%"></label></td>
					<td class="FieldLabel" style="width: 15%">家庭年均收入（元）</td>
					<td class="FieldInput" style="width: 18%"><label name="家庭年均收入"
						title="家庭月均收入" field="yearAverageIncome" style="width: 80%"></label></td>
				...
				<tr>
					...
					<td class="FieldInput" style="width: 18%" id="assistanceModeL">
						<label id="assistanceMode" ></label>
					</td>
					<td class="FieldLabel" style="width: 15%">低保证号</td>
					<td class="FieldInput" style="width: 18%"><label id="cardNo"></label></td>
				</tr>
				<tr>
	...
	<next:EditGridPanel id="housePanel"titleCollapse="true" collapsible="true"  stripeRows="true"  autoHeight="true" dataset="houseListDataset" title="家庭房产信息">
		<next:Columns>
			...
			<next:Column header="建筑面积（㎡）" field="buildArea" width="100" align='right'>
				<next:TextField   editable="false"/>
			</next:Column>
			<next:Column header="使用面积（㎡）" field="useArea" width="100" align='right'>
				<next:TextField   editable="false"/>
			</next:Column>
		</next:Columns>
	</next:EditGridPanel>
	...
	<next:GridPanel id="supportPanel"titleCollapse="true" collapsible="true"  stripeRows="true"  autoHeight="true" dataset="supportListDataset" notSelectFirstRow="true" title="赡（抚、扶）养义务人员信息">
			<next:Columns>
				<next:RowNumberColumn/>
				<next:RadioBoxColumn></next:RadioBoxColumn>	
