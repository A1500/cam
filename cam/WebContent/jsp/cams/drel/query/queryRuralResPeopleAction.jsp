...
<html>
<head>
<title>农村低保人员查询</title>
<next:ScriptManager />
	<script type="text/javascript" src="queryRuralResPeopleAction.js"></script>
...
<!-- 分类施保类别 -->
			<model:dataset id="asisstanceClassDataset1" cmd="com.inspur.cams.comm.dicm.DicQueryCmd" autoLoad="true">
				...
				<model:params>
					...
					<model:param name="ASSISTANCE_TYPE" value="02" />
				</model:params>
			</model:dataset>
	<!-- 人员状态 -->
		...
		<table width="100%">
			...
			<tr>
				<td class="FieldLabel" width="8%">人员类型</td>
                    ...
                    <input type="text" id='peopleTypeName' style="width: 180px" readOnly="true" />
                ...
                <td class="FieldInput" width="25%"><input type="text"
                    id="assistanceBegin" name="assistanceBegin" readonly="readonly" onclick="setmonth(this)"   style="width: 180px;padding-right:20px;background:url('<%= SkinUtils.getImage(request, "default/rl.gif ") %> ') no-repeat scroll right center transparent; "/></td>
			</tr>
...
<next:GridPanel id="infoQueryGrid" name="baseinfoPeopleResource"
	...
	<next:TopBar>
		<next:ToolBarItem id="qrToolbar" text="农村低保人员查询信息"></next:ToolBarItem>
