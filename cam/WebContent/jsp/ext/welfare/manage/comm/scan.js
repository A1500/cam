...
function scan(){
	try {
		var getreturn =window.showModalDialog(L5.webPath+"/jsp/ext/welfare/manage/comm/scan.jsp",window,"dialogWidth=0px;dialogHeight=0px;help:no;scroll:no;status:0");
