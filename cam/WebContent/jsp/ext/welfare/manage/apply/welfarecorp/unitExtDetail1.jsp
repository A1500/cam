...
function backPage(){
	var url='jsp/ext/welfare/manage/apply/welfarecorp/welfarecorpList.jsp';
	L5.forward(url);
}
</script>
</head>
...
<div id="float" >
	<input type="button" value="下一页" style="height:25px;width:80px;position:absolute;margin-left:20px;" onclick="nextPageY('2')" />
	<input type="button" value="返回" style="height:25px;width:80px;position:absolute;margin-left:120px;" onclick="backPage();"/>
</div>
