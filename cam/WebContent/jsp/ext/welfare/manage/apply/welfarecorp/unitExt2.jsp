...
<input field="" type="button" value="下一页"
	...
	onclick="nextPageW('3')" /> <input field="" type="button" value="上一页"
	style="height: 25px; width: 80px; position: absolute; margin-left: 120px;"
	onclick="lastPageW('1')" /> <input field="" type="button" value="保存"
		...
		<TR vAlign=top>
			...
			<table border=0 cellpadding=0 cellspacing=0 width=690
				...
				<tr height=45>
					...
					<td colspan=8 class=unnamed1>
					<div align="left"><input type="text" vname="兼营"
