...
function query() {
	...
	if(idCards != ''){
		ds.baseParams["CERT_NUM_MAN@in"]= idCards;
		ds.baseParams["CERT_NUM_WOMAN@in"]= idCards;
	}	
...
function queryDetails() {
	...
	window.open(L5.webPath+
					"/jsp/cams/marry/marry_details.jsp?method=DETAILS&dataBean=" + id + "&certNumMan=" + certNumMan + "&certNumWoman=" + certNumWoman,
					"_blank",
