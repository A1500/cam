...
<script type="text/javascript" src="exchangeMarryQuery.js"></script>
...
<next:Panel name="form" width="100%" border="0" autoHeight="true">
	<next:Html>
		...
		<div>
		<form style="width: 100%; height: 100%;" id="form_content" class="L5form">
		<table border="1" width="100%">
			...
			<tr>
				<td class="FieldLabel"colspan="4">下载批量导入身份证模版:
