...
<%
String organArea = ExtBspInfo.getUserInfo(request).getAreaCode().substring(0,6);
String organArea1 = ExtBspInfo.getUserInfo(request).getAreaCode();
...
<html>
	<head>
		...
		<next:ScriptManager/>
		<script type="text/javascript" src="jzfaKnjtQuery.js"></script>
...
<model:datasets>
	...
	<!-- 数据统计的dataset -->
    <model:dataset id="zhcxJtxxNumDs" cmd="com.inspur.sdmz.jzfa.cmd.KnjtQueryCmd" global="true" autoLoad="false" method="getJtxxNum">
	...
	<model:dataset id="shbzSelect" cmd="com.inspur.cams.comm.dicm.DicQueryCmd" global="true" autoLoad="true">
	...
	<!-- 家庭信息明细 -->
	<model:dataset id="singleDs" cmd="com.inspur.sdmz.jzfa.cmd.JtxxQueryCmd" global="true" autoLoad="false">
		<model:record fromBean="com.inspur.sdmz.jtxx.data.BaseinfoFamily"></model:record>
	</model:dataset>
			<!-- 列表的dataset -->
	<model:dataset id="ds" cmd="com.inspur.sdmz.jzfa.cmd.KnjtQueryCmd" global="true" autoLoad="false" pageSize="15">
	</model:dataset>
</model:datasets>
				...
				<table  border="1" style="width:99%;table-layout:fixed;" >
					<tr >
						...
						<td class="FieldInput" width="18%">
							<select id="shbzquery">
								<option dataset="shbzSelect" ></option>
							</select>
						</td>
					</tr>
					<tr>
...
<next:GridPanel id="ygjzjtxxGrid" name="ygjzjtxxGrid" width="99%" deferRowRender="false" columnLines="true" bodyBorder="true" notSelectFirstRow="true" height="300" dataset="ds" title="困难家庭信息列表">
	<next:TopBar>
...
<next:Window id="knjt_detail" title="困难家庭信息" width="640" height="350" closeAction="hide" modal="true" resizable="true" autoScroll="true">	
	<next:Panel>
		<next:TopBar>
			<next:ToolBarItem symbol="->"></next:ToolBarItem>
	...
	<next:FitLayout>
		<next:TabPanel id="tab" border="false" >
			<next:Tabs>
							...
							<table border="0" width="100%">
								<tr>
									...
									<td class="FieldInput" style="width: 25%">
										<input type="text" name="hzxm" field="familyName" readonly="true" styleClass="txtReadOnly" style="width:90%">
									</td>
									<td class="FieldLabel" style="width: 10%" nowrap>身份证号:</td>
									<td class="FieldInput" style="width: 25%">
										<input type="text" name="sfzh" field="familyCardNo" readonly="true" style="width:90%"/>
									</td>
								</tr>
								<tr>
									<td class="FieldLabel" style="width: 10%" nowrap>人口数量:</td>
									<td class="FieldInput" style="width: 25%">
										<input type="text" name="rkSl" field="peopleNum" readonly="true" style="width:90%"/>
									</td>
									<td class="FieldLabel" style="width: 10%" nowrap>地址_省:</td>
									<td class="FieldInput" style="width: 25%">
										<input type="text" name="dzSheng" field="province" readonly="true" renderer="beforeshow" styleClass="txtReadOnly" style="width:90%">
									</td>
								</tr>
								<tr>
									<td class="FieldLabel" style="width: 10%" nowrap>地址_市:</td>
									<td class="FieldInput" style="width: 25%">
										<input type="text" name="dzShi" field="city" readonly="true" renderer="beforeshow" style="width:90%"/>
									</td>
									<td class="FieldLabel" style="width: 10%" nowrap>地址_县（市、区）:</td>
									<td class="FieldInput" style="width: 25%">
										<input type="text" name="dzXian" field="county" readonly="true" renderer="beforeshow" style="width:90%"/>
									</td>
								</tr>
								<tr>
									<td class="FieldLabel" style="width: 10%" nowrap>地址_镇:</td>
									<td class="FieldInput" style="width: 25%">
										<input type="text" name="dzZhen" field="town" readonly="true" renderer="beforeshow" style="width:90%"/>
									</td>
									<td class="FieldLabel" style="width: 10%" nowrap>地址_村（居）:</td>
									<td class="FieldInput" style="width: 25%">
										<input type="text" name="dzCun" field="village" readonly="true" renderer="beforeshow" style="width:90%"/>
									</td>
								</tr>
								<tr>
									<td class="FieldLabel" style="width: 10%" nowrap>地址_门牌号:</td>
									<td class="FieldInput" style="width: 25%">
										<input type="text" name="dzMph" field="address" readonly="true" style="width:90%"/>
									</td>
									<td class="FieldLabel" style="width: 10%" nowrap>联系电话_宅电:</td>
									<td class="FieldInput" style="width: 25%">
										<input type="text" name="dhhm" field="familyPhone" readonly="true" style="width:90%"/>
									</td>
								</tr>
								<tr>
									<td class="FieldLabel" style="width: 10%" nowrap>联系电话_手机:</td>
									<td class="FieldInput" style="width: 25%">
										<input type="text" name="sjhm" field="familyMobile" readonly="true" style="width:90%"/>
									</td>
									<td class="FieldLabel" style="width: 10%" nowrap>联系电话_其他:</td>
									<td class="FieldInput" style="width: 25%">
										<input type="text" name="qt" field="familyOtherPhone" readonly="true" style="width:90%"/>
									</td>
								</tr>
								<tr>
									<td class="FieldLabel" style="width: 10%" nowrap>家庭年总收入:</td>
									<td class="FieldInput" style="width: 25%">
										<input type="text" name="nzsrJe" field="yearIncome" readonly="true" style="width:90%"/>
									</td>
									<td class="FieldLabel" style="width: 10%" nowrap>家庭年人均收入:</td>
									<td class="FieldInput" style="width: 25%">
										<input type="text" name="nrjsrJe" field="yearAverageIncome" readonly="true" style="width:90%"/>
									</td>
								</tr>
								<tr>
									<td class="FieldLabel" style="width: 10%" nowrap>家庭月总收入:</td>
									<td class="FieldInput" style="width: 25%">
										<input type="text" name="yzsrJe" field="monthIncome" readonly="true" style="width:90%"/>
									</td>
									<td class="FieldLabel" style="width: 10%" nowrap>家庭月人居收入:</td>
									<td class="FieldInput" style="width: 25%">
										<input type="text" name="yrjsrJe" field="monthAverageIncome" readonly="true" style="width:90%"/>
									</td>
								</tr>
							</table>
						</form>
				...
				<next:GridPanel id="winGrid" name="winGrid" width="100%" deferRowRender="false" columnLines="true" bodyBorder="true" notSelectFirstRow="true" height="95%" dataset="jzlsDs" title="受助历史信息">
					...
					<next:BottomBar >
						<next:PagingToolBar dataset="jzlsDs"/>
					</next:BottomBar>					
				</next:GridPanel>
			</next:Tabs>
		</next:TabPanel>
