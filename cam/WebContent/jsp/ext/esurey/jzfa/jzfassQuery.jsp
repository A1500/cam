...
<model:datasets>
	...
	<model:dataset id="jzfaDataset" cmd="com.inspur.sdmz.jzfa.cmd.PlanQueryCmd" global="true" method="queryExt" autoLoad="false" pageSize="10">
		<model:record fromBean="com.inspur.sdmz.jzfa.data.Plan"></model:record>
			<model:params>
				<model:param name="STATUS" value='1'></model:param>
			</model:params>
	</model:dataset>
	<model:dataset id="sjtjDataset" cmd="com.inspur.sdmz.jzfa.cmd.PlanQueryCmd" method="sjtjss" global="true" autoLoad="true">
		<model:record fromBean="com.inspur.sdmz.jzfa.data.Plan"></model:record>
	</model:dataset>
	...
	<next:AnchorLayout>
			...
			<next:Html>
				...
				<table border="0"
					...
					<tr>
						...
						<td class="FieldInput" width="30%" nowrap="nowrap"><select name="plantype" field="planType" style="width: 60%"><option dataset="DmJzlxDataSet"></option></select></td>
						<td class="FieldLabel" width="10%" nowrap="nowrap">救助方案名称：</td>
						<td class="FieldInput" width="30%" nowrap="nowrap"><input type="text" id="planName" style="width: 60%" class="TextEditor" /></td>
					...
					<tr>
						...
						<td class="FieldInput"><input type="text" id="planBegin"
						...
						<td class="FieldInput"><input type="text" id="lrrqQ"
		...
		<%} %>
			...
			<next:Columns>
				...
				<next:Column header="救助方案名称" field="PLAN_NAME" id="planName" width="100" sortable="true" />
				...
				<next:Column header="开始日期" field="PLAN_BEGIN" width="100" align="center" sortable="true" />
				<next:Column header="结束日期" field="PLAN_END" width="100" align="center" sortable="true" />
