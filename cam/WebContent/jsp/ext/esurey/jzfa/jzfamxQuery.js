...
function query(){
	...
	jzfamxDataset.setParameter("SAM_PLAN_DETAIL.HANDICAP_NUM@=",getParam("handicapNum"));	
	sjtjDataset.setParameter("HANDICAP_NUM",getParam("handicapNum"));
...
function exportJzfamxExcel() {
	...
	L5.dataset2excel(jzfamxDataset, "/jsp/ext/esurey/jzfa/exportJzfamxExcel.jsp?planId="+planId);
}
