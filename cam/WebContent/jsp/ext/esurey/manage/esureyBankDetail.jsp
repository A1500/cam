	...
	<next:Html>
		...
		<table border="1" width="100%">
			<tr>
				...
				<td class="FieldInput"><input type="text" id="name" maxlength="25"
					class="TextEditor" /></td>
...
<next:Window id="socialWin" height="130" title="银行信息录入" width="550" closeAction="hide">
		<next:TopBar>
			<next:ToolBarItem symbol="->"></next:ToolBarItem>
			<next:ToolBarItem text="提交" iconCls="detail"
				handler="Evt_butcheckin_onclick"></next:ToolBarItem>
			<next:ToolBarItem text="保存，暂不提交" iconCls="save"
		...
		<next:Html>
			<form class="L5form" dataset="bankDataset">
			<table width="100%">
				
				<tr>
					<td class="FieldLabel">开户人姓名：</td>
					<td class="FieldInput"><input type="text" name="accountName" maxlength="25" readonly="readonly"
						field="accountName" /></td>

					<td class="FieldLabel">存款金额合计（元）：</td>
					<td class="FieldInput"><input type="text" name="totalSavings" maxlength="16" align="right" onblur="checkMoney(this.id)"
						field="totalSavings" /></td>
				</tr>
				<tr>
					<td class="FieldLabel">债券总金额（元）：</td>
					<td class="FieldInput"><input type="text" name="totalBond" maxlength="16" align="right" onblur="checkMoney(this.id)"
						field="totalBond" /></td>
