...
<model:datasets>
	...
	<!--房管信息dataset-->
	<model:dataset id="securitiesDataset"
...
<next:Window id="socialWin" height="130" width="550" title="证监信息录入" closeAction="hide">
		<next:TopBar>
			<next:ToolBarItem symbol="->"></next:ToolBarItem>
			<next:ToolBarItem text="提交" iconCls="detail"
				handler="Evt_butcheckin_onclick"></next:ToolBarItem>
		...
		<next:Html>
			<form class="L5form" dataset="securitiesDataset">
			<table width="100%">
				<tr>
					...
					<td class="FieldLabel">股票市值总金额（元）：</td>
					<td class="FieldInput"><input type="text" name="stock" maxlength="16" align="right" onblur="checkMoney(this.id)"
						field="stock" /></td>
				</tr>
				<tr>
					<td class="FieldLabel">基金市值总金额（元）：</td>
					<td class="FieldInput"><input type="text" name="fund" maxlength="16" align="right" onblur="checkMoney(this.id)"
						field="fund" /></td>

					<td class="FieldLabel">资金总余额（元）：</td>
					<td class="FieldInput"><input type="text" name="money" maxlength="16" align="right" onblur="checkMoney(this.id)"
						field="money" /></td>
				</tr>
			</table>
			</form>
