...
<model:datasets>
	<!--经济核对_国税填报信息的dataset-->
	<model:dataset id="externalGTaxDataset"
		cmd="com.inspur.cams.drel.esurey.cmd.SamEsureyTaxQueryCmd"
		global="true" pageSize="10" method="queryGExtTax">
...
<next:GridPanel id="editGridPanel" name="editGridPanel" width="100%"
	stripeRows="true" height="100%" dataset="externalGTaxDataset" 
	notSelectFirstRow="true" title="国税填报信息的列表">
	...
	<next:BottomBar>
		<next:PagingToolBar dataset="externalGTaxDataset" />
	</next:BottomBar>
</next:GridPanel>
