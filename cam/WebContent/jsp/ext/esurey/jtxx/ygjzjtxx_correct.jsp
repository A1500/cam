...
<next:Window id="hello-win" title="家庭成员信息录入" width="780" height="450" closeAction="hide" modal="true" resizable="true" autoScroll="true">
	<next:AnchorLayout>
		<next:Panel title="基本信息" collapsible="true" animCollapse="true"  width="750" height="320">
			<next:Html>
				...
				<table border="0" width="750">
					...
					<tr>
						...
						<td class="FieldInput" style="width: 20%"><select name="employmentCode" field="employmentCode" style="width:33%"><option dataset="DmZyDataSet"></option></select><font color="red">*</font></td>
					</tr>
					<tr>
