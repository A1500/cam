	...
	<next:Html>
		...
		<form id="queryForm"   style="width: 98%; height: 100%;" class="L5form">
			...
			<tr>
				...
				<td class="FieldInput" width="25%"><input type="text"  id="hzxmquery" name="hzxmquery" maxlength="25" class="TextEditor" title="户主姓名" style="width:90%"/><font color="red">*</font></td>
				<td class="FieldLabel" width="15%">户主身份证:</td>
				<td class="FieldInput" width="25%"><input type="text" style="width:90%" id="sfzhquery" name="sfzhquery" maxlength="18"  class="TextEditor" title="户主身份证" /></td>
			...
			<tr>
			    <td class="FieldLabel" nowrap width="15%">救助类型:</td>
			    <td class="FieldInput" width="25%"><input type="text" id="jzlxDisplay" style="width:60%" readOnly="true" ondblclick="displayDbClick('jzlxDisplay','jzlxquery')" />
			    ...
			    <td class="FieldLabel" width="15%" nowrap="nowrap">录入日期：</td>
				<td class="FieldInput" colspan="1" width="25%" nowrap="nowrap"><input type="text" id="lrrqQ" format="Ymd" name="lrrqQ"  style="width:36%"  onclick="LoushangDate(this)" readonly="readonly"/> -----
