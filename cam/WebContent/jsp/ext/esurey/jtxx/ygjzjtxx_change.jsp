...
<model:datasets>
	...
	<model:dataset id="YgjzJtxxCyxxDataSet3"
		cmd="com.inspur.sdmz.jtxx.cmd.YgjzJtxxCyxxCommand" global="true"
		autoLoad="false">
		<model:record fromBean="com.inspur.sdmz.jtxx.data.BaseinfoPeople"></model:record>
	</model:dataset>
...
<next:Panel height="100%" width="100%" >
	<next:TopBar>
		...
		<next:ToolBarItem iconCls="save" text="提交" handler="modifyClick2" />
		<next:ToolBarItem iconCls="undo" text="返回" handler="returnClick2" />
	</next:TopBar>
	<next:TabPanel id="tabPanels" height="100%" width="100%" activeTab="0">
		<next:Tabs>
			<next:Panel title="困难家庭信息" name="阳光基本信息" height="100%" autoScroll="true">
				<next:AnchorLayout>
							...
							<table border="0" width="100%" >
								<tr>
									...
									<td class="FieldInput" width="20%"><input type="text"
										id="familyName" name="户主姓名" maxlength="25" field="familyName"
										onchange="checkCN('familyName','familyCardNo','户主姓名');" style="width: 75%"/><font color="red">*</font></td>
									<td class="FieldLabel" width="10%">身份证号：</td>
									<td class="FieldInput" width="20%"><input type="text"
										id="familyCardNo" name="身份证号" maxlength="18"
										onchange="checkIDCard('familyCardNo','户主身份证');checkIfRepeat();"
										style="width: 75%" field="familyCardNo" /><font color="red">*</font><br>
									若该人无身份证,<a href="#" onClick="getMaxCode('familyCardNo');">请点击此处获取编号</a></td>
									<td class="FieldLabel" width="10%" rowspan="3">照片:</td>
									<td class="FieldInput" nowrap rowspan="3"><img
										name="RELATIONER_PHOTO_IMG" width=140 height=90
								...
								<tr>
									...
									<td class="FieldInput" width="10%"><select id="town"
								...
								<tr>
									...
									<td class="FieldInput" width="15%"><select id="village"
								...
								<tr>
									...
									<td class="FieldInput" width="10%"><input type="text"
										id="familyPhone" name="familyPhone" maxlength="20" onchange="checkDhhm();"
										field="familyPhone" style="width: 75%"/></td>
									<td class="FieldLabel" width="10%">手机：</td>
									<td class="FieldInput" width="15%"><input type="text"
										id="familyMobile" name="familyMobile" maxlength="20" onchange="checkSjhm();"
										style="width: 75%" field="familyMobile" /></td>
									<td class="FieldLabel" nowrap width="10%">其他联系方式：</td>
									<td class="FieldInput" width="20%"><input type="text"
										name="familyOtherPhone" maxlength="25" field="familyOtherPhone" style="width: 75%"/></td>
								</tr>
								<tr>
									<td class="FieldLabel" width="10%" nowrap="nowrap">家庭年总收入:<br>
									(单位：元)&nbsp</td>
									<td class="FieldInput" width="10%"><input type="text"
										id="yearIncome" name="家庭年总收入" maxlength="9" field="yearIncome"
										onchange="CheckTxt('yearIncome','家庭年总收入');" style="width: 75%"/><font color="red">*</font></td>
									<td class="FieldLabel" nowrap="nowrap" width="10%">家庭年人均收入：<br>
									(单位：元)&nbsp</td>
									<td class="FieldInput"><span
										onmousemove="this.setCapture();"
										onmouseout="this.releaseCapture();"> <input type="text"
										name="yearAverageIncome" maxlength="9" style="width: 75%"
										field="yearAverageIncome" readonly="true" /></span>&nbsp;<font color=green>自动生成</font></td>
									<td class="FieldLabel" nowrap width="10%">人口数量：</td>
									<td class="FieldInput" width="20%"><span
										onmousemove="this.setCapture();"
										onmouseout="this.releaseCapture();"> <input type="text"
										style="width: 30px" name="peopleNum" maxlength="2" field="peopleNum"
								...
								<tr>
									<td class="FieldLabel" nowrap="nowrap" width="10%">建筑面积 :<br>
									(单位：平方米)&nbsp</td>
									<td class="FieldInput" width="10%"><input type="text"
										name="buildArea" maxlength="6" field="buildArea"
										onchange=" CheckTxt('buildArea','建筑面积');" style="width: 75%"/></td>
									<td class="FieldLabel" nowrap width="15%">人均建筑面积: <br>
									(单位：平方米) &nbsp</td>
									<td class="FieldInput"><span
										onmousemove="this.setCapture();"
										onmouseout="this.releaseCapture();"> <input type="text"
								...
								<tr>
									...
									<td class="FieldInput" width="20%"><input type="file"
										id="agreement"  name="agreement" onchange="agreementCheck(this)"/> <br />
									<label field="agreementName"></label>&nbsp;<a id="download"
			...
			<next:Panel  width="100%" autoHeight="true" height="50%">
			<next:Html>
				<form id="accountForm" method="post"  onsubmit="return false" class="L5form">
				  ...
				  <table id="isCity" width="100%" style="display:none">
				   ...
				   <table id="isFive" width="100%"  style="display:none">
					...
					<next:EditGridPanel height="50%" id="YgjzJtxxZrzhEditGridPanel"
						...
						<next:Columns>
							...
							<next:Column id="familyId" header="家庭ID" field="familyId" width="120"
								hidden="true">
								<next:TextField allowBlank="false" />
							</next:Column>
							<next:Column id="calamityDate" header="受灾时间" field="calamityDate" width="120"
								align="center">
								<next:DateField allowBlank="false" format="Y-m-d" />
							</next:Column>
							<next:Column id="calamityType" header="灾害种类" field="calamityType" width="120"
								align="center">
					...
					<next:EditGridPanel id="YgjzJzzsEditGridPanel"
						...
						autoScroll="true" height="50%" dataset="YgjzJzzsDataSet"
						title="阳光救助_救助指数">
						<next:Columns>
							<next:RowNumberColumn width="30" />
							<next:CheckBoxColumn></next:CheckBoxColumn>
							...
							<next:Column id="deformityIndex" header="残疾救助指数" field="deformityIndex"
								width="90" align="center">
								<next:NumberField allowBlank="false" />
							</next:Column>
			...
			<next:Panel title="家庭成员基本信息" name="anchor-div" height="100%">
				<next:AnchorLayout>
					<next:GridPanel id="YgjzJtxxCyxxEditGridPanel"
						...
						height="600" dataset="YgjzJtxxCyxxDataSet" title="阳光救助_家庭信息_成员信息">
						<next:TopBar>
							<next:ToolBarItem symbol="->"></next:ToolBarItem>
							<next:ToolBarItem text="增加" iconCls="add"
								handler="addYgjzJtxxCyxx" />
							<next:ToolBarItem text="修改" iconCls="edit" handler="modifyCyxx" />
							<next:ToolBarItem text="删除" iconCls="remove"
								handler="removeYgjzJtxxCyxx" />
						</next:TopBar>
						<next:Columns>
							<next:RowNumberColumn width="30" />
							<next:CheckBoxColumn></next:CheckBoxColumn>
							<next:Column id="peopleId" header="成员ID" field="peopleId" 
								hidden="true">
								<next:TextField allowBlank="false" />
							</next:Column>
							...
							<next:Column id="idCard" header="身份证号" field="idCard" width="23%"
								align="center">
								<next:TextField />
							</next:Column>
							<next:Column id="sex" header="性别" field="sex" width="8%"
								align="center" dataset="DmXbDataSet">
								<next:TextField />
							</next:Column>
							<next:Column id="regPeople" header="录入人" field="regPeople" width="15%"
								align="center">
								<next:TextField />
							</next:Column>
				...
				<table border="0" width="750">
					<tr>
						...
						<td class="FieldInput" style="width: 20%"><input type="text"
							onchange="checkJtcyCN('name','idCard','户主姓名');"
							id="name" name="name" field="name" style="width: 90%"/><font color="red">*</font></td>
						<td class="FieldLabel" nowrap="nowrap" style="width: 10%">身份证号：</td>
						<td class="FieldInput" style="width: 20%"><input type="text"
							onchange="if(checkIDCard('idCard','户主身份证')){checkCyxxIfReapeat()};getBirthdayByIdCard();"
							id="idCard" style="width: 90%" name="idCard" field="idCard" /><font
							color="red">*</font><br>
						若该人无身份证,<a href="#" onClick="getMaxCode2('idCard');">请点击此处获取编号</a></td>
						<td class="FieldLabel" width="10%" rowspan="4">照片:</td>
						<td nowrap colspan="1" rowspan="4"><img
							name="RELATIONER_PHOTOC_IMG" width=90 height=130 id="photocImg"
					...
					<tr>
						...
						<td class="FieldInput" style="width: 20%"><select id="relationshipType"
							name="relationshipType" field="relationshipType" style="width: 90%">
							<option dataset="DmHzgxDataSet"></option>
						</select><font color="red">*</font></td>
						<td class="FieldLabel" nowrap="nowrap" style="width: 10%">性别：</td>
						<td class="FieldInput" style="width: 20%"><select name="sex"
							field="sex" style="width: 90%">
					...
					<tr>
						...
						<td class="FieldInput" style="width: 20%"><input type="text"
							id="birthday" format="Ymd" name="birthday"
							field="birthday" onclick="LoushangDate(this)" style="width: 90%"/><font color="red">*</font></td>
						<td class="FieldLabel" nowrap="nowrap" style="width: 10%">户籍性质：</td>
						<td class="FieldInput" style="width: 20%"><select
							name="domicileType" field="domicileType" style="width: 90%">
							<option dataset="DmHjxzDataSet"></option>
						</select><font color="red">*</font></td>
					</tr>
					<tr>
						<td class="FieldLabel" nowrap="nowrap" style="width: 10%">民族：</td>
						<td class="FieldInput" style="width: 20%"><select id="nation"
							name="nation" field="nation" style="width: 90%">
							<option dataset="DmMzDataSet"></option>
						</select><font color="red">*</font></td>
						<td class="FieldLabel" nowrap="nowrap" style="width: 10%">婚姻状况：</td>
						<td class="FieldInput" style="width: 20%"><select
							name="marriageCode" field="marriageCode" style="width: 90%">
					...
					<tr>
						...
						<td class="FieldInput" style="width: 20%"><input type="text"
							name="telMobile" field="telMobile" onchange="checkSjhm();" style="width: 90%"/></td>
						<td class="FieldLabel" nowrap="nowrap" style="width: 10%">其他联系方式：</td>
						<td class="FieldInput" style="width: 20%"><input type="text"
							name="telOther" field="telOther" style="width: 90%"/></td>
					...
					<tr>
						...
						<td class="FieldInput" style="width: 20%"><select
							name="safeguardType" field="safeguardType" style="width: 90%">
						...
						<td class="FieldInput" style="width: 20%">
						    <select name="employmentCode" field="employmentCode" style="width: 34%">
					...
					<tr>
						...
						<td class="FieldInput" style="width: 20%"><input type="text"
							name="workUnitName" field="workUnitName" style="width: 90%"/></td>
						<td class="FieldLabel" nowrap="nowrap" style="width: 10%">工作单位电话：</td>
						<td class="FieldInput" style="width: 20%"><input type="text"
							name="workUnitTel" field="workUnitTel" style="width: 90%"/></td>
						<td class="FieldLabel" nowrap="nowrap" style="width: 10%">工作单位地址：</td>
						<td class="FieldInput" style="width: 20%"><input type="text"
							name="workUnitAdd" field="workUnitAdd" style="width: 90%"/></td>
					</tr>
					<tr>
						<td class="FieldLabel" nowrap="nowrap" style="width: 10%">抚恤对象类型：</td>
						<td class="FieldInput" style="width: 20%"><select
							name="bptType" field="bptType" style="width: 90%">
							<option dataset="DmFxdxlxDataSet"></option>
						</select></td>
						<td class="FieldLabel" nowrap="nowrap" style="width: 10%">抚恤定补金：</td>
						<td class="FieldInput" style="width: 20%"><input type="text"
							name="bptNum" onchange="CheckTxt('bptNum','抚恤定补金');"
							field="bptNum" style="width: 34%"/></td>
