function init(){
	...
	cdcOrganInfoDataSet.setParameter("ORGAN_TYPE@=","1");
...
function insert(){
	...
	var url="jsp/ext/cdc/manage/organInfo/cdcOrganInfoEdit.jsp";
	L5.forward(url,'',data);
}
function update(){
...
function detail(){
	...
	var data=new L5.Map();
	data.put("organId",records[0].get("organId"));
	var url="jsp/ext/cdc/manage/organInfo/cdcOrganInfoDetail.jsp";
	L5.forward(url,'',data);
}
function del(){
	var grid=L5.getCmp("grid");
