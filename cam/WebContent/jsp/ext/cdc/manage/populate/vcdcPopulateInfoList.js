...
function init(){
	...
	populateDataSet.setParameter("REPORT_TYPE@=","N");
...
function insert(){
	...
	if(ifInsert){
		...
		var url="jsp/ext/cdc/manage/populate/vcdcPopulateInfoEdit.jsp";
		L5.forward(url,'',data);
	}else{
...
function detail(){
	...
	var data=new L5.Map();
	data.put("recordId",records[0].get("recordId"));
	var url="jsp/ext/cdc/manage/populate/vcdcPopulateInfoDetail.jsp";
	L5.forward(url,'',data);
}
function report(){
	var grid=L5.getCmp("grid");
...
function sumInsert(){
	var data=new L5.Map();
	data.put("method","insert");
	var url="jsp/ext/cdc/manage/populate/vcdcPopulateInfoSum.jsp";
	L5.forward(url,'',data);
}
function sumRedo(){
	var grid=L5.getCmp("grid");
