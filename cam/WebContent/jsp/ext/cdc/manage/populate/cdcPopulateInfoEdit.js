function init(){
	...
	if(method=="insert"){
		...
		populateDataSet.newRecord({"organCode":organCode,"organName":organName,"parentCode":parentCode,"communityNum":"1","reportType":"C"});
...
function save(){
	...
	if (!command.error){
		L5.Msg.alert("提示","保存成功！",function(){
			var url="jsp/ext/cdc/manage/populate/cdcPopulateInfoList.jsp";
			L5.forward(url,'',null);
		});
	}else{
