...
function nextPage(){
	var data = new L5.Map();
	var url='jsp/cams/sorg/check/group/detail/groupCheckDetail11.jsp';
...
<p class=MsoNormal align=left width=800px
	...
	<label field="delegateBuildNum" style="width:30"></label>
	）个，其中已办理成立登记手续的（	<label field="delegateBuildedNum" style="width:30"></label>
	）个；<span
...
<p class=MsoNormal align=left width=800px
	...
	<label field="delegateCancelNum" style="width:30"></label>
	）个，其中已办理注销登记手续的（
	<label field="delegateCanceledNum" style="width:30"></label>
	）个；<span
	lang=EN-US><o:p></o:p></span></span></p>
