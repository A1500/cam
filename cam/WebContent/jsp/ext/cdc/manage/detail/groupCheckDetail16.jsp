...
<script language="javascript">
	...
	function init(){
		...
		somCheckInterProjectDataSet.on("load",function(ds){
			if(ds.getCount()<1){
				...
				for(i=1;i<=ds.getCount();i++){
					document.getElementById("projectName"+i).innerHTML=ds.getAt(i-1).get("projectName");
					document.getElementById("auditOrganName"+i).innerHTML=ds.getAt(i-1).get("auditOrganName");
					document.getElementById("coopOrganName"+i).innerHTML=ds.getAt(i-1).get("coopOrganName");
					document.getElementById("coopOrganNation"+i).innerHTML=ds.getAt(i-1).get("coopOrganNation");
					...
					document.getElementById("projectPeriod"+i).innerHTML=ds.getAt(i-1).get("projectPeriod");
					document.getElementById("projectPlace"+i).innerHTML=ds.getAt(i-1).get("projectPlace");
				}
			}
		});
		...
		somCheckInterMeetingDataSet.on("load",function(ds){
			if(ds.getCount()<1){
				...
				for(i=1;i<=ds.getCount();i++){
					document.getElementById("meetingName"+i).innerHTML=ds.getAt(i-1).get("meetingName");
					document.getElementById("meetingDate"+i).innerHTML=ds.getAt(i-1).get("meetingDate");
					document.getElementById("meetingType"+i).innerHTML=ds.getAt(i-1).get("meetingType");
					document.getElementById("meetingPlace"+i).value=ds.getAt(i-1).get("meetingPlace");
					document.getElementById("hostOrganName"+i).innerHTML=ds.getAt(i-1).get("hostOrganName");
					document.getElementById("fundsSource"+i).value=ds.getAt(i-1).get("fundsSource");
					document.getElementById("speakSubject"+i).innerHTML=ds.getAt(i-1).get("speakSubject");
				}
			}
		});
	}
	...
	function nextPage(){
		...
		var url='jsp/cams/sorg/check/group/detail/groupCheckDetail17.jsp';
		var text = '下一页';
		L5.forward(url,text,data);
	}
</script>
...
<form method="post" dataset=somCheckInterProjectDataSet onsubmit="return false">
	<table cellspacing=0 cellpadding=0 width="800">
		...
		<tr style='page-break-inside: avoid; height: 36.75pt'>
			...
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="项目名称" id="projectName1" style="width: 98%" /></span></p>
			</td>
			<td width="8%"
			...
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="境外合作单位名称" id="coopOrganName1" style="width: 98%" /></span></p>
			</td>
			<td width="12%"
			...
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="境外合作单位所属国家、地区或国际组织" id="coopOrganNation1" style="width: 98%" /></span></p>
			</td>
			<td width="10%"
			...
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="境内项目资金" id="onProjectFund1" style="width: 98%;text-align: right" /></span></p>
			</td>
			<td width="10%"
				style='width: 10.52%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="境外项目资金" id="offProjectFund1" style="width: 98%;text-align: right" /></span></p>
			</td>
			<td width="8%"
				style='width: 8.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<select name='项目类别' id="projectType1" style="width: 90%" disabled="disabled"/>
			...
			<td width="8%"
				style='width: 8.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="项目实施时间" id="projectPeriod1" style="width: 98%" /></span></p>
			</td>
			<td width="12%"
			...
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="项目实施地" id="projectPlace1" style="width: 98%" /></span></p>
			</td>
		</tr>
		<tr style='page-break-inside: avoid; height: 36.75pt'>
			<td width="15%"
				style='width: 15.78%; border-top: none; border-left: solid windowtext 1.5pt; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext 1.5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="项目名称" id="projectName2" style="width: 98%" /></span></p>
			</td>
			<td width="8%"
				style='width: 8.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
			...
			<td width="12%"
				style='width: 12.04%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="境外合作单位名称" id="coopOrganName2" style="width: 98%" /></span></p>
			</td>
			<td width="12%"
				style='width: 12.52%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="境外合作单位所属国家、地区或国际组织" id="coopOrganNation2" style="width: 98%" /></span></p>
			</td>
			<td width="10%"
				style='width: 10.52%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="境内项目资金" id="onProjectFund2" style="width: 98%;text-align: right" /></span></p>
			</td>
			<td width="10%"
				style='width: 10.52%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="境外项目资金" id="offProjectFund2" style="width: 98%;text-align: right" /></span></p>
			</td>
			<td width="8%"
				style='width: 8.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<select name='项目类别' id="projectType2" style="width: 90%" disabled="disabled"/>
					<option dataset="projectTypeSelect"></option>
				</select></span></p>
			</td>
			<td width="8%"
				style='width: 8.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="项目实施时间" id="projectPeriod2" style="width: 98%" /></span></p>
			</td>
			<td width="12%"
				style='width: 12.28%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.5pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext 1.5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="项目实施地" id="projectPlace2" style="width:98%" /></span></p>
			</td>
		</tr>
		<tr style='page-break-inside: avoid; height: 36.75pt'>
			<td width="15%"
				style='width: 15.78%; border-top: none; border-left: solid windowtext 1.5pt; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext 1.5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="项目名称" id="projectName3" style="width: 98%" /></span></p>
			</td>
			<td width="8%"
				style='width: 8.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
			...
			<p class=MsoNormal align=center
				...
				<label name="境外合作单位名称" id="coopOrganName3" style="width: 98%" /></span></p>
			</td>
			<td width="12%"
				style='width: 12.52%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center
				style='text-align: center; mso-pagination: widow-orphan'><span> 
				<label name="境外合作单位所属国家、地区或国际组织" id="coopOrganNation3" style="width: 98%" /></span></p>
			</td>
			<td width="10%"
				style='width: 10.52%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="境内项目资金" id="onProjectFund3" style="width: 98%;text-align: right" /></span></p>
			</td>
			<td width="10%"
				style='width: 10.52%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="境外项目资金" id="offProjectFund3" style="width: 98%;text-align: right" /></span></p>
			</td>
			<td width="8%"
				style='width: 8.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<select name='项目类别' id="projectType3" style="width: 90%" disabled="disabled"/>
					<option dataset="projectTypeSelect"></option>
				</select></span></p>
			</td>
			<td width="8%"
				style='width: 8.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="项目实施时间" id="projectPeriod3" style="width: 98%" /></span></p>
			</td>
			<td width="12%"
				style='width: 12.28%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.5pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext 1.5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="项目实施地" id="projectPlace3" style="width:98%" /></span></p>
			</td>
		</tr>
		<tr style='page-break-inside: avoid; height: 36.75pt'>
			<td width="15%"
				style='width: 15.78%; border-top: none; border-left: solid windowtext 1.5pt; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext 1.5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="项目名称" id="projectName4" style="width: 98%" /></span></p>
			</td>
			<td width="8%"
				style='width: 8.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
			...
			<p class=MsoNormal align=center
				style='text-align: center; mso-pagination: widow-orphan'><span> 
				<label name="境外合作单位名称" id="coopOrganName4" style="width: 98%" /></span></p>
			</td>
			<td width="12%"
				style='width: 12.52%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center
				style='text-align: center; mso-pagination: widow-orphan'><span> 
				<label name="境外合作单位所属国家、地区或国际组织" id="coopOrganNation4" style="width: 98%" /></span></p>
			</td>
			<td width="10%"
				style='width: 10.52%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="境内项目资金" id="onProjectFund4" style="width: 98%;text-align: right" /></span></p>
			</td>
			<td width="10%"
				style='width: 10.52%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="境外项目资金" id="offProjectFund4" style="width: 98%;text-align: right" /></span></p>
			</td>
			<td width="8%"
				style='width: 8.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<select name='项目类别' id="projectType4" style="width: 90%" disabled="disabled"/>
					<option dataset="projectTypeSelect"></option>
				</select></span></p>
			</td>
			<td width="8%"
				style='width: 8.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="项目实施时间" id="projectPeriod4" style="width: 98%" /></span></p>
			</td>
			<td width="12%"
				style='width: 12.28%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.5pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext 1.5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="项目实施地" id="projectPlace4" style="width:98%" /></span></p>
			</td>
		</tr>
		<tr
			...
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="项目名称" id="projectName5" style="width: 98%" /></span></p>
			</td>
			<td width="8%"
			...
			<p class=MsoNormal align=center
				style='text-align: center; mso-pagination: widow-orphan'><span> 
				<label name="境外合作单位名称" id="coopOrganName5" style="width: 98%" /></span></p>
			</td>
			<td width="12%"
			...
			<p class=MsoNormal align=center
				style='text-align: center; mso-pagination: widow-orphan'><span> 
				<label name="境外合作单位所属国家、地区或国际组织" id="coopOrganNation5" style="width: 98%" /></span></p>
			</td>
			<td width="10%"
			...
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="境内项目资金" id="onProjectFund5" style="width: 98%;text-align: right" /></span></p>
			</td>
			<td width="10%"
				style='width: 10.52%; border-top: none; border-left: none; border-bottom: solid windowtext 1.5pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-bottom-alt: solid windowtext 1.5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="境外项目资金" id="offProjectFund5" style="width: 98%;text-align: right" /></span></p>
			</td>
			<td width="8%"
				style='width: 8.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.5pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-bottom-alt: solid windowtext 1.5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<select name='项目类别' id="projectType5" style="width: 90%" disabled="disabled"/>
					<option dataset="projectTypeSelect"></option>
				</select></span></p>
			</td>
			<td width="8%"
				style='width: 8.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.5pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-bottom-alt: solid windowtext 1.5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 36.75pt'>
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="项目实施时间" id="projectPeriod5" style="width: 98%" /></span></p>
			</td>
			<td width="12%"
			...
			<p class=MsoNormal align=center style='text-align: center'><span> 
				<label name="项目实施地" id="projectPlace5" style="width:98%" /></span></p>
			</td>
		</tr>
	</table>
</form>
...
<form method="post" dataset=somCheckInterMeetingDataSet onsubmit="return false">
	<table cellspacing=0 cellpadding=0 width="800">		
		...
		<tr style='height: 31.5pt'>
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<label name="会议名称" id="meetingName1" style="width: 98%" /></span></p>
			</td>
			<td width="10%"
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<label name='会议时间' id="meetingDate1" format="Y-m-d" onclick="LoushangDate(this)" readonly="readonly" style="width: 98%" /></span></p>
			</td>
			<td width="10%"
				style='width: 10.52%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 31.5pt'>
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<label name="会议地点" id="meetingPlace1" style="width: 98%" /></span></p>
			</td>
			<td width="12%"
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<select name='会议类型' id="meetingType1" style="width: 90%" disabled="disabled"/>
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<label name="会议主办单位名称" id="hostOrganName1" style="width: 98%" /></span></p>
			</td>
			<td width="10%"
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<select name='我方经费来源' id="fundsSource1" style="width: 90%" disabled="disabled"/>
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<label name="我方发言主题" id="speakSubject1" style="width: 98%" /></span></p>
			</td>
		</tr>
		<tr style='height: 31.5pt'>
			<td width="15%"
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<label name="会议名称" id="meetingName2" style="width: 98%" /></span></p>
			</td>
			<td width="10%"
				style='width: 10.52%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 31.5pt'>
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<label name='会议时间' id="meetingDate2" format="Y-m-d" onclick="LoushangDate(this)" readonly="readonly" style="width: 98%" /></span></p>
			</td>
			<td width="10%"
				style='width: 10.52%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 31.5pt'>
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<label name="会议地点" id="meetingPlace2" style="width: 98%" /></span></p>
			</td>
			<td width="12%"
				style='width: 12.28%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 31.5pt'>
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<select name='会议类型' id="meetingType2" style="width: 90%" disabled="disabled"/>
					<option dataset="meetingTypeSelect"></option>
				</select></span></p>
			</td>
			<td width="19%"
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<label name="会议主办单位名称" id="hostOrganName2" style="width: 98%" /></span></p>
			</td>
			<td width="10%"
				style='width: 10.0%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 31.5pt'>
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<select name='我方经费来源' id="fundsSource2" style="width: 90%" disabled="disabled"/>
					<option dataset="fundsSourceSelect"></option>
				</select></span></p>
			</td>
			<td width="21%"
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<label name="我方发言主题" id="speakSubject2" style="width: 98%" /></span></p>
			</td>
		</tr>
		<tr style='height: 31.5pt'>
			<td width="15%"
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<label name="会议名称" id="meetingName3" style="width: 98%" /></span></p>
			</td>
			<td width="10%"
				style='width: 10.52%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 31.5pt'>
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<label name='会议时间' id="meetingDate3" format="Y-m-d" onclick="LoushangDate(this)" readonly="readonly" style="width: 98%" /></span></p>
			</td>
			<td width="10%"
				style='width: 10.52%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 31.5pt'>
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<label name="会议地点" id="meetingPlace3" style="width: 98%" /></span></p>
			</td>
			<td width="12%"
				style='width: 12.28%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 31.5pt'>
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<select name='会议类型' id="meetingType3" style="width: 90%" disabled="disabled"/>
					<option dataset="meetingTypeSelect"></option>
				</select></span></p>
			</td>
			<td width="19%"
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<label name="会议主办单位名称" id="hostOrganName3" style="width: 98%" /></span></p>
			</td>
			<td width="10%"
				style='width: 10.0%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 31.5pt'>
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<select name='我方经费来源' id="fundsSource3" style="width: 90%" disabled="disabled"/>
					<option dataset="fundsSourceSelect"></option>
				</select></span></p>
			</td>
			<td width="21%"
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<label name="我方发言主题" id="speakSubject3" style="width: 98%" /></span></p>
			</td>
		</tr>
		<tr style='height: 31.5pt'>
			<td width="15%"
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<label name="会议名称" id="meetingName4" style="width: 98%" /></span></p>
			</td>
			<td width="10%"
				style='width: 10.52%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 31.5pt'>
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<label name='会议时间' id="meetingDate4" format="Y-m-d" onclick="LoushangDate(this)" readonly="readonly" style="width: 98%" /></span></p>
			</td>
			<td width="10%"
				style='width: 10.52%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 31.5pt'>
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<label name="会议地点" id="meetingPlace4" style="width: 98%" /></span></p>
			</td>
			<td width="12%"
				style='width: 12.28%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 31.5pt'>
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<select name='会议类型' id="meetingType4" style="width: 90%" disabled="disabled"/>
					<option dataset="meetingTypeSelect"></option>
				</select></span></p>
			</td>
			<td width="19%"
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<label name="会议主办单位名称" id="hostOrganName4" style="width: 98%" /></span></p>
			</td>
			<td width="10%"
				style='width: 10.0%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 31.5pt'>
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<select name='我方经费来源' id="fundsSource4" style="width: 90%" disabled="disabled"/>
					<option dataset="fundsSourceSelect"></option>
				</select></span></p>
			</td>
			<td width="21%"
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<label name="我方发言主题" id="speakSubject4" style="width: 98%" /></span></p>
			</td>
		</tr>
		<tr style='mso-yfti-lastrow: yes; height: 31.5pt'>
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<label name="会议名称" id="meetingName5" style="width: 98%" /></span></p>
			</td>
			<td width="10%"
				style='width: 10.52%; border-top: none; border-left: none; border-bottom: solid windowtext 1.5pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-bottom-alt: solid windowtext 1.5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 31.5pt'>
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<label name='会议时间' id="meetingDate5" format="Y-m-d" onclick="LoushangDate(this)" readonly="readonly" style="width: 98%" /></span></p>
			</td>
			<td width="10%"
				style='width: 10.52%; border-top: none; border-left: none; border-bottom: solid windowtext 1.5pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-bottom-alt: solid windowtext 1.5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 31.5pt'>
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<label name="会议地点" id="meetingPlace5" style="width: 98%" /></span></p>
			</td>
			<td width="12%"
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<select name='会议类型' id="meetingType5" style="width: 90%" disabled="disabled"/>
					<option dataset="meetingTypeSelect"></option>
				</select></span></p>
			</td>
			<td width="19%"
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<label name="会议主办单位名称" id="hostOrganName5" style="width: 98%" /></span></p>
			</td>
			<td width="10%"
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<select name='我方经费来源' id="fundsSource5" style="width: 90%" disabled="disabled"/>
					<option dataset="fundsSourceSelect"></option>
				</select></span></p>
			</td>
			<td width="21%"
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 150%'><span> 
				<label name="我方发言主题" id="speakSubject5" style="width: 98%" /></span></p>
			</td>
		</tr>
	</table>
</form>
