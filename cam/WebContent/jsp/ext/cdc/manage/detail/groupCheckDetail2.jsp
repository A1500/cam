...
<script language="javascript">
	...
	function nextPage(){
		...
		var url='jsp/cams/sorg/check/group/detail/groupCheckDetail3.jsp';
		var text = '下一页';
		L5.forward(url,text,data);
	}
</script>
...
<!--机构设置情况-->
		<tr style='page-break-inside: avoid; height: 27.0pt'>
			...
			<p class=MsoNormal
				...
				<label name='代表机构数' id="delegateNum" style="width: 98%" maxlength="10" /></span></p>
			</td>
		</tr>
		<tr style='page-break-inside: avoid; height: 27.0pt'>
			<td width="37%" colspan=3
...
<!--举办刊物情况-->
		...
		<tr style='page-break-inside: avoid; height: 27.0pt'>
			...
			<p class=MsoNormal
				style='line-height: 27.0pt; mso-line-height-rule: exactly'><span> 
				<label name='公开发行的刊物名称' id="publicationName" style="width: 98%" maxlength="10" /></span></p>
			</td>
		</tr>
<!--会费情况-->
		...
		<tr style='mso-yfti-lastrow: yes; page-break-inside: avoid; height: 84.55pt'>
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 27.0pt; mso-line-height-rule: exactly'><span> 
				<textarea name='会费标准' id="feeRule" style="width: 98%" rows="10" readonly="readonly"></textarea></span></p>
			</td>
		</tr>
