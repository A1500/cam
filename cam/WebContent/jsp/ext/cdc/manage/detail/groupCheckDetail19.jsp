...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0
	...
	<tr style='mso-yfti-irow: 0; mso-yfti-firstrow: yes; height: 231.65pt'>
		...
		<p class=MsoNormal align=center style="margin-top: 7.8pt;"><span
			...
			<textarea field="borgOpinionDesc" name="业务主管单位初审意见" style="width: 700" rows="18" readonly></textarea>
		</o:p></span></p>
		</td>
	</tr>
	...
	<tr style='mso-yfti-irow: 2; height: 275.95pt'>
		...
		<p class=MsoNormal align=center style="margin-top: 7.8pt;"><span
			lang=EN-US style='font-size: 14.0pt'><o:p>
			<textarea field="checkResultDesc" name="登记管理机关审定意见" style="width: 700" rows="22" readonly></textarea>
		</o:p></span></p>
		</td>
	</tr>
