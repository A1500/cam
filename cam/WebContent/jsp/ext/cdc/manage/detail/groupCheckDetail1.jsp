...
<next:ScriptManager/>
		...
		<script language="javascript">
			...
			function nextPage(){
				var data = new L5.Map();
				var url='jsp/cams/sorg/check/group/detail/groupCheckDetail2.jsp';
...
<tr style='height:27.0pt'>
  ...
  <p align=center style='line-height:28.0pt;'>
  	<span>
		<textarea rows="5" name='业务范围' field="business" style="width:98%;overflow:auto" readonly="readonly"></textarea>
	</span>
  </p>
  </td>
 </tr>
 ...
 <tr style='page-break-inside:avoid;height:27.0pt'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:27.0pt'>
  <p  align=center>
  <span><label  style="text-align:right" field="regMon" style="width:58%"></label>万元</span></p>
  </td>
 </tr>
 <tr style='page-break-inside:avoid;height:27.0pt'>
  <td width="16%" style='width:16.88%;border-top:none;border-left:solid windowtext 1.5pt;
 ...
 <tr style='page-break-inside:avoid;height:27.0pt'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:27.0pt'>
	  <p style='line-height:28.0pt;'>
		  <span style='font-size:14.0pt;font-family:宋体'>
		  省部级及以上(<label  field="servantProNum" style="width:30"></label>)人；
		  地厅级(<label  field="servantCityNum" style="width:30"></label>)人；
		  县处级(<label  field="servantTownNum" style="width:30"></label>)人
		  </span>
	  </p>
  </td>
 </tr>
 <tr style='mso-yfti-lastrow:yes;page-break-inside:avoid;height:27.0pt'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:27.0pt'>
	  <p style='margin-right:-.7pt;line-height:28.0pt;'>
		  <span style='font-size:14.0pt;font-family:宋体'>
		  总数(<label  field="retiredSumNum" style="width:30"></label>)人，
		  其中地厅级及以上(<label  field="retiredCityNum" style="width:30"></label>)人；
		  70岁以上(<label  field="retiredOldNum" style="width:30"></label>)人
		  </span>
	  </p>
  </td>
 </tr>
