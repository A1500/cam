...
<script language="javascript">
	...
	function nextPage(){
		...
		var url='jsp/cams/sorg/check/group/detail/groupCheckDetail4.jsp';
		var text = '下一页';
		L5.forward(url,text,data);
	}
</script>
	...
	<table cellspacing=0 cellpadding=0 width="800" id="changeTable">
		...
		<tr style='height: 18.0pt'>
			...
			<p class=MsoNormal
				...
				<label id="changeDate1" style="width: 98%" /></span></p>
			</td>
		</tr>
		<tr style='height: 18.0pt'>
			<td width="33%"
			...
			<p class=MsoNormal
				style='line-height: 25.0pt; mso-line-height-rule: exactly'><b
				style='mso-bidi-font-weight: normal'><span> 
				<label id="changeDate2" style="width: 98%" /></span></p>
			</td>
		</tr>
		<tr style='height: 18.0pt'>
			<td width="33%"
			...
			<p class=MsoNormal
				style='line-height: 25.0pt; mso-line-height-rule: exactly'><b
				style='mso-bidi-font-weight: normal'><span> 
				<label id="changeDate3" style="width: 98%" /></span></p>
			</td>
		</tr>
		<tr style='height: 18.0pt'>
			<td width="33%"
			...
			<p class=MsoNormal
				style='line-height: 25.0pt; mso-line-height-rule: exactly'><b
				style='mso-bidi-font-weight: normal'><span> 
				<label id="changeDate4" style="width: 98%" /></span></p>
			</td>
		</tr>
		<tr style='height: 18.0pt'>
			<td width="33%"
			...
			<p class=MsoNormal
				style='line-height: 25.0pt; mso-line-height-rule: exactly'><b
				style='mso-bidi-font-weight: normal'><span> 
				<label id="changeDate5" style="width: 98%" /></span></p>
			</td>
		</tr>
		<tr style='height: 18.0pt'>
			<td width="33%"
			...
			<p class=MsoNormal
				style='line-height: 25.0pt; mso-line-height-rule: exactly'><b
				style='mso-bidi-font-weight: normal'><span> 
				<label id="changeDate6" style="width: 98%" /></span></p>
			</td>
		</tr>
		<tr style='height: 18.0pt'>
			<td width="33%"
			...
			<p class=MsoNormal
				style='line-height: 25.0pt; mso-line-height-rule: exactly'><b
				style='mso-bidi-font-weight: normal'><span> 
				<label id="changeDate7" style="width: 98%" /></span></p>
			</td>
		</tr>
		<tr style='height: 18.0pt'>
			<td width="33%"
			...
			<p class=MsoNormal
				style='line-height: 25.0pt; mso-line-height-rule: exactly'><b
				style='mso-bidi-font-weight: normal'><span> 
				<label id="changeDate8" style="width: 98%" /></span></p>
			</td>
		</tr>
		<tr style='mso-yfti-lastrow: yes; height: 18.0pt'>
			...
			<p class=MsoNormal
				style='line-height: 25.0pt; mso-line-height-rule: exactly'><b
				style='mso-bidi-font-weight: normal'><span> 
				<label id="changeDate9" style="width: 98%" /></span></p>
			</td>
		</tr>
	</table>
</form>
	...
	<table cellspacing=0 cellpadding=0 width="800">
		...
		<tr style='height: 23.25pt'>
			...
			<p class=MsoNormal
				...
				lang=EN-US><label name='章程规定换届年数' field="generalElectionYears" style="width: 30"></label><span style='mso-spacerun: yes'></span></span>）年一届<span
				lang=EN-US><o:p></o:p></span></span></p>
			</td>
			<td width="65%"
			...
			<p class=MsoNormal
				...
				lang=EN-US><span style='mso-spacerun: yes'><label name='最近一次换届大会时间' field="electionMeetingTime" style="width: 80"></label>）<span lang=EN-US><o:p></o:p></span></span></p>
			</td>
		</tr>
		<tr style='height: 23.25pt'>
			<td width="34%" colspan=2
			...
			</span></span><label name='章程规定理事会年数' field="orderCouncilYears" style="width: 30" maxlength="10"></label>）年（<span lang=EN-US><span style='mso-spacerun: yes'>
			</span></span><label type="text" name='章程规定理事会次数' field="orderCouncilTimes" style="width: 30" maxlength="10"></label>）次<span lang=EN-US><o:p></o:p></span></span></p>
			</td>
			<td width="65%"
				style='width: 65.94%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.5pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext 1.5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 23.25pt'>
			<p class=MsoNormal
				...
				lang=EN-US><span style='mso-spacerun: yes'></span></span><label name='开理事会次数' field="councilTimes" style="width: 30" maxlength="10"></label>）次<span
				lang=EN-US><o:p></o:p></span></span></p>
			</td>
		</tr>
		<tr style='height: 23.25pt'>
			...
			<p class=MsoNormal
				...
				lang=EN-US><span style='mso-spacerun: yes'>
			</span></span><label name='章程规定常务理事会年数' field="orderGeneralcouncilYears" style="width: 30" maxlength="10" ></label>）年（<span lang=EN-US><span style='mso-spacerun: yes'>
			</span></span><label name='章程规定常务理事会次数' field="orderGeneralcouncilTimes" style="width: 30" maxlength="10" ></label>）次<span lang=EN-US><o:p></o:p></span></span></p>
			</td>
			<td width="65%"
				style='width: 65.94%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.5pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext 1.5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 23.25pt'>
			<p class=MsoNormal
				...
				lang=EN-US><span style='mso-spacerun: yes'></span></span><label name='召开常务理事会次数' field="generalcouncilTimes" style="width: 30" maxlength="10" ></label>）次<span
				lang=EN-US><o:p></o:p></span></span></p>
			</td>
		</tr>
		<tr style='mso-yfti-lastrow: yes; height: 126.5pt'>
			...
			<p class=MsoNormal
				...
				<textarea name='未召开原因' field="reason" style="width: 98%" rows="10" readonly="readonly"></textarea></span></p>
			</td>
		</tr>
