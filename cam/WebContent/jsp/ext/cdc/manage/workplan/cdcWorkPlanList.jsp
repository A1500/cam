...
<title>工作计划</title>
<next:ScriptManager/>
<script type="text/javascript" src="cdcWorkPlanList.js"></script>
	...
	<legend class="GroupBoxTitle">查询条件</legend>
		<form class="L5form">
			<table border="1" width="100%">
				<tr>
					<td class="FieldLabel" style="width:10%">名称：</td>
					...
					<td class="FieldInput" colspan="4"><button onclick="query()">查询</button>&nbsp;&nbsp;&nbsp;&nbsp;<button type="reset">重置</button>&nbsp;&nbsp;&nbsp;&nbsp;<button onclick="selfQuery()" id ="Queryself">本单位查询</button></td>
				</tr>
			</table>
		</form>
	</fieldset>
...
<next:EditGridPanel id="grid" dataset="cdcWorkInfoDataSet" width="100%" stripeRows="true" height="99.9%">
	...
	<next:Columns>
		...
		<next:RadioBoxColumn/>
		<next:Column field="NAME" header="名称" width="30%" sortable="false"/>
		<next:Column field="KIND" header="文档分类" width="15%" editable="false" sortable="false" align="center"><next:ComboBox dataset="workPlanDataSet"/></next:Column>
		<next:Column field="REPORTPEOPLE" header="上报人" width="10%" sortable="false" align="center"/>
