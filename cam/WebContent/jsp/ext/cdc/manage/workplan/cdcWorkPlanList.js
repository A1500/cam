...
function init(){
	if(organLevel=='SQ'){
		...
		document.getElementById("Queryself").style.display = "none";
	...
	cdcWorkInfoDataSet.setParameter("type","2");
...
function insert(){
	...
	var url="jsp/ext/cdc/manage/workplan/cdcWorkPlanEdit.jsp";
	L5.forward(url,'',data);
}
function update(){
...
function detail(){
	...
	var url="jsp/ext/cdc/manage/workplan/cdcWorkPlanDetail.jsp";
	L5.forward(url,'',data);
}
