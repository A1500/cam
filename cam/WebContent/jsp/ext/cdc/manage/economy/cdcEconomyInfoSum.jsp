...
<html>
<head>
<title>城市资产状况汇总</title>
<next:ScriptManager/>
<script type="text/javascript" src="cdcEconomyInfoSum.js"></script>
...
<next:EditGridPanel id="grid" dataset="detailDataSet" width="100%" stripeRows="true" height="99.9%" hasSum="true">
	...
	<next:Columns>
		...
		<next:Column field="incomeMon" header="收入总额<br>（万元）" width="10%" sortable="false" align="right" summaryType="sum"/>
		<next:Column field="incomeMon" header="平均收入总额<br>（万元）" width="10%" sortable="false" align="right" renderer="avgRender"/>
