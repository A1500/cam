...
<html>
<head>
<title>城市资产状况列表</title>
<next:ScriptManager/>
<script type="text/javascript" src="cdcEconomyInfoList.js"></script>
...
<model:datasets>
	...
	<model:dataset id="queryDs" cmd="com.inspur.cams.cdc.base.cmd.CdcEconomyInfoQueryCmd" pageSize="20">
		<model:record fromBean="com.inspur.cams.cdc.base.data.CdcEconomyInfo"/>
	</model:dataset>
...
<next:EditGridPanel id="grid" dataset="economyDataSet" width="100%" stripeRows="true" height="99.9%">
	...
	<next:Columns>
		...
		<next:Column field="incomeMon" header="收入总额（万元）" width="10%" sortable="false" align="right"/>
