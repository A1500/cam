...
function init(){
	...
	economyDataSet.setParameter("REPORT_TYPE@=","C");
	economyDataSet.load();
...
function insert(){
	...
	if(ifInsert){
		...
		var url="jsp/ext/cdc/manage/economy/cdcEconomyInfoEdit.jsp";
		L5.forward(url,'',data);
	}else{
		var data=new L5.Map();
		data.put("method","insert");
...
function detail(){
	...
	var data=new L5.Map();
	data.put("recordId",records[0].get("recordId"));
	var url="jsp/ext/cdc/manage/economy/cdcEconomyInfoDetail.jsp";
	L5.forward(url,'',data);
}
function report(){
	var grid=L5.getCmp("grid");
...
function sumInsert(){
	var data=new L5.Map();
	data.put("method","insert");
	var url="jsp/ext/cdc/manage/economy/cdcEconomyInfoSum.jsp";
	L5.forward(url,'',data);
}
function sumRedo(){
	var grid=L5.getCmp("grid");
...
//    dataset.setParameter("dir","desc");
    dataset.load(true);
	L5.dataset2excel(dataset,"/jsp/ext/cdc/manage/economy/cdcEconomyInfoExcel.jsp?organName="+organName);
}
