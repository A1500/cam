...
function init(){
	...
	fundDataSet.setParameter("REPORT_TYPE@=","N");
	fundDataSet.load();
...
function insert(){
	...
	if(ifInsert){
		...
		var url="jsp/ext/cdc/manage/fund/vcdcFundInfoEdit.jsp";
		L5.forward(url,'',data);
	}else{
...
function detail(){
	...
	var data=new L5.Map();
	data.put("fundId",records[0].get("fundId"));
	var url="jsp/ext/cdc/manage/fund/vcdcFundInfoDetail.jsp";
	L5.forward(url,'',data);
}
function report(){
	var grid=L5.getCmp("grid");
...
function sumInsert(){
	var data=new L5.Map();
	data.put("method","insert");
	var url="jsp/ext/cdc/manage/fund/vcdcFundInfoSum.jsp";
	L5.forward(url,'',data);
}
function sumRedo(){
	var grid=L5.getCmp("grid");
