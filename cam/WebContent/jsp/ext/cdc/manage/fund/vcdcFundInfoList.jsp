...
<html>
<head>
<title>农村社区经费列表</title>
<next:ScriptManager/>
<script type="text/javascript" src="vcdcFundInfoList.js"></script>
...
<next:EditGridPanel id="grid" dataset="fundDataSet" width="100%" stripeRows="true" height="99.9%">
	...
	<next:Columns>
		...
		<next:Column id="useBuildMon" header="基础设施建设金额(万元)" field="useBuildMon" width="135" />
