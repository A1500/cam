...
<legend>社区经费情况</legend>
	<table border="1"  width="100%" >
	   		...
	   		<tr>
				...
				<td class="FieldInput"><label id="feeAlongMon" field="feeAlongMon"  renderer="reRender"/> </td>
			</tr>
				<td  class="FieldLabel" >其他</td>
				<td class="FieldInput" colspan="3"><label id="offOtherMon" field="offOtherMon"  renderer="reRender"/> </td>
