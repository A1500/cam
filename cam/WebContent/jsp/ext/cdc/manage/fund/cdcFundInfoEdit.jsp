...
<html>
<head>
<title>城市社区经费情况填报</title>
<next:ScriptManager/>
<script type="text/javascript" src="cdcFundInfoEdit.js"></script>
...
<legend>社区经费情况</legend>
		<table border="1"  width="100%" >
	   		<tr>
				...
				<td class="FieldInput"  colspan="4"><label  name ="办公经费总额" field="offMon" renderer="reRender"/> </td>
			</tr>
	   		<tr>
	   		...
	   		<tr>
				...
				<td class="FieldInput" colspan="3"><input type="text" name = "办公经费来源其他"  id="offOtherMon" field="offOtherMon" onchange="forcheck(this)"/>&nbsp;万元<font color="red">*</font> </td>
			</tr>
	   		<tr>
