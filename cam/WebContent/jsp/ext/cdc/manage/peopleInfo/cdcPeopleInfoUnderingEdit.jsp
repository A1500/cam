...
<html>
<head>
<title>社区下属委员会成员信息编辑</title>
<jsp:include page="../util/cdcOrgan.jsp" flush="true"/>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript" src="cdcPeopleInfoUnderingEdit.js"></script>
...
<fieldset >
	...
	<table width="99%">
		<tr>
			...
			<td class="FieldInput" style="width:36%"><input type="text" name="身份证件号码" id="idCard" field="idCard" maxlength="50" style="width:80%"/></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="FieldInput" style="width:36%"><select name="分管工作" id="jobType" field="jobType" style="width:80%"> <option dataset ="jobDataSet" ></option> </select> </td>
		...
		<tr>
			...
			<td class="FieldInput" style="width:36%" colspan="3"><input type="text" name="家庭住址" id="address" field="address" maxlength="50" style="width:93%"/></td>
		</tr>
		<tr>
			...
			<td class="FieldInput" style="width:36%"><input type="text" name="邮政编码" id="postCode" field="postCode" maxlength="50" style="width:80%"/></td>
		</tr>
		<tr>
