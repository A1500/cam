...
<html>
<head>
<title>社工组织成员信息编辑</title>
<jsp:include page="../util/cdcOrgan.jsp" flush="true"/>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript" src="cdcPeopleInfoWorkerEdit.js"></script>
...
<fieldset >
	...
	<table width="99%">
		...
		<tr>
			...
			<td class="FieldInput" style="width:36%"><select  name="身份" id=identity field="identity" style="width:80%"><option dataset = "identityDataSet"> </option> </select></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="FieldInput" style="width:36%"><input type="text" name="联系电话" id="tel" field="tel" maxlength="12" style="width:80%"/></td>
		...
		<tr>
			...
			<td class="FieldInput" style="width:36%"><select name="是否具备社会工作职业资格" id="ifWorker" field="ifWorker" style="width:80%"><option dataset ="YorN"></option> </select></td>
			<td class="FieldLabel" style="width:18%">职业资格等级：</td>
			<td class="FieldInput" style="width:36%"><select type="text" name="职业资格等级" style="width:80%" id="careerLevel" field="careerLevel" maxlength="5" style="width:34%">
				<option dataset="career_level"></option>
			</select></td>
		</tr>
		<tr>
			<td class="FieldLabel" style="width:18%">月报酬：</td>
			<td class="FieldInput" style="width:36%" colspan="3"><input type="text" name="月报酬" id="subsidyMon" field="subsidyMon" maxlength="5" style="width:34%"/>&nbsp;元</td>
		</tr>
		<tr>
