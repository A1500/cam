...
<html>
<head>
<title>下属委员会成员信息列表</title>
<next:ScriptManager></next:ScriptManager>
<jsp:include page="../util/cdcOrgan.jsp" flush="true"/>
<script type="text/javascript" src="cdcPeopleInfoUnderingList.js"></script>
		...
		<form class="L5form">
			<table border="1" width="100%">
				<tr>
					...
					<td class="FieldLabel" style="width:10%">分管工作：</td>
					<td class="FieldInput" style="width:12%"><select id = "query_job" ><option dataset = "jobDataSet"></option> </select> </td>
...
<next:EditGridPanel id="grid" dataset="cdcPeopleInfoDataSet" width="100%" stripeRows="true" height="99.9%" autoExpandColumn="postCode">
	...
	<next:Columns>
		...
		<next:Column field="jobType" header="分管工作" dataset ="jobDataSet" width="90" sortable="false"/>
