...
<html>
<head>
<title>居委会成员信息列表</title>
<next:ScriptManager></next:ScriptManager>
<jsp:include page="../util/cdcOrgan.jsp" flush="true"/>
<script type="text/javascript" src="cdcPeopleInfoCommitteeList.js"></script>
		...
		<form class="L5form">
			<table border="1" width="100%">
				<tr>
					...
					<td class="FieldLabel" style="width:10%">职务：</td>
					<td class="FieldInput" style="width:12%"><select id = "query_duty" ><option dataset = "dutyTypeDataSet"></option> </select> </td>
...
<next:EditGridPanel id="grid" dataset="cdcPeopleInfoDataSet" width="100%" stripeRows="true" height="99.9%">
	<next:TopBar>
	...
	<next:Columns>
		...
		<next:Column field="duty" header="职务" dataset ="dutyTypeDataSet" width="90" sortable="false"/>
		<next:Column field="ifCross" header="是否交叉任职" dataset ="YorN" width="90" sortable="false"/>
		...
		<next:Column field="postCode" header="邮政编码" width="90" sortable="false"/>
	</next:Columns>
	<next:BottomBar>
