...
<html>
<head>
<title>社区居委会成员信息编辑</title>
<jsp:include page="../util/cdcOrgan.jsp" flush="true"/>
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript" src="cdcPeopleInfoCommitteeEdit.js"></script>
...
<fieldset >
	...
	<table width="100%">
		<tr>
			...
			<td class="FieldInput" style="width:36%"><input type="text" name="姓名" id="name" field="name" maxlength="50" style="width:80%"/><font color="red">*</font></td>
			<td class="FieldLabel" style="width:18%">身份证件号码：</td>
			<td class="FieldInput" style="width:36%"><input type="text" name="身份证件号码" id="idCard" field="idCard" maxlength="18" style="width:80%" onblur="backBirthDay(this.value)"  /><font color="red">*</font></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="FieldInput" style="width:36%"><select  name="民族" id="nation" field="nation" style="width:80%"><option dataset = "NationDataset"> </option> </select><font color="red">*</font></td>
			<td class="FieldLabel" style="width:18%">任职届次：</td>
			<td class="FieldInput" style="width:36%"><input type="text" name="届次" id="season" field="season" maxlength="50" style="width:80%"/></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="FieldInput" style="width:36%"><select name="职务" id="duty" field="duty" style="width:80%"> <option dataset = "dutyTypeDataSet"></option> </select></td>
			<td class="FieldLabel" style="width:18%">是否交叉任职：</td>
			<td class="FieldInput" style="width:36%"><select name="是否交叉任职" id="ifCross" field="ifCross" style="width:80%"><option dataset ="YorN"></option> </select>  </td>
		</tr>
		<tr>
		...
		<% if(villageFlag) { %>
			...
			<td class="FieldInput" style="width:36%"><select name="是否是大学生村官" id="ifOfficial" field="ifOfficial" style="width:80%"><option dataset ="YorN"></option> </select></td>
