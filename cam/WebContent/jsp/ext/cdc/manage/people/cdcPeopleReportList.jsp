...
<title>城市人员信息</title>
<next:ScriptManager/>
<script type="text/javascript" src="cdcPeopleReportList.js"></script>
...
<model:datasets>
	...
	<model:dataset id="queryDs2" cmd="com.inspur.cams.cdc.base.cmd.CdcPeopleReportQueryCmd" pageSize="-1">
		<model:record fromBean="com.inspur.cams.cdc.base.data.CdcPeopleReport"/>
	</model:dataset>
...
<next:EditGridPanel id="grid" dataset="peopleReportDataSet" width="100%" stripeRows="true" height="99.9%">
	...
	<next:Columns>
		...
		<next:Column id="submitDate" header="上报日期" field="submitDate" sortable="true" width="100" align="center" />
	</next:Columns>
	<next:BottomBar>
	...
	<next:ExtendConfig>
	   		plugins:new L5.ux.grid.ColumnHeaderGroup({
        		rows: [
        			  [{header:'',start:0,colspan:3},{header:'经选举产生的社区村民委员会成员',start:3,colspan:23},{header:'其他社区工作者情况',start:24,colspan:29},{header:'',start:52,colspan:3}]
    		]})
	</next:ExtendConfig>
</next:EditGridPanel>
</body>
