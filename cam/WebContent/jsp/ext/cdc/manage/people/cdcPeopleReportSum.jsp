...
<html>
<head>
<title>城市人员信息汇总</title>
<next:ScriptManager/>
<script type="text/javascript" src="cdcPeopleReportSum.js"></script>
...
<next:EditGridPanel id="grid" dataset="detailDataSet" width="100%" stripeRows="true" height="99.9%" hasSum="true">
	...
	<next:ExtendConfig>
	   		plugins:new L5.ux.grid.ColumnHeaderGroup({
        		rows: [
        			  [{header:'',start:0,colspan:3},{header:'经选举产生的社区居民委员会成员',start:3,colspan:24},{header:'其他社区工作者情况',start:25,colspan:29},{header:'',start:52,colspan:3}]
    		]})
	</next:ExtendConfig>
</next:EditGridPanel>
		   ...
		   <tr>
			...
			<tr>
		   	...
		   	<tr>
				...
				<td class="FieldInput" colspan="5"><label name="mbSubsidyAvgMon" field="mbSubsidyAvgMon" renderer="mRender" /></td>
			</tr>
		   </table>
	   </fieldset>
	   <fieldset id="cdcFieldset">
