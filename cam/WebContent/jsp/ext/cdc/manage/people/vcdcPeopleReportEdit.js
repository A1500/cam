function init(){
	...
	if(method=="insert"){
		...
		peopleReportDataSet.newRecord({"organCode":organCode,"organName":organName,"parentCode":parentCode,"communityNum":"1","reportType":"N","organType":"1"});
...
function returnBack(){
	...
	*/
	var url="jsp/ext/cdc/manage/people/vcdcPeopleReportList.jsp";
	L5.forward(url,'',null);
}
...
function confirm(){
 ...
 function getCommitteeNum(){
	...
	peopleReportRecord.set("mbOfficalNum",mbOfficalNum);
