...
<next:ScriptManager/>
<script type="text/javascript" src="vcdcPeopleReportEdit.js"></script>
...
<model:datasets>
	...
	<model:dataset id="seasonDataSet" cmd="com.inspur.cams.cdc.base.cmd.CdcPeopleInfoQueryCmd" method="getSeasons" autoLoad="true" pageSize="20">
		<model:record>
		   ...
		   <tr>
			...
			<% } %>
		   	<tr>
				...
				<td class="FieldInput"><label name="mbOfficalNum" field="mbOfficalNum"/></td>
				<td class="FieldLabel">人均月报酬:</td>
				<td class="FieldInput" colspan="3"><label name="mbSubsidyAvgMon" field="mbSubsidyAvgMon"  />&nbsp;元</td>
			</tr>
	 </table>
	   </fieldset>
	   <fieldset id="cdcFieldset">
