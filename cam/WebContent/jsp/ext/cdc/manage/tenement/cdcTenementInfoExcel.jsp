...
<Excel:tablelist filename="城市物业情况">
	<Excel:table sheetname="城市物业情况">
	<Excel:tr>
			<Excel:td colspan="6" align="center" width = "100" ><Excel:font size="15"  bold="true"><%=organName+"城市物业情况"%></Excel:font></Excel:td>
		</Excel:tr>
		<Excel:tr>
			<Excel:td colspan="3" align="left">统计单位：<%= organName%></Excel:td>
			<Excel:td colspan="3" align="right">统计时间：<%=date2%></Excel:td>
		</Excel:tr>
		<Excel:tr bgcolor="grey">
			<Excel:td  align="center"  width = "100" >单位名称</Excel:td>
			<Excel:td  align="center"  width = "100" >物业服务企业个数</Excel:td>
			<Excel:td  align="center"  width = "100" >业主委员会个数</Excel:td>
		...
		<Excel:td><%=record.get("tenementNum")%></Excel:td>
		<Excel:td><%=record.get("proprietorCommitteeNum")%></Excel:td>
