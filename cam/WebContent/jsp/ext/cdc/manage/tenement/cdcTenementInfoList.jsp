...
<html>
<head>
<title>城市社区物业情况</title>
<next:ScriptManager/>
<script type="text/javascript" src="cdcTenementInfoList.js"></script>
...
<model:datasets>
	...
	<model:dataset id="queryDs" cmd="com.inspur.cams.cdc.base.cmd.CdcTenementInfoQueryCmd" method="query" pageSize="-1">
		<model:record fromBean="com.inspur.cams.cdc.base.data.CdcTenementInfo"/>
	</model:dataset>
		...
		<form class="L5form">
			<table border="1" width="100%">
				<tr>
					...
					<td class="FieldInput" style="width:12%"><select id="status" ><option dataset="statusDataSet"/></select></td>
...
<next:EditGridPanel id="grid" dataset="tenementInfoDataSet" width="99%" stripeRows="true" height="99.9%">
	<next:TopBar>
	...
	<next:BottomBar>
		<next:PagingToolBar dataset="tenementInfoDataSet"/>
	</next:BottomBar>
</next:EditGridPanel>
</body>
</html>