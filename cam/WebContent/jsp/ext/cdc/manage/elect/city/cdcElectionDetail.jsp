		...
		<next:Html>
			...
			<TR ><TD width="758">
		      <table border=0 cellspacing=0 cellpadding=0 width="160">
		        ...
		        <tr id=Item0> 
		          <td colspan=3 width="150"> <IMG align=absMiddle border=0 src="../images/gzai.jpg" width="16" height="16"title="返回主页面">
			  ...
			  <tr id=Item5 > 
		          ...
		          <td width="120"><A href="#" onclick="selectedNode('4')" ><font id="node4" color="#000000">选举投票方式信息</font></A></td>
		        </tr>
