...
<legend>选民登记信息</legend>
	<table width="100%">
		<tr>
			...
			<td class="FieldInput"  style="width:14%"><input type="text" name = "选民总数" onchange="forcheck(this)" id="villagerNum" field="villagerNum" maxlength="30" /></td>
			<td class="FieldLabel"  style="width:18%">本届登记选民总数：</td>
			<td class="FieldInput" 	style="width:14%"><input type="text" name = "本届登记选民总数"onchange="forcheck(this)"  id="joinVillagerNum" field="joinVillagerNum" maxlength="30" /></td>
		</tr>
		<tr>
			<td class="FieldLabel"  style="width:18%">女性人数：</td>
			<td class="FieldInput"  style="width:14%"><input type="text" name = "女性人数" onchange="forcheck(this)" id="eleFemaleNum" field="eleFemaleNum" maxlength="30" /></td>
			<td class="FieldLabel"  style="width:18%">少数民族人数：</td>
			<td class="FieldInput" 	style="width:14%"><input type="text" name = "少数民族人数" onchange="forcheck(this)" id="eleFolkNum" field="eleFolkNum" maxlength="30" /></td>
		</tr>
	</table>
</fieldset>
<fieldset id="cdcFieldset">
<legend>居民选举委员会信息</legend>
	<table width="100%">
		...
		<tr>
			...
			<td class="FieldInput" style="width:14%"><input type="text" name = "总人数" onchange="forcheck(this)" id="eleComNum" field="eleComNum" maxlength="30" /></td>
			<td class="FieldLabel" style="width:18%">党员人数：</td>
			<td class="FieldInput" style="width:14%" ><input type="text" name = "党员人数" onchange="forcheck(this)" id="eleComPartyNum" field="eleComPartyNum" maxlength="30" /></td>
		</tr>
	</table>
</fieldset>
</form>
