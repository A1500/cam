...
<next:EditGridPanel id="grid" dataset="electionInfoDataSet" width="100%" stripeRows="true" height="99.9%">
	<next:TopBar>
		<next:ToolBarItem symbol="->"/>
		<next:ToolBarItem id="sum" iconCls="add" text="汇总本级数据" handler="sum" />
		<next:ToolBarItem id="detail1" iconCls="add" text="填报" handler="insert"/>
		<next:ToolBarItem id="detail2" iconCls="edit" text="修改选举内容" handler="updateInfo"/>
		<next:ToolBarItem id="detail3" iconCls="view" text="填写选举详细信息" handler="update"/>
	...
	<next:Columns>
		...
		<next:Column field="reportDate" header="填报日期" width="15%" editable="false" sortable="true" align="center"dataset="reportWorkDataSet"/>
	</next:Columns>
	<next:BottomBar>
