...
function init(){
	...
	electionInfoDataSet.setParameter("organCode",organC);
...
var insertDataSet = L5.DatasetMgr.lookup("insertDataSet");
	...
	if(ifInsert){
		...
		var url="jsp/ext/cdc/manage/elect/country/cdcElectionInfoEdit.jsp";
		L5.forward(url,'',data);
	}else{
...
function update(){
	...
	data.put("organ_Code",records[0].get("organCode"));
	var url="jsp/ext/cdc/manage/elect/country/cdcElectionEdit.jsp";
	L5.forward(url,'',data);
}
function detail(){
	var grid=L5.getCmp("grid");
	...
	data.put("recordId",records[0].get("recordId"));
	data.put("organ_Code",records[0].get("organCode"));
	var url="jsp/ext/cdc/manage/elect/country/cdcElectionDetail.jsp";
	L5.forward(url,'',data);
}
...
function sum(){
	var data=new L5.Map();
	var url = "jsp/ext/cdc/manage/elect/detail/vcdcElectionEdit.jsp";
	L5.forward(url,'',data);
}
