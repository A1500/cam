...
<next:Panel  id="leftPanel" collapsible="true"  title='选举情况填报'  autoScroll="true" width="20%" border="false">
		...
		<TR><TD width="758">
			<table border=0 cellspacing=0 cellpadding=0 width="160">
		        ...
		        <tr id=Item2>
			  	...
			  	<tr id=Item7>
		          <td width="40"><IMG border=0 height=22 src="../images/lastnodeline.jpg" width=16><IMG  border=0 id=Pic7 src="../images/clsfld.jpg" width="16" height="16"></td>
	...
	<next:Panel id="center" width="100%" height="100%">
		<next:Panel id="detail" hidden="ture" width="100%" height="100%" >
			<next:Html>
				<iframe id="nodeFrame" name="nodeFrame" height="100%" width="100%" src="cdcElectionPrepareEdit.jsp?recordId=<%=request.getParameter("recordId")%>"></iframe>
			</next:Html>
		</next:Panel>
	</next:Panel>	
</next:Center>
