...
<model:datasets>
	...
	<model:dataset id="xiaXiaCun" cmd="com.inspur.cams.comm.extuser.cmd.ComExtUserQueryCmd" method = "getXiaXiaCun" pageSize="20">
		<model:record fromBean="com.inspur.cams.comm.extuser.data.ComExtUser"/>
	</model:dataset>
	<model:dataset id="reportDataSet" cmd="com.inspur.cams.cdc.base.cmd.CdcReportWorkQueryCmd" global="true" autoLoad="false">
...
<legend>填报情况</legend>
	<table width="100%">
		<tr>
			...
			<td class="FieldInput" style="width:27%"><select id="reportOrgan" field="organCode" onchange="reportOrganChanges()"></select><font color="red">*</font></td>
			<td class="FieldLabel" style="width:13%">填报日期：</td>
			<td class="FieldInput" style="width:42%"><select id="reportDate" field="reportDate" onchange="setSeason()"><option dataset="reportWorkDataSet"/></select><font color="red">*</font></td>
		</tr>
	</table>
</fieldset>
<fieldset id="cdcFieldset">
<legend>选举情况</legend>
	<table width="100%">
		...
		<tr>
			...
			<td class="FieldInput" style="width:15%"><label id="season" field="season" maxlength="30"  /></td>
			</tr>
		<tr>
