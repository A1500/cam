...
<body>
<model:datasets>
	<model:dataset id="electionMemberDataSet" cmd="com.inspur.cams.cdc.base.cmd.CdcElectionCityMemberQueryCommand" method="querySum" pageSize="20">
...
function init(){
	...
	electionMemberDataSet.setParameter("REPORT_TYPE","C");
