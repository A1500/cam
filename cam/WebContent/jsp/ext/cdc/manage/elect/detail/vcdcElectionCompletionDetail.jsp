...
<legend>选举完成情况</legend>
	<table width="100%">
		<tr>
			<td class="FieldLabel" style="width:13%" colspan="2">换届选举村数：</td>
			<td class="FieldInput" style="width:14%"><label field ="IFELECTION" /></td>
		</tr>
		<tr>
			<td class="FieldLabel" style="width:13%" rowspan="3">已完成选举村情况：</td>
			<td class="FieldLabel" style="width:13%">另行选举村数：</td>
			<td class="FieldInput" style="width:14%"><label field="ANOTHER"  /></td>
		</tr>
		<tr>
			<td class="FieldLabel" style="width:13%">重新选举村数：</td>
			<td class="FieldInput" style="width:15%"><label field="AFRESH"  /></td>
		</tr>
		<tr>
			<td class="FieldLabel" style="width:13%">一次性选举村数：</td>
			<td class="FieldInput" style="width:15%"><label field="ONCE"  /></td>
		</tr>
		<tr>
			<td class="FieldLabel" style="width:13%" rowspan="2">选举整体情况：</td>
			<td class="FieldLabel" style="width:13%">已完成选举村数：</td>
