...
<legend>当选两委成员</legend>
	<table width="100%">
		<tr>
			<td class="FieldLabel" style="width:13%" rowspan="2">已当选村干部人数：</td>
...
<legend>两委成员情况</legend>
	<table width="100%">
		...
		<tr>
			...
			<tr>
			<td class="FieldLabel" style="width:19.5%">两委大学生村官人数：</td>
...
function init(){
	...
	electionCommitteeDataSet.setParameter("REPORT_TYPE","N");
