...
<legend>完成选举情况</legend>
	<table width="100%">
		<tr>
			<td class="FieldLabel" style="width:13%" >居委会总数：</td>
			<td class="FieldInput" style="width:14%"><label field ="TOTALNUM" /></td>
			<td class="FieldLabel" style="width:13%">参加换届选举居数总数：</td>
			<td class="FieldInput" style="width:14%"><label field="ELECTION"  /></td>
		</tr>
		<tr>
			<td class="FieldLabel" style="width:13%">完成选举居总数：</td>
		...
		<tr>
			<td class="FieldLabel" style="width:13%">未进行选举居数：</td>
