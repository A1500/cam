...
<script type="text/javascript">
	...
	function init(){
		...
		familyMemberDataSet.setParameter("FAMILY_ID@=",peopleId);
...
<fieldset>
	...
	<table width="100%">
		<tr>
			...
			<td class="FieldInput" style="width:20%"><label name="性别" id="sex" field="sex" option dataset="sexDataSet" /></td>
