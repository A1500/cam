...
function init(){
	...
	serviceReportDataSet.setParameter("REPORT_TYPE@=","N");
...
function insert(){
	...
	var url="jsp/ext/cdc/manage/service/vcdcServiceInfoEdit.jsp";
	L5.forward(url,'',data);
}
function update(){
...
function detail(){
	...
	var data=new L5.Map();
	data.put("recordId",records[0].get("recordId"));
	var url="jsp/ext/cdc/manage/service/vcdcServiceInfoDetail.jsp";
	L5.forward(url,'',data);
}
function report(){
	var grid=L5.getCmp("grid");
...
function sumInsert(){
	var data=new L5.Map();
	data.put("method","insert");
	var url="jsp/ext/cdc/manage/service/vcdcServiceInfoSum.jsp";
	L5.forward(url,'',data);
}
function sumRedo(){
	var grid=L5.getCmp("grid");
