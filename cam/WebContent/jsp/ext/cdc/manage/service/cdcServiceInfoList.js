...
function init(){
	...
	serviceReportDataSet.setParameter("REPORT_TYPE@=","C");
...
function query(){
	var serviceReportDataSet = L5.DatasetMgr.lookup("serviceReportDataSet");
	serviceReportDataSet.setParameter("STATUS@=",_$("status"));
	serviceReportDataSet.setParameter("REPORT_TYPE@=","C");
	serviceReportDataSet.setParameter("REPORT_DATE@=",_$("reportDate"));
	serviceReportDataSet.setParameter("ORGAN_CODE@=",organCode);
	serviceReportDataSet.load();	
}
function insert(){
	...
	var url="jsp/ext/cdc/manage/service/cdcServiceInfoEdit.jsp";
	L5.forward(url,'',data);
}
function update(){
...
function detail(){
	...
	var data=new L5.Map();
	data.put("recordId",records[0].get("recordId"));
	var url="jsp/ext/cdc/manage/service/cdcServiceInfoDetail.jsp";
	L5.forward(url,'',data);
}
function report(){
	var grid=L5.getCmp("grid");
...
function sumInsert(){
	var data=new L5.Map();
	data.put("method","insert");
	var url="jsp/ext/cdc/manage/service/cdcServiceInfoSum.jsp";
	L5.forward(url,'',data);
}
function sumRedo(){
	var grid=L5.getCmp("grid");
...
//    dataset.setParameter("dir","desc");
    dataset.load(true);
	L5.dataset2excel(dataset,"/jsp/ext/cdc/manage/service/cdcServiceInfoExcel.jsp?organName="+organName);
}