...
<next:EditGridPanel id="grid" dataset="serviceInfoDataSet" width="99%" stripeRows="true" height="250" hasSum="true">
	<next:TopBar>
		<next:ToolBarItem symbol="->"/>
...
<next:Window id="detailWin" title="社区服务" resizable="false" width="800" height="300" modal="true" closable="true"  closeAction="hide" autoScroll="true">
<next:Panel>
<next:TopBar>
	<next:ToolBarItem symbol="->"/>
		...
		<td colspan="2">
			<table width="100%">
				<tr  >
					...
					<td class="FieldInput"><select name = "服务内容"  field="contents"><option dataset ="serviceContentDataSet"></option> </select> <font color="red">*</font> </td>
				</tr>
				<tr >
					<td class="FieldLabel">服务性质：</td>
