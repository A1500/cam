...
function insert(){
	...
	if(ifInsert){
		...
		var url="jsp/ext/cdc/manage/finance/vcdcFinanceInfoEdit.jsp";
		L5.forward(url,'',data);
	}else{
...
function update(){
	...
	data.put("recordId",records[0].get("FINANCEID"));
	var url="jsp/ext/cdc/manage/finance/vcdcFinanceInfoEdit.jsp";
	L5.forward(url,'',data);
}
function detail(){
	...
	var data=new L5.Map();
	data.put("recordId",records[0].get("FINANCEID"));
	var url="jsp/ext/cdc/manage/finance/vcdcFinanceInfoDetail.jsp";
	L5.forward(url,'',data);
}
function report(){
	var grid=L5.getCmp("grid");
...
function sumInsert(){
	var data=new L5.Map();
	data.put("method","insert");
	var url="jsp/ext/cdc/manage/finance/vcdcFinanceInfoSum.jsp";
	L5.forward(url,'',data);
}
function sumRedo(){
	var grid=L5.getCmp("grid");
