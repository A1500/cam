...
<html>
<head>
<title>农村经济基本情况列表</title>
<next:ScriptManager/>
<script type="text/javascript" src="vcdcFinanceInfoList.js"></script>
...
<body>
<model:datasets>
	<model:dataset id="infoDataSet" cmd="com.inspur.cams.cdc.base.cmd.CdcFinanceInfoQueryCmd"  method="queryList" pageSize="20" >
	</model:dataset>
...
<next:EditGridPanel id="grid" dataset="infoDataSet" width="100%" stripeRows="true" height="99.9%">
	...
	<next:Columns>
		...
		<next:Column field="FINANCEMON" header="财政收入(万元)" width="10%" sortable="false" align="right"/>
