...
<html>
<head>
<title>农村社区服务列表</title>
<next:ScriptManager/>
<script type="text/javascript" src="vcdcServiceInfoList.js"></script>
...
<body>
<model:datasets>
	<model:dataset id="infoDataSet" cmd="com.inspur.cams.cdc.base.cmd.CdcServiceModeQueryCmd" method="queryList" pageSize="20" >
	</model:dataset>
...
<next:EditGridPanel id="grid" dataset="infoDataSet" width="100%" stripeRows="true" height="99.9%">
	<next:TopBar>
	...
	<next:Columns>
		...
		<next:Column field="IFSERCICE" header="否提供全程代办代理服务" width="10%" sortable="false" align="right" dataset ="YorN"/>
		<next:Column field="SERVICEPHONE" header="服务热线" width="10%" sortable="false" align="right"/>
		<next:Column field="SERVICEWEB" header="网络服务平台" width="10%" sortable="false" align="right"/>
