...
<html>
	<head>
		<title>申报</title>
		<next:ScriptManager/>
		<script type="text/javascript" src="cdcReportNList.js"></script>
...
<model:datasets>
	...
	<model:dataset id="cdcNoticeDataset" cmd="com.inspur.cams.cdc.base.cmd.CdcNoticeInfoQueryCmd" method="queryMyReport"  pageSize="20">
					...
					<form style="width: 98%; height: 100%;" class="L5form">
						<table  border="1" width="100%" >
							<tr >
								...
								<td class="FieldLabel" nowrap="nowrap">是否上报：</td>
								<td class="FieldInput">
...
<next:GridPanel id="editGridPanel" name="baseinfopeopleGrid" width="100%" stripeRows="true" height="98%" autoScroll="true"  dataset="cdcNoticeDataset" title="申报材料信息" notSelectFirstRow="true">
				<next:TopBar>
					...
					<next:ToolBarItem text="上报材料" iconCls="upload" handler="report" />
					<next:ToolBarItem text="增加申报" iconCls="add" handler="insertReport" />
				...
				<next:Columns>
					...
					<next:Column id="flag" header="是否上报" field="FLAG" dataset="reportFlag" width="100">
						<next:TextField allowBlank="false" />
					</next:Column>
