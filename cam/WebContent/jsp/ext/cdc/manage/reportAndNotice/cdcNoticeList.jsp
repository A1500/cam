...
<html>
	<head>
		<title>通知</title>
		<next:ScriptManager/>
		<script type="text/javascript" src="cdcNoticeList.js"></script>
...
<body>
<model:datasets>
	<model:dataset id="cdcNoticeDataset" cmd="com.inspur.cams.cdc.base.cmd.CdcNoticeInfoQueryCmd" method="queryNotice"  pageSize="20">
					...
					<form style="width: 98%; height: 100%;" class="L5form">
						<table  border="1" width="100%" >
							<tr >
								...
								<td class="FieldInput">
									<input type="text"  id="organName" class="TextEditor" title="发布单位"  />
								</td>
							</tr>
							<tr>	
								...
								<td class="FieldInput" style="text-align: center;" colspan="2">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<next:GridPanel id="editGridPanel" name="baseinfopeopleGrid" width="100%" stripeRows="true" height="98%" autoScroll="true"  dataset="cdcNoticeDataset" title="通知通告信息" notSelectFirstRow="true">
				...
				<next:Columns>
					...
					<next:Column id="noticeType" header="通知通告类型" field="NOTICE_TYPE" dataset="noticeType" hidden="true" width="100" >
