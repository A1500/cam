...
<model:datasets>
	...
	<model:dataset id="targetToDataSet" enumName="CDC.NOTICE.TAREGARTTO" autoLoad="true" global="true"/>
</model:datasets>
...
<legend>填报内容</legend>
	<table width="100%">
		<tr>
			...
			<td class="FieldInput" style="width: 30%"><label id="name" field="name" style="width:200"/></td>
			<td class="FieldLabel" style="width: 10%">下发至:</td>
			<td class="FieldInput" style="width: 30%"> <label id = "targetTo" field="targetTo" dataset = "targetToDataSet" />
			</td>
		</tr>
		<tr>
			<td class="FieldLabel">内容:</td>
			<td class="FieldInput" colspan="3"><label id="content" field="content"  ></label></td>
		</tr>
		<tr>
