...
<html>
<head>
<title>农村民主管理列表</title>
<next:ScriptManager/>
<script type="text/javascript" src="vcdcManageInfoList.js"></script>
...
<next:EditGridPanel id="grid" dataset="manageReportDataSet" width="100%" stripeRows="true" height="99.9%">
	<next:TopBar>
	...
	<next:Columns>
		...
		<next:Column field="ruleNum" header="建立村民自治章程村数" width="12%" sortable="false" align="right"/>
		<next:Column field="notRuleNum" header="未建立村民自治章程村数" width="12%" sortable="false" align="right"/>
		<next:Column field="pactNum" header="建立村规民约社区数" width="10%" sortable="false" align="right"/>
		<next:Column field="notPactNum" header="未建立村规民约社区数" width="12%" sortable="false" align="right"/>
		<next:Column field="archiveNum" header="建立村务档案村居数" width="12%" sortable="false" align="right"/>
		<next:Column field="notArchiveNum" header="未建立村务档案村居数" width="13%" sortable="false" align="right"/>
	...
	<next:BottomBar>
		<next:PagingToolBar dataset="manageReportDataSet"/>
	</next:BottomBar>
</next:EditGridPanel>
</body>
</html>