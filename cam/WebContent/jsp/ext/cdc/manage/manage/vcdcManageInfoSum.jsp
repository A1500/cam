...
<html>
<head>
<title>农村民主管理汇总</title>
<next:ScriptManager/>
<script type="text/javascript" src="vcdcManageInfoSum.js"></script>
...
<next:EditGridPanel id="grid" dataset="detailDataSet" width="100%" stripeRows="true" height="99.9%" hasSum="true">
	...
	<next:Columns>
		...
		<next:Column field="ruleNum" header="建立村民自治章程村数" width="12%" sortable="false" align="right" summaryType="sum"/>
		<next:Column field="notRuleNum" header="未建立村民自治章程村数" width="12%" sortable="false" align="right" summaryType="sum"/>
		<next:Column field="pactNum" header="建立村规民约社区数" width="10%" sortable="false" align="right" summaryType="sum"/>
		<next:Column field="notPactNum" header="未建立村规民约社区数" width="12%" sortable="false" align="right" summaryType="sum"/>
		<next:Column field="archiveNum" header="建立村务档案村居数" width="12%" sortable="false" align="right" summaryType="sum"/>
		<next:Column field="notArchiveNum" header="未建立村务档案村居数" width="13%" sortable="false" align="right" summaryType="sum"/>
		<next:Column field="reportDate" header="填报日期" width="10%" editable="false" sortable="true" align="center" dataset="reportWorkDataSet"/>
		<next:Column field="status" header="填报状态" width="10%" editable="false" sortable="false" align="center" dataset="statusDataSet"/>
...
<next:Window id="detailWin" title="明细" resizable="false" width="800" height="320" modal="true" closeAction="hide" autoScroll="true">
	<next:Panel height="300">
		<next:Html>
			...
			<table width="100%">
				<tr>
					<td class="FieldLabel" style="width:18%">建立村居民自治章程村居数：</td>
					<td class="FieldInput" style="width:18%"><label field ="ruleNum" renderer="gRender"/> </td>
					<td class="FieldLabel" style="width:16%">建立村居公约村居数：</td>
					<td class="FieldInput" style="width:16%"><label field ="pactNum" renderer="gRender"/> </td>
					<td class="FieldLabel" style="width:16%">建立村务档案村居数：</td>
					<td class="FieldInput" style="width:16%"><label field ="archiveNum" renderer="gRender"/> </td>
				</tr>
				<tr>
					<td class="FieldLabel" style="width:18%">未建立村居民自治章程村居数：</td>
					<td class="FieldInput" style="width:18%"><label field ="notRuleNum" renderer="gRender"/> </td>
					<td class="FieldLabel" style="width:16%">未建立村居公约村居数：</td>
					<td class="FieldInput" style="width:16%"><label field ="notPactNum" renderer="gRender"/> </td>
					<td class="FieldLabel" style="width:16%">未建立村务档案村居数：</td>
					<td class="FieldInput" style="width:16%"><label field ="notArchiveNum" renderer="gRender"/> </td>
				</tr>
			</table>
			</fieldset>
			</form>
