...
<html>
<head>
<title>农村民主管理情况填报</title>
<next:ScriptManager/>
<script type="text/javascript" src="vcdcManageInfoEdit.js"></script>
...
<legend>民主管理情况</legend>
	<table width="100%">
		<tr>
			<td class="FieldLabel" style="width:18%">是否建立村民自治章程：</td>
			...
			<td class="FieldLabel" style="width:16%">是否建立村规民约：</td>
			<td class="FieldInput" style="width:16%"><select id ="ifPact" field ="ifPact"><option dataset = "YorN"></option> </select><font color="red">*</font> </td>
			<td class="FieldLabel" style="width:16%">是否建立村务档案：</td>
			<td class="FieldInput" style="width:16%"><select id ="ifArchive" field ="ifArchive"><option dataset = "YorN"></option> </select><font color="red">*</font></td>
		</tr>
	</table>
</fieldset>
</form>
