...
<next:EditGridPanel id="grid" dataset="detailDataSet" width="100%" stripeRows="true" height="99.9%" hasSum="true">
	...
	<next:Columns>
		...
		<next:Column field="meetingShouldNum" header="居民会议次数" width="10%" sortable="false" align="right" summaryType="sum"/>
		<next:Column field="meetingRealNum" header="居民会议参加人数" width="15%" sortable="false" align="right" summaryType="sum"/>
		<next:Column field="meetingAgreeNum" header="居民代表会议次数" width="15%" sortable="false" align="right" summaryType="sum"/>
		<next:Column field="meetingUnagreeNum" header="居民代表会议参加人数" width="15%" editable="false" sortable="false" align="right" summaryType="sum"/>
			...
			<legend>民主决策情况</legend>
				<table width="100%">
					<tr>
						...
						<td class="FieldInput" style="width:35%"><label field="meetingShouldNum" renderer="cRender"/></td>
						<td class="FieldLabel" style="width:15%">居民会议参加人数：</td>
						<td class="FieldInput" style="width:30%"><label field="meetingRealNum" renderer="pRender"/></td>
					</tr>
					<tr>
						...
						<td class="FieldInput"><label field="meetingUnagreeNum" renderer="pRender"/></td>
					</tr>
				</table>
			</fieldset>
			</form>
