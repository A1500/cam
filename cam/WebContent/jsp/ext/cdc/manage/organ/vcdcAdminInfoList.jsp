...
<html>
<head>
<title>农村社区管理与共建列表</title>
<next:ScriptManager/>
<script type="text/javascript" src="vcdcAdminInfoList.js"></script>
...
<model:datasets>
	...
	<model:dataset id="queryDs" cmd="com.inspur.cams.cdc.base.cmd.CdcOrganReportQueryCmd" pageSize="20">
		<model:record fromBean="com.inspur.cams.cdc.base.data.CdcOrganReport"/>
		<model:params>
			<model:param name="ORGAN_TYPE" value='2'/>
		</model:params>
...
<next:EditGridPanel id="grid" dataset="adminReportDataSet" width="100%" stripeRows="true" height="99.9%">
	...
	<next:Columns>
		...
		<next:Column field="status" header="填报状态" width="10%" editable="true" sortable="false" align="center"><next:ComboBox dataset="statusDataSet"/></next:Column>
