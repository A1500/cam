...
function init(){
	...
	if(method=="insert"){
		if(organLevel=='SQ'){
			organReportDataSet.newRecord({"organCode":organCode,"organName":organName,"parentCode":parentCode,"communityNum":"1","reportType":"N","organType":"1"});
			...
			OrgCodeDataset.on("load",function() {
				...
				organReportDataSet.newRecord({"organCode":orgCode,"organName":organName,"parentCode":organCode,"communityNum":"1","reportType":"N","organType":"1"});
...
function save(){
	...
	if (!command.error){
		L5.Msg.alert("提示","保存成功！",function(){
			var url="jsp/ext/cdc/manage/organ/vcdcOrganInfoList.jsp";
			L5.forward(url,'',null);
		});
	}else{
