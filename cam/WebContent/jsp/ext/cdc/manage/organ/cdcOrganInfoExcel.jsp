...
<Excel:tablelist filename="社区社会组织">
	<Excel:table sheetname="社区社会组织">
	<Excel:tr>
			<Excel:td colspan="13" align="center" width = "100" ><Excel:font size="15"  bold="true"><%=organName+"社区社会组织"%></Excel:font></Excel:td>
		</Excel:tr>
		<Excel:tr>
		...
		<Excel:tr bgcolor="grey">
			...
			<Excel:td  align="center"  width = "100" >社会组织总数</Excel:td>
			<Excel:td  align="center"  width = "100" >主管单位总数</Excel:td>
			<Excel:td  align="center"  width = "100" >行业协会类个数</Excel:td>
			<Excel:td  align="center"  width = "100" >社会服务类个数</Excel:td>
			<Excel:td  align="center"  width = "100" >公益慈善类个数</Excel:td>
			<Excel:td  align="center"  width = "100" >其他类个数</Excel:td>
			<Excel:td  align="center"  width = "100" >成员总数</Excel:td>
			<Excel:td  align="center"  width = "100" >办公场所数量(个)</Excel:td>
			<Excel:td  align="center"  width = "100" >办公场所总面积(㎡)</Excel:td>
		...
		<Excel:td><%=record.get("officialNum")%></Excel:td>
