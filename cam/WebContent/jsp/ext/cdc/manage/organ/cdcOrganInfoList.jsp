...
<html>
<head>
<title>社区社会组织列表</title>
<next:ScriptManager/>
<script type="text/javascript" src='<%=SkinUtils.getJS(request,"cams.js")%>'></script>
<script type="text/javascript" src='<%=SkinUtils.getJS(request,"camsCheck.js")%>'></script>
<script type="text/javascript" >
	var userStatus = "cdcOrganInfoList.jsp";
</script>
...
<body>
<model:datasets>
	<model:dataset id="organReportDataSet" cmd="com.inspur.cams.cdc.base.cmd.CdcOrganReportQueryCmd" method="queryList"  pageSize="20">
	</model:dataset>
...
<next:EditGridPanel id="grid" dataset="organReportDataSet" width="100%" stripeRows="true" height="99.9%">
	<next:TopBar>
		...
		<next:ToolBarItem id="detail1" iconCls="add" text="本级填报" handler="insert"/>
	...
	<next:Columns>
		...
		<next:Column field="ORGANNUM" header="社会组织总数" width="10%" sortable="false" align="right"/>
		<next:Column field="MORGNUM" header="主管单位总数" width="10%" sortable="false" align="right"/>
		<next:Column field="KINDONENUM" header="行业协会类个数" width="10%" sortable="false" align="right"/>
		<next:Column field="KINDTWONUM" header="社会服务类个数" width="10%" sortable="false" align="right"/>
		<next:Column field="KINDTHREENUM" header="公益慈善类个数" width="10%" sortable="false" align="right"/>
		<next:Column field="KINDFOURNUM" header="其他类个数" width="10%" sortable="false" align="right"/>
		<next:Column field="MEMBERNUM" header="成员总数" width="10%" sortable="false" align="right"/>
		<next:Column field="OFFICIALNUM" header="办公场所数量(个)" width="10%" sortable="false" align="right"/>
		<next:Column field="OFFICIALAREA" header="办公场所总面积(㎡)" width="10%" sortable="false" align="right"/>
	...
	<next:BottomBar>
		<next:PagingToolBar dataset="organReportDataSet"/>
	</next:BottomBar>
</next:EditGridPanel>
</body>
</html>