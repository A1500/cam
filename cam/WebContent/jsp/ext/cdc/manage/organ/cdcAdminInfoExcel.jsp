...
<Excel:tablelist filename="社区管理与共建">
	<Excel:table sheetname="社区管理与共建">
	<Excel:tr>
			<Excel:td colspan="14" align="center" width = "100" ><Excel:font size="15"  bold="true"><%=organName+"社区管理与共建"%></Excel:font></Excel:td>
		</Excel:tr>
		<Excel:tr>
		...
		<Excel:tr bgcolor="grey">
			...
			<Excel:td  align="center"  width = "100" >驻区单位总数</Excel:td>
			<Excel:td  align="center"  width = "100" >当年进驻单位数</Excel:td>
			<Excel:td  align="center"  width = "100" >政府机关类个数</Excel:td>
			<Excel:td  align="center"  width = "100" >事业单位类个数</Excel:td>
			<Excel:td  align="center"  width = "100" >企业单位类个数</Excel:td>
			<Excel:td  align="center"  width = "100" >其他单位类个数</Excel:td>
			<Excel:td  align="center"  width = "100" >主管部门数量</Excel:td>
			<Excel:td  align="center"  width = "100" >职工总人数</Excel:td>
			<Excel:td  align="center"  width = "100" >占地面积(㎡)</Excel:td>
		...
		<Excel:td><%=record.get("organNum")%></Excel:td>
		<Excel:td><%=record.get("organYearNum")%></Excel:td>
		<Excel:td><%=record.get("kindOneNum")%></Excel:td>
		<Excel:td><%=record.get("kindTwoNum")%></Excel:td>
		<Excel:td><%=record.get("kindThreeNum")%></Excel:td>
		<Excel:td><%=record.get("kindFourNum")%></Excel:td>
		<Excel:td><%=record.get("morgNum")%></Excel:td>
		<Excel:td><%=record.get("memberNum")%></Excel:td>
		<Excel:td><%=record.get("officialArea")%></Excel:td>
