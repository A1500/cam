...
<fieldset id="cdcFieldset">
<legend>民间组织状况</legend>
	<table width="100%">
		<tr>
			<td class="FieldLabel" style="text-align:center;width:18%" rowspan="4">民间组织状况</td>
			<td class="FieldLabel" style="width:13%">民间组织总数：</td>
			...
			<td class="FieldLabel" style="width:13%">工商经济类个数：</td>
