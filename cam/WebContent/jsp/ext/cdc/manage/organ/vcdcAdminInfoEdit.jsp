...
<html>
<head>
<title>农村社区管理与共建填报</title>
<next:ScriptManager/>
<script type="text/javascript" src="vcdcAdminInfoEdit.js"></script>
...
<body>
<model:datasets>
	<model:dataset id="adminReportDataSet" cmd="com.inspur.cams.cdc.base.cmd.CdcOrganReportQueryCmd" >
