function init(){
	...
	if(method=="insert"){
		adminReportDataSet.newRecord({"organCode":organCode,"organName":organName,"parentCode":parentCode,"communityNum":"1","reportType":"C","organType":"2"});
...
function save(){
	...
	if (!command.error){
		L5.Msg.alert("提示","保存成功！",function(){
			var url="jsp/ext/cdc/manage/organ/cdcAdminInfoList.jsp";
			L5.forward(url,'',null);
		});
	}else{
