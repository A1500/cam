...
<Excel:tablelist filename="社区资产状况">
	<Excel:table sheetname="社区资产状况">
		<Excel:tr>
			<Excel:td colspan="8" align="center" width = "100" ><Excel:font size="15"  bold="true"><%=organName+"社区资产状况"%></Excel:font></Excel:td>
		</Excel:tr>
		<Excel:tr>
			<Excel:td colspan="4" align="left">统计单位：<%= organName%></Excel:td>
			<Excel:td colspan="4" align="right">统计时间：<%=date2%></Excel:td>
		</Excel:tr>
		<Excel:tr bgcolor="grey">
			<Excel:td  align="center"  width = "100" >单位名称</Excel:td>
			<Excel:td  align="center"  width = "100" >社区数(个)</Excel:td>
			<Excel:td  align="center"  width = "100" >规划集中居住面积(㎡)</Excel:td>
			<Excel:td  align="center"  width = "100" >已建成集中居住区面积(㎡)</Excel:td>
			<Excel:td  align="center"  width = "100" >规划入住户数(户)</Excel:td>
		...
		<Excel:td><%=record.get("planArea")%></Excel:td>
		<Excel:td><%=record.get("alreadyArea")%></Excel:td>
