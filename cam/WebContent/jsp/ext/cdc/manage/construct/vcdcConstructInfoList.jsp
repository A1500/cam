...
<body>
<model:datasets>
	<model:dataset id="constructDataSet" cmd="com.inspur.cams.cdc.base.cmd.CdcConstructReportQueryCmd" pageSize="20">
		<model:record fromBean="com.inspur.cams.cdc.base.data.CdcConstructReport"/>
	</model:dataset>
	
	<model:dataset id="queryDs" cmd="com.inspur.cams.cdc.base.cmd.CdcConstructReportQueryCmd" pageSize="-1">
		<model:record fromBean="com.inspur.cams.cdc.base.data.CdcConstructReport"/>
	</model:dataset>
...
<next:EditGridPanel id="grid" dataset="constructDataSet" width="100%" stripeRows="true" height="99.9%">
	<next:TopBar>
	...
	<next:Columns>
		...
		<next:Column field="communityNum" header="社区数(个)" width="10%" sortable="false" align="right"/>
		<next:Column field="planArea" header="规划集中居住面积(㎡)" width="13%" sortable="false" align="right"/>
		<next:Column field="alreadyArea" header="已建成集中居住区面积(㎡)" width="15%" sortable="false" align="right"/>
		<next:Column field="populateNum" header="规划入住户数(户)" width="15%" sortable="false" align="right"/>
		<next:Column field="reportDate" header="填报日期" width="10%" editable="false" sortable="true" dataset="reportWorkDataSet" align="center" />
	...
	<next:BottomBar>
		<next:PagingToolBar dataset="constructDataSet"/>
	</next:BottomBar>
</next:EditGridPanel>
</body>
</html>