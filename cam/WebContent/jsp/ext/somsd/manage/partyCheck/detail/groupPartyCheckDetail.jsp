...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 align=left dataset="partyCheckDataSet"
 ...
 <tr style='height:30.85pt'>
  ...
  <label type="text" name='填表单位' field="morgName" style="width:25%" maxlength="100"></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  填表人：<label type="text" name='填表人' field="linkMan" style="width:15%" maxlength="72"></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  联系电话:<label type="text" name='联系电话' field="linkPhone" style="width:15%" maxlength="30"></label></span></span></p>
  </td>
 </tr>
