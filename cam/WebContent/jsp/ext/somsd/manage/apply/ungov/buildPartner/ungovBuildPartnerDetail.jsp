...
<script type="text/javascript" src="ungovBuildPartnerDetail.js"></script>
						...
						<fieldset>
							...
							<table width="100%">
								...
								<tr>
									...
									<td class="FieldInput" style="width:17%"><label field="resideSource" onchange="changeResideSource();" id="resideSource" dataset="resideSourceSelect" name='住所来源' style="width:90%""></label></td>
								...
								<tr>
									...
									<td class="FieldInput"><label field="busScope" name='所属行（事）业' dataset="busScopeSelect" style="width:90%"></option></label></td>
