...
function insert(){
	...
	url="jsp/ext/somsd/manage/apply/ungov/buildIndividual/ungovBuildIndividualEdit.jsp";
	L5.forward(url,'',data);	
}
function update(){
...
function detail(){
	...
	data.put("taskCode",records[0].get('taskCode'));
	var url='';
	url="jsp/ext/somsd/manage/apply/ungov/buildIndividual/ungovBuildIndividualDetail.jsp";
	L5.forward(url,'',data);	
}
...
function enter(){
	var url='jsp/ext/somsd/manage/apply/ungov/buildIndividual/ungovBuildIndividualEdit.jsp?method=INSERT';
	L5.forward(url);
}
...
function printSelect(){
	...
	var FZRDJ = document.getElementById("FZRDJ").checked;
	if(DJSQ==true){
		var url=L5.webPath+"/jsp/ext/somsd/manage/printWord/ungov/jsp/buildIndividual/ungovBuildIndividualWord.jsp?taskCode="+taskCode+"&sorgId="+sorgId;
		window.open(url);
	}else if(FZRDJ==true){
		var url=L5.webPath+"/jsp/ext/somsd/manage/printWord/ungov/jsp/buildIndividual/ungovIndividualWord.jsp?taskCode="+taskCode+"&sorgId="+sorgId;
		window.open(url);
	}else if(NSJG==true){
