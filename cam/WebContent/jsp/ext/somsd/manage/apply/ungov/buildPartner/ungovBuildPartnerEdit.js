...
function init(){
	...
	if(method == "INSERT"){
		somOrganDataSet.newRecord({"cnName":userId,"sorgId":sorgId,"sorgKind":"2","sorgType":"M","ifBranch":'0',"morgName":userId,"morgArea":morgArea});
...
/*
	...
	*/
	...
	somApplyRecord.set("sorgName",_$("cnName"));
