...
<html>
<head>
<title>民办非企业单位（合伙）成立登记网上申请</title>
...
<script type="text/javascript" src="ungovBuildPartnerEdit.js"></script>
...
<next:Panel width="100%" height="100%">
	<next:TopBar>
		<next:ToolBarItem symbol="民办非企业单位（合伙）成立登记"></next:ToolBarItem>
