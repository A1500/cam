function init(){
	if(method=="INSERT"){
		...
		somApplyDataSet.newRecord({"sorgName":userId,"taskCode":taskCode,"sorgId":sorgId,"applyType":applyType,"dataSource":"ONLINE","sorgType":"M","acceptArea":morgArea,"createOrgan":morgArea,"createPerson":userId});
		somOrganDataSet.newRecord({"cnName":userId,"sorgCode":sorgCode,"sorgStatus":"00","sorgId":sorgId,"sorgType":"M","ifBranch":"0","morgName":userId,"morgArea":morgArea});
	}else{
		var somRuleDataSet=L5.DatasetMgr.lookup("somRuleDataSet");
...
function save(){
	...
	if(somApplyRecord.get("borgName")==""){
