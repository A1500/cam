...
function insert(){
	...
	url="jsp/ext/somsd/manage/apply/ungov/nameApproval/ungovNameApprovalEdit.jsp";
	L5.forward(url,'',data);
}
function update(){
...
function detail(){
	...
	data.put("taskCode",records[0].get('taskCode'));
	var url='';
	url="jsp/ext/somsd/manage/apply/ungov/nameApproval/ungovNameApprovalDetail.jsp";
	L5.forward(url,'',data);
}
...
function enter(){
	...
	var url='jsp/ext/somsd/manage/apply/ungov/nameApproval/ungovNameApprovalEdit.jsp?method=INSERT';
	L5.forward(url);
}
...
function printWord(){
	...
	var sorgId = records[0].get('sorgId');
 	var url=L5.webPath+"/jsp/ext/somsd/manage/printWord/ungov/jsp/nameApproval/ungovNameApprovalWord.jsp?taskCode="+taskCode+"&sorgId="+sorgId;
	window.open(url);
}
