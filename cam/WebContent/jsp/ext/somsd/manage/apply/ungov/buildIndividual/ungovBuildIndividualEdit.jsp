...
<script type="text/javascript" src="ungovBuildIndividualEdit.js"></script>
						...
						<fieldset>
							...
							<table width="100%">
								<tr>
									...
									<td class="FieldInput" style="width:51%"colspan="3">
									<label type="text" id="cnName" name='民办非企业中文名称' field="cnName" style="width:55%"/>
									</td>
