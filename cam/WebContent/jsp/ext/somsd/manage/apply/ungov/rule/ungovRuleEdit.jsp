...
<script type="text/javascript" src="ungovRuleEdit.js"></script>
					...
					<form id="ruleForm" method="post" dataset="somRuleDataSet" onsubmit="return false" class="L5form">
						...
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput" colspan="3"><input type="text" id="meetingName" field="meetingName" maxlength="100" style="width:96%" name="会议名称"></td>
								<td class="FieldLabel">会议形式：</td>
								<td class="FieldInput"><input type="text" id="meetingFormat" field="meetingFormat" maxlength="30" style="width:85%" name="会议形式"></td>
							</tr>
							<tr>
								<td class="FieldLabel" style="width:17%">时间：</td>
								<td class="FieldInput" style="width:17%"><input type="text" id="meetingDate" field="meetingDate" readonly="readonly" onclick="WdatePicker()" style="width:85%" name="时间"></td>
					...
					<form id="form2" method="post" dataset="somApplyDataSet" onsubmit="return false" class="L5form">
						...
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput" style="width:17%"><input type="text" field="borgCheckDate" readonly="readonly" onclick="WdatePicker()" style="width:85%" name="业务主管单位审查日期"></td>
							</tr>
						</table>
						</fieldset>
					</form>
