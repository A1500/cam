...
<script type="text/javascript" src="ungovNameApprovalDetail.js"></script>
				...
				<next:Html>
					...
					<table width="100%">
						<tr>
							...
							<label type="text" id="cnName" name='申请设立民办非企业单位名称' field="cnName" style="width:98%" /><span style="color:red">*</span>
							</td>
						</tr>
						<tr>
							<td class="FieldLabel">单位宗旨：</td>
							<td class="FieldInput" colspan="5"><textarea disabled="disabled" rows="5" name='"单位宗旨"' field="purpose" style="width:98%"></textarea><span style="color:red">*</span></td>
						</tr>
						<tr>
							<td class="FieldLabel">业务范围：</td>
							<td class="FieldInput" colspan="5"><textarea disabled="disabled" rows="5" name='"业务范围"' field="business" style="width:98%"></textarea><span style="color:red">*</span></td>
						</tr>
						<tr>
							<td class="FieldLabel">拟定业务主管单位：</td>
							<td class="FieldInput">
							<label type="text" id="borgNameDispaly" name="borgNameDispaly"  title="拟定业务主管单位" />
						...
						<tr>
							...
							<td class="FieldInput" colspan="5"><label type="text" field="currency" name='"拟定开办资金币种"' readonly/></td>		
						</tr>
						<tr>				
							<td class="FieldLabel">拟定开办资金数额（万元）：</td>
							<td class="FieldInput" colspan="5"><textarea rows="3" disabled="disabled" field="regMon" name='"拟定开办资金数额（万元）"' style="width:98%"></textarea></td>
						</tr>
						<tr>
							<td class="FieldLabel">出资人：</td>
							<td class="FieldInput" colspan="5"><textarea name='出资人' disabled="disabled" field="fundingPeople" style="width:98%" ></textarea></td>
						</tr>						
						<tr>
							<td class="FieldLabel">资金来源：</td>
							<td class="FieldInput" colspan="5"><textarea rows="3" disabled="disabled" field="moneySource" name='"资金来源"' style="width:98%"></textarea></td>
						</tr>
						<tr>
							<td class="FieldLabel">办公地点：</td>
							<td class="FieldInput" colspan="5"><label type="text" name='办公地点' field="residence" style="width:98%"/><span style="color:red">*</span></td>
						</tr>
					</table>
					</form>
					</fieldset>
					...
					<table width="100%">
						<tr>
							...
							<td class="FieldInput" style="width:17%"><label type="text" name='"身份证号"' field="idCard" style="width:90%"/></td>
						...
						<tr>
							...
							<td class="FieldInput" colspan="3"><label  name='"户口所在地"' id='populace' field="populace" style="width:90%"/></td>
							<td class="FieldLabel" >联系电话：</td>
							<td class="FieldInput"><label name='"联系电话"'id='phone' field="phone" style="width:90%"/></td>
					...
					<table width="100%">
						<tr>
							...
							<td class="FieldInput" style="width:17%"><label type="text" name='"申请人电话"'id='appPhone' field="appPhone" style="width:90%"/></td>
