...
%>	
<script type="text/javascript" src="ungovBuildIndividualList.js"></script>
...
<!-- 打印列表window -->
<next:Window id="printListWin" closeAction="hide" title="民办非企业单位成立登记（个体）打印列表" width="350" height="200"  modal="true">
	<next:TopBar>
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
		...
		<next:Html>
			...
			<tr>
				...
				<input type="radio"name="Word" 
					id="DJSQ" label="民办非企业单位（个体）登记申请表" /><a href=# onclick="javascript:document.getElementById('DJSQ').checked=true;">民办非企业单位（个体）登记申请表</a><br/>
				<input type="radio" name="Word" 
					id="FZRDJ" label="民办非企业单位（个体）负责人登记表" /><a href=# onclick="javascript:document.getElementById('FZRDJ').checked=true;">民办非企业单位（个体）负责人登记表</a> <br/>
				<input type="radio" name="Word" 
