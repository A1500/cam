...
<html>
<head>
<title>民办非企业单位（个体）成立登记网上申请</title>
...
<script type="text/javascript">
	...
	%>
	var applyType='<%=ApplyType.SOM_UNGOV_BUILD_INDIVIDUAL%>';//业务类型
...
<script type="text/javascript" src="ungovBuildIndividualDetail.js"></script>
...
<next:Panel width="100%" height="100%">
	<next:TopBar>
		<next:ToolBarItem symbol="民办非企业单位（个体）成立登记"></next:ToolBarItem>
						...
						<fieldset>
							...
							<table width="100%">
								...
								<tr>
									...
									<td class="FieldInput" style="width:17%"><label field="resideSource" onchange="changeResideSource();" id="resideSource" name='住所来源' dataset="resideSourceSelect" style="width:90%"></label></td>
					...
					<fieldset>
						...
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput" style="width:17%"><label type="text" id="meetingDate" field="meetingDate" onClick="WdatePicker()" style="width:90%"></td>
