...
<script type="text/javascript" src="groupFeeExt.js"></script>
			...
			<table width="100%">
				<tr>
					<td class="FieldLabel">社团名称：</td>
						...
						<td class="FieldInput">
						<label type="text" id="sorgCode" name='登记证号' field="sorgCode" style="width:55%"/></td>
				</tr>
				<tr>
					...
					<td class="FieldInput" style="width:15%"><input type="text" name="linkPhone" id="linkPhone" field="linkPhone" maxlength="30"style="width:90%"/></td>
					<td class="FieldLabel" style="width:17%"></td>
					<td class="FieldInput" style="width:17%"></td>
				</tr>
				<tr>
					<td class="FieldLabel">会议名称：</td>
					<td class="FieldInput"><input type="text" name="meetingName" id="meetingName" maxlength="50" field="meetingName" maxlength="100" style="width:90%"/></td>
					<td class="FieldLabel">召开日期：</td>
					<td class="FieldInput"><input type="text" name="meetingDate" id="meetingDate"maxlength="10" field="meetingDate" style="width:90%"  readonly="readonly" onclick="WdatePicker()"  /></td>
					<td class="FieldLabel">召开地点：</td>
					<td class="FieldInput"><input type="text" name="meetingPlace" id="meetingPlace"maxlength="50" field="meetingPlace" maxlength="100" style="width:90%"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="FieldInput"><input type="text" name="备案日期" id="regDate" field="regDate" readonly="readonly" onclick="WdatePicker()" style="width:100%"/></td>
