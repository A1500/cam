...
<script type="text/javascript" src="groupRuleDetail.js"></script>
					...
					<form id="ruleForm" method="post" dataset="somRuleDataSet" onsubmit="return false" class="L5form">
						...
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput" colspan="3"><label type="text" id="meetingName" field="meetingName" maxlength="100" style="width:96%" name="会议名称"><span style="color:red">*</span></td>
								<td class="FieldLabel">会议形式：</td>
								<td class="FieldInput"><label type="text" id="meetingFormat" field="meetingFormat" maxlength="30" style="width:85%" name="会议形式"><span style="color:red">*</span></td>
							</tr>
							<tr>
								<td class="FieldLabel" style="width:17%">时间：</td>
								<td class="FieldInput" style="width:17%"><label type="text" id="meetingDate" field="meetingDate" readonly="readonly" style="width:85%" name="时间"><span style="color:red">*</span></td>
								<td class="FieldLabel" style="width:17%">应到人数：</td>
								<td class="FieldInput" style="width:15%"><label type="text" name="应到人数" id="shouldNum" field="shouldNum" maxlength="6" style="width:85%"><span style="color:red">*</span></td>
								<td class="FieldLabel" style="width:17%">实到人数：</td>
								<td class="FieldInput" style="width:17%"><label type="text" name="实到人数" id="realNum" field="realNum" maxlength="6" style="width:85%"><span style="color:red">*</span></td>
							</tr>
							<tr>
								<td class="FieldLabel">同意人数：</td>
								<td class="FieldInput"><label type="text" name="同意人数" id="passNum" field="passNum" maxlength="6" style="width:85%"><span style="color:red">*</span></td>
								<td class="FieldLabel">反对人数：</td>
								<td class="FieldInput"><label type="text" name="反对人数" id="nopassNum" field="nopassNum" maxlength="6" style="width:85%"><span style="color:red">*</span></td>
								<td class="FieldLabel">弃权人数：</td>
								<td class="FieldInput"><label type="text" name="弃权人数" id="giveupNum" field="giveupNum" maxlength="6" style="width:85%"><span style="color:red">*</span></td>
							</tr>
							<tr>
								<td class="FieldLabel">需说明的主要问题：</td>
								<td class="FieldInput" colspan="5"><textarea disabled name="需说明的主要问题" id=mainQuestion field="mainQuestion" cols="65" rows="4" style="width:97%"></textarea><span style="color:red">*</span></td>
							</tr>
						</table>
						</fieldset>
					</form>
						...
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput" style="width:49%">
									<label name="业务主管单位" field="borgName" dataset="businessOrganSelect" style="width:96%" name="业务主管单位">
									</label><span style="color:red">*</span>
								</td>
								<td class="FieldLabel" style="width:17%">业务主管单位审查日期：</td>
								<td class="FieldInput" style="width:17%"><label type="text" field="borgCheckDate" readonly="readonly" style="width:85%" name="业务主管单位审查日期"><span style="color:red">*</span></td>
							</tr>
						</table>
						</fieldset>
					</form>
