...
%>	
<script type="text/javascript" src="groupFeeExtList.js"></script>
...
<script type="text/javascript">
	...
	var userId='<%=userId%>';
	var applyType='<%=ApplyType.SOM_GROUP_FEE%>';
</script>
</head>
<body>
...
<next:EditGridPanel id="grid" dataset="somApplyDataSet" width="100%" stripeRows="true" height="99.9%">
	...
	<next:Columns>
		...
		<next:Column field="sorgName" header="社会团体名称" width="30%" sortable="false"></next:Column>
		<next:Column field="onlineStatus" header="提交状态" width="30%" sortable="false"  dataset="onlineStatusDataSet"></next:Column>
		<next:Column field="createPerson" header="创建人" width="30%" sortable="false"></next:Column>
		<next:Column field="createTime" header="创建时间" width="20%" sortable="false"></next:Column>
	</next:Columns>
	<next:BottomBar>
