...
<script type="text/javascript" src="groupBranchBuildEdit.js"></script>
					...
					<form method="post" dataset="somOrganDataSet" onsubmit="return false"class="L5form">
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput" colspan="5"><input type="text" id="cnName" name='"分支/代表机构名称"'maxlength="100" field="cnName" style="width:98%"/><label style="color:red">*</label></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<input type="text" id="borgNameDispaly" style="width:50%" name="borgNameDispaly"  title="业务主管单位"  onkeyup="findDiv(this,'borgName','popup','','businessOrganAuto','BORG_NAME@like','borgCode','borgName','35')" onblur="clearDiv()" onchange="clearBorg(this)"/><img src="<%=SkinUtils.getImage(request,"l5/help.gif")%>" style="cursor:hand" onclick="showBorgWin()"/>
						...
						<form onsubmit="return false" dataset="somSessionDataSet" class="L5form">
							<table width="100%">
								<tr>
									...
									<td class="FieldInput" style="width:17%"><input type="text" id="tenure" onkeyup="value=value.replace(/[^\\w\.\/]/ig,'').toUpperCase()" field="tenure" style="width:90%"/></td>
								</tr>
								<tr>
