...
function insert(){
	...
	url="jsp/ext/somsd/manage/apply/group/branchChange/groupBranchChangeEdit.jsp";
	L5.forward(url,'',data);	
}
function update(){
...
function detail(){
	...
	data.put("taskCode",records[0].get('taskCode'));
	var url='';
	url="jsp/ext/somsd/manage/apply/group/branchChange/groupBranchChangeDetail.jsp";
	L5.forward(url,'',data);	
}
...
function enter(){
	var url='jsp/ext/somsd/manage/apply/group/branchChange/groupBranchChangeEdit.jsp?method=INSERT';
	L5.forward(url);
}
...
function printItem(){
	...
	var id=records[0].get('id');
		var url=L5.webPath+"/jsp/ext/somsd/manage/printWord/group/jsp/branch/branchChange.jsp?id="+id+"&sorgId="+sorgId+"&taskCode="+taskCode;
		window.open(url);
}