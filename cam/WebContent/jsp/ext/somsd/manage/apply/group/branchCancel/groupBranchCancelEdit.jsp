...
<script type="text/javascript" src="groupBranchCancelEdit.js"></script>
					...
					<next:Html>
						...
						<table width="100%">
							...
							<tr>
								...
								<input id="cnName" field="cnName" name='"分支（代表）机构名称"' style="width:81%" maxlength="50"/>
								</td>
								<td class="FieldLabel" width="20%"><label>分支（代表）机构登记证号：</label></td>
								<td class="FieldInput" width="30%"><input id="sorgCode" field="sorgCode" name='"分支（代表）机构登记证号"' onkeyup="value=value.replace(/[^\-\\w\.\/]/ig,'').toUpperCase()" style="width:81%" maxlength="20"/></td>
							</tr>
							<tr>
								<td class="FieldLabel"><label>注销理由：</label></td>
								<td class="FieldInput" colspan="3"><textarea rows="3" id="cancelReasonDesc" field="cancelReasonDesc" name='"注销理由"' style="width:93%"></textarea></td>
							</tr>
						</table>
						</form>
						</fieldset>
