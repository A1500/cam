...
function insert(){
	...
	url="jsp/ext/somsd/manage/apply/group/rule/groupRuleEdit.jsp";
	L5.forward(url,'',data);	
}
function update(){
...
function detail(){
	...
	data.put("taskCode",records[0].get('taskCode'));
	var url='';
	url="jsp/ext/somsd/manage/apply/group/rule/groupRuleDetail.jsp";
	L5.forward(url,'',data);	
}
...
function enter(){
	var url='jsp/ext/somsd/manage/apply/group/rule/groupRuleEdit.jsp?method=INSERT';
	L5.forward(url);
}
