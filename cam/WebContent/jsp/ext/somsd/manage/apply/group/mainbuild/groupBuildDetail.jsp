...
<script type="text/javascript" src="groupBuildDetail.js"></script>
					...
					<fieldset>
						...
						<table width="100%">
							<tr>
								...
								<td class="FieldInput" colspan="5"><label type="text" id="cnName" name='社会团体中文名称' field="cnName" style="width:97%"/><span style="color:red">*</span></td>
							</tr>
							<tr>
								<td class="FieldLabel" style="width:17%">社会团体英文名称：</td>
								<td class="FieldInput"  style="width:17%"><label type="text" name='社会团体英文名称' field="enName" style="width:90%"/></td>
								<td class="FieldLabel" style="width:17%">社会团体英文名称缩写：</td>
								<td class="FieldInput" style="width:17%"><label type="text" field="abName" name='社会团体英文名称缩写' style="width:90%"/></td>
								<td class="FieldLabel">成立日期：</td>
								<td class="FieldInput"><label type="text" name='成立日期' field="buildDate" style="width:90%"/></td>
							</tr>
							<tr>
								<td class="FieldLabel" style="width:17%">组织机构代码：</td>
								<td class="FieldInput" style="width:17%"><label type="text" name='组织机构代码' field="organCode"  style="width:90%"/></td>
								<td class="FieldLabel" style="width:17%">登记日期：</td>
								<td class="FieldInput" style="width:17%"><label type="text" id="regDate" name='登记日期' field="regDate"  style="width:90%"/><span style="color:red">*</span></td>
								<td class="FieldLabel" style="width:17%"></td>
								<td class="FieldInput" style="width:17%"></td>
							</tr>
							<tr>
								<td class="FieldLabel">社会团体类型：</td>
								<td class="FieldInput"><label id="sorgKind" field="sorgKind" name='社会团体类型' dataset="sorgKindSelect" style="width:90%"></label></td>
								<td class="FieldLabel">所属行（事）业：</td>
								<td class="FieldInput"><label field="busScope" name='所属行（事）业' style="width:90%"  dataset="busScopeSelect"></label></td>
								<td class="FieldLabel" style="width:17%"></td>
								<td class="FieldInput" style="width:17%"></td>
							</tr>
							<tr>	
								<td class="FieldLabel" style="width:17%">住所来源：</td>
								<td class="FieldInput" style="width:17%"><label field="resideSource" id="resideSource" name='住所来源' style="width:90%""></label></td>
							...
							<tr>
								...
								<td class="FieldInput" style="width:17%"><label type="text" id="sorgPost" name='社会团体邮编' field="sorgPost" style="width:90%"/></td>								
								<td class="FieldLabel">社会团体电话：</td>
								<td class="FieldInput"><label type="text" id="sorgPhone" name='社会团体电话' field="sorgPhone" style="width:90%"/></td>	
								<td class="FieldLabel">活动地域：</td>
								<td class="FieldInput"><label type="text" name='活动地域' field="actArea" style="width:90%" /></td>							
							</tr>
							<tr>
								...
								<td class="FieldInput"><label type="text" name='业务主管单位联系人' field="borgPeople" style="width:90%" /></td>
								<td class="FieldLabel">业务主管单位电话：</td>
								<td class="FieldInput"><label type="text" name='业务主管单位电话' field="borgPhone" style="width:90%" /></td>
							</tr>
							<tr>	
								<td class="FieldLabel">社会团体宗旨：</td>
								<td class="FieldInput" colspan="5"><textarea disabled="dsiabled" rows="5" name='社会团体宗旨' field="purpose" style="width:98%"></textarea></td>
							</tr>
							<tr>	
								<td class="FieldLabel">业务范围：</td>
								<td class="FieldInput" colspan="5"><textarea disabled="dsiabled"  rows="5" name='业务范围' field="business" style="width:98%"></textarea></td>
							</tr>
							<tr>	
								<td class="FieldLabel">单位会员数：</td>
								<td class="FieldInput"><label type="text" id="unitsNum" name='单位会员数' field="unitsNum" maxlength="6" style="width:90%"/></td>
								<td class="FieldLabel">个人会员数：</td>
								<td class="FieldInput"><label type="text" id="peopleNum" name='个人会员数' field="peopleNum" maxlength="6" style="width:90%"/></td>
								<td class="FieldLabel">理事数：</td>
								<td class="FieldInput"><label type="text" name='理事数' field="councilNum" maxlength="6" style="width:90%"></td>
							</tr>
							<tr>
								<td class="FieldLabel">常务理事数：</td>
								<td class="FieldInput"><label type="text" name='常务理事数' field="standCouncilNum" maxlength="6" style="width:90%"/></td>
								<td class="FieldLabel">活动资金数额：</td>
								<td class="FieldInput" colspan="3"><label type="text" id="regMon" name='活动资金数额' field="regMon" maxlength="10" style="width:30%"/>万元</td>
							</tr>
							<tr>
								<td class="FieldLabel">出资人：</td>
								<td class="FieldInput" colspan="5"><textarea disabled="disabled" name='出资人' field="fundingPeople" style="width:98%" ></textarea></td>
							</tr>
							<tr>
								<td class="FieldLabel">验资单位：</td>
								<td class="FieldInput" colspan="5"><label type="text" name='验资单位' field="checkCapitalOrgan" style="width:98%"></td>
							</tr>
							<tr>
								<td class="FieldLabel">经费来源：</td>
								<td class="FieldInput" colspan="5"><label type="text" name='经费来源' field="moneySource" style="width:98%"/></td>
							</tr>
							<tr>	
							...
							<tr>	
								...
								<td class="FieldInput"><label type="text"name='社会团体通信地址' id="sorgAdds" field="sorgAdds" style="width:97%"/></td>
								<td class="FieldLabel">社会团体电子邮箱：</td>
								<td class="FieldInput"><label type="text" name='社会团体电子邮箱' field="sorgEmail" style="width:90%"/></td>
					...
					<legend>社会团体信息</legend>
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput" style="width:17%"><label type="text" id="startDate" field="startDate" style="width:90%" onchange="calSessionDate()"/></td>
						...
						<next:Html>
							...
							<table width="100%">
								...
								<tr>
									...
									<td class="FieldInput" colspan="5"><textarea disabled="disabled" rows="2" name='"所在单位人事部门审查意见"' readonly="readonly" field="workOpinion" style="width:97.7%"></textarea><span style="color:red">*</span></td>
								</tr>
								<tr>
								...
								<tr>
										...
										<td class="FieldInput" colspan="5"><textarea disabled="disabled"   rows="2" name='"按照本社会团体章程会议产生通过情况"' field="sorgOpinion" style="width:97.7%"></textarea><span style="color:red">*</span></td>
									</tr>
									<tr>	
										<td class="FieldLabel"><label>签署日期：</label></td>
										<td class="FieldInput" colspan="5"><label type="text"  field="sorgCheckDate" onClick="WdatePicker()" style="width:22%"/></td>
								</tr>
								<tr>
									<td class="FieldLabel">备注：</td>
									<td class="FieldInput" colspan="5"><textarea disabled="disabled" rows="2" name='"备注"' readonly="readonly" field="note" style="width:97.7%"></textarea></td>
								</tr>
							</table>
							</form>
						</next:Html>
				...
				<form id="ruleForm" method="post" dataset="somRule" onsubmit="return false" class="L5form">
					...
					<table width="100%">
						<tr>
							...
							<td class="FieldInput"><label type="text" id="meetingName" field="meetingName" maxlength="100" style="width:90%" onchange="meetingInteractive(this.value,'meetingNameFee','somRule','somFee','meetingName')"></td>
							<td class="FieldLabel">会议形式：</td>
							<td class="FieldInput" colspan="3"><label type="text" id="meetingFormat" field="meetingFormat" maxlength="30" style="width:90%"></td>
						</tr>
						<tr>
							<td class="FieldLabel" style="width:17%">时间：</td>
							<td class="FieldInput" style="width:17%">
							<label type="text" name='时间' id="meetingDate" field="meetingDate" onClick="WdatePicker()" style="width:90%" onchange="meetingInteractive(this.value,'meetingDateFee','somRule','somFee','meetingDate')"/>
							</td>
						...
						<tr>
							...
							<td class="FieldInput" colspan="5"><textarea disabled="disabled" name="需说明的主要问题" id=mainQuestion field="mainQuestion" cols="65" rows="4" style="width:97%"></textarea></td>
						</tr>
					</table>
					</form>
				<form id="form2" method="post" dataset="somApplyDataSet" onsubmit="return false" class="L5form">
					...
					<table width="100%">
						...
						<tr>
							...
							<td class="FieldInput" style="width:49%"><label name="业务主管单位" field="borgName" style="width:90%" dataset="businessOrganSelect" ></label></td>
							<td class="FieldLabel" style="width:17%">业务主管单位审查日期：</td>
							<td class="FieldInput" style="width:17%"><label type="text" field="borgCheckDate" style="width:90%"></td>
						</tr>
					</table>
					</fieldset>
				</form>
				...
				<form method="post" onsubmit="return false" dataset="somFee" class="L5form">
					...
					<table width="100%">
						<tr>
							...
							<td class="FieldInput" style="width:15%"><label type="text" name="linkPhone" id="linkPhone" field="linkPhone" style="width:90%"/></td>
							<td class="FieldLabel" style="width:17%"></td>
							<td class="FieldInput" style="width:17%"></td>
						</tr>
						<tr>
							<td class="FieldLabel">会议名称：</td>
							<td class="FieldInput"><label type="text" name="meetingName" id="meetingNameFee" field="meetingName" maxlength="100" style="width:90%" /></td>
							<td class="FieldLabel">召开日期：</td>
							<td class="FieldInput">
							<label type="text" name='时间' id="meetingDateFee" field="meetingDate"  style="width:90%"/></td>
							<td class="FieldLabel">召开地点：</td>
							<td class="FieldInput"><label type="text" name="meetingPlace" id="meetingPlace" field="meetingPlace" maxlength="100" style="width:90%"/></td>
						</tr>
						<tr>	
							<td class="FieldLabel" style="width:17%">应到人数：</td>
							<td class="FieldInput" style="width:17%"><label type="text" name="应到人数" id="shouldNumFee" field="shouldNum" style="width:90%" maxlength="6" /></td>
							<td class="FieldLabel" style="width:17%">实到人数：</td>
							<td class="FieldInput" style="width:15%"><label type="text" name="实到人数" id="realNumFee" field="realNum" style="width:90%" maxlength="6" /></td>
							<td class="FieldLabel" style="width:17%"></td>
							<td class="FieldInput" style="width:17%"></td>
						</tr>
						<tr>
							<td class="FieldLabel">同意：</td>
							<td class="FieldInput"><label type="text" name="同意" id="passNumFee" field="passNum" style="width:90%" maxlength="6" /></td>			
							<td class="FieldLabel">不同意：</td>
							<td class="FieldInput"><label type="text" name="不同意" id="nopassNumFee" field="nopassNum" style="width:90%" maxlength="6" /></td>
							<td class="FieldLabel">弃权：</td>
							<td class="FieldInput"><label type="text" name="弃权" id="giveupNumFee" field="giveupNum" style="width:90%" maxlength="6"/></td>
						</tr>
						<tr>
					...
					<form title="负责人信息" id="addForm" method="post" dataset="somDutyInsertDataSet" onsubmit="return false" class="L5form">
						<table width="100%">
							...
							<tr id="leaderTr" style="display:none">
								...
								<td class="FieldInput">
									<label field="partyLeaderLevel" dataset="leaderLevelDataSet" id="partyLeaderLevel" name='"党政机关领导干部职级"'  style="width:90%">
									</label>
								</td>
								<td class="FieldLabel">批准机关：</td>
								<td class="FieldInput"><label type="text" id="promiseOrgan_add" field="promiseOrgan"style="width:90%;"/></td>
								<td class="FieldLabel">批准文号：</td>
								<td class="FieldInput"><label type="text" id="promiseCode_add" field="promiseCode"style="width:90%;"/></td>
							</tr>
							<tr>
								<td class="FieldLabel">其他社会职务：</td>
								<td class="FieldInput" colspan="5"><textarea disabled="disabled" rows="3" field="otherDuties" name='"其他社会职务"' style="width:97.7%"></textarea></td>
							</tr>
							<tr>
								<td class="FieldLabel">本人所在单位人事部门审查意见：</td>
								<td class="FieldInput" colspan="5"><textarea disabled="disabled" rows="2" name='"所在单位人事部门审查意见"' field="workOpinion" style="width:97.7%"></textarea></td>
							</tr>
							<tr>
								<td class="FieldLabel">审查工作单位：</td>
								<td class="FieldInput" colspan="3"><label type="text" field="workName" name='"工作单位"' style="width:90%"/></td>
							...
							<tr>
								<td class="FieldLabel">备注：</td>
								<td class="FieldInput" colspan="5"><textarea disabled="disabled" rows="2" name='"备注"' field="note" style="width:97.7%"></textarea></td>
							</tr>
						</table>
					</form>				
				</next:Html>
