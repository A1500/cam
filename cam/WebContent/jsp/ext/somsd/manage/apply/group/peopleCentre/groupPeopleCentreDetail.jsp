...
<html>
<head>
<title>社会团体负责人届中备案</title> 
<next:ScriptManager></next:ScriptManager>
<script type="text/javascript" src="groupPeopleCentreDetail.js"></script>
...
<script type="text/javascript">
	...
	%>
	var applyType='<%=ApplyType.SOM_GROUP_CHARGER_CENTRE%>';//业务类型
						...
						<form id="form2" dataset="somSessionDataSet" onsubmit="return false" class="L5form">
							...
							<table width="100%">
								<tr>
									...
									<label type="text" id="cnName" name='"社团名称"' title="社团名称" style="width:90%"/><span style="color:red">*</span>
									</td>
									<td class="FieldLabel" style="width:15%">登记证号：</td>
									<td class="FieldInput" style="width:35%">
									<label type="text" id="sorgCode" name='"登记证号"' title="登记证号" /><span style="color:red">*</span>
									</td>
								</tr>
								<tr>
									<td class="FieldLabel">届次名称：</td>
									<td class="FieldInput" ><label type="text" id="sessionName"  field="sessionName" name='"届次名称"' style="width:90%"/></td>
					...
					<form id="peopleFrom" method="post" dataset="somDutyInsertDataSet" onsubmit="return false" class="L5form">
						...
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput"><label type="text" id="birthday" field="birthday" name='"出生年月"' onblur="showAge()"  readonly="readonly" style="width:90%"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="FieldInput">
									<label field="ifFulltime"  dataset="ifFulltimeDataSet" name='"专/兼职"' style="width:90%">
									</label>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="FieldInput"><label type="text" id="startDate" field="startDate" name='"任职开始日期"' format="Y-m-d"  readonly="readonly" style="width:90%"/></td>
								<td class="FieldLabel">任职结束日期：</td>
								<td class="FieldInput"><label type="text" id="peopleEndDate" field="endDate" name='"任职结束日期"' format="Y-m-d" readonly="readonly" style="width:90%;display:none"/></td>
							</tr>
							<tr>
