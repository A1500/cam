...
<script type="text/javascript" src="groupPeopleCentreExt.js"></script>
						...
						<form id="form2" dataset="somSessionDataSet" onsubmit="return false" class="L5form">
							...
							<table width="100%">
								...
								<tr>
									...
									<td class="FieldInput" ><input type="text" id="sessionName"  field="sessionName" name='"届次名称"' style="width:90%"/><span style="color:red">*</span></td>
