...
<script type="text/javascript" src="groupDelayElectionEdit.js"></script>
						...
						<legend>审查意见</legend>
							<table width="100%">
								...
								<tr>
									...
									<td class="FieldInput" colspan="4"><textarea field="borgOpinion" cols="65" rows="2" style="width:97%"></textarea></td>
								</tr>
							</table>
						</fieldset>
						</form>
