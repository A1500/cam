...
<script type="text/javascript" src="groupElectionDetail.js"></script>
						...
						<form id="ElectionForm" method="post" dataset="somElectionDataSet" onsubmit="return false" class="L5form">
							...
							<table width="100%">
								<tr>
									...
									<label type="text" name="社团名称" id="cnName" maxlength="50" style="width:90%">
									<span style="color:red">*</span></td>
									<td class="FieldLabel" style="width:16%">登记证号：</td>
									<td class="FieldInput" style="width:30%">
									<label type="text" name="登记证号" id="sorgCode" maxlength="20" style="width:90%">
									<span style="color:red">*</span></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="FieldInput" colspan="3"><label type="text" name="会议名称" field="meetingName" maxlength="50" >
									<span style="color:red">*</span></td>
								</tr>
								<tr>
									<td class="FieldLabel">召开时间：</td>
									<td class="FieldInput"><label type="text" field="meetingDate" style="width:90%" readonly="readonly" /></td>
									<td class="FieldLabel">召开地点：</td>
									<td class="FieldInput"><label type="text" name="召开地点" field="meetingPlace" maxlength="50" style="width:90%"></td>
								</tr>
								<tr>
									<td class="FieldLabel">参会主要人员：</td>
									<td class="FieldInput"><label type="text" name="参会主要人员" field="mainPeople" maxlength="500" style="width:90%"></td>
									<td class="FieldLabel">参会人数：</td>
									<td class="FieldInput"><label type="text" name="参会人数" field="shouldNum"  maxlength="6" style="width:90%"></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="FieldInput">
										<label id="ifMakeFee" dataset="yesornoDataSet" field="ifMakeFee" name='"是否制定或修改会费标准"' style="width:90%">
										</label>
									</td>
									<td class="FieldLabel">候选人人数：</td>
									<td class="FieldInput"><label type="text" name="候选人人数" field="chiefNum" maxlength="6" style="width:90%"></td>
								</tr>
							</table>
						</form>
					</next:Html>
						...
						<form id="form2" method="post" dataset="somApplyDataSet" onsubmit="return false" class="L5form">
							...
							<table width="100%">
								<tr>
									...
									<td class="FieldInput" colspan="5"><textarea disabled field="borgOpinion" cols="65" rows="2" style="width:97%"></textarea></td>
								</tr>
								<tr>
									<td class="FieldLabel" style="width:20%">业务主管单位：</td>
									<td class="FieldInput" colspan="3" style="width:40%">
										<label type="text" id="borgNameDispaly" name="borgNameDispaly" style="width:50%"  title="业务主管单位" />
