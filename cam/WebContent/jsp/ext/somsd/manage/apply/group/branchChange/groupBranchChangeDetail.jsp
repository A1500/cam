...
<head>
	<next:ScriptManager/>
	<script type="text/javascript" src="groupBranchChangeDetail.js"></script>
				...
				<next:Panel>
					...
					<table width="100%">
						<tr>
							...
							<label type="text" id="mainSorgName" field="mainSorgName" title="社会团体主体名称"/><font color="red">*</font>
							</td>
							<td class="FieldLabel" style="width: 10%;"><label>社会团体主体登记证号：</label></td>
							<td class="FieldInput" style="width: 10%;">
							<label type="text" id="mainSorgCode"  field="mainSorgCode" onkeyup="value=value.replace(/[^\\w\.\/]/ig,'').toUpperCase()" /><font color="red">*</font>
							</td>
						</tr>
						<tr>
...
<table width="100%">
			<tr>
				...
				<td class="FieldInput"style="width:15%"><label id='leaPeopleNameBefore' type="text"  style="width:98%"/>
				</td>
				<td class="FieldLabel"style="width:15%" style="color:blue"><label>负责人姓名变更为：</label></td>
				<td class="FieldInput"style="width:15%"><label id="leaPeopleNameAfter" type="text"  onclick="add()" readonly="readonly" /></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更程序：</label></td>
				<td class="FieldInput" colspan="5"><textArea disabled id="leaPeopleDesc" cols="75" rows="4" style="width: 100%" field="changeDesc"></textArea></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更理由：</label></td>
				<td class="FieldInput" colspan="5"><textArea disabled id="leaPeopleReason" cols="75" rows="4" style="width: 100%" field="changeReason"></textArea></td>
			</tr>
		</table>
...
<table width="100%">
			...
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更程序：</label></td>
				<td class="FieldInput" colspan="3"><textArea cols="75" readonly="readonly" rows="4" style="width: 100%" id="housechangeDesc"></textArea></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更理由：</label></td>
					...
					<form title="负责人信息" id="addForm" method="post" dataset="somLegalPeopleDataSet" onsubmit="return false" class="L5form">
						<table width="100%">
							<tr>
								...
								<td class="FieldInput" style="width:21%"><input type="text" id="idCard" field="idCard" name='"身份证号码"' style="width:90%"/><span style="color:red">*</span></td>
							...
							<tr>
								...
								<td class="FieldInput">
									<select field="ifPartyLeader" id="ifPartyLeader_add" name='"是否党政机关领导干部"'  style="width:90%">
