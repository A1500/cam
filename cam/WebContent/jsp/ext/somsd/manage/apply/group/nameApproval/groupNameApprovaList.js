...
function insert(){
	...
	url="jsp/ext/somsd/manage/apply/group/nameApproval/groupNameApprovaEdit.jsp";
	L5.forward(url,'',data);
}
function update(){
...
function detail(){
	...
	data.put("taskCode",records[0].get('taskCode'));
	var url='';
	url="jsp/ext/somsd/manage/apply/group/nameApproval/groupNameApprovaDetail.jsp";
	L5.forward(url,'',data);
}
...
function enter(){
	...
	var url='jsp/ext/somsd/manage/apply/group/nameApproval/groupNameApprovaEdit.jsp?method=INSERT&sorgType='+sorgType;
	L5.forward(url);
}
...
function printWord(){
	...
	var url=L5.webPath+"/jsp/ext/somsd/manage/printWord/group/jsp/groupNameApproval.jsp?taskCode="+taskCode+"&sorgId="+sorgId;
	window.open(url);
}