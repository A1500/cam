...
<script type="text/javascript" src="groupCancelDetail.js"></script>
					...
					<next:Html>
						...
						<table width="100%">
							<tr>
								...
								<td class="FieldInput" width="30%"><label id="sorgCode" field="sorgCode" name='"登记证号"'   style="width:50%"/><span style="color:red">*</span></td>
								<td class="FieldLabel" width="20%"><label>社团代码：</label></td>
								<td class="FieldInput" width="30%">
								<label id="organCode" field="organCode" name='"社团代码"' style="width:50%"/><span style="color:red">*</span>
								</td>
							</tr>
							<tr>
								<td class="FieldLabel"><label>社团名称：</label></td>
								<td class="FieldInput">
								<label id="cnName" field="cnName" name='"社团名称"' style="width:50%"/><span style="color:red">*</span>
								</td>
								<td class="FieldLabel"><label>成立日期：</label></td>
								<td class="FieldInput">
								<label id="buildDate" field="buildDate" name='"成立日期"' style="width:50%"/><span style="color:red">*</span>
								</td>
							</tr>
							<tr>							
								<td class="FieldLabel"><label>住所：</label></td>
								<td class="FieldInput">
								<label id="residence" field="residence" name='"住所"' style="width:50%"/><span style="color:red">*</span>
								</td>
								<td class="FieldLabel"><label>社团电话：</label></td>
								<td class="FieldInput">
								<label id="sorgPhone" field="sorgPhone" name='"社团电话"' style="width:50%"/><span style="color:red">*</span>
								</td>
							</tr>
							<tr>
								<td class="FieldLabel"><label>法定代表人：</label></td>
								<td class="FieldInput">
								<label id="legalPeople" field="legalPeople" name='"法定代表人"' style="width:50%"/><span style="color:red">*</span>
								</td>
							...
							<tr>
								...
								<td class="FieldInput">
									<label id="cancelReason" dataset="cancelReasonSelect" field="cancelReason" name='"注销社团原因"' style="width:50%">
									</label><span style="color:red">*</span>
								</td>
							...
							<tr id="cancelReasonDescTr" style="display:none">
								...
								<td class="FieldInput" colspan="3"><textarea disabled rows="3" id="cancelReasonDesc" field="cancelReasonDesc" name='"注销原因说明"' style="width:93%"></textarea><span style="color:red">*</span></td>
							</tr>
							<tr>
								<td class="FieldLabel"><label>清算结论：</label></td>
								<td class="FieldInput" colspan="3"><textarea disabled rows="3" id="liqResult" field="liqResult" name='"清算结论"' style="width:93%"></textarea><span style="color:red">*</span></td>
							</tr>
						</table>
						</form>
						</fieldset>		
