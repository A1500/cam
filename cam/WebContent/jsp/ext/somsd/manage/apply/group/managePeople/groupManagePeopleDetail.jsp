...
<script type="text/javascript" src="groupManagePeopleDetail.js"></script>
						...
						<form id="form2" dataset="somSessionDataSet" onsubmit="return false" class="L5form">
							...
							<table width="100%">
								<tr>
									...
									<label type="text" id="cnName" name='"社团名称"' maxlength="20" title="社团名称" style="width:90%"/><span style="color:red">*</span>
									</td>
									<td class="FieldLabel">登记证号：</td>
									<td class="FieldInput">
									<label type="text" id="sorgCode" name='"登记证号"' title="登记证号" style="width:90%" /><span style="color:red">*</span>
									</td>
								</tr>
								<tr>
									<td class="FieldLabel">届次名称：</td>
									<td class="FieldInput" colspan="3"><label type="text" id="sessionName" field="sessionName" name='"届次名称"' style="width:90%"/><span style="color:red">*</span></td>
									<td class="FieldLabel">本届任期（年）：</td>
									<td class="FieldInput"><label type="text" id="tenure" field="tenure" name='"本届任期（年）"' style="width:90%"/></td>
								</tr>
								<tr>
									<td class="FieldLabel" style="width:17%">本届开始日期：</td>
									<td class="FieldInput" style="width:17%"><label type="text" id="startDate" field="startDate" name='"本届开始日期"'  readonly="readonly" style="width:90%"/></td>
									<td class="FieldLabel" style="width:17%">章程规定换届日期：</td>
									<td class="FieldInput" style="width:15%"><label type="text" id="endDate" field="endDate" name='"章程规定换届日期"' format="Y-m"  readonly="readonly" style="width:90%"/></td>
					...
					<form id="peopleFrom" method="post" dataset="somDutyInsertDataSet" onsubmit="return false" class="L5form">
						...
						<table width="100%">
							<tr>
								...
								<td class="FieldInput" style="width:21%"><label type="text" id="idCard" field="idCard" name='"身份证号码"' maxlength="18" style="width:90%"/><span style="color:red">*</span></td>
								<td class="FieldLabel" style="width:14%">姓名：</td>
								<td class="FieldInput" style="width:17%"><label type="text" id="name" field="name" name='"姓名"' style="width:90%"/><span style="color:red">*</span></td>
							...
							<tr>
								...
								<td class="FieldInput">
									<label id="sex" dataset="sexDataSet" field="sex" name='"性别"' style="width:90%">
									</label>
								</td>
								<td class="FieldLabel">出生日期：</td>
								<td class="FieldInput"><label type="text" id="birthday" field="birthday" name='"出生年月"' onblur="showAge()"  format="Y-m-d" readonly="readonly" style="width:90%"/></td>
							</tr>
							<tr>
								<td class="FieldLabel">政治面貌：</td>
								<td class="FieldInput">
									<label field="politics" dataset="politicsDataSet" name='"政治面貌"' style="width:90%">
									</label>
								</td>
								<td class="FieldLabel">民族：</td>
								<td class="FieldInput">
									<label field="folk" dataset="folkDataSet" name='"民族"' style="width:90%">
									</label>
								</td>
							</tr>
							<tr>
								<td class="FieldLabel">户口所在地：</td>
								<td class="FieldInput" colspan="5"><label type="text" field="populace" name='"户口所在地"' style="width:90%"/></td>
							</tr>
							<tr>
								<td class="FieldLabel">家庭住址：</td>
								<td class="FieldInput" colspan="5"><label type="text" field="adds" name='"家庭住址"' style="width:97%"/></td>
							</tr>
							<tr>
								<td class="FieldLabel">邮编：</td>
								<td class="FieldInput"><label type="text" id="postCode" field="postCode" name='"邮编"' maxlength="6" style="width:90%"/></td>
								...
								<td class="FieldInput">
									<label dataset="ifFulltimeDataSet" field="ifFulltime" name='"专/兼职"' style="width:90%">
									</label>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="FieldInput">
									<label id="sorgDuties" dataset="sorgDutiesDS" field="sorgDuties" name='"担任职务"'   style="width:90%">
									</label><span style="color:red">*</span>
								</td>
								<td class="FieldLabel">任职开始日期：</td>
								<td class="FieldInput"><label type="text" id="startDate" field="startDate" name='"任职开始日期"' format="Y-m-d" onclick="WdatePicker()" style="width:90%"/></td>
								<td class="FieldLabel">任职结束日期：</td>
								<td class="FieldInput"><label type="text" id="peopleEndDate" field="endDate" name='"任职结束日期"' format="Y-m-d" onclick="WdatePicker()" style="width:90%;display:none"/></td>
							</tr>
							<tr>
								<td class="FieldLabel">是否党政机关领导干部：</td>
								<td class="FieldInput">
									<label id="ifPartyLeader" dataset="yesornoDataSet" field="ifPartyLeader" name='"是否党政机关领导干部"' style="width:90%">
									</label><span style="color:red">*</span>
								</td>
							...
							<tr>
								...
								<td class="FieldInput"><label type="text" field="workCheckDate" format="Y-m-d" readonly="readonly" style="width:90%"/></td>
							</tr>
							<tr>
