...
<script type="text/javascript" src="groupPrepareDetail.js"></script>
				...
				<next:Html>
					...
					<table width="100%">
						<tr>
							...
							<td class="FieldInput" colspan="5"><label type="text" name='"社会团体中文名称"' id="cnName" field="cnName" style="width:98%"/><span style="color:red">*</span></td>
						</tr>
						<tr>
							<td class="FieldLabel">英文名称：</td>
							<td class="FieldInput" colspan="3"><label type="text" name='"社团英文名称"' field="enName" style="width:98%"/></td>
							<td class="FieldLabel">英文名称缩写：</td>
							<td class="FieldInput"><label type="text" field="abName" name='"社团缩写名称"' style="width:90%"/></td>
						</tr>
						<tr>
							<td class="FieldLabel">住所：</td>
							<td class="FieldInput" colspan="3"><label type="text" name='"住所"' field="residence" style="width:98%"/></td>
							<td class="FieldLabel">住所来源：</td>
							<td class="FieldInput">
								<label field="resideSource" name='"住所来源"'  dataset="resideSourceDataSet" style="width:90%">
								</label>
							</td>
						</tr>
						<tr>
							<td class="FieldLabel">电话：</td>
							<td class="FieldInput" colspan="3"><label type="text" id="sorgPhone" name='"电话"' field="sorgPhone" style="width:98%"/></td>
							<td class="FieldLabel">邮编：</td>
							<td class="FieldInput"><label type="text" id="sorgPost" name='"邮编"' field="sorgPost" style="width:90%"/></td>
						</tr>
						<tr>
							<td class="FieldLabel" style="width:17%">活动地域：</td>
							<td class="FieldInput" style="width:17%"><label type="text" name='"活动地域"' field="actArea" style="width:90%"/></td>
							<td class="FieldLabel" style="width:17%">个人会员数：</td>
							<td class="FieldInput" style="width:17%"><label type="text" id="peopleNum" name='"个人会员数"' field="peopleNum" maxlength="6" style="width:90%"/></td>
							<td class="FieldLabel" style="width:17%">单位会员数：</td>
							<td class="FieldInput" style="width:17%"><label type="text" id="unitsNum" name='"单位会员数"' field="unitsNum" maxlength="6" style="width:90%"/></td>
						</tr>
						<tr>
							...
							<td class="FieldInput"><label type="text" name='"资金数额"' field="regMon" maxlength="10" style="width:90%"/></td>
						</tr>
						<tr>
							<td class="FieldLabel">社团活动经费来源：</td>
							<td class="FieldInput" colspan="5"><label type="text" name='"资金来源"' field="moneySource" style="width:98%"/></td>
						</tr>
						<tr>
							<td class="FieldLabel">社团宗旨：</td>
							<td class="FieldInput" colspan="5"><textarea disabled="disabled" rows="5" name='"社团宗旨"' field="purpose" style="width:98%"></textarea></td>
						</tr>
						<tr>
							<td class="FieldLabel">业务范围：</td>
							<td class="FieldInput" colspan="5"><textarea disabled="disabled" rows="5" name='"业务范围"' field="business" style="width:98%"></textarea></td>
						</tr>
						<tr>
							<td class="FieldLabel">国家及其他省、市设立此类社团的情况：</td>
							<td class="FieldInput" colspan="5"><textarea disabled="disabled" rows="3" field="buildStatus" name='"国家及其他省、市设立此类社团的情况"' style="width:98%"></textarea></td>
						</tr>
						<tr>
							<td class="FieldLabel">拟吸收会员的意向：</td>
							<td class="FieldInput" colspan="5"><textarea disabled="disabled" rows="3" field="absorpMember" name='"拟吸收会员的意向"' style="width:98%"></textarea></td>
						</tr>
					</table>
					</form>
					</fieldset>
					...
					<table width="100%">
						<tr>
							...
							<td class="FieldInput" style="width:17%"><label type="text" name='"申请日期"' field="appDate"  style="width:90%"/></td>
						</tr>
					</table>
					</form>
					</fieldset>
			...
			<next:Panel title="拟任负责人">
				<next:EditGridPanel id="aspchiefGrid" dataset="somAspchiefDataSet" width="100%" stripeRows="true" height="100%">
					...
					<next:Columns>
						...
						<next:Column header="是否是拟任法定代表人" field="ifLegal" width="10%" editable="false"><next:ComboBox dataset="yesornoDataSet"></next:ComboBox></next:Column>
					</next:Columns>
					<next:BottomBar>
