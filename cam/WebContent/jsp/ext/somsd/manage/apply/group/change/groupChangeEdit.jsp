...
<head>
	<next:ScriptManager/>
	<script type="text/javascript" src="groupChangeEdit.js"></script>
			...
			<next:Panel title="社会团体变更登记申请表" width="100%" height="100%" autoScroll="true">
				...
				<next:Html>
					...
					<form method="post" onsubmit="return false"  dataset="somFlowAddDataset" class="L5form">
						<table width="100%">
						<tr>
							<td class="FieldInput" colspan="3"><textarea name="社团内部履行程序" id="process" field="process" cols="65" rows="4" style="width:95%"></textarea></td>
						</tr>
					</table>
					</form>
					</fieldset>
...
<table width="100%">
			...
			<tr>
				...
				<td class="FieldInput"style="width:15%"><input id='leaPeopleNameAfter' field="changeAfter"  onclick="add()" readonly="readonly" type="text" /></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更理由：</label></td>
...
<table width="100%">
			<tr>
				...
				<td class="FieldInput" style="width:75%">
					<input id='moneyBefore' type="text"  style="width:98%"/>
				</td>
			</tr>
			<tr>
				<td class="FieldLabel"><label>资金来源变更前：</label></td>
				<td class="FieldInput">
					<input id='moneySourceBefore' type="text"  style="width:98%"/>
				</td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">资金数额变更为：</label></td>
				<td class="FieldInput">
				<input id='moneyAfter' type="text"  style="width:98%"/>
				</td>
			</tr>
			<tr>
				<td class="FieldLabel" style="width:25%"><label style="color:blue">资金数额变更为：</label></td>
				<td class="FieldInput" style="width:75%"><input id="moneyAfter" type="text" style="width:98%"/></td>
			</tr>
			<tr>
...
<table width="100%">
			<tr>
				...
				<td class="FieldInput"style="width:75%"><select  id="borgNameBefore" style="width:80%"><option  dataset="businessOrganSelect"></option></select></td>
			</tr>
			<tr>
...
<next:Window id="detail2" closeAction="hide" title="法定代表人变更" width="600"  autoScroll="true" modal="true">
	<next:TopBar>
		...
		<next:ToolBarItem text="确定" iconCls="return" handler="forLeaPeopleMove"></next:ToolBarItem>
		<next:ToolBarItem text="关闭" iconCls="return" handler="closeChangeWinD"></next:ToolBarItem>
	</next:TopBar>
	<next:Html>
	<form method="post" onsubmit="return false" class="L5form">
