...
<script type="text/javascript" src="fundBuildDetail.js"></script>
						...
						<next:Html>
							...
							<table width="100%">
								<tr>
									...
									<td class="FieldInput" colspan="3"><input disabled="true" type="text" id="cnName" name='基金会中文名称' field="cnName" style="width:97%"  /><span style="color:red">*</span></td>
								</tr>
								<tr>
									<td class="FieldLabel" style="width:17%">基金会英文名称：</td>
									<td class="FieldInput"  style="width:17%"><label type="text" name='基金会英文名称' field="enName" style="width:90%"/></td>
									<td class="FieldLabel" style="width:17%">基金会英文名称缩写：</td>
									<td class="FieldInput" style="width:17%"><label type="text" field="abName" name='基金会英文名称缩写' style="width:90%"/></td>
								</tr>
								<tr>
									<td class="FieldLabel" style="width:17%">登记时间：</td>
									<td class="FieldInput" style="width:17%"><label type="text" name='登记时间' id="regDate" field="regDate" style="width:90%"/><span style="color:red">*</span></td>						
									<td class="FieldLabel">基金会类型：</td>
									<td class="FieldInput"><label id="sorgKind" field="sorgKind" name='基金会类型' style="width:90%" dataset="sorgKindSelect" ></label><span style="color:red">*</span></td>
								</tr>
								<tr>	
									...
									<td class="FieldInput"><label type="text" id="regMon" name='活动资金数额' field="regMon" maxlength="10" style="width:30%"/>万元</td>
								</tr>
								<tr>	
								...
								<tr>
									...
									<td class="FieldInput" colspan="3"><textarea rows="5" disabled="disabled"
								...
								<tr>
									...
									<td class="FieldInput">
										...
										<div id="popup" style="width:300px; height: 150px; display: none;position: absolute;background-color: #FFFFFF;" >  
	   									...
	   									<input  id="borgName" name="borgName" field="borgName" title="业务主管单位代码"/>
								...
								<tr>	
									...
									<td class="FieldInput"><label type="text" name='住所' field="residence" style="width:90%"/><span style="color:red">*</span></td>
									<td class="FieldLabel" style="width:17%">邮编：</td>
									<td class="FieldInput" style="width:17%"><label type="text" id="sorgPost" name='基金会邮编' field="sorgPost" style="width:90%"/></td>								
								</tr>
							</table>
							</form>
							</fieldset>
								...
								<form  method="post" dataset="LegalPeopleDataSet" onsubmit="return false" class="L5form">
									<table width="100%">
										...
										<tr>
												...
												<td class="FieldInput" colspan="5"><textarea   disabled="disabled" rows="2" name='"按照本基金会章程会议产生通过情况"' field="sorgOpinion" style="width:97.7%"></textarea></td>
										</tr>
										<tr>	
												<td class="FieldLabel"><label>签署日期：</label></td>
												<td class="FieldInput" colspan="5"><label type="text"  field="sorgCheckDate" style="width:22%"/></td>
										</tr>
										<tr>
											<td class="FieldLabel">备注：</td>
											<td class="FieldInput" colspan="5"><textarea  disabled="disabled" rows="2" name='"备注"' field="note"style="width:98%;background-color:#F5FAFA;border:0"></textarea></td>
										</tr>
									</table>
								</form>
							</next:Html>
		...
		<next:Html>
			...
			<table width="100%">
				...
				<tr>
					...
					<td class="FieldInput"><label type="text" id="meetingName" field="meetingName" maxlength="100" style="width:90%"></td>
				...
				<tr>
					...
					<td class="FieldInput" style="width:17%"><label type="text" id="meetingDate" field="meetingDate" readonly="readonly" style="width:90%"></td>
				...
				<tr>
					...
					<td class="FieldInput"><label type="text" name="赞同人数" id="passNum" field="passNum" maxlength="6" style="width:90%"></td>
		...
		<form id="form2" method="post"  onsubmit="return false" class="L5form" dataset="somApplyDataSet">
			...
			<table width="100%">
				...
				<tr>
					...
					<td class="FieldInput"  colspan="4"><label type="text" field="borgCheckDate" readonly="readonly" ></td>
				</tr>
				<tr>
					<td class="FieldLabel">承办人：</td>
					<td class="FieldInput"><label type="text" field="acceptPeopleName"  style="width:90%"></td>
					<td class="FieldLabel">承办日期：</td>
					<td class="FieldInput"><label type="text"  field="acceptTime" readonly="readonly" style="width:90%"></td>
				</tr>
			</table>
			</fieldset>
		</form>
