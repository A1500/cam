...
<head>
	<next:ScriptManager/>
	<script type="text/javascript" src="fundChangeEdit.js"></script>
	...
	<script type="text/javascript">
		...
		var somApplyType='<%=ApplyType.SOM_FUND_CHANGE%>';//业务类型
...
<model:datasets>
	...
	<!-- 变更意见 -->
	<model:dataset id="somFlowAddDataset" cmd="com.inspur.cams.sorg.base.cmd.SomApplyQueryCmd" global="true">
					...
					<form method="post" onsubmit="return false" class="L5form" dataset="somOrganDataSet">
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput" ><input type="text"  field="legalPeople"  maxlength="32"/><font color="red">*</font></td>

								<td class="FieldLabel" style="width: 10%;"><label>申请时间：</label></td>
								<td class="FieldInput" ><input type="text" id="appDate"onClick="WdatePicker()"/><font color="red">*</font></td>
							</tr>
						</table>
					</form>
					</fieldset>
...
<next:Html>
	...
	<table width="100%">
			<tr>
				...
				<td class="FieldInput"style="width:75%"><input id='nameBefore' type="text"  style="width:98%"/></td>
			</tr>
			<tr>
...
<next:Window id="AddChange2" closeAction="hide" title="法定代表人变更" width="600"  modal="true" autoScroll="true">
	<next:TopBar>
		<next:ToolBarItem text='' id="displayItem" />
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
		<next:ToolBarItem text="填写法定代表人登记表" iconCls="add" handler="forLegalPeople" ></next:ToolBarItem>
...
<table width="100%">
			<tr>
				...
				<td class="FieldInput"style="width:15%"><input id='leaPeopleNameBefore'   type="text" /> </td>
				<td class="FieldLabel"style="width:15%" style="color:blue"><label>法定代表人姓名变更为：</label></td>
				<td class="FieldInput"style="width:15%"><input id='leaPeopleNameAfter' field="changeAfter" readonly="readonly" onclick="forLegalPeople();" type="text" /></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更理由：</label></td>
...
<table width="100%">
			<tr>
				...
				<td class="FieldInput" style="width:60%"><input id="moneyBefore" type="text" style="width:85%"/>万元 </td>
			</tr>
			<tr>
				<td class="FieldLabel"><label>基金来源变更前：</label></td>
				<td class="FieldInput"><input id="moneySourceBefore" type="text" style="width:98%"/></td>
			</tr>
			<tr>
...
<table width="100%">
			<tr>
				...
				<td class="FieldInput" style="width:75%"><textArea id="borgNameBefore"   field="changeBefore" cols="75" rows="4" style="width: 100%" ></textArea></td>
			</tr>
			<tr>
	...
	<form method="post" onsubmit="return false" class="L5form"dataset="somChangeDataset">
		<table width="100%">
			<tr>
				...
				<td class="FieldInput"style="width:25%"><select  id="fundTypeBefore"  ><option  dataset="sorgGroupKind"></option></select></td>
...
<next:Window id="legalPeopleWindow" closeAction="hide" title="法定代表人登记表" height="400" width="800" modal="true" >
	<next:TabPanel  width="98%" height="84%">
		<next:Tabs>
			...
			<next:EditGridPanel id="somResumeLegalGrid" dataset="somResumeInsertDataSet" stripeRows="true" title="本人简历" width="100%" height="100%" autoScroll="true">
				<next:TopBar>
					<next:ToolBarItem symbol="->"></next:ToolBarItem>
				</next:TopBar>
				<next:Columns>
...
<next:Window id="legalPeopleWin" closeAction="hide" title="负责人列表" width="800" height="350" autoScroll="true" modal="true">
	<next:EditGridPanel id="peopleGrid" dataset="somLegalPeopleDataSet" width="780" stripeRows="true" height="300">
	<next:TopBar>
		<next:ToolBarItem symbol="->"></next:ToolBarItem>
	...
	<next:BottomBar>
		<next:PagingToolBar dataset="somLegalPeopleDataSet"/>
	</next:BottomBar>
</next:EditGridPanel>
</next:Window>
<next:Window id="peopleWin" title="法定代表人信息" resizable="false" width="800" height="430" modal="true" closeAction="hide" closable="false">
	<next:TabPanel id="tabSomOrgan">
		<next:Tabs>
			<next:Panel id="peoplePanel" title="基本信息" autoScroll="true" width="770" height="85%">
				<next:Html>
					<form id="peopleFrom" method="post" dataset="somLegalPeopleDataSet" onsubmit="return false" class="L5form">
						<input type="hidden" id="peopleId" field="peopleId">
						<table width="100%">
							<tr>
								<td class="FieldLabel" style="width:15%">身份证号码：</td>
								<td class="FieldInput" style="width:21%"><input type="text" id="idCard" field="idCard" name='"身份证号码"' onchange="idCardCheck()" maxlength="18" style="width:90%"/><span style="color:red">*</span></td>
								<td class="FieldLabel" style="width:14%">姓名：</td>
							...
							<tr>
								<td class="FieldLabel">担任职务：</td>
								<td class="FieldInput">
									<select id="sorgDuties" field="sorgDuties" name='"担任职务"' disabled="disabled" style="width:90%">
										<option dataset="sorgDutiesSelect"></option>
									</select><span style="color:red">*</span>
								</td>
								<td class="FieldLabel">任职开始日期：</td>
								<td class="FieldInput"><input type="text" id="startDate" field="startDate" name='"任职开始日期"' onclick="WdatePicker()" readonly="readonly" style="width:90%"/> <span style="color:red">*</span> </td>
								<td class="FieldLabel">任职结束日期：</td>
								<td class="FieldInput"><input type="text" id="peopleEndDate" field="endDate" name='"任职结束日期"' onclick="WdatePicker()" readonly="readonly" style="width:90%;display:none"/></td>
							</tr>
							<tr>
								<td class="FieldLabel">是否党政机关领导干部：</td>
								<td class="FieldInput">
							...
							<tr>
								...
								<td class="FieldInput" colspan="3"><input type="text" field="workName" name='"工作单位"' style="width:90%"/></td>
								<td class="FieldLabel">审查日期：</td>
								<td class="FieldInput"><input type="text" field="workCheckDate" onclick="WdatePicker()" readonly="readonly" style="width:90%"/></td>
							</tr>
							<tr>
								<td class="FieldLabel">备注：</td>
			...
			<next:EditGridPanel id="uploadPeopleGrid" title="法律要件" stripeRows="true" dataset="somLegalPeopleElectronicDataSet" width="770" height="85%" autoScroll="true">
				<next:TopBar>
					<next:ToolBarItem symbol="附件列表"></next:ToolBarItem>
					<next:ToolBarItem symbol="->"></next:ToolBarItem>
					<next:ToolBarItem iconCls="add" text="增加上传附件" handler="uploadLegalPeopleFile"></next:ToolBarItem>
	...
	<next:Buttons>
		...
		<next:ToolButton text="关闭" handler="closePeopleWIns"></next:ToolButton>
	</next:Buttons>
</next:Window>
