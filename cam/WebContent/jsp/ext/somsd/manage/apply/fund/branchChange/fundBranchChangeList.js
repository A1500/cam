...
function insert(){
	...
	url="jsp/ext/somsd/manage/apply/fund/branchChange/fundBranchChangeEdit.jsp";
	L5.forward(url,'',data);	
}
function update(){
...
function detail(){
	...
	data.put("taskCode",records[0].get('taskCode'));
	var url='';
	url="jsp/ext/somsd/manage/apply/fund/branchChange/fundBranchChangeDetail.jsp";
	L5.forward(url,'',data);	
}
...
function enter(){
	var url='jsp/ext/somsd/manage/apply/fund/branchChange/fundBranchChangeEdit.jsp?method=INSERT';
	L5.forward(url);
}
...
function printItem(){
	...
	var dutyId=records[0].get('legalDutyId');
	var id=records[0].get('id');
		var url=L5.webPath+"/jsp/ext/somsd/manage/printWord/fund/jsp/branchChange/branchChange.jsp?dutyId="+dutyId+"&sorgId="+sorgId+"&id="+id+"&taskCode="+taskCode;
		window.open(url);
}