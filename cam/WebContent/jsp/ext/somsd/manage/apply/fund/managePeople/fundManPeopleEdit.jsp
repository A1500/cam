...
<script type="text/javascript" src="fundManPeopleEdit.js"></script>
						...
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput" colspan="3"><input type="text"
									id="sessionName" field="sessionName" name='"届次名称"'  onchange="findSessionExist();"
							...
							<tr>
								...
								<td class="FieldInput" style="width: 15%"><input
									...
									format="Y-m" onclick="WdatePicker()" readonly="readonly"
									style="width: 90%" /></td>
					...
					<form title="负责人信息" id="addForm" method="post" dataset="somDutyDataSet" onsubmit="return false" class="L5form">
						<table width="100%">
							<tr>
								...
								<td class="FieldInput" style="width:21%"><input type="text" id="idCardID" field="idCard" name='"身份证号码"' onblur="checkCard();" style="width:90%"/><span style="color:red">*</span></td>
