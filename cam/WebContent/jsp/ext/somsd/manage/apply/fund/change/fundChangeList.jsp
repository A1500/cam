...
%>	
<script type="text/javascript" src="fundChangeList.js"></script>
...
<!-- 打印变更事项列表window -->
<next:Window id="printItemWin" closeAction="hide" title="打印变更事项" width="800" height="350" autoScroll="true" modal="true">
  <next:EditGridPanel id="heldGrid" dataset="somChangeList" width="95%" stripeRows="true" height="99.9%">
				<next:TopBar>
					<next:ToolBarItem symbol="->"></next:ToolBarItem>
					<next:ToolBarItem iconCls="print" text="打印" handler="printItem"></next:ToolBarItem>
				</next:TopBar>
				<next:Columns>
					<next:RowNumberColumn/>
					<next:RadioBoxColumn></next:RadioBoxColumn>
					<next:Column header="变更事项"id="changeItem"  field="changeItem" width="20%" editable="false" dataset="somChangeItem"><next:TextField/></next:Column>
					</next:Columns>
				<next:BottomBar>
					<next:PagingToolBar dataset="somChangeList" />
				</next:BottomBar>
			</next:EditGridPanel>
</next:Window>
</body>
