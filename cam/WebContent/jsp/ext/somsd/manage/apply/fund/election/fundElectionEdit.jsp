				...
				<next:Html>
					...
					<table width="100%">
						<tr>
							...
							<td class="FieldInput" style="width: 17%" colspan="3">
							<label type="text" id="sorgName" name='基金会名称' field="sorgName" style="width:55%"/>
							</td>
						</tr>
						<tr>
						...
						<%if(method.equals("INSERT")){ %>
							...
							<td class="FieldInput" colspan="3">第<input type="text" name="会议名称" field="meetingName" id="meetingName" maxlength="50" style="width:5%" onchange="ifNumber(this);">次理事会会议
					...
					<table width="100%">
								<tr>
									...
									<input type="text" id="borgNameDispaly" name="borgNameDispaly"  title="业务主管单位"  onkeyup="findDiv(this,'borgName','popup','','businessOrganAuto','BORG_NAME@like','borgCode','borgName','35')" onblur="clearDiv()" onchange="clearBorg(this)" style="width:40%"/><img src="<%=SkinUtils.getImage(request,"l5/help.gif")%>" style="cursor:hand" onclick="showBorgWin()"/>
			...
			<next:Panel title="基金会人员基本情况" width="100%" height="100%"
				...
				<next:EditGridPanel id="peopleGrid" dataset="aspForLiShi"
					...
					<next:Columns>
						...
						<next:Column header="姓名" field="name" width="10%" editable="false" summaryType="count">
							<next:ExtendConfig>
						...
						<next:Column header="年龄" field="age" width="6%"
							editable="false">
							<next:TextField />
						</next:Column>
						...
						<next:Column header="专职/兼职" field="ifFulltime" width="8%"
							editable="false">
							<next:ComboBox dataset="ifFulltimeDataSet" />
						</next:Column>
						<next:Column header="是否退休" field="ifRetire" width="8%"
							editable="false">
				...
				<next:EditGridPanel id="peopleGrid1" dataset="aspForJianShi"
					 stripeRows="true" hasSum="true" height="250" autoScroll="true"
					title="基金会监事基本情况">
					<next:TopBar>
						<next:ToolBarItem symbol="->"></next:ToolBarItem>
					...
					<next:Columns>
						...
						<next:Column header="人事关系所在单位" field="workName" width="15%"
							editable="false">
							<next:TextField />
						</next:Column>
						<next:Column header="人事关系所在单位职务" field="workDuties" width="15%"
