...
function init() {
	...
	if(method=="INSERT"){
		somOrganDataSet.newRecord({"cnName":userId,"sorgId":sorgId,"sorgStatus":'22',"sorgType":"J","ifBranch":'0',"morgName":userId,"morgArea":morgArea});
		...
		somApplyDataSet.newRecord({"curActivity":"受理","taskCode":taskCode,
			"sorgId":sorgId,"applyType":somApplyType,"dataSource":"ONLINE","sorgType":"J",
				"acceptOpinionId":"1","acceptArea":morgArea,"createOrgan":morgArea,"createPerson":userId});
	}else{
		loadInfo();
	}
