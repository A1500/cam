...
%>	
<script type="text/javascript" src="fundBuildList.js"></script>
...
<script type="text/javascript">
	...
	var userId='<%=userId%>';
	var applyType='<%=ApplyType.SOM_FUND_BUILD%>';
</script>
</head>
<body>
			...
			<next:Panel title="打印列表"  width="100%" height="100%" autoScroll="true">
				<next:Html>
					...
					<input type="radio"name="Word" 
						id="SQ" label="基金设立申请表" />基金设立申请表 <br />
					<input type="radio"name="Word" 
						id="FD" label="基金法人登记申请表" />基金法人登记申请表 <br />
					<input type="radio" name="Word"
						id="FZ" label="理事监事备案表" />理事监事备案表 <br />
					<input type="radio" name="Word" 
						id="FR" label="基金法定代表人登记表 " />基金法定代表人登记表 <br />
					<input type="radio" name="Word" 
						id="ZC" label="基金章程核准表" />基金章程核准表 <br />
					<input type="radio" name="Word" 
						id="BA" label="理事监事申请备案表" />理事监事备案申请表 <br />
					</td>
...
<next:Window id="printHeldWin" closeAction="hide" title="打印负责人" width="800" height="350" autoScroll="true" modal="true">
  <next:EditGridPanel id="heldGrid" dataset="aspForLiShi" width="95%" stripeRows="true" height="99.9%">
				<next:TopBar>
					<next:ToolBarItem symbol="->"></next:ToolBarItem>
				...
				<next:Columns>
					...
					<next:Column header="职务" field="sorgDuties" width="20%"dataset="sorgDutiesDataSet" editable="false"><next:TextField/></next:Column>
					</next:Columns>
				<next:BottomBar>
