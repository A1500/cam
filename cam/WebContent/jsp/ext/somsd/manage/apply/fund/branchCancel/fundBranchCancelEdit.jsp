...
<script type="text/javascript" src="fundBranchCancelEdit.js"></script>
					...
					<next:Html>
						...
						<table width="100%">
							<tr>
								...
								<td class="FieldInput" width="30%"><input id="sorgCode"
									field="sorgCode" name='"分支/代表机构登记证号"' style="width: 80%"
									maxlength="20" onkeyup="value=value.replace(/[^\-\\w\.\/]/ig,'').toUpperCase()"/><font color="red">*</font></td>
							...
							<tr>
								...
								<td class="FieldInput"><input field="cnName"
									name='"分支/代表机构名称"' id="cnName" style="width: 80%" maxlength="50" /><font
									color="red">*</font></td>
								<td class="FieldLabel"><label>成立日期：</label></td>
								<td class="FieldInput"><input field="buildDate"
									name='"成立日期"' onclick="WdatePicker()" style="width: 80%" /><font
									color="red">*</font></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="FieldInput"><input field="residence" name='"住所"'
									style="width: 80%" maxlength="50" /><font color="red">*</font></td>
								<td class="FieldLabel"><label>基金会电话：</label></td>
								<td class="FieldInput"><input field="sorgPhone"
									name='"基金会电话"' style="width: 80%" maxlength="15" /></td>
							</tr>
							<tr>
								<td class="FieldLabel"><label>注销日期：</label></td>
								<td class="FieldInput"><input id="cancelDate"
									field="cancelDate" name='"注销日期"' onclick="WdatePicker()"
