					...
					<form id="ruleForm" method="post" dataset="somRuleDataSet" onsubmit="return false" class="L5form">
						...
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput" colspan="3"><input type="text" id="meetingName" field="meetingName" maxlength="100" style="width:96%" name="会议名称"><font color="red">*</font></td>
								<td class="FieldLabel">会议形式：</td>
								<td class="FieldInput"><input type="text" id="meetingFormat" field="meetingFormat" maxlength="30" style="width:85%" name="会议形式"><font color="red">*</font></td>
							</tr>
							<tr>
								<td class="FieldLabel" style="width:17%">时间：</td>
								<td class="FieldInput" style="width:17%"><input type="text" id="meetingDate" field="meetingDate" readonly="readonly" onclick="WdatePicker()" style="width:85%" name="时间"><font color="red">*</font></td>
								<td class="FieldLabel" style="width:17%">应到人数：</td>
								<td class="FieldInput" style="width:15%"><input type="text" name="应到人数" id="shouldNum" field="shouldNum" maxlength="6" style="width:85%"><font color="red">*</font></td>
								<td class="FieldLabel" style="width:17%">实到人数：</td>
								<td class="FieldInput" style="width:17%"><input type="text" name="实到人数" id="realNum" field="realNum" maxlength="6" style="width:85%"><font color="red">*</font></td>
							</tr>
							<tr>
								<td class="FieldLabel">同意人数：</td>
								<td class="FieldInput"><input type="text" name="同意人数" id="passNum" field="passNum" maxlength="6" style="width:85%"><font color="red">*</font></td>
								<td class="FieldLabel">反对人数：</td>
								<td class="FieldInput"><input type="text" name="反对人数" id="nopassNum" field="nopassNum" maxlength="6" style="width:85%"><font color="red">*</font></td>
								<td class="FieldLabel">弃权人数：</td>
								<td class="FieldInput"><input type="text" name="弃权人数" id="giveupNum" field="giveupNum" maxlength="6" style="width:85%"><font color="red">*</font></td>
							</tr>
							<tr>
								<td class="FieldLabel">章程修改内容及说明：</td>
								<td class="FieldInput" colspan="5"><textarea name="章程修改内容及说明" id=mainQuestion field="mainQuestion" cols="65" rows="4" style="width:97%"></textarea><font color="red">*</font></td>
							</tr>
						</table>
						</fieldset>
					</form>
					<form id="form2" method="post" dataset="somApplyDataSet" onsubmit="return false" class="L5form">
						...
						<table width="100%">
							<tr>
								...
								<td class="FieldInput" colspan="5"><textarea field="borgOpinion" cols="65" rows="2" style="width:97%" name="业务主管单位审查意见"></textarea><font color="red">*</font></td>
							</tr>
							<tr>
								<td class="FieldLabel" style="width:17%">业务主管单位：</td>
								<td class="FieldInput" colspan="3" style="width:49%">
									<input type="text" id="borgNameDispaly" name="borgNameDispaly" style="width:60%"  title="业务主管单位"  onkeyup="findDiv(this,'borgName','popup','','businessOrganAuto','BORG_NAME@like','borgCode','borgName','35')" onblur="clearDiv();" onchange="clearBorg(this);"/>
									<img src="<%=SkinUtils.getImage(request,"l5/help.gif")%>" style="cursor:hand" onclick="showBorgWin()"/>
								...
								<td class="FieldInput" style="width:17%" ><input type="text" field="borgCheckDate" readonly="readonly" onclick="WdatePicker()" style="width:85%" name="业务主管单位审查日期"><font color="red">*</font></td>
							</tr>
							</table>
							</fieldset>
					</form>
