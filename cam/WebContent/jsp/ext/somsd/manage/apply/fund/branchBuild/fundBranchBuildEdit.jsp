...
<script type="text/javascript" src="fundBranchBuildEdit.js"></script>
...
<model:datasets>
	...
	<model:dataset id="somOrganDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomOrganQueryCmd" global="true" method="queryOrganOnline">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomOrgan">
			<model:field name="mainSorgCode" type="string"  />
			<model:field name="mainSorgName" type="string"  />
					...
					<form method="post" dataset="somOrganDataSet" onsubmit="return false"class="L5form">
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput" colspan="5"><input type="text" id="cnName" name='"机构名称"' field="cnName" style="width:98%"/><label style="color:red">*</label></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="FieldInput"><input type="text" name='"成立日期"' id="buildDate" field="buildDate" onclick="WdatePicker()" readonly="readonly" style="width:90%"/><span style="color:red">*</span></td>
							</tr>
					...
					<form title="负责人信息" id="addForm" method="post" dataset="somDutyInsertDataSet" onsubmit="return false" class="L5form">
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput">
									<select field="sorgDuties" name='"职务"' style="width:90%">
