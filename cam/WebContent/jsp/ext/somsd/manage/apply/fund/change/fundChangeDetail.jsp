...
<head>
	<next:ScriptManager/>
	<script type="text/javascript" src="fundChangeDetail.js"></script>
					...
					<form method="post" onsubmit="return false" class="L5form" dataset="somOrganDataSet">
						<table width="100%">
							<tr>
								...
								<td class="FieldInput" style="width: 10%;"><label type="text"  field="sorgCode"  maxlength="20"/><font color="red">*</font></td>
								<td class="FieldLabel" style="width: 10%;"><label>基金会名称：</label></td>
								<td class="FieldInput" style="width: 10%;"><label type="text"  field="cnName"  maxlength="50"/><font color="red">*</font></td>
							</tr>
							<tr>
								<td class="FieldLabel" style="width: 10%;"><label>法定代表人：</label></td>
								<td class="FieldInput" ><label type="text"  field="legalPeople"  maxlength="32"/><font color="red">*</font></td>
							
								<td class="FieldLabel" style="width: 10%;"><label>申请时间：</label></td>
								<td class="FieldInput" ><label type="text" id="appDate"/><font color="red">*</font></td>
							</tr>
						</table>
					</form>
					</fieldset>
					...
					<form  method="post" dataset="somLegalPeopleDataSet" onsubmit="return false" class="L5form">
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput" colspan="5"><textarea diabled rows="2" name='"所在单位人事部门审查意见"' readonly="readonly" field="workOpinion" style="width:97.7%"></textarea><span style="color:red">*</span></td>
							</tr>
							<tr>
							...
							<tr>
									...
									<td class="FieldInput" colspan="5"><textarea disabled  rows="2" name='"按照本社会团体章程会议产生通过情况"' field="sorgOpinion" style="width:97.7%"></textarea><span style="color:red">*</span></td>
								</tr>
								<tr>	
							...
							<tr>
								...
								<td class="FieldInput" colspan="5"><textarea disabled rows="2" name='"备注"' readonly="readonly" field="note" style="width:97.7%"></textarea></td>
							</tr>
						</table>
					</form>
				</next:Html>
		...
		<next:Tabs>
					...
					<form id="peopleFrom" method="post" dataset="somLegalPeopleDataSet" onsubmit="return false" class="L5form">
						...
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldLabel">出生年月：</td>
								<td class="FieldInput"><input type="text" id="birthday" field="birthday" name='"出生年月"' format="Y-m"  readonly="readonly" style="width:90%"/></td>
							</tr>
							<tr>
								<td class="FieldLabel">政治面貌：</td>
								<td class="FieldInput">
							...
							<tr>
								<td class="FieldLabel">是否党政机关领导干部：</td>
								<td class="FieldInput">
									<select id="ifPartyLeader" field="ifPartyLeader" name='"是否党政机关领导干部"' style="width:90%">
			...
			<next:EditGridPanel id="somResumeGrid" dataset="somResumeInsertDataSet" stripeRows="true" title="本人简历" width="770" height="85%" autoScroll="true">
				...
				<next:Columns>
					...
					<next:Column header="开始年月" field="startDate" width="15%" editable="true" ><next:TextField/></next:Column>
					<next:Column header="结束年月" field="endDate" width="15%" editable="true" ><next:TextField/></next:Column>
