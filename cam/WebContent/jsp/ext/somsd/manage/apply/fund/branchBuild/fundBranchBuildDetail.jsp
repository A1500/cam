...
<script type="text/javascript" src="fundBranchBuildDetail.js"></script>
...
<next:Panel width="100%" height="100%">
	...
	<next:TabPanel id="tab" width="100%" height="100%" activeTab="0">
		<next:Tabs>
			<next:Panel title="申请设立基金会（分支、代表机构）名称核准表" width="100%" height="100%" autoScroll="true">
				<next:Html>
					<form method="post" dataset="somOrganDataSet" onsubmit="return false"class="L5form">
						<table width="100%">
							<tr>
								<td class="FieldLabel"><label>基金会登记证号：</label></td>
								<td class="FieldInput" colspan="5"><label type="text"  id="mainSorgCode" name='"主体登记证号"' field="mainSorgCode" style="width:98%"/><label style="color:red">*</label></td>
							</tr>
							<tr>
								<td class="FieldLabel"><label>基金会名称：</label></td>
								<td class="FieldInput" colspan="5"><label id="mainSorgName"  field="mainSorgName" style="width:98%"/><label style="color:red">*</label></td>
							</tr>
							<tr>
								<td class="FieldLabel"><label>分支/代表机构名称：</label></td>
								<td class="FieldInput" colspan="5"><label type="text" id="cnName" name='"机构名称"' field="cnName" style="width:98%"/><label style="color:red">*</label></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="FieldInput" style="width:17%">
									<label name='"分支/代表机构类型"' field="sorgKind" dataset="sorgKindSelect" style="width:90%">
									</label>
								</td>
							</tr>
							<tr>
								<td class="FieldLabel"><label>业务范围：</label></td>
								<td class="FieldInput" colspan="5"><textarea disabled="disabled" rows="10" name='"业务范围"' field="business" style="width:98%"/></textarea><label style="color:red">*</label></td>
							</tr>
							<tr>
								<td class="FieldLabel"><label>设立理由：</label></td>
								<td class="FieldInput" colspan="5"><textarea rows="5" disabled="disabled" name='"设立理由"' field="appReason" style="width:98%"></textarea><label style="color:red">*</label></td>
							</tr>
							<tr>
								...
								<td class="FieldInput"><label type="text" name='"成立日期"' id="buildDate" field="buildDate" readonly="readonly" style="width:90%"/><span style="color:red">*</span></td>
							</tr>
						...
						<form onsubmit="return false" dataset="somSessionDataSet" class="L5form">
							<table width="100%">
								<tr>
									...
									<td class="FieldInput" style="width:17%"><label type="text" id="tenure" field="tenure" maxlength='2'style="width:90%"/></td>
								</tr>
								<tr>
									<td class="FieldLabel" style="width:17%">本届开始日期：</td>
									<td class="FieldInput" style="width:17%"><label type="text" id="startDate" field="startDate" readonly="readonly" style="width:90%"/></td>
									<td class="FieldLabel" style="width:17%">规定换届日期：</td>
									<td class="FieldInput" style="width:15%"><label type="text" id="endDate" field="endDate" readonly="readonly" style="width:90%"/></td>
...
<next:Window id="peopleWin" title="主要负责人" resizable="false" width="800" height="430" closeAction="hide"  modal="true">
	...
	<next:TabPanel id="tabSomOrgan">
		<next:Tabs>
			<next:Panel id="panel_win" title="基本信息" width="770" height="85%"autoScroll="true">
				<next:Html>
					<form title="负责人信息" id="addForm" method="post" dataset="somDutyInsertDataSet" onsubmit="return false" class="L5form">
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput">
									<label field="sex" name='"性别"' style="width:90%" dataset="sexSelect">
									</label>
								</td>
								<td class="FieldLabel">出生年月：</td>
								<td class="FieldInput"><label type="text" id="birthday" field="birthday" name='"出生年月"' readonly="readonly" style="width:90%"/></td>
							...
							<tr>
								...
								<td class="FieldInput">
									<label field="sorgDuties" name='"职务"' dataset="sorgDutiesSelect" style="width:90%">
									</label><span style="color:red">*</span>
								</td>
								<td class="FieldLabel">任职开始日期：</td>
								<td class="FieldInput"><label type="text" field="startDate" name='"任职开始日期"' readonly="readonly" style="width:90%"/><span style="color:red">*</span></td>
							...
							<tr>
								...
								<td class="FieldInput" colspan="5"><textarea disabled="disabled" rows="2" name='"所在单位人事部门审查意见"' field="workOpinion" style="width:97.7%"></textarea><span style="color:red">*</span></td>
							</tr>
							<tr>
								<td class="FieldLabel">审查工作单位：</td>
								<td class="FieldInput" colspan="3"><label type="text" field="workName" name='"工作单位"' style="width:90%"/></td>
								<td class="FieldLabel">审查日期：</td>
								<td class="FieldInput"><label type="text" field="workCheckDate" readonly="readonly" style="width:90%"/></td>
							</tr>
							<tr>
			...
			<next:EditGridPanel id="somResumeGrid" dataset="somResumeInsertDataSet" width="770" stripeRows="true" height="85%" title="本人简历"autoScroll="true">
				<next:TopBar>
					<next:ToolBarItem symbol="->"></next:ToolBarItem>
				</next:TopBar>
				<next:Columns>
