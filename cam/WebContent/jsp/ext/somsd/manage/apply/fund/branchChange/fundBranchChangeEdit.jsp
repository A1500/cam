...
<head>
	<next:ScriptManager/>
	<script type="text/javascript" src="fundBranchChangeEdit.js"></script>
	...
	<script type="text/javascript">
		<%
			...
			if(method.equals("INSERT")){
				sorgId = SomIdHelpOnline.getFundSorgId(organArea);
				taskCode = SomIdHelpOnline.getFundTaskCode(organArea);
			}else{
				...
				<next:Panel>
					...
					<table width="100%">
						<tr>
							...
							<label type="text" id="mainSorgName" name='基金会名称' field="mainSorgName" style="width:55%"/>
							</td>
							<td class="FieldLabel" style="width: 10%;"><label>基金会主体登记证号：</label></td>
							<td class="FieldInput" style="width: 10%;">
							<label type="text" id="mainSorgCode" name='主体登记证号' field="mainSorgCode" style="width:55%"/>
							</td>
						</tr>
						<tr>
							<td class="FieldLabel" style="width: 10%;"><label>分支/代表机构登记证号：</label></td>
							<td class="FieldInput" style="width: 10%;"><input type="text" id="sorgCode" onkeyup="value=value.replace(/[^\-\\w\.\/]/ig,'').toUpperCase()" field="sorgCode" title="分支/代表机构登记证号"/><font color="red">*</font></td>
