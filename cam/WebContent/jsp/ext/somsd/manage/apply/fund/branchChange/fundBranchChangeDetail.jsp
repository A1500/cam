...
<head>
	<next:ScriptManager/>
	<script type="text/javascript" src="fundBranchChangeDetail.js"></script>
...
<model:datasets>
	...
	<%--分支负责人简历 --%>
	<model:dataset id="somLegalPeopleResumeDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomPeopleResumeQueryCommand" sortField="startDate" sortDirection="DESC" global="true">
		...
		<next:Tabs>
			<next:Panel title="基金会变更登记申请表" width="100%" height="100%"  autoScroll="true">
				<next:Panel>
					...
					<table width="100%">
						<tr>
							<td class="FieldLabel" style="width: 10%;"><label>基金会主体名称：</label></td>
							<td class="FieldInput" style="width: 10%;">
							<label type="text" id="mainSorgName" field="mainSorgName" title="基金会主体名称"/><font color="red">*</font>
							</td>
							<td class="FieldLabel" style="width: 10%;"><label>基金会主体登记证号：</label></td>
							<td class="FieldInput" style="width: 10%;">
							<label type="text" id="mainSorgCode"  field="mainSorgCode"/><font color="red">*</font>
							</td>
						</tr>
						<tr>
							<td class="FieldLabel" style="width: 10%;"><label>分支/代表机构登记证号：</label></td>
							<td class="FieldInput" style="width: 10%;"><label type="text" id="sorgCode"  field="sorgCode" title="分支/代表机构登记证号"/><font color="red">*</font></td>
							<td class="FieldLabel" style="width: 10%;"><label>分支/代表机构名称：</label></td>
							<td class="FieldInput" style="width: 10%;"><label type="text" id="cnName" field="cnName" title="分支/代表机构名称"/><font color="red">*</font></td>
						</tr>
						<tr>
							<td class="FieldLabel" style="width: 10%;"><label>申请时间：</label></td>
							<td class="FieldInput" style="width: 10%;"><label type="text" id="appDate"   title="申请时间"/><font color="red">*</font></td>
...
<table width="100%">
			...
			<tr>
				<td class="FieldLabel" style="width:15%"><label>基金会类别变更前：</label></td>
				<td class="FieldInput"style="width:15%"><select  id="sorgFundKindBefore" ><option  dataset="sorgKindSelect"></option></select></td>
			...
			<tr>
				<td class="FieldLabel" style="width:15%"><label style="color:blue">基金会类别变更为：</label></td>
				<td class="FieldInput"style="width:15%"><select  id="sorgFundKindAfter"><option  dataset="sorgKindSelect"></option></select></td>
			...
			<tr>
				...
				<td class="FieldInput" colspan="5"><textArea id="nameDesc" cols="75" rows="4" style="width: 100%" field="changeDesc"></textArea></td>
			</tr>
			<tr>
...
<table width="100%">
			<tr>
				...
				<td class="FieldInput" style="width:75%"><input id="houseNameBefore" type="text" style="width:98%"/></td>
			</tr>		
			<tr>
...
<table width="100%">
			...
			<tr>
				<td class="FieldLabel" style="width:15%"><label>基金会类别变更前：</label></td>
				<td class="FieldInput"style="width:15%"><select  id="sorgFundKindBefore1" disabled="disabled"><option  dataset="sorgKindSelect"></option></select></td>
				<td class="FieldLabel" style="width:25%"><label>所属行（事）业变更前：</label></td>
			...
			<tr>
				<td class="FieldLabel" style="width:15%"><label style="color:blue">基金会类别变更为：</label></td>
				<td class="FieldInput"style="width:15%"><select  id="sorgFundKindAfter1" disabled="disabled"><option  dataset="sorgKindSelect"></option></select></td>
				<td class="FieldLabel" style="width:15%"><label style="color:blue">所属行（事）业变更为：</label></td>
			...
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更程序：</label></td>
				<td class="FieldInput" colspan="5"><textArea cols="75" rows="4" style="width: 100%" id="namechangeDesc" readonly="readonly"></textArea></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更理由：</label></td>
...
<table width="100%">
			...
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更程序：</label></td>
				<td class="FieldInput" colspan="5"><textArea cols="75" rows="4" style="width: 100%" readonly="readonly" id="peoplechangeDesc"></textArea></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更理由：</label></td>
...
<table width="100%">
			...
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更程序：</label></td>
				<td class="FieldInput"><textArea cols="75" readonly="readonly" rows="4" style="width: 100%;color:blue" id="housechangeDesc"></textArea></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更理由：</label></td>
...
<table width="100%">
			...
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更程序：</label></td>
				<td class="FieldInput" colspan="5"><textArea readonly="readonly" cols="75" rows="4" style="width: 100%" id="areaChangeDesc"></textArea></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label style="color:blue">变更理由：</label></td>
					...
					<form title="负责人信息" id="addForm" method="post" dataset="somLegalPeopleDataSet" onsubmit="return false" class="L5form">
						<table width="100%">
							...
							<tr>
								...
								<td class="FieldInput">
									<label field="politics" name='"政治面貌"'  dataset="politicsSelect" style="width:90%">
									</label>
								</td>
							...
							<tr>
								...
								<td class="FieldInput">
									<label type="text" id="nationDispaly" name="countryNameDispaly"  title="国籍" />
								...
								<td class="FieldInput"><label type="text" field="adds" name='"家庭住址"' style="width:90%"/></td>
							...
							<tr>
								...
								<td class="FieldInput">
									<label field="ifFulltime" name='"专/兼职"' dataset="ifFulltimeSelect" style="width:90%">
									</label>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="FieldInput">
									<label field="sorgDuties" name='"基金会职务"' dataset="sorgDutiesSelect" style="width:90%">
							...
							<tr>
								...
								<td class="FieldInput">
									<label field="ifPartyLeader" id="ifPartyLeader_add" dataset="comm_yesorno" name='"是否党政机关领导干部"' style="width:90%">
									</label><span style="color:red">*</span>
								</td>
							...
							<tr>
								...
								<td class="FieldInput" colspan="5"><textarea rows="2" disabled="disabled" name='"所在单位人事部门审查意见"' field="workOpinion" style="width:97.7%"></textarea></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="FieldInput" colspan="5"><textarea rows="2" disabled="disabled"  name='"备注"' field="note" style="width:97.7%"></textarea></td>
							</tr>
						</table>
					</form>				
				</next:Html>
