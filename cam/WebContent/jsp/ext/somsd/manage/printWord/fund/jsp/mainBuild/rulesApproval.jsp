...
function init(){  
	//取得文件名 和标签    
	var nowFileName = "/jsp/ext/somsd/manage/printWord/fund/doc/rulesApproval.doc";
	...
	var somSessionDataSet=L5.DatasetMgr.lookup("somSessionDataSet");
		...
		showMap.put("jieci",somSessionDataSet.get("sessionName"));
		

	var somRuleDataSet=L5.DatasetMgr.lookup("somRuleDataSet");
		somRuleDataSet.setParameter("SORG_ID@=", sorgId);
		
		somRuleDataSet.load();
		somRuleDataSet.on('load', function(){

		showMap.put("meetingName",somRuleDataSet.get("meetingName"));
		showMap.put("meetingFormat",somRuleDataSet.get("meetingFormat"));
		showMap.put("meetingDate",somRuleDataSet.get("meetingDate"));
		showMap.put("shouldNum",somRuleDataSet.get("shouldNum"));
		showMap.put("realNum",somRuleDataSet.get("realNum"));
		showMap.put("passNum",somRuleDataSet.get("passNum"));
		showMap.put("nopassNum",somRuleDataSet.get("nopassNum"));
		showMap.put("giveupNum",somRuleDataSet.get("giveupNum"));
		showMap.put("mainQuestion",somRuleDataSet.get("mainQuestion"));
