...
function init(){  
	//取得文件名 和标签    
	var nowFileName = "/jsp/ext/somsd/manage/printWord/fund/doc/legalPeople.doc";
	...
	var aspForLiShi=L5.DatasetMgr.lookup("aspForLiShi");
		...
		aspForLiShi.setParameter("SORG_DUTIES", "00012");
		aspForLiShi.load();
		
		aspForLiShi.on('load', function(){
		showMap.put("idCard",aspForLiShi.get("idCard"));
		showMap.put("name",aspForLiShi.get("name"));
		showMap.put("birthday",aspForLiShi.get("birthday"));
		sex=aspForLiShi.get("sex");
		dutyId=aspForLiShi.get("dutyId");
		switch(sex){
			case "1" : sex = "男"; break;
			case "2" : sex = "女"; break;
			default : sex = "";
		...
		showMap.put("sex",sex);		
		politics=aspForLiShi.get("politics");
		switch (politics){
		...
		showMap.put("adds",aspForLiShi.get("adds"));
		showMap.put("populace",aspForLiShi.get("populace"));
		showMap.put("postCode",aspForLiShi.get("postCode"));
		showMap.put("phone",aspForLiShi.get("phone"));
		ifFulltime=aspForLiShi.get("ifFulltime");
		switch(ifFulltime){
		...
		workName=aspForLiShi.get("workName");
		workDuties=workName+aspForLiShi.get("workDuties")
		showMap.put("workDuties",workDuties);
		otherDuties=aspForLiShi.get("otherDuties");
		showMap.put("otherDuties",otherDuties);
		folk=aspForLiShi.get("folk");
