...
function init(){  
	//取得文件名 和标签    
	var nowFileName = "/jsp/ext/somsd/manage/printWord/fund/doc/change.doc";
	...
	var somOrganDataSet=L5.DatasetMgr.lookup("somOrganDataSet");
		...
		for(var i=1;i<=records.length;i++){
			...
			if(record.get("changeDesc")!=null){
			changeDesc = record.get("changeDesc");
			...
			showMap.put("changeItem","变更名称");
				...
				//需要打印负责人信息
				var url=L5.webPath+"/jsp/ext/somsd/manage/printWord/fund/jsp/mainChange/leaderChange.jsp?taskCode="+taskCode+"&sorgId="+sorgId;
				window.open(url);
			}
				...
				showMap.put("changeBefore",changeBefore);
				showMap.put("changeAfter",changeAfter);
				showMap.put("changeItem","变更原始基金数额");
			}
			else if(changeItem==5){
				showMap.put("changeBefore",changeBefore);
				showMap.put("changeAfter",changeAfter);
				showMap.put("changeItem","变更宗旨");
			}
			else if(changeItem==6){
				switch (changeBefore){
				case "1" : changeBefore = "公募"; break;
				case "2" : changeBefore = "非公募"; break;
				default : changeBefore = "";
				}
				switch (changeAfter){
				case "1" : changeAfter = "公募"; break;
				case "2" : changeAfter = "非公募"; break;
				default : changeAfter = "";
				}
			showMap.put("changeBefore",changeBefore);
			showMap.put("changeAfter",changeAfter);
			showMap.put("changeItem","变更类型");
			}
