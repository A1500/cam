...
function init(){  
	//取得文件名 和标签    
	var nowFileName = "/jsp/ext/somsd/manage/printWord/fund/doc/branchBuild.doc";
	...
	var showMap=new L5.Map("java.util.HashMap");
		...
		residence=somOrganDataSet.get("residence")+somOrganDataSet.get("sorgPhone");
		...
		somDutyInsertDataSet.on('load', function(){
			...
			idCard = somDutyInsertDataSet.get("idCard");
