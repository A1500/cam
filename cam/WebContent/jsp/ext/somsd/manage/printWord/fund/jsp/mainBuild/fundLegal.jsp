...
function init(){
	//取得文件名 和标签
	var nowFileName = "/jsp/ext/somsd/manage/printWord/fund/doc/fundLegal.doc";
	...
	var showMap=new L5.Map("java.util.HashMap");
		...
		showMap.put("standCouncilNum",somOrganDataSet.get("standCouncilNum"));
				var  sorgKind=somOrganDataSet.get("sorgKind");
			switch (sorgKind){
						case "1" : sorgKind = "公募"; break;
						case "2" : sorgKind = "非公募"; break;
 						default : sorgKind = "";
						}
		showMap.put("sorgKind",sorgKind);
