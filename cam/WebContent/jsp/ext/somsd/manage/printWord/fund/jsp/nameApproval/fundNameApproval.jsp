...
function init(){  
	//取得文件名 和标签    
	var nowFileName = "/jsp/ext/somsd/manage/printWord/fund/doc/nameApproval.doc";
	...
	var somApplyDataSet=L5.DatasetMgr.lookup("somApplyDataSet");
		...
		showMap.put("currency",somOrganDataSet.get("currency"));
		...
		for(var i=0;i<records.length;i++){
			...
			showMap.put("heldName"+i,name);
			showMap.put("heldPhone"+i,phone);
		 	showMap.put("heldBirthday"+i,birthday);
			showMap.put("heldWorkName"+i,workName);
			showMap.put("heldWorkDuties"+i,workDuties);
			}
		...
		aspChiefDataset.on('load', function(){
			...
			name = aspChiefDataset.get("name");
			sex = aspChiefDataset.get("sex");
			birthday = aspChiefDataset.get("birthday");
			workName = aspChiefDataset.get("workName");
			workDuties = aspChiefDataset.get("workDuties");
			phone = aspChiefDataset.get("phone");
			otherDuties = aspChiefDataset.get("otherDuties");
			
			
			showMap.put("name",name);
		 	showMap.put("sex",sex);
			showMap.put("birthday",birthday);
			showMap.put("workName",workName);
