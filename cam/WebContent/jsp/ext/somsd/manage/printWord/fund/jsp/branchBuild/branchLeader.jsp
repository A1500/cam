...
function init(){  
	//取得文件名 和标签    
	var nowFileName = "/jsp/ext/somsd/manage/printWord/fund/doc/branchLeader.doc";
	...
	var somDutyInsertDataSet=L5.DatasetMgr.lookup("somDutyInsertDataSet");
		...
		showMap.put("otherDuties",somDutyInsertDataSet.get("otherDuties"));
		...
		for(var i=0;i<records.length;i++){
			...
			var date=endDate+"至"+startDate;
			workOrgan = record.get("workOrgan");
			duty = record.get("duty");
			showMap.put("date"+i,date);
