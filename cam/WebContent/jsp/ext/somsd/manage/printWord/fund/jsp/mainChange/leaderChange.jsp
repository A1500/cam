...
function init(){  
	...
	var somLegalPeopleDataSet=L5.DatasetMgr.lookup("somLegalPeopleDataSet");
		...
		showMap.put("idCard",somLegalPeopleDataSet.get("idCard"));
		showMap.put("name",somLegalPeopleDataSet.get("name"));
		showMap.put("birthday",somLegalPeopleDataSet.get("birthday"));
		...
		workName=somLegalPeopleDataSet.get("workName");
		workDuties=workName+somLegalPeopleDataSet.get("workDuties");
		showMap.put("workDuties",workDuties);
		otherDuties=somLegalPeopleDataSet.get("otherDuties");
		showMap.put("otherDuties",otherDuties);
		
		folk=somLegalPeopleDataSet.get("folk");
