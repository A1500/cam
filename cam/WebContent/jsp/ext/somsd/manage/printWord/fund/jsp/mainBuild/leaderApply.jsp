...
function init(){  
	//取得文件名 和标签    
	var nowFileName = "/jsp/ext/somsd/manage/printWord/fund/doc/leaderApply.doc";
		...
		showMap.put("standCouncilNum",somOrganDataSet.get("standCouncilNum"));
			...
			var aspForLiShi=L5.DatasetMgr.lookup("aspForLiShi");
				...
				for(var i=0;i<records.length;i++){
					...
					else if(sorgDuties==00003){  // 副理事长
					showMap.put("fulishizhang",name);
					}
					...
					else if(sorgDuties==00005){  // 理事
					lishi=lishi+" "+name;
					
					}
					else if(sorgDuties==00006){  // 监事
					jianshi=jianshi+" "+name;
					}
				}
				showMap.put("lishi",lishi);
				showMap.put("jianshi",jianshi);
		getMarks();
		writeDoc(showMap);
								});
						});
...
<model:datasets>
	...
	<!-- 负责人录入窗口 -->
	<model:dataset id="peopleInsertDataset" cmd="com.inspur.cams.sorg.base.cmd.SomDutyQueryCmd" global="true"  method="queryPeople" pageSize="100">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomDuty">
			<model:field name="idCard" type="string" rule="length{18}" />
			<model:field name="name" type="string" rule="require|length{72}" />
			<model:field name="aliasName" type="string" rule="length{72}" />
	...
	<!-- 负责人录入窗口 -->
	<model:dataset id="peopleInsertDataset1" cmd="com.inspur.cams.sorg.base.cmd.SomDutyQueryCmd" global="true" pageSize="100">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomDuty">
			<model:field name="idCard" type="string" rule="length{18}" />
			<model:field name="name" type="string" rule="require|length{72}" />
			<model:field name="aliasName" type="string" rule="length{72}" />
	...
	<!-- 负责人录入窗口 -->
	<model:dataset id="peopleInsertDataset2" cmd="com.inspur.cams.sorg.base.cmd.SomDutyQueryCmd" global="true" pageSize="100">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomDuty">
			<model:field name="idCard" type="string" rule="length{18}" />
			<model:field name="name" type="string" rule="require|length{72}" />
			<model:field name="aliasName" type="string" rule="length{72}" />
	...
	<!-- 负责人录入窗口 -->
	<model:dataset id="peopleInsertDataset3" cmd="com.inspur.cams.sorg.base.cmd.SomDutyQueryCmd" global="true" pageSize="100">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomDuty">
			<model:field name="idCard" type="string" rule="length{18}" />
			<model:field name="name" type="string" rule="require|length{72}" />
			<model:field name="aliasName" type="string" rule="length{72}" />
	...
	<!-- 负责人录入窗口 -->
	<model:dataset id="peopleInsertDataset4" cmd="com.inspur.cams.sorg.base.cmd.SomDutyQueryCmd" global="true" pageSize="100">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomDuty">
			<model:field name="idCard" type="string" rule="length{18}" />
			<model:field name="name" type="string" rule="require|length{72}" />
			<model:field name="aliasName" type="string" rule="length{72}" />
	...
	<!-- 负责人录入窗口 -->
	<model:dataset id="peopleInsertDataset5" cmd="com.inspur.cams.sorg.base.cmd.SomDutyQueryCmd" global="true" pageSize="100">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomDuty">
			<model:field name="idCard" type="string" rule="length{18}" />
			<model:field name="name" type="string" rule="require|length{72}" />
			<model:field name="aliasName" type="string" rule="length{72}" />
