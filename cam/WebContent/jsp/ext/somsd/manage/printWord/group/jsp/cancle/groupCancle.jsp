...
function init(){  
	//取得文件名 和标签    
	var nowFileName = "/jsp/ext/somsd/manage/printWord/group/doc/groupCancle.doc";
	...
	var somOrganDataSet=L5.DatasetMgr.lookup("somOrganDataSet");
		...
		showMap.put("reason",somOrganDataSet.get("cancelReasonDesc"));
		showMap.put("liqResult",somOrganDataSet.get("liqResult"));
