...
var nameBefore="";
var sorgGroupKindBefore="";
var sorgBusScopeBefore="";
var nameAfter="";
var sorgGroupKindAfter="";
var sorgBusScopeAfter="";

var houseSourceBefore="";
var houseNameBefore="";
var houseBorgBefore="";
var houseDateBefore="";
var houseAreaBefore="";

var houseSourceAfter="";
var houseNameAfter="";
var houseBorgAfter="";
var houseDateAfter="";
var houseAreaAfter="";
...
function init(){  
	//取得文件名 和标签    
	var nowFileName = "/jsp/ext/somsd/manage/printWord/group/doc/groupChange.doc";
	...
	var somOrganDataSet=L5.DatasetMgr.lookup("somOrganDataSet");
		...
		somChangeList.setParameter("SORG_ID@=", sorgId);
		somChangeList.load();
		
		somChangeList.on('load', function(){
		
		var records=somChangeList.getAllRecords();
		for(var i=0;i<records.length;i++){
			var record =records[i];
			if(record.get("changeItem")!=null){
			changeItem = record.get("changeItem");
			}
			if(record.get("changeBefore")!=null){
			changeBefore = record.get("changeBefore");
			}

			if(record.get("changeAfter")!=null){
			changeAfter = record.get("changeAfter");
			}
			
			if(record.get("changeReason")!=null){
			changeReason = record.get("changeReason");
			}
			// alert("changeItem"+changeItem+"\ni"+i);
			if(changeItem==0){
			
			var a=changeBefore.split(";");
			nameBefore=a[0];
			
			sorgGroupKindBefore=a[1];
			
			switch (sorgGroupKindBefore){
			case "1" : sorgGroupKindBefore = "学术性"; break;
			case "2" : sorgGroupKindBefore = "行业性"; break;
			case "3" : sorgGroupKindBefore = "专业性"; break;
			case "4" : sorgGroupKindBefore = "联合性"; break;
			default : sorgGroupKindBefore = "";
	}
			
			sorgBusScopeBefore=a[2];
			
			switch (sorgBusScopeBefore){
			
			case "01" : sorgBusScopeBefore = "工商"; break;
			case "02" : sorgBusScopeBefore = "农业农村"; break;
			case "03" : sorgBusScopeBefore = "自然科学"; break;
			case "04" : sorgBusScopeBefore = "社会科学"; break;
			case "05" : sorgBusScopeBefore = "教育"; break;
			case "06" : sorgBusScopeBefore = "卫生"; break;
			case "07" : sorgBusScopeBefore = "文化"; break;
			case "08" : sorgBusScopeBefore = "体育"; break;
			case "09" : sorgBusScopeBefore = "生态环境"; break;
			case "10" : sorgBusScopeBefore = "慈善"; break;
			case "11" : sorgBusScopeBefore = "法律"; break;
			case "12" : sorgBusScopeBefore = "宗教"; break;
			case "13" : sorgBusScopeBefore = "职业及从业"; break;
			case "14" : sorgBusScopeBefore = "涉外"; break;
			case "15" : sorgBusScopeBefore = "其他"; break;
			default : sorgBusScopeBefore = "";
	}
			
			
			var b=changeAfter.split(";");
			nameAfter=b[0];
			sorgGroupKindAfter=b[1];
			
			switch (sorgGroupKindAfter){
			case "1" : sorgGroupKindAfter = "学术性"; break;
			case "2" : sorgGroupKindAfter = "行业性"; break;
			case "3" : sorgGroupKindAfter = "专业性"; break;
			case "4" : sorgGroupKindAfter = "联合性"; break;
			default : sorgGroupKindAfter = "";
	}
			
			sorgBusScopeAfter=b[2];
			
			switch (sorgBusScopeAfter){
			
			case "01" : sorgBusScopeAfter = "工商"; break;
			case "02" : sorgBusScopeAfter = "农业农村"; break;
			case "03" : sorgBusScopeAfter = "自然科学"; break;
			case "04" : sorgBusScopeAfter = "社会科学"; break;
			case "05" : sorgBusScopeAfter = "教育"; break;
			case "06" : sorgBusScopeAfter = "卫生"; break;
			case "07" : sorgBusScopeAfter = "文化"; break;
			case "08" : sorgBusScopeAfter = "体育"; break;
			case "09" : sorgBusScopeAfter = "生态环境"; break;
			case "10" : sorgBusScopeAfter = "慈善"; break;
			case "11" : sorgBusScopeAfter = "法律"; break;
			case "12" : sorgBusScopeAfter = "宗教"; break;
			case "13" : sorgBusScopeAfter = "职业及从业"; break;
			case "14" : sorgBusScopeAfter = "涉外"; break;
			case "15" : sorgBusScopeAfter = "其他"; break;
			default : sorgBusScopeAfter = "";
	}
			
			changeAfter=nameAfter+";"+sorgGroupKindAfter+";"+sorgBusScopeAfter;
			showMap.put("changeAfter"+i,changeAfter);
			changeBefore=nameBefore+";"+sorgGroupKindBefore+";"+sorgBusScopeBefore;
			showMap.put("changeBefore"+i,changeBefore);
			showMap.put("changeItem"+i,"变更名称");
			
			}
			else if(changeItem==1){
			var a=changeBefore.split(";");
			houseSourceBefore=a[0];
			switch (houseSourceBefore){
			case "1" : houseSourceBefore = "自有"; break;
			case "2" : houseSourceBefore = "租赁"; break;
			case "3" : houseSourceBefore = "个人或组织无偿提供"; break;
			
			default : houseSourceBefore = "";
	}
			houseNameBefore=a[1];
			houseBorgBefore=a[2];
			houseAreaBefore=a[3];
			...
			var b=changeAfter.split(";");
			houseSourceAfter=b[0];
			switch (houseSourceAfter){
			case "1" : houseSourceAfter = "自有"; break;
			case "2" : houseSourceAfter = "租赁"; break;
			case "3" : houseSourceAfter = "个人或组织无偿提供"; break;
			
			default : houseSourceAfter = "";
	}
			houseNameAfter=b[1];
			houseBorgAfter=b[2];
			houseAreaAfter=b[3];
			houseDateAfter=b[4];
			changeBefore=houseSourceBefore+";"+houseNameBefore+";"+houseBorgBefore+";"+houseAreaBefore+";"+houseDateBefore;
			changeAfter=houseSourceAfter+";"+houseNameAfter+";"+houseBorgAfter+";"+houseAreaAfter+";"+houseDateAfter;
			showMap.put("changeBefore"+i,changeBefore);
			showMap.put("changeAfter"+i,changeAfter);
			showMap.put("changeReason"+i,changeReason)
		 	showMap.put("changeItem"+i,"变更住所");
		 	}
		 	else if(changeItem==2){
		 	//需要打印负责人信息
			var url=L5.webPath+"/jsp/ext/somsd/manage/printWord/group/jsp/legalChange.jsp?taskCode="+taskCode+"&sorgId="+sorgId;
				window.open(url);
		 	showMap.put("changeBefore"+i,changeBefore);
			showMap.put("changeAfter"+i,changeAfter);
			showMap.put("changeReason"+i,changeReason)
			showMap.put("changeItem"+i,"变更法定代表人");
			}
			else if(changeItem==3){
			showMap.put("changeBefore"+i,changeBefore);
			showMap.put("changeAfter"+i,changeAfter);
			showMap.put("changeReason"+i,changeReason)
			showMap.put("changeItem"+i,"变更业务范围");
			}
			else if(changeItem==4){
			showMap.put("changeBefore"+i,changeBefore);
			showMap.put("changeAfter"+i,changeAfter);
			showMap.put("changeReason"+i,changeReason)
			showMap.put("changeItem"+i,"变更注册资金");
			}
			else if(changeItem==5){
				changeItemAs=changeItem;
				changeBeforeAs=changeBefore;
				changeAfterAs=changeAfter;
				changeReasonAs=changeReason;
				j=i;
		...
		var businessOrganSelect=L5.DatasetMgr.lookup("businessOrganSelect");
			businessOrganSelect.setParameter("includeCode", changeBeforeAs);
			businessOrganSelect.load();
			businessOrganSelect.on('load',function(){
				changeBefore=businessOrganSelect.get("text");
				
				
				var businessOrganSelect2=L5.DatasetMgr.lookup("businessOrganSelect2");
				businessOrganSelect2.setParameter("includeCode", changeAfterAs);
				businessOrganSelect2.load();
				businessOrganSelect2.on('load',function(){
				changeAfter=businessOrganSelect2.get("text");
					
					showMap.put("changeBefore"+j,changeBefore);
					showMap.put("changeAfter"+j,changeAfter);
					showMap.put("changeReason"+j,changeReason)
					showMap.put("changeItem"+j,"变更业务主管单位");
