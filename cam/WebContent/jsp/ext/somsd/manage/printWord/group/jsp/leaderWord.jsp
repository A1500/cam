...
function init(){
	//取得文件名 和标签
	var nowFileName = "/jsp/ext/somsd/manage/printWord/group/doc/groupHelder.doc";
	...
	var somDutyInsertDataSet=L5.DatasetMgr.lookup("somDutyInsertDataSet");
		somDutyInsertDataSet.setParameter("DUTY_ID", dutyId);

		somDutyInsertDataSet.load();
		somDutyInsertDataSet.on('load', function(){

		showMap.put("idCard",somDutyInsertDataSet.get("idCard"));

		showMap.put("name",somDutyInsertDataSet.get("name"));
		showMap.put("birthday",somDutyInsertDataSet.get("birthday"));
		showMap.put("aliasName",somDutyInsertDataSet.get("aliasName"));
		sex=somDutyInsertDataSet.get("sex");
		switch(sex){
			case "1" : sex = "男"; break;
			case "2" : sex = "女"; break;
			default : sex = "";
		...
		showMap.put("sex",sex);
		politics=somDutyInsertDataSet.get("politics");
		switch (politics){
		...
		showMap.put("adds",somDutyInsertDataSet.get("adds"));
		showMap.put("populace",somDutyInsertDataSet.get("populace"));
		showMap.put("postCode",somDutyInsertDataSet.get("postCode"));
		showMap.put("phone",somDutyInsertDataSet.get("phone"));
		ifFulltime=somDutyInsertDataSet.get("ifFulltime");
		switch(ifFulltime){
		...
		showMap.put("workName",somDutyInsertDataSet.get("workName"));
		showMap.put("workDuties",somDutyInsertDataSet.get("workDuties"));
		sorgDuties=somDutyInsertDataSet.get("sorgDuties");
		switch (sorgDuties){
		...
		folk=somDutyInsertDataSet.get("folk");
		var folkSelect=L5.DatasetMgr.lookup("folkSelect");
		folkSelect.setParameter("folk", folk);
		folkSelect.load();
		folkSelect.on('load', function(){
		    folk=folkSelect.get("text");
		...
		var records=somResumeInsertDataSet.getAllRecords();
...
<model:datasets>
	...
	<%--人员简历 --%>
	<model:dataset id="somResumeInsertDataSet" cmd="com.inspur.cams.sorg.base.cmd.SomPeopleResumeQueryCommand" sortField="startDate" sortDirection="asc">
		<model:record fromBean="com.inspur.cams.sorg.base.data.SomPeopleResume"></model:record>
	</model:dataset>
	<%--所有符合身份证号的人员列表--%>
