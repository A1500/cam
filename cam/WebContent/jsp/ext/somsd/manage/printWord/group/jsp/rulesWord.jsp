...
function init(){  
	//取得文件名 和标签    
	var nowFileName = "/jsp/ext/somsd/manage/printWord/group/doc/groupRules.doc";
	...
	var somRule=L5.DatasetMgr.lookup("somRule");
		somRule.setParameter("SORG_ID@=", sorgId);
		
		somRule.load();
		somRule.on('load', function(){

		showMap.put("meetingName",somRule.get("meetingName"));
		showMap.put("meetingFormat",somRule.get("meetingFormat"));
		showMap.put("meetingDate",somRule.get("meetingDate"));
		showMap.put("shouldNum",somRule.get("shouldNum"));
		showMap.put("realNum",somRule.get("realNum"));
		showMap.put("passNum",somRule.get("passNum"));
		showMap.put("nopassNum",somRule.get("nopassNum"));
		showMap.put("giveupNum",somRule.get("giveupNum"));
		showMap.put("mainQuestion",somRule.get("mainQuestion"));
