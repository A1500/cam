...
<%
	...
	String borgNameDispaly=request.getParameter("borgNameDispaly");
	String buildStatus=request.getParameter("buildStatus");
%>
<script type="text/javascript">
var cnName=decodeURIComponent('<%=cnName%>');
var purpose=decodeURIComponent('<%=purpose%>');
var business=decodeURIComponent('<%=business%>');
var borgNameDispaly=decodeURIComponent('<%=borgNameDispaly%>');
var buildStatus=decodeURIComponent('<%=buildStatus%>');
...
function init(){  
	...
	showMap.put("borgNameDispaly",borgNameDispaly);
	
	showMap.put("buildStatus",buildStatus);
