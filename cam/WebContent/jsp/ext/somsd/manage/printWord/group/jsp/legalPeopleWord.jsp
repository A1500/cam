...
function init(){
	//取得文件名 和标签
	var nowFileName = "/jsp/ext/somsd/manage/printWord/group/doc/legalPeople.doc";
	...
	var LegalPeopleDataSet=L5.DatasetMgr.lookup("LegalPeopleDataSet");
		...
		LegalPeopleDataSet.setParameter("SORG_DUTIES", "00012");
		LegalPeopleDataSet.load();

	var dutyid;
		LegalPeopleDataSet.on('load', function(){
		dutyid = LegalPeopleDataSet.get("dutyId");
		showMap.put("idCard",LegalPeopleDataSet.get("idCard"));
		showMap.put("name",LegalPeopleDataSet.get("name"));
		showMap.put("birthday",LegalPeopleDataSet.get("birthday"));
		showMap.put("aliasName",LegalPeopleDataSet.get("aliasName"));
		sex=LegalPeopleDataSet.get("sex");
		switch(sex){
			case "1" : sex = "男"; break;
			case "2" : sex = "女"; break;
			default : sex = "";
		...
		showMap.put("sex",sex);
		politics=LegalPeopleDataSet.get("politics");
		switch (politics){
		...
		showMap.put("adds",LegalPeopleDataSet.get("adds"));
		showMap.put("populace",LegalPeopleDataSet.get("populace"));
		showMap.put("postCode",LegalPeopleDataSet.get("postCode"));
		showMap.put("phone",LegalPeopleDataSet.get("phone"));
		ifFulltime=LegalPeopleDataSet.get("ifFulltime");
		switch(ifFulltime){
		...
		showMap.put("workName",LegalPeopleDataSet.get("workName"));
		showMap.put("workDuties",LegalPeopleDataSet.get("workDuties"));
		sorgDuties=LegalPeopleDataSet.get("sorgDuties");
		switch (sorgDuties){
		...
		folk=LegalPeopleDataSet.get("folk");
		...
		for(var i=0;i<records.length;i++){
			...
			if(record.get("dutyId") == dutyid){
				endDate = record.get("endDate");
				startDate = record.get("startDate");
				workOrgan = record.get("workOrgan");
				duty = record.get("duty");
				showMap.put("endDate"+j,endDate);
			 	showMap.put("startDate"+j,startDate);
				showMap.put("workOrgan"+j,workOrgan);
				showMap.put("duty"+j,duty);
				j++;
			}
		}
		getMarks();
