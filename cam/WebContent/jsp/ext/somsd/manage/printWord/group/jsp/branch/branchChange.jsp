...
function init(){  
	//取得文件名 和标签    
	var nowFileName = "/jsp/ext/somsd/manage/printWord/group/doc/branchChange.doc";
	...
	var somOrganDataSet=L5.DatasetMgr.lookup("somOrganDataSet");
		...
		somChangeList.setParameter("ID@=", id);
		somChangeList.load();
		...
		for(var i=1;i<=records.length;i++){
			...
			if(changeItem==0){
				...
				showMap.put("changeAfter",changeAfter);
				showMap.put("changeReason",changeReason);
			 	showMap.put("changeItem","变更住所");
			 	}
			 	else if(changeItem==2){
			 	showMap.put("changeBefore",changeBefore);
				showMap.put("changeAfter",changeAfter);
				showMap.put("changeItem","变更负责人");
				//需要打印负责人信息
				var url=L5.webPath+"/jsp/ext/somsd/manage/printWord/group/jsp/branch/branchLeaderChange.jsp?taskCode="+taskCode+"&sorgId="+sorgId;
				window.open(url);
			}
			else if(changeItem==3){
				showMap.put("changeBefore",changeBefore);
				showMap.put("changeAfter",changeAfter);
				showMap.put("changeItem","变更业务范围");
			
			}
			else if(changeItem==4){
				showMap.put("changeBefore",changeBefore);
				showMap.put("changeAfter",changeAfter);
				showMap.put("changeItem","变更注册资金");
			}
			else if(changeItem==5){
				var businessOrganSelect=L5.DatasetMgr.lookup("businessOrganSelect");
				businessOrganSelect.setParameter("includeCode", changeBefore);
				businessOrganSelect.load();
				changeBefore=businessOrganSelect.get("text");
				showMap.put("changeBefore",changeBefore);
				
				businessOrganSelect.setParameter("includeCode", changeAfter);
				businessOrganSelect.load();
				changeAfter=businessOrganSelect.get("text");
				showMap.put("changeAfter",changeAfter);
				showMap.put("changeItem","变更业务主管单位");
			}
