		...
		<script language="javascript">
			...
			function init(){
				...
				somCheckCouncilDataSet.on("load",function(ds){
					if(ds.getCount()==0){
						somCheckCouncilDataSet.newRecord({"taskCode":taskCode});
					}
				});
				//创建页面导航下拉框
			...
			function save(){
				//将修改后的业务主管单位维护进organ
				somCheckDataSet.set('borgName',document.getElementById("borgName").value);			
				...
				var somCheckCouncilDataSetIsValidate = somCheckCouncilDataSet.isValidate();
				if(somCheckCouncilDataSetIsValidate!=true){
					L5.Msg.alert("提示",somCheckCouncilDataSetIsValidate);
					return "break";
				}
				var retiredSumNum=somCheckCouncilDataSet.get('retiredSumNum');
				var retiredCityNum=somCheckCouncilDataSet.get('realNum');
				var retiredOldNum=somCheckCouncilDataSet.get('realNum');
				if(parseInt(retiredCityNum) > parseInt(retiredSumNum)){
					L5.Msg.alert("提示","离退休人员担任负责人中地厅级及以上人数不能大于总数！");
					return "break";
				}
				if(parseInt(retiredOldNum)>parseInt(retiredSumNum)){
					L5.Msg.alert("提示","离退休人员担任负责人中70岁以上人数不能大于总数！");
					return "break";
				}
...
<model:datasets>
	<model:dataset id="somCheckDataSet" cmd="com.inspur.cams.sorg.check.somcheck.cmd.SomCheckQueryCommand" global="true">
		<model:record fromBean="com.inspur.cams.sorg.check.somcheck.data.SomCheck">
			...
			<model:field name="business" type="string" rule="require" />
			...
			<model:field name="legalPeopleDuty" type="string" rule="require" />
	...
	<model:dataset id="somCheckCouncilDataSet" cmd="com.inspur.cams.sorg.check.checkcouncil.cmd.SomCheckCouncilQueryCommand" global="true">
		<model:record fromBean="com.inspur.cams.sorg.check.checkcouncil.data.SomCheckCouncil"><model:field name="chairmanName" type="string" rule="require" />
			<model:field name="councilNum" type="string" rule="require" />
			<model:field name="secretarygeneralNum" type="string" rule="require" />
			<model:field name="secretarygeneralName" type="string" rule="require" />
			<model:field name="executiveDirectorNum" type="string" rule="require" />
			<model:field name="secretarygeneralType" type="string" rule="require" />
			<model:field name="servantProNum" type="string" rule="require" />
			<model:field name="servantCityNum" type="string" rule="require" />
			<model:field name="servantTownNum" type="string" rule="require" />
			<model:field name="retiredSumNum" type="string" rule="require" />
			<model:field name="retiredCityNum" type="string" rule="require" />
			<model:field name="retiredOldNum" type="string" rule="require" />
		</model:record>
	</model:dataset>
	<!-- 业务主管单位 -->
...
<div id="float" >
	...
	<input type="button" value="上一页" style="height:25px;width:80px;position:absolute;margin-left:20px;" onclick="lastPage('03')"/>
	<input type="button" value="下一页" style="height:25px;width:80px;position:absolute;margin-left:120px;" onclick="nextPage('2')"/>
	<!--[if lte IE 7]><div></div><![endif]-->
...
<tr style='height:27.0pt'>
  ...
  <p align=center style='line-height:28.0pt;'>
  	<span>
		<textarea rows="5" name='业务范围' field="business" style="width:670;"></textarea>
	</span>
  </p>
  </td>
 </tr>
 <tr style='page-break-inside:avoid;height:27.0pt'>
  ...
  <p style='line-height:28.0pt;'>
  	<span>
		<input type="text" name='登记证号' field="sorgCode" style="width:98%" maxlength="20" onkeyup="value=value.replace(/[^\-\w\.\/]/ig,'').toUpperCase()" />
	</span>
  </p>
  </td>
  <td width="21%" colspan=2 style='width:21.46%;border-top:none;border-left:
  ...
  <p align=center style='line-height:28.0pt;'>
  	<span>
		<input type="text" name='组织机构代码' field="organCode" style="width:98%" maxlength="10"/>
	</span>
  </p>
  </td>
 </tr>
 <tr style='page-break-inside:avoid;height:27.0pt'>
  ...
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:27.0pt'>
	  	<input type="text" id="buildDate" name='成立日期' field="buildDate" onClick="WdatePicker()" style="width:98%"/>
  </td>
  <td width="21%" colspan=2 style='width:21.46%;border-top:none;border-left:
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:27.0pt'>
  <p>
  <span><input type="text" style="text-align:right;padding-right:2px;" id="regMon" name='注册资金' field="regMon" maxlength="10" style="width:90%"/>万元</span></p>
  </td>
 </tr>
 <tr style='page-break-inside:avoid;height:27.0pt'>
  <td width="16%" style='width:16.88%;border-top:none;border-left:solid windowtext 1.5pt;
 ...
 <tr style='page-break-inside:avoid;height:27.0pt'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:27.0pt'>
  <p>
  	<input type="text" name='联系电话' field="sorgPhone" style="width:98%" maxlength="30" onkeyup="value=value.replace(/[^\d-]/g,'') "/>
  </p>
  </td>
  <td width="21%" colspan=2 style='width:21.46%;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:27.0pt'>
  <p>
		<input type="text" name='传真' field="sorgFax" style="width:98%" maxlength="30"onkeyup="value=value.replace(/[^\d-]/g,'') "/>
  </p>
  </td>
 </tr>
 <tr style='page-break-inside:avoid;height:27.0pt'>
 ...
 <tr style='page-break-inside:avoid;height:27.0pt'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:27.0pt'>
  <p>
  	<input type="text" name='单位会员数' field="unitsNum" style="width:98%" maxlength="6"onkeyup="value=value.replace(/[^\d]/g,'') "/>
  </p>
  </td>
  <td width="21%" colspan=2 style='width:21.46%;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:27.0pt'>
  <p>
  	<input type="text" name='个人会员数' field="peopleNum" style="width:98%" maxlength="6"onkeyup="value=value.replace(/[^\d]/g,'') "/>
  </p>
  </td>
 </tr>
 <tr style='page-break-inside:avoid;height:27.0pt'>
...
<form method="post" dataset="somCheckCouncilDataSet" onsubmit="return false">
 ...
 <tr style='height:27.0pt;' >
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:27.0pt'>
	  <p>
	  	<input type="text" name='理事人数' field="councilNum" style="width:98%" maxlength="10"onkeyup="value=value.replace(/[^\d]/g,'') "/>
	  </p>
  </td>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:27.0pt'>
  <p>
  		<input type="text" name='秘书长以上负责人人数' field="secretarygeneralNum" style="width:98%" maxlength="10"onkeyup="value=value.replace(/[^\d]/g,'') "/>
  </p>
  </td>
 </tr>
 <tr style='page-break-inside:avoid;height:27.0pt'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:27.0pt'>
  <p>
  		<input type="text" name='常务理事人数' field="executiveDirectorNum" style="width:98%" maxlength="10"onkeyup="value=value.replace(/[^\d]/g,'') "/>
  </p>
  </td>
  <td width="17%" colspan=2 style='width:17.1%;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  <select field='secretarygeneralType'style='width:98%'name='秘书长为'><option dataset='secretarygeneralTypeSelect'/></select>
  </o:p></span></p>
  </td>
 </tr>
 <tr style='page-break-inside:avoid;height:27.0pt'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:27.0pt'>
	  <p style='line-height:28.0pt;'>
		  ...
		  省部级及以上(<input type="text" name='省部级及以上人数' field="servantProNum" style="width:50;text-align:center;" maxlength="10"onkeyup="value=value.replace(/[^\d]/g,'') "/>)人；
		  地厅级(<input type="text" name='地厅级以上人数' field="servantCityNum" style="width:50;text-align:center;" maxlength="10"onkeyup="value=value.replace(/[^\d]/g,'') "/>)人；
		  县处级(<input type="text" name='县处级以上人数' field="servantTownNum" style="width:50;text-align:center;" maxlength="10"onkeyup="value=value.replace(/[^\d]/g,'') "/>)人
		  </span>
	  </p>
  </td>
 </tr>
 <tr style='mso-yfti-lastrow:yes;page-break-inside:avoid;height:27.0pt'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:27.0pt'>
	  <p style='margin-right:-.7pt;line-height:28.0pt;'>
		  <span style='font-size:14.0pt;font-family:宋体'>
		  总数(<input type="text" name='总数'id='retiredSumNum' field="retiredSumNum" style="width:50;text-align:center;" maxlength="10"onkeyup="value=value.replace(/[^\d]/g,'') "/>)人，
		  其中地厅级及以上(<input type="text" name='地厅级以上人数'id='retiredCityNum' field="retiredCityNum" style="width:50;text-align:center;" maxlength="10"onkeyup="value=value.replace(/[^\d]/g,'') "/>)人；
		  70岁以上(<input type="text" name='70岁以上人数'id='retiredOldNum' field="retiredOldNum" style="width:50;text-align:center;" maxlength="10"onkeyup="value=value.replace(/[^\d]/g,'') "/>)人
		  </span>
	  </p>
  </td>
 </tr>
