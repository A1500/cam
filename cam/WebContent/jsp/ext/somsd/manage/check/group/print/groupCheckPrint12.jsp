		...
		if(ds.getCount()==0){
			...
			for(i=1;i<=ds.getCount();i++){
				...
				if(ds.getAt(i-1).get("accounts")!=""){
					...
					document.getElementById("accounts_12"+sequence).innerHTML=accounts;
				}
...
function addTr_12(){
    ...
    newNameTD.style.borderTop="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='height:35px;line-height: 13.0pt; mso-line-height-rule: exactly'><span lang=EN-US><o:p><label class='label12'  name='名称' id='organName_12"+xuhao+"' style='width:98%'  maxlength='100'/></o:p></span></p>";
    //添加列:负责人
    ...
    newNameTD.style.borderTop="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='height:35px;line-height: 13.0pt; mso-line-height-rule: exactly'><span lang=EN-US><o:p><label class='label12'  name='负责人' id='manager_12"+xuhao+"' style='width:98%'  maxlength='72'/></o:p></span></p>";
    //添加列:登记时间
    ...
    newNameTD.style.borderTop="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='height:35px;line-height: 13.0pt; mso-line-height-rule: exactly'><span lang=EN-US><o:p><label class='label12'  name='登记时间' id='regTime_12"+xuhao+"' style='width:98%' /></o:p></span></p>";
    //添加列:登记证号
    ...
    newNameTD.style.borderTop="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='height:35px;line-height: 13.0pt; mso-line-height-rule: exactly'><span lang=EN-US><o:p><label class='label12'  name='登记证号' id='regNumber_12"+xuhao+"' style='width:98%' maxlength='30'/></o:p></span></p>";
 	//添加列:账户
    ...
    newNameTD.style.borderTop="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='line-height: 13.0pt; mso-line-height-rule: exactly'><span lang=EN-US><o:p><label id='accounts_12"+xuhao+"' style='width:98%'/></o:p></span></p>";
	//添加列:住所
    ...
    newNameTD.style.borderTop="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='height:35px;line-height: 13.0pt; mso-line-height-rule: exactly'><span lang=EN-US><o:p><label class='label12'  name='住所' id='address_12"+xuhao+"' style='width:98%'  maxlength='100'/></o:p></span></p>";
...
<model:datasets>
	<model:dataset id="somCheckSuborganDataSet_12" cmd="com.inspur.cams.sorg.check.checksuborgan.cmd.SomCheckSuborganQueryCommand" global="true" pageSize="300" sortField="TO_NUMBER(SEQUENCE)">
...
<p class=MsoNormal align=left width=610px
	...
	style='font-size: 12.0pt; font-family: 宋体'>（四）专项基金管理机构情况<span
...
<p class=MsoNormal align=left width=610px
	...
	style='font-size: 12.0pt; font-family: 宋体'>．本年度新成立专项基金管理机构（<span
	lang=EN-US><span style='mso-spacerun: yes'> <label class='label12' 
	field="specialFundBuildNum" style="width: 20;font-size: 12.0pt; "></label> </span></span>）个，其中已办理成立登记手续的（<span
	lang=EN-US><span style='mso-spacerun: yes'> <label class='label12' 
	field="specialFundBuildedNum" style="width: 20;font-size: 12.0pt; "></label> </span></span>）个；<span
	lang=EN-US><o:p></o:p></span></span></p>

<p class=MsoNormal align=left width=610px
	style='margin-left: 28.0pt; mso-char-indent-count: 2.0; line-height: 25.0pt; mso-line-height-rule: exactly'><span
	lang=EN-US style='font-size: 12.0pt; font-family: 宋体'>2</span><span
	style='font-size: 12.0pt; font-family: 宋体'>．本年度注销专项基金管理机构（<span
	lang=EN-US><span style='mso-spacerun: yes'> <label class='label12' 
	field="specialFundCancelNum" style="width: 20;font-size: 12.0pt; "></label> </span></span>）个，其中已办理注销登记手续的（<span
	lang=EN-US><span style='mso-spacerun: yes'> <label class='label12' 
	field="specialFundCanceledNum" style="width: 20;font-size: 12.0pt; "></label> </span></span>）个；<span
	lang=EN-US><o:p></o:p></span></span></p>
...
<p class=MsoNormal align=left width=610px
	...
	style='font-size: 12.0pt; font-family: 宋体'>．目前本社团专项基金管理机构设置情况如下：<span
	lang=EN-US><o:p></o:p></span></span></p>
