...
function insert() {
	...
	var url='jsp/ext/somsd/manage/check/group/edit/groupCheckEdit01.jsp';
...
function update(){
	...
	var url='jsp/ext/somsd/manage/check/group/edit/groupCheckEdit1.jsp';
	var text = '修改SOM_CHECK_TASK';
	L5.forward(url,text,data);
}
function detailCheck(){
	...
	var url='jsp/ext/somsd/manage/check/group/detail/groupCheckDetail01.jsp';
	var text = '年检明细';
	L5.forward(url,text,data);
}
function printCheck(){
...
function confirmPrint(){
	...
	var url='';
	if(printPart==1){
		url='jsp/ext/somsd/manage/check/group/print/groupCheckPrint01.jsp';
	}else{
		url='jsp/ext/somsd/manage/check/group/print/groupCheckPrint9.jsp';
	}
	var text = '年检明细';
	L5.forward(url,text,data);
}
...
function submit(){
	...
	if(selected[0].get('status')=='0' || selected[0].get('status')=='4'){
		...
		cmd.setParameter("sorgType", "group_");
