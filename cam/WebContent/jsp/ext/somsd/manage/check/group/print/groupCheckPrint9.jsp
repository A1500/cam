		...
		if(ds.getCount()==0){
			...
			for(i=1;i<=ds.getCount();i++){
				...
				if(ds.getAt(i-1).get("accounts")!=""){
					...
					document.getElementById("accounts_9"+sequence).innerHTML=accounts;
				}
...
function addTr_9(){
    ...
    newNameTD.style.borderTop="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='height:30px;line-height: 23.0pt; mso-line-height-rule: exactly'><span lang=EN-US><o:p><label class='label9'  name='名称' id='organName_9"+xuhao+"' style='width:98%'  maxlength='100'/></o:p></span></p>";
    //添加列:负责人
    ...
    newNameTD.style.borderTop="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='line-height: 13.0pt; mso-line-height-rule: exactly'><span lang=EN-US><o:p><label id='accounts_9"+xuhao+"' style='width:98%'/></o:p></span></p>";
	//添加列:住所
...
<body>
<model:datasets>
	<model:dataset id="somCheckSuborganDataSet_9" cmd="com.inspur.cams.sorg.check.checksuborgan.cmd.SomCheckSuborganQueryCommand" global="true" pageSize="300" sortField="TO_NUMBER(SEQUENCE)">
...
<p class=MsoNormal align=center width=610px
...
<p class=MsoNormal align=left width=610px
	...
	style='font-size: 12.0pt; font-family: 宋体'>（一）分支机构情况<span
...
<p class=MsoNormal align=left width=610px
	...
	style='font-size: 12.0pt; font-family: 宋体; letter-spacing: -.5pt'>．本年度新设立分支机构（
	<label class='label9'  field="branchBuildNum" style="width:20;font-size: 12.0pt; "></label>
	）个，其中已办理成立登记手续的（
	<label class='label9'  field="branchBuildedNum" style="width:20;font-size: 12.0pt; "></label>
	）个；<span
	lang=EN-US><o:p></o:p></span></span></p>
...
<p class=MsoNormal align=left width=610px
	...
	style='font-size: 12.0pt; font-family: 宋体; letter-spacing: -.5pt'>．本年度注销分支机构（
	<label class='label9'  field="branchCancelNum" style="width:20;font-size: 12.0pt; "></label>
	）个，其中已办理注销登记手续的（
	<label class='label9'  field="branchCanceledNum" style="width:20;font-size: 12.0pt; "></label>
	）个；<span
	lang=EN-US><o:p></o:p></span></span></p>
...
<p class=MsoNormal align=left width=610px
	...
	style='font-size: 12.0pt; font-family: 宋体; letter-spacing: -.4pt'>．目前本社团分支机构设置情况如下：<span
	lang=EN-US><o:p></o:p></span></span></p>
</form>
...
<next:Window id="winOperDesc" closeAction="hide" title="打印说明" width="800"  autoScroll="true" modal="true">
	<next:TopBar>
