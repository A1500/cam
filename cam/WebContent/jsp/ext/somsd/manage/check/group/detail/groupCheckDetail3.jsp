	...
	<table cellspacing=0 cellpadding=0 width="800">
		...
		<tr style='height: 23.25pt'>
			...
			<p class=MsoNormal
				...
				lang=EN-US><label name='章程规定换届年数' field="generalElectionYears" style="width: 50;text-align:center"></label><span style='mso-spacerun: yes'></span></span>）年一届<span
				lang=EN-US><o:p></o:p></span></span></p>
			</td>
			<td width="65%"
			...
			<p class=MsoNormal
				...
				（<label name='最近一次换届大会时间' field="electionMeetingTime" style="width: 80"></label>）</span></p>
			</td>
		</tr>
		<tr style='height: 23.25pt'>
			<td width="34%" colspan=2
			...
			</span></span><label name='章程规定理事会年数' field="orderCouncilYears" style="width: 50;text-align:center" maxlength="10"></label>）年（<span lang=EN-US><span style='mso-spacerun: yes'>
			</span></span><label type="text" name='章程规定理事会次数' field="orderCouncilTimes" style="width: 50;text-align:center" maxlength="10"></label>）次<span lang=EN-US><o:p></o:p></span></span></p>
			</td>
			<td width="65%"
				style='width: 65.94%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.5pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext 1.5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 23.25pt'>
			<p class=MsoNormal
				...
				lang=EN-US><span style='mso-spacerun: yes'></span></span><label name='开理事会次数' field="councilTimes" style="width: 50;text-align:center" maxlength="10"></label>）次<span
				lang=EN-US><o:p></o:p></span></span></p>
			</td>
		</tr>
		<tr style='height: 23.25pt'>
			...
			<p class=MsoNormal
				...
				lang=EN-US><span style='mso-spacerun: yes'>
			</span></span><label name='章程规定常务理事会年数' field="orderGeneralcouncilYears" style="width: 50;text-align:center" maxlength="10" ></label>）年（<span lang=EN-US><span style='mso-spacerun: yes'>
			</span></span><label name='章程规定常务理事会次数' field="orderGeneralcouncilTimes" style="width: 50;text-align:center" maxlength="10" ></label>）次<span lang=EN-US><o:p></o:p></span></span></p>
			</td>
			<td width="65%"
				style='width: 65.94%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.5pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext 1.5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 23.25pt'>
			<p class=MsoNormal
				...
				lang=EN-US><span style='mso-spacerun: yes'></span></span><label name='召开常务理事会次数' field="generalcouncilTimes" style="width: 50;text-align:center" maxlength="10" ></label>）次<span
				lang=EN-US><o:p></o:p></span></span></p>
			</td>
		</tr>
