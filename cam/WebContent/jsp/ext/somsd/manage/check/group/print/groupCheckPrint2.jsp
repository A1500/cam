	...
	function init2(){
		...
		somCheckWorkerDataSet.on("load",function(ds){
			if(ds.getCount()==0){
				...
				if(ds.get("ifBuildParty")=="1"){
					document.getElementById("ifBuildParty").innerHTML = '是';
				}
				if(ds.get("ifBuildParty")=="0"){
					document.getElementById("ifBuildParty").innerHTML = '否';
				}
		...
		somCheckDuesDataSet.on("load",function(ds){
			if(ds.getCount()==0){
				...
				if(ds.get("regFeeType")=="1"){
					document.getElementById("regFeeType").innerHTML = '财政部门';
				}
				if(ds.get("regFeeType")=="0"){
					document.getElementById("regFeeType").innerHTML = '民政部门';
				}
...
<form method="post" onsubmit="return false">
	<table cellspacing=0 cellpadding=0 width="610px">
		<tr style='page-break-inside: avoid; height: 27.0pt'>
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 25.0pt; mso-line-height-rule: exactly'><span> 
				<label class='label2'  name='工作人员总数' id="totalNum" style="width: 98%" maxlength="10" /></span></p>
			</td>
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 25.0pt; mso-line-height-rule: exactly'><span> 
				<label class='label2'  name='专职工作人员数' id="fullPeopleNum" style="width: 98%" maxlength="10" /></span></p>
			</td>
		</tr>
		<tr style='page-break-inside: avoid; height: 27.0pt'>
			<td width="37%" colspan=3
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 25.0pt; mso-line-height-rule: exactly'><span> 
				<label class='label2'  name='兼职人员数' id="partPeopleNum" style="width: 98%" maxlength="10" /></span></p>
			</td>
			<td width="28%" colspan=5
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 25.0pt; mso-line-height-rule: exactly'><span> 
				<label class='label2'  name='离退休返聘人员数' id="returnmentNum" style="width: 98%" maxlength="10" /></span></p>
			</td>
		</tr>
		<tr style='page-break-inside: avoid; height: 27.0pt'>
			<td width="37%" colspan=3
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 25.0pt; mso-line-height-rule: exactly'><span> 
				<label class='label2'  name='志愿者人数' id="volunterNum" style="width: 98%" maxlength="10" /></span></p>
			</td>
			<td width="28%" colspan=5
			...
			<p class=MsoNormal align=center
				...
				<label class='label2'  name='志愿劳动时间' id="volunterPeriod" style="width: 98%" maxlength="30" /></span></p>
			</td>
		</tr>
		<tr style='page-break-inside: avoid; height: 27.0pt'>
			<td width="37%" colspan=3
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 25.0pt; mso-line-height-rule: exactly'><span> 
				<label class='label2'  name='专职工作人员中党员人数' id="fullPartyNum" style="width: 98%" maxlength="10" /></span></p>
			</td>
			<td width="28%" colspan=5
				style='width: 28.44%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 27.0pt'>
			<p class=MsoNormal align=center
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 25.0pt; mso-line-height-rule: exactly'><span> 
				<label id="ifBuildParty" style="width:90%"/></span>
				</p>
			</td>
		</tr>
<!--机构设置情况-->
		<tr style='page-break-inside: avoid; height: 27.0pt'>
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 27.0pt; mso-line-height-rule: exactly'><span> 
				<label class='label2'  name='分支机构数' id="branchNum" style="width: 98%" maxlength="10" /></span></p>
			</td>
			...
			<p class=MsoNormal
				...
				<label class='label2'  name='代表机构数' id="delegateNum" style="width: 98%" maxlength="10" ></label></span></p>
			</td>
		</tr>
		<tr style='page-break-inside: avoid; height: 27.0pt'>
			<td width="37%" colspan=3
			...
			<p class=MsoNormal align=center
				style='margin-left: -5.35pt; mso-para-margin-left: -.51gd; text-align: center; line-height: 27.0pt; mso-line-height-rule: exactly'><span> 
				<label class='label2'  name='专项基金管理机构数' id="specialFundNum" style="width: 98%" maxlength="10" /></span></p>
			</td>
			...
			<p class=MsoNormal
				style='line-height: 27.0pt; mso-line-height-rule: exactly'><span> 
				<label class='label2'  name='办事机构数' id="workingNum" style="width: 98%" maxlength="10" /></span></p>
			</td>
		</tr>
<!--举办刊物情况-->
		<tr style='page-break-inside: avoid; height: 69.35pt'>
			...
			<p class=MsoNormal align=center
				style='margin-left: -5.35pt; mso-para-margin-left: -.51gd; text-align: center; line-height: 27.0pt; mso-line-height-rule: exactly'><span> 
				<label class='label2'  name='公开发行的刊物数' id="publicationNum" style="width: 98%" maxlength="10" /></span></p>
			</td>
			<td width="18%" colspan=3
			...
			<p class=MsoNormal
				style='line-height: 27.0pt; mso-line-height-rule: exactly'><span> 
				<label class='label2'  name='内部资料性刊物数' id="innerPublicationNum" style="width: 98%" maxlength="10" /></span></p>
			</td>
		</tr>
		<tr style='page-break-inside: avoid; height: 27.0pt'>
			<td width="37%" colspan=3
			...
			<p class=MsoNormal
				style='line-height: 27.0pt; mso-line-height-rule: exactly'><span> 
				<label class='label2'  name='公开发行的刊物名称' id="publicationName" style="width: 98%" maxlength="10" ></label></span></p>
			</td>
		</tr>
<!--会费情况-->
		<tr style='page-break-inside: avoid; height: 20.55pt'>
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 27.0pt; mso-line-height-rule: exactly'><span> 
				<label class='label2'  name='制定会费标准的时间' id="makeFeeDate" style="width: 98%" /></span></p>
			</td>
			<td width="18%" colspan=3
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 27.0pt; mso-line-height-rule: exactly'><span> 
				<label id="regFeeType" style="width:90%"/>
				</span></p>
			</td>
		</tr>
		<tr style='page-break-inside: avoid; height: 23.25pt'>
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 27.0pt; mso-line-height-rule: exactly'><span> 
				<label class='label2'  name='通过会费标准的会议名称' id="meetingName" style="width: 98%" /></span></p>
			</td>
		</tr>
		<tr style='mso-yfti-lastrow: yes; page-break-inside: avoid; height: 84.55pt'>
			<td width="85%" colspan=10 valign=middle
				style=' border-top: none; border-left: none; border-bottom: solid windowtext 1.5pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt; height: 84.55pt'>
			<p class=MsoNormal
			...
			<p class=MsoNormal align=center
				style='text-align: center; line-height: 27.0pt; mso-line-height-rule: exactly'><span> 
				<textarea style='border-left:0px;border-top:0px;border-right:0px;border-bottom:0px ' name='会费标准' id="feeRule" style="width: 98%" rows="25" readonly="readonly"></textarea></span></p>
			</td>
		</tr>
