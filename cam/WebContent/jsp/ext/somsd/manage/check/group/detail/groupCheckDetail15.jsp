...
<div id="float" class="noprint">
	<input type="button" value="上一页" style="height: 25px; width: 80px; position: absolute; margin-left: 20px;" onclick="lastPage1('14');"/>
	<input type="button" value="下一页" style="height: 25px; width: 80px; position: absolute; margin-left: 120px;" onclick="nextPage1('16');"/>
	...
	<table cellspacing=0 cellpadding=0 width="800">
		...
		<tr style='mso-yfti-lastrow: yes; height: 374.2pt'>
			...
			<p class=MsoNormal style='tab-stops: 248.15pt'><span> 
				<textarea name='主要用途和使用情况' field="useDetail" style="width: 738;height: 374.2pt" readonly="readonly"></textarea></span></p>
			</td>
		</tr>
