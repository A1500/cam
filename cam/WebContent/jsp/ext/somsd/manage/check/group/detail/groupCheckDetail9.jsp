...
<p class=MsoNormal align=left width=800px
	...
	<label field="branchBuildNum" style="width:50"></label>
	）个，其中已办理成立登记手续的（
	<label field="branchBuildedNum" style="width:50"></label>
	）个；<span
	lang=EN-US><o:p></o:p></span></span></p>
...
<p class=MsoNormal align=left width=800px
	...
	<label field="branchCancelNum" style="width:50"></label>
	）个，其中已办理注销登记手续的（
	<label field="branchCanceledNum" style="width:50"></label>
	）个；<span
	lang=EN-US><o:p></o:p></span></span></p>
