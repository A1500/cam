...
<p class=MsoNormal align=left style='margin-top: 7.8pt; mso-para-margin-top: .5gd'><b
...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 align=center
	width="100%"
	style='margin-top:15px;width: 100.0%; border-collapse: collapse; border: none; mso-border-alt: solid windowtext 1.5pt; mso-yfti-tbllook: 480; mso-padding-alt: 0cm 5.4pt 0cm 5.4pt; mso-border-insideh: .5pt solid windowtext; mso-border-insidev: .5pt solid windowtext'>
	<tr style='mso-yfti-lastrow: yes; height: 561.35pt'>
		...
		<p class=MsoNormal align=center
			...
			<textarea field="workSummary" name="本年度业务活动总体情况" style="width:610px;height:561.35pt;"  readonly></textarea>
			</o:p></span></b></p>
		</td>
	</tr>
</table>
