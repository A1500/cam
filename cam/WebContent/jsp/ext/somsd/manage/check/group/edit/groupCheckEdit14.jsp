...
<script language="javascript">
	...
	function save(){
		...
		for(i=1;i<19;i++){
			...
			var eventName=document.getElementById("eventName"+i).value;
			var eventType=document.getElementById("eventType"+i).value;
			var eventDate=document.getElementById("eventDate"+i).value;
			var eventPlace=document.getElementById("eventPlace"+i).value;
			var approveOrgan=document.getElementById("approveOrgan"+i).value;
			var chargeStatus=document.getElementById("chargeStatus"+i).value;
			if(eventName==""||eventType==""||eventDate==""||eventPlace==""||approveOrgan==""||chargeStatus==""){
				if(i==1){
					if(eventName!='无'){
						L5.Msg.alert("提示","请至少输入一条本年度举办研讨、展览、培训、评比达标表彰等活动的情况！没有的请填无！");
						return "break";
					}
				}else{
					if(!(eventName==""&&eventType==""&&eventDate==""&&eventPlace==""&&approveOrgan==""&&chargeStatus=="")){
						L5.Msg.alert("提示","请输入完整的本年度举办研讨、展览、培训、评比达标表彰等活动的情况！");
						return "break";
					}			
				}
			}
...
<!--页面按钮-->
<div id="float">
	<input type="button" value="上一页" style="height: 25px; width: 80px; position: absolute; margin-left: 20px;" onclick="lastPage('13');"/>
	<input type="button" value="下一页" style="height: 25px; width: 80px; position: absolute; margin-left: 120px;" onclick="nextPage('15');"/>
	...
	<span style="height:25px;width:80px;position:absolute;margin-left:420px;">当前页数：16</span>
</div>
<div align=center>
	...
	<table cellspacing=0 cellpadding=0 width="800">
		...
		<tr style='mso-yfti-irow: 1; height: 14.8pt'>
			...
			<p class=MsoNormal align=center ><span> 
				<textarea name="活动名称" id="eventName1" style="width: 177px;height: 38px"></textarea></span></p>
			</td>
			<td width="11%"
			...
			<p class=MsoNormal align=center ><span> 
				<select name='类型' id="eventType1" style="width:98%;" />
			...
			<p class=MsoNormal align=center><span> 
				<textarea type="text" name='时间' style="width: 89px;" rows='2' id="eventDate1" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 14.8pt'>
			<p class=MsoNormal align=center><span> 
				<textarea name="地点" id="eventPlace1" style="width: 89px;height: 38px" ></textarea></span></p>
			</td>
			<td width="17%"
			...
			<p class=MsoNormal align=center><span> 
				<textarea name="批准单位" id="approveOrgan1" style="width: 144px;height: 38px" ></textarea></span></p>
			</td>
			<td width="16%"
			...
			<p class=MsoNormal align=center><span> 
				<textarea name="收费情况" id="chargeStatus1" style="width: 135px;height: 38px" ></textarea></span></p>
			</td>
		</tr>
		<tr style='mso-yfti-irow: 2; height: 31.2pt'>
			...
			<p class=MsoNormal align=center><span> 
				<textarea name="活动名称" id="eventName2" style="width: 177px;height: 38px"></textarea></span></p>
			</td>
			<td width="11%"
			...
			<p class=MsoNormal align=center><span> 
				<select name='类型' id="eventType2" style="width:98%;" />
					<option dataset="eventTypeSelect"></option>
				</select></span></p>
			</td>
			<td width="11%"
			...
			<p class=MsoNormal align=center><span> 
				<textarea type="text" name='时间' style="width: 89px;" rows='2' id="eventDate2" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea name="地点" id="eventPlace2" style="width: 89px;height: 38px" ></textarea></span></p>
			</td>
			<td width="17%"
			...
			<p class=MsoNormal align=center><span> 
				<textarea name="批准单位" id="approveOrgan2" style="width: 144px;height: 38px"></textarea></span></p>
			</td>
			<td width="16%"
			...
			<p class=MsoNormal align=center><span> 
				<textarea name="收费情况" id="chargeStatus2" style="width: 135px;height: 38px" ></textarea></span></p>
			</td>
		</tr>
		<tr style='mso-yfti-irow: 3; height: 31.2pt'>
			...
			<td width="21%"
				style='width: 21.6%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea name="活动名称" id="eventName3" style="width: 177px;height: 38px" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.76%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<select name='类型' id="eventType3" style="width:98%;" />
					<option dataset="eventTypeSelect"></option>
				</select></span></p>
			</td>
			<td width="11%"
				style='width: 11.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea type="text" name='时间' style="width: 89px;" rows='2' id="eventDate3" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea name="地点" id="eventPlace3" style="width: 89px;height: 38px"></textarea></span></p>
			</td>
			<td width="17%"
				style='width: 17.66%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea name="批准单位" id="approveOrgan3" style="width: 144px;height: 38px" ></textarea></span></p>
			</td>
			<td width="16%"
				style='width: 16.42%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.5pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext 1.5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea name="收费情况" id="chargeStatus3" style="width: 135px;height: 38px" ></textarea></span></p>
			</td>
		</tr>
		<tr style='mso-yfti-irow: 4; height: 31.2pt'>
			...
			<td width="21%"
				style='width: 21.6%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea name="活动名称" id="eventName4" style="width: 177px;height: 38px" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.76%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<select name='类型' id="eventType4" style="width:98%;" />
					<option dataset="eventTypeSelect"></option>
				</select></span></p>
			</td>
			<td width="11%"
				style='width: 11.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea type="text" name='时间' style="width: 89px;" rows='2' id="eventDate4" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea name="地点" id="eventPlace4" style="width: 89px;height: 38px" ></textarea></span></p>
			</td>
			<td width="17%"
				style='width: 17.66%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea name="批准单位" id="approveOrgan4" style="width: 144px;height: 38px" ></textarea></span></p>
			</td>
			<td width="16%"
				style='width: 16.42%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.5pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext 1.5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea name="收费情况" id="chargeStatus4" style="width: 135px;height: 38px" ></textarea></span></p>
			</td>
		</tr>
		<tr style='mso-yfti-irow: 5; height: 31.2pt'>
			...
			<td width="21%"
				style='width: 21.6%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea name="活动名称" id="eventName5" style="width: 177px;height: 38px" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.76%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<select name='类型' id="eventType5" style="width:98%;" />
					<option dataset="eventTypeSelect"></option>
				</select></span></p>
			</td>
			<td width="11%"
				style='width: 11.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea type="text" name='时间' style="width: 89px;" rows='2' id="eventDate5" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea name="地点" id="eventPlace5" style="width: 89px;height: 38px" ></textarea></span></p>
			</td>
			<td width="17%"
				style='width: 17.66%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea name="批准单位" id="approveOrgan5" style="width: 144px;height: 38px"></textarea></span></p>
			</td>
			<td width="16%"
				style='width: 16.42%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.5pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext 1.5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea name="收费情况" id="chargeStatus5" style="width: 135px;height: 38px"></textarea></span></p>
			</td>
		</tr>
		<tr style='mso-yfti-irow: 6; height: 31.2pt'>
			...
			<td width="21%"
				style='width: 21.6%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea name="活动名称" id="eventName6" style="width: 177px;height: 38px" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.76%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<select name='类型' id="eventType6" style="width:98%;" />
					<option dataset="eventTypeSelect"></option>
				</select></span></p>
			</td>
			<td width="11%"
				style='width: 11.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea type="text" name='时间' style="width: 89px;" rows='2' id="eventDate6" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea name="地点" id="eventPlace6" style="width: 89px;height: 38px" ></textarea></span></p>
			</td>
			<td width="17%"
				style='width: 17.66%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea name="批准单位" id="approveOrgan6" style="width: 144px;height: 38px" ></textarea></span></p>
			</td>
			<td width="16%"
				style='width: 16.42%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.5pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext 1.5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea name="收费情况" id="chargeStatus6" style="width: 135px;height: 38px"></textarea></span></p>
			</td>
		</tr>
		<tr style='mso-yfti-irow: 7; height: 31.2pt'>
			...
			<td width="21%"
				style='width: 21.6%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea name="活动名称" id="eventName7" style="width: 177px;height: 38px" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.76%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<select name='类型' id="eventType7" style="width:98%;" />
					<option dataset="eventTypeSelect"></option>
				</select></span></p>
			</td>
			<td width="11%"
				style='width: 11.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea type="text" name='时间' style="width: 89px;" rows='2' id="eventDate7" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea name="地点" id="eventPlace7" style="width: 89px;height: 38px" ></textarea></span></p>
			</td>
			<td width="17%"
				style='width: 17.66%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea name="批准单位" id="approveOrgan7" style="width: 144px;height: 38px" ></textarea></span></p>
			</td>
			<td width="16%"
				style='width: 16.42%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.5pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext 1.5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea name="收费情况" id="chargeStatus7" style="width: 135px;height: 38px" ></textarea></span></p>
			</td>
		</tr>
		<tr style='mso-yfti-irow: 8; height: 31.2pt'>
			...
			<td width="21%"
				style='width: 21.6%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea name="活动名称" id="eventName8" style="width: 177px;height: 38px" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.76%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<select name='类型' id="eventType8" style="width:98%;" />
					<option dataset="eventTypeSelect"></option>
				</select></span></p>
			</td>
			<td width="11%"
				style='width: 11.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center><span> 
				<textarea type="text" name='时间' style="width: 89px;" rows='2' id="eventDate8" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="地点" id="eventPlace8" style="width: 89px;height: 38px" ></textarea></span></p>
			</td>
			<td width="17%"
				style='width: 17.66%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="批准单位" id="approveOrgan8" style="width: 144px;height: 38px" ></textarea></span></p>
			</td>
			<td width="16%"
				style='width: 16.42%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.5pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext 1.5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="收费情况" id="chargeStatus8" style="width: 135px;height: 38px" ></textarea></span></p>
			</td>
		</tr>
		<tr style='mso-yfti-irow: 9; height: 31.2pt'>
			...
			<p class=MsoNormal align=center
				><span> 
				<textarea name="活动名称" id="eventName9" style="width: 177px;height: 38px" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.76%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<select name='类型' id="eventType9" style="width:98%;" />
					<option dataset="eventTypeSelect"></option>
				</select></span></p>
			</td>
			<td width="11%"
			...
			<p class=MsoNormal align=center
				><span> 
				<textarea type="text" name='时间' style="width: 89px;" rows='2' id="eventDate9" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="地点" id="eventPlace9" style="width: 89px;height: 38px" ></textarea></span></p>
			</td>
			<td width="17%"
				style='width: 17.66%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="批准单位" id="approveOrgan9" style="width: 144px;height: 38px" ></textarea></span></p>
			</td>
			<td width="16%"
				style='width: 16.42%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.5pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext 1.5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="收费情况" id="chargeStatus9" style="width: 135px;height: 38px" ></textarea></span></p>
			</td>
		</tr>
		<tr style='mso-yfti-irow: 10; height: 31.2pt'>
			...
			<p class=MsoNormal align=center
				><span> 
				<textarea name="活动名称" id="eventName10" style="width: 177px;height: 38px" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.76%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<select name='类型' id="eventType10" style="width:98%;" />
					<option dataset="eventTypeSelect"></option>
				</select></span></p>
			</td>
			<td width="11%"
			...
			<p class=MsoNormal align=center
				><span> 
				<textarea type="text" name='时间' style="width: 89px;" rows='2' id="eventDate10" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="地点" id="eventPlace10" style="width: 89px;height: 38px" ></textarea></span></p>
			</td>
			<td width="17%"
				style='width: 17.66%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="批准单位" id="approveOrgan10" style="width: 144px;height: 38px" ></textarea></span></p>
			</td>
			<td width="16%"
				style='width: 16.42%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.5pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext 1.5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="收费情况" id="chargeStatus10" style="width: 135px;height: 38px" ></textarea></span></p>
			</td>
		</tr>
		<tr style='mso-yfti-irow: 11; height: 31.2pt'>
			...
			<p class=MsoNormal align=center
				><span> 
				<textarea name="活动名称" id="eventName11" style="width: 177px;height: 38px" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.76%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><b
				style='mso-bidi-font-weight: normal'><span> 
				<select name='类型' id="eventType11" style="width:98%;" />
					<option dataset="eventTypeSelect"></option>
				</select></span></p>
			</td>
			<td width="11%"
			...
			<p class=MsoNormal align=center
				><span> 
				<textarea type="text" name='时间' style="width: 89px;" rows='2' id="eventDate11" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="地点" id="eventPlace11" style="width: 89px;height: 38px" ></textarea></span></p>
			</td>
			<td width="17%"
				style='width: 17.66%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="批准单位" id="approveOrgan11" style="width: 144px;height: 38px" ></textarea></span></p>
			</td>
			<td width="16%"
				style='width: 16.42%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.5pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext 1.5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="收费情况" id="chargeStatus11" style="width: 135px;height: 38px" ></textarea></span></p>
			</td>
		</tr>
		<tr style='mso-yfti-irow: 12; height: 31.2pt'>
			...
			<p class=MsoNormal align=center
				><span> 
				<textarea name="活动名称" id="eventName12" style="width: 177px;height: 38px" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.76%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<select name='类型' id="eventType12" style="width:98%;" />
					<option dataset="eventTypeSelect"></option>
				</select></span></p>
			</td>
			<td width="11%"
			...
			<p class=MsoNormal align=center
				><span> 
				<textarea type="text" name='时间' style="width: 89px;" rows='2' id="eventDate12" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="地点" id="eventPlace12" style="width: 89px;height: 38px" ></textarea></span></p>
			</td>
			<td width="17%"
				style='width: 17.66%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="批准单位" id="approveOrgan12" style="width: 144px;height: 38px" ></textarea></span></p>
			</td>
			<td width="16%"
				style='width: 16.42%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.5pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext 1.5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="收费情况" id="chargeStatus12" style="width: 135px;height: 38px" ></textarea></span></p>
			</td>
		</tr>
		<tr style='mso-yfti-irow: 13; height: 31.2pt'>
			...
			<p class=MsoNormal align=center
				><span> 
				<textarea name="活动名称" id="eventName13" style="width: 177px;height: 38px" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.76%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<select name='类型' id="eventType13" style="width:98%;" />
					<option dataset="eventTypeSelect"></option>
				</select></span></p>
			</td>
			<td width="11%"
			...
			<p class=MsoNormal align=center
				><span> 
				<textarea type="text" name='时间' style="width: 89px;" rows='2' id="eventDate13" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="地点" id="eventPlace13" style="width: 89px;height: 38px" ></textarea></span></p>
			</td>
			<td width="17%"
				style='width: 17.66%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="批准单位" id="approveOrgan13" style="width: 144px;height: 38px" ></textarea></span></p>
			</td>
			<td width="16%"
				style='width: 16.42%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.5pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext 1.5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="收费情况" id="chargeStatus13" style="width: 135px;height: 38px" ></textarea></span></p>
			</td>
		</tr>
		<tr style='mso-yfti-irow: 14; height: 31.2pt'>
			...
			<p class=MsoNormal align=center
				><span> 
				<textarea name="活动名称" id="eventName14" style="width: 177px;height: 38px" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.76%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<select name='类型' id="eventType14" style="width:98%;" />
					<option dataset="eventTypeSelect"></option>
				</select></span></p>
			</td>
			<td width="11%"
			...
			<p class=MsoNormal align=center
				><span> 
				<textarea type="text" name='时间' style="width: 89px;" rows='2' id="eventDate14" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="地点" id="eventPlace14" style="width: 89px;height: 38px" ></textarea></span></p>
			</td>
			<td width="17%"
				style='width: 17.66%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="批准单位" id="approveOrgan14" style="width: 144px;height: 38px" ></textarea></span></p>
			</td>
			<td width="16%"
				style='width: 16.42%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.5pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext 1.5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="收费情况" id="chargeStatus14" style="width: 135px;height: 38px" ></textarea></span></p>
			</td>
		</tr>
		<tr style='mso-yfti-irow: 15; height: 31.2pt'>
			...
			<p class=MsoNormal align=center
				><span> 
				<textarea name="活动名称" id="eventName15" style="width: 177px;height: 38px" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.76%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<select name='类型' id="eventType15" style="width:98%;" />
					<option dataset="eventTypeSelect"></option>
				</select></span></p>
			</td>
			<td width="11%"
			...
			<p class=MsoNormal align=center
				><span> 
				<textarea type="text" name='时间' style="width: 89px;" rows='2' id="eventDate15" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="地点" id="eventPlace15" style="width: 89px;height: 38px" ></textarea></span></p>
			</td>
			<td width="17%"
				style='width: 17.66%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="批准单位" id="approveOrgan15" style="width: 144px;height: 38px" ></textarea></span></p>
			</td>
			<td width="16%"
				style='width: 16.42%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.5pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext 1.5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="收费情况" id="chargeStatus15" style="width: 135px;height: 38px" ></textarea></span></p>
			</td>
		</tr>
		<tr style='mso-yfti-irow: 16; height: 31.2pt'>
			...
			<p class=MsoNormal align=center
				><span> 
				<textarea name="活动名称" id="eventName16" style="width: 177px;height: 38px" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.76%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<select name='类型' id="eventType16" style="width:98%;" />
					<option dataset="eventTypeSelect"></option>
				</select></span></p>
			</td>
			<td width="11%"
			...
			<p class=MsoNormal align=center
				><span> 
				<textarea type="text" name='时间' style="width: 89px;" rows='2' id="eventDate16" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="地点" id="eventPlace16" style="width: 89px;height: 38px" ></textarea></span></p>
			</td>
			<td width="17%"
				style='width: 17.66%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="批准单位" id="approveOrgan16" style="width: 144px;height: 38px" ></textarea></span></p>
			</td>
			<td width="16%"
				style='width: 16.42%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.5pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext 1.5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="收费情况" id="chargeStatus16" style="width: 135px;height: 38px" ></textarea></span></p>
			</td>
		</tr>
		<tr style='mso-yfti-irow: 17; height: 31.2pt'>
			...
			<p class=MsoNormal align=center
				><span> 
				<textarea name="活动名称" id="eventName17" style="width: 177px;height: 38px" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.76%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<select name='类型' id="eventType17" style="width:98%;" />
					<option dataset="eventTypeSelect"></option>
				</select></span></p>
			</td>
			<td width="11%"
			...
			<p class=MsoNormal align=center
				><span> 
				<textarea type="text" name='时间' style="width: 89px;" rows='2' id="eventDate17" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="地点" id="eventPlace17" style="width: 89px;height: 38px" ></textarea></span></p>
			</td>
			<td width="17%"
				style='width: 17.66%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="批准单位" id="approveOrgan17" style="width: 144px;height: 38px" ></textarea></span></p>
			</td>
			<td width="16%"
				style='width: 16.42%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.5pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-right-alt: solid windowtext 1.5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="收费情况" id="chargeStatus17" style="width: 135px;height: 38px" ></textarea></span></p>
			</td>
		</tr>
		<tr style='mso-yfti-irow: 18; mso-yfti-lastrow: yes; height: 31.2pt'>
			...
			<p class=MsoNormal align=center
				><span> 
				<textarea name="活动名称" id="eventName18" style="width: 177px;height: 38px" ></textarea></span></p>
			</td>
			<td width="11%"
			...
			<p class=MsoNormal align=center
				><span> 
				<select name='类型' id="eventType18" style="width:98%;" />
					<option dataset="eventTypeSelect"></option>
				</select></span></p>
			</td>
			<td width="11%"
			...
			<p class=MsoNormal align=center
				><span> 
				<textarea type="text" name='时间' style="width: 89px;" rows='2' id="eventDate18" ></textarea></span></p>
			</td>
			<td width="11%"
				style='width: 11.78%; border-top: none; border-left: none; border-bottom: solid windowtext 1.5pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; mso-border-bottom-alt: solid windowtext 1.5pt; padding: 0cm 0pt 0cm 0pt; height: 31.2pt'>
			<p class=MsoNormal align=center
				><span> 
				<textarea name="地点" id="eventPlace18" style="width: 89px;height: 38px" ></textarea></span></p>
			</td>
			<td width="17%"
			...
			<p class=MsoNormal align=center
				><span> 
				<textarea name="批准单位" id="approveOrgan18" style="width: 144px;height: 38px" ></textarea></span></p>
			</td>
			<td width="16%"
			...
			<p class=MsoNormal align=center
				><span> 
				<textarea name="收费情况" id="chargeStatus18" style="width: 135px;height: 38px" ></textarea></span></p>
			</td>
		</tr>
	</table>
</form>
