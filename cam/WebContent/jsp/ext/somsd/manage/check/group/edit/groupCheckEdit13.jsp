...
<div id="float"><!--[if lte IE 7]><div></div><![endif]--> <input
	...
	style="height: 25px; width: 80px; position: absolute; margin-left: 20px;" onclick="lastPage('12')"/>
	<input
	type="button" value="下一页"
	style="height: 25px; width: 80px; position: absolute; margin-left: 120px;" onclick="nextPage('14')"/>
<!--[if lte IE 7]><div></div><![endif]--> <input type="button"
	...
	<span style="height:25px;width:80px;position:absolute;margin-left:420px;">当前页数：15</span>
</div>
<div align=center>
...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 align=center
	...
	<tr style='mso-yfti-lastrow: yes; height: 561.35pt'>
		...
		<p class=MsoNormal align=center
			...
			<textarea field="workSummary" name="本年度业务活动总体情况" style="width:800;height:561.35pt" ></textarea>
			</o:p></span></b></p>
		</td>
	</tr>
</table>
