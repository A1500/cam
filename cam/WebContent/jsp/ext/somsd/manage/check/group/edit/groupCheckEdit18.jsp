...
<div id="float">
<!--[if lte IE 7]><div></div><![endif]--><input type="button" value="上一页"
	style="height: 25px; width: 80px; position: absolute; margin-left: 20px;"
	onclick="lastPage('17');" /><input type="button" value="下一页"
	style="height: 25px; width: 80px; position: absolute; margin-left: 120px;"
	onclick="nextPage('19');" /> <input type="button" value="保存"
	...
	<span style="height:25px;width:80px;position:absolute;margin-left:420px;">当前页数：20</span>
</div>
<div align=center>
...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0
	...
	<tr style='mso-yfti-lastrow: yes; height: 601.0pt'>
		...
		<p class=MsoNormal align=center
			...
			<textarea field="otherDesc" name="其它需要说明的情况" style="width:800;height:601pt;" rows="50"></textarea>
			</o:p></span></p>
		</td>
	</tr>
</table>
