...
function init(){
	...
	somCheckCashFlowDataSet.on("load",function(ds){
		if(ds.getCount()==0){
			ds.newRecord({"TASK_CODE":taskCode});
		}
...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width="700"
 style='width:700;border-collapse:collapse;border:none;mso-border-alt:solid windowtext 1.5pt;
...
name='"收取会费收到的现金"' style="width:98%"  maxlength="15" style='text-align:right' />
 ...
 <tr style='mso-yfti-irow:16;height:15.0pt'>
  ...
  text-autospace:none'><span lang=EN-US style='font-size:10.5pt;font-family:
  楷体_GB2312;mso-hansi-font-family:宋体;color:black'><o:p>
  <input  onblur='checkFloat(this);'onchange="value=value.replace(/[^\d.-]/g,'');countIaInflowSum();"id="iaInflowSum4" field="iaRegoupingOutlay" 
 ...
 <tr style='mso-yfti-irow:17;height:15.0pt'>
  ...
  text-autospace:none'><span lang=EN-US style='font-size:10.5pt;font-family:
  楷体_GB2312;mso-hansi-font-family:宋体;color:black'><o:p>
  <input  onblur='checkFloat(this);'onchange="value=value.replace(/[^\d.-]/g,'');countIaInflowSum();"id="iaInflowSum3" field="iaMadeIncome" 
 ...
 <tr style='mso-yfti-irow:18;height:15.0pt'>
  ...
  text-autospace:none'><span lang=EN-US style='font-size:10.5pt;font-family:
  楷体_GB2312;mso-hansi-font-family:宋体;color:black'><o:p>
  <input  onblur='checkFloat(this);'onchange="value=value.replace(/[^\d.-]/g,'');countIaInflowSum();"id="iaInflowSum2" field="iaInflowAssets" 
 ...
 <tr style='mso-yfti-irow:19;height:15.0pt'>
  ...
  text-autospace:none'><span lang=EN-US style='font-size:10.5pt;font-family:
  楷体_GB2312;mso-hansi-font-family:宋体;color:black'><o:p>
  <input  onblur='checkFloat(this);'onchange="value=value.replace(/[^\d.-]/g,'');countIaInflowSum();"id="iaInflowSum1" field="iaInflowOthers" 
