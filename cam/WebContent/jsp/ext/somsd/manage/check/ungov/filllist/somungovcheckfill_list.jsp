...
<script type="text/javascript">
	...
	<head>
		...
		<script type="text/javascript" src="somungovcheckfill_list.js"></script>
	</head>
<body>
<model:datasets>
...
<next:GridPanel id="editGridPanel" name="somcheckGrid" width="100%" stripeRows="true" height="300" dataset="ds" title="民办非企业单位年检列表" notSelectFirstRow="true">
	<next:TopBar>
...
<next:Panel  name="desc" width="100%" border="0" bodyStyle="padding-bottom:10px;padding-top:2px;" autoHeight="true" >
	<next:Html>
	<div>
