...
<div id="float" >
	<input type="button" value="上一页" style="height:25px;width:80px;position:absolute;margin-left:20px;" onclick="nextPageM('5')"/>
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width="700"
 style='width:700;border-collapse:collapse;mso-yfti-tbllook:191;mso-padding-alt:
 ...
 <tr style='mso-yfti-irow:2;height:17.25pt'>
  ...
  <input field="caMoneyfundsS" id="货币资金" name='"货币资金"' style="width: 98%; "
				maxlength="15" style='text-align:right' onblur='checkFloat(this);'onchange="value=value.replace(/[^\d.-]/g,'');setSumMoney() " 
       />
  </o:p></span></p>
  </td>
  <td width="11%" valign=top style='width:11.58%;border-top:none;border-left:
 ...
 <tr style='mso-yfti-irow:19;height:17.25pt'>
  ...
  <input field="faAccumulatedDepreciationE" id="_减：累计折旧" name='"_减：累计折旧"' style="width: 98%; "
				maxmaxlength="15" style='text-align:right' onblur='checkFloat(this);'onchange="value=value.replace(/[^\d.-]/g,'');setSumMoney() " />
  </o:p></span></p>
  </td>
  <td width="27%" valign=top style='width:27.42%;border-top:none;border-left:
  none;border-bottom:solid black 1.0pt;border-right:solid black 1.0pt;
