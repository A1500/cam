...
<div id="float" class="noprint">
	<input type="button" value="下一页" style="height: 25px; width: 80px; position: absolute; margin-left: 120px;" onclick="nextPageJ1('8')" />
	<input type="button" value="上一页" style="height: 25px; width: 80px; position: absolute; margin-left: 20px;" onclick="nextPageJ1('6')" />
		...
		<TABLE class=f16ps-size1 cellSpacing=0 cellPadding=0 width='100%'
				...
				<TBODY>
					<TR>
						...
						<TD class=font12size2 width='11%' rowSpan=2><label field='branchNum'
						...
						<TD class=font12size2 width='13%'><label field='branchBuildNum'
							name='新设分支数' value=''
						...
						<TD class=font12size3 width='17%'><label field='branchBuildedNum'
							name='办理新设分支数'
					...
					<TR>
						...
						<TD class=font12size2 width='13%'><label field='branchCancelNum'
							name='注销分支数' value=''
						...
						<TD class=font12size3 width='17%'><label field='branchCanceledNum'
							name='办理注销分支数'
					...
					<TR>
						...
						<TD class=font12size2 rowSpan=2><label field='delegateNum'
						...
						<TD class=font12size2><label field='delegateBuildNum'
							name='新设代表数' value=''
						...
						<TD class=font12size3><label field='delegateBuildedNum'
							name='办理新设代表数'
					...
					<TR>
						<TD class=font12size2>本年度注销</TD>
						<TD class=font12size2><label field='delegateCancelNum'
							name='注销代表数' value=''
						...
						<TD class=font12size3><label field='delegateCanceledNum'
							name='办理注销代表数'
					...
					<TR>
						...
						<TD class=font12size2 rowSpan=2><label field='specialFundNum'
							name='专项基金总数' value='' ID='基金数' onKeyUp="value=value.replace(/[^\d]/g,'');"
							 STYLE='text-align:right;padding-right:2px;' SIZE='6' maxlength="6"
							
							> </label> 个</TD>
						<TD class=font12size2 width='15%'>本年度新设</TD>
						<TD class=font12size2><label field='specialFundBuildNum'
							name='新设基金数' value=''
					...
					<TR>
						<TD class=font12size2>本年度注销</TD>
						<TD class=font12size2><label field='workingCancelNum'
							name='注销办事数' value=''
							ID='注销办事数'  STYLE='text-align:right;padding-right:2px;' SIZE='6' maxlength="6" onKeyUp="value=value.replace(/[^\d]/g,'');"
							> </label> 个</TD>
						<TD class=font12size2 height=40>其中已办理注销手续的</TD>
						<TD class=font12size3><label field='workingCanceledNum'
							name='办理注销办事数'
					...
					<TR>
						...
						<TD rowspan='2' class=font12size4><label field='entityNum'
							name='实体机构总数' value='' ID='实体数' onKeyUp="value=value.replace(/[^\d]/g,'');"
							 STYLE='text-align:right;padding-right:2px;' SIZE='6' maxlength="6" >
						</label> 个</TD>
						<TD class=font12size2>本年度新设立</TD>
						<TD class=font12size2><label field='entityBuildNum'
							name='新设实体数' value=''
						...
						<TD class=font12size3><label field='entityBuildedNum'
							name='办理新设实体数'
					...
					<TR>
						...
						<TD class=font12size4><label field='entityCancelNum'
							name='注销实体数' value=''
						...
						<TD class=font12s><label field='entityCanceledNum'
							name='办理注销实体数'
