	...
	somJxCheckInterProjectDataSet.on("load",function(ds){
		if(ds.getCount()==0){
			...
			for(i=0;i<ds.getCount();i++){
				...
				tab.rows[i+2].cells[4].getElementsByTagName("input")[0].value=record.get("onProjectFund");
				tab.rows[i+2].cells[5].getElementsByTagName("input")[0].value=record.get("offProjectFund");
	...
	somCheckInterOrgDataSet.on('load',function(ds){
		...
		if(count == 0){
			...
			for(i=0;i<ds.getCount();i++){
				...
				tab.rows[i+1].cells[3].getElementsByTagName("input")[0].value=record.get("joinDate");
...
function getSomJxCheckInterProjectDataSet(){
	...
	for(i=2;i<=6;i++){
		...
		record.set("onProjectFund",tab.rows[i].cells[4].getElementsByTagName("input")[0].value);
		record.set("offProjectFund",tab.rows[i].cells[5].getElementsByTagName("input")[0].value);
		...
		var projectName=tab.rows[i].cells[1].getElementsByTagName("textarea")[0].value;
		var coopOrganName=tab.rows[i].cells[2].getElementsByTagName("textarea")[0].value;
		var coopOrganNation=tab.rows[i].cells[3].getElementsByTagName("textarea")[0].value;
		var onProjectFund=tab.rows[i].cells[4].getElementsByTagName("input")[0].value;
		var offProjectFund=tab.rows[i].cells[5].getElementsByTagName("input")[0].value;
		var projectType=tab.rows[i].cells[6].getElementsByTagName("textarea")[0].value;
		var projectDesc=tab.rows[i].cells[7].getElementsByTagName("textarea")[0].value;
		if(projectName==""||coopOrganName==""||coopOrganNation==""||onProjectFund==""||offProjectFund==""||projectType==""||projectDesc==""){
			if(i==2){
				L5.Msg.alert("提示","请至少输入一条涉外合作项目信息！没有的请填无！");
				return "break";
			}else{
				if(!(projectName==""&&coopOrganName==""&&coopOrganNation==""&&onProjectFund==""&&offProjectFund==""&&projectType==""&&projectDesc=="")){
					L5.Msg.alert("提示","请输入完整的涉外合作项目信息！");
					return "break";
				}			
			}
		}
...
function getSomCheckInterMeetingDataSet(){
	...
	for(i=1;i<=5;i++){
		...
		var meetingName=tab.rows[i].cells[1].getElementsByTagName("textarea")[0].value;
		var meetingDate=tab.rows[i].cells[2].getElementsByTagName("textarea")[0].value;
		var meetingPlace=tab.rows[i].cells[3].getElementsByTagName("textarea")[0].value;
		var hostOrganName=tab.rows[i].cells[4].getElementsByTagName("textarea")[0].value;
		var fundsSource=tab.rows[i].cells[5].getElementsByTagName("textarea")[0].value;
		if(meetingName==""||meetingDate==""||meetingPlace==""||hostOrganName==""||fundsSource==""){
			if(i==1){
...
function getSomCheckInterOrgDataSet(){
	...
	for(i=1;i<=5;i++){
		...
		var orgCnName=tab.rows[i].cells[1].getElementsByTagName("textarea")[0].value;
		var orgEnName=tab.rows[i].cells[2].getElementsByTagName("textarea")[0].value;
		var joinDate=tab.rows[i].cells[3].getElementsByTagName("input")[0].value;
		var auditOrganName=tab.rows[i].cells[4].getElementsByTagName("textarea")[0].value;
		var dutyType=tab.rows[i].cells[5].getElementsByTagName("textarea")[0].value;
		if(orgCnName==""||orgEnName==""||joinDate==""||auditOrganName==""||dutyType==""){
			if(i==1){
...
<body>
<model:datasets>
	<model:dataset id="somJxCheckInterProjectDataSet" cmd="com.inspur.cams.sorg.check.checkinterproject.cmd.SomCheckInterProjectQueryCommand" global="true" method="queryNoPage">
		<model:record fromBean="com.inspur.cams.sorg.check.checkinterproject.data.SomCheckInterProject"></model:record>
	</model:dataset>
	<model:dataset id="somCheckInterMeetingDataSet" cmd="com.inspur.cams.sorg.check.checkintermeeting.cmd.SomCheckInterMeetingQueryCommand" global="true" method="queryNoPage">
		<model:record fromBean="com.inspur.cams.sorg.check.checkintermeeting.data.SomCheckInterMeeting"></model:record>
	</model:dataset>
	<model:dataset id="somCheckInterOrgDataSet" cmd="com.inspur.cams.sorg.check.checkinterorg.cmd.SomCheckInterOrgQueryCommand" global="true" method="queryNoPage">
		<model:record fromBean="com.inspur.cams.sorg.check.checkinterorg.data.SomCheckInterOrg"></model:record>
	</model:dataset>
</model:datasets>
<div id="float" >
	<input type="button" value="上一页" style="height:25px;width:80px;position:absolute;margin-left:20px;" onclick="lastPageJ('28')"/>
	<input type="button" value="下一页" style="height:25px;width:80px;position:absolute;margin-left:120px;" onclick="nextPageJ('30')"/>
		...
		<TR>
			...
			<TABLE id=activitiesInterProject class=unnamed1 cellSpacing=0 cellPadding=0 width='100%'
				...
				<TBODY>
					...
					<TR align=middle>
						<TD class=font12size2 width=31 height=31><input value='1' CLASS='boder12-0' SIZE='2'	readOnly='true' style='text-align:center'></TD>
						<TD class=font12size2 height=31><textarea
							...
							ID='子表1.项目名称$1' COLS='12' rows='3' limit='18' CLASS='boder12-0'
							onChange='createNo(this);' ></textarea></TD>
						<TD class=font12size2 height=31><textarea
							...
							ID='子表1.合作方名称$1' CLASS='boder12-0' COLS='12' rows='3' limit='18'
							onChange='createNo(this);' ></textarea></TD>
						<TD class=font12size2 height=31>
							<textarea CLASS='boder12-0' COLS='12' rows='3' limit='18'></textarea></TD>
						<TD class=font12size2 vAlign=middle><input
							name='query$form$0$JOIN_OUTER_ITEM$wofangjingfei$1' value=''
							ID='子表1.我方经费$1' 
							onblur='checkFloat(this);'onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'') " style='text-align:right;padding-right:2px;' CLASS='boder12-0' SIZE='10' maxlength='15'
							onChange='createNo(this);' ></TD>
						<TD class=font12size2 vAlign=middle><input
							name='query$form$0$JOIN_OUTER_ITEM$waifangjingfei$1' value=''
							ID='子表1.外方经费$1'
							onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'') " style='text-align:right;padding-right:2px;' CLASS='boder12-0' maxlength='10' SIZE='10'
							onChange='createNo(this);' ></TD>
						...
						<TD class=font12size3><textarea
							...
							ID='子表1.合作项目$1' CLASS='boder12-0' COLS='30' rows='3' limit='45'
							onChange='createNo(this);' ></textarea></TD>
					</TR>
					<TR align=middle>
						<TD class=font12size2 height=30><input value='2' CLASS='boder12-0' SIZE='2'	readOnly='true' style='text-align:center'></TD>
						<TD class=font12size2 height=30><textarea
							...
							ID='子表1.项目名称$2' COLS='12' rows='3' limit='18' CLASS='boder12-0'
							onChange='createNo(this);' ></textarea></TD>
						<TD class=font12size2 height=30><textarea
							...
							ID='子表1.合作方名称$2' CLASS='boder12-0' COLS='12' rows='3' limit='18'
							onChange='createNo(this);' ></textarea></TD>
						...
						<TD class=font12size2 vAlign=middle><input
							...
							ID='子表1.我方经费$2'
							onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'') " style='text-align:right;padding-right:2px;' CLASS='boder12-0' maxlength='15' SIZE='10'
							onChange='createNo(this);' ></TD>
						<TD class=font12size2 vAlign=middle><input
						...
						<TD class=font12size3><textarea
							...
							ID='子表1.合作项目$2' CLASS='boder12-0' COLS='30' rows='3' limit='45'
							onChange='createNo(this);' ></textarea></TD>
					</TR>
					<TR align=middle>
						<TD class=font12size2 height=32><input value='3' CLASS='boder12-0' SIZE='2'	readOnly='true' style='text-align:center'></TD>
						<TD class=font12size2 height=32><textarea
							...
							ID='子表1.项目名称$3' COLS='12' rows='3' limit='18' CLASS='boder12-0'
							onChange='createNo(this);' ></textarea></TD>
						<TD class=font12size2 height=32><textarea
							...
							ID='子表1.合作方名称$3' CLASS='boder12-0' COLS='12' rows='3' limit='18'
							onChange='createNo(this);' ></textarea></TD>
						...
						<TD class=font12size3><textarea
							...
							ID='子表1.合作项目$3' CLASS='boder12-0' COLS='30' rows='3' limit='45'
							onChange='createNo(this);' ></textarea></TD>
					</TR>
					<TR align=middle>
						<TD class=font12size2 height=31><input value='4' CLASS='boder12-0' SIZE='2'	readOnly='true' style='text-align:center'></TD>
						<TD class=font12size2 height=31><textarea
							...
							ID='子表1.项目名称$4' COLS='12' rows='3' limit='18' CLASS='boder12-0'
							onChange='createNo(this);' ></textarea></TD>
						<TD class=font12size2 height=31><textarea
							...
							ID='子表1.合作方名称$4' CLASS='boder12-0' COLS='12' rows='3' limit='18'
							onChange='createNo(this);' ></textarea></TD>
						<TD class=font12size2 height=31>
							<textarea CLASS='boder12-0' COLS='12' rows='3' limit='18'></textarea></TD>
						<TD class=font12size2 vAlign=middle><input
						...
						<TD class=font12size3><textarea
							...
							ID='子表1.合作项目$4' CLASS='boder12-0' COLS='30' rows='3' limit='45'
							onChange='createNo(this);' ></textarea></TD>
					</TR>
					<TR align=middle>
						<TD class=font12size4 height=32><input value='5' CLASS='boder12-0' SIZE='2'	readOnly='true' style='text-align:center'></TD>
						<TD class=font12size4 height=32><textarea
							...
							ID='子表1.项目名称$5' COLS='12' rows='3' limit='18' CLASS='boder12-0'
							onChange='createNo(this);' ></textarea></TD>
						<TD class=font12size4 height=32><textarea
							...
							ID='子表1.合作方名称$5' CLASS='boder12-0' COLS='12' rows='3' limit='18'
							onChange='createNo(this);' ></textarea></TD>
						<TD class=font12size4 height=32>
							<textarea CLASS='boder12-0' COLS='12' rows='3' limit='18'></textarea></TD>
						<TD class=font12size4 valign=middle><input
							name='query$form$0$JOIN_OUTER_ITEM$wofangjingfei$5' value=''
							ID='子表1.我方经费$5'
							onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'') " style='text-align:right;padding-right:2px;' CLASS='boder12-0' size='10' maxlength='15'
						...
						<TD><textarea
							...
							ID='子表1.合作项目$5' CLASS='boder12-0' COLS='30' rows='3' limit='45'
							onChange='createNo(this);' ></textarea></TD>
					</TR>
				</TBODY>
			</TABLE>
		...
		<TR>
			...
			<TABLE id=internationalMeeting class=unnamed1 cellSpacing=0 cellPadding=0 width='100%'
				...
				<TBODY>
					...
					<TR align=middle>
						<TD class=font12size2 height=31><input value='1' CLASS='boder12-0' SIZE='2'	readOnly='true' style='text-align:center'></TD>
						<TD class=font12size2 height=31><textarea
							...
							ID='子表2.会议名称$1' COLS='28' limit='28' CLASS='boder12-0'
							onChange='createNo(this);' ></textarea></TD>
						<TD class=font12size2 height=31>
							<textarea CLASS='boder12-0' COLS='12' rows='3' limit='18'></textarea></TD>
						<TD class=font12size2 height=31>
						...
						<TD class=font12size2><textarea
							...
							ID='子表2.主办方名称$1' COLS='20' limit='20' CLASS='boder12-0'
							onChange='createNo(this);' ></textarea></TD>
						<TD class=font12size3>
							<textarea CLASS='boder12-0' COLS='12' rows='3' limit='18'></textarea></TD>
					</TR>
					<TR align=middle>
						<TD class=font12size2 height=31><input value='2' CLASS='boder12-0' SIZE='2'	readOnly='true' style='text-align:center'></TD>
						<TD class=font12size2 height=31><textarea
							...
							ID='子表2.会议名称$2' COLS='28' limit='28' CLASS='boder12-0'
							onChange='createNo(this);' ></textarea></TD>
						<TD class=font12size2 height=31>
							<textarea CLASS='boder12-0' COLS='12' rows='3' limit='18'></textarea></TD>
						<TD class=font12size2 height=31>
						...
						<TD class=font12size2><textarea
							...
							ID='子表2.主办方名称$2' COLS='20' limit='20' CLASS='boder12-0'
							onChange='createNo(this);' ></textarea></TD>
						<TD class=font12size3>
							<textarea CLASS='boder12-0' COLS='12' rows='3' limit='18'></textarea></TD>
					</TR>
					<TR align=middle>
						...
						<TD class=font12size2 height=32><textarea
							...
							ID='子表2.会议名称$3' COLS='28' limit='28' CLASS='boder12-0'
							onChange='createNo(this);' ></textarea></TD>
						<TD class=font12size2 height=32>
							<textarea CLASS='boder12-0' COLS='12' rows='3' limit='18'></textarea></TD>
						<TD class=font12size2 height=32>
						...
						<TD class=font12size2><textarea
							...
							ID='子表2.主办方名称$3' COLS='20' limit='20' CLASS='boder12-0'
							onChange='createNo(this);' ></textarea></TD>
						<TD class=font12size3>
							<textarea CLASS='boder12-0' COLS='12' rows='3' limit='18'></textarea></TD>
					</TR>
					<TR align=middle>
						<TD class=font12size2 height=32><input value='4' CLASS='boder12-0' SIZE='2'	readOnly='true' style='text-align:center'></TD>
						<TD class=font12size2 height=32><textarea
							...
							ID='子表2.会议名称$4' COLS='28' limit='28' CLASS='boder12-0'
							onChange='createNo(this);' ></textarea></TD>
						<TD class=font12size2 height=32>
							<textarea CLASS='boder12-0' COLS='12' rows='3' limit='18'></textarea></TD>
						<TD class=font12size2 height=32>
						...
						<TD class=font12size2><textarea
							...
							ID='子表2.主办方名称$4' COLS='20' limit='20' CLASS='boder12-0'
							onChange='createNo(this);' ></textarea></TD>
						<TD class=font12size3>
							<textarea CLASS='boder12-0' COLS='12' rows='3' limit='18'></textarea></TD>
					</TR>
					<TR align=middle>
						...
						<TD class=font12size4 height=32><textarea
							...
							ID='子表2.会议名称$5' COLS='28' limit='28' CLASS='boder12-0'
							onChange='createNo(this);' ></textarea></TD>
						<TD class=font12size4 height=32>
							<textarea CLASS='boder12-0' COLS='12' rows='3' limit='18'></textarea></TD>
						<TD class=font12size4 height=32>
						...
						<TD class=font12size4><textarea
							...
							ID='子表2.主办方名称$5' COLS='20' limit='20' CLASS='boder12-0'
							onChange='createNo(this);' ></textarea></TD>
						<TD >
							<textarea CLASS='boder12-0' COLS='12' rows='3' limit='18'></textarea></TD>
					</TR>
				...
				<TBODY>
					...
					<TR class=font12size2 align=middle>
						...
						<TD class=font12size2 height=31><textarea
							...
							ID='子表3.中文全称$5' COLS='24' rows='3' limit='36' CLASS='boder12-0'
							onChange='createNo(this);' ></textarea></TD>
						<TD class=font12size2 height=31><textarea
							...
							ID='子表3.英文全称$5' COLS='38' rows='3' limit='110' CLASS='boder12-0'
							onChange='createNo(this);' ></textarea></TD>
						<TD class=font12size2 vAlign=middle height=31>
							<input CLASS='boder12-0' style='text-align:center' maxlength="10"></TD>
						<TD class=font12size2><textarea
							...
							ID='子表3.批准部门$1' COLS='12' rows='3' limit='18' CLASS='boder12-0'
							onChange='createNo(this);' ></textarea></TD>
						<TD class=font12size3>
							<textarea CLASS='boder12-0' COLS='12' rows='3' limit='18'></textarea></TD>
					</TR>
					<TR class=font12size2 align=middle>
						<TD class=font12size2 height=32><input value='2' CLASS='boder12-0' SIZE='2'	readOnly='true' style='text-align:center'></TD>
						<TD class=font12size2 height=32><textarea
						...
						<TD class=font12size2><textarea
							...
							ID='子表3.批准部门$2' COLS='12' rows='3' limit='18' CLASS='boder12-0'
							onChange='createNo(this);' ></textarea></TD>
						<TD class=font12size3>
							<textarea CLASS='boder12-0' COLS='12' rows='3' limit='18'></textarea></TD>
					</TR>
					<TR align=middle>
						...
						<TD class=font12size2 height=32><textarea
							...
							onChange='createNo(this);' ></textarea></TD>
						<TD class=font12size2 vAlign=middle height=32>
							<input CLASS='boder12-0' format="Y-m-d" maxlength="10"style='text-align:center'></TD>
						<TD class=font12size2><textarea
							...
							ID='子表3.批准部门$3' COLS='12' rows='3' limit='18' CLASS='boder12-0'
							onChange='createNo(this);' ></textarea></TD>
						<TD class=font12size3>
							<textarea CLASS='boder12-0' COLS='12' rows='3' limit='18'></textarea></TD>
					</TR>
					<TR align=middle>
						...
						<TD class=font12size2 height=32><textarea
							...
							onChange='createNo(this);' ></textarea></TD>
						<TD class=font12size2 vAlign=middle height=32>
							<input CLASS='boder12-0' maxlength="10" style='text-align:center'></TD>
						<TD class=font12size2><textarea
							...
							ID='子表3.批准部门$4' COLS='12' rows='3' limit='18' CLASS='boder12-0'
							onChange='createNo(this);' ></textarea></TD>
						<TD class=font12size3>
							<textarea CLASS='boder12-0' COLS='12' rows='3' limit='18'></textarea></TD>
					</TR>
					<TR align=middle>
						...
						<TD class=font12size4><textarea
							...
							ID='子表3.批准部门$5' COLS='12' rows='3' limit='18' CLASS='boder12-0'
							onChange='createNo(this);' ></textarea></TD>
						<TD >
							<textarea CLASS='boder12-0' COLS='12' rows='3' limit='18'></textarea></TD>
					</TR>
