...
function query(){
	...
	taskDs.setParameter("SOM_CHECK_TASK.BATCH_YEAR@=",getParam("checkYear"));
...
function insert() {
	...
	data.put("checkYear",selected[0].get('batchYear'));
	var url='jsp/ext/somsd/manage/check/fund/edit/fundCheckEdit1.jsp';
...
function detailCheck(){
	...
	var url='jsp/ext/somsd/manage/check/fund/detail/fundCheckDetail1.jsp';
	var text = '年检明细';
	L5.forward(url,text,data);
}
function printCheck(){
...
function confirmPrint(){
	...
	var url='';
	if(printPart==1){
		url='jsp/ext/somsd/manage/check/fund/print/fundCheckPrint1.jsp';
	}else{
		url='jsp/ext/somsd/manage/check/fund/print/fundCheckPrint16.jsp';
	}
	var text = '年检明细';
	L5.forward(url,text,data);
}
...
function submit(){
	...
	if(selected[0].get('status')=='0' || selected[0].get('status')=='4'){
		...
		cmd.setParameter("sorgType", "fund_");
