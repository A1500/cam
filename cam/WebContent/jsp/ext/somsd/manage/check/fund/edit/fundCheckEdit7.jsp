...
<body>
<model:datasets>
	<model:dataset id="somJxOrganBasicDataSet" cmd="com.inspur.cams.sorg.check.checkorgdetail.cmd.SomCheckOrgDetailQueryCommand" global="true">
		<model:record fromBean="com.inspur.cams.sorg.check.checkorgdetail.data.SomCheckOrgDetail">
			...
			<model:field name="entityBuildNum" type="string" rule="require" />
			...
			<TABLE class=f16ps-size1 cellSpacing=0 cellPadding=0 width='100%'
				...
				<TBODY>
					<TR>
						...
						<TD class=font12size2 width='11%' rowSpan=2><input field='branchNum'
						...
						<TD class=font12size2 width='13%'><input field='branchBuildNum'
							name='新设分支数' value=''
						...
						<TD class=font12size3 width='17%'><input field='branchBuildedNum'
							name='办理新设分支数'
					...
					<TR>
						...
						<TD class=font12size2 width='13%'><input field='branchCancelNum'
							name='注销分支数' value=''
						...
						<TD class=font12size3 width='17%'><input field='branchCanceledNum'
							name='办理注销分支数'
					...
					<TR>
						...
						<TD class=font12size2><input field='delegateBuildNum'
							name='新设代表数' value=''
					...
					<TR>
						...
						<TD class=font12size2 rowSpan=2><input field='specialFundNum'
							name='专项基金总数' value='' ID='基金数' onKeyUp="value=value.replace(/[^\d]/g,'');"
							 STYLE='text-align:right;padding-right:2px;' SIZE='6' maxlength="6"
							
							> 个</TD>
						<TD class=font12size2 width='15%'>本年度新设</TD>
						<TD class=font12size2><input field='specialFundBuildNum'
							name='新设基金数' value=''
						...
						<TD class=font12size3><input field='specialFundBuildedNum'
					...
					<TR>
						<TD class=font12size2>本年度注销</TD>
						<TD class=font12size2><input field='specialFundCancelNum'
							name='注销基金数' value=''
							ID='注销基金数'  STYLE='text-align:right;padding-right:2px;' SIZE='6' maxlength="6" onKeyUp="value=value.replace(/[^\d]/g,'');"
							> 个</TD>
						<TD class=font12size2 height=40>其中已办理注销手续的</TD>
						<TD class=font12size3><input field='specialFundCanceledNum'
							name='办理注销基金数'
					...
					<TR>
						<TD class=font12size2>本年度注销</TD>
						<TD class=font12size2><input field='workingCancelNum'
							name='注销办事数' value=''
							ID='注销办事数'  STYLE='text-align:right;padding-right:2px;' SIZE='6' maxlength="6" onKeyUp="value=value.replace(/[^\d]/g,'');"
							> 个</TD>
						<TD class=font12size2 height=40>其中已办理注销手续的</TD>
						<TD class=font12size3><input field='workingCanceledNum'
							name='办理注销办事数'
					...
					<TR>
						...
						<TD class=font12size2><input field='entityBuildNum'
							name='新设实体数' value=''
