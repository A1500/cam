...
<model:datasets>
	<model:dataset id="somJxCheckMajorDataSet"
		cmd="com.inspur.cams.sorg.check.somcheckmajor.cmd.SomCheckMajorQueryCommand"
		global="true" method="queryNoPage">
		<model:record
			fromBean="com.inspur.cams.sorg.check.somcheckmajor.dao.SomCheckMajor"></model:record>
	</model:dataset>
</model:datasets>
...
<TABLE class='word-st-14 border-tl' id=table1 cellSpacing=0
	...
	<TBODY>
		<TR>
			...
			<TD align=middle width=111>支付金额（<span style="color:red">万元</span>）</TD>
		...
		<TR>
			...
			<TD align=middle width=111><input
				...
				CLASS='input-01' SIZE='12' MAXLENGTH='15' onblur='checkFloat(this);setSum();' style='text-align:right;padding-right:2px;'>
			</TD>
			<TD align=middle width=76><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$bili$1' value=''
				CLASS='input-01' SIZE='5' MAXLENGTH='5' onblur='checkFloat(this);setSum();' style='text-align:center'>
			%</TD>
