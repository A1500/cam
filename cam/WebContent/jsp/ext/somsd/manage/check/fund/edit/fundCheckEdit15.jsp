...
<model:datasets>
	<model:dataset id="somJxCheckExpenditureDataSet" cmd="com.inspur.cams.sorg.check.somcheckexpenditure.cmd.SomCheckExpenditureQueryCommand" global="true">
		<model:record fromBean="com.inspur.cams.sorg.check.somcheckexpenditure.dao.SomCheckExpenditure">
			<model:field name="limitTotal" type="string" rule="require" />
			<model:field name="limitExplain" type="string" rule="require|length{1000}"/>
			<model:field name="unlimitTotal" type="string" rule="require" />
			<model:field name="unlimitExplain" type="string" rule="require|length{1000}"/>
			<model:field name="pubExplain" type="string" rule="require|length{1000}"/>
			<model:field name="perOffExplain" type="string" rule="require|length{1000}"/>
			<model:field name="otherExplain" type="string" rule="require|length{1000}"/>
		</model:record>
	</model:dataset>
</model:datasets>
<div id="float">
							...
							<TBODY>
								<TR>
									<TD height=20>上年度总收入中有时间受限为上年不得使用的限定性收入为 <input
										name='上年度总收入中有时间受限为上年不得使用的限定性收入'
										field='limitTotal'  SIZE='8' isMoney='true' maxlength="15" onkeyup="value=value.replace(/[^\d.]/g,'')"
										onblur='checkFloat(this);' style='text-align: right'>
								...
								<TR>
									...
									<P>于上年解除时间限定的净资产为 <input
										name='于上年解除时间限定的净资产' field='unlimitTotal'
										 SIZE='8' isMoney='true' maxlength="15" onkeyup="value=value.replace(/[^\d.]/g,'')"
										 onblur='checkFloat(this);' style='text-align: right'>
								...
								<TR>
									<TD><textarea
										name='如果本年公益支出与业务活动表中“公益活动支出”“本年累计数”的合计不一致,请说明具体情况'
								...
								<TR>
									<TD><textarea
										name='如果本年度工作人员工资福利、行政办公之和与业务活动表中“管理费用”“本年累计数”的合计不一致,请说明具体情况'
