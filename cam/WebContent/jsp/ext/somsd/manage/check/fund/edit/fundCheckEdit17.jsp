	...
	somCheckPublicActivitiesDataSet.on('load',function(ds){
		...
		if(count!=0){
			for(i=1;i<=count;i++){
				...
				document.getElementById("JNAME"+i).value=ds.getAt(i-1).get("activityName");
				document.getElementById("income"+i).value=ds.getAt(i-1).get("income");
				document.getElementById("expend"+i).value=ds.getAt(i-1).get("expenditure");
				document.getElementById("year"+i).value=ds.getAt(i-1).get("itemYear");
				document.getElementById("yearEnd"+i).value=ds.getAt(i-1).get("endYear");
				document.getElementById("itemContent"+i).value=ds.getAt(i-1).get("socialBenefits");
			}
		}
	});
	//创建页面导航下拉框
...
function getSomCheckPublicActivitiesDataSet(){
	...
	for(var i = 1;i<=5;i++){
		...
		record.set("activityName",document.getElementById("JNAME"+i).value);
		record.set("income",document.getElementById("income"+i).value);
		record.set("expenditure",document.getElementById("expend"+i).value);
		record.set("itemYear",document.getElementById("year"+i).value);
		record.set("endYear",document.getElementById("yearEnd"+i).value);
		record.set("socialBenefits",document.getElementById("itemContent"+i).value);
...
<body>
<model:datasets>
	<model:dataset id="somCheckPublicActivitiesDataSet" cmd="com.inspur.cams.sorg.check.checkpublicbenefit.cmd.SomCheckPublicBenefitQueryCommand" global="true">
		<model:record fromBean="com.inspur.cams.sorg.check.checkpublicbenefit.data.SomCheckPublicBenefit">
			<model:field name="socialBenefits" type="string" rule="length{100}"/>
		</model:record>
	</model:dataset>
</model:datasets>
<div id="float">
							...
							<TBODY>
								...
								<TR>
									...
									<span style="color:red">万元</span>，项目本年度支出：人民币<input
										...
										CLASS='boder-1' SIZE='10' isMoney='true' 
										style='text-align:right;padding-right:2px;' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.]/g,'') "maxlength="15">
									<span style="color:red">万元</span>，执行年度：自<input id='year2'
										value='' CLASS='boder-1' SIZE='4' 
										onkeyup="value=value.replace(/[^\d]/g,'') "maxlength="4"style='text-align:center'> 年至<input
										id='yearEnd2' value=''
										CLASS='boder-1' SIZE='4' 
							...
							<TBODY>
								...
								<TR>
									...
									<span style="color:red">万元</span>，项目本年度支出：人民币<input
										...
										CLASS='boder-1' SIZE='10' isMoney='true' 
										style='text-align:right;padding-right:2px;' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.]/g,'') "maxlength="15">
									<span style="color:red">万元</span>，执行年度：自<input id='year3'
										value='' CLASS='boder-1' SIZE='4' 
										onkeyup="value=value.replace(/[^\d]/g,'') "maxlength="4"style='text-align:center'> 年至<input
										id='yearEnd3' value=''
										CLASS='boder-1' SIZE='4' 
							...
							<TBODY>
								...
								<TR>
									...
									<span style="color:red">万元</span>，项目本年度支出：人民币<input
										...
										CLASS='boder-1' SIZE='10' isMoney='true' 
										style='text-align:right;padding-right:2px;' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.]/g,'') "maxlength="15">
									<span style="color:red">万元</span>，执行年度：自<input id='year4'
										value='' CLASS='boder-1' SIZE='4' 
										onkeyup="value=value.replace(/[^\d]/g,'') "maxlength="4"style='text-align:center'> 年至<input
										id='yearEnd4' value=''
										CLASS='boder-1' SIZE='4' 
							...
							<TBODY>
								...
								<TR>
									...
									<span style="color:red">万元</span>，项目本年度支出：人民币<input
										...
										CLASS='boder-1' SIZE='10' isMoney='true' 
										style='text-align:right;padding-right:2px;' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.]/g,'') "maxlength="15">
									<span style="color:red">万元</span>，执行年度：自<input id='year5'
										value='' CLASS='boder-1' SIZE='4' 
										onkeyup="value=value.replace(/[^\d]/g,'') "maxlength="4"style='text-align:center'> 年至<input
										id='yearEnd5' value=''
										CLASS='boder-1' SIZE='4' 
