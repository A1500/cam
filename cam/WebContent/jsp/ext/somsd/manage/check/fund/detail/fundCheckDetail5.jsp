			...
			for(i=1;i<=ds.getCount();i++){
				for(j=0;j<ds.getCount();j++){
					...
					if( record.get('seqNum') == i ){
						...
						tab1.rows[rowLength-2].cells[2].getElementsByTagName("label")[0].innerHTML=record.get("political");
...
<div id="float" class="noprint">
	<input type="button" value="下一页" style="height:25px;width:80px;position:absolute;margin-left:120px;" onclick="nextPageJ1('6')"/>
	<input type="button" value="上一页" style="height:25px;width:80px;position:absolute;margin-left:20px;" onclick="lastPageJ1('4')"/>
				...
				<TBODY>
					...
					<tr align='middle'>
						<td height='20' align='left' colspan='4'>基金会工作人员的平均年工资为：<label
							...
							ID='averageYearlySalary' ></label> 万元</td>
					</tr>
