...
<script type="text/javascript" src="samMBalanceLeaveBptSam.js"></script>
...
<next:Panel width="98.5%">
	...
	<next:Panel title="城乡居民医疗救助结算单" width="100%">
		<next:TopBar>
			...
			<next:ToolBarItem iconCls="save" text="打印预览" handler="seePrintBptSam" />
		...
		<next:Html>
			...
			<table border="1" width="100%">
				<tr>
					<td width="10%" class="FieldLabel" rowspan="5">基本信息</td>
				...
				<tr>
					...
					<td class="FieldInput"><input type="text"  name="leaveTime"
				...
				<tr>
					...
					<td class="FieldInput"><input type="text"  id="totalExpense" readonly="readonly"
						maxlength="16"  onchange="formatTotal(this.value)" name="totalExpense"
				...
				<tr>
					...
					<td class="FieldInput"><input type="text"  id="insuranceExpense" readonly="readonly"
						maxlength="16" onchange="formatInsuranceExpense(this.value)"
				...
				<tr>
					...
					<td class="FieldInput"><input id="hospitalPay" maxlength="16"
						name="hospitalPay" field="hospitalPay"
						onchange="formatHospitalPay(this.value)"></td>
					<td class="FieldLabel">优抚补助比例</td>
					<td class="FieldInput"><label id="bptPercentage"
						name="bptPercentage" /></td>
				</tr>
				<tr>
					<td class="FieldLabel">优抚补助金额（元）</td>
					<td class="FieldInput"><label id="bptAssitancePay"
						name="bptAssitancePay" field="specialPay" /></td>
				...
				<tr>
					...
					<td class="FieldInput"><label id="assitancePay"
						name="assitancePay" field="assitancePay" /></td>
					<td class="FieldLabel">自付费用（元）</td>
					<td class="FieldInput"><label id="personalPay"
						name="personalPay" field="personalPay" /></td>
				</tr>
	...
	<next:GridPanel height="200" width="100%" id="expGrid"
		title="医保系统查询结果" autoScroll="true" autoWidth="true"
		dataset="insuranceDS">
		<next:TopBar>
			<next:ToolBarItem symbol="->"></next:ToolBarItem>
