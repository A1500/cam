...
<html>
	<head>
		<title>普通门规信息列表</title>
		<next:ScriptManager/>
		<script type="text/javascript" src="samMBalanceOutpatientAss.js"></script>
...
<model:datasets>
    ...
    <model:dataset id="ds" cmd="com.inspur.cams.drel.mbalance.cmd.SamMedicalClinicSpQueryCmd" method="queryForNomClinic" pageSize="10">
	</model:dataset>
	...
	<!-- 人员查询 -->
	<model:dataset id="queryPeoDS" cmd="com.inspur.cams.drel.mbalance.cmd.SamMedicalClinicSpQueryCmd" method="QueryPeople">
	</model:dataset>
	<!-- 伤残等级 -->
	...
	<model:dataset id="ds3" cmd="com.inspur.cams.drel.mbalance.cmd.SamMedicalClinicSpQueryCmd" method="queryForNomClinic" pageSize="10">
	</model:dataset>	
<!-- 个人信息 -->
...
<next:GridPanel id="rule_Grid" name="rule_Grid"   dataset="ds" title="普通门规信息列表" stripeRows="true" notSelectFirstRow="true" autoScroll="true" collapsible="true"  width="100%" height="99.9%">
	<next:TopBar>
	...
	<next:Columns>
		...
		<next:Column id="sign"  header="是否已提交" field="SIGN" sortable="true" dataset="signDS"  width="10%">
			<next:TextField />
		</next:Column>
	</next:Columns>
	<next:BottomBar>
...
<next:Window id="door_rule" title="门规信息"  width="750" height="450" closeAction="hide" resizable="true" autoScroll="false" animCollapse="true">
	<next:FitLayout>
			...
			<next:Html>
				...
				<table  width="100%">
					...
					<tr>
						...
						<td class="FieldInput">
							<select  id="wType"  style="width:95%"><option dataset="assitanceTypeDataset"></option></select> 
						</td>
						<td class="FieldLabel">证件编码：</td>
						<td class="FieldInput">
			...
			<form class="L5form" dataset="ds2">
				<table width="100%">
					...
					<tr>
						...
						<td class="FieldInput">
							<input type="text" id="specialPay" name="救助金额：" onblur="changeTwo2(this.value);" field="specialPay"  maxlength="16" style="width:85%"/>
							<font color="red">*</font>
						</td>
...
<next:Window id="people_help" title="帮助信息"  width="600" height="260" collapsible="true" closeAction="hide">
	<next:FitLayout>
	<next:GridPanel id="base_people" name="base_people" width="100%" disableSelection="true" stripeRows="true" notSelectFirstRow="true" collapsible="true" height="90%" autoScroll="true" dataset="queryPeoDS">
			<next:TopBar>
				<next:ToolBarItem symbol="->"></next:ToolBarItem>
				...
				<next:Columns>		
					...
					<next:Column id="hpeopleId" header="人员Id" field="PEOPLE_ID" hidden="true" width="10" >
					</next:Column>
					<next:Column id="hname" header="姓名" field="NAME"   width="9%"  >
					</next:Column>
					<next:Column id="hidCard" header="身份证号" field="ID_CARD" width="20%" >
					</next:Column>
					<next:Column id="hsex" header="性别" field="SEX" dataset="sexDS" width="8%"  >
					</next:Column>
				</next:Columns> 
				<next:BottomBar>
					<next:PagingToolBar dataset="queryPeoDS"/>
				</next:BottomBar>
		</next:GridPanel>
		</next:FitLayout>
</next:Window>
