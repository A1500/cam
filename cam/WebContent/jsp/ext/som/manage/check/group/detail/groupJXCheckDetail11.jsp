...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 align=center width=700
	...
	<tr style='mso-yfti-irow: 0; mso-yfti-firstrow: yes; height: 354.4pt'>
		...
		<p class=MsoNormal align=center
			...
			<textarea field="workSummary" name='"年度工作总结"' style="width:700;height:690pt;font-size: 12.0pt;" rows="30" readonly="readonly"></textarea>
			</o:p></span></p>
			<br>
		</td>
	</tr>
