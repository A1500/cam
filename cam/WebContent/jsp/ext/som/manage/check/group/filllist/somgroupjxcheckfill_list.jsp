...
<script type="text/javascript">
	...
	<head>
		...
		<script type="text/javascript" src="somgroupjxcheckfill_list.js"></script>
	</head>
<body>
<model:datasets>
...
<next:GridPanel id="editGridPanel" name="somcheckGrid" width="100%" stripeRows="true" height="230" dataset="ds" title="社会团体年检列表" notSelectFirstRow="true">
	<next:TopBar>
