...
<model:datasets>
	<model:dataset id="somJxCheckDataSet" cmd="com.inspur.cams.sorg.jxcheck.somjxcheck.cmd.SomJxCheckQueryCommand" global="true">
		<model:record fromBean="com.inspur.cams.sorg.jxcheck.somjxcheck.dao.SomJxCheck">
			<model:field name="workSummary" type="string" rule="require" />
			<model:field name="nextYearPlan" type="string" rule="require" />
		</model:record>
	</model:dataset>
</model:datasets>
<div id="float">	
		<input type="button" value="上一页" style="height:25px;width:80px;position:absolute;margin-left:20px;" onclick="lastPage('10')"/>
		<input type="button" value="下一页" style="height:25px;width:80px;position:absolute;margin-left:120px;" onclick="nextPage('12')"/>
...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 align=center width=800
	...
	<tr style='mso-yfti-irow: 0; mso-yfti-firstrow: yes; height: 354.4pt'>
		...
		<p class=MsoNormal align=left
			...
			lang=EN-US><label id=checkYear1 style='font-size: 14.0pt;'></label></span>年年度工作总结（500-1000字）<span
		...
		<p class=MsoNormal align=center
			...
			<textarea field="workSummary" name='"年度工作总结"' style="width:750;" rows="30" ></textarea>
			</o:p></span></p>
			<br>
		</td>
	</tr>
	<tr style='mso-yfti-irow: 1; mso-yfti-lastrow: yes; height: 354.35pt'>
		...
		<p class=MsoNormal align=left
			style='margin-left: 5.4pt; text-align: left; tab-stops: 248.15pt'><span
			lang=EN-US
			style='font-size: 16.0pt; font-family: 仿宋; mso-hansi-font-family: 宋体; color: black'>2</span><span
			style='font-size: 16.0pt; font-family: 仿宋; mso-hansi-font-family: 宋体; color: black'>、<span
		...
		<p class=MsoNormal align=center
			...
			lang=EN-US
			style='font-size: 16.0pt; font-family: 仿宋; mso-hansi-font-family: 宋体; color: black'><o:p>
			<textarea field="nextYearPlan" name='"年度工作计划"' style="width:750;" rows="25" ></textarea>
			</o:p></span></p>	
			<br>		
		</td>
	</tr>
