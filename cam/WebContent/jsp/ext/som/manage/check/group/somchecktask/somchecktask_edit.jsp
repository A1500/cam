...
<model:datasets>
	<model:dataset id="ds" cmd="com.inspur.cams.sorg.check.checktask.cmd.SomCheckTaskQueryCommand" global="true">
		<model:record fromBean="com.inspur.cams.sorg.check.checktask.data.SomCheckTask">
				...
				<model:field name="batch" type="string" rule="require" />
		...
		<table border="1"  width="100%" >
			...
			<tr>
	   		...
	   		<tr>
				...
				<td class="FieldInput"><input type="text" name="batch" field="batch"  title="批次" maxlength="10"/><span style="color:red">*</span> </td>
			
				<td  class="FieldLabel" >批次年份</td>
				<td class="FieldInput"><input type="text" name="batchYear" title="批次年份" field="batchYear"  maxlength="4"/><span style="color:red">*</span></td>
			</tr>
	   		<tr>
				<td  class="FieldLabel" >有效期至</td>
				<td class="FieldInput">
				<input type="text" id="validDate" field="validDate" format="Y-m-d" onclick="LoushangDate(this)" readonly="readonly" />
				</td>
