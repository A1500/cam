...
<model:datasets>
	<model:dataset id="somJxCheckDataSet" cmd="com.inspur.cams.sorg.jxcheck.somjxcheck.cmd.SomJxCheckQueryCommand" global="true">
		<model:record fromBean="com.inspur.cams.sorg.jxcheck.somjxcheck.dao.SomJxCheck">
			...
			<model:field name="nextYearPlan" type="string" rule="require|length{3500}" />
		</model:record>
	</model:dataset>
</model:datasets>
<div id="float">	
	<input type="button" value="上一页" style="height:25px;width:80px;position:absolute;margin-left:20px;" onclick="lastPageM('10')"/>
		<input type="button" value="下一页" style="height:25px;width:80px;position:absolute;margin-left:120px;" onclick="nextPageM('12')"/>
...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
  ...
  <textarea field="workSummary" name='"年度工作总结"'
				style="width: 750; overflow: hidden" rows="30"  ></textarea>
  </o:p></span></b></p>
  </td>
 </tr>
</table>
...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
  ...
  <textarea field="nextYearPlan" name='"年度工作计划"'
				style="width: 750; overflow: hidden" rows="25" ></textarea>
  </o:p></span></p>
  </td>
 </tr>
</table>
