...
<label id='earningTotal1' style='width:100;' field="serviceEarning"  class='label7'></label>
	元（其中，政府购买服务收入：</span></p>
<p class=MsoNormal
	style='margin-left: 73.5pt;   '>
<label  style='width:100;' field="organEarning"  class='label7'></label>
	元）<span lang=EN-US><o:p></o:p></span></p>

<p class=MsoNormal
	style='margin-left: 73.5pt;   '><span
	lang=EN-US
...
<p class=MsoNormal
	style='margin-left: 0cm; text-indent: 0cm;  ; '><span
	lang=EN-US
