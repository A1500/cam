...
function save(){
	...
	cashFlowRecord.set("netRevalueation",document.getElementById('netRevalueation').innerHTML);
...
function netRevalueationcount(){
	...
	document.getElementById("netRevalueation").innerHTML = num.toFixed(6)*1;
}
</script>
</head>
...
<model:datasets>
	<model:dataset id="somJxCheckCashFlowDataSet" cmd="com.inspur.cams.sorg.jxcheck.somjxcheckcashflow.cmd.SomJxCheckCashFlowQueryCommand" global="true">
		<model:record fromBean="com.inspur.cams.sorg.jxcheck.somjxcheckcashflow.dao.SomJxCheckCashFlow">
...
<div id="float">
	<input  type="button" value="上一页" style="height:25px;width:80px;position:absolute;margin-left:20px;" onclick="lastPageM('9')"/>
	<input  type="button" value="下一页" style="height:25px;width:80px;position:absolute;margin-left:120px;" onclick="nextPageM('11')"/>
...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0
	...
	<tr style='mso-yfti-irow: 2; height: 17.0pt'>
		...
		<p class=MsoNormal align=right
			...
			<input onblur='checkFloat(this);' onblur='checkFloat(this);'onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'');countBaInflowSum();" id="baInflowSum0" field="baReceiveDonations" name='"接受捐赠收到的现金"' style="width:98%"  maxlength="15" style='text-align:right;padding-right:2px;' />
			</o:p></span></p>
		</td>
	</tr>
	<tr style='mso-yfti-irow: 3; height: 17.0pt'>
		...
		<p class=MsoNormal align=right
			style='text-align: right; text-autospace: none'><span lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'><o:p>
			<input onblur='checkFloat(this);' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'');countBaInflowSum();" id="baInflowSum1" field="baGatherDues" name='"收取会费收到的现金"' style="width:98%"  maxlength="15" style='text-align:right;padding-right:2px;' />
			</o:p></span></p>
		</td>
	</tr>
	<tr style='mso-yfti-irow: 4; height: 17.0pt'>
		...
		<p class=MsoNormal align=right
			style='text-align: right; text-autospace: none'><span lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'><o:p>
			<input onblur='checkFloat(this);' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'');countBaInflowSum();" id="baInflowSum2" field="baRenderServices" name='"提供服务收到的现金"' style="width:98%" maxlength="15" style='text-align:right;padding-right:2px;'  />
			</o:p></span></p>
		</td>
	</tr>
	<tr style='mso-yfti-irow: 5; height: 17.0pt'>
		...
		<p class=MsoNormal align=right
			style='text-align: right; text-autospace: none'><span lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'><o:p>
			<input onblur='checkFloat(this);' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'');countBaInflowSum();" id="baInflowSum3" field="baSellProduct" name='"销售商品收到的现金"' style="width:98%"  maxlength="15" style='text-align:right;padding-right:2px;' />
			</o:p></span></p>
		</td>
	</tr>
	<tr style='mso-yfti-irow: 6; height: 17.0pt'>
		...
		<p class=MsoNormal align=right
			style='text-align: right; text-autospace: none'><span lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'><o:p>
			<input onblur='checkFloat(this);' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'');countBaInflowSum();" id="baInflowSum4" field="baGovernmentGrants" name='"政府补助收到的现金"' style="width:98%" maxlength="15" style='text-align:right;padding-right:2px;'  />
			</o:p></span></p>
		</td>
	</tr>
	<tr style='mso-yfti-irow: 7; height: 17.0pt'>
		...
		<p class=MsoNormal align=right
			style='text-align: right; text-autospace: none'><span lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'><o:p>
			<input onblur='checkFloat(this);' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'');countBaInflowSum();" id="baInflowSum5" field="baInfolwOthers" name='"收到的其他与业务活动有关的现金"' style="width:98%"  maxlength="15" style='text-align:right;padding-right:2px;' />
			</o:p></span></p>
		</td>
	</tr>
...
<label id="baInflowSum" field="baInflowSum" name='"现金流入小计"' style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'></label>
	...
	<tr style='mso-yfti-irow: 9; height: 17.0pt'>
		...
		<p class=MsoNormal align=right
			style='text-align: right; text-autospace: none'><span lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'><o:p>
			<input onblur='checkFloat(this);' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'');countBaOutflowSum();"id="baOutflowSum1" field="baDonatedPay" name='"提供捐赠或者资助支付的现金"' style="width:98%"  maxlength="15" style='text-align:right;padding-right:2px;' />
			</o:p></span></p>
		</td>
	</tr>
	<tr style='mso-yfti-irow: 10; height: 17.0pt'>
		...
		<p class=MsoNormal align=right
			style='text-align: right; text-autospace: none'><span lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'><o:p>
			<input onblur='checkFloat(this);' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'');countBaOutflowSum();"id="baOutflowSum2" field="baPayEmployee" name='"支付给员工以及为员工支付的现金"' style="width:98%"  maxlength="15" style='text-align:right;padding-right:2px;' />
			</o:p></span></p>
		</td>
	</tr>
	<tr style='mso-yfti-irow: 11; height: 17.0pt'>
		...
		<p class=MsoNormal align=right
			style='text-align: right; text-autospace: none'><span lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'><o:p>
			<input onblur='checkFloat(this);' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'');countBaOutflowSum();" id="baOutflowSum3" field="baProductServices" name='"购买商品、接受服务支付的现金"' style="width:98%"  maxlength="15" style='text-align:right;padding-right:2px;' />
			</o:p></span></p>
		</td>
	</tr>
	<tr style='mso-yfti-irow: 12; height: 17.0pt'>
		...
		<p class=MsoNormal align=right
			style='text-align: right; text-autospace: none'><span lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'><o:p>
			<input onblur='checkFloat(this);' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'');countBaOutflowSum();" id="baOutflowSum4" field="baOutflowOthers" name='"支付的其他与业务活动有关的现金"' style="width:98%"  maxlength="15" style='text-align:right;padding-right:2px;' />
			</o:p></span></p>
		</td>
	</tr>
...
<label id="baNetAmount" field="baNetAmount" name='"业务活动产生的现金流量净额"'style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'></label>
	...
	<tr style='mso-yfti-irow: 16; height: 17.0pt'>
		...
		<p class=MsoNormal align=right
			style='text-align: right; text-autospace: none'><span lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'><o:p>
			<input onblur='checkFloat(this);' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'');countIaInflowSum();"id="iaInflowSum4" field="iaRegoupingOutlay" name='"收回投资所收到的现金"' style="width:98%"  maxlength="15" style='text-align:right;padding-right:2px;' />
			</o:p></span></p>
		</td>
	</tr>
	<tr style='mso-yfti-irow: 17; height: 17.0pt'>
		...
		<p class=MsoNormal align=right
			style='text-align: right; text-autospace: none'><span lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'><o:p>
			<input onblur='checkFloat(this);' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'');countIaInflowSum();"id="iaInflowSum3" field="iaMadeIncome" name='"取得投资收益所收到的现金"' style="width:98%"  maxlength="15" style='text-align:right;padding-right:2px;' />
			</o:p></span></p>
		</td>
	</tr>
	<tr style='mso-yfti-irow: 18; height: 17.0pt'>
		...
		<p class=MsoNormal align=right
			style='text-align: right; text-autospace: none'><span lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'><o:p>
			<input onblur='checkFloat(this);' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'');countIaInflowSum();"id="iaInflowSum2" field="iaInflowAssets" name='"处置固定资产和无形资产所收回的现金"' style="width:98%"  maxlength="15" style='text-align:right;padding-right:2px;' />
			</o:p></span></p>
		</td>
	</tr>
	<tr style='mso-yfti-irow: 19; height: 17.0pt'>
		...
		<p class=MsoNormal align=right
			style='text-align: right; text-autospace: none'><span lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'><o:p>
			<input onblur='checkFloat(this);' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'');countIaInflowSum();"id="iaInflowSum1" field="iaInflowOthers" name='"收到的其他与投资活动有关的现金"' style="width:98%" maxlength="15" style='text-align:right;padding-right:2px;'  />
			</o:p></span></p>
		</td>
	</tr>
...
<label id="iaInflowSum" field="iaInflowSum" name='"现金流入小计"'style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'></label>
	...
	<tr style='mso-yfti-irow: 21; height: 17.0pt'>
		...
		<p class=MsoNormal align=right
			style='text-align: right; text-autospace: none'><span lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'><o:p>
			<input onblur='checkFloat(this);' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'');countIaOutflowSum();" id="iaOutflowSum1" field="iaOutflowAssets" name='"购建固定资产和无形资产所支付的现金"' style="width:98%"  maxlength="15" style='text-align:right;padding-right:2px;' />
			</o:p></span></p>
		</td>
	</tr>
	<tr style='mso-yfti-irow: 22; height: 17.0pt'>
		...
		<p class=MsoNormal align=right
			style='text-align: right; text-autospace: none'><span lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'><o:p>
			<input onblur='checkFloat(this);' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'');countIaOutflowSum();" id="iaOutflowSum2" field="iaOutflowAbroad" name='"对外投资所支付的现金"' style="width:98%"  maxlength="15" style='text-align:right;padding-right:2px;' />
			</o:p></span></p>
		</td>
	</tr>
	<tr style='mso-yfti-irow: 23; height: 17.0pt'>
		...
		<p class=MsoNormal align=right
			style='text-align: right; text-autospace: none'><span lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'><o:p>
			<input onblur='checkFloat(this);' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'');countIaOutflowSum();"  id="iaOutflowSum3" field="iaOutflowOthers" name='"支付的其他与投资活动有关的现金"' style="width:98%"  maxlength="15" style='text-align:right;padding-right:2px;' />
			</o:p></span></p>
		</td>
	</tr>
...
<label id="iaNetAmount" field="iaNetAmount" name='"投资活动产生的现金流量净额"'style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'></label>
	...
	<tr style='mso-yfti-irow: 27; height: 17.0pt'>
		...
		<p class=MsoNormal align=right
			style='text-align: right; text-autospace: none'><span lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'><o:p>
			<input onblur='checkFloat(this);' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'');countFaInflowSum();"id="faInflowSum1" field="faInflowLoan" name='"借款所收到的现金"' style="width:98%"  maxlength="15" style='text-align:right;padding-right:2px;' />
			</o:p></span></p>
		</td>
	</tr>
	<tr style='mso-yfti-irow: 28; height: 17.0pt'>
		...
		<p class=MsoNormal align=right
			style='text-align: right; text-autospace: none'><span lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'><o:p>
			<input onblur='checkFloat(this);' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'');countFaInflowSum();"id="faInflowSum2" field="faInflowOthers" name='"收到的其他与筹资活动有关的现金"' style="width:98%" maxlength="15" style='text-align:right;padding-right:2px;'  />
			</o:p></span></p>
		</td>
	</tr>
...
<label id="faInflowSum" field="faInflowSum" name='"现金流入小计"'style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'></label>
	...
	<tr style='mso-yfti-irow: 30; height: 17.0pt'>
		...
		<p class=MsoNormal align=right
			style='text-align: right; text-autospace: none'><span lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'><o:p>
			<input onblur='checkFloat(this);' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'');countfaOutflowSum();" id="faOutflowSum1" field="faOutflowDebt" name='"偿还借款所支付的现金"' style="width:98%"  maxlength="15" style='text-align:right;padding-right:2px;' />
			</o:p></span></p>
		</td>
	</tr>
	<tr style='mso-yfti-irow: 31; height: 16.65pt'>
		...
		<p class=MsoNormal style='text-autospace: none'><span lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'><o:p>
			<input onblur='checkFloat(this);' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'');countfaOutflowSum();" id="faOutflowSum2" field="faOutflowRatio" name='"偿付利息所支付的现金"' style="width:98%" maxlength="15" style='text-align:right;padding-right:2px;'  />
			</o:p></span></p>
		</td>
	</tr>
	<tr style='mso-yfti-irow: 32; height: 17.0pt'>
		...
		<p class=MsoNormal style='text-autospace: none'><span lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'><o:p>
			<input onblur='checkFloat(this);' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'');countfaOutflowSum();" id="faOutflowSum3" field="faOutflowOthers" name='"支付的其他与筹资活动有关的现金"' style="width:98%"  maxlength="15" style='text-align:right;padding-right:2px;' />
			</o:p></span></p>
		</td>
	</tr>
...
<label id="faNetAmount" field="faNetAmount" name='"筹资活动产生的现金流量净额"'style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'></label>
	...
	<tr style='mso-yfti-irow: 35; height: 8.7pt'>
		...
		<p class=MsoNormal align=right
			style='text-align: right; text-autospace: none'><span lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'><o:p>
			<input onblur='checkFloat(this);' id="exchangeRateMovement" onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'');netRevalueationcount()" field="exchangeRateMovement" name='"四、汇率变动对现金的影响额"' style="width:98%"  maxlength="15" style='text-align:right;padding-right:2px;' />
			</o:p></span></p>
		</td>
	</tr>
	<tr style='mso-yfti-irow: 36; mso-yfti-lastrow: yes; height: 17.0pt'>
		...
		<p class=MsoNormal align=right
			style='text-align: right; text-autospace: none'><span lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'><o:p>
			<label id="netRevalueation"  onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'')" field="netRevalueation" name='"五、现金及现金等价物净增加额"'  maxlength="15" style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋' ></label>
			</o:p></span></p>
		</td>
	</tr>
</table>
