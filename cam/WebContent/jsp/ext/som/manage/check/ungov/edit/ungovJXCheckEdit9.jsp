...
<p class=MsoNormal align=right
	...
	style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; line-height: 150%; font-family: 仿宋; mso-hansi-font-family: 仿宋'>单位：
...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0
	...
	<tr style='mso-yfti-irow: 22'>
		...
		<p class=MsoNormal
			...
			lang=EN-US
			style='font-size: 14.0pt; mso-bidi-font-size: 10.5pt; font-family: 仿宋; mso-hansi-font-family: 仿宋'><o:p>
			<input field="limitToUnlimitPyUnlimt" id="限定性净资产转为非限定性净资产1" name='"限定性净资产转为非限定性净资产"' style="width:98%" maxlength="15" style='text-align:right;padding-right:2px;' onblur='checkFloat(this);'onkeyup="value=value.replace(/[^\d.-]/g,'');setSumMoney() " />
			</o:p></span></p>
		</td>
		<td width=57
			style='width: 42.5pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .5pt; mso-border-left-alt: solid windowtext .5pt; mso-border-alt: solid windowtext .5pt; padding: 0cm 5.4pt 0cm 5.4pt'>
