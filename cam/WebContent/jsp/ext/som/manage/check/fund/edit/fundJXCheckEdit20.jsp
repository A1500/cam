...
<model:datasets>
	<model:dataset id="somCheckDataSet" cmd="com.inspur.cams.sorg.jxcheck.somjxcheck.cmd.SomJxCheckQueryCommand" global="true">
		<model:record fromBean="com.inspur.cams.sorg.jxcheck.somjxcheck.dao.SomJxCheck">
			<model:field name="resultAndLack" type="string" rule="require|length{1500}"/>
		</model:record>
	</model:dataset>
</model:datasets>
<div id="float" >
	<input type="button" value="下一页" style="height:25px;width:80px;position:absolute;margin-left:120px;" onclick="nextPageJ('21')"/>
	<input type="button" value="上一页" style="height:25px;width:80px;position:absolute;margin-left:20px;" onclick="lastPageJ('19')"/>
			...
			<TABLE class=f14pt-b1 cellSpacing=0 cellPadding=0 width='100%'
				...
				<TBODY>
					<TR align=middle>
						...
						<textarea name='用文字描述本基金会本年的成绩和不足'
							ROWS='45' COLS='86' CLASS='boder14-0' field='resultAndLack'></textarea></TD>
					</TR>
				</TBODY>
			</TABLE>
			</TD>
