	...
	somJxPeopleDataSet.setParameter("TASK_CODE", taskCode);
				...
				somJxPeopleDataSet.on('load',function (){
					...
					somJxPeopleDataSet.each(function(record, index){
						document.getElementById("aboveCountyNum").value = record.get("aboveCountyNum");
						document.getElementById("npcNum").value = record.get("npcNum");
						document.getElementById("cppccNum").value = record.get("cppccNum");
						document.getElementById("partyNumNation").value = record.get("partyNumNation");
						document.getElementById("partyNumProvince").value = record.get("partyNumProvince");
						document.getElementById("npcNumNation").value = record.get("npcNumNation");
						document.getElementById("npcNumProvince").value = record.get("npcNumProvince");
						document.getElementById("cppccNumNation").value = record.get("cppccNumNation");
						document.getElementById("cppccNumProvince").value = record.get("cppccNumProvince");
					});
				});
	//创建页面导航下拉框
...
function save(){
	...
	somJxPeopleRecord.set("aboveCountyNum",document.getElementById("aboveCountyNum").value);
	somJxPeopleRecord.set("npcNum",document.getElementById("npcNum").value);
	somJxPeopleRecord.set("cppccNum",document.getElementById("cppccNum").value);
	somJxPeopleRecord.set("partyNumNation",document.getElementById("partyNumNation").value);
	somJxPeopleRecord.set("partyNumProvince",document.getElementById("partyNumProvince").value);
	somJxPeopleRecord.set("npcNumNation",document.getElementById("npcNumNation").value);
	somJxPeopleRecord.set("npcNumProvince",document.getElementById("npcNumProvince").value);
	somJxPeopleRecord.set("cppccNumNation",document.getElementById("cppccNumNation").value);
	somJxPeopleRecord.set("cppccNumProvince",document.getElementById("cppccNumProvince").value);
...
<model:datasets>
	<model:dataset id="somCheckDataSet" cmd="com.inspur.cams.sorg.jxcheck.somjxcheck.cmd.SomJxCheckQueryCommand" global="true">
		<model:record fromBean="com.inspur.cams.sorg.jxcheck.somjxcheck.dao.SomJxCheck">
			...
			<model:field name="specialFunds" type="string" rule="require" />
			...
			<model:field name="taxCode" type="string" rule="require" />
		</model:record>
	</model:dataset>
				...
				<TBODY>
					...
					<tr>
						...
						<TD height=30 colspan='2' class=unnamed2><input field="sorgCode"
							name='登记证号' value=''
							CLASS='boder-0' SIZE='30' MAXLENGTH='20' ></TD>
					...
					<TR>
							...
							<TBODY>
								<TR>
									<TD class=unnamed4 width='55%'>
										<input id="aboveCountyNum" name='从业人员中担任党代表人数' value='' CLASS='boder-0' onKeyUp="value=value.replace(/[^\d]/g,'')" SIZE='10' maxlength='10' ></TD>
									<TD align=middle width='45%'>
						...
						<TD class=unnamed2 align=middle height=30><input id="partyNumProvince"
							name='省级及以下担任党代表人数' value=''
							CLASS='boder-0' SIZE='10' maxlength='10' ></TD>
						<TD height=30 colspan='2' class=unnamed3>
						<TABLE height=40 cellSpacing=0 cellPadding=0 width='100%' border=0>
							<TBODY>
								<TR>
									<TD width='70%' height='31' align=middle class=unnamed4>全国性的担任党代表人数</TD>
									<TD align=middle><input id="partyNumNation"  onKeyUp="value=value.replace(/[^\d]/g,'')"
										name='全国性的担任党代表人数' value=''
										CLASS='boder-0' SIZE='6' maxlength='6' ></TD>
								</TR>
							</TBODY>
						</TABLE>
					...
					<TR>
						...
						<TABLE height=40 cellSpacing=0 cellPadding=0 width='100%' border=0>
							<TBODY>
								<TR>
									<TD class=unnamed4 width='55%'>
										<input id="npcNum" name='从业人员中担任人大代表人数' value='' CLASS='boder-0' onKeyUp="value=value.replace(/[^\d]/g,'')" SIZE='10' maxlength='10' ></TD>
									<TD align=middle width='45%'>
									<div align='center'>省级及以下<br>
									担任人大代表人数</div>
									</TD>
						...
						<TD class=unnamed2 align=middle height=30><input id="npcNumProvince"
							name='省级及以下担任人大代表人数' value=''
							CLASS='boder-0' SIZE='10' maxlength='10' ></TD>
						<TD height=30 colspan='2' class=unnamed3>
						<TABLE height=40 cellSpacing=0 cellPadding=0 width='100%' border=0>
							<TBODY>
								<TR>
									<TD width='70%' height='31' align=middle class=unnamed4>全国性的担任人大代表人数</TD>
									<TD align=middle><input id="npcNumNation"  onKeyUp="value=value.replace(/[^\d]/g,'')"
										name='全国性的担任人大代表人数' value=''
										CLASS='boder-0' SIZE='6' maxlength='6' ></TD>
								</TR>
							</TBODY>
						</TABLE>
					...
					<TR>
						...
						<TABLE height=40 cellSpacing=0 cellPadding=0 width='100%' border=0>
							<TBODY>
								<TR>
									<TD class=unnamed4 width='55%'>
										<input id="cppccNum" name='从业人员中担任政协委员人数' value='' CLASS='boder-0' onKeyUp="value=value.replace(/[^\d]/g,'')" SIZE='10' maxlength='10' ></TD>
									<TD align=middle width='45%'>
									<div align='center'>省级及以下<br>
									担任政协委员人数</div>
									</TD>
						...
						<TD class=unnamed2 align=middle height=30><input id="cppccNumProvince"
							name='省级及以下担任政协委员人数' value=''
							CLASS='boder-0' SIZE='10' maxlength='10' ></TD>
						<TD height=30 colspan='2' class=unnamed3>
						<TABLE height=40 cellSpacing=0 cellPadding=0 width='100%' border=0>
							<TBODY>
								<TR>
									<TD width='70%' height='31' align=middle class=unnamed4>全国性的担任政协委员人数</TD>
									<TD align=middle><input id="cppccNumNation"  onKeyUp="value=value.replace(/[^\d]/g,'')"
										name='全国性的担任政协委员人数' value=''
										CLASS='boder-0' SIZE='6' maxlength='6' ></TD>
								</TR>
							</TBODY>
						</TABLE>
					...
					<TR>
						...
						<TABLE height=30 cellSpacing=0 cellPadding=0 width='100%' border=0>
							<TBODY>
								<TR>
									<TD><input field="specialFunds"
										name='专项基金数' value=''
										 size='8' onKeyUp="value=value.replace(/[^\d.]/g,'')"
										 onblur='checkFloat(this);' maxlength='8' CLASS='boder-0' >元</TD>
								</TR>
							</TBODY>
						</TABLE>
						</TD>
					...
					<TR>
						...
						<TD colSpan=5 height=30><input field="taxCode"
							name='税务登记证号码' value=''
