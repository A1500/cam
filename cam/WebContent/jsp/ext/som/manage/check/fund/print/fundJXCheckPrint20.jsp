...
<TABLE cellSpacing=0 cellPadding=0 width=645 align=center border=0>
	<TBODY>
		...
		<TR>
			...
			<TABLE class=f14pt-b1 cellSpacing=0 cellPadding=0 width=700
				border=0>
				<TBODY>
					<TR align=middle>
						<TD vAlign=top colSpan=3 height=700>
						...
						<textarea name='query$form$0$JJHNJ_CHENGJISHUOMING_SUB$chengji$1'
							ROWS='45' COLS='80' CLASS='boder14-0' field='resultAndLack'></textarea>
							</span></TD>
					</TR>
				</TBODY>
			</TABLE>
...
<TABLE align='center'>
	<tr valign=bottom align='center'>
		<td width=645 height='27' align=center valign=bottom><br>
		</td>
	</tr>
</TABLE>
