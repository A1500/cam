...
function processBar(){
	...
	progressId = setInterval(function(){
			if(PROGRESS_BAR==21){
				...
				L5.Msg.updateProgress(PROGRESS_BAR/21);
			}
	},100);
}
function init(){
...
<div id="float" class="noprint">
	<input type="button" value="返回" style="height: 25px; width: 80px; position: absolute; margin-left: 20px;" onclick="backJ();" />
...
<TABLE class='word-st-14 border-tl' id=table1 cellSpacing=0
	...
	<TBODY>
		<TR>
			<TD align=middle width='220' height=24><STRONG>捐赠人</STRONG></TD>
			<TD align=middle width='120'height=24><STRONG>本年捐赠额（<span style="color:red">元</span>）</STRONG></TD>
			<TD align=middle width='360'height=24><STRONG>用途</STRONG></TD>
		</TR>
		<TR>
...
<jsp:include page="fundJXCheckPrint17.jsp" flush="true"/>
<jsp:include page="fundJXCheckPrint18.jsp" flush="true"/>
<jsp:include page="fundJXCheckPrint19.jsp" flush="true"/>
<jsp:include page="fundJXCheckPrint20.jsp" flush="true"/>
<jsp:include page="fundJXCheckPrint21.jsp" flush="true"/>
<jsp:include page="fundJXCheckPrint22.jsp" flush="true"/>
<jsp:include page="fundJXCheckPrint23.jsp" flush="true"/>
<jsp:include page="fundJXCheckPrint24.jsp" flush="true"/>
<jsp:include page="fundJXCheckPrint25.jsp" flush="true"/>
<jsp:include page="fundJXCheckPrint26.jsp" flush="true"/>
<jsp:include page="fundJXCheckPrint27.jsp" flush="true"/>
<jsp:include page="fundJXCheckPrint28.jsp" flush="true"/>
<jsp:include page="fundJXCheckPrint29.jsp" flush="true"/>
<jsp:include page="fundJXCheckPrint30.jsp" flush="true"/>
</body>
</html>