		...
		<script language="javascript">
			...
			function init(){
				if(method=="INSERT"){
					...
					somCheckDataSet.newRecord({"taskCode":taskCode,"reportDate":date,"cnName":'<%=username%>',"checkYear":year,"sorgType":'J',"status":"0","fillPeopleName":'<%=username%>',"fillPeopleId":'<%=peopleId%>',"fillPeopleArea":'<%=peopleArea%>',"currentActivity":'0'});
					changeYear();
				}else{
