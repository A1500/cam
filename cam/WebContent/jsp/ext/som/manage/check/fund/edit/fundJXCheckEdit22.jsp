...
function save(){
	...
	somJxCheckBusinessActivityRecord.set("donationIncomePyUnlimit",document.getElementById('mojuanfeixian').value);
	somJxCheckBusinessActivityRecord.set("donationIncomePyLimit",document.getElementById('mojuanxian').value);
	somJxCheckBusinessActivityRecord.set("donationIncomePySum",document.getElementById('mojuanheji').value);
	somJxCheckBusinessActivityRecord.set("donationIncomeTyUnlimit",document.getElementById('leijijuanfeixian').value);
	somJxCheckBusinessActivityRecord.set("donationIncomeTyLimit",document.getElementById('leijijuanxian').value);
	somJxCheckBusinessActivityRecord.set("donationIncomeTySum",document.getElementById('leijijuanheji').value);
	somJxCheckBusinessActivityRecord.set("duesIncomePyUnlimit",document.getElementById('mohuifeixian').value);
	somJxCheckBusinessActivityRecord.set("duesIncomePyLimit",document.getElementById('mohuixian').value);
	somJxCheckBusinessActivityRecord.set("duesIncomePySum",document.getElementById('mohuiheji').value);
	somJxCheckBusinessActivityRecord.set("duesIncomeTyUnlimit",document.getElementById('leijihuifeixian').value);
	somJxCheckBusinessActivityRecord.set("duesIncomeTyLimit",document.getElementById('leijihuixian').value);
	somJxCheckBusinessActivityRecord.set("duesIncomeTySum",document.getElementById('leijihuiheji').value);
	somJxCheckBusinessActivityRecord.set("serviceIncomePyUnlimit",document.getElementById('mofuwufeixian').value);
	somJxCheckBusinessActivityRecord.set("serviceIncomePyLimit",document.getElementById('mofuwuxian').value);
	somJxCheckBusinessActivityRecord.set("serviceIncomePySum",document.getElementById('mofuwuheji').value);
	somJxCheckBusinessActivityRecord.set("serviceIncomeTyUnlimit",document.getElementById('leijifuwufeixian').value);
	somJxCheckBusinessActivityRecord.set("serviceIncomeTyLimit",document.getElementById('leijifuwuxian').value);
	somJxCheckBusinessActivityRecord.set("serviceIncomeTySum",document.getElementById('leijifuwuheji').value);
	somJxCheckBusinessActivityRecord.set("productIncomePyUnlimit",document.getElementById('moxiaoshoufeixian').value);
	somJxCheckBusinessActivityRecord.set("productIncomePyLimit",document.getElementById('moxiaoshouxian').value);
	somJxCheckBusinessActivityRecord.set("productIncomePySum",document.getElementById('moxiaoshouheji').value);
	somJxCheckBusinessActivityRecord.set("productIncomeTyUnlimit",document.getElementById('leijixiaoshoufeixian').value);
	somJxCheckBusinessActivityRecord.set("productIncomeTyLimit",document.getElementById('leijixiaoshouxian').value);
	somJxCheckBusinessActivityRecord.set("productIncomeTySum",document.getElementById('leijixiaoshouheji').value);
	somJxCheckBusinessActivityRecord.set("govGrantsPyUnlimit",document.getElementById('mobuzhufeixian').value);
	somJxCheckBusinessActivityRecord.set("govGrantsPyLimit",document.getElementById('mobuzhuxian').value);
	somJxCheckBusinessActivityRecord.set("govGrantsPySum",document.getElementById('mobuzhuheji').value);
	somJxCheckBusinessActivityRecord.set("govGrantsTyUnlimit",document.getElementById('leijibuzhufeixian').value);
	somJxCheckBusinessActivityRecord.set("govGrantsTyLimit",document.getElementById('leijibuzhuxian').value);
	somJxCheckBusinessActivityRecord.set("govGrantsTySum",document.getElementById('leijibuzhuheji').value);
	somJxCheckBusinessActivityRecord.set("invIncomePyUnlimit",document.getElementById('motouzifeixian').value);
	somJxCheckBusinessActivityRecord.set("invIncomePyLimit",document.getElementById('motouzixian').value);
	somJxCheckBusinessActivityRecord.set("invIncomePySum",document.getElementById('motouziheji').value);
	somJxCheckBusinessActivityRecord.set("invIncomeTyUnlimit",document.getElementById('leijitouzifeixian').value);
	somJxCheckBusinessActivityRecord.set("invIncomeTyLimit",document.getElementById('leijitouzixian').value);
	somJxCheckBusinessActivityRecord.set("invIncomeTySum",document.getElementById('leijitouziheji').value);
	somJxCheckBusinessActivityRecord.set("otherIncomePyUnlimit",document.getElementById('moqitafeixian').value);
	somJxCheckBusinessActivityRecord.set("otherIncomePyLimit",document.getElementById('moqitaxian').value);
	somJxCheckBusinessActivityRecord.set("otherIncomePySum",document.getElementById('moqitaheji').value);
	somJxCheckBusinessActivityRecord.set("otherIncomeTyUnlimit",document.getElementById('leijiqitafeixian').value);
	somJxCheckBusinessActivityRecord.set("otherIncomeTyLimit",document.getElementById('leijiqitaxian').value);
	somJxCheckBusinessActivityRecord.set("otherIncomeTySum",document.getElementById('leijiqitaheji').value);
	somJxCheckBusinessActivityRecord.set("incomeSumPyUnlimit",document.getElementById('mohejifeixian').value);
	somJxCheckBusinessActivityRecord.set("incomeSumPyLimit",document.getElementById('mohejixian').value);
	somJxCheckBusinessActivityRecord.set("incomeSumPySum",document.getElementById('mohejiheji').value);
	somJxCheckBusinessActivityRecord.set("incomeSumTyUnlimit",document.getElementById('leijihejifeixian').value);
	somJxCheckBusinessActivityRecord.set("incomeSumTyLimit",document.getElementById('leijihejixian').value);
	somJxCheckBusinessActivityRecord.set("incomeSumTySum",document.getElementById('leijihejiheji').value);
	somJxCheckBusinessActivityRecord.set("businessCostPyUnlimit",document.getElementById('mochengbenfeixian').value);
	somJxCheckBusinessActivityRecord.set("businessCostPyLimit",document.getElementById('mochengbenxian').value);
	somJxCheckBusinessActivityRecord.set("businessCostPySun",document.getElementById('mochengbenheji').value);
	somJxCheckBusinessActivityRecord.set("businessCostTyUnlimit",document.getElementById('leijichengbenfeixian').value);
	somJxCheckBusinessActivityRecord.set("businessCostTyLimit",document.getElementById('leijichengbenxian').value);
	somJxCheckBusinessActivityRecord.set("businessCostTySum",document.getElementById('leijichengbenheji').value);
	somJxCheckBusinessActivityRecord.set("publicWelfarrePyUnlimit",document.getElementById('moqizhongfeixian1').value);
	somJxCheckBusinessActivityRecord.set("publicWelfarrePyLimit",document.getElementById('moqizhongxian1').value);
	somJxCheckBusinessActivityRecord.set("publicWelfarrePySum",document.getElementById('moqizhongheji1').value);
	somJxCheckBusinessActivityRecord.set("publicWelfarreTyUnlimit",document.getElementById('leijiqizhongfeixian1').value);
	somJxCheckBusinessActivityRecord.set("publicWelfarreTyLimit",document.getElementById('leijiqizhongxian1').value);
	somJxCheckBusinessActivityRecord.set("publicWelfarreTySum",document.getElementById('leijiqizhongheji1').value);
	somJxCheckBusinessActivityRecord.set("staffCostPyUnlimit",document.getElementById('moqizhongfeixian2').value);
	somJxCheckBusinessActivityRecord.set("staffCostPyLimit",document.getElementById('moqizhongxian2').value);
	somJxCheckBusinessActivityRecord.set("staffCostPySum",document.getElementById('moqizhongheji2').value);
	somJxCheckBusinessActivityRecord.set("staffCostTyUnlimit",document.getElementById('leijiqizhongfeixian2').value);
	somJxCheckBusinessActivityRecord.set("staffCostTyLimit",document.getElementById('leijiqizhongxian2').value);
	somJxCheckBusinessActivityRecord.set("staffCostTySum",document.getElementById('leijiqizhongheji2').value);
	somJxCheckBusinessActivityRecord.set("runningCostPyUnlimit",document.getElementById('moqizhongfeixian3').value);
	somJxCheckBusinessActivityRecord.set("runningCostPyLimit",document.getElementById('moqizhongxian3').value);
	somJxCheckBusinessActivityRecord.set("runningCostPySum",document.getElementById('moqizhongheji3').value);
	somJxCheckBusinessActivityRecord.set("runningCostTyUnlimit",document.getElementById('leijiqizhongfeixian3').value);
	somJxCheckBusinessActivityRecord.set("runningCostTyLimit",document.getElementById('leijiqizhongxian3').value);
	somJxCheckBusinessActivityRecord.set("runningCostTySum",document.getElementById('leijiqizhongheji3').value);
	somJxCheckBusinessActivityRecord.set("depreciationAssetsPyUnlimit",document.getElementById('moqizhongfeixian4').value);
	somJxCheckBusinessActivityRecord.set("depreciationAssetsPyLimit",document.getElementById('moqizhongxian4').value);
	somJxCheckBusinessActivityRecord.set("depreciationAssetsPySum",document.getElementById('moqizhongheji4').value);
	somJxCheckBusinessActivityRecord.set("depreciationAssetsTyUnlimit",document.getElementById('leijiqizhongfeixian4').value);
	somJxCheckBusinessActivityRecord.set("depreciationAssetsTyLimit",document.getElementById('leijiqizhongxian4').value);
	somJxCheckBusinessActivityRecord.set("depreciationAssetsTySum",document.getElementById('leijiqizhongheji4').value);
	somJxCheckBusinessActivityRecord.set("manageCostPyUnlimit",document.getElementById('moguanlifeixian').value);
	somJxCheckBusinessActivityRecord.set("manageCostPyLimit",document.getElementById('moguanlixian').value);
	somJxCheckBusinessActivityRecord.set("manageCostPySum",document.getElementById('moguanliheji').value);
	somJxCheckBusinessActivityRecord.set("manageCostTyUnlimit",document.getElementById('leijiguanlifeixian').value);
	somJxCheckBusinessActivityRecord.set("manageCostTyLimit",document.getElementById('leijiguanlixian').value);
	somJxCheckBusinessActivityRecord.set("manageCostTySum",document.getElementById('leijiguanliheji').value);
	somJxCheckBusinessActivityRecord.set("raisingCostPyUnlimit",document.getElementById('mochouzifeixian').value);
	somJxCheckBusinessActivityRecord.set("raisingCostPyLimit",document.getElementById('mochouzixian').value);
	somJxCheckBusinessActivityRecord.set("raisingCostPySum",document.getElementById('mochouziheji').value);
	somJxCheckBusinessActivityRecord.set("raisingCostTyUnlimit",document.getElementById('leijichouzifeixian').value);
	somJxCheckBusinessActivityRecord.set("raisingCostTyLimit",document.getElementById('leijichouzixian').value);
	somJxCheckBusinessActivityRecord.set("raisingCostTySum",document.getElementById('leijichouziheji').value);
	somJxCheckBusinessActivityRecord.set("otherCostPyUnlimit",document.getElementById('moqitafeiyongfei').value);
	somJxCheckBusinessActivityRecord.set("otherCostPyLimit",document.getElementById('moqitafeiyongxian').value);
	somJxCheckBusinessActivityRecord.set("otherCostPySum",document.getElementById('moqitafeiyongheji').value);
	somJxCheckBusinessActivityRecord.set("otherCostTyUnlimit",document.getElementById('leijiqitafeiyongfeixian').value);
	somJxCheckBusinessActivityRecord.set("otherCostTyLimit",document.getElementById('leijiqitafeiyongxian').value);
	somJxCheckBusinessActivityRecord.set("otherCostTySum",document.getElementById('leijiqitafeiyongheji').value);
	somJxCheckBusinessActivityRecord.set("costSumPyUnlimit",document.getElementById('mofeiyonghejifei').value);
	somJxCheckBusinessActivityRecord.set("costSumPyLimit",document.getElementById('mofeiyonghejixian').value);
	somJxCheckBusinessActivityRecord.set("costSumPySum",document.getElementById('mofeiyonghejiheji').value);
	somJxCheckBusinessActivityRecord.set("costSumTyUnlimit",document.getElementById('leijifeiyonghejifei').value);
	somJxCheckBusinessActivityRecord.set("costSumTyLimit",document.getElementById('leijifeiyonghejixian').value);
	somJxCheckBusinessActivityRecord.set("costSumTySum",document.getElementById('leijifeiyonghejiheji').value);
	somJxCheckBusinessActivityRecord.set("limitToUnlimitPyUnlimt",document.getElementById('mozhuanfeixian').value);
	somJxCheckBusinessActivityRecord.set("limitToUnlimitPyLimit",document.getElementById('mozhuanxian').value);
	somJxCheckBusinessActivityRecord.set("limitToUnlimitPySum",document.getElementById('mozhuanheji').value);
	somJxCheckBusinessActivityRecord.set("limitToUnlimitTyUnlimit",document.getElementById('leijizhuanfeixian').value);
	somJxCheckBusinessActivityRecord.set("limitToUnlimitTyLimit",document.getElementById('leijizhuanxian').value);
	somJxCheckBusinessActivityRecord.set("limitToUnlimitTySum",document.getElementById('leijizhuanheji').value);
	somJxCheckBusinessActivityRecord.set("assetsChangePyUnlimit",document.getElementById('mobiandongfeixian').value);
	somJxCheckBusinessActivityRecord.set("assetsChangePyLimit",document.getElementById('mobiandongxian').value);
	somJxCheckBusinessActivityRecord.set("assetsChangePySum",document.getElementById('mobiandongheji').value);
	somJxCheckBusinessActivityRecord.set("assetsChangeTyUnlimit",document.getElementById('leijibiandongfeixian').value);
	somJxCheckBusinessActivityRecord.set("assetsChangeTyLimit",document.getElementById('leijibiandongxian').value);
	somJxCheckBusinessActivityRecord.set("assetsChangeTySum",document.getElementById('leijibiandongheji').value);
...
function setSumFei1(result1){
   ...
   calShouHeji1();
   calJing("mohejifeixian","mofeiyonghejifei","mozhuanfeixian","mobiandongfeixian");
}
...
function calShouHeji11(ele1,ele2,result){
 ...
 function setSumFei2(result1){
   ...
   calShouHeji1();
   calJing("mohejixian","mofeiyonghejixian","mozhuanxian","mobiandongxian");
}
...
function setSumLei1(result1){
   ...
   calLeijiHeji1();
   calJing("leijihejifeixian","leijifeiyonghejifei","leijizhuanfeixian","leijibiandongfeixian");
}
...
function calLeijiHeji11(ele1,ele2,result){
 ...
 function setSumLei2(result1){
   ...
   calLeijiHeji1();
   calJing("leijihejixian","leijifeiyonghejixian","leijizhuanxian","leijibiandongxian");
}
...
//------------------------------其中 上年末数------------------------
 ...
 function calHeji(ele1,ele2,result){
     ...
     function calJing(ele1,ele2,ele3,result){
										...
										<TBODY>
											...
											<TR>
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													onblur="checkFloat(this);setSumFei1(1);"
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													onblur="checkFloat(this);setSumFei2(1);"
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													onblur="checkFloat(this);setSumLei1(1);"
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													onblur="checkFloat(this);setSumLei2(1);"
											...
											<TR>
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													isMoney='true' style='text-align:right;padding-right:2px;'
													onblur="checkFloat(this);setSumFei1(2);"
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													style='text-align:right;padding-right:2px;' CLASS='boder-cal1' SIZE='14'
													onblur="checkFloat(this);setSumFei2(2);"
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													MAXLENGTH='15' CLASS='boder12-0' SIZE='14'
													onblur="checkFloat(this);setSumLei1(2);"
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													name='会费收入' MAXLENGTH='15' isMoney='true'
													style='text-align:right;padding-right:2px;' CLASS='boder12-0' SIZE='14'
													onblur="checkFloat(this);setSumLei2(2);"
											...
											<TR>
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													style='text-align:right;padding-right:2px;' SIZE='14'
													onblur="checkFloat(this);setSumFei1(3);"
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													name='提供服务收入' MAXLENGTH='15' CLASS='boder-cal1' isMoney='true'
													style='text-align:right;padding-right:2px;' SIZE='14'
													onblur="checkFloat(this);setSumFei2(3);"
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													style='text-align:right;padding-right:2px;' SIZE='14'
													onblur="checkFloat(this);setSumLei1(3);"
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													MAXLENGTH='15' CLASS='boder12-0' SIZE='14'
													onblur="checkFloat(this);setSumLei2(3);"
											...
											<TR>
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													isMoney='true' style='text-align:right;padding-right:2px;' SIZE='14'
													onblur="checkFloat(this);setSumFei1(4);"
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													style='text-align:right;padding-right:2px;' CLASS='boder-cal1' SIZE='14'
													onblur="checkFloat(this);setSumFei2(4);"
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													style='text-align:right;padding-right:2px;' CLASS='boder12-0' SIZE='14'
													onblur="checkFloat(this);setSumLei1(4);"
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													value='' name='商品销售收入' MAXLENGTH='15' isMoney='true'
													style='text-align:right;padding-right:2px;' CLASS='boder12-0' SIZE='14'
													onblur="checkFloat(this);setSumLei2(4);"
											...
											<TR>
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													style='text-align:right;padding-right:2px;' SIZE='14'
													onblur="checkFloat(this);setSumFei1(5);"
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													style='text-align:right;padding-right:2px;' CLASS='boder-cal1' SIZE='14'
													onblur="checkFloat(this);setSumFei2(5);"
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													style='text-align:right;padding-right:2px;' CLASS='boder12-0' SIZE='14'
													onblur="checkFloat(this);setSumLei1(5);"
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													style='text-align:right;padding-right:2px;' SIZE='14'
													onblur="checkFloat(this);setSumLei2(5);"
											...
											<TR>
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													isMoney='true' style='text-align:right;padding-right:2px;'
													onblur="checkFloat(this);setSumFei1(6);"
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													style='text-align:right;padding-right:2px;' CLASS='boder-cal1' SIZE='14'
													onblur="checkFloat(this);setSumFei2(6);"
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													SIZE='14' onblur="checkFloat(this);setSumLei1(6);"
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													MAXLENGTH='15' CLASS='boder12-0' SIZE='14'
													onblur="checkFloat(this);setSumLei2(6);"
											...
											<TR>
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													MAXLENGTH='15' CLASS='boder-cal1' SIZE='14'
													onblur="checkFloat(this);setSumFei1(7);"
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													name='其他收入' isMoney='true' style='text-align:right;padding-right:2px;'
													MAXLENGTH='15' CLASS='boder-cal1' SIZE='14'
													onblur="checkFloat(this);setSumFei2(7);"
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													name='其他收入' isMoney='true' style='text-align:right;padding-right:2px;'
													MAXLENGTH='15' CLASS='boder12-0' SIZE='14'
													onblur="checkFloat(this);setSumLei1(7);"
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													style='text-align:right;padding-right:2px;' CLASS='boder12-0' SIZE='14'
													onblur="checkFloat(this);setSumLei2(7);"
											...
											<TR>
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													SIZE='14' onblur="checkFloat(this);setSumYong1(1);"
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													style='text-align:right;padding-right:2px;' CLASS='boder-cal1' SIZE='14'
													onblur="checkFloat(this);setSumYong2(1);"
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													value='' name='业务活动成本' readonly isMoney='true'
													style='text-align:right;padding-right:2px;' MAXLENGTH='15' CLASS='boder12-0'
													SIZE='14' onblur="checkFloat(this);setSumYong3(1);"
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													value='' name='业务活动成本' readonly isMoney='true'
													style='text-align:right;padding-right:2px;' MAXLENGTH='15' CLASS='boder12-0'
													SIZE='14' onblur="checkFloat(this);setSumYong4(1);"
											...
											<TR>
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													isMoney='true' style='text-align:right;padding-right:2px;' SIZE='14'
													onblur="checkFloat(this);setSumQizhong(2,1,4);" field='staffCostPyUnlimit'></TD>
												<TD class=font-cal align=middle width=13% height=30><input
													id='moqizhongxian2' value=''
													name='末其中限2' MAXLENGTH='15' CLASS='boder-cal1' isMoney='true'
													style='text-align:right;padding-right:2px;' SIZE='14'
													onblur="checkFloat(this);setSumQizhong2(2,1,4);" field=staffCostPyLimit></TD>
												<TD class=font-cal width=13% height=30><input
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													style='text-align:right;padding-right:2px;' CLASS='boder12-0' SIZE='14'
													onblur="checkFloat(this);setSumQizhongLei(2,1,4);" field=staffCostTyUnlimit></TD>
												<TD class=font12size2 align=middle width=13% height=30><input
													id='leijiqizhongxian2'
													value='' name='累计其中限2' MAXLENGTH='15' isMoney='true'
													style='text-align:right;padding-right:2px;' CLASS='boder12-0' SIZE='14'
													onblur="checkFloat(this);setSumQizhongLei2(2,1,4);" field=staffCostTyLimit></TD>
												<TD class=font-calend align=middle width=13% height=30><input
											...
											<TR>
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													isMoney='true' style='text-align:right;padding-right:2px;' SIZE='14'
													onblur="checkFloat(this);setSumQizhong(3,1,4);" field=runningCostPyUnlimit></TD>
												<TD class=font-cal align=middle width=13% height=30><input
													id='moqizhongxian3' value=''
													name='末其中限3' MAXLENGTH='15' CLASS='boder-cal1' isMoney='true'
													style='text-align:right;padding-right:2px;' SIZE='14'
													onblur="checkFloat(this);setSumQizhong2(3,1,4);" field=runningCostPyLimit></TD>
												<TD class=font-cal width=13% height=30><input
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													isMoney='true' style='text-align:right;padding-right:2px;' SIZE='14'
													onblur="checkFloat(this);setSumQizhongLei(3,1,4);" field=runningCostTyUnlimit></TD>
												<TD class=font12size2 align=middle width=13% height=30><input
													id='leijiqizhongxian3'
													value='' name='累计其中限3' MAXLENGTH='15' CLASS='boder12-0'
													isMoney='true' style='text-align:right;padding-right:2px;' SIZE='14'
													onblur="checkFloat(this);setSumQizhongLei2(3,1,4);" field=runningCostTyLimit></TD>
												<TD class=font-calend align=middle width=13% height=30><input
											...
											<TR>
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													isMoney='true' style='text-align:right;padding-right:2px;' SIZE='14'
													onblur="checkFloat(this);setSumQizhong(4,1,4);"  field=depreciationAssetsPyUnlimit></TD>
												<TD class=font-cal align=middle width=13% height=30><input
													id='moqizhongxian4' value=''
													name='末其中限4' MAXLENGTH='15' CLASS='boder-cal1' isMoney='true'
													style='text-align:right;padding-right:2px;' SIZE='14'
													onblur="checkFloat(this);setSumQizhong2(4,1,4);"  field=depreciationAssetsPyLimit></TD>
												<TD class=font-cal width=13% height=30><input
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													onblur="checkFloat(this);setSumQizhongLei(4,1,4);"  field=depreciationAssetsTyUnlimit></TD>
												<TD class=font12size2 align=middle width=13% height=30><input
													id='leijiqizhongxian4'
													value='' name='累计其中限4' MAXLENGTH='15' CLASS='boder12-0'
													isMoney='true' style='text-align:right;padding-right:2px;' SIZE='14'
													onblur="checkFloat(this);setSumQizhongLei2(4,1,4);"  field=depreciationAssetsTyLimit></TD>
												<TD class=font-calend align=middle width=13% height=30><input
											...
											<TR>
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													style='text-align:right;padding-right:2px;' SIZE='14'
													onblur="checkFloat(this);setSumYong1(2);"
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													style='text-align:right;padding-right:2px;' CLASS='boder-cal1' SIZE='14'
													onblur="checkFloat(this);setSumYong2(2);"
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													SIZE='14' isMoney='true' style='text-align:right;padding-right:2px;'
													onblur="checkFloat(this);setSumYong3(2);"
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													name='管理费用' MAXLENGTH='15' isMoney='true'
													style='text-align:right;padding-right:2px;' CLASS='boder12-0' SIZE='14'
													onblur="checkFloat(this);setSumYong4(2);"
												...
												<TD class=font-calend align=middle width=13% height=30><input
													...
													name='管理费用' readonly MAXLENGTH='15' isMoney='true'
													style='text-align:right;padding-right:2px;' CLASS='boder-cal1' SIZE='14'
													field="manageCostTySum" style="width: 98%; "
													></TD>
											</TR>
											<TR>
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													style='text-align:right;padding-right:2px;' CLASS='boder-cal1' SIZE='14'
													onblur="checkFloat(this);setSumYong1(3);"
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													style='text-align:right;padding-right:2px;' SIZE='14'
													onblur="checkFloat(this);setSumYong2(3);"
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													style='text-align:right;padding-right:2px;' CLASS='boder12-0' SIZE='14'
													onblur="checkFloat(this);setSumYong3(3);"
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													name='筹资费用' MAXLENGTH='15' isMoney='true'
													style='text-align:right;padding-right:2px;' CLASS='boder12-0' SIZE='14'
													onblur="checkFloat(this);setSumYong4(3);"
											...
											<TR>
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													isMoney='true' style='text-align:right;padding-right:2px;' SIZE='14'
													onblur="checkFloat(this);setSumYong1(4);"
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													style='text-align:right;padding-right:2px;' CLASS='boder-cal1' SIZE='14'
													onblur="checkFloat(this);setSumYong2(4);"
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													isMoney='true' style='text-align:right;padding-right:2px;' SIZE='14'
													onblur="checkFloat(this);setSumYong3(4);"
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													value='' name='其他费用' MAXLENGTH='15' isMoney='true'
													style='text-align:right;padding-right:2px;' CLASS='boder12-0' SIZE='14'
													onblur="checkFloat(this);setSumYong4(4);"
											...
											<TR>
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													style='text-align:right;padding-right:2px;' SIZE='14' onblur="checkFloat(this);setSum(1);setSumYong1()"
												...
												<TD class=font-cal align=middle width=13% height=30><input
													...
													MAXLENGTH='15' CLASS='boder-cal1' SIZE='14'
													onblur="checkFloat(this);setSum(1);setSumYong2()"
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													style='text-align:right;padding-right:2px;' MAXLENGTH='15' CLASS='boder12-0'
													SIZE='14' onblur="checkFloat(this);setSum(2);setSumYong3()"
												...
												<TD class=font12size2 align=middle width=13% height=30><input
													...
													name='限定性净资产转为非限定性净资产' isMoney='true' style='text-align:right;padding-right:2px;'
													MAXLENGTH='15' CLASS='boder12-0' SIZE='14'
													onblur="checkFloat(this);setSum(2);setSumYong4()"
