...
function save(){
	...
	somJxCheckCashFlowRecord.set('baReceiveDonations',document.getElementById('jieshoujuanzeng').value);
	somJxCheckCashFlowRecord.set('baGatherDues',document.getElementById('shouquhuifei').value);
	somJxCheckCashFlowRecord.set('baRenderServices',document.getElementById('tigongfuwu').value);
	somJxCheckCashFlowRecord.set('baSellProduct',document.getElementById('xiaoshoushangpin').value);
	somJxCheckCashFlowRecord.set('baGovernmentGrants',document.getElementById('zhengfubuzhu').value);
	somJxCheckCashFlowRecord.set('baInfolwOthers',document.getElementById('shoudaoqitayewu').value);
	somJxCheckCashFlowRecord.set('baInflowSum',document.getElementById('yewuliuruxiaoji').value);
	somJxCheckCashFlowRecord.set('baDonatedPay',document.getElementById('juanzengzhifu').value);
	somJxCheckCashFlowRecord.set('baPayEmployee',document.getElementById('zhifuyuangong').value);
	somJxCheckCashFlowRecord.set('baProductServices',document.getElementById('shangpinfuwuzhifu').value);
	somJxCheckCashFlowRecord.set('baOutflowOthers',document.getElementById('zhifuqitayewu').value);
	somJxCheckCashFlowRecord.set('baOutflowSum',document.getElementById('yewuliuchuxiaoji').value);
	somJxCheckCashFlowRecord.set('baNetAmount',document.getElementById('yewujinge').value);
	somJxCheckCashFlowRecord.set('iaRegoupingOutlay',document.getElementById('shouhuitouzi').value);
	somJxCheckCashFlowRecord.set('iaMadeIncome',document.getElementById('touzishouyi').value);
	somJxCheckCashFlowRecord.set('iaInflowAssets',document.getElementById('chuzhizichanshouhui').value);
	somJxCheckCashFlowRecord.set('iaInflowOthers',document.getElementById('shoudaoqitatouzi').value);
	somJxCheckCashFlowRecord.set('iaInflowSum',document.getElementById('touziliuruxiaoji').value);
	somJxCheckCashFlowRecord.set('iaOutflowAssets',document.getElementById('goujianzichanzhifu').value);
	somJxCheckCashFlowRecord.set('iaOutflowAbroad',document.getElementById('touzizhifu').value);
	somJxCheckCashFlowRecord.set('iaOutflowOthers',document.getElementById('zhifuqitatouzi').value);
	somJxCheckCashFlowRecord.set('iaOutflowSum',document.getElementById('touziliuchuxiaoji').value);
	somJxCheckCashFlowRecord.set('iaNetAmount',document.getElementById('touzijinge').value);
	somJxCheckCashFlowRecord.set('faInflowLoan',document.getElementById('jiekuanshoudao').value);
	somJxCheckCashFlowRecord.set('faInflowOthers',document.getElementById('shoudaoqitachouzi').value);
	somJxCheckCashFlowRecord.set('faInflowSum',document.getElementById('chouziliuruxiaoji').value);
	somJxCheckCashFlowRecord.set('faOutflowDebt',document.getElementById('jiekuanzhifu').value);
	somJxCheckCashFlowRecord.set('faOutflowRatio',document.getElementById('lixizhifu').value);
	somJxCheckCashFlowRecord.set('faOutflowOthers',document.getElementById('zhifuqitachouzi').value);
	somJxCheckCashFlowRecord.set('faOutflowSum',document.getElementById('chouziliuchuxiaoji').value);
	somJxCheckCashFlowRecord.set('faNetAmount',document.getElementById('chouzijinge').value);
	somJxCheckCashFlowRecord.set('exchangeRateMovement',document.getElementById('huilvyingxiange').value);
	somJxCheckCashFlowRecord.set('netRevalueation',document.getElementById('xianjinzengjiae').value);
							...
							<TBODY>
								<TR>
									...
									<TABLE cellSpacing=0 cellPadding=0 width='100%' border=0>
										<TBODY>
											<TR>
												<TD width='33%' height='41' align=right>单位：<span style="color:red">人民币元</span></TD>
											</TR>
										</TBODY>
									</TABLE>
									</TD>
