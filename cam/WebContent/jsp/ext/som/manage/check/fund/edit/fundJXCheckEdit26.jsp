...
function save(){
	...
	for(i=1;i<=2;i++){
		...
		if(document.getElementById("name"+i).value==""){
			L5.Msg.alert("提示","至少填齐1名监事姓名。如无2名，则下面填无！");
			return "break";
		}
		if(document.getElementById("opinion"+i).value==""){
			L5.Msg.alert("提示","至少填齐1名监事意见。如无2名，则下面填无！");
			return "break";
		}
	}
	var somJxFundPeopleDataSetIsValidate = somJxCheckSupervisorOpinDataSet.isValidate();
...
<div id="float" >
	<input type="button" value="下一页" style="height:25px;width:80px;position:absolute;margin-left:120px;" onclick="nextPageJ('27')"/>
	<input type="button" value="上一页" style="height:25px;width:80px;position:absolute;margin-left:20px;" onclick="lastPageJ('25')"/>
				...
				<TBODY>
					<TR>
						<TD vAlign=top align=left>监事<input
							...
							SIZE='10' style='text-align:center'> :</TD>
					</TR>
					<TR>
