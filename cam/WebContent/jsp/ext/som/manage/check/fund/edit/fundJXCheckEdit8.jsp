...
function addFTr(){
    ...
    newNameTD.style.borderRight="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='mso-line-height-alt: 12.0pt'><span lang=EN-US style='font-size: 14.0pt; font-family: 仿宋'><input id='peopleName"+xuhao+"' type='text' style='width: 100%;' maxlength='30'></span></p>";
    //添加列:登记时间
    ...
    newNameTD.style.borderRight="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='mso-line-height-alt: 12.0pt'><span lang=EN-US style='font-size: 14.0pt; font-family: 仿宋'><input id='sorgCode"+xuhao+"' type='text' style='width: 100%;' maxlength='20'></span></p>";
	//添加列:住所
