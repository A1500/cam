...
<!-- 公募基金会接受捐赠情况 -->
	<model:dataset id="somJxContributeDataSet" cmd="com.inspur.cams.sorg.jxcheck.somjxcontribute.cmd.SomJxContributeQueryCommand" global="true">
		<model:record fromBean="com.inspur.cams.sorg.jxcheck.somjxcontribute.dao.SomJxContribute">
	...
	<model:dataset id="somJxCheckExpenditureDataSet" cmd="com.inspur.cams.sorg.jxcheck.somjxcheckexpenditure.cmd.SomJxCheckExpenditureQueryCommand" global="true">
		<model:record fromBean="com.inspur.cams.sorg.jxcheck.somjxcheckexpenditure.dao.SomJxCheckExpenditure">
			...
			<model:field name="commExpPubRatioTwo" type="string" rule="require" />
			<model:field name="commExpPubRatioThree" type="string" rule="require" />
			<model:field name="commExpPerRatioTwo" type="string" rule="require" />
			<model:field name="commExpPerRatioThree" type="string" rule="require" />
		</model:record>
	</model:dataset>
							...
							<TR>
								...
								<TABLE class=unnamed1 cellSpacing=0 cellPadding=0 width='100%'
									...
									<TBODY>
										...
										<TR>
											<TD class=unnamed2 height=22>公益事业支出占上年度总收入的比例（综合近两年比例，综合近三年比例）</TD>
											<TD class=font-calend align=left height=22>&nbsp;&nbsp;<input
												...
												style='text-align:right;padding-right:2px;' readonly> %
												<br>
												综合两年<input
												name='公墓基金会公益事业支出占上年度总收入的比例--两年综合' value=''
												ID='公益比例' MAXLENGTH='15'  SIZE='15'
												style='text-align:right;padding-right:2px;' field='commExpPubRatioTwo'> %
												<br>
												综合三年<input
												name='公墓基金会公益事业支出占上年度总收入的比例--三年综合' value=''
												ID='公益比例' MAXLENGTH='15'  SIZE='15'
												style='text-align:right;padding-right:2px;' field='commExpPubRatioThree'> %
												</TD>

										</TR>
										<TR>
											<TD class=unnamed4 height=22>工作人员工资福利和行政办公支出占总支出的比例（综合近两年比例，综合近三年比例）</TD>
											<TD class=font-rightdown align=left height=22>&nbsp;&nbsp;<input
												...
												<br>
												综合两年<input
												name='公墓基金会工作人员工资福利和行政办公支出占总支出的比例--两年综合' value=''
												ID='公益比例' MAXLENGTH='15'  SIZE='15'
												style='text-align:right;padding-right:2px;' field='commExpPerRatioTwo'> %
												<br>
												综合三年<input
												name='公墓基金会工作人员工资福利和行政办公支出占总支出的比例--三年综合' value=''
												ID='公益比例' MAXLENGTH='15'  SIZE='15'
												style='text-align:right;padding-right:2px;' field=commExpPerRatioThree> %
												</TD>
										</TR>
									</TBODY>
								</TABLE>
