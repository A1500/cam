	...
	somJxLargeDonationDataSet.on("load",function(ds){
		if(ds.getCount()!=0){
			for(i=1;i<=ds.getCount();i++){
				document.getElementById("donorName"+i).value=ds.getAt(i-1).get("donorName");
...
function save(){
	...
	for(i=1;i<=10;i++){
		...
		var donorName=document.getElementById("donorName"+i).value;
...
<TABLE class='word-st-14 border-tl' id=table1 cellSpacing=0
	...
	<TBODY>
		<TR>
			...
			<TD align=middle height=24><STRONG>本年捐赠额（	<span style="color:red">元</span>）</STRONG></TD>
		...
		<TR>
			<TD height=24>1.<input
				...
				ID='donorName1' CLASS='input-01' SIZE='34' MAXLENGTH='20' >
			</TD>
		...
		<TR>
			<TD height=24>2.<input
				...
				ID='donorName2' CLASS='input-01' SIZE='34' MAXLENGTH='20' >
			</TD>
			<TD align=middle height=24>&nbsp; <input
		...
		<TR>
			<TD height=24>3.<input
				...
				ID='donorName3' CLASS='input-01' SIZE='34' MAXLENGTH='20' >
			</TD>
			<TD align=middle height=24>&nbsp; <input
		...
		<TR>
			<TD height=24>4.<input
				...
				ID='donorName4' CLASS='input-01' SIZE='34' MAXLENGTH='20' >
			</TD>
			<TD align=middle height=24>&nbsp; <input
		...
		<TR>
			<TD height=24>5.<input
				...
				ID='donorName5' CLASS='input-01' SIZE='34' MAXLENGTH='20' >
			</TD>
			<TD align=middle height=24>&nbsp; <input
		...
		<TR>
			<TD height=24>6.<STRONG><input
				...
				ID='donorName6' CLASS='input-01' SIZE='34' MAXLENGTH='20' >
			</STRONG></TD>
		...
		<TR>
			<TD height=24>7.<STRONG><input
				...
				ID='donorName7' CLASS='input-01' SIZE='34' MAXLENGTH='20' >
			</STRONG></TD>
			<TD align=middle height=24>&nbsp; <STRONG><input
		...
		<TR>
			<TD height=24>8.<STRONG><input
				...
				ID='donorName8' CLASS='input-01' SIZE='34' MAXLENGTH='20' >
			</STRONG></TD>
			<TD align=middle height=24>&nbsp; <STRONG><input
		...
		<TR>
			<TD height=24>9.<STRONG><input
				...
				ID='donorName9' CLASS='input-01' SIZE='34' MAXLENGTH='20' >
			</STRONG></TD>
			<TD align=middle height=24>&nbsp; <STRONG><input
		...
		<TR>
			<TD height=24>10.<STRONG><input
				...
				ID='donorName10' CLASS='input-01' SIZE='34' MAXLENGTH='20' >
			</STRONG></TD>
			<TD align=middle height=24>&nbsp; <STRONG><input
