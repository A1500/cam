			...
			for(i=1;i<=somJxOrganFundsDataSet8.getCount();i++){
				...
				for(j=1;j<=somJxOrganFundsDataSet8.getCount();j++){
					if(somJxOrganFundsDataSet8.getAt(j-1).get("seqNum") == i){
						...
						var accountType = somJxOrganFundsDataSet8.getAt(j-1).get("accountType");
						if(accountType == '0'){
							tab.rows[rowLength-1].cells[6].getElementsByTagName("label")[0].innerHTML="否";
						}
						if(accountType == '1'){
							tab.rows[rowLength-1].cells[6].getElementsByTagName("label")[0].innerHTML="基本账户";
						}
						if(accountType == '2'){
							tab.rows[rowLength-1].cells[6].getElementsByTagName("label")[0].innerHTML="一般账户";
						}
			...
			<TABLE class=f14pt-b1 cellSpacing=0 cellPadding=0 width='96%' id="activitiesF8"
				...
				<TBODY>
					<TR align=middle>
						...
						<TD width='10%' align=center class=f14pt-boder2>负责人</TD>
						<TD width='13%' align=center class=f14pt-boder2>登记时间</TD>
