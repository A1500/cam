...
function query(){
	...
	ds.setParameter("SOM_JX_CHECK.SORG_TYPE@=","J");
...
function insert() {
	...
	var url='jsp/ext/som/manage/check/fund/edit/fundJXCheckEdit1.jsp';
	var text = '增加年检';
...
function detail(){
	...
	data.put("taskCode",selected[0].get('taskCode'));
	var url='jsp/ext/som/manage/check/fund/detail/fundJXCheckDetail1.jsp';
	var text = '年检明细';
	L5.forward(url,text,data);
}
function print(){
...
function confirmPrint(){
	...
	var url='';
	if(printPart==1){
		url='jsp/ext/som/manage/check/fund/print/fundJXCheckPrint1.jsp';
	}else{
		url='jsp/ext/som/manage/check/fund/print/fundJXCheckPrint16.jsp';
	}
	var text = '年检明细';
	L5.forward(url,text,data);
}
