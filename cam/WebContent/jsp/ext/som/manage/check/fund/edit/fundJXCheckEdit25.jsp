...
<body>
<model:datasets>
	<model:dataset id="somJxCheckAuditOpinionDataSet" cmd="com.inspur.cams.sorg.jxcheck.somjxcheckauditopinion.cmd.SomJxCheckAuditOpinionQueryCommand" global="true">
		<model:record fromBean="com.inspur.cams.sorg.jxcheck.somjxcheckauditopinion.dao.SomJxCheckAuditOpinion">
			<model:field name="auditOpinion" type="string" rule="require|length{1500}"/>
			<model:field name="auditOrgan" type="string" rule="require" />
			<model:field name="auditPerson" type="string" rule="require" />
...
<div id="float" >
	<input type="button" value="下一页" style="height:25px;width:80px;position:absolute;margin-left:120px;" onclick="nextPageJ('26')"/>
	<input type="button" value="上一页" style="height:25px;width:80px;position:absolute;margin-left:20px;" onclick="lastPageJ('24')"/>
