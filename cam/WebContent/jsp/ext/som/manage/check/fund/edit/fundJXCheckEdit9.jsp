...
function save(){
	...
	for(i=1;i<tab1.rows.length;i++){
		...
		var place=tab1.rows[i].cells[4].getElementsByTagName("textarea")[0].innerHTML;
		var accountType=tab1.rows[i].cells[5].getElementsByTagName("select")[0].value;
		var openAccount=tab1.rows[i].cells[6].getElementsByTagName("textarea")[0].value;
		if(organName==""||peopleName==""||organDate==""||place==""||accountType==""||openAccount==""){
			if(i==1){
				L5.Msg.alert("提示","请至少填齐一行代表机构信息！没有的请填无！");
				return "break";
			}else{
				if(!(organName==""&&peopleName==""&&organDate==""&&place==""&&accountType==""&&openAccount=="")){
					L5.Msg.alert("提示","请至少填齐一行代表机构信息！");
					return "break";
				}			
			}
		}
...
function addFTr(){
    ...
    newNameTD.style.borderRight="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML ="<p class=MsoNormal style='mso-line-height-alt: 12.0pt'><span lang=EN-US style='font-size: 14.0pt; font-family: 仿宋'><textarea id='organName"+xuhao+"' onkeyup='this.value = this.value.slice(0,100)' ROWS='3' COLS='30'></textarea></span></p>"
    //添加列:负责人
    ...
    newNameTD.style.borderRight="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='mso-line-height-alt: 12.0pt'><span lang=EN-US style='font-size: 14.0pt; font-family: 仿宋'><input id='peopleName"+xuhao+"' type='text' style='width: 100%;' maxlength='72'></span></p>";
    //添加列:登记时间
    ...
    newNameTD.style.borderRight="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML ="<p class=MsoNormal style='mso-line-height-alt: 12.0pt'><span lang=EN-US style='font-size: 14.0pt; font-family: 仿宋'><input id='organDate"+xuhao+"' type='text' style='width: 100%;'maxlength='10'></span></p>";
	//添加列:住所
    ...
    newNameTD.style.borderRight="solid windowtext 1.0pt";
    //添加列内容
    newNameTD.innerHTML = "<p class=MsoNormal style='mso-line-height-alt: 12.0pt'><span lang=EN-US style='font-size: 14.0pt; font-family: 仿宋'><textarea id='place"+xuhao+"' type='text' style='width: 100%;' onkeyup='this.value = this.value.slice(0,100)' ROWS='3' COLS='20' ></textarea></span></p>";
	//添加列:账户
