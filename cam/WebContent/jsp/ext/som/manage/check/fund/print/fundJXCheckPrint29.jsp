	...
	somJxCheckInterProjectDataSet.on("load",function(ds){
		if(ds.getCount()==0){
			...
			for(i=0;i<ds.getCount();i++){
				...
				tab.rows[i+2].cells[1].getElementsByTagName("span")[0].innerHTML=record.get("projectName");
				tab.rows[i+2].cells[2].getElementsByTagName("span")[0].innerHTML=record.get("coopOrganName");
				tab.rows[i+2].cells[3].getElementsByTagName("span")[0].innerHTML=record.get("coopOrganNation");
				tab.rows[i+2].cells[4].getElementsByTagName("span")[0].innerHTML=record.get("onProjectFund");
				tab.rows[i+2].cells[5].getElementsByTagName("span")[0].innerHTML=record.get("offProjectFund");
				tab.rows[i+2].cells[6].getElementsByTagName("span")[0].innerHTML=record.get("projectType");
				tab.rows[i+2].cells[7].getElementsByTagName("span")[0].innerHTML=record.get("projectDesc");
			}
		}
		PROGRESS_BAR++;
	});
	...
	somCheckInterMeetingDataSet.on('load',function(ds){
		...
		if(count == 0){
			...
			for(i=0;i<ds.getCount();i++){
				...
				tab.rows[i+1].cells[1].getElementsByTagName("span")[0].innerHTML=record.get("meetingName");
				tab.rows[i+1].cells[2].getElementsByTagName("span")[0].innerHTML=record.get("meetingDate");
				tab.rows[i+1].cells[3].getElementsByTagName("span")[0].innerHTML=record.get("meetingPlace");
				tab.rows[i+1].cells[4].getElementsByTagName("span")[0].innerHTML=record.get("hostOrganName");
				tab.rows[i+1].cells[5].getElementsByTagName("span")[0].innerHTML=record.get("fundsSource");
			}
		}
		PROGRESS_BAR++;
	});
	...
	somCheckInterOrgDataSet.on('load',function(ds){
		...
		if(count == 0){
			...
			for(i=0;i<ds.getCount();i++){
				...
				tab.rows[i+1].cells[1].getElementsByTagName("span")[0].innerHTML=record.get("orgCnName");
				tab.rows[i+1].cells[2].getElementsByTagName("span")[0].innerHTML=record.get("orgEnName");
				tab.rows[i+1].cells[3].getElementsByTagName("span")[0].innerHTML=record.get("joinDate");
				tab.rows[i+1].cells[4].getElementsByTagName("span")[0].innerHTML=record.get("auditOrganName");
				tab.rows[i+1].cells[5].getElementsByTagName("span")[0].innerHTML=record.get("dutyType");
			}
		}
		PROGRESS_BAR++;
	});
...
<TABLE height=465 cellSpacing=0 cellPadding=0 width=644 align=center
	...
	<TBODY>
		...
		<TR>
			<TD vAlign=top align=middle height=5>
		...
		<TR>
			...
			<TABLE id=activitiesInterProject class=unnamed1 cellSpacing=0 cellPadding=0 width='700px'
				border=0>
				<TBODY>
					<TR align=middle>
						...
						<TD class=font12size3 width='30%' rowSpan=2>合作项目内容简介</TD>
					</TR>
					<TR align=middle>
					...
					<TR align=middle>
						<TD class=font12size2 width=31 height=31>
						<label style='text-align:center' CLASS='boder12-0_29'>1</label>
						</TD>
						<TD class=font12size2 height=31><span style='width:100%;text-align:center;word-warp:break-word;word-break:break-all' ></span></TD>
						<TD class=font12size2 height=31><span style='width:100%;text-align:center;word-warp:break-word;word-break:break-all' ></span></TD>
						<TD class=font12size2 height=31>
						<span style='width:100%;text-align:center;word-warp:break-word;word-break:break-all' ></span>
							</TD>
						<TD class=font12size2>
						<span style='width:100%;text-align:center;word-warp:break-word;word-break:break-all' ></span>
						</TD>
						<TD class=font12size2><span style='width:100%;text-align:center;word-warp:break-word;word-break:break-all' ></span></TD>
						<TD class=font12size2>
							<span style='width:100%;text-align:center;word-warp:break-word;word-break:break-all' ></span>
						<TD class=font12size3><span style='width:100%;text-align:center;word-warp:break-word;word-break:break-all' ></span></TD>
					</TR>
					<TR align=middle>
						<TD class=font12size2 width=31 height=31>
						<label style='text-align:center' CLASS='boder12-0_29'>2</label>
						</TD>
						<TD class=font12size2 height=31><span style='width:100%;text-align:center;word-warp:break-word;word-break:break-all' ></span></TD>
						<TD class=font12size2 height=31><span style='width:100%;text-align:center;word-warp:break-word;word-break:break-all' ></span></TD>
						<TD class=font12size2 height=31>
					...
					<TR align=middle>
						<TD class=font12size2 width=31 height=31>
						<label style='text-align:center' CLASS='boder12-0_29'>3</label>
						</TD>
						<TD class=font12size2 height=31><span style='width:100%;text-align:center;word-warp:break-word;word-break:break-all' ></span></TD>
						<TD class=font12size2 height=31><span style='width:100%;text-align:center;word-warp:break-word;word-break:break-all' ></span></TD>
						<TD class=font12size2 height=31>
					...
					<TR align=middle>
						<TD class=font12size2 width=31 height=31>
						<label style='text-align:center' CLASS='boder12-0_29'>4</label>
						</TD>
						<TD class=font12size2 height=31><span style='width:100%;text-align:center;word-warp:break-word;word-break:break-all' ></span></TD>
						<TD class=font12size2 height=31><span style='width:100%;text-align:center;word-warp:break-word;word-break:break-all' ></span></TD>
						<TD class=font12size2 height=31>
					...
					<TR align=middle>
						<TD class=font12size2 width=31 height=31>
						<label style='text-align:center' CLASS='boder12-0_29'>5</label>
						</TD>
						<TD class=font12size2 height=31><span style='width:100%;text-align:center;word-warp:break-word;word-break:break-all' ></span></TD>
						<TD class=font12size2 height=31><span style='width:100%;text-align:center;word-warp:break-word;word-break:break-all' ></span></TD>
						<TD class=font12size2 height=31>
		...
		<TR>
			<TD vAlign=center align=left height=8></TD>
		</TR>
		<TR>
			<TD vAlign=top align=middle height=5>
		...
		<TR>
			<TD vAlign=top height=5>
			<TABLE id=internationalMeeting class=unnamed1 cellSpacing=0 cellPadding=0 width='700px'
				border=0>
				<TBODY>
					<TR align=middle>
					...
					<TR align=middle>
						<TD class=font12size2 height=32><label style='text-align:center;width:100%' CLASS='boder12-0_29'>1</label></TD>
						<TD class=font12size2 height=32><span style='width:100%;text-align:center;word-warp:break-word;word-break:break-all' ></span></TD>
		...
		<TR>
			...
			<TABLE id=internationalOrganization class=unnamed1 cellSpacing=0 cellPadding=0 width='700px'
				border=0>
				<TBODY>
					<TR class=font12size2 align=middle>
						<TD class=font12size2 width='32px' height=32>序号</TD>
						<TD class=font12size2 width='156px' height=32>国际组织名称（中文全称）</TD>
						<TD class=font12size2 width='238px' height=32>国际组织名称（英文全称）</TD>
						<TD class=font12size2 width='78px' height=32>参加时间</TD>
						<TD class=font12size2 width='78px' height=32>批准部门</TD>
						<TD class=font12size3 width='67px'>担任何职务</TD>
					</TR>
					<TR class=font12size2 align=middle>
						<TD class=font12size2 height=31><label style='text-align:center;width:32px' CLASS='boder12-0_29'>1</label></TD>
						<TD class=font12size2 height=31>
						<span style='width:100%;text-align:center;word-warp:break-word;word-break:break-all' ></span>
						<TD class=font12size2 height=31><span style='width:100%;text-align:center;word-warp:break-word;word-break:break-all' ></span></TD>
						<TD class=font12size2 height=31>
							<span style='width:100%;text-align:center;word-warp:break-word;word-break:break-all' ></span></TD>
						<TD class=font12size2><span style='width:100%;text-align:center;word-warp:break-word;word-break:break-all' ></span></TD>
						<TD class=font12size3>
							<span style='width:100%;text-align:center;word-warp:break-word;word-break:break-all' ></span></TD>
					</TR>
