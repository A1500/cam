	...
	somJxCheckMajorDataSet.on('load',function(ds){
		if(ds.getCount()!=0){
			for(i=0;i<ds.getCount();i++){
				...
				tab1.rows[i+1].cells[0].getElementsByTagName("input")[0].value=record.get("projectName");
				tab1.rows[i+1].cells[1].getElementsByTagName("textarea")[0].value=record.get("zahlungsziel");
				tab1.rows[i+1].cells[2].getElementsByTagName("input")[0].value=record.get("expenditureCash");
				tab1.rows[i+1].cells[3].getElementsByTagName("input")[0].value=record.get("ratio");
...
function save(){
	...
	for(i=1;i<=20;i++){
		...
		var projectName=tab1.rows[i].cells[0].getElementsByTagName("input")[0].value;
		var zahlungsziel=tab1.rows[i].cells[1].getElementsByTagName("textarea")[0].value;
		var expenditureCash=tab1.rows[i].cells[2].getElementsByTagName("input")[0].value;
		var ratio=tab1.rows[i].cells[3].getElementsByTagName("input")[0].value;
		var purpose=tab1.rows[i].cells[4].getElementsByTagName("textarea")[0].value;
		if(projectName==""||zahlungsziel==""||expenditureCash==""||ratio==""||purpose==""){
			if(i==1){
				L5.Msg.alert("提示","请至少输入一条重大公益项目大额支付对象信息！没有的请填无！");
				return "break";
			}else{
				if(!(projectName==""&&zahlungsziel==""&&expenditureCash==""&&ratio==""&&purpose=="")){
					L5.Msg.alert("提示","请输入完整的重大公益项目大额支付对象信息！");
					return "break";
				}
			}
		}
...
function setSumMoney(){
	for(var i=1;i<=20;i++){
		document.getElementsByName("query$form$0$JJHNJ_ZHDGYXMDEZHFDX$zhifujine")[0].value
		=setParseFloat("query$form$0$JJHNJ_ZHDGYXMDEZHFDX$zhifujine","query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$zhifujine$"+i);
		document.getElementsByName("query$form$0$JJHNJ_ZHDGYXMDEZHFDX$bili")[0].value
...
function setSum(){
  ...
  var preName = "query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$";
    ...
    var bilisum =0;
    for(i=1;i<=20;i++){
       var obj =  document.all(preName + "zhifujine" +"$" +i);
       var obj1 =  document.all(preName + "bili" +"$" +i);
         if(obj.value != ""){
            totalsum1 += parseFloat(obj.value);
         }
         if(obj1.value != ""){
            bilisum += parseFloat(obj1.value);
         }
      }
    document.all(preName1 + "zhifujine" ).value = (Math.round(totalsum1*1000000))/1000000 ;
    document.all(preName1 + "bili" ).value =    (Math.round(bilisum*1000000))/1000000;
}
</script>
<STYLE>
textarea {
...
<div id="float"><input type="button" value="上一页"
	style="height: 25px; width: 80px; position: absolute; margin-left: 20px;"
	onclick="nextPageJ('18')" /> <input type="button" value="下一页"
	style="height: 25px; width: 80px; position: absolute; margin-left: 120px;"
	onclick="nextPageJ('20')" /> <input type="button" value="保存"
...
<TABLE class='word-st-14 border-tl' id=table1 cellSpacing=0
	...
	<TBODY>
		...
		<TR>
			<TD align=middle width=203 height=32>1、<input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$xiangmumingcheng$1'
				value='' CLASS='input-01'></TD>
			<TD align=middle width=94 height=32><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$daezhifuduixiang$1'
				...
				CLASS='input-01' ROWS='2' COLS='18' limit='46'></textarea></TD>
			<TD align=middle width=111><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$zhifujine$1' value=''
				CLASS='input-01' SIZE='12' MAXLENGTH='15' onblur='checkFloat(this);'onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:right;padding-right:2px;'>
			</TD>
			<TD align=middle width=76><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$bili$1' value=''
				CLASS='input-01' SIZE='5' MAXLENGTH='5' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:center'>
			%</TD>
			<TD align=middle width=160><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$yongtu$1'
				...
				CLASS='input-01' ROWS='2' COLS='22' limit='46'></textarea></TD>
		</TR>
		<TR>
			<TD align=middle height=32>2、<input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$xiangmumingcheng$2'
				value='' CLASS='input-01'></TD>
			<TD align=middle height=32><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$daezhifuduixiang$2'
			...
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$zhifujine$2' value=''
				CLASS='input-01' SIZE='12' MAXLENGTH='15' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:right;padding-right:2px;'>
			</TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$bili$2' value=''
				CLASS='input-01' SIZE='5' MAXLENGTH='5' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:center'>
			%</TD>
			<TD align=middle><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$yongtu$2'
		...
		<TR>
			<TD align=middle height=32>3、<input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$xiangmumingcheng$3'
				value='' CLASS='input-01'></TD>
			<TD align=middle height=32><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$daezhifuduixiang$3'
				...
				CLASS='input-01' ROWS='2' COLS='18' limit='46'></textarea></TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$zhifujine$3' value=''
				CLASS='input-01' SIZE='12' MAXLENGTH='15' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:right;padding-right:2px;'>
			</TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$bili$3' value=''
				CLASS='input-01' SIZE='5' MAXLENGTH='5' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:center'>
			%</TD>
			<TD align=middle><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$yongtu$3'
		...
		<TR>
			<TD align=middle height=32>4、<input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$xiangmumingcheng$4'
				value='' CLASS='input-01'></TD>
			<TD align=middle height=32><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$daezhifuduixiang$4'
				...
				CLASS='input-01' ROWS='2' COLS='18' limit='46'></textarea></TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$zhifujine$4' value=''
				CLASS='input-01' SIZE='12' MAXLENGTH='15' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:right;padding-right:2px;'>
			</TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$bili$4' value=''
				CLASS='input-01' SIZE='5' MAXLENGTH='5' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:center'>
			%</TD>
			<TD align=middle><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$yongtu$4'
		...
		<TR>
			<TD align=middle height=32>5、<input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$xiangmumingcheng$5'
				value='' CLASS='input-01'></TD>
			<TD align=middle height=32><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$daezhifuduixiang$5'
				...
				CLASS='input-01' ROWS='2' COLS='18' limit='46'></textarea></TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$zhifujine$5' value=''
				CLASS='input-01' SIZE='12' MAXLENGTH='15' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:right;padding-right:2px;'>
			</TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$bili$5' value=''
				CLASS='input-01' SIZE='5' MAXLENGTH='5' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:center'>
			%</TD>
			<TD align=middle><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$yongtu$5'
		...
		<TR>
			<TD align=middle height=32>6、<input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$xiangmumingcheng$6'
				value='' CLASS='input-01'></TD>
			<TD align=middle height=32><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$daezhifuduixiang$6'
				...
				CLASS='input-01' ROWS='2' COLS='18' limit='46'></textarea></TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$zhifujine$6' value=''
				CLASS='input-01' SIZE='12' MAXLENGTH='15' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:right;padding-right:2px;'>
			</TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$bili$6' value=''
				CLASS='input-01' SIZE='5' MAXLENGTH='5' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:center'>
			%</TD>
			<TD align=middle><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$yongtu$6'
		...
		<TR>
			<TD align=middle height=32>7、<input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$xiangmumingcheng$7'
				value='' CLASS='input-01'></TD>
			<TD align=middle height=32><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$daezhifuduixiang$7'
				...
				CLASS='input-01' ROWS='2' COLS='18' limit='46'></textarea></TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$zhifujine$7' value=''
				CLASS='input-01' SIZE='12' MAXLENGTH='15' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:right;padding-right:2px;'>
			</TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$bili$7' value=''
				CLASS='input-01' SIZE='5' MAXLENGTH='5' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:center'>
			%</TD>
			<TD align=middle><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$yongtu$7'
		...
		<TR>
			<TD align=middle height=32>8、<input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$xiangmumingcheng$8'
				value='' CLASS='input-01'></TD>
			<TD align=middle height=32><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$daezhifuduixiang$8'
				...
				CLASS='input-01' ROWS='2' COLS='18' limit='46'></textarea></TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$zhifujine$8' value=''
				CLASS='input-01' SIZE='12' MAXLENGTH='15' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:right;padding-right:2px;'>
			</TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$bili$8' value=''
				CLASS='input-01' SIZE='5' MAXLENGTH='5' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:center'>
			%</TD>
			<TD align=middle><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$yongtu$8'
		...
		<TR>
			<TD align=middle height=32>9、<input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$xiangmumingcheng$9'
				value='' CLASS='input-01'></TD>
			<TD align=middle height=32><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$daezhifuduixiang$9'
				...
				CLASS='input-01' ROWS='2' COLS='18' limit='46'></textarea></TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$zhifujine$9' value=''
				CLASS='input-01' SIZE='12' MAXLENGTH='15' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:right;padding-right:2px;'>
			</TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$bili$9' value=''
				CLASS='input-01' SIZE='5' MAXLENGTH='5' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:center'>
			%</TD>
			<TD align=middle><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$yongtu$9'
		...
		<TR>
			<TD align=middle height=32>10、<input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$xiangmumingcheng$10'
				value='' CLASS='input-01'></TD>
			<TD align=middle height=32><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$daezhifuduixiang$10'
				...
				CLASS='input-01' ROWS='2' COLS='18' limit='46'></textarea></TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$zhifujine$10' value=''
				CLASS='input-01' SIZE='12' MAXLENGTH='15' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:right;padding-right:2px;'>
			</TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$bili$10' value=''
				CLASS='input-01' SIZE='5' MAXLENGTH='5' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:center'>
			%</TD>
			<TD align=middle><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$yongtu$10'
		...
		<tr>
			<TD align=middle width=203 height=32>11、<input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$xiangmumingcheng$11'
				value='' CLASS='input-01'></TD>
			<TD align=middle width=94 height=32><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$daezhifuduixiang$11'
				...
				CLASS='input-01' ROWS='2' COLS='18' limit='46'></textarea></TD>
			<TD align=middle width=111><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$zhifujine$11' value=''
				CLASS='input-01' SIZE='12' MAXLENGTH='15' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:right;padding-right:2px;'>
			</TD>
			<TD align=middle width=76><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$bili$11' value=''
				CLASS='input-01' SIZE='5' MAXLENGTH='5' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:center'>
			%</TD>
			<TD align=middle width=160><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$yongtu$11'
		...
		<TR>
			<TD align=middle height=32>12、<input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$xiangmumingcheng$12'
				value='' CLASS='input-01'></TD>
			<TD align=middle height=32><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$daezhifuduixiang$12'
				...
				CLASS='input-01' ROWS='2' COLS='18' limit='46'></textarea></TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$zhifujine$12' value=''
				CLASS='input-01' SIZE='12' MAXLENGTH='15' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:right;padding-right:2px;'>
			</TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$bili$12' value=''
				CLASS='input-01' SIZE='5' MAXLENGTH='5' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:center'>
			%</TD>
			<TD align=middle><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$yongtu$12'
		...
		<TR>
			<TD align=middle height=32>13、<input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$xiangmumingcheng$13'
				value='' CLASS='input-01'></TD>
			<TD align=middle height=32><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$daezhifuduixiang$13'
				...
				CLASS='input-01' ROWS='2' COLS='18' limit='46'></textarea></TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$zhifujine$13' value=''
				CLASS='input-01' SIZE='12' MAXLENGTH='15' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:right;padding-right:2px;'>
			</TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$bili$13' value=''
				CLASS='input-01' SIZE='5' MAXLENGTH='5' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:center'>
			%</TD>
			<TD align=middle><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$yongtu$13'
		...
		<TR>
			<TD align=middle height=32>14、<input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$xiangmumingcheng$14'
				value='' CLASS='input-01'></TD>
			<TD align=middle height=32><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$daezhifuduixiang$14'
				...
				CLASS='input-01' ROWS='2' COLS='18' limit='46'></textarea></TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$zhifujine$14' value=''
				CLASS='input-01' SIZE='12' MAXLENGTH='15' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:right;padding-right:2px;'>
			</TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$bili$14' value=''
				CLASS='input-01' SIZE='5' MAXLENGTH='5' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:center'>
			%</TD>
			<TD align=middle><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$yongtu$14'
		...
		<TR>
			<TD align=middle height=32>15、<input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$xiangmumingcheng$15'
				value='' CLASS='input-01'></TD>
			<TD align=middle height=32><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$daezhifuduixiang$15'
				...
				CLASS='input-01' ROWS='2' COLS='18' limit='46'></textarea></TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$zhifujine$15' value=''
				CLASS='input-01' SIZE='12' MAXLENGTH='15' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:right;padding-right:2px;'>
			</TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$bili$15' value=''
				CLASS='input-01' SIZE='5' MAXLENGTH='5' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:center'>
			%</TD>
			<TD align=middle><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$yongtu$15'
		...
		<TR>
			<TD align=middle height=32>16、<input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$xiangmumingcheng$16'
				value='' CLASS='input-01'></TD>
			<TD align=middle height=32><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$daezhifuduixiang$16'
				...
				CLASS='input-01' ROWS='2' COLS='18' limit='46'></textarea></TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$zhifujine$16' value=''
				CLASS='input-01' SIZE='12' MAXLENGTH='15' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:right;padding-right:2px;'>
			</TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$bili$16' value=''
				CLASS='input-01' SIZE='5' MAXLENGTH='5' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:center'>
			%</TD>
			<TD align=middle><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$yongtu$16'
		...
		<TR>
			<TD align=middle height=32>17、<input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$xiangmumingcheng$17'
				value='' CLASS='input-01'></TD>
			<TD align=middle height=32><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$daezhifuduixiang$17'
				...
				CLASS='input-01' ROWS='2' COLS='18' limit='46'></textarea></TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$zhifujine$17' value=''
				CLASS='input-01' SIZE='12' MAXLENGTH='15' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:right;padding-right:2px;'>
			</TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$bili$17' value=''
				CLASS='input-01' SIZE='5' MAXLENGTH='5' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:center'>
			%</TD>
			<TD align=middle><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$yongtu$17'
		...
		<TR>
			<TD align=middle height=32>18、<input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$xiangmumingcheng$18'
				value='' CLASS='input-01'></TD>
			<TD align=middle height=32><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$daezhifuduixiang$18'
				...
				CLASS='input-01' ROWS='2' COLS='18' limit='46'></textarea></TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$zhifujine$18' value=''
				CLASS='input-01' SIZE='12' MAXLENGTH='15' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:right;padding-right:2px;'>
			</TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$bili$18' value=''
				CLASS='input-01' SIZE='5' MAXLENGTH='5' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:center'>
			%</TD>
			<TD align=middle><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$yongtu$18'
		...
		<TR>
			<TD align=middle height=32>19、<input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$xiangmumingcheng$19'
				value='' CLASS='input-01'></TD>
			<TD align=middle height=32><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$daezhifuduixiang$19'
				...
				CLASS='input-01' ROWS='2' COLS='18' limit='46'></textarea></TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$zhifujine$19' value=''
				CLASS='input-01' SIZE='12' MAXLENGTH='15' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:right;padding-right:2px;'>
			</TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$bili$19' value=''
				CLASS='input-01' SIZE='5' MAXLENGTH='5' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:center'>
			%</TD>
			<TD align=middle><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$yongtu$19'
		...
		<TR>
			<TD align=middle height=32>20、<input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$xiangmumingcheng$20'
				value='' CLASS='input-01'></TD>
			<TD align=middle height=32><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$daezhifuduixiang$20'
				...
				CLASS='input-01' ROWS='2' COLS='18' limit='46'></textarea></TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$zhifujine$20' value=''
				CLASS='input-01' SIZE='12' MAXLENGTH='15' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:right;padding-right:2px;'>
			</TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$bili$20' value=''
				CLASS='input-01' SIZE='5' MAXLENGTH='5' onblur='checkFloat(this);' onKeyUp="value=value.replace(/[^\d.-]/g,'');setSum();" style='text-align:center'>
			%</TD>
			<TD align=middle><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX_SUB$yongtu$20'
		...
		<TR>
			...
			<TD align=middle height=32><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX$daezhifuduixiang'
				...
				CLASS='input-01' ROWS='2' COLS='15' limit='46' style='text-align:right;padding-right:2px;' readonly></textarea></TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX$zhifujine' value=''
				CLASS='input-01' SIZE='14' style='text-align:right;padding-right:2px;' readonly></TD>
			<TD align=middle><input
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX$bili' value='' ID='子表.比例'
				CLASS='input-01' SIZE='5' MAXLENGTH='5'style='text-align:center' readonly> %</TD>
			<TD align=middle><textarea
				name='query$form$0$JJHNJ_ZHDGYXMDEZHFDX$yongtu'
				...
				CLASS='input-01' ROWS='2' COLS='22' limit='46'  style='text-align:right;padding-right:2px;' readonly></textarea></TD>
		</TR>
	</TBODY>
</TABLE>
<TABLE cellSpacing=0 cellPadding=0 width=645 align=center border=0>
