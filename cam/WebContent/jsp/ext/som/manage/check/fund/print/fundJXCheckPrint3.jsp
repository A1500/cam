...
<TABLE class=f14pt-boder1 cellSpacing=0 cellPadding=0 width=700
	align=center border=0>
	<TBODY>
		<TR>
			<TD class=f14pt-boder3 vAlign=top width=700>
			<TABLE height=245 cellSpacing=0 cellPadding=0 width='97%'
				align=center border=0>
				<TBODY>
					<TR>
						<TD height=24 colspan='2' class=word-st-14>1、本基金会于（ <label field='meetingYear' style='width:40;font-size: 11.0pt; font-family: 仿宋'></label>
						&nbsp;）年（ <label field='meetingMonth' style='width:30;font-size: 11.0pt; font-family: 仿宋'></label>
						&nbsp;）月（ <label field='meetingDay' style='width:30;font-size: 11.0pt; font-family: 仿宋'></label>
						&nbsp;）日召开（ <label  field='meetingNumber' style='width:30;font-size: 11.0pt; font-family: 仿宋'></label>
						&nbsp;）届（ <label  field='meetingTimes' style='width:30;font-size: 11.0pt; font-family: 仿宋'></label>
						&nbsp;）次理事会议</TD>
					</TR>
					<!--<TR><TD height=24 colspan='2' class=word-st-14>会议时间： &nbsp; </TD></TR>-->
					<TR>
						<TD height=24 colspan='2' class=word-st-14>会议地点：
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label field='meetingPlace' style='width:500;font-size: 10.0pt; font-family: 仿宋'></label></TD>
					</TR>
					<TR>
						...
						<TD width='87%' class=word-st-14><textarea  field='meetingTheme'  readonly="readonly"
							...
							ID='子表1.会议主题$1'  ROWS='2' COLS='60' limit='100'
							></textarea></TD>
					</TR>
					<TR>
					...
					<TR>
						<TD height=25 colspan='2' align=middle class=word-st-14><textarea  field='meetingResult'
							name='会议决议'ID='子表1.会议决议$1' ROWS='8' COLS='84'
							></textarea></TD>
					</TR>
					<TR>
