...
//初始化
function init15(){
	var somJxCheckExpenditureDataSet15 = L5.DatasetMgr.lookup("somJxCheckExpenditureDataSet15");
	somJxCheckExpenditureDataSet15.setParameter("TASK_CODE@=", taskCode);
	somJxCheckExpenditureDataSet15.load();
	somJxCheckExpenditureDataSet15.on("load",function(ds){
		if(ds.getCount()==0){
			somJxCheckExpenditureDataSet15.newRecord({"taskCode":taskCode});
			PROGRESS_BAR++;
		}
		PROGRESS_BAR++;
	});
...
<model:datasets>
<model:dataset id="somJxCheckExpenditureDataSet15" cmd="com.inspur.cams.sorg.jxcheck.somjxcheckexpenditure.cmd.SomJxCheckExpenditureQueryCommand" global="true">
			...
			<TABLE class=unnamed1 cellSpacing=0 cellPadding=0 width='100%'
				...
				<TBODY>
					<TR>
						...
						<form method="post" dataset="somJxCheckExpenditureDataSet15" onsubmit="return false">
						<TABLE cellSpacing=0 cellPadding=0 width='98%' align=center
							border=0>
							<TBODY>
								<TR>
									<TD height=20>上年度总收入中有时间受限为上年不得使用的限定性收入为 <label
										field='limitTotal' style='border-bottom: solid 1px;width:60;font-size: 14.0pt; font-family: 仿宋;text-align: center'></label>
									（单位：	<span style="color:red">元</span>）,</TD>
								</TR>
								<TR>
									<TD height=20>
									<P>请说明具体情况:</P>
								...
								<TR>
									<TD><textarea readonly="readonly"
										...
										ROWS='7' COLS='90' field='limitExplain' ></textarea></TD>
								</TR>
								<TR>
									<TD>&nbsp;</TD>
								</TR>
								<TR>
									<TD height=20>
									<P>于上年解除时间限定的净资产为 <label field='unlimitTotal'
										style='border-bottom: solid 1px;width:60;font-size: 14.0pt; font-family: 仿宋;text-align: center'></label>
									（单位：	<span style="color:red">元</span>），</P>
									</TD>
								</TR>
								<TR>
								...
								<TR>
									<TD><textarea readonly="readonly"
										...
										ROWS='7' COLS='90' field='unlimitExplain' ></textarea></TD>
								</TR>
								<TR>
									<TD>&nbsp;</TD>
								</TR>
								...
								<TR>
									<TD><textarea readonly="readonly"
										...
										ROWS='7' COLS='90' field='pubExplain' ></textarea></TD>
								</TR>
								<TR>
									<TD>&nbsp;</TD>
								</TR>
								...
								<TR>
									<TD><textarea readonly="readonly"
										...
										ROWS='7' COLS='90' field='perOffExplain' ></textarea></TD>
								</TR>
								<TR>
									<TD>&nbsp;</TD>
								</TR>
								...
								<TR>
									<TD><textarea readonly="readonly"
										...
										COLS='90' field='otherExplain' ></textarea></TD>
								</TR>
								<TR>
									<TD>&nbsp;</TD>
								</TR>
