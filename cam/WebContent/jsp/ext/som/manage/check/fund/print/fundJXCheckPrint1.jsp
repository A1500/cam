			...
			function processBar(){
					...
					progressId = setInterval(function(){
							if(PROGRESS_BAR==16){
								...
								L5.Msg.updateProgress(PROGRESS_BAR/20);
							}
					},100);
			}
		 	//初始化
...
<TABLE height=677 cellSpacing=0 cellPadding=0 width=700 align=center
	border=0>
	<TBODY>
		<TR>
						...
						<TABLE cellSpacing=0 cellPadding=0 width='100%' border=0>
							<TBODY>
								<TR>
									...
									<STRONG><STRONG><label ID='year' field="checkYear" ></label>
