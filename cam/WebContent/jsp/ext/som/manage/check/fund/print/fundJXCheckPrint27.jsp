	...
	<TBODY>
		...
		<TR>
			<TD height=30>（一）是否在登记管理机关指定的媒体上公布上年度工作报告摘要
				<select disabled="disabled" id='ifPutoutReport' style='width:100'><option dataset='comm_yesorno'/></select>
			</TD>
		</TR>
		<TR>
			<TD height=30>（二）是否在其他媒体上公布上年度工作报告
				<select disabled="disabled" id='ifPutoutView' style='width:100'><option dataset='comm_yesorno'/></select>
			</TD>
		</TR>
		<TR>
		...
		<TR>
			<TD vAlign=top>
			<TABLE id=activitiesPublishDetail1 class=unnamed1 cellSpacing=0 cellPadding=0 width=700
				border=0>
				<TBODY>
					<TR align=middle>
						<TD class=unnamed2 width='7%' height=25>序号</TD>
						<TD class=unnamed2 width='38%' height=25>刊载媒体名称</TD>
						<TD class=unnamed2 width='39%' height=25>刊载事项</TD>
						<TD class=unnamed3 width='16%' height=25>刊载日期</TD>
					</TR>
					<TR align=middle>
						<TD class=unnamed2 height=25>1
						</TD>
						<TD class=unnamed2 height=25><textarea disabled="disabled"
						...
						<TD class=unnamed2 height=25><textarea disabled="disabled"
							...
							></textarea></TD>
						<TD class=unnamed3 height=25>
							<input id='' disabled="disabled" format="Y-m-d" onclick="LoushangDate(this);" readonly="readonly" style='text-align:center' CLASS='boder12-0'/>
						</TD>
					</TR>
					<TR align=middle>
						<TD class=unnamed2 height=25>2
						</TD>
						<TD class=unnamed2 height=25><textarea disabled="disabled"
		...
		<TR>
			<TD height=30>（三）公布募捐公告(包括通过义演、义赛、义卖、义展等活动进行募捐)
				<select disabled="disabled" id='ifPutoutFunds' style='width:100'><option dataset='comm_yesorno'/></select>
			</TD>
		</TR>
		<TR>
			<TD height=30> 如选“是”，请说明在哪些媒体上进行公布
				...
				<TBODY>
					...
					<TR align=middle>
						...
						<TD class=unnamed2 height=25><textarea disabled="disabled"
							...
							></textarea></TD>
						<TD class=unnamed3 height=25>
							<input id='' format="Y-m-d" disabled="disabled" onclick="LoushangDate(this);" readonly="readonly" style='text-align:center' CLASS='boder12-0'/>
						</TD>
					</TR>
					<TR align=middle>
						<TD class=unnamed2 height=25>2
		...
		<TR>
			<TD height=30>（四）是否在媒体上公布了内部管理制度（公募基金会填写）
				<select disabled="disabled" id='ifPutoutSys' style='width:100'><option dataset='comm_yesorno'/></select>
			</TD>
		</TR>
		<TR>
			<TD height=30> 如选“是”，请说明在哪些媒体上进行公布
		...
		<TR>
			<TD height=30>（五）在开展募捐以及为突发事件接收的公益捐赠，取得捐赠收入后，是否在自身网站和其他公开媒体上公布详细的收入和支出明细？
				<select disabled="disabled" id='ifPutoutWeb' style='width:100'><option dataset='comm_yesorno'/></select>
		...
		<TR>
			<TD height=30>（六）是否在媒体上公布公益项目的进展情况、资金使用情况
				<select disabled="disabled" id='ifPutoutAdvance' style='width:100'><option dataset='comm_yesorno'/></select>
			</TD>
		</TR>
		<TR>
			<TD height=30> 如选“是”，请说明在哪些媒体上进行公布
