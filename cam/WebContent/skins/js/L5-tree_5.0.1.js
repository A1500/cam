...
var len=recs.length;var add=[];for(var i=0;i<len;i++){var rec=recs[i];if(!this.children.containsKey(rec.id)){var oldparent=rec.parentRecord;if(oldparent){oldparent.remove(rec);}
...
this.showType=shtype;this.checkedOnDblClick=a.checkedOnDblClick||false;var href=a.href?a.href:L5.isGecko?"":"#";var htmlValue=/\<|\>/;if(htmlValue.test(n.text)){n.text=L5.util.Format.htmlEncode(n.text);}
...
if(this.wasLeaf){this.removeClass("l-tree-node-leaf");this.wasLeaf=false;}
...
if(!attributes.singleClickExpand){attributes.singleClickExpand=true;}
...
el.on('dblclick',this.delegateDblClick,this);el.on('contextmenu',this.delegateContextMenu,this);},getNode:function(e){var t;if(t=e.getTarget('.l-tree-node-el',10)){var id=L5.fly(t,'_treeEvents').getAttributeNS('L5','tree-node-id');if(id){return this.tree.getNodeById(id);}}
