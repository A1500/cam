...
public class BspUtil {
	...
	private static ISecurityProvider sp = SecurityFactory
	...
	public static OrganView getParentOrgan() {
		String parentId = op.getListByOrganId(GetBspInfo.getBspInfo()
				.getCorporationOrganId())[0].getParentId();
	...
	public static OrganView[] getSameOrgan() {
		return op.getUnderLingByOrganId(op.getListByOrganId(GetBspInfo
				.getBspInfo().getCorporationOrganId())[0].getParentId(), "1",
				"00");
	}
	...
	public static OrganView[] getUnderOrgan() {
		return op.getUnderLingByOrganId(GetBspInfo.getBspInfo()
				.getCorporationOrganId(), "2", "00");
	}
	...
	public static String getDeptStruId() {
		String departmentOrganId = GetBspInfo.getBspInfo()
				.getDepartmentOrganId();
	...
	/**
	 * 获得当前登录人所在单位上级单位OrganCode
	 */
	public static String getParentOrganCode() {
		StruView[] struView = op.getListByOrganId(getParentOrganId());
		if (struView == null || struView.length <= 0) {
			return "";
		} else {
			return struView[0].getOrganCode();
		}
	}
	 ...
	 * @return
	 */
	public static boolean hasUrlPermit(String url) {
		return sp.hasPermission(url);
	}
}
