...
public class PrsDisabilityQuery5_8Dao extends BaseJdbcDao {

	public PrsDisabilityQuery5_8Dao() {
    ...
    private static class Proc extends Procedure {
        ...
        public Proc(DataSource ds) {
            ...
            super(ds, "BP_PRS_QUERY_DISABILITY_5_8");
            // 声明参数
        ...
        public Map call(String xzqh, String cxsj_q, String cxsj_z) {
            ...
            ResultReader resultReader = new ResultReaderImpl() {
                protected Object mapRow(ResultSet rs, int rowNum) throws SQLException {
                    ...
                    record.set("YZ_5", rs.getString("YZ_5"));
                    record.set("YG_5", rs.getString("YG_5"));
                    
                    record.set("YZ_6", rs.getString("YZ_6"));
                    record.set("YG_6", rs.getString("YG_6"));
                    
                    record.set("YZ_7", rs.getString("YZ_7"));
                    record.set("YG_7", rs.getString("YG_7"));
                    
                    record.set("YZ_8", rs.getString("YZ_8"));
                    record.set("YG_8", rs.getString("YG_8"));
