...
/**
 * @Path com.inspur.cams.fis.base.dao.jdbc.FisResourceTypeDao
 * @Description: TODO 殡葬业务资源分类表dao实现
 * @author wangziming
 * @date 2011-11-15
 */
public class FisResourceTypeDao extends EntityDao<FisResourceType> implements IFisResourceTypeDao {

	public FisResourceTypeDao() throws Exception {
	...
	public DataSet queryForExport(ParameterSet pSet) {
		...
		sqlBuffer.append(" SELECT * FROM FIS_RESOURCE_TYPE O ");
