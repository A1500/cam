...
public class DivorcePeopleTypeQueryDao extends BaseJdbcDao {

    public DivorcePeopleTypeQueryDao() {
    ...
    private static class Proc extends Procedure {
        ...
        public Proc(DataSource ds) {
            ...
            super(ds, "BP_MRM_RPT_DIVORCE_MONTH");
            // 声明参数
 ...
 */
	...
	public DataSet getDataSetForGis(ParameterSet pset) {
		 init();
        DataSet set = new DataSet();
        List results = null;
        Object object = null;
        ...
        String cxsj_z = DateUtil.getMonth();//当前月份
        String cxsj_q = DateUtil.getYear()+"-01";//当前年的一月份
        object = procduce.call(cxsj_q,cxsj_z,xzqu).get("results");
        if (object instanceof ArrayList) {
            results = (List) object;
            for (Object o : results) {
