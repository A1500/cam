 ...
 * @date 2011-6-15
 */
public class SamMedicalTopLineQueryCmd  extends BaseQueryCommand{
	...
	public DataSet execute() {
		...
		DataSet samMBalance= samMedicalTopLineDomain.query(pset);
		...
		for(int i=0;i<samMBalance.getCount();i++){	
			...
			familyRecord.set("topLine", StrUtil.changeTwoDecimal(familyRecord.get("topLine").toString()));
