package com.inspur.cams.drel.application.five.cmd;
 ...
 * 农村五保新申请业务Cmd
 */
public class SamFiveApplyCmd  extends BaseAjaxCommand {
	// 获取SCA组件
	private ISamFiveApplyDomain service = ScaComponentFactory.getService(ISamFiveApplyDomain.class, "samFiveApplyDomain/samFiveApplyDomain");
	/**
	 * 保存五保新申请业务信息
	 */
	...
	public void insertPeopleInfo() {
		...
		BaseinfoFamily baseinfoFamily=service.insertPeopleInfo(baseinfoPeople,(String)getParameter("applyId"));
	...
	public void deletePeopleInfo() {
		...
		BaseinfoFamily baseinfoFamily=service.deletePeopleInfo(delId,familyId);
		setReturn("assistancePeopleNum",baseinfoFamily.getAssistancePeopleNum());
		setReturn("peopleNum",baseinfoFamily.getPeopleNum());
	}
	/**
