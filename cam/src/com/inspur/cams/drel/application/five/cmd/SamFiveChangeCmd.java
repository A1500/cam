 ...
 */
public class SamFiveChangeCmd extends BaseAjaxCommand {
	// 获取SCA组件
	private ISamFiveChangeDomain service = ScaComponentFactory.getService(ISamFiveChangeDomain.class,
			"samFiveChangeDomain/samFiveChangeDomain");
	/**
	 * 保存低保复查变更业务信息
	 */
	...
	public void updatePeopleStats(){
		...
		BaseinfoFamily baseinfoFamily=service.updatePeopleStats(peopleId,familyId,personalStatsTag);
