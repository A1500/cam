...
/**
 * @title:SamEsureyBusinessDao
 * @description:
 * @author:
 * @since:2011-06-29
 * @version:1.0
*/
 public class SamEsureyBusinessDao extends EntityDao<SamEsureyBusiness> implements ISamEsureyBusinessDao{

 	public SamEsureyBusinessDao() throws Exception {
	...
	public Class getEntityClass() {
		return SamEsureyBusiness.class;
	}
   public void deleteStruAll() {
		executeUpdate("delete from SamEsureyBusiness");
	}
   public void delete(String peopleId){
	   String sql="DELETE FROM SAM_ESUREY_BUSINESS WHERE TYPE='1' AND PEOPLE_ID='"+peopleId+"'";
	   executeUpdate(sql);
   }
   public DataSet queryExtBusiness(ParameterSet pset) {
		...
		StringBuffer sql = new StringBuffer(
			"SELECT " +
				...
				"P.CHECK_PEOPLE   "+
			"FROM " +
				"SAM_ESUREY_FAMILY f ,SAM_ESUREY_FEEDBACK p ,SAM_ESUREY_BUSINESS b  " +
