...
/**
 * @title:SamEsureyHousingFundDao
 * @description:
 * @author:
 * @since:2011-06-29
 * @version:1.0
*/
 public class SamEsureyHousingFundDao extends EntityDao<SamEsureyHousingFund> implements ISamEsureyHousingFundDao{

 	public SamEsureyHousingFundDao() throws Exception {
	...
	public Class getEntityClass() {
		return SamEsureyHousingFund.class;
	}
   public void deleteStruAll() {
		executeUpdate("delete from SamEsureyHousingFund");
	}
   public void delete(String peopleId){
	   String sql="DELETE FROM  SAM_ESUREY_HOUSING_FUND WHERE TYPE='1' AND PEOPLE_ID='"+peopleId+"'";
	   executeUpdate(sql);
   }
   public DataSet queryExtHousingFund(ParameterSet pset) {
		...
		StringBuffer sql = new StringBuffer(
			"SELECT " +
				...
				"P.CHECK_PEOPLE   "+
			"FROM " +
				" SAM_ESUREY_FAMILY f , SAM_ESUREY_FEEDBACK p ,SAM_ESUREY_HOUSING_FUND h  " +
				" WHERE  f.FAMILY_ID=p.FAMILY_ID AND  p.FEEDBACK_ID=h.FEEDBACK_ID(+) " +
			" AND  p.CHECK_FLG='1' ");
