...
/**
 * @title:SamEsureyTaxDao
 * @description:
 * @author:
 * @since:2011-06-29
 * @version:1.0
*/
 public class SamEsureyTaxDao extends EntityDao<SamEsureyTax> implements ISamEsureyTaxDao{

 	public SamEsureyTaxDao() throws Exception {
	...
	public Class getEntityClass() {
		return SamEsureyTax.class;
	}
   public void deleteStruAll() {
		executeUpdate("delete from SamEsureyTax");
	}
   public void delete(String peopleId){
	   String sql="DELETE FROM SAM_ESUREY_TAX WHERE TYPE='1' AND PEOPLE_ID='"+peopleId+"'";
	   executeUpdate(sql);
   }
   public DataSet queryGExtTax(ParameterSet pset) {
		...
		StringBuffer sql = new StringBuffer(
			"SELECT " +
				...
				"t.TAXES_PEOPLE," +
				"t.TAXES_ORG," +
				"t.TURNOVER_LATEST_YEAR," +
				"t.TAXES_LATEST_YEAR ," +
				"P.CHECK_TIME,"+
				"P.CHECK_PEOPLE   "+
			"FROM " +
				"SAM_ESUREY_FAMILY f , SAM_ESUREY_FEEDBACK p , SAM_ESUREY_TAX t   " +
				" WHERE f.FAMILY_ID=p.FAMILY_ID AND p.FEEDBACK_ID=t.FEEDBACK_ID(+) " +
				" AND p.CHECK_FLG='1' ");
