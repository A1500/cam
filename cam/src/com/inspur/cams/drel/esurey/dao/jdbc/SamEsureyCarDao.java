...
/**
 * @title:SamEsureyCarDao
 * @description:
 * @author:
 * @since:2011-06-29
 * @version:1.0
*/
 public class SamEsureyCarDao extends EntityDao<SamEsureyCar> implements ISamEsureyCarDao{

 	public SamEsureyCarDao() throws Exception {
	...
	public Class getEntityClass() {
		return SamEsureyCar.class;
	}
   public void deleteStruAll() {
		executeUpdate("delete from SamEsureyCar");
	}
   public void delete(String peopleId){
	   String sql="DELETE FROM SAM_ESUREY_CAR WHERE TYPE='1' AND PEOPLE_ID='"+peopleId+"'";
	   executeUpdate(sql);
   }
   public DataSet queryExtCar(ParameterSet pset) {
		...
		StringBuffer sql = new StringBuffer(
				"SELECT " +
					...
					"P.CHECK_PEOPLE   "+
				"FROM " +
					"SAM_ESUREY_FAMILY f, SAM_ESUREY_FEEDBACK p,SAM_ESUREY_CAR c   " +
					" WHERE f.FAMILY_ID=p.FAMILY_ID  AND  p.FEEDBACK_ID=c.FEEDBACK_ID(+) " +
				" AND  p.CHECK_FLG='1' ");
