...
/**
 * @title:SamEsureySecuritiesDao
 * @description:
 * @author:
 * @since:2011-06-29
 * @version:1.0
*/
 public class SamEsureySecuritiesDao extends EntityDao<SamEsureySecurities> implements ISamEsureySecuritiesDao{

 	public SamEsureySecuritiesDao() throws Exception {
	...
	public Class getEntityClass() {
		return SamEsureySecurities.class;
	}
   public void deleteStruAll() {
		executeUpdate("delete from SamEsureySecurities");
	}
   public void delete(String peopleId){
	   String sql="DELETE FROM SAM_ESUREY_SECURITIES WHERE TYPE='1' AND PEOPLE_ID='"+peopleId+"'";
	   executeUpdate(sql);
   }
   public DataSet queryExtSecurities(ParameterSet pset) {
		...
		StringBuffer sql = new StringBuffer(
			"SELECT " +
				...
				"s.MONEY " +
			"FROM " +
				"SAM_ESUREY_FAMILY f  ,SAM_ESUREY_FEEDBACK p ,SAM_ESUREY_SECURITIES s  " +
				" WHERE f.FAMILY_ID=p.FAMILY_ID AND p.FEEDBACK_ID=s.FEEDBACK_ID(+) " +
			" AND p.CHECK_FLG='1' ");
