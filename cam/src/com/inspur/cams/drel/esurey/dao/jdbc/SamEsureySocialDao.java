...
/**
 * @title:SamEsureySocialDao
 * @description:
 * @author:
 * @since:2011-06-29
 * @version:1.0
*/
 public class SamEsureySocialDao extends EntityDao<SamEsureySocial> implements ISamEsureySocialDao{

 	public SamEsureySocialDao() throws Exception {
	...
	public Class getEntityClass() {
		return SamEsureySocial.class;
	}
   public void deleteStruAll() {
		executeUpdate("delete from SamEsureySocial");
	}
   public void delete(String peopleId){
	   String sql="DELETE FROM  SAM_ESUREY_SOCIAL WHERE TYPE='1' AND PEOPLE_ID='"+peopleId+"'";
	   executeUpdate(sql);
   }
   public DataSet queryExtSocial(ParameterSet pset) {
		...
		StringBuffer sql = new StringBuffer(
				"SELECT " +
					...
					"P.CHECK_PEOPLE   "+
				" FROM " +
					"SAM_ESUREY_FAMILY f , SAM_ESUREY_FEEDBACK p , SAM_ESUREY_SOCIAL s " +
					" WHERE f.FAMILY_ID=p.FAMILY_ID AND  p.FEEDBACK_ID=s.FEEDBACK_ID(+) AND p.CHECK_FLG='1' ");
