package com.inspur.cams.drel.his.city.domain.support;
 ...
 * @date 
 */
public class SamCityHisDomain implements ISamCityHisDomain{	
	@Reference
	...
	public void deleteHisInfoByApplyAndFamilyId(String applyId, String familyId) {
		samApplyInfoDomain.deleteHisInfoByApplyAndFamilyId(applyId,familyId);
	}
	/**
	 * 处理家庭基本信息
	 */
	...
	private void fillApplyInfo(SamApplyInfo applyInfo) {
		...
		applyInfo.setApplyType(SamApplyType.SAM_CITY_HIS);//申请业务类别
	}
	/**
	 * 保存照片
	 * @param photoText
	...
	public void deleteHisPeople(String peopleId, String familyId) {
		samApplyInfoDomain.deleteHisPeople(peopleId,familyId);
