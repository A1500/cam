package com.inspur.cams.drel.his.five.cmd;
 ...
 * @date 
 */
public class SamFiveHisCmd  extends BaseAjaxCommand {
	// 获取SCA组件
	private ISamFiveHisDomain service = ScaComponentFactory.getService(ISamFiveHisDomain.class, "samFiveHisDomain/samFiveHisDomain");
	/**
	 * 保存
	 */
