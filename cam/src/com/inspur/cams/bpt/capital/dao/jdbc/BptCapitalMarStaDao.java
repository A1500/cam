...
/**
 * @title 烈士子女补助标准标准列表dao
 * @author Lin Yangyang
 *
 */
public class BptCapitalMarStaDao extends EntityDao<BptCapitalRetMarSta> implements IBptCapitalMarStaDao{
	/**
	 * 必须写的（前人写好的）
	 * @throws Exception
	 */
	public BptCapitalMarStaDao() throws Exception{
