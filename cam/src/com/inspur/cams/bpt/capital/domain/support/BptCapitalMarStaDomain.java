...
import com.inspur.cams.bpt.capital.dao.IBptCapitalMarStaDao;
...
/**
 * @title 烈士子女补助标准domain
 * @author Lin Yangyang
 *
 */
public class BptCapitalMarStaDomain implements IBptCapitalMarStaDomain{
	@Reference
	private IBptCapitalMarStaDao bptCapitalMarStaDao ;
	/**
	 * 保存功能
	 */
	...
	public DataSet query(ParameterSet pset){
		return bptCapitalMarStaDao.query(pset);
	}
	/**
	 * 获得最大生效日期起
	 * @param pset
	...
	public DataSet getMaxDate(ParameterSet pset){
		...
		DataSet dss =bptCapitalMarStaDao.getMaxDate(params);
		return dss;
	}
}
