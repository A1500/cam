...
public class DemobilizedDao extends BaseJdbcDao {

    public DemobilizedDao() {
    ...
    private static class Proc extends Procedure {
        ...
        public Proc(DataSource ds) {
            ...
            super(ds, "BP_BPT_QUERY_DEMOBILIZED");
            // 声明参数
        ...
        public Map call(String xzqh, String cxsj_q, String cxsj_z) {
            ...
            ResultReader resultReader = new ResultReaderImpl() {
                protected Object mapRow(ResultSet rs, int rowNum) throws SQLException {
                    ...
                    record.set("ANTI_JAPAN", rs.getString("ANTI_JAPAN"));
                    
                    record.set("COUNT_NONANTI", rs.getString("COUNT_NONANTI"));
                    record.set("LIBERATION", rs.getString("LIBERATION"));
                    record.set("AFTER_PRC", rs.getString("AFTER_PRC"));
                    record.set("Korean_War", rs.getString("Korean_War"));
