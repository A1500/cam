...
public class TemporaryHelpDao extends BaseJdbcDao {

	public TemporaryHelpDao() {
	...
	private static class Proc extends Procedure {
		...
		public Proc(DataSource ds) {
			...
			super(ds, "BP_BPT_QUERY_TEMPORARY_HELP");
			//声明参数
		...
		public Map call(String xzqh,String cxsj_q,String cxsj_z,String pxzd,String pxfs) {
			...
			ResultReader resultReader = new ResultReaderImpl() {
				...
				protected Object mapRow(ResultSet rs, int rowNum)
					...
					record.set("war_mon", rs.getBigDecimal("war_mon"));
					record.set("war_avg_mon", rs.getBigDecimal("war_avg_mon"));
					record.set("tested_num", rs.getString("tested_num"));
					record.set("tested_mon", rs.getBigDecimal("tested_mon"));
					record.set("tested_avg_mon", rs.getBigDecimal("tested_avg_mon"));
					return record;
				}
			};
