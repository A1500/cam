...
public class DisabilityAssDevicesDao extends BaseJdbcDao {

    public DisabilityAssDevicesDao() {
    ...
    private static class Proc extends Procedure {
        ...
        public Proc(DataSource ds) {
            ...
            super(ds, "BP_BPT_QUERY_ASSDEVICES");
            // 声明参数
        ...
        public Map call(String xzqh,String cxsj_q,String cxsj_z,String pxzd,String pxfs) {
            ...
            ResultReader resultReader = new ResultReaderImpl() {
                protected Object mapRow(ResultSet rs, int rowNum) throws SQLException {
                    ...
                    record.set("wheelchair_num", rs.getString("wheelchair_num"));
                    record.set("single_shoe_num", rs.getString("single_shoe_num"));
                    record.set("sandals_num", rs.getString("sandals_num"));
                    record.set("upper_limb_num", rs.getString("upper_limb_num"));
                    record.set("thigh_num", rs.getString("thigh_num"));
                    record.set("lower_leg_num", rs.getString("lower_leg_num"));
                    record.set("in_turn_num", rs.getString("in_turn_num"));
