...
public class YouFuTongJiDao extends BaseJdbcDao {

    public YouFuTongJiDao() {
     ...
     * @return
     */
    public DataSet getBptObjectNum(ParameterSet pset){
    	final String  sql = " SELECT  DIS ,DEPANDENT, DEMOBI, DEMOBIILL, WAR, TESTED, RETIRED, MARTRY FROM BPT_OBJECT_NUMBER";
