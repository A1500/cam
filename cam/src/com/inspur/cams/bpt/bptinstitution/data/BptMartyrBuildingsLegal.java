...
/**
 * @title:BptMartyrBuildingsLegal
 * @description:
 * @author:
 * @since:2011-06-15
 * @version:1.0
*/
 @Table(tableName = "BPT_MARTYR_BUILDINGS_LEGAL" , keyFields = "legalId")
public class BptMartyrBuildingsLegal extends StatefulDatabean {	
   //ID
