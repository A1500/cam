...
/**
 * @title:BptGloriousLegal
 * @description:
 * @author:
 * @since:2011-06-14
 * @version:1.0
*/
 @Table(tableName = "BPT_GLORIOUS_LEGAL" , keyFields = "legalId")
public class BptGloriousLegal extends StatefulDatabean {	
   //ID
   ...
   //光荣院ID   
	@Column(name = "GLORIOUS_DETAIL_ID")
   private String gloriousDetailId;   
   //录入人ID   
	@Column(name = "REG_ID")
    ...
    * @generated
    */
   public String getGloriousDetailId(){
      return this.gloriousDetailId;
   }   
   /** 
    * setter for 光荣院ID
    * @generated
    */
   public void setGloriousDetailId(String gloriousDetailId){
      this.gloriousDetailId = gloriousDetailId;	
   }  
