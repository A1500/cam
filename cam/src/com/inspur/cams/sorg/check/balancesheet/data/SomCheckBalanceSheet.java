package com.inspur.cams.sorg.check.balancesheet.data;
...
/**
 * @title:SomCheckBalanceSheet
 * @description:
 * @author:
 * @since:2012-01-06
 * @version:1.0
*/
 @Table(tableName = "SOM_CHECK_BALANCE_SHEET" , keyFields = "id")
public class SomCheckBalanceSheet extends StatefulDatabean {
   //ID
	@Column(name = "ID")
   private String id;
   //TASK_CODE
