package com.inspur.cams.sorg.check.businessactivity.data;
...
/**
 * @title:SomCheckBusinessActivity
 * @description:
 * @author:
 * @since:2012-01-06
 * @version:1.0
*/
 @Table(tableName = "SOM_CHECK_BUSINESS_ACTIVITY" , keyFields = "id")
public class SomCheckBusinessActivity extends StatefulDatabean {
   //ID
	@Column(name = "ID")
   private String id;
   //TASK_CODE
   ...
   //BUSINESS_COST_PY_SUN
	...
	@Column(name = "BUSINESS_COST_PY_SUM")
   private String businessCostPySum;
   ...
   private String remainingBalanceTy;
	 ...
	 private String publicWelfarrePySun;
...
//TODO 
    ...
    * @generated
    */
   public void setDepreciationAssetsPyUnlimit(String depreciationAssetsPyUnlimit){
    ...
    * @generated
    */
   public void setDepreciationAssetsPyLimit(String depreciationAssetsPyLimit){
    ...
    * @generated
    */
   public void setDepreciationAssetsTyUnlimit(String depreciationAssetsTyUnlimit){
    ...
    * @generated
    */
   public void setDepreciationAssetsTyLimit(String depreciationAssetsTyLimit){
...
public String getBusinessCostPySum() {
	return businessCostPySum;
}
public void setBusinessCostPySum(String businessCostPySum) {
	this.businessCostPySum = businessCostPySum;
}
...
public String getPublicWelfarrePySun() {
	return publicWelfarrePySun;
}
public void setPublicWelfarrePySun(String publicWelfarrePySun) {
	this.publicWelfarrePySun = publicWelfarrePySun;
}
