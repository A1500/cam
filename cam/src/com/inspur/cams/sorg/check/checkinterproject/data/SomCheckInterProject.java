package com.inspur.cams.sorg.check.checkinterproject.data;
...
/**
 * @title:SomCheckInterProject
 * @description:
 * @author:
 * @since:2012-01-07
 * @version:1.0
*/
 @Table(tableName = "SOM_CHECK_INTER_PROJECT" , keyFields = "id")
public class SomCheckInterProject extends StatefulDatabean {
   //ID
