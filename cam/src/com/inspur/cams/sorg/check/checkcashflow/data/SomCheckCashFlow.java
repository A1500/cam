package com.inspur.cams.sorg.check.checkcashflow.data;
 ...
 * @version:1.0
 */
@Table(tableName = "SOM_CHECK_CASH_FLOW", keyFields = "id")
public class SomCheckCashFlow extends StatefulDatabean {
	// ID
	@Column(name = "ID")
	private String id;
	// TASK_CODE
