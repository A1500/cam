...
/**
 * @title:SomJxCheckInterMeetingQueryCommand
 * @description:
 * @author:
 * @since:2012-01-14
 * @version:1.0
*/
public class SomJxCheckInterMeetingQueryCommand extends BaseQueryCommand{

	public DataSet execute() {
		ParameterSet pset = getParameterSet();
		EntityDao<SomJxCheckInterMeeting> dao = (EntityDao<SomJxCheckInterMeeting>) DaoFactory
