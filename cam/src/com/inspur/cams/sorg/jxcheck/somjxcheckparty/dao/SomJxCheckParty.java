...
/**
 * @title:SomJxCheckParty
 * @description:
 * @author:
 * @since:2012-03-09
 * @version:1.0
*/
 @Table(tableName = "SOM_JX_CHECK_PARTY" , keyFields = "id")
public class SomJxCheckParty extends StatefulDatabean {
   //ID
	@Column(name = "ID")
   private String id;
   //TASK_CODE
   ...
   private String noBuildPartyResonDesc;
   //PARTY_MEMBER_TOTAL
   	@Rule(value="number")
   ...
   //PARTY_STUDY_WAY_SELF
	@Column(name = "PARTY_STUDY_WAY_SELF")
   private String partyStudyWaySelf;
   ...
   //PARTY_RETIRE_NUM
   	@Rule(value="number")
	@Column(name = "PARTY_RETIRE_NUM")
   private BigDecimal partyRetireNum;
   //PARTY_SPACE
	@Column(name = "PARTY_SPACE")
   private String partySpace;
   //PARTY_STUDY_WAY_TALK
	@Column(name = "PARTY_STUDY_WAY_TALK")
   private String partyStudyWayTalk;
   //PARTY_STUDY_WAY_CHAIR
	@Column(name = "PARTY_STUDY_WAY_CHAIR")
   private String partyStudyWayChair;
   //PARTY_STUDY_WAY_VISIT
	@Column(name = "PARTY_STUDY_WAY_VISIT")
   private String partyStudyWayVisit;
   //PARTY_STUDY_WAY_ART
	@Column(name = "PARTY_STUDY_WAY_ART")
   private String partyStudyWayArt;
   //PARTY_STUDY_WAY_OTHER
	@Column(name = "PARTY_STUDY_WAY_OTHER")
   private String partyStudyWayOther;
   /**
    * getter for ID
    * @generated
    */
   ...
   /**
    * getter for PARTY_STUDY_WAY_SELF
    * @generated
    */
   public String getPartyStudyWaySelf(){
      return this.partyStudyWaySelf;
   }
   /**
    * setter for PARTY_STUDY_WAY_SELF
    * @generated
    */
   public void setPartyStudyWaySelf(String partyStudyWaySelf){
      this.partyStudyWaySelf = partyStudyWaySelf;
   }
   ...
   /**
    * getter for PARTY_RETIRE_NUM
    * @generated
    */
   public BigDecimal getPartyRetireNum(){
      return this.partyRetireNum;
   }
   /**
    * setter for PARTY_RETIRE_NUM
    * @generated
    */
   public void setPartyRetireNum(BigDecimal partyRetireNum){
      this.partyRetireNum = partyRetireNum;
   }

   /**
    * getter for PARTY_SPACE
    * @generated
    */
   public String getPartySpace(){
      return this.partySpace;
   }
   /**
    * setter for PARTY_SPACE
    * @generated
    */
   public void setPartySpace(String partySpace){
      this.partySpace = partySpace;
   }

   /**
    * getter for PARTY_STUDY_WAY_TALK
    * @generated
    */
   public String getPartyStudyWayTalk(){
      return this.partyStudyWayTalk;
   }
   /**
    * setter for PARTY_STUDY_WAY_TALK
    * @generated
    */
   public void setPartyStudyWayTalk(String partyStudyWayTalk){
      this.partyStudyWayTalk = partyStudyWayTalk;
   }

   /**
    * getter for PARTY_STUDY_WAY_CHAIR
    * @generated
    */
   public String getPartyStudyWayChair(){
      return this.partyStudyWayChair;
   }
   /**
    * setter for PARTY_STUDY_WAY_CHAIR
    * @generated
    */
   public void setPartyStudyWayChair(String partyStudyWayChair){
      this.partyStudyWayChair = partyStudyWayChair;
   }

   /**
    * getter for PARTY_STUDY_WAY_VISIT
    * @generated
    */
   public String getPartyStudyWayVisit(){
      return this.partyStudyWayVisit;
   }
   /**
    * setter for PARTY_STUDY_WAY_VISIT
    * @generated
    */
   public void setPartyStudyWayVisit(String partyStudyWayVisit){
      this.partyStudyWayVisit = partyStudyWayVisit;
   }

   /**
    * getter for PARTY_STUDY_WAY_ART
    * @generated
    */
   public String getPartyStudyWayArt(){
      return this.partyStudyWayArt;
   }
   /**
    * setter for PARTY_STUDY_WAY_ART
    * @generated
    */
   public void setPartyStudyWayArt(String partyStudyWayArt){
      this.partyStudyWayArt = partyStudyWayArt;
   }

   /**
    * getter for PARTY_STUDY_WAY_OTHER
    * @generated
    */
   public String getPartyStudyWayOther(){
      return this.partyStudyWayOther;
   }
   /**
    * setter for PARTY_STUDY_WAY_OTHER
    * @generated
    */
   public void setPartyStudyWayOther(String partyStudyWayOther){
      this.partyStudyWayOther = partyStudyWayOther;
   }
public String getNoBuildPartyResonDesc() {
	return noBuildPartyResonDesc;
}
public void setNoBuildPartyResonDesc(String noBuildPartyResonDesc) {
	this.noBuildPartyResonDesc = noBuildPartyResonDesc;
}
