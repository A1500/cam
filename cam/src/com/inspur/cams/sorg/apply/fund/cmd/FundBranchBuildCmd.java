 ...
 * @date 2011-8-23
 */
public class FundBranchBuildCmd extends BaseAjaxCommand {
	
	IFundBranchBuildDomain service = ScaComponentFactory.getService(IFundBranchBuildDomain.class, "fundBranchBuildDomain/fundBranchBuildDomain");
