 ...
 * @date 2011-8-17
 */
public class FundChangeCmd extends BaseAjaxCommand {
	private IFundChangeDomain service = ScaComponentFactory.getService(IFundChangeDomain.class, "fundChangeDomain/fundChangeDomain");
	/**
	 * 业务流程中的保存发送流程
	 */
	 ...
	 * @title 内网预受理保存变更信息
	 */
	public void savePreChangeOnline(){
		SomChangeApply somChangeApply=createChangeInfo();
		service.savePreChangeOnline(somChangeApply);
	}
	/**
	 * 网上申请业务流程中的保存发送流程
	 */
