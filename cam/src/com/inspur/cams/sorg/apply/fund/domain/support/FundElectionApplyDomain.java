...
public class FundElectionApplyDomain implements IFundElectionApplyDomain {
	...
	public static final String PROC_DEF_UNIQUE_ID = "402881e4383631ab0138364bdc30001a";
	...
	public String create(SomApply somApply, SomElection somElection) {
		...
		if("ONLINE".equals(somApply.getDataSource())){
