...
public class FundBranchAPCheckCmd extends BaseAjaxCommand {
	// 获取SCA组件
	private IFundBranchAPCheckDomain service = ScaComponentFactory.getService(IFundBranchAPCheckDomain.class, "fundBranchAPCheckDomain/fundBranchAPCheckDomain");
