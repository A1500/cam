...
public class UngovCancelCmd extends BaseAjaxCommand {
	// 获取SCA组件
	private IUngovCancelDomain service = ScaComponentFactory.getService(
			IUngovCancelDomain.class, "ungovCancelDomain/ungovCancelDomain");
