 ...
 * 说明:
 */
public class UngovPartBuildCmd extends BaseAjaxCommand {
	// 获取SCA组件
	private IUngovPartBuildDomain service = ScaComponentFactory.getService(IUngovPartBuildDomain.class, "ungovPartBuildDomain/ungovPartBuildDomain");
