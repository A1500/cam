...
public class UngovBuildDomain implements IUngovBuildDomain {
	@Reference
	...
	public static final String PROC_DEF_UNIQUE_ID = "8a898b9d36385b4201363904440b0031";
	...
	private void insertBuildContent(SomApply applyBean) {	
		...
		applyBean.setApplyType(ApplyType.SOM_UNGOV_BUILD_LEGAL);
