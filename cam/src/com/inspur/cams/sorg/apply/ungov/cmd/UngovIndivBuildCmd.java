 ...
 * 说明:
 */
public class UngovIndivBuildCmd extends BaseAjaxCommand {
	// 获取SCA组件
	private IUngovIndivBuildDomain service = ScaComponentFactory.getService(IUngovIndivBuildDomain.class, "ungovIndivBuildDomain/ungovIndivBuildDomain");
