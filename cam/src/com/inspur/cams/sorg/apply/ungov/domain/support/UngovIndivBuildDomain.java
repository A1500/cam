...
import com.inspur.cams.sorg.apply.ungov.domain.IUngovIndivBuildDomain;
...
public class UngovIndivBuildDomain implements IUngovIndivBuildDomain {
	@Reference
	...
	public static final String PROC_DEF_UNIQUE_ID = "8a898b9d363952230136395b83ea0050";
	...
	private void insertBuildContent(SomApply applyBean) {	
		...
		applyBean.setApplyType(ApplyType.SOM_UNGOV_BUILD_INDIVIDUAL);
