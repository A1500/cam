...
public class GroupBranchAPCheckDomain implements IGroupBranchAPCheckDomain {
	@Reference
	...
	public static final String PROC_DEF_UNIQUE_ID = "4028b881338c056e01338c056e930000";
	public static final String START_ACT_DEF_ID = "act1";
	
	/**
	 * 社会团体异地设立分支（代表）机构的审查保存
	 * 
	 * @param dataBean
	 */
	...
	private void insertBuildContent(SomApply applyBean) {	
		...
		applyBean.setApplyType(ApplyType.SOM_GROUP_BRANCH_ANOTHER_PLACE_CHECK);
