 ...
 * @date 2012年6月25日
 */
public class GroupElectionApplyDomain implements IGroupElectionApplyDomain {
	@Reference
	...
	public static final String PROC_DEF_UNIQUE_ID = "402881e43807decf013807decf190000";
	...
	public String create(SomApply somApply, SomElection somElection) {
		...
		Map wfMap=WfTaskRequestWrapper.getInstance().create(somApply.getTaskCode(), somApply.getSorgName()+"的换届（成立）事先报批申请");
