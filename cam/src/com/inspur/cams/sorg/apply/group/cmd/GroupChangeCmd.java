...
public class GroupChangeCmd extends BaseAjaxCommand {
	private IGroupChangeDomain service = ScaComponentFactory.getService(IGroupChangeDomain.class, "groupChangeDomain/groupChangeDomain");
	/**
	 * 业务流程中的保存发送流程
	 */
