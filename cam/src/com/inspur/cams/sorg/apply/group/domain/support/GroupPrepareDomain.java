 ...
 * @date 2011-8-9
 */
public class GroupPrepareDomain implements IGroupPrepareDomain {
	...
	public static final String PROC_DEF_UNIQUE_ID = "8a898b9d3629c479013629c4796f0000";
	...
	public String create(SomApply somApply) {
		...
		Map wfMap = WfTaskRequestWrapper.getInstance().create(somApply.getTaskCode(), somOrgan.getCnName() + "筹备申请");
		...
		somApply.setApplyType(ApplyType.SOM_GROUP_PREPARE);
