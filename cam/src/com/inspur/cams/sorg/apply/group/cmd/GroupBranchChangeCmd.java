...
public class GroupBranchChangeCmd extends BaseAjaxCommand  {
	private IGroupBranchChangeDomain service = ScaComponentFactory.getService(IGroupBranchChangeDomain.class, "groupBranchChangeDomain/groupBranchChangeDomain");	
	/**
	 * 业务流程中的保存发送流程
	 */
