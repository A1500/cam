...
public class GroupCancelDomain implements IGroupCancelDomain {
	@Reference
	...
	public String create(SomApply somApply) {
		...
		CommandContext.setContextParameter("procDefUniqueId",
				"402881ec31e5e98e0131e5eb94dc0014");
		CommandContext.setContextParameter("startActDefUniqueId",
				"402881ec31e5e98e0131e5f1dd040022");
		// 调用工作流创建接口
	...
	private void dealSomLiqpeople(SomApply somApply){
		...
		for (int i = 0; i < somLiqpeopleList.size(); i++) {
			SomLiqpeople somLiqpeople = somLiqpeopleList.get(i);
