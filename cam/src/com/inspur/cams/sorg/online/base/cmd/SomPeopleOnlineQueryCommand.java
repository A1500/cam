...
/**
 * @title:SomPeopleOnlineQueryCommand
 * @description:
 * @author:
 * @since:2012-11-08
 * @version:1.0
*/
public class SomPeopleOnlineQueryCommand extends BaseQueryCommand{

	public DataSet execute() {
		ParameterSet pset = getParameterSet();
		EntityDao<SomPeopleOnline> dao = (EntityDao<SomPeopleOnline>) DaoFactory
