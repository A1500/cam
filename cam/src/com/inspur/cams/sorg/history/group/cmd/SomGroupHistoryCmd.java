package com.inspur.cams.sorg.history.group.cmd;
 ...
 * @date 2011-11-21
 */
public class SomGroupHistoryCmd extends BaseAjaxCommand {
	@Reference
	private ISomGroupHistoryDomain service = ScaComponentFactory.getService(ISomGroupHistoryDomain.class,"somGroupHistoryDomain/somGroupHistoryDomain");
	...
	public void deleteChange(){
		service.deleteChange((String)getParameter("taskCode"));
	}
	/**
	 * 保存社会组织分支变更信息
	 */
