...
public class SomGroupAccountQuery {
	// id
	private String id;
	// 登记时间
	...
	// 党政机关领导干部兼任领导人数
	private String servantTotalNum;
	// 执行会计制度
	// 固定资产原价
	...
	// 出版物数
	private String publicationTotalNum;
	// 年检时间
	...
	public String getServantTotalNum() {
		return servantTotalNum;
	}

	public void setServantTotalNum(String servantTotalNum) {
		this.servantTotalNum = servantTotalNum;
	}
	...
	public String getPublicationTotalNum() {
		return publicationTotalNum;
	}

	public void setPublicationTotalNum(String publicationTotalNum) {
		this.publicationTotalNum = publicationTotalNum;
	}
}
