...
public class SomUngovAccountQuery {
	// id
	private String id;
	// 登记时间
	...
	public BigDecimal getIfNewBuild() {
		return ifNewBuild;
	}

	public void setIfNewBuild(BigDecimal ifNewBuild) {
		this.ifNewBuild = ifNewBuild;
	}
}
