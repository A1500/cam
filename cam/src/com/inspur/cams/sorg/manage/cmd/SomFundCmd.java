...
/**
 * 基金会成立基本信息、人员信息的录入、修改和查看
 * @author Muqi
 * @date 2011年6月3日11:47:58
 */
public class SomFundCmd extends BaseAjaxCommand {
	// ---------------------------------------muqi-----------------------------------------------------
	// 获取SCA组件
	...
	public void branchStatusNum() {
		...
		setReturn("num", service.branchStatusNum(mainMorgId, sorgStatus,sorgStatus2));
	}
